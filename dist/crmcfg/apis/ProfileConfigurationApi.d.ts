...
import type { AddressFormats, CopyExclusivePreferencesRequest, CopyPreferencesRequest, CreditRatings, ExclusivePreferences, HotelPreferences, OperaVersion, PostProfileNameValidationsRequest, PreferenceGroups, ProfileLinks, ProfileNameValidations, PutAddressFormatsRequest, PutCreditRatingsRequest, PutExclusivePreferencesRequest, PutPreferenceGroupsRequest, PutPreferencesRequest, PutProfileNameValidationsRequest, PutProfileRelationshipsRequest, PutTemplateExclusivePreferencesRequest, PutTemplatePreferencesRequest, Status, TemplateExclusivePreferences, TemplatePreferences } from '../models';
...
export interface DeleteProfileConfigServiceCacheRequest {
    authorization?: string;
    xAppKey?: string;
    xHotelid?: string;
    xExternalsystem?: string;
...
export interface PutProfileRelationshipsOperationRequest {
    authorization?: string;
    xAppKey?: string;
    xHotelid?: string;
    profileLinks?: PutProfileRelationshipsRequest;
...
export declare class ProfileConfigurationApi extends runtime.BaseAPI {
     ...
     *  clear cache
     */
    deleteProfileConfigServiceCacheRaw(requestParameters: DeleteProfileConfigServiceCacheRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Status>>;
    /**
     * Clear Profile Configuratoin Cache <p><strong>OperationId:</strong>deleteProfileConfigServiceCache</p>
     *  clear cache
     */
    deleteProfileConfigServiceCache(requestParameters: DeleteProfileConfigServiceCacheRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Status>;
    /**
     ...
     *  ping
     */
    pingProfileConfigServiceRaw(requestParameters: PingProfileConfigServiceRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<OperaVersion>>;
    /**
     * Ping Profile Configuration Service <p><strong>OperationId:</strong>pingProfileConfigService</p>
     *  ping
     */
    pingProfileConfigService(requestParameters: PingProfileConfigServiceRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<OperaVersion>;
    /**
     ...
     */
    putProfileRelationshipsRaw(requestParameters: PutProfileRelationshipsOperationRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Status>>;
    /**
     * You can use this API to change profile relationships. <p><strong>OperationId:</strong>putProfileRelationships</p>
     * Change profile relationships
     */
    putProfileRelationships(requestParameters: PutProfileRelationshipsOperationRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Status>;
    /**
