...
class HotelConfigApi extends runtime.BaseAPI {
     ...
     */
    async changeCommunicationTypeRaw(requestParameters, initOverrides) {
        ...
        const response = await this.request({
            ...
            body: (0, models_1.ChangeCommunicationTypeRequestToJSON)(requestParameters.communicationTypeToBeChanged),
        }, initOverrides);
     ...
     * Change a  communication type
     */
    async changeCommunicationType(requestParameters, initOverrides) {
     ...
     */
    async getCommunicationTypesRaw(requestParameters, initOverrides) {
        const queryParameters = {};
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => (0, models_1.CommunicationTypesDetailsFromJSON)(jsonValue));
    }
    /**
     * Use this API to get communication types. <p><strong>OperationId:</strong>getCommunicationTypes</p>
     * Get communication types
     */
    async getCommunicationTypes(requestParameters, initOverrides) {
     ...
     */
    async postCommunicationTypeRaw(requestParameters, initOverrides) {
        const queryParameters = {};
        const headerParameters = {};
        headerParameters['Content-Type'] = 'application/json;charset=UTF-8';
        if (requestParameters.authorization !== undefined && requestParameters.authorization !== null) {
        ...
        const response = await this.request({
            ...
            headers: headerParameters,
            query: queryParameters,
            body: (0, models_1.PostCommunicationTypeRequestToJSON)(requestParameters.communicationTypeCriteria),
        }, initOverrides);
        return new runtime.JSONApiResponse(response, (jsonValue) => (0, models_1.StatusFromJSON)(jsonValue));
    }
    /**
     ...
     * Create a  communication type
     */
    async postCommunicationType(requestParameters, initOverrides) {
     ...
     */
    async removeCommunicationTypeRaw(requestParameters, initOverrides) {
        const queryParameters = {};
        const headerParameters = {};
        if (requestParameters.authorization !== undefined && requestParameters.authorization !== null) {
            headerParameters['authorization'] = String(requestParameters.authorization);
     ...
     * Delete a communication type
     */
    async removeCommunicationType(requestParameters, initOverrides) {
