 ...
 */
function instanceOfTravelAgentTypesCriteria(value) {
    let isInstance = true;
    return isInstance;
}
exports.instanceOfTravelAgentTypesCriteria = instanceOfTravelAgentTypesCriteria;
function TravelAgentTypesCriteriaFromJSON(json) {
    return TravelAgentTypesCriteriaFromJSONTyped(json, false);
}
exports.TravelAgentTypesCriteriaFromJSON = TravelAgentTypesCriteriaFromJSON;
function TravelAgentTypesCriteriaFromJSONTyped(json, ignoreDiscriminator) {
...
function TravelAgentTypesCriteriaToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
