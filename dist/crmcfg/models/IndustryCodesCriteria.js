 ...
 */
function instanceOfIndustryCodesCriteria(value) {
    let isInstance = true;
    return isInstance;
}
exports.instanceOfIndustryCodesCriteria = instanceOfIndustryCodesCriteria;
function IndustryCodesCriteriaFromJSON(json) {
    return IndustryCodesCriteriaFromJSONTyped(json, false);
}
exports.IndustryCodesCriteriaFromJSON = IndustryCodesCriteriaFromJSON;
function IndustryCodesCriteriaFromJSONTyped(json, ignoreDiscriminator) {
...
function IndustryCodesCriteriaToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
