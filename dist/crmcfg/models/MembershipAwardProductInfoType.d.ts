 ...
 */
export declare function instanceOfMembershipAwardProductInfoType(value: object): boolean;
export declare function MembershipAwardProductInfoTypeFromJSON(json: any): MembershipAwardProductInfoType;
export declare function MembershipAwardProductInfoTypeFromJSONTyped(json: any, ignoreDiscriminator: boolean): MembershipAwardProductInfoType;
export declare function MembershipAwardProductInfoTypeToJSON(value?: MembershipAwardProductInfoType | null): any;
