 ...
 */
function instanceOfProfileInactiveReasonsCriteria(value) {
    let isInstance = true;
    return isInstance;
}
exports.instanceOfProfileInactiveReasonsCriteria = instanceOfProfileInactiveReasonsCriteria;
function ProfileInactiveReasonsCriteriaFromJSON(json) {
    return ProfileInactiveReasonsCriteriaFromJSONTyped(json, false);
}
exports.ProfileInactiveReasonsCriteriaFromJSON = ProfileInactiveReasonsCriteriaFromJSON;
function ProfileInactiveReasonsCriteriaFromJSONTyped(json, ignoreDiscriminator) {
...
function ProfileInactiveReasonsCriteriaToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
