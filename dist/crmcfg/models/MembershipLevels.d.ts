 ...
 */
export declare function instanceOfMembershipLevels(value: object): boolean;
export declare function MembershipLevelsFromJSON(json: any): MembershipLevels;
export declare function MembershipLevelsFromJSONTyped(json: any, ignoreDiscriminator: boolean): MembershipLevels;
export declare function MembershipLevelsToJSON(value?: MembershipLevels | null): any;
