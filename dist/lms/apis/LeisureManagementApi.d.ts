...
import type { ActivityBookingModified, ActivityBookingsDetails, OperaVersion, PostActivityBookingRequest, PostLocationNotificationRequest, PutActivityBookingRequest, Status } from '../models';
...
export declare class LeisureManagementApi extends runtime.BaseAPI {
     ...
     */
    deleteLeisureManagementServiceCacheRaw(requestParameters: DeleteLeisureManagementServiceCacheRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Status>>;
    /**
     * Operation to clear cache <p><strong>OperationId:</strong>deleteLeisureManagementServiceCache</p>
     * Clear Cache for the Leisure Management Service
     */
    deleteLeisureManagementServiceCache(requestParameters: DeleteLeisureManagementServiceCacheRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Status>;
    /**
     ...
     */
    pingLeisureManagementServiceRaw(requestParameters: PingLeisureManagementServiceRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<OperaVersion>>;
    /**
     * Service ping the Leisure Management Service. <p><strong>OperationId:</strong>pingLeisureManagementService</p>
     * Ping the Leisure Management Service
     */
    pingLeisureManagementService(requestParameters: PingLeisureManagementServiceRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<OperaVersion>;
    /**
