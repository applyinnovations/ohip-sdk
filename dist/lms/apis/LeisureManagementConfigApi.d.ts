...
import type { ChangeActivityLocationsRS, ChangeActivityStatusCodesRS, ChangeActivityTypesRS, CopyActivityLocationsRS, CopyActivityLocationsRequest, CopyActivityTypesRS, CopyActivityTypesRequest, FetchActivityLocations, FetchActivityStatusCodes, FetchActivityTypes, OperaVersion, PostActivityLocationsRequest, PostActivityStatusCodesRequest, PostActivityTypesRequest, PutActivityLocationsRequest, PutActivityStatusCodesRequest, PutActivityTypesRequest, Status } from '../models';
...
export interface DeleteLeisureManagementConfigCacheRequest {
    authorization?: string;
    xAppKey?: string;
    xHotelid?: string;
    xExternalsystem?: string;
...
export interface GetLeisureManagementConfigServicesStatusRequest {
    authorization?: string;
    xAppKey?: string;
    xHotelid?: string;
    xExternalsystem?: string;
...
export declare class LeisureManagementConfigApi extends runtime.BaseAPI {
     ...
     *  clear cache
     */
    deleteLeisureManagementConfigCacheRaw(requestParameters: DeleteLeisureManagementConfigCacheRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Status>>;
    /**
     * Delete Leisure Management Configuration Cache <p><strong>OperationId:</strong>deleteLeisureManagementConfigCache</p>
     *  clear cache
     */
    deleteLeisureManagementConfigCache(requestParameters: DeleteLeisureManagementConfigCacheRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Status>;
    /**
     ...
     */
    getLeisureManagementConfigServicesStatusRaw(requestParameters: GetLeisureManagementConfigServicesStatusRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<OperaVersion>>;
    /**
     * Get Leisure Management Configuration Services Status <p><strong>OperationId:</strong>getLeisureManagementConfigServicesStatus</p>
     * Send a response to a ping
     */
    getLeisureManagementConfigServicesStatus(requestParameters: GetLeisureManagementConfigServicesStatusRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<OperaVersion>;
    /**
