...
exports.PostCompanyProfileRequestToJSON = exports.PostCompanyProfileRequestFromJSONTyped = exports.PostCompanyProfileRequestFromJSON = exports.instanceOfPostCompanyProfileRequest = void 0;
 ...
 */
function instanceOfPostCompanyProfileRequest(value) {
    let isInstance = true;
    return isInstance;
}
exports.instanceOfPostCompanyProfileRequest = instanceOfPostCompanyProfileRequest;
function PostCompanyProfileRequestFromJSON(json) {
    return PostCompanyProfileRequestFromJSONTyped(json, false);
}
exports.PostCompanyProfileRequestFromJSON = PostCompanyProfileRequestFromJSON;
function PostCompanyProfileRequestFromJSONTyped(json, ignoreDiscriminator) {
...
exports.PostCompanyProfileRequestFromJSONTyped = PostCompanyProfileRequestFromJSONTyped;
function PostCompanyProfileRequestToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
...
exports.PostCompanyProfileRequestToJSON = PostCompanyProfileRequestToJSON;
