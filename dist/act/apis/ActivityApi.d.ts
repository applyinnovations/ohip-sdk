...
import type { ActivitiesInfo, Activity, ActivityAttachments, ActivityLog, ActivityStatistics, EmailsDetails, OperaVersion, PostActivitiesRequest, PostLinkedActivitiesRequest, PostMultipleActivitiesCompletionRequest, PostSingleActivityCompletionRequest, PutActivitiesRequest, RecentlyAccessedActivities, Status } from '../models';
...
export interface DeleteActivityServiceCacheRequest {
    authorization?: string;
    xAppKey?: string;
    xHotelid?: string;
    xExternalsystem?: string;
...
export interface PingActivityServiceRequest {
    authorization?: string;
    xAppKey?: string;
    xHotelid?: string;
    xExternalsystem?: string;
...
export declare class ActivityApi extends runtime.BaseAPI {
     ...
     */
    deleteActivityServiceCacheRaw(requestParameters: DeleteActivityServiceCacheRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Status>>;
    /**
     * Use this API to clear the cache for the Activity module <p><strong>OperationId:</strong>deleteActivityServiceCache</p>
     * Clear Activity Cache
     */
    deleteActivityServiceCache(requestParameters: DeleteActivityServiceCacheRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Status>;
    /**
     ...
     */
    pingActivityServiceRaw(requestParameters: PingActivityServiceRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<OperaVersion>>;
    /**
     *  <p><strong>OperationId:</strong>pingActivityService</p>
     * Operation to get health status
     */
    pingActivityService(requestParameters: PingActivityServiceRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<OperaVersion>;
    /**
