 ...
 */
export declare function instanceOfActivityDetailsTypeLinkedAccounts(value: object): boolean;
export declare function ActivityDetailsTypeLinkedAccountsFromJSON(json: any): ActivityDetailsTypeLinkedAccounts;
export declare function ActivityDetailsTypeLinkedAccountsFromJSONTyped(json: any, ignoreDiscriminator: boolean): ActivityDetailsTypeLinkedAccounts;
export declare function ActivityDetailsTypeLinkedAccountsToJSON(value?: ActivityDetailsTypeLinkedAccounts | null): any;
