 ...
 */
export declare function instanceOfActivitiesInformation(value: object): boolean;
export declare function ActivitiesInformationFromJSON(json: any): ActivitiesInformation;
export declare function ActivitiesInformationFromJSONTyped(json: any, ignoreDiscriminator: boolean): ActivitiesInformation;
export declare function ActivitiesInformationToJSON(value?: ActivitiesInformation | null): any;
