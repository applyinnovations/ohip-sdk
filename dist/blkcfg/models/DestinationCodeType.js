...
exports.DestinationCodeTypeToJSON = exports.DestinationCodeTypeFromJSONTyped = exports.DestinationCodeTypeFromJSON = exports.instanceOfDestinationCodeType = void 0;
 ...
 */
function instanceOfDestinationCodeType(value) {
    let isInstance = true;
    return isInstance;
}
exports.instanceOfDestinationCodeType = instanceOfDestinationCodeType;
function DestinationCodeTypeFromJSON(json) {
    return DestinationCodeTypeFromJSONTyped(json, false);
}
exports.DestinationCodeTypeFromJSON = DestinationCodeTypeFromJSON;
function DestinationCodeTypeFromJSONTyped(json, ignoreDiscriminator) {
...
exports.DestinationCodeTypeFromJSONTyped = DestinationCodeTypeFromJSONTyped;
function DestinationCodeTypeToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
...
exports.DestinationCodeTypeToJSON = DestinationCodeTypeToJSON;
