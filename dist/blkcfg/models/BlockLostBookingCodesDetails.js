 ...
 */
function instanceOfBlockLostBookingCodesDetails(value) {
    let isInstance = true;
    return isInstance;
}
exports.instanceOfBlockLostBookingCodesDetails = instanceOfBlockLostBookingCodesDetails;
function BlockLostBookingCodesDetailsFromJSON(json) {
    return BlockLostBookingCodesDetailsFromJSONTyped(json, false);
}
exports.BlockLostBookingCodesDetailsFromJSON = BlockLostBookingCodesDetailsFromJSON;
function BlockLostBookingCodesDetailsFromJSONTyped(json, ignoreDiscriminator) {
...
function BlockLostBookingCodesDetailsToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
