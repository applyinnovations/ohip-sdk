...
exports.BlockRateOverrideReasonTypeToJSON = exports.BlockRateOverrideReasonTypeFromJSONTyped = exports.BlockRateOverrideReasonTypeFromJSON = exports.instanceOfBlockRateOverrideReasonType = void 0;
 ...
 */
function instanceOfBlockRateOverrideReasonType(value) {
    let isInstance = true;
    return isInstance;
}
exports.instanceOfBlockRateOverrideReasonType = instanceOfBlockRateOverrideReasonType;
function BlockRateOverrideReasonTypeFromJSON(json) {
    return BlockRateOverrideReasonTypeFromJSONTyped(json, false);
}
exports.BlockRateOverrideReasonTypeFromJSON = BlockRateOverrideReasonTypeFromJSON;
function BlockRateOverrideReasonTypeFromJSONTyped(json, ignoreDiscriminator) {
...
exports.BlockRateOverrideReasonTypeFromJSONTyped = BlockRateOverrideReasonTypeFromJSONTyped;
function BlockRateOverrideReasonTypeToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
...
exports.BlockRateOverrideReasonTypeToJSON = BlockRateOverrideReasonTypeToJSON;
