...
exports.PostBlockRefusedReasonspostBloRequestToJSON = exports.PostBlockRefusedReasonspostBloRequestFromJSONTyped = exports.PostBlockRefusedReasonspostBloRequestFromJSON = exports.instanceOfPostBlockRefusedReasonspostBloRequest = void 0;
 ...
 */
function instanceOfPostBlockRefusedReasonspostBloRequest(value) {
    let isInstance = true;
    return isInstance;
}
exports.instanceOfPostBlockRefusedReasonspostBloRequest = instanceOfPostBlockRefusedReasonspostBloRequest;
function PostBlockRefusedReasonspostBloRequestFromJSON(json) {
    return PostBlockRefusedReasonspostBloRequestFromJSONTyped(json, false);
}
exports.PostBlockRefusedReasonspostBloRequestFromJSON = PostBlockRefusedReasonspostBloRequestFromJSON;
function PostBlockRefusedReasonspostBloRequestFromJSONTyped(json, ignoreDiscriminator) {
...
exports.PostBlockRefusedReasonspostBloRequestFromJSONTyped = PostBlockRefusedReasonspostBloRequestFromJSONTyped;
function PostBlockRefusedReasonspostBloRequestToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
...
exports.PostBlockRefusedReasonspostBloRequestToJSON = PostBlockRefusedReasonspostBloRequestToJSON;
