...
import type { BlockSalesAllowance, NextBlockStatusCodeDetails, OperaVersion, PostBlockStatusCodeRequest, PostSalesManagerGoalsRequest, PostWashScheduleRequest, PutNextBlockStatusCodesRequest, PutSalesManagerGoalsRequest, SalesManagerGoalsInfo, SalesManagersInfo, SetBlockSalesAllowanceRangeRequest, Status, StatusCodeDetails, WashScheduleDetails } from '../models';
export interface DeleteBlockConfigServiceCacheRequest {
...
export interface PingBlockConfigServiceRequest {
    authorization?: string;
    xAppKey?: string;
    xHotelid?: string;
    xExternalsystem?: string;
...
export declare class BlockConfigApi extends runtime.BaseAPI {
     ...
     *  clear cache
     */
    deleteBlockConfigServiceCacheRaw(requestParameters: DeleteBlockConfigServiceCacheRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Status>>;
    /**
     * delete Block Configuration Service Cache <p><strong>OperationId:</strong>deleteBlockConfigServiceCache</p>
     *  clear cache
     */
    deleteBlockConfigServiceCache(requestParameters: DeleteBlockConfigServiceCacheRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Status>;
    /**
     ...
     *  ping
     */
    pingBlockConfigServiceRaw(requestParameters: PingBlockConfigServiceRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<OperaVersion>>;
    /**
     * Ping Block Configuration Service <p><strong>OperationId:</strong>pingBlockConfigService</p>
     *  ping
     */
    pingBlockConfigService(requestParameters: PingBlockConfigServiceRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<OperaVersion>;
    /**
