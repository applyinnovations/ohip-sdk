...
import type { ChangedDeliveryMethods, ChangedInterfaceRight, ChangedUDFMapping, FetchedDeliveryMethods, FetchedExternalDatabaseAvailableProperties, FetchedHotelInterfaceControllerRegistry, FetchedHotelInterfaceErrors, FetchedHotelInterfaceFailedMessages, FetchedHotelInterfaceSchemas, FetchedHotelInterfaces, FetchedPublishers, FetchedUDFMappings, InterfaceRightType, OperaVersion, PostDeliveryMethodsRequest, PostPublishersRequest, PutDeliveryMethodsRequest, PutInterfaceRightRequest, PutUDFMappingRequest, Status } from '../models';
