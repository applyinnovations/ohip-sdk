 ...
 * @export
 */
export declare const ClassOfServiceConfigType: {
...
export declare function ClassOfServiceConfigTypeFromJSON(json: any): ClassOfServiceConfigType;
export declare function ClassOfServiceConfigTypeFromJSONTyped(json: any, ignoreDiscriminator: boolean): ClassOfServiceConfigType;
export declare function ClassOfServiceConfigTypeToJSON(value?: ClassOfServiceConfigType | null): any;
