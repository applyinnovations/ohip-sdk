 ...
 */
export declare function instanceOfPostTemplateDeviceLocationsRequest(value: object): boolean;
export declare function PostTemplateDeviceLocationsRequestFromJSON(json: any): PostTemplateDeviceLocationsRequest;
export declare function PostTemplateDeviceLocationsRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): PostTemplateDeviceLocationsRequest;
export declare function PostTemplateDeviceLocationsRequestToJSON(value?: PostTemplateDeviceLocationsRequest | null): any;
