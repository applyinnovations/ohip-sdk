 ...
 */
export declare function instanceOfBlockTypeBlockProfiles(value: object): boolean;
export declare function BlockTypeBlockProfilesFromJSON(json: any): BlockTypeBlockProfiles;
export declare function BlockTypeBlockProfilesFromJSONTyped(json: any, ignoreDiscriminator: boolean): BlockTypeBlockProfiles;
export declare function BlockTypeBlockProfilesToJSON(value?: BlockTypeBlockProfiles | null): any;
