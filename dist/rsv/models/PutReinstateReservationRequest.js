...
exports.PutReinstateReservationRequestToJSON = exports.PutReinstateReservationRequestFromJSONTyped = exports.PutReinstateReservationRequestFromJSON = exports.instanceOfPutReinstateReservationRequest = void 0;
 ...
 */
function instanceOfPutReinstateReservationRequest(value) {
    let isInstance = true;
    return isInstance;
}
exports.instanceOfPutReinstateReservationRequest = instanceOfPutReinstateReservationRequest;
function PutReinstateReservationRequestFromJSON(json) {
    return PutReinstateReservationRequestFromJSONTyped(json, false);
}
exports.PutReinstateReservationRequestFromJSON = PutReinstateReservationRequestFromJSON;
function PutReinstateReservationRequestFromJSONTyped(json, ignoreDiscriminator) {
...
exports.PutReinstateReservationRequestFromJSONTyped = PutReinstateReservationRequestFromJSONTyped;
function PutReinstateReservationRequestToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
...
exports.PutReinstateReservationRequestToJSON = PutReinstateReservationRequestToJSON;
