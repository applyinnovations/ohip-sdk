 ...
 */
export declare function instanceOfShareReservationInstructionType(value: object): boolean;
export declare function ShareReservationInstructionTypeFromJSON(json: any): ShareReservationInstructionType;
export declare function ShareReservationInstructionTypeFromJSONTyped(json: any, ignoreDiscriminator: boolean): ShareReservationInstructionType;
export declare function ShareReservationInstructionTypeToJSON(value?: ShareReservationInstructionType | null): any;
