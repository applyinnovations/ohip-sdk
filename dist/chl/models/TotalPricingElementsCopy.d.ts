 ...
 */
export declare function instanceOfTotalPricingElementsCopy(value: object): boolean;
export declare function TotalPricingElementsCopyFromJSON(json: any): TotalPricingElementsCopy;
export declare function TotalPricingElementsCopyFromJSONTyped(json: any, ignoreDiscriminator: boolean): TotalPricingElementsCopy;
export declare function TotalPricingElementsCopyToJSON(value?: TotalPricingElementsCopy | null): any;
