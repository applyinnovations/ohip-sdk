 ...
 */
export declare function instanceOfPostChannelAccountsRequest(value: object): boolean;
export declare function PostChannelAccountsRequestFromJSON(json: any): PostChannelAccountsRequest;
export declare function PostChannelAccountsRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): PostChannelAccountsRequest;
export declare function PostChannelAccountsRequestToJSON(value?: PostChannelAccountsRequest | null): any;
