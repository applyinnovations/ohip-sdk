 ...
 */
export declare function instanceOfChannelAccountContracts(value: object): boolean;
export declare function ChannelAccountContractsFromJSON(json: any): ChannelAccountContracts;
export declare function ChannelAccountContractsFromJSONTyped(json: any, ignoreDiscriminator: boolean): ChannelAccountContracts;
export declare function ChannelAccountContractsToJSON(value?: ChannelAccountContracts | null): any;
