 ...
 */
export declare function instanceOfDistributeChannelRatesType(value: object): boolean;
export declare function DistributeChannelRatesTypeFromJSON(json: any): DistributeChannelRatesType;
export declare function DistributeChannelRatesTypeFromJSONTyped(json: any, ignoreDiscriminator: boolean): DistributeChannelRatesType;
export declare function DistributeChannelRatesTypeToJSON(value?: DistributeChannelRatesType | null): any;
