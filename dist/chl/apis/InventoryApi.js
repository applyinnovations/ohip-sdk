...
class InventoryApi extends runtime.BaseAPI {
     ...
     */
    async changeChannelSellLimitsByDateRaw(requestParameters, initOverrides) {
        ...
        const response = await this.request({
            ...
            body: (0, models_1.ChangeChannelSellLimitsByDateRequestToJSON)(requestParameters.channelSellLimitsByDate),
        }, initOverrides);
     ...
     * Updates channel sell limits by date
     */
    async changeChannelSellLimitsByDate(requestParameters, initOverrides) {
     ...
     */
    async changeChannelSellLimitsByDateRangeRaw(requestParameters, initOverrides) {
        const queryParameters = {};
        const headerParameters = {};
        headerParameters['Content-Type'] = 'application/json;charset=UTF-8';
        if (requestParameters.authorization !== undefined && requestParameters.authorization !== null) {
        ...
        const response = await this.request({
            ...
            headers: headerParameters,
            query: queryParameters,
            body: (0, models_1.ChangeChannelSellLimitsByDateRangeRequestToJSON)(requestParameters.channelSellLimitsByDateRange),
        }, initOverrides);
        return new runtime.JSONApiResponse(response, (jsonValue) => (0, models_1.StatusFromJSON)(jsonValue));
    }
    /**
     ...
     * Updates channel sell limits by daterange
     */
    async changeChannelSellLimitsByDateRange(requestParameters, initOverrides) {
     ...
     */
    async deleteChannelSellLimitsRaw(requestParameters, initOverrides) {
        const queryParameters = {};
        const headerParameters = {};
        if (requestParameters.authorization !== undefined && requestParameters.authorization !== null) {
            headerParameters['authorization'] = String(requestParameters.authorization);
     ...
     * Deletes channel sell limits
     */
    async deleteChannelSellLimits(requestParameters, initOverrides) {
     ...
     */
    async getChannelSellLimitsRaw(requestParameters, initOverrides) {
        const queryParameters = {};
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => (0, models_1.ChannelSellLimitsFromJSON)(jsonValue));
    }
    /**
     * Use this API to retrieve channel sell limit detail to get or review daily sell limits for a given hotel-channel combination. <p><strong>OperationId:</strong>getChannelSellLimits</p>
     * Gets sell limit detail for a given channel hotel combination
     */
    async getChannelSellLimits(requestParameters, initOverrides) {
