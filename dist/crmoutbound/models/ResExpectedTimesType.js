...
function ResExpectedTimesTypeFromJSONTyped(json, ignoreDiscriminator) {
    ...
    return {
        'resExpectedArrivalTime': !(0, runtime_1.exists)(json, 'resExpectedArrivalTime') ? undefined : (new Date(json['resExpectedArrivalTime'])),
        'resExpectedDepartureTime': !(0, runtime_1.exists)(json, 'resExpectedDepartureTime') ? undefined : (new Date(json['resExpectedDepartureTime'])),
    };
}
