...
function ResGuestInfoTypeFromJSONTyped(json, ignoreDiscriminator) {
    ...
    return {
        ...
        'altGivenName': !(0, runtime_1.exists)(json, 'altGivenName') ? undefined : json['altGivenName'],
        ...
        'altSurname': !(0, runtime_1.exists)(json, 'altSurname') ? undefined : json['altSurname'],
        ...
        'altFullName': !(0, runtime_1.exists)(json, 'altFullName') ? undefined : json['altFullName'],
...
function ResGuestInfoTypeToJSON(value) {
    ...
    return {
        ...
        'altGivenName': value.altGivenName,
        'middleName': value.middleName,
        'surnamePrefix': value.surnamePrefix,
        'surname': value.surname,
        'altSurname': value.altSurname,
