 ...
 */
export declare function instanceOfHousekeepingRoomSchedulesCriteria(value: object): boolean;
export declare function HousekeepingRoomSchedulesCriteriaFromJSON(json: any): HousekeepingRoomSchedulesCriteria;
export declare function HousekeepingRoomSchedulesCriteriaFromJSONTyped(json: any, ignoreDiscriminator: boolean): HousekeepingRoomSchedulesCriteria;
export declare function HousekeepingRoomSchedulesCriteriaToJSON(value?: HousekeepingRoomSchedulesCriteria | null): any;
