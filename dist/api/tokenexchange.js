...
class HttpClient {
    constructor(_a = {}) {
        ...
        this.instance = axios_1.default.create(Object.assign(Object.assign({}, axiosConfig), { baseURL: new URL('/tokenExchange/v1', axiosConfig.baseURL).toString() }));
        this.secure = secure;
        this.format = format;
...
class Api extends HttpClient {
    constructor() {
        ...
        this.hotels = {
             ...
             * @secure
             */
            openPaymentTokenExchange: (hotelCode, body, params = {}) => {
                const newParams = params;
                return this.request(Object.assign({ path: `/hotels/${hotelCode}/tokens`, method: 'POST', body: body, secure: true, type: ContentType.Json, format: 'json' }, newParams));
            },
        };
    }
}
