...
exports.Api = exports.HttpClient = exports.ContentType = exports.BusinessEventModuleType = void 0;
var BusinessEventModuleType;
(function (BusinessEventModuleType) {
    BusinessEventModuleType["Activity"] = "Activity";
    BusinessEventModuleType["Availability"] = "Availability";
    BusinessEventModuleType["Block"] = "Block";
    BusinessEventModuleType["BlockOffsets"] = "BlockOffsets";
    BusinessEventModuleType["Cashiering"] = "Cashiering";
    BusinessEventModuleType["Catering"] = "Catering";
    BusinessEventModuleType["CateringNotes"] = "CateringNotes";
    BusinessEventModuleType["Configuration"] = "Configuration";
    BusinessEventModuleType["ECertificate"] = "ECertificate";
    BusinessEventModuleType["Enrollment"] = "Enrollment";
    BusinessEventModuleType["Housekeeping"] = "Housekeeping";
    BusinessEventModuleType["MrEnrollment"] = "MrEnrollment";
    BusinessEventModuleType["NightAudit"] = "NightAudit";
    BusinessEventModuleType["OwnerContract"] = "OwnerContract";
    BusinessEventModuleType["Profile"] = "Profile";
    BusinessEventModuleType["Rate"] = "Rate";
    BusinessEventModuleType["Reservation"] = "Reservation";
    BusinessEventModuleType["StayRecords"] = "StayRecords";
})(BusinessEventModuleType = exports.BusinessEventModuleType || (exports.BusinessEventModuleType = {}));
...
class HttpClient {
    constructor(_a = {}) {
        ...
        this.instance = axios_1.default.create(Object.assign(Object.assign({}, axiosConfig), { baseURL: new URL('/int/v1', axiosConfig.baseURL).toString() }));
        this.secure = secure;
        this.format = format;
...
class Api extends HttpClient {
    constructor() {
        ...
        this.externalSystem = {
             ...
             */
            getBusinessEventsByExternalSystem: (hotelId, extSystemCode, query, params = {}) => {
                ...
                return this.request(Object.assign({ path: `/externalSystem/${extSystemCode}/businessEvents`, method: 'GET', query: query, type: ContentType.Json, format: 'json' }, newParams));
            },
            /**
             ...
             */
            getBusinessEvents: (hotelId, extSystemCode, query, params = {}) => {
                const headers = Object.assign(Object.assign({}, params.headers), { 'x-hotelid': hotelId });
                const newParams = Object.assign(Object.assign({}, params), { headers });
                return this.request(Object.assign({ path: `/externalSystem/${extSystemCode}/hotels/${hotelId}/businessEvents`, method: 'GET', query: query, type: ContentType.Json, format: 'json' }, newParams));
            },
        };
    }
}
