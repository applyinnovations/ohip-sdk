...
export declare enum BusinessEventModuleType {
    Activity = "Activity",
...
export declare class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
    externalSystem: {
         ...
         */
        getBusinessEventsByExternalSystem: (hotelId: string, extSystemCode: string, query?: {
            /**
             * Number of messages web service should dequeue from the BE queue.
             * @default 1
             */
            limit?: number;
        }, params?: RequestParams) => Promise<AxiosResponse<BusinessEvents, any>>;
        /**
         ...
         */
        getBusinessEvents: (hotelId: string, extSystemCode: string, query?: {
            /**
             * Number of messages web service should dequeue from the BE queue.
             * @default 1
             */
