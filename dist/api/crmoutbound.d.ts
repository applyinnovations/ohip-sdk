...
export declare enum StagedProfileErrorField {
...
export declare enum StagedAddressCleansStatus {
...
export declare enum ExternalStatusType {
...
export declare enum ClaimSourceType {
    Ocis = "Ocis",
    Opms = "Opms",
    Web = "Web"
}
...
export declare enum ClaimRecordType {
    Stay = "Stay",
    Other = "Other",
    LimitedAdjustment = "LimitedAdjustment"
}
/** Claim approve or reject status. */
export declare enum ClaimApprovalStatusType {
    Approved = "Approved",
    Rejected = "Rejected",
    Pending = "Pending"
}
...
/** Processing type of the award like Actual , Projected or Inactive. */
export declare enum MemberAwardProcessType {
    Actual = "Actual",
    Projected = "Projected",
    Inactive = "Inactive"
}
...
/** Enumeration for stay types. */
export declare enum StayReservationType {
    Transient = "Transient",
    Block = "Block"
}
/**
...
export declare enum StatisticsReportType {
...
export declare class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
    externalSystems: {
         ...
         */
        getExternalProfiles: (extSystemCode: string, chainCode: string, query?: {
             ...
             */
            birthDate?: string;
        }, params?: RequestParams) => Promise<AxiosResponse<ExternalProfiles, any>>;
        /**
         ...
         */
        downloadExternalProfile: (extSystemCode: string, chainCode: string, profileExternalId: string, query?: {
         ...
         */
        postEnrollment: (extSystemCode: string, chainCode: string, enrollment: Enrollment, params?: RequestParams) => Promise<AxiosResponse<Enrollment, any>>;
        /**
         ...
         */
        getPlayerStatistics: (profileId: string, extSystemCode: string, query?: {
        ...
        }, params?: RequestParams) => Promise<AxiosResponse<FetchPlayerStatisticsRS, any>>;
        /**
         ...
         */
        getGamingOffers: (membershipNo: string, extSystemCode: string, query?: {
            ...
            /** @format date */
            endDate?: string;
        }, params?: RequestParams) => Promise<AxiosResponse<GamingOffers, any>>;
        /**
         ...
         */
        redeemAward: (extSystemCode: string, externalProfileId: string, award: Award, params?: RequestParams) => Promise<AxiosResponse<Award, any>>;
        /**
         ...
         */
        postMembershipNumber: (extSystemCode: string, membershipType: string, membershipNumber: MembershipNumber, params?: RequestParams) => Promise<AxiosResponse<Status, any>>;
        /**
         ...
         */
        getMembershipDetails: (extSystemCode: string, externalProfileId: string, query?: {
            /** A unique identifying value assigned by the creating system. The ID attribute may be used to reference a primary-key value within a database or in a particular implementation. */
        ...
        }, params?: RequestParams) => Promise<AxiosResponse<MemberInformation, any>>;
        /**
         ...
         */
        validateMembershipNumber: (chainCode: string, extSystemCode: string, query: {
            ...
            hotelId?: string;
        }, params?: RequestParams) => Promise<AxiosResponse<ValidateMembershipNumber, any>>;
    };
    hotels: {
        /**
         ...
         */
        checkIataNumber: (iataNumber: string, hotelId: string, params?: RequestParams) => Promise<AxiosResponse<IataNumberDetails, any>>;
    };
    validatedAddresses: {
        /**
        ...
        }, params?: RequestParams) => Promise<AxiosResponse<ValidatedAddresses, any>>;
        /**
         ...
         */
        getValidatedAddress: (externalAddressId: string, query?: {
            /** Maximum time you are prepared to wait for a response. */
            timeoutSeconds?: number;
        }, params?: RequestParams) => Promise<AxiosResponse<ValidatedAddress, any>>;
    };
}
