...
class HttpClient {
    constructor(_a = {}) {
        ...
        this.instance = axios_1.default.create(Object.assign(Object.assign({}, axiosConfig), { baseURL: new URL('/blk/async/v1', axiosConfig.baseURL).toString() }));
        this.secure = secure;
        this.format = format;
...
class Api extends HttpClient {
    constructor() {
        ...
        this.externalSystems = {
             ...
             */
            startBlockAllocationSummaryProcess: (hotelId, extSystemCode, criteria, params = {}) => {
                ...
                return this.request(Object.assign({ path: `/externalSystems/${extSystemCode}/hotels/${hotelId}/blocks/allocationSummary`, method: 'POST', body: criteria, type: ContentType.Json }, newParams));
            },
            /**
             ...
             */
            getBlockAllocationSummaryProcessStatus: (requestId, extSystemCode, hotelId, params = {}) => {
                const headers = Object.assign(Object.assign({}, params.headers), { 'x-hotelid': hotelId });
                const newParams = Object.assign(Object.assign({}, params), { headers });
                return this.request(Object.assign({ path: `/externalSystems/${extSystemCode}/hotels/${hotelId}/blocks/allocationSummary/${requestId}`, method: 'HEAD', type: ContentType.Json }, newParams));
            },
            /**
             ...
             */
            getBlockAllocationSummary: (requestId, hotelId, extSystemCode, params = {}) => {
                const headers = Object.assign(Object.assign({}, params.headers), { 'x-hotelid': hotelId });
                const newParams = Object.assign(Object.assign({}, params), { headers });
                return this.request(Object.assign({ path: `/externalSystems/${extSystemCode}/hotels/${hotelId}/blocks/allocationSummary/${requestId}`, method: 'GET', type: ContentType.Json, format: 'json' }, newParams));
            },
        };
    }
}
