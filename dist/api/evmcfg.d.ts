...
export declare enum MenuTypeType {
    Food = "Food",
    Beverage = "Beverage"
}
/** @maxItems 4000 */
...
/** Serving */
export declare enum ServingType {
    Pp = "Pp",
    Pt = "Pt"
}
...
export declare class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
    cateringEventTypes: {
         ...
         */
        getFunctionSpaceEventTypes: (hotelId: string, query?: {
            codes?: string[];
            /** Specifies the Event field value description to search. */
            description?: string;
        }, params?: RequestParams) => Promise<AxiosResponse<FunctionSpaceEventTypesDetails, any>>;
    };
    hotels: {
        /**
         ...
         */
        getCateringMenuItems: (hotelId: string, query?: {
            /** Indicates maximum number of records a Web Service should return. */
            limit?: number;
            /**
             * Index or initial index of the set(page) being requested. If the index goes out of the bounds of the total set count then no data will be returned.
        ...
        }, params?: RequestParams) => Promise<AxiosResponse<CateringMenuItemsInfo, any>>;
        /**
         ...
         */
        getCateringMenus: (hotelId: string, query?: {
            /** Indicates maximum number of records a Web Service should return. */
            limit?: number;
            /**
             * Index or initial index of the set(page) being requested. If the index goes out of the bounds of the total set count then no data will be returned.
        ...
        }, params?: RequestParams) => Promise<AxiosResponse<CateringMenusInfo, any>>;
        /**
         ...
         */
        getRoomTypePool: (hotelId: string, query?: {
        ...
        }, params?: RequestParams) => Promise<AxiosResponse<RoomTypePoolDetails, any>>;
        /**
         ...
         */
        postRoomTypePool: (hotelId: string, roomTypePoolCriteria: RoomTypePoolCriteria, params?: RequestParams) => Promise<AxiosResponse<Status, any>>;
        /**
         ...
         */
        removeRoomTypePool: (roomPoolCode: string, hotelId: string, query?: {
            /** The description of room pool type. */
            description?: string[];
            /** Default text with Character length from 0 to 1000. */
            defaultText?: string;
         ...
         */
        changeRoomTypePool: (roomPoolCode: string, hotelId: string, roomTypePoolToBeChanged: RoomTypePoolToBeChanged, params?: RequestParams) => Promise<AxiosResponse<Status, any>>;
    };
}
