...
class HttpClient {
    constructor(_a = {}) {
        ...
        this.instance = axios_1.default.create(Object.assign(Object.assign({}, axiosConfig), { baseURL: new URL('/rsv/config/v1', axiosConfig.baseURL).toString() }));
        this.secure = secure;
        this.format = format;
...
class Api extends HttpClient {
    constructor() {
        ...
        this.guaranteeCodes = {
             ...
             */
            getGuaranteeCodes: (hotelId, query, params = {}) => {
                ...
                return this.request(Object.assign({ path: `/guaranteeCodes`, method: 'GET', query: query, type: ContentType.Json, format: 'json' }, newParams));
            },
        };
    }
}
