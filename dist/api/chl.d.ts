...
export declare enum SystemErrorBookingResponseType {
...
export declare enum ChannelAccountTypeType {
    Property = "Property",
    Chain = "Chain",
    Dealer = "Dealer",
...
export declare enum ContractFeeTypeType {
    Setup = "Setup",
...
export declare enum ContractPriceType {
    FlatFee = "FlatFee",
    Property = "Property",
    Room = "Room",
...
export declare enum ContractTransactionType {
...
export declare enum ContractPriceFrequencyType {
    Monthly = "Monthly",
    Quarterly = "Quarterly",
...
/** User defined logical group name for the amenities. */
export declare enum AmenityGroupType {
...
export declare enum OrderByAscDescType {
    Asc = "Asc",
    Desc = "Desc"
}
...
export declare enum LetterTypeType {
...
export declare enum GlobalDescTypeType {
    RoomType = "RoomType",
    RatePlan = "RatePlan"
}
/** Enhanced descriptions of hotel-channel room type or rate code mapping. */
...
/** The value types of parameter, possible types are Boolean, String, Date, and Number. */
export declare enum ChannelParameterValueType {
    Boolean = "Boolean",
    String = "String",
    Date = "Date",
    Time = "Time",
...
export declare enum ChargeTypeType {
    Tax = "Tax",
...
export declare enum ChannelParameterLevelType {
    Global = "Global",
    Hotel = "Hotel"
}
...
export interface AdditionalDetailType {
    description?: string;
    detailType?: 'CancelPolicy' | 'CommissionPolicy' | 'GuaranteePolicy' | 'DepositPolicy' | 'PenaltyPolicy' | 'MarketingInformation' | 'Promotion' | 'TaxInformation' | 'Other';
    /**
     * @minLength 0
     * @maxLength 80
     */
...
export interface AdditionalAmountType {
    amountType?: 'AdditionalAdult' | 'AdditionalChild' | 'AdditionalRollawayBed' | 'AdditionalCrib' | 'AdditionalRollawayCrib';
    /** A monetary amount. */
    amount?: number;
    /**
     * Provides a currency code to reflect the currency in which an amount may be expressed.
...
export declare class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
    availability: {
         ...
         */
        getRegionalRateParity: (hotelId: string, query?: {
            /** Language identification. */
            language?: string;
            /** Indicates maximum number of records a Web Service should return. */
            limit?: number;
        ...
        }, params?: RequestParams) => Promise<AxiosResponse<RegionalRateParity, any>>;
    };
    channels: {
        /**
         ...
         */
        getChannels: (hotelId: string, query?: {
        ...
        }, params?: RequestParams) => Promise<AxiosResponse<Channels, any>>;
        /**
         ...
         */
        putChannels: (hotelId: string, channels: Channels, params?: RequestParams) => Promise<AxiosResponse<Status, any>>;
        /**
         ...
         */
        postChannels: (hotelId: string, channels: Channels, params?: RequestParams) => Promise<AxiosResponse<Status, any>>;
        /**
         ...
         */
        deleteChannelAccountContracts: (hotelId: string, query?: {
            /** A unique identifying value assigned by the creating system. The ID attribute may be used to reference a primary-key value within a database or in a particular implementation. */
            id?: string;
            /** Additional identifying value assigned by the creating system. */
            idExtension?: number;
         ...
         */
        copyChannelAccountContracts: (hotelId: string, channelAccountContractsCopy: ChannelAccountContractsCopy, params?: RequestParams) => Promise<AxiosResponse<ChannelAccountContractsDetailsCopy, any>>;
        /**
         ...
         */
        getChannelAccounts: (hotelId: string, query?: {
            ...
            /** @uniqueItems true */
            orderType?: ('Asc' | 'Desc')[];
        }, params?: RequestParams) => Promise<AxiosResponse<ChannelAccountsSummary, any>>;
        /**
         ...
         */
        postChannelAccounts: (hotelId: string, channelAccounts: ChannelAccounts, params?: RequestParams) => Promise<AxiosResponse<Status, any>>;
        /**
         ...
         */
        putChannelAccounts: (hotelId: string, channelAccountsToChange: ChannelAccountsToChange, params?: RequestParams) => Promise<AxiosResponse<Status, any>>;
        /**
         ...
         */
        getChannelAccount: (hotelId: string, accountProfileId: string, query?: {
             ...
             * @uniqueItems true
             */
            fetchInstructions?: ('PrimaryDetails' | 'Communication' | 'Contact' | 'Notes' | 'Contracts' | 'Statements' | 'Indicators')[];
        }, params?: RequestParams) => Promise<AxiosResponse<ChannelAccount, any>>;
        /**
         ...
         */
        putChannelAccountContracts: (hotelId: string, accountProfileId: string, channelAccountContracts: ChannelAccountContracts, params?: RequestParams) => Promise<AxiosResponse<Status, any>>;
        /**
         ...
         */
        postChannelAccountContracts: (hotelId: string, accountProfileId: string, channelAccountContracts: ChannelAccountContracts, params?: RequestParams) => Promise<AxiosResponse<Status, any>>;
        /**
         ...
         */
        getChannelAccountContractElements: (hotelId: string, contractId: string, accountProfileId: string, query?: {
            /** Indicates maximum number of records a Web Service should return. */
            limit?: number;
            /**
             * Index or initial index of the set(page) being requested. If the index goes out of the bounds of the total set count then no data will be returned.
            ...
            /** @uniqueItems true */
            orderType?: ('Asc' | 'Desc')[];
        }, params?: RequestParams) => Promise<AxiosResponse<ChannelAccountContractElements, any>>;
        /**
         ...
         */
        postAmenitiesMapping: (hotelId: string, amenities: Amenities, params?: RequestParams) => Promise<AxiosResponse<Status, any>>;
        /**
         ...
         */
        putAmenitiesMapping: (hotelId: string, amenities: Amenities, params?: RequestParams) => Promise<AxiosResponse<Status, any>>;
        /**
         ...
         */
        deleteAmenitiesMapping: (hotelId: string, query?: {
            /** Indicates whether code is inactive or not. */
            inactive?: boolean;
            /** External system code such as TRAVELOCITY, EXPEDIA, etc. */
            systemCode?: string;
         ...
         */
        getAmenitiesMapping: (hotelId: string, query?: {
            /** Indicates whether searching for active or inactive codes. */
            inactive?: boolean;
            /** Indicates maximum number of records a Web Service should return. */
            limit?: number;
        ...
        }, params?: RequestParams) => Promise<AxiosResponse<AmenitiesMapping, any>>;
        /**
         ...
         */
        publishChannelAvailability: (hotelId: string, channelAvailability: ChannelAvailability, params?: RequestParams) => Promise<AxiosResponse<Status, any>>;
        /**
         ...
         */
        getChannelBillingStatements: (hotelId: string, query?: {
        ...
        }, params?: RequestParams) => Promise<AxiosResponse<ChannelBillingStatementSummaries, any>>;
        /**
         ...
         */
        postChannelBillingStatements: (hotelId: string, channelBillingStatements: ChannelBillingStatements, params?: RequestParams) => Promise<AxiosResponse<Status, any>>;
        /**
         ...
         */
        putChannelBillingStatements: (hotelId: string, channelBillingStatements: ChannelBillingStatements, params?: RequestParams) => Promise<AxiosResponse<Status, any>>;
        /**
         ...
         */
        deleteChannelBillingStatements: (hotelId: string, query?: {
            /** A unique identifying value assigned by the creating system. The ID attribute may be used to reference a primary-key value within a database or in a particular implementation. */
            id?: string[];
            /** Additional identifying value assigned by the creating system. */
            idExtension?: number[];
         ...
         */
        generateChannelBillingStatements: (hotelId: string, channelBillingStatements: ChannelBillingStatements, params?: RequestParams) => Promise<AxiosResponse<Status, any>>;
        /**
         ...
         */
        getChannelBillingStatement: (hotelId: string, statementId: string, query?: {
            /**
             * Used to identify the source of the identifier (e.g., IATA, ABTA).
             * @default "OPERA"
             */
             ...
             */
            idType?: string;
        }, params?: RequestParams) => Promise<AxiosResponse<ChannelBillingStatement, any>>;
        /**
         ...
         */
        getChannelBillingStatementDetails: (hotelId: string, statementId: string, query?: {
            /** Indicates maximum number of records a Web Service should return. */
            limit?: number;
            /**
             * Index or initial index of the set(page) being requested. If the index goes out of the bounds of the total set count then no data will be returned.
            ...
            /** @uniqueItems true */
            orderType?: ('Asc' | 'Desc')[];
        }, params?: RequestParams) => Promise<AxiosResponse<ChannelBillingStatementDetails, any>>;
        /**
         ...
         */
        getStatementDetailsStatistics: (hotelId: string, statementId: string, query?: {
            /** A unique identifying value assigned by the creating system. The ID attribute may be used to reference a primary-key value within a database or in a particular implementation. */
            contractId?: string;
            /** A reference to the type of object defined by the UniqueID element. */
            contractIdType?: string;
        ...
        }, params?: RequestParams) => Promise<AxiosResponse<StatementDetailsStatistics, any>>;
        /**
         ...
         */
        getChannelCardTypeMappings: (hotelId: string, query: {
            hotelIds: string[];
            /** Indicates maximum number of records a Web Service should return. */
            limit?: number;
            /**
            ...
            fetchMapped?: boolean;
        }, params?: RequestParams) => Promise<AxiosResponse<ChannelCardTypeMappingDetails, any>>;
        /**
         ...
         */
        postCreditCardsMapping: (hotelId: string, creditCards: CreditCards, params?: RequestParams) => Promise<AxiosResponse<Status, any>>;
        /**
         ...
         */
        putCreditCardsMapping: (hotelId: string, creditCards: CreditCards, params?: RequestParams) => Promise<AxiosResponse<Status, any>>;
        /**
         ...
         */
        deleteCreditCardsMapping: (hotelId: string, query?: {
            /** Indicates whether code is inactive or not. */
            inactive?: boolean;
            /** External system code such as TRAVELOCITY, EXPEDIA, etc. */
            systemCode?: string;
         ...
         */
        getCreditCardsMapping: (hotelId: string, query?: {
            /** Indicates whether searching for active or inactive codes. */
            inactive?: boolean;
            /** Indicates maximum number of records a Web Service should return. */
            limit?: number;
            ...
            includeInactive?: boolean;
        }, params?: RequestParams) => Promise<AxiosResponse<CreditCardsMapping, any>>;
        /**
         ...
         */
        getChannelHotelLetters: (hotelId: string, query?: {
            channelCode?: string[];
            hotelIds?: string[];
            /** Language code associated with the hotel letters. */
            language?: string;
        ...
        }, params?: RequestParams) => Promise<AxiosResponse<FetchedChannelHotelLetters, any>>;
        /**
         ...
         */
        postChannelHotelLetters: (hotelId: string, channelHotelLettersToBeCreated: ChannelHotelLettersToBeCreated, params?: RequestParams) => Promise<AxiosResponse<Status, any>>;
        /**
         ...
         */
        putChannelHotelLetters: (hotelId: string, channelHotelLettersToBeChanged: ChannelHotelLettersToBeChanged, params?: RequestParams) => Promise<AxiosResponse<Status, any>>;
        /**
         ...
         */
        deleteChannelHotelLetters: (hotelId: string, query?: {
            /** Code. */
            code?: string;
            /** description. */
            description?: string;
         ...
         */
        postCurrenciesMapping: (hotelId: string, currencies: Currencies, params?: RequestParams) => Promise<AxiosResponse<Status, any>>;
        /**
         ...
         */
        putCurrenciesMapping: (hotelId: string, currencies: Currencies, params?: RequestParams) => Promise<AxiosResponse<Status, any>>;
        /**
         ...
         */
        deleteCurrenciesMapping: (hotelId: string, query?: {
            /** Indicates whether code is inactive or not. */
            inactive?: boolean;
            /** External system code such as TRAVELOCITY, EXPEDIA, etc. */
            systemCode?: string;
         ...
         */
        getCurrenciesMapping: (hotelId: string, query?: {
            /** Indicates whether searching for active or inactive codes. */
            inactive?: boolean;
            /** Indicates maximum number of records a Web Service should return. */
            limit?: number;
            ...
            /** Indicates whether to include inactive guarantees or not. */
            includeInactive?: boolean;
        }, params?: RequestParams) => Promise<AxiosResponse<CurrenciesMapping, any>>;
        /**
         ...
         */
        getDistributionTemplates: (hotelId: string, query?: {
            /**
            ...
            includeInactive?: boolean;
        }, params?: RequestParams) => Promise<AxiosResponse<DistributionTemplates, any>>;
        /**
         ...
         */
        postDistributionTemplates: (hotelId: string, distributionTemplates: DistributionTemplates, params?: RequestParams) => Promise<AxiosResponse<Status, any>>;
        /**
         ...
         */
        putDistributionTemplates: (hotelId: string, distributionTemplates: DistributionTemplates, params?: RequestParams) => Promise<AxiosResponse<Status, any>>;
        /**
         ...
         */
        deleteDistributionTemplates: (hotelId: string, query?: {
            codes?: string[];
            /** Configuration code. */
            code?: string[];
         ...
         */
        deleteChannelErrors: (hotelId: string, query?: {
         ...
         */
        postGuaranteesMapping: (hotelId: string, guarantees: Guarantees, params?: RequestParams) => Promise<AxiosResponse<Status, any>>;
        /**
         ...
         */
        putGuaranteesMapping: (hotelId: string, guarantees: Guarantees, params?: RequestParams) => Promise<AxiosResponse<Status, any>>;
        /**
         ...
         */
        deleteGuaranteesMapping: (hotelId: string, query?: {
            /** Indicates whether code is inactive or not. */
            inactive?: boolean;
            /** External system code such as TRAVELOCITY, EXPEDIA, etc. */
            systemCode?: string;
         ...
         */
        getGuaranteesMapping: (hotelId: string, query?: {
            /** Indicates whether searching for active or inactive codes. */
            inactive?: boolean;
            /** Indicates maximum number of records a Web Service should return. */
            limit?: number;
            ...
            /** Indicates whether to include inactive guarantees or not. */
            includeInactive?: boolean;
        }, params?: RequestParams) => Promise<AxiosResponse<GuaranteesMapping, any>>;
        /**
         ...
         */
        postHotelsMapping: (hotelId: string, properties: Properties, params?: RequestParams) => Promise<AxiosResponse<Status, any>>;
        /**
         ...
         */
        putHotelsMapping: (hotelId: string, properties: Properties, params?: RequestParams) => Promise<AxiosResponse<Status, any>>;
        /**
         ...
         */
        deleteHotelsMapping: (hotelId: string, query?: {
            /** Indicates whether code is inactive or not. */
            inactive?: boolean;
            /** External system code such as TRAVELOCITY, EXPEDIA, etc. */
            systemCode?: string;
         ...
         */
        getHotelsMapping: (hotelId: string, query?: {
            /** Indicates whether searching for active or inactive codes. */
            inactive?: boolean;
            /** Indicates maximum number of records a Web Service should return. */
            limit?: number;
            ...
            /** Indicates whether to include inactive guarantees or not. */
            includeInactive?: boolean;
        }, params?: RequestParams) => Promise<AxiosResponse<PropertiesMapping, any>>;
        /**
         ...
         */
        getChannelMarketingText: (hotelId: string, query?: {
            transactionType?: string;
            policyType?: string;
            policyDetail?: string;
            /** @format date */
             ...
             * @uniqueItems true
             */
            fetchInstructions?: ('Marketingtext' | 'Amenity' | 'Carrier' | 'Currency' | 'Error' | 'Guarantee' | 'Ratecategory')[];
            /** Hotel code. */
            hotelIds?: string[];
            channelCode?: string[];
        }, params?: RequestParams) => Promise<AxiosResponse<ChannelMarketingTextsInfo, any>>;
        /**
         ...
         */
        postChannelMarketingText: (hotelId: string, channelMarketingText: ChannelMarketingText, params?: RequestParams) => Promise<AxiosResponse<Status, any>>;
        /**
         ...
         */
        putChannelMarketingText: (hotelId: string, channelMarketingTextToChange: ChannelMarketingTextToChange, params?: RequestParams) => Promise<AxiosResponse<Status, any>>;
        /**
         ...
         */
        deleteChannelMarketingText: (hotelId: string, query?: {
            beginDate?: string[];
            /** The code that identifies a Booking Channel. */
            bookingChannelCode?: string[];
            endDate?: string[];
         ...
         */
        copyChannelMarketingText: (hotelId: string, channelMarketingTextCopy: ChannelMarketingTextCopy, params?: RequestParams) => Promise<AxiosResponse<Status, any>>;
        /**
         ...
         */
        postChannelNegotiatedRate: (hotelId: string, channelNegotiatedRates: ChannelNegotiatedRates, params?: RequestParams) => Promise<AxiosResponse<Status, any>>;
        /**
         ...
         */
        putChannelNegotiatedRate: (hotelId: string, channelNegotiatedRates: ChannelNegotiatedRates, params?: RequestParams) => Promise<AxiosResponse<Status, any>>;
        /**
         ...
         */
        deleteChannelNegotiatedRate: (hotelId: string, query?: {
            /** Booking Channel Code. */
            bookingChannelCode?: string;
            /** Channel Room Type. */
            channelRatePlanCode?: string;
         ...
         */
        getChannelNegotiatedRate: (hotelId: string, query?: {
            /** Indicates maximum number of records a Web Service should return. */
            limit?: number;
            hotelId?: string;
            bookingChannelCode?: string;
            ...
            uniqueId?: string[];
            uniqueIdType?: string[];
        }, params?: RequestParams) => Promise<AxiosResponse<ChannelNegotiatedRateDetails, any>>;
        /**
         ...
         */
        deleteChannelRateCategories: (hotelId: string, query: {
         ...
         */
        deleteChannelRateLevels: (hotelId: string, query: {
         ...
         */
        getChannelRateMapping: (hotelId: string, query?: {
            /** Indicates maximum number of records a Web Service should return. */
            limit?: number;
            /**
             * Index or initial index of the set(page) being requested. If the index goes out of the bounds of the total set count then no data will be returned.
        ...
        }, params?: RequestParams) => Promise<AxiosResponse<ChannelRateMappings, any>>;
        /**
         ...
         */
        postChannelRateMapping: (hotelId: string, channelRateMapping: ChannelRateMapping, params?: RequestParams) => Promise<AxiosResponse<Status, any>>;
        /**
         ...
         */
        putChannelRateMapping: (hotelId: string, channelRateMapping: ChannelRateMapping, params?: RequestParams) => Promise<AxiosResponse<Status, any>>;
        /**
         ...
         */
        deleteChannelRateMapping: (hotelId: string, query?: {
            /** Booking Channel Code. */
            bookingChannelCode?: string[];
            /** Channel Room Type. */
            channelRatePlanCode?: string[];
         ...
         */
        getChannelRatesGlobalDescriptions: (hotelId: string, query?: {
            hotelIds?: string[];
            ratePlanCodes?: string[];
            roomTypes?: string[];
            /**
        ...
        }, params?: RequestParams) => Promise<AxiosResponse<ChannelGlobalDescriptions, any>>;
        /**
         ...
         */
        postChannelRatesGlobalDescriptions: (hotelId: string, channelGlobalDescriptions: ChannelGlobalDescriptions, params?: RequestParams) => Promise<AxiosResponse<Status, any>>;
        /**
         ...
         */
        putChannelRatesGlobalDescriptions: (hotelId: string, channelGlobalDescriptions: ChannelGlobalDescriptions, params?: RequestParams) => Promise<AxiosResponse<Status, any>>;
        /**
         ...
         */
        deleteChannelRatesGlobalDescriptions: (hotelId: string, query?: {
            /** Property mapping with Rate plan code or Room type */
            hotelId?: string[];
            /** Code. */
            code?: string;
         ...
         */
        putChannelRateRoomSeq: (hotelId: string, channelRateRoomSequence: ChannelRateRoomSequence, params?: RequestParams) => Promise<AxiosResponse<Status, any>>;
        /**
         ...
         */
        publishChannelRestrictions: (hotelId: string, channelRestrictions: ChannelRestrictions, params?: RequestParams) => Promise<AxiosResponse<Status, any>>;
        /**
         ...
         */
        deleteChannelRoomTypes: (hotelId: string, query: {
         ...
         */
        postChannelRoomMapping: (hotelId: string, channelRoomMappings: ChannelRoomMappings, params?: RequestParams) => Promise<AxiosResponse<Status, any>>;
        /**
         ...
         */
        manageChannelRoomMapping: (hotelId: string, channelRoomMappings: ChannelRoomMappings, params?: RequestParams) => Promise<AxiosResponse<Status, any>>;
        /**
         ...
         */
        putRoomDescription: (hotelId: string, channelGlobalDescription: ChannelGlobalDescription, params?: RequestParams) => Promise<AxiosResponse<Status, any>>;
        /**
         ...
         */
        getChannelRoomsGlobalDescriptions: (hotelId: string, query?: {
            hotelIds?: string[];
            ratePlanCodes?: string[];
            roomTypes?: string[];
            /**
         ...
         */
        postChannelRoomsGlobalDescriptions: (hotelId: string, channelGlobalDescriptions: ChannelGlobalDescriptions, params?: RequestParams) => Promise<AxiosResponse<Status, any>>;
        /**
         ...
         */
        putChannelRoomsGlobalDescriptions: (hotelId: string, channelGlobalDescriptions: ChannelGlobalDescriptions, params?: RequestParams) => Promise<AxiosResponse<Status, any>>;
        /**
         ...
         */
        deleteChannelRoomsGlobalDescriptions: (hotelId: string, query?: {
            /** Property mapping with Rate plan code or Room type */
            hotelId?: string[];
            /** Code. */
            code?: string;
         ...
         */
        deleteChannelCarriers: (hotelId: string, query: {
         ...
         */
        getChannel: (hotelId: string, channelCode: string, query?: {
         ...
         */
        putChannelErrors: (hotelId: string, channelCode: string, channelErrors: ChannelErrors, params?: RequestParams) => Promise<AxiosResponse<Status, any>>;
        /**
         ...
         */
        postChannelErrors: (hotelId: string, channelCode: string, channelErrors: ChannelErrors, params?: RequestParams) => Promise<AxiosResponse<Status, any>>;
        /**
         ...
         */
        getChannelHotelCodeMapping: (hotelId: string, channelCode: string, query?: {
            ...
            channelHotelCode?: string;
        }, params?: RequestParams) => Promise<AxiosResponse<ChannelHotelCodeMapping, any>>;
        /**
         ...
         */
        putChannelParameters: (hotelId: string, channelCode: string, changeChannelParameters: ChangeChannelParameters, params?: RequestParams) => Promise<AxiosResponse<Status, any>>;
        /**
         ...
         */
        putChannelRateCategories: (hotelId: string, channelCode: string, channelRateCategories: ChannelRateCategories, params?: RequestParams) => Promise<AxiosResponse<Status, any>>;
        /**
         ...
         */
        postChannelRateCategories: (hotelId: string, channelCode: string, channelRateCategories: ChannelRateCategories, params?: RequestParams) => Promise<AxiosResponse<Status, any>>;
        /**
         ...
         */
        putChannelRateLevels: (hotelId: string, channelCode: string, channelRateLevels: ChannelRateLevels, params?: RequestParams) => Promise<AxiosResponse<Status, any>>;
        /**
         ...
         */
        postChannelRateLevels: (hotelId: string, channelCode: string, channelRateLevels: ChannelRateLevels, params?: RequestParams) => Promise<AxiosResponse<Status, any>>;
        /**
         ...
         */
        publishChannelRatePlans: (hotelId: string, channelCode: string, channelRatePlans: ChannelRatePlans, params?: RequestParams) => Promise<AxiosResponse<Status, any>>;
        /**
         ...
         */
        getChannelRateRoomSeq: (hotelId: string, channelCode: string, query?: {
            /** Indicates maximum number of records a Web Service should return. */
            limit?: number;
        ...
        }, params?: RequestParams) => Promise<AxiosResponse<ChannelRateRoomSequenceDetails, any>>;
        /**
         ...
         */
        putRateGlobalDescription: (hotelId: string, channelRateCode: string, channelCode: string, channelGlobalDescription: ChannelGlobalDescription, params?: RequestParams) => Promise<AxiosResponse<Status, any>>;
        /**
         ...
         */
        putChannelRoomTypes: (hotelId: string, channelCode: string, channelRoomTypes: ChannelRoomTypes, params?: RequestParams) => Promise<AxiosResponse<Status, any>>;
        /**
         ...
         */
        postChannelRoomTypes: (hotelId: string, channelCode: string, channelRoomTypes: ChannelRoomTypes, params?: RequestParams) => Promise<AxiosResponse<Status, any>>;
        /**
         ...
         */
        putChannelCarriers: (hotelId: string, channelCode: string, channelCarriers: ChannelCarriers, params?: RequestParams) => Promise<AxiosResponse<Status, any>>;
        /**
         ...
         */
        postChannelCarriers: (hotelId: string, channelCode: string, channelCarriers: ChannelCarriers, params?: RequestParams) => Promise<AxiosResponse<Status, any>>;
        /**
         ...
         */
        postChannelOrgMapping: (hotelId: string, channelCode: string, channelOrgMapping: ChannelOrgMapping, params?: RequestParams) => Promise<AxiosResponse<Status, any>>;
        /**
         ...
         */
        putChannelOrgMapping: (hotelId: string, tenantCode: string, channelCode: string, channelOrgMapping: ChannelOrgMapping, params?: RequestParams) => Promise<AxiosResponse<Status, any>>;
        /**
         ...
         */
        getChannelOrgMapping: (hotelId: string, tenantCode: string, channelCode: string, query?: {
            /** Chain code for which channel code and org code are mapped. */
            chainCode?: string;
        }, params?: RequestParams) => Promise<AxiosResponse<ChannelOrgMappingsDetails, any>>;
        /**
         ...
         */
        deleteChannelOrgMapping: (hotelId: string, tenantCode: string, channelCode: string, query?: {
            /** Chain code for which channel code and org code are mapped. */
            chainCode?: string;
        }, params?: RequestParams) => Promise<AxiosResponse<Status, any>>;
    };
    hotels: {
         ...
         */
        postTotalPricingElements: (hotelId: string, totalPricingElements: TotalPricingElements, params?: RequestParams) => Promise<AxiosResponse<Status, any>>;
        /**
         ...
         */
        putTotalPricingElements: (hotelId: string, totalPricingElements: TotalPricingElements, params?: RequestParams) => Promise<AxiosResponse<Status, any>>;
        /**
         ...
         */
        deleteTotalPricingElements: (hotelId: string, query?: {
            /** Hotel Code that associated with Transaction Code and Total Pricing Element */
            hotelId?: string[];
            /** Code. */
            code?: string;
         ...
         */
        copyTotalPricingElements: (hotelId: string, totalPricingElementsCopy: TotalPricingElementsCopy, params?: RequestParams) => Promise<AxiosResponse<Status, any>>;
        /**
         ...
         */
        getChannelSellLimits: (hotelId: string, query: {
            /**
            ...
            channelRoomType?: string;
        }, params?: RequestParams) => Promise<AxiosResponse<ChannelSellLimits, any>>;
        /**
         ...
         */
        changeChannelSellLimitsByDate: (hotelId: string, channelSellLimitsByDate: ChannelSellLimitsByDate, params?: RequestParams) => Promise<AxiosResponse<Status, any>>;
        /**
         ...
         */
        deleteChannelSellLimits: (id: string, hotelId: string, params?: RequestParams) => Promise<AxiosResponse<Status, any>>;
        /**
         ...
         */
        getChannelGuaranteeCodeMappings: (hotelId: string, query?: {
            /** Indicates maximum number of records a Web Service should return. */
            limit?: number;
            /**
             * Index or initial index of the set(page) being requested. If the index goes out of the bounds of the total set count then no data will be returned.
            ...
            fetchMapped?: boolean;
        }, params?: RequestParams) => Promise<AxiosResponse<ChannelGuaranteeCodeMappingDetails, any>>;
        /**
         ...
         */
        publishHotelChannelRatePlans: (hotelId: string, channelRatePlans: ChannelRatePlans, params?: RequestParams) => Promise<AxiosResponse<Status, any>>;
        /**
         ...
         */
        postChannelRates: (hotelId: string, channelRates: ChannelRates, params?: RequestParams) => Promise<AxiosResponse<Status, any>>;
        /**
         ...
         */
        getTotalPricingElements: (hotelId: string, query?: {
            /** Indicates maximum number of records a Web Service should return. */
            limit?: number;
            /**
             * Index or initial index of the set(page) being requested. If the index goes out of the bounds of the total set count then no data will be returned.
        ...
        }, params?: RequestParams) => Promise<AxiosResponse<TotalPricingElements, any>>;
        /**
         ...
         */
        postChannelCardTypeMapping: (cardTypeCode: string, channelCode: string, hotelId: string, channelCardTypeMappings: ChannelCardTypeMappings, params?: RequestParams) => Promise<AxiosResponse<Status, any>>;
        /**
         ...
         */
        putChannelCardTypeMapping: (cardTypeCode: string, channelCode: string, hotelId: string, channelCardTypeMappings: ChannelCardTypeMappings, params?: RequestParams) => Promise<AxiosResponse<Status, any>>;
        /**
         ...
         */
        deleteChannelCardTypeMapping: (cardTypeCode: string, channelCode: string, hotelId: string, query?: {
            /** Used for codes in the OPERA Code tables. Possible values of this pattern are 1, 101, 101.EQP, or 101.EQP.X. */
            channelCardType?: string;
        }, params?: RequestParams) => Promise<AxiosResponse<Status, any>>;
        /**
         ...
         */
        postChannelGuaranteeCodeMapping: (guaranteeCode: string, channelCode: string, hotelId: string, channelGuaranteeCodeMappings: ChannelGuaranteeCodeMappings, params?: RequestParams) => Promise<AxiosResponse<Status, any>>;
        /**
         ...
         */
        putChannelGuaranteeCodeMapping: (guaranteeCode: string, channelCode: string, hotelId: string, channelGuaranteeCodeMappings: ChannelGuaranteeCodeMappings, params?: RequestParams) => Promise<AxiosResponse<Status, any>>;
        /**
         ...
         */
        deleteChannelGuaranteeCodeMapping: (guaranteeCode: string, channelCode: string, hotelId: string, params?: RequestParams) => Promise<AxiosResponse<Status, any>>;
        /**
         ...
         */
        getChannelParameters: (channelCode: string, hotelId: string, query?: {
            /** Parameter for wild card search on channel parameters. */
            parameterNameWildCard?: string;
        }, params?: RequestParams) => Promise<AxiosResponse<ChannelParameterMapping, any>>;
        /**
         ...
         */
        getChannelPolicies: (channelCode: string, hotelId: string, query?: {
            requestType?: string;
            /** @format date */
            startDate?: string;
            /** @format date */
        ...
        }, params?: RequestParams) => Promise<AxiosResponse<ChannelPolicies, any>>;
        /**
         ...
         */
        postChannelRoomTypeRate: (channelRoomType: string, channelCode: string, hotelId: string, channelRates: ChannelRates, params?: RequestParams) => Promise<AxiosResponse<Status, any>>;
        /**
         ...
         */
        getChannelRoomMappingById: (roomTypeCode: string, channelCode: string, hotelId: string, query?: {
            /**
             * Begin Date.
             * @format date
             */
            ...
            /** Channel Room Type. */
            channelRoomType?: string;
        }, params?: RequestParams) => Promise<AxiosResponse<ChannelRoomMapping, any>>;
        /**
         ...
         */
        putChannelRoomMapping: (roomTypeCode: string, channelCode: string, hotelId: string, channelRoomMapping: ChannelRoomMapping, params?: RequestParams) => Promise<AxiosResponse<Status, any>>;
        /**
         ...
         */
        deleteChannelRoomMapping: (roomTypeCode: string, channelCode: string, hotelId: string, query?: {
            /**
             * Begin Date.
             * @format date
             */
         ...
         */
        getChannelInventorySnapshotByRoomType: (roomTypeCode: string, channelCode: string, hotelId: string, query: {
            /** @format date */
            fromDate: string;
            /** @default "false" */
            friday?: boolean;
        ...
        }, params?: RequestParams) => Promise<AxiosResponse<ChannelInventorySnapshot, any>>;
        /**
         ...
         */
        changeChannelSellLimitsByDateRange: (channelId: string, hotelId: string, channelSellLimitsByDateRange: ChannelSellLimitsByDateRange, params?: RequestParams) => Promise<AxiosResponse<Status, any>>;
        /**
         ...
         */
        getGeneralAvailabilitySimulator: (hotelId: string, query?: {
            /** Indicates maximum number of records a Web Service should return. */
            limit?: number;
            bookingChannelCode?: string;
            /** @format date */
            ...
            currencyCode?: string;
            language?: string;
        }, params?: RequestParams) => Promise<AxiosResponse<GeneralAvailabilitySimulator, any>>;
        /**
         ...
         */
        getChannelInventorySnapshot: (hotelId: string, query: {
            /** @format date */
            fromDate: string;
            /** @default "false" */
            friday?: boolean;
         ...
         */
        getRateParity: (hotelId: string, query?: {
            ...
            qualifyingProfileCategory?: string;
            qualifyingProfileId?: string;
        }, params?: RequestParams) => Promise<AxiosResponse<RateParity, any>>;
        /**
         ...
         */
        getChannelRateCodeGlobalDesc: (ratePlanCode: string, hotelId: string, params?: RequestParams) => Promise<AxiosResponse<ChannelEnhancedGlobalDescription, any>>;
        /**
         ...
         */
        getChannelRoomMapping: (hotelId: string, query?: {
            /** Indicates maximum number of records a Web Service should return. */
            limit?: number;
            /**
             * Index or initial index of the set(page) being requested. If the index goes out of the bounds of the total set count then no data will be returned.
        ...
        }, params?: RequestParams) => Promise<AxiosResponse<ChannelRoomMappingsSummary, any>>;
        /**
         ...
         */
        getChannelRoomTypeGlobalDesc: (roomType: string, hotelId: string, params?: RequestParams) => Promise<AxiosResponse<ChannelEnhancedGlobalDescription, any>>;
    };
    services: {
        /**
         ...
         */
        deleteChannelServiceCache: (hotelId: string, params?: RequestParams) => Promise<AxiosResponse<Status, any>>;
        /**
         ...
         */
        pingChannelService: (hotelId: string, params?: RequestParams) => Promise<AxiosResponse<OperaVersion, any>>;
    };
}
