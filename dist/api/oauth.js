...
class HttpClient {
    constructor(_a = {}) {
        ...
        this.instance = axios_1.default.create(Object.assign(Object.assign({}, axiosConfig), { baseURL: new URL('/oauth/v1', axiosConfig.baseURL).toString() }));
        this.secure = secure;
        this.format = format;
    ...
    constructor() {
        ...
        this.tokens = {
            ...
            getToken: (data, params = {}) => {
                ...
                return this.request(Object.assign({ path: `/tokens`, method: 'POST', body: data, secure: true, type: ContentType.FormData, format: 'json' }, newParams));
            },
        };
    }
}
