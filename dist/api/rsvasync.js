...
exports.Api = exports.HttpClient = exports.ContentType = exports.PMSResStatusType = void 0;
...
(function (PMSResStatusType) {
    ...
    PMSResStatusType["CheckedIn"] = "CheckedIn";
...
class HttpClient {
    constructor(_a = {}) {
        ...
        this.instance = axios_1.default.create(Object.assign(Object.assign({}, axiosConfig), { baseURL: new URL('/rsv/async/v1', axiosConfig.baseURL).toString() }));
        this.secure = secure;
        this.format = format;
...
class Api extends HttpClient {
    constructor() {
        ...
        this.externalSystems = {
             ...
             */
            startReservationsDailySummaryProcess: (extSystemCode, hotelId, criteria, params = {}) => {
                ...
                return this.request(Object.assign({ path: `/externalSystems/${extSystemCode}/hotels/${hotelId}/reservations/dailySummary`, method: 'POST', body: criteria, type: ContentType.Json }, newParams));
            },
            /**
             ...
             */
            getReservationsProcessStatus: (summaryId, extSystemCode, hotelId, params = {}) => {
                const headers = Object.assign(Object.assign({}, params.headers), { 'x-hotelid': hotelId });
                const newParams = Object.assign(Object.assign({}, params), { headers });
                return this.request(Object.assign({ path: `/externalSystems/${extSystemCode}/hotels/${hotelId}/reservations/dailySummary/${summaryId}`, method: 'HEAD', type: ContentType.Json }, newParams));
            },
            /**
             ...
             */
            getReservationsDailySummary: (summaryId, extSystemCode, hotelId, params = {}) => {
                const headers = Object.assign(Object.assign({}, params.headers), { 'x-hotelid': hotelId });
                const newParams = Object.assign(Object.assign({}, params), { headers });
                return this.request(Object.assign({ path: `/externalSystems/${extSystemCode}/hotels/${hotelId}/reservations/dailySummary/${summaryId}`, method: 'GET', type: ContentType.Json, format: 'json' }, newParams));
            },
        };
    }
}
