...
export declare class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
    hotels: {
         ...
         */
        getBusinessDate: (hotelId: string, params?: RequestParams) => Promise<AxiosResponse<BusinessDate, any>>;
    };
    services: {
        /**
         ...
         */
        clearBackOfficeOperationsServiceCache: (hotelId: string, params?: RequestParams) => Promise<AxiosResponse<Status, any>>;
        /**
         ...
         */
        pingBackOfficeOperationsService: (hotelId: string, params?: RequestParams) => Promise<AxiosResponse<OperaVersion, any>>;
    };
}
