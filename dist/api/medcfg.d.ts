...
export declare enum ImageCodeType {
    LogoChain = "LogoChain",
    Logo = "Logo",
    Profile = "Profile",
...
export declare class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
    customizedLetter: {
         ...
         */
        getCustomizedLetter: (hotelId: string, letterId: string, query?: {
            /** Used to identify the source of the identifier (e.g., IATA, ABTA). */
            letterIdContext?: string;
            /** A reference to the type of object defined by the UniqueID element. */
            letterIdtype?: string;
        }, params?: RequestParams) => Promise<AxiosResponse<CustomizedLetter, any>>;
    };
    emailFile: {
        /**
         ...
         */
        getEmailFile: (hotelId: string, emailId: string, params?: RequestParams) => Promise<AxiosResponse<EmailFile, any>>;
    };
    fileAttachments: {
        /**
         ...
         */
        getFileAttachment: (hotelId: string, query?: {
            /** A unique identifying value assigned by the creating system. The ID attribute may be used to reference a primary-key value within a database or in a particular implementation. */
            id?: string;
            /** Used to identify the source of the identifier (e.g., IATA, ABTA). */
            idContext?: string;
         ...
         */
        uploadFileAttachment: (hotelId: string, fileToUpload: FileToUpload, params?: RequestParams) => Promise<AxiosResponse<Status, any>>;
    };
    folioReports: {
        /**
         ...
         */
        emailFolioReport: (hotelId: string, folioReportToEmail: FolioReportToEmail, params?: RequestParams) => Promise<AxiosResponse<Status, any>>;
    };
    hotels: {
        /**
         ...
         */
        setCustomizedLetter: (reservationId: string, hotelId: string, customizedLetter: CustomizedLetter, params?: RequestParams) => Promise<AxiosResponse<CustomizedLetterStatus, any>>;
        /**
         ...
         */
        getFolioReport: (reservationId: string, hotelId: string, query?: {
            /** Used to identify the source of the identifier (e.g., IATA, ABTA). */
            ...
            /** Folio currency code. */
            referenceCurrency?: string;
        }, params?: RequestParams) => Promise<AxiosResponse<FolioReport, any>>;
        /**
         ...
         */
        getRegistrationCard: (reservationId: string, hotelId: string, query?: {
            /** Used to identify the source of the identifier (e.g., IATA, ABTA). */
            reservationIdContext?: string;
            /** A reference to the type of object defined by the UniqueID element. */
            reservationIdType?: string;
            ...
            template?: string;
        }, params?: RequestParams) => Promise<AxiosResponse<RegistrationCard, any>>;
    };
    images: {
        /**
         ...
         * @request POST:/images
         */
        uploadImage: (hotelId: string, imageToUpload: ImageToUpload, params?: RequestParams) => Promise<AxiosResponse<Status, any>>;
        /**
         ...
         */
        removeImage: (hotelId: string, query?: {
            /** @uniqueItems true */
            imageCode?: 'LogoChain' | 'Logo' | 'Profile' | 'Nationality' | 'User' | 'ToolbarItemCode' | 'Chain' | 'MembershipType' | 'MembershipLevel' | 'Resort' | 'RoomTypeChain' | 'RoomType' | 'RoomNumber' | 'OooReasonChain' | 'OooReason' | 'RoomMaintChain' | 'RoomMaintenance' | 'RoomMaintIssue' | 'FloorPlan' | 'SiteLayout' | 'Attraction' | 'PropertyMap' | 'InvItemChain' | 'InvItem' | 'PackageChain' | 'Package' | 'Pool' | 'RoomConditionChain' | 'RoomCondition' | 'FunctionSpace' | 'FunctionSetupStyle' | 'TrackItTypeChain' | 'TrackItType' | 'Height' | 'Width';
        ...
        getImage: (hotelId: string, query?: {
            ...
            imageCode?: 'LogoChain' | 'Logo' | 'Profile' | 'Nationality' | 'User' | 'ToolbarItemCode' | 'Chain' | 'MembershipType' | 'MembershipLevel' | 'Resort' | 'RoomTypeChain' | 'RoomType' | 'RoomNumber' | 'OooReasonChain' | 'OooReason' | 'RoomMaintChain' | 'RoomMaintenance' | 'RoomMaintIssue' | 'FloorPlan' | 'SiteLayout' | 'Attraction' | 'PropertyMap' | 'InvItemChain' | 'InvItem' | 'PackageChain' | 'Package' | 'Pool' | 'RoomConditionChain' | 'RoomCondition' | 'FunctionSpace' | 'FunctionSetupStyle' | 'TrackItTypeChain' | 'TrackItType' | 'Height' | 'Width';
            /** @uniqueItems true */
            imageParameterCode?: ('LogoChain' | 'Logo' | 'Profile' | 'Nationality' | 'User' | 'ToolbarItemCode' | 'Chain' | 'MembershipType' | 'MembershipLevel' | 'Resort' | 'RoomTypeChain' | 'RoomType' | 'RoomNumber' | 'OooReasonChain' | 'OooReason' | 'RoomMaintChain' | 'RoomMaintenance' | 'RoomMaintIssue' | 'FloorPlan' | 'SiteLayout' | 'Attraction' | 'PropertyMap' | 'InvItemChain' | 'InvItem' | 'PackageChain' | 'Package' | 'Pool' | 'RoomConditionChain' | 'RoomCondition' | 'FunctionSpace' | 'FunctionSetupStyle' | 'TrackItTypeChain' | 'TrackItType' | 'Height' | 'Width')[];
            /** Image parameter value. */
            imageParameterValue?: string[];
            languageCode?: string;
            /**
            ...
            base64?: boolean;
        }, params?: RequestParams) => Promise<AxiosResponse<Image, any>>;
    };
}
