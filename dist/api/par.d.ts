...
export declare enum RateChangeTypeType {
...
export declare class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
    hotels: {
         ...
         */
        getHotelAvailability: (hotelId: string, query?: {
            ...
            /** @uniqueItems true */
            reservationProfileType?: ('Guest' | 'Company' | 'Group' | 'TravelAgent' | 'Source' | 'ReservationContact' | 'BillingContact' | 'Addressee')[];
            /** A unique identifying value assigned by the creating system. The ID attribute may be used to reference a primary-key value within a database or in a particular implementation. */
            ...
            hotelPackage?: string[];
        }, params?: RequestParams) => Promise<AxiosResponse<HotelAvailability, any>>;
        /**
         ...
         */
        getReservationGuarantees: (hotelId: string, query: {
            /**
            ...
            roomType?: string;
        }, params?: RequestParams) => Promise<AxiosResponse<ReservationGuaranteesPolicies, any>>;
        /**
         ...
         */
        getRestrictionsByDateRange: (hotelId: string, query?: {
            /** The name of the hotel chain (e.g., Hilton, Marriott, Hyatt). */
            chainName?: string;
            /**
             * The ending value of the date range.
            ...
            filterCode?: string[];
        }, params?: RequestParams) => Promise<AxiosResponse<RestrictionsByDateRange, any>>;
    };
}
