...
export declare enum FrequencyTypeType {
    Everyday = "Everyday",
...
export declare enum HousekeepingCreditsDefinitionType {
    Departure = "Departure",
    Pickup = "Pickup",
    Turndown = "Turndown",
    StayOver = "StayOver",
...
export declare class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
    bedTypes: {
         ...
         */
        getBedTypes: (hotelId: string, query?: {
            ...
            description?: string;
        }, params?: RequestParams) => Promise<AxiosResponse<BedTypesDetails, any>>;
    };
    hotels: {
        /**
         ...
         */
        getHousekeepingRoomSchedules: (hotelId: string, query?: {
            roomTypeCodes?: string[];
            housekeepingRoomScheduleCodes?: string[];
        }, params?: RequestParams) => Promise<AxiosResponse<HousekeepingRoomSchedulesDetails, any>>;
        /**
         ...
         */
        postHousekeepingRoomSchedules: (hotelId: string, housekeepingRoomSchedulesCriteria: HousekeepingRoomSchedulesCriteria, params?: RequestParams) => Promise<AxiosResponse<Status, any>>;
        /**
         ...
         */
        changeHousekeepingRoomSchedules: (roomScheduleId: string, hotelId: string, housekeepingRoomSchedulesToBeChanged: HousekeepingRoomSchedulesToBeChanged, params?: RequestParams) => Promise<AxiosResponse<Status, any>>;
        /**
         ...
         */
        getHousekeepingSections: (hotelId: string, query?: {
            /** Indicates if the Section Code is active. */
            includeInactive?: boolean;
            housekeepingSectionsCodes?: string[];
            /** Description of the Section. */
            description?: string;
        }, params?: RequestParams) => Promise<AxiosResponse<HousekeepingSectionsDetails, any>>;
        /**
         ...
         */
        postHousekeepingSections: (hotelId: string, housekeepingSectionsCriteria: HousekeepingSectionsCriteria, params?: RequestParams) => Promise<AxiosResponse<Status, any>>;
        /**
         ...
         */
        removeHousekeepingSections: (code: string, hotelId: string, params?: RequestParams) => Promise<AxiosResponse<Status, any>>;
        /**
         ...
         */
        changeHousekeepingSections: (code: string, hotelId: string, housekeepingSectionsToBeChanged: HousekeepingSectionsToBeChanged, params?: RequestParams) => Promise<AxiosResponse<Status, any>>;
        /**
         ...
         */
        getHotelRoomMaintenanceReasons: (hotelId: string, query?: {
            /** Indicates maximum number of records a Web Service should return. */
            limit?: number;
            /**
             * Index or initial index of the set(page) being requested. If the index goes out of the bounds of the total set count then no data will be returned.
            ...
            includeInactive?: boolean;
        }, params?: RequestParams) => Promise<AxiosResponse<HotelRoomMaintenanceReasonsDetails, any>>;
        /**
         ...
         */
        postHotelRoomMaintenanceReasons: (hotelId: string, hotelRoomMaintenanceReasonsCriteria: HotelRoomMaintenanceReasonsCriteria, params?: RequestParams) => Promise<AxiosResponse<Status, any>>;
        /**
         ...
         */
        changeHotelRoomMaintenanceReasons: (reasonCode: string, hotelId: string, hotelRoomMaintenanceReasonsToBeChanged: HotelRoomMaintenanceReasonsToBeChanged, params?: RequestParams) => Promise<AxiosResponse<Status, any>>;
        /**
         ...
         */
        removeHotelRoomMaintenanceReasons: (reasonCode: string, hotelId: string, params?: RequestParams) => Promise<AxiosResponse<Status, any>>;
        /**
         ...
         */
        removeHousekeepingRoomSchedules: (roomScheduleId: string, roomTypeCode: string, hotelId: string, params?: RequestParams) => Promise<AxiosResponse<Status, any>>;
        /**
         ...
         */
        getRoomTypes: (hotelId: string, query?: {
        ...
        }, params?: RequestParams) => Promise<AxiosResponse<RoomTypesDetails, any>>;
        /**
         ...
         */
        postRoomTypes: (hotelId: string, roomTypesCriteria: RoomTypesCriteria, params?: RequestParams) => Promise<AxiosResponse<Status, any>>;
        /**
         ...
         */
        putRoomTypes: (roomTypeId: string, hotelId: string, roomTypesToBeChanged: RoomTypesToBeChanged, params?: RequestParams) => Promise<AxiosResponse<Status, any>>;
        /**
         ...
         */
        deleteRoomTypes: (roomTypeId: string, hotelId: string, query?: {
            /** Used for codes in the OPERA Code tables. Possible values of this pattern are 1, 101, 101.EQP, or 101.EQP.X. */
            roomType?: string;
        ...
        getRooms: (hotelId: string, query?: {
            ...
            /** Room to be searched. */
            room?: string;
        }, params?: RequestParams) => Promise<AxiosResponse<RoomsDetails, any>>;
    };
    roomPotentials: {
        /**
         ...
         */
        getRoomPotentials: (hotelId: string, query?: {
            /** Determines wether to fetch inactive records or not. */
            fetchInactive?: boolean;
            /** Codes to be searched. */
            codes?: string[];
            ...
            /** Description of the code. */
            description?: string;
        }, params?: RequestParams) => Promise<AxiosResponse<RoomPotentialsDetails, any>>;
        /**
         ...
         */
        postRoomPotentials: (hotelId: string, roomPotentialsCriteria: RoomPotentialsCriteria, params?: RequestParams) => Promise<AxiosResponse<Status, any>>;
        /**
         ...
         */
        putRoomPotentials: (hotelId: string, roomPotentialsId: string, roomPotentialsToBeChanged: RoomPotentialsToBeChanged, params?: RequestParams) => Promise<AxiosResponse<Status, any>>;
        /**
         ...
         */
        deleteRoomPotentials: (hotelId: string, roomPotentialsId: string, query?: {
    ...
    roomTypes: {
         ...
         */
        getRoomTypeTemplates: (hotelId: string, query?: {
            ...
            roomTypeCodes?: string[];
            roomClassCodes?: string[];
        }, params?: RequestParams) => Promise<AxiosResponse<RoomTypeTemplatesDetails, any>>;
        /**
         ...
         */
        postRoomTypeTemplates: (hotelId: string, roomTypeTemplatesCriteria: RoomTypeTemplatesCriteria, params?: RequestParams) => Promise<AxiosResponse<Status, any>>;
        /**
         ...
         */
        putRoomTypeTemplates: (hotelId: string, roomTypeTemplatesId: string, roomTypeTemplatesToBeChanged: RoomTypeTemplatesToBeChanged, params?: RequestParams) => Promise<AxiosResponse<Status, any>>;
        /**
         ...
         */
        deleteRoomTypeTemplates: (hotelId: string, roomTypeTemplatesId: string, query?: {
            /** Used for codes in the OPERA Code tables. Possible values of this pattern are 1, 101, 101.EQP, or 101.EQP.X. */
            roomType?: string;
        }, params?: RequestParams) => Promise<AxiosResponse<Status, any>>;
    };
    templateFloors: {
         ...
         */
        getTemplateFloors: (hotelId: string, query?: {
            floors?: string[];
        }, params?: RequestParams) => Promise<AxiosResponse<TemplateFloorsDetails, any>>;
        /**
         ...
         */
        postTemplateFloors: (hotelId: string, templateFloorsCriteria: TemplateFloorsCriteria, params?: RequestParams) => Promise<AxiosResponse<Status, any>>;
        /**
         ...
         */
        changeTemplateFloors: (hotelId: string, templateFloorsId: string, templateFloorsToBeChanged: TemplateFloorsToBeChanged, params?: RequestParams) => Promise<AxiosResponse<Status, any>>;
        /**
         ...
         */
        removeTemplateFloors: (hotelId: string, templateFloorsId: string, params?: RequestParams) => Promise<AxiosResponse<Status, any>>;
    };
}
