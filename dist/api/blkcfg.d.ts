...
export declare enum BlockStatusCodeStatusType {
    Waitlist = "Waitlist",
    Cancel = "Cancel",
    Lost = "Lost",
    Refused = "Refused",
...
export declare class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
    blockCancellationReasons: {
         ...
         */
        getBlockCancellationReasons: (hotelId: string, query?: {
            ...
            description?: string;
        }, params?: RequestParams) => Promise<AxiosResponse<BlockCancellationReasonsDetails, any>>;
        /**
         ...
         */
        postBlockCancellationReasons: (hotelId: string, blockCancellationReasonsCriteria: BlockCancellationReasonsCriteria, params?: RequestParams) => Promise<AxiosResponse<Status, any>>;
        /**
         ...
         */
        putBlockCancellationReasons: (hotelId: string, blockCancellationReasonsId: string, blockCancellationReasonsToBeChanged: BlockCancellationReasonsToBeChanged, params?: RequestParams) => Promise<AxiosResponse<Status, any>>;
        /**
         ...
         */
        deleteBlockCancellationReasons: (hotelId: string, blockCancellationReasonsId: string, query?: {
    ...
    blockLostBookingCodes: {
         ...
         */
        getBlockLostBookingCodes: (hotelId: string, query?: {
            /** Determines wether to fetch inactive records or not. */
            fetchInactive?: boolean;
            /** Codes to be searched. */
            codes?: string[];
            ...
            /** Description of the code. */
            description?: string;
        }, params?: RequestParams) => Promise<AxiosResponse<BlockLostBookingCodesDetails, any>>;
        /**
         ...
         */
        postBlockLostBookingCodes: (hotelId: string, blockLostBookingCodesCriteria: BlockLostBookingCodesCriteria, params?: RequestParams) => Promise<AxiosResponse<Status, any>>;
        /**
         ...
         */
        putBlockLostBookingCodes: (hotelId: string, blockLostBookingCodesId: string, blockLostBookingCodesToBeChanged: BlockLostBookingCodesToBeChanged, params?: RequestParams) => Promise<AxiosResponse<Status, any>>;
        /**
         ...
         */
        deleteBlockLostBookingCodes: (hotelId: string, blockLostBookingCodesId: string, query?: {
    ...
    blockRateOverrideReasons: {
         ...
         */
        getBlockRateOverrideReasons: (hotelId: string, query?: {
            /** Determines wether to fetch inactive records or not. */
            fetchInactive?: boolean;
            /** Codes to be searched. */
            codes?: string[];
            ...
            /** Description of the code. */
            description?: string;
        }, params?: RequestParams) => Promise<AxiosResponse<BlockRateOverrideReasonsDetails, any>>;
        /**
         ...
         */
        postBlockRateOverrideReasons: (hotelId: string, blockRateOverrideReasonsCriteria: BlockRateOverrideReasonsCriteria, params?: RequestParams) => Promise<AxiosResponse<Status, any>>;
        /**
         ...
         */
        putBlockRateOverrideReasons: (hotelId: string, blockRateOverrideReasonsId: string, blockRateOverrideReasonsToBeChanged: BlockRateOverrideReasonsToBeChanged, params?: RequestParams) => Promise<AxiosResponse<Status, any>>;
        /**
         ...
         */
        deleteBlockRateOverrideReasons: (hotelId: string, blockRateOverrideReasonsId: string, query?: {
    ...
    blockRefusedReasons: {
         ...
         */
        getBlockRefusedReasons: (hotelId: string, query?: {
            /** Determines wether to fetch inactive records or not. */
            fetchInactive?: boolean;
            /** Codes to be searched. */
            codes?: string[];
            ...
            /** Description of the code. */
            description?: string;
        }, params?: RequestParams) => Promise<AxiosResponse<BlockRefusedReasonsDetails, any>>;
        /**
         ...
         */
        postBlockRefusedReasonspostBlo: (hotelId: string, blockRefusedReasonsCriteria: BlockRefusedReasonsCriteria, params?: RequestParams) => Promise<AxiosResponse<Status, any>>;
        /**
         ...
         */
        putBlockRefusedReasons: (hotelId: string, blockRefusedReasonsId: string, blockRefusedReasonsToBeChanged: BlockRefusedReasonsToBeChanged, params?: RequestParams) => Promise<AxiosResponse<Status, any>>;
        /**
         ...
         */
        deleteBlockRefusedReasons: (hotelId: string, blockRefusedReasonsId: string, query?: {
    ...
    blockStatusCodes: {
         ...
         */
        getBlockStatusCodes: (hotelId: string, query?: {
            blockStatusCodes?: string[];
        }, params?: RequestParams) => Promise<AxiosResponse<StatusCodeDetails, any>>;
        /**
         ...
         */
        postBlockStatusCode: (hotelId: string, blockStatusCodeDetails: BlockStatusCodeDetails, params?: RequestParams) => Promise<AxiosResponse<Status, any>>;
        /**
         ...
         */
        getNextBlockStatusCodes: (hotelId: string, query?: {
            /** When set to true, only configured next status codes will be included (available status list will not be included). */
            configuredOnly?: boolean;
            blockStatusCodes?: string[];
        }, params?: RequestParams) => Promise<AxiosResponse<NextBlockStatusCodeDetails, any>>;
        /**
         ...
         */
        deleteBlockStatusCode: (hotelId: string, blockStatusCode: string, params?: RequestParams) => Promise<AxiosResponse<Status, any>>;
        /**
         ...
         */
        putBlockStatusCode: (hotelId: string, blockStatusCode: string, blockStatusCodeDetails: BlockStatusCodeDetails, params?: RequestParams) => Promise<AxiosResponse<Status, any>>;
        /**
         ...
         */
        putNextBlockStatusCodes: (hotelId: string, srcBlockStatusCode: string, nextBlockStatusCode: NextBlockStatusCode, params?: RequestParams) => Promise<AxiosResponse<Status, any>>;
    };
    destinationCodes: {
        /**
         ...
         */
        getDestinationCodes: (hotelId: string, query?: {
            /** Determines wether to fetch inactive records or not. */
            fetchInactive?: boolean;
            /** Codes to be searched. */
            codes?: string[];
            ...
            /** Description of the code. */
            description?: string;
        }, params?: RequestParams) => Promise<AxiosResponse<DestinationCodesDetails, any>>;
        /**
         ...
         */
        postDestinationCodes: (hotelId: string, destinationCodesCriteria: DestinationCodesCriteria, params?: RequestParams) => Promise<AxiosResponse<Status, any>>;
        /**
         ...
         */
        putDestinationCodes: (hotelId: string, destinationCodesId: string, destinationCodesToBeChanged: DestinationCodesToBeChanged, params?: RequestParams) => Promise<AxiosResponse<Status, any>>;
        /**
         ...
         */
        deleteDestinationCodes: (hotelId: string, destinationCodesId: string, query?: {
    ...
    hotels: {
         ...
         */
        getBlockSalesAllowance: (hotelId: string, query?: {
            /**
             * The ending value of the date range.
             * @format date
             */
        ...
        }, params?: RequestParams) => Promise<AxiosResponse<BlockSalesAllowance, any>>;
        /**
         ...
         */
        deleteBlockSalesAllowanceRange: (hotelId: string, query: {
            /**
             * The ending value of the date range.
             * @format date
             */
         ...
         */
        setBlockSalesAllowanceRange: (hotelId: string, blockSalesAllowanceRange: BlockSalesAllowanceRange, params?: RequestParams) => Promise<AxiosResponse<Status, any>>;
        /**
         ...
         */
        getSalesManagers: (hotelId: string, query?: {
            /** Indicates maximum number of records a Web Service should return. */
            limit?: number;
            /**
             * Index or initial index of the set(page) being requested. If the index goes out of the bounds of the total set count then no data will be returned.
            ...
            lastName?: string;
        }, params?: RequestParams) => Promise<AxiosResponse<SalesManagersInfo, any>>;
        /**
         ...
         */
        getSalesManagerGoals: (salesManagerId: string, hotelId: string, query?: {
            /** Indicates maximum number of records a Web Service should return. */
            limit?: number;
            /**
             * Index or initial index of the set(page) being requested. If the index goes out of the bounds of the total set count then no data will be returned.
        ...
        }, params?: RequestParams) => Promise<AxiosResponse<SalesManagerGoalsInfo, any>>;
        /**
         ...
         */
        postSalesManagerGoals: (salesManagerId: string, hotelId: string, createSalesManagerGoals: CreateSalesManagerGoals, params?: RequestParams) => Promise<AxiosResponse<Status, any>>;
        /**
         ...
         */
        putSalesManagerGoals: (salesGoalId: string, salesManagerId: string, hotelId: string, salesManagerGoalsInfo: SalesManagerGoalsInfo, params?: RequestParams) => Promise<AxiosResponse<Status, any>>;
        /**
         ...
         */
        postWashSchedule: (hotelId: string, washScheduleCriteria: WashScheduleCriteria, params?: RequestParams) => Promise<AxiosResponse<Status, any>>;
        /**
         ...
         */
        deleteWashSchedule: (washScheduleCode: string, hotelId: string, params?: RequestParams) => Promise<AxiosResponse<Status, any>>;
        /**
         ...
         */
        putWashSchedule: (washScheduleCode: string, hotelId: string, washScheduleCriteria: WashScheduleCriteria, params?: RequestParams) => Promise<AxiosResponse<Status, any>>;
    };
    reservationMethods: {
        /**
         ...
         */
        getReservationMethods: (hotelId: string, query?: {
            /** Determines wether to fetch inactive records or not. */
            fetchInactive?: boolean;
            /** Codes to be searched. */
            codes?: string[];
            ...
            /** Description of the code. */
            description?: string;
        }, params?: RequestParams) => Promise<AxiosResponse<ReservationMethodsDetails, any>>;
        /**
         ...
         */
        postReservationMethods: (hotelId: string, reservationMethodsCriteria: ReservationMethodsCriteria, params?: RequestParams) => Promise<AxiosResponse<Status, any>>;
        /**
         ...
         */
        putReservationMethods: (hotelId: string, reservationMethodsId: string, reservationMethodsToBeChanged: ReservationMethodsToBeChanged, params?: RequestParams) => Promise<AxiosResponse<Status, any>>;
        /**
         ...
         */
        deleteReservationMethods: (hotelId: string, reservationMethodsId: string, query?: {
    ...
    salesManagers: {
         ...
         */
        getSalesManagersMultipleHotelIds: (hotelId: string, query: {
            hotelIds: string[];
            /** Indicates maximum number of records a Web Service should return. */
            limit?: number;
            /**
         ...
         */
        removeSalesManagerGoals: (hotelId: string, salesManagerId: string, query?: {
            /** A unique identifying value assigned by the creating system. The ID attribute may be used to reference a primary-key value within a database or in a particular implementation. */
            salesGoalId?: string[];
        }, params?: RequestParams) => Promise<AxiosResponse<Status, any>>;
        /**
         ...
         */
        getSalesManagerGoalsMultipleHotelIds: (hotelId: string, salesManagerId: string, query?: {
            /** Indicates maximum number of records a Web Service should return. */
            limit?: number;
            /**
             * Index or initial index of the set(page) being requested. If the index goes out of the bounds of the total set count then no data will be returned.
         ...
         */
        removeSalesManagerGoal: (hotelId: string, salesGoalId: string, salesManagerId: string, params?: RequestParams) => Promise<AxiosResponse<Status, any>>;
    };
    services: {
        /**
         ...
         */
        deleteBlockConfigServiceCache: (hotelId: string, params?: RequestParams) => Promise<AxiosResponse<Status, any>>;
        /**
         ...
         */
        pingBlockConfigService: (hotelId: string, params?: RequestParams) => Promise<AxiosResponse<OperaVersion, any>>;
        /**
         ...
         */
        deleteChainConfigServicesCache: (hotelId: string, params?: RequestParams) => Promise<AxiosResponse<Status, any>>;
        /**
         ...
         */
        pingChainConfigServices: (hotelId: string, params?: RequestParams) => Promise<AxiosResponse<OperaVersion, any>>;
    };
    washSchedules: {
        /**
         ...
         */
        getWashSchedule: (hotelId: string, query?: {
            hotelIds?: string[];
            /** Codes to be searched. */
            washCodes?: string[];
            /** Wildcard search on the code. */
            wildCard?: string;
        }, params?: RequestParams) => Promise<AxiosResponse<WashScheduleDetails, any>>;
    };
}
