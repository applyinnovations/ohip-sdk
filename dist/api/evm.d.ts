...
/** A collection of supported list of link types for catering events. */
export declare enum CateringEventLinkTypeType {
    SubEvent = "SubEvent",
    Alternate = "Alternate"
}
/** Allows for a choice in description of the amount of time spanned by this type. EndDate specifies a specific date, while Duration provides a measure of time to add to the StartDate to yield eventEndDate date. */
...
export declare enum CateringStatusTypeType {
    Waitlist = "Waitlist",
    Regret = "Regret",
    Inquiry = "Inquiry",
    Cancel = "Cancel",
...
export declare class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
    events: {
         ...
         * @request GET:/events
         */
        getEventsMultipleHotels: (hotelId: string, query?: {
            /**
             ...
             * @example ["Indicators"]
             */
            fetchInstructions?: ('EventDetails' | 'BlocksInfo' | 'Indicators' | 'Notes' | 'SubEventsInfo' | 'AlternateEventsInfo' | 'MasterEventInfo' | 'Revenues' | 'IncludeInactiveSubEventsInfo' | 'IncludeInactiveMasterEventInfo' | 'ActualEventDetails' | 'EligibleMasterEventDetails')[];
            /**
             * Indicates maximum number of records a Web Service should return.
             * @default 200
             * @example 200
             ...
             */
            offset?: number;
        }, params?: RequestParams) => Promise<AxiosResponse<Events, any>>;
    };
    hotels: {
        /**
         ...
         */
        getEventsOneHotel: (hotelId: string, query?: {
            /**
             * The starting value of the date range.
             * @format date
             * @example "2020-12-30"
         ...
         */
        getEvent: (eventId: string, hotelId: string, query?: {
            /**
             * Instruction to fetch all eligible master events for the selected event
             * @uniqueItems true
             * @example ["Indicators","Notes"]
             */
            fetchInstructions?: ('EventDetails' | 'BlocksInfo' | 'Indicators' | 'Notes' | 'AlternateEventsInfo' | 'SubEventsInfo' | 'MasterEventInfo' | 'Revenues' | 'IncludeInactiveSubEventsInfo' | 'IncludeInactiveMasterEventInfo' | 'ActualEventDetails' | 'EligibleMasterEventDetails')[];
        }, params?: RequestParams) => Promise<AxiosResponse<Event, any>>;
    };
}
