...
exports.PutItemInventoryHoldRequestToJSON = exports.PutItemInventoryHoldRequestFromJSONTyped = exports.PutItemInventoryHoldRequestFromJSON = exports.instanceOfPutItemInventoryHoldRequest = void 0;
 ...
 */
function instanceOfPutItemInventoryHoldRequest(value) {
    let isInstance = true;
    return isInstance;
}
exports.instanceOfPutItemInventoryHoldRequest = instanceOfPutItemInventoryHoldRequest;
function PutItemInventoryHoldRequestFromJSON(json) {
    return PutItemInventoryHoldRequestFromJSONTyped(json, false);
}
exports.PutItemInventoryHoldRequestFromJSON = PutItemInventoryHoldRequestFromJSON;
function PutItemInventoryHoldRequestFromJSONTyped(json, ignoreDiscriminator) {
...
exports.PutItemInventoryHoldRequestFromJSONTyped = PutItemInventoryHoldRequestFromJSONTyped;
function PutItemInventoryHoldRequestToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
...
exports.PutItemInventoryHoldRequestToJSON = PutItemInventoryHoldRequestToJSON;
