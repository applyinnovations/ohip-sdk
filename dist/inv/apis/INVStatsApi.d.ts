...
import type { BlockInventoryStatistic, PingDetail, StatisticType, Status } from '../models';
export interface DeleteinvStatsServiceRequest {
...
export interface PinginvStatsServiceRequest {
    authorization?: string;
    xAppKey?: string;
    xHotelid?: string;
    xExternalsystem?: string;
...
export declare class INVStatsApi extends runtime.BaseAPI {
     ...
     * Clear Cache
     */
    deleteinvStatsServiceRaw(requestParameters: DeleteinvStatsServiceRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Status>>;
    /**
     * Clearing of cache in inventory statistics service <p><strong>OperationId:</strong>deleteinvStatsService</p>
     * Clear Cache
     */
    deleteinvStatsService(requestParameters: DeleteinvStatsServiceRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Status>;
    /**
     ...
     * Ping
     */
    pinginvStatsServiceRaw(requestParameters: PinginvStatsServiceRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<PingDetail>>;
    /**
     * Check inventory statistics service <p><strong>OperationId:</strong>pinginvStatsService</p>
     * Ping
     */
    pinginvStatsService(requestParameters: PinginvStatsServiceRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<PingDetail>;
}
/**
 * @export
 */
