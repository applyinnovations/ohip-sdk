 ...
 */
function instanceOfRoomTypeOrder(value) {
    let isInstance = true;
    return isInstance;
}
exports.instanceOfRoomTypeOrder = instanceOfRoomTypeOrder;
function RoomTypeOrderFromJSON(json) {
    return RoomTypeOrderFromJSONTyped(json, false);
}
exports.RoomTypeOrderFromJSON = RoomTypeOrderFromJSON;
function RoomTypeOrderFromJSONTyped(json, ignoreDiscriminator) {
...
function RoomTypeOrderToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
