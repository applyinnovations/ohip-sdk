...
exports.PostTourSeriesRequestToJSON = exports.PostTourSeriesRequestFromJSONTyped = exports.PostTourSeriesRequestFromJSON = exports.instanceOfPostTourSeriesRequest = void 0;
 ...
 */
function instanceOfPostTourSeriesRequest(value) {
    let isInstance = true;
    return isInstance;
}
exports.instanceOfPostTourSeriesRequest = instanceOfPostTourSeriesRequest;
function PostTourSeriesRequestFromJSON(json) {
    return PostTourSeriesRequestFromJSONTyped(json, false);
}
exports.PostTourSeriesRequestFromJSON = PostTourSeriesRequestFromJSON;
function PostTourSeriesRequestFromJSONTyped(json, ignoreDiscriminator) {
...
exports.PostTourSeriesRequestFromJSONTyped = PostTourSeriesRequestFromJSONTyped;
function PostTourSeriesRequestToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
...
exports.PostTourSeriesRequestToJSON = PostTourSeriesRequestToJSON;
