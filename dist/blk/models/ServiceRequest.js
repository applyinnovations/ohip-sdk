...
function ServiceRequestFromJSONTyped(json, ignoreDiscriminator) {
    ...
    return {
        ...
        'completionDate': !(0, runtime_1.exists)(json, 'completionDate') ? undefined : (new Date(json['completionDate'])),
        'closedDate': !(0, runtime_1.exists)(json, 'closedDate') ? undefined : (new Date(json['closedDate'])),
...
function ServiceRequestToJSON(value) {
    ...
    return {
        ...
        'room': value.room,
        'openDate': value.openDate === undefined ? undefined : (value.openDate.toISOString()),
        ...
        'closedDate': value.closedDate === undefined ? undefined : (value.closedDate.toISOString()),
