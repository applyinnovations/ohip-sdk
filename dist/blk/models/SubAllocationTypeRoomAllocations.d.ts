 ...
 */
export declare function instanceOfSubAllocationTypeRoomAllocations(value: object): boolean;
export declare function SubAllocationTypeRoomAllocationsFromJSON(json: any): SubAllocationTypeRoomAllocations;
export declare function SubAllocationTypeRoomAllocationsFromJSONTyped(json: any, ignoreDiscriminator: boolean): SubAllocationTypeRoomAllocations;
export declare function SubAllocationTypeRoomAllocationsToJSON(value?: SubAllocationTypeRoomAllocations | null): any;
