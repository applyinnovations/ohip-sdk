 ...
 */
export declare function instanceOfInventoryToBorrow(value: object): boolean;
export declare function InventoryToBorrowFromJSON(json: any): InventoryToBorrow;
export declare function InventoryToBorrowFromJSONTyped(json: any, ignoreDiscriminator: boolean): InventoryToBorrow;
export declare function InventoryToBorrowToJSON(value?: InventoryToBorrow | null): any;
