 ...
 */
function instanceOfRoomingListReservationType(value) {
    let isInstance = true;
    return isInstance;
}
exports.instanceOfRoomingListReservationType = instanceOfRoomingListReservationType;
function RoomingListReservationTypeFromJSON(json) {
    return RoomingListReservationTypeFromJSONTyped(json, false);
}
exports.RoomingListReservationTypeFromJSON = RoomingListReservationTypeFromJSON;
function RoomingListReservationTypeFromJSONTyped(json, ignoreDiscriminator) {
...
exports.RoomingListReservationTypeFromJSONTyped = RoomingListReservationTypeFromJSONTyped;
function RoomingListReservationTypeToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
...
exports.RoomingListReservationTypeToJSON = RoomingListReservationTypeToJSON;
