 ...
 */
export declare function instanceOfBlockStatusChanges(value: object): boolean;
export declare function BlockStatusChangesFromJSON(json: any): BlockStatusChanges;
export declare function BlockStatusChangesFromJSONTyped(json: any, ignoreDiscriminator: boolean): BlockStatusChanges;
export declare function BlockStatusChangesToJSON(value?: BlockStatusChanges | null): any;
