...
export declare class BlockApi extends runtime.BaseAPI {
     ...
     */
    deleteBlockServiceCacheRaw(requestParameters: DeleteBlockServiceCacheRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Status>>;
    /**
     * This API deletes the block service cache. <p><strong>OperationId:</strong>deleteBlockServiceCache</p>
     * Delete Block service cache
     */
    deleteBlockServiceCache(requestParameters: DeleteBlockServiceCacheRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Status>;
    /**
     ...
     */
    pingBlockServiceRaw(requestParameters: PingBlockServiceRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<OperaVersion>>;
    /**
     * Use this API to ping and retrieve block service status. <p><strong>OperationId:</strong>pingBlockService</p>
     * This API retrieves the Block service version
     */
    pingBlockService(requestParameters: PingBlockServiceRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<OperaVersion>;
    /**
