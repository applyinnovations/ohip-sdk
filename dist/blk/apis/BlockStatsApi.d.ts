...
import type { BlockStats, OperaVersion, Status } from '../models';
...
export declare class BlockStatsApi extends runtime.BaseAPI {
     ...
     */
    deleteBlockStatsServiceCacheRaw(requestParameters: DeleteBlockStatsServiceCacheRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Status>>;
    /**
     * Use this API to delete Block Stat Service cache. <p><strong>OperationId:</strong>deleteBlockStatsServiceCache</p>
     * Delete Block Stat Service cache
     */
    deleteBlockStatsServiceCache(requestParameters: DeleteBlockStatsServiceCacheRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Status>;
    /**
     ...
     */
    pingBlockStatsServiceRaw(requestParameters: PingBlockStatsServiceRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<OperaVersion>>;
    /**
     * Use this API to retrieve block stats service status. <p><strong>OperationId:</strong>pingBlockStatsService</p>
     * Retrieve/Ping  Block stats service
     */
    pingBlockStatsService(requestParameters: PingBlockStatsServiceRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<OperaVersion>;
}
/**
 * @export
 */
