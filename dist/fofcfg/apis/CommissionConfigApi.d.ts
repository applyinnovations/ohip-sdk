...
import type { BankAccountsInfo, CommissionCodeDetail, CommissionCodesSummary, OperaVersion, PutCommissionCodesRequest, PutConfigBankAccountsRequest, PutStopProcessingReasonsRequest, Status, StopProcessingReasons } from '../models';
export interface DeleteCommisionConfigServicesCacheRequest {
...
export interface PingCommisionConfigServicesRequest {
    authorization?: string;
    xAppKey?: string;
    xHotelid?: string;
...
export declare class CommissionConfigApi extends runtime.BaseAPI {
     ...
     */
    deleteCommisionConfigServicesCacheRaw(requestParameters: DeleteCommisionConfigServicesCacheRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Status>>;
    /**
     *  <p><strong>OperationId:</strong>deleteCommisionConfigServicesCache</p>
     * Operation to clear cache.
     */
    deleteCommisionConfigServicesCache(requestParameters: DeleteCommisionConfigServicesCacheRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Status>;
    /**
     ...
     * Operation to ping.
     */
    pingCommisionConfigServicesRaw(requestParameters: PingCommisionConfigServicesRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<OperaVersion>>;
    /**
     *  <p><strong>OperationId:</strong>pingCommisionConfigServices</p>
     * Operation to ping.
     */
    pingCommisionConfigServices(requestParameters: PingCommisionConfigServicesRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<OperaVersion>;
    /**
     ...
     */
    putCommissionCodesRaw(requestParameters: PutCommissionCodesOperationRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Status>>;
    /**
     *  <p><strong>OperationId:</strong>putCommissionCodes</p>
     * Operation to change commission codes.
     */
    putCommissionCodes(requestParameters: PutCommissionCodesOperationRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Status>;
    /**
     *  <p><strong>OperationId:</strong>putConfigBankAccounts</p>
     * Operation to change config bank accounts.
     */
    putConfigBankAccountsRaw(requestParameters: PutConfigBankAccountsOperationRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Status>>;
    /**
     *  <p><strong>OperationId:</strong>putConfigBankAccounts</p>
     * Operation to change config bank accounts.
     */
    putConfigBankAccounts(requestParameters: PutConfigBankAccountsOperationRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Status>;
    /**
     *  <p><strong>OperationId:</strong>putStopProcessingReasons</p>
     * Operation to change stop processing reasons.
     */
    putStopProcessingReasonsRaw(requestParameters: PutStopProcessingReasonsOperationRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<StopProcessingReasons>>;
    /**
     *  <p><strong>OperationId:</strong>putStopProcessingReasons</p>
     * Operation to change stop processing reasons.
     */
    putStopProcessingReasons(requestParameters: PutStopProcessingReasonsOperationRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<StopProcessingReasons>;
}
