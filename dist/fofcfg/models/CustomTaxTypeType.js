...
exports.CustomTaxTypeTypeToJSON = exports.CustomTaxTypeTypeFromJSONTyped = exports.CustomTaxTypeTypeFromJSON = exports.instanceOfCustomTaxTypeType = void 0;
 ...
 */
function instanceOfCustomTaxTypeType(value) {
    let isInstance = true;
    return isInstance;
}
exports.instanceOfCustomTaxTypeType = instanceOfCustomTaxTypeType;
function CustomTaxTypeTypeFromJSON(json) {
    return CustomTaxTypeTypeFromJSONTyped(json, false);
}
exports.CustomTaxTypeTypeFromJSON = CustomTaxTypeTypeFromJSON;
function CustomTaxTypeTypeFromJSONTyped(json, ignoreDiscriminator) {
...
exports.CustomTaxTypeTypeFromJSONTyped = CustomTaxTypeTypeFromJSONTyped;
function CustomTaxTypeTypeToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
...
exports.CustomTaxTypeTypeToJSON = CustomTaxTypeTypeToJSON;
