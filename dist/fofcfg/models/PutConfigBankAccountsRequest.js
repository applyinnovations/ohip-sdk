...
exports.PutConfigBankAccountsRequestToJSON = exports.PutConfigBankAccountsRequestFromJSONTyped = exports.PutConfigBankAccountsRequestFromJSON = exports.instanceOfPutConfigBankAccountsRequest = void 0;
 ...
 */
function instanceOfPutConfigBankAccountsRequest(value) {
    let isInstance = true;
    return isInstance;
}
exports.instanceOfPutConfigBankAccountsRequest = instanceOfPutConfigBankAccountsRequest;
function PutConfigBankAccountsRequestFromJSON(json) {
    return PutConfigBankAccountsRequestFromJSONTyped(json, false);
}
exports.PutConfigBankAccountsRequestFromJSON = PutConfigBankAccountsRequestFromJSON;
function PutConfigBankAccountsRequestFromJSONTyped(json, ignoreDiscriminator) {
...
exports.PutConfigBankAccountsRequestFromJSONTyped = PutConfigBankAccountsRequestFromJSONTyped;
function PutConfigBankAccountsRequestToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
...
exports.PutConfigBankAccountsRequestToJSON = PutConfigBankAccountsRequestToJSON;
