 ...
 */
export declare function instanceOfPostCompTypesRequest(value: object): boolean;
export declare function PostCompTypesRequestFromJSON(json: any): PostCompTypesRequest;
export declare function PostCompTypesRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): PostCompTypesRequest;
export declare function PostCompTypesRequestToJSON(value?: PostCompTypesRequest | null): any;
