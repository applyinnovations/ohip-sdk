 ...
 */
function instanceOfCountryMainGroupsDetails(value) {
    let isInstance = true;
    return isInstance;
}
exports.instanceOfCountryMainGroupsDetails = instanceOfCountryMainGroupsDetails;
function CountryMainGroupsDetailsFromJSON(json) {
    return CountryMainGroupsDetailsFromJSONTyped(json, false);
}
exports.CountryMainGroupsDetailsFromJSON = CountryMainGroupsDetailsFromJSON;
function CountryMainGroupsDetailsFromJSONTyped(json, ignoreDiscriminator) {
...
function CountryMainGroupsDetailsToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
