 ...
 */
function instanceOfHotelContactsToBeChanged(value) {
    let isInstance = true;
    return isInstance;
}
exports.instanceOfHotelContactsToBeChanged = instanceOfHotelContactsToBeChanged;
function HotelContactsToBeChangedFromJSON(json) {
    return HotelContactsToBeChangedFromJSONTyped(json, false);
}
exports.HotelContactsToBeChangedFromJSON = HotelContactsToBeChangedFromJSON;
function HotelContactsToBeChangedFromJSONTyped(json, ignoreDiscriminator) {
...
function HotelContactsToBeChangedToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
