 ...
 */
export declare function instanceOfConversionCodeMappingType(value: object): boolean;
export declare function ConversionCodeMappingTypeFromJSON(json: any): ConversionCodeMappingType;
export declare function ConversionCodeMappingTypeFromJSONTyped(json: any, ignoreDiscriminator: boolean): ConversionCodeMappingType;
export declare function ConversionCodeMappingTypeToJSON(value?: ConversionCodeMappingType | null): any;
