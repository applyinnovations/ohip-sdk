 ...
 */
export declare function instanceOfCommunicationMethodEditType(value: object): boolean;
export declare function CommunicationMethodEditTypeFromJSON(json: any): CommunicationMethodEditType;
export declare function CommunicationMethodEditTypeFromJSONTyped(json: any, ignoreDiscriminator: boolean): CommunicationMethodEditType;
export declare function CommunicationMethodEditTypeToJSON(value?: CommunicationMethodEditType | null): any;
