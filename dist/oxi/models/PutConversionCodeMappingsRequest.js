...
exports.PutConversionCodeMappingsRequestToJSON = exports.PutConversionCodeMappingsRequestFromJSONTyped = exports.PutConversionCodeMappingsRequestFromJSON = exports.instanceOfPutConversionCodeMappingsRequest = void 0;
 ...
 */
function instanceOfPutConversionCodeMappingsRequest(value) {
    let isInstance = true;
    return isInstance;
}
exports.instanceOfPutConversionCodeMappingsRequest = instanceOfPutConversionCodeMappingsRequest;
function PutConversionCodeMappingsRequestFromJSON(json) {
    return PutConversionCodeMappingsRequestFromJSONTyped(json, false);
}
exports.PutConversionCodeMappingsRequestFromJSON = PutConversionCodeMappingsRequestFromJSON;
function PutConversionCodeMappingsRequestFromJSONTyped(json, ignoreDiscriminator) {
...
exports.PutConversionCodeMappingsRequestFromJSONTyped = PutConversionCodeMappingsRequestFromJSONTyped;
function PutConversionCodeMappingsRequestToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
...
exports.PutConversionCodeMappingsRequestToJSON = PutConversionCodeMappingsRequestToJSON;
