...
// APIClient manages communication with the OPERA Cloud DataValueMapping Service API API v23.2
...
type APIClient struct {
	...
	DataValueMappingApi *DataValueMappingApiService
...
func NewAPIClient(cfg *Configuration) *APIClient {
	...
	// API Services
	c.DataValueMappingApi = (*DataValueMappingApiService)(&c.common)
