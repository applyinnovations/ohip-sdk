...
// checks if the DeleteAssignRoomRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DeleteAssignRoomRequest{}

// DeleteAssignRoomRequest struct for DeleteAssignRoomRequest
type DeleteAssignRoomRequest struct {
...
func (o DeleteAssignRoomRequest) MarshalJSON() ([]byte, error) {
...
func (o DeleteAssignRoomRequest) ToMap() (map[string]interface{}, error) {
...
type NullableDeleteAssignRoomRequest struct {
	value *DeleteAssignRoomRequest
	isSet bool
}

func (v NullableDeleteAssignRoomRequest) Get() *DeleteAssignRoomRequest {
	return v.value
}

func (v *NullableDeleteAssignRoomRequest) Set(val *DeleteAssignRoomRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableDeleteAssignRoomRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableDeleteAssignRoomRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDeleteAssignRoomRequest(val *DeleteAssignRoomRequest) *NullableDeleteAssignRoomRequest {
	return &NullableDeleteAssignRoomRequest{value: val, isSet: true}
}

func (v NullableDeleteAssignRoomRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDeleteAssignRoomRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
