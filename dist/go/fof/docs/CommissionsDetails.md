...
------------ | ------------- | ------------- | -------------
**CommissionInfoList** | Pointer to [**[]CommissionInfoType**](CommissionInfoType.md) | List of commission info. | [optional] 
...
`func (o *CommissionsDetails) GetCommissionInfoList() []CommissionInfoType`

GetCommissionInfoList returns the CommissionInfoList field if non-nil, zero value otherwise.

### GetCommissionInfoListOk

`func (o *CommissionsDetails) GetCommissionInfoListOk() (*[]CommissionInfoType, bool)`
...
`func (o *CommissionsDetails) SetCommissionInfoList(v []CommissionInfoType)`
...
`func (o *CommissionsDetails) GetLinks() []InstanceLink`

GetLinks returns the Links field if non-nil, zero value otherwise.

### GetLinksOk

`func (o *CommissionsDetails) GetLinksOk() (*[]InstanceLink, bool)`
...
`func (o *CommissionsDetails) SetLinks(v []InstanceLink)`
...
`func (o *CommissionsDetails) GetWarnings() []WarningType`

GetWarnings returns the Warnings field if non-nil, zero value otherwise.

### GetWarningsOk

`func (o *CommissionsDetails) GetWarningsOk() (*[]WarningType, bool)`
...
`func (o *CommissionsDetails) SetWarnings(v []WarningType)`
