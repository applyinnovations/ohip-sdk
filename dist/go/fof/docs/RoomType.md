...
**ScheduledRoomMoveOutTime** | Pointer to **string** | It indicates the time of the reservation which is scheduled for move  out. | [optional] 
...
`func (o *RoomType) GetScheduledRoomMoveOutTimeOk() (*string, bool)`
