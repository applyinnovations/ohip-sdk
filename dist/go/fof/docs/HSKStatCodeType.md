...
* `ARRIVALS_ACTUAL_PERSONS` (value: `"ArrivalsActualPersons"`)
...
* `HOUSE_USE_DEPARTURE_VIP` (value: `"HouseUseDepartureVIP"`)
...
* `OUT_OF_SERVICE_ASSIGNED` (value: `"OutOfServiceAssigned"`)
...
* `OPEN_FOLIO_TOTAL` (value: `"OpenFolioTotal"`)
