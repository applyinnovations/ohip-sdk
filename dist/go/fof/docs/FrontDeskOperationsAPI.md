...
[**GetAiraLastRunStatus**](FrontDeskOperationsAPI.md#GetAiraLastRunStatus) | **Get** /hotels/{hotelId}/reservations/ai/rooms | Automated Intelligence Room Assignment last run status
...
[**GetKeyOptions**](FrontDeskOperationsAPI.md#GetKeyOptions) | **Get** /hotels/{hotelId}/reservations/{reservationId}/keyOptions | Fetch the keysOptions
...
[**GetReservationsKeyOptions**](FrontDeskOperationsAPI.md#GetReservationsKeyOptions) | **Get** /hotels/{hotelId}/reservationsKeyOptions | Fetch keysOptions for the reservation and the guest profile
...
[**GetWakeUpCalls**](FrontDeskOperationsAPI.md#GetWakeUpCalls) | **Get** /hotels/{hotelId}/wakeUpCalls | Get Wake Up Calls
...
[**PostExternalRoomKeys**](FrontDeskOperationsAPI.md#PostExternalRoomKeys) | **Post** /hotels/{hotelId}/externalRoomKeys | Requests room key(s)
...
[**PostRoomKeysExternal**](FrontDeskOperationsAPI.md#PostRoomKeysExternal) | **Post** /hotels/{hotelId}/roomKeysExternal | Requests room key(s)
...
func main() {
    ...
    includeDueOut := true // bool | This flag when set to true when include rooms assigned to due out reservations. (optional)
 ...
 **includeDueOut** | **bool** | This flag when set to true when include rooms assigned to due out reservations. | 
...
> Status DeleteCheckin(ctx, reservationId, hotelId).Authorization(authorization).XAppKey(xAppKey).XHotelid(xHotelid).RoomStatus(roomStatus).UnassignRoom(unassignRoom).SharersList(sharersList).XExternalsystem(xExternalsystem).AcceptLanguage(acceptLanguage).Execute()
...
func main() {
    ...
    sharersList := []string{"Inner_example"} // []string | List of sharers IDs linked to the reservation selected to be reverse check in. (optional)
    xExternalsystem := "xExternalsystem_example" // string | External system code. (optional)
    acceptLanguage := "acceptLanguage_example" // string | Language code (optional)

    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.FrontDeskOperationsAPI.DeleteCheckin(context.Background(), reservationId, hotelId).Authorization(authorization).XAppKey(xAppKey).XHotelid(xHotelid).RoomStatus(roomStatus).UnassignRoom(unassignRoom).SharersList(sharersList).XExternalsystem(xExternalsystem).AcceptLanguage(acceptLanguage).Execute()
    if err != nil {
 ...
 **sharersList** | **[]string** | List of sharers IDs linked to the reservation selected to be reverse check in. | 
 **xExternalsystem** | **string** | External system code. | 
 **acceptLanguage** | **string** | Language code | 
...
> AiraLastRunStatusInfo GetAiraLastRunStatus(ctx, hotelId).Authorization(authorization).XAppKey(xAppKey).XHotelid(xHotelid).XExternalsystem(xExternalsystem).AcceptLanguage(acceptLanguage).Execute()
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.FrontDeskOperationsAPI.GetAiraLastRunStatus(context.Background(), hotelId).Authorization(authorization).XAppKey(xAppKey).XHotelid(xHotelid).XExternalsystem(xExternalsystem).AcceptLanguage(acceptLanguage).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `FrontDeskOperationsAPI.GetAiraLastRunStatus``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `GetAiraLastRunStatus`: AiraLastRunStatusInfo
    fmt.Fprintf(os.Stdout, "Response from `FrontDeskOperationsAPI.GetAiraLastRunStatus`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiGetAiraLastRunStatusRequest struct via the builder pattern
...
func main() {
    ...
    perfectFitRoomsOnly := true // bool | When this flag is set to true, this API will fetch only those rooms that have exactly Y nights free with the reservation guest(s) points. (optional)
    ...
    includeScheduledMoveOutRoom := true // bool | This flag when set to true will include rooms assigned to move out reservations. This query parameter is supported when OPERA Control Advanced Daily Details is active. (optional)
    scheduledRoomMoveOutTime := time.Now() // string | When IncludeMoveOut is enabled, it is the move out time before which to search. It will return rooms assigned to moving reservations that have a scheduled move out time before the entered time. This query parameter is supported when OPERA Control Advanced Daily Details is active (optional)
    xExternalsystem := "xExternalsystem_example" // string | External system code. (optional)
    acceptLanguage := "acceptLanguage_example" // string | Language code (optional)
 ...
 **perfectFitRoomsOnly** | **bool** | When this flag is set to true, this API will fetch only those rooms that have exactly Y nights free with the reservation guest(s) points. | 
 ...
 **includeScheduledMoveOutRoom** | **bool** | This flag when set to true will include rooms assigned to move out reservations. This query parameter is supported when OPERA Control Advanced Daily Details is active. | 
 **scheduledRoomMoveOutTime** | **string** | When IncludeMoveOut is enabled, it is the move out time before which to search. It will return rooms assigned to moving reservations that have a scheduled move out time before the entered time. This query parameter is supported when OPERA Control Advanced Daily Details is active | 
 **xExternalsystem** | **string** | External system code. | 
 **acceptLanguage** | **string** | Language code | 
...
> KeyOptionsInfo GetKeyOptions(ctx, reservationId, hotelId).Authorization(authorization).XAppKey(xAppKey).XHotelid(xHotelid).XExternalsystem(xExternalsystem).AcceptLanguage(acceptLanguage).Execute()

Fetch the keysOptions
...
func main() {
    reservationId := "reservationId_example" // string | Unique identifier of the reservation
    hotelId := "hotelId_example" // string | Name of the resort.
    authorization := "authorization_example" // string | Bearer token that needs to be passed which is generated post user authentication
    xAppKey := "xAppKey_example" // string | Client or Partner's Application Key
    xHotelid := "xHotelid_example" // string | Mandatory parameter to identify the hotel code where the end user is logged in
    xExternalsystem := "xExternalsystem_example" // string | External system code. (optional)
    ...
    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.FrontDeskOperationsAPI.GetKeyOptions(context.Background(), reservationId, hotelId).Authorization(authorization).XAppKey(xAppKey).XHotelid(xHotelid).XExternalsystem(xExternalsystem).AcceptLanguage(acceptLanguage).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `FrontDeskOperationsAPI.GetKeyOptions``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `GetKeyOptions`: KeyOptionsInfo
    fmt.Fprintf(os.Stdout, "Response from `FrontDeskOperationsAPI.GetKeyOptions`: %v\n", resp)
}
```
...
**hotelId** | **string** | Name of the resort. | 

### Other Parameters

Other parameters are passed through a pointer to a apiGetKeyOptionsRequest struct via the builder pattern
...
[**KeyOptionsInfo**](KeyOptionsInfo.md)
...
func main() {
    ...
    keyword := "keyword_example" // string | Wildcard search value to lookup reservation summaries with RoomId or First Name or Last Name. If both keyword and roomId/firstName/lastName is specified, keyword will take precedence. (optional)
    fetchInstructions := []string{"FetchInstructions_example"} // []string | Simple type for reservation instructions that can be used in requests to fetch necessary reservation summary details. (optional)
    limit := int32(56) // int32 | Indicates maximum number of records a Web Service should return. (optional)
    offset := int32(56) // int32 | Index or initial index of the set(page) being requested. If the index goes out of the bounds of the total set count then no data will be returned. (optional) (default to 0)
    xExternalsystem := "xExternalsystem_example" // string | External system code. (optional)
    acceptLanguage := "acceptLanguage_example" // string | Language code (optional)
 ...
 **keyword** | **string** | Wildcard search value to lookup reservation summaries with RoomId or First Name or Last Name. If both keyword and roomId/firstName/lastName is specified, keyword will take precedence. | 
 **fetchInstructions** | **[]string** | Simple type for reservation instructions that can be used in requests to fetch necessary reservation summary details. | 
 **limit** | **int32** | Indicates maximum number of records a Web Service should return. | 
 **offset** | **int32** | Index or initial index of the set(page) being requested. If the index goes out of the bounds of the total set count then no data will be returned. | [default to 0]
 **xExternalsystem** | **string** | External system code. | 
 **acceptLanguage** | **string** | Language code | 
...
> KeyOptionsInfoListType GetReservationsKeyOptions(ctx, hotelId).ReservationIdList(reservationIdList).Authorization(authorization).XAppKey(xAppKey).XHotelid(xHotelid).Limit(limit).Offset(offset).XExternalsystem(xExternalsystem).AcceptLanguage(acceptLanguage).Execute()

Fetch keysOptions for the reservation and the guest profile
...
func main() {
    reservationIdList := []string{"Inner_example"} // []string | A list of reservation ids to fetch key options for.
    hotelId := "hotelId_example" // string | Name of the resort.
    authorization := "authorization_example" // string | Bearer token that needs to be passed which is generated post user authentication
    xAppKey := "xAppKey_example" // string | Client or Partner's Application Key
    xHotelid := "xHotelid_example" // string | Mandatory parameter to identify the hotel code where the end user is logged in
    ...
    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.FrontDeskOperationsAPI.GetReservationsKeyOptions(context.Background(), hotelId).ReservationIdList(reservationIdList).Authorization(authorization).XAppKey(xAppKey).XHotelid(xHotelid).Limit(limit).Offset(offset).XExternalsystem(xExternalsystem).AcceptLanguage(acceptLanguage).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `FrontDeskOperationsAPI.GetReservationsKeyOptions``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `GetReservationsKeyOptions`: KeyOptionsInfoListType
    fmt.Fprintf(os.Stdout, "Response from `FrontDeskOperationsAPI.GetReservationsKeyOptions`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiGetReservationsKeyOptionsRequest struct via the builder pattern


Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **reservationIdList** | **[]string** | A list of reservation ids to fetch key options for. | 
...
[**KeyOptionsInfoListType**](KeyOptionsInfoListType.md)
...
> RoomKeyInterfaceDetails GetRoomKeyInterfaceDetails(ctx, hotelId).Authorization(authorization).XAppKey(xAppKey).XHotelid(xHotelid).RoomNumbersCode(roomNumbersCode).InterfaceId(interfaceId).XExternalsystem(xExternalsystem).AcceptLanguage(acceptLanguage).Execute()
...
func main() {
    ...
    interfaceId := "interfaceId_example" // string | Unique DB internal number of a Hotel Interface record. (optional)
    xExternalsystem := "xExternalsystem_example" // string | External system code. (optional)
    acceptLanguage := "acceptLanguage_example" // string | Language code (optional)

    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.FrontDeskOperationsAPI.GetRoomKeyInterfaceDetails(context.Background(), hotelId).Authorization(authorization).XAppKey(xAppKey).XHotelid(xHotelid).RoomNumbersCode(roomNumbersCode).InterfaceId(interfaceId).XExternalsystem(xExternalsystem).AcceptLanguage(acceptLanguage).Execute()
    if err != nil {
 ...
 **interfaceId** | **string** | Unique DB internal number of a Hotel Interface record. | 
 **xExternalsystem** | **string** | External system code. | 
 **acceptLanguage** | **string** | Language code | 
...
> RoomKeyInfo GetRoomKeys(ctx, reservationId, hotelId).Authorization(authorization).XAppKey(xAppKey).XHotelid(xHotelid).IncludeInactiveRoomKeys(includeInactiveRoomKeys).XExternalsystem(xExternalsystem).AcceptLanguage(acceptLanguage).Execute()
...
func main() {
    ...
    xAppKey := "xAppKey_example" // string | Client or Partner's Application Key
    xHotelid := "xHotelid_example" // string | Mandatory parameter to identify the hotel code where the end user is logged in
    includeInactiveRoomKeys := true // bool | Setting this to true will include inactive rooms keys details. This is supported when OPERA Control Multiple Guest Room Key is active. (optional)
    xExternalsystem := "xExternalsystem_example" // string | External system code. (optional)
    acceptLanguage := "acceptLanguage_example" // string | Language code (optional)

    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.FrontDeskOperationsAPI.GetRoomKeys(context.Background(), reservationId, hotelId).Authorization(authorization).XAppKey(xAppKey).XHotelid(xHotelid).IncludeInactiveRoomKeys(includeInactiveRoomKeys).XExternalsystem(xExternalsystem).AcceptLanguage(acceptLanguage).Execute()
    if err != nil {
 ...
 **xAppKey** | **string** | Client or Partner&#39;s Application Key | 
 **xHotelid** | **string** | Mandatory parameter to identify the hotel code where the end user is logged in | 
 **includeInactiveRoomKeys** | **bool** | Setting this to true will include inactive rooms keys details. This is supported when OPERA Control Multiple Guest Room Key is active. | 
 **xExternalsystem** | **string** | External system code. | 
 **acceptLanguage** | **string** | Language code | 
...
> WakeUpCalls GetWakeUpCalls(ctx, hotelId).Authorization(authorization).XAppKey(xAppKey).XHotelid(xHotelid).FetchCancelled(fetchCancelled).FetchCompleted(fetchCompleted).FetchNoAnswer(fetchNoAnswer).FetchPending(fetchPending).ReservationId(reservationId).IdExtension(idExtension).ReservationIdContext(reservationIdContext).ReservationIdType(reservationIdType).BeginDate(beginDate).EndDate(endDate).BeginTime(beginTime).EndTime(endTime).Room(room).BlockId(blockId).GuestName(guestName).XExternalsystem(xExternalsystem).AcceptLanguage(acceptLanguage).Execute()
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.FrontDeskOperationsAPI.GetWakeUpCalls(context.Background(), hotelId).Authorization(authorization).XAppKey(xAppKey).XHotelid(xHotelid).FetchCancelled(fetchCancelled).FetchCompleted(fetchCompleted).FetchNoAnswer(fetchNoAnswer).FetchPending(fetchPending).ReservationId(reservationId).IdExtension(idExtension).ReservationIdContext(reservationIdContext).ReservationIdType(reservationIdType).BeginDate(beginDate).EndDate(endDate).BeginTime(beginTime).EndTime(endTime).Room(room).BlockId(blockId).GuestName(guestName).XExternalsystem(xExternalsystem).AcceptLanguage(acceptLanguage).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `FrontDeskOperationsAPI.GetWakeUpCalls``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `GetWakeUpCalls`: WakeUpCalls
    fmt.Fprintf(os.Stdout, "Response from `FrontDeskOperationsAPI.GetWakeUpCalls`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiGetWakeUpCallsRequest struct via the builder pattern
...
> RoomKeyExternalDetails PostExternalRoomKeys(ctx, hotelId).Authorization(authorization).XAppKey(xAppKey).XHotelid(xHotelid).RoomKey(roomKey).XExternalsystem(xExternalsystem).AcceptLanguage(acceptLanguage).Execute()
...
func main() {
    ...
    xAppKey := "xAppKey_example" // string | Client or Partner's Application Key
    xHotelid := "xHotelid_example" // string | Mandatory parameter to identify the hotel code where the end user is logged in
    roomKey := *openapiclient.NewRoomKeyExternal("EncoderId_example", "EncoderTerminal_example", openapiclient.roomKeyOutBoundType("New")) // RoomKeyExternal | Request for generation of room key.
    xExternalsystem := "xExternalsystem_example" // string | External system code. (optional)
    acceptLanguage := "acceptLanguage_example" // string | Language code (optional)

    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.FrontDeskOperationsAPI.PostExternalRoomKeys(context.Background(), hotelId).Authorization(authorization).XAppKey(xAppKey).XHotelid(xHotelid).RoomKey(roomKey).XExternalsystem(xExternalsystem).AcceptLanguage(acceptLanguage).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `FrontDeskOperationsAPI.PostExternalRoomKeys``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `PostExternalRoomKeys`: RoomKeyExternalDetails
    fmt.Fprintf(os.Stdout, "Response from `FrontDeskOperationsAPI.PostExternalRoomKeys`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiPostExternalRoomKeysRequest struct via the builder pattern
 ...
 **xAppKey** | **string** | Client or Partner&#39;s Application Key | 
 **xHotelid** | **string** | Mandatory parameter to identify the hotel code where the end user is logged in | 
 **roomKey** | [**RoomKeyExternal**](RoomKeyExternal.md) | Request for generation of room key. | 
 **xExternalsystem** | **string** | External system code. | 
 **acceptLanguage** | **string** | Language code | 

### Return type

[**RoomKeyExternalDetails**](RoomKeyExternalDetails.md)
...
> RoomKeysExternalDetails PostRoomKeysExternal(ctx, hotelId).Authorization(authorization).XAppKey(xAppKey).XHotelid(xHotelid).RoomKey(roomKey).XExternalsystem(xExternalsystem).AcceptLanguage(acceptLanguage).Execute()
...
func main() {
    ...
    xAppKey := "xAppKey_example" // string | Client or Partner's Application Key
    xHotelid := "xHotelid_example" // string | Mandatory parameter to identify the hotel code where the end user is logged in
    roomKey := *openapiclient.NewRoomKeysExternal("EncoderId_example", "EncoderTerminal_example", openapiclient.roomKeyOutBoundType("New"), time.Now(), openapiclient.externalRoomKeyType("HardKey"), openapiclient.keyUserType("Guest")) // RoomKeysExternal | Request for generation of room key.
    xExternalsystem := "xExternalsystem_example" // string | External system code. (optional)
    acceptLanguage := "acceptLanguage_example" // string | Language code (optional)

    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.FrontDeskOperationsAPI.PostRoomKeysExternal(context.Background(), hotelId).Authorization(authorization).XAppKey(xAppKey).XHotelid(xHotelid).RoomKey(roomKey).XExternalsystem(xExternalsystem).AcceptLanguage(acceptLanguage).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `FrontDeskOperationsAPI.PostRoomKeysExternal``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `PostRoomKeysExternal`: RoomKeysExternalDetails
    fmt.Fprintf(os.Stdout, "Response from `FrontDeskOperationsAPI.PostRoomKeysExternal`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiPostRoomKeysExternalRequest struct via the builder pattern
 ...
 **xAppKey** | **string** | Client or Partner&#39;s Application Key | 
 **xHotelid** | **string** | Mandatory parameter to identify the hotel code where the end user is logged in | 
 **roomKey** | [**RoomKeysExternal**](RoomKeysExternal.md) | Request for generation of room key. | 
 **xExternalsystem** | **string** | External system code. | 
 **acceptLanguage** | **string** | Language code | 

### Return type

[**RoomKeysExternalDetails**](RoomKeysExternalDetails.md)
...
> RoomKeyStatus ReadRoomKey(ctx, hotelId).Authorization(authorization).XAppKey(xAppKey).XHotelid(xHotelid).EncoderTerminal(encoderTerminal).InterfaceId(interfaceId).EncoderId(encoderId).EncoderIdContext(encoderIdContext).EncoderIdType(encoderIdType).XExternalsystem(xExternalsystem).AcceptLanguage(acceptLanguage).Execute()
...
> Status ShiftRooms(ctx, hotelId, sourceReservationId, targetReservationId).Authorization(authorization).XAppKey(xAppKey).XHotelid(xHotelid).ShiftRooms(shiftRooms).OverrideBackToBackRoomSkip(overrideBackToBackRoomSkip).XExternalsystem(xExternalsystem).AcceptLanguage(acceptLanguage).Execute()
...
func main() {
    ...
    overrideBackToBackRoomSkip := true // bool | Specifies if the Swap/Shift action should continue regardless of the reservation having a Back to Back Linked Reservation assigned to the same room. Swap/Shift functionality is available when the Swap/Shift Rooms OPERA Control is active. Back to Back Reservation handling is available when the Back to Back Handling for Linked Reservations OPERA Control is active. (optional)
    xExternalsystem := "xExternalsystem_example" // string | External system code. (optional)
    acceptLanguage := "acceptLanguage_example" // string | Language code (optional)

    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.FrontDeskOperationsAPI.ShiftRooms(context.Background(), hotelId, sourceReservationId, targetReservationId).Authorization(authorization).XAppKey(xAppKey).XHotelid(xHotelid).ShiftRooms(shiftRooms).OverrideBackToBackRoomSkip(overrideBackToBackRoomSkip).XExternalsystem(xExternalsystem).AcceptLanguage(acceptLanguage).Execute()
    if err != nil {
 ...
 **overrideBackToBackRoomSkip** | **bool** | Specifies if the Swap/Shift action should continue regardless of the reservation having a Back to Back Linked Reservation assigned to the same room. Swap/Shift functionality is available when the Swap/Shift Rooms OPERA Control is active. Back to Back Reservation handling is available when the Back to Back Handling for Linked Reservations OPERA Control is active. | 
 **xExternalsystem** | **string** | External system code. | 
 **acceptLanguage** | **string** | Language code | 
...
> Status SwapRooms(ctx, hotelId, sourceReservationId, targetReservationId).Authorization(authorization).XAppKey(xAppKey).XHotelid(xHotelid).SwapRooms(swapRooms).OverrideBackToBackRoomSkip(overrideBackToBackRoomSkip).XExternalsystem(xExternalsystem).AcceptLanguage(acceptLanguage).Execute()
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.FrontDeskOperationsAPI.SwapRooms(context.Background(), hotelId, sourceReservationId, targetReservationId).Authorization(authorization).XAppKey(xAppKey).XHotelid(xHotelid).SwapRooms(swapRooms).OverrideBackToBackRoomSkip(overrideBackToBackRoomSkip).XExternalsystem(xExternalsystem).AcceptLanguage(acceptLanguage).Execute()
    if err != nil {
...
func main() {
    ...
    xAppKey := "xAppKey_example" // string | Client or Partner's Application Key
    xHotelid := "xHotelid_example" // string | Mandatory parameter to identify the hotel code where the end user is logged in
    verifyCheckinInstructions := []string{"VerifyCheckinInstructions_example"} // []string | Instructions for including in the request when retrieving reservation information. Voucher - indicates to generate vouchers,if reservation matches voucher rule. (optional)
    xExternalsystem := "xExternalsystem_example" // string | External system code. (optional)
    acceptLanguage := "acceptLanguage_example" // string | Language code (optional)
 ...
 **xAppKey** | **string** | Client or Partner&#39;s Application Key | 
 **xHotelid** | **string** | Mandatory parameter to identify the hotel code where the end user is logged in | 
 **verifyCheckinInstructions** | **[]string** | Instructions for including in the request when retrieving reservation information. Voucher - indicates to generate vouchers,if reservation matches voucher rule. | 
 **xExternalsystem** | **string** | External system code. | 
 **acceptLanguage** | **string** | Language code | 
