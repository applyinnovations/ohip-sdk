...
func Test_rmrcfg_RoomRotationConfigApiService(t *testing.T) {
	...
	t.Run("Test RoomRotationConfigApiService DeleteRoomOwner", func(t *testing.T) {
		...
		resp, httpRes, err := apiClient.RoomRotationConfigApi.DeleteRoomOwner(context.Background(), roomOwnerId, hotelId).Execute()
	...
	t.Run("Test RoomRotationConfigApiService DeleteRoomRotationConfigServiceCache", func(t *testing.T) {

		t.Skip("skip test")  // remove to run test

		resp, httpRes, err := apiClient.RoomRotationConfigApi.DeleteRoomRotationConfigServiceCache(context.Background()).Execute()
	...
	t.Run("Test RoomRotationConfigApiService DeleteRotationGroups", func(t *testing.T) {

		t.Skip("skip test")  // remove to run test

		var rotationGroupsId string
		var hotelId string

		resp, httpRes, err := apiClient.RoomRotationConfigApi.DeleteRotationGroups(context.Background(), rotationGroupsId, hotelId).Execute()
	...
	t.Run("Test RoomRotationConfigApiService GetRotationGroups", func(t *testing.T) {

		t.Skip("skip test")  // remove to run test

		resp, httpRes, err := apiClient.RoomRotationConfigApi.GetRotationGroups(context.Background()).Execute()
	...
	t.Run("Test RoomRotationConfigApiService PingRoomRotationConfigService", func(t *testing.T) {

		t.Skip("skip test")  // remove to run test

		resp, httpRes, err := apiClient.RoomRotationConfigApi.PingRoomRotationConfigService(context.Background()).Execute()
	...
	t.Run("Test RoomRotationConfigApiService PostRoomOwner", func(t *testing.T) {
		...
		resp, httpRes, err := apiClient.RoomRotationConfigApi.PostRoomOwner(context.Background(), hotelId).Execute()
	...
	t.Run("Test RoomRotationConfigApiService PostRotationGroups", func(t *testing.T) {

		t.Skip("skip test")  // remove to run test

		var hotelId string

		resp, httpRes, err := apiClient.RoomRotationConfigApi.PostRotationGroups(context.Background(), hotelId).Execute()
	...
	t.Run("Test RoomRotationConfigApiService PutRoomOwner", func(t *testing.T) {
		...
		resp, httpRes, err := apiClient.RoomRotationConfigApi.PutRoomOwner(context.Background(), roomOwnerId, hotelId).Execute()
	...
	t.Run("Test RoomRotationConfigApiService PutRotationGroups", func(t *testing.T) {
		...
		resp, httpRes, err := apiClient.RoomRotationConfigApi.PutRotationGroups(context.Background(), rotationGroupsId, hotelId).Execute()
