...
// checks if the ValidateReservationsForProfileRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ValidateReservationsForProfileRequest{}

// ValidateReservationsForProfileRequest struct for ValidateReservationsForProfileRequest
type ValidateReservationsForProfileRequest struct {
...
func NewValidateReservationsForProfileRequest() *ValidateReservationsForProfileRequest {
	this := ValidateReservationsForProfileRequest{}
	return &this
}
...
func (o ValidateReservationsForProfileRequest) MarshalJSON() ([]byte, error) {
...
func (o ValidateReservationsForProfileRequest) ToMap() (map[string]interface{}, error) {
...
type NullableValidateReservationsForProfileRequest struct {
	value *ValidateReservationsForProfileRequest
	isSet bool
}

func (v NullableValidateReservationsForProfileRequest) Get() *ValidateReservationsForProfileRequest {
	return v.value
}

func (v *NullableValidateReservationsForProfileRequest) Set(val *ValidateReservationsForProfileRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableValidateReservationsForProfileRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableValidateReservationsForProfileRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableValidateReservationsForProfileRequest(val *ValidateReservationsForProfileRequest) *NullableValidateReservationsForProfileRequest {
	return &NullableValidateReservationsForProfileRequest{value: val, isSet: true}
}

func (v NullableValidateReservationsForProfileRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableValidateReservationsForProfileRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
