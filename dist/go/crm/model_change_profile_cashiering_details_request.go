...
// checks if the ChangeProfileCashieringDetailsRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ChangeProfileCashieringDetailsRequest{}

// ChangeProfileCashieringDetailsRequest struct for ChangeProfileCashieringDetailsRequest
type ChangeProfileCashieringDetailsRequest struct {
...
func NewChangeProfileCashieringDetailsRequest() *ChangeProfileCashieringDetailsRequest {
	this := ChangeProfileCashieringDetailsRequest{}
	return &this
}
...
func (o ChangeProfileCashieringDetailsRequest) MarshalJSON() ([]byte, error) {
...
func (o ChangeProfileCashieringDetailsRequest) ToMap() (map[string]interface{}, error) {
...
type NullableChangeProfileCashieringDetailsRequest struct {
	value *ChangeProfileCashieringDetailsRequest
	isSet bool
}

func (v NullableChangeProfileCashieringDetailsRequest) Get() *ChangeProfileCashieringDetailsRequest {
	return v.value
}

func (v *NullableChangeProfileCashieringDetailsRequest) Set(val *ChangeProfileCashieringDetailsRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableChangeProfileCashieringDetailsRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableChangeProfileCashieringDetailsRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableChangeProfileCashieringDetailsRequest(val *ChangeProfileCashieringDetailsRequest) *NullableChangeProfileCashieringDetailsRequest {
	return &NullableChangeProfileCashieringDetailsRequest{value: val, isSet: true}
}

func (v NullableChangeProfileCashieringDetailsRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableChangeProfileCashieringDetailsRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
