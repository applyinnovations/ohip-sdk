...
**EnrollmentSource** | Pointer to **string** | Source from where the enrollment is done. This is set at the OPERA control level and cannot be overriden. | [optional] 
...
**AutoPopulateFromName** | Pointer to **bool** | Automatically populate membership number based on profile name. | [optional] [default to false]
...
### GetAutoPopulateFromName

`func (o *ProfileMembershipType) GetAutoPopulateFromName() bool`

GetAutoPopulateFromName returns the AutoPopulateFromName field if non-nil, zero value otherwise.

### GetAutoPopulateFromNameOk

`func (o *ProfileMembershipType) GetAutoPopulateFromNameOk() (*bool, bool)`

GetAutoPopulateFromNameOk returns a tuple with the AutoPopulateFromName field if it's non-nil, zero value otherwise
and a boolean to check if the value has been set.

### SetAutoPopulateFromName

`func (o *ProfileMembershipType) SetAutoPopulateFromName(v bool)`

SetAutoPopulateFromName sets AutoPopulateFromName field to given value.

### HasAutoPopulateFromName

`func (o *ProfileMembershipType) HasAutoPopulateFromName() bool`

HasAutoPopulateFromName returns a boolean if a field has been set.
