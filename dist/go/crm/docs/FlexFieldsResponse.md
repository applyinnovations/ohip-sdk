...
------------ | ------------- | ------------- | -------------
**FlexFieldValues** | Pointer to [**[]FlexFieldValueType**](FlexFieldValueType.md) | List of flex fields. | [optional] 
...
`func (o *FlexFieldsResponse) GetFlexFieldValues() []FlexFieldValueType`

GetFlexFieldValues returns the FlexFieldValues field if non-nil, zero value otherwise.

### GetFlexFieldValuesOk

`func (o *FlexFieldsResponse) GetFlexFieldValuesOk() (*[]FlexFieldValueType, bool)`

GetFlexFieldValuesOk returns a tuple with the FlexFieldValues field if it's non-nil, zero value otherwise
and a boolean to check if the value has been set.

### SetFlexFieldValues

`func (o *FlexFieldsResponse) SetFlexFieldValues(v []FlexFieldValueType)`

SetFlexFieldValues sets FlexFieldValues field to given value.

### HasFlexFieldValues

`func (o *FlexFieldsResponse) HasFlexFieldValues() bool`

HasFlexFieldValues returns a boolean if a field has been set.
