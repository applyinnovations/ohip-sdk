...
`func (o *StagedProfileNumericUDFType) GetAlternateName() string`

GetAlternateName returns the AlternateName field if non-nil, zero value otherwise.

### GetAlternateNameOk

`func (o *StagedProfileNumericUDFType) GetAlternateNameOk() (*string, bool)`
...
`func (o *StagedProfileNumericUDFType) SetAlternateName(v string)`

SetAlternateName sets AlternateName field to given value.

### HasAlternateName

`func (o *StagedProfileNumericUDFType) HasAlternateName() bool`
