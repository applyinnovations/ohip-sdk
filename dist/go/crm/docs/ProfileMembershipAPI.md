...
[**GetMembershipTransactionRates**](ProfileMembershipAPI.md#GetMembershipTransactionRates) | **Get** /membershipTransactions/{membershipTransactionId}/rates | Fetch the rate details associated to current points transaction.
...
> MemberPointsToExpireCollection GetMemberPointsToExpireByCardNo(ctx, membershipCardNo, membershipCardType).Authorization(authorization).XAppKey(xAppKey).XHotelid(xHotelid).XExternalsystem(xExternalsystem).AcceptLanguage(acceptLanguage).Execute()
...
func main() {
    membershipCardNo := "membershipCardNo_example" // string | The card number associated to the membership
    membershipCardType := "membershipCardType_example" // string | The type of card the membership belongs to
    authorization := "authorization_example" // string | Bearer token that needs to be passed which is generated post user authentication
    xAppKey := "xAppKey_example" // string | Client or Partner's Application Key
    xHotelid := "xHotelid_example" // string | Mandatory parameter to identify the hotel code where the end user is logged in
    xExternalsystem := "xExternalsystem_example" // string | External system code. (optional)
    ...
    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.ProfileMembershipAPI.GetMemberPointsToExpireByCardNo(context.Background(), membershipCardNo, membershipCardType).Authorization(authorization).XAppKey(xAppKey).XHotelid(xHotelid).XExternalsystem(xExternalsystem).AcceptLanguage(acceptLanguage).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `ProfileMembershipAPI.GetMemberPointsToExpireByCardNo``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `GetMemberPointsToExpireByCardNo`: MemberPointsToExpireCollection
    fmt.Fprintf(os.Stdout, "Response from `ProfileMembershipAPI.GetMemberPointsToExpireByCardNo`: %v\n", resp)
}
```
...
------------- | ------------- | ------------- | -------------
**ctx** | **context.Context** | context for authentication, logging, cancellation, deadlines, tracing, etc.
**membershipCardNo** | **string** | The card number associated to the membership | 
**membershipCardType** | **string** | The type of card the membership belongs to | 

### Other Parameters

Other parameters are passed through a pointer to a apiGetMemberPointsToExpireByCardNoRequest struct via the builder pattern
...
[**MemberPointsToExpireCollection**](MemberPointsToExpireCollection.md)
...
> MemberCardHistoryList GetMembershipCardHistory(ctx, profileId).Authorization(authorization).XAppKey(xAppKey).XHotelid(xHotelid).Limit(limit).Offset(offset).XExternalsystem(xExternalsystem).AcceptLanguage(acceptLanguage).Execute()
...
func main() {
    profileId := "profileId_example" // string | Profile Id of the guest.
    authorization := "authorization_example" // string | Bearer token that needs to be passed which is generated post user authentication
    xAppKey := "xAppKey_example" // string | Client or Partner's Application Key
    xHotelid := "xHotelid_example" // string | Mandatory parameter to identify the hotel code where the end user is logged in
    limit := int32(56) // int32 | Indicates maximum number of records a Web Service should return. (optional) (default to 20)
    ...
    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.ProfileMembershipAPI.GetMembershipCardHistory(context.Background(), profileId).Authorization(authorization).XAppKey(xAppKey).XHotelid(xHotelid).Limit(limit).Offset(offset).XExternalsystem(xExternalsystem).AcceptLanguage(acceptLanguage).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `ProfileMembershipAPI.GetMembershipCardHistory``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `GetMembershipCardHistory`: MemberCardHistoryList
    fmt.Fprintf(os.Stdout, "Response from `ProfileMembershipAPI.GetMembershipCardHistory`: %v\n", resp)
}
```
...
------------- | ------------- | ------------- | -------------
**ctx** | **context.Context** | context for authentication, logging, cancellation, deadlines, tracing, etc.
**profileId** | **string** | Profile Id of the guest. | 

### Other Parameters

Other parameters are passed through a pointer to a apiGetMembershipCardHistoryRequest struct via the builder pattern
...
[**MemberCardHistoryList**](MemberCardHistoryList.md)
...
> MembershipIssueAwards GetMembershipIssueAwardsList(ctx, membershipId).Authorization(authorization).XAppKey(xAppKey).XHotelid(xHotelid).MembershipType(membershipType).HotelBookingNumber(hotelBookingNumber).HotelId(hotelId).AwardCode(awardCode).AwardNumber(awardNumber).AwardBasedOn(awardBasedOn).Limit(limit).Offset(offset).XExternalsystem(xExternalsystem).AcceptLanguage(acceptLanguage).Execute()
...
func main() {
    ...
    hotelBookingNumber := "hotelBookingNumber_example" // string | Confirmation Number attached  (optional)
    hotelId := "hotelId_example" // string | Award Code belongs to which Hotel. (optional)
    awardCode := []string{"Inner_example"} // []string | Unique code identifying the award. (optional)
    awardNumber := float32(8.14) // float32 | Award Id for identifying the award. (optional)
    awardBasedOn := "awardBasedOn_example" // string | Award Type for identifying the award. (optional)
    limit := int32(56) // int32 | Indicates maximum number of records a Web Service should return. (optional) (default to 20)
    offset := int32(56) // int32 | Index or initial index of the set(page) being requested. If the index goes out of the bounds of the total set count then no data will be returned. (optional) (default to 1)
    xExternalsystem := "xExternalsystem_example" // string | External system code. (optional)
    acceptLanguage := "acceptLanguage_example" // string | Language code (optional)
    ...
    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.ProfileMembershipAPI.GetMembershipIssueAwardsList(context.Background(), membershipId).Authorization(authorization).XAppKey(xAppKey).XHotelid(xHotelid).MembershipType(membershipType).HotelBookingNumber(hotelBookingNumber).HotelId(hotelId).AwardCode(awardCode).AwardNumber(awardNumber).AwardBasedOn(awardBasedOn).Limit(limit).Offset(offset).XExternalsystem(xExternalsystem).AcceptLanguage(acceptLanguage).Execute()
    if err != nil {
 ...
 **hotelBookingNumber** | **string** | Confirmation Number attached  | 
 **hotelId** | **string** | Award Code belongs to which Hotel. | 
 **awardCode** | **[]string** | Unique code identifying the award. | 
 **awardNumber** | **float32** | Award Id for identifying the award. | 
 **awardBasedOn** | **string** | Award Type for identifying the award. | 
 **limit** | **int32** | Indicates maximum number of records a Web Service should return. | [default to 20]
 **offset** | **int32** | Index or initial index of the set(page) being requested. If the index goes out of the bounds of the total set count then no data will be returned. | [default to 1]
 **xExternalsystem** | **string** | External system code. | 
 **acceptLanguage** | **string** | Language code | 
...
> MemberPointsExceptions GetMembershipPointsExceptions(ctx).ExceptionStatus(exceptionStatus).Authorization(authorization).XAppKey(xAppKey).XHotelid(xHotelid).HotelId(hotelId).ProfileId(profileId).ArrivalFrom(arrivalFrom).DepartureTo(departureTo).MembershipType(membershipType).MembershipLevel(membershipLevel).MembershipCardNo(membershipCardNo).Limit(limit).Offset(offset).XExternalsystem(xExternalsystem).AcceptLanguage(acceptLanguage).Execute()
...
func main() {
    exceptionStatus := "exceptionStatus_example" // string | Indicates the type of Exception like Exception not resolved,Points Rejected on Exception etc.,
    authorization := "authorization_example" // string | Bearer token that needs to be passed which is generated post user authentication
    xAppKey := "xAppKey_example" // string | Client or Partner's Application Key
    xHotelid := "xHotelid_example" // string | Mandatory parameter to identify the hotel code where the end user is logged in
    hotelId := "hotelId_example" // string | Membership transaction belongs to which Hotel. (optional)
    profileId := float32(8.14) // float32 | Profile Id of the guest. (optional)
    arrivalFrom := time.Now() // string | Arrival From Date to fetch the reservations flagged for Membership Points Exception (optional)
    departureTo := time.Now() // string | Departure To Date to fetch the reservation flagged for Membership Points Exception (optional)
    membershipType := "membershipType_example" // string | The type of the membership. (optional)
    ...
    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.ProfileMembershipAPI.GetMembershipPointsExceptions(context.Background()).ExceptionStatus(exceptionStatus).Authorization(authorization).XAppKey(xAppKey).XHotelid(xHotelid).HotelId(hotelId).ProfileId(profileId).ArrivalFrom(arrivalFrom).DepartureTo(departureTo).MembershipType(membershipType).MembershipLevel(membershipLevel).MembershipCardNo(membershipCardNo).Limit(limit).Offset(offset).XExternalsystem(xExternalsystem).AcceptLanguage(acceptLanguage).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `ProfileMembershipAPI.GetMembershipPointsExceptions``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `GetMembershipPointsExceptions`: MemberPointsExceptions
    fmt.Fprintf(os.Stdout, "Response from `ProfileMembershipAPI.GetMembershipPointsExceptions`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiGetMembershipPointsExceptionsRequest struct via the builder pattern


Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **exceptionStatus** | **string** | Indicates the type of Exception like Exception not resolved,Points Rejected on Exception etc., | 
 **authorization** | **string** | Bearer token that needs to be passed which is generated post user authentication | 
 **xAppKey** | **string** | Client or Partner&#39;s Application Key | 
 **xHotelid** | **string** | Mandatory parameter to identify the hotel code where the end user is logged in | 
 **hotelId** | **string** | Membership transaction belongs to which Hotel. | 
 **profileId** | **float32** | Profile Id of the guest. | 
 **arrivalFrom** | **string** | Arrival From Date to fetch the reservations flagged for Membership Points Exception | 
 **departureTo** | **string** | Departure To Date to fetch the reservation flagged for Membership Points Exception | 
 **membershipType** | **string** | The type of the membership. | 
...
[**MemberPointsExceptions**](MemberPointsExceptions.md)
...
> MembershipPromotionsDetails GetMembershipPromotions(ctx, membershipId).Authorization(authorization).XAppKey(xAppKey).XHotelid(xHotelid).IncludeInactive(includeInactive).XExternalsystem(xExternalsystem).AcceptLanguage(acceptLanguage).Execute()
...
func main() {
    ...
    xAppKey := "xAppKey_example" // string | Client or Partner's Application Key
    xHotelid := "xHotelid_example" // string | Mandatory parameter to identify the hotel code where the end user is logged in
    includeInactive := true // bool | Search criteria for fetching inactive membership promotions. When set to true, inactive records will be included. (optional)
    xExternalsystem := "xExternalsystem_example" // string | External system code. (optional)
    acceptLanguage := "acceptLanguage_example" // string | Language code (optional)

    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.ProfileMembershipAPI.GetMembershipPromotions(context.Background(), membershipId).Authorization(authorization).XAppKey(xAppKey).XHotelid(xHotelid).IncludeInactive(includeInactive).XExternalsystem(xExternalsystem).AcceptLanguage(acceptLanguage).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `ProfileMembershipAPI.GetMembershipPromotions``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `GetMembershipPromotions`: MembershipPromotionsDetails
    fmt.Fprintf(os.Stdout, "Response from `ProfileMembershipAPI.GetMembershipPromotions`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiGetMembershipPromotionsRequest struct via the builder pattern
 ...
 **xAppKey** | **string** | Client or Partner&#39;s Application Key | 
 **xHotelid** | **string** | Mandatory parameter to identify the hotel code where the end user is logged in | 
 **includeInactive** | **bool** | Search criteria for fetching inactive membership promotions. When set to true, inactive records will be included. | 
 **xExternalsystem** | **string** | External system code. | 
 **acceptLanguage** | **string** | Language code | 

### Return type

[**MembershipPromotionsDetails**](MembershipPromotionsDetails.md)
...
> MembershipReservationDetails GetMembershipReservationActivity(ctx).HotelIds(hotelIds).Authorization(authorization).XAppKey(xAppKey).XHotelid(xHotelid).PropertyDate(propertyDate).RoomClasses(roomClasses).MembershipType(membershipType).XExternalsystem(xExternalsystem).AcceptLanguage(acceptLanguage).Execute()
...
func main() {
    hotelIds := []string{"Inner_example"} // []string | Unique ID of the hotels to fetch the membership reservation activity.
    authorization := "authorization_example" // string | Bearer token that needs to be passed which is generated post user authentication
    xAppKey := "xAppKey_example" // string | Client or Partner's Application Key
    xHotelid := "xHotelid_example" // string | Mandatory parameter to identify the hotel code where the end user is logged in
    propertyDate := time.Now() // string | Business Date of the property selected. (optional)
    roomClasses := []string{"Inner_example"} // []string | Room Classes required to fetch the membership reservation activity. (optional)
    membershipType := "membershipType_example" // string | Membership Type required to fetch the membership reservation activity. (optional)
    xExternalsystem := "xExternalsystem_example" // string | External system code. (optional)
    acceptLanguage := "acceptLanguage_example" // string | Language code (optional)

    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.ProfileMembershipAPI.GetMembershipReservationActivity(context.Background()).HotelIds(hotelIds).Authorization(authorization).XAppKey(xAppKey).XHotelid(xHotelid).PropertyDate(propertyDate).RoomClasses(roomClasses).MembershipType(membershipType).XExternalsystem(xExternalsystem).AcceptLanguage(acceptLanguage).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `ProfileMembershipAPI.GetMembershipReservationActivity``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `GetMembershipReservationActivity`: MembershipReservationDetails
    fmt.Fprintf(os.Stdout, "Response from `ProfileMembershipAPI.GetMembershipReservationActivity`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiGetMembershipReservationActivityRequest struct via the builder pattern


Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **hotelIds** | **[]string** | Unique ID of the hotels to fetch the membership reservation activity. | 
 **authorization** | **string** | Bearer token that needs to be passed which is generated post user authentication | 
 **xAppKey** | **string** | Client or Partner&#39;s Application Key | 
 **xHotelid** | **string** | Mandatory parameter to identify the hotel code where the end user is logged in | 
 **propertyDate** | **string** | Business Date of the property selected. | 
 **roomClasses** | **[]string** | Room Classes required to fetch the membership reservation activity. | 
 **membershipType** | **string** | Membership Type required to fetch the membership reservation activity. | 
 **xExternalsystem** | **string** | External system code. | 
 **acceptLanguage** | **string** | Language code | 

### Return type

[**MembershipReservationDetails**](MembershipReservationDetails.md)
...
> MembershipTransactionsSummaryCollection GetMembershipTransactionsSummaryByCardNo(ctx, membershipCardNo, membershipCardType).Authorization(authorization).XAppKey(xAppKey).XHotelid(xHotelid).XExternalsystem(xExternalsystem).AcceptLanguage(acceptLanguage).Execute()
...
func main() {
    membershipCardNo := "membershipCardNo_example" // string | 
    membershipCardType := "membershipCardType_example" // string | 
    authorization := "authorization_example" // string | Bearer token that needs to be passed which is generated post user authentication
    xAppKey := "xAppKey_example" // string | Client or Partner's Application Key
    xHotelid := "xHotelid_example" // string | Mandatory parameter to identify the hotel code where the end user is logged in
    xExternalsystem := "xExternalsystem_example" // string | External system code. (optional)
    ...
    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.ProfileMembershipAPI.GetMembershipTransactionsSummaryByCardNo(context.Background(), membershipCardNo, membershipCardType).Authorization(authorization).XAppKey(xAppKey).XHotelid(xHotelid).XExternalsystem(xExternalsystem).AcceptLanguage(acceptLanguage).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `ProfileMembershipAPI.GetMembershipTransactionsSummaryByCardNo``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `GetMembershipTransactionsSummaryByCardNo`: MembershipTransactionsSummaryCollection
    fmt.Fprintf(os.Stdout, "Response from `ProfileMembershipAPI.GetMembershipTransactionsSummaryByCardNo`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiGetMembershipTransactionsSummaryByCardNoRequest struct via the builder pattern
...
[**MembershipTransactionsSummaryCollection**](MembershipTransactionsSummaryCollection.md)
...
> IssuedAward IssueOtherAwards(ctx).Authorization(authorization).XAppKey(xAppKey).XHotelid(xHotelid).OtherAwardsIssueCriteria(otherAwardsIssueCriteria).XExternalsystem(xExternalsystem).AcceptLanguage(acceptLanguage).Execute()
...
func main() {
    ...
    xAppKey := "xAppKey_example" // string | Client or Partner's Application Key
    xHotelid := "xHotelid_example" // string | Mandatory parameter to identify the hotel code where the end user is logged in
    otherAwardsIssueCriteria := *openapiclient.NewOtherAwardsIssueCriteria() // OtherAwardsIssueCriteria | Request object to issue an OTHER type award to a member's profile.
    xExternalsystem := "xExternalsystem_example" // string | External system code. (optional)
    acceptLanguage := "acceptLanguage_example" // string | Language code (optional)

    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.ProfileMembershipAPI.IssueOtherAwards(context.Background()).Authorization(authorization).XAppKey(xAppKey).XHotelid(xHotelid).OtherAwardsIssueCriteria(otherAwardsIssueCriteria).XExternalsystem(xExternalsystem).AcceptLanguage(acceptLanguage).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `ProfileMembershipAPI.IssueOtherAwards``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `IssueOtherAwards`: IssuedAward
    fmt.Fprintf(os.Stdout, "Response from `ProfileMembershipAPI.IssueOtherAwards`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiIssueOtherAwardsRequest struct via the builder pattern
 ...
 **xAppKey** | **string** | Client or Partner&#39;s Application Key | 
 **xHotelid** | **string** | Mandatory parameter to identify the hotel code where the end user is logged in | 
 **otherAwardsIssueCriteria** | [**OtherAwardsIssueCriteria**](OtherAwardsIssueCriteria.md) | Request object to issue an OTHER type award to a member&#39;s profile. | 
 **xExternalsystem** | **string** | External system code. | 
 **acceptLanguage** | **string** | Language code | 

### Return type

[**IssuedAward**](IssuedAward.md)
...
> OperaVersion PingMembershipService(ctx).Authorization(authorization).XAppKey(xAppKey).XHotelid(xHotelid).XExternalsystem(xExternalsystem).AcceptLanguage(acceptLanguage).Execute()
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.ProfileMembershipAPI.PingMembershipService(context.Background()).Authorization(authorization).XAppKey(xAppKey).XHotelid(xHotelid).XExternalsystem(xExternalsystem).AcceptLanguage(acceptLanguage).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `ProfileMembershipAPI.PingMembershipService``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `PingMembershipService`: OperaVersion
    fmt.Fprintf(os.Stdout, "Response from `ProfileMembershipAPI.PingMembershipService`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiPingMembershipServiceRequest struct via the builder pattern
...
func main() {
    ...
    xAppKey := "xAppKey_example" // string | Client or Partner's Application Key
    xHotelid := "xHotelid_example" // string | Mandatory parameter to identify the hotel code where the end user is logged in
    enrollment := *openapiclient.NewEnrollment() // Enrollment | Request object to create profile enrollment.
    xExternalsystem := "xExternalsystem_example" // string | External system code. (optional)
    acceptLanguage := "acceptLanguage_example" // string | Language code (optional)
 ...
 **xAppKey** | **string** | Client or Partner&#39;s Application Key | 
 **xHotelid** | **string** | Mandatory parameter to identify the hotel code where the end user is logged in | 
 **enrollment** | [**Enrollment**](Enrollment.md) | Request object to create profile enrollment. | 
 **xExternalsystem** | **string** | External system code. | 
 **acceptLanguage** | **string** | Language code | 
...
func main() {
    ...
    xAppKey := "xAppKey_example" // string | Client or Partner's Application Key
    xHotelid := "xHotelid_example" // string | Mandatory parameter to identify the hotel code where the end user is logged in
    membershipClaim := *openapiclient.NewMembershipClaim() // MembershipClaim | Request object for creating membership claim.
    xExternalsystem := "xExternalsystem_example" // string | External system code. (optional)
    acceptLanguage := "acceptLanguage_example" // string | Language code (optional)
 ...
 **xAppKey** | **string** | Client or Partner&#39;s Application Key | 
 **xHotelid** | **string** | Mandatory parameter to identify the hotel code where the end user is logged in | 
 **membershipClaim** | [**MembershipClaim**](MembershipClaim.md) | Request object for creating membership claim. | 
 **xExternalsystem** | **string** | External system code. | 
 **acceptLanguage** | **string** | Language code | 
...
> Status PostMembershipPromotion(ctx, membershipId).Authorization(authorization).XAppKey(xAppKey).XHotelid(xHotelid).MembershipPromotion(membershipPromotion).XExternalsystem(xExternalsystem).AcceptLanguage(acceptLanguage).Execute()
...
func main() {
    ...
    xAppKey := "xAppKey_example" // string | Client or Partner's Application Key
    xHotelid := "xHotelid_example" // string | Mandatory parameter to identify the hotel code where the end user is logged in
    membershipPromotion := *openapiclient.NewMembershipPromotionDetails() // MembershipPromotionDetails | Request object for creating a membership promotion.
    xExternalsystem := "xExternalsystem_example" // string | External system code. (optional)
    acceptLanguage := "acceptLanguage_example" // string | Language code (optional)

    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.ProfileMembershipAPI.PostMembershipPromotion(context.Background(), membershipId).Authorization(authorization).XAppKey(xAppKey).XHotelid(xHotelid).MembershipPromotion(membershipPromotion).XExternalsystem(xExternalsystem).AcceptLanguage(acceptLanguage).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `ProfileMembershipAPI.PostMembershipPromotion``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `PostMembershipPromotion`: Status
    fmt.Fprintf(os.Stdout, "Response from `ProfileMembershipAPI.PostMembershipPromotion`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiPostMembershipPromotionRequest struct via the builder pattern
 ...
 **xAppKey** | **string** | Client or Partner&#39;s Application Key | 
 **xHotelid** | **string** | Mandatory parameter to identify the hotel code where the end user is logged in | 
 **membershipPromotion** | [**MembershipPromotionDetails**](MembershipPromotionDetails.md) | Request object for creating a membership promotion. | 
 **xExternalsystem** | **string** | External system code. | 
 **acceptLanguage** | **string** | Language code | 
...
func main() {
    ...
    xAppKey := "xAppKey_example" // string | Client or Partner's Application Key
    xHotelid := "xHotelid_example" // string | Mandatory parameter to identify the hotel code where the end user is logged in
    membershipTransaction := *openapiclient.NewMembershipTransaction() // MembershipTransaction | Request object for creating a membership transaction.
    xExternalsystem := "xExternalsystem_example" // string | External system code. (optional)
    acceptLanguage := "acceptLanguage_example" // string | Language code (optional)
 ...
 **xAppKey** | **string** | Client or Partner&#39;s Application Key | 
 **xHotelid** | **string** | Mandatory parameter to identify the hotel code where the end user is logged in | 
 **membershipTransaction** | [**MembershipTransaction**](MembershipTransaction.md) | Request object for creating a membership transaction. | 
 **xExternalsystem** | **string** | External system code. | 
 **acceptLanguage** | **string** | Language code | 
...
> Status PutMembershipPointsExceptions(ctx).Authorization(authorization).XAppKey(xAppKey).XHotelid(xHotelid).MembershipPointsExceptions(membershipPointsExceptions).XExternalsystem(xExternalsystem).AcceptLanguage(acceptLanguage).Execute()
...
func main() {
    ...
    xAppKey := "xAppKey_example" // string | Client or Partner's Application Key
    xHotelid := "xHotelid_example" // string | Mandatory parameter to identify the hotel code where the end user is logged in
    membershipPointsExceptions := *openapiclient.NewMembershipPointsExceptions() // MembershipPointsExceptions | Request object for updating membership points exceptions.
    xExternalsystem := "xExternalsystem_example" // string | External system code. (optional)
    acceptLanguage := "acceptLanguage_example" // string | Language code (optional)

    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.ProfileMembershipAPI.PutMembershipPointsExceptions(context.Background()).Authorization(authorization).XAppKey(xAppKey).XHotelid(xHotelid).MembershipPointsExceptions(membershipPointsExceptions).XExternalsystem(xExternalsystem).AcceptLanguage(acceptLanguage).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `ProfileMembershipAPI.PutMembershipPointsExceptions``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `PutMembershipPointsExceptions`: Status
    fmt.Fprintf(os.Stdout, "Response from `ProfileMembershipAPI.PutMembershipPointsExceptions`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiPutMembershipPointsExceptionsRequest struct via the builder pattern
 ...
 **xAppKey** | **string** | Client or Partner&#39;s Application Key | 
 **xHotelid** | **string** | Mandatory parameter to identify the hotel code where the end user is logged in | 
 **membershipPointsExceptions** | [**MembershipPointsExceptions**](MembershipPointsExceptions.md) | Request object for updating membership points exceptions. | 
 **xExternalsystem** | **string** | External system code. | 
 **acceptLanguage** | **string** | Language code | 
...
> Status PutMembershipPromotion(ctx, membershipId, promotionCode).Authorization(authorization).XAppKey(xAppKey).XHotelid(xHotelid).MembershipPromotion(membershipPromotion).XExternalsystem(xExternalsystem).AcceptLanguage(acceptLanguage).Execute()
...
func main() {
    ...
    xAppKey := "xAppKey_example" // string | Client or Partner's Application Key
    xHotelid := "xHotelid_example" // string | Mandatory parameter to identify the hotel code where the end user is logged in
    membershipPromotion := *openapiclient.NewMembershipPromotionDetails() // MembershipPromotionDetails | The request element used to update an existing membership promotion in the database.
    xExternalsystem := "xExternalsystem_example" // string | External system code. (optional)
    acceptLanguage := "acceptLanguage_example" // string | Language code (optional)

    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.ProfileMembershipAPI.PutMembershipPromotion(context.Background(), membershipId, promotionCode).Authorization(authorization).XAppKey(xAppKey).XHotelid(xHotelid).MembershipPromotion(membershipPromotion).XExternalsystem(xExternalsystem).AcceptLanguage(acceptLanguage).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `ProfileMembershipAPI.PutMembershipPromotion``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `PutMembershipPromotion`: Status
    fmt.Fprintf(os.Stdout, "Response from `ProfileMembershipAPI.PutMembershipPromotion`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiPutMembershipPromotionRequest struct via the builder pattern
 ...
 **xAppKey** | **string** | Client or Partner&#39;s Application Key | 
 **xHotelid** | **string** | Mandatory parameter to identify the hotel code where the end user is logged in | 
 **membershipPromotion** | [**MembershipPromotionDetails**](MembershipPromotionDetails.md) | The request element used to update an existing membership promotion in the database. | 
 **xExternalsystem** | **string** | External system code. | 
 **acceptLanguage** | **string** | Language code | 
...
func main() {
    ...
    xAppKey := "xAppKey_example" // string | Client or Partner's Application Key
    xHotelid := "xHotelid_example" // string | Mandatory parameter to identify the hotel code where the end user is logged in
    award := *openapiclient.NewAward() // Award | Request object to redeem award.
    xExternalsystem := "xExternalsystem_example" // string | External system code. (optional)
    acceptLanguage := "acceptLanguage_example" // string | Language code (optional)
 ...
 **xAppKey** | **string** | Client or Partner&#39;s Application Key | 
 **xHotelid** | **string** | Mandatory parameter to identify the hotel code where the end user is logged in | 
 **award** | [**Award**](Award.md) | Request object to redeem award. | 
 **xExternalsystem** | **string** | External system code. | 
 **acceptLanguage** | **string** | Language code | 
