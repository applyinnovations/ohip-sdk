...
**InactiveReason** | Pointer to **string** | Inactive reason associated with the current profile. | [optional] 
...
**InternalFolio** | Pointer to **bool** | Flag considered during folio settlement, to select the corresponding Folio Type when the value is true. Only used in Poland country mode. | [optional] 
...
`func (o *ProfileType) GetInactiveReason() string`

GetInactiveReason returns the InactiveReason field if non-nil, zero value otherwise.

### GetInactiveReasonOk

`func (o *ProfileType) GetInactiveReasonOk() (*string, bool)`
...
`func (o *ProfileType) SetInactiveReason(v string)`

SetInactiveReason sets InactiveReason field to given value.

### HasInactiveReason

`func (o *ProfileType) HasInactiveReason() bool`
...
`func (o *ProfileType) GetInternalFolio() bool`

GetInternalFolio returns the InternalFolio field if non-nil, zero value otherwise.

### GetInternalFolioOk

`func (o *ProfileType) GetInternalFolioOk() (*bool, bool)`
...
`func (o *ProfileType) SetInternalFolio(v bool)`

SetInternalFolio sets InternalFolio field to given value.

### HasInternalFolio

`func (o *ProfileType) HasInternalFolio() bool`
