...
**ProfileSourceCode** | Pointer to **string** | Original Source Code for profile. It is used as reference to identify the source of Profile. | [optional] 
...
### GetProfileSourceCode

`func (o *ProfileSummaryType) GetProfileSourceCode() string`

GetProfileSourceCode returns the ProfileSourceCode field if non-nil, zero value otherwise.

### GetProfileSourceCodeOk

`func (o *ProfileSummaryType) GetProfileSourceCodeOk() (*string, bool)`

GetProfileSourceCodeOk returns a tuple with the ProfileSourceCode field if it's non-nil, zero value otherwise
and a boolean to check if the value has been set.

### SetProfileSourceCode

`func (o *ProfileSummaryType) SetProfileSourceCode(v string)`

SetProfileSourceCode sets ProfileSourceCode field to given value.

### HasProfileSourceCode

`func (o *ProfileSummaryType) HasProfileSourceCode() bool`

HasProfileSourceCode returns a boolean if a field has been set.
