...
// APIClient manages communication with the Opera Cloud Rate Plan Asynchronous Service API API v23.2
...
type APIClient struct {
	...
	RatePlanAsyncApi *RatePlanAsyncApiService
...
func NewAPIClient(cfg *Configuration) *APIClient {
	...
	// API Services
	c.RatePlanAsyncApi = (*RatePlanAsyncApiService)(&c.common)
