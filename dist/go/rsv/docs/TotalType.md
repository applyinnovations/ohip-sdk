...
**AmountBeforeTax** | Pointer to **float32** | The total amount does not include any associated tax (e.g., sales tax, VAT, GST or any associated tax), if the amount is Tax Exclusive. However, it does Include Taxes if it is marked as Tax Inclusive. | [optional] 
**AmountBeforeAnyTax** | Pointer to **float32** | The total amount per room does not include any associated tax (e.g., sales tax, VAT, GST or any associated tax), for both Tax Exclusive/Inclusive. | [optional] 
...
**AmountBeforeTaxPerRoom** | Pointer to **float32** | The total amount per room not including any associated tax (e.g., sales tax, VAT, GST or any associated tax). | [optional] 
**AmountAfterTaxPerRoom** | Pointer to **float32** | The total amount per room including all associated taxes (e.g., sales tax, VAT, GST or any associated tax). | [optional] 
...
### GetAmountBeforeAnyTax

`func (o *TotalType) GetAmountBeforeAnyTax() float32`

GetAmountBeforeAnyTax returns the AmountBeforeAnyTax field if non-nil, zero value otherwise.

### GetAmountBeforeAnyTaxOk

`func (o *TotalType) GetAmountBeforeAnyTaxOk() (*float32, bool)`

GetAmountBeforeAnyTaxOk returns a tuple with the AmountBeforeAnyTax field if it's non-nil, zero value otherwise
and a boolean to check if the value has been set.

### SetAmountBeforeAnyTax

`func (o *TotalType) SetAmountBeforeAnyTax(v float32)`

SetAmountBeforeAnyTax sets AmountBeforeAnyTax field to given value.

### HasAmountBeforeAnyTax
...
### GetAmountBeforeTaxPerRoom

`func (o *TotalType) GetAmountBeforeTaxPerRoom() float32`

GetAmountBeforeTaxPerRoom returns the AmountBeforeTaxPerRoom field if non-nil, zero value otherwise.

### GetAmountBeforeTaxPerRoomOk

`func (o *TotalType) GetAmountBeforeTaxPerRoomOk() (*float32, bool)`

GetAmountBeforeTaxPerRoomOk returns a tuple with the AmountBeforeTaxPerRoom field if it's non-nil, zero value otherwise
and a boolean to check if the value has been set.

### SetAmountBeforeTaxPerRoom

`func (o *TotalType) SetAmountBeforeTaxPerRoom(v float32)`

SetAmountBeforeTaxPerRoom sets AmountBeforeTaxPerRoom field to given value.

### HasAmountBeforeTaxPerRoom

`func (o *TotalType) HasAmountBeforeTaxPerRoom() bool`

HasAmountBeforeTaxPerRoom returns a boolean if a field has been set.

### GetAmountAfterTaxPerRoom

`func (o *TotalType) GetAmountAfterTaxPerRoom() float32`

GetAmountAfterTaxPerRoom returns the AmountAfterTaxPerRoom field if non-nil, zero value otherwise.

### GetAmountAfterTaxPerRoomOk

`func (o *TotalType) GetAmountAfterTaxPerRoomOk() (*float32, bool)`

GetAmountAfterTaxPerRoomOk returns a tuple with the AmountAfterTaxPerRoom field if it's non-nil, zero value otherwise
and a boolean to check if the value has been set.

### SetAmountAfterTaxPerRoom

`func (o *TotalType) SetAmountAfterTaxPerRoom(v float32)`

SetAmountAfterTaxPerRoom sets AmountAfterTaxPerRoom field to given value.

### HasAmountAfterTaxPerRoom
