...
------------ | ------------- | ------------- | -------------
**ExcludeFromAutoAuthorization** | Pointer to **bool** | Indicates if the reseravtion will be excluded from auto athorization of Credit Cards. | [optional] 
...
### GetExcludeFromAutoAuthorization

`func (o *BillingPrivilegesType) GetExcludeFromAutoAuthorization() bool`

GetExcludeFromAutoAuthorization returns the ExcludeFromAutoAuthorization field if non-nil, zero value otherwise.

### GetExcludeFromAutoAuthorizationOk

`func (o *BillingPrivilegesType) GetExcludeFromAutoAuthorizationOk() (*bool, bool)`

GetExcludeFromAutoAuthorizationOk returns a tuple with the ExcludeFromAutoAuthorization field if it's non-nil, zero value otherwise
and a boolean to check if the value has been set.

### SetExcludeFromAutoAuthorization

`func (o *BillingPrivilegesType) SetExcludeFromAutoAuthorization(v bool)`

SetExcludeFromAutoAuthorization sets ExcludeFromAutoAuthorization field to given value.

### HasExcludeFromAutoAuthorization

`func (o *BillingPrivilegesType) HasExcludeFromAutoAuthorization() bool`

HasExcludeFromAutoAuthorization returns a boolean if a field has been set.
