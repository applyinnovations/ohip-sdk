...
**GuestAge** | Pointer to **int32** | Age of a guest in years. | [optional] 
...
`func (o *ProfileType) GetGuestAge() int32`

GetGuestAge returns the GuestAge field if non-nil, zero value otherwise.

### GetGuestAgeOk

`func (o *ProfileType) GetGuestAgeOk() (*int32, bool)`
...
`func (o *ProfileType) SetGuestAge(v int32)`

SetGuestAge sets GuestAge field to given value.

### HasGuestAge

`func (o *ProfileType) HasGuestAge() bool`
