...
### GetApplyUntilLastShareDepartureDate

`func (o *ChangeInstructionType) GetApplyUntilLastShareDepartureDate() bool`

GetApplyUntilLastShareDepartureDate returns the ApplyUntilLastShareDepartureDate field if non-nil, zero value otherwise.

### GetApplyUntilLastShareDepartureDateOk

`func (o *ChangeInstructionType) GetApplyUntilLastShareDepartureDateOk() (*bool, bool)`

GetApplyUntilLastShareDepartureDateOk returns a tuple with the ApplyUntilLastShareDepartureDate field if it's non-nil, zero value otherwise
and a boolean to check if the value has been set.

### SetApplyUntilLastShareDepartureDate

`func (o *ChangeInstructionType) SetApplyUntilLastShareDepartureDate(v bool)`

SetApplyUntilLastShareDepartureDate sets ApplyUntilLastShareDepartureDate field to given value.

### HasApplyUntilLastShareDepartureDate
