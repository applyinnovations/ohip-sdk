...
**RoomRates** | Pointer to [**[]RoomRateType**](RoomRateType.md) | A collection of Room Rates associated with a particular Room Stay. Each Room Rate combination can have multiple rates. Example King room, Rack rate plan, Monday through Thursday, weekday amount, Friday and Saturday, weekend amount. | [optional] 
...
**ReservationKeyInfo** | Pointer to [**ReservationKeyInfoType**](ReservationKeyInfoType.md) |  | [optional] 
