...
**EligibilityCode** | Pointer to **string** | Used by 3rd party CRS, the Eligible Reservation Code defines if this day/rate is eligible for points in the Loyalty System. | [optional] 
**AwardCode** | Pointer to **string** | Used by 3rd party CRS, the Award Code defines if this day/rate was booked as an Award in the Loyalty System. | [optional] 
**AwardNumber** | Pointer to **string** | Used by 3rd party CRS, the Award Number defines if this day/rate was booked as an Award in the Loyalty System. | [optional] 
...
**RateIncludesTax** | Pointer to **bool** | Indicates if the calculated amount for the day is inclusive of tax. | [optional] 
...
**AllowAutoCheckIn** | Pointer to **bool** | It represents whether auto check-in is enabled or not for psuedo room types. | [optional] 
...
`func (o *RoomRateType) GetEligibilityCode() string`

GetEligibilityCode returns the EligibilityCode field if non-nil, zero value otherwise.

### GetEligibilityCodeOk

`func (o *RoomRateType) GetEligibilityCodeOk() (*string, bool)`

GetEligibilityCodeOk returns a tuple with the EligibilityCode field if it's non-nil, zero value otherwise
and a boolean to check if the value has been set.

### SetEligibilityCode

`func (o *RoomRateType) SetEligibilityCode(v string)`

SetEligibilityCode sets EligibilityCode field to given value.

### HasEligibilityCode

`func (o *RoomRateType) HasEligibilityCode() bool`

HasEligibilityCode returns a boolean if a field has been set.

### GetAwardCode

`func (o *RoomRateType) GetAwardCode() string`

GetAwardCode returns the AwardCode field if non-nil, zero value otherwise.

### GetAwardCodeOk

`func (o *RoomRateType) GetAwardCodeOk() (*string, bool)`
...
`func (o *RoomRateType) SetAwardNumber(v string)`

SetAwardNumber sets AwardNumber field to given value.

### HasAwardNumber

`func (o *RoomRateType) HasAwardNumber() bool`
...
`func (o *RoomRateType) SetRateIncludesTax(v bool)`

SetRateIncludesTax sets RateIncludesTax field to given value.

### HasRateIncludesTax

`func (o *RoomRateType) HasRateIncludesTax() bool`
...
`func (o *RoomRateType) GetBookingMediumDescriptionOk() (*string, bool)`
...
`func (o *RoomRateType) SetPurposeOfStay(v string)`

SetPurposeOfStay sets PurposeOfStay field to given value.

### HasPurposeOfStay

`func (o *RoomRateType) HasPurposeOfStay() bool`
