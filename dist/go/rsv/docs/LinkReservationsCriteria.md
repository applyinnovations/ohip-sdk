...
`func (o *LinkReservationsCriteria) GetHotelId() string`

GetHotelId returns the HotelId field if non-nil, zero value otherwise.

### GetHotelIdOk

`func (o *LinkReservationsCriteria) GetHotelIdOk() (*string, bool)`
...
`func (o *LinkReservationsCriteria) SetHotelId(v string)`

SetHotelId sets HotelId field to given value.

### HasHotelId

`func (o *LinkReservationsCriteria) HasHotelId() bool`
