...
**IncludeFixedCharges** | Pointer to **bool** | Flag to indicate if fixed charges is to be included in the response, and added to the total cost of stay. | [optional] [default to true]
**IncludeDeposits** | Pointer to **bool** | Flag to indicate if paid deposits is to be included in the response, and deducted from total cost of stay when calculating for outstanding cost of stay. | [optional] [default to true]
**IncludeRouting** | Pointer to **bool** | Flag to indicate if routing and guest pay amounts are to be included in the response. | [optional] [default to true]
...
### GetIncludeFixedCharges

`func (o *ValidateRateInfoCriteria) GetIncludeFixedCharges() bool`

GetIncludeFixedCharges returns the IncludeFixedCharges field if non-nil, zero value otherwise.

### GetIncludeFixedChargesOk

`func (o *ValidateRateInfoCriteria) GetIncludeFixedChargesOk() (*bool, bool)`

GetIncludeFixedChargesOk returns a tuple with the IncludeFixedCharges field if it's non-nil, zero value otherwise
and a boolean to check if the value has been set.

### SetIncludeFixedCharges

`func (o *ValidateRateInfoCriteria) SetIncludeFixedCharges(v bool)`

SetIncludeFixedCharges sets IncludeFixedCharges field to given value.

### HasIncludeFixedCharges

`func (o *ValidateRateInfoCriteria) HasIncludeFixedCharges() bool`

HasIncludeFixedCharges returns a boolean if a field has been set.

### GetIncludeDeposits

`func (o *ValidateRateInfoCriteria) GetIncludeDeposits() bool`

GetIncludeDeposits returns the IncludeDeposits field if non-nil, zero value otherwise.

### GetIncludeDepositsOk

`func (o *ValidateRateInfoCriteria) GetIncludeDepositsOk() (*bool, bool)`

GetIncludeDepositsOk returns a tuple with the IncludeDeposits field if it's non-nil, zero value otherwise
and a boolean to check if the value has been set.

### SetIncludeDeposits

`func (o *ValidateRateInfoCriteria) SetIncludeDeposits(v bool)`

SetIncludeDeposits sets IncludeDeposits field to given value.

### HasIncludeDeposits

`func (o *ValidateRateInfoCriteria) HasIncludeDeposits() bool`

HasIncludeDeposits returns a boolean if a field has been set.

### GetIncludeRouting

`func (o *ValidateRateInfoCriteria) GetIncludeRouting() bool`

GetIncludeRouting returns the IncludeRouting field if non-nil, zero value otherwise.

### GetIncludeRoutingOk

`func (o *ValidateRateInfoCriteria) GetIncludeRoutingOk() (*bool, bool)`
...
`func (o *ValidateRateInfoCriteria) SetIncludeRouting(v bool)`

SetIncludeRouting sets IncludeRouting field to given value.

### HasIncludeRouting

`func (o *ValidateRateInfoCriteria) HasIncludeRouting() bool`
