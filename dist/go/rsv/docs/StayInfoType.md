...
**BookingTimeSpan** | Pointer to [**BookingTimeSpanType**](BookingTimeSpanType.md) |  | [optional] 
...
**ScheduledRoomMoveRoomPending** | Pointer to **bool** | Pending Scheduled Move Room. | [optional] 
...
**UpgradedByAI** | Pointer to **bool** | Represents the room was assigned by AI Room Assignment. | [optional] 
**RoomAvailableNights** | Pointer to **int32** | Number of nights this room is avaiable if room is assigned to reservation | [optional] 
...
**ScheduledRoomMoveResponseType** | Pointer to [**ScheduledRoomMoveResponseType**](ScheduledRoomMoveResponseType.md) |  | [optional] 
...
`func (o *StayInfoType) GetScheduledRoomMoveRoomPendingOk() (*bool, bool)`
...
`func (o *StayInfoType) SetBackToBackGroupId(v string)`
