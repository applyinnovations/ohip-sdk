...
[**DeleteOnHoldReservation**](ReservationAPI.md#DeleteOnHoldReservation) | **Delete** /hotels/{hotelId}/reservations/{reservationId} | Delete a Reservation by resort
...
[**DeleteReservation**](ReservationAPI.md#DeleteReservation) | **Delete** /reservations/{reservationId} | Delete a Reservation
...
[**GetDistributionReservationsSummary**](ReservationAPI.md#GetDistributionReservationsSummary) | **Get** /hotels/{hotelId}/reservations/statistics | Get Reservation DistributionReservationsSummary
...
[**PutAddOnReservationPackages**](ReservationAPI.md#PutAddOnReservationPackages) | **Put** /hotels/{hotelId}/reservations/{reservationId}/addOnReservationPackages | Update Add On (Sell Separate) packages on a reservation.
[**PutAddOnReservationPackagesByExtId**](ReservationAPI.md#PutAddOnReservationPackagesByExtId) | **Put** /hotels/{hotelId}/externalSystems/{externalSystemCode}/reservations/{reservationExternalId}/addOnReservationPackagesByExtId | Update Add On (Sell Separate) packages on a reservation
...
[**PutLinkedReservation**](ReservationAPI.md#PutLinkedReservation) | **Put** /hotels/{hotelId}/reservations/{reservationId}/linked | Update Linked Reservation by ID
...
[**PutPayeeSharer**](ReservationAPI.md#PutPayeeSharer) | **Put** /hotels/{hotelId}/reservations/{reservationId}/payeeSharer | Update Payee Sharer Information by ID.
...
[**PutReservationLinks**](ReservationAPI.md#PutReservationLinks) | **Put** /hotels/{hotelId}/reservations/linkedReservations/{reservationId} | Update Linked Reservations Common Details.
...
[**PutScheduledRoomMove**](ReservationAPI.md#PutScheduledRoomMove) | **Put** /hotels/{hotelId}/reservations/{reservationId}/scheduledRoomMoves/{scheduledMoveDate} | Update Scheduled Room Move Details based on reservationID and move date
...
[**PutValidateReservationChanges**](ReservationAPI.md#PutValidateReservationChanges) | **Put** /hotels/{hotelId}/reservations/validations | Validate Reservation Before Creating or Applying Changes
...
> Status DeleteOnHoldReservation(ctx, reservationId, hotelId).Authorization(authorization).XAppKey(xAppKey).XHotelid(xHotelid).XExternalsystem(xExternalsystem).AcceptLanguage(acceptLanguage).Execute()
...
func main() {
    reservationId := float32(8.14) // float32 | Unique OPERA reservation ID which is used to find reservation from OPERA. This ID is to delete only an on hold (in-session) reservation.
    hotelId := "hotelId_example" // string | Unique ID of the hotel where reservation is searched based on reservation ID.
    authorization := "authorization_example" // string | Bearer token that needs to be passed which is generated post user authentication
    xAppKey := "xAppKey_example" // string | Client or Partner's Application Key
    xHotelid := "xHotelid_example" // string | Mandatory parameter to identify the hotel code where the end user is logged in
    ...
    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.ReservationAPI.DeleteOnHoldReservation(context.Background(), reservationId, hotelId).Authorization(authorization).XAppKey(xAppKey).XHotelid(xHotelid).XExternalsystem(xExternalsystem).AcceptLanguage(acceptLanguage).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `ReservationAPI.DeleteOnHoldReservation``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `DeleteOnHoldReservation`: Status
    fmt.Fprintf(os.Stdout, "Response from `ReservationAPI.DeleteOnHoldReservation`: %v\n", resp)
}
```
...
------------- | ------------- | ------------- | -------------
**ctx** | **context.Context** | context for authentication, logging, cancellation, deadlines, tracing, etc.
**reservationId** | **float32** | Unique OPERA reservation ID which is used to find reservation from OPERA. This ID is to delete only an on hold (in-session) reservation. | 
**hotelId** | **string** | Unique ID of the hotel where reservation is searched based on reservation ID. | 

### Other Parameters

Other parameters are passed through a pointer to a apiDeleteOnHoldReservationRequest struct via the builder pattern
...
> Status DeleteReservation(ctx, reservationId).Authorization(authorization).XAppKey(xAppKey).XHotelid(xHotelid).XExternalsystem(xExternalsystem).AcceptLanguage(acceptLanguage).Execute()
...
func main() {
    reservationId := "reservationId_example" // string | Unique OPERA reservation ID which is used to find reservation from OPERA. This ID is to delete only an on hold (in-session) reservation.
    authorization := "authorization_example" // string | Bearer token that needs to be passed which is generated post user authentication
    xAppKey := "xAppKey_example" // string | Client or Partner's Application Key
    xHotelid := "xHotelid_example" // string | Mandatory parameter to identify the hotel code where the end user is logged in
    xExternalsystem := "xExternalsystem_example" // string | External system code. (optional)
    ...
    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.ReservationAPI.DeleteReservation(context.Background(), reservationId).Authorization(authorization).XAppKey(xAppKey).XHotelid(xHotelid).XExternalsystem(xExternalsystem).AcceptLanguage(acceptLanguage).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `ReservationAPI.DeleteReservation``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `DeleteReservation`: Status
    fmt.Fprintf(os.Stdout, "Response from `ReservationAPI.DeleteReservation`: %v\n", resp)
}
```
...
------------- | ------------- | ------------- | -------------
**ctx** | **context.Context** | context for authentication, logging, cancellation, deadlines, tracing, etc.
**reservationId** | **string** | Unique OPERA reservation ID which is used to find reservation from OPERA. This ID is to delete only an on hold (in-session) reservation. | 

### Other Parameters

Other parameters are passed through a pointer to a apiDeleteReservationRequest struct via the builder pattern
...
> Status DeleteUpsell(ctx, reservationId, hotelId).Authorization(authorization).XAppKey(xAppKey).XHotelid(xHotelid).OverrideInventory(overrideInventory).XExternalsystem(xExternalsystem).AcceptLanguage(acceptLanguage).Execute()
...
func main() {
    ...
    xAppKey := "xAppKey_example" // string | Client or Partner's Application Key
    xHotelid := "xHotelid_example" // string | Mandatory parameter to identify the hotel code where the end user is logged in
    overrideInventory := true // bool | Indicates whether to Override the Room Inventory Check (optional) (default to false)
    xExternalsystem := "xExternalsystem_example" // string | External system code. (optional)
    acceptLanguage := "acceptLanguage_example" // string | Language code (optional)

    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.ReservationAPI.DeleteUpsell(context.Background(), reservationId, hotelId).Authorization(authorization).XAppKey(xAppKey).XHotelid(xHotelid).OverrideInventory(overrideInventory).XExternalsystem(xExternalsystem).AcceptLanguage(acceptLanguage).Execute()
    if err != nil {
 ...
 **xAppKey** | **string** | Client or Partner&#39;s Application Key | 
 **xHotelid** | **string** | Mandatory parameter to identify the hotel code where the end user is logged in | 
 **overrideInventory** | **bool** | Indicates whether to Override the Room Inventory Check | [default to false]
 **xExternalsystem** | **string** | External system code. | 
 **acceptLanguage** | **string** | Language code | 
...
## GetDistributionReservationsSummary

> CheckDistributionReservationsSummary GetDistributionReservationsSummary(ctx, hotelId).Authorization(authorization).XAppKey(xAppKey).XHotelid(xHotelid).EnterpriseId(enterpriseId).ChannelCode(channelCode).StartDate(startDate).EndDate(endDate).Limit(limit).Offset(offset).XExternalsystem(xExternalsystem).AcceptLanguage(acceptLanguage).Execute()
...
func main() {
    hotelId := "hotelId_example" // string | This is the Hotel Code of the Reservations
    authorization := "authorization_example" // string | Bearer token that needs to be passed which is generated post user authentication
    xAppKey := "xAppKey_example" // string | Client or Partner's Application Key
    xHotelid := "xHotelid_example" // string | Mandatory parameter to identify the hotel code where the end user is logged in
    enterpriseId := "enterpriseId_example" // string | This is the EnterpriseId of Hotel Code (optional)
    channelCode := []string{"Inner_example"} // []string | This is the ChannelCode of Hotel Code in the Reservations (optional)
    startDate := time.Now() // string | This is the Last Updated From Date for a Reservation (optional)
    endDate := time.Now() // string | This is the Last Updated To Date for a Reservation (optional)
    ...
    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.ReservationAPI.GetDistributionReservationsSummary(context.Background(), hotelId).Authorization(authorization).XAppKey(xAppKey).XHotelid(xHotelid).EnterpriseId(enterpriseId).ChannelCode(channelCode).StartDate(startDate).EndDate(endDate).Limit(limit).Offset(offset).XExternalsystem(xExternalsystem).AcceptLanguage(acceptLanguage).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `ReservationAPI.GetDistributionReservationsSummary``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `GetDistributionReservationsSummary`: CheckDistributionReservationsSummary
    fmt.Fprintf(os.Stdout, "Response from `ReservationAPI.GetDistributionReservationsSummary`: %v\n", resp)
}
```
...
------------- | ------------- | ------------- | -------------
**ctx** | **context.Context** | context for authentication, logging, cancellation, deadlines, tracing, etc.
**hotelId** | **string** | This is the Hotel Code of the Reservations | 

### Other Parameters

Other parameters are passed through a pointer to a apiGetDistributionReservationsSummaryRequest struct via the builder pattern
 ...
 **xAppKey** | **string** | Client or Partner&#39;s Application Key | 
 **xHotelid** | **string** | Mandatory parameter to identify the hotel code where the end user is logged in | 
 **enterpriseId** | **string** | This is the EnterpriseId of Hotel Code | 
 **channelCode** | **[]string** | This is the ChannelCode of Hotel Code in the Reservations | 
 **startDate** | **string** | This is the Last Updated From Date for a Reservation | 
 **endDate** | **string** | This is the Last Updated To Date for a Reservation | 
...
[**CheckDistributionReservationsSummary**](CheckDistributionReservationsSummary.md)
...
func main() {
    ...
    externalReferenceLegId := float32(8.14) // float32 | External reference leg number (optional)
    arrivalEndDate := time.Now() // string | The ending value of the date range. (optional)
    arrivalStartDate := time.Now() // string | The starting value of the date range. (optional)
    departureEndDate := time.Now() // string | The ending value of the date range. (optional)
    departureStartDate := time.Now() // string | The starting value of the date range. (optional)
    ...
    profileId := "profileId_example" // string | Unique Identifier for a guest profile associated with the reservation(s) (optional)
    commissionPaid := true // bool | Commission Paid criteria (optional)
    vouchersGenerated := true // bool | All reservations with generated vouchers to be returned if vouchersGenerated is set to true. All reservations without the generated vouchers to be returned if it is set to false. (optional)
    membershipCardNumber := "membershipCardNumber_example" // string | Membership ID criteria. (optional)
    membershipLevels := []string{"Inner_example"} // []string |  (optional)
    membershipTypes := []string{"Inner_example"} // []string |  (optional)
    reservationsWithMembershipType := true // bool | When set to true, only reservations with a membership belonging to the specified membership type will be returned (optional)
    surname := "surname_example" // string | Family name, last name. (optional)
    givenName := "givenName_example" // string | Given name, first name or names (optional)
    ...
    roomRangeTo := "roomRangeTo_example" // string |  (optional)
    communication := "communication_example" // string | Filter by the last digits of a reservation's phone number. (optional)
    fetchInstructions := []string{"FetchInstructions_example"} // []string | Instruction on which elements of the reservation are to be fetched. Instructions are cumulative i.e. additional elements would be added, but not duplicated. (optional)
    ...
    daysSinceLastAutoSettled := float32(8.14) // float32 | Use the Number of days since last auto settled. (optional)
    dateSinceLastAutoSettled := time.Now() // string | Use the Date since last auto settled. (optional)
    excludePseudoRoomReservations := true // bool | Indicates to exclude Pseudo room reservations. (optional)
    excludeReservationIds := []string{"Inner_example"} // []string | A unique identifying value assigned by the creating system. The ID attribute may be used to reference a primary-key value within a database or in a particular implementation. (optional)
    excludeVIPStatusCodes := []string{"Inner_example"} // []string | VIP status of the customer. (optional)
    excludeSpecials := []string{"Inner_example"} // []string | Preference value for display purposes. (optional)
    ...
    taRecordLocatorList := []string{"Inner_example"} // []string | Travel Agent Record Locators List. (optional)
    packageCodes := []string{"Inner_example"} // []string | Package Codes and Package Groups to be searched, can only be used when searching for reservations at a single property with a maximum date range of 90 days. It is required to populate either Arrival From/To, Departure From/To, or the Stay Date filter(s). (optional)
    inventoryItems := []string{"Inner_example"} // []string | Inventory Items to be searched, can only be used when searching for reservations at a single property with a maximum date range of 90 days. It is required to populate either Arrival From/To, Departure From/To, or the Stay Date filter(s) (optional)
    guaranteeCodes := []string{"Inner_example"} // []string | Fetches the reservation having Guarantee Codes(Reservation Type) supplied here. Example guaranteeCodes=6PM (optional)
    linkedName := "linkedName_example" // string | Name of the group of Linked Reservations to be searched. (optional)
    backToBackOnly := true // bool | Indicates that only reservations marked as Back to Back should be expected in the result. (optional)
    backToBackDateOn := time.Now() // string | Fetches linked Back to Back reservations with the specified Back to Back Date. Fetched reservations will be marked as Back to Back and they will either depart or arrive on the specified Back to Back day. (optional)
    scheduledRoomMoveDate := time.Now() // string | Scheduled Move Rooms Date Criteria. This will parameter be mandatory when search Type is ScheduledRoomMove. (optional)
    scheduledRoomMoveStartTime := "scheduledRoomMoveStartTime_example" // string | Start of Scheduled Move Room Time Range Criteria (in 24 hour time format). Applicable when Search Type is ScheduledRoomMove. (optional)
    scheduledRoomMoveEndTime := "scheduledRoomMoveEndTime_example" // string | End of Scheduled Move Room Time Range Criteria (in 24 hour time format). Applicable when Search Type is ScheduledRoomMove. (optional)
    scheduledRoomMoveStatus := "scheduledRoomMoveStatus_example" // string | Scheduled Move Room Status Criteria. (optional)
    excludeBackToBackReservations := true // bool | When this flag is set to true, it will exclude the linked reservations which are marked as Back to Back in the result. Marking reservations as Back to Back is available when the Back to Back Handling for Linked Reservations OPERA control is active. (optional)
    xExternalsystem := "xExternalsystem_example" // string | External system code. (optional)
    acceptLanguage := "acceptLanguage_example" // string | Language code (optional)
 ...
 **externalReferenceLegId** | **float32** | External reference leg number | 
 **arrivalEndDate** | **string** | The ending value of the date range. | 
 **arrivalStartDate** | **string** | The starting value of the date range. | 
 **departureEndDate** | **string** | The ending value of the date range. | 
 **departureStartDate** | **string** | The starting value of the date range. | 
 ...
 **profileId** | **string** | Unique Identifier for a guest profile associated with the reservation(s) | 
 **commissionPaid** | **bool** | Commission Paid criteria | 
 **vouchersGenerated** | **bool** | All reservations with generated vouchers to be returned if vouchersGenerated is set to true. All reservations without the generated vouchers to be returned if it is set to false. | 
 **membershipCardNumber** | **string** | Membership ID criteria. | 
 **membershipLevels** | **[]string** |  | 
 **membershipTypes** | **[]string** |  | 
 **reservationsWithMembershipType** | **bool** | When set to true, only reservations with a membership belonging to the specified membership type will be returned | 
 **surname** | **string** | Family name, last name. | 
 **givenName** | **string** | Given name, first name or names | 
 ...
 **roomRangeTo** | **string** |  | 
 **communication** | **string** | Filter by the last digits of a reservation&#39;s phone number. | 
 **fetchInstructions** | **[]string** | Instruction on which elements of the reservation are to be fetched. Instructions are cumulative i.e. additional elements would be added, but not duplicated. | 
 ...
 **daysSinceLastAutoSettled** | **float32** | Use the Number of days since last auto settled. | 
 **dateSinceLastAutoSettled** | **string** | Use the Date since last auto settled. | 
 **excludePseudoRoomReservations** | **bool** | Indicates to exclude Pseudo room reservations. | 
 **excludeReservationIds** | **[]string** | A unique identifying value assigned by the creating system. The ID attribute may be used to reference a primary-key value within a database or in a particular implementation. | 
 **excludeVIPStatusCodes** | **[]string** | VIP status of the customer. | 
 **excludeSpecials** | **[]string** | Preference value for display purposes. | 
 ...
 **taRecordLocatorList** | **[]string** | Travel Agent Record Locators List. | 
 **packageCodes** | **[]string** | Package Codes and Package Groups to be searched, can only be used when searching for reservations at a single property with a maximum date range of 90 days. It is required to populate either Arrival From/To, Departure From/To, or the Stay Date filter(s). | 
 **inventoryItems** | **[]string** | Inventory Items to be searched, can only be used when searching for reservations at a single property with a maximum date range of 90 days. It is required to populate either Arrival From/To, Departure From/To, or the Stay Date filter(s) | 
 ...
 **linkedName** | **string** | Name of the group of Linked Reservations to be searched. | 
 **backToBackOnly** | **bool** | Indicates that only reservations marked as Back to Back should be expected in the result. | 
 **backToBackDateOn** | **string** | Fetches linked Back to Back reservations with the specified Back to Back Date. Fetched reservations will be marked as Back to Back and they will either depart or arrive on the specified Back to Back day. | 
 **scheduledRoomMoveDate** | **string** | Scheduled Move Rooms Date Criteria. This will parameter be mandatory when search Type is ScheduledRoomMove. | 
 **scheduledRoomMoveStartTime** | **string** | Start of Scheduled Move Room Time Range Criteria (in 24 hour time format). Applicable when Search Type is ScheduledRoomMove. | 
 **scheduledRoomMoveEndTime** | **string** | End of Scheduled Move Room Time Range Criteria (in 24 hour time format). Applicable when Search Type is ScheduledRoomMove. | 
 **scheduledRoomMoveStatus** | **string** | Scheduled Move Room Status Criteria. | 
 **excludeBackToBackReservations** | **bool** | When this flag is set to true, it will exclude the linked reservations which are marked as Back to Back in the result. Marking reservations as Back to Back is available when the Back to Back Handling for Linked Reservations OPERA control is active. | 
 **xExternalsystem** | **string** | External system code. | 
 **acceptLanguage** | **string** | Language code | 
...
> LinkedReservationsInfo GetLinkedReservationsSummary(ctx, reservationId, hotelId).Authorization(authorization).XAppKey(xAppKey).XHotelid(xHotelid).AdditionalReservationId(additionalReservationId).AdditionalReservationIdType(additionalReservationIdType).BackToBackOnly(backToBackOnly).XExternalsystem(xExternalsystem).AcceptLanguage(acceptLanguage).Execute()
...
func main() {
    ...
    additionalReservationId := []string{"Inner_example"} // []string | A unique identifying value assigned by the creating system. The ID attribute may be used to reference a primary-key value within a database or in a particular implementation. (optional)
    additionalReservationIdType := []string{"Inner_example"} // []string | A reference to the type of object defined by the UniqueID element. (optional)
    backToBackOnly := true // bool | Indicates that only reservations marked as Back to Back should be expected in the result. Returned linked Back to Back reservations will belong to the same group of linked Back to Back reservations as the specified reservation with the given reservation name id and hotel code. (optional)
    xExternalsystem := "xExternalsystem_example" // string | External system code. (optional)
    acceptLanguage := "acceptLanguage_example" // string | Language code (optional)

    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.ReservationAPI.GetLinkedReservationsSummary(context.Background(), reservationId, hotelId).Authorization(authorization).XAppKey(xAppKey).XHotelid(xHotelid).AdditionalReservationId(additionalReservationId).AdditionalReservationIdType(additionalReservationIdType).BackToBackOnly(backToBackOnly).XExternalsystem(xExternalsystem).AcceptLanguage(acceptLanguage).Execute()
    if err != nil {
 ...
 **additionalReservationId** | **[]string** | A unique identifying value assigned by the creating system. The ID attribute may be used to reference a primary-key value within a database or in a particular implementation. | 
 **additionalReservationIdType** | **[]string** | A reference to the type of object defined by the UniqueID element. | 
 **backToBackOnly** | **bool** | Indicates that only reservations marked as Back to Back should be expected in the result. Returned linked Back to Back reservations will belong to the same group of linked Back to Back reservations as the specified reservation with the given reservation name id and hotel code. | 
 **xExternalsystem** | **string** | External system code. | 
 **acceptLanguage** | **string** | Language code | 
...
> Packages GetPackage(ctx, reservationId, hotelId).ProductCode(productCode).Authorization(authorization).XAppKey(xAppKey).XHotelid(xHotelid).PostingRhythm(postingRhythm).RatePlanCode(ratePlanCode).ReservationTimeSpanStartDate(reservationTimeSpanStartDate).ReservationTimeSpanEndDate(reservationTimeSpanEndDate).PackageTimeSpanStartDate(packageTimeSpanStartDate).PackageTimeSpanEndDate(packageTimeSpanEndDate).PackageQuantity(packageQuantity).PackageExcludedQuantity(packageExcludedQuantity).ReservationAdults(reservationAdults).ReservationChildren(reservationChildren).FetchInstructions(fetchInstructions).XExternalsystem(xExternalsystem).AcceptLanguage(acceptLanguage).Execute()
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.ReservationAPI.GetPackage(context.Background(), reservationId, hotelId).ProductCode(productCode).Authorization(authorization).XAppKey(xAppKey).XHotelid(xHotelid).PostingRhythm(postingRhythm).RatePlanCode(ratePlanCode).ReservationTimeSpanStartDate(reservationTimeSpanStartDate).ReservationTimeSpanEndDate(reservationTimeSpanEndDate).PackageTimeSpanStartDate(packageTimeSpanStartDate).PackageTimeSpanEndDate(packageTimeSpanEndDate).PackageQuantity(packageQuantity).PackageExcludedQuantity(packageExcludedQuantity).ReservationAdults(reservationAdults).ReservationChildren(reservationChildren).FetchInstructions(fetchInstructions).XExternalsystem(xExternalsystem).AcceptLanguage(acceptLanguage).Execute()
    if err != nil {
...
func main() {
    ...
    reservationId := "reservationId_example" // string | Unique OPERA reservation ID which is used to find reservation from OPERA. This ID is a primary identification of a reservation in OPERA. (optional)
    xExternalsystem := "xExternalsystem_example" // string | External system code. (optional)
    acceptLanguage := "acceptLanguage_example" // string | Language code (optional)
...
> Reservation GetReservation(ctx, reservationId, hotelId).Authorization(authorization).XAppKey(xAppKey).XHotelid(xHotelid).FetchInstructions(fetchInstructions).AllowedActions(allowedActions).MarkAsRecentlyAccessed(markAsRecentlyAccessed).IncludeInSession(includeInSession).XExternalsystem(xExternalsystem).AcceptLanguage(acceptLanguage).Execute()
...
func main() {
    ...
    xAppKey := "xAppKey_example" // string | Client or Partner's Application Key
    xHotelid := "xHotelid_example" // string | Mandatory parameter to identify the hotel code where the end user is logged in
    fetchInstructions := []string{"FetchInstructions_example"} // []string | Instruction on which of the reservation's elements are to be returned e.g. DailySummary will return summarized information for each day of the reservation. Instructions are cumulative i.e. if multiple instructions are sent in a request, then the combined reservation elements would be returned, elements will not be duplicated in the response. (optional)
    ...
    includeInSession := true // bool | Flag indicating whether to fetch the in-session reservation. (optional)
    xExternalsystem := "xExternalsystem_example" // string | External system code. (optional)
    acceptLanguage := "acceptLanguage_example" // string | Language code (optional)

    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.ReservationAPI.GetReservation(context.Background(), reservationId, hotelId).Authorization(authorization).XAppKey(xAppKey).XHotelid(xHotelid).FetchInstructions(fetchInstructions).AllowedActions(allowedActions).MarkAsRecentlyAccessed(markAsRecentlyAccessed).IncludeInSession(includeInSession).XExternalsystem(xExternalsystem).AcceptLanguage(acceptLanguage).Execute()
    if err != nil {
 ...
 **xAppKey** | **string** | Client or Partner&#39;s Application Key | 
 **xHotelid** | **string** | Mandatory parameter to identify the hotel code where the end user is logged in | 
 **fetchInstructions** | **[]string** | Instruction on which of the reservation&#39;s elements are to be returned e.g. DailySummary will return summarized information for each day of the reservation. Instructions are cumulative i.e. if multiple instructions are sent in a request, then the combined reservation elements would be returned, elements will not be duplicated in the response. | 
 ...
 **includeInSession** | **bool** | Flag indicating whether to fetch the in-session reservation. | 
 **xExternalsystem** | **string** | External system code. | 
 **acceptLanguage** | **string** | Language code | 
...
> ReservationAttachments GetReservationAttachments(ctx, reservationId, hotelId).Authorization(authorization).XAppKey(xAppKey).XHotelid(xHotelid).WebRegistrationCard(webRegistrationCard).AttachedFileName(attachedFileName).Description(description).XExternalsystem(xExternalsystem).AcceptLanguage(acceptLanguage).Execute()
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.ReservationAPI.GetReservationAttachments(context.Background(), reservationId, hotelId).Authorization(authorization).XAppKey(xAppKey).XHotelid(xHotelid).WebRegistrationCard(webRegistrationCard).AttachedFileName(attachedFileName).Description(description).XExternalsystem(xExternalsystem).AcceptLanguage(acceptLanguage).Execute()
    if err != nil {
...
> CheckReservationsDetails GetReservationIndicators(ctx).Authorization(authorization).XAppKey(xAppKey).XHotelid(xHotelid).ReservationId(reservationId).HotelId(hotelId).CheckInstructions(checkInstructions).XExternalsystem(xExternalsystem).AcceptLanguage(acceptLanguage).Execute()
...
func main() {
    ...
    hotelId := []string{"Inner_example"} // []string | Hotel code of each reservation ID. If more than one reservation id is requested from multiple hotels, this is needed to identify per reservation id. Example reservationId=123&hotelId=PROP1&reservationId=456&hotelId=PROP2 (optional)
    ...
    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.ReservationAPI.GetReservationIndicators(context.Background()).Authorization(authorization).XAppKey(xAppKey).XHotelid(xHotelid).ReservationId(reservationId).HotelId(hotelId).CheckInstructions(checkInstructions).XExternalsystem(xExternalsystem).AcceptLanguage(acceptLanguage).Execute()
    if err != nil {
 ...
 **xHotelid** | **string** | Mandatory parameter to identify the hotel code where the end user is logged in | 
 **reservationId** | **[]string** | A unique identifying value assigned by the creating system. The ID attribute may be used to reference a primary-key value within a database or in a particular implementation. | 
 **hotelId** | **[]string** | Hotel code of each reservation ID. If more than one reservation id is requested from multiple hotels, this is needed to identify per reservation id. Example reservationId&#x3D;123&amp;hotelId&#x3D;PROP1&amp;reservationId&#x3D;456&amp;hotelId&#x3D;PROP2 | 
...
func main() {
    ...
    roomRangeTo := "roomRangeTo_example" // string |  (optional)
    communication := "communication_example" // string | Filter by the last digits of a reservation's phone number. (optional)
    fetchInstructions := []string{"FetchInstructions_example"} // []string | Instruction on which of the reservation's elements are to be returned. Instructions are cumulative i.e. if multiple instructions are sent in a request, then the combined reservation elements would be returned, elements will not be duplicated in the response. (optional)
    allowedReservationActions := []string{"AllowedReservationActions_example"} // []string | Flag indicating whether the Enrollment is in progress or not for the Profile associated with this Reservation. (optional)
    allowPreRegistration := true // bool | Flag containing true or false value for reservation to be eligible for prior check in by guest using mobile device. Pass the 'true' or 'false' values when creating / modifying reservation to indicate whether a reservation is eligible for mobile check in yes / no. Upon fetch, the current state of the flag will show true or false. (optional)
    hasDepositBalance := true // bool | Indicates that only reservations with deposit balance should be expected from the result. (optional)
    hasOpenBalance := true // bool | Indicates that only reservations with open balance should be expected from the result. (optional)
 ...
 **roomRangeTo** | **string** |  | 
 **communication** | **string** | Filter by the last digits of a reservation&#39;s phone number. | 
 **fetchInstructions** | **[]string** | Instruction on which of the reservation&#39;s elements are to be returned. Instructions are cumulative i.e. if multiple instructions are sent in a request, then the combined reservation elements would be returned, elements will not be duplicated in the response. | 
 **allowedReservationActions** | **[]string** | Flag indicating whether the Enrollment is in progress or not for the Profile associated with this Reservation. | 
 **allowPreRegistration** | **bool** | Flag containing true or false value for reservation to be eligible for prior check in by guest using mobile device. Pass the &#39;true&#39; or &#39;false&#39; values when creating / modifying reservation to indicate whether a reservation is eligible for mobile check in yes / no. Upon fetch, the current state of the flag will show true or false. | 
 **hasDepositBalance** | **bool** | Indicates that only reservations with deposit balance should be expected from the result. | 
 **hasOpenBalance** | **bool** | Indicates that only reservations with open balance should be expected from the result. | 
...
> FetchReservations GetReservationsToShareByReservationId(ctx, reservationIdtoShare, hotelId).Authorization(authorization).XAppKey(xAppKey).XHotelid(xHotelid).Limit(limit).SuperSearch(superSearch).ReservationGuestId(reservationGuestId).ReservationGuestIdType(reservationGuestIdType).MembershipId(membershipId).MembershipLevel(membershipLevel).MembershipType(membershipType).Surname(surname).GivenName(givenName).RoomId(roomId).CancellationNumberList(cancellationNumberList).ExternalReferenceIds(externalReferenceIds).ExternalSystemCodes(externalSystemCodes).ConfirmationNumberList(confirmationNumberList).TaRecordLocatorList(taRecordLocatorList).ReservationStatuses(reservationStatuses).LinkedName(linkedName).FetchInstructions(fetchInstructions).XExternalsystem(xExternalsystem).AcceptLanguage(acceptLanguage).Execute()
...
func main() {
    ...
    confirmationNumberList := []string{"Inner_example"} // []string | A unique identifying value assigned by the creating system. The ID attribute may be used to reference a primary-key value within a database or in a particular implementation. (optional)
    taRecordLocatorList := []string{"Inner_example"} // []string | Travel Agent Record Locators List. (optional)
    reservationStatuses := []string{"ReservationStatuses_example"} // []string | Reservation status list for reservations search. (optional)
    linkedName := "linkedName_example" // string | Name of the group of Linked Reservations to be searched. (optional)
    fetchInstructions := []string{"FetchInstructions_example"} // []string | Instruction to fetch whether the room was assigned/upgraded by AI. This will also include Reservation instruction. (optional)
    xExternalsystem := "xExternalsystem_example" // string | External system code. (optional)
    acceptLanguage := "acceptLanguage_example" // string | Language code (optional)
 ...
 **confirmationNumberList** | **[]string** | A unique identifying value assigned by the creating system. The ID attribute may be used to reference a primary-key value within a database or in a particular implementation. | 
 **taRecordLocatorList** | **[]string** | Travel Agent Record Locators List. | 
 **reservationStatuses** | **[]string** | Reservation status list for reservations search. | 
 **linkedName** | **string** | Name of the group of Linked Reservations to be searched. | 
 **fetchInstructions** | **[]string** | Instruction to fetch whether the room was assigned/upgraded by AI. This will also include Reservation instruction. | 
 **xExternalsystem** | **string** | External system code. | 
 **acceptLanguage** | **string** | Language code | 
...
> RoomCalendar GetRoomCalendar(ctx, hotelId).Authorization(authorization).XAppKey(xAppKey).XHotelid(xHotelid).AdvanceCheckedIn(advanceCheckedIn).AssignedRooms(assignedRooms).ComponentRooms(componentRooms).ConnectingRoomsOnly(connectingRoomsOnly).BackToBackOnly(backToBackOnly).ScheduledRoomMoveOnly(scheduledRoomMoveOnly).DueOut(dueOut).EndDate(endDate).IsSortDescending(isSortDescending).PageIndex(pageIndex).PartiallyAssignedRooms(partiallyAssignedRooms).RecordsPerPage(recordsPerPage).RoomConditions(roomConditions).OwnerRoomsOnly(ownerRoomsOnly).OwnerExclusiveOnly(ownerExclusiveOnly).SortingBy(sortingBy).IncludeRoomMoveHistory(includeRoomMoveHistory).IncludeComponentRoomBlockOutDates(includeComponentRoomBlockOutDates).StartDate(startDate).UnassignedRooms(unassignedRooms).RoomId(roomId).RoomType(roomType).RoomClass(roomClass).Floor(floor).RoomFeature(roomFeature).RoomStatus(roomStatus).SmokingPreference(smokingPreference).BedType(bedType).ShowRoomMoveSegments(showRoomMoveSegments).XExternalsystem(xExternalsystem).AcceptLanguage(acceptLanguage).Execute()
...
func main() {
    ...
    backToBackOnly := true // bool | Indicates that only reservations marked as Back to Back should be expected in the result. (optional)
    scheduledRoomMoveOnly := true // bool | Indicates that only reservations having scheduled room moves should be expected in the result. (optional)
    ...
    showRoomMoveSegments := true // bool | If set to true then reservations having past or future room moves will come according to the exact stay dates in the rooms. (optional)
    xExternalsystem := "xExternalsystem_example" // string | External system code. (optional)
    acceptLanguage := "acceptLanguage_example" // string | Language code (optional)

    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.ReservationAPI.GetRoomCalendar(context.Background(), hotelId).Authorization(authorization).XAppKey(xAppKey).XHotelid(xHotelid).AdvanceCheckedIn(advanceCheckedIn).AssignedRooms(assignedRooms).ComponentRooms(componentRooms).ConnectingRoomsOnly(connectingRoomsOnly).BackToBackOnly(backToBackOnly).ScheduledRoomMoveOnly(scheduledRoomMoveOnly).DueOut(dueOut).EndDate(endDate).IsSortDescending(isSortDescending).PageIndex(pageIndex).PartiallyAssignedRooms(partiallyAssignedRooms).RecordsPerPage(recordsPerPage).RoomConditions(roomConditions).OwnerRoomsOnly(ownerRoomsOnly).OwnerExclusiveOnly(ownerExclusiveOnly).SortingBy(sortingBy).IncludeRoomMoveHistory(includeRoomMoveHistory).IncludeComponentRoomBlockOutDates(includeComponentRoomBlockOutDates).StartDate(startDate).UnassignedRooms(unassignedRooms).RoomId(roomId).RoomType(roomType).RoomClass(roomClass).Floor(floor).RoomFeature(roomFeature).RoomStatus(roomStatus).SmokingPreference(smokingPreference).BedType(bedType).ShowRoomMoveSegments(showRoomMoveSegments).XExternalsystem(xExternalsystem).AcceptLanguage(acceptLanguage).Execute()
    if err != nil {
 ...
 **backToBackOnly** | **bool** | Indicates that only reservations marked as Back to Back should be expected in the result. | 
 **scheduledRoomMoveOnly** | **bool** | Indicates that only reservations having scheduled room moves should be expected in the result. | 
 ...
 **bedType** | **[]string** |  | 
 **showRoomMoveSegments** | **bool** | If set to true then reservations having past or future room moves will come according to the exact stay dates in the rooms. | 
 **xExternalsystem** | **string** | External system code. | 
 **acceptLanguage** | **string** | Language code | 
...
## PutAddOnReservationPackages

> AddOnReservationPackagesType PutAddOnReservationPackages(ctx, reservationId, hotelId).Authorization(authorization).XAppKey(xAppKey).XHotelid(xHotelid).ReservationAddOnPackages(reservationAddOnPackages).XExternalsystem(xExternalsystem).AcceptLanguage(acceptLanguage).Execute()
...
func main() {
    reservationId := float32(8.14) // float32 | Unique OPERA reservation ID which is used to find reservation from OPERA. This ID is a primary identification of a reservation in OPERA.
    hotelId := "hotelId_example" // string | Unique ID of the hotel where reservation is searched based on reservation ID.
    authorization := "authorization_example" // string | Bearer token that needs to be passed which is generated post user authentication
    xAppKey := "xAppKey_example" // string | Client or Partner's Application Key
    xHotelid := "xHotelid_example" // string | Mandatory parameter to identify the hotel code where the end user is logged in
    reservationAddOnPackages := *openapiclient.NewReservationAddOnPackagesType() // ReservationAddOnPackagesType | Request object to overlay addon packages on an existing reservation.
    xExternalsystem := "xExternalsystem_example" // string | External system code. (optional)
    acceptLanguage := "acceptLanguage_example" // string | Language code (optional)

    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.ReservationAPI.PutAddOnReservationPackages(context.Background(), reservationId, hotelId).Authorization(authorization).XAppKey(xAppKey).XHotelid(xHotelid).ReservationAddOnPackages(reservationAddOnPackages).XExternalsystem(xExternalsystem).AcceptLanguage(acceptLanguage).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `ReservationAPI.PutAddOnReservationPackages``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `PutAddOnReservationPackages`: AddOnReservationPackagesType
    fmt.Fprintf(os.Stdout, "Response from `ReservationAPI.PutAddOnReservationPackages`: %v\n", resp)
}
```
...
------------- | ------------- | ------------- | -------------
**ctx** | **context.Context** | context for authentication, logging, cancellation, deadlines, tracing, etc.
**reservationId** | **float32** | Unique OPERA reservation ID which is used to find reservation from OPERA. This ID is a primary identification of a reservation in OPERA. | 
**hotelId** | **string** | Unique ID of the hotel where reservation is searched based on reservation ID. | 

### Other Parameters

Other parameters are passed through a pointer to a apiPutAddOnReservationPackagesRequest struct via the builder pattern
 ...
 **xAppKey** | **string** | Client or Partner&#39;s Application Key | 
 **xHotelid** | **string** | Mandatory parameter to identify the hotel code where the end user is logged in | 
 **reservationAddOnPackages** | [**ReservationAddOnPackagesType**](ReservationAddOnPackagesType.md) | Request object to overlay addon packages on an existing reservation. | 
 **xExternalsystem** | **string** | External system code. | 
 **acceptLanguage** | **string** | Language code | 

### Return type

[**AddOnReservationPackagesType**](AddOnReservationPackagesType.md)
...
## PutAddOnReservationPackagesByExtId

> AddOnReservationPackagesType PutAddOnReservationPackagesByExtId(ctx, reservationExternalId, externalSystemCode, hotelId).Authorization(authorization).XAppKey(xAppKey).XHotelid(xHotelid).ReservationAddOnPackages(reservationAddOnPackages).LegNumber(legNumber).XExternalsystem(xExternalsystem).AcceptLanguage(acceptLanguage).Execute()
...
func main() {
    ...
    xHotelid := "xHotelid_example" // string | Mandatory parameter to identify the hotel code where the end user is logged in
    reservationAddOnPackages := *openapiclient.NewReservationAddOnPackagesType() // ReservationAddOnPackagesType | Request object to overlay addon packages on an existing reservation.
    legNumber := float32(8.14) // float32 | External system Leg Number for the reservation. (optional)
    xExternalsystem := "xExternalsystem_example" // string | External system code. (optional)
    acceptLanguage := "acceptLanguage_example" // string | Language code (optional)

    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.ReservationAPI.PutAddOnReservationPackagesByExtId(context.Background(), reservationExternalId, externalSystemCode, hotelId).Authorization(authorization).XAppKey(xAppKey).XHotelid(xHotelid).ReservationAddOnPackages(reservationAddOnPackages).LegNumber(legNumber).XExternalsystem(xExternalsystem).AcceptLanguage(acceptLanguage).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `ReservationAPI.PutAddOnReservationPackagesByExtId``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `PutAddOnReservationPackagesByExtId`: AddOnReservationPackagesType
    fmt.Fprintf(os.Stdout, "Response from `ReservationAPI.PutAddOnReservationPackagesByExtId`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiPutAddOnReservationPackagesByExtIdRequest struct via the builder pattern
 ...
 **xHotelid** | **string** | Mandatory parameter to identify the hotel code where the end user is logged in | 
 **reservationAddOnPackages** | [**ReservationAddOnPackagesType**](ReservationAddOnPackagesType.md) | Request object to overlay addon packages on an existing reservation. | 
 **legNumber** | **float32** | External system Leg Number for the reservation. | 
 **xExternalsystem** | **string** | External system code. | 
 **acceptLanguage** | **string** | Language code | 
...
## PutLinkedReservation

> Status PutLinkedReservation(ctx, reservationId, hotelId).Authorization(authorization).XAppKey(xAppKey).XHotelid(xHotelid).ChangeLinkedReservation(changeLinkedReservation).XExternalsystem(xExternalsystem).AcceptLanguage(acceptLanguage).Execute()
...
func main() {
    ...
    xAppKey := "xAppKey_example" // string | Client or Partner's Application Key
    xHotelid := "xHotelid_example" // string | Mandatory parameter to identify the hotel code where the end user is logged in
    changeLinkedReservation := *openapiclient.NewChangeLinkedReservationType() // ChangeLinkedReservationType | Request object to change a linked reservation information.
    xExternalsystem := "xExternalsystem_example" // string | External system code. (optional)
    acceptLanguage := "acceptLanguage_example" // string | Language code (optional)

    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.ReservationAPI.PutLinkedReservation(context.Background(), reservationId, hotelId).Authorization(authorization).XAppKey(xAppKey).XHotelid(xHotelid).ChangeLinkedReservation(changeLinkedReservation).XExternalsystem(xExternalsystem).AcceptLanguage(acceptLanguage).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `ReservationAPI.PutLinkedReservation``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `PutLinkedReservation`: Status
    fmt.Fprintf(os.Stdout, "Response from `ReservationAPI.PutLinkedReservation`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiPutLinkedReservationRequest struct via the builder pattern
 ...
 **xAppKey** | **string** | Client or Partner&#39;s Application Key | 
 **xHotelid** | **string** | Mandatory parameter to identify the hotel code where the end user is logged in | 
 **changeLinkedReservation** | [**ChangeLinkedReservationType**](ChangeLinkedReservationType.md) | Request object to change a linked reservation information. | 
 **xExternalsystem** | **string** | External system code. | 
 **acceptLanguage** | **string** | Language code | 
...
> Status PutPayeeSharer(ctx, reservationId, hotelId).Authorization(authorization).XAppKey(xAppKey).XHotelid(xHotelid).ChangePayeeSharer(changePayeeSharer).XExternalsystem(xExternalsystem).AcceptLanguage(acceptLanguage).Execute()
...
func main() {
    ...
    xAppKey := "xAppKey_example" // string | Client or Partner's Application Key
    xHotelid := "xHotelid_example" // string | Mandatory parameter to identify the hotel code where the end user is logged in
    changePayeeSharer := *openapiclient.NewChangePayeeSharerType() // ChangePayeeSharerType | Request object to to mark or unmark the payee sharer information.
    xExternalsystem := "xExternalsystem_example" // string | External system code. (optional)
    acceptLanguage := "acceptLanguage_example" // string | Language code (optional)

    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.ReservationAPI.PutPayeeSharer(context.Background(), reservationId, hotelId).Authorization(authorization).XAppKey(xAppKey).XHotelid(xHotelid).ChangePayeeSharer(changePayeeSharer).XExternalsystem(xExternalsystem).AcceptLanguage(acceptLanguage).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `ReservationAPI.PutPayeeSharer``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `PutPayeeSharer`: Status
    fmt.Fprintf(os.Stdout, "Response from `ReservationAPI.PutPayeeSharer`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiPutPayeeSharerRequest struct via the builder pattern
 ...
 **xAppKey** | **string** | Client or Partner&#39;s Application Key | 
 **xHotelid** | **string** | Mandatory parameter to identify the hotel code where the end user is logged in | 
 **changePayeeSharer** | [**ChangePayeeSharerType**](ChangePayeeSharerType.md) | Request object to to mark or unmark the payee sharer information. | 
 **xExternalsystem** | **string** | External system code. | 
 **acceptLanguage** | **string** | Language code | 
...
> LinkedReservationsCommonDetails PutReservationLinks(ctx, hotelId, reservationId).Authorization(authorization).XAppKey(xAppKey).XHotelid(xHotelid).ChangeLinkedReservationsCommonDetails(changeLinkedReservationsCommonDetails).XExternalsystem(xExternalsystem).AcceptLanguage(acceptLanguage).Execute()
...
func main() {
    ...
    xAppKey := "xAppKey_example" // string | Client or Partner's Application Key
    xHotelid := "xHotelid_example" // string | Mandatory parameter to identify the hotel code where the end user is logged in
    changeLinkedReservationsCommonDetails := *openapiclient.NewChangeLinkedReservationsCommonDetails() // ChangeLinkedReservationsCommonDetails | Request object with attributes to be updated on all linked reservations.
    xExternalsystem := "xExternalsystem_example" // string | External system code. (optional)
    acceptLanguage := "acceptLanguage_example" // string | Language code (optional)

    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.ReservationAPI.PutReservationLinks(context.Background(), hotelId, reservationId).Authorization(authorization).XAppKey(xAppKey).XHotelid(xHotelid).ChangeLinkedReservationsCommonDetails(changeLinkedReservationsCommonDetails).XExternalsystem(xExternalsystem).AcceptLanguage(acceptLanguage).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `ReservationAPI.PutReservationLinks``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `PutReservationLinks`: LinkedReservationsCommonDetails
    fmt.Fprintf(os.Stdout, "Response from `ReservationAPI.PutReservationLinks`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiPutReservationLinksRequest struct via the builder pattern
 ...
 **xAppKey** | **string** | Client or Partner&#39;s Application Key | 
 **xHotelid** | **string** | Mandatory parameter to identify the hotel code where the end user is logged in | 
 **changeLinkedReservationsCommonDetails** | [**ChangeLinkedReservationsCommonDetails**](ChangeLinkedReservationsCommonDetails.md) | Request object with attributes to be updated on all linked reservations. | 
 **xExternalsystem** | **string** | External system code. | 
 **acceptLanguage** | **string** | Language code | 

### Return type

[**LinkedReservationsCommonDetails**](LinkedReservationsCommonDetails.md)
...
## PutScheduledRoomMove

> ScheduledRoomMoveDetails PutScheduledRoomMove(ctx, reservationId, hotelId, scheduledMoveDate).Authorization(authorization).XAppKey(xAppKey).XHotelid(xHotelid).ScheduledRoomMoveDetails(scheduledRoomMoveDetails).XExternalsystem(xExternalsystem).AcceptLanguage(acceptLanguage).Execute()
...
func main() {
    reservationId := "reservationId_example" // string | Unique OPERA reservation ID which is used to find reservation from OPERA. This ID is a primary identification of a reservation in OPERA.
    hotelId := "hotelId_example" // string | Property code of the reservation.
    scheduledMoveDate := time.Now() // string | The scheduled date of room move.
    authorization := "authorization_example" // string | Bearer token that needs to be passed which is generated post user authentication
    xAppKey := "xAppKey_example" // string | Client or Partner's Application Key
    xHotelid := "xHotelid_example" // string | Mandatory parameter to identify the hotel code where the end user is logged in
    scheduledRoomMoveDetails := *openapiclient.NewScheduledRoomMoveDetails() // ScheduledRoomMoveDetails | Request method to change a scheduled room move details.
    xExternalsystem := "xExternalsystem_example" // string | External system code. (optional)
    acceptLanguage := "acceptLanguage_example" // string | Language code (optional)

    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.ReservationAPI.PutScheduledRoomMove(context.Background(), reservationId, hotelId, scheduledMoveDate).Authorization(authorization).XAppKey(xAppKey).XHotelid(xHotelid).ScheduledRoomMoveDetails(scheduledRoomMoveDetails).XExternalsystem(xExternalsystem).AcceptLanguage(acceptLanguage).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `ReservationAPI.PutScheduledRoomMove``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `PutScheduledRoomMove`: ScheduledRoomMoveDetails
    fmt.Fprintf(os.Stdout, "Response from `ReservationAPI.PutScheduledRoomMove`: %v\n", resp)
}
```
...
**ctx** | **context.Context** | context for authentication, logging, cancellation, deadlines, tracing, etc.
**reservationId** | **string** | Unique OPERA reservation ID which is used to find reservation from OPERA. This ID is a primary identification of a reservation in OPERA. | 
**hotelId** | **string** | Property code of the reservation. | 
**scheduledMoveDate** | **string** | The scheduled date of room move. | 

### Other Parameters

Other parameters are passed through a pointer to a apiPutScheduledRoomMoveRequest struct via the builder pattern
 ...
 **xAppKey** | **string** | Client or Partner&#39;s Application Key | 
 **xHotelid** | **string** | Mandatory parameter to identify the hotel code where the end user is logged in | 
 **scheduledRoomMoveDetails** | [**ScheduledRoomMoveDetails**](ScheduledRoomMoveDetails.md) | Request method to change a scheduled room move details. | 
 **xExternalsystem** | **string** | External system code. | 
 **acceptLanguage** | **string** | Language code | 

### Return type

[**ScheduledRoomMoveDetails**](ScheduledRoomMoveDetails.md)
