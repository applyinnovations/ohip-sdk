...
**AttachDetachType** | Pointer to [**AttachDetachType**](AttachDetachType.md) |  | [optional] 
...
`func (o *ResGuestTypeProfileInfo) GetAttachDetachType() AttachDetachType`

GetAttachDetachType returns the AttachDetachType field if non-nil, zero value otherwise.

### GetAttachDetachTypeOk

`func (o *ResGuestTypeProfileInfo) GetAttachDetachTypeOk() (*AttachDetachType, bool)`

GetAttachDetachTypeOk returns a tuple with the AttachDetachType field if it's non-nil, zero value otherwise
and a boolean to check if the value has been set.

### SetAttachDetachType

`func (o *ResGuestTypeProfileInfo) SetAttachDetachType(v AttachDetachType)`

SetAttachDetachType sets AttachDetachType field to given value.

### HasAttachDetachType

`func (o *ResGuestTypeProfileInfo) HasAttachDetachType() bool`

HasAttachDetachType returns a boolean if a field has been set.
