...
// checks if the PostTurnawayReservationRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PostTurnawayReservationRequest{}

// PostTurnawayReservationRequest struct for PostTurnawayReservationRequest
type PostTurnawayReservationRequest struct {
...
func NewPostTurnawayReservationRequest() *PostTurnawayReservationRequest {
	this := PostTurnawayReservationRequest{}
	return &this
}
...
func (o PostTurnawayReservationRequest) MarshalJSON() ([]byte, error) {
...
func (o PostTurnawayReservationRequest) ToMap() (map[string]interface{}, error) {
...
type NullablePostTurnawayReservationRequest struct {
	value *PostTurnawayReservationRequest
	isSet bool
}

func (v NullablePostTurnawayReservationRequest) Get() *PostTurnawayReservationRequest {
	return v.value
}

func (v *NullablePostTurnawayReservationRequest) Set(val *PostTurnawayReservationRequest) {
	v.value = val
	v.isSet = true
}

func (v NullablePostTurnawayReservationRequest) IsSet() bool {
	return v.isSet
}

func (v *NullablePostTurnawayReservationRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePostTurnawayReservationRequest(val *PostTurnawayReservationRequest) *NullablePostTurnawayReservationRequest {
	return &NullablePostTurnawayReservationRequest{value: val, isSet: true}
}

func (v NullablePostTurnawayReservationRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePostTurnawayReservationRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
