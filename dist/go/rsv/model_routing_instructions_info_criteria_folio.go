...
type RoutingInstructionsInfoCriteriaFolio struct {
	...
	GuestInfo *ResvRoutingCriteriaTypeFolioGuestInfo `json:"guestInfo,omitempty"`
...
func (o *RoutingInstructionsInfoCriteriaFolio) GetGuestInfo() ResvRoutingCriteriaTypeFolioGuestInfo {
	if o == nil || IsNil(o.GuestInfo) {
		var ret ResvRoutingCriteriaTypeFolioGuestInfo
		return ret
	}
	return *o.GuestInfo
}
...
// SetGuestInfo gets a reference to the given ResvRoutingCriteriaTypeFolioGuestInfo and assigns it to the GuestInfo field.
