...
// checks if the UpgradeEligibilityReservations type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UpgradeEligibilityReservations{}

// UpgradeEligibilityReservations Response object to the Fetch UpgradeEligibilityReservations Request operation. Based on the criteria, reservation information is returned.
type UpgradeEligibilityReservations struct {
...
func NewUpgradeEligibilityReservations() *UpgradeEligibilityReservations {
	this := UpgradeEligibilityReservations{}
	return &this
}
...
func (o UpgradeEligibilityReservations) MarshalJSON() ([]byte, error) {
...
func (o UpgradeEligibilityReservations) ToMap() (map[string]interface{}, error) {
...
type NullableUpgradeEligibilityReservations struct {
	value *UpgradeEligibilityReservations
	isSet bool
}

func (v NullableUpgradeEligibilityReservations) Get() *UpgradeEligibilityReservations {
	return v.value
}

func (v *NullableUpgradeEligibilityReservations) Set(val *UpgradeEligibilityReservations) {
	v.value = val
	v.isSet = true
}

func (v NullableUpgradeEligibilityReservations) IsSet() bool {
	return v.isSet
}

func (v *NullableUpgradeEligibilityReservations) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUpgradeEligibilityReservations(val *UpgradeEligibilityReservations) *NullableUpgradeEligibilityReservations {
	return &NullableUpgradeEligibilityReservations{value: val, isSet: true}
}

func (v NullableUpgradeEligibilityReservations) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUpgradeEligibilityReservations) UnmarshalJSON(src []byte) error {
	v.isSet = true
