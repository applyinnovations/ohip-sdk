...
------------ | ------------- | ------------- | -------------
**ContractElements** | Pointer to [**[]ContractElementInformationType**](ContractElementInformationType.md) | Channel account contract elements information object to hold details of contract elements. | [optional] 
