...
// checks if the PostTemplateTransactionSubgroupsRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PostTemplateTransactionSubgroupsRequest{}

// PostTemplateTransactionSubgroupsRequest struct for PostTemplateTransactionSubgroupsRequest
type PostTemplateTransactionSubgroupsRequest struct {
...
func NewPostTemplateTransactionSubgroupsRequest() *PostTemplateTransactionSubgroupsRequest {
	this := PostTemplateTransactionSubgroupsRequest{}
	return &this
}
...
func (o PostTemplateTransactionSubgroupsRequest) MarshalJSON() ([]byte, error) {
...
func (o PostTemplateTransactionSubgroupsRequest) ToMap() (map[string]interface{}, error) {
...
type NullablePostTemplateTransactionSubgroupsRequest struct {
	value *PostTemplateTransactionSubgroupsRequest
	isSet bool
}

func (v NullablePostTemplateTransactionSubgroupsRequest) Get() *PostTemplateTransactionSubgroupsRequest {
	return v.value
}

func (v *NullablePostTemplateTransactionSubgroupsRequest) Set(val *PostTemplateTransactionSubgroupsRequest) {
	v.value = val
	v.isSet = true
}

func (v NullablePostTemplateTransactionSubgroupsRequest) IsSet() bool {
	return v.isSet
}

func (v *NullablePostTemplateTransactionSubgroupsRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePostTemplateTransactionSubgroupsRequest(val *PostTemplateTransactionSubgroupsRequest) *NullablePostTemplateTransactionSubgroupsRequest {
	return &NullablePostTemplateTransactionSubgroupsRequest{value: val, isSet: true}
}

func (v NullablePostTemplateTransactionSubgroupsRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePostTemplateTransactionSubgroupsRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
