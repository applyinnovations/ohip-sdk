...
// checks if the CopyRevenueBucketTypesRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CopyRevenueBucketTypesRequest{}

// CopyRevenueBucketTypesRequest struct for CopyRevenueBucketTypesRequest
type CopyRevenueBucketTypesRequest struct {
...
func NewCopyRevenueBucketTypesRequest() *CopyRevenueBucketTypesRequest {
	this := CopyRevenueBucketTypesRequest{}
	return &this
}
...
func (o CopyRevenueBucketTypesRequest) MarshalJSON() ([]byte, error) {
...
func (o CopyRevenueBucketTypesRequest) ToMap() (map[string]interface{}, error) {
...
type NullableCopyRevenueBucketTypesRequest struct {
	value *CopyRevenueBucketTypesRequest
	isSet bool
}

func (v NullableCopyRevenueBucketTypesRequest) Get() *CopyRevenueBucketTypesRequest {
	return v.value
}

func (v *NullableCopyRevenueBucketTypesRequest) Set(val *CopyRevenueBucketTypesRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableCopyRevenueBucketTypesRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableCopyRevenueBucketTypesRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCopyRevenueBucketTypesRequest(val *CopyRevenueBucketTypesRequest) *NullableCopyRevenueBucketTypesRequest {
	return &NullableCopyRevenueBucketTypesRequest{value: val, isSet: true}
}

func (v NullableCopyRevenueBucketTypesRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCopyRevenueBucketTypesRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
