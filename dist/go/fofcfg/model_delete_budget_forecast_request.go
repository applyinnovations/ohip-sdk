...
// checks if the DeleteBudgetForecastRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DeleteBudgetForecastRequest{}

// DeleteBudgetForecastRequest struct for DeleteBudgetForecastRequest
type DeleteBudgetForecastRequest struct {
...
func NewDeleteBudgetForecastRequest() *DeleteBudgetForecastRequest {
	this := DeleteBudgetForecastRequest{}
	return &this
}
...
func (o DeleteBudgetForecastRequest) MarshalJSON() ([]byte, error) {
...
func (o DeleteBudgetForecastRequest) ToMap() (map[string]interface{}, error) {
...
type NullableDeleteBudgetForecastRequest struct {
	value *DeleteBudgetForecastRequest
	isSet bool
}

func (v NullableDeleteBudgetForecastRequest) Get() *DeleteBudgetForecastRequest {
	return v.value
}

func (v *NullableDeleteBudgetForecastRequest) Set(val *DeleteBudgetForecastRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableDeleteBudgetForecastRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableDeleteBudgetForecastRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDeleteBudgetForecastRequest(val *DeleteBudgetForecastRequest) *NullableDeleteBudgetForecastRequest {
	return &NullableDeleteBudgetForecastRequest{value: val, isSet: true}
}

func (v NullableDeleteBudgetForecastRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDeleteBudgetForecastRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
