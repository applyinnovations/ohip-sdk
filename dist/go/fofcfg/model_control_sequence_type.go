...
type ControlSequenceType struct {
	...
	FolioType *CodeDescriptionType `json:"folioType,omitempty"`
...
// SetFolioType gets a reference to the given CodeDescriptionType and assigns it to the FolioType field.
