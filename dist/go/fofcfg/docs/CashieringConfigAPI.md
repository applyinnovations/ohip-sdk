...
[**CopyVouchersConfig**](CashieringConfigAPI.md#CopyVouchersConfig) | **Put** /hotelVouchersConfig/copy | Operation to copy Vouchers Config.
...
[**DeleteRoomTypebasedchargeranges**](CashieringConfigAPI.md#DeleteRoomTypebasedchargeranges) | **Delete** /roomTypeBasedChargeRanges | Operation to delete Room Type Based Charge Ranges.
...
[**DeleteVouchers**](CashieringConfigAPI.md#DeleteVouchers) | **Delete** /hotels/{hotelId}/vouchers | Operation to remove Vouchers.
...
[**GetRoomTypeBasedChargeRanges**](CashieringConfigAPI.md#GetRoomTypeBasedChargeRanges) | **Get** /roomTypeBasedChargeRanges | Operation to fetch Room Type Based Charge Ranges.
...
[**GetVouchers**](CashieringConfigAPI.md#GetVouchers) | **Get** /hotels/{hotelId}/vouchers | Get Vouchers
...
[**PostRoomTypeBasedChargeRanges**](CashieringConfigAPI.md#PostRoomTypeBasedChargeRanges) | **Post** /roomTypeBasedChargeRanges | Operation to create Room Type Based Charge Ranges.
...
[**PostVouchers**](CashieringConfigAPI.md#PostVouchers) | **Post** /hotels/{hotelId}/vouchers | Operation to create Vouchers.
...
[**PutRoomTypeBasedChargeRanges**](CashieringConfigAPI.md#PutRoomTypeBasedChargeRanges) | **Put** /roomTypeBasedChargeRanges | Operation to change Room Type Based Charge Ranges.
...
[**PutVouchers**](CashieringConfigAPI.md#PutVouchers) | **Put** /hotels/{hotelId}/vouchers | Operation to change a voucher.
...
> Status CopyVouchersConfig(ctx).Authorization(authorization).XAppKey(xAppKey).XHotelid(xHotelid).CopyVouchersConfig(copyVouchersConfig).XExternalsystem(xExternalsystem).AcceptLanguage(acceptLanguage).Execute()

Operation to copy Vouchers Config.
...
func main() {
    ...
    xAppKey := "xAppKey_example" // string | Client or Partner's Application Key
    xHotelid := "xHotelid_example" // string | Mandatory parameter to identify the hotel code where the end user is logged in
    copyVouchersConfig := *openapiclient.NewVouchersConfigCopy() // VouchersConfigCopy | List of the Membership Type of Vouchers Config to be copied.
    xExternalsystem := "xExternalsystem_example" // string | External system code. (optional)
    acceptLanguage := "acceptLanguage_example" // string | Language code (optional)

    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.CashieringConfigAPI.CopyVouchersConfig(context.Background()).Authorization(authorization).XAppKey(xAppKey).XHotelid(xHotelid).CopyVouchersConfig(copyVouchersConfig).XExternalsystem(xExternalsystem).AcceptLanguage(acceptLanguage).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `CashieringConfigAPI.CopyVouchersConfig``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `CopyVouchersConfig`: Status
    fmt.Fprintf(os.Stdout, "Response from `CashieringConfigAPI.CopyVouchersConfig`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiCopyVouchersConfigRequest struct via the builder pattern
 ...
 **xAppKey** | **string** | Client or Partner&#39;s Application Key | 
 **xHotelid** | **string** | Mandatory parameter to identify the hotel code where the end user is logged in | 
 **copyVouchersConfig** | [**VouchersConfigCopy**](VouchersConfigCopy.md) | List of the Membership Type of Vouchers Config to be copied. | 
 **xExternalsystem** | **string** | External system code. | 
 **acceptLanguage** | **string** | Language code | 
...
> Status DeleteRevenueBucketCodes(ctx).HotelId(hotelId).Authorization(authorization).XAppKey(xAppKey).XHotelid(xHotelid).Code(code).RevenueBucketType(revenueBucketType).BucketType(bucketType).XExternalsystem(xExternalsystem).AcceptLanguage(acceptLanguage).Execute()
...
func main() {
    ...
    bucketType := []string{"BucketType_example"} // []string | Flag to identify Fiscal related bucket types. (optional)
    xExternalsystem := "xExternalsystem_example" // string | External system code. (optional)
    acceptLanguage := "acceptLanguage_example" // string | Language code (optional)

    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.CashieringConfigAPI.DeleteRevenueBucketCodes(context.Background()).HotelId(hotelId).Authorization(authorization).XAppKey(xAppKey).XHotelid(xHotelid).Code(code).RevenueBucketType(revenueBucketType).BucketType(bucketType).XExternalsystem(xExternalsystem).AcceptLanguage(acceptLanguage).Execute()
    if err != nil {
 ...
 **bucketType** | **[]string** | Flag to identify Fiscal related bucket types. | 
 **xExternalsystem** | **string** | External system code. | 
 **acceptLanguage** | **string** | Language code | 
...
## DeleteRoomTypebasedchargeranges

> Status DeleteRoomTypebasedchargeranges(ctx).HotelId(hotelId).TransactionNo(transactionNo).Authorization(authorization).XAppKey(xAppKey).XHotelid(xHotelid).XExternalsystem(xExternalsystem).AcceptLanguage(acceptLanguage).Execute()

Operation to delete Room Type Based Charge Ranges.
...
func main() {
    ...
    transactionNo := float32(8.14) // float32 | Transaction number, Unique Identifier of the record.
    authorization := "authorization_example" // string | Bearer token that needs to be passed which is generated post user authentication
    xAppKey := "xAppKey_example" // string | Client or Partner's Application Key
    xHotelid := "xHotelid_example" // string | Mandatory parameter to identify the hotel code where the end user is logged in
    xExternalsystem := "xExternalsystem_example" // string | External system code. (optional)
    ...
    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.CashieringConfigAPI.DeleteRoomTypebasedchargeranges(context.Background()).HotelId(hotelId).TransactionNo(transactionNo).Authorization(authorization).XAppKey(xAppKey).XHotelid(xHotelid).XExternalsystem(xExternalsystem).AcceptLanguage(acceptLanguage).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `CashieringConfigAPI.DeleteRoomTypebasedchargeranges``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `DeleteRoomTypebasedchargeranges`: Status
    fmt.Fprintf(os.Stdout, "Response from `CashieringConfigAPI.DeleteRoomTypebasedchargeranges`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiDeleteRoomTypebasedchargerangesRequest struct via the builder pattern


Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **hotelId** | **string** | Unique ID of the source hotel in OPERA. | 
 **transactionNo** | **float32** | Transaction number, Unique Identifier of the record. | 
 **authorization** | **string** | Bearer token that needs to be passed which is generated post user authentication | 
 **xAppKey** | **string** | Client or Partner&#39;s Application Key | 
 **xHotelid** | **string** | Mandatory parameter to identify the hotel code where the end user is logged in | 
 **xExternalsystem** | **string** | External system code. | 
...
> Status DeleteVouchers(ctx, hotelId).VoucherId(voucherId).Authorization(authorization).XAppKey(xAppKey).XHotelid(xHotelid).XExternalsystem(xExternalsystem).AcceptLanguage(acceptLanguage).Execute()

Operation to remove Vouchers.
...
func main() {
    hotelId := "hotelId_example" // string | Unique ID of the hotel in OPERA
    voucherId := int32(56) // int32 | Unique internal ID of the voucher
    authorization := "authorization_example" // string | Bearer token that needs to be passed which is generated post user authentication
    xAppKey := "xAppKey_example" // string | Client or Partner's Application Key
    xHotelid := "xHotelid_example" // string | Mandatory parameter to identify the hotel code where the end user is logged in
    xExternalsystem := "xExternalsystem_example" // string | External system code. (optional)
    ...
    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.CashieringConfigAPI.DeleteVouchers(context.Background(), hotelId).VoucherId(voucherId).Authorization(authorization).XAppKey(xAppKey).XHotelid(xHotelid).XExternalsystem(xExternalsystem).AcceptLanguage(acceptLanguage).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `CashieringConfigAPI.DeleteVouchers``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `DeleteVouchers`: Status
    fmt.Fprintf(os.Stdout, "Response from `CashieringConfigAPI.DeleteVouchers`: %v\n", resp)
}
```
 ...
 **voucherId** | **int32** | Unique internal ID of the voucher | 
 **authorization** | **string** | Bearer token that needs to be passed which is generated post user authentication | 
 **xAppKey** | **string** | Client or Partner&#39;s Application Key | 
 **xHotelid** | **string** | Mandatory parameter to identify the hotel code where the end user is logged in | 
 **xExternalsystem** | **string** | External system code. | 
...
> CollectingAgentTaxes GetCollectingAgentTaxes(ctx).Authorization(authorization).XAppKey(xAppKey).XHotelid(xHotelid).HotelId(hotelId).TaxCodes(taxCodes).TaxType(taxType).XExternalsystem(xExternalsystem).AcceptLanguage(acceptLanguage).Execute()
...
func main() {
    ...
    taxType := []string{"Inner_example"} // []string | Parameter to fetch Collecting Agent Taxes based on tax types which are marked Collecting Agent. The list of tax types is fetched using getTaxTypes operation. (optional)
    xExternalsystem := "xExternalsystem_example" // string | External system code. (optional)
    acceptLanguage := "acceptLanguage_example" // string | Language code (optional)

    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.CashieringConfigAPI.GetCollectingAgentTaxes(context.Background()).Authorization(authorization).XAppKey(xAppKey).XHotelid(xHotelid).HotelId(hotelId).TaxCodes(taxCodes).TaxType(taxType).XExternalsystem(xExternalsystem).AcceptLanguage(acceptLanguage).Execute()
    if err != nil {
 ...
 **hotelId** | **string** | It represents Hotel Code | 
 **taxCodes** | **[]string** |  | 
 **taxType** | **[]string** | Parameter to fetch Collecting Agent Taxes based on tax types which are marked Collecting Agent. The list of tax types is fetched using getTaxTypes operation. | 
 **xExternalsystem** | **string** | External system code. | 
 **acceptLanguage** | **string** | Language code | 
...
> CustomChargesConfigDetails GetCustomChargeCodes(ctx, hotelId).Authorization(authorization).XAppKey(xAppKey).XHotelid(xHotelid).HotelIds(hotelIds).ConfigurationId(configurationId).IncludeInactive(includeInactive).WildCard(wildCard).XExternalsystem(xExternalsystem).AcceptLanguage(acceptLanguage).Execute()
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.CashieringConfigAPI.GetCustomChargeCodes(context.Background(), hotelId).Authorization(authorization).XAppKey(xAppKey).XHotelid(xHotelid).HotelIds(hotelIds).ConfigurationId(configurationId).IncludeInactive(includeInactive).WildCard(wildCard).XExternalsystem(xExternalsystem).AcceptLanguage(acceptLanguage).Execute()
    if err != nil {
...
## GetRoomTypeBasedChargeRanges

> RoomTypeBasedChargeRngs GetRoomTypeBasedChargeRanges(ctx).HotelId(hotelId).TransactionCode(transactionCode).GenerateTrxCode(generateTrxCode).RoomTypeGroup(roomTypeGroup).Authorization(authorization).XAppKey(xAppKey).XHotelid(xHotelid).XExternalsystem(xExternalsystem).AcceptLanguage(acceptLanguage).Execute()

Operation to fetch Room Type Based Charge Ranges.
...
func main() {
    hotelId := "hotelId_example" // string | Unique ID of the source hotel in OPERA
    transactionCode := "transactionCode_example" // string | Transaction code
    generateTrxCode := "generateTrxCode_example" // string | Generate of the Main Transaction code
    roomTypeGroup := "roomTypeGroup_example" // string | Room Type Group Code
    authorization := "authorization_example" // string | Bearer token that needs to be passed which is generated post user authentication
    xAppKey := "xAppKey_example" // string | Client or Partner's Application Key
    xHotelid := "xHotelid_example" // string | Mandatory parameter to identify the hotel code where the end user is logged in
    xExternalsystem := "xExternalsystem_example" // string | External system code. (optional)
    ...
    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.CashieringConfigAPI.GetRoomTypeBasedChargeRanges(context.Background()).HotelId(hotelId).TransactionCode(transactionCode).GenerateTrxCode(generateTrxCode).RoomTypeGroup(roomTypeGroup).Authorization(authorization).XAppKey(xAppKey).XHotelid(xHotelid).XExternalsystem(xExternalsystem).AcceptLanguage(acceptLanguage).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `CashieringConfigAPI.GetRoomTypeBasedChargeRanges``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `GetRoomTypeBasedChargeRanges`: RoomTypeBasedChargeRngs
    fmt.Fprintf(os.Stdout, "Response from `CashieringConfigAPI.GetRoomTypeBasedChargeRanges`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiGetRoomTypeBasedChargeRangesRequest struct via the builder pattern
 ...
 **generateTrxCode** | **string** | Generate of the Main Transaction code | 
 **roomTypeGroup** | **string** | Room Type Group Code | 
 **authorization** | **string** | Bearer token that needs to be passed which is generated post user authentication | 
 **xAppKey** | **string** | Client or Partner&#39;s Application Key | 
 **xHotelid** | **string** | Mandatory parameter to identify the hotel code where the end user is logged in | 
 **xExternalsystem** | **string** | External system code. | 
...
[**RoomTypeBasedChargeRngs**](RoomTypeBasedChargeRngs.md)
...
> HotelTransactionCodes GetTransactionCodes(ctx).HotelIds(hotelIds).Authorization(authorization).XAppKey(xAppKey).XHotelid(xHotelid).CompTransactionCodes(compTransactionCodes).IncludeInactive(includeInactive).EarnMembershipPoints(earnMembershipPoints).TransactionGroupCodes(transactionGroupCodes).TransactionSubgroupsCodes(transactionSubgroupsCodes).TransactionCodes(transactionCodes).WildCard(wildCard).Description(description).BrandCode(brandCode).UniversalProductCode(universalProductCode).XExternalsystem(xExternalsystem).AcceptLanguage(acceptLanguage).Execute()
...
func main() {
    ...
    compTransactionCodes := false // bool | Flag to indicate whether comp accounting transaction codes are being requested. If true, only comp accounting transaction codes will be returned. If false, only standard transaction codes will be returned. (optional)
    includeInactive := false // bool | Inactive flag used to include/exclude inactive transaction codes from the search result (optional)
    earnMembershipPoints := false // bool | This flag indicates that the transaction is eligible to earn points (guest can earn points on the revenue posted to this transaction code) (optional)
    transactionGroupCodes := []string{"Inner_example"} // []string |  (optional)
    transactionSubgroupsCodes := []string{"Inner_example"} // []string |  (optional)
    transactionCodes := []string{"Inner_example"} // []string | Codes to be searched. (optional)
    wildCard := "wildCard_example" // string | Wildcard search on the code. (optional)
 ...
 **compTransactionCodes** | **bool** | Flag to indicate whether comp accounting transaction codes are being requested. If true, only comp accounting transaction codes will be returned. If false, only standard transaction codes will be returned. | 
 **includeInactive** | **bool** | Inactive flag used to include/exclude inactive transaction codes from the search result | 
 **earnMembershipPoints** | **bool** | This flag indicates that the transaction is eligible to earn points (guest can earn points on the revenue posted to this transaction code) | 
 **transactionGroupCodes** | **[]string** |  | 
 **transactionSubgroupsCodes** | **[]string** |  | 
 **transactionCodes** | **[]string** | Codes to be searched. | 
 **wildCard** | **string** | Wildcard search on the code. | 
...
> VouchersDetails GetVouchers(ctx, hotelId).Authorization(authorization).XAppKey(xAppKey).XHotelid(xHotelid).MembershipTypes(membershipTypes).MembershipLevels(membershipLevels).StartDate(startDate).EndDate(endDate).XExternalsystem(xExternalsystem).AcceptLanguage(acceptLanguage).Execute()
...
func main() {
    ...
    membershipTypes := []string{"Inner_example"} // []string | Membership Types set to the search criteria (optional)
    membershipLevels := []string{"Inner_example"} // []string | Membership Levels set to the search criteria (optional)
    startDate := time.Now() // string | Start date of the voucher (optional)
    endDate := time.Now() // string | End date of the voucher (optional)
    xExternalsystem := "xExternalsystem_example" // string | External system code. (optional)
    acceptLanguage := "acceptLanguage_example" // string | Language code (optional)

    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.CashieringConfigAPI.GetVouchers(context.Background(), hotelId).Authorization(authorization).XAppKey(xAppKey).XHotelid(xHotelid).MembershipTypes(membershipTypes).MembershipLevels(membershipLevels).StartDate(startDate).EndDate(endDate).XExternalsystem(xExternalsystem).AcceptLanguage(acceptLanguage).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `CashieringConfigAPI.GetVouchers``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `GetVouchers`: VouchersDetails
    fmt.Fprintf(os.Stdout, "Response from `CashieringConfigAPI.GetVouchers`: %v\n", resp)
}
```
 ...
 **membershipTypes** | **[]string** | Membership Types set to the search criteria | 
 **membershipLevels** | **[]string** | Membership Levels set to the search criteria | 
 **startDate** | **string** | Start date of the voucher | 
 **endDate** | **string** | End date of the voucher | 
 **xExternalsystem** | **string** | External system code. | 
 **acceptLanguage** | **string** | Language code | 

### Return type

[**VouchersDetails**](VouchersDetails.md)
...
## PostRoomTypeBasedChargeRanges

> Status PostRoomTypeBasedChargeRanges(ctx).Authorization(authorization).XAppKey(xAppKey).XHotelid(xHotelid).RoomTypeBasedChargeRanges(roomTypeBasedChargeRanges).XExternalsystem(xExternalsystem).AcceptLanguage(acceptLanguage).Execute()

Operation to create Room Type Based Charge Ranges.
...
func main() {
    ...
    xAppKey := "xAppKey_example" // string | Client or Partner's Application Key
    xHotelid := "xHotelid_example" // string | Mandatory parameter to identify the hotel code where the end user is logged in
    roomTypeBasedChargeRanges := *openapiclient.NewRoomTypeBasedChargeRngs() // RoomTypeBasedChargeRngs | Request to create Room Type Based Charge Ranges.
    xExternalsystem := "xExternalsystem_example" // string | External system code. (optional)
    acceptLanguage := "acceptLanguage_example" // string | Language code (optional)

    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.CashieringConfigAPI.PostRoomTypeBasedChargeRanges(context.Background()).Authorization(authorization).XAppKey(xAppKey).XHotelid(xHotelid).RoomTypeBasedChargeRanges(roomTypeBasedChargeRanges).XExternalsystem(xExternalsystem).AcceptLanguage(acceptLanguage).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `CashieringConfigAPI.PostRoomTypeBasedChargeRanges``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `PostRoomTypeBasedChargeRanges`: Status
    fmt.Fprintf(os.Stdout, "Response from `CashieringConfigAPI.PostRoomTypeBasedChargeRanges`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiPostRoomTypeBasedChargeRangesRequest struct via the builder pattern
 ...
 **xAppKey** | **string** | Client or Partner&#39;s Application Key | 
 **xHotelid** | **string** | Mandatory parameter to identify the hotel code where the end user is logged in | 
 **roomTypeBasedChargeRanges** | [**RoomTypeBasedChargeRngs**](RoomTypeBasedChargeRngs.md) | Request to create Room Type Based Charge Ranges. | 
 **xExternalsystem** | **string** | External system code. | 
 **acceptLanguage** | **string** | Language code | 
...
> GeneratesInfoType PostTransactionGenerates(ctx).Authorization(authorization).XAppKey(xAppKey).XHotelid(xHotelid).HotelTransactionGenerates(hotelTransactionGenerates).XExternalsystem(xExternalsystem).AcceptLanguage(acceptLanguage).Execute()
...
func main() {
    ...
    // response from `PostTransactionGenerates`: GeneratesInfoType
...
[**GeneratesInfoType**](GeneratesInfoType.md)
...
> Status PostVouchers(ctx, hotelId).Authorization(authorization).XAppKey(xAppKey).XHotelid(xHotelid).Vouchers(vouchers).XExternalsystem(xExternalsystem).AcceptLanguage(acceptLanguage).Execute()

Operation to create Vouchers.
...
func main() {
    ...
    xAppKey := "xAppKey_example" // string | Client or Partner's Application Key
    xHotelid := "xHotelid_example" // string | Mandatory parameter to identify the hotel code where the end user is logged in
    vouchers := *openapiclient.NewVouchersDetails() // VouchersDetails | Request to create a voucher.
    xExternalsystem := "xExternalsystem_example" // string | External system code. (optional)
    acceptLanguage := "acceptLanguage_example" // string | Language code (optional)

    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.CashieringConfigAPI.PostVouchers(context.Background(), hotelId).Authorization(authorization).XAppKey(xAppKey).XHotelid(xHotelid).Vouchers(vouchers).XExternalsystem(xExternalsystem).AcceptLanguage(acceptLanguage).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `CashieringConfigAPI.PostVouchers``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `PostVouchers`: Status
    fmt.Fprintf(os.Stdout, "Response from `CashieringConfigAPI.PostVouchers`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiPostVouchersRequest struct via the builder pattern
 ...
 **xAppKey** | **string** | Client or Partner&#39;s Application Key | 
 **xHotelid** | **string** | Mandatory parameter to identify the hotel code where the end user is logged in | 
 **vouchers** | [**VouchersDetails**](VouchersDetails.md) | Request to create a voucher. | 
 **xExternalsystem** | **string** | External system code. | 
 **acceptLanguage** | **string** | Language code | 
...
## PutRoomTypeBasedChargeRanges

> Status PutRoomTypeBasedChargeRanges(ctx).Authorization(authorization).XAppKey(xAppKey).XHotelid(xHotelid).RoomTypeBasedChargeRanges(roomTypeBasedChargeRanges).XExternalsystem(xExternalsystem).AcceptLanguage(acceptLanguage).Execute()

Operation to change Room Type Based Charge Ranges.
...
func main() {
    ...
    xAppKey := "xAppKey_example" // string | Client or Partner's Application Key
    xHotelid := "xHotelid_example" // string | Mandatory parameter to identify the hotel code where the end user is logged in
    roomTypeBasedChargeRanges := *openapiclient.NewRoomTypeBasedChargeRngs() // RoomTypeBasedChargeRngs | Request to change Room Type Based Charge Ranges.
    xExternalsystem := "xExternalsystem_example" // string | External system code. (optional)
    acceptLanguage := "acceptLanguage_example" // string | Language code (optional)

    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.CashieringConfigAPI.PutRoomTypeBasedChargeRanges(context.Background()).Authorization(authorization).XAppKey(xAppKey).XHotelid(xHotelid).RoomTypeBasedChargeRanges(roomTypeBasedChargeRanges).XExternalsystem(xExternalsystem).AcceptLanguage(acceptLanguage).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `CashieringConfigAPI.PutRoomTypeBasedChargeRanges``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `PutRoomTypeBasedChargeRanges`: Status
    fmt.Fprintf(os.Stdout, "Response from `CashieringConfigAPI.PutRoomTypeBasedChargeRanges`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiPutRoomTypeBasedChargeRangesRequest struct via the builder pattern
 ...
 **xAppKey** | **string** | Client or Partner&#39;s Application Key | 
 **xHotelid** | **string** | Mandatory parameter to identify the hotel code where the end user is logged in | 
 **roomTypeBasedChargeRanges** | [**RoomTypeBasedChargeRngs**](RoomTypeBasedChargeRngs.md) | Request to change Room Type Based Charge Ranges. | 
 **xExternalsystem** | **string** | External system code. | 
 **acceptLanguage** | **string** | Language code | 
...
> Status PutVouchers(ctx, hotelId).Authorization(authorization).XAppKey(xAppKey).XHotelid(xHotelid).Vouchers(vouchers).XExternalsystem(xExternalsystem).AcceptLanguage(acceptLanguage).Execute()

Operation to change a voucher.
...
func main() {
    ...
    xAppKey := "xAppKey_example" // string | Client or Partner's Application Key
    xHotelid := "xHotelid_example" // string | Mandatory parameter to identify the hotel code where the end user is logged in
    vouchers := *openapiclient.NewVouchersDetails() // VouchersDetails | Request to change voucher.
    xExternalsystem := "xExternalsystem_example" // string | External system code. (optional)
    acceptLanguage := "acceptLanguage_example" // string | Language code (optional)

    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.CashieringConfigAPI.PutVouchers(context.Background(), hotelId).Authorization(authorization).XAppKey(xAppKey).XHotelid(xHotelid).Vouchers(vouchers).XExternalsystem(xExternalsystem).AcceptLanguage(acceptLanguage).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `CashieringConfigAPI.PutVouchers``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `PutVouchers`: Status
    fmt.Fprintf(os.Stdout, "Response from `CashieringConfigAPI.PutVouchers`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiPutVouchersRequest struct via the builder pattern
 ...
 **xAppKey** | **string** | Client or Partner&#39;s Application Key | 
 **xHotelid** | **string** | Mandatory parameter to identify the hotel code where the end user is logged in | 
 **vouchers** | [**VouchersDetails**](VouchersDetails.md) | Request to change voucher. | 
 **xExternalsystem** | **string** | External system code. | 
 **acceptLanguage** | **string** | Language code | 
