...
**RatePlanCode** | Pointer to **string** | This represents the rate plan code of the room type. | [optional] 
**RoomType** | Pointer to **string** | This represents the room type code. | [optional] 
