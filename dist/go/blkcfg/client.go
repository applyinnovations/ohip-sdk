...
// APIClient manages communication with the OPERA Cloud Block Configuration API API v23.2
...
type APIClient struct {
	...
	BlockConfigApi *BlockConfigApiService
...
func NewAPIClient(cfg *Configuration) *APIClient {
	...
	// API Services
	c.BlockConfigApi = (*BlockConfigApiService)(&c.common)
