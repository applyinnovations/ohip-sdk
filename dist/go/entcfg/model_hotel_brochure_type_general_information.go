...
// checks if the HotelBrochureTypeGeneralInformation type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &HotelBrochureTypeGeneralInformation{}

// HotelBrochureTypeGeneralInformation General Information of the hotel.
type HotelBrochureTypeGeneralInformation struct {
...
func NewHotelBrochureTypeGeneralInformation() *HotelBrochureTypeGeneralInformation {
	this := HotelBrochureTypeGeneralInformation{}
	return &this
}
...
func (o *HotelBrochureTypeGeneralInformation) SetBaseLanguage(v string) {
	o.BaseLanguage = &v
}
...
func (o HotelBrochureTypeGeneralInformation) MarshalJSON() ([]byte, error) {
...
func (o HotelBrochureTypeGeneralInformation) ToMap() (map[string]interface{}, error) {
...
type NullableHotelBrochureTypeGeneralInformation struct {
	value *HotelBrochureTypeGeneralInformation
	isSet bool
}

func (v NullableHotelBrochureTypeGeneralInformation) Get() *HotelBrochureTypeGeneralInformation {
	return v.value
}

func (v *NullableHotelBrochureTypeGeneralInformation) Set(val *HotelBrochureTypeGeneralInformation) {
	v.value = val
	v.isSet = true
}

func (v NullableHotelBrochureTypeGeneralInformation) IsSet() bool {
	return v.isSet
}

func (v *NullableHotelBrochureTypeGeneralInformation) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableHotelBrochureTypeGeneralInformation(val *HotelBrochureTypeGeneralInformation) *NullableHotelBrochureTypeGeneralInformation {
	return &NullableHotelBrochureTypeGeneralInformation{value: val, isSet: true}
}

func (v NullableHotelBrochureTypeGeneralInformation) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableHotelBrochureTypeGeneralInformation) UnmarshalJSON(src []byte) error {
	v.isSet = true
