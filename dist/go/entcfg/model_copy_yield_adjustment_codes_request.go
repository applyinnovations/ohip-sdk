...
// checks if the CopyYieldAdjustmentCodesRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CopyYieldAdjustmentCodesRequest{}

// CopyYieldAdjustmentCodesRequest struct for CopyYieldAdjustmentCodesRequest
type CopyYieldAdjustmentCodesRequest struct {
...
func NewCopyYieldAdjustmentCodesRequest() *CopyYieldAdjustmentCodesRequest {
	this := CopyYieldAdjustmentCodesRequest{}
	return &this
}
...
func (o CopyYieldAdjustmentCodesRequest) MarshalJSON() ([]byte, error) {
...
func (o CopyYieldAdjustmentCodesRequest) ToMap() (map[string]interface{}, error) {
...
type NullableCopyYieldAdjustmentCodesRequest struct {
	value *CopyYieldAdjustmentCodesRequest
	isSet bool
}

func (v NullableCopyYieldAdjustmentCodesRequest) Get() *CopyYieldAdjustmentCodesRequest {
	return v.value
}

func (v *NullableCopyYieldAdjustmentCodesRequest) Set(val *CopyYieldAdjustmentCodesRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableCopyYieldAdjustmentCodesRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableCopyYieldAdjustmentCodesRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCopyYieldAdjustmentCodesRequest(val *CopyYieldAdjustmentCodesRequest) *NullableCopyYieldAdjustmentCodesRequest {
	return &NullableCopyYieldAdjustmentCodesRequest{value: val, isSet: true}
}

func (v NullableCopyYieldAdjustmentCodesRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCopyYieldAdjustmentCodesRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
