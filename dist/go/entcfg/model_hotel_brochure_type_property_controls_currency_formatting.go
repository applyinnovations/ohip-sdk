...
// checks if the HotelBrochureTypePropertyControlsCurrencyFormatting type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &HotelBrochureTypePropertyControlsCurrencyFormatting{}

// HotelBrochureTypePropertyControlsCurrencyFormatting Currency Formatting information configuration of the hotel.
type HotelBrochureTypePropertyControlsCurrencyFormatting struct {
...
func NewHotelBrochureTypePropertyControlsCurrencyFormatting() *HotelBrochureTypePropertyControlsCurrencyFormatting {
	this := HotelBrochureTypePropertyControlsCurrencyFormatting{}
	return &this
}
...
func (o HotelBrochureTypePropertyControlsCurrencyFormatting) MarshalJSON() ([]byte, error) {
...
func (o HotelBrochureTypePropertyControlsCurrencyFormatting) ToMap() (map[string]interface{}, error) {
...
type NullableHotelBrochureTypePropertyControlsCurrencyFormatting struct {
	value *HotelBrochureTypePropertyControlsCurrencyFormatting
	isSet bool
}

func (v NullableHotelBrochureTypePropertyControlsCurrencyFormatting) Get() *HotelBrochureTypePropertyControlsCurrencyFormatting {
	return v.value
}

func (v *NullableHotelBrochureTypePropertyControlsCurrencyFormatting) Set(val *HotelBrochureTypePropertyControlsCurrencyFormatting) {
	v.value = val
	v.isSet = true
}

func (v NullableHotelBrochureTypePropertyControlsCurrencyFormatting) IsSet() bool {
	return v.isSet
}

func (v *NullableHotelBrochureTypePropertyControlsCurrencyFormatting) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableHotelBrochureTypePropertyControlsCurrencyFormatting(val *HotelBrochureTypePropertyControlsCurrencyFormatting) *NullableHotelBrochureTypePropertyControlsCurrencyFormatting {
	return &NullableHotelBrochureTypePropertyControlsCurrencyFormatting{value: val, isSet: true}
}

func (v NullableHotelBrochureTypePropertyControlsCurrencyFormatting) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableHotelBrochureTypePropertyControlsCurrencyFormatting) UnmarshalJSON(src []byte) error {
	v.isSet = true
