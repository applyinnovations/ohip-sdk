...
func Test_entcfg_HotelConfigAPIService(t *testing.T) {
	...
	t.Run("Test HotelConfigAPIService ChangeCentralConfig", func(t *testing.T) {
		...
		resp, httpRes, err := apiClient.HotelConfigAPI.ChangeCentralConfig(context.Background(), hotelId, config, code).Execute()
	...
	t.Run("Test HotelConfigAPIService GetCentralConfig", func(t *testing.T) {
		...
		resp, httpRes, err := apiClient.HotelConfigAPI.GetCentralConfig(context.Background(), hotelId, config).Execute()
	...
	t.Run("Test HotelConfigAPIService GetOperation", func(t *testing.T) {

		t.Skip("skip test")  // remove to run test

		resp, httpRes, err := apiClient.HotelConfigAPI.GetOperation(context.Background()).Execute()
