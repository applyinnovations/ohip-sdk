...
[**ChangeCentralConfig**](HotelConfigAPI.md#ChangeCentralConfig) | **Put** /hotels/{hotelId}/centralConfigs/{config}/items/{code} | Change the status for Central Config to manage at Hotel/Enterprise Level.
...
[**GetCentralConfig**](HotelConfigAPI.md#GetCentralConfig) | **Get** /hotels/{hotelId}/centralConfigs/{config} | Lists the configurations managed centrally
...
[**GetOperation**](HotelConfigAPI.md#GetOperation) | **Get** /operation | Fetch all operations
...
> Status ChangeCentralConfig(ctx, hotelId, config, code).Authorization(authorization).XAppKey(xAppKey).XHotelid(xHotelid).CentralConfig(centralConfig).XExternalsystem(xExternalsystem).AcceptLanguage(acceptLanguage).Execute()
...
func main() {
    ...
    config := "config_example" // string | Configuration to be checked for listing the configs.
    code := "code_example" // string | Configuration Item to be modified.
    authorization := "authorization_example" // string | Bearer token that needs to be passed which is generated post user authentication
    xAppKey := "xAppKey_example" // string | Client or Partner's Application Key
    xHotelid := "xHotelid_example" // string | Mandatory parameter to identify the hotel code where the end user is logged in
    centralConfig := *openapiclient.NewCentralConfigRequest() // CentralConfigRequest | Central Configuration
    xExternalsystem := "xExternalsystem_example" // string | External system code. (optional)
    acceptLanguage := "acceptLanguage_example" // string | Language code (optional)

    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.HotelConfigAPI.ChangeCentralConfig(context.Background(), hotelId, config, code).Authorization(authorization).XAppKey(xAppKey).XHotelid(xHotelid).CentralConfig(centralConfig).XExternalsystem(xExternalsystem).AcceptLanguage(acceptLanguage).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `HotelConfigAPI.ChangeCentralConfig``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `ChangeCentralConfig`: Status
    fmt.Fprintf(os.Stdout, "Response from `HotelConfigAPI.ChangeCentralConfig`: %v\n", resp)
}
```
...
**config** | **string** | Configuration to be checked for listing the configs. | 
**code** | **string** | Configuration Item to be modified. | 

### Other Parameters

Other parameters are passed through a pointer to a apiChangeCentralConfigRequest struct via the builder pattern
 ...
 **xAppKey** | **string** | Client or Partner&#39;s Application Key | 
 **xHotelid** | **string** | Mandatory parameter to identify the hotel code where the end user is logged in | 
 **centralConfig** | [**CentralConfigRequest**](CentralConfigRequest.md) | Central Configuration | 
 **xExternalsystem** | **string** | External system code. | 
 **acceptLanguage** | **string** | Language code | 
...
> CentralConfigsResponse GetCentralConfig(ctx, hotelId, config).Authorization(authorization).XAppKey(xAppKey).XHotelid(xHotelid).XExternalsystem(xExternalsystem).AcceptLanguage(acceptLanguage).Execute()
...
func main() {
    hotelId := "hotelId_example" // string | Unique ID that identifies a single hotel property.
    config := "config_example" // string | Configuration to be checked for listing the centrally managed items.
    authorization := "authorization_example" // string | Bearer token that needs to be passed which is generated post user authentication
    xAppKey := "xAppKey_example" // string | Client or Partner's Application Key
    xHotelid := "xHotelid_example" // string | Mandatory parameter to identify the hotel code where the end user is logged in
    xExternalsystem := "xExternalsystem_example" // string | External system code. (optional)
    ...
    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.HotelConfigAPI.GetCentralConfig(context.Background(), hotelId, config).Authorization(authorization).XAppKey(xAppKey).XHotelid(xHotelid).XExternalsystem(xExternalsystem).AcceptLanguage(acceptLanguage).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `HotelConfigAPI.GetCentralConfig``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `GetCentralConfig`: CentralConfigsResponse
    fmt.Fprintf(os.Stdout, "Response from `HotelConfigAPI.GetCentralConfig`: %v\n", resp)
}
```
...
**ctx** | **context.Context** | context for authentication, logging, cancellation, deadlines, tracing, etc.
**hotelId** | **string** | Unique ID that identifies a single hotel property. | 
**config** | **string** | Configuration to be checked for listing the centrally managed items. | 

### Other Parameters

Other parameters are passed through a pointer to a apiGetCentralConfigRequest struct via the builder pattern
...
[**CentralConfigsResponse**](CentralConfigsResponse.md)
...
> OperationResponse GetOperation(ctx).Authorization(authorization).XAppKey(xAppKey).XHotelid(xHotelid).Code(code).Operation(operation).XExternalsystem(xExternalsystem).AcceptLanguage(acceptLanguage).Execute()
...
func main() {
    ...
    xAppKey := "xAppKey_example" // string | Client or Partner's Application Key
    xHotelid := "xHotelid_example" // string | Mandatory parameter to identify the hotel code where the end user is logged in
    code := "code_example" // string | Unique code for a configuration. (optional)
    operation := "operation_example" // string | Describing the type of operation a particular configuration supports (optional)
    xExternalsystem := "xExternalsystem_example" // string | External system code. (optional)
    acceptLanguage := "acceptLanguage_example" // string | Language code (optional)

    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.HotelConfigAPI.GetOperation(context.Background()).Authorization(authorization).XAppKey(xAppKey).XHotelid(xHotelid).Code(code).Operation(operation).XExternalsystem(xExternalsystem).AcceptLanguage(acceptLanguage).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `HotelConfigAPI.GetOperation``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `GetOperation`: OperationResponse
    fmt.Fprintf(os.Stdout, "Response from `HotelConfigAPI.GetOperation`: %v\n", resp)
}
```
 ...
 **xAppKey** | **string** | Client or Partner&#39;s Application Key | 
 **xHotelid** | **string** | Mandatory parameter to identify the hotel code where the end user is logged in | 
 **code** | **string** | Unique code for a configuration. | 
 **operation** | **string** | Describing the type of operation a particular configuration supports | 
 **xExternalsystem** | **string** | External system code. | 
 **acceptLanguage** | **string** | Language code | 
