...
**OverbookAll** | Pointer to **bool** | Flag to determine if user wants to overbook sales allowance. | [optional] 
...
**IsCentralSalesLead** | Pointer to **bool** | Flag to determine if the given block is central lead or not. | [optional] 
**CentralSalesLeadResort** | Pointer to **string** | Resort name of central sales lead for this property lead. | [optional] 
**CentralSalesLeadId** | Pointer to **string** | Central sales lead id of the central sales lead for this property lead. | [optional] 
...
**AutoloadForecastGrid** | Pointer to **bool** | Indicates if forecast grid will be auto loaded from original grid. | [optional] 
...
**HasLinkedActivities** | Pointer to **bool** | Indicates if block has any linked activity(s). | [optional] 
...
**QuoteReferenceNumber** | Pointer to **string** | Quote Reference Number is an alternate id number for the block that can be used in the SC Quote report and allows for tracking and managing revisions | [optional] 
...
`func (o *BlockDetailsType) GetOverbookAll() bool`

GetOverbookAll returns the OverbookAll field if non-nil, zero value otherwise.

### GetOverbookAllOk

`func (o *BlockDetailsType) GetOverbookAllOk() (*bool, bool)`
...
`func (o *BlockDetailsType) SetOverbookAll(v bool)`

SetOverbookAll sets OverbookAll field to given value.

### HasOverbookAll

`func (o *BlockDetailsType) HasOverbookAll() bool`
...
`func (o *BlockDetailsType) GetIsCentralSalesLead() bool`

GetIsCentralSalesLead returns the IsCentralSalesLead field if non-nil, zero value otherwise.

### GetIsCentralSalesLeadOk

`func (o *BlockDetailsType) GetIsCentralSalesLeadOk() (*bool, bool)`

GetIsCentralSalesLeadOk returns a tuple with the IsCentralSalesLead field if it's non-nil, zero value otherwise
and a boolean to check if the value has been set.

### SetIsCentralSalesLead

`func (o *BlockDetailsType) SetIsCentralSalesLead(v bool)`

SetIsCentralSalesLead sets IsCentralSalesLead field to given value.

### HasIsCentralSalesLead

`func (o *BlockDetailsType) HasIsCentralSalesLead() bool`

HasIsCentralSalesLead returns a boolean if a field has been set.

### GetCentralSalesLeadResort

`func (o *BlockDetailsType) GetCentralSalesLeadResort() string`
...
`func (o *BlockDetailsType) GetCentralSalesLeadResortOk() (*string, bool)`
...
### GetAutoloadForecastGrid

`func (o *BlockDetailsType) GetAutoloadForecastGrid() bool`

GetAutoloadForecastGrid returns the AutoloadForecastGrid field if non-nil, zero value otherwise.

### GetAutoloadForecastGridOk

`func (o *BlockDetailsType) GetAutoloadForecastGridOk() (*bool, bool)`

GetAutoloadForecastGridOk returns a tuple with the AutoloadForecastGrid field if it's non-nil, zero value otherwise
and a boolean to check if the value has been set.

### SetAutoloadForecastGrid

`func (o *BlockDetailsType) SetAutoloadForecastGrid(v bool)`

SetAutoloadForecastGrid sets AutoloadForecastGrid field to given value.

### HasAutoloadForecastGrid

`func (o *BlockDetailsType) HasAutoloadForecastGrid() bool`

HasAutoloadForecastGrid returns a boolean if a field has been set.
...
### GetHasLinkedActivities

`func (o *BlockDetailsType) GetHasLinkedActivities() bool`

GetHasLinkedActivities returns the HasLinkedActivities field if non-nil, zero value otherwise.

### GetHasLinkedActivitiesOk

`func (o *BlockDetailsType) GetHasLinkedActivitiesOk() (*bool, bool)`

GetHasLinkedActivitiesOk returns a tuple with the HasLinkedActivities field if it's non-nil, zero value otherwise
and a boolean to check if the value has been set.

### SetHasLinkedActivities

`func (o *BlockDetailsType) SetHasLinkedActivities(v bool)`

SetHasLinkedActivities sets HasLinkedActivities field to given value.

### HasHasLinkedActivities

`func (o *BlockDetailsType) HasHasLinkedActivities() bool`

HasHasLinkedActivities returns a boolean if a field has been set.
