...
**ArrivalTime** | Pointer to **string** | Indicates the approximate check in time for the reservations made for the block. | [optional] 
**DepartureTime** | Pointer to **string** | Indicates the approximate check out time for the reservations made for the block. | [optional] 
...
**CutoffScheduleCode** | Pointer to **string** | Cutoff Schedule Code for Business Block | [optional] 
...
**PostingMastersCancellable** | Pointer to **bool** | Indicates if posting master reservations can be cancelled. | [optional] 
