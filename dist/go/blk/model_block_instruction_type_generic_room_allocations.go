...
// checks if the BlockInstructionTypeGenericRoomAllocations type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BlockInstructionTypeGenericRoomAllocations{}

// BlockInstructionTypeGenericRoomAllocations Generic Room Type Allocations for the Block.
type BlockInstructionTypeGenericRoomAllocations struct {
...
func NewBlockInstructionTypeGenericRoomAllocations() *BlockInstructionTypeGenericRoomAllocations {
	this := BlockInstructionTypeGenericRoomAllocations{}
	return &this
}
...
func (o BlockInstructionTypeGenericRoomAllocations) MarshalJSON() ([]byte, error) {
...
func (o BlockInstructionTypeGenericRoomAllocations) ToMap() (map[string]interface{}, error) {
...
type NullableBlockInstructionTypeGenericRoomAllocations struct {
	value *BlockInstructionTypeGenericRoomAllocations
	isSet bool
}

func (v NullableBlockInstructionTypeGenericRoomAllocations) Get() *BlockInstructionTypeGenericRoomAllocations {
	return v.value
}

func (v *NullableBlockInstructionTypeGenericRoomAllocations) Set(val *BlockInstructionTypeGenericRoomAllocations) {
	v.value = val
	v.isSet = true
}

func (v NullableBlockInstructionTypeGenericRoomAllocations) IsSet() bool {
	return v.isSet
}

func (v *NullableBlockInstructionTypeGenericRoomAllocations) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBlockInstructionTypeGenericRoomAllocations(val *BlockInstructionTypeGenericRoomAllocations) *NullableBlockInstructionTypeGenericRoomAllocations {
	return &NullableBlockInstructionTypeGenericRoomAllocations{value: val, isSet: true}
}

func (v NullableBlockInstructionTypeGenericRoomAllocations) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBlockInstructionTypeGenericRoomAllocations) UnmarshalJSON(src []byte) error {
	v.isSet = true
