...
// APIClient manages communication with the OPERA Cloud Block API API v23.2
...
type APIClient struct {
	...
	BlockStatsApi *BlockStatsApiService
...
func NewAPIClient(cfg *Configuration) *APIClient {
	...
	c.BlockStatsApi = (*BlockStatsApiService)(&c.common)
