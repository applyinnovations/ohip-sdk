...
// checks if the PostTourSeriesRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PostTourSeriesRequest{}

// PostTourSeriesRequest struct for PostTourSeriesRequest
type PostTourSeriesRequest struct {
...
func (o PostTourSeriesRequest) MarshalJSON() ([]byte, error) {
...
func (o PostTourSeriesRequest) ToMap() (map[string]interface{}, error) {
...
type NullablePostTourSeriesRequest struct {
	value *PostTourSeriesRequest
	isSet bool
}

func (v NullablePostTourSeriesRequest) Get() *PostTourSeriesRequest {
	return v.value
}

func (v *NullablePostTourSeriesRequest) Set(val *PostTourSeriesRequest) {
	v.value = val
	v.isSet = true
}

func (v NullablePostTourSeriesRequest) IsSet() bool {
	return v.isSet
}

func (v *NullablePostTourSeriesRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePostTourSeriesRequest(val *PostTourSeriesRequest) *NullablePostTourSeriesRequest {
	return &NullablePostTourSeriesRequest{value: val, isSet: true}
}

func (v NullablePostTourSeriesRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePostTourSeriesRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
