...
// checks if the ChangeFloorsRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ChangeFloorsRequest{}

// ChangeFloorsRequest struct for ChangeFloorsRequest
type ChangeFloorsRequest struct {
...
func (o ChangeFloorsRequest) MarshalJSON() ([]byte, error) {
...
func (o ChangeFloorsRequest) ToMap() (map[string]interface{}, error) {
...
type NullableChangeFloorsRequest struct {
	value *ChangeFloorsRequest
	isSet bool
}

func (v NullableChangeFloorsRequest) Get() *ChangeFloorsRequest {
	return v.value
}

func (v *NullableChangeFloorsRequest) Set(val *ChangeFloorsRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableChangeFloorsRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableChangeFloorsRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableChangeFloorsRequest(val *ChangeFloorsRequest) *NullableChangeFloorsRequest {
	return &NullableChangeFloorsRequest{value: val, isSet: true}
}

func (v NullableChangeFloorsRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableChangeFloorsRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
