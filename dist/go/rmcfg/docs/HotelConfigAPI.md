...
[**ChangeTemplateHousekeepingRoomSchedule**](HotelConfigAPI.md#ChangeTemplateHousekeepingRoomSchedule) | **Put** /roomSchedules/templates/{sequenceId} | Change housekeeping room schedules configured at template level
...
[**DeleteTemplateHousekeepingRoomSchedule**](HotelConfigAPI.md#DeleteTemplateHousekeepingRoomSchedule) | **Delete** /roomSchedules/templates/{sequenceId} | Delete housekeeping room schedules configured at template level
...
[**DeleteVacantRoomStatus**](HotelConfigAPI.md#DeleteVacantRoomStatus) | **Delete** /hotels/{hotelId}/vacantRoomStatus/{vacantRoomStatusId} | Delete vacant room status configuration.
...
[**GetTemplateHousekeepingRoomSchedules**](HotelConfigAPI.md#GetTemplateHousekeepingRoomSchedules) | **Get** /roomSchedules/templates | Get housekeeping room schedules configured at template level.
...
[**GetVacantRoomStatus**](HotelConfigAPI.md#GetVacantRoomStatus) | **Get** /hotels/{hotelId}/vacantRoomStatus | Get vacant room status configuration.
...
[**PostTemplateHousekeepingRoomSchedule**](HotelConfigAPI.md#PostTemplateHousekeepingRoomSchedule) | **Post** /roomSchedules/templates | Create housekeeping room schedules at template level
...
[**PostVacantRoomStatus**](HotelConfigAPI.md#PostVacantRoomStatus) | **Post** /hotels/{hotelId}/vacantRoomStatus | Create vacant room status configuration.
...
[**PutVacantRoomStatus**](HotelConfigAPI.md#PutVacantRoomStatus) | **Put** /hotels/{hotelId}/vacantRoomStatus/{vacantRoomStatusId} | Update the vacant room status configuration.
...
[**RemoveHousekeepingSchedule**](HotelConfigAPI.md#RemoveHousekeepingSchedule) | **Delete** /hotels/{hotelId}/roomSchedules/{sequenceId} | Delete housekeeping room schedules
...
> Status ChangeTemplateHousekeepingRoomSchedule(ctx, sequenceId).Authorization(authorization).XAppKey(xAppKey).XHotelid(xHotelid).TemplateHousekeepingRoomSchedulesToBeChanged(templateHousekeepingRoomSchedulesToBeChanged).XExternalsystem(xExternalsystem).AcceptLanguage(acceptLanguage).Execute()

Change housekeeping room schedules configured at template level
...
func main() {
    sequenceId := int32(56) // int32 | Unique sequence number of room scheduled.
    authorization := "authorization_example" // string | Bearer token that needs to be passed which is generated post user authentication
    xAppKey := "xAppKey_example" // string | Client or Partner's Application Key
    xHotelid := "xHotelid_example" // string | Mandatory parameter to identify the hotel code where the end user is logged in
    templateHousekeepingRoomSchedulesToBeChanged := *openapiclient.NewTemplateHousekeepingRoomSchedulesToBeChanged() // TemplateHousekeepingRoomSchedulesToBeChanged | Request object for changing housekeeping task schedules configured at template level.
    xExternalsystem := "xExternalsystem_example" // string | External system code. (optional)
    acceptLanguage := "acceptLanguage_example" // string | Language code (optional)

    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.HotelConfigAPI.ChangeTemplateHousekeepingRoomSchedule(context.Background(), sequenceId).Authorization(authorization).XAppKey(xAppKey).XHotelid(xHotelid).TemplateHousekeepingRoomSchedulesToBeChanged(templateHousekeepingRoomSchedulesToBeChanged).XExternalsystem(xExternalsystem).AcceptLanguage(acceptLanguage).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `HotelConfigAPI.ChangeTemplateHousekeepingRoomSchedule``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `ChangeTemplateHousekeepingRoomSchedule`: Status
    fmt.Fprintf(os.Stdout, "Response from `HotelConfigAPI.ChangeTemplateHousekeepingRoomSchedule`: %v\n", resp)
}
```
...
------------- | ------------- | ------------- | -------------
**ctx** | **context.Context** | context for authentication, logging, cancellation, deadlines, tracing, etc.
**sequenceId** | **int32** | Unique sequence number of room scheduled. | 

### Other Parameters

Other parameters are passed through a pointer to a apiChangeTemplateHousekeepingRoomScheduleRequest struct via the builder pattern
 ...
 **xAppKey** | **string** | Client or Partner&#39;s Application Key | 
 **xHotelid** | **string** | Mandatory parameter to identify the hotel code where the end user is logged in | 
 **templateHousekeepingRoomSchedulesToBeChanged** | [**TemplateHousekeepingRoomSchedulesToBeChanged**](TemplateHousekeepingRoomSchedulesToBeChanged.md) | Request object for changing housekeeping task schedules configured at template level. | 
 **xExternalsystem** | **string** | External system code. | 
 **acceptLanguage** | **string** | Language code | 
...
> Status DeleteTemplateHousekeepingRoomSchedule(ctx, sequenceId).Authorization(authorization).XAppKey(xAppKey).XHotelid(xHotelid).XExternalsystem(xExternalsystem).AcceptLanguage(acceptLanguage).Execute()

Delete housekeeping room schedules configured at template level
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.HotelConfigAPI.DeleteTemplateHousekeepingRoomSchedule(context.Background(), sequenceId).Authorization(authorization).XAppKey(xAppKey).XHotelid(xHotelid).XExternalsystem(xExternalsystem).AcceptLanguage(acceptLanguage).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `HotelConfigAPI.DeleteTemplateHousekeepingRoomSchedule``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `DeleteTemplateHousekeepingRoomSchedule`: Status
    fmt.Fprintf(os.Stdout, "Response from `HotelConfigAPI.DeleteTemplateHousekeepingRoomSchedule`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiDeleteTemplateHousekeepingRoomScheduleRequest struct via the builder pattern
...
> Status DeleteVacantRoomStatus(ctx, hotelId, vacantRoomStatusId).Authorization(authorization).XAppKey(xAppKey).XHotelid(xHotelid).XExternalsystem(xExternalsystem).AcceptLanguage(acceptLanguage).Execute()

Delete vacant room status configuration.
...
func main() {
    hotelId := "hotelId_example" // string | Hotel Code for which vacant room status needs to be fetched.
    vacantRoomStatusId := float32(8.14) // float32 | The unique ID of the vacant room configuration to which this record applies.
    authorization := "authorization_example" // string | Bearer token that needs to be passed which is generated post user authentication
    xAppKey := "xAppKey_example" // string | Client or Partner's Application Key
    xHotelid := "xHotelid_example" // string | Mandatory parameter to identify the hotel code where the end user is logged in
    xExternalsystem := "xExternalsystem_example" // string | External system code. (optional)
    ...
    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.HotelConfigAPI.DeleteVacantRoomStatus(context.Background(), hotelId, vacantRoomStatusId).Authorization(authorization).XAppKey(xAppKey).XHotelid(xHotelid).XExternalsystem(xExternalsystem).AcceptLanguage(acceptLanguage).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `HotelConfigAPI.DeleteVacantRoomStatus``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `DeleteVacantRoomStatus`: Status
    fmt.Fprintf(os.Stdout, "Response from `HotelConfigAPI.DeleteVacantRoomStatus`: %v\n", resp)
}
```
...
------------- | ------------- | ------------- | -------------
**ctx** | **context.Context** | context for authentication, logging, cancellation, deadlines, tracing, etc.
**hotelId** | **string** | Hotel Code for which vacant room status needs to be fetched. | 
**vacantRoomStatusId** | **float32** | The unique ID of the vacant room configuration to which this record applies. | 

### Other Parameters

Other parameters are passed through a pointer to a apiDeleteVacantRoomStatusRequest struct via the builder pattern
 ...
 **xHotelid** | **string** | Mandatory parameter to identify the hotel code where the end user is logged in | 
 **ruleCodes** | **[]string** |  | 
 **ruleType** | **string** | A Facility Rule will add extra credit to a task assignment sheet when certain task conditions exist. Multiple Facility Task Rules will be applied on top of each other if the conditions are met. A Miscellaneous Rule will add extra credit to a task assignment sheet when the attendants are occupied with anything other than cleaning a room, for example a team meeting. A Special Rule will add extra credit to a task assignment sheet when the defined Specials are attached to a reservation. A Traveling Rule will add extra credit to a task assignment sheet when rooms from multiple Buildings, Section Groups, Sections and/or Floors are assigned. An Inventory Item Rule will add extra credit to a task assignment sheet when the defined Items are attached to a reservation. | 
...
> TemplateHousekeepingRoomSchedulesDetails GetTemplateHousekeepingRoomSchedules(ctx).Authorization(authorization).XAppKey(xAppKey).XHotelid(xHotelid).RoomTypeCodes(roomTypeCodes).HousekeepingRoomScheduleCodes(housekeepingRoomScheduleCodes).XExternalsystem(xExternalsystem).AcceptLanguage(acceptLanguage).Execute()

Get housekeeping room schedules configured at template level.
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.HotelConfigAPI.GetTemplateHousekeepingRoomSchedules(context.Background()).Authorization(authorization).XAppKey(xAppKey).XHotelid(xHotelid).RoomTypeCodes(roomTypeCodes).HousekeepingRoomScheduleCodes(housekeepingRoomScheduleCodes).XExternalsystem(xExternalsystem).AcceptLanguage(acceptLanguage).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `HotelConfigAPI.GetTemplateHousekeepingRoomSchedules``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `GetTemplateHousekeepingRoomSchedules`: TemplateHousekeepingRoomSchedulesDetails
    fmt.Fprintf(os.Stdout, "Response from `HotelConfigAPI.GetTemplateHousekeepingRoomSchedules`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiGetTemplateHousekeepingRoomSchedulesRequest struct via the builder pattern
...
[**TemplateHousekeepingRoomSchedulesDetails**](TemplateHousekeepingRoomSchedulesDetails.md)
...
> VacantRoomStatusesList GetVacantRoomStatus(ctx, hotelId).Authorization(authorization).XAppKey(xAppKey).XHotelid(xHotelid).RoomTypes(roomTypes).BeginDate(beginDate).EndDate(endDate).Limit(limit).Offset(offset).XExternalsystem(xExternalsystem).AcceptLanguage(acceptLanguage).Execute()

Get vacant room status configuration.
...
func main() {
    ...
    xAppKey := "xAppKey_example" // string | Client or Partner's Application Key
    xHotelid := "xHotelid_example" // string | Mandatory parameter to identify the hotel code where the end user is logged in
    roomTypes := []string{"Inner_example"} // []string | Room Type of the room. (optional)
    beginDate := time.Now() // string | The starting value of the date range. By default this would be the current business date. (optional)
    endDate := time.Now() // string | The ending value of the date range. (optional)
    limit := int32(56) // int32 | Indicates maximum number of records a Web Service should return. (optional)
    offset := int32(56) // int32 | Index or initial index of the set(page) being requested. If the index goes out of the bounds of the total set count then no data will be returned. (optional)
    xExternalsystem := "xExternalsystem_example" // string | External system code. (optional)
    acceptLanguage := "acceptLanguage_example" // string | Language code (optional)

    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.HotelConfigAPI.GetVacantRoomStatus(context.Background(), hotelId).Authorization(authorization).XAppKey(xAppKey).XHotelid(xHotelid).RoomTypes(roomTypes).BeginDate(beginDate).EndDate(endDate).Limit(limit).Offset(offset).XExternalsystem(xExternalsystem).AcceptLanguage(acceptLanguage).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `HotelConfigAPI.GetVacantRoomStatus``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `GetVacantRoomStatus`: VacantRoomStatusesList
    fmt.Fprintf(os.Stdout, "Response from `HotelConfigAPI.GetVacantRoomStatus`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiGetVacantRoomStatusRequest struct via the builder pattern
 ...
 **xAppKey** | **string** | Client or Partner&#39;s Application Key | 
 **xHotelid** | **string** | Mandatory parameter to identify the hotel code where the end user is logged in | 
 **roomTypes** | **[]string** | Room Type of the room. | 
 **beginDate** | **string** | The starting value of the date range. By default this would be the current business date. | 
...
[**VacantRoomStatusesList**](VacantRoomStatusesList.md)
...
> Status PostTemplateHousekeepingRoomSchedule(ctx).Authorization(authorization).XAppKey(xAppKey).XHotelid(xHotelid).TemplateHousekeepingRoomSchedulesCriteria(templateHousekeepingRoomSchedulesCriteria).XExternalsystem(xExternalsystem).AcceptLanguage(acceptLanguage).Execute()

Create housekeeping room schedules at template level
...
func main() {
    ...
    xAppKey := "xAppKey_example" // string | Client or Partner's Application Key
    xHotelid := "xHotelid_example" // string | Mandatory parameter to identify the hotel code where the end user is logged in
    templateHousekeepingRoomSchedulesCriteria := *openapiclient.NewTemplateHousekeepingRoomSchedulesCriteria() // TemplateHousekeepingRoomSchedulesCriteria | Request object to create housekeeping room schedules at template level
    xExternalsystem := "xExternalsystem_example" // string | External system code. (optional)
    acceptLanguage := "acceptLanguage_example" // string | Language code (optional)

    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.HotelConfigAPI.PostTemplateHousekeepingRoomSchedule(context.Background()).Authorization(authorization).XAppKey(xAppKey).XHotelid(xHotelid).TemplateHousekeepingRoomSchedulesCriteria(templateHousekeepingRoomSchedulesCriteria).XExternalsystem(xExternalsystem).AcceptLanguage(acceptLanguage).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `HotelConfigAPI.PostTemplateHousekeepingRoomSchedule``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `PostTemplateHousekeepingRoomSchedule`: Status
    fmt.Fprintf(os.Stdout, "Response from `HotelConfigAPI.PostTemplateHousekeepingRoomSchedule`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiPostTemplateHousekeepingRoomScheduleRequest struct via the builder pattern
 ...
 **xAppKey** | **string** | Client or Partner&#39;s Application Key | 
 **xHotelid** | **string** | Mandatory parameter to identify the hotel code where the end user is logged in | 
 **templateHousekeepingRoomSchedulesCriteria** | [**TemplateHousekeepingRoomSchedulesCriteria**](TemplateHousekeepingRoomSchedulesCriteria.md) | Request object to create housekeeping room schedules at template level | 
 **xExternalsystem** | **string** | External system code. | 
 **acceptLanguage** | **string** | Language code | 
...
> Status PostVacantRoomStatus(ctx, hotelId).Authorization(authorization).XAppKey(xAppKey).XHotelid(xHotelid).VacantRoomStatusDetails(vacantRoomStatusDetails).XExternalsystem(xExternalsystem).AcceptLanguage(acceptLanguage).Execute()

Create vacant room status configuration.
...
func main() {
    ...
    xAppKey := "xAppKey_example" // string | Client or Partner's Application Key
    xHotelid := "xHotelid_example" // string | Mandatory parameter to identify the hotel code where the end user is logged in
    vacantRoomStatusDetails := *openapiclient.NewVacantRoomStatusDetails() // VacantRoomStatusDetails | Request object for creating a vacant room housekeeping status details.
    xExternalsystem := "xExternalsystem_example" // string | External system code. (optional)
    acceptLanguage := "acceptLanguage_example" // string | Language code (optional)

    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.HotelConfigAPI.PostVacantRoomStatus(context.Background(), hotelId).Authorization(authorization).XAppKey(xAppKey).XHotelid(xHotelid).VacantRoomStatusDetails(vacantRoomStatusDetails).XExternalsystem(xExternalsystem).AcceptLanguage(acceptLanguage).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `HotelConfigAPI.PostVacantRoomStatus``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `PostVacantRoomStatus`: Status
    fmt.Fprintf(os.Stdout, "Response from `HotelConfigAPI.PostVacantRoomStatus`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiPostVacantRoomStatusRequest struct via the builder pattern
 ...
 **xAppKey** | **string** | Client or Partner&#39;s Application Key | 
 **xHotelid** | **string** | Mandatory parameter to identify the hotel code where the end user is logged in | 
 **vacantRoomStatusDetails** | [**VacantRoomStatusDetails**](VacantRoomStatusDetails.md) | Request object for creating a vacant room housekeeping status details. | 
 **xExternalsystem** | **string** | External system code. | 
 **acceptLanguage** | **string** | Language code | 
...
> Status PutVacantRoomStatus(ctx, hotelId, vacantRoomStatusId).Authorization(authorization).XAppKey(xAppKey).XHotelid(xHotelid).VacantRoomStatusDetails(vacantRoomStatusDetails).XExternalsystem(xExternalsystem).AcceptLanguage(acceptLanguage).Execute()

Update the vacant room status configuration.
...
func main() {
    ...
    xAppKey := "xAppKey_example" // string | Client or Partner's Application Key
    xHotelid := "xHotelid_example" // string | Mandatory parameter to identify the hotel code where the end user is logged in
    vacantRoomStatusDetails := *openapiclient.NewVacantRoomStatusDetails() // VacantRoomStatusDetails | Request object for creating a vacant room housekeeping details.
    xExternalsystem := "xExternalsystem_example" // string | External system code. (optional)
    acceptLanguage := "acceptLanguage_example" // string | Language code (optional)

    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.HotelConfigAPI.PutVacantRoomStatus(context.Background(), hotelId, vacantRoomStatusId).Authorization(authorization).XAppKey(xAppKey).XHotelid(xHotelid).VacantRoomStatusDetails(vacantRoomStatusDetails).XExternalsystem(xExternalsystem).AcceptLanguage(acceptLanguage).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `HotelConfigAPI.PutVacantRoomStatus``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `PutVacantRoomStatus`: Status
    fmt.Fprintf(os.Stdout, "Response from `HotelConfigAPI.PutVacantRoomStatus`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiPutVacantRoomStatusRequest struct via the builder pattern
 ...
 **xAppKey** | **string** | Client or Partner&#39;s Application Key | 
 **xHotelid** | **string** | Mandatory parameter to identify the hotel code where the end user is logged in | 
 **vacantRoomStatusDetails** | [**VacantRoomStatusDetails**](VacantRoomStatusDetails.md) | Request object for creating a vacant room housekeeping details. | 
 **xExternalsystem** | **string** | External system code. | 
 **acceptLanguage** | **string** | Language code | 
...
> Status RemoveHousekeepingSchedule(ctx, sequenceId, hotelId).Authorization(authorization).XAppKey(xAppKey).XHotelid(xHotelid).XExternalsystem(xExternalsystem).AcceptLanguage(acceptLanguage).Execute()
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.HotelConfigAPI.RemoveHousekeepingSchedule(context.Background(), sequenceId, hotelId).Authorization(authorization).XAppKey(xAppKey).XHotelid(xHotelid).XExternalsystem(xExternalsystem).AcceptLanguage(acceptLanguage).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `HotelConfigAPI.RemoveHousekeepingSchedule``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `RemoveHousekeepingSchedule`: Status
    fmt.Fprintf(os.Stdout, "Response from `HotelConfigAPI.RemoveHousekeepingSchedule`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiRemoveHousekeepingScheduleRequest struct via the builder pattern
