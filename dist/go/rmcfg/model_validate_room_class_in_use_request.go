...
// checks if the ValidateRoomClassInUseRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ValidateRoomClassInUseRequest{}

// ValidateRoomClassInUseRequest struct for ValidateRoomClassInUseRequest
type ValidateRoomClassInUseRequest struct {
...
func NewValidateRoomClassInUseRequest() *ValidateRoomClassInUseRequest {
	this := ValidateRoomClassInUseRequest{}
	return &this
}
...
func (o ValidateRoomClassInUseRequest) MarshalJSON() ([]byte, error) {
...
func (o ValidateRoomClassInUseRequest) ToMap() (map[string]interface{}, error) {
...
type NullableValidateRoomClassInUseRequest struct {
	value *ValidateRoomClassInUseRequest
	isSet bool
}

func (v NullableValidateRoomClassInUseRequest) Get() *ValidateRoomClassInUseRequest {
	return v.value
}

func (v *NullableValidateRoomClassInUseRequest) Set(val *ValidateRoomClassInUseRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableValidateRoomClassInUseRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableValidateRoomClassInUseRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableValidateRoomClassInUseRequest(val *ValidateRoomClassInUseRequest) *NullableValidateRoomClassInUseRequest {
	return &NullableValidateRoomClassInUseRequest{value: val, isSet: true}
}

func (v NullableValidateRoomClassInUseRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableValidateRoomClassInUseRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
