...
// checks if the ChangeRoomGroupsRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ChangeRoomGroupsRequest{}

// ChangeRoomGroupsRequest struct for ChangeRoomGroupsRequest
type ChangeRoomGroupsRequest struct {
...
func (o ChangeRoomGroupsRequest) MarshalJSON() ([]byte, error) {
...
func (o ChangeRoomGroupsRequest) ToMap() (map[string]interface{}, error) {
...
type NullableChangeRoomGroupsRequest struct {
	value *ChangeRoomGroupsRequest
	isSet bool
}

func (v NullableChangeRoomGroupsRequest) Get() *ChangeRoomGroupsRequest {
	return v.value
}

func (v *NullableChangeRoomGroupsRequest) Set(val *ChangeRoomGroupsRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableChangeRoomGroupsRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableChangeRoomGroupsRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableChangeRoomGroupsRequest(val *ChangeRoomGroupsRequest) *NullableChangeRoomGroupsRequest {
	return &NullableChangeRoomGroupsRequest{value: val, isSet: true}
}

func (v NullableChangeRoomGroupsRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableChangeRoomGroupsRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
