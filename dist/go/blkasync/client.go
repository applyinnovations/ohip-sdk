...
// APIClient manages communication with the OPERA Cloud Block Reservation Asynchronous API API v22.4.0.0
...
type APIClient struct {
	...
	BlockAsyncApi *BlockAsyncApiService
...
func NewAPIClient(cfg *Configuration) *APIClient {
	...
	// API Services
	c.BlockAsyncApi = (*BlockAsyncApiService)(&c.common)
