...
------------ | ------------- | ------------- | -------------
**BlockId** | Pointer to **float32** | A unique identifying value assigned by the creating system. The ID attribute may be used to reference a primary-key value within a database or in a particular implementation. | [optional] 
...
**MasterBlockId** | Pointer to **float32** | A unique identifying value assigned by the creating system. The ID attribute may be used to reference a primary-key value within a database or in a particular implementation. | [optional] 
...
**CutOffDate** | Pointer to **string** |  | [optional] 
...
**CreateDateTime** | Pointer to **string** | The business date the block was created. | [optional] 
...
**LastModifiedDate** | Pointer to **string** | Date Time when the block was modified last. | [optional] 
...
**BookingMedium** | Pointer to **string** | Booking Medium/Origin Code of the Block. | [optional] 
**BlockProfiles** | Pointer to [**BlockAllocationSummaryTypeBlockProfiles**](BlockAllocationSummaryTypeBlockProfiles.md) |  | [optional] 
