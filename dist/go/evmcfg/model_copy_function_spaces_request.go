...
// checks if the CopyFunctionSpacesRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CopyFunctionSpacesRequest{}

// CopyFunctionSpacesRequest struct for CopyFunctionSpacesRequest
type CopyFunctionSpacesRequest struct {
...
func NewCopyFunctionSpacesRequest() *CopyFunctionSpacesRequest {
	this := CopyFunctionSpacesRequest{}
	return &this
}
...
func (o CopyFunctionSpacesRequest) MarshalJSON() ([]byte, error) {
...
func (o CopyFunctionSpacesRequest) ToMap() (map[string]interface{}, error) {
...
type NullableCopyFunctionSpacesRequest struct {
	value *CopyFunctionSpacesRequest
	isSet bool
}

func (v NullableCopyFunctionSpacesRequest) Get() *CopyFunctionSpacesRequest {
	return v.value
}

func (v *NullableCopyFunctionSpacesRequest) Set(val *CopyFunctionSpacesRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableCopyFunctionSpacesRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableCopyFunctionSpacesRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCopyFunctionSpacesRequest(val *CopyFunctionSpacesRequest) *NullableCopyFunctionSpacesRequest {
	return &NullableCopyFunctionSpacesRequest{value: val, isSet: true}
}

func (v NullableCopyFunctionSpacesRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCopyFunctionSpacesRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
