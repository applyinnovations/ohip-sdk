...
[**CopyCateringPackage**](ResourceConfigAPI.md#CopyCateringPackage) | **Post** /hotels/{hotelId}/cateringPackages/{cateringPackageId}/copy | Operation to copy catering package or template.
[**CopyCateringPackagePrice**](ResourceConfigAPI.md#CopyCateringPackagePrice) | **Post** /hotels/{hotelId}/cateringPackages/{cateringPackageId}/prices/{pricesId}/copy | Operation to copy catering package price.
...
[**DeleteResourceConfigServiceCache**](ResourceConfigAPI.md#DeleteResourceConfigServiceCache) | **Delete** /services/resources/cache | ClearCache
...
> ResourceCodeInfo CopyCateringPackage(ctx, hotelId, cateringPackageId).Authorization(authorization).XAppKey(xAppKey).XHotelid(xHotelid).CopyCateringPackageType(copyCateringPackageType).XExternalsystem(xExternalsystem).AcceptLanguage(acceptLanguage).Execute()

Operation to copy catering package or template.
...
func main() {
    ...
    cateringPackageId := "cateringPackageId_example" // string | Unique Catering Package or Template ID.
    authorization := "authorization_example" // string | Bearer token that needs to be passed which is generated post user authentication
    xAppKey := "xAppKey_example" // string | Client or Partner's Application Key
    xHotelid := "xHotelid_example" // string | Mandatory parameter to identify the hotel code where the end user is logged in
    copyCateringPackageType := *openapiclient.NewCopyCateringPackageType() // CopyCateringPackageType | Request object for Copying Catering Package/Template.
    xExternalsystem := "xExternalsystem_example" // string | External system code. (optional)
    acceptLanguage := "acceptLanguage_example" // string | Language code (optional)

    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.ResourceConfigAPI.CopyCateringPackage(context.Background(), hotelId, cateringPackageId).Authorization(authorization).XAppKey(xAppKey).XHotelid(xHotelid).CopyCateringPackageType(copyCateringPackageType).XExternalsystem(xExternalsystem).AcceptLanguage(acceptLanguage).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `ResourceConfigAPI.CopyCateringPackage``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `CopyCateringPackage`: ResourceCodeInfo
    fmt.Fprintf(os.Stdout, "Response from `ResourceConfigAPI.CopyCateringPackage`: %v\n", resp)
}
```
...
**cateringPackageId** | **string** | Unique Catering Package or Template ID. | 
 ...
 **xAppKey** | **string** | Client or Partner&#39;s Application Key | 
 **xHotelid** | **string** | Mandatory parameter to identify the hotel code where the end user is logged in | 
 **copyCateringPackageType** | [**CopyCateringPackageType**](CopyCateringPackageType.md) | Request object for Copying Catering Package/Template. | 
 **xExternalsystem** | **string** | External system code. | 
 **acceptLanguage** | **string** | Language code | 

### Return type

[**ResourceCodeInfo**](ResourceCodeInfo.md)
...
> ResourceCodeInfo CopyCateringPackagePrice(ctx, pricesId, cateringPackageId, hotelId).Authorization(authorization).XAppKey(xAppKey).XHotelid(xHotelid).CopyCateringPackagePriceType(copyCateringPackagePriceType).XExternalsystem(xExternalsystem).AcceptLanguage(acceptLanguage).Execute()

Operation to copy catering package price.
...
func main() {
    ...
    xAppKey := "xAppKey_example" // string | Client or Partner's Application Key
    xHotelid := "xHotelid_example" // string | Mandatory parameter to identify the hotel code where the end user is logged in
    copyCateringPackagePriceType := *openapiclient.NewCopyCateringPackagePriceType() // CopyCateringPackagePriceType | Request object for Copying Catering Package Price.
    xExternalsystem := "xExternalsystem_example" // string | External system code. (optional)
    acceptLanguage := "acceptLanguage_example" // string | Language code (optional)

    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.ResourceConfigAPI.CopyCateringPackagePrice(context.Background(), pricesId, cateringPackageId, hotelId).Authorization(authorization).XAppKey(xAppKey).XHotelid(xHotelid).CopyCateringPackagePriceType(copyCateringPackagePriceType).XExternalsystem(xExternalsystem).AcceptLanguage(acceptLanguage).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `ResourceConfigAPI.CopyCateringPackagePrice``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `CopyCateringPackagePrice`: ResourceCodeInfo
    fmt.Fprintf(os.Stdout, "Response from `ResourceConfigAPI.CopyCateringPackagePrice`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiCopyCateringPackagePriceRequest struct via the builder pattern
 ...
 **xAppKey** | **string** | Client or Partner&#39;s Application Key | 
 **xHotelid** | **string** | Mandatory parameter to identify the hotel code where the end user is logged in | 
 **copyCateringPackagePriceType** | [**CopyCateringPackagePriceType**](CopyCateringPackagePriceType.md) | Request object for Copying Catering Package Price. | 
 **xExternalsystem** | **string** | External system code. | 
 **acceptLanguage** | **string** | Language code | 
...
## DeleteResourceConfigServiceCache

> Status DeleteResourceConfigServiceCache(ctx).Authorization(authorization).XAppKey(xAppKey).XHotelid(xHotelid).OperaClearInput(operaClearInput).XExternalsystem(xExternalsystem).AcceptLanguage(acceptLanguage).Execute()
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.ResourceConfigAPI.DeleteResourceConfigServiceCache(context.Background()).Authorization(authorization).XAppKey(xAppKey).XHotelid(xHotelid).OperaClearInput(operaClearInput).XExternalsystem(xExternalsystem).AcceptLanguage(acceptLanguage).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `ResourceConfigAPI.DeleteResourceConfigServiceCache``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `DeleteResourceConfigServiceCache`: Status
    fmt.Fprintf(os.Stdout, "Response from `ResourceConfigAPI.DeleteResourceConfigServiceCache`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiDeleteResourceConfigServiceCacheRequest struct via the builder pattern
 ...
 **fetchInstructions** | **[]string** | Fetch instructions that can be used in Fetching Catering Menus Items. SummaryInfo fetchInstruction is used to fetch limited set of Menu Item information required for Menu Items Panel Drawer and DetailsInfo returns detailed information required for Menu Items listing screen. | 
 **xExternalsystem** | **string** | External system code. | 
 **acceptLanguage** | **string** | Language code | 
