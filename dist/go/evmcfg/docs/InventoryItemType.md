...
**TracesPerDay** | Pointer to **bool** | Flag to indicate that trace text will be created for each day of the Item Inventory. | [optional] 
...
**ResourceNotes** | Pointer to [**[]EventResourceNoteType**](EventResourceNoteType.md) | Contains event resource note information. | [optional] 
