...
// APIClient manages communication with the OPERA Cloud Event Configuration API API v23.2
...
type APIClient struct {
	...
	ResourceConfigApi *ResourceConfigApiService
...
func NewAPIClient(cfg *Configuration) *APIClient {
	...
	c.ResourceConfigApi = (*ResourceConfigApiService)(&c.common)
