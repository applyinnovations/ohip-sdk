...
// APIClient manages communication with the OPERA Cloud Price Availability Rate Async API API v23.2
...
type APIClient struct {
	...
	AvailabilityAsyncApi *AvailabilityAsyncApiService
...
func NewAPIClient(cfg *Configuration) *APIClient {
	...
	// API Services
	c.AvailabilityAsyncApi = (*AvailabilityAsyncApiService)(&c.common)
