...
func Test_lov_LOVAPIService(t *testing.T) {
	...
	t.Run("Test LOVAPIService DeleteLOVServiceCache", func(t *testing.T) {

		t.Skip("skip test")  // remove to run test

		resp, httpRes, err := apiClient.LOVAPI.DeleteLOVServiceCache(context.Background()).Execute()
	...
	t.Run("Test LOVAPIService GetRoomsKeyCreationLOV", func(t *testing.T) {
		...
		resp, httpRes, err := apiClient.LOVAPI.GetRoomsKeyCreationLOV(context.Background(), room, hotelId).Execute()
	...
	t.Run("Test LOVAPIService GetSnapshotTypesLOV", func(t *testing.T) {

		t.Skip("skip test")  // remove to run test

		var hotelId string

		resp, httpRes, err := apiClient.LOVAPI.GetSnapshotTypesLOV(context.Background(), hotelId).Execute()
