...
**BillNumber** | Pointer to **float32** | Optional bill number to generate. | [optional] 
...
`func (o *FolioReportCriteriaType) GetBillNumber() float32`

GetBillNumber returns the BillNumber field if non-nil, zero value otherwise.

### GetBillNumberOk

`func (o *FolioReportCriteriaType) GetBillNumberOk() (*float32, bool)`
...
`func (o *FolioReportCriteriaType) SetBillNumber(v float32)`
