...
// APIClient manages communication with the OPERA Cloud Content Service API v22.3
...
type APIClient struct {
	...
	OperaContentApi *OperaContentApiService
...
func NewAPIClient(cfg *Configuration) *APIClient {
	...
	// API Services
	c.OperaContentApi = (*OperaContentApiService)(&c.common)
