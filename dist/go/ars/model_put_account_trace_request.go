...
// checks if the PutAccountTraceRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PutAccountTraceRequest{}

// PutAccountTraceRequest struct for PutAccountTraceRequest
type PutAccountTraceRequest struct {
...
func (o PutAccountTraceRequest) MarshalJSON() ([]byte, error) {
...
func (o PutAccountTraceRequest) ToMap() (map[string]interface{}, error) {
...
type NullablePutAccountTraceRequest struct {
	value *PutAccountTraceRequest
	isSet bool
}

func (v NullablePutAccountTraceRequest) Get() *PutAccountTraceRequest {
	return v.value
}

func (v *NullablePutAccountTraceRequest) Set(val *PutAccountTraceRequest) {
	v.value = val
	v.isSet = true
}

func (v NullablePutAccountTraceRequest) IsSet() bool {
	return v.isSet
}

func (v *NullablePutAccountTraceRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePutAccountTraceRequest(val *PutAccountTraceRequest) *NullablePutAccountTraceRequest {
	return &NullablePutAccountTraceRequest{value: val, isSet: true}
}

func (v NullablePutAccountTraceRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePutAccountTraceRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
