...
// APIClient manages communication with the OPERA Cloud Accounts Receivables API API v22.3
...
type APIClient struct {
	...
	AccountsReceivablesApi *AccountsReceivablesApiService
...
func NewAPIClient(cfg *Configuration) *APIClient {
	...
	// API Services
	c.AccountsReceivablesApi = (*AccountsReceivablesApiService)(&c.common)
