...
// checks if the PostChargesToARRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PostChargesToARRequest{}

// PostChargesToARRequest struct for PostChargesToARRequest
type PostChargesToARRequest struct {
...
func (o PostChargesToARRequest) MarshalJSON() ([]byte, error) {
...
func (o PostChargesToARRequest) ToMap() (map[string]interface{}, error) {
...
type NullablePostChargesToARRequest struct {
	value *PostChargesToARRequest
	isSet bool
}

func (v NullablePostChargesToARRequest) Get() *PostChargesToARRequest {
	return v.value
}

func (v *NullablePostChargesToARRequest) Set(val *PostChargesToARRequest) {
	v.value = val
	v.isSet = true
}

func (v NullablePostChargesToARRequest) IsSet() bool {
	return v.isSet
}

func (v *NullablePostChargesToARRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePostChargesToARRequest(val *PostChargesToARRequest) *NullablePostChargesToARRequest {
	return &NullablePostChargesToARRequest{value: val, isSet: true}
}

func (v NullablePostChargesToARRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePostChargesToARRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
