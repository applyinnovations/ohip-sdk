...
// checks if the ProfileEnrollmentTypeAddresses type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ProfileEnrollmentTypeAddresses{}

// ProfileEnrollmentTypeAddresses List of customer addresses.
type ProfileEnrollmentTypeAddresses struct {
...
func NewProfileEnrollmentTypeAddresses() *ProfileEnrollmentTypeAddresses {
	this := ProfileEnrollmentTypeAddresses{}
	return &this
}
...
func (o ProfileEnrollmentTypeAddresses) MarshalJSON() ([]byte, error) {
...
func (o ProfileEnrollmentTypeAddresses) ToMap() (map[string]interface{}, error) {
...
type NullableProfileEnrollmentTypeAddresses struct {
	value *ProfileEnrollmentTypeAddresses
	isSet bool
}

func (v NullableProfileEnrollmentTypeAddresses) Get() *ProfileEnrollmentTypeAddresses {
	return v.value
}

func (v *NullableProfileEnrollmentTypeAddresses) Set(val *ProfileEnrollmentTypeAddresses) {
	v.value = val
	v.isSet = true
}

func (v NullableProfileEnrollmentTypeAddresses) IsSet() bool {
	return v.isSet
}

func (v *NullableProfileEnrollmentTypeAddresses) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableProfileEnrollmentTypeAddresses(val *ProfileEnrollmentTypeAddresses) *NullableProfileEnrollmentTypeAddresses {
	return &NullableProfileEnrollmentTypeAddresses{value: val, isSet: true}
}

func (v NullableProfileEnrollmentTypeAddresses) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableProfileEnrollmentTypeAddresses) UnmarshalJSON(src []byte) error {
	v.isSet = true
