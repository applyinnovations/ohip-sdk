...
type ProfileEnrollmentType struct {
	...
	Addresses *ProfileEnrollmentTypeAddresses `json:"addresses,omitempty"`
...
func (o *ProfileEnrollmentType) GetAddresses() ProfileEnrollmentTypeAddresses {
	if o == nil || IsNil(o.Addresses) {
		var ret ProfileEnrollmentTypeAddresses
		return ret
	}
	return *o.Addresses
}
...
// SetAddresses gets a reference to the given ProfileEnrollmentTypeAddresses and assigns it to the Addresses field.
