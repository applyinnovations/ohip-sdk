...
**GuaranteedYn** | Pointer to **string** |  | [optional] 
...
`func (o *RoomRateType) GetGuaranteedYn() string`

GetGuaranteedYn returns the GuaranteedYn field if non-nil, zero value otherwise.

### GetGuaranteedYnOk

`func (o *RoomRateType) GetGuaranteedYnOk() (*string, bool)`

GetGuaranteedYnOk returns a tuple with the GuaranteedYn field if it's non-nil, zero value otherwise
and a boolean to check if the value has been set.

### SetGuaranteedYn

`func (o *RoomRateType) SetGuaranteedYn(v string)`

SetGuaranteedYn sets GuaranteedYn field to given value.

### HasGuaranteedYn

`func (o *RoomRateType) HasGuaranteedYn() bool`

HasGuaranteedYn returns a boolean if a field has been set.
