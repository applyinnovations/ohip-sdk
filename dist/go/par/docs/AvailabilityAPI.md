...
func main() {
    ...
    hurdleRangeStart := []string{time.Now()} // []string | Hurdle date start range from which the hurdle rate is scheduled. (optional)
    hurdleRangeEnd := []string{time.Now()} // []string | Hurdle date end range to which the hurdle rate is scheduled. (optional)
    xExternalsystem := "xExternalsystem_example" // string | External system code. (optional)
    acceptLanguage := "acceptLanguage_example" // string | Language code (optional)
 ...
 **hurdleRangeStart** | **[]string** | Hurdle date start range from which the hurdle rate is scheduled. | 
 **hurdleRangeEnd** | **[]string** | Hurdle date end range to which the hurdle rate is scheduled. | 
 **xExternalsystem** | **string** | External system code. | 
 **acceptLanguage** | **string** | Language code | 
...
func main() {
    ...
    includeNoRatePlanSet := []bool{false} // []bool | Includes the rate codes which do not have a rate plan set associated. This parameter is applicable when the property has not configured a default rate plan set. (optional)
    ...
    membershipCardNumber := []string{"Inner_example"} // []string | Member Card number associated with the guest membership. (optional)
    ...
    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.AvailabilityAPI.GetHotelAvailability(context.Background(), hotelId).Authorization(authorization).XAppKey(xAppKey).XHotelid(xHotelid).Cro(cro).IncludeClosedRates(includeClosedRates).IncludeDefaultRatePlanSet(includeDefaultRatePlanSet).IncludeNoRatePlanSet(includeNoRatePlanSet).InitialRatePlanSet(initialRatePlanSet).Limit(limit).PagePointerKey(pagePointerKey).RatePlanSet(ratePlanSet).RedeemAwards(redeemAwards).RoomStayStartDate(roomStayStartDate).RoomStayEndDate(roomStayEndDate).RoomStayQuantity(roomStayQuantity).Adults(adults).Children(children).ChildAge(childAge).Bucket1Count(bucket1Count).Bucket2Count(bucket2Count).Bucket3Count(bucket3Count).Bucket4Count(bucket4Count).Bucket5Count(bucket5Count).FullStayTimeSpanStartDate(fullStayTimeSpanStartDate).FullStayTimeSpanEndDate(fullStayTimeSpanEndDate).PrevailingRate(prevailingRate).RateCategory(rateCategory).RateClass(rateClass).RateGroup(rateGroup).RatePlanCode(ratePlanCode).PromotionCode(promotionCode).RoomType(roomType).Feature(feature).ReservationGuestId(reservationGuestId).ReservationGuestIdType(reservationGuestIdType).ReservationProfileType(reservationProfileType).AttachedProfileId(attachedProfileId).HotelReservationId(hotelReservationId).HotelReservationIdType(hotelReservationIdType).RatePlanInfo(ratePlanInfo).ReturnOnlyAvailableRateCodes(returnOnlyAvailableRateCodes).ResGuaranteeInfo(resGuaranteeInfo).RoomTypeInfo(roomTypeInfo).MembershipIdNumber(membershipIdNumber).MembershipLevel(membershipLevel).MembershipType(membershipType).PointsAvailable(pointsAvailable).MembershipCardNumber(membershipCardNumber).SmokingPreference(smokingPreference).HotelPackage(hotelPackage).XExternalsystem(xExternalsystem).AcceptLanguage(acceptLanguage).Execute()
    if err != nil {
 ...
 **includeNoRatePlanSet** | **[]bool** | Includes the rate codes which do not have a rate plan set associated. This parameter is applicable when the property has not configured a default rate plan set. | 
 ...
 **membershipCardNumber** | **[]string** | Member Card number associated with the guest membership. | 
...
> HotelAvailability GetHotelAvailabilityCRO(ctx).Authorization(authorization).XAppKey(xAppKey).XHotelid(xHotelid).Cro(cro).HotelIds(hotelIds).IncludeClosedRates(includeClosedRates).IncludeDefaultRatePlanSet(includeDefaultRatePlanSet).IncludeNoRatePlanSet(includeNoRatePlanSet).InitialRatePlanSet(initialRatePlanSet).Limit(limit).PagePointerKey(pagePointerKey).RatePlanSet(ratePlanSet).RedeemAwards(redeemAwards).RoomStayStartDate(roomStayStartDate).RoomStayEndDate(roomStayEndDate).RoomStayQuantity(roomStayQuantity).Adults(adults).Children(children).ChildAge(childAge).Bucket1Count(bucket1Count).Bucket2Count(bucket2Count).Bucket3Count(bucket3Count).Bucket4Count(bucket4Count).Bucket5Count(bucket5Count).FullStayTimeSpanStartDate(fullStayTimeSpanStartDate).FullStayTimeSpanEndDate(fullStayTimeSpanEndDate).PrevailingRate(prevailingRate).RateCategory(rateCategory).RateClass(rateClass).RateGroup(rateGroup).RatePlanCode(ratePlanCode).PromotionCode(promotionCode).RoomType(roomType).RoomClass(roomClass).BedType(bedType).Feature(feature).ReservationGuestId(reservationGuestId).ReservationGuestIdType(reservationGuestIdType).ReservationProfileType(reservationProfileType).AttachedProfileId(attachedProfileId).HotelReservationId(hotelReservationId).HotelReservationIdType(hotelReservationIdType).RatePlanInfo(ratePlanInfo).ReturnOnlyAvailableRateCodes(returnOnlyAvailableRateCodes).ResGuaranteeInfo(resGuaranteeInfo).RoomTypeInfo(roomTypeInfo).MembershipIdNumber(membershipIdNumber).MembershipLevel(membershipLevel).MembershipType(membershipType).PointsAvailable(pointsAvailable).MembershipCardNumber(membershipCardNumber).SmokingPreference(smokingPreference).HotelPackage(hotelPackage).YieldMarketCode(yieldMarketCode).AccessibleRoomTypesOnly(accessibleRoomTypesOnly).XExternalsystem(xExternalsystem).AcceptLanguage(acceptLanguage).Execute()
...
func main() {
    ...
    accessibleRoomTypesOnly := true // bool | Used to fetch accessible room types only in the Rate Plan set. (optional)
    xExternalsystem := "xExternalsystem_example" // string | External system code. (optional)
    acceptLanguage := "acceptLanguage_example" // string | Language code (optional)
 ...
 **accessibleRoomTypesOnly** | **bool** | Used to fetch accessible room types only in the Rate Plan set. | 
 **xExternalsystem** | **string** | External system code. | 
 **acceptLanguage** | **string** | Language code | 
...
func main() {
    ...
    roomTypeInfo := true // bool | If true Room Type Master information will be included in the response. (optional)
    orderBy := "orderBy_example" // string | A collection of supported sorting options for search hotels results. (optional)
 ...
 **roomTypeInfo** | **bool** | If true Room Type Master information will be included in the response. | 
 **orderBy** | **string** | A collection of supported sorting options for search hotels results. | 
...
> HurdleRates GetHurdleRates(ctx, hotelId).Authorization(authorization).XAppKey(xAppKey).XHotelid(xHotelid).HotelIds(hotelIds).HurdleDate(hurdleDate).Limit(limit).RoomTypesCode(roomTypesCode).WildCard(wildCard).HurdleRangeStart(hurdleRangeStart).HurdleRangeEnd(hurdleRangeEnd).XExternalsystem(xExternalsystem).AcceptLanguage(acceptLanguage).Execute()
...
func main() {
    ...
    hurdleDate := time.Now() // string | Date criteria for which the hurdle rate is scheduled. (optional)
    limit := int32(56) // int32 | Indicates maximum number of records a Web Service should return. (optional)
    roomTypesCode := []string{"Inner_example"} // []string | Codes to be searched. (optional)
    wildCard := "wildCard_example" // string | Wildcard search on the code. (optional)
    hurdleRangeStart := time.Now() // string | Hurdle date start range from which the hurdle rate is scheduled. (optional)
    hurdleRangeEnd := time.Now() // string | Hurdle date end range to which the hurdle rate is scheduled. (optional)
    xExternalsystem := "xExternalsystem_example" // string | External system code. (optional)
    acceptLanguage := "acceptLanguage_example" // string | Language code (optional)

    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.AvailabilityAPI.GetHurdleRates(context.Background(), hotelId).Authorization(authorization).XAppKey(xAppKey).XHotelid(xHotelid).HotelIds(hotelIds).HurdleDate(hurdleDate).Limit(limit).RoomTypesCode(roomTypesCode).WildCard(wildCard).HurdleRangeStart(hurdleRangeStart).HurdleRangeEnd(hurdleRangeEnd).XExternalsystem(xExternalsystem).AcceptLanguage(acceptLanguage).Execute()
    if err != nil {
