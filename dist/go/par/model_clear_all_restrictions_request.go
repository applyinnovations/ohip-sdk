...
// checks if the ClearAllRestrictionsRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ClearAllRestrictionsRequest{}

// ClearAllRestrictionsRequest struct for ClearAllRestrictionsRequest
type ClearAllRestrictionsRequest struct {
...
func NewClearAllRestrictionsRequest() *ClearAllRestrictionsRequest {
	this := ClearAllRestrictionsRequest{}
	return &this
}
...
func (o ClearAllRestrictionsRequest) MarshalJSON() ([]byte, error) {
...
func (o ClearAllRestrictionsRequest) ToMap() (map[string]interface{}, error) {
...
type NullableClearAllRestrictionsRequest struct {
	value *ClearAllRestrictionsRequest
	isSet bool
}

func (v NullableClearAllRestrictionsRequest) Get() *ClearAllRestrictionsRequest {
	return v.value
}

func (v *NullableClearAllRestrictionsRequest) Set(val *ClearAllRestrictionsRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableClearAllRestrictionsRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableClearAllRestrictionsRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableClearAllRestrictionsRequest(val *ClearAllRestrictionsRequest) *NullableClearAllRestrictionsRequest {
	return &NullableClearAllRestrictionsRequest{value: val, isSet: true}
}

func (v NullableClearAllRestrictionsRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableClearAllRestrictionsRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
