...
[**DeleteMembershipOriginGroup**](MembershipConfigAPI.md#DeleteMembershipOriginGroup) | **Delete** /membershipOriginGroups/{membershipOriginGroupId} | Delete Membership origin group
...
[**DeleteMembershipRates**](MembershipConfigAPI.md#DeleteMembershipRates) | **Delete** /membershipRates/{membershipRatesId} | Delete Membership rates
[**DeleteMembershipSourceGroup**](MembershipConfigAPI.md#DeleteMembershipSourceGroup) | **Delete** /membershipSourceGroups/{membershipSourceGroupId} | Delete Membership Source group
...
[**GetMembershipOriginGroups**](MembershipConfigAPI.md#GetMembershipOriginGroups) | **Get** /membershipOriginGroups | Get Membership origin groups
...
[**GetMembershipRates**](MembershipConfigAPI.md#GetMembershipRates) | **Get** /membershipRates | Get Membership rates 
[**GetMembershipSourceGroups**](MembershipConfigAPI.md#GetMembershipSourceGroups) | **Get** /membershipSourceGroups | Get Membership source groups
...
[**PostMembershipEnrollmentGroups**](MembershipConfigAPI.md#PostMembershipEnrollmentGroups) | **Post** /membershipEnrollmentGroups | Create Membership enrollment groups
...
[**PostMembershipOriginGroup**](MembershipConfigAPI.md#PostMembershipOriginGroup) | **Post** /membershipOriginGroups | Create a Membership origin group
...
[**PostMembershipRates**](MembershipConfigAPI.md#PostMembershipRates) | **Post** /membershipRates | Create Membership rates
[**PostMembershipSourceGroup**](MembershipConfigAPI.md#PostMembershipSourceGroup) | **Post** /membershipSourceGroups | Create a Membership source group
...
[**PutMembershipOriginGroup**](MembershipConfigAPI.md#PutMembershipOriginGroup) | **Put** /membershipOriginGroups/{membershipOriginGroupId} | Change Membership origin group
...
[**PutMembershipRates**](MembershipConfigAPI.md#PutMembershipRates) | **Put** /membershipRates/{membershipRatesId} | Change Membership rates
[**PutMembershipSourceGroup**](MembershipConfigAPI.md#PutMembershipSourceGroup) | **Put** /membershipSourceGroups/{membershipSourceGroupId} | Change Membership source group
...
Other parameters are passed through a pointer to a apiDeleteMembershipEnrollmentGroupsRequest struct via the builder pattern
...
> Status DeleteMembershipOriginGroup(ctx, membershipOriginGroupId).Authorization(authorization).XAppKey(xAppKey).XHotelid(xHotelid).XExternalsystem(xExternalsystem).AcceptLanguage(acceptLanguage).Execute()

Delete Membership origin group
...
func main() {
    membershipOriginGroupId := "membershipOriginGroupId_example" // string | Delete delete Membership Origin Group based on given membershipOriginGroupId
    authorization := "authorization_example" // string | Bearer token that needs to be passed which is generated post user authentication
    xAppKey := "xAppKey_example" // string | Client or Partner's Application Key
    xHotelid := "xHotelid_example" // string | Mandatory parameter to identify the hotel code where the end user is logged in
    xExternalsystem := "xExternalsystem_example" // string | External system code. (optional)
    ...
    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.MembershipConfigAPI.DeleteMembershipOriginGroup(context.Background(), membershipOriginGroupId).Authorization(authorization).XAppKey(xAppKey).XHotelid(xHotelid).XExternalsystem(xExternalsystem).AcceptLanguage(acceptLanguage).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `MembershipConfigAPI.DeleteMembershipOriginGroup``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `DeleteMembershipOriginGroup`: Status
    fmt.Fprintf(os.Stdout, "Response from `MembershipConfigAPI.DeleteMembershipOriginGroup`: %v\n", resp)
}
```
...
------------- | ------------- | ------------- | -------------
**ctx** | **context.Context** | context for authentication, logging, cancellation, deadlines, tracing, etc.
**membershipOriginGroupId** | **string** | Delete delete Membership Origin Group based on given membershipOriginGroupId | 

### Other Parameters

Other parameters are passed through a pointer to a apiDeleteMembershipOriginGroupRequest struct via the builder pattern
...
> Status DeleteMembershipRates(ctx, membershipRatesId).Authorization(authorization).XAppKey(xAppKey).XHotelid(xHotelid).HotelId(hotelId).XExternalsystem(xExternalsystem).AcceptLanguage(acceptLanguage).Execute()
...
func main() {
    membershipRatesId := "membershipRatesId_example" // string | Fetch membershipClasses values based on given membershipClassId
    authorization := "authorization_example" // string | Bearer token that needs to be passed which is generated post user authentication
    xAppKey := "xAppKey_example" // string | Client or Partner's Application Key
    xHotelid := "xHotelid_example" // string | Mandatory parameter to identify the hotel code where the end user is logged in
    hotelId := []string{"Inner_example"} // []string | Hotel code of membership rate. (optional)
    xExternalsystem := "xExternalsystem_example" // string | External system code. (optional)
    acceptLanguage := "acceptLanguage_example" // string | Language code (optional)

    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.MembershipConfigAPI.DeleteMembershipRates(context.Background(), membershipRatesId).Authorization(authorization).XAppKey(xAppKey).XHotelid(xHotelid).HotelId(hotelId).XExternalsystem(xExternalsystem).AcceptLanguage(acceptLanguage).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `MembershipConfigAPI.DeleteMembershipRates``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `DeleteMembershipRates`: Status
    fmt.Fprintf(os.Stdout, "Response from `MembershipConfigAPI.DeleteMembershipRates`: %v\n", resp)
}
```
...
------------- | ------------- | ------------- | -------------
**ctx** | **context.Context** | context for authentication, logging, cancellation, deadlines, tracing, etc.
**membershipRatesId** | **string** | Fetch membershipClasses values based on given membershipClassId | 

### Other Parameters

Other parameters are passed through a pointer to a apiDeleteMembershipRatesRequest struct via the builder pattern
 ...
 **xAppKey** | **string** | Client or Partner&#39;s Application Key | 
 **xHotelid** | **string** | Mandatory parameter to identify the hotel code where the end user is logged in | 
 **hotelId** | **[]string** | Hotel code of membership rate. | 
 **xExternalsystem** | **string** | External system code. | 
 **acceptLanguage** | **string** | Language code | 
...
> Status DeleteMembershipSourceGroup(ctx, membershipSourceGroupId).Authorization(authorization).XAppKey(xAppKey).XHotelid(xHotelid).XExternalsystem(xExternalsystem).AcceptLanguage(acceptLanguage).Execute()

Delete Membership Source group
...
func main() {
    membershipSourceGroupId := "membershipSourceGroupId_example" // string | Delete delete Membership Source Group based on given membershipSourceGroupId
    authorization := "authorization_example" // string | Bearer token that needs to be passed which is generated post user authentication
    xAppKey := "xAppKey_example" // string | Client or Partner's Application Key
    xHotelid := "xHotelid_example" // string | Mandatory parameter to identify the hotel code where the end user is logged in
    xExternalsystem := "xExternalsystem_example" // string | External system code. (optional)
    ...
    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.MembershipConfigAPI.DeleteMembershipSourceGroup(context.Background(), membershipSourceGroupId).Authorization(authorization).XAppKey(xAppKey).XHotelid(xHotelid).XExternalsystem(xExternalsystem).AcceptLanguage(acceptLanguage).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `MembershipConfigAPI.DeleteMembershipSourceGroup``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `DeleteMembershipSourceGroup`: Status
    fmt.Fprintf(os.Stdout, "Response from `MembershipConfigAPI.DeleteMembershipSourceGroup`: %v\n", resp)
}
```
...
------------- | ------------- | ------------- | -------------
**ctx** | **context.Context** | context for authentication, logging, cancellation, deadlines, tracing, etc.
**membershipSourceGroupId** | **string** | Delete delete Membership Source Group based on given membershipSourceGroupId | 

### Other Parameters

Other parameters are passed through a pointer to a apiDeleteMembershipSourceGroupRequest struct via the builder pattern
...
> MembershipMarketGroupsInfo GetMembershipMarketGroups(ctx).Authorization(authorization).XAppKey(xAppKey).XHotelid(xHotelid).FetchInactive(fetchInactive).Codes(codes).WildCard(wildCard).Description(description).XExternalsystem(xExternalsystem).AcceptLanguage(acceptLanguage).Execute()
...
> MembershipOriginGroupsDetails GetMembershipOriginGroups(ctx).Authorization(authorization).XAppKey(xAppKey).XHotelid(xHotelid).Codes(codes).Description(description).XExternalsystem(xExternalsystem).AcceptLanguage(acceptLanguage).Execute()

Get Membership origin groups
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.MembershipConfigAPI.GetMembershipOriginGroups(context.Background()).Authorization(authorization).XAppKey(xAppKey).XHotelid(xHotelid).Codes(codes).Description(description).XExternalsystem(xExternalsystem).AcceptLanguage(acceptLanguage).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `MembershipConfigAPI.GetMembershipOriginGroups``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `GetMembershipOriginGroups`: MembershipOriginGroupsDetails
    fmt.Fprintf(os.Stdout, "Response from `MembershipConfigAPI.GetMembershipOriginGroups`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiGetMembershipOriginGroupsRequest struct via the builder pattern
...
[**MembershipOriginGroupsDetails**](MembershipOriginGroupsDetails.md)
...
> MembershipRatesInfo GetMembershipRates(ctx).Authorization(authorization).XAppKey(xAppKey).XHotelid(xHotelid).HotelIds(hotelIds).MembershipTypes(membershipTypes).RatePlanCodes(ratePlanCodes).Description(description).IncludeInactive(includeInactive).XExternalsystem(xExternalsystem).AcceptLanguage(acceptLanguage).Execute()
...
func main() {
    ...
    xAppKey := "xAppKey_example" // string | Client or Partner's Application Key
    xHotelid := "xHotelid_example" // string | Mandatory parameter to identify the hotel code where the end user is logged in
    hotelIds := []string{"Inner_example"} // []string | Hotel code of membership rates to be searched. (optional)
    membershipTypes := []string{"Inner_example"} // []string | Membership type to be searched. (optional)
    ratePlanCodes := []string{"Inner_example"} // []string | Rate code of the membership rule rate. (optional)
    description := "description_example" // string | Description of the Membership Rate. (optional)
    includeInactive := true // bool | Indicates whether search includes inactive membership rates. (optional)
    xExternalsystem := "xExternalsystem_example" // string | External system code. (optional)
    acceptLanguage := "acceptLanguage_example" // string | Language code (optional)

    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.MembershipConfigAPI.GetMembershipRates(context.Background()).Authorization(authorization).XAppKey(xAppKey).XHotelid(xHotelid).HotelIds(hotelIds).MembershipTypes(membershipTypes).RatePlanCodes(ratePlanCodes).Description(description).IncludeInactive(includeInactive).XExternalsystem(xExternalsystem).AcceptLanguage(acceptLanguage).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `MembershipConfigAPI.GetMembershipRates``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `GetMembershipRates`: MembershipRatesInfo
    fmt.Fprintf(os.Stdout, "Response from `MembershipConfigAPI.GetMembershipRates`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiGetMembershipRatesRequest struct via the builder pattern
 ...
 **xAppKey** | **string** | Client or Partner&#39;s Application Key | 
 **xHotelid** | **string** | Mandatory parameter to identify the hotel code where the end user is logged in | 
 **hotelIds** | **[]string** | Hotel code of membership rates to be searched. | 
 **membershipTypes** | **[]string** | Membership type to be searched. | 
 **ratePlanCodes** | **[]string** | Rate code of the membership rule rate. | 
 **description** | **string** | Description of the Membership Rate. | 
 **includeInactive** | **bool** | Indicates whether search includes inactive membership rates. | 
 **xExternalsystem** | **string** | External system code. | 
 **acceptLanguage** | **string** | Language code | 

### Return type

[**MembershipRatesInfo**](MembershipRatesInfo.md)
...
> MembershipSourceGroupsDetails GetMembershipSourceGroups(ctx).Authorization(authorization).XAppKey(xAppKey).XHotelid(xHotelid).Codes(codes).Description(description).XExternalsystem(xExternalsystem).AcceptLanguage(acceptLanguage).Execute()

Get Membership source groups
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.MembershipConfigAPI.GetMembershipSourceGroups(context.Background()).Authorization(authorization).XAppKey(xAppKey).XHotelid(xHotelid).Codes(codes).Description(description).XExternalsystem(xExternalsystem).AcceptLanguage(acceptLanguage).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `MembershipConfigAPI.GetMembershipSourceGroups``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `GetMembershipSourceGroups`: MembershipSourceGroupsDetails
    fmt.Fprintf(os.Stdout, "Response from `MembershipConfigAPI.GetMembershipSourceGroups`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiGetMembershipSourceGroupsRequest struct via the builder pattern
...
[**MembershipSourceGroupsDetails**](MembershipSourceGroupsDetails.md)
...
func main() {
    ...
    xAppKey := "xAppKey_example" // string | Client or Partner's Application Key
    xHotelid := "xHotelid_example" // string | Mandatory parameter to identify the hotel code where the end user is logged in
    membershipAwards := *openapiclient.NewMembershipAwards() // MembershipAwards | Request object for creating new membership awards.
    xExternalsystem := "xExternalsystem_example" // string | External system code. (optional)
    acceptLanguage := "acceptLanguage_example" // string | Language code (optional)
 ...
 **xAppKey** | **string** | Client or Partner&#39;s Application Key | 
 **xHotelid** | **string** | Mandatory parameter to identify the hotel code where the end user is logged in | 
 **membershipAwards** | [**MembershipAwards**](MembershipAwards.md) | Request object for creating new membership awards. | 
 **xExternalsystem** | **string** | External system code. | 
 **acceptLanguage** | **string** | Language code | 
...
func main() {
    ...
    xAppKey := "xAppKey_example" // string | Client or Partner's Application Key
    xHotelid := "xHotelid_example" // string | Mandatory parameter to identify the hotel code where the end user is logged in
    membershipBenefitPrograms := *openapiclient.NewMembershipBenefitPrograms() // MembershipBenefitPrograms | Request object for creating new membership benefit programs.
    xExternalsystem := "xExternalsystem_example" // string | External system code. (optional)
    acceptLanguage := "acceptLanguage_example" // string | Language code (optional)
 ...
 **xAppKey** | **string** | Client or Partner&#39;s Application Key | 
 **xHotelid** | **string** | Mandatory parameter to identify the hotel code where the end user is logged in | 
 **membershipBenefitPrograms** | [**MembershipBenefitPrograms**](MembershipBenefitPrograms.md) | Request object for creating new membership benefit programs. | 
 **xExternalsystem** | **string** | External system code. | 
 **acceptLanguage** | **string** | Language code | 
...
func main() {
    ...
    xAppKey := "xAppKey_example" // string | Client or Partner's Application Key
    xHotelid := "xHotelid_example" // string | Mandatory parameter to identify the hotel code where the end user is logged in
    membershipClasses := *openapiclient.NewMembershipClasses() // MembershipClasses | Request object for creating Membership Class
    xExternalsystem := "xExternalsystem_example" // string | External system code. (optional)
    acceptLanguage := "acceptLanguage_example" // string | Language code (optional)
 ...
 **xAppKey** | **string** | Client or Partner&#39;s Application Key | 
 **xHotelid** | **string** | Mandatory parameter to identify the hotel code where the end user is logged in | 
 **membershipClasses** | [**MembershipClasses**](MembershipClasses.md) | Request object for creating Membership Class | 
 **xExternalsystem** | **string** | External system code. | 
 **acceptLanguage** | **string** | Language code | 
...
func main() {
    ...
    xAppKey := "xAppKey_example" // string | Client or Partner's Application Key
    xHotelid := "xHotelid_example" // string | Mandatory parameter to identify the hotel code where the end user is logged in
    membershipEnrollmentGroups := *openapiclient.NewMembershipEnrollmentGroups() // MembershipEnrollmentGroups | Request object for creating new membership enrollment groups.
    xExternalsystem := "xExternalsystem_example" // string | External system code. (optional)
    acceptLanguage := "acceptLanguage_example" // string | Language code (optional)
 ...
 **xAppKey** | **string** | Client or Partner&#39;s Application Key | 
 **xHotelid** | **string** | Mandatory parameter to identify the hotel code where the end user is logged in | 
 **membershipEnrollmentGroups** | [**MembershipEnrollmentGroups**](MembershipEnrollmentGroups.md) | Request object for creating new membership enrollment groups. | 
 **xExternalsystem** | **string** | External system code. | 
 **acceptLanguage** | **string** | Language code | 
...
func main() {
    ...
    xAppKey := "xAppKey_example" // string | Client or Partner's Application Key
    xHotelid := "xHotelid_example" // string | Mandatory parameter to identify the hotel code where the end user is logged in
    membershipFolioTexts := *openapiclient.NewMembershipFolioTexts() // MembershipFolioTexts | Collection of FolioTexts to be inserted at MembershipLevel.
    xExternalsystem := "xExternalsystem_example" // string | External system code. (optional)
    acceptLanguage := "acceptLanguage_example" // string | Language code (optional)
 ...
 **xAppKey** | **string** | Client or Partner&#39;s Application Key | 
 **xHotelid** | **string** | Mandatory parameter to identify the hotel code where the end user is logged in | 
 **membershipFolioTexts** | [**MembershipFolioTexts**](MembershipFolioTexts.md) | Collection of FolioTexts to be inserted at MembershipLevel. | 
 **xExternalsystem** | **string** | External system code. | 
 **acceptLanguage** | **string** | Language code | 
...
func main() {
    ...
    xAppKey := "xAppKey_example" // string | Client or Partner's Application Key
    xHotelid := "xHotelid_example" // string | Mandatory parameter to identify the hotel code where the end user is logged in
    membershipLevels := *openapiclient.NewMembershipLevels() // MembershipLevels | Request object for creating new membership levels.
    xExternalsystem := "xExternalsystem_example" // string | External system code. (optional)
    acceptLanguage := "acceptLanguage_example" // string | Language code (optional)
 ...
 **xAppKey** | **string** | Client or Partner&#39;s Application Key | 
 **xHotelid** | **string** | Mandatory parameter to identify the hotel code where the end user is logged in | 
 **membershipLevels** | [**MembershipLevels**](MembershipLevels.md) | Request object for creating new membership levels. | 
 **xExternalsystem** | **string** | External system code. | 
 **acceptLanguage** | **string** | Language code | 
...
func main() {
    ...
    xAppKey := "xAppKey_example" // string | Client or Partner's Application Key
    xHotelid := "xHotelid_example" // string | Mandatory parameter to identify the hotel code where the end user is logged in
    membershipMarketGroups := *openapiclient.NewMembershipMarketGroups() // MembershipMarketGroups | Request object for creating new Membership Market Group Configurations.
    xExternalsystem := "xExternalsystem_example" // string | External system code. (optional)
    acceptLanguage := "acceptLanguage_example" // string | Language code (optional)
 ...
 **xAppKey** | **string** | Client or Partner&#39;s Application Key | 
 **xHotelid** | **string** | Mandatory parameter to identify the hotel code where the end user is logged in | 
 **membershipMarketGroups** | [**MembershipMarketGroups**](MembershipMarketGroups.md) | Request object for creating new Membership Market Group Configurations. | 
 **xExternalsystem** | **string** | External system code. | 
 **acceptLanguage** | **string** | Language code | 
...
> Status PostMembershipOriginGroup(ctx).Authorization(authorization).XAppKey(xAppKey).XHotelid(xHotelid).MembershipOriginGroup(membershipOriginGroup).XExternalsystem(xExternalsystem).AcceptLanguage(acceptLanguage).Execute()

Create a Membership origin group
...
func main() {
    ...
    xAppKey := "xAppKey_example" // string | Client or Partner's Application Key
    xHotelid := "xHotelid_example" // string | Mandatory parameter to identify the hotel code where the end user is logged in
    membershipOriginGroup := *openapiclient.NewMembershipOriginGroupDetails() // MembershipOriginGroupDetails | Request object for creating new Membership origin Group Configurations.
    xExternalsystem := "xExternalsystem_example" // string | External system code. (optional)
    acceptLanguage := "acceptLanguage_example" // string | Language code (optional)

    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.MembershipConfigAPI.PostMembershipOriginGroup(context.Background()).Authorization(authorization).XAppKey(xAppKey).XHotelid(xHotelid).MembershipOriginGroup(membershipOriginGroup).XExternalsystem(xExternalsystem).AcceptLanguage(acceptLanguage).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `MembershipConfigAPI.PostMembershipOriginGroup``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `PostMembershipOriginGroup`: Status
    fmt.Fprintf(os.Stdout, "Response from `MembershipConfigAPI.PostMembershipOriginGroup`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiPostMembershipOriginGroupRequest struct via the builder pattern
 ...
 **xAppKey** | **string** | Client or Partner&#39;s Application Key | 
 **xHotelid** | **string** | Mandatory parameter to identify the hotel code where the end user is logged in | 
 **membershipOriginGroup** | [**MembershipOriginGroupDetails**](MembershipOriginGroupDetails.md) | Request object for creating new Membership origin Group Configurations. | 
 **xExternalsystem** | **string** | External system code. | 
 **acceptLanguage** | **string** | Language code | 
...
> Status PostMembershipPropertyGroups(ctx).Authorization(authorization).XAppKey(xAppKey).XHotelid(xHotelid).MembershipPropertyGroups(membershipPropertyGroups).XExternalsystem(xExternalsystem).AcceptLanguage(acceptLanguage).Execute()
...
func main() {
    ...
    xAppKey := "xAppKey_example" // string | Client or Partner's Application Key
    xHotelid := "xHotelid_example" // string | Mandatory parameter to identify the hotel code where the end user is logged in
    membershipPropertyGroups := *openapiclient.NewMembershipPropertyGroups() // MembershipPropertyGroups | Request object for creating new Membership Property Groups Configurations.
    xExternalsystem := "xExternalsystem_example" // string | External system code. (optional)
    acceptLanguage := "acceptLanguage_example" // string | Language code (optional)

    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.MembershipConfigAPI.PostMembershipPropertyGroups(context.Background()).Authorization(authorization).XAppKey(xAppKey).XHotelid(xHotelid).MembershipPropertyGroups(membershipPropertyGroups).XExternalsystem(xExternalsystem).AcceptLanguage(acceptLanguage).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `MembershipConfigAPI.PostMembershipPropertyGroups``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `PostMembershipPropertyGroups`: Status
    fmt.Fprintf(os.Stdout, "Response from `MembershipConfigAPI.PostMembershipPropertyGroups`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiPostMembershipPropertyGroupsRequest struct via the builder pattern
 ...
 **xAppKey** | **string** | Client or Partner&#39;s Application Key | 
 **xHotelid** | **string** | Mandatory parameter to identify the hotel code where the end user is logged in | 
 **membershipPropertyGroups** | [**MembershipPropertyGroups**](MembershipPropertyGroups.md) | Request object for creating new Membership Property Groups Configurations. | 
 **xExternalsystem** | **string** | External system code. | 
 **acceptLanguage** | **string** | Language code | 
...
> Status PostMembershipRateGroups(ctx).Authorization(authorization).XAppKey(xAppKey).XHotelid(xHotelid).MembershipRateGroups(membershipRateGroups).XExternalsystem(xExternalsystem).AcceptLanguage(acceptLanguage).Execute()
...
func main() {
    ...
    xAppKey := "xAppKey_example" // string | Client or Partner's Application Key
    xHotelid := "xHotelid_example" // string | Mandatory parameter to identify the hotel code where the end user is logged in
    membershipRateGroups := *openapiclient.NewMembershipRateGroups() // MembershipRateGroups | Request object for creating new Membership Rate Groups.
    xExternalsystem := "xExternalsystem_example" // string | External system code. (optional)
    acceptLanguage := "acceptLanguage_example" // string | Language code (optional)

    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.MembershipConfigAPI.PostMembershipRateGroups(context.Background()).Authorization(authorization).XAppKey(xAppKey).XHotelid(xHotelid).MembershipRateGroups(membershipRateGroups).XExternalsystem(xExternalsystem).AcceptLanguage(acceptLanguage).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `MembershipConfigAPI.PostMembershipRateGroups``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `PostMembershipRateGroups`: Status
    fmt.Fprintf(os.Stdout, "Response from `MembershipConfigAPI.PostMembershipRateGroups`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiPostMembershipRateGroupsRequest struct via the builder pattern
 ...
 **xAppKey** | **string** | Client or Partner&#39;s Application Key | 
 **xHotelid** | **string** | Mandatory parameter to identify the hotel code where the end user is logged in | 
 **membershipRateGroups** | [**MembershipRateGroups**](MembershipRateGroups.md) | Request object for creating new Membership Rate Groups. | 
 **xExternalsystem** | **string** | External system code. | 
 **acceptLanguage** | **string** | Language code | 
...
> Status PostMembershipRates(ctx).Authorization(authorization).XAppKey(xAppKey).XHotelid(xHotelid).MembershipRates(membershipRates).XExternalsystem(xExternalsystem).AcceptLanguage(acceptLanguage).Execute()
...
func main() {
    ...
    xAppKey := "xAppKey_example" // string | Client or Partner's Application Key
    xHotelid := "xHotelid_example" // string | Mandatory parameter to identify the hotel code where the end user is logged in
    membershipRates := *openapiclient.NewMembershipRates() // MembershipRates | Request object for creating new membership rate code rules.
    xExternalsystem := "xExternalsystem_example" // string | External system code. (optional)
    acceptLanguage := "acceptLanguage_example" // string | Language code (optional)

    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.MembershipConfigAPI.PostMembershipRates(context.Background()).Authorization(authorization).XAppKey(xAppKey).XHotelid(xHotelid).MembershipRates(membershipRates).XExternalsystem(xExternalsystem).AcceptLanguage(acceptLanguage).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `MembershipConfigAPI.PostMembershipRates``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `PostMembershipRates`: Status
    fmt.Fprintf(os.Stdout, "Response from `MembershipConfigAPI.PostMembershipRates`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiPostMembershipRatesRequest struct via the builder pattern
 ...
 **xAppKey** | **string** | Client or Partner&#39;s Application Key | 
 **xHotelid** | **string** | Mandatory parameter to identify the hotel code where the end user is logged in | 
 **membershipRates** | [**MembershipRates**](MembershipRates.md) | Request object for creating new membership rate code rules. | 
 **xExternalsystem** | **string** | External system code. | 
 **acceptLanguage** | **string** | Language code | 
...
> Status PostMembershipSourceGroup(ctx).Authorization(authorization).XAppKey(xAppKey).XHotelid(xHotelid).MembershipSourceGroup(membershipSourceGroup).XExternalsystem(xExternalsystem).AcceptLanguage(acceptLanguage).Execute()

Create a Membership source group
...
func main() {
    ...
    xAppKey := "xAppKey_example" // string | Client or Partner's Application Key
    xHotelid := "xHotelid_example" // string | Mandatory parameter to identify the hotel code where the end user is logged in
    membershipSourceGroup := *openapiclient.NewMembershipSourceGroupDetails() // MembershipSourceGroupDetails | Request object for creating new Membership source Group Configurations.
    xExternalsystem := "xExternalsystem_example" // string | External system code. (optional)
    acceptLanguage := "acceptLanguage_example" // string | Language code (optional)

    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.MembershipConfigAPI.PostMembershipSourceGroup(context.Background()).Authorization(authorization).XAppKey(xAppKey).XHotelid(xHotelid).MembershipSourceGroup(membershipSourceGroup).XExternalsystem(xExternalsystem).AcceptLanguage(acceptLanguage).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `MembershipConfigAPI.PostMembershipSourceGroup``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `PostMembershipSourceGroup`: Status
    fmt.Fprintf(os.Stdout, "Response from `MembershipConfigAPI.PostMembershipSourceGroup`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiPostMembershipSourceGroupRequest struct via the builder pattern
 ...
 **xAppKey** | **string** | Client or Partner&#39;s Application Key | 
 **xHotelid** | **string** | Mandatory parameter to identify the hotel code where the end user is logged in | 
 **membershipSourceGroup** | [**MembershipSourceGroupDetails**](MembershipSourceGroupDetails.md) | Request object for creating new Membership source Group Configurations. | 
 **xExternalsystem** | **string** | External system code. | 
 **acceptLanguage** | **string** | Language code | 
...
> MembershipTypeRulesDetails PostMembershipTypeRules(ctx).Authorization(authorization).XAppKey(xAppKey).XHotelid(xHotelid).MembershipTypeRules(membershipTypeRules).XExternalsystem(xExternalsystem).AcceptLanguage(acceptLanguage).Execute()
...
func main() {
    ...
    xAppKey := "xAppKey_example" // string | Client or Partner's Application Key
    xHotelid := "xHotelid_example" // string | Mandatory parameter to identify the hotel code where the end user is logged in
    membershipTypeRules := *openapiclient.NewMembershipTypeRules() // MembershipTypeRules | Request object for creating new membership type rules.
    xExternalsystem := "xExternalsystem_example" // string | External system code. (optional)
    acceptLanguage := "acceptLanguage_example" // string | Language code (optional)

    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.MembershipConfigAPI.PostMembershipTypeRules(context.Background()).Authorization(authorization).XAppKey(xAppKey).XHotelid(xHotelid).MembershipTypeRules(membershipTypeRules).XExternalsystem(xExternalsystem).AcceptLanguage(acceptLanguage).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `MembershipConfigAPI.PostMembershipTypeRules``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `PostMembershipTypeRules`: MembershipTypeRulesDetails
    fmt.Fprintf(os.Stdout, "Response from `MembershipConfigAPI.PostMembershipTypeRules`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiPostMembershipTypeRulesRequest struct via the builder pattern
 ...
 **xAppKey** | **string** | Client or Partner&#39;s Application Key | 
 **xHotelid** | **string** | Mandatory parameter to identify the hotel code where the end user is logged in | 
 **membershipTypeRules** | [**MembershipTypeRules**](MembershipTypeRules.md) | Request object for creating new membership type rules. | 
 **xExternalsystem** | **string** | External system code. | 
 **acceptLanguage** | **string** | Language code | 

### Return type

[**MembershipTypeRulesDetails**](MembershipTypeRulesDetails.md)
...
> Status PostMembershipTypes(ctx).Authorization(authorization).XAppKey(xAppKey).XHotelid(xHotelid).MembershipTypes(membershipTypes).XExternalsystem(xExternalsystem).AcceptLanguage(acceptLanguage).Execute()
...
func main() {
    ...
    xAppKey := "xAppKey_example" // string | Client or Partner's Application Key
    xHotelid := "xHotelid_example" // string | Mandatory parameter to identify the hotel code where the end user is logged in
    membershipTypes := *openapiclient.NewMembershipTypes() // MembershipTypes | Request object to create Membership types. Includes instructions for information which needs to be returned.
    xExternalsystem := "xExternalsystem_example" // string | External system code. (optional)
    acceptLanguage := "acceptLanguage_example" // string | Language code (optional)

    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.MembershipConfigAPI.PostMembershipTypes(context.Background()).Authorization(authorization).XAppKey(xAppKey).XHotelid(xHotelid).MembershipTypes(membershipTypes).XExternalsystem(xExternalsystem).AcceptLanguage(acceptLanguage).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `MembershipConfigAPI.PostMembershipTypes``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `PostMembershipTypes`: Status
    fmt.Fprintf(os.Stdout, "Response from `MembershipConfigAPI.PostMembershipTypes`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiPostMembershipTypesRequest struct via the builder pattern
 ...
 **xAppKey** | **string** | Client or Partner&#39;s Application Key | 
 **xHotelid** | **string** | Mandatory parameter to identify the hotel code where the end user is logged in | 
 **membershipTypes** | [**MembershipTypes**](MembershipTypes.md) | Request object to create Membership types. Includes instructions for information which needs to be returned. | 
 **xExternalsystem** | **string** | External system code. | 
 **acceptLanguage** | **string** | Language code | 
...
> Status PutMembershipAwards(ctx, membershipAwardsId).Authorization(authorization).XAppKey(xAppKey).XHotelid(xHotelid).MembershipAwards(membershipAwards).XExternalsystem(xExternalsystem).AcceptLanguage(acceptLanguage).Execute()
...
func main() {
    ...
    xAppKey := "xAppKey_example" // string | Client or Partner's Application Key
    xHotelid := "xHotelid_example" // string | Mandatory parameter to identify the hotel code where the end user is logged in
    membershipAwards := *openapiclient.NewMembershipAwards() // MembershipAwards | Request object for modifying membership awards.
    xExternalsystem := "xExternalsystem_example" // string | External system code. (optional)
    acceptLanguage := "acceptLanguage_example" // string | Language code (optional)

    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.MembershipConfigAPI.PutMembershipAwards(context.Background(), membershipAwardsId).Authorization(authorization).XAppKey(xAppKey).XHotelid(xHotelid).MembershipAwards(membershipAwards).XExternalsystem(xExternalsystem).AcceptLanguage(acceptLanguage).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `MembershipConfigAPI.PutMembershipAwards``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `PutMembershipAwards`: Status
    fmt.Fprintf(os.Stdout, "Response from `MembershipConfigAPI.PutMembershipAwards`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiPutMembershipAwardsRequest struct via the builder pattern
 ...
 **xAppKey** | **string** | Client or Partner&#39;s Application Key | 
 **xHotelid** | **string** | Mandatory parameter to identify the hotel code where the end user is logged in | 
 **membershipAwards** | [**MembershipAwards**](MembershipAwards.md) | Request object for modifying membership awards. | 
 **xExternalsystem** | **string** | External system code. | 
 **acceptLanguage** | **string** | Language code | 
...
> Status PutMembershipBenefitPrograms(ctx, membershipBenefitProgramsId).Authorization(authorization).XAppKey(xAppKey).XHotelid(xHotelid).MembershipBenefitPrograms(membershipBenefitPrograms).XExternalsystem(xExternalsystem).AcceptLanguage(acceptLanguage).Execute()
...
func main() {
    ...
    xAppKey := "xAppKey_example" // string | Client or Partner's Application Key
    xHotelid := "xHotelid_example" // string | Mandatory parameter to identify the hotel code where the end user is logged in
    membershipBenefitPrograms := *openapiclient.NewMembershipBenefitPrograms() // MembershipBenefitPrograms | Request object for modifying membership benefit programs.
    xExternalsystem := "xExternalsystem_example" // string | External system code. (optional)
    acceptLanguage := "acceptLanguage_example" // string | Language code (optional)

    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.MembershipConfigAPI.PutMembershipBenefitPrograms(context.Background(), membershipBenefitProgramsId).Authorization(authorization).XAppKey(xAppKey).XHotelid(xHotelid).MembershipBenefitPrograms(membershipBenefitPrograms).XExternalsystem(xExternalsystem).AcceptLanguage(acceptLanguage).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `MembershipConfigAPI.PutMembershipBenefitPrograms``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `PutMembershipBenefitPrograms`: Status
    fmt.Fprintf(os.Stdout, "Response from `MembershipConfigAPI.PutMembershipBenefitPrograms`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiPutMembershipBenefitProgramsRequest struct via the builder pattern
 ...
 **xAppKey** | **string** | Client or Partner&#39;s Application Key | 
 **xHotelid** | **string** | Mandatory parameter to identify the hotel code where the end user is logged in | 
 **membershipBenefitPrograms** | [**MembershipBenefitPrograms**](MembershipBenefitPrograms.md) | Request object for modifying membership benefit programs. | 
 **xExternalsystem** | **string** | External system code. | 
 **acceptLanguage** | **string** | Language code | 
...
> MembershipClassesInfo PutMembershipClasses(ctx, membershipClassId).Authorization(authorization).XAppKey(xAppKey).XHotelid(xHotelid).MembershipClasses(membershipClasses).XExternalsystem(xExternalsystem).AcceptLanguage(acceptLanguage).Execute()
...
func main() {
    ...
    xAppKey := "xAppKey_example" // string | Client or Partner's Application Key
    xHotelid := "xHotelid_example" // string | Mandatory parameter to identify the hotel code where the end user is logged in
    membershipClasses := *openapiclient.NewMembershipClasses() // MembershipClasses | Request object for changing Membership Class.
    xExternalsystem := "xExternalsystem_example" // string | External system code. (optional)
    acceptLanguage := "acceptLanguage_example" // string | Language code (optional)

    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.MembershipConfigAPI.PutMembershipClasses(context.Background(), membershipClassId).Authorization(authorization).XAppKey(xAppKey).XHotelid(xHotelid).MembershipClasses(membershipClasses).XExternalsystem(xExternalsystem).AcceptLanguage(acceptLanguage).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `MembershipConfigAPI.PutMembershipClasses``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `PutMembershipClasses`: MembershipClassesInfo
    fmt.Fprintf(os.Stdout, "Response from `MembershipConfigAPI.PutMembershipClasses`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiPutMembershipClassesRequest struct via the builder pattern
 ...
 **xAppKey** | **string** | Client or Partner&#39;s Application Key | 
 **xHotelid** | **string** | Mandatory parameter to identify the hotel code where the end user is logged in | 
 **membershipClasses** | [**MembershipClasses**](MembershipClasses.md) | Request object for changing Membership Class. | 
 **xExternalsystem** | **string** | External system code. | 
 **acceptLanguage** | **string** | Language code | 
...
> Status PutMembershipEnrollmentGroups(ctx, membershipEnrollmentGroupsId).Authorization(authorization).XAppKey(xAppKey).XHotelid(xHotelid).MembershipEnrollmentGroups(membershipEnrollmentGroups).XExternalsystem(xExternalsystem).AcceptLanguage(acceptLanguage).Execute()
...
func main() {
    ...
    xAppKey := "xAppKey_example" // string | Client or Partner's Application Key
    xHotelid := "xHotelid_example" // string | Mandatory parameter to identify the hotel code where the end user is logged in
    membershipEnrollmentGroups := *openapiclient.NewMembershipEnrollmentGroups() // MembershipEnrollmentGroups | Request object for changing new membership enrollment groups.
    xExternalsystem := "xExternalsystem_example" // string | External system code. (optional)
    acceptLanguage := "acceptLanguage_example" // string | Language code (optional)

    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.MembershipConfigAPI.PutMembershipEnrollmentGroups(context.Background(), membershipEnrollmentGroupsId).Authorization(authorization).XAppKey(xAppKey).XHotelid(xHotelid).MembershipEnrollmentGroups(membershipEnrollmentGroups).XExternalsystem(xExternalsystem).AcceptLanguage(acceptLanguage).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `MembershipConfigAPI.PutMembershipEnrollmentGroups``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `PutMembershipEnrollmentGroups`: Status
    fmt.Fprintf(os.Stdout, "Response from `MembershipConfigAPI.PutMembershipEnrollmentGroups`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiPutMembershipEnrollmentGroupsRequest struct via the builder pattern
 ...
 **xAppKey** | **string** | Client or Partner&#39;s Application Key | 
 **xHotelid** | **string** | Mandatory parameter to identify the hotel code where the end user is logged in | 
 **membershipEnrollmentGroups** | [**MembershipEnrollmentGroups**](MembershipEnrollmentGroups.md) | Request object for changing new membership enrollment groups. | 
 **xExternalsystem** | **string** | External system code. | 
 **acceptLanguage** | **string** | Language code | 
...
> Status PutMembershipLevels(ctx, membershipLevelsId).Authorization(authorization).XAppKey(xAppKey).XHotelid(xHotelid).MembershipLevels(membershipLevels).XExternalsystem(xExternalsystem).AcceptLanguage(acceptLanguage).Execute()
...
func main() {
    ...
    xAppKey := "xAppKey_example" // string | Client or Partner's Application Key
    xHotelid := "xHotelid_example" // string | Mandatory parameter to identify the hotel code where the end user is logged in
    membershipLevels := *openapiclient.NewMembershipLevels() // MembershipLevels | Request object for modifying membership levels.
    xExternalsystem := "xExternalsystem_example" // string | External system code. (optional)
    acceptLanguage := "acceptLanguage_example" // string | Language code (optional)

    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.MembershipConfigAPI.PutMembershipLevels(context.Background(), membershipLevelsId).Authorization(authorization).XAppKey(xAppKey).XHotelid(xHotelid).MembershipLevels(membershipLevels).XExternalsystem(xExternalsystem).AcceptLanguage(acceptLanguage).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `MembershipConfigAPI.PutMembershipLevels``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `PutMembershipLevels`: Status
    fmt.Fprintf(os.Stdout, "Response from `MembershipConfigAPI.PutMembershipLevels`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiPutMembershipLevelsRequest struct via the builder pattern
 ...
 **xAppKey** | **string** | Client or Partner&#39;s Application Key | 
 **xHotelid** | **string** | Mandatory parameter to identify the hotel code where the end user is logged in | 
 **membershipLevels** | [**MembershipLevels**](MembershipLevels.md) | Request object for modifying membership levels. | 
 **xExternalsystem** | **string** | External system code. | 
 **acceptLanguage** | **string** | Language code | 
...
> Status PutMembershipMarketGroups(ctx, membershipMarketGroupId).Authorization(authorization).XAppKey(xAppKey).XHotelid(xHotelid).MembershipMarketGroups(membershipMarketGroups).XExternalsystem(xExternalsystem).AcceptLanguage(acceptLanguage).Execute()
...
func main() {
    ...
    xAppKey := "xAppKey_example" // string | Client or Partner's Application Key
    xHotelid := "xHotelid_example" // string | Mandatory parameter to identify the hotel code where the end user is logged in
    membershipMarketGroups := *openapiclient.NewMembershipMarketGroups() // MembershipMarketGroups | Request object for changing existing Membership Market Groups Configurations.
    xExternalsystem := "xExternalsystem_example" // string | External system code. (optional)
    acceptLanguage := "acceptLanguage_example" // string | Language code (optional)

    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.MembershipConfigAPI.PutMembershipMarketGroups(context.Background(), membershipMarketGroupId).Authorization(authorization).XAppKey(xAppKey).XHotelid(xHotelid).MembershipMarketGroups(membershipMarketGroups).XExternalsystem(xExternalsystem).AcceptLanguage(acceptLanguage).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `MembershipConfigAPI.PutMembershipMarketGroups``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `PutMembershipMarketGroups`: Status
    fmt.Fprintf(os.Stdout, "Response from `MembershipConfigAPI.PutMembershipMarketGroups`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiPutMembershipMarketGroupsRequest struct via the builder pattern
 ...
 **xAppKey** | **string** | Client or Partner&#39;s Application Key | 
 **xHotelid** | **string** | Mandatory parameter to identify the hotel code where the end user is logged in | 
 **membershipMarketGroups** | [**MembershipMarketGroups**](MembershipMarketGroups.md) | Request object for changing existing Membership Market Groups Configurations. | 
 **xExternalsystem** | **string** | External system code. | 
 **acceptLanguage** | **string** | Language code | 
...
> Status PutMembershipOriginGroup(ctx, membershipOriginGroupId).Authorization(authorization).XAppKey(xAppKey).XHotelid(xHotelid).MembershipOriginGroup(membershipOriginGroup).XExternalsystem(xExternalsystem).AcceptLanguage(acceptLanguage).Execute()

Change Membership origin group
...
func main() {
    membershipOriginGroupId := "membershipOriginGroupId_example" // string | Membership origin group code which will be changed.
    authorization := "authorization_example" // string | Bearer token that needs to be passed which is generated post user authentication
    xAppKey := "xAppKey_example" // string | Client or Partner's Application Key
    xHotelid := "xHotelid_example" // string | Mandatory parameter to identify the hotel code where the end user is logged in
    membershipOriginGroup := *openapiclient.NewMembershipOriginGroupDetails() // MembershipOriginGroupDetails | Request object for changing existing Membership Origin Group Configurations.
    xExternalsystem := "xExternalsystem_example" // string | External system code. (optional)
    acceptLanguage := "acceptLanguage_example" // string | Language code (optional)

    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.MembershipConfigAPI.PutMembershipOriginGroup(context.Background(), membershipOriginGroupId).Authorization(authorization).XAppKey(xAppKey).XHotelid(xHotelid).MembershipOriginGroup(membershipOriginGroup).XExternalsystem(xExternalsystem).AcceptLanguage(acceptLanguage).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `MembershipConfigAPI.PutMembershipOriginGroup``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `PutMembershipOriginGroup`: Status
    fmt.Fprintf(os.Stdout, "Response from `MembershipConfigAPI.PutMembershipOriginGroup`: %v\n", resp)
}
```
...
------------- | ------------- | ------------- | -------------
**ctx** | **context.Context** | context for authentication, logging, cancellation, deadlines, tracing, etc.
**membershipOriginGroupId** | **string** | Membership origin group code which will be changed. | 

### Other Parameters

Other parameters are passed through a pointer to a apiPutMembershipOriginGroupRequest struct via the builder pattern
 ...
 **xAppKey** | **string** | Client or Partner&#39;s Application Key | 
 **xHotelid** | **string** | Mandatory parameter to identify the hotel code where the end user is logged in | 
 **membershipOriginGroup** | [**MembershipOriginGroupDetails**](MembershipOriginGroupDetails.md) | Request object for changing existing Membership Origin Group Configurations. | 
 **xExternalsystem** | **string** | External system code. | 
 **acceptLanguage** | **string** | Language code | 
...
> Status PutMembershipPropertyGroups(ctx, membershipPropertyGroupsId).Authorization(authorization).XAppKey(xAppKey).XHotelid(xHotelid).MembershipPropertyGroups(membershipPropertyGroups).XExternalsystem(xExternalsystem).AcceptLanguage(acceptLanguage).Execute()
...
func main() {
    ...
    xAppKey := "xAppKey_example" // string | Client or Partner's Application Key
    xHotelid := "xHotelid_example" // string | Mandatory parameter to identify the hotel code where the end user is logged in
    membershipPropertyGroups := *openapiclient.NewMembershipPropertyGroups() // MembershipPropertyGroups | Request object for changing existing Membership Property Groups Configurations.
    xExternalsystem := "xExternalsystem_example" // string | External system code. (optional)
    acceptLanguage := "acceptLanguage_example" // string | Language code (optional)

    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.MembershipConfigAPI.PutMembershipPropertyGroups(context.Background(), membershipPropertyGroupsId).Authorization(authorization).XAppKey(xAppKey).XHotelid(xHotelid).MembershipPropertyGroups(membershipPropertyGroups).XExternalsystem(xExternalsystem).AcceptLanguage(acceptLanguage).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `MembershipConfigAPI.PutMembershipPropertyGroups``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `PutMembershipPropertyGroups`: Status
    fmt.Fprintf(os.Stdout, "Response from `MembershipConfigAPI.PutMembershipPropertyGroups`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiPutMembershipPropertyGroupsRequest struct via the builder pattern
 ...
 **xAppKey** | **string** | Client or Partner&#39;s Application Key | 
 **xHotelid** | **string** | Mandatory parameter to identify the hotel code where the end user is logged in | 
 **membershipPropertyGroups** | [**MembershipPropertyGroups**](MembershipPropertyGroups.md) | Request object for changing existing Membership Property Groups Configurations. | 
 **xExternalsystem** | **string** | External system code. | 
 **acceptLanguage** | **string** | Language code | 
...
> Status PutMembershipRateGroups(ctx, membershipRateGroupId).Authorization(authorization).XAppKey(xAppKey).XHotelid(xHotelid).MembershipRateGroups(membershipRateGroups).XExternalsystem(xExternalsystem).AcceptLanguage(acceptLanguage).Execute()
...
func main() {
    ...
    xAppKey := "xAppKey_example" // string | Client or Partner's Application Key
    xHotelid := "xHotelid_example" // string | Mandatory parameter to identify the hotel code where the end user is logged in
    membershipRateGroups := *openapiclient.NewMembershipRateGroups() // MembershipRateGroups | Request object for modifying Membership Rate Groups.
    xExternalsystem := "xExternalsystem_example" // string | External system code. (optional)
    acceptLanguage := "acceptLanguage_example" // string | Language code (optional)

    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.MembershipConfigAPI.PutMembershipRateGroups(context.Background(), membershipRateGroupId).Authorization(authorization).XAppKey(xAppKey).XHotelid(xHotelid).MembershipRateGroups(membershipRateGroups).XExternalsystem(xExternalsystem).AcceptLanguage(acceptLanguage).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `MembershipConfigAPI.PutMembershipRateGroups``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `PutMembershipRateGroups`: Status
    fmt.Fprintf(os.Stdout, "Response from `MembershipConfigAPI.PutMembershipRateGroups`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiPutMembershipRateGroupsRequest struct via the builder pattern
 ...
 **xAppKey** | **string** | Client or Partner&#39;s Application Key | 
 **xHotelid** | **string** | Mandatory parameter to identify the hotel code where the end user is logged in | 
 **membershipRateGroups** | [**MembershipRateGroups**](MembershipRateGroups.md) | Request object for modifying Membership Rate Groups. | 
 **xExternalsystem** | **string** | External system code. | 
 **acceptLanguage** | **string** | Language code | 
...
> Status PutMembershipRates(ctx, membershipRatesId).Authorization(authorization).XAppKey(xAppKey).XHotelid(xHotelid).MembershipRates(membershipRates).XExternalsystem(xExternalsystem).AcceptLanguage(acceptLanguage).Execute()
...
func main() {
    ...
    xAppKey := "xAppKey_example" // string | Client or Partner's Application Key
    xHotelid := "xHotelid_example" // string | Mandatory parameter to identify the hotel code where the end user is logged in
    membershipRates := *openapiclient.NewMembershipRates() // MembershipRates | Request object for changing membership rate rules.
    xExternalsystem := "xExternalsystem_example" // string | External system code. (optional)
    acceptLanguage := "acceptLanguage_example" // string | Language code (optional)

    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.MembershipConfigAPI.PutMembershipRates(context.Background(), membershipRatesId).Authorization(authorization).XAppKey(xAppKey).XHotelid(xHotelid).MembershipRates(membershipRates).XExternalsystem(xExternalsystem).AcceptLanguage(acceptLanguage).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `MembershipConfigAPI.PutMembershipRates``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `PutMembershipRates`: Status
    fmt.Fprintf(os.Stdout, "Response from `MembershipConfigAPI.PutMembershipRates`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiPutMembershipRatesRequest struct via the builder pattern
 ...
 **xAppKey** | **string** | Client or Partner&#39;s Application Key | 
 **xHotelid** | **string** | Mandatory parameter to identify the hotel code where the end user is logged in | 
 **membershipRates** | [**MembershipRates**](MembershipRates.md) | Request object for changing membership rate rules. | 
 **xExternalsystem** | **string** | External system code. | 
 **acceptLanguage** | **string** | Language code | 
...
> Status PutMembershipSourceGroup(ctx, membershipSourceGroupId).Authorization(authorization).XAppKey(xAppKey).XHotelid(xHotelid).MembershipSourceGroup(membershipSourceGroup).XExternalsystem(xExternalsystem).AcceptLanguage(acceptLanguage).Execute()

Change Membership source group
...
func main() {
    membershipSourceGroupId := "membershipSourceGroupId_example" // string | Membership source group code which will be changed.
    authorization := "authorization_example" // string | Bearer token that needs to be passed which is generated post user authentication
    xAppKey := "xAppKey_example" // string | Client or Partner's Application Key
    xHotelid := "xHotelid_example" // string | Mandatory parameter to identify the hotel code where the end user is logged in
    membershipSourceGroup := *openapiclient.NewMembershipSourceGroupDetails() // MembershipSourceGroupDetails | Request object for changing existing Membership Source Group Configurations.
    xExternalsystem := "xExternalsystem_example" // string | External system code. (optional)
    acceptLanguage := "acceptLanguage_example" // string | Language code (optional)

    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.MembershipConfigAPI.PutMembershipSourceGroup(context.Background(), membershipSourceGroupId).Authorization(authorization).XAppKey(xAppKey).XHotelid(xHotelid).MembershipSourceGroup(membershipSourceGroup).XExternalsystem(xExternalsystem).AcceptLanguage(acceptLanguage).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `MembershipConfigAPI.PutMembershipSourceGroup``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `PutMembershipSourceGroup`: Status
    fmt.Fprintf(os.Stdout, "Response from `MembershipConfigAPI.PutMembershipSourceGroup`: %v\n", resp)
}
```
...
------------- | ------------- | ------------- | -------------
**ctx** | **context.Context** | context for authentication, logging, cancellation, deadlines, tracing, etc.
**membershipSourceGroupId** | **string** | Membership source group code which will be changed. | 

### Other Parameters

Other parameters are passed through a pointer to a apiPutMembershipSourceGroupRequest struct via the builder pattern
 ...
 **xAppKey** | **string** | Client or Partner&#39;s Application Key | 
 **xHotelid** | **string** | Mandatory parameter to identify the hotel code where the end user is logged in | 
 **membershipSourceGroup** | [**MembershipSourceGroupDetails**](MembershipSourceGroupDetails.md) | Request object for changing existing Membership Source Group Configurations. | 
 **xExternalsystem** | **string** | External system code. | 
 **acceptLanguage** | **string** | Language code | 
...
> MembershipTypes PutMembershipType(ctx, membershipTypeId).Authorization(authorization).XAppKey(xAppKey).XHotelid(xHotelid).MembershipTypeChangeInstructions(membershipTypeChangeInstructions).XExternalsystem(xExternalsystem).AcceptLanguage(acceptLanguage).Execute()
...
func main() {
    ...
    xAppKey := "xAppKey_example" // string | Client or Partner's Application Key
    xHotelid := "xHotelid_example" // string | Mandatory parameter to identify the hotel code where the end user is logged in
    membershipTypeChangeInstructions := *openapiclient.NewMembershipTypeChangeInstructions() // MembershipTypeChangeInstructions | Request object for changing membership type.
    xExternalsystem := "xExternalsystem_example" // string | External system code. (optional)
    acceptLanguage := "acceptLanguage_example" // string | Language code (optional)

    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.MembershipConfigAPI.PutMembershipType(context.Background(), membershipTypeId).Authorization(authorization).XAppKey(xAppKey).XHotelid(xHotelid).MembershipTypeChangeInstructions(membershipTypeChangeInstructions).XExternalsystem(xExternalsystem).AcceptLanguage(acceptLanguage).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `MembershipConfigAPI.PutMembershipType``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `PutMembershipType`: MembershipTypes
    fmt.Fprintf(os.Stdout, "Response from `MembershipConfigAPI.PutMembershipType`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiPutMembershipTypeRequest struct via the builder pattern
 ...
 **xAppKey** | **string** | Client or Partner&#39;s Application Key | 
 **xHotelid** | **string** | Mandatory parameter to identify the hotel code where the end user is logged in | 
 **membershipTypeChangeInstructions** | [**MembershipTypeChangeInstructions**](MembershipTypeChangeInstructions.md) | Request object for changing membership type. | 
 **xExternalsystem** | **string** | External system code. | 
 **acceptLanguage** | **string** | Language code | 
...
> Status PutMembershipTypeRules(ctx, membershipTypeRulesId).Authorization(authorization).XAppKey(xAppKey).XHotelid(xHotelid).MembershipTypeRules(membershipTypeRules).XExternalsystem(xExternalsystem).AcceptLanguage(acceptLanguage).Execute()
...
func main() {
    ...
    xAppKey := "xAppKey_example" // string | Client or Partner's Application Key
    xHotelid := "xHotelid_example" // string | Mandatory parameter to identify the hotel code where the end user is logged in
    membershipTypeRules := *openapiclient.NewMembershipTypeRules() // MembershipTypeRules | Request object for changing membership type rules.
    xExternalsystem := "xExternalsystem_example" // string | External system code. (optional)
    acceptLanguage := "acceptLanguage_example" // string | Language code (optional)

    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.MembershipConfigAPI.PutMembershipTypeRules(context.Background(), membershipTypeRulesId).Authorization(authorization).XAppKey(xAppKey).XHotelid(xHotelid).MembershipTypeRules(membershipTypeRules).XExternalsystem(xExternalsystem).AcceptLanguage(acceptLanguage).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `MembershipConfigAPI.PutMembershipTypeRules``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `PutMembershipTypeRules`: Status
    fmt.Fprintf(os.Stdout, "Response from `MembershipConfigAPI.PutMembershipTypeRules`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiPutMembershipTypeRulesRequest struct via the builder pattern
 ...
 **xAppKey** | **string** | Client or Partner&#39;s Application Key | 
 **xHotelid** | **string** | Mandatory parameter to identify the hotel code where the end user is logged in | 
 **membershipTypeRules** | [**MembershipTypeRules**](MembershipTypeRules.md) | Request object for changing membership type rules. | 
 **xExternalsystem** | **string** | External system code. | 
 **acceptLanguage** | **string** | Language code | 
