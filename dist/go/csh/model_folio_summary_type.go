...
type FolioSummaryType struct {
	...
	GenerateFiscalSupportingDoc *bool `json:"generateFiscalSupportingDoc,omitempty"`
	...
	ReservationInfo *FolioSummaryTypeReservationInfo `json:"reservationInfo,omitempty"`
	// Folio Revision number.
	RevisionNo *float32 `json:"revisionNo,omitempty"`
	// The starting value of the date range.
	Start *string `json:"start,omitempty"`
	SupportingDocument *SupportingDocumentType `json:"supportingDocument,omitempty"`
...
// GetGenerateFiscalSupportingDoc returns the GenerateFiscalSupportingDoc field value if set, zero value otherwise.
func (o *FolioSummaryType) GetGenerateFiscalSupportingDoc() bool {
	if o == nil || IsNil(o.GenerateFiscalSupportingDoc) {
		var ret bool
		return ret
	}
	return *o.GenerateFiscalSupportingDoc
}

// GetGenerateFiscalSupportingDocOk returns a tuple with the GenerateFiscalSupportingDoc field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *FolioSummaryType) GetGenerateFiscalSupportingDocOk() (*bool, bool) {
	if o == nil || IsNil(o.GenerateFiscalSupportingDoc) {
		return nil, false
	}
	return o.GenerateFiscalSupportingDoc, true
}
...
// SetGenerateFiscalSupportingDoc gets a reference to the given bool and assigns it to the GenerateFiscalSupportingDoc field.
func (o *FolioSummaryType) SetGenerateFiscalSupportingDoc(v bool) {
	o.GenerateFiscalSupportingDoc = &v
}
...
func (o *FolioSummaryType) GetReservationInfo() FolioSummaryTypeReservationInfo {
	if o == nil || IsNil(o.ReservationInfo) {
		var ret FolioSummaryTypeReservationInfo
		return ret
	}
...
// SetReservationInfo gets a reference to the given FolioSummaryTypeReservationInfo and assigns it to the ReservationInfo field.
...
// GetSupportingDocument returns the SupportingDocument field value if set, zero value otherwise.
func (o *FolioSummaryType) GetSupportingDocument() SupportingDocumentType {
	if o == nil || IsNil(o.SupportingDocument) {
		var ret SupportingDocumentType
		return ret
	}
	return *o.SupportingDocument
}

// GetSupportingDocumentOk returns a tuple with the SupportingDocument field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *FolioSummaryType) GetSupportingDocumentOk() (*SupportingDocumentType, bool) {
	if o == nil || IsNil(o.SupportingDocument) {
		return nil, false
	}
	return o.SupportingDocument, true
}
...
// SetSupportingDocument gets a reference to the given SupportingDocumentType and assigns it to the SupportingDocument field.
func (o *FolioSummaryType) SetSupportingDocument(v SupportingDocumentType) {
	o.SupportingDocument = &v
}
...
func (o FolioSummaryType) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.GenerateFiscalSupportingDoc) {
		toSerialize["generateFiscalSupportingDoc"] = o.GenerateFiscalSupportingDoc
	}
	...
	if !IsNil(o.SupportingDocument) {
		toSerialize["supportingDocument"] = o.SupportingDocument
	}
