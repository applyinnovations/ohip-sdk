...
// checks if the DetachDepositPolicyFromPaymentRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DetachDepositPolicyFromPaymentRequest{}

// DetachDepositPolicyFromPaymentRequest struct for DetachDepositPolicyFromPaymentRequest
type DetachDepositPolicyFromPaymentRequest struct {
...
func NewDetachDepositPolicyFromPaymentRequest() *DetachDepositPolicyFromPaymentRequest {
	this := DetachDepositPolicyFromPaymentRequest{}
	return &this
}
...
func (o DetachDepositPolicyFromPaymentRequest) MarshalJSON() ([]byte, error) {
...
func (o DetachDepositPolicyFromPaymentRequest) ToMap() (map[string]interface{}, error) {
...
type NullableDetachDepositPolicyFromPaymentRequest struct {
	value *DetachDepositPolicyFromPaymentRequest
	isSet bool
}

func (v NullableDetachDepositPolicyFromPaymentRequest) Get() *DetachDepositPolicyFromPaymentRequest {
	return v.value
}

func (v *NullableDetachDepositPolicyFromPaymentRequest) Set(val *DetachDepositPolicyFromPaymentRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableDetachDepositPolicyFromPaymentRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableDetachDepositPolicyFromPaymentRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDetachDepositPolicyFromPaymentRequest(val *DetachDepositPolicyFromPaymentRequest) *NullableDetachDepositPolicyFromPaymentRequest {
	return &NullableDetachDepositPolicyFromPaymentRequest{value: val, isSet: true}
}

func (v NullableDetachDepositPolicyFromPaymentRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDetachDepositPolicyFromPaymentRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
