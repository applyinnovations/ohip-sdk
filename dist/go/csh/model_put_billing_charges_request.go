...
// checks if the PutBillingChargesRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PutBillingChargesRequest{}

// PutBillingChargesRequest struct for PutBillingChargesRequest
type PutBillingChargesRequest struct {
...
func (o PutBillingChargesRequest) MarshalJSON() ([]byte, error) {
...
func (o PutBillingChargesRequest) ToMap() (map[string]interface{}, error) {
...
type NullablePutBillingChargesRequest struct {
	value *PutBillingChargesRequest
	isSet bool
}

func (v NullablePutBillingChargesRequest) Get() *PutBillingChargesRequest {
	return v.value
}

func (v *NullablePutBillingChargesRequest) Set(val *PutBillingChargesRequest) {
	v.value = val
	v.isSet = true
}

func (v NullablePutBillingChargesRequest) IsSet() bool {
	return v.isSet
}

func (v *NullablePutBillingChargesRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePutBillingChargesRequest(val *PutBillingChargesRequest) *NullablePutBillingChargesRequest {
	return &NullablePutBillingChargesRequest{value: val, isSet: true}
}

func (v NullablePutBillingChargesRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePutBillingChargesRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
