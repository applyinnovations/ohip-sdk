...
**GenerateFiscalPayload** | Pointer to **bool** | Flag to indicate if a fiscal payload should be generated for the Payment. | [optional] 
...
**OriginalInvoice** | Pointer to **string** | User-defined original invoice number. | [optional] 
**InvoiceType** | Pointer to **string** | Type of invoice specified in the originalInvoice field. | [optional] 
...
GetOriginalInvoice returns the OriginalInvoice field if non-nil, zero value otherwise.

### GetOriginalInvoiceOk

`func (o *BillingPaymentCriteria) GetOriginalInvoiceOk() (*string, bool)`

GetOriginalInvoiceOk returns a tuple with the OriginalInvoice field if it's non-nil, zero value otherwise
and a boolean to check if the value has been set.
...
SetOriginalInvoice sets OriginalInvoice field to given value.
