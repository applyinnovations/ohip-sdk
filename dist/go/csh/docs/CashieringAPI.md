...
[**ChangeTransactionCovers**](CashieringAPI.md#ChangeTransactionCovers) | **Put** /hotels/{hotelId}/covers | Change Transaction Covers
...
[**GetReservationVouchers**](CashieringAPI.md#GetReservationVouchers) | **Get** /hotels/{hotelId}/reservations/{reservationId}/vouchers | Get the list of vouchers generated for a reservation.
[**GetReservationsVouchers**](CashieringAPI.md#GetReservationsVouchers) | **Get** /hotels/{hotelId}/reservations/vouchers | Get the list of vouchers generated from a list of reservations.
...
[**GetTransactionCovers**](CashieringAPI.md#GetTransactionCovers) | **Get** /hotels/{hotelId}/covers | Get transaction covers
...
[**PostBulkPrepaidCards**](CashieringAPI.md#PostBulkPrepaidCards) | **Post** /hotels/{hotelId}/bulkPrepaidCards | Create multiple Prepaid Cards
[**PostCCSettlement**](CashieringAPI.md#PostCCSettlement) | **Post** /hotels/{hotelId}/ccSettlement | Create CreditCard Settlement
[**PostChargesAndPayments**](CashieringAPI.md#PostChargesAndPayments) | **Post** /hotels/{hotelId}/reservations/{reservationId}/chargesAndPayments | Post charges and payments on a reservation
...
[**PostGenerateBatchVouchers**](CashieringAPI.md#PostGenerateBatchVouchers) | **Post** /hotels/{hotelId}/vouchers/batchJobs | Generate Batch Vouchers
...
[**PostProformaFolio**](CashieringAPI.md#PostProformaFolio) | **Post** /hotels/{hotelId}/reservations/{reservationId}/proformaFolio | Create proforma
...
[**PostReservationVouchers**](CashieringAPI.md#PostReservationVouchers) | **Post** /hotels/{hotelId}/reservations/{reservationId}/vouchers | Generate Reservation Vouchers
...
> Status ChangeTransactionCovers(ctx, hotelId).Authorization(authorization).XAppKey(xAppKey).XHotelid(xHotelid).CoversInfo(coversInfo).XExternalsystem(xExternalsystem).AcceptLanguage(acceptLanguage).Execute()
...
func main() {
    ...
    xAppKey := "xAppKey_example" // string | Client or Partner's Application Key
    xHotelid := "xHotelid_example" // string | Mandatory parameter to identify the hotel code where the end user is logged in
    coversInfo := *openapiclient.NewCoversInfo() // CoversInfo | To change the trx cover for the given date and transaction code.
    xExternalsystem := "xExternalsystem_example" // string | External system code. (optional)
    acceptLanguage := "acceptLanguage_example" // string | Language code (optional)

    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.CashieringAPI.ChangeTransactionCovers(context.Background(), hotelId).Authorization(authorization).XAppKey(xAppKey).XHotelid(xHotelid).CoversInfo(coversInfo).XExternalsystem(xExternalsystem).AcceptLanguage(acceptLanguage).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `CashieringAPI.ChangeTransactionCovers``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `ChangeTransactionCovers`: Status
    fmt.Fprintf(os.Stdout, "Response from `CashieringAPI.ChangeTransactionCovers`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiChangeTransactionCoversRequest struct via the builder pattern
 ...
 **xAppKey** | **string** | Client or Partner&#39;s Application Key | 
 **xHotelid** | **string** | Mandatory parameter to identify the hotel code where the end user is logged in | 
 **coversInfo** | [**CoversInfo**](CoversInfo.md) | To change the trx cover for the given date and transaction code. | 
 **xExternalsystem** | **string** | External system code. | 
 **acceptLanguage** | **string** | Language code | 
...
func main() {
    ...
    customNumber := "customNumber_example" // string | Custom number (optional)
    xExternalsystem := "xExternalsystem_example" // string | External system code. (optional)
    acceptLanguage := "acceptLanguage_example" // string | Language code (optional)
 ...
 **customNumber** | **string** | Custom number | 
 **xExternalsystem** | **string** | External system code. | 
 **acceptLanguage** | **string** | Language code | 
...
> ReceiptHistoryResponse GetReceiptHistory(ctx, hotelId).Authorization(authorization).XAppKey(xAppKey).XHotelid(xHotelid).FromDate(fromDate).ToDate(toDate).Name(name).FirstName(firstName).ReceiptTypeName(receiptTypeName).TaxInvoice(taxInvoice).ReceiptNo(receiptNo).CustomNumber(customNumber).XExternalsystem(xExternalsystem).AcceptLanguage(acceptLanguage).Execute()
...
> ReservationVouchersType GetReservationVouchers(ctx, reservationId, hotelId).Authorization(authorization).XAppKey(xAppKey).XHotelid(xHotelid).XExternalsystem(xExternalsystem).AcceptLanguage(acceptLanguage).Execute()
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.CashieringAPI.GetReservationVouchers(context.Background(), reservationId, hotelId).Authorization(authorization).XAppKey(xAppKey).XHotelid(xHotelid).XExternalsystem(xExternalsystem).AcceptLanguage(acceptLanguage).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `CashieringAPI.GetReservationVouchers``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `GetReservationVouchers`: ReservationVouchersType
    fmt.Fprintf(os.Stdout, "Response from `CashieringAPI.GetReservationVouchers`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiGetReservationVouchersRequest struct via the builder pattern
...
[**ReservationVouchersType**](ReservationVouchersType.md)
...
> ReservationVouchersType GetReservationsVouchers(ctx, hotelId).GuestId(guestId).Authorization(authorization).XAppKey(xAppKey).XHotelid(xHotelid).XExternalsystem(xExternalsystem).AcceptLanguage(acceptLanguage).Execute()
...
func main() {
    hotelId := "hotelId_example" // string | Unique ID of the hotel
    guestId := []string{"Inner_example"} // []string | A unique identifying value assigned by the creating system. The ID attribute may be used to reference a primary-key value within a database or in a particular implementation.
    authorization := "authorization_example" // string | Bearer token that needs to be passed which is generated post user authentication
    xAppKey := "xAppKey_example" // string | Client or Partner's Application Key
    xHotelid := "xHotelid_example" // string | Mandatory parameter to identify the hotel code where the end user is logged in
    xExternalsystem := "xExternalsystem_example" // string | External system code. (optional)
    ...
    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.CashieringAPI.GetReservationsVouchers(context.Background(), hotelId).GuestId(guestId).Authorization(authorization).XAppKey(xAppKey).XHotelid(xHotelid).XExternalsystem(xExternalsystem).AcceptLanguage(acceptLanguage).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `CashieringAPI.GetReservationsVouchers``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `GetReservationsVouchers`: ReservationVouchersType
    fmt.Fprintf(os.Stdout, "Response from `CashieringAPI.GetReservationsVouchers`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiGetReservationsVouchersRequest struct via the builder pattern


Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------

 **guestId** | **[]string** | A unique identifying value assigned by the creating system. The ID attribute may be used to reference a primary-key value within a database or in a particular implementation. | 
 **authorization** | **string** | Bearer token that needs to be passed which is generated post user authentication | 
 **xAppKey** | **string** | Client or Partner&#39;s Application Key | 
 **xHotelid** | **string** | Mandatory parameter to identify the hotel code where the end user is logged in | 
 **xExternalsystem** | **string** | External system code. | 
...
> CoversInfo GetTransactionCovers(ctx, hotelId).CoversDate(coversDate).Authorization(authorization).XAppKey(xAppKey).XHotelid(xHotelid).TransactionCode(transactionCode).XExternalsystem(xExternalsystem).AcceptLanguage(acceptLanguage).Execute()
...
func main() {
    hotelId := "hotelId_example" // string | Unique ID of the hotel
    coversDate := time.Now() // string | 
    authorization := "authorization_example" // string | Bearer token that needs to be passed which is generated post user authentication
    xAppKey := "xAppKey_example" // string | Client or Partner's Application Key
    xHotelid := "xHotelid_example" // string | Mandatory parameter to identify the hotel code where the end user is logged in
    transactionCode := []string{"Inner_example"} // []string | Transaction Code to search. (optional)
    xExternalsystem := "xExternalsystem_example" // string | External system code. (optional)
    acceptLanguage := "acceptLanguage_example" // string | Language code (optional)

    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.CashieringAPI.GetTransactionCovers(context.Background(), hotelId).CoversDate(coversDate).Authorization(authorization).XAppKey(xAppKey).XHotelid(xHotelid).TransactionCode(transactionCode).XExternalsystem(xExternalsystem).AcceptLanguage(acceptLanguage).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `CashieringAPI.GetTransactionCovers``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `GetTransactionCovers`: CoversInfo
    fmt.Fprintf(os.Stdout, "Response from `CashieringAPI.GetTransactionCovers`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiGetTransactionCoversRequest struct via the builder pattern
 ...
 **xAppKey** | **string** | Client or Partner&#39;s Application Key | 
 **xHotelid** | **string** | Mandatory parameter to identify the hotel code where the end user is logged in | 
 **transactionCode** | **[]string** | Transaction Code to search. | 
 **xExternalsystem** | **string** | External system code. | 
 **acceptLanguage** | **string** | Language code | 

### Return type

[**CoversInfo**](CoversInfo.md)
...
> FiscalCallStatus GetValidateFiscalPrintingDetails(ctx, hotelId).Authorization(authorization).XAppKey(xAppKey).XHotelid(xHotelid).FolioView(folioView).FolioType(folioType).Id(id).Code(code).FetchInstruction(fetchInstruction).ProfileIdId(profileIdId).FiscalServiceMode(fiscalServiceMode).CashieringEventType(cashieringEventType).Balance(balance).QueueName(queueName).DebitFolio(debitFolio).SimpleFolio(simpleFolio).ManualFolioNo(manualFolioNo).XExternalsystem(xExternalsystem).AcceptLanguage(acceptLanguage).Execute()
...
func main() {
    ...
    cashieringEventType := "cashieringEventType_example" // string | Cashiering event triggered. (optional)
    balance := float32(8.14) // float32 | A monetary amount (optional)
    queueName := "queueName_example" // string | Folio Queue Name (optional)
    debitFolio := true // bool | This flag indicates if the folio to be generated is a Debit Folio. (optional)
    simpleFolio := true // bool | This flag indicates if the folio to be generated is a Simple Folio. (optional)
    manualFolioNo := float32(8.14) // float32 | User provided folio number. (optional)
    xExternalsystem := "xExternalsystem_example" // string | External system code. (optional)
    acceptLanguage := "acceptLanguage_example" // string | Language code (optional)
 ...
 **cashieringEventType** | **string** | Cashiering event triggered. | 
 **balance** | **float32** | A monetary amount | 
 **queueName** | **string** | Folio Queue Name | 
 **debitFolio** | **bool** | This flag indicates if the folio to be generated is a Debit Folio. | 
 **simpleFolio** | **bool** | This flag indicates if the folio to be generated is a Simple Folio. | 
 **manualFolioNo** | **float32** | User provided folio number. | 
 **xExternalsystem** | **string** | External system code. | 
 **acceptLanguage** | **string** | Language code | 
...
> BulkPrepaidCardsType PostBulkPrepaidCards(ctx, hotelId).Authorization(authorization).XAppKey(xAppKey).XHotelid(xHotelid).BulkPrepaidCardCriteria(bulkPrepaidCardCriteria).XExternalsystem(xExternalsystem).AcceptLanguage(acceptLanguage).Execute()
...
func main() {
    ...
    xAppKey := "xAppKey_example" // string | Client or Partner's Application Key
    xHotelid := "xHotelid_example" // string | Mandatory parameter to identify the hotel code where the end user is logged in
    bulkPrepaidCardCriteria := *openapiclient.NewBulkPrepaidCardCriteria() // BulkPrepaidCardCriteria | Request type for bulk prepaid card creation process
    xExternalsystem := "xExternalsystem_example" // string | External system code. (optional)
    acceptLanguage := "acceptLanguage_example" // string | Language code (optional)

    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.CashieringAPI.PostBulkPrepaidCards(context.Background(), hotelId).Authorization(authorization).XAppKey(xAppKey).XHotelid(xHotelid).BulkPrepaidCardCriteria(bulkPrepaidCardCriteria).XExternalsystem(xExternalsystem).AcceptLanguage(acceptLanguage).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `CashieringAPI.PostBulkPrepaidCards``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `PostBulkPrepaidCards`: BulkPrepaidCardsType
    fmt.Fprintf(os.Stdout, "Response from `CashieringAPI.PostBulkPrepaidCards`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiPostBulkPrepaidCardsRequest struct via the builder pattern
 ...
 **xAppKey** | **string** | Client or Partner&#39;s Application Key | 
 **xHotelid** | **string** | Mandatory parameter to identify the hotel code where the end user is logged in | 
 **bulkPrepaidCardCriteria** | [**BulkPrepaidCardCriteria**](BulkPrepaidCardCriteria.md) | Request type for bulk prepaid card creation process | 
 **xExternalsystem** | **string** | External system code. | 
 **acceptLanguage** | **string** | Language code | 

### Return type

[**BulkPrepaidCardsType**](BulkPrepaidCardsType.md)
...
> Status PostChargesAndPayments(ctx, hotelId, reservationId).Authorization(authorization).XAppKey(xAppKey).XHotelid(xHotelid).ChargesAndPaymentsCriteria(chargesAndPaymentsCriteria).XExternalsystem(xExternalsystem).AcceptLanguage(acceptLanguage).Execute()
...
func main() {
    ...
    xAppKey := "xAppKey_example" // string | Client or Partner's Application Key
    xHotelid := "xHotelid_example" // string | Mandatory parameter to identify the hotel code where the end user is logged in
    chargesAndPaymentsCriteria := *openapiclient.NewChargesAndPaymentsCriteria() // ChargesAndPaymentsCriteria | Request to post charges and payments on a reservation.
    xExternalsystem := "xExternalsystem_example" // string | External system code. (optional)
    acceptLanguage := "acceptLanguage_example" // string | Language code (optional)

    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.CashieringAPI.PostChargesAndPayments(context.Background(), hotelId, reservationId).Authorization(authorization).XAppKey(xAppKey).XHotelid(xHotelid).ChargesAndPaymentsCriteria(chargesAndPaymentsCriteria).XExternalsystem(xExternalsystem).AcceptLanguage(acceptLanguage).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `CashieringAPI.PostChargesAndPayments``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `PostChargesAndPayments`: Status
    fmt.Fprintf(os.Stdout, "Response from `CashieringAPI.PostChargesAndPayments`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiPostChargesAndPaymentsRequest struct via the builder pattern
 ...
 **xAppKey** | **string** | Client or Partner&#39;s Application Key | 
 **xHotelid** | **string** | Mandatory parameter to identify the hotel code where the end user is logged in | 
 **chargesAndPaymentsCriteria** | [**ChargesAndPaymentsCriteria**](ChargesAndPaymentsCriteria.md) | Request to post charges and payments on a reservation. | 
 **xExternalsystem** | **string** | External system code. | 
 **acceptLanguage** | **string** | Language code | 
...
> Status PostGenerateBatchVouchers(ctx, hotelId).Authorization(authorization).XAppKey(xAppKey).XHotelid(xHotelid).BatchVouchersCriteria(batchVouchersCriteria).XExternalsystem(xExternalsystem).AcceptLanguage(acceptLanguage).Execute()
...
func main() {
    ...
    xAppKey := "xAppKey_example" // string | Client or Partner's Application Key
    xHotelid := "xHotelid_example" // string | Mandatory parameter to identify the hotel code where the end user is logged in
    batchVouchersCriteria := *openapiclient.NewBatchVouchersCriteria() // BatchVouchersCriteria | Request type for batch vouchers.
    xExternalsystem := "xExternalsystem_example" // string | External system code. (optional)
    acceptLanguage := "acceptLanguage_example" // string | Language code (optional)

    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.CashieringAPI.PostGenerateBatchVouchers(context.Background(), hotelId).Authorization(authorization).XAppKey(xAppKey).XHotelid(xHotelid).BatchVouchersCriteria(batchVouchersCriteria).XExternalsystem(xExternalsystem).AcceptLanguage(acceptLanguage).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `CashieringAPI.PostGenerateBatchVouchers``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `PostGenerateBatchVouchers`: Status
    fmt.Fprintf(os.Stdout, "Response from `CashieringAPI.PostGenerateBatchVouchers`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiPostGenerateBatchVouchersRequest struct via the builder pattern
 ...
 **xAppKey** | **string** | Client or Partner&#39;s Application Key | 
 **xHotelid** | **string** | Mandatory parameter to identify the hotel code where the end user is logged in | 
 **batchVouchersCriteria** | [**BatchVouchersCriteria**](BatchVouchersCriteria.md) | Request type for batch vouchers. | 
 **xExternalsystem** | **string** | External system code. | 
 **acceptLanguage** | **string** | Language code | 
...
> ProformaFolio PostProformaFolio(ctx, reservationId, hotelId).Authorization(authorization).XAppKey(xAppKey).XHotelid(xHotelid).ReservationFolio(reservationFolio).XExternalsystem(xExternalsystem).AcceptLanguage(acceptLanguage).Execute()
...
func main() {
    ...
    xAppKey := "xAppKey_example" // string | Client or Partner's Application Key
    xHotelid := "xHotelid_example" // string | Mandatory parameter to identify the hotel code where the end user is logged in
    reservationFolio := *openapiclient.NewProformaReservationFolio() // ProformaReservationFolio | Request to create a Pro-Forma(folio) transactions for a reservation for external partners via OHIP domain. The request generates the internal transactions required to create a Pro-Forma folio, pass it into the response and finally remove/cleanup these transactions
    xExternalsystem := "xExternalsystem_example" // string | External system code. (optional)
    acceptLanguage := "acceptLanguage_example" // string | Language code (optional)

    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.CashieringAPI.PostProformaFolio(context.Background(), reservationId, hotelId).Authorization(authorization).XAppKey(xAppKey).XHotelid(xHotelid).ReservationFolio(reservationFolio).XExternalsystem(xExternalsystem).AcceptLanguage(acceptLanguage).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `CashieringAPI.PostProformaFolio``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `PostProformaFolio`: ProformaFolio
    fmt.Fprintf(os.Stdout, "Response from `CashieringAPI.PostProformaFolio`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiPostProformaFolioRequest struct via the builder pattern
 ...
 **xAppKey** | **string** | Client or Partner&#39;s Application Key | 
 **xHotelid** | **string** | Mandatory parameter to identify the hotel code where the end user is logged in | 
 **reservationFolio** | [**ProformaReservationFolio**](ProformaReservationFolio.md) | Request to create a Pro-Forma(folio) transactions for a reservation for external partners via OHIP domain. The request generates the internal transactions required to create a Pro-Forma folio, pass it into the response and finally remove/cleanup these transactions | 
 **xExternalsystem** | **string** | External system code. | 
 **acceptLanguage** | **string** | Language code | 

### Return type

[**ProformaFolio**](ProformaFolio.md)
...
> Status PostReservationVouchers(ctx, reservationId, hotelId).Authorization(authorization).XAppKey(xAppKey).XHotelid(xHotelid).XExternalsystem(xExternalsystem).AcceptLanguage(acceptLanguage).Execute()
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.CashieringAPI.PostReservationVouchers(context.Background(), reservationId, hotelId).Authorization(authorization).XAppKey(xAppKey).XHotelid(xHotelid).XExternalsystem(xExternalsystem).AcceptLanguage(acceptLanguage).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `CashieringAPI.PostReservationVouchers``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `PostReservationVouchers`: Status
    fmt.Fprintf(os.Stdout, "Response from `CashieringAPI.PostReservationVouchers`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiPostReservationVouchersRequest struct via the builder pattern
...
> DepositTransitionStatus TransitionDepositToGuestFolio(ctx, reservationId, hotelId).Authorization(authorization).XAppKey(xAppKey).XHotelid(xHotelid).DepositToGuestFolio(depositToGuestFolio).XExternalsystem(xExternalsystem).AcceptLanguage(acceptLanguage).Execute()
...
func main() {
    ...
    // response from `TransitionDepositToGuestFolio`: DepositTransitionStatus
...
[**DepositTransitionStatus**](DepositTransitionStatus.md)
