...
`func (o *PaymentCriteriaType) GetOriginalInvoice() string`

GetOriginalInvoice returns the OriginalInvoice field if non-nil, zero value otherwise.

### GetOriginalInvoiceOk

`func (o *PaymentCriteriaType) GetOriginalInvoiceOk() (*string, bool)`
...
`func (o *PaymentCriteriaType) SetOriginalInvoice(v string)`

SetOriginalInvoice sets OriginalInvoice field to given value.

### HasOriginalInvoice

`func (o *PaymentCriteriaType) HasOriginalInvoice() bool`

HasOriginalInvoice returns a boolean if a field has been set.

### GetInvoiceType

`func (o *PaymentCriteriaType) GetInvoiceType() string`

GetInvoiceType returns the InvoiceType field if non-nil, zero value otherwise.

### GetInvoiceTypeOk

`func (o *PaymentCriteriaType) GetInvoiceTypeOk() (*string, bool)`
...
`func (o *PaymentCriteriaType) SetInvoiceType(v string)`

SetInvoiceType sets InvoiceType field to given value.

### HasInvoiceType

`func (o *PaymentCriteriaType) HasInvoiceType() bool`
