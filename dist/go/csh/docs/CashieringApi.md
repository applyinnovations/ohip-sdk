...
func main() {
    ...
    fromCreateDateTime := "fromCreateDateTime_example" // string | Time stamp of the creation. (optional)
...
func main() {
    ...
    logDate := "logDate_example" // string |  (optional)
...
func main() {
    ...
    xAppKey := "xAppKey_example" // string | Client or Partner's Application Key
    xHotelid := "xHotelid_example" // string | Mandatory parameter to identify the hotel code where the end user is logged in
    awardDetails := *openapiclient.NewPostAwardTransactionRequest() // PostAwardTransactionRequest | Request object for creating an award transaction.
    xExternalsystem := "EXTERNALSYSTEMCODE" // string | External system code. (optional)
    acceptLanguage := "acceptLanguage_example" // string | Language code (optional)
 ...
 **xAppKey** | **string** | Client or Partner&#39;s Application Key | 
 **xHotelid** | **string** | Mandatory parameter to identify the hotel code where the end user is logged in | 
 **awardDetails** | [**PostAwardTransactionRequest**](PostAwardTransactionRequest.md) | Request object for creating an award transaction. | 
 **xExternalsystem** | **string** | External system code. | 
 **acceptLanguage** | **string** | Language code | 
...
func main() {
    ...
    xAppKey := "xAppKey_example" // string | Client or Partner's Application Key
    xHotelid := "xHotelid_example" // string | Mandatory parameter to identify the hotel code where the end user is logged in
    postFiscalInfoType := *openapiclient.NewPostFiscalInfoRequest() // PostFiscalInfoRequest | Request to generate CHECK OUT payload for a reservation.
    xExternalsystem := "EXTERNALSYSTEMCODE" // string | External system code. (optional)
    acceptLanguage := "acceptLanguage_example" // string | Language code (optional)
 ...
 **xAppKey** | **string** | Client or Partner&#39;s Application Key | 
 **xHotelid** | **string** | Mandatory parameter to identify the hotel code where the end user is logged in | 
 **postFiscalInfoType** | [**PostFiscalInfoRequest**](PostFiscalInfoRequest.md) | Request to generate CHECK OUT payload for a reservation. | 
 **xExternalsystem** | **string** | External system code. | 
 **acceptLanguage** | **string** | Language code | 
...
func main() {
    ...
    xAppKey := "xAppKey_example" // string | Client or Partner's Application Key
    xHotelid := "xHotelid_example" // string | Mandatory parameter to identify the hotel code where the end user is logged in
    fiscalSupportingDocumentCriteria := *openapiclient.NewResendSupportingDocumentRequest() // ResendSupportingDocumentRequest | Request to send supporting document.
    xExternalsystem := "EXTERNALSYSTEMCODE" // string | External system code. (optional)
    acceptLanguage := "acceptLanguage_example" // string | Language code (optional)
 ...
 **xAppKey** | **string** | Client or Partner&#39;s Application Key | 
 **xHotelid** | **string** | Mandatory parameter to identify the hotel code where the end user is logged in | 
 **fiscalSupportingDocumentCriteria** | [**ResendSupportingDocumentRequest**](ResendSupportingDocumentRequest.md) | Request to send supporting document. | 
 **xExternalsystem** | **string** | External system code. | 
 **acceptLanguage** | **string** | Language code | 
