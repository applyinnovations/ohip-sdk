...
**IsARAttached** | Pointer to **bool** | Flag to check if the folio has an AR number attached. | [optional] 
**IsFiscalFolio** | Pointer to **bool** | Flag to check if the folio type is fiscal or not. | [optional] 
**CreditBillGenerated** | Pointer to **bool** | Flag which indicates whether credit folio has been generated. | [optional] 
