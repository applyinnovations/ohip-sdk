...
**AwardTransaction** | Pointer to **bool** | Indicator to determine if the posting&#39;s transaction code is related to a payment award. | [optional] 
**Covers** | Pointer to **string** | POS covers | [optional] 
**ProformaFlag** | Pointer to **string** | This flag indicates if it is a proforma posted transaction. | [optional] 
...
GetAwardTransaction returns the AwardTransaction field if non-nil, zero value otherwise.

### GetAwardTransactionOk

`func (o *SummaryPostingType) GetAwardTransactionOk() (*bool, bool)`

GetAwardTransactionOk returns a tuple with the AwardTransaction field if it's non-nil, zero value otherwise
and a boolean to check if the value has been set.
...
SetAwardTransaction sets AwardTransaction field to given value.
...
GetProformaFlag returns the ProformaFlag field if non-nil, zero value otherwise.

### GetProformaFlagOk

`func (o *SummaryPostingType) GetProformaFlagOk() (*string, bool)`

GetProformaFlagOk returns a tuple with the ProformaFlag field if it's non-nil, zero value otherwise
and a boolean to check if the value has been set.
...
SetProformaFlag sets ProformaFlag field to given value.
