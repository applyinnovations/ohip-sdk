...
**FolioTypeName** | Pointer to **string** | Folio Type Name. | [optional] 
...
`func (o *FiscalCallStatus) GetFolioTypeName() string`

GetFolioTypeName returns the FolioTypeName field if non-nil, zero value otherwise.

### GetFolioTypeNameOk

`func (o *FiscalCallStatus) GetFolioTypeNameOk() (*string, bool)`
...
`func (o *FiscalCallStatus) SetFolioTypeName(v string)`

SetFolioTypeName sets FolioTypeName field to given value.

### HasFolioTypeName

`func (o *FiscalCallStatus) HasFolioTypeName() bool`
