...
**ServiceTypeInfo** | Pointer to [**[]TransactionServiceTypeType**](TransactionServiceTypeType.md) | Details about service type postings. | [optional] 
...
**PaymentsOnly** | Pointer to **bool** | Flag to indicate the window has only payment transactions | [optional] 
...
**TaxFolioPostingExists** | Pointer to **bool** | Indicates whether a folio window has Tax Folio transaction codes or not. | [optional] 
...
`func (o *FolioWindowType) GetServiceTypeInfoOk() (*[]TransactionServiceTypeType, bool)`
...
`func (o *FolioWindowType) GetPaymentsOnly() bool`
