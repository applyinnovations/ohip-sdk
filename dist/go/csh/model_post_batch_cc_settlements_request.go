...
// checks if the PostBatchCCSettlementsRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PostBatchCCSettlementsRequest{}

// PostBatchCCSettlementsRequest struct for PostBatchCCSettlementsRequest
type PostBatchCCSettlementsRequest struct {
...
func NewPostBatchCCSettlementsRequest() *PostBatchCCSettlementsRequest {
	this := PostBatchCCSettlementsRequest{}
	return &this
}
...
func (o PostBatchCCSettlementsRequest) MarshalJSON() ([]byte, error) {
...
func (o PostBatchCCSettlementsRequest) ToMap() (map[string]interface{}, error) {
...
type NullablePostBatchCCSettlementsRequest struct {
	value *PostBatchCCSettlementsRequest
	isSet bool
}

func (v NullablePostBatchCCSettlementsRequest) Get() *PostBatchCCSettlementsRequest {
	return v.value
}

func (v *NullablePostBatchCCSettlementsRequest) Set(val *PostBatchCCSettlementsRequest) {
	v.value = val
	v.isSet = true
}

func (v NullablePostBatchCCSettlementsRequest) IsSet() bool {
	return v.isSet
}

func (v *NullablePostBatchCCSettlementsRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePostBatchCCSettlementsRequest(val *PostBatchCCSettlementsRequest) *NullablePostBatchCCSettlementsRequest {
	return &NullablePostBatchCCSettlementsRequest{value: val, isSet: true}
}

func (v NullablePostBatchCCSettlementsRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePostBatchCCSettlementsRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
