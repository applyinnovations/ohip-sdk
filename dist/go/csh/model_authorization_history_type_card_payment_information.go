...
type AuthorizationHistoryTypeCardPaymentInformation struct {
	...
	EmailFolioInfo *AuthorizationHistoryTypeCardPaymentInformationEmailFolioInfo `json:"emailFolioInfo,omitempty"`
...
func (o *AuthorizationHistoryTypeCardPaymentInformation) GetEmailFolioInfo() AuthorizationHistoryTypeCardPaymentInformationEmailFolioInfo {
	if o == nil || IsNil(o.EmailFolioInfo) {
		var ret AuthorizationHistoryTypeCardPaymentInformationEmailFolioInfo
		return ret
	}
...
// SetEmailFolioInfo gets a reference to the given AuthorizationHistoryTypeCardPaymentInformationEmailFolioInfo and assigns it to the EmailFolioInfo field.
