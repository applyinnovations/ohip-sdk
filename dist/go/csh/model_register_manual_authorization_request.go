...
// checks if the RegisterManualAuthorizationRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RegisterManualAuthorizationRequest{}

// RegisterManualAuthorizationRequest struct for RegisterManualAuthorizationRequest
type RegisterManualAuthorizationRequest struct {
...
func NewRegisterManualAuthorizationRequest() *RegisterManualAuthorizationRequest {
	this := RegisterManualAuthorizationRequest{}
	return &this
}
...
func (o RegisterManualAuthorizationRequest) MarshalJSON() ([]byte, error) {
...
func (o RegisterManualAuthorizationRequest) ToMap() (map[string]interface{}, error) {
...
type NullableRegisterManualAuthorizationRequest struct {
	value *RegisterManualAuthorizationRequest
	isSet bool
}

func (v NullableRegisterManualAuthorizationRequest) Get() *RegisterManualAuthorizationRequest {
	return v.value
}

func (v *NullableRegisterManualAuthorizationRequest) Set(val *RegisterManualAuthorizationRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableRegisterManualAuthorizationRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableRegisterManualAuthorizationRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRegisterManualAuthorizationRequest(val *RegisterManualAuthorizationRequest) *NullableRegisterManualAuthorizationRequest {
	return &NullableRegisterManualAuthorizationRequest{value: val, isSet: true}
}

func (v NullableRegisterManualAuthorizationRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRegisterManualAuthorizationRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
