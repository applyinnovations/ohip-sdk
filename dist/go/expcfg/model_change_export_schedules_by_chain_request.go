...
// checks if the ChangeExportSchedulesByChainRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ChangeExportSchedulesByChainRequest{}

// ChangeExportSchedulesByChainRequest struct for ChangeExportSchedulesByChainRequest
type ChangeExportSchedulesByChainRequest struct {
...
func NewChangeExportSchedulesByChainRequest() *ChangeExportSchedulesByChainRequest {
	this := ChangeExportSchedulesByChainRequest{}
	return &this
}
...
func (o ChangeExportSchedulesByChainRequest) MarshalJSON() ([]byte, error) {
...
func (o ChangeExportSchedulesByChainRequest) ToMap() (map[string]interface{}, error) {
...
type NullableChangeExportSchedulesByChainRequest struct {
	value *ChangeExportSchedulesByChainRequest
	isSet bool
}

func (v NullableChangeExportSchedulesByChainRequest) Get() *ChangeExportSchedulesByChainRequest {
	return v.value
}

func (v *NullableChangeExportSchedulesByChainRequest) Set(val *ChangeExportSchedulesByChainRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableChangeExportSchedulesByChainRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableChangeExportSchedulesByChainRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableChangeExportSchedulesByChainRequest(val *ChangeExportSchedulesByChainRequest) *NullableChangeExportSchedulesByChainRequest {
	return &NullableChangeExportSchedulesByChainRequest{value: val, isSet: true}
}

func (v NullableChangeExportSchedulesByChainRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableChangeExportSchedulesByChainRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
