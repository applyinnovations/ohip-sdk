...
[**GetExportsAvailable**](ExportAPI.md#GetExportsAvailable) | **Get** /availableExports | Operation to fetch exports available.
...
func main() {
    ...
    exportSchedulesToBeChanged := *openapiclient.NewExportSchedulesToBeChanged() // ExportSchedulesToBeChanged | Request object for changing export schedules
 ...
 **exportSchedulesToBeChanged** | [**ExportSchedulesToBeChanged**](ExportSchedulesToBeChanged.md) | Request object for changing export schedules | 
...
> ExportMappingCodesToLink GetExportMappingCodesToLink(ctx, configType, hotelId).Authorization(authorization).XAppKey(xAppKey).XHotelid(xHotelid).Code(code).Description(description).Limit(limit).Offset(offset).XExternalsystem(xExternalsystem).AcceptLanguage(acceptLanguage).Execute()
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.ExportAPI.GetExportMappingCodesToLink(context.Background(), configType, hotelId).Authorization(authorization).XAppKey(xAppKey).XHotelid(xHotelid).Code(code).Description(description).Limit(limit).Offset(offset).XExternalsystem(xExternalsystem).AcceptLanguage(acceptLanguage).Execute()
    if err != nil {
...
> GeneratedExports GetExportsGenerated(ctx, exportFileId).Authorization(authorization).XAppKey(xAppKey).XHotelid(xHotelid).ExportDataId(exportDataId).Limit(limit).Offset(offset).XExternalsystem(xExternalsystem).AcceptLanguage(acceptLanguage).Execute()
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.ExportAPI.GetExportsGenerated(context.Background(), exportFileId).Authorization(authorization).XAppKey(xAppKey).XHotelid(xHotelid).ExportDataId(exportDataId).Limit(limit).Offset(offset).XExternalsystem(xExternalsystem).AcceptLanguage(acceptLanguage).Execute()
    if err != nil {
...
func main() {
    ...
    xAppKey := "xAppKey_example" // string | Client or Partner's Application Key
    xHotelid := "xHotelid_example" // string | Mandatory parameter to identify the hotel code where the end user is logged in
    exportMappingCodes := *openapiclient.NewExportMappingCodes() // ExportMappingCodes | Request to create export mapping code for a given export.
    xExternalsystem := "xExternalsystem_example" // string | External system code. (optional)
    acceptLanguage := "acceptLanguage_example" // string | Language code (optional)
 ...
 **xAppKey** | **string** | Client or Partner&#39;s Application Key | 
 **xHotelid** | **string** | Mandatory parameter to identify the hotel code where the end user is logged in | 
 **exportMappingCodes** | [**ExportMappingCodes**](ExportMappingCodes.md) | Request to create export mapping code for a given export. | 
 **xExternalsystem** | **string** | External system code. | 
 **acceptLanguage** | **string** | Language code | 
...
func main() {
    ...
    xAppKey := "xAppKey_example" // string | Client or Partner's Application Key
    xHotelid := "xHotelid_example" // string | Mandatory parameter to identify the hotel code where the end user is logged in
    exportMappings := *openapiclient.NewExportMappings() // ExportMappings | Request to create export definitions for a given export.
    xExternalsystem := "xExternalsystem_example" // string | External system code. (optional)
    acceptLanguage := "acceptLanguage_example" // string | Language code (optional)
 ...
 **xAppKey** | **string** | Client or Partner&#39;s Application Key | 
 **xHotelid** | **string** | Mandatory parameter to identify the hotel code where the end user is logged in | 
 **exportMappings** | [**ExportMappings**](ExportMappings.md) | Request to create export definitions for a given export. | 
 **xExternalsystem** | **string** | External system code. | 
 **acceptLanguage** | **string** | Language code | 
...
func main() {
    ...
    xAppKey := "xAppKey_example" // string | Client or Partner's Application Key
    xHotelid := "xHotelid_example" // string | Mandatory parameter to identify the hotel code where the end user is logged in
    exportSchedulesCriteria := *openapiclient.NewExportSchedulesCriteria() // ExportSchedulesCriteria | Request to create export schedules
    xExternalsystem := "xExternalsystem_example" // string | External system code. (optional)
    acceptLanguage := "acceptLanguage_example" // string | Language code (optional)
 ...
 **xAppKey** | **string** | Client or Partner&#39;s Application Key | 
 **xHotelid** | **string** | Mandatory parameter to identify the hotel code where the end user is logged in | 
 **exportSchedulesCriteria** | [**ExportSchedulesCriteria**](ExportSchedulesCriteria.md) | Request to create export schedules | 
 **xExternalsystem** | **string** | External system code. | 
 **acceptLanguage** | **string** | Language code | 
...
func main() {
    ...
    xAppKey := "xAppKey_example" // string | Client or Partner's Application Key
    xHotelid := "xHotelid_example" // string | Mandatory parameter to identify the hotel code where the end user is logged in
    exportMappingLinkedTypes := *openapiclient.NewExportMappingLinkedTypes() // ExportMappingLinkedTypes | Request to fetch codes linked to export mapping codes.
    xExternalsystem := "xExternalsystem_example" // string | External system code. (optional)
    acceptLanguage := "acceptLanguage_example" // string | Language code (optional)
 ...
 **xAppKey** | **string** | Client or Partner&#39;s Application Key | 
 **xHotelid** | **string** | Mandatory parameter to identify the hotel code where the end user is logged in | 
 **exportMappingLinkedTypes** | [**ExportMappingLinkedTypes**](ExportMappingLinkedTypes.md) | Request to fetch codes linked to export mapping codes. | 
 **xExternalsystem** | **string** | External system code. | 
 **acceptLanguage** | **string** | Language code | 
