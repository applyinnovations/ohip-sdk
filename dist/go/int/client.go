...
// APIClient manages communication with the OPERA Cloud Integration Processor API API v23.2
...
type APIClient struct {
	...
	IntegrationProcessorApi *IntegrationProcessorApiService
...
func NewAPIClient(cfg *Configuration) *APIClient {
	...
	// API Services
	c.IntegrationProcessorApi = (*IntegrationProcessorApiService)(&c.common)
