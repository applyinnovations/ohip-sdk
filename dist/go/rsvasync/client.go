...
// APIClient manages communication with the OPERA Cloud Reservation Asynchronous API API v22.4.0.0
...
type APIClient struct {
	...
	ReservationAsyncApi *ReservationAsyncApiService
...
func NewAPIClient(cfg *Configuration) *APIClient {
	...
	// API Services
	c.ReservationAsyncApi = (*ReservationAsyncApiService)(&c.common)
