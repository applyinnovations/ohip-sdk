...
**ResvStatus** | Pointer to [**DatabaseResStatusType**](DatabaseResStatusType.md) |  | [optional] 
...
**SharersList** | Pointer to **string** | Collection of Confirmation Numbers of Sharers. | [optional] 
**SharersResvIdList** | Pointer to **string** | The unique identifier reservationId List of the shared reservations. | [optional] 
...
GetSharersResvIdListOk returns a tuple with the SharersResvIdList field if it's non-nil, zero value otherwise
and a boolean to check if the value has been set.
...
SetModifiedHotelDateTime sets ModifiedHotelDateTime field to given value.
