...
[**DeleteActivityBookingForProfile**](LeisureManagementAPI.md#DeleteActivityBookingForProfile) | **Delete** /hotels/{hotelId}/profiles/{profileId}/activityBookings | Send a response to Cancellation of an Activity Booking
...
[**PostActivityBookingForProfile**](LeisureManagementAPI.md#PostActivityBookingForProfile) | **Post** /hotels/{hotelId}/profiles/{profileId}/activityBookings | Send a response to Creation of Activity Booking
...
[**PutActivityBookingForProfile**](LeisureManagementAPI.md#PutActivityBookingForProfile) | **Put** /hotels/{hotelId}/profiles/{profileId}/activityBookings | Send a response to Change in Activity Booking
...
> Status DeleteActivityBookingForProfile(ctx, profileId, hotelId).ActivityId(activityId).ActivityIdType(activityIdType).Authorization(authorization).XAppKey(xAppKey).XHotelid(xHotelid).XExternalsystem(xExternalsystem).AcceptLanguage(acceptLanguage).Execute()
...
func main() {
    profileId := "profileId_example" // string | Unique OPERA Profile ID which is used to find any profile in OPERA.
    hotelId := "hotelId_example" // string | Unique OPERA Hotel code
    activityId := "activityId_example" // string | A unique identifying value assigned by the creating system. The ID attribute may be used to reference a primary-key value within a database or in a particular implementation.
    activityIdType := "EXTERNALSYSTEMCODE" // string | A reference to the type of object defined by the UniqueID element.
    authorization := "authorization_example" // string | Bearer token that needs to be passed which is generated post user authentication
    ...
    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.LeisureManagementAPI.DeleteActivityBookingForProfile(context.Background(), profileId, hotelId).ActivityId(activityId).ActivityIdType(activityIdType).Authorization(authorization).XAppKey(xAppKey).XHotelid(xHotelid).XExternalsystem(xExternalsystem).AcceptLanguage(acceptLanguage).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `LeisureManagementAPI.DeleteActivityBookingForProfile``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `DeleteActivityBookingForProfile`: Status
    fmt.Fprintf(os.Stdout, "Response from `LeisureManagementAPI.DeleteActivityBookingForProfile`: %v\n", resp)
}
```
...
------------- | ------------- | ------------- | -------------
**ctx** | **context.Context** | context for authentication, logging, cancellation, deadlines, tracing, etc.
**profileId** | **string** | Unique OPERA Profile ID which is used to find any profile in OPERA. | 
**hotelId** | **string** | Unique OPERA Hotel code | 

### Other Parameters

Other parameters are passed through a pointer to a apiDeleteActivityBookingForProfileRequest struct via the builder pattern
...
func main() {
    ...
    xAppKey := "xAppKey_example" // string | Client or Partner's Application Key
    xHotelid := "xHotelid_example" // string | Mandatory parameter to identify the hotel code where the end user is logged in
    createActivityBooking := *openapiclient.NewCreateActivityBooking() // CreateActivityBooking | Self-contained Request object that is used when Creating activities.
    xExternalsystem := "xExternalsystem_example" // string | External system code. (optional)
    acceptLanguage := "acceptLanguage_example" // string | Language code (optional)
 ...
 **xAppKey** | **string** | Client or Partner&#39;s Application Key | 
 **xHotelid** | **string** | Mandatory parameter to identify the hotel code where the end user is logged in | 
 **createActivityBooking** | [**CreateActivityBooking**](CreateActivityBooking.md) | Self-contained Request object that is used when Creating activities. | 
 **xExternalsystem** | **string** | External system code. | 
 **acceptLanguage** | **string** | Language code | 
...
> Status PostActivityBookingForProfile(ctx, profileId, hotelId).Authorization(authorization).XAppKey(xAppKey).XHotelid(xHotelid).CreateActivityBookingForProfile(createActivityBookingForProfile).XExternalsystem(xExternalsystem).AcceptLanguage(acceptLanguage).Execute()
...
func main() {
    ...
    xAppKey := "xAppKey_example" // string | Client or Partner's Application Key
    xHotelid := "xHotelid_example" // string | Mandatory parameter to identify the hotel code where the end user is logged in
    createActivityBookingForProfile := *openapiclient.NewCreateActivityBooking() // CreateActivityBooking | Self-contained Request object that is used when Creating activities.
    xExternalsystem := "xExternalsystem_example" // string | External system code. (optional)
    acceptLanguage := "acceptLanguage_example" // string | Language code (optional)

    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.LeisureManagementAPI.PostActivityBookingForProfile(context.Background(), profileId, hotelId).Authorization(authorization).XAppKey(xAppKey).XHotelid(xHotelid).CreateActivityBookingForProfile(createActivityBookingForProfile).XExternalsystem(xExternalsystem).AcceptLanguage(acceptLanguage).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `LeisureManagementAPI.PostActivityBookingForProfile``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `PostActivityBookingForProfile`: Status
    fmt.Fprintf(os.Stdout, "Response from `LeisureManagementAPI.PostActivityBookingForProfile`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiPostActivityBookingForProfileRequest struct via the builder pattern
 ...
 **xAppKey** | **string** | Client or Partner&#39;s Application Key | 
 **xHotelid** | **string** | Mandatory parameter to identify the hotel code where the end user is logged in | 
 **createActivityBookingForProfile** | [**CreateActivityBooking**](CreateActivityBooking.md) | Self-contained Request object that is used when Creating activities. | 
 **xExternalsystem** | **string** | External system code. | 
 **acceptLanguage** | **string** | Language code | 
...
func main() {
    ...
    xAppKey := "xAppKey_example" // string | Client or Partner's Application Key
    xHotelid := "xHotelid_example" // string | Mandatory parameter to identify the hotel code where the end user is logged in
    locationNotificationToBeCreated := *openapiclient.NewLocationNotificationToBeCreated() // LocationNotificationToBeCreated | Generic self-contained request object that is used for Location Notification
    xExternalsystem := "xExternalsystem_example" // string | External system code. (optional)
    acceptLanguage := "acceptLanguage_example" // string | Language code (optional)
 ...
 **xAppKey** | **string** | Client or Partner&#39;s Application Key | 
 **xHotelid** | **string** | Mandatory parameter to identify the hotel code where the end user is logged in | 
 **locationNotificationToBeCreated** | [**LocationNotificationToBeCreated**](LocationNotificationToBeCreated.md) | Generic self-contained request object that is used for Location Notification | 
 **xExternalsystem** | **string** | External system code. | 
 **acceptLanguage** | **string** | Language code | 
...
func main() {
    ...
    xAppKey := "xAppKey_example" // string | Client or Partner's Application Key
    xHotelid := "xHotelid_example" // string | Mandatory parameter to identify the hotel code where the end user is logged in
    changeActivityBooking := *openapiclient.NewChangeActivityBooking() // ChangeActivityBooking | Self-contained Request object that is used when Updating activities.
    xExternalsystem := "xExternalsystem_example" // string | External system code. (optional)
    acceptLanguage := "acceptLanguage_example" // string | Language code (optional)
 ...
 **xAppKey** | **string** | Client or Partner&#39;s Application Key | 
 **xHotelid** | **string** | Mandatory parameter to identify the hotel code where the end user is logged in | 
 **changeActivityBooking** | [**ChangeActivityBooking**](ChangeActivityBooking.md) | Self-contained Request object that is used when Updating activities. | 
 **xExternalsystem** | **string** | External system code. | 
 **acceptLanguage** | **string** | Language code | 
...
> ActivityBookingModified PutActivityBookingForProfile(ctx, profileId, hotelId).Authorization(authorization).XAppKey(xAppKey).XHotelid(xHotelid).ChangeActivityBookingForProfile(changeActivityBookingForProfile).XExternalsystem(xExternalsystem).AcceptLanguage(acceptLanguage).Execute()
...
func main() {
    ...
    xAppKey := "xAppKey_example" // string | Client or Partner's Application Key
    xHotelid := "xHotelid_example" // string | Mandatory parameter to identify the hotel code where the end user is logged in
    changeActivityBookingForProfile := *openapiclient.NewChangeActivityBooking() // ChangeActivityBooking | Self-contained Request object that is used when Updating activities.
    xExternalsystem := "xExternalsystem_example" // string | External system code. (optional)
    acceptLanguage := "acceptLanguage_example" // string | Language code (optional)

    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.LeisureManagementAPI.PutActivityBookingForProfile(context.Background(), profileId, hotelId).Authorization(authorization).XAppKey(xAppKey).XHotelid(xHotelid).ChangeActivityBookingForProfile(changeActivityBookingForProfile).XExternalsystem(xExternalsystem).AcceptLanguage(acceptLanguage).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `LeisureManagementAPI.PutActivityBookingForProfile``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `PutActivityBookingForProfile`: ActivityBookingModified
    fmt.Fprintf(os.Stdout, "Response from `LeisureManagementAPI.PutActivityBookingForProfile`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiPutActivityBookingForProfileRequest struct via the builder pattern
 ...
 **xAppKey** | **string** | Client or Partner&#39;s Application Key | 
 **xHotelid** | **string** | Mandatory parameter to identify the hotel code where the end user is logged in | 
 **changeActivityBookingForProfile** | [**ChangeActivityBooking**](ChangeActivityBooking.md) | Self-contained Request object that is used when Updating activities. | 
 **xExternalsystem** | **string** | External system code. | 
 **acceptLanguage** | **string** | Language code | 
