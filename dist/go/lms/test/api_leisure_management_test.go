...
func Test_lms_LeisureManagementAPIService(t *testing.T) {
	...
	t.Run("Test LeisureManagementAPIService DeleteActivityBookingForProfile", func(t *testing.T) {
		...
		resp, httpRes, err := apiClient.LeisureManagementAPI.DeleteActivityBookingForProfile(context.Background(), profileId, hotelId).Execute()
	...
	t.Run("Test LeisureManagementAPIService PostActivityBookingForProfile", func(t *testing.T) {
		...
		resp, httpRes, err := apiClient.LeisureManagementAPI.PostActivityBookingForProfile(context.Background(), profileId, hotelId).Execute()
	...
	t.Run("Test LeisureManagementAPIService PutActivityBookingForProfile", func(t *testing.T) {
		...
		resp, httpRes, err := apiClient.LeisureManagementAPI.PutActivityBookingForProfile(context.Background(), profileId, hotelId).Execute()
