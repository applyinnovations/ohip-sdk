 ...
 **taskSheets** | [**TaskSheets**](TaskSheets.md) | Request for generating housekeeping Task Sheets automatically. To generate task sheets automatically the minimum required criteria is the Task Date, Task Code, Number of Attendants/Tasksheets required and the Room Statuses. Based on the criteria defined, task sheets will be created and the rooms will be assigned to the Tasksheets. Example: if the criteria defines that Dirty room status to be used to generate 5 sheets, then only those rooms which have the status &#x3D; Dirty will be used and will be assigned to the 5 sheets. | 
...
func main() {
    ...
    xAppKey := "xAppKey_example" // string | Client or Partner's Application Key
    xHotelid := "xHotelid_example" // string | Mandatory parameter to identify the hotel code where the end user is logged in
    taskRoom := *openapiclient.NewTaskRoom() // TaskRoom | Request to cancel the servicing of a task room.
    xExternalsystem := "xExternalsystem_example" // string | External system code. (optional)
    acceptLanguage := "acceptLanguage_example" // string | Language code (optional)
 ...
 **xAppKey** | **string** | Client or Partner&#39;s Application Key | 
 **xHotelid** | **string** | Mandatory parameter to identify the hotel code where the end user is logged in | 
 **taskRoom** | [**TaskRoom**](TaskRoom.md) | Request to cancel the servicing of a task room. | 
 **xExternalsystem** | **string** | External system code. | 
 **acceptLanguage** | **string** | Language code | 
...
func main() {
    ...
    xAppKey := "xAppKey_example" // string | Client or Partner's Application Key
    xHotelid := "xHotelid_example" // string | Mandatory parameter to identify the hotel code where the end user is logged in
    taskRoom := *openapiclient.NewTaskRoom() // TaskRoom | Request to complete servicing of a task room. This will complete the servicing and set the end time and status to COMPLETED.
    xExternalsystem := "xExternalsystem_example" // string | External system code. (optional)
    acceptLanguage := "acceptLanguage_example" // string | Language code (optional)
 ...
 **xAppKey** | **string** | Client or Partner&#39;s Application Key | 
 **xHotelid** | **string** | Mandatory parameter to identify the hotel code where the end user is logged in | 
 **taskRoom** | [**TaskRoom**](TaskRoom.md) | Request to complete servicing of a task room. This will complete the servicing and set the end time and status to COMPLETED. | 
 **xExternalsystem** | **string** | External system code. | 
 **acceptLanguage** | **string** | Language code | 
...
func main() {
    ...
    xAppKey := "xAppKey_example" // string | Client or Partner's Application Key
    xHotelid := "xHotelid_example" // string | Mandatory parameter to identify the hotel code where the end user is logged in
    schedule := *openapiclient.NewSchedule() // Schedule | A schedule with task(s) to be edited for the given reservation.
    xExternalsystem := "xExternalsystem_example" // string | External system code. (optional)
    acceptLanguage := "acceptLanguage_example" // string | Language code (optional)
 ...
 **xAppKey** | **string** | Client or Partner&#39;s Application Key | 
 **xHotelid** | **string** | Mandatory parameter to identify the hotel code where the end user is logged in | 
 **schedule** | [**Schedule**](Schedule.md) | A schedule with task(s) to be edited for the given reservation. | 
 **xExternalsystem** | **string** | External system code. | 
 **acceptLanguage** | **string** | Language code | 
...
func main() {
    ...
    xAppKey := "xAppKey_example" // string | Client or Partner's Application Key
    xHotelid := "xHotelid_example" // string | Mandatory parameter to identify the hotel code where the end user is logged in
    taskRoom := *openapiclient.NewTaskRoom() // TaskRoom | Request to end service break.
    xExternalsystem := "xExternalsystem_example" // string | External system code. (optional)
    acceptLanguage := "acceptLanguage_example" // string | Language code (optional)
 ...
 **xAppKey** | **string** | Client or Partner&#39;s Application Key | 
 **xHotelid** | **string** | Mandatory parameter to identify the hotel code where the end user is logged in | 
 **taskRoom** | [**TaskRoom**](TaskRoom.md) | Request to end service break. | 
 **xExternalsystem** | **string** | External system code. | 
 **acceptLanguage** | **string** | Language code | 
...
> TaskAssignment GetHouseKeepingTasks(ctx, hotelId).TaskDate(taskDate).Authorization(authorization).XAppKey(xAppKey).XHotelid(xHotelid).AttendantInRoomOnly(attendantInRoomOnly).GenerateCleaningSequence(generateCleaningSequence).IncludeReservationInfo(includeReservationInfo).IncludeComponentRoomsInfo(includeComponentRoomsInfo).IncludeTaskSheetDetails(includeTaskSheetDetails).IncludeScheduledRoomDetails(includeScheduledRoomDetails).IncludeTaskSheetsSummary(includeTaskSheetsSummary).SortByCleaningSequence(sortByCleaningSequence).TaskCodes(taskCodes).TaskHotelCodes(taskHotelCodes).TaskSequences(taskSequences).TaskDescriptions(taskDescriptions).TaskInstructions(taskInstructions).FacilityDepartureTask(facilityDepartureTask).LinenChange(linenChange).TaskCodesBreakOutId(taskCodesBreakOutId).TaskCodesBreakOutIdContext(taskCodesBreakOutIdContext).TaskCodesBreakOutIdType(taskCodesBreakOutIdType).AttendantId(attendantId).TaskSheetNumber(taskSheetNumber).HousekeepingRoomStatus(housekeepingRoomStatus).GuestService(guestService).RoomStatusToChange(roomStatusToChange).XExternalsystem(xExternalsystem).AcceptLanguage(acceptLanguage).Execute()
...
func main() {
    ...
    includeComponentRoomsInfo := true // bool | Setting this to true will include component rooms information associated to the room. (optional)
    ...
    includeScheduledRoomDetails := true // bool | Set this to true to include reservation information associated with any scheduled room moves. Available when the Advanced Daily Details OPERA Control is active. Note: IncludeReservationInfo must also be set to true to fetch reservation details. (optional)
    ...
    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.HousekeepingAPI.GetHouseKeepingTasks(context.Background(), hotelId).TaskDate(taskDate).Authorization(authorization).XAppKey(xAppKey).XHotelid(xHotelid).AttendantInRoomOnly(attendantInRoomOnly).GenerateCleaningSequence(generateCleaningSequence).IncludeReservationInfo(includeReservationInfo).IncludeComponentRoomsInfo(includeComponentRoomsInfo).IncludeTaskSheetDetails(includeTaskSheetDetails).IncludeScheduledRoomDetails(includeScheduledRoomDetails).IncludeTaskSheetsSummary(includeTaskSheetsSummary).SortByCleaningSequence(sortByCleaningSequence).TaskCodes(taskCodes).TaskHotelCodes(taskHotelCodes).TaskSequences(taskSequences).TaskDescriptions(taskDescriptions).TaskInstructions(taskInstructions).FacilityDepartureTask(facilityDepartureTask).LinenChange(linenChange).TaskCodesBreakOutId(taskCodesBreakOutId).TaskCodesBreakOutIdContext(taskCodesBreakOutIdContext).TaskCodesBreakOutIdType(taskCodesBreakOutIdType).AttendantId(attendantId).TaskSheetNumber(taskSheetNumber).HousekeepingRoomStatus(housekeepingRoomStatus).GuestService(guestService).RoomStatusToChange(roomStatusToChange).XExternalsystem(xExternalsystem).AcceptLanguage(acceptLanguage).Execute()
    if err != nil {
 ...
 **includeComponentRoomsInfo** | **bool** | Setting this to true will include component rooms information associated to the room. | 
 ...
 **includeScheduledRoomDetails** | **bool** | Set this to true to include reservation information associated with any scheduled room moves. Available when the Advanced Daily Details OPERA Control is active. Note: IncludeReservationInfo must also be set to true to fetch reservation details. | 
 ...
 **fetchInstructions** | **[]string** | Simple type for housekeeping instructions that can be used in requests for partial operations. When ScheduedRoomMoveInfo instruction is set to true, get only the rooms with a scheduled room move, along with the associated reservation information. When false, scheduled room move information is not included in the response. The scheduled room move information will assist housekeeping associates to prioritize rooms for cleaning. | 
 **fromRoomNumber** | **string** |  | 
 **toRoomNumber** | **string** |  | 
 **floor** | **[]string** | The floor of room to be fetched. | 
 ...
 **scheduledRoomMovesOnly** | **bool** | This flag indicates true or false. When it is set to true, get only the rooms with a scheduled room move, along with the associated reservation information. When false, scheduled room move information is not included in the response. The scheduled room move information will assist housekeeping associates to prioritize rooms for cleaning. | 
 **xExternalsystem** | **string** | External system code. | 
 **acceptLanguage** | **string** | Language code | 
...
func main() {
    ...
    roomStatusToChange := []string{"RoomStatusToChange_example"} // []string | Simple type for room status instructions to be used in requests for fetching housekeeping rooms. Valid status values are Clean, Dirty, Pickup, Inspected, OutOfOrder, OutOfService. (optional)
    includeScheduledRoomDetails := true // bool | Set this to true to include reservation information associated with any scheduled room moves. Available when the Advanced Daily Details OPERA Control is active. (optional)
    xExternalsystem := "xExternalsystem_example" // string | External system code. (optional)
    acceptLanguage := "acceptLanguage_example" // string | Language code (optional)
 ...
 **roomStatusToChange** | **[]string** | Simple type for room status instructions to be used in requests for fetching housekeeping rooms. Valid status values are Clean, Dirty, Pickup, Inspected, OutOfOrder, OutOfService. | 
 **includeScheduledRoomDetails** | **bool** | Set this to true to include reservation information associated with any scheduled room moves. Available when the Advanced Daily Details OPERA Control is active. | 
 **xExternalsystem** | **string** | External system code. | 
 **acceptLanguage** | **string** | Language code | 
...
func main() {
    ...
    xAppKey := "xAppKey_example" // string | Client or Partner's Application Key
    xHotelid := "xHotelid_example" // string | Mandatory parameter to identify the hotel code where the end user is logged in
    taskSheetToLock := *openapiclient.NewTaskSheetToLock() // TaskSheetToLock | Request for locking a task sheet.
    xExternalsystem := "xExternalsystem_example" // string | External system code. (optional)
    acceptLanguage := "acceptLanguage_example" // string | Language code (optional)
 ...
 **xAppKey** | **string** | Client or Partner&#39;s Application Key | 
 **xHotelid** | **string** | Mandatory parameter to identify the hotel code where the end user is logged in | 
 **taskSheetToLock** | [**TaskSheetToLock**](TaskSheetToLock.md) | Request for locking a task sheet. | 
 **xExternalsystem** | **string** | External system code. | 
 **acceptLanguage** | **string** | Language code | 
...
func main() {
    ...
    xAppKey := "xAppKey_example" // string | Client or Partner's Application Key
    xHotelid := "xHotelid_example" // string | Mandatory parameter to identify the hotel code where the end user is logged in
    taskSheetToMerge := *openapiclient.NewTaskSheetToMerge() // TaskSheetToMerge | Request for merging task sheets.
    xExternalsystem := "xExternalsystem_example" // string | External system code. (optional)
    acceptLanguage := "acceptLanguage_example" // string | Language code (optional)
 ...
 **xAppKey** | **string** | Client or Partner&#39;s Application Key | 
 **xHotelid** | **string** | Mandatory parameter to identify the hotel code where the end user is logged in | 
 **taskSheetToMerge** | [**TaskSheetToMerge**](TaskSheetToMerge.md) | Request for merging task sheets. | 
 **xExternalsystem** | **string** | External system code. | 
 **acceptLanguage** | **string** | Language code | 
...
func main() {
    ...
    xAppKey := "xAppKey_example" // string | Client or Partner's Application Key
    xHotelid := "xHotelid_example" // string | Mandatory parameter to identify the hotel code where the end user is logged in
    moveTaskRooms := *openapiclient.NewMoveTaskRooms() // MoveTaskRooms | Request for moving rooms between task sheets.
    xExternalsystem := "xExternalsystem_example" // string | External system code. (optional)
    acceptLanguage := "acceptLanguage_example" // string | Language code (optional)
 ...
 **xAppKey** | **string** | Client or Partner&#39;s Application Key | 
 **xHotelid** | **string** | Mandatory parameter to identify the hotel code where the end user is logged in | 
 **moveTaskRooms** | [**MoveTaskRooms**](MoveTaskRooms.md) | Request for moving rooms between task sheets. | 
 **xExternalsystem** | **string** | External system code. | 
 **acceptLanguage** | **string** | Language code | 
...
func main() {
    ...
    xAppKey := "xAppKey_example" // string | Client or Partner's Application Key
    xHotelid := "xHotelid_example" // string | Mandatory parameter to identify the hotel code where the end user is logged in
    attendantSchedule := *openapiclient.NewAttendantSchedule() // AttendantSchedule | Request for creating the attendant schedule.
    xExternalsystem := "xExternalsystem_example" // string | External system code. (optional)
    acceptLanguage := "acceptLanguage_example" // string | Language code (optional)
 ...
 **xAppKey** | **string** | Client or Partner&#39;s Application Key | 
 **xHotelid** | **string** | Mandatory parameter to identify the hotel code where the end user is logged in | 
 **attendantSchedule** | [**AttendantSchedule**](AttendantSchedule.md) | Request for creating the attendant schedule. | 
 **xExternalsystem** | **string** | External system code. | 
 **acceptLanguage** | **string** | Language code | 
...
func main() {
    ...
    xAppKey := "xAppKey_example" // string | Client or Partner's Application Key
    xHotelid := "xHotelid_example" // string | Mandatory parameter to identify the hotel code where the end user is logged in
    schedule := *openapiclient.NewSchedule() // Schedule | A schedule with task(s) to be created for the given reservation.
    xExternalsystem := "xExternalsystem_example" // string | External system code. (optional)
    acceptLanguage := "acceptLanguage_example" // string | Language code (optional)
 ...
 **xAppKey** | **string** | Client or Partner&#39;s Application Key | 
 **xHotelid** | **string** | Mandatory parameter to identify the hotel code where the end user is logged in | 
 **schedule** | [**Schedule**](Schedule.md) | A schedule with task(s) to be created for the given reservation. | 
 **xExternalsystem** | **string** | External system code. | 
 **acceptLanguage** | **string** | Language code | 
...
func main() {
    ...
    xAppKey := "xAppKey_example" // string | Client or Partner's Application Key
    xHotelid := "xHotelid_example" // string | Mandatory parameter to identify the hotel code where the end user is logged in
    roomMaintenanceRequest := *openapiclient.NewRoomMaintenanceRequest() // RoomMaintenanceRequest | Request to create a room maintenance record.
    xExternalsystem := "xExternalsystem_example" // string | External system code. (optional)
    acceptLanguage := "acceptLanguage_example" // string | Language code (optional)
 ...
 **xAppKey** | **string** | Client or Partner&#39;s Application Key | 
 **xHotelid** | **string** | Mandatory parameter to identify the hotel code where the end user is logged in | 
 **roomMaintenanceRequest** | [**RoomMaintenanceRequest**](RoomMaintenanceRequest.md) | Request to create a room maintenance record. | 
 **xExternalsystem** | **string** | External system code. | 
 **acceptLanguage** | **string** | Language code | 
 ...
 **xAppKey** | **string** | Client or Partner&#39;s Application Key | 
 **xHotelid** | **string** | Mandatory parameter to identify the hotel code where the end user is logged in | 
 **taskSheet** | [**TaskSheet**](TaskSheet.md) | Request to create a new task sheet. Details for the task sheet required are the Task Code, Task Date and Resort. Task Instructions and total credits if not provided will be retrieved from the task code setup. If room and attendant information is sent, this will be added to the task sheet created. | 
 **xExternalsystem** | **string** | External system code. | 
 **acceptLanguage** | **string** | Language code | 
 ...
 **xAppKey** | **string** | Client or Partner&#39;s Application Key | 
 **xHotelid** | **string** | Mandatory parameter to identify the hotel code where the end user is logged in | 
 **taskSheet** | [**TaskSheet**](TaskSheet.md) | Request to create(add) a room in a task sheet. Details for the task sheet required are the Task Code, Task Date and Resort. The room element will contain the list of rooms that are to be added to the task sheet. These rooms will be added to the existing rooms on the task sheet. Room instructions and credits will be updated for each room. | 
 **xExternalsystem** | **string** | External system code. | 
 **acceptLanguage** | **string** | Language code | 
...
func main() {
    ...
    xAppKey := "xAppKey_example" // string | Client or Partner's Application Key
    xHotelid := "xHotelid_example" // string | Mandatory parameter to identify the hotel code where the end user is logged in
    roomMaintenance := *openapiclient.NewRoomMaintenance() // RoomMaintenance | Request to change room maintenance details.
    xExternalsystem := "xExternalsystem_example" // string | External system code. (optional)
    acceptLanguage := "acceptLanguage_example" // string | Language code (optional)
 ...
 **xAppKey** | **string** | Client or Partner&#39;s Application Key | 
 **xHotelid** | **string** | Mandatory parameter to identify the hotel code where the end user is logged in | 
 **roomMaintenance** | [**RoomMaintenance**](RoomMaintenance.md) | Request to change room maintenance details. | 
 **xExternalsystem** | **string** | External system code. | 
 **acceptLanguage** | **string** | Language code | 
 ...
 **xAppKey** | **string** | Client or Partner&#39;s Application Key | 
 **xHotelid** | **string** | Mandatory parameter to identify the hotel code where the end user is logged in | 
 **taskSheet** | [**TaskSheet**](TaskSheet.md) | Request of Changing a Task Sheet. The task instructions, total credits, attendant information and room information can be changed on a task sheet. Task Instructions , Total Credits and Attendants will be replaced with what is sent in this request. Example: If the task instructions is null in the request, the task instructions on the task sheet will be updated to null. If rooms are sent as part of this request, this will replace the existing rooms on the task sheet. If rooms are not sent, then the original rooms will remain. The task date, hotel code, task sheet number and task code is required to search for the task sheet which has to be changed | 
 **xExternalsystem** | **string** | External system code. | 
 **acceptLanguage** | **string** | Language code | 
 ...
 **xAppKey** | **string** | Client or Partner&#39;s Application Key | 
 **xHotelid** | **string** | Mandatory parameter to identify the hotel code where the end user is logged in | 
 **taskSheet** | [**TaskSheet**](TaskSheet.md) | Request to change a room on a task sheet. The information that can be changed are the room instructions and credits. The instructions and credits for a room will be updated based on the information sent in this request. The criteria required to search for the particular task sheet to update requires the HotelCode, Task Sheet Number, Task Code and Task Date. | 
 **xExternalsystem** | **string** | External system code. | 
 **acceptLanguage** | **string** | Language code | 
...
func main() {
    ...
    xAppKey := "xAppKey_example" // string | Client or Partner's Application Key
    xHotelid := "xHotelid_example" // string | Mandatory parameter to identify the hotel code where the end user is logged in
    taskSheetTemplate := *openapiclient.NewTaskSheetTemplate() // TaskSheetTemplate | Request for changing task sheet template.
    xExternalsystem := "xExternalsystem_example" // string | External system code. (optional)
    acceptLanguage := "acceptLanguage_example" // string | Language code (optional)
 ...
 **xAppKey** | **string** | Client or Partner&#39;s Application Key | 
 **xHotelid** | **string** | Mandatory parameter to identify the hotel code where the end user is logged in | 
 **taskSheetTemplate** | [**TaskSheetTemplate**](TaskSheetTemplate.md) | Request for changing task sheet template. | 
 **xExternalsystem** | **string** | External system code. | 
 **acceptLanguage** | **string** | Language code | 
...
func main() {
    ...
    xAppKey := "xAppKey_example" // string | Client or Partner's Application Key
    xHotelid := "xHotelid_example" // string | Mandatory parameter to identify the hotel code where the end user is logged in
    scheduleSearch := *openapiclient.NewScheduleSearch() // ScheduleSearch | Request with basic information reservation needed for the reset of the schedule.
    xExternalsystem := "xExternalsystem_example" // string | External system code. (optional)
    acceptLanguage := "acceptLanguage_example" // string | Language code (optional)
 ...
 **xAppKey** | **string** | Client or Partner&#39;s Application Key | 
 **xHotelid** | **string** | Mandatory parameter to identify the hotel code where the end user is logged in | 
 **scheduleSearch** | [**ScheduleSearch**](ScheduleSearch.md) | Request with basic information reservation needed for the reset of the schedule. | 
 **xExternalsystem** | **string** | External system code. | 
 **acceptLanguage** | **string** | Language code | 
...
func main() {
    ...
    xAppKey := "xAppKey_example" // string | Client or Partner's Application Key
    xHotelid := "xHotelid_example" // string | Mandatory parameter to identify the hotel code where the end user is logged in
    roomMaintenance := *openapiclient.NewRoomMaintenance() // RoomMaintenance | Request to resolve a room maintenance request.
    xExternalsystem := "xExternalsystem_example" // string | External system code. (optional)
    acceptLanguage := "acceptLanguage_example" // string | Language code (optional)
 ...
 **xAppKey** | **string** | Client or Partner&#39;s Application Key | 
 **xHotelid** | **string** | Mandatory parameter to identify the hotel code where the end user is logged in | 
 **roomMaintenance** | [**RoomMaintenance**](RoomMaintenance.md) | Request to resolve a room maintenance request. | 
 **xExternalsystem** | **string** | External system code. | 
 **acceptLanguage** | **string** | Language code | 
...
func main() {
    ...
    xAppKey := "xAppKey_example" // string | Client or Partner's Application Key
    xHotelid := "xHotelid_example" // string | Mandatory parameter to identify the hotel code where the end user is logged in
    guestHousekeepingServiceRequest := *openapiclient.NewGuestHousekeepingServiceRequest() // GuestHousekeepingServiceRequest | Operation to get set guest housekeeping instructions for the room.
    xExternalsystem := "xExternalsystem_example" // string | External system code. (optional)
    acceptLanguage := "acceptLanguage_example" // string | Language code (optional)
 ...
 **xAppKey** | **string** | Client or Partner&#39;s Application Key | 
 **xHotelid** | **string** | Mandatory parameter to identify the hotel code where the end user is logged in | 
 **guestHousekeepingServiceRequest** | [**GuestHousekeepingServiceRequest**](GuestHousekeepingServiceRequest.md) | Operation to get set guest housekeeping instructions for the room. | 
 **xExternalsystem** | **string** | External system code. | 
 **acceptLanguage** | **string** | Language code | 
...
func main() {
    ...
    xAppKey := "xAppKey_example" // string | Client or Partner's Application Key
    xHotelid := "xHotelid_example" // string | Mandatory parameter to identify the hotel code where the end user is logged in
    guestHousekeepingServiceRequestCriteria := *openapiclient.NewGuestHousekeepingServiceRequestCriteria() // GuestHousekeepingServiceRequestCriteria | Operation to set the Guest Service status of an occupied room. The service status can be Do Not Disturb or Make Up Room.
    xExternalsystem := "xExternalsystem_example" // string | External system code. (optional)
    acceptLanguage := "acceptLanguage_example" // string | Language code (optional)
 ...
 **xAppKey** | **string** | Client or Partner&#39;s Application Key | 
 **xHotelid** | **string** | Mandatory parameter to identify the hotel code where the end user is logged in | 
 **guestHousekeepingServiceRequestCriteria** | [**GuestHousekeepingServiceRequestCriteria**](GuestHousekeepingServiceRequestCriteria.md) | Operation to set the Guest Service status of an occupied room. The service status can be Do Not Disturb or Make Up Room. | 
 **xExternalsystem** | **string** | External system code. | 
 **acceptLanguage** | **string** | Language code | 
...
func main() {
    ...
    xAppKey := "xAppKey_example" // string | Client or Partner's Application Key
    xHotelid := "xHotelid_example" // string | Mandatory parameter to identify the hotel code where the end user is logged in
    roomCleaningPriority := *openapiclient.NewRoomCleaningPriority() // RoomCleaningPriority | Request to set a list of rooms as priority for cleaning. This will set a flag as priority and a priority number at the bottom of the current priority line.
    xExternalsystem := "xExternalsystem_example" // string | External system code. (optional)
    acceptLanguage := "acceptLanguage_example" // string | Language code (optional)
 ...
 **xAppKey** | **string** | Client or Partner&#39;s Application Key | 
 **xHotelid** | **string** | Mandatory parameter to identify the hotel code where the end user is logged in | 
 **roomCleaningPriority** | [**RoomCleaningPriority**](RoomCleaningPriority.md) | Request to set a list of rooms as priority for cleaning. This will set a flag as priority and a priority number at the bottom of the current priority line. | 
 **xExternalsystem** | **string** | External system code. | 
 **acceptLanguage** | **string** | Language code | 
...
func main() {
    ...
    xAppKey := "xAppKey_example" // string | Client or Partner's Application Key
    xHotelid := "xHotelid_example" // string | Mandatory parameter to identify the hotel code where the end user is logged in
    roomCondition := *openapiclient.NewRoomCondition() // RoomCondition | Request element for setting room condition.
    xExternalsystem := "xExternalsystem_example" // string | External system code. (optional)
    acceptLanguage := "acceptLanguage_example" // string | Language code (optional)
 ...
 **xAppKey** | **string** | Client or Partner&#39;s Application Key | 
 **xHotelid** | **string** | Mandatory parameter to identify the hotel code where the end user is logged in | 
 **roomCondition** | [**RoomCondition**](RoomCondition.md) | Request element for setting room condition. | 
 **xExternalsystem** | **string** | External system code. | 
 **acceptLanguage** | **string** | Language code | 
...
func main() {
    ...
    xAppKey := "xAppKey_example" // string | Client or Partner's Application Key
    xHotelid := "xHotelid_example" // string | Mandatory parameter to identify the hotel code where the end user is logged in
    scheduleShiftRequest := *openapiclient.NewScheduleShiftRequest() // ScheduleShiftRequest | Request with the information needed for the shift of the schedule.
    xExternalsystem := "xExternalsystem_example" // string | External system code. (optional)
    acceptLanguage := "acceptLanguage_example" // string | Language code (optional)
 ...
 **xAppKey** | **string** | Client or Partner&#39;s Application Key | 
 **xHotelid** | **string** | Mandatory parameter to identify the hotel code where the end user is logged in | 
 **scheduleShiftRequest** | [**ScheduleShiftRequest**](ScheduleShiftRequest.md) | Request with the information needed for the shift of the schedule. | 
 **xExternalsystem** | **string** | External system code. | 
 **acceptLanguage** | **string** | Language code | 
...
func main() {
    ...
    xAppKey := "xAppKey_example" // string | Client or Partner's Application Key
    xHotelid := "xHotelid_example" // string | Mandatory parameter to identify the hotel code where the end user is logged in
    taskRoom := *openapiclient.NewTaskRoom() // TaskRoom | Request to start servicing a task room. When the attendant starts working on a room this request can be called to set the times and the status to WORKING for the room.
    xExternalsystem := "xExternalsystem_example" // string | External system code. (optional)
    acceptLanguage := "acceptLanguage_example" // string | Language code (optional)
 ...
 **xAppKey** | **string** | Client or Partner&#39;s Application Key | 
 **xHotelid** | **string** | Mandatory parameter to identify the hotel code where the end user is logged in | 
 **taskRoom** | [**TaskRoom**](TaskRoom.md) | Request to start servicing a task room. When the attendant starts working on a room this request can be called to set the times and the status to WORKING for the room. | 
 **xExternalsystem** | **string** | External system code. | 
 **acceptLanguage** | **string** | Language code | 
...
func main() {
    ...
    xAppKey := "xAppKey_example" // string | Client or Partner's Application Key
    xHotelid := "xHotelid_example" // string | Mandatory parameter to identify the hotel code where the end user is logged in
    taskRoom := *openapiclient.NewTaskRoom() // TaskRoom | Request to start service break.
    xExternalsystem := "xExternalsystem_example" // string | External system code. (optional)
    acceptLanguage := "acceptLanguage_example" // string | Language code (optional)
 ...
 **xAppKey** | **string** | Client or Partner&#39;s Application Key | 
 **xHotelid** | **string** | Mandatory parameter to identify the hotel code where the end user is logged in | 
 **taskRoom** | [**TaskRoom**](TaskRoom.md) | Request to start service break. | 
 **xExternalsystem** | **string** | External system code. | 
 **acceptLanguage** | **string** | Language code | 
...
func main() {
    ...
    xAppKey := "xAppKey_example" // string | Client or Partner's Application Key
    xHotelid := "xHotelid_example" // string | Mandatory parameter to identify the hotel code where the end user is logged in
    roomMaintenance := *openapiclient.NewRoomMaintenance() // RoomMaintenance | Request to set unresolved status for room maintenance request.
    xExternalsystem := "xExternalsystem_example" // string | External system code. (optional)
    acceptLanguage := "acceptLanguage_example" // string | Language code (optional)
 ...
 **xAppKey** | **string** | Client or Partner&#39;s Application Key | 
 **xHotelid** | **string** | Mandatory parameter to identify the hotel code where the end user is logged in | 
 **roomMaintenance** | [**RoomMaintenance**](RoomMaintenance.md) | Request to set unresolved status for room maintenance request. | 
 **xExternalsystem** | **string** | External system code. | 
 **acceptLanguage** | **string** | Language code | 
...
func main() {
    ...
    xAppKey := "xAppKey_example" // string | Client or Partner's Application Key
    xHotelid := "xHotelid_example" // string | Mandatory parameter to identify the hotel code where the end user is logged in
    taskSheetToUnlock := *openapiclient.NewTaskSheetToUnlock() // TaskSheetToUnlock | Request for unlocking a task sheet.
    xExternalsystem := "xExternalsystem_example" // string | External system code. (optional)
    acceptLanguage := "acceptLanguage_example" // string | Language code (optional)
 ...
 **xAppKey** | **string** | Client or Partner&#39;s Application Key | 
 **xHotelid** | **string** | Mandatory parameter to identify the hotel code where the end user is logged in | 
 **taskSheetToUnlock** | [**TaskSheetToUnlock**](TaskSheetToUnlock.md) | Request for unlocking a task sheet. | 
 **xExternalsystem** | **string** | External system code. | 
 **acceptLanguage** | **string** | Language code | 
