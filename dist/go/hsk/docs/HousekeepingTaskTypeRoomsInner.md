...
**ScheduledRoomMoveResvInfo** | Pointer to [**[]ReservationShortInfoType**](ReservationShortInfoType.md) |  | [optional] 
...
### GetScheduledRoomMoveResvInfo

`func (o *HousekeepingTaskTypeRoomsInner) GetScheduledRoomMoveResvInfo() []ReservationShortInfoType`

GetScheduledRoomMoveResvInfo returns the ScheduledRoomMoveResvInfo field if non-nil, zero value otherwise.

### GetScheduledRoomMoveResvInfoOk

`func (o *HousekeepingTaskTypeRoomsInner) GetScheduledRoomMoveResvInfoOk() (*[]ReservationShortInfoType, bool)`

GetScheduledRoomMoveResvInfoOk returns a tuple with the ScheduledRoomMoveResvInfo field if it's non-nil, zero value otherwise
and a boolean to check if the value has been set.

### SetScheduledRoomMoveResvInfo

`func (o *HousekeepingTaskTypeRoomsInner) SetScheduledRoomMoveResvInfo(v []ReservationShortInfoType)`

SetScheduledRoomMoveResvInfo sets ScheduledRoomMoveResvInfo field to given value.

### HasScheduledRoomMoveResvInfo
