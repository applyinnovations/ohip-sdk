...
**BackToBack** | Pointer to **bool** | Indicates if the Reservation is Back to Back Reservation. Available when the Back to Back Handling for Linked Reservations OPERA Control is active.  | [optional] 
**BackToBackHSKIndicator** | Pointer to **bool** | Indicates if the Reservation is departing today with a Back to Back Reservation arriving today. Available when the Back to Back Handling for Linked Reservations OPERA Control is active. | [optional] 
...
`func (o *ReservationInfoType) GetBackToBack() bool`

GetBackToBack returns the BackToBack field if non-nil, zero value otherwise.

### GetBackToBackOk

`func (o *ReservationInfoType) GetBackToBackOk() (*bool, bool)`
...
`func (o *ReservationInfoType) SetBackToBack(v bool)`

SetBackToBack sets BackToBack field to given value.

### HasBackToBack

`func (o *ReservationInfoType) HasBackToBack() bool`

HasBackToBack returns a boolean if a field has been set.

### GetBackToBackHSKIndicator

`func (o *ReservationInfoType) GetBackToBackHSKIndicator() bool`

GetBackToBackHSKIndicator returns the BackToBackHSKIndicator field if non-nil, zero value otherwise.

### GetBackToBackHSKIndicatorOk

`func (o *ReservationInfoType) GetBackToBackHSKIndicatorOk() (*bool, bool)`

GetBackToBackHSKIndicatorOk returns a tuple with the BackToBackHSKIndicator field if it's non-nil, zero value otherwise
and a boolean to check if the value has been set.

### SetBackToBackHSKIndicator

`func (o *ReservationInfoType) SetBackToBackHSKIndicator(v bool)`

SetBackToBackHSKIndicator sets BackToBackHSKIndicator field to given value.

### HasBackToBackHSKIndicator

`func (o *ReservationInfoType) HasBackToBackHSKIndicator() bool`

HasBackToBackHSKIndicator returns a boolean if a field has been set.
...
`func (o *ReservationInfoType) GetScheduledMoveInRoomId() string`
...
`func (o *ReservationInfoType) GetScheduledMoveInRoomIdOk() (*string, bool)`
...
`func (o *ReservationInfoType) GetScheduledMoveOutRoomIdOk() (*string, bool)`
...
`func (o *ReservationInfoType) SetScheduledMoveOutRoomId(v string)`

SetScheduledMoveOutRoomId sets ScheduledMoveOutRoomId field to given value.

### HasScheduledMoveOutRoomId

`func (o *ReservationInfoType) HasScheduledMoveOutRoomId() bool`
