...
// APIClient manages communication with the OPERA Cloud Housekeeping Service API API v23.2
...
type APIClient struct {
	...
	HousekeepingApi *HousekeepingApiService
...
func NewAPIClient(cfg *Configuration) *APIClient {
	...
	// API Services
	c.HousekeepingApi = (*HousekeepingApiService)(&c.common)
