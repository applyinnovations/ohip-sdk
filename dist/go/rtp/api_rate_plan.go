...
func (r RatePlanAPIGetNegotiatedRatesForGivenProfileRequest) HotelCodes(hotelCodes []string) RatePlanAPIGetNegotiatedRatesForGivenProfileRequest {
	r.hotelCodes = &hotelCodes
	return r
}
...
func (a *RatePlanAPIService) GetNegotiatedRatesForGivenProfileExecute(r RatePlanAPIGetNegotiatedRatesForGivenProfileRequest) (*NegotiatedRates, *http.Response, error) {
	...
	if r.hotelCodes != nil {
		...
		if reflect.TypeOf(t).Kind() == reflect.Slice {
			s := reflect.ValueOf(t)
			for i := 0; i < s.Len(); i++ {
				parameterAddToHeaderOrQuery(localVarQueryParams, "hotelCodes", s.Index(i).Interface(), "multi")
			}
		} else {
			parameterAddToHeaderOrQuery(localVarQueryParams, "hotelCodes", t, "multi")
		}
  }
...
type RatePlanAPISetRatePlanSchedulesRequest struct {
	ctx context.Context
	ApiService *RatePlanAPIService
	ratePlanCode string
	hotelId string
	...
	xAppKey *string
	xHotelid *string
	ratePlanSchedules *RatePlanSchedulesToSet
	xExternalsystem *string
	acceptLanguage *string
}

// Bearer token that needs to be passed which is generated post user authentication
func (r RatePlanAPISetRatePlanSchedulesRequest) Authorization(authorization string) RatePlanAPISetRatePlanSchedulesRequest {
	r.authorization = &authorization
	return r
}

// Client or Partner&#39;s Application Key
func (r RatePlanAPISetRatePlanSchedulesRequest) XAppKey(xAppKey string) RatePlanAPISetRatePlanSchedulesRequest {
	r.xAppKey = &xAppKey
	return r
}

// Mandatory parameter to identify the hotel code where the end user is logged in
func (r RatePlanAPISetRatePlanSchedulesRequest) XHotelid(xHotelid string) RatePlanAPISetRatePlanSchedulesRequest {
	r.xHotelid = &xHotelid
	return r
}

// Request object to set rate plan schedules.
func (r RatePlanAPISetRatePlanSchedulesRequest) RatePlanSchedules(ratePlanSchedules RatePlanSchedulesToSet) RatePlanAPISetRatePlanSchedulesRequest {
	r.ratePlanSchedules = &ratePlanSchedules
	return r
}

// External system code.
func (r RatePlanAPISetRatePlanSchedulesRequest) XExternalsystem(xExternalsystem string) RatePlanAPISetRatePlanSchedulesRequest {
	r.xExternalsystem = &xExternalsystem
	return r
}

// Language code
func (r RatePlanAPISetRatePlanSchedulesRequest) AcceptLanguage(acceptLanguage string) RatePlanAPISetRatePlanSchedulesRequest {
	r.acceptLanguage = &acceptLanguage
	return r
}

func (r RatePlanAPISetRatePlanSchedulesRequest) Execute() (*Status, *http.Response, error) {
	return r.ApiService.SetRatePlanSchedulesExecute(r)
}

/*
SetRatePlanSchedules Set rate plan schedules
...
This API allows you to set Rate Plan schedules. <p><strong>OperationId:</strong>setRatePlanSchedules</p>
 ...
 @param ratePlanCode Rate Plan Code.
 @param hotelId Unique ID that identifies a single hotel property.
 @return RatePlanAPISetRatePlanSchedulesRequest
*/
func (a *RatePlanAPIService) SetRatePlanSchedules(ctx context.Context, ratePlanCode string, hotelId string) RatePlanAPISetRatePlanSchedulesRequest {
	return RatePlanAPISetRatePlanSchedulesRequest{
		ApiService: a,
		ctx: ctx,
		ratePlanCode: ratePlanCode,
...
// Execute executes the request
//  @return Status
func (a *RatePlanAPIService) SetRatePlanSchedulesExecute(r RatePlanAPISetRatePlanSchedulesRequest) (*Status, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPut
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "RatePlanAPIService.SetRatePlanSchedules")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/hotels/{hotelId}/ratePlans/{ratePlanCode}/schedules/set"
	localVarPath = strings.Replace(localVarPath, "{"+"ratePlanCode"+"}", url.PathEscape(parameterValueToString(r.ratePlanCode, "ratePlanCode")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"hotelId"+"}", url.PathEscape(parameterValueToString(r.hotelId, "hotelId")), -1)
...
type RatePlanAPISyncRatePlansRequest struct {
	ctx context.Context
	ApiService *RatePlanAPIService
	hotelId string
	authorization *string
	xAppKey *string
	xHotelid *string
	ratePlansSync *RatePlansSync
	xExternalsystem *string
	acceptLanguage *string
}

// Bearer token that needs to be passed which is generated post user authentication
func (r RatePlanAPISyncRatePlansRequest) Authorization(authorization string) RatePlanAPISyncRatePlansRequest {
	r.authorization = &authorization
	return r
}

// Client or Partner&#39;s Application Key
func (r RatePlanAPISyncRatePlansRequest) XAppKey(xAppKey string) RatePlanAPISyncRatePlansRequest {
	r.xAppKey = &xAppKey
	return r
}

// Mandatory parameter to identify the hotel code where the end user is logged in
func (r RatePlanAPISyncRatePlansRequest) XHotelid(xHotelid string) RatePlanAPISyncRatePlansRequest {
	r.xHotelid = &xHotelid
	return r
}

// Request object to synchronize rate codes.
func (r RatePlanAPISyncRatePlansRequest) RatePlansSync(ratePlansSync RatePlansSync) RatePlanAPISyncRatePlansRequest {
	r.ratePlansSync = &ratePlansSync
	return r
}

// External system code.
func (r RatePlanAPISyncRatePlansRequest) XExternalsystem(xExternalsystem string) RatePlanAPISyncRatePlansRequest {
	r.xExternalsystem = &xExternalsystem
	return r
}

// Language code
func (r RatePlanAPISyncRatePlansRequest) AcceptLanguage(acceptLanguage string) RatePlanAPISyncRatePlansRequest {
	r.acceptLanguage = &acceptLanguage
	return r
}

func (r RatePlanAPISyncRatePlansRequest) Execute() (*Status, *http.Response, error) {
	return r.ApiService.SyncRatePlansExecute(r)
}

/*
SyncRatePlans Synchronizes Rate Plan information including Rate Header and Packages across target properties.

This API updates all requested properties having the same rate code so they have the same rate code attributes.

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param hotelId Unique ID that identifies a single hotel property.
 @return RatePlanAPISyncRatePlansRequest
*/
func (a *RatePlanAPIService) SyncRatePlans(ctx context.Context, hotelId string) RatePlanAPISyncRatePlansRequest {
	return RatePlanAPISyncRatePlansRequest{
		ApiService: a,
		ctx: ctx,
		hotelId: hotelId,
...
// Execute executes the request
//  @return Status
func (a *RatePlanAPIService) SyncRatePlansExecute(r RatePlanAPISyncRatePlansRequest) (*Status, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPut
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "RatePlanAPIService.SyncRatePlans")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/hotels/{hotelId}/ratePlans/sync"
	localVarPath = strings.Replace(localVarPath, "{"+"hotelId"+"}", url.PathEscape(parameterValueToString(r.hotelId, "hotelId")), -1)
	...
	// body params
	localVarPostBody = r.ratePlansSync
	req, err := a.client.prepareRequest(r.ctx, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, formFiles)
	if err != nil {
		return localVarReturnValue, nil, err
	}
