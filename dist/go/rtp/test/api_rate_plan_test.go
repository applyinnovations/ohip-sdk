...
func Test_rtp_RatePlanAPIService(t *testing.T) {
	...
	t.Run("Test RatePlanAPIService SetRatePlanSchedules", func(t *testing.T) {
		...
		resp, httpRes, err := apiClient.RatePlanAPI.SetRatePlanSchedules(context.Background(), ratePlanCode, hotelId).Execute()
	...
	t.Run("Test RatePlanAPIService SyncRatePlans", func(t *testing.T) {

		t.Skip("skip test")  // remove to run test

		var hotelId string

		resp, httpRes, err := apiClient.RatePlanAPI.SyncRatePlans(context.Background(), hotelId).Execute()
