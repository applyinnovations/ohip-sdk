...
**PercentageSavings** | Pointer to **float32** | Percentage savings resulting from accepting upsell offer. This will be calculated as the ratio of the amount saved by accepting the upsell offer to the actual functionSpaceDetails rate (i.e. functionSpaceDetails rate when upsell is not offered) | [optional] 
