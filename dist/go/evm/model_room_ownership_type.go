...
// RoomOwnershipType Define the search criteria for retrieving functionSpaceDetails ownership records
type RoomOwnershipType struct {
	// Contract ID of the functionSpaceDetails ownership record.
	ContractId *int32 `json:"contractId,omitempty"`
	// Contract number for functionSpaceDetails owner.
	ContractNumber *string `json:"contractNumber,omitempty"`
	// Unit for functionSpaceDetails owner.
