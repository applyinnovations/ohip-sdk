...
// APIClient manages communication with the OPERA Cloud Cashiering Outbound API API v22.3
...
type APIClient struct {
	...
	CashieringApi *CashieringApiService
...
func NewAPIClient(cfg *Configuration) *APIClient {
	...
	// API Services
	c.CashieringApi = (*CashieringApiService)(&c.common)
