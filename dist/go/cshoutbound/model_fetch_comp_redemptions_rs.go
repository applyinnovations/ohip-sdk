...
type FetchCompRedemptionsRS struct {
	...
	CompRedemptions []FetchCompRedemptionsRSCompRedemptionType `json:"compRedemptions,omitempty"`
}
...
func (o *FetchCompRedemptionsRS) GetCompRedemptions() []FetchCompRedemptionsRSCompRedemptionType {
	if o == nil || IsNil(o.CompRedemptions) {
		var ret []FetchCompRedemptionsRSCompRedemptionType
		return ret
	}
...
// SetCompRedemptions gets a reference to the given []FetchCompRedemptionsRSCompRedemptionType and assigns it to the CompRedemptions field.
