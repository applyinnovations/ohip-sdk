...
// APIClient manages communication with the OPERA Cloud Integration Configuration API API v23.2
...
type APIClient struct {
	...
	ExternalSystemsConfigApi *ExternalSystemsConfigApiService
...
func NewAPIClient(cfg *Configuration) *APIClient {
	...
	c.ExternalSystemsConfigApi = (*ExternalSystemsConfigApiService)(&c.common)
