...
**FromRoom** | Pointer to **string** | From Room Number | [optional] 
**ToRoom** | Pointer to **string** | To Room Number | [optional] 
**FromLine** | Pointer to **string** | From Line Number | [optional] 
**ToLine** | Pointer to **string** | To Line Number | [optional] 
...
GetToLine returns the ToLine field if non-nil, zero value otherwise.
