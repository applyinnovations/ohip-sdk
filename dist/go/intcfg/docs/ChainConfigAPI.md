...
func main() {
    ...
    templateDeviceLocationsToBeChanged := *openapiclient.NewTemplateDeviceLocationsToBeChanged() // TemplateDeviceLocationsToBeChanged | Request object for changing template Device locations.
 ...
 **templateDeviceLocationsToBeChanged** | [**TemplateDeviceLocationsToBeChanged**](TemplateDeviceLocationsToBeChanged.md) | Request object for changing template Device locations. | 
...
func main() {
    ...
    xAppKey := "xAppKey_example" // string | Client or Partner's Application Key
    xHotelid := "xHotelid_example" // string | Mandatory parameter to identify the hotel code where the end user is logged in
    templateDeviceLocationsCriteria := *openapiclient.NewTemplateDeviceLocationsCriteria() // TemplateDeviceLocationsCriteria | Request object for creating template Device locations.
    xExternalsystem := "xExternalsystem_example" // string | External system code. (optional)
    acceptLanguage := "acceptLanguage_example" // string | Language code (optional)
 ...
 **xAppKey** | **string** | Client or Partner&#39;s Application Key | 
 **xHotelid** | **string** | Mandatory parameter to identify the hotel code where the end user is logged in | 
 **templateDeviceLocationsCriteria** | [**TemplateDeviceLocationsCriteria**](TemplateDeviceLocationsCriteria.md) | Request object for creating template Device locations. | 
 **xExternalsystem** | **string** | External system code. | 
 **acceptLanguage** | **string** | Language code | 
