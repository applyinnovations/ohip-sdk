...
// checks if the PostBookingTypesRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PostBookingTypesRequest{}

// PostBookingTypesRequest struct for PostBookingTypesRequest
type PostBookingTypesRequest struct {
...
func (o PostBookingTypesRequest) MarshalJSON() ([]byte, error) {
...
func (o PostBookingTypesRequest) ToMap() (map[string]interface{}, error) {
...
type NullablePostBookingTypesRequest struct {
	value *PostBookingTypesRequest
	isSet bool
}

func (v NullablePostBookingTypesRequest) Get() *PostBookingTypesRequest {
	return v.value
}

func (v *NullablePostBookingTypesRequest) Set(val *PostBookingTypesRequest) {
	v.value = val
	v.isSet = true
}

func (v NullablePostBookingTypesRequest) IsSet() bool {
	return v.isSet
}

func (v *NullablePostBookingTypesRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePostBookingTypesRequest(val *PostBookingTypesRequest) *NullablePostBookingTypesRequest {
	return &NullablePostBookingTypesRequest{value: val, isSet: true}
}

func (v NullablePostBookingTypesRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePostBookingTypesRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
