...
`func (o *TemplateSourceCodeType) GetCentral() bool`

GetCentral returns the Central field if non-nil, zero value otherwise.

### GetCentralOk

`func (o *TemplateSourceCodeType) GetCentralOk() (*bool, bool)`
...
`func (o *TemplateSourceCodeType) SetCentral(v bool)`

SetCentral sets Central field to given value.

### HasCentral

`func (o *TemplateSourceCodeType) HasCentral() bool`

HasCentral returns a boolean if a field has been set.

### GetManagedBy

`func (o *TemplateSourceCodeType) GetManagedBy() ManagedByOptions`

GetManagedBy returns the ManagedBy field if non-nil, zero value otherwise.

### GetManagedByOk

`func (o *TemplateSourceCodeType) GetManagedByOk() (*ManagedByOptions, bool)`
...
`func (o *TemplateSourceCodeType) SetManagedBy(v ManagedByOptions)`

SetManagedBy sets ManagedBy field to given value.

### HasManagedBy

`func (o *TemplateSourceCodeType) HasManagedBy() bool`
