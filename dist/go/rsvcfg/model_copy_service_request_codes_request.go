...
// checks if the CopyServiceRequestCodesRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CopyServiceRequestCodesRequest{}

// CopyServiceRequestCodesRequest struct for CopyServiceRequestCodesRequest
type CopyServiceRequestCodesRequest struct {
...
func NewCopyServiceRequestCodesRequest() *CopyServiceRequestCodesRequest {
	this := CopyServiceRequestCodesRequest{}
	return &this
}
...
func (o CopyServiceRequestCodesRequest) MarshalJSON() ([]byte, error) {
...
func (o CopyServiceRequestCodesRequest) ToMap() (map[string]interface{}, error) {
...
type NullableCopyServiceRequestCodesRequest struct {
	value *CopyServiceRequestCodesRequest
	isSet bool
}

func (v NullableCopyServiceRequestCodesRequest) Get() *CopyServiceRequestCodesRequest {
	return v.value
}

func (v *NullableCopyServiceRequestCodesRequest) Set(val *CopyServiceRequestCodesRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableCopyServiceRequestCodesRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableCopyServiceRequestCodesRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCopyServiceRequestCodesRequest(val *CopyServiceRequestCodesRequest) *NullableCopyServiceRequestCodesRequest {
	return &NullableCopyServiceRequestCodesRequest{value: val, isSet: true}
}

func (v NullableCopyServiceRequestCodesRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCopyServiceRequestCodesRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
