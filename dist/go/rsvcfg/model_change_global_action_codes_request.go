...
// checks if the ChangeGlobalActionCodesRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ChangeGlobalActionCodesRequest{}

// ChangeGlobalActionCodesRequest struct for ChangeGlobalActionCodesRequest
type ChangeGlobalActionCodesRequest struct {
...
func NewChangeGlobalActionCodesRequest() *ChangeGlobalActionCodesRequest {
	this := ChangeGlobalActionCodesRequest{}
	return &this
}
...
func (o ChangeGlobalActionCodesRequest) MarshalJSON() ([]byte, error) {
...
func (o ChangeGlobalActionCodesRequest) ToMap() (map[string]interface{}, error) {
...
type NullableChangeGlobalActionCodesRequest struct {
	value *ChangeGlobalActionCodesRequest
	isSet bool
}

func (v NullableChangeGlobalActionCodesRequest) Get() *ChangeGlobalActionCodesRequest {
	return v.value
}

func (v *NullableChangeGlobalActionCodesRequest) Set(val *ChangeGlobalActionCodesRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableChangeGlobalActionCodesRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableChangeGlobalActionCodesRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableChangeGlobalActionCodesRequest(val *ChangeGlobalActionCodesRequest) *NullableChangeGlobalActionCodesRequest {
	return &NullableChangeGlobalActionCodesRequest{value: val, isSet: true}
}

func (v NullableChangeGlobalActionCodesRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableChangeGlobalActionCodesRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
