...
// checks if the CopyGlobalAlertsRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CopyGlobalAlertsRequest{}

// CopyGlobalAlertsRequest struct for CopyGlobalAlertsRequest
type CopyGlobalAlertsRequest struct {
...
func (o CopyGlobalAlertsRequest) MarshalJSON() ([]byte, error) {
...
func (o CopyGlobalAlertsRequest) ToMap() (map[string]interface{}, error) {
...
type NullableCopyGlobalAlertsRequest struct {
	value *CopyGlobalAlertsRequest
	isSet bool
}

func (v NullableCopyGlobalAlertsRequest) Get() *CopyGlobalAlertsRequest {
	return v.value
}

func (v *NullableCopyGlobalAlertsRequest) Set(val *CopyGlobalAlertsRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableCopyGlobalAlertsRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableCopyGlobalAlertsRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCopyGlobalAlertsRequest(val *CopyGlobalAlertsRequest) *NullableCopyGlobalAlertsRequest {
	return &NullableCopyGlobalAlertsRequest{value: val, isSet: true}
}

func (v NullableCopyGlobalAlertsRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCopyGlobalAlertsRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
