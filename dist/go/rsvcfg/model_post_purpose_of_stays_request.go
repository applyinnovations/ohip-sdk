...
// checks if the PostPurposeOfStaysRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PostPurposeOfStaysRequest{}

// PostPurposeOfStaysRequest struct for PostPurposeOfStaysRequest
type PostPurposeOfStaysRequest struct {
...
func NewPostPurposeOfStaysRequest() *PostPurposeOfStaysRequest {
	this := PostPurposeOfStaysRequest{}
	return &this
}
...
func (o PostPurposeOfStaysRequest) MarshalJSON() ([]byte, error) {
...
func (o PostPurposeOfStaysRequest) ToMap() (map[string]interface{}, error) {
...
type NullablePostPurposeOfStaysRequest struct {
	value *PostPurposeOfStaysRequest
	isSet bool
}

func (v NullablePostPurposeOfStaysRequest) Get() *PostPurposeOfStaysRequest {
	return v.value
}

func (v *NullablePostPurposeOfStaysRequest) Set(val *PostPurposeOfStaysRequest) {
	v.value = val
	v.isSet = true
}

func (v NullablePostPurposeOfStaysRequest) IsSet() bool {
	return v.isSet
}

func (v *NullablePostPurposeOfStaysRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePostPurposeOfStaysRequest(val *PostPurposeOfStaysRequest) *NullablePostPurposeOfStaysRequest {
	return &NullablePostPurposeOfStaysRequest{value: val, isSet: true}
}

func (v NullablePostPurposeOfStaysRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePostPurposeOfStaysRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
