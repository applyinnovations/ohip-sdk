 ...
 */
export declare function instanceOfDailyRatePlanSchedules(value: object): boolean;
export declare function DailyRatePlanSchedulesFromJSON(json: any): DailyRatePlanSchedules;
export declare function DailyRatePlanSchedulesFromJSONTyped(json: any, ignoreDiscriminator: boolean): DailyRatePlanSchedules;
export declare function DailyRatePlanSchedulesToJSON(value?: DailyRatePlanSchedules | null): any;
