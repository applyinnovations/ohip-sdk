...
export declare class AccountsReceivablesApi extends runtime.BaseAPI {
     ...
     */
    deleteAccountsReceivableServiceCacheRaw(requestParameters: DeleteAccountsReceivableServiceCacheRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Status>>;
    /**
     * This API facilitates clearing of cache in account receivable services. <p><strong>OperationId:</strong>deleteAccountsReceivableServiceCache</p>
     * Clears service level cache
     */
    deleteAccountsReceivableServiceCache(requestParameters: DeleteAccountsReceivableServiceCacheRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Status>;
    /**
     ...
     */
    pingAccountsReceivableServiceRaw(requestParameters: PingAccountsReceivableServiceRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<OperaVersion>>;
    /**
     * Use this API to check account receivable service status. <p><strong>OperationId:</strong>pingAccountsReceivableService</p>
     * Check account receivable service status
     */
    pingAccountsReceivableService(requestParameters: PingAccountsReceivableServiceRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<OperaVersion>;
    /**
