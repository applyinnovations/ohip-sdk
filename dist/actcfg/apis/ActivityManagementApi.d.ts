...
export declare class ActivityManagementApi extends runtime.BaseAPI {
     ...
     */
    deleteActivityManagementServicesCacheRaw(requestParameters: DeleteActivityManagementServicesCacheRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Status>>;
    /**
     *  <p><strong>OperationId:</strong>deleteActivityManagementServicesCache</p>
     * Operation to clear cache.
     */
    deleteActivityManagementServicesCache(requestParameters: DeleteActivityManagementServicesCacheRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Status>;
    /**
     ...
     * Operation to ping.
     */
    pingActivityManagementServicesRaw(requestParameters: PingActivityManagementServicesRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<OperaVersion>>;
    /**
     *  <p><strong>OperationId:</strong>pingActivityManagementServices</p>
     * Operation to ping.
     */
    pingActivityManagementServices(requestParameters: PingActivityManagementServicesRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<OperaVersion>;
    /**
