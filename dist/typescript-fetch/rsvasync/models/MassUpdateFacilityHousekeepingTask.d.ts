 ...
 */
export declare function instanceOfMassUpdateFacilityHousekeepingTask(value: object): boolean;
export declare function MassUpdateFacilityHousekeepingTaskFromJSON(json: any): MassUpdateFacilityHousekeepingTask;
export declare function MassUpdateFacilityHousekeepingTaskFromJSONTyped(json: any, ignoreDiscriminator: boolean): MassUpdateFacilityHousekeepingTask;
export declare function MassUpdateFacilityHousekeepingTaskToJSON(value?: MassUpdateFacilityHousekeepingTask | null): any;
