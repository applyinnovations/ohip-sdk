 ...
 */
export declare function instanceOfReservationDetailsMassUpdateCriteria(value: object): boolean;
export declare function ReservationDetailsMassUpdateCriteriaFromJSON(json: any): ReservationDetailsMassUpdateCriteria;
export declare function ReservationDetailsMassUpdateCriteriaFromJSONTyped(json: any, ignoreDiscriminator: boolean): ReservationDetailsMassUpdateCriteria;
export declare function ReservationDetailsMassUpdateCriteriaToJSON(value?: ReservationDetailsMassUpdateCriteria | null): any;
