 ...
 */
export function instanceOfChannelSellLimitScheduleType(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function ChannelSellLimitScheduleTypeFromJSON(json: any): ChannelSellLimitScheduleType {
    return ChannelSellLimitScheduleTypeFromJSONTyped(json, false);
}

export function ChannelSellLimitScheduleTypeFromJSONTyped(json: any, ignoreDiscriminator: boolean): ChannelSellLimitScheduleType {
    ...
    return {
        ...
        'sellLimitId': !exists(json, 'sellLimitId') ? undefined : UniqueIDTypeFromJSON(json['sellLimitId']),
    };
}

export function ChannelSellLimitScheduleTypeToJSON(value?: ChannelSellLimitScheduleType | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'sellLimitId': UniqueIDTypeToJSON(value.sellLimitId),
    };
}
