 ...
 * 
 * @export
 * @interface CopyChannelAccountContractsRequest
 */
export interface CopyChannelAccountContractsRequest {
     ...
     * @memberof CopyChannelAccountContractsRequest
     */
 ...
 */
export function instanceOfCopyChannelAccountContractsRequest(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function CopyChannelAccountContractsRequestFromJSON(json: any): CopyChannelAccountContractsRequest {
    return CopyChannelAccountContractsRequestFromJSONTyped(json, false);
}

export function CopyChannelAccountContractsRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): CopyChannelAccountContractsRequest {
...
export function CopyChannelAccountContractsRequestToJSON(value?: CopyChannelAccountContractsRequest | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
