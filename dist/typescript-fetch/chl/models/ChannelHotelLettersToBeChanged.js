 ...
 */
function instanceOfChannelHotelLettersToBeChanged(value) {
    let isInstance = true;
    return isInstance;
}
exports.instanceOfChannelHotelLettersToBeChanged = instanceOfChannelHotelLettersToBeChanged;
function ChannelHotelLettersToBeChangedFromJSON(json) {
    return ChannelHotelLettersToBeChangedFromJSONTyped(json, false);
}
exports.ChannelHotelLettersToBeChangedFromJSON = ChannelHotelLettersToBeChangedFromJSON;
function ChannelHotelLettersToBeChangedFromJSONTyped(json, ignoreDiscriminator) {
...
function ChannelHotelLettersToBeChangedToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
