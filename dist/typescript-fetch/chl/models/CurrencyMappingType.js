...
exports.CurrencyMappingTypeToJSON = exports.CurrencyMappingTypeFromJSONTyped = exports.CurrencyMappingTypeFromJSON = exports.instanceOfCurrencyMappingType = void 0;
 ...
 */
function instanceOfCurrencyMappingType(value) {
    let isInstance = true;
    return isInstance;
}
exports.instanceOfCurrencyMappingType = instanceOfCurrencyMappingType;
function CurrencyMappingTypeFromJSON(json) {
    return CurrencyMappingTypeFromJSONTyped(json, false);
}
exports.CurrencyMappingTypeFromJSON = CurrencyMappingTypeFromJSON;
function CurrencyMappingTypeFromJSONTyped(json, ignoreDiscriminator) {
    ...
    return {
        ...
        'lanyonDecimalPosition': !(0, runtime_1.exists)(json, 'lanyonDecimalPosition') ? undefined : json['lanyonDecimalPosition'],
        'channelDecimalPosition': !(0, runtime_1.exists)(json, 'channelDecimalPosition') ? undefined : json['channelDecimalPosition'],
    };
}
exports.CurrencyMappingTypeFromJSONTyped = CurrencyMappingTypeFromJSONTyped;
function CurrencyMappingTypeToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
...
exports.CurrencyMappingTypeToJSON = CurrencyMappingTypeToJSON;
