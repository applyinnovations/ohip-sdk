 ...
 */
export function instanceOfChannelAccountContactTypeEmails(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function ChannelAccountContactTypeEmailsFromJSON(json: any): ChannelAccountContactTypeEmails {
    return ChannelAccountContactTypeEmailsFromJSONTyped(json, false);
}

export function ChannelAccountContactTypeEmailsFromJSONTyped(json: any, ignoreDiscriminator: boolean): ChannelAccountContactTypeEmails {
...
export function ChannelAccountContactTypeEmailsToJSON(value?: ChannelAccountContactTypeEmails | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
