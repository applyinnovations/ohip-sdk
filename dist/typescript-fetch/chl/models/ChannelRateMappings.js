...
exports.ChannelRateMappingsToJSON = exports.ChannelRateMappingsFromJSONTyped = exports.ChannelRateMappingsFromJSON = exports.instanceOfChannelRateMappings = void 0;
 ...
 */
function instanceOfChannelRateMappings(value) {
    let isInstance = true;
    return isInstance;
}
exports.instanceOfChannelRateMappings = instanceOfChannelRateMappings;
function ChannelRateMappingsFromJSON(json) {
    return ChannelRateMappingsFromJSONTyped(json, false);
}
exports.ChannelRateMappingsFromJSON = ChannelRateMappingsFromJSON;
function ChannelRateMappingsFromJSONTyped(json, ignoreDiscriminator) {
...
function ChannelRateMappingsToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
