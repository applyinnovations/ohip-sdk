 ...
 */
function instanceOfChannelAccountContractsCopy(value) {
    let isInstance = true;
    return isInstance;
}
exports.instanceOfChannelAccountContractsCopy = instanceOfChannelAccountContractsCopy;
function ChannelAccountContractsCopyFromJSON(json) {
    return ChannelAccountContractsCopyFromJSONTyped(json, false);
}
exports.ChannelAccountContractsCopyFromJSON = ChannelAccountContractsCopyFromJSON;
function ChannelAccountContractsCopyFromJSONTyped(json, ignoreDiscriminator) {
...
function ChannelAccountContractsCopyToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
