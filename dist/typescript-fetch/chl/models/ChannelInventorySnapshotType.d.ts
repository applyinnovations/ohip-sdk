 ...
 */
export declare function instanceOfChannelInventorySnapshotType(value: object): boolean;
export declare function ChannelInventorySnapshotTypeFromJSON(json: any): ChannelInventorySnapshotType;
export declare function ChannelInventorySnapshotTypeFromJSONTyped(json: any, ignoreDiscriminator: boolean): ChannelInventorySnapshotType;
export declare function ChannelInventorySnapshotTypeToJSON(value?: ChannelInventorySnapshotType | null): any;
