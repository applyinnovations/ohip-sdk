 ...
 */
function instanceOfChannelRateCategories(value) {
    let isInstance = true;
    return isInstance;
}
exports.instanceOfChannelRateCategories = instanceOfChannelRateCategories;
function ChannelRateCategoriesFromJSON(json) {
    return ChannelRateCategoriesFromJSONTyped(json, false);
}
exports.ChannelRateCategoriesFromJSON = ChannelRateCategoriesFromJSON;
function ChannelRateCategoriesFromJSONTyped(json, ignoreDiscriminator) {
...
function ChannelRateCategoriesToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
