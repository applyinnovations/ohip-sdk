 ...
 */
export declare function instanceOfChannelAccountContractsCopy(value: object): boolean;
export declare function ChannelAccountContractsCopyFromJSON(json: any): ChannelAccountContractsCopy;
export declare function ChannelAccountContractsCopyFromJSONTyped(json: any, ignoreDiscriminator: boolean): ChannelAccountContractsCopy;
export declare function ChannelAccountContractsCopyToJSON(value?: ChannelAccountContractsCopy | null): any;
