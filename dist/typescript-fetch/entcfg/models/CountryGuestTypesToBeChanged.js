 ...
 */
function instanceOfCountryGuestTypesToBeChanged(value) {
    let isInstance = true;
    return isInstance;
}
exports.instanceOfCountryGuestTypesToBeChanged = instanceOfCountryGuestTypesToBeChanged;
function CountryGuestTypesToBeChangedFromJSON(json) {
    return CountryGuestTypesToBeChangedFromJSONTyped(json, false);
}
exports.CountryGuestTypesToBeChangedFromJSON = CountryGuestTypesToBeChangedFromJSON;
function CountryGuestTypesToBeChangedFromJSONTyped(json, ignoreDiscriminator) {
...
function CountryGuestTypesToBeChangedToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
