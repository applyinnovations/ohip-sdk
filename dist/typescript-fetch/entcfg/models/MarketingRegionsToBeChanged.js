 ...
 */
function instanceOfMarketingRegionsToBeChanged(value) {
    let isInstance = true;
    return isInstance;
}
exports.instanceOfMarketingRegionsToBeChanged = instanceOfMarketingRegionsToBeChanged;
function MarketingRegionsToBeChangedFromJSON(json) {
    return MarketingRegionsToBeChangedFromJSONTyped(json, false);
}
exports.MarketingRegionsToBeChangedFromJSON = MarketingRegionsToBeChangedFromJSON;
function MarketingRegionsToBeChangedFromJSONTyped(json, ignoreDiscriminator) {
...
function MarketingRegionsToBeChangedToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
