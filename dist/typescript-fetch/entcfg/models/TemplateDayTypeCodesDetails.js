 ...
 */
function instanceOfTemplateDayTypeCodesDetails(value) {
    let isInstance = true;
    return isInstance;
}
exports.instanceOfTemplateDayTypeCodesDetails = instanceOfTemplateDayTypeCodesDetails;
function TemplateDayTypeCodesDetailsFromJSON(json) {
    return TemplateDayTypeCodesDetailsFromJSONTyped(json, false);
}
exports.TemplateDayTypeCodesDetailsFromJSON = TemplateDayTypeCodesDetailsFromJSON;
function TemplateDayTypeCodesDetailsFromJSONTyped(json, ignoreDiscriminator) {
...
function TemplateDayTypeCodesDetailsToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
