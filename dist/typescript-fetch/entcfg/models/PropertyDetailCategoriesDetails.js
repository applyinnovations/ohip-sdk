 ...
 */
function instanceOfPropertyDetailCategoriesDetails(value) {
    let isInstance = true;
    return isInstance;
}
exports.instanceOfPropertyDetailCategoriesDetails = instanceOfPropertyDetailCategoriesDetails;
function PropertyDetailCategoriesDetailsFromJSON(json) {
    return PropertyDetailCategoriesDetailsFromJSONTyped(json, false);
}
exports.PropertyDetailCategoriesDetailsFromJSON = PropertyDetailCategoriesDetailsFromJSON;
function PropertyDetailCategoriesDetailsFromJSONTyped(json, ignoreDiscriminator) {
...
function PropertyDetailCategoriesDetailsToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
