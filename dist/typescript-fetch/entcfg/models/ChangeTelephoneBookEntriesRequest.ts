 ...
 * 
 * @export
 * @interface ChangeTelephoneBookEntriesRequest
 */
export interface ChangeTelephoneBookEntriesRequest {
    /**
     * 
     * @type {Array<InstanceLink>}
     * @memberof ChangeTelephoneBookEntriesRequest
     */
 ...
 */
export function instanceOfChangeTelephoneBookEntriesRequest(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function ChangeTelephoneBookEntriesRequestFromJSON(json: any): ChangeTelephoneBookEntriesRequest {
    return ChangeTelephoneBookEntriesRequestFromJSONTyped(json, false);
}

export function ChangeTelephoneBookEntriesRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): ChangeTelephoneBookEntriesRequest {
...
export function ChangeTelephoneBookEntriesRequestToJSON(value?: ChangeTelephoneBookEntriesRequest | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
