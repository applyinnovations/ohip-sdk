 ...
 */
function instanceOfCorporateBusinessUnitsCriteria(value) {
    let isInstance = true;
    return isInstance;
}
exports.instanceOfCorporateBusinessUnitsCriteria = instanceOfCorporateBusinessUnitsCriteria;
function CorporateBusinessUnitsCriteriaFromJSON(json) {
    return CorporateBusinessUnitsCriteriaFromJSONTyped(json, false);
}
exports.CorporateBusinessUnitsCriteriaFromJSON = CorporateBusinessUnitsCriteriaFromJSON;
function CorporateBusinessUnitsCriteriaFromJSONTyped(json, ignoreDiscriminator) {
...
function CorporateBusinessUnitsCriteriaToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
