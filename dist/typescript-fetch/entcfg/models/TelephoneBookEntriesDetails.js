 ...
 */
function instanceOfTelephoneBookEntriesDetails(value) {
    let isInstance = true;
    return isInstance;
}
exports.instanceOfTelephoneBookEntriesDetails = instanceOfTelephoneBookEntriesDetails;
function TelephoneBookEntriesDetailsFromJSON(json) {
    return TelephoneBookEntriesDetailsFromJSONTyped(json, false);
}
exports.TelephoneBookEntriesDetailsFromJSON = TelephoneBookEntriesDetailsFromJSON;
function TelephoneBookEntriesDetailsFromJSONTyped(json, ignoreDiscriminator) {
...
function TelephoneBookEntriesDetailsToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
