 ...
 */
export function instanceOfChangeJobTitlesRequest(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function ChangeJobTitlesRequestFromJSON(json: any): ChangeJobTitlesRequest {
    return ChangeJobTitlesRequestFromJSONTyped(json, false);
}

export function ChangeJobTitlesRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): ChangeJobTitlesRequest {
...
export function ChangeJobTitlesRequestToJSON(value?: ChangeJobTitlesRequest | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
