 ...
 */
export declare function instanceOfHotelConferenceFacilitiesType(value: object): boolean;
export declare function HotelConferenceFacilitiesTypeFromJSON(json: any): HotelConferenceFacilitiesType;
export declare function HotelConferenceFacilitiesTypeFromJSONTyped(json: any, ignoreDiscriminator: boolean): HotelConferenceFacilitiesType;
export declare function HotelConferenceFacilitiesTypeToJSON(value?: HotelConferenceFacilitiesType | null): any;
