 ...
 */
function instanceOfTemplateJobTitlesDetails(value) {
    let isInstance = true;
    return isInstance;
}
exports.instanceOfTemplateJobTitlesDetails = instanceOfTemplateJobTitlesDetails;
function TemplateJobTitlesDetailsFromJSON(json) {
    return TemplateJobTitlesDetailsFromJSONTyped(json, false);
}
exports.TemplateJobTitlesDetailsFromJSON = TemplateJobTitlesDetailsFromJSON;
function TemplateJobTitlesDetailsFromJSONTyped(json, ignoreDiscriminator) {
...
function TemplateJobTitlesDetailsToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
