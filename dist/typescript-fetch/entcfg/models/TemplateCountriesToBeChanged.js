 ...
 */
function instanceOfTemplateCountriesToBeChanged(value) {
    let isInstance = true;
    return isInstance;
}
exports.instanceOfTemplateCountriesToBeChanged = instanceOfTemplateCountriesToBeChanged;
function TemplateCountriesToBeChangedFromJSON(json) {
    return TemplateCountriesToBeChangedFromJSONTyped(json, false);
}
exports.TemplateCountriesToBeChangedFromJSON = TemplateCountriesToBeChangedFromJSON;
function TemplateCountriesToBeChangedFromJSONTyped(json, ignoreDiscriminator) {
...
function TemplateCountriesToBeChangedToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
