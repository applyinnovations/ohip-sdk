 ...
 */
function instanceOfTemplateHotelDetailsToBeChanged(value) {
    let isInstance = true;
    return isInstance;
}
exports.instanceOfTemplateHotelDetailsToBeChanged = instanceOfTemplateHotelDetailsToBeChanged;
function TemplateHotelDetailsToBeChangedFromJSON(json) {
    return TemplateHotelDetailsToBeChangedFromJSONTyped(json, false);
}
exports.TemplateHotelDetailsToBeChangedFromJSON = TemplateHotelDetailsToBeChangedFromJSON;
function TemplateHotelDetailsToBeChangedFromJSONTyped(json, ignoreDiscriminator) {
...
function TemplateHotelDetailsToBeChangedToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
