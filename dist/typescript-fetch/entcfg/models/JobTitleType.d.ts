 ...
 */
export declare function instanceOfJobTitleType(value: object): boolean;
export declare function JobTitleTypeFromJSON(json: any): JobTitleType;
export declare function JobTitleTypeFromJSONTyped(json: any, ignoreDiscriminator: boolean): JobTitleType;
export declare function JobTitleTypeToJSON(value?: JobTitleType | null): any;
