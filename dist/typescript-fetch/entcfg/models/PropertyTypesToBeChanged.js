 ...
 */
function instanceOfPropertyTypesToBeChanged(value) {
    let isInstance = true;
    return isInstance;
}
exports.instanceOfPropertyTypesToBeChanged = instanceOfPropertyTypesToBeChanged;
function PropertyTypesToBeChangedFromJSON(json) {
    return PropertyTypesToBeChangedFromJSONTyped(json, false);
}
exports.PropertyTypesToBeChangedFromJSON = PropertyTypesToBeChangedFromJSON;
function PropertyTypesToBeChangedFromJSONTyped(json, ignoreDiscriminator) {
...
function PropertyTypesToBeChangedToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
