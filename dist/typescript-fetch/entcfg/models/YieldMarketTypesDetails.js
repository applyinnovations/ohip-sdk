 ...
 */
function instanceOfYieldMarketTypesDetails(value) {
    let isInstance = true;
    return isInstance;
}
exports.instanceOfYieldMarketTypesDetails = instanceOfYieldMarketTypesDetails;
function YieldMarketTypesDetailsFromJSON(json) {
    return YieldMarketTypesDetailsFromJSONTyped(json, false);
}
exports.YieldMarketTypesDetailsFromJSON = YieldMarketTypesDetailsFromJSON;
function YieldMarketTypesDetailsFromJSONTyped(json, ignoreDiscriminator) {
...
function YieldMarketTypesDetailsToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
