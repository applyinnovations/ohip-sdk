 ...
 */
function instanceOfYieldCategoriesDetails(value) {
    let isInstance = true;
    return isInstance;
}
exports.instanceOfYieldCategoriesDetails = instanceOfYieldCategoriesDetails;
function YieldCategoriesDetailsFromJSON(json) {
    return YieldCategoriesDetailsFromJSONTyped(json, false);
}
exports.YieldCategoriesDetailsFromJSON = YieldCategoriesDetailsFromJSON;
function YieldCategoriesDetailsFromJSONTyped(json, ignoreDiscriminator) {
...
function YieldCategoriesDetailsToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
