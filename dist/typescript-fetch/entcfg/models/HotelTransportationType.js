...
exports.HotelTransportationTypeToJSON = exports.HotelTransportationTypeFromJSONTyped = exports.HotelTransportationTypeFromJSON = exports.instanceOfHotelTransportationType = void 0;
 ...
 */
function instanceOfHotelTransportationType(value) {
    let isInstance = true;
    return isInstance;
}
exports.instanceOfHotelTransportationType = instanceOfHotelTransportationType;
function HotelTransportationTypeFromJSON(json) {
    return HotelTransportationTypeFromJSONTyped(json, false);
}
exports.HotelTransportationTypeFromJSON = HotelTransportationTypeFromJSON;
function HotelTransportationTypeFromJSONTyped(json, ignoreDiscriminator) {
...
exports.HotelTransportationTypeFromJSONTyped = HotelTransportationTypeFromJSONTyped;
function HotelTransportationTypeToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
...
exports.HotelTransportationTypeToJSON = HotelTransportationTypeToJSON;
