...
exports.HotelAttractionTypeToJSON = exports.HotelAttractionTypeFromJSONTyped = exports.HotelAttractionTypeFromJSON = exports.instanceOfHotelAttractionType = void 0;
 ...
 */
function instanceOfHotelAttractionType(value) {
    let isInstance = true;
    return isInstance;
}
exports.instanceOfHotelAttractionType = instanceOfHotelAttractionType;
function HotelAttractionTypeFromJSON(json) {
    return HotelAttractionTypeFromJSONTyped(json, false);
}
exports.HotelAttractionTypeFromJSON = HotelAttractionTypeFromJSON;
function HotelAttractionTypeFromJSONTyped(json, ignoreDiscriminator) {
...
exports.HotelAttractionTypeFromJSONTyped = HotelAttractionTypeFromJSONTyped;
function HotelAttractionTypeToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
...
exports.HotelAttractionTypeToJSON = HotelAttractionTypeToJSON;
