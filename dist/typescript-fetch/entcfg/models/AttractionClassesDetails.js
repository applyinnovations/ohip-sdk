 ...
 */
function instanceOfAttractionClassesDetails(value) {
    let isInstance = true;
    return isInstance;
}
exports.instanceOfAttractionClassesDetails = instanceOfAttractionClassesDetails;
function AttractionClassesDetailsFromJSON(json) {
    return AttractionClassesDetailsFromJSONTyped(json, false);
}
exports.AttractionClassesDetailsFromJSON = AttractionClassesDetailsFromJSON;
function AttractionClassesDetailsFromJSONTyped(json, ignoreDiscriminator) {
...
function AttractionClassesDetailsToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
