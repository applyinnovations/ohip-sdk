 ...
 */
export function instanceOfCountryGuestTypesToBeChanged(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function CountryGuestTypesToBeChangedFromJSON(json: any): CountryGuestTypesToBeChanged {
    return CountryGuestTypesToBeChangedFromJSONTyped(json, false);
}

export function CountryGuestTypesToBeChangedFromJSONTyped(json: any, ignoreDiscriminator: boolean): CountryGuestTypesToBeChanged {
...
export function CountryGuestTypesToBeChangedToJSON(value?: CountryGuestTypesToBeChanged | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
