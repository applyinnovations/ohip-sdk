...
exports.AttractionCodeTypeToJSON = exports.AttractionCodeTypeFromJSONTyped = exports.AttractionCodeTypeFromJSON = exports.instanceOfAttractionCodeType = void 0;
 ...
 */
function instanceOfAttractionCodeType(value) {
    let isInstance = true;
    return isInstance;
}
exports.instanceOfAttractionCodeType = instanceOfAttractionCodeType;
function AttractionCodeTypeFromJSON(json) {
    return AttractionCodeTypeFromJSONTyped(json, false);
}
exports.AttractionCodeTypeFromJSON = AttractionCodeTypeFromJSON;
function AttractionCodeTypeFromJSONTyped(json, ignoreDiscriminator) {
...
exports.AttractionCodeTypeFromJSONTyped = AttractionCodeTypeFromJSONTyped;
function AttractionCodeTypeToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
...
exports.AttractionCodeTypeToJSON = AttractionCodeTypeToJSON;
