 ...
 */
function instanceOfTransportationCriteria(value) {
    let isInstance = true;
    return isInstance;
}
exports.instanceOfTransportationCriteria = instanceOfTransportationCriteria;
function TransportationCriteriaFromJSON(json) {
    return TransportationCriteriaFromJSONTyped(json, false);
}
exports.TransportationCriteriaFromJSON = TransportationCriteriaFromJSON;
function TransportationCriteriaFromJSONTyped(json, ignoreDiscriminator) {
...
function TransportationCriteriaToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
