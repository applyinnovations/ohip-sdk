 ...
 */
export function instanceOfAttractionsDetails(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function AttractionsDetailsFromJSON(json: any): AttractionsDetails {
    return AttractionsDetailsFromJSONTyped(json, false);
}

export function AttractionsDetailsFromJSONTyped(json: any, ignoreDiscriminator: boolean): AttractionsDetails {
...
export function AttractionsDetailsToJSON(value?: AttractionsDetails | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
