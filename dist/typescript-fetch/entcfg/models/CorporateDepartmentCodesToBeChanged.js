 ...
 */
function instanceOfCorporateDepartmentCodesToBeChanged(value) {
    let isInstance = true;
    return isInstance;
}
exports.instanceOfCorporateDepartmentCodesToBeChanged = instanceOfCorporateDepartmentCodesToBeChanged;
function CorporateDepartmentCodesToBeChangedFromJSON(json) {
    return CorporateDepartmentCodesToBeChangedFromJSONTyped(json, false);
}
exports.CorporateDepartmentCodesToBeChangedFromJSON = CorporateDepartmentCodesToBeChangedFromJSON;
function CorporateDepartmentCodesToBeChangedFromJSONTyped(json, ignoreDiscriminator) {
...
function CorporateDepartmentCodesToBeChangedToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
