...
exports.HotelBrochureTypeAddressToJSON = exports.HotelBrochureTypeAddressFromJSONTyped = exports.HotelBrochureTypeAddressFromJSON = exports.instanceOfHotelBrochureTypeAddress = void 0;
const runtime_1 = require("../runtime");
const CountryNameType_1 = require("./CountryNameType");
/**
 * Check if a given object implements the HotelBrochureTypeAddress interface.
 */
function instanceOfHotelBrochureTypeAddress(value) {
    let isInstance = true;
    return isInstance;
}
exports.instanceOfHotelBrochureTypeAddress = instanceOfHotelBrochureTypeAddress;
function HotelBrochureTypeAddressFromJSON(json) {
    return HotelBrochureTypeAddressFromJSONTyped(json, false);
}
exports.HotelBrochureTypeAddressFromJSON = HotelBrochureTypeAddressFromJSON;
function HotelBrochureTypeAddressFromJSONTyped(json, ignoreDiscriminator) {
...
exports.HotelBrochureTypeAddressFromJSONTyped = HotelBrochureTypeAddressFromJSONTyped;
function HotelBrochureTypeAddressToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
...
exports.HotelBrochureTypeAddressToJSON = HotelBrochureTypeAddressToJSON;
