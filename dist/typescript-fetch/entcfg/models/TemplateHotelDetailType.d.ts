 ...
 */
export declare function instanceOfTemplateHotelDetailType(value: object): boolean;
export declare function TemplateHotelDetailTypeFromJSON(json: any): TemplateHotelDetailType;
export declare function TemplateHotelDetailTypeFromJSONTyped(json: any, ignoreDiscriminator: boolean): TemplateHotelDetailType;
export declare function TemplateHotelDetailTypeToJSON(value?: TemplateHotelDetailType | null): any;
