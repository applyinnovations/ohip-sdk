 ...
 */
function instanceOfCommunicationMethodsEntDetailsToBeChanged(value) {
    let isInstance = true;
    return isInstance;
}
exports.instanceOfCommunicationMethodsEntDetailsToBeChanged = instanceOfCommunicationMethodsEntDetailsToBeChanged;
function CommunicationMethodsEntDetailsToBeChangedFromJSON(json) {
    return CommunicationMethodsEntDetailsToBeChangedFromJSONTyped(json, false);
}
exports.CommunicationMethodsEntDetailsToBeChangedFromJSON = CommunicationMethodsEntDetailsToBeChangedFromJSON;
function CommunicationMethodsEntDetailsToBeChangedFromJSONTyped(json, ignoreDiscriminator) {
...
function CommunicationMethodsEntDetailsToBeChangedToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
