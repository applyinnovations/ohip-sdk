 ...
 */
export declare function instanceOfAmenitiesToBeChanged(value: object): boolean;
export declare function AmenitiesToBeChangedFromJSON(json: any): AmenitiesToBeChanged;
export declare function AmenitiesToBeChangedFromJSONTyped(json: any, ignoreDiscriminator: boolean): AmenitiesToBeChanged;
export declare function AmenitiesToBeChangedToJSON(value?: AmenitiesToBeChanged | null): any;
