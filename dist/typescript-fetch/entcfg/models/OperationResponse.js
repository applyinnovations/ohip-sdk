...
exports.OperationResponseToJSON = exports.OperationResponseFromJSONTyped = exports.OperationResponseFromJSON = exports.instanceOfOperationResponse = void 0;
 ...
 */
function instanceOfOperationResponse(value) {
    let isInstance = true;
    return isInstance;
}
exports.instanceOfOperationResponse = instanceOfOperationResponse;
...
function OperationResponseFromJSONTyped(json, ignoreDiscriminator) {
    ...
    return {
        'configs': !(0, runtime_1.exists)(json, 'configs') ? undefined : (json['configs'].map(Operation_1.OperationFromJSON)),
...
function OperationResponseToJSON(value) {
    ...
    return {
        'configs': value.configs === undefined ? undefined : (value.configs.map(Operation_1.OperationToJSON)),
