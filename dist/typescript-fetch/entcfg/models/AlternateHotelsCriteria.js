 ...
 */
function instanceOfAlternateHotelsCriteria(value) {
    let isInstance = true;
    return isInstance;
}
exports.instanceOfAlternateHotelsCriteria = instanceOfAlternateHotelsCriteria;
function AlternateHotelsCriteriaFromJSON(json) {
    return AlternateHotelsCriteriaFromJSONTyped(json, false);
}
exports.AlternateHotelsCriteriaFromJSON = AlternateHotelsCriteriaFromJSON;
function AlternateHotelsCriteriaFromJSONTyped(json, ignoreDiscriminator) {
...
function AlternateHotelsCriteriaToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
