...
exports.GetYieldAdjustmentCodesTypeEnum = exports.GetPropertyCalendarFetchInstructionsEnum = exports.GetHotelsFetchInstructionsEnum = exports.GetHotelCalendarFetchInstructionsEnum = exports.GetHotelBrochureFetchInstructionsEnum = exports.GetHotelFetchInstructionsEnum = exports.GetCurrencyExchangeRatesExchangeTypeEnum = exports.GetConfigActivityLogModuleEnum = exports.HotelConfigApi = void 0;
...
class HotelConfigApi extends runtime.BaseAPI {
     ...
     */
    changeCentralConfigRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            if (requestParameters.hotelId === null || requestParameters.hotelId === undefined) {
            ...
            const response = yield this.request({
                ...
                headers: headerParameters,
                query: queryParameters,
                body: (0, index_1.CentralConfigRequestToJSON)(requestParameters.centralConfig),
            }, initOverrides);
            return new runtime.JSONApiResponse(response, (jsonValue) => (0, index_1.StatusFromJSON)(jsonValue));
        });
    }
     ...
     * Change the status for Central Config to manage at Hotel/Enterprise Level.
     */
    changeCentralConfig(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield this.changeCentralConfigRaw(requestParameters, initOverrides);
            return yield response.value();
        });
    }
    /**
     ...
     */
    getCentralConfigRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            if (requestParameters.hotelId === null || requestParameters.hotelId === undefined) {
            ...
            return new runtime.JSONApiResponse(response, (jsonValue) => (0, index_1.CentralConfigsResponseFromJSON)(jsonValue));
        });
    }
    /**
     * This API will get the configuration items added from central within the property for this Configuration. <p><strong>OperationId:</strong>getCentralConfig</p>
     * Lists the configurations managed centrally
     */
    getCentralConfig(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield this.getCentralConfigRaw(requestParameters, initOverrides);
            return yield response.value();
        });
    }
    /**
    ...
    getOperationRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return new runtime.JSONApiResponse(response, (jsonValue) => (0, index_1.OperationResponseFromJSON)(jsonValue));
        });
    }
    /**
     * This API will fetch all the operations wrt a code. <p><strong>OperationId:</strong>getOperation</p>
     ...
     */
    putHotelRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            if (requestParameters.hotelId === null || requestParameters.hotelId === undefined) {
            ...
            const response = yield this.request({
                ...
                headers: headerParameters,
                query: queryParameters,
                body: (0, index_1.HotelToBeChangedToJSON)(requestParameters.hotelToBeChanged),
            }, initOverrides);
            return new runtime.JSONApiResponse(response, (jsonValue) => (0, index_1.StatusFromJSON)(jsonValue));
        });
    }
     ...
     * Update hotel information
     */
    putHotel(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield this.putHotelRaw(requestParameters, initOverrides);
            return yield response.value();
        });
    }
    /**
 ...
 * @export
 */
exports.GetHotelsFetchInstructionsEnum = {
