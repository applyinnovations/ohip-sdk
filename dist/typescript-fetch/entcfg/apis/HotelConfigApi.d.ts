...
export declare class HotelConfigApi extends runtime.BaseAPI {
     ...
     */
    changeCentralConfigRaw(requestParameters: ChangeCentralConfigRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Status>>;
    /**
     * This API will manage if config can be updated from Hotel. <p><strong>OperationId:</strong>changeCentralConfig</p>
     * Change the status for Central Config to manage at Hotel/Enterprise Level.
     */
    changeCentralConfig(requestParameters: ChangeCentralConfigRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Status>;
    /**
     ...
     */
    getCentralConfigRaw(requestParameters: GetCentralConfigRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<CentralConfigsResponse>>;
    /**
     * This API will get the configuration items added from central within the property for this Configuration. <p><strong>OperationId:</strong>getCentralConfig</p>
     * Lists the configurations managed centrally
     */
    getCentralConfig(requestParameters: GetCentralConfigRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<CentralConfigsResponse>;
    /**
     ...
     */
    getOperationRaw(requestParameters: GetOperationRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<OperationResponse>>;
    /**
     * This API will fetch all the operations wrt a code. <p><strong>OperationId:</strong>getOperation</p>
     * Fetch all operations
     */
    getOperation(requestParameters: GetOperationRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<OperationResponse>;
    /**
     ...
     */
    putHotelRaw(requestParameters: PutHotelRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Status>>;
    /**
     * Use this API to update hotel configuration information. <p><strong>OperationId:</strong>putHotel</p>
     * Update hotel information
     */
    putHotel(requestParameters: PutHotelRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Status>;
    /**
 ...
 * @export
 */
export declare const GetHotelsFetchInstructionsEnum: {
    readonly CateringEvent: "CateringEvent";
};
