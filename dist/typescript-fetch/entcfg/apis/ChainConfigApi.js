...
class ChainConfigApi extends runtime.BaseAPI {
     ...
     */
    deleteFlexFieldRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
     ...
     * Operation to delete a flex field.
     */
    deleteFlexField(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield this.deleteFlexFieldRaw(requestParameters, initOverrides);
            return yield response.value();
        });
    }
    /**
     ...
     */
    getFlexFieldRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            if (requestParameters.flexFieldId === null || requestParameters.flexFieldId === undefined) {
            ...
            return new runtime.JSONApiResponse(response, (jsonValue) => (0, index_1.FlexFieldCriteriaFromJSON)(jsonValue));
        });
    }
    /**
     * API to fetch the flex field details.<br><p><strong></strong></p> <p><strong>OperationId:</strong>getFlexField</p>
     * Operation to fetch the flex field details.
     */
    getFlexField(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield this.getFlexFieldRaw(requestParameters, initOverrides);
            return yield response.value();
        });
    }
    /**
     ...
     */
    getFlexFieldsRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            const queryParameters = {};
     ...
     * Operation to fetch flex fields.
     */
    getFlexFields(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield this.getFlexFieldsRaw(requestParameters, initOverrides);
            return yield response.value();
        });
    }
    /**
     ...
     */
    postFlexFieldRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const response = yield this.request({
                ...
                headers: headerParameters,
                query: queryParameters,
                body: (0, index_1.FlexFieldCriteriaToJSON)(requestParameters.flexFieldDetail),
            }, initOverrides);
            return new runtime.JSONApiResponse(response, (jsonValue) => (0, index_1.StatusFromJSON)(jsonValue));
        });
    }
     ...
     * Operation to create a flex field.
     */
    postFlexField(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield this.postFlexFieldRaw(requestParameters, initOverrides);
            return yield response.value();
        });
    }
    /**
     ...
     */
    updateFlexFieldRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            if (requestParameters.flexFieldId === null || requestParameters.flexFieldId === undefined) {
     ...
     * Operation to update flex field.
     */
    updateFlexField(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield this.updateFlexFieldRaw(requestParameters, initOverrides);
            return yield response.value();
        });
    }
}
