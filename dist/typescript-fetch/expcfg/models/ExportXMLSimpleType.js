...
exports.ExportXMLSimpleTypeToJSON = exports.ExportXMLSimpleTypeFromJSONTyped = exports.ExportXMLSimpleTypeFromJSON = exports.instanceOfExportXMLSimpleType = void 0;
 ...
 */
function instanceOfExportXMLSimpleType(value) {
    let isInstance = true;
    return isInstance;
}
exports.instanceOfExportXMLSimpleType = instanceOfExportXMLSimpleType;
function ExportXMLSimpleTypeFromJSON(json) {
    return ExportXMLSimpleTypeFromJSONTyped(json, false);
}
exports.ExportXMLSimpleTypeFromJSON = ExportXMLSimpleTypeFromJSON;
function ExportXMLSimpleTypeFromJSONTyped(json, ignoreDiscriminator) {
...
exports.ExportXMLSimpleTypeFromJSONTyped = ExportXMLSimpleTypeFromJSONTyped;
function ExportXMLSimpleTypeToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
...
exports.ExportXMLSimpleTypeToJSON = ExportXMLSimpleTypeToJSON;
