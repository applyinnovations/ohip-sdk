...
exports.BlockLostBookingCodeTypeToJSON = exports.BlockLostBookingCodeTypeFromJSONTyped = exports.BlockLostBookingCodeTypeFromJSON = exports.instanceOfBlockLostBookingCodeType = void 0;
 ...
 */
function instanceOfBlockLostBookingCodeType(value) {
    let isInstance = true;
    return isInstance;
}
exports.instanceOfBlockLostBookingCodeType = instanceOfBlockLostBookingCodeType;
function BlockLostBookingCodeTypeFromJSON(json) {
    return BlockLostBookingCodeTypeFromJSONTyped(json, false);
}
exports.BlockLostBookingCodeTypeFromJSON = BlockLostBookingCodeTypeFromJSON;
function BlockLostBookingCodeTypeFromJSONTyped(json, ignoreDiscriminator) {
...
exports.BlockLostBookingCodeTypeFromJSONTyped = BlockLostBookingCodeTypeFromJSONTyped;
function BlockLostBookingCodeTypeToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
...
exports.BlockLostBookingCodeTypeToJSON = BlockLostBookingCodeTypeToJSON;
