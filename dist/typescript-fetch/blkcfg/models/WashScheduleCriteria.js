 ...
 */
function instanceOfWashScheduleCriteria(value) {
    let isInstance = true;
    return isInstance;
}
exports.instanceOfWashScheduleCriteria = instanceOfWashScheduleCriteria;
function WashScheduleCriteriaFromJSON(json) {
    return WashScheduleCriteriaFromJSONTyped(json, false);
}
exports.WashScheduleCriteriaFromJSON = WashScheduleCriteriaFromJSON;
function WashScheduleCriteriaFromJSONTyped(json, ignoreDiscriminator) {
...
function WashScheduleCriteriaToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
