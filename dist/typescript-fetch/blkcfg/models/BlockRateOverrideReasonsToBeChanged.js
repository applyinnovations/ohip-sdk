 ...
 */
function instanceOfBlockRateOverrideReasonsToBeChanged(value) {
    let isInstance = true;
    return isInstance;
}
exports.instanceOfBlockRateOverrideReasonsToBeChanged = instanceOfBlockRateOverrideReasonsToBeChanged;
function BlockRateOverrideReasonsToBeChangedFromJSON(json) {
    return BlockRateOverrideReasonsToBeChangedFromJSONTyped(json, false);
}
exports.BlockRateOverrideReasonsToBeChangedFromJSON = BlockRateOverrideReasonsToBeChangedFromJSON;
function BlockRateOverrideReasonsToBeChangedFromJSONTyped(json, ignoreDiscriminator) {
...
function BlockRateOverrideReasonsToBeChangedToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
