 ...
 */
export function instanceOfPutBlockRefusedReasonsRequest(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function PutBlockRefusedReasonsRequestFromJSON(json: any): PutBlockRefusedReasonsRequest {
    return PutBlockRefusedReasonsRequestFromJSONTyped(json, false);
}

export function PutBlockRefusedReasonsRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): PutBlockRefusedReasonsRequest {
...
export function PutBlockRefusedReasonsRequestToJSON(value?: PutBlockRefusedReasonsRequest | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
