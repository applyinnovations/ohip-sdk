...
class ActivityApi extends runtime.BaseAPI {
     ...
     */
    putBulkActivitiesRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            if (requestParameters.putBulkActivities === null || requestParameters.putBulkActivities === undefined) {
                throw new runtime.RequiredError('putBulkActivities', 'Required parameter requestParameters.putBulkActivities was null or undefined when calling putBulkActivities.');
            }
            const queryParameters = {};
            const headerParameters = {};
            headerParameters['Content-Type'] = 'application/json;charset=UTF-8';
            ...
            const response = yield this.request({
                ...
                headers: headerParameters,
                query: queryParameters,
                body: (0, index_1.ActivitiesBulkUpdateToJSON)(requestParameters.putBulkActivities),
            }, initOverrides);
            return new runtime.JSONApiResponse(response, (jsonValue) => (0, index_1.ActivitiesBulkUpdateStatusFromJSON)(jsonValue));
        });
    }
    /**
     * You can use this API to bulk update activities <p><strong>OperationId:</strong>putBulkActivities</p>
     * Operation to update multiple activities
     */
    putBulkActivities(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield this.putBulkActivitiesRaw(requestParameters, initOverrides);
            return yield response.value();
        });
    }
}
