 ...
 */
export function instanceOfPutRotationPeriodRequest(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function PutRotationPeriodRequestFromJSON(json: any): PutRotationPeriodRequest {
    return PutRotationPeriodRequestFromJSONTyped(json, false);
}

export function PutRotationPeriodRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): PutRotationPeriodRequest {
...
export function PutRotationPeriodRequestToJSON(value?: PutRotationPeriodRequest | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
