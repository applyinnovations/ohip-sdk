 ...
 */
function instanceOfChangeRevenueTransactionCodesCriteria(value) {
    let isInstance = true;
    return isInstance;
}
exports.instanceOfChangeRevenueTransactionCodesCriteria = instanceOfChangeRevenueTransactionCodesCriteria;
function ChangeRevenueTransactionCodesCriteriaFromJSON(json) {
    return ChangeRevenueTransactionCodesCriteriaFromJSONTyped(json, false);
}
exports.ChangeRevenueTransactionCodesCriteriaFromJSON = ChangeRevenueTransactionCodesCriteriaFromJSON;
function ChangeRevenueTransactionCodesCriteriaFromJSONTyped(json, ignoreDiscriminator) {
...
function ChangeRevenueTransactionCodesCriteriaToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
