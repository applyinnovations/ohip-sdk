 ...
 * @export
 * @interface ChangeRevenueTransactionCodesDetails
 */
export interface ChangeRevenueTransactionCodesDetails {
    /**
 ...
 */
export declare function instanceOfChangeRevenueTransactionCodesDetails(value: object): boolean;
export declare function ChangeRevenueTransactionCodesDetailsFromJSON(json: any): ChangeRevenueTransactionCodesDetails;
export declare function ChangeRevenueTransactionCodesDetailsFromJSONTyped(json: any, ignoreDiscriminator: boolean): ChangeRevenueTransactionCodesDetails;
export declare function ChangeRevenueTransactionCodesDetailsToJSON(value?: ChangeRevenueTransactionCodesDetails | null): any;
