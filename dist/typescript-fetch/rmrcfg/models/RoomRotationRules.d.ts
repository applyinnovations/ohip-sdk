 ...
 */
export declare function instanceOfRoomRotationRules(value: object): boolean;
export declare function RoomRotationRulesFromJSON(json: any): RoomRotationRules;
export declare function RoomRotationRulesFromJSONTyped(json: any, ignoreDiscriminator: boolean): RoomRotationRules;
export declare function RoomRotationRulesToJSON(value?: RoomRotationRules | null): any;
