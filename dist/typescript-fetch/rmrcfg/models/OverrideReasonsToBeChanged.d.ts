 ...
 */
export declare function instanceOfOverrideReasonsToBeChanged(value: object): boolean;
export declare function OverrideReasonsToBeChangedFromJSON(json: any): OverrideReasonsToBeChanged;
export declare function OverrideReasonsToBeChangedFromJSONTyped(json: any, ignoreDiscriminator: boolean): OverrideReasonsToBeChanged;
export declare function OverrideReasonsToBeChangedToJSON(value?: OverrideReasonsToBeChanged | null): any;
