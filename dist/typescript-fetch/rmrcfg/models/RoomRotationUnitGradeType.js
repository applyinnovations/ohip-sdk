...
exports.RoomRotationUnitGradeTypeToJSON = exports.RoomRotationUnitGradeTypeFromJSONTyped = exports.RoomRotationUnitGradeTypeFromJSON = exports.instanceOfRoomRotationUnitGradeType = void 0;
 ...
 */
function instanceOfRoomRotationUnitGradeType(value) {
    let isInstance = true;
    return isInstance;
}
exports.instanceOfRoomRotationUnitGradeType = instanceOfRoomRotationUnitGradeType;
function RoomRotationUnitGradeTypeFromJSON(json) {
    return RoomRotationUnitGradeTypeFromJSONTyped(json, false);
}
exports.RoomRotationUnitGradeTypeFromJSON = RoomRotationUnitGradeTypeFromJSON;
function RoomRotationUnitGradeTypeFromJSONTyped(json, ignoreDiscriminator) {
...
exports.RoomRotationUnitGradeTypeFromJSONTyped = RoomRotationUnitGradeTypeFromJSONTyped;
function RoomRotationUnitGradeTypeToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
...
exports.RoomRotationUnitGradeTypeToJSON = RoomRotationUnitGradeTypeToJSON;
