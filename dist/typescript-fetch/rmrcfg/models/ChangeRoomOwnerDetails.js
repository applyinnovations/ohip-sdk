 ...
 */
function instanceOfChangeRoomOwnerDetails(value) {
    let isInstance = true;
    return isInstance;
}
exports.instanceOfChangeRoomOwnerDetails = instanceOfChangeRoomOwnerDetails;
function ChangeRoomOwnerDetailsFromJSON(json) {
    return ChangeRoomOwnerDetailsFromJSONTyped(json, false);
}
exports.ChangeRoomOwnerDetailsFromJSON = ChangeRoomOwnerDetailsFromJSON;
function ChangeRoomOwnerDetailsFromJSONTyped(json, ignoreDiscriminator) {
...
function ChangeRoomOwnerDetailsToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
