 ...
 */
function instanceOfFetchUnitGradesDetails(value) {
    let isInstance = true;
    return isInstance;
}
exports.instanceOfFetchUnitGradesDetails = instanceOfFetchUnitGradesDetails;
function FetchUnitGradesDetailsFromJSON(json) {
    return FetchUnitGradesDetailsFromJSONTyped(json, false);
}
exports.FetchUnitGradesDetailsFromJSON = FetchUnitGradesDetailsFromJSON;
function FetchUnitGradesDetailsFromJSONTyped(json, ignoreDiscriminator) {
...
function FetchUnitGradesDetailsToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
