 ...
 */
function instanceOfDailyDocket(value) {
    let isInstance = true;
    return isInstance;
}
exports.instanceOfDailyDocket = instanceOfDailyDocket;
function DailyDocketFromJSON(json) {
    return DailyDocketFromJSONTyped(json, false);
}
exports.DailyDocketFromJSON = DailyDocketFromJSON;
function DailyDocketFromJSONTyped(json, ignoreDiscriminator) {
...
function DailyDocketToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
