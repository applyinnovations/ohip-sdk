 ...
 */
function instanceOfRoutingInfoTypeFolioGuestInfo(value) {
    let isInstance = true;
    return isInstance;
}
exports.instanceOfRoutingInfoTypeFolioGuestInfo = instanceOfRoutingInfoTypeFolioGuestInfo;
function RoutingInfoTypeFolioGuestInfoFromJSON(json) {
    return RoutingInfoTypeFolioGuestInfoFromJSONTyped(json, false);
}
exports.RoutingInfoTypeFolioGuestInfoFromJSON = RoutingInfoTypeFolioGuestInfoFromJSON;
function RoutingInfoTypeFolioGuestInfoFromJSONTyped(json, ignoreDiscriminator) {
...
function RoutingInfoTypeFolioGuestInfoToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
