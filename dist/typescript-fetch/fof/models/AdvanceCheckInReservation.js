 ...
 */
function instanceOfAdvanceCheckInReservation(value) {
    let isInstance = true;
    return isInstance;
}
exports.instanceOfAdvanceCheckInReservation = instanceOfAdvanceCheckInReservation;
function AdvanceCheckInReservationFromJSON(json) {
    return AdvanceCheckInReservationFromJSONTyped(json, false);
}
exports.AdvanceCheckInReservationFromJSON = AdvanceCheckInReservationFromJSON;
function AdvanceCheckInReservationFromJSONTyped(json, ignoreDiscriminator) {
...
function AdvanceCheckInReservationToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
