 ...
 */
function instanceOfBatchCCAuth(value) {
    let isInstance = true;
    return isInstance;
}
exports.instanceOfBatchCCAuth = instanceOfBatchCCAuth;
function BatchCCAuthFromJSON(json) {
    return BatchCCAuthFromJSONTyped(json, false);
}
exports.BatchCCAuthFromJSON = BatchCCAuthFromJSON;
function BatchCCAuthFromJSONTyped(json, ignoreDiscriminator) {
...
function BatchCCAuthToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
