 ...
 */
export declare function instanceOfPrintDataType(value: object): boolean;
export declare function PrintDataTypeFromJSON(json: any): PrintDataType;
export declare function PrintDataTypeFromJSONTyped(json: any, ignoreDiscriminator: boolean): PrintDataType;
export declare function PrintDataTypeToJSON(value?: PrintDataType | null): any;
