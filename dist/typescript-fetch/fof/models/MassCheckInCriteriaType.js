 ...
 */
function instanceOfMassCheckInCriteriaType(value) {
    let isInstance = true;
    return isInstance;
}
exports.instanceOfMassCheckInCriteriaType = instanceOfMassCheckInCriteriaType;
function MassCheckInCriteriaTypeFromJSON(json) {
    return MassCheckInCriteriaTypeFromJSONTyped(json, false);
}
exports.MassCheckInCriteriaTypeFromJSON = MassCheckInCriteriaTypeFromJSON;
function MassCheckInCriteriaTypeFromJSONTyped(json, ignoreDiscriminator) {
...
function MassCheckInCriteriaTypeToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
