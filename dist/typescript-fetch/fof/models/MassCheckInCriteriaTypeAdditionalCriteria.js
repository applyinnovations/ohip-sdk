 ...
 */
function instanceOfMassCheckInCriteriaTypeAdditionalCriteria(value) {
    let isInstance = true;
    return isInstance;
}
exports.instanceOfMassCheckInCriteriaTypeAdditionalCriteria = instanceOfMassCheckInCriteriaTypeAdditionalCriteria;
function MassCheckInCriteriaTypeAdditionalCriteriaFromJSON(json) {
    return MassCheckInCriteriaTypeAdditionalCriteriaFromJSONTyped(json, false);
}
exports.MassCheckInCriteriaTypeAdditionalCriteriaFromJSON = MassCheckInCriteriaTypeAdditionalCriteriaFromJSON;
function MassCheckInCriteriaTypeAdditionalCriteriaFromJSONTyped(json, ignoreDiscriminator) {
...
function MassCheckInCriteriaTypeAdditionalCriteriaToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
