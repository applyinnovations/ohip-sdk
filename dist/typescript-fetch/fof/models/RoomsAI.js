 ...
 */
function instanceOfRoomsAI(value) {
    let isInstance = true;
    return isInstance;
}
exports.instanceOfRoomsAI = instanceOfRoomsAI;
function RoomsAIFromJSON(json) {
    return RoomsAIFromJSONTyped(json, false);
}
exports.RoomsAIFromJSON = RoomsAIFromJSON;
function RoomsAIFromJSONTyped(json, ignoreDiscriminator) {
