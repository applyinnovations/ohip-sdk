 ...
 */
export declare function instanceOfRoomKeyInterfaceDetails(value: object): boolean;
export declare function RoomKeyInterfaceDetailsFromJSON(json: any): RoomKeyInterfaceDetails;
export declare function RoomKeyInterfaceDetailsFromJSONTyped(json: any, ignoreDiscriminator: boolean): RoomKeyInterfaceDetails;
export declare function RoomKeyInterfaceDetailsToJSON(value?: RoomKeyInterfaceDetails | null): any;
