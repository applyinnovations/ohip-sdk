 ...
 */
export declare function instanceOfSetProcessingInstructions(value: object): boolean;
export declare function SetProcessingInstructionsFromJSON(json: any): SetProcessingInstructions;
export declare function SetProcessingInstructionsFromJSONTyped(json: any, ignoreDiscriminator: boolean): SetProcessingInstructions;
export declare function SetProcessingInstructionsToJSON(value?: SetProcessingInstructions | null): any;
