 ...
 */
export declare function instanceOfCommissionAgentType(value: object): boolean;
export declare function CommissionAgentTypeFromJSON(json: any): CommissionAgentType;
export declare function CommissionAgentTypeFromJSONTyped(json: any, ignoreDiscriminator: boolean): CommissionAgentType;
export declare function CommissionAgentTypeToJSON(value?: CommissionAgentType | null): any;
