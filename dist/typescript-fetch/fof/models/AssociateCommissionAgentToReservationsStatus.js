 ...
 */
function instanceOfAssociateCommissionAgentToReservationsStatus(value) {
    let isInstance = true;
    return isInstance;
}
exports.instanceOfAssociateCommissionAgentToReservationsStatus = instanceOfAssociateCommissionAgentToReservationsStatus;
function AssociateCommissionAgentToReservationsStatusFromJSON(json) {
    return AssociateCommissionAgentToReservationsStatusFromJSONTyped(json, false);
}
exports.AssociateCommissionAgentToReservationsStatusFromJSON = AssociateCommissionAgentToReservationsStatusFromJSON;
function AssociateCommissionAgentToReservationsStatusFromJSONTyped(json, ignoreDiscriminator) {
...
function AssociateCommissionAgentToReservationsStatusToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
