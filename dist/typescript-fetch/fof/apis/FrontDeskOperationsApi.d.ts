...
import type { ActivityLog, AdvanceCheckInReservation, AiraLastRunStatusInfo, AssignedRoom, AutoAssignRoom, AutoRoomAssignType, BatchCCAuth, BatchCCAuthToProcess, ChangedWakeUpCalls, CheckedinReservation, DailyDocket, DeliverQueueRoomsTextMessage, FloorPlans, HoldRooms, HotelRooms, KeyOptionsInfo, KeyOptionsInfoListType, LinkedReservations, MassAdvanceCheckInReservations, MassCheckInReservations, MoveInHouseGuest, MovedInHouseGuest, PostCheckInRequest, QueueReservation, QueueRoomsTextMessage, QueuedRoomsTextMessage, ReservationInterface, ReservationQueuePriority, ReservationQueuePriorityNumber, ReservationsInQueue, ReservationsInfo, ResvForBatchCCAut, Room, RoomInterfaceStatus, RoomKey, RoomKeyDetails, RoomKeyExternal, RoomKeyExternalDetails, RoomKeyInfo, RoomKeyInterfaceDetails, RoomKeyMultipleGuests, RoomKeyStatus, RoomKeysExternal, RoomKeysExternalDetails, RoomMoveHistory, RoomsAI, ServiceRequestsInfo, ShiftRooms, ShortReservation, Status, SuggestedRooms, SwapRooms, UnAssignRoomCriteria, UnAssignedRoom, UpdateRoomKeys, VerifiedCheckinReservation, WakeUpCalls } from '../models/index';
...
export declare class FrontDeskOperationsApi extends runtime.BaseAPI {
     ...
     */
    getAiraLastRunStatusRaw(requestParameters: GetAiraLastRunStatusRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<AiraLastRunStatusInfo>>;
    /**
     * This API fetches the last run status of an Automated Intelligence Room Assignment. <p><strong>OperationId:</strong>getAiraLastRunStatus</p>
     * Automated Intelligence Room Assignment last run status
     */
    getAiraLastRunStatus(requestParameters: GetAiraLastRunStatusRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<AiraLastRunStatusInfo>;
    /**
     ...
     */
    getKeyOptionsRaw(requestParameters: GetKeyOptionsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<KeyOptionsInfo>>;
    /**
     * This API is used to retrieve the key options attached to the room, reservation and profile. These key options are preferences that correspond to the Door Lock System in use that control the access to areas with the room key. Key option preferences can be configured and saved on profiles, rooms, and reservations to be included when requesting a room key. <p><strong>OperationId:</strong>getKeyOptions</p>
     * Fetch the keysOptions
     */
    getKeyOptions(requestParameters: GetKeyOptionsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<KeyOptionsInfo>;
    /**
     ...
     */
    getReservationsKeyOptionsRaw(requestParameters: GetReservationsKeyOptionsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<KeyOptionsInfoListType>>;
    /**
     * This API is used to retrieve the key options attached to the room, reservation and profile for all the reservations in reservationIdList. These key options are preferences that correspond to the Door Lock System in use that control the access to areas with the room key. Key option preferences can be configured and saved on profiles, rooms, and reservations to be included when requesting a room key. <p><strong>OperationId:</strong>getKeyOptions</p>
     * Fetch keysOptions for the reservation and the guest profile
     */
    getReservationsKeyOptions(requestParameters: GetReservationsKeyOptionsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<KeyOptionsInfoListType>;
    /**
     ...
     * Get Wake Up Calls
     */
    getWakeUpCallsRaw(requestParameters: GetWakeUpCallsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<WakeUpCalls>>;
    /**
     * Use thisAPI to get existing wake up calls on an in-house reservation. <p><strong>OperationId:</strong>getWakeUpCalls</p>
     * Get Wake Up Calls
     */
    getWakeUpCalls(requestParameters: GetWakeUpCallsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<WakeUpCalls>;
    /**
     ...
     * @deprecated
     */
    postExternalRoomKeysRaw(requestParameters: PostExternalRoomKeysRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<RoomKeyExternalDetails>>;
    /**
     * API that manages requests for Door Lock Room Keys. This operation is used by OPERA Cloud PMS connected to external Door Lock Systems systems via Outbound Systems configuration:   <strong>OPERA Cloud utilizes this operation </strong>  - to request new or additional room keys - e.g. when guest checks in, or additional keys post check in.  - to request to activate new keys after check on e.g. when a room key has been lost for a room.  - to request a room key which is not related to a guest reservation but valid for a defined time - (for show rooms, repair) - One Shot Key.  - to request to re-encode a key whereby other keys for this room remain active.  - to request to read a key data from a room key and display it to the user in the PMS.  - to request to modify existing key data - upon room move or change of departure date. (online key systems only!!)  - to request to remove / delete a room key from a room on. Usually sent with check out of a reservation.  Use this API to post a room key action to the active Door Lock System.  <strong>Notes on keyType values:</strong>  <strong>keyType = New  keyType = Lost </strong>  It is expected that all previous active keys for the room will become invalid.  It is expected that partner system handles multiple keys being active in case numberOfKeys is >1.  <strong>keyType = Duplicate  keyType = ReEncode</strong>  It is expected that existing active keys for this room remain active.  <strong>keyType = OneShot</strong>  It is expected that the room key is only valid for a room for specific time (for maintenance or Show room).  It is never related to a reservation.  <strong>keyType = Read</strong> A request to the Key Card system to read Key Card information from requested Key Encoder/reader.  The Key Read functionality is of pure informational purpose. None of the received information is stored or processed in the PMS, and it is only for display to the user.  <strong>keyType = Remove</strong>  It is expected that with this request all active keys for a room or reservation will become inactive or invalid so they will not be able to open the room after defined validityEnd time.  <strong>Additional KeyType actions used by Online Door Lock Systems:</strong>  <strong>Online Key card Systems</strong> are systems which do not write guest data to the room key directly but do store guest data internally and send the information to the related door lock.  <strong>keyType = ModifyStay</strong>  For Online Door Lock Systems - Request to adjust Room key data when guest changes length of stay (validityEnd)  <strong>keyType = RoomMove</strong>  For Online Door Lock Systems - adjust Room key data when guest performs room move.   <p><strong>OperationId:</strong> postExternalRoomKeys</p>
     * Requests room key(s)
     * @deprecated
     */
    postExternalRoomKeys(requestParameters: PostExternalRoomKeysRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<RoomKeyExternalDetails>;
    /**
     ...
     * Requests room key(s)
     */
    postRoomKeysExternalRaw(requestParameters: PostRoomKeysExternalRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<RoomKeysExternalDetails>>;
    /**
     * API that manages requests for Door Lock Room Keys. This operation is used by OPERA Cloud PMS connected to external Door Lock Systems systems via Outbound Systems configuration:   <strong>OPERA Cloud utilizes this operation </strong>  - to request new or additional room keys - e.g. when guest checks in, or additional keys post check in.  - to request to activate new keys after check on e.g. when a room key has been lost for a room.  - to request a room key which is not related to a guest reservation but valid for a defined time - (for show rooms, repair) - One Shot Key.  - to request to re-encode a key whereby other keys for this room remain active.  - to request to read a key data from a room key and display it to the user in the PMS.  - to request to modify existing key data - upon room move or change of departure date. (online key systems only!!)  - to request to remove / delete a room key from a room on. Usually sent with check out of a reservation.  Use this API to post a room key action to the active Door Lock System.  <strong>Notes on keyType values:</strong>  <strong>keyType = New  keyType = Lost </strong>  It is expected that all previous active keys for the room will become invalid.  It is expected that partner system handles multiple keys being active in case numberOfKeys is >1.  <strong>keyType = Duplicate  keyType = ReEncode</strong>  It is expected that existing active keys for this room remain active.  <strong>keyType = OneShot</strong>  It is expected that the room key is only valid for a room for specific time (for maintenance or Show room).  It is never related to a reservation.  <strong>keyType = Read</strong> A request to the Key Card system to read Key Card information from requested Key Encoder/reader.  The Key Read functionality is of pure informational purpose. None of the received information is stored or processed in the PMS, and it is only for display to the user.  <strong>keyType = Remove</strong>  It is expected that with this request all active keys for a room or reservation will become inactive or invalid so they will not be able to open the room after defined validityEnd time.  <strong>Additional KeyType actions used by Online Door Lock Systems:</strong>  <strong>Online Key card Systems</strong> are systems which do not write guest data to the room key directly but do store guest data internally and send the information to the related door lock.  <strong>keyType = ModifyStay</strong>  For Online Door Lock Systems - Request to adjust Room key data when guest changes length of stay (validityEnd)  <strong>keyType = RoomMove</strong>  For Online Door Lock Systems - adjust Room key data when guest performs room move.   <p><strong>OperationId:</strong> postRoomKeysExternal</p>
     * Requests room key(s)
     */
    postRoomKeysExternal(requestParameters: PostRoomKeysExternalRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<RoomKeysExternalDetails>;
    /**
 ...
 * @export
 */
export declare const GetReservationSummariesFetchInstructionsEnum: {
    readonly ShortReservationSummaries: "ShortReservationSummaries";
};
