 ...
 */
export declare function instanceOfHotelInfoTypePrimaryDetails(value: object): boolean;
export declare function HotelInfoTypePrimaryDetailsFromJSON(json: any): HotelInfoTypePrimaryDetails;
export declare function HotelInfoTypePrimaryDetailsFromJSONTyped(json: any, ignoreDiscriminator: boolean): HotelInfoTypePrimaryDetails;
export declare function HotelInfoTypePrimaryDetailsToJSON(value?: HotelInfoTypePrimaryDetails | null): any;
