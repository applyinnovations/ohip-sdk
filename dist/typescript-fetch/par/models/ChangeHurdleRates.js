...
const HurdleRateEditType_1 = require("./HurdleRateEditType");
...
function ChangeHurdleRatesFromJSONTyped(json, ignoreDiscriminator) {
    ...
    return {
        'hurdleRates': !(0, runtime_1.exists)(json, 'hurdleRates') ? undefined : (json['hurdleRates'].map(HurdleRateEditType_1.HurdleRateEditTypeFromJSON)),
...
function ChangeHurdleRatesToJSON(value) {
    ...
    return {
        'hurdleRates': value.hurdleRates === undefined ? undefined : (value.hurdleRates.map(HurdleRateEditType_1.HurdleRateEditTypeToJSON)),
