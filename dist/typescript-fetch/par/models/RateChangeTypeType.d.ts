 ...
 * @export
 */
export declare const RateChangeTypeType: {
    readonly FirstNight: "FirstNight";
    readonly Highest: "Highest";
    readonly Lowest: "Lowest";
    readonly MostCommon: "MostCommon";
    readonly Average: "Average";
};
export type RateChangeTypeType = typeof RateChangeTypeType[keyof typeof RateChangeTypeType];
export declare function RateChangeTypeTypeFromJSON(json: any): RateChangeTypeType;
export declare function RateChangeTypeTypeFromJSONTyped(json: any, ignoreDiscriminator: boolean): RateChangeTypeType;
export declare function RateChangeTypeTypeToJSON(value?: RateChangeTypeType | null): any;
