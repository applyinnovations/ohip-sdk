 ...
 */
function instanceOfReservationGuaranteesPolicies(value) {
    let isInstance = true;
    return isInstance;
}
exports.instanceOfReservationGuaranteesPolicies = instanceOfReservationGuaranteesPolicies;
function ReservationGuaranteesPoliciesFromJSON(json) {
    return ReservationGuaranteesPoliciesFromJSONTyped(json, false);
}
exports.ReservationGuaranteesPoliciesFromJSON = ReservationGuaranteesPoliciesFromJSON;
function ReservationGuaranteesPoliciesFromJSONTyped(json, ignoreDiscriminator) {
...
function ReservationGuaranteesPoliciesToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
