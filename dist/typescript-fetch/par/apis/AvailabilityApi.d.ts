...
import type { AlternateAvailability, AvailabilityRatePlanInfo, AvailableUpsells, ChangeHurdleRates, ChangeHurdleRatesDetails, ClearAllRestrictions, CreateHurdleRates, CreateRestriction, HotelAvailability, HurdleRates, RateAnalysisDetails, ReservationGuaranteesPolicies, RestrictionsByDateRange, RestrictionsHistory, SearchHotelsDetails, Status, ValidateReservationGuarantees } from '../models/index';
 ...
 * @export
 */
export declare const GetHotelsOrderByEnum: {
    readonly Mostavail: "MOSTAVAIL";
    readonly Leastavail: "LEASTAVAIL";
    readonly Mostpercavail: "MOSTPERCAVAIL";
    readonly Listpercavail: "LISTPERCAVAIL";
    readonly Shortestdistance: "SHORTESTDISTANCE";
    readonly Default: "DEFAULT";
    readonly Alphabetical: "ALPHABETICAL";
    readonly Ratelowtohigh: "RATELOWTOHIGH";
    readonly Ratehightolow: "RATEHIGHTOLOW";
};
