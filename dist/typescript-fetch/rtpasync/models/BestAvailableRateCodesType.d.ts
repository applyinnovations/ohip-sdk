 ...
 * @export
 * @interface BestAvailableRateCodesType
 */
export interface BestAvailableRateCodesType extends Array<string> {
}
/**
 * Check if a given object implements the BestAvailableRateCodesType interface.
 */
export declare function instanceOfBestAvailableRateCodesType(value: object): boolean;
export declare function BestAvailableRateCodesTypeFromJSON(json: any): BestAvailableRateCodesType;
export declare function BestAvailableRateCodesTypeFromJSONTyped(json: any, ignoreDiscriminator: boolean): BestAvailableRateCodesType;
export declare function BestAvailableRateCodesTypeToJSON(value?: BestAvailableRateCodesType | null): any;
