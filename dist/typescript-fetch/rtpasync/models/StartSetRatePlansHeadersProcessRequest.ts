 ...
 * 
 * @export
 * @interface StartSetRatePlansHeadersProcessRequest
 */
export interface StartSetRatePlansHeadersProcessRequest {
    /**
     * 
     * @type {Array<InstanceLink>}
     * @memberof StartSetRatePlansHeadersProcessRequest
     */
 ...
 */
export function instanceOfStartSetRatePlansHeadersProcessRequest(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function StartSetRatePlansHeadersProcessRequestFromJSON(json: any): StartSetRatePlansHeadersProcessRequest {
    return StartSetRatePlansHeadersProcessRequestFromJSONTyped(json, false);
}

export function StartSetRatePlansHeadersProcessRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): StartSetRatePlansHeadersProcessRequest {
...
export function StartSetRatePlansHeadersProcessRequestToJSON(value?: StartSetRatePlansHeadersProcessRequest | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
