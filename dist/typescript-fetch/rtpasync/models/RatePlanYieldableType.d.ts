 ...
 * @export
 */
export declare const RatePlanYieldableType: {
    readonly Yieldable: "Yieldable";
    readonly NonYieldable: "NonYieldable";
    readonly StayPattern: "StayPattern";
};
export type RatePlanYieldableType = typeof RatePlanYieldableType[keyof typeof RatePlanYieldableType];
export declare function RatePlanYieldableTypeFromJSON(json: any): RatePlanYieldableType;
export declare function RatePlanYieldableTypeFromJSONTyped(json: any, ignoreDiscriminator: boolean): RatePlanYieldableType;
export declare function RatePlanYieldableTypeToJSON(value?: RatePlanYieldableType | null): any;
