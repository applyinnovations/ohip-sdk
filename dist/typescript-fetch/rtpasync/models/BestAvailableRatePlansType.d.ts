 ...
 */
export declare function instanceOfBestAvailableRatePlansType(value: object): boolean;
export declare function BestAvailableRatePlansTypeFromJSON(json: any): BestAvailableRatePlansType;
export declare function BestAvailableRatePlansTypeFromJSONTyped(json: any, ignoreDiscriminator: boolean): BestAvailableRatePlansType;
export declare function BestAvailableRatePlansTypeToJSON(value?: BestAvailableRatePlansType | null): any;
