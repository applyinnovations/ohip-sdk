...
exports.RatePlansToJSON = exports.RatePlansFromJSONTyped = exports.RatePlansFromJSON = exports.instanceOfRatePlans = void 0;
 ...
 */
function instanceOfRatePlans(value) {
    let isInstance = true;
    return isInstance;
}
exports.instanceOfRatePlans = instanceOfRatePlans;
function RatePlansFromJSON(json) {
    return RatePlansFromJSONTyped(json, false);
}
exports.RatePlansFromJSON = RatePlansFromJSON;
function RatePlansFromJSONTyped(json, ignoreDiscriminator) {
...
exports.RatePlansFromJSONTyped = RatePlansFromJSONTyped;
function RatePlansToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
...
exports.RatePlansToJSON = RatePlansToJSON;
