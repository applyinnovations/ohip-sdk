...
function DailyRatePlanScheduleTypeFromJSONTyped(json, ignoreDiscriminator) {
    ...
    return {
        ...
        'rateDateRangeStart': !(0, runtime_1.exists)(json, 'rateDateRangeStart') ? undefined : json['rateDateRangeStart'],
        'rateDateRangeEnd': !(0, runtime_1.exists)(json, 'rateDateRangeEnd') ? undefined : json['rateDateRangeEnd'],
