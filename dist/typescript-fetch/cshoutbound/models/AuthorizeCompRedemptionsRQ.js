 ...
 */
function instanceOfAuthorizeCompRedemptionsRQ(value) {
    let isInstance = true;
    return isInstance;
}
exports.instanceOfAuthorizeCompRedemptionsRQ = instanceOfAuthorizeCompRedemptionsRQ;
function AuthorizeCompRedemptionsRQFromJSON(json) {
    return AuthorizeCompRedemptionsRQFromJSONTyped(json, false);
}
exports.AuthorizeCompRedemptionsRQFromJSON = AuthorizeCompRedemptionsRQFromJSON;
function AuthorizeCompRedemptionsRQFromJSONTyped(json, ignoreDiscriminator) {
...
function AuthorizeCompRedemptionsRQToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
