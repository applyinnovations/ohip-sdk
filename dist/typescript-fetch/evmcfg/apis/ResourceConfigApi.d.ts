...
import type { CateringContainers, CateringContainersInfo, CateringItemRates, CateringItemRatesInfo, CateringMenuClasses, CateringMenuClassesInfo, CateringMenuItemClasses, CateringMenuItemClassesCopy, CateringMenuItemClassesInfo, CateringMenuItems, CateringMenuItemsCopy, CateringMenuItemsInfo, CateringMenus, CateringMenusCopy, CateringMenusInfo, CateringPackage, CateringPackages, CateringPackagesInfo, CateringServings, CateringServingsInfo, CheckedDiscountAvailable, CopyCateringPackagePriceType, CopyCateringPackageType, CopyConfigurationCodeType, DailyInventoryItems, EventForecasts, EventForecastsCopy, EventForecastsInfo, InventoryItemTemplates, InventoryItems, InventoryItemsCopy, InventoryItemsCreated, ItemClasses, ItemClassesInfo, ItemPools, ItemPoolsInfo, ResourceCodeInfo, RevenueGroups, RevenueGroupsInfo, RevenueTypes, RevenueTypesInfo, Status } from '../models/index';
...
export declare class ResourceConfigApi extends runtime.BaseAPI {
     ...
     */
    copyCateringPackageRaw(requestParameters: CopyCateringPackageRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ResourceCodeInfo>>;
    /**
     * Use this API to copy catering package or template. <p><strong>OperationId:</strong>copyCateringPackage</p>
     * Operation to copy catering package or template.
     */
    copyCateringPackage(requestParameters: CopyCateringPackageRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<ResourceCodeInfo>;
    /**
     ...
     */
    copyCateringPackagePriceRaw(requestParameters: CopyCateringPackagePriceRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ResourceCodeInfo>>;
    /**
     * Use this API to copy catering package price. <p><strong>OperationId:</strong>copyCateringPackagePrice</p>
     * Operation to copy catering package price.
     */
    copyCateringPackagePrice(requestParameters: CopyCateringPackagePriceRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<ResourceCodeInfo>;
    /**
     ...
     * ClearCache
     */
    deleteResourceConfigServiceCacheRaw(requestParameters: DeleteResourceConfigServiceCacheRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Status>>;
    /**
     * You can use this API to delete the Resource Configuration Service Status Cache. <p><strong>OperationId:</strong>deleteResourceConfigServiceCache</p>
     * ClearCache
     */
    deleteResourceConfigServiceCache(requestParameters: DeleteResourceConfigServiceCacheRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Status>;
    /**
 ...
 * @export
 */
export declare const GetCateringMenuItemsFetchInstructionsEnum: {
    readonly SummaryInfo: "SummaryInfo";
    readonly DetailsInfo: "DetailsInfo";
};
