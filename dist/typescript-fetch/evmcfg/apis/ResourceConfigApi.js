...
exports.GetItemClassesCriteriaEnum = exports.GetEventForecastsFetchInstructionsEnum = exports.GetCateringPackagesMultiPropertiesFetchInstructionsEnum = exports.GetCateringPackagesMultiPropertiesPkgTmpltTypeEnum = exports.GetCateringPackagesFetchInstructionsEnum = exports.GetCateringPackagesPkgTmpltTypeEnum = exports.GetCateringPackageByChainFetchInstructionsEnum = exports.GetCateringPackageFetchInstructionsEnum = exports.GetCateringMenusFetchInstructionsEnum = exports.GetCateringMenusMenuTypesEnum = exports.GetCateringMenuItemsFetchInstructionsEnum = exports.GetCateringMenuItemClassesMenuTypesEnum = exports.GetCateringMenuFetchInstructionsEnum = exports.DeleteEventForecastsAmountTypeEnum = exports.ResourceConfigApi = void 0;
...
class ResourceConfigApi extends runtime.BaseAPI {
    ...
    copyCateringPackageRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const response = yield this.request({
                ...
                headers: headerParameters,
                query: queryParameters,
                body: (0, index_1.CopyCateringPackageTypeToJSON)(requestParameters.copyCateringPackageType),
            }, initOverrides);
            return new runtime.JSONApiResponse(response, (jsonValue) => (0, index_1.ResourceCodeInfoFromJSON)(jsonValue));
        });
    }
    /**
     * Use this API to copy catering package or template. <p><strong>OperationId:</strong>copyCateringPackage</p>
     ...
     */
    copyCateringPackagePriceRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const response = yield this.request({
                ...
                headers: headerParameters,
                query: queryParameters,
                body: (0, index_1.CopyCateringPackagePriceTypeToJSON)(requestParameters.copyCateringPackagePriceType),
            }, initOverrides);
            return new runtime.JSONApiResponse(response, (jsonValue) => (0, index_1.ResourceCodeInfoFromJSON)(jsonValue));
        });
    }
     ...
     * Operation to copy catering package price.
     */
    copyCateringPackagePrice(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield this.copyCateringPackagePriceRaw(requestParameters, initOverrides);
            return yield response.value();
        });
    }
    /**
     ...
     * ClearCache
     */
    deleteResourceConfigServiceCacheRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            const queryParameters = {};
     ...
     * ClearCache
     */
    deleteResourceConfigServiceCache(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield this.deleteResourceConfigServiceCacheRaw(requestParameters, initOverrides);
            return yield response.value();
        });
    }
    /**
 ...
 * @export
 */
exports.GetCateringMenuItemsFetchInstructionsEnum = {
