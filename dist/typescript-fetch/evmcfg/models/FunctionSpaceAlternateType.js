 ...
 */
function instanceOfFunctionSpaceAlternateType(value) {
    let isInstance = true;
    return isInstance;
}
exports.instanceOfFunctionSpaceAlternateType = instanceOfFunctionSpaceAlternateType;
function FunctionSpaceAlternateTypeFromJSON(json) {
    return FunctionSpaceAlternateTypeFromJSONTyped(json, false);
}
exports.FunctionSpaceAlternateTypeFromJSON = FunctionSpaceAlternateTypeFromJSON;
function FunctionSpaceAlternateTypeFromJSONTyped(json, ignoreDiscriminator) {
...
exports.FunctionSpaceAlternateTypeFromJSONTyped = FunctionSpaceAlternateTypeFromJSONTyped;
function FunctionSpaceAlternateTypeToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
...
exports.FunctionSpaceAlternateTypeToJSON = FunctionSpaceAlternateTypeToJSON;
