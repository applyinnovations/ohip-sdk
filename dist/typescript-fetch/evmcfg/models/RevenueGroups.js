 ...
 */
function instanceOfRevenueGroups(value) {
    let isInstance = true;
    return isInstance;
}
exports.instanceOfRevenueGroups = instanceOfRevenueGroups;
function RevenueGroupsFromJSON(json) {
    return RevenueGroupsFromJSONTyped(json, false);
}
exports.RevenueGroupsFromJSON = RevenueGroupsFromJSON;
function RevenueGroupsFromJSONTyped(json, ignoreDiscriminator) {
...
function RevenueGroupsToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
