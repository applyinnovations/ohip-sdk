 ...
 */
export declare function instanceOfCateringPackageEventType(value: object): boolean;
export declare function CateringPackageEventTypeFromJSON(json: any): CateringPackageEventType;
export declare function CateringPackageEventTypeFromJSONTyped(json: any, ignoreDiscriminator: boolean): CateringPackageEventType;
export declare function CateringPackageEventTypeToJSON(value?: CateringPackageEventType | null): any;
