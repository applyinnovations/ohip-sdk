 ...
 */
function instanceOfRoomTypePoolToBeChanged(value) {
    let isInstance = true;
    return isInstance;
}
exports.instanceOfRoomTypePoolToBeChanged = instanceOfRoomTypePoolToBeChanged;
function RoomTypePoolToBeChangedFromJSON(json) {
    return RoomTypePoolToBeChangedFromJSONTyped(json, false);
}
exports.RoomTypePoolToBeChangedFromJSON = RoomTypePoolToBeChangedFromJSON;
function RoomTypePoolToBeChangedFromJSONTyped(json, ignoreDiscriminator) {
...
function RoomTypePoolToBeChangedToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
