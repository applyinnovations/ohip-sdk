 ...
 */
export declare function instanceOfTemplateEventCodesDetails(value: object): boolean;
export declare function TemplateEventCodesDetailsFromJSON(json: any): TemplateEventCodesDetails;
export declare function TemplateEventCodesDetailsFromJSONTyped(json: any, ignoreDiscriminator: boolean): TemplateEventCodesDetails;
export declare function TemplateEventCodesDetailsToJSON(value?: TemplateEventCodesDetails | null): any;
