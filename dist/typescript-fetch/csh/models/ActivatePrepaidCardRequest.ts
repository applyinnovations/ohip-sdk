 ...
 */
export function instanceOfActivatePrepaidCardRequest(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function ActivatePrepaidCardRequestFromJSON(json: any): ActivatePrepaidCardRequest {
    return ActivatePrepaidCardRequestFromJSONTyped(json, false);
}

export function ActivatePrepaidCardRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): ActivatePrepaidCardRequest {
...
export function ActivatePrepaidCardRequestToJSON(value?: ActivatePrepaidCardRequest | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
