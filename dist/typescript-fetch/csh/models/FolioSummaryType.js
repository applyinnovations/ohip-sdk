...
function FolioSummaryTypeFromJSONTyped(json, ignoreDiscriminator) {
    ...
    return {
        ...
        'isARAttached': !(0, runtime_1.exists)(json, 'isARAttached') ? undefined : json['isARAttached'],
        'isFiscalFolio': !(0, runtime_1.exists)(json, 'isFiscalFolio') ? undefined : json['isFiscalFolio'],
