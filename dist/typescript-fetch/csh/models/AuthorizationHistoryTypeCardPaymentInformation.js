...
exports.AuthorizationHistoryTypeCardPaymentInformationToJSON = exports.AuthorizationHistoryTypeCardPaymentInformationFromJSONTyped = exports.AuthorizationHistoryTypeCardPaymentInformationFromJSON = exports.instanceOfAuthorizationHistoryTypeCardPaymentInformation = void 0;
 ...
 */
function instanceOfAuthorizationHistoryTypeCardPaymentInformation(value) {
    let isInstance = true;
    return isInstance;
}
exports.instanceOfAuthorizationHistoryTypeCardPaymentInformation = instanceOfAuthorizationHistoryTypeCardPaymentInformation;
function AuthorizationHistoryTypeCardPaymentInformationFromJSON(json) {
    return AuthorizationHistoryTypeCardPaymentInformationFromJSONTyped(json, false);
}
exports.AuthorizationHistoryTypeCardPaymentInformationFromJSON = AuthorizationHistoryTypeCardPaymentInformationFromJSON;
function AuthorizationHistoryTypeCardPaymentInformationFromJSONTyped(json, ignoreDiscriminator) {
...
exports.AuthorizationHistoryTypeCardPaymentInformationFromJSONTyped = AuthorizationHistoryTypeCardPaymentInformationFromJSONTyped;
function AuthorizationHistoryTypeCardPaymentInformationToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
...
exports.AuthorizationHistoryTypeCardPaymentInformationToJSON = AuthorizationHistoryTypeCardPaymentInformationToJSON;
