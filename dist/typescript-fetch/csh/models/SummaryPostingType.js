...
exports.SummaryPostingTypeToJSON = exports.SummaryPostingTypeFromJSONTyped = exports.SummaryPostingTypeFromJSON = exports.instanceOfSummaryPostingType = void 0;
...
const PostingTimeType_1 = require("./PostingTimeType");
const UniqueIDType_1 = require("./UniqueIDType");
/**
 * Check if a given object implements the SummaryPostingType interface.
 */
function instanceOfSummaryPostingType(value) {
    let isInstance = true;
    return isInstance;
}
exports.instanceOfSummaryPostingType = instanceOfSummaryPostingType;
function SummaryPostingTypeFromJSON(json) {
    return SummaryPostingTypeFromJSONTyped(json, false);
}
exports.SummaryPostingTypeFromJSON = SummaryPostingTypeFromJSON;
function SummaryPostingTypeFromJSONTyped(json, ignoreDiscriminator) {
    ...
    return {
        ...
        'postingTime': !(0, runtime_1.exists)(json, 'postingTime') ? undefined : (0, PostingTimeType_1.PostingTimeTypeFromJSON)(json['postingTime']),
        ...
        'awardTransaction': !(0, runtime_1.exists)(json, 'awardTransaction') ? undefined : json['awardTransaction'],
        'covers': !(0, runtime_1.exists)(json, 'covers') ? undefined : json['covers'],
        'proformaFlag': !(0, runtime_1.exists)(json, 'proformaFlag') ? undefined : json['proformaFlag'],
    };
}
exports.SummaryPostingTypeFromJSONTyped = SummaryPostingTypeFromJSONTyped;
function SummaryPostingTypeToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'postingTime': (0, PostingTimeType_1.PostingTimeTypeToJSON)(value.postingTime),
...
exports.SummaryPostingTypeToJSON = SummaryPostingTypeToJSON;
