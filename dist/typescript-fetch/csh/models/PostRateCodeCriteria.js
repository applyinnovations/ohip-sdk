 ...
 */
function instanceOfPostRateCodeCriteria(value) {
    let isInstance = true;
    return isInstance;
}
exports.instanceOfPostRateCodeCriteria = instanceOfPostRateCodeCriteria;
function PostRateCodeCriteriaFromJSON(json) {
    return PostRateCodeCriteriaFromJSONTyped(json, false);
}
exports.PostRateCodeCriteriaFromJSON = PostRateCodeCriteriaFromJSON;
function PostRateCodeCriteriaFromJSONTyped(json, ignoreDiscriminator) {
...
function PostRateCodeCriteriaToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
