 ...
 * @export
 * @interface CancelPrepaidCardTransaction
 */
 ...
 */
export function instanceOfCancelPrepaidCardTransaction(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function CancelPrepaidCardTransactionFromJSON(json: any): CancelPrepaidCardTransaction {
    return CancelPrepaidCardTransactionFromJSONTyped(json, false);
}

export function CancelPrepaidCardTransactionFromJSONTyped(json: any, ignoreDiscriminator: boolean): CancelPrepaidCardTransaction {
...
export function CancelPrepaidCardTransactionToJSON(value?: CancelPrepaidCardTransaction | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
