 ...
 */
export declare function instanceOfPostRateCodeCheckType(value: object): boolean;
export declare function PostRateCodeCheckTypeFromJSON(json: any): PostRateCodeCheckType;
export declare function PostRateCodeCheckTypeFromJSONTyped(json: any, ignoreDiscriminator: boolean): PostRateCodeCheckType;
export declare function PostRateCodeCheckTypeToJSON(value?: PostRateCodeCheckType | null): any;
