...
function AdjustedTransactionsFromJSONTyped(json, ignoreDiscriminator) {
    ...
    return {
        ...
        'serviceRecoveryAdjustments': !(0, runtime_1.exists)(json, 'serviceRecoveryAdjustments') ? undefined : (0, SummaryPostingsType_1.SummaryPostingsTypeFromJSON)(json['serviceRecoveryAdjustments']),
...
function AdjustedTransactionsToJSON(value) {
    ...
    return {
        ...
        'serviceRecoveryAdjustments': (0, SummaryPostingsType_1.SummaryPostingsTypeToJSON)(value.serviceRecoveryAdjustments),
