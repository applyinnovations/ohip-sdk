...
exports.CashOutPrepaidCardCriteriaToJSON = exports.CashOutPrepaidCardCriteriaFromJSONTyped = exports.CashOutPrepaidCardCriteriaFromJSON = exports.instanceOfCashOutPrepaidCardCriteria = void 0;
 ...
 */
function instanceOfCashOutPrepaidCardCriteria(value) {
    let isInstance = true;
    return isInstance;
}
exports.instanceOfCashOutPrepaidCardCriteria = instanceOfCashOutPrepaidCardCriteria;
function CashOutPrepaidCardCriteriaFromJSON(json) {
    return CashOutPrepaidCardCriteriaFromJSONTyped(json, false);
}
exports.CashOutPrepaidCardCriteriaFromJSON = CashOutPrepaidCardCriteriaFromJSON;
function CashOutPrepaidCardCriteriaFromJSONTyped(json, ignoreDiscriminator) {
...
exports.CashOutPrepaidCardCriteriaFromJSONTyped = CashOutPrepaidCardCriteriaFromJSONTyped;
function CashOutPrepaidCardCriteriaToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
...
exports.CashOutPrepaidCardCriteriaToJSON = CashOutPrepaidCardCriteriaToJSON;
