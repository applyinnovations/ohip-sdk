 ...
 */
export function instanceOfPolicyApplyCriteriaType(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function PolicyApplyCriteriaTypeFromJSON(json: any): PolicyApplyCriteriaType {
    return PolicyApplyCriteriaTypeFromJSONTyped(json, false);
}

export function PolicyApplyCriteriaTypeFromJSONTyped(json: any, ignoreDiscriminator: boolean): PolicyApplyCriteriaType {
...
export function PolicyApplyCriteriaTypeToJSON(value?: PolicyApplyCriteriaType | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
