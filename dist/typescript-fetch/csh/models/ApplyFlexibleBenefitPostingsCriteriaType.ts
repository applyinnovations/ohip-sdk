 ...
 */
export function instanceOfApplyFlexibleBenefitPostingsCriteriaType(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function ApplyFlexibleBenefitPostingsCriteriaTypeFromJSON(json: any): ApplyFlexibleBenefitPostingsCriteriaType {
    return ApplyFlexibleBenefitPostingsCriteriaTypeFromJSONTyped(json, false);
}

export function ApplyFlexibleBenefitPostingsCriteriaTypeFromJSONTyped(json: any, ignoreDiscriminator: boolean): ApplyFlexibleBenefitPostingsCriteriaType {
...
export function ApplyFlexibleBenefitPostingsCriteriaTypeToJSON(value?: ApplyFlexibleBenefitPostingsCriteriaType | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
