 ...
 */
export declare function instanceOfEarlyDepartureInfo(value: object): boolean;
export declare function EarlyDepartureInfoFromJSON(json: any): EarlyDepartureInfo;
export declare function EarlyDepartureInfoFromJSONTyped(json: any, ignoreDiscriminator: boolean): EarlyDepartureInfo;
export declare function EarlyDepartureInfoToJSON(value?: EarlyDepartureInfo | null): any;
