 ...
 */
function instanceOfFolioHistoryResponse(value) {
    let isInstance = true;
    return isInstance;
}
exports.instanceOfFolioHistoryResponse = instanceOfFolioHistoryResponse;
function FolioHistoryResponseFromJSON(json) {
    return FolioHistoryResponseFromJSONTyped(json, false);
}
exports.FolioHistoryResponseFromJSON = FolioHistoryResponseFromJSON;
function FolioHistoryResponseFromJSONTyped(json, ignoreDiscriminator) {
...
function FolioHistoryResponseToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
