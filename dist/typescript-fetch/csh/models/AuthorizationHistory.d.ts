 ...
 */
export declare function instanceOfAuthorizationHistory(value: object): boolean;
export declare function AuthorizationHistoryFromJSON(json: any): AuthorizationHistory;
export declare function AuthorizationHistoryFromJSONTyped(json: any, ignoreDiscriminator: boolean): AuthorizationHistory;
export declare function AuthorizationHistoryToJSON(value?: AuthorizationHistory | null): any;
