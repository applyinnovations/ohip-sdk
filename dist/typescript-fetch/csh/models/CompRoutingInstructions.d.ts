 ...
 */
export declare function instanceOfCompRoutingInstructions(value: object): boolean;
export declare function CompRoutingInstructionsFromJSON(json: any): CompRoutingInstructions;
export declare function CompRoutingInstructionsFromJSONTyped(json: any, ignoreDiscriminator: boolean): CompRoutingInstructions;
export declare function CompRoutingInstructionsToJSON(value?: CompRoutingInstructions | null): any;
