 ...
 */
export declare function instanceOfPostSupplementalFolio(value: object): boolean;
export declare function PostSupplementalFolioFromJSON(json: any): PostSupplementalFolio;
export declare function PostSupplementalFolioFromJSONTyped(json: any, ignoreDiscriminator: boolean): PostSupplementalFolio;
export declare function PostSupplementalFolioToJSON(value?: PostSupplementalFolio | null): any;
