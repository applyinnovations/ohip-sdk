 ...
 */
export declare function instanceOfAuthorizationHistoryTypeStatus(value: object): boolean;
export declare function AuthorizationHistoryTypeStatusFromJSON(json: any): AuthorizationHistoryTypeStatus;
export declare function AuthorizationHistoryTypeStatusFromJSONTyped(json: any, ignoreDiscriminator: boolean): AuthorizationHistoryTypeStatus;
export declare function AuthorizationHistoryTypeStatusToJSON(value?: AuthorizationHistoryTypeStatus | null): any;
