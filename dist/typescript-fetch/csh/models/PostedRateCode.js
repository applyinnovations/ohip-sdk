 ...
 */
function instanceOfPostedRateCode(value) {
    let isInstance = true;
    return isInstance;
}
exports.instanceOfPostedRateCode = instanceOfPostedRateCode;
function PostedRateCodeFromJSON(json) {
    return PostedRateCodeFromJSONTyped(json, false);
}
exports.PostedRateCodeFromJSON = PostedRateCodeFromJSON;
function PostedRateCodeFromJSONTyped(json, ignoreDiscriminator) {
...
function PostedRateCodeToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
