 ...
 */
function instanceOfCcBatchSettlements(value) {
    let isInstance = true;
    return isInstance;
}
exports.instanceOfCcBatchSettlements = instanceOfCcBatchSettlements;
function CcBatchSettlementsFromJSON(json) {
    return CcBatchSettlementsFromJSONTyped(json, false);
}
exports.CcBatchSettlementsFromJSON = CcBatchSettlementsFromJSON;
function CcBatchSettlementsFromJSONTyped(json, ignoreDiscriminator) {
...
function CcBatchSettlementsToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
