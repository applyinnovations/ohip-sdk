 ...
 */
export declare function instanceOfPostingBreakdownType(value: object): boolean;
export declare function PostingBreakdownTypeFromJSON(json: any): PostingBreakdownType;
export declare function PostingBreakdownTypeFromJSONTyped(json: any, ignoreDiscriminator: boolean): PostingBreakdownType;
export declare function PostingBreakdownTypeToJSON(value?: PostingBreakdownType | null): any;
