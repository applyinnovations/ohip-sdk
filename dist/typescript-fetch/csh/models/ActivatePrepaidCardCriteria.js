...
exports.ActivatePrepaidCardCriteriaToJSON = exports.ActivatePrepaidCardCriteriaFromJSONTyped = exports.ActivatePrepaidCardCriteriaFromJSON = exports.instanceOfActivatePrepaidCardCriteria = void 0;
 ...
 */
function instanceOfActivatePrepaidCardCriteria(value) {
    let isInstance = true;
    return isInstance;
}
exports.instanceOfActivatePrepaidCardCriteria = instanceOfActivatePrepaidCardCriteria;
function ActivatePrepaidCardCriteriaFromJSON(json) {
    return ActivatePrepaidCardCriteriaFromJSONTyped(json, false);
}
exports.ActivatePrepaidCardCriteriaFromJSON = ActivatePrepaidCardCriteriaFromJSON;
function ActivatePrepaidCardCriteriaFromJSONTyped(json, ignoreDiscriminator) {
...
exports.ActivatePrepaidCardCriteriaFromJSONTyped = ActivatePrepaidCardCriteriaFromJSONTyped;
function ActivatePrepaidCardCriteriaToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
...
exports.ActivatePrepaidCardCriteriaToJSON = ActivatePrepaidCardCriteriaToJSON;
