 ...
 */
function instanceOfBatchDepositType(value) {
    let isInstance = true;
    return isInstance;
}
exports.instanceOfBatchDepositType = instanceOfBatchDepositType;
function BatchDepositTypeFromJSON(json) {
    return BatchDepositTypeFromJSONTyped(json, false);
}
exports.BatchDepositTypeFromJSON = BatchDepositTypeFromJSON;
function BatchDepositTypeFromJSONTyped(json, ignoreDiscriminator) {
...
function BatchDepositTypeToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
