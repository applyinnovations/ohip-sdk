 ...
 */
export function instanceOfAdjustmentDetailsType(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function AdjustmentDetailsTypeFromJSON(json: any): AdjustmentDetailsType {
    return AdjustmentDetailsTypeFromJSONTyped(json, false);
}

export function AdjustmentDetailsTypeFromJSONTyped(json: any, ignoreDiscriminator: boolean): AdjustmentDetailsType {
...
export function AdjustmentDetailsTypeToJSON(value?: AdjustmentDetailsType | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
