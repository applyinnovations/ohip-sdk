 ...
 */
export function instanceOfPostArticlesSaleRequest(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function PostArticlesSaleRequestFromJSON(json: any): PostArticlesSaleRequest {
    return PostArticlesSaleRequestFromJSONTyped(json, false);
}

export function PostArticlesSaleRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): PostArticlesSaleRequest {
...
export function PostArticlesSaleRequestToJSON(value?: PostArticlesSaleRequest | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
