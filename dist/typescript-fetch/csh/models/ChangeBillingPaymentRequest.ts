 ...
 */
export function instanceOfChangeBillingPaymentRequest(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function ChangeBillingPaymentRequestFromJSON(json: any): ChangeBillingPaymentRequest {
    return ChangeBillingPaymentRequestFromJSONTyped(json, false);
}

export function ChangeBillingPaymentRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): ChangeBillingPaymentRequest {
...
export function ChangeBillingPaymentRequestToJSON(value?: ChangeBillingPaymentRequest | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
