 ...
 */
export declare function instanceOfPostedBillingChargesInBatch(value: object): boolean;
export declare function PostedBillingChargesInBatchFromJSON(json: any): PostedBillingChargesInBatch;
export declare function PostedBillingChargesInBatchFromJSONTyped(json: any, ignoreDiscriminator: boolean): PostedBillingChargesInBatch;
export declare function PostedBillingChargesInBatchToJSON(value?: PostedBillingChargesInBatch | null): any;
