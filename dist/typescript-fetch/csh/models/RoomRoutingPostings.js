 ...
 */
function instanceOfRoomRoutingPostings(value) {
    let isInstance = true;
    return isInstance;
}
exports.instanceOfRoomRoutingPostings = instanceOfRoomRoutingPostings;
function RoomRoutingPostingsFromJSON(json) {
    return RoomRoutingPostingsFromJSONTyped(json, false);
}
exports.RoomRoutingPostingsFromJSON = RoomRoutingPostingsFromJSON;
function RoomRoutingPostingsFromJSONTyped(json, ignoreDiscriminator) {
...
function RoomRoutingPostingsToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
