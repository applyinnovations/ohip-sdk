 ...
 */
function instanceOfBillingPaymentToChange(value) {
    let isInstance = true;
    return isInstance;
}
exports.instanceOfBillingPaymentToChange = instanceOfBillingPaymentToChange;
function BillingPaymentToChangeFromJSON(json) {
    return BillingPaymentToChangeFromJSONTyped(json, false);
}
exports.BillingPaymentToChangeFromJSON = BillingPaymentToChangeFromJSON;
function BillingPaymentToChangeFromJSONTyped(json, ignoreDiscriminator) {
...
function BillingPaymentToChangeToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
