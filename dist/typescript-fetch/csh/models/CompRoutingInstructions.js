 ...
 */
function instanceOfCompRoutingInstructions(value) {
    let isInstance = true;
    return isInstance;
}
exports.instanceOfCompRoutingInstructions = instanceOfCompRoutingInstructions;
function CompRoutingInstructionsFromJSON(json) {
    return CompRoutingInstructionsFromJSONTyped(json, false);
}
exports.CompRoutingInstructionsFromJSON = CompRoutingInstructionsFromJSON;
function CompRoutingInstructionsFromJSONTyped(json, ignoreDiscriminator) {
...
function CompRoutingInstructionsToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
