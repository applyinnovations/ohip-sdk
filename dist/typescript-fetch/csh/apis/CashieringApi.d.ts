...
export declare class CashieringApi extends runtime.BaseAPI {
     ...
     */
    changeTransactionCoversRaw(requestParameters: ChangeTransactionCoversRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Status>>;
    /**
     * You can use this API to change Trx Covers. <p><strong>OperationId:</strong>changeTransactionCovers</p>
     * Change Transaction Covers
     */
    changeTransactionCovers(requestParameters: ChangeTransactionCoversRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Status>;
    /**
     ...
     */
    getReservationVouchersRaw(requestParameters: GetReservationVouchersRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ReservationVouchersType>>;
    /**
     * This API is used to fetch the list of vouchers from a reservation. <p><strong>OperationId:</strong>getReservationVouchers</p>
     * Get the list of vouchers generated for a reservation.
     */
    getReservationVouchers(requestParameters: GetReservationVouchersRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<ReservationVouchersType>;
    /**
     ...
     */
    getReservationsVouchersRaw(requestParameters: GetReservationsVouchersRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ReservationVouchersType>>;
    /**
     * This API is used to fetch the list of vouchers from a list of reservations. <p><strong>OperationId:</strong>getReservationsVouchers</p>
     * Get the list of vouchers generated from a list of reservations.
     */
    getReservationsVouchers(requestParameters: GetReservationsVouchersRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<ReservationVouchersType>;
    /**
     ...
     */
    getTransactionCoversRaw(requestParameters: GetTransactionCoversRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<CoversInfo>>;
    /**
     * You can use this API to get Trx Covers. <p><strong>OperationId:</strong>getTransactionCovers</p>
     * Get transaction covers
     */
    getTransactionCovers(requestParameters: GetTransactionCoversRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<CoversInfo>;
    /**
     ...
     */
    postBulkPrepaidCardsRaw(requestParameters: PostBulkPrepaidCardsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<BulkPrepaidCardsType>>;
    /**
     * You can use this API to create multiple Prepaid Cards. <p><strong>OperationId:</strong>postBulkPrepaidCards</p>
     * Create multiple Prepaid Cards
     */
    postBulkPrepaidCards(requestParameters: PostBulkPrepaidCardsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<BulkPrepaidCardsType>;
    /**
     ...
     */
    postChargesAndPaymentsRaw(requestParameters: PostChargesAndPaymentsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Status>>;
    /**
     * You can use this API to post charges and payments on a reservation.This operation can be used to enforce Payment for additional charges posted on the reservation <p><strong>OperationId:</strong>postChargesAndPayments</p>
     * Post charges and payments on a reservation
     */
    postChargesAndPayments(requestParameters: PostChargesAndPaymentsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Status>;
    /**
     ...
     */
    postGenerateBatchVouchersRaw(requestParameters: PostGenerateBatchVouchersRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Status>>;
    /**
     * This api can be used to generate Batch Vouchers. <p><strong>OperationId:</strong>postGenerateBatchVouchers</p>
     * Generate Batch Vouchers
     */
    postGenerateBatchVouchers(requestParameters: PostGenerateBatchVouchersRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Status>;
    /**
     ...
     * Create proforma
     */
    postProformaFolioRaw(requestParameters: PostProformaFolioRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ProformaFolio>>;
    /**
     * API to create Pro-Forma for a specific reservation for external partners.<p><strong>OperationId:</strong>postProformaFolio</p> <p><strong>OperationId:</strong>postProformaFolio</p>
     * Create proforma
     */
    postProformaFolio(requestParameters: PostProformaFolioRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<ProformaFolio>;
    /**
     ...
     */
    postReservationVouchersRaw(requestParameters: PostReservationVouchersRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Status>>;
    /**
     * Generate vouchers for the reservation. <p><strong>OperationId:</strong>postReservationVouchers</p>
     * Generate Reservation Vouchers
     */
    postReservationVouchers(requestParameters: PostReservationVouchersRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Status>;
    /**
     ...
     */
    transitionDepositToGuestFolioRaw(requestParameters: TransitionDepositToGuestFolioRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<DepositTransitionStatus>>;
    /**
     * You can use this API to Transfer Deposit to Guest Folio. <p><strong>OperationId:</strong>transitionDepositToGuestFolio</p>
     * Transition Deposit to Guest Folio
     */
    transitionDepositToGuestFolio(requestParameters: TransitionDepositToGuestFolioRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<DepositTransitionStatus>;
    /**
 ...
 * @export
 */
export declare const GetValidateFiscalPrintingDetailsCashieringEventTypeEnum: {
    readonly CheckOut: "CheckOut";
    readonly EarlyDeparture: "EarlyDeparture";
    readonly AdvanceBill: "AdvanceBill";
    readonly InterimBill: "InterimBill";
    ...
    readonly PostIt: "PostIt";
    readonly CreditBill: "CreditBill";
    readonly ChargesAndPayments: "ChargesAndPayments";
    readonly Deposit: "Deposit";
    readonly DepositRefund: "DepositRefund";
    readonly AutoFolio: "AutoFolio";
    readonly PrepaidCard: "PrepaidCard";
