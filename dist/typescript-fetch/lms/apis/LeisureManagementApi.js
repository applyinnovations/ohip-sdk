...
class LeisureManagementApi extends runtime.BaseAPI {
     ...
     * Send a response to Cancellation of an Activity Booking
     */
    deleteActivityBookingForProfileRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
     ...
     * Send a response to Cancellation of an Activity Booking
     */
    deleteActivityBookingForProfile(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield this.deleteActivityBookingForProfileRaw(requestParameters, initOverrides);
            return yield response.value();
        });
    }
    /**
     ...
     * Send a response to Creation of Activity Booking
     */
    postActivityBookingForProfileRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            if (requestParameters.profileId === null || requestParameters.profileId === undefined) {
            ...
            const response = yield this.request({
                ...
                headers: headerParameters,
                query: queryParameters,
                body: (0, index_1.CreateActivityBookingToJSON)(requestParameters.createActivityBookingForProfile),
            }, initOverrides);
            return new runtime.JSONApiResponse(response, (jsonValue) => (0, index_1.StatusFromJSON)(jsonValue));
        });
    }
     ...
     * Send a response to Creation of Activity Booking
     */
    postActivityBookingForProfile(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield this.postActivityBookingForProfileRaw(requestParameters, initOverrides);
            return yield response.value();
        });
    }
    /**
     ...
     * Send a response to Change in Activity Booking
     */
    putActivityBookingForProfileRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            if (requestParameters.profileId === null || requestParameters.profileId === undefined) {
            ...
            const response = yield this.request({
                ...
                headers: headerParameters,
                query: queryParameters,
                body: (0, index_1.ChangeActivityBookingToJSON)(requestParameters.changeActivityBookingForProfile),
            }, initOverrides);
            return new runtime.JSONApiResponse(response, (jsonValue) => (0, index_1.ActivityBookingModifiedFromJSON)(jsonValue));
        });
    }
     ...
     * Send a response to Change in Activity Booking
     */
    putActivityBookingForProfile(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield this.putActivityBookingForProfileRaw(requestParameters, initOverrides);
            return yield response.value();
        });
    }
}
