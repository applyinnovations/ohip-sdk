...
export declare class LeisureManagementApi extends runtime.BaseAPI {
     ...
     * Send a response to Cancellation of an Activity Booking
     */
    deleteActivityBookingForProfileRaw(requestParameters: DeleteActivityBookingForProfileRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Status>>;
    /**
     * This API will send a response to Cancellation of an Activity Booking. <p><strong>OperationId:</strong>deleteActivityBooking</p>
     * Send a response to Cancellation of an Activity Booking
     */
    deleteActivityBookingForProfile(requestParameters: DeleteActivityBookingForProfileRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Status>;
    /**
     ...
     * Send a response to Creation of Activity Booking
     */
    postActivityBookingForProfileRaw(requestParameters: PostActivityBookingForProfileRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Status>>;
    /**
     * This API will send a response to Creation of Activity Booking. <p><strong>OperationId:</strong>postActivityBooking</p>
     * Send a response to Creation of Activity Booking
     */
    postActivityBookingForProfile(requestParameters: PostActivityBookingForProfileRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Status>;
    /**
     ...
     * Send a response to Change in Activity Booking
     */
    putActivityBookingForProfileRaw(requestParameters: PutActivityBookingForProfileRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ActivityBookingModified>>;
    /**
     * This API will send a response to a  Change in Activity Booking request from external Activity Scheduler system. <p><strong>OperationId:</strong>putActivityBookingForProfile</p>
     * Send a response to Change in Activity Booking
     */
    putActivityBookingForProfile(requestParameters: PutActivityBookingForProfileRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<ActivityBookingModified>;
}
