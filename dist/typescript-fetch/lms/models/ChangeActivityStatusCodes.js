 ...
 */
function instanceOfChangeActivityStatusCodes(value) {
    let isInstance = true;
    return isInstance;
}
exports.instanceOfChangeActivityStatusCodes = instanceOfChangeActivityStatusCodes;
function ChangeActivityStatusCodesFromJSON(json) {
    return ChangeActivityStatusCodesFromJSONTyped(json, false);
}
exports.ChangeActivityStatusCodesFromJSON = ChangeActivityStatusCodesFromJSON;
function ChangeActivityStatusCodesFromJSONTyped(json, ignoreDiscriminator) {
...
function ChangeActivityStatusCodesToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
