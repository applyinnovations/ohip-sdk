 ...
 */
export declare function instanceOfCopyActivityTypesRS(value: object): boolean;
export declare function CopyActivityTypesRSFromJSON(json: any): CopyActivityTypesRS;
export declare function CopyActivityTypesRSFromJSONTyped(json: any, ignoreDiscriminator: boolean): CopyActivityTypesRS;
export declare function CopyActivityTypesRSToJSON(value?: CopyActivityTypesRS | null): any;
