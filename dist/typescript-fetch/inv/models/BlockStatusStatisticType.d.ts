 ...
 */
export declare function instanceOfBlockStatusStatisticType(value: object): boolean;
export declare function BlockStatusStatisticTypeFromJSON(json: any): BlockStatusStatisticType;
export declare function BlockStatusStatisticTypeFromJSONTyped(json: any, ignoreDiscriminator: boolean): BlockStatusStatisticType;
export declare function BlockStatusStatisticTypeToJSON(value?: BlockStatusStatisticType | null): any;
