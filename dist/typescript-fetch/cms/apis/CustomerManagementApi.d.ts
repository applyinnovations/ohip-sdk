...
export declare class CustomerManagementApi extends runtime.BaseAPI {
    ...
    /**
     * You can fetch a list of Calendar Tasks for with this API, for one or more properties. <p><strong>OperationId:</strong>getCalendarTasks</p> <p>This API allows a time span of <strong>90</strong> days.</p>
     * Get Calendar Tasks
     */
