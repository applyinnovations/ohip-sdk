...
class ProfileMembershipApi extends runtime.BaseAPI {
     ...
     */
    deleteMembershipPromotionRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
     ...
     * Delete membership promotion of a guest
     */
    deleteMembershipPromotion(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield this.deleteMembershipPromotionRaw(requestParameters, initOverrides);
            return yield response.value();
        });
    }
    /**
     ...
     * Get  membership points to expire
     */
    getMemberPointsToExpireByCardNoRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return new runtime.JSONApiResponse(response, (jsonValue) => (0, index_1.MemberPointsToExpireCollectionFromJSON)(jsonValue));
        });
    }
    /**
     * Use this API to retrieve your Points To Expire by by specifying membership card number and membership card type. This operation can return more than one membership points to expire if duplicate card numbers are allowed in the configuration. <p><strong>OperationId:</strong>getMemberPointsToExpireByCardNo</p>
     * Get  membership points to expire
     */
    getMemberPointsToExpireByCardNo(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield this.getMemberPointsToExpireByCardNoRaw(requestParameters, initOverrides);
            return yield response.value();
        });
    }
    /**
     ...
     */
    getMembershipCardHistoryRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return new runtime.JSONApiResponse(response, (jsonValue) => (0, index_1.MemberCardHistoryListFromJSON)(jsonValue));
        });
    }
    /**
     * Use this API to retrieve membership card history on a profile. <p><strong>OperationId:</strong>getMembershipCardHistory</p>
     * Get membership card history information on a profile
     */
    getMembershipCardHistory(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield this.getMembershipCardHistoryRaw(requestParameters, initOverrides);
            return yield response.value();
        });
    }
    /**
     ...
     */
    getMembershipPointsExceptionsRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return new runtime.JSONApiResponse(response, (jsonValue) => (0, index_1.MemberPointsExceptionsFromJSON)(jsonValue));
        });
    }
    /**
     * Use this API to get membership points exceptions.<p><strong>OperationId:</strong>getMembershipPointsExceptions</p><br>The maximum date Range supported between arrival and departure date is 90 days.
     * Get membership points exception details
     */
    getMembershipPointsExceptions(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield this.getMembershipPointsExceptionsRaw(requestParameters, initOverrides);
            return yield response.value();
        });
    }
    /**
     ...
     */
    getMembershipPromotionsRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            if (requestParameters.membershipId === null || requestParameters.membershipId === undefined) {
            ...
            return new runtime.JSONApiResponse(response, (jsonValue) => (0, index_1.MembershipPromotionsDetailsFromJSON)(jsonValue));
        });
    }
    /**
     * Use this API to retrieve your available promotions by membershipId. <p><strong>OperationId:</strong>getMembershipPromotions</p>
     * Fetch membership promotions of a guest
     */
    getMembershipPromotions(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield this.getMembershipPromotionsRaw(requestParameters, initOverrides);
            return yield response.value();
        });
    }
    /**
     ...
     */
    getMembershipReservationActivityRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return new runtime.JSONApiResponse(response, (jsonValue) => (0, index_1.MembershipReservationDetailsFromJSON)(jsonValue));
        });
    }
    /**
     * This API is useful to retrieve membership reservation activity for the day(ExpectedArrival, ExpectedDepartures, InHouse, Projected Room Revenue) <p><strong>OperationId:</strong>getMembershipReservationActivity</p>
     * Get Membership Reservation Activity
     */
    getMembershipReservationActivity(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield this.getMembershipReservationActivityRaw(requestParameters, initOverrides);
            return yield response.value();
        });
    }
    /**
     ...
     * Get membership transactions
     */
    getMembershipTransactionsSummaryByCardNoRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            if (requestParameters.membershipCardNo === null || requestParameters.membershipCardNo === undefined) {
            ...
            return new runtime.JSONApiResponse(response, (jsonValue) => (0, index_1.MembershipTransactionsSummaryCollectionFromJSON)(jsonValue));
        });
    }
    /**
     * Get membership transactions summary information by specifying membership card number and membership card type, this operation can return more than one membership transactions if duplicate card numbers allowed in the configuration. <p><strong>OperationId:</strong>getMembershipTransactionsSummaryByCardNo</p>
     * Get membership transactions
     */
    getMembershipTransactionsSummaryByCardNo(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield this.getMembershipTransactionsSummaryByCardNoRaw(requestParameters, initOverrides);
            return yield response.value();
        });
    }
    /**
     ...
     */
    issueOtherAwardsRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const response = yield this.request({
                ...
                headers: headerParameters,
                query: queryParameters,
                body: (0, index_1.OtherAwardsIssueCriteriaToJSON)(requestParameters.otherAwardsIssueCriteria),
            }, initOverrides);
            return new runtime.JSONApiResponse(response, (jsonValue) => (0, index_1.IssuedAwardFromJSON)(jsonValue));
        });
    }
    /**
     * This API will allow you to issue OTHER type award based on membership id or membership type and membership card number <p><strong>OperationId:</strong>issueOtherAwards</p>
     * Issue an OTHER type award
     */
    issueOtherAwards(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield this.issueOtherAwardsRaw(requestParameters, initOverrides);
            return yield response.value();
        });
    }
    /**
     ...
     */
    pingMembershipServiceRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            const queryParameters = {};
            const headerParameters = {};
            if (requestParameters.authorization !== undefined && requestParameters.authorization !== null) {
     ...
     * Operation to check status of ProfileMembership service
     */
    pingMembershipService(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield this.pingMembershipServiceRaw(requestParameters, initOverrides);
            return yield response.value();
        });
    }
    /**
     ...
     */
    postMembershipPromotionRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            if (requestParameters.membershipId === null || requestParameters.membershipId === undefined) {
            ...
            const response = yield this.request({
                ...
                headers: headerParameters,
                query: queryParameters,
                body: (0, index_1.MembershipPromotionDetailsToJSON)(requestParameters.membershipPromotion),
            }, initOverrides);
            return new runtime.JSONApiResponse(response, (jsonValue) => (0, index_1.StatusFromJSON)(jsonValue));
        });
    }
     ...
     * Create membership promotion of a guest
     */
    postMembershipPromotion(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield this.postMembershipPromotionRaw(requestParameters, initOverrides);
            return yield response.value();
        });
    }
    /**
     ...
     */
    putMembershipPointsExceptionsRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const response = yield this.request({
                ...
                headers: headerParameters,
                query: queryParameters,
                body: (0, index_1.MembershipPointsExceptionsToJSON)(requestParameters.membershipPointsExceptions),
            }, initOverrides);
            return new runtime.JSONApiResponse(response, (jsonValue) => (0, index_1.StatusFromJSON)(jsonValue));
        });
    }
     ...
     * Update membership points exceptions
     */
    putMembershipPointsExceptions(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield this.putMembershipPointsExceptionsRaw(requestParameters, initOverrides);
            return yield response.value();
        });
    }
    /**
     ...
     */
    putMembershipPromotionRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            if (requestParameters.membershipId === null || requestParameters.membershipId === undefined) {
     ...
     * Change membership promotion of a guest
     */
    putMembershipPromotion(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield this.putMembershipPromotionRaw(requestParameters, initOverrides);
            return yield response.value();
        });
    }
    /**
