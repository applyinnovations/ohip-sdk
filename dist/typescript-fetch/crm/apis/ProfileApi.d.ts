...
import type { AccountForecasts, AwardDetails, ChangeAccountForecastsRS, ChangeProfileOwnersRequest, ChangedMembership, CheckedProfiles, CityState, Company, DuplicateExternalSubscriptions, DuplicateOPERASubscriptions, ECertificateGeneration, ECertificateToConsume, ECertificateToExtend, ECertificateToVerify, ECertificates, FlexFieldValues, FlexFieldsResponse, ForecastsInformation, ForgetProfilesCriteria, FulfillmentExportedLogs, FuturePastBookings, FuturePastBookingsCriteria, Guest, InstanceLink, LinkedProfiles, MatchListType, MatchedProfiles, Membership, MembershipNumber, MembershipTierProjections, MergeProfilesRequest, MergedProfilesSnapshotDetails, MergedStageProfileSnapshot, OperaVersion, PostProfileRelationshipRequest, PostProfileRequest, Preference, ProcessedStagedProfile, Profile, ProfileAccounts, ProfileActivityLog, ProfileAttachments, ProfileCashieringDetails, ProfileCashieringDetailsInfo, ProfileCommissionAccount, ProfileCommissionAccountCopy, ProfileCommissionAccountInfo, ProfileDetails, ProfileMatch, ProfileOwners, ProfileOwnersDetail, ProfileRelationships, ProfileStayHistory, ProfileSubscriptionsToSynchronize, ProfileSummaries, ProfileTransactions, ProfilesMatch, PutProfileByExtIdRequest, PutProfileRelationshipRequest, RecentlyAccessedProfiles, StagedProfile, StagedProfileCriteria, StagedProfileDetails, StagedProfiles, Status, StayMembershipDetails, StayRecordDetail, StayRecordDetails, StoreEmailRequest, SuspendedAddresses, SuspendedProfileErrorSummaryInfo, ValidatedForgetProfiles, VerifiedECertificate } from '../models/index';
...
export declare class ProfileApi extends runtime.BaseAPI {
     ...
     */
    addReplaceStayMembershipRaw(requestParameters: AddReplaceStayMembershipRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Status>>;
    /**
     * A user can add a new membership or substitute an existing membership for a stay record by providing the relevant membership information in the request.<p><strong>OperationId:</strong>addReplaceStayMembership</p>
     * This API facilitates attaching or replacing a membership to a given stayRecord.
     */
    addReplaceStayMembership(requestParameters: AddReplaceStayMembershipRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Status>;
    /**
     ...
     */
    clearProfileServiceCacheRaw(requestParameters: ClearProfileServiceCacheRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Status>>;
    /**
     *  <p><strong>OperationId:</strong>clearProfileServiceCache</p>
     * Operation to delete cache for Profile service
     */
    clearProfileServiceCache(requestParameters: ClearProfileServiceCacheRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Status>;
    /**
     ...
     */
    deleteProfileFlexFieldValueRaw(requestParameters: DeleteProfileFlexFieldValueRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Status>>;
    /**
     * Operation to delete a flex field Value. <p><strong>OperationId:</strong>deleteFlexFieldValue</p>
     * Operation to delete a flex field.
     */
    deleteProfileFlexFieldValue(requestParameters: DeleteProfileFlexFieldValueRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Status>;
    /**
     * This API can be used to delete a staged profile. <p><strong>OperationId:</strong>deleteStagedProfile</p>
     * Delete a staged profile
     */
    deleteStagedProfileRaw(requestParameters: DeleteStagedProfileRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Status>>;
    /**
     * This API can be used to delete a staged profile. <p><strong>OperationId:</strong>deleteStagedProfile</p>
     * Delete a staged profile
     */
    deleteStagedProfile(requestParameters: DeleteStagedProfileRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Status>;
    /**
     ...
     */
    getAllProfileFlexFieldValuesRaw(requestParameters: GetAllProfileFlexFieldValuesRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<FlexFieldsResponse>>;
    /**
     * API to fetch flex field values. <p><strong>OperationId:</strong>getAllFlexFieldValues</p>
     * Operation to fetch flex field values.
     */
    getAllProfileFlexFieldValues(requestParameters: GetAllProfileFlexFieldValuesRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<FlexFieldsResponse>;
    /**
     ...
     * Operation to fetch flex field values.
     */
    getProfileFlexFieldValueRaw(requestParameters: GetProfileFlexFieldValueRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<FlexFieldsResponse>>;
    /**
     * API to fetch flex field values. <p><strong>OperationId:</strong>getFlexFieldValue</p>
     * Operation to fetch flex field values.
     */
    getProfileFlexFieldValue(requestParameters: GetProfileFlexFieldValueRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<FlexFieldsResponse>;
    /**
     ...
     */
    getProfileMatchRaw(requestParameters: GetProfileMatchRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ProfileMatch>>;
    /**
     * Use this operation to fetch guest profile (profile Id). This operation can be integrated with createReservation API, to prevent creation of duplicate profiles.<p><strong>OperationId:</strong>getProfileMatch</p>
     * Fetch the profile Id if a unique guest profile Exists
     */
    getProfileMatch(requestParameters: GetProfileMatchRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<ProfileMatch>;
    /**
     ...
     */
    getProfileTransactionsRaw(requestParameters: GetProfileTransactionsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ProfileTransactions>>;
    /**
     * Retrieve the Transactions associated to a profile related to Stay Records or Membership Adjustments.<p><strong>OperationId:</strong>getProfileTransactions</p> <p>This API allows a time span of <strong>90</strong> days.</p>
     * Get Profile Transactions
     */
    getProfileTransactions(requestParameters: GetProfileTransactionsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<ProfileTransactions>;
    /**
     ...
     */
    getProfilesMatchListRaw(requestParameters: GetProfilesMatchListRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ProfilesMatch>>;
    /**
     * This API provides list of matching profiles based on the profile match configuration. These profiles are matched based on address, Postal codes, Last Name etc.<p><strong>OperationId:getProfilesMatchList</strong></p> <p>The maximum allowable limit for this API is <strong>200</strong>.</p>
     * Get profiles match list.
     */
    getProfilesMatchList(requestParameters: GetProfilesMatchListRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<ProfilesMatch>;
    /**
     ...
     */
    getStayRecordDetailRaw(requestParameters: GetStayRecordDetailRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<StayRecordDetail>>;
    /**
     * This API is used to retrieve details of a given stay record (including UDFs, Daily Rates and Revenue). <p><strong>OperationId:</strong>getStayRecordDetail</p>
     * Get Stay Record Detail.
     */
    getStayRecordDetail(requestParameters: GetStayRecordDetailRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<StayRecordDetail>;
    /**
     ...
     */
    pingProfileServiceRaw(requestParameters: PingProfileServiceRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<OperaVersion>>;
    /**
     *  <p><strong>OperationId:</strong>pingProfileService</p>
     * Operation to check the status of profile service
     */
    pingProfileService(requestParameters: PingProfileServiceRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<OperaVersion>;
    /**
     ...
     */
    postProfileFlexFieldValueRaw(requestParameters: PostProfileFlexFieldValueRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Status>>;
    /**
     * Operation to create a flex field Value. <p><strong>OperationId:</strong>postFlexFieldValue</p>
     * Operation to create a flex field with value for a module.
     */
    postProfileFlexFieldValue(requestParameters: PostProfileFlexFieldValueRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Status>;
    /**
     ...
     */
    postStayRecordRaw(requestParameters: PostStayRecordRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Array<InstanceLink>>>;
    /**
     * A user can upload stay record to OPERA by specifying stay record column details in the request.<p><strong>OperationId:</strong>postStayRecord</p>
     * This API facilitates uploading stage records to LCS.
     */
    postStayRecord(requestParameters: PostStayRecordRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Array<InstanceLink>>;
    /**
     ...
     */
    processStagedProfileRaw(requestParameters: ProcessStagedProfileRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ProcessedStagedProfile>>;
    /**
     * Use this API to process one profile that has been staged. <p><strong>OperationId:</strong>processStagedProfile</p>
     * Process a staged profile
     */
    processStagedProfile(requestParameters: ProcessStagedProfileRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<ProcessedStagedProfile>;
    /**
     ...
     */
    putProfileRaw(requestParameters: PutProfileRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Profile>>;
    /**
     * Use this to update a guests details on their profile.  You will need to know the OPERA Profile ID to use this API, and you will also need to know the List of Values for profile fields, such as AddressType, PhoneType, Title.  <p><strong>OperationId:</strong>putProfile</p>
     * Update a profile by ID
     */
    putProfile(requestParameters: PutProfileRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Profile>;
    /**
     ...
     */
    putProfileByExtIdRaw(requestParameters: PutProfileByExtIdOperationRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Profile>>;
    /**
     * Use this API to update guests details on profile.  You will need to know the External Profile ID and external system code to use this API. <p><strong>OperationId:</strong>putProfileByExtId</p>
     * Update by external ID
     */
    putProfileByExtId(requestParameters: PutProfileByExtIdOperationRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Profile>;
    /**
     * Operation to update flex field value. <p><strong>OperationId:</strong>putFlexFieldValue</p>
     * Operation to update flex field value.
     */
    putProfileFlexFieldValueRaw(requestParameters: PutProfileFlexFieldValueRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Status>>;
    /**
     * Operation to update flex field value. <p><strong>OperationId:</strong>putFlexFieldValue</p>
     * Operation to update flex field value.
     */
    putProfileFlexFieldValue(requestParameters: PutProfileFlexFieldValueRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Status>;
    /**
     ...
     */
    putProfilesMatchListRaw(requestParameters: PutProfilesMatchListRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Status>>;
    /**
     * Use this API to update a list of records of profiles match to skip or don\'t skip profile match
     * Updates a list of matchIds to skip or don\'t skip profile match.
     */
    putProfilesMatchList(requestParameters: PutProfilesMatchListRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Status>;
    /**
 ...
 * @export
 */
export declare const GetStagedProfilesStagedReasonsEnum: {
    readonly InvalidEnrollmentCode: "InvalidEnrollmentCode";
    readonly EmptyEnrollmentCode: "EmptyEnrollmentCode";
    readonly NameChange: "NameChange";
    readonly InvalidExpirationDate: "InvalidExpirationDate";
    readonly EmptyExpirationDate: "EmptyExpirationDate";
    readonly EmptyMembershipLevel: "EmptyMembershipLevel";
    readonly InvalidMembershipLevel: "InvalidMembershipLevel";
    readonly DuplicateMembership: "DuplicateMembership";
};
 ...
 * @export
 */
export declare const GetStayRecordDetailFetchInstructionsEnum: {
    readonly Udf: "UDF";
