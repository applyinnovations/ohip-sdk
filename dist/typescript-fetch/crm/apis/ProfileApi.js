...
class ProfileApi extends runtime.BaseAPI {
     ...
     */
    addReplaceStayMembershipRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            if (requestParameters.stayMembershipDetails === null || requestParameters.stayMembershipDetails === undefined) {
                throw new runtime.RequiredError('stayMembershipDetails', 'Required parameter requestParameters.stayMembershipDetails was null or undefined when calling addReplaceStayMembership.');
            }
            ...
            const response = yield this.request({
                ...
                body: (0, index_1.StayMembershipDetailsToJSON)(requestParameters.stayMembershipDetails),
            }, initOverrides);
     ...
     * This API facilitates attaching or replacing a membership to a given stayRecord.
     */
    addReplaceStayMembership(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield this.addReplaceStayMembershipRaw(requestParameters, initOverrides);
     ...
     */
    clearProfileServiceCacheRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            const queryParameters = {};
            const headerParameters = {};
            if (requestParameters.authorization !== undefined && requestParameters.authorization !== null) {
            ...
            const response = yield this.request({
                path: `/service/profileService/cache`,
                method: 'DELETE',
                headers: headerParameters,
                query: queryParameters,
            }, initOverrides);
     ...
     * Operation to delete cache for Profile service
     */
    clearProfileServiceCache(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield this.clearProfileServiceCacheRaw(requestParameters, initOverrides);
            return yield response.value();
        });
    }
    /**
     ...
     */
    deleteProfileFlexFieldValueRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            if (requestParameters.flexFieldCode === null || requestParameters.flexFieldCode === undefined) {
                throw new runtime.RequiredError('flexFieldCode', 'Required parameter requestParameters.flexFieldCode was null or undefined when calling deleteProfileFlexFieldValue.');
            }
            if (requestParameters.hotelId === null || requestParameters.hotelId === undefined) {
                throw new runtime.RequiredError('hotelId', 'Required parameter requestParameters.hotelId was null or undefined when calling deleteProfileFlexFieldValue.');
            }
            if (requestParameters.profileId === null || requestParameters.profileId === undefined) {
                throw new runtime.RequiredError('profileId', 'Required parameter requestParameters.profileId was null or undefined when calling deleteProfileFlexFieldValue.');
            }
            const queryParameters = {};
            const headerParameters = {};
            if (requestParameters.authorization !== undefined && requestParameters.authorization !== null) {
            ...
            const response = yield this.request({
                path: `/hotels/{hotelId}/profiles/{profileId}/flexFieldCode/{flexFieldCode}`.replace(`{${"flexFieldCode"}}`, encodeURIComponent(String(requestParameters.flexFieldCode))).replace(`{${"hotelId"}}`, encodeURIComponent(String(requestParameters.hotelId))).replace(`{${"profileId"}}`, encodeURIComponent(String(requestParameters.profileId))),
                method: 'DELETE',
                headers: headerParameters,
                query: queryParameters,
            }, initOverrides);
     ...
     * Operation to delete a flex field.
     */
    deleteProfileFlexFieldValue(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield this.deleteProfileFlexFieldValueRaw(requestParameters, initOverrides);
            return yield response.value();
        });
    }
    /**
     ...
     */
    deleteStagedProfileRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            if (requestParameters.profileId === null || requestParameters.profileId === undefined) {
                throw new runtime.RequiredError('profileId', 'Required parameter requestParameters.profileId was null or undefined when calling deleteStagedProfile.');
            }
            if (requestParameters.hotelId === null || requestParameters.hotelId === undefined) {
                throw new runtime.RequiredError('hotelId', 'Required parameter requestParameters.hotelId was null or undefined when calling deleteStagedProfile.');
            }
            const queryParameters = {};
            const headerParameters = {};
            if (requestParameters.authorization !== undefined && requestParameters.authorization !== null) {
            ...
            const response = yield this.request({
                path: `/profiles/{profileId}/hotels/{hotelId}/stagedProfile`.replace(`{${"profileId"}}`, encodeURIComponent(String(requestParameters.profileId))).replace(`{${"hotelId"}}`, encodeURIComponent(String(requestParameters.hotelId))),
                method: 'DELETE',
                headers: headerParameters,
                query: queryParameters,
            }, initOverrides);
     ...
     * Delete a staged profile
     */
    deleteStagedProfile(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield this.deleteStagedProfileRaw(requestParameters, initOverrides);
            return yield response.value();
        });
    }
    /**
     ...
     */
    getAllProfileFlexFieldValuesRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            if (requestParameters.profileId === null || requestParameters.profileId === undefined) {
                throw new runtime.RequiredError('profileId', 'Required parameter requestParameters.profileId was null or undefined when calling getAllProfileFlexFieldValues.');
            }
            if (requestParameters.hotelIds === null || requestParameters.hotelIds === undefined) {
                throw new runtime.RequiredError('hotelIds', 'Required parameter requestParameters.hotelIds was null or undefined when calling getAllProfileFlexFieldValues.');
            }
            const queryParameters = {};
            ...
            if (requestParameters.flexFieldCode !== undefined) {
                queryParameters['flexFieldCode'] = requestParameters.flexFieldCode;
            }
            if (requestParameters.flexFieldValue !== undefined) {
                queryParameters['flexFieldValue'] = requestParameters.flexFieldValue;
            }
            if (requestParameters.limit !== undefined) {
                queryParameters['limit'] = requestParameters.limit;
            }
            ...
            const response = yield this.request({
                path: `/profiles/{profileId}/flexFieldValues`.replace(`{${"profileId"}}`, encodeURIComponent(String(requestParameters.profileId))),
                method: 'GET',
                headers: headerParameters,
                query: queryParameters,
            }, initOverrides);
            return new runtime.JSONApiResponse(response, (jsonValue) => (0, index_1.FlexFieldsResponseFromJSON)(jsonValue));
        });
    }
    /**
     * API to fetch flex field values. <p><strong>OperationId:</strong>getAllFlexFieldValues</p>
     * Operation to fetch flex field values.
     */
    getAllProfileFlexFieldValues(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield this.getAllProfileFlexFieldValuesRaw(requestParameters, initOverrides);
            return yield response.value();
        });
    }
    /**
    ...
    getProfileAttachmentsRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (requestParameters.attachedFileName !== undefined) {
                queryParameters['attachedFileName'] = requestParameters.attachedFileName;
            }
            if (requestParameters.description !== undefined) {
                queryParameters['description'] = requestParameters.description;
            }
     ...
     * Operation to fetch flex field values.
     */
    getProfileFlexFieldValueRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            if (requestParameters.hotelId === null || requestParameters.hotelId === undefined) {
                throw new runtime.RequiredError('hotelId', 'Required parameter requestParameters.hotelId was null or undefined when calling getProfileFlexFieldValue.');
            }
            if (requestParameters.profileId === null || requestParameters.profileId === undefined) {
                throw new runtime.RequiredError('profileId', 'Required parameter requestParameters.profileId was null or undefined when calling getProfileFlexFieldValue.');
            }
            const queryParameters = {};
            if (requestParameters.flexFieldId !== undefined) {
                queryParameters['flexFieldId'] = requestParameters.flexFieldId;
            ...
            const response = yield this.request({
                path: `/hotels/{hotelId}/profiles/{profileId}/flexFieldValues`.replace(`{${"hotelId"}}`, encodeURIComponent(String(requestParameters.hotelId))).replace(`{${"profileId"}}`, encodeURIComponent(String(requestParameters.profileId))),
                method: 'GET',
                headers: headerParameters,
                query: queryParameters,
            }, initOverrides);
     ...
     * Operation to fetch flex field values.
     */
    getProfileFlexFieldValue(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield this.getProfileFlexFieldValueRaw(requestParameters, initOverrides);
            return yield response.value();
        });
    }
    /**
     ...
     */
    getProfileMatchRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            if (requestParameters.lastName === null || requestParameters.lastName === undefined) {
                throw new runtime.RequiredError('lastName', 'Required parameter requestParameters.lastName was null or undefined when calling getProfileMatch.');
            }
            const queryParameters = {};
            ...
            if (requestParameters.identificationType !== undefined) {
                queryParameters['identificationType'] = requestParameters.identificationType;
            }
            if (requestParameters.identificationNumber !== undefined) {
                queryParameters['identificationNumber'] = requestParameters.identificationNumber;
            }
            if (requestParameters.email !== undefined) {
                queryParameters['email'] = requestParameters.email;
            }
            if (requestParameters.subscriptionType !== undefined) {
                queryParameters['subscriptionType'] = requestParameters.subscriptionType;
            }
            ...
            return new runtime.JSONApiResponse(response, (jsonValue) => (0, index_1.ProfileMatchFromJSON)(jsonValue));
        });
    }
    /**
     * Use this operation to fetch guest profile (profile Id). This operation can be integrated with createReservation API, to prevent creation of duplicate profiles.<p><strong>OperationId:</strong>getProfileMatch</p>
     * Fetch the profile Id if a unique guest profile Exists
     */
    getProfileMatch(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield this.getProfileMatchRaw(requestParameters, initOverrides);
            return yield response.value();
        });
    }
    /**
     ...
     */
    getProfileTransactionsRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            if (requestParameters.profileId === null || requestParameters.profileId === undefined) {
                throw new runtime.RequiredError('profileId', 'Required parameter requestParameters.profileId was null or undefined when calling getProfileTransactions.');
            }
            const queryParameters = {};
            ...
            const response = yield this.request({
                path: `/profileTransactions/{profileId}`.replace(`{${"profileId"}}`, encodeURIComponent(String(requestParameters.profileId))),
                method: 'GET',
                headers: headerParameters,
                query: queryParameters,
            }, initOverrides);
            return new runtime.JSONApiResponse(response, (jsonValue) => (0, index_1.ProfileTransactionsFromJSON)(jsonValue));
        });
    }
    /**
     * Retrieve the Transactions associated to a profile related to Stay Records or Membership Adjustments.<p><strong>OperationId:</strong>getProfileTransactions</p> <p>This API allows a time span of <strong>90</strong> days.</p>
     * Get Profile Transactions
     */
    getProfileTransactions(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield this.getProfileTransactionsRaw(requestParameters, initOverrides);
            return yield response.value();
        });
    }
    /**
     ...
     */
    getProfilesMatchListRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            if (requestParameters.profileType === null || requestParameters.profileType === undefined) {
                throw new runtime.RequiredError('profileType', 'Required parameter requestParameters.profileType was null or undefined when calling getProfilesMatchList.');
            }
            const queryParameters = {};
            if (requestParameters.registeredProperty !== undefined) {
                queryParameters['registeredProperty'] = requestParameters.registeredProperty;
            }
            if (requestParameters.computedDate !== undefined) {
                queryParameters['computedDate'] = requestParameters.computedDate;
            }
            ...
            if (requestParameters.doNotMerge !== undefined) {
                queryParameters['doNotMerge'] = requestParameters.doNotMerge;
            }
            if (requestParameters.aboveUpperThreshold !== undefined) {
                queryParameters['aboveUpperThreshold'] = requestParameters.aboveUpperThreshold;
            }
            if (requestParameters.belowUpperThreshold !== undefined) {
                queryParameters['belowUpperThreshold'] = requestParameters.belowUpperThreshold;
            }
            if (requestParameters.limit !== undefined) {
                queryParameters['limit'] = requestParameters.limit;
            }
            ...
            const response = yield this.request({
                path: `/profilesMatchList/profileType/{profileType}`.replace(`{${"profileType"}}`, encodeURIComponent(String(requestParameters.profileType))),
                method: 'GET',
                headers: headerParameters,
                query: queryParameters,
            }, initOverrides);
            return new runtime.JSONApiResponse(response, (jsonValue) => (0, index_1.ProfilesMatchFromJSON)(jsonValue));
        });
    }
    /**
     * This API provides list of matching profiles based on the profile match configuration. These profiles are matched based on address, Postal codes, Last Name etc.<p><strong>OperationId:getProfilesMatchList</strong></p> <p>The maximum allowable limit for this API is <strong>200</strong>.</p>
     * Get profiles match list.
     */
    getProfilesMatchList(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield this.getProfilesMatchListRaw(requestParameters, initOverrides);
            return yield response.value();
        });
    }
    /**
    ...
    getStagedProfilesRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (requestParameters.stagedReasons) {
                queryParameters['stagedReasons'] = requestParameters.stagedReasons;
            }
            if (requestParameters.id) {
                queryParameters['id'] = requestParameters.id;
            }
            ...
            if (requestParameters.insertDateFrom !== undefined) {
                queryParameters['insertDateFrom'] = requestParameters.insertDateFrom;
            }
            if (requestParameters.insertDateTo !== undefined) {
                queryParameters['insertDateTo'] = requestParameters.insertDateTo;
            }
     ...
     */
    getStayRecordDetailRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            if (requestParameters.stayRecordId === null || requestParameters.stayRecordId === undefined) {
                throw new runtime.RequiredError('stayRecordId', 'Required parameter requestParameters.stayRecordId was null or undefined when calling getStayRecordDetail.');
            }
            const queryParameters = {};
            if (requestParameters.fetchInstructions) {
                queryParameters['fetchInstructions'] = requestParameters.fetchInstructions;
            ...
            const response = yield this.request({
                path: `/stayRecord/{stayRecordId}`.replace(`{${"stayRecordId"}}`, encodeURIComponent(String(requestParameters.stayRecordId))),
                method: 'GET',
                headers: headerParameters,
                query: queryParameters,
            }, initOverrides);
            return new runtime.JSONApiResponse(response, (jsonValue) => (0, index_1.StayRecordDetailFromJSON)(jsonValue));
        });
    }
    /**
     * This API is used to retrieve details of a given stay record (including UDFs, Daily Rates and Revenue). <p><strong>OperationId:</strong>getStayRecordDetail</p>
     * Get Stay Record Detail.
     */
    getStayRecordDetail(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield this.getStayRecordDetailRaw(requestParameters, initOverrides);
            return yield response.value();
        });
    }
    /**
     ...
     */
    pingProfileServiceRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            const queryParameters = {};
            const headerParameters = {};
            if (requestParameters.authorization !== undefined && requestParameters.authorization !== null) {
     ...
     * Operation to check the status of profile service
     */
    pingProfileService(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield this.pingProfileServiceRaw(requestParameters, initOverrides);
            return yield response.value();
        });
    }
    /**
     ...
     */
    postProfileFlexFieldValueRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            if (requestParameters.hotelId === null || requestParameters.hotelId === undefined) {
                throw new runtime.RequiredError('hotelId', 'Required parameter requestParameters.hotelId was null or undefined when calling postProfileFlexFieldValue.');
            }
            if (requestParameters.profileId === null || requestParameters.profileId === undefined) {
                throw new runtime.RequiredError('profileId', 'Required parameter requestParameters.profileId was null or undefined when calling postProfileFlexFieldValue.');
            }
            if (requestParameters.flexFieldValueInfo === null || requestParameters.flexFieldValueInfo === undefined) {
                throw new runtime.RequiredError('flexFieldValueInfo', 'Required parameter requestParameters.flexFieldValueInfo was null or undefined when calling postProfileFlexFieldValue.');
            }
            const queryParameters = {};
            const headerParameters = {};
            headerParameters['Content-Type'] = 'application/json;charset=UTF-8';
            ...
            const response = yield this.request({
                ...
                headers: headerParameters,
                query: queryParameters,
                body: (0, index_1.FlexFieldValuesToJSON)(requestParameters.flexFieldValueInfo),
            }, initOverrides);
            return new runtime.JSONApiResponse(response, (jsonValue) => (0, index_1.StatusFromJSON)(jsonValue));
        });
    }
     ...
     * Operation to create a flex field with value for a module.
     */
    postProfileFlexFieldValue(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield this.postProfileFlexFieldValueRaw(requestParameters, initOverrides);
            return yield response.value();
        });
    }
    /**
     ...
     */
    postStayRecordRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            if (requestParameters.stayRecordDetails === null || requestParameters.stayRecordDetails === undefined) {
                throw new runtime.RequiredError('stayRecordDetails', 'Required parameter requestParameters.stayRecordDetails was null or undefined when calling postStayRecord.');
            }
            const queryParameters = {};
            const headerParameters = {};
            headerParameters['Content-Type'] = 'application/json;charset=UTF-8';
            ...
            const response = yield this.request({
                ...
                headers: headerParameters,
                query: queryParameters,
                body: (0, index_1.StayRecordDetailsToJSON)(requestParameters.stayRecordDetails),
            }, initOverrides);
     ...
     * This API facilitates uploading stage records to LCS.
     */
    postStayRecord(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield this.postStayRecordRaw(requestParameters, initOverrides);
            return yield response.value();
        });
    }
    /**
     ...
     */
    processStagedProfileRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            if (requestParameters.stagedProfileCriteria === null || requestParameters.stagedProfileCriteria === undefined) {
                throw new runtime.RequiredError('stagedProfileCriteria', 'Required parameter requestParameters.stagedProfileCriteria was null or undefined when calling processStagedProfile.');
            }
            const queryParameters = {};
            const headerParameters = {};
            headerParameters['Content-Type'] = 'application/json;charset=UTF-8';
            ...
            const response = yield this.request({
                path: `/processStagedProfile`,
                method: 'PUT',
                headers: headerParameters,
                query: queryParameters,
                body: (0, index_1.StagedProfileCriteriaToJSON)(requestParameters.stagedProfileCriteria),
            }, initOverrides);
            return new runtime.JSONApiResponse(response, (jsonValue) => (0, index_1.ProcessedStagedProfileFromJSON)(jsonValue));
        });
    }
    /**
     * Use this API to process one profile that has been staged. <p><strong>OperationId:</strong>processStagedProfile</p>
     * Process a staged profile
     */
    processStagedProfile(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield this.processStagedProfileRaw(requestParameters, initOverrides);
            return yield response.value();
        });
    }
    /**
    ...
    putProfileRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const response = yield this.request({
                ...
                headers: headerParameters,
                query: queryParameters,
                body: (0, index_1.PutProfileByExtIdRequestToJSON)(requestParameters.profile),
            }, initOverrides);
            return new runtime.JSONApiResponse(response, (jsonValue) => (0, index_1.ProfileFromJSON)(jsonValue));
        });
    }
     ...
     */
    putProfileByExtIdRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            if (requestParameters.profileExternalId === null || requestParameters.profileExternalId === undefined) {
                throw new runtime.RequiredError('profileExternalId', 'Required parameter requestParameters.profileExternalId was null or undefined when calling putProfileByExtId.');
            }
            if (requestParameters.extSystemCode === null || requestParameters.extSystemCode === undefined) {
                throw new runtime.RequiredError('extSystemCode', 'Required parameter requestParameters.extSystemCode was null or undefined when calling putProfileByExtId.');
            }
            if (requestParameters.profile === null || requestParameters.profile === undefined) {
                throw new runtime.RequiredError('profile', 'Required parameter requestParameters.profile was null or undefined when calling putProfileByExtId.');
            }
            const queryParameters = {};
            const headerParameters = {};
            headerParameters['Content-Type'] = 'application/json;charset=UTF-8';
     ...
     * Update by external ID
     */
    putProfileByExtId(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield this.putProfileByExtIdRaw(requestParameters, initOverrides);
            return yield response.value();
        });
    }
    /**
     ...
     */
    putProfileFlexFieldValueRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            if (requestParameters.hotelId === null || requestParameters.hotelId === undefined) {
                throw new runtime.RequiredError('hotelId', 'Required parameter requestParameters.hotelId was null or undefined when calling putProfileFlexFieldValue.');
            }
            if (requestParameters.profileId === null || requestParameters.profileId === undefined) {
                throw new runtime.RequiredError('profileId', 'Required parameter requestParameters.profileId was null or undefined when calling putProfileFlexFieldValue.');
            }
            if (requestParameters.flexFieldValueInfo === null || requestParameters.flexFieldValueInfo === undefined) {
                throw new runtime.RequiredError('flexFieldValueInfo', 'Required parameter requestParameters.flexFieldValueInfo was null or undefined when calling putProfileFlexFieldValue.');
            }
            const queryParameters = {};
            const headerParameters = {};
            headerParameters['Content-Type'] = 'application/json;charset=UTF-8';
     ...
     * Operation to update flex field value.
     */
    putProfileFlexFieldValue(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield this.putProfileFlexFieldValueRaw(requestParameters, initOverrides);
            return yield response.value();
        });
    }
    /**
     ...
     */
    putProfilesMatchListRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            if (requestParameters.matchList === null || requestParameters.matchList === undefined) {
                throw new runtime.RequiredError('matchList', 'Required parameter requestParameters.matchList was null or undefined when calling putProfilesMatchList.');
            }
            const queryParameters = {};
            const headerParameters = {};
            headerParameters['Content-Type'] = 'application/json;charset=UTF-8';
            ...
            const response = yield this.request({
                path: `/profilesMatchList`,
                method: 'PUT',
                headers: headerParameters,
                query: queryParameters,
                body: (0, index_1.MatchListTypeToJSON)(requestParameters.matchList),
            }, initOverrides);
            return new runtime.JSONApiResponse(response, (jsonValue) => (0, index_1.StatusFromJSON)(jsonValue));
        });
    }
     ...
     * Updates a list of matchIds to skip or don\'t skip profile match.
     */
    putProfilesMatchList(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield this.putProfilesMatchListRaw(requestParameters, initOverrides);
            return yield response.value();
        });
    }
    /**
 ...
 * @export
 */
exports.GetStagedProfilesStagedReasonsEnum = {
    InvalidEnrollmentCode: 'InvalidEnrollmentCode',
    EmptyEnrollmentCode: 'EmptyEnrollmentCode',
    NameChange: 'NameChange',
    InvalidExpirationDate: 'InvalidExpirationDate',
    EmptyExpirationDate: 'EmptyExpirationDate',
    EmptyMembershipLevel: 'EmptyMembershipLevel',
    InvalidMembershipLevel: 'InvalidMembershipLevel',
 ...
 * @export
 */
exports.GetStayRecordDetailFetchInstructionsEnum = {
    Udf: 'UDF',
    Revenue: 'Revenue',
    Rates: 'Rates'
};
