 ...
 */
export declare function instanceOfMembershipTransactionRevenueType(value: object): boolean;
export declare function MembershipTransactionRevenueTypeFromJSON(json: any): MembershipTransactionRevenueType;
export declare function MembershipTransactionRevenueTypeFromJSONTyped(json: any, ignoreDiscriminator: boolean): MembershipTransactionRevenueType;
export declare function MembershipTransactionRevenueTypeToJSON(value?: MembershipTransactionRevenueType | null): any;
