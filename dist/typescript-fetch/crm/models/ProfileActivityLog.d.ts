 ...
 */
export declare function instanceOfProfileActivityLog(value: object): boolean;
export declare function ProfileActivityLogFromJSON(json: any): ProfileActivityLog;
export declare function ProfileActivityLogFromJSONTyped(json: any, ignoreDiscriminator: boolean): ProfileActivityLog;
export declare function ProfileActivityLogToJSON(value?: ProfileActivityLog | null): any;
