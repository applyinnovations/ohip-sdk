 ...
 */
function instanceOfAvailableAwardsBasedOnType(value) {
    let isInstance = true;
    return isInstance;
}
exports.instanceOfAvailableAwardsBasedOnType = instanceOfAvailableAwardsBasedOnType;
function AvailableAwardsBasedOnTypeFromJSON(json) {
    return AvailableAwardsBasedOnTypeFromJSONTyped(json, false);
}
exports.AvailableAwardsBasedOnTypeFromJSON = AvailableAwardsBasedOnTypeFromJSON;
function AvailableAwardsBasedOnTypeFromJSONTyped(json, ignoreDiscriminator) {
...
function AvailableAwardsBasedOnTypeToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
