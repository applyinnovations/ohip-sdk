 ...
 */
export declare function instanceOfFuturePastBookingsCriteria(value: object): boolean;
export declare function FuturePastBookingsCriteriaFromJSON(json: any): FuturePastBookingsCriteria;
export declare function FuturePastBookingsCriteriaFromJSONTyped(json: any, ignoreDiscriminator: boolean): FuturePastBookingsCriteria;
export declare function FuturePastBookingsCriteriaToJSON(value?: FuturePastBookingsCriteria | null): any;
