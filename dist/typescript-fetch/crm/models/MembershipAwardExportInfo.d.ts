 ...
 */
export declare function instanceOfMembershipAwardExportInfo(value: object): boolean;
export declare function MembershipAwardExportInfoFromJSON(json: any): MembershipAwardExportInfo;
export declare function MembershipAwardExportInfoFromJSONTyped(json: any, ignoreDiscriminator: boolean): MembershipAwardExportInfo;
export declare function MembershipAwardExportInfoToJSON(value?: MembershipAwardExportInfo | null): any;
