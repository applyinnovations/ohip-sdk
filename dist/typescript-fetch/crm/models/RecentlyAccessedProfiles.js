 ...
 */
function instanceOfRecentlyAccessedProfiles(value) {
    let isInstance = true;
    return isInstance;
}
exports.instanceOfRecentlyAccessedProfiles = instanceOfRecentlyAccessedProfiles;
function RecentlyAccessedProfilesFromJSON(json) {
    return RecentlyAccessedProfilesFromJSONTyped(json, false);
}
exports.RecentlyAccessedProfilesFromJSON = RecentlyAccessedProfilesFromJSON;
function RecentlyAccessedProfilesFromJSONTyped(json, ignoreDiscriminator) {
...
function RecentlyAccessedProfilesToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
