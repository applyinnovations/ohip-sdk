 ...
 */
export declare function instanceOfMembershipStatisticsType(value: object): boolean;
export declare function MembershipStatisticsTypeFromJSON(json: any): MembershipStatisticsType;
export declare function MembershipStatisticsTypeFromJSONTyped(json: any, ignoreDiscriminator: boolean): MembershipStatisticsType;
export declare function MembershipStatisticsTypeToJSON(value?: MembershipStatisticsType | null): any;
