 ...
 */
export declare function instanceOfRelationshipCriteriaType(value: object): boolean;
export declare function RelationshipCriteriaTypeFromJSON(json: any): RelationshipCriteriaType;
export declare function RelationshipCriteriaTypeFromJSONTyped(json: any, ignoreDiscriminator: boolean): RelationshipCriteriaType;
export declare function RelationshipCriteriaTypeToJSON(value?: RelationshipCriteriaType | null): any;
