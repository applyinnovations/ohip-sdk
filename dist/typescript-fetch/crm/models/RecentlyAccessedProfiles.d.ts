 ...
 */
export declare function instanceOfRecentlyAccessedProfiles(value: object): boolean;
export declare function RecentlyAccessedProfilesFromJSON(json: any): RecentlyAccessedProfiles;
export declare function RecentlyAccessedProfilesFromJSONTyped(json: any, ignoreDiscriminator: boolean): RecentlyAccessedProfiles;
export declare function RecentlyAccessedProfilesToJSON(value?: RecentlyAccessedProfiles | null): any;
