...
import type { RelationshipsSummary } from './RelationshipsSummary';
import {
    RelationshipsSummaryFromJSON,
    RelationshipsSummaryFromJSONTyped,
    RelationshipsSummaryToJSON,
} from './RelationshipsSummary';
...
export function ProfileRelationshipsFromJSONTyped(json: any, ignoreDiscriminator: boolean): ProfileRelationships {
    ...
    return {
        ...
        'relationships': !exists(json, 'relationships') ? undefined : RelationshipsSummaryFromJSON(json['relationships']),
...
export function ProfileRelationshipsToJSON(value?: ProfileRelationships | null): any {
    ...
    return {
        ...
        'relationships': RelationshipsSummaryToJSON(value.relationships),
