 ...
 */
function instanceOfAwardDetails(value) {
    let isInstance = true;
    return isInstance;
}
exports.instanceOfAwardDetails = instanceOfAwardDetails;
function AwardDetailsFromJSON(json) {
    return AwardDetailsFromJSONTyped(json, false);
}
exports.AwardDetailsFromJSON = AwardDetailsFromJSON;
function AwardDetailsFromJSONTyped(json, ignoreDiscriminator) {
...
function AwardDetailsToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
