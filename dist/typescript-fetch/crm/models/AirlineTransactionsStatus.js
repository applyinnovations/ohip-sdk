 ...
 */
function instanceOfAirlineTransactionsStatus(value) {
    let isInstance = true;
    return isInstance;
}
exports.instanceOfAirlineTransactionsStatus = instanceOfAirlineTransactionsStatus;
function AirlineTransactionsStatusFromJSON(json) {
    return AirlineTransactionsStatusFromJSONTyped(json, false);
}
exports.AirlineTransactionsStatusFromJSON = AirlineTransactionsStatusFromJSON;
function AirlineTransactionsStatusFromJSONTyped(json, ignoreDiscriminator) {
...
function AirlineTransactionsStatusToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
