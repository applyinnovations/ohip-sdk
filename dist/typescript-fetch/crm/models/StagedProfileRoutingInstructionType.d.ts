 ...
 */
export declare function instanceOfStagedProfileRoutingInstructionType(value: object): boolean;
export declare function StagedProfileRoutingInstructionTypeFromJSON(json: any): StagedProfileRoutingInstructionType;
export declare function StagedProfileRoutingInstructionTypeFromJSONTyped(json: any, ignoreDiscriminator: boolean): StagedProfileRoutingInstructionType;
export declare function StagedProfileRoutingInstructionTypeToJSON(value?: StagedProfileRoutingInstructionType | null): any;
