 ...
 */
export declare function instanceOfPointsRejectionReasonsType(value: object): boolean;
export declare function PointsRejectionReasonsTypeFromJSON(json: any): PointsRejectionReasonsType;
export declare function PointsRejectionReasonsTypeFromJSONTyped(json: any, ignoreDiscriminator: boolean): PointsRejectionReasonsType;
export declare function PointsRejectionReasonsTypeToJSON(value?: PointsRejectionReasonsType | null): any;
