 ...
 */
export declare function instanceOfProfileStatisticsbyYearSummaryType(value: object): boolean;
export declare function ProfileStatisticsbyYearSummaryTypeFromJSON(json: any): ProfileStatisticsbyYearSummaryType;
export declare function ProfileStatisticsbyYearSummaryTypeFromJSONTyped(json: any, ignoreDiscriminator: boolean): ProfileStatisticsbyYearSummaryType;
export declare function ProfileStatisticsbyYearSummaryTypeToJSON(value?: ProfileStatisticsbyYearSummaryType | null): any;
