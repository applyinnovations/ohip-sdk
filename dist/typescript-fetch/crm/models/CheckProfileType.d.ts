 ...
 */
export declare function instanceOfCheckProfileType(value: object): boolean;
export declare function CheckProfileTypeFromJSON(json: any): CheckProfileType;
export declare function CheckProfileTypeFromJSONTyped(json: any, ignoreDiscriminator: boolean): CheckProfileType;
export declare function CheckProfileTypeToJSON(value?: CheckProfileType | null): any;
