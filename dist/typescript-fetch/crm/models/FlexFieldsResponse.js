...
function FlexFieldsResponseFromJSONTyped(json, ignoreDiscriminator) {
    ...
    return {
        'flexFieldValues': !(0, runtime_1.exists)(json, 'flexFieldValues') ? undefined : (json['flexFieldValues'].map(FlexFieldValueType_1.FlexFieldValueTypeFromJSON)),
...
function FlexFieldsResponseToJSON(value) {
    ...
    return {
        'flexFieldValues': value.flexFieldValues === undefined ? undefined : (value.flexFieldValues.map(FlexFieldValueType_1.FlexFieldValueTypeToJSON)),
