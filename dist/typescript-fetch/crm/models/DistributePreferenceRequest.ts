 ...
 */
export function instanceOfDistributePreferenceRequest(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function DistributePreferenceRequestFromJSON(json: any): DistributePreferenceRequest {
    return DistributePreferenceRequestFromJSONTyped(json, false);
}

export function DistributePreferenceRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): DistributePreferenceRequest {
...
export function DistributePreferenceRequestToJSON(value?: DistributePreferenceRequest | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
