 ...
 */
export declare function instanceOfStagedProfileDateUDFType(value: object): boolean;
export declare function StagedProfileDateUDFTypeFromJSON(json: any): StagedProfileDateUDFType;
export declare function StagedProfileDateUDFTypeFromJSONTyped(json: any, ignoreDiscriminator: boolean): StagedProfileDateUDFType;
export declare function StagedProfileDateUDFTypeToJSON(value?: StagedProfileDateUDFType | null): any;
