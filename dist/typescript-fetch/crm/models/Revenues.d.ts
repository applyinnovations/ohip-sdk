 ...
 */
export declare function instanceOfRevenues(value: object): boolean;
export declare function RevenuesFromJSON(json: any): Revenues;
export declare function RevenuesFromJSONTyped(json: any, ignoreDiscriminator: boolean): Revenues;
export declare function RevenuesToJSON(value?: Revenues | null): any;
