 ...
 */
export declare function instanceOfMembershipTierPointsType(value: object): boolean;
export declare function MembershipTierPointsTypeFromJSON(json: any): MembershipTierPointsType;
export declare function MembershipTierPointsTypeFromJSONTyped(json: any, ignoreDiscriminator: boolean): MembershipTierPointsType;
export declare function MembershipTierPointsTypeToJSON(value?: MembershipTierPointsType | null): any;
