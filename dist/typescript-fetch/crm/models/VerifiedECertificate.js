 ...
 */
function instanceOfVerifiedECertificate(value) {
    let isInstance = true;
    return isInstance;
}
exports.instanceOfVerifiedECertificate = instanceOfVerifiedECertificate;
function VerifiedECertificateFromJSON(json) {
    return VerifiedECertificateFromJSONTyped(json, false);
}
exports.VerifiedECertificateFromJSON = VerifiedECertificateFromJSON;
function VerifiedECertificateFromJSONTyped(json, ignoreDiscriminator) {
...
function VerifiedECertificateToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
