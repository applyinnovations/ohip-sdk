 ...
 */
function instanceOfForgetProfileResultType(value) {
    let isInstance = true;
    return isInstance;
}
exports.instanceOfForgetProfileResultType = instanceOfForgetProfileResultType;
function ForgetProfileResultTypeFromJSON(json) {
    return ForgetProfileResultTypeFromJSONTyped(json, false);
}
exports.ForgetProfileResultTypeFromJSON = ForgetProfileResultTypeFromJSON;
function ForgetProfileResultTypeFromJSONTyped(json, ignoreDiscriminator) {
...
exports.ForgetProfileResultTypeFromJSONTyped = ForgetProfileResultTypeFromJSONTyped;
function ForgetProfileResultTypeToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
...
exports.ForgetProfileResultTypeToJSON = ForgetProfileResultTypeToJSON;
