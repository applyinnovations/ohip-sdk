 ...
 */
export declare function instanceOfPointsRejectionReasons(value: object): boolean;
export declare function PointsRejectionReasonsFromJSON(json: any): PointsRejectionReasons;
export declare function PointsRejectionReasonsFromJSONTyped(json: any, ignoreDiscriminator: boolean): PointsRejectionReasons;
export declare function PointsRejectionReasonsToJSON(value?: PointsRejectionReasons | null): any;
