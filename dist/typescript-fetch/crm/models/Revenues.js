 ...
 */
function instanceOfRevenues(value) {
    let isInstance = true;
    return isInstance;
}
exports.instanceOfRevenues = instanceOfRevenues;
function RevenuesFromJSON(json) {
    return RevenuesFromJSONTyped(json, false);
}
exports.RevenuesFromJSON = RevenuesFromJSON;
function RevenuesFromJSONTyped(json, ignoreDiscriminator) {
