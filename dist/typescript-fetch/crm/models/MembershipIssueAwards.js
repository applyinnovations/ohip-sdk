 ...
 */
function instanceOfMembershipIssueAwards(value) {
    let isInstance = true;
    return isInstance;
}
exports.instanceOfMembershipIssueAwards = instanceOfMembershipIssueAwards;
function MembershipIssueAwardsFromJSON(json) {
    return MembershipIssueAwardsFromJSONTyped(json, false);
}
exports.MembershipIssueAwardsFromJSON = MembershipIssueAwardsFromJSON;
function MembershipIssueAwardsFromJSONTyped(json, ignoreDiscriminator) {
...
function MembershipIssueAwardsToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
