 ...
 */
function instanceOfMembershipClaim(value) {
    let isInstance = true;
    return isInstance;
}
exports.instanceOfMembershipClaim = instanceOfMembershipClaim;
function MembershipClaimFromJSON(json) {
    return MembershipClaimFromJSONTyped(json, false);
}
exports.MembershipClaimFromJSON = MembershipClaimFromJSON;
function MembershipClaimFromJSONTyped(json, ignoreDiscriminator) {
...
function MembershipClaimToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
