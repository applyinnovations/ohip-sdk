 ...
 */
export declare function instanceOfDuplicateOPERASubscriptions(value: object): boolean;
export declare function DuplicateOPERASubscriptionsFromJSON(json: any): DuplicateOPERASubscriptions;
export declare function DuplicateOPERASubscriptionsFromJSONTyped(json: any, ignoreDiscriminator: boolean): DuplicateOPERASubscriptions;
export declare function DuplicateOPERASubscriptionsToJSON(value?: DuplicateOPERASubscriptions | null): any;
