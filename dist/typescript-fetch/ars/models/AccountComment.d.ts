 ...
 */
export declare function instanceOfAccountComment(value: object): boolean;
export declare function AccountCommentFromJSON(json: any): AccountComment;
export declare function AccountCommentFromJSONTyped(json: any, ignoreDiscriminator: boolean): AccountComment;
export declare function AccountCommentToJSON(value?: AccountComment | null): any;
