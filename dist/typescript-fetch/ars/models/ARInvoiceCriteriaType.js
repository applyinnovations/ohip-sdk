...
exports.ARInvoiceCriteriaTypeToJSON = exports.ARInvoiceCriteriaTypeFromJSONTyped = exports.ARInvoiceCriteriaTypeFromJSON = exports.instanceOfARInvoiceCriteriaType = void 0;
const runtime_1 = require("../runtime");
const ARInvoiceCategory_1 = require("./ARInvoiceCategory");
const ARInvoiceCriteriaTypeAdditionalFilter_1 = require("./ARInvoiceCriteriaTypeAdditionalFilter");
 ...
 */
function instanceOfARInvoiceCriteriaType(value) {
    let isInstance = true;
    return isInstance;
}
exports.instanceOfARInvoiceCriteriaType = instanceOfARInvoiceCriteriaType;
function ARInvoiceCriteriaTypeFromJSON(json) {
    return ARInvoiceCriteriaTypeFromJSONTyped(json, false);
}
exports.ARInvoiceCriteriaTypeFromJSON = ARInvoiceCriteriaTypeFromJSON;
function ARInvoiceCriteriaTypeFromJSONTyped(json, ignoreDiscriminator) {
    ...
    return {
        ...
        'additionalFilter': !(0, runtime_1.exists)(json, 'additionalFilter') ? undefined : (0, ARInvoiceCriteriaTypeAdditionalFilter_1.ARInvoiceCriteriaTypeAdditionalFilterFromJSON)(json['additionalFilter']),
        'cashierId': !(0, runtime_1.exists)(json, 'cashierId') ? undefined : json['cashierId'],
    };
}
exports.ARInvoiceCriteriaTypeFromJSONTyped = ARInvoiceCriteriaTypeFromJSONTyped;
function ARInvoiceCriteriaTypeToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'additionalFilter': (0, ARInvoiceCriteriaTypeAdditionalFilter_1.ARInvoiceCriteriaTypeAdditionalFilterToJSON)(value.additionalFilter),
        'cashierId': value.cashierId,
    };
}
exports.ARInvoiceCriteriaTypeToJSON = ARInvoiceCriteriaTypeToJSON;
