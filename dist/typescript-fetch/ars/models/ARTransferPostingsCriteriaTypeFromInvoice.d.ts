 ...
 */
export declare function instanceOfARTransferPostingsCriteriaTypeFromInvoice(value: object): boolean;
export declare function ARTransferPostingsCriteriaTypeFromInvoiceFromJSON(json: any): ARTransferPostingsCriteriaTypeFromInvoice;
export declare function ARTransferPostingsCriteriaTypeFromInvoiceFromJSONTyped(json: any, ignoreDiscriminator: boolean): ARTransferPostingsCriteriaTypeFromInvoice;
export declare function ARTransferPostingsCriteriaTypeFromInvoiceToJSON(value?: ARTransferPostingsCriteriaTypeFromInvoice | null): any;
