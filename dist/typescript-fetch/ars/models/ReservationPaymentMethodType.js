...
const CashieringPaymentMethodTypeEmailFolioInfo_1 = require("./CashieringPaymentMethodTypeEmailFolioInfo");
...
function ReservationPaymentMethodTypeFromJSONTyped(json, ignoreDiscriminator) {
    ...
    return {
        ...
        'emailFolioInfo': !(0, runtime_1.exists)(json, 'emailFolioInfo') ? undefined : (0, CashieringPaymentMethodTypeEmailFolioInfo_1.CashieringPaymentMethodTypeEmailFolioInfoFromJSON)(json['emailFolioInfo']),
...
function ReservationPaymentMethodTypeToJSON(value) {
    ...
    return {
        ...
        'emailFolioInfo': (0, CashieringPaymentMethodTypeEmailFolioInfo_1.CashieringPaymentMethodTypeEmailFolioInfoToJSON)(value.emailFolioInfo),
