 ...
 */
function instanceOfInvoices(value) {
    let isInstance = true;
    return isInstance;
}
exports.instanceOfInvoices = instanceOfInvoices;
function InvoicesFromJSON(json) {
    return InvoicesFromJSONTyped(json, false);
}
exports.InvoicesFromJSON = InvoicesFromJSON;
function InvoicesFromJSONTyped(json, ignoreDiscriminator) {
