...
exports.AccountInvoiceInfoTypeToJSON = exports.AccountInvoiceInfoTypeFromJSONTyped = exports.AccountInvoiceInfoTypeFromJSON = exports.instanceOfAccountInvoiceInfoType = void 0;
 ...
 */
function instanceOfAccountInvoiceInfoType(value) {
    let isInstance = true;
    return isInstance;
}
exports.instanceOfAccountInvoiceInfoType = instanceOfAccountInvoiceInfoType;
function AccountInvoiceInfoTypeFromJSON(json) {
    return AccountInvoiceInfoTypeFromJSONTyped(json, false);
}
exports.AccountInvoiceInfoTypeFromJSON = AccountInvoiceInfoTypeFromJSON;
function AccountInvoiceInfoTypeFromJSONTyped(json, ignoreDiscriminator) {
...
exports.AccountInvoiceInfoTypeFromJSONTyped = AccountInvoiceInfoTypeFromJSONTyped;
function AccountInvoiceInfoTypeToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
...
exports.AccountInvoiceInfoTypeToJSON = AccountInvoiceInfoTypeToJSON;
