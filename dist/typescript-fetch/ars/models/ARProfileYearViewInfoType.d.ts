 ...
 */
export declare function instanceOfARProfileYearViewInfoType(value: object): boolean;
export declare function ARProfileYearViewInfoTypeFromJSON(json: any): ARProfileYearViewInfoType;
export declare function ARProfileYearViewInfoTypeFromJSONTyped(json: any, ignoreDiscriminator: boolean): ARProfileYearViewInfoType;
export declare function ARProfileYearViewInfoTypeToJSON(value?: ARProfileYearViewInfoType | null): any;
