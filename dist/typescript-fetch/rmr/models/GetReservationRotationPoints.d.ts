 ...
 */
export declare function instanceOfGetReservationRotationPoints(value: object): boolean;
export declare function GetReservationRotationPointsFromJSON(json: any): GetReservationRotationPoints;
export declare function GetReservationRotationPointsFromJSONTyped(json: any, ignoreDiscriminator: boolean): GetReservationRotationPoints;
export declare function GetReservationRotationPointsToJSON(value?: GetReservationRotationPoints | null): any;
