...
exports.SellLimitsByDateToJSON = exports.SellLimitsByDateFromJSONTyped = exports.SellLimitsByDateFromJSON = exports.instanceOfSellLimitsByDate = void 0;
/**
 * Check if a given object implements the SellLimitsByDate interface.
 */
function instanceOfSellLimitsByDate(value) {
    let isInstance = true;
    return isInstance;
}
exports.instanceOfSellLimitsByDate = instanceOfSellLimitsByDate;
function SellLimitsByDateFromJSON(json) {
    return SellLimitsByDateFromJSONTyped(json, false);
}
exports.SellLimitsByDateFromJSON = SellLimitsByDateFromJSON;
function SellLimitsByDateFromJSONTyped(json, ignoreDiscriminator) {
    return json;
}
exports.SellLimitsByDateFromJSONTyped = SellLimitsByDateFromJSONTyped;
function SellLimitsByDateToJSON(value) {
    return value;
}
exports.SellLimitsByDateToJSON = SellLimitsByDateToJSON;
