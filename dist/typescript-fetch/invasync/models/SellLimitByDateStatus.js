...
exports.SellLimitByDateStatusToJSON = exports.SellLimitByDateStatusFromJSONTyped = exports.SellLimitByDateStatusFromJSON = exports.instanceOfSellLimitByDateStatus = void 0;
 ...
 */
function instanceOfSellLimitByDateStatus(value) {
    let isInstance = true;
    return isInstance;
}
exports.instanceOfSellLimitByDateStatus = instanceOfSellLimitByDateStatus;
function SellLimitByDateStatusFromJSON(json) {
    return SellLimitByDateStatusFromJSONTyped(json, false);
}
exports.SellLimitByDateStatusFromJSON = SellLimitByDateStatusFromJSON;
function SellLimitByDateStatusFromJSONTyped(json, ignoreDiscriminator) {
...
exports.SellLimitByDateStatusFromJSONTyped = SellLimitByDateStatusFromJSONTyped;
function SellLimitByDateStatusToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
...
exports.SellLimitByDateStatusToJSON = SellLimitByDateStatusToJSON;
