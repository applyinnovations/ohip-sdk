 ...
 */
export declare function instanceOfSellLimitsByDate(value: object): boolean;
export declare function SellLimitsByDateFromJSON(json: any): SellLimitsByDate;
export declare function SellLimitsByDateFromJSONTyped(json: any, ignoreDiscriminator: boolean): SellLimitsByDate;
export declare function SellLimitsByDateToJSON(value?: SellLimitsByDate | null): any;
