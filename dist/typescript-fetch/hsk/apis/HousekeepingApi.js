...
class HousekeepingApi extends runtime.BaseAPI {
    ...
    getHouseKeepingTasksRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (requestParameters.includeComponentRoomsInfo !== undefined) {
                queryParameters['includeComponentRoomsInfo'] = requestParameters.includeComponentRoomsInfo;
            }
            ...
            if (requestParameters.includeScheduledRoomDetails !== undefined) {
                queryParameters['includeScheduledRoomDetails'] = requestParameters.includeScheduledRoomDetails;
            }
    ...
    getHousekeepingOverviewRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (requestParameters.scheduledRoomMovesOnly !== undefined) {
                queryParameters['scheduledRoomMovesOnly'] = requestParameters.scheduledRoomMovesOnly;
            }
            const headerParameters = {};
            if (requestParameters.authorization !== undefined && requestParameters.authorization !== null) {
                headerParameters['authorization'] = String(requestParameters.authorization);
...
exports.GetHousekeepingOverviewFetchInstructionsEnum = {
    ...
    ScheduedRoomMoveInfo: 'ScheduedRoomMoveInfo'
};
/**
 * @export
 */
