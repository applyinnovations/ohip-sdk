...
function HousekeepingTaskTypeRoomsInnerFromJSONTyped(json, ignoreDiscriminator) {
    ...
    return {
        ...
        'scheduledRoomMoveResvInfo': !(0, runtime_1.exists)(json, 'scheduledRoomMoveResvInfo') ? undefined : (json['scheduledRoomMoveResvInfo'].map(ReservationShortInfoType_1.ReservationShortInfoTypeFromJSON)),
...
function HousekeepingTaskTypeRoomsInnerToJSON(value) {
    ...
    return {
        ...
        'scheduledRoomMoveResvInfo': value.scheduledRoomMoveResvInfo === undefined ? undefined : (value.scheduledRoomMoveResvInfo.map(ReservationShortInfoType_1.ReservationShortInfoTypeToJSON)),
