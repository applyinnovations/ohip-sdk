 ...
 */
export declare function instanceOfTaskCompanion(value: object): boolean;
export declare function TaskCompanionFromJSON(json: any): TaskCompanion;
export declare function TaskCompanionFromJSONTyped(json: any, ignoreDiscriminator: boolean): TaskCompanion;
export declare function TaskCompanionToJSON(value?: TaskCompanion | null): any;
