 ...
 */
export declare function instanceOfFacilityTaskForecastType(value: object): boolean;
export declare function FacilityTaskForecastTypeFromJSON(json: any): FacilityTaskForecastType;
export declare function FacilityTaskForecastTypeFromJSONTyped(json: any, ignoreDiscriminator: boolean): FacilityTaskForecastType;
export declare function FacilityTaskForecastTypeToJSON(value?: FacilityTaskForecastType | null): any;
