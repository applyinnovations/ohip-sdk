 ...
 */
export declare function instanceOfFacilityTaskBaseType(value: object): boolean;
export declare function FacilityTaskBaseTypeFromJSON(json: any): FacilityTaskBaseType;
export declare function FacilityTaskBaseTypeFromJSONTyped(json: any, ignoreDiscriminator: boolean): FacilityTaskBaseType;
export declare function FacilityTaskBaseTypeToJSON(value?: FacilityTaskBaseType | null): any;
