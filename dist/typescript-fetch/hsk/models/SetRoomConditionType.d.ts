 ...
 */
export declare function instanceOfSetRoomConditionType(value: object): boolean;
export declare function SetRoomConditionTypeFromJSON(json: any): SetRoomConditionType;
export declare function SetRoomConditionTypeFromJSONTyped(json: any, ignoreDiscriminator: boolean): SetRoomConditionType;
export declare function SetRoomConditionTypeToJSON(value?: SetRoomConditionType | null): any;
