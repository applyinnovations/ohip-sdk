...
function ScheduledRoomMoveInfoTypeFromJSONTyped(json, ignoreDiscriminator) {
    ...
    return {
        'scheduledRoomMoveInTime': !(0, runtime_1.exists)(json, 'scheduledRoomMoveInTime') ? undefined : json['scheduledRoomMoveInTime'],
        'scheduledRoomMoveOutTime': !(0, runtime_1.exists)(json, 'scheduledRoomMoveOutTime') ? undefined : json['scheduledRoomMoveOutTime'],
        'scheduledRoomMoveIn': !(0, runtime_1.exists)(json, 'scheduledRoomMoveIn') ? undefined : json['scheduledRoomMoveIn'],
