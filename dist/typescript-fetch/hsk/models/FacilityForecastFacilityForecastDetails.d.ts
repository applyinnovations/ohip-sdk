 ...
 */
export declare function instanceOfFacilityForecastFacilityForecastDetails(value: object): boolean;
export declare function FacilityForecastFacilityForecastDetailsFromJSON(json: any): FacilityForecastFacilityForecastDetails;
export declare function FacilityForecastFacilityForecastDetailsFromJSONTyped(json: any, ignoreDiscriminator: boolean): FacilityForecastFacilityForecastDetails;
export declare function FacilityForecastFacilityForecastDetailsToJSON(value?: FacilityForecastFacilityForecastDetails | null): any;
