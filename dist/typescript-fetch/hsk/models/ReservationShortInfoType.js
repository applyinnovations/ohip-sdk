...
function ReservationShortInfoTypeFromJSONTyped(json, ignoreDiscriminator) {
    ...
    return {
        ...
        'scheduledMoveInRoomId': !(0, runtime_1.exists)(json, 'scheduledMoveInRoomId') ? undefined : json['scheduledMoveInRoomId'],
        'scheduledMoveOutRoomId': !(0, runtime_1.exists)(json, 'scheduledMoveOutRoomId') ? undefined : json['scheduledMoveOutRoomId'],
