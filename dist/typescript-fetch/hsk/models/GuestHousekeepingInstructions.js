 ...
 */
function instanceOfGuestHousekeepingInstructions(value) {
    let isInstance = true;
    return isInstance;
}
exports.instanceOfGuestHousekeepingInstructions = instanceOfGuestHousekeepingInstructions;
function GuestHousekeepingInstructionsFromJSON(json) {
    return GuestHousekeepingInstructionsFromJSONTyped(json, false);
}
exports.GuestHousekeepingInstructionsFromJSON = GuestHousekeepingInstructionsFromJSON;
function GuestHousekeepingInstructionsFromJSONTyped(json, ignoreDiscriminator) {
...
function GuestHousekeepingInstructionsToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
