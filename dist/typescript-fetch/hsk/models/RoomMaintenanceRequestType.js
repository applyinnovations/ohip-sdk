 ...
 */
function instanceOfRoomMaintenanceRequestType(value) {
    let isInstance = true;
    return isInstance;
}
exports.instanceOfRoomMaintenanceRequestType = instanceOfRoomMaintenanceRequestType;
function RoomMaintenanceRequestTypeFromJSON(json) {
    return RoomMaintenanceRequestTypeFromJSONTyped(json, false);
}
exports.RoomMaintenanceRequestTypeFromJSON = RoomMaintenanceRequestTypeFromJSON;
function RoomMaintenanceRequestTypeFromJSONTyped(json, ignoreDiscriminator) {
...
function RoomMaintenanceRequestTypeToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
