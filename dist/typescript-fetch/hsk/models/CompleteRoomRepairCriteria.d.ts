 ...
 */
export declare function instanceOfCompleteRoomRepairCriteria(value: object): boolean;
export declare function CompleteRoomRepairCriteriaFromJSON(json: any): CompleteRoomRepairCriteria;
export declare function CompleteRoomRepairCriteriaFromJSONTyped(json: any, ignoreDiscriminator: boolean): CompleteRoomRepairCriteria;
export declare function CompleteRoomRepairCriteriaToJSON(value?: CompleteRoomRepairCriteria | null): any;
