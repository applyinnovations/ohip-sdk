...
export declare class ReservationApi extends runtime.BaseAPI {
     ...
     */
    deleteOnHoldReservationRaw(requestParameters: DeleteOnHoldReservationRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Status>>;
    /**
     * This API will delete only an on hold (in-session) reservation.<p><strong>OperationId:</strong>deleteOnHoldReservation</p>
     * Delete a Reservation by resort
     */
    deleteOnHoldReservation(requestParameters: DeleteOnHoldReservationRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Status>;
    /**
     ...
     * @deprecated
     */
    deleteReservationRaw(requestParameters: DeleteReservationRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Status>>;
    /**
     * This API will delete only an on hold (in-session) reservation.<p><strong>OperationId:</strong>deleteReservation</p>
     * Delete a Reservation
     * @deprecated
     */
    deleteReservation(requestParameters: DeleteReservationRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Status>;
    /**
     ...
     */
    getDistributionReservationsSummaryRaw(requestParameters: GetDistributionReservationsSummaryRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<CheckDistributionReservationsSummary>>;
    /**
     * Get DistributionReservationsSummary. <p><strong>OperationId:</strong>getDistributionReservationsSummary</p>
     * Get Reservation DistributionReservationsSummary
     */
    getDistributionReservationsSummary(requestParameters: GetDistributionReservationsSummaryRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<CheckDistributionReservationsSummary>;
    /**
     ...
     */
    putAddOnReservationPackagesRaw(requestParameters: PutAddOnReservationPackagesRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<AddOnReservationPackagesType>>;
    /**
     * This API will allow you to update Add On (Sell Separate) packages on a reservation. Note: this API works as a full overlay for Reservation\'s Add On Packages.<p><strong>OperationId:</strong>putAddOnReservationPackages</p>
     * Update Add On (Sell Separate) packages on a reservation.
     */
    putAddOnReservationPackages(requestParameters: PutAddOnReservationPackagesRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<AddOnReservationPackagesType>;
    /**
     ...
     * Update Add On (Sell Separate) packages on a reservation
     */
    putAddOnReservationPackagesByExtIdRaw(requestParameters: PutAddOnReservationPackagesByExtIdRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<AddOnReservationPackagesType>>;
    /**
     * This API will allow you to update Add On (Sell Separate) packages on a reservation\'s. Note: this API works as a full overlay for Reservation Add On Packages./<p><strong>OperationId:</strong>putAddOnReservationPackagesByExtId</p>
     * Update Add On (Sell Separate) packages on a reservation
     */
    putAddOnReservationPackagesByExtId(requestParameters: PutAddOnReservationPackagesByExtIdRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<AddOnReservationPackagesType>;
    /**
     ...
     */
    putLinkedReservationRaw(requestParameters: PutLinkedReservationRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Status>>;
    /**
     * Use this API to update an existing linked reservation for given reservation name id and hotel code. <p><strong>OperationId:</strong>putLinkedReservation</p>
     * Update Linked Reservation by ID
     */
    putLinkedReservation(requestParameters: PutLinkedReservationRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Status>;
    /**
     ...
     */
    putPayeeSharerRaw(requestParameters: PutPayeeSharerRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Status>>;
    /**
     * Use this API to mark or un mark a shared reservation as the payee sharer for the group of shared reservations. <p><strong>OperationId:</strong>putPayeeSharer</p>
     * Update Payee Sharer Information by ID.
     */
    putPayeeSharer(requestParameters: PutPayeeSharerRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Status>;
    /**
     ...
     */
    putReservationLinksRaw(requestParameters: PutReservationLinksRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<LinkedReservationsCommonDetails>>;
    /**
     * This Operation allows to update attributes common to all reservations that are linked to an existing reservation. <p><strong>OperationId:</strong>putReservationLinks</p>
     * Update Linked Reservations Common Details.
     */
    putReservationLinks(requestParameters: PutReservationLinksRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<LinkedReservationsCommonDetails>;
    /**
     ...
     */
    putScheduledRoomMoveRaw(requestParameters: PutScheduledRoomMoveRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ScheduledRoomMoveDetails>>;
    /**
     * Use this to update an existing scheduled room move for a reservation in a hotel and for a specific date. Use this to update move comments, move time etc. <p><strong>OperationId:</strong>putScheduledRoomMove</p>
     * Update Scheduled Room Move Details based on reservationID and move date
     */
    putScheduledRoomMove(requestParameters: PutScheduledRoomMoveRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<ScheduledRoomMoveDetails>;
    /**
...
export declare const GetHotelReservationsSearchTypeEnum: {
    ...
    readonly CorrectionPostings: "CorrectionPostings";
    readonly Vouchers: "Vouchers";
    readonly ScheduledRoomMove: "ScheduledRoomMove";
};
...
export declare const GetHotelReservationsFetchInstructionsEnum: {
    ...
    readonly DepartureReservationInfo: "DepartureReservationInfo";
};
 ...
 * @export
 */
export declare const GetHotelReservationsScheduledRoomMoveStatusEnum: {
    readonly Completed: "Completed";
    readonly Pending: "Pending";
};
...
export declare const GetReservationFetchInstructionsEnum: {
    ...
    readonly Keys: "Keys";
    readonly AccompanyingGuestProfile: "AccompanyingGuestProfile";
    readonly AccompanyingGuestMembership: "AccompanyingGuestMembership";
    readonly AccompanyingGuestRelationship: "AccompanyingGuestRelationship";
    readonly Voucher: "Voucher";
    readonly ScheduledRoomMoves: "ScheduledRoomMoves";
    readonly DailySummary: "DailySummary";
    readonly RateInfoDetails: "RateInfoDetails";
};
 ...
 * @export
 */
export declare const GetReservationsScheduledRoomMoveStatusEnum: {
    readonly Completed: "Completed";
    readonly Pending: "Pending";
};
 ...
 * @export
 */
export declare const GetReservationsToShareByReservationIdReservationStatusesEnum: {
    readonly Cancelled: "Cancelled";
    readonly CheckedOut: "CheckedOut";
    readonly CheckedIn: "CheckedIn";
    readonly DueIn: "DueIn";
