...
class ReservationApi extends runtime.BaseAPI {
     ...
     */
    deleteOnHoldReservationRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            if (requestParameters.reservationId === null || requestParameters.reservationId === undefined) {
     ...
     * Delete a Reservation by resort
     */
    deleteOnHoldReservation(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield this.deleteOnHoldReservationRaw(requestParameters, initOverrides);
            return yield response.value();
        });
    }
    /**
     ...
     * @deprecated
     */
    deleteReservationRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            if (requestParameters.reservationId === null || requestParameters.reservationId === undefined) {
     ...
     * @deprecated
     */
    deleteReservation(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield this.deleteReservationRaw(requestParameters, initOverrides);
            return yield response.value();
        });
    }
    /**
     ...
     */
    getDistributionReservationsSummaryRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            if (requestParameters.hotelId === null || requestParameters.hotelId === undefined) {
            ...
            return new runtime.JSONApiResponse(response, (jsonValue) => (0, index_1.CheckDistributionReservationsSummaryFromJSON)(jsonValue));
        });
    }
    /**
     * Get DistributionReservationsSummary. <p><strong>OperationId:</strong>getDistributionReservationsSummary</p>
     * Get Reservation DistributionReservationsSummary
     */
    getDistributionReservationsSummary(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield this.getDistributionReservationsSummaryRaw(requestParameters, initOverrides);
            return yield response.value();
        });
    }
    /**
     ...
     */
    putAddOnReservationPackagesRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            if (requestParameters.reservationId === null || requestParameters.reservationId === undefined) {
            ...
            const response = yield this.request({
                ...
                headers: headerParameters,
                query: queryParameters,
                body: (0, index_1.ReservationAddOnPackagesTypeToJSON)(requestParameters.reservationAddOnPackages),
            }, initOverrides);
            return new runtime.JSONApiResponse(response, (jsonValue) => (0, index_1.AddOnReservationPackagesTypeFromJSON)(jsonValue));
        });
    }
    /**
     * This API will allow you to update Add On (Sell Separate) packages on a reservation. Note: this API works as a full overlay for Reservation\'s Add On Packages.<p><strong>OperationId:</strong>putAddOnReservationPackages</p>
     * Update Add On (Sell Separate) packages on a reservation.
     */
    putAddOnReservationPackages(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield this.putAddOnReservationPackagesRaw(requestParameters, initOverrides);
            return yield response.value();
        });
    }
    /**
     ...
     * Update Add On (Sell Separate) packages on a reservation
     */
    putAddOnReservationPackagesByExtIdRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            if (requestParameters.reservationExternalId === null || requestParameters.reservationExternalId === undefined) {
     ...
     * Update Add On (Sell Separate) packages on a reservation
     */
    putAddOnReservationPackagesByExtId(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield this.putAddOnReservationPackagesByExtIdRaw(requestParameters, initOverrides);
            return yield response.value();
        });
    }
    /**
     ...
     */
    putLinkedReservationRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            if (requestParameters.reservationId === null || requestParameters.reservationId === undefined) {
            ...
            const response = yield this.request({
                ...
                headers: headerParameters,
                query: queryParameters,
                body: (0, index_1.ChangeLinkedReservationTypeToJSON)(requestParameters.changeLinkedReservation),
            }, initOverrides);
            return new runtime.JSONApiResponse(response, (jsonValue) => (0, index_1.StatusFromJSON)(jsonValue));
        });
    }
     ...
     * Update Linked Reservation by ID
     */
    putLinkedReservation(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield this.putLinkedReservationRaw(requestParameters, initOverrides);
            return yield response.value();
        });
    }
    /**
     ...
     */
    putPayeeSharerRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            if (requestParameters.reservationId === null || requestParameters.reservationId === undefined) {
            ...
            const response = yield this.request({
                ...
                headers: headerParameters,
                query: queryParameters,
                body: (0, index_1.ChangePayeeSharerTypeToJSON)(requestParameters.changePayeeSharer),
            }, initOverrides);
            return new runtime.JSONApiResponse(response, (jsonValue) => (0, index_1.StatusFromJSON)(jsonValue));
        });
    }
     ...
     * Update Payee Sharer Information by ID.
     */
    putPayeeSharer(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield this.putPayeeSharerRaw(requestParameters, initOverrides);
            return yield response.value();
        });
    }
    /**
     ...
     */
    putReservationLinksRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            if (requestParameters.hotelId === null || requestParameters.hotelId === undefined) {
            ...
            const response = yield this.request({
                ...
                headers: headerParameters,
                query: queryParameters,
                body: (0, index_1.ChangeLinkedReservationsCommonDetailsToJSON)(requestParameters.changeLinkedReservationsCommonDetails),
            }, initOverrides);
            return new runtime.JSONApiResponse(response, (jsonValue) => (0, index_1.LinkedReservationsCommonDetailsFromJSON)(jsonValue));
        });
    }
    /**
     * This Operation allows to update attributes common to all reservations that are linked to an existing reservation. <p><strong>OperationId:</strong>putReservationLinks</p>
     * Update Linked Reservations Common Details.
     */
    putReservationLinks(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield this.putReservationLinksRaw(requestParameters, initOverrides);
            return yield response.value();
        });
    }
    /**
     ...
     */
    putScheduledRoomMoveRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            if (requestParameters.reservationId === null || requestParameters.reservationId === undefined) {
            ...
            const response = yield this.request({
                ...
                headers: headerParameters,
                query: queryParameters,
                body: (0, index_1.ScheduledRoomMoveDetailsToJSON)(requestParameters.scheduledRoomMoveDetails),
            }, initOverrides);
            return new runtime.JSONApiResponse(response, (jsonValue) => (0, index_1.ScheduledRoomMoveDetailsFromJSON)(jsonValue));
        });
    }
    /**
     * Use this to update an existing scheduled room move for a reservation in a hotel and for a specific date. Use this to update move comments, move time etc. <p><strong>OperationId:</strong>putScheduledRoomMove</p>
     * Update Scheduled Room Move Details based on reservationID and move date
     */
    putScheduledRoomMove(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield this.putScheduledRoomMoveRaw(requestParameters, initOverrides);
            return yield response.value();
        });
    }
    /**
 ...
 * @export
 */
exports.GetHotelReservationsScheduledRoomMoveStatusEnum = {
    Completed: 'Completed',
    Pending: 'Pending'
};
/**
 ...
 * @export
 */
exports.GetReservationsToShareByReservationIdReservationStatusesEnum = {
    Cancelled: 'Cancelled',
    CheckedOut: 'CheckedOut',
    CheckedIn: 'CheckedIn',
    DueIn: 'DueIn',
