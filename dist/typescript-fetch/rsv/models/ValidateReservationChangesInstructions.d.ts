 ...
 */
export declare function instanceOfValidateReservationChangesInstructions(value: object): boolean;
export declare function ValidateReservationChangesInstructionsFromJSON(json: any): ValidateReservationChangesInstructions;
export declare function ValidateReservationChangesInstructionsFromJSONTyped(json: any, ignoreDiscriminator: boolean): ValidateReservationChangesInstructions;
export declare function ValidateReservationChangesInstructionsToJSON(value?: ValidateReservationChangesInstructions | null): any;
