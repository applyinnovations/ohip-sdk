 ...
 */
export declare function instanceOfCopyReservationTypeInstructions(value: object): boolean;
export declare function CopyReservationTypeInstructionsFromJSON(json: any): CopyReservationTypeInstructions;
export declare function CopyReservationTypeInstructionsFromJSONTyped(json: any, ignoreDiscriminator: boolean): CopyReservationTypeInstructions;
export declare function CopyReservationTypeInstructionsToJSON(value?: CopyReservationTypeInstructions | null): any;
