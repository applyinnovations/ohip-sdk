 ...
 */
function instanceOfCallHistory(value) {
    let isInstance = true;
    return isInstance;
}
exports.instanceOfCallHistory = instanceOfCallHistory;
function CallHistoryFromJSON(json) {
    return CallHistoryFromJSONTyped(json, false);
}
exports.CallHistoryFromJSON = CallHistoryFromJSON;
function CallHistoryFromJSONTyped(json, ignoreDiscriminator) {
...
function CallHistoryToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
