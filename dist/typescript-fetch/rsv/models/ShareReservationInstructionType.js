 ...
 */
function instanceOfShareReservationInstructionType(value) {
    let isInstance = true;
    return isInstance;
}
exports.instanceOfShareReservationInstructionType = instanceOfShareReservationInstructionType;
function ShareReservationInstructionTypeFromJSON(json) {
    return ShareReservationInstructionTypeFromJSONTyped(json, false);
}
exports.ShareReservationInstructionTypeFromJSON = ShareReservationInstructionTypeFromJSON;
function ShareReservationInstructionTypeFromJSONTyped(json, ignoreDiscriminator) {
    ...
    return {
        ...
        'shareType': !(0, runtime_1.exists)(json, 'shareType') ? undefined : (0, ShareTypeType_1.ShareTypeTypeFromJSON)(json['shareType']),
        'fixedRate': !(0, runtime_1.exists)(json, 'fixedRate') ? undefined : json['fixedRate'],
    };
}
exports.ShareReservationInstructionTypeFromJSONTyped = ShareReservationInstructionTypeFromJSONTyped;
function ShareReservationInstructionTypeToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'shareType': (0, ShareTypeType_1.ShareTypeTypeToJSON)(value.shareType),
        'fixedRate': value.fixedRate,
    };
}
exports.ShareReservationInstructionTypeToJSON = ShareReservationInstructionTypeToJSON;
