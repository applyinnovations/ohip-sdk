 ...
 */
export declare function instanceOfMoveReservationHotelCriteriaType(value: object): boolean;
export declare function MoveReservationHotelCriteriaTypeFromJSON(json: any): MoveReservationHotelCriteriaType;
export declare function MoveReservationHotelCriteriaTypeFromJSONTyped(json: any, ignoreDiscriminator: boolean): MoveReservationHotelCriteriaType;
export declare function MoveReservationHotelCriteriaTypeToJSON(value?: MoveReservationHotelCriteriaType | null): any;
