 ...
 */
function instanceOfCheckReservationType(value) {
    let isInstance = true;
    return isInstance;
}
exports.instanceOfCheckReservationType = instanceOfCheckReservationType;
function CheckReservationTypeFromJSON(json) {
    return CheckReservationTypeFromJSONTyped(json, false);
}
exports.CheckReservationTypeFromJSON = CheckReservationTypeFromJSON;
function CheckReservationTypeFromJSONTyped(json, ignoreDiscriminator) {
...
function CheckReservationTypeToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
