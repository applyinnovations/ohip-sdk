...
const ScheduledRoomMoveResponseType_1 = require("./ScheduledRoomMoveResponseType");
...
function StayInfoTypeFromJSONTyped(json, ignoreDiscriminator) {
    ...
    return {
        ...
        'scheduledRoomMoveRoomPending': !(0, runtime_1.exists)(json, 'scheduledRoomMoveRoomPending') ? undefined : json['scheduledRoomMoveRoomPending'],
        ...
        'scheduledRoomMoveResponseType': !(0, runtime_1.exists)(json, 'scheduledRoomMoveResponseType') ? undefined : (0, ScheduledRoomMoveResponseType_1.ScheduledRoomMoveResponseTypeFromJSON)(json['scheduledRoomMoveResponseType']),
...
function StayInfoTypeToJSON(value) {
    ...
    return {
        ...
        'scheduledRoomMoveResponseType': (0, ScheduledRoomMoveResponseType_1.ScheduledRoomMoveResponseTypeToJSON)(value.scheduledRoomMoveResponseType),
