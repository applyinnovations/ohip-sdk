 ...
 */
function instanceOfReservationDailyRateDetailDetails(value) {
    let isInstance = true;
    return isInstance;
}
exports.instanceOfReservationDailyRateDetailDetails = instanceOfReservationDailyRateDetailDetails;
function ReservationDailyRateDetailDetailsFromJSON(json) {
    return ReservationDailyRateDetailDetailsFromJSONTyped(json, false);
}
exports.ReservationDailyRateDetailDetailsFromJSON = ReservationDailyRateDetailDetailsFromJSON;
function ReservationDailyRateDetailDetailsFromJSONTyped(json, ignoreDiscriminator) {
...
function ReservationDailyRateDetailDetailsToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
