 ...
 */
export declare function instanceOfChangeInstructionType(value: object): boolean;
export declare function ChangeInstructionTypeFromJSON(json: any): ChangeInstructionType;
export declare function ChangeInstructionTypeFromJSONTyped(json: any, ignoreDiscriminator: boolean): ChangeInstructionType;
export declare function ChangeInstructionTypeToJSON(value?: ChangeInstructionType | null): any;
