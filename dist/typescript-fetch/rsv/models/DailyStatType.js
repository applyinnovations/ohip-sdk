 ...
 */
function instanceOfDailyStatType(value) {
    let isInstance = true;
    return isInstance;
}
exports.instanceOfDailyStatType = instanceOfDailyStatType;
function DailyStatTypeFromJSON(json) {
    return DailyStatTypeFromJSONTyped(json, false);
}
exports.DailyStatTypeFromJSON = DailyStatTypeFromJSON;
function DailyStatTypeFromJSONTyped(json, ignoreDiscriminator) {
...
function DailyStatTypeToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
