...
const AttachDetachType_1 = require("./AttachDetachType");
...
function ResGuestTypeProfileInfoFromJSONTyped(json, ignoreDiscriminator) {
    ...
    return {
        ...
        'attachDetachType': !(0, runtime_1.exists)(json, 'attachDetachType') ? undefined : (0, AttachDetachType_1.AttachDetachTypeFromJSON)(json['attachDetachType']),
    };
}
...
function ResGuestTypeProfileInfoToJSON(value) {
    ...
    return {
        ...
        'attachDetachType': (0, AttachDetachType_1.AttachDetachTypeToJSON)(value.attachDetachType),
    };
}
