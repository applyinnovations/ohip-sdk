 ...
 */
function instanceOfBlockStatType(value) {
    let isInstance = true;
    return isInstance;
}
exports.instanceOfBlockStatType = instanceOfBlockStatType;
function BlockStatTypeFromJSON(json) {
    return BlockStatTypeFromJSONTyped(json, false);
}
exports.BlockStatTypeFromJSON = BlockStatTypeFromJSON;
function BlockStatTypeFromJSONTyped(json, ignoreDiscriminator) {
...
function BlockStatTypeToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
