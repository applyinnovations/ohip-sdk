 ...
 */
export declare function instanceOfChangeResvGuestMessages(value: object): boolean;
export declare function ChangeResvGuestMessagesFromJSON(json: any): ChangeResvGuestMessages;
export declare function ChangeResvGuestMessagesFromJSONTyped(json: any, ignoreDiscriminator: boolean): ChangeResvGuestMessages;
export declare function ChangeResvGuestMessagesToJSON(value?: ChangeResvGuestMessages | null): any;
