 ...
 */
function instanceOfComponentBlockOutDates(value) {
    let isInstance = true;
    return isInstance;
}
exports.instanceOfComponentBlockOutDates = instanceOfComponentBlockOutDates;
function ComponentBlockOutDatesFromJSON(json) {
    return ComponentBlockOutDatesFromJSONTyped(json, false);
}
exports.ComponentBlockOutDatesFromJSON = ComponentBlockOutDatesFromJSON;
function ComponentBlockOutDatesFromJSONTyped(json, ignoreDiscriminator) {
...
function ComponentBlockOutDatesToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
