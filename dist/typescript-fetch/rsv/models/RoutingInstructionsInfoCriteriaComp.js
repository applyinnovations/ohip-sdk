...
exports.RoutingInstructionsInfoCriteriaCompToJSON = exports.RoutingInstructionsInfoCriteriaCompFromJSONTyped = exports.RoutingInstructionsInfoCriteriaCompFromJSON = exports.instanceOfRoutingInstructionsInfoCriteriaComp = void 0;
 ...
 */
function instanceOfRoutingInstructionsInfoCriteriaComp(value) {
    let isInstance = true;
    return isInstance;
}
exports.instanceOfRoutingInstructionsInfoCriteriaComp = instanceOfRoutingInstructionsInfoCriteriaComp;
function RoutingInstructionsInfoCriteriaCompFromJSON(json) {
    return RoutingInstructionsInfoCriteriaCompFromJSONTyped(json, false);
}
exports.RoutingInstructionsInfoCriteriaCompFromJSON = RoutingInstructionsInfoCriteriaCompFromJSON;
function RoutingInstructionsInfoCriteriaCompFromJSONTyped(json, ignoreDiscriminator) {
...
exports.RoutingInstructionsInfoCriteriaCompFromJSONTyped = RoutingInstructionsInfoCriteriaCompFromJSONTyped;
function RoutingInstructionsInfoCriteriaCompToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
...
exports.RoutingInstructionsInfoCriteriaCompToJSON = RoutingInstructionsInfoCriteriaCompToJSON;
