...
exports.ChangeReservationDetailsToJSON = exports.ChangeReservationDetailsFromJSONTyped = exports.ChangeReservationDetailsFromJSON = exports.instanceOfChangeReservationDetails = void 0;
 ...
 */
function instanceOfChangeReservationDetails(value) {
    let isInstance = true;
    return isInstance;
}
exports.instanceOfChangeReservationDetails = instanceOfChangeReservationDetails;
function ChangeReservationDetailsFromJSON(json) {
    return ChangeReservationDetailsFromJSONTyped(json, false);
}
exports.ChangeReservationDetailsFromJSON = ChangeReservationDetailsFromJSON;
function ChangeReservationDetailsFromJSONTyped(json, ignoreDiscriminator) {
...
function ChangeReservationDetailsToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
