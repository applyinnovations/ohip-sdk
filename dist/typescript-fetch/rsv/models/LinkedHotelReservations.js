 ...
 */
function instanceOfLinkedHotelReservations(value) {
    let isInstance = true;
    return isInstance;
}
exports.instanceOfLinkedHotelReservations = instanceOfLinkedHotelReservations;
function LinkedHotelReservationsFromJSON(json) {
    return LinkedHotelReservationsFromJSONTyped(json, false);
}
exports.LinkedHotelReservationsFromJSON = LinkedHotelReservationsFromJSON;
function LinkedHotelReservationsFromJSONTyped(json, ignoreDiscriminator) {
...
function LinkedHotelReservationsToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
