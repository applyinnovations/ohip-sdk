 ...
 */
function instanceOfBreakShareValidationsDetails(value) {
    let isInstance = true;
    return isInstance;
}
exports.instanceOfBreakShareValidationsDetails = instanceOfBreakShareValidationsDetails;
function BreakShareValidationsDetailsFromJSON(json) {
    return BreakShareValidationsDetailsFromJSONTyped(json, false);
}
exports.BreakShareValidationsDetailsFromJSON = BreakShareValidationsDetailsFromJSON;
function BreakShareValidationsDetailsFromJSONTyped(json, ignoreDiscriminator) {
...
function BreakShareValidationsDetailsToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
