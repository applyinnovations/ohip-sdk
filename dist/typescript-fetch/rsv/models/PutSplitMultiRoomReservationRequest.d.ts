 ...
 */
export declare function instanceOfPutSplitMultiRoomReservationRequest(value: object): boolean;
export declare function PutSplitMultiRoomReservationRequestFromJSON(json: any): PutSplitMultiRoomReservationRequest;
export declare function PutSplitMultiRoomReservationRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): PutSplitMultiRoomReservationRequest;
export declare function PutSplitMultiRoomReservationRequestToJSON(value?: PutSplitMultiRoomReservationRequest | null): any;
