...
function ResPaymentCardTypeFromJSONTyped(json, ignoreDiscriminator) {
    ...
    return {
        ...
        'storeToCreditCardWallet': !(0, runtime_1.exists)(json, 'storeToCreditCardWallet') ? undefined : json['storeToCreditCardWallet'],
...
function ResPaymentCardTypeToJSON(value) {
    ...
    return {
        ...
        'storeToCreditCardWallet': value.storeToCreditCardWallet,
        'swiped': value.swiped,
