...
function ChannelResvRSInfoTypeFromJSONTyped(json, ignoreDiscriminator) {
    ...
    return {
        ...
        'inSessionReservationId': !(0, runtime_1.exists)(json, 'inSessionReservationId') ? undefined : (0, UniqueIDType_1.UniqueIDTypeFromJSON)(json['inSessionReservationId']),
    };
}
...
function ChannelResvRSInfoTypeToJSON(value) {
    ...
    return {
        ...
        'inSessionReservationId': (0, UniqueIDType_1.UniqueIDTypeToJSON)(value.inSessionReservationId),
    };
}
