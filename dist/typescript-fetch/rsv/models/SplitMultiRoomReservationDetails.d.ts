 ...
 */
export declare function instanceOfSplitMultiRoomReservationDetails(value: object): boolean;
export declare function SplitMultiRoomReservationDetailsFromJSON(json: any): SplitMultiRoomReservationDetails;
export declare function SplitMultiRoomReservationDetailsFromJSONTyped(json: any, ignoreDiscriminator: boolean): SplitMultiRoomReservationDetails;
export declare function SplitMultiRoomReservationDetailsToJSON(value?: SplitMultiRoomReservationDetails | null): any;
