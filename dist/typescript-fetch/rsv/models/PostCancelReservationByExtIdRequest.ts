 ...
 */
export function instanceOfPostCancelReservationByExtIdRequest(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function PostCancelReservationByExtIdRequestFromJSON(json: any): PostCancelReservationByExtIdRequest {
    return PostCancelReservationByExtIdRequestFromJSONTyped(json, false);
}

export function PostCancelReservationByExtIdRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): PostCancelReservationByExtIdRequest {
...
export function PostCancelReservationByExtIdRequestToJSON(value?: PostCancelReservationByExtIdRequest | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
