 ...
 * 
 * @export
 * @interface PutSharingGuestsRequest
 */
export interface PutSharingGuestsRequest {
    /**
     * 
     * @type {Array<InstanceLink>}
     * @memberof PutSharingGuestsRequest
     */
 ...
 */
export function instanceOfPutSharingGuestsRequest(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function PutSharingGuestsRequestFromJSON(json: any): PutSharingGuestsRequest {
    return PutSharingGuestsRequestFromJSONTyped(json, false);
}

export function PutSharingGuestsRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): PutSharingGuestsRequest {
...
export function PutSharingGuestsRequestToJSON(value?: PutSharingGuestsRequest | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
