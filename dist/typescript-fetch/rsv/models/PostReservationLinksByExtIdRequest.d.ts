 ...
 */
export declare function instanceOfPostReservationLinksByExtIdRequest(value: object): boolean;
export declare function PostReservationLinksByExtIdRequestFromJSON(json: any): PostReservationLinksByExtIdRequest;
export declare function PostReservationLinksByExtIdRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): PostReservationLinksByExtIdRequest;
export declare function PostReservationLinksByExtIdRequestToJSON(value?: PostReservationLinksByExtIdRequest | null): any;
