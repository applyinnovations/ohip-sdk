...
function ComputeDepositPoliciesDetailsFromJSONTyped(json, ignoreDiscriminator) {
    ...
    return {
        ...
        'policies': !(0, runtime_1.exists)(json, 'policies') ? undefined : (json['policies'].map(ResDepositPolicyType_1.ResDepositPolicyTypeFromJSON)),
...
function ComputeDepositPoliciesDetailsToJSON(value) {
    ...
    return {
        ...
        'policies': value.policies === undefined ? undefined : (value.policies.map(ResDepositPolicyType_1.ResDepositPolicyTypeToJSON)),
