 ...
 */
function instanceOfReservationExcludedPreferences(value) {
    let isInstance = true;
    return isInstance;
}
exports.instanceOfReservationExcludedPreferences = instanceOfReservationExcludedPreferences;
function ReservationExcludedPreferencesFromJSON(json) {
    return ReservationExcludedPreferencesFromJSONTyped(json, false);
}
exports.ReservationExcludedPreferencesFromJSON = ReservationExcludedPreferencesFromJSON;
function ReservationExcludedPreferencesFromJSONTyped(json, ignoreDiscriminator) {
...
function ReservationExcludedPreferencesToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
