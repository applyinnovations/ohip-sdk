 ...
 */
function instanceOfCheckReservationsDetails(value) {
    let isInstance = true;
    return isInstance;
}
exports.instanceOfCheckReservationsDetails = instanceOfCheckReservationsDetails;
function CheckReservationsDetailsFromJSON(json) {
    return CheckReservationsDetailsFromJSONTyped(json, false);
}
exports.CheckReservationsDetailsFromJSON = CheckReservationsDetailsFromJSON;
function CheckReservationsDetailsFromJSONTyped(json, ignoreDiscriminator) {
...
function CheckReservationsDetailsToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
