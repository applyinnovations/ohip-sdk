 ...
 */
function instanceOfReservationStatistics(value) {
    let isInstance = true;
    return isInstance;
}
exports.instanceOfReservationStatistics = instanceOfReservationStatistics;
function ReservationStatisticsFromJSON(json) {
    return ReservationStatisticsFromJSONTyped(json, false);
}
exports.ReservationStatisticsFromJSON = ReservationStatisticsFromJSON;
function ReservationStatisticsFromJSONTyped(json, ignoreDiscriminator) {
...
function ReservationStatisticsToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
