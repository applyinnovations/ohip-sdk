 ...
 */
export declare function instanceOfCancelReservationsType(value: object): boolean;
export declare function CancelReservationsTypeFromJSON(json: any): CancelReservationsType;
export declare function CancelReservationsTypeFromJSONTyped(json: any, ignoreDiscriminator: boolean): CancelReservationsType;
export declare function CancelReservationsTypeToJSON(value?: CancelReservationsType | null): any;
