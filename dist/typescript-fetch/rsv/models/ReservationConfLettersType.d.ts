 ...
 */
export declare function instanceOfReservationConfLettersType(value: object): boolean;
export declare function ReservationConfLettersTypeFromJSON(json: any): ReservationConfLettersType;
export declare function ReservationConfLettersTypeFromJSONTyped(json: any, ignoreDiscriminator: boolean): ReservationConfLettersType;
export declare function ReservationConfLettersTypeToJSON(value?: ReservationConfLettersType | null): any;
