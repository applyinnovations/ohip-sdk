 ...
 * @export
 * @interface ReservationPreferenceInfo
 */
export interface ReservationPreferenceInfo {
    /**
 ...
 */
export function instanceOfReservationPreferenceInfo(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function ReservationPreferenceInfoFromJSON(json: any): ReservationPreferenceInfo {
    return ReservationPreferenceInfoFromJSONTyped(json, false);
}

export function ReservationPreferenceInfoFromJSONTyped(json: any, ignoreDiscriminator: boolean): ReservationPreferenceInfo {
...
export function ReservationPreferenceInfoToJSON(value?: ReservationPreferenceInfo | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
