...
function TotalTypeFromJSONTyped(json, ignoreDiscriminator) {
    ...
    return {
        ...
        'amountBeforeAnyTax': !(0, runtime_1.exists)(json, 'amountBeforeAnyTax') ? undefined : json['amountBeforeAnyTax'],
        ...
        'amountBeforeTaxPerRoom': !(0, runtime_1.exists)(json, 'amountBeforeTaxPerRoom') ? undefined : json['amountBeforeTaxPerRoom'],
        'amountAfterTaxPerRoom': !(0, runtime_1.exists)(json, 'amountAfterTaxPerRoom') ? undefined : json['amountAfterTaxPerRoom'],
    };
}
