 ...
 */
export declare function instanceOfDistinctIDType(value: object): boolean;
export declare function DistinctIDTypeFromJSON(json: any): DistinctIDType;
export declare function DistinctIDTypeFromJSONTyped(json: any, ignoreDiscriminator: boolean): DistinctIDType;
export declare function DistinctIDTypeToJSON(value?: DistinctIDType | null): any;
