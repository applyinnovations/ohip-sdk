 ...
 */
export declare function instanceOfShareDistributionCriteria(value: object): boolean;
export declare function ShareDistributionCriteriaFromJSON(json: any): ShareDistributionCriteria;
export declare function ShareDistributionCriteriaFromJSONTyped(json: any, ignoreDiscriminator: boolean): ShareDistributionCriteria;
export declare function ShareDistributionCriteriaToJSON(value?: ShareDistributionCriteria | null): any;
