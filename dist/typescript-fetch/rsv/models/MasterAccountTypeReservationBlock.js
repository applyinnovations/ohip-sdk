 ...
 */
function instanceOfMasterAccountTypeReservationBlock(value) {
    let isInstance = true;
    return isInstance;
}
exports.instanceOfMasterAccountTypeReservationBlock = instanceOfMasterAccountTypeReservationBlock;
function MasterAccountTypeReservationBlockFromJSON(json) {
    return MasterAccountTypeReservationBlockFromJSONTyped(json, false);
}
exports.MasterAccountTypeReservationBlockFromJSON = MasterAccountTypeReservationBlockFromJSON;
function MasterAccountTypeReservationBlockFromJSONTyped(json, ignoreDiscriminator) {
...
function MasterAccountTypeReservationBlockToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
