 ...
 */
export declare function instanceOfDepositCancelConfigCriteriaType(value: object): boolean;
export declare function DepositCancelConfigCriteriaTypeFromJSON(json: any): DepositCancelConfigCriteriaType;
export declare function DepositCancelConfigCriteriaTypeFromJSONTyped(json: any, ignoreDiscriminator: boolean): DepositCancelConfigCriteriaType;
export declare function DepositCancelConfigCriteriaTypeToJSON(value?: DepositCancelConfigCriteriaType | null): any;
