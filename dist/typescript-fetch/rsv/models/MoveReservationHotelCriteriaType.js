...
exports.MoveReservationHotelCriteriaTypeToJSON = exports.MoveReservationHotelCriteriaTypeFromJSONTyped = exports.MoveReservationHotelCriteriaTypeFromJSON = exports.instanceOfMoveReservationHotelCriteriaType = void 0;
 ...
 */
function instanceOfMoveReservationHotelCriteriaType(value) {
    let isInstance = true;
    return isInstance;
}
exports.instanceOfMoveReservationHotelCriteriaType = instanceOfMoveReservationHotelCriteriaType;
function MoveReservationHotelCriteriaTypeFromJSON(json) {
    return MoveReservationHotelCriteriaTypeFromJSONTyped(json, false);
}
exports.MoveReservationHotelCriteriaTypeFromJSON = MoveReservationHotelCriteriaTypeFromJSON;
function MoveReservationHotelCriteriaTypeFromJSONTyped(json, ignoreDiscriminator) {
    ...
    return {
        ...
        'retainRateCodeAndAmount': !(0, runtime_1.exists)(json, 'retainRateCodeAndAmount') ? undefined : json['retainRateCodeAndAmount'],
    };
}
exports.MoveReservationHotelCriteriaTypeFromJSONTyped = MoveReservationHotelCriteriaTypeFromJSONTyped;
function MoveReservationHotelCriteriaTypeToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
...
exports.MoveReservationHotelCriteriaTypeToJSON = MoveReservationHotelCriteriaTypeToJSON;
