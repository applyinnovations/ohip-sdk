 ...
 */
function instanceOfPreArrivalMemberReservationType(value) {
    let isInstance = true;
    return isInstance;
}
exports.instanceOfPreArrivalMemberReservationType = instanceOfPreArrivalMemberReservationType;
function PreArrivalMemberReservationTypeFromJSON(json) {
    return PreArrivalMemberReservationTypeFromJSONTyped(json, false);
}
exports.PreArrivalMemberReservationTypeFromJSON = PreArrivalMemberReservationTypeFromJSON;
function PreArrivalMemberReservationTypeFromJSONTyped(json, ignoreDiscriminator) {
...
function PreArrivalMemberReservationTypeToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
