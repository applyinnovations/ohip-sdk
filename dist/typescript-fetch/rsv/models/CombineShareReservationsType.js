...
const CombineShareFromExistingReservationType_1 = require("./CombineShareFromExistingReservationType");
...
function CombineShareReservationsTypeFromJSONTyped(json, ignoreDiscriminator) {
    ...
    return {
        ...
        'existingReservation': !(0, runtime_1.exists)(json, 'existingReservation') ? undefined : (0, CombineShareFromExistingReservationType_1.CombineShareFromExistingReservationTypeFromJSON)(json['existingReservation']),
    };
}
...
function CombineShareReservationsTypeToJSON(value) {
    ...
    return {
        ...
        'existingReservation': (0, CombineShareFromExistingReservationType_1.CombineShareFromExistingReservationTypeToJSON)(value.existingReservation),
    };
}
