 ...
 */
export function instanceOfReservationLock(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function ReservationLockFromJSON(json: any): ReservationLock {
    return ReservationLockFromJSONTyped(json, false);
}

export function ReservationLockFromJSONTyped(json: any, ignoreDiscriminator: boolean): ReservationLock {
...
export function ReservationLockToJSON(value?: ReservationLock | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
