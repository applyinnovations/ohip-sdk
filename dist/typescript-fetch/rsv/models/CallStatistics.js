 ...
 */
function instanceOfCallStatistics(value) {
    let isInstance = true;
    return isInstance;
}
exports.instanceOfCallStatistics = instanceOfCallStatistics;
function CallStatisticsFromJSON(json) {
    return CallStatisticsFromJSONTyped(json, false);
}
exports.CallStatisticsFromJSON = CallStatisticsFromJSON;
function CallStatisticsFromJSONTyped(json, ignoreDiscriminator) {
...
function CallStatisticsToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
