...
export interface RoomInfo {
     ...
     * @memberof RoomInfo
     */
    componentSuiteRoomNumbers?: Array<string>;
    /**
     * Room number.
     * @type {Array<string>}
     * @memberof RoomInfo
 ...
 */
export declare function instanceOfRoomInfo(value: object): boolean;
export declare function RoomInfoFromJSON(json: any): RoomInfo;
export declare function RoomInfoFromJSONTyped(json: any, ignoreDiscriminator: boolean): RoomInfo;
export declare function RoomInfoToJSON(value?: RoomInfo | null): any;
