 ...
 */
function instanceOfShareReservationType(value) {
    let isInstance = true;
    return isInstance;
}
exports.instanceOfShareReservationType = instanceOfShareReservationType;
function ShareReservationTypeFromJSON(json) {
    return ShareReservationTypeFromJSONTyped(json, false);
}
exports.ShareReservationTypeFromJSON = ShareReservationTypeFromJSON;
function ShareReservationTypeFromJSONTyped(json, ignoreDiscriminator) {
...
exports.ShareReservationTypeFromJSONTyped = ShareReservationTypeFromJSONTyped;
function ShareReservationTypeToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
...
exports.ShareReservationTypeToJSON = ShareReservationTypeToJSON;
