 ...
 */
function instanceOfReservationAwards(value) {
    let isInstance = true;
    return isInstance;
}
exports.instanceOfReservationAwards = instanceOfReservationAwards;
function ReservationAwardsFromJSON(json) {
    return ReservationAwardsFromJSONTyped(json, false);
}
exports.ReservationAwardsFromJSON = ReservationAwardsFromJSON;
function ReservationAwardsFromJSONTyped(json, ignoreDiscriminator) {
...
function ReservationAwardsToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
