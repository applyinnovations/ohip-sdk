 ...
 */
function instanceOfReserveInventoryItems(value) {
    let isInstance = true;
    return isInstance;
}
exports.instanceOfReserveInventoryItems = instanceOfReserveInventoryItems;
function ReserveInventoryItemsFromJSON(json) {
    return ReserveInventoryItemsFromJSONTyped(json, false);
}
exports.ReserveInventoryItemsFromJSON = ReserveInventoryItemsFromJSON;
function ReserveInventoryItemsFromJSONTyped(json, ignoreDiscriminator) {
...
function ReserveInventoryItemsToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
