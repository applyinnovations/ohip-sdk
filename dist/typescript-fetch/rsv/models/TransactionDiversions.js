 ...
 */
function instanceOfTransactionDiversions(value) {
    let isInstance = true;
    return isInstance;
}
exports.instanceOfTransactionDiversions = instanceOfTransactionDiversions;
function TransactionDiversionsFromJSON(json) {
    return TransactionDiversionsFromJSONTyped(json, false);
}
exports.TransactionDiversionsFromJSON = TransactionDiversionsFromJSON;
function TransactionDiversionsFromJSONTyped(json, ignoreDiscriminator) {
...
function TransactionDiversionsToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
