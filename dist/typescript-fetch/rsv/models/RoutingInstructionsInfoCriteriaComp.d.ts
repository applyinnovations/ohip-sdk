 ...
 */
export declare function instanceOfRoutingInstructionsInfoCriteriaComp(value: object): boolean;
export declare function RoutingInstructionsInfoCriteriaCompFromJSON(json: any): RoutingInstructionsInfoCriteriaComp;
export declare function RoutingInstructionsInfoCriteriaCompFromJSONTyped(json: any, ignoreDiscriminator: boolean): RoutingInstructionsInfoCriteriaComp;
export declare function RoutingInstructionsInfoCriteriaCompToJSON(value?: RoutingInstructionsInfoCriteriaComp | null): any;
