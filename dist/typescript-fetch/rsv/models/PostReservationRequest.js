...
exports.PostReservationRequestToJSON = exports.PostReservationRequestFromJSONTyped = exports.PostReservationRequestFromJSON = exports.instanceOfPostReservationRequest = void 0;
 ...
 */
function instanceOfPostReservationRequest(value) {
    let isInstance = true;
    return isInstance;
}
exports.instanceOfPostReservationRequest = instanceOfPostReservationRequest;
function PostReservationRequestFromJSON(json) {
    return PostReservationRequestFromJSONTyped(json, false);
}
exports.PostReservationRequestFromJSON = PostReservationRequestFromJSON;
function PostReservationRequestFromJSONTyped(json, ignoreDiscriminator) {
...
function PostReservationRequestToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
