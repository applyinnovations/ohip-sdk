 ...
 */
export declare function instanceOfConfirmationLettersDetails(value: object): boolean;
export declare function ConfirmationLettersDetailsFromJSON(json: any): ConfirmationLettersDetails;
export declare function ConfirmationLettersDetailsFromJSONTyped(json: any, ignoreDiscriminator: boolean): ConfirmationLettersDetails;
export declare function ConfirmationLettersDetailsToJSON(value?: ConfirmationLettersDetails | null): any;
