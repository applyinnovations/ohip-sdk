 ...
 */
export declare function instanceOfReservationAlertsType(value: object): boolean;
export declare function ReservationAlertsTypeFromJSON(json: any): ReservationAlertsType;
export declare function ReservationAlertsTypeFromJSONTyped(json: any, ignoreDiscriminator: boolean): ReservationAlertsType;
export declare function ReservationAlertsTypeToJSON(value?: ReservationAlertsType | null): any;
