 ...
 */
function instanceOfTransactionDiversionsInfo(value) {
    let isInstance = true;
    return isInstance;
}
exports.instanceOfTransactionDiversionsInfo = instanceOfTransactionDiversionsInfo;
function TransactionDiversionsInfoFromJSON(json) {
    return TransactionDiversionsInfoFromJSONTyped(json, false);
}
exports.TransactionDiversionsInfoFromJSON = TransactionDiversionsInfoFromJSON;
function TransactionDiversionsInfoFromJSONTyped(json, ignoreDiscriminator) {
...
function TransactionDiversionsInfoToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
