 ...
 */
export declare function instanceOfReservationDailyRateDetailDetails(value: object): boolean;
export declare function ReservationDailyRateDetailDetailsFromJSON(json: any): ReservationDailyRateDetailDetails;
export declare function ReservationDailyRateDetailDetailsFromJSONTyped(json: any, ignoreDiscriminator: boolean): ReservationDailyRateDetailDetails;
export declare function ReservationDailyRateDetailDetailsToJSON(value?: ReservationDailyRateDetailDetails | null): any;
