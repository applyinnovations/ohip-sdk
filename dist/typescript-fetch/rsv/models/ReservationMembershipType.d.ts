 ...
 */
export declare function instanceOfReservationMembershipType(value: object): boolean;
export declare function ReservationMembershipTypeFromJSON(json: any): ReservationMembershipType;
export declare function ReservationMembershipTypeFromJSONTyped(json: any, ignoreDiscriminator: boolean): ReservationMembershipType;
export declare function ReservationMembershipTypeToJSON(value?: ReservationMembershipType | null): any;
