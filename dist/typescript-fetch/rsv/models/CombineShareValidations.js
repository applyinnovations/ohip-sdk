 ...
 */
function instanceOfCombineShareValidations(value) {
    let isInstance = true;
    return isInstance;
}
exports.instanceOfCombineShareValidations = instanceOfCombineShareValidations;
function CombineShareValidationsFromJSON(json) {
    return CombineShareValidationsFromJSONTyped(json, false);
}
exports.CombineShareValidationsFromJSON = CombineShareValidationsFromJSON;
function CombineShareValidationsFromJSONTyped(json, ignoreDiscriminator) {
...
function CombineShareValidationsToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
