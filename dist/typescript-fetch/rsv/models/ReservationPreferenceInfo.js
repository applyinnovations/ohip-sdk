 ...
 */
function instanceOfReservationPreferenceInfo(value) {
    let isInstance = true;
    return isInstance;
}
exports.instanceOfReservationPreferenceInfo = instanceOfReservationPreferenceInfo;
function ReservationPreferenceInfoFromJSON(json) {
    return ReservationPreferenceInfoFromJSONTyped(json, false);
}
exports.ReservationPreferenceInfoFromJSON = ReservationPreferenceInfoFromJSON;
function ReservationPreferenceInfoFromJSONTyped(json, ignoreDiscriminator) {
...
function ReservationPreferenceInfoToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
