...
exports.CreateReservationToJSON = exports.CreateReservationFromJSONTyped = exports.CreateReservationFromJSON = exports.instanceOfCreateReservation = void 0;
 ...
 */
function instanceOfCreateReservation(value) {
    let isInstance = true;
    return isInstance;
}
exports.instanceOfCreateReservation = instanceOfCreateReservation;
function CreateReservationFromJSON(json) {
    return CreateReservationFromJSONTyped(json, false);
}
exports.CreateReservationFromJSON = CreateReservationFromJSON;
function CreateReservationFromJSONTyped(json, ignoreDiscriminator) {
...
exports.CreateReservationFromJSONTyped = CreateReservationFromJSONTyped;
function CreateReservationToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
...
exports.CreateReservationToJSON = CreateReservationToJSON;
