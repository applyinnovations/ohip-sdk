 ...
 */
function instanceOfReservationLocatorsDetailsInfo(value) {
    let isInstance = true;
    return isInstance;
}
exports.instanceOfReservationLocatorsDetailsInfo = instanceOfReservationLocatorsDetailsInfo;
function ReservationLocatorsDetailsInfoFromJSON(json) {
    return ReservationLocatorsDetailsInfoFromJSONTyped(json, false);
}
exports.ReservationLocatorsDetailsInfoFromJSON = ReservationLocatorsDetailsInfoFromJSON;
function ReservationLocatorsDetailsInfoFromJSONTyped(json, ignoreDiscriminator) {
...
function ReservationLocatorsDetailsInfoToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
