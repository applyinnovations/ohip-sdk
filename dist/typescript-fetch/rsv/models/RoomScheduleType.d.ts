 ...
 */
export declare function instanceOfRoomScheduleType(value: object): boolean;
export declare function RoomScheduleTypeFromJSON(json: any): RoomScheduleType;
export declare function RoomScheduleTypeFromJSONTyped(json: any, ignoreDiscriminator: boolean): RoomScheduleType;
export declare function RoomScheduleTypeToJSON(value?: RoomScheduleType | null): any;
