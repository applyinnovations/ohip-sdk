 ...
 */
export function instanceOfTicketsInfo(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function TicketsInfoFromJSON(json: any): TicketsInfo {
    return TicketsInfoFromJSONTyped(json, false);
}

export function TicketsInfoFromJSONTyped(json: any, ignoreDiscriminator: boolean): TicketsInfo {
...
export function TicketsInfoToJSON(value?: TicketsInfo | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
