 ...
 * 
 * @export
 * @interface PutTransactionDiversionsRequest
 */
export interface PutTransactionDiversionsRequest {
    /**
     * Used for codes in the OPERA Code tables. Possible values of this pattern are 1, 101, 101.EQP, or 101.EQP.X.
     * @type {string}
     * @memberof PutTransactionDiversionsRequest
     */
    hotelId?: string;
    /**
     * 
 ...
 */
export function instanceOfPutTransactionDiversionsRequest(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function PutTransactionDiversionsRequestFromJSON(json: any): PutTransactionDiversionsRequest {
    return PutTransactionDiversionsRequestFromJSONTyped(json, false);
}

export function PutTransactionDiversionsRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): PutTransactionDiversionsRequest {
...
export function PutTransactionDiversionsRequestToJSON(value?: PutTransactionDiversionsRequest | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
