 ...
 */
function instanceOfDeliveryHistoryLog(value) {
    let isInstance = true;
    return isInstance;
}
exports.instanceOfDeliveryHistoryLog = instanceOfDeliveryHistoryLog;
function DeliveryHistoryLogFromJSON(json) {
    return DeliveryHistoryLogFromJSONTyped(json, false);
}
exports.DeliveryHistoryLogFromJSON = DeliveryHistoryLogFromJSON;
function DeliveryHistoryLogFromJSONTyped(json, ignoreDiscriminator) {
...
function DeliveryHistoryLogToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
