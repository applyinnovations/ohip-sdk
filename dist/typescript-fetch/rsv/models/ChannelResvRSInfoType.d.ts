 ...
 */
export declare function instanceOfChannelResvRSInfoType(value: object): boolean;
export declare function ChannelResvRSInfoTypeFromJSON(json: any): ChannelResvRSInfoType;
export declare function ChannelResvRSInfoTypeFromJSONTyped(json: any, ignoreDiscriminator: boolean): ChannelResvRSInfoType;
export declare function ChannelResvRSInfoTypeToJSON(value?: ChannelResvRSInfoType | null): any;
