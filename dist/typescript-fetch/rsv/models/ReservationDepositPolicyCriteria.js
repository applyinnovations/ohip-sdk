 ...
 */
function instanceOfReservationDepositPolicyCriteria(value) {
    let isInstance = true;
    return isInstance;
}
exports.instanceOfReservationDepositPolicyCriteria = instanceOfReservationDepositPolicyCriteria;
function ReservationDepositPolicyCriteriaFromJSON(json) {
    return ReservationDepositPolicyCriteriaFromJSONTyped(json, false);
}
exports.ReservationDepositPolicyCriteriaFromJSON = ReservationDepositPolicyCriteriaFromJSON;
function ReservationDepositPolicyCriteriaFromJSONTyped(json, ignoreDiscriminator) {
...
function ReservationDepositPolicyCriteriaToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
