...
const ReservationPreConfiguredRoutingInstructionsType_1 = require("./ReservationPreConfiguredRoutingInstructionsType");
...
function ResCashieringTypeFromJSONTyped(json, ignoreDiscriminator) {
    ...
    return {
        ...
        'reservationPreConfiguredRoutingInstructions': !(0, runtime_1.exists)(json, 'reservationPreConfiguredRoutingInstructions') ? undefined : (0, ReservationPreConfiguredRoutingInstructionsType_1.ReservationPreConfiguredRoutingInstructionsTypeFromJSON)(json['reservationPreConfiguredRoutingInstructions']),
    };
}
...
function ResCashieringTypeToJSON(value) {
    ...
    return {
        ...
        'reservationPreConfiguredRoutingInstructions': (0, ReservationPreConfiguredRoutingInstructionsType_1.ReservationPreConfiguredRoutingInstructionsTypeToJSON)(value.reservationPreConfiguredRoutingInstructions),
    };
}
