 ...
 */
function instanceOfReservationConfLettersType(value) {
    let isInstance = true;
    return isInstance;
}
exports.instanceOfReservationConfLettersType = instanceOfReservationConfLettersType;
function ReservationConfLettersTypeFromJSON(json) {
    return ReservationConfLettersTypeFromJSONTyped(json, false);
}
exports.ReservationConfLettersTypeFromJSON = ReservationConfLettersTypeFromJSON;
function ReservationConfLettersTypeFromJSONTyped(json, ignoreDiscriminator) {
...
exports.ReservationConfLettersTypeFromJSONTyped = ReservationConfLettersTypeFromJSONTyped;
function ReservationConfLettersTypeToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
...
exports.ReservationConfLettersTypeToJSON = ReservationConfLettersTypeToJSON;
