 ...
 */
function instanceOfReservationConfirmationLetters(value) {
    let isInstance = true;
    return isInstance;
}
exports.instanceOfReservationConfirmationLetters = instanceOfReservationConfirmationLetters;
function ReservationConfirmationLettersFromJSON(json) {
    return ReservationConfirmationLettersFromJSONTyped(json, false);
}
exports.ReservationConfirmationLettersFromJSON = ReservationConfirmationLettersFromJSON;
function ReservationConfirmationLettersFromJSONTyped(json, ignoreDiscriminator) {
...
function ReservationConfirmationLettersToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
