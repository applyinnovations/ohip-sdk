...
function NumericCategorySummaryTypeFromJSONTyped(json, ignoreDiscriminator) {
    ...
    return {
        'numericCategoryCode': !(0, runtime_1.exists)(json, 'numericCategoryCode') ? undefined : json['numericCategoryCode'],
        'numericSummary': !(0, runtime_1.exists)(json, 'numericSummary') ? undefined : json['numericSummary'],
    };
}
