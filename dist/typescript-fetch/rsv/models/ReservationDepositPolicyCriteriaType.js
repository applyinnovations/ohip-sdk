...
exports.ReservationDepositPolicyCriteriaTypeToJSON = exports.ReservationDepositPolicyCriteriaTypeFromJSONTyped = exports.ReservationDepositPolicyCriteriaTypeFromJSON = exports.instanceOfReservationDepositPolicyCriteriaType = void 0;
 ...
 */
function instanceOfReservationDepositPolicyCriteriaType(value) {
    let isInstance = true;
    return isInstance;
}
exports.instanceOfReservationDepositPolicyCriteriaType = instanceOfReservationDepositPolicyCriteriaType;
function ReservationDepositPolicyCriteriaTypeFromJSON(json) {
    return ReservationDepositPolicyCriteriaTypeFromJSONTyped(json, false);
}
exports.ReservationDepositPolicyCriteriaTypeFromJSON = ReservationDepositPolicyCriteriaTypeFromJSON;
function ReservationDepositPolicyCriteriaTypeFromJSONTyped(json, ignoreDiscriminator) {
...
exports.ReservationDepositPolicyCriteriaTypeFromJSONTyped = ReservationDepositPolicyCriteriaTypeFromJSONTyped;
function ReservationDepositPolicyCriteriaTypeToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
...
exports.ReservationDepositPolicyCriteriaTypeToJSON = ReservationDepositPolicyCriteriaTypeToJSON;
