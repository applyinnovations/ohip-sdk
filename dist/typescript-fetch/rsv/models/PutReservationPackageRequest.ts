 ...
 */
export function instanceOfPutReservationPackageRequest(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function PutReservationPackageRequestFromJSON(json: any): PutReservationPackageRequest {
    return PutReservationPackageRequestFromJSONTyped(json, false);
}

export function PutReservationPackageRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): PutReservationPackageRequest {
...
export function PutReservationPackageRequestToJSON(value?: PutReservationPackageRequest | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
