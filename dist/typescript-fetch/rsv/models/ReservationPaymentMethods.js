 ...
 */
function instanceOfReservationPaymentMethods(value) {
    let isInstance = true;
    return isInstance;
}
exports.instanceOfReservationPaymentMethods = instanceOfReservationPaymentMethods;
function ReservationPaymentMethodsFromJSON(json) {
    return ReservationPaymentMethodsFromJSONTyped(json, false);
}
exports.ReservationPaymentMethodsFromJSON = ReservationPaymentMethodsFromJSON;
function ReservationPaymentMethodsFromJSONTyped(json, ignoreDiscriminator) {
...
function ReservationPaymentMethodsToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
