 ...
 */
function instanceOfBlockReservationStatisticsByDateAndRoomPoolType(value) {
    let isInstance = true;
    return isInstance;
}
exports.instanceOfBlockReservationStatisticsByDateAndRoomPoolType = instanceOfBlockReservationStatisticsByDateAndRoomPoolType;
function BlockReservationStatisticsByDateAndRoomPoolTypeFromJSON(json) {
    return BlockReservationStatisticsByDateAndRoomPoolTypeFromJSONTyped(json, false);
}
exports.BlockReservationStatisticsByDateAndRoomPoolTypeFromJSON = BlockReservationStatisticsByDateAndRoomPoolTypeFromJSON;
function BlockReservationStatisticsByDateAndRoomPoolTypeFromJSONTyped(json, ignoreDiscriminator) {
...
function BlockReservationStatisticsByDateAndRoomPoolTypeToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
