 ...
 */
export declare function instanceOfPutValidateReservationChangesRequest(value: object): boolean;
export declare function PutValidateReservationChangesRequestFromJSON(json: any): PutValidateReservationChangesRequest;
export declare function PutValidateReservationChangesRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): PutValidateReservationChangesRequest;
export declare function PutValidateReservationChangesRequestToJSON(value?: PutValidateReservationChangesRequest | null): any;
