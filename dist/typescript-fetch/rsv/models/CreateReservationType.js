...
exports.CreateReservationTypeToJSON = exports.CreateReservationTypeFromJSONTyped = exports.CreateReservationTypeFromJSON = exports.instanceOfCreateReservationType = void 0;
 ...
 */
function instanceOfCreateReservationType(value) {
    let isInstance = true;
    return isInstance;
}
exports.instanceOfCreateReservationType = instanceOfCreateReservationType;
function CreateReservationTypeFromJSON(json) {
    return CreateReservationTypeFromJSONTyped(json, false);
}
exports.CreateReservationTypeFromJSON = CreateReservationTypeFromJSON;
function CreateReservationTypeFromJSONTyped(json, ignoreDiscriminator) {
...
exports.CreateReservationTypeFromJSONTyped = CreateReservationTypeFromJSONTyped;
function CreateReservationTypeToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
...
exports.CreateReservationTypeToJSON = CreateReservationTypeToJSON;
