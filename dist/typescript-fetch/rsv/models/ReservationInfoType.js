...
const DepartureReservationInfoType_1 = require("./DepartureReservationInfoType");
...
function ReservationInfoTypeFromJSONTyped(json, ignoreDiscriminator) {
    ...
    return {
        ...
        'departureReservationInfo': !(0, runtime_1.exists)(json, 'departureReservationInfo') ? undefined : (0, DepartureReservationInfoType_1.DepartureReservationInfoTypeFromJSON)(json['departureReservationInfo']),
        ...
        'parentReservationHotelId': !(0, runtime_1.exists)(json, 'parentReservationHotelId') ? undefined : json['parentReservationHotelId'],
...
function ReservationInfoTypeToJSON(value) {
    ...
    return {
        ...
        'departureReservationInfo': (0, DepartureReservationInfoType_1.DepartureReservationInfoTypeToJSON)(value.departureReservationInfo),
        ...
        'parentReservationHotelId': value.parentReservationHotelId,
