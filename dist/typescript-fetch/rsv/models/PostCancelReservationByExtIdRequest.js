...
exports.PostCancelReservationByExtIdRequestToJSON = exports.PostCancelReservationByExtIdRequestFromJSONTyped = exports.PostCancelReservationByExtIdRequestFromJSON = exports.instanceOfPostCancelReservationByExtIdRequest = void 0;
 ...
 */
function instanceOfPostCancelReservationByExtIdRequest(value) {
    let isInstance = true;
    return isInstance;
}
exports.instanceOfPostCancelReservationByExtIdRequest = instanceOfPostCancelReservationByExtIdRequest;
function PostCancelReservationByExtIdRequestFromJSON(json) {
    return PostCancelReservationByExtIdRequestFromJSONTyped(json, false);
}
exports.PostCancelReservationByExtIdRequestFromJSON = PostCancelReservationByExtIdRequestFromJSON;
function PostCancelReservationByExtIdRequestFromJSONTyped(json, ignoreDiscriminator) {
...
exports.PostCancelReservationByExtIdRequestFromJSONTyped = PostCancelReservationByExtIdRequestFromJSONTyped;
function PostCancelReservationByExtIdRequestToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
...
exports.PostCancelReservationByExtIdRequestToJSON = PostCancelReservationByExtIdRequestToJSON;
