 ...
 */
function instanceOfReservationAttachments(value) {
    let isInstance = true;
    return isInstance;
}
exports.instanceOfReservationAttachments = instanceOfReservationAttachments;
function ReservationAttachmentsFromJSON(json) {
    return ReservationAttachmentsFromJSONTyped(json, false);
}
exports.ReservationAttachmentsFromJSON = ReservationAttachmentsFromJSON;
function ReservationAttachmentsFromJSONTyped(json, ignoreDiscriminator) {
...
function ReservationAttachmentsToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
