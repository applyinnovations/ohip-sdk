 ...
 */
export declare function instanceOfAwardUpgradeInfoType(value: object): boolean;
export declare function AwardUpgradeInfoTypeFromJSON(json: any): AwardUpgradeInfoType;
export declare function AwardUpgradeInfoTypeFromJSONTyped(json: any, ignoreDiscriminator: boolean): AwardUpgradeInfoType;
export declare function AwardUpgradeInfoTypeToJSON(value?: AwardUpgradeInfoType | null): any;
