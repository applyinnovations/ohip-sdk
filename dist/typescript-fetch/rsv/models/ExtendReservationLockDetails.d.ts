 ...
 */
export declare function instanceOfExtendReservationLockDetails(value: object): boolean;
export declare function ExtendReservationLockDetailsFromJSON(json: any): ExtendReservationLockDetails;
export declare function ExtendReservationLockDetailsFromJSONTyped(json: any, ignoreDiscriminator: boolean): ExtendReservationLockDetails;
export declare function ExtendReservationLockDetailsToJSON(value?: ExtendReservationLockDetails | null): any;
