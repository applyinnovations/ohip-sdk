 ...
 */
function instanceOfChangeInstructionType(value) {
    let isInstance = true;
    return isInstance;
}
exports.instanceOfChangeInstructionType = instanceOfChangeInstructionType;
function ChangeInstructionTypeFromJSON(json) {
    return ChangeInstructionTypeFromJSONTyped(json, false);
}
exports.ChangeInstructionTypeFromJSON = ChangeInstructionTypeFromJSON;
function ChangeInstructionTypeFromJSONTyped(json, ignoreDiscriminator) {
    ...
    return {
        ...
        'applyUntilLastShareDepartureDate': !(0, runtime_1.exists)(json, 'applyUntilLastShareDepartureDate') ? undefined : json['applyUntilLastShareDepartureDate'],
    };
}
exports.ChangeInstructionTypeFromJSONTyped = ChangeInstructionTypeFromJSONTyped;
function ChangeInstructionTypeToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'applyUntilLastShareDepartureDate': value.applyUntilLastShareDepartureDate,
    };
}
exports.ChangeInstructionTypeToJSON = ChangeInstructionTypeToJSON;
