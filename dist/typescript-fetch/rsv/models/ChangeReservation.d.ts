 ...
 */
export declare function instanceOfChangeReservation(value: object): boolean;
export declare function ChangeReservationFromJSON(json: any): ChangeReservation;
export declare function ChangeReservationFromJSONTyped(json: any, ignoreDiscriminator: boolean): ChangeReservation;
export declare function ChangeReservationToJSON(value?: ChangeReservation | null): any;
