 ...
 */
function instanceOfReservationsUpgradeEligibility(value) {
    let isInstance = true;
    return isInstance;
}
exports.instanceOfReservationsUpgradeEligibility = instanceOfReservationsUpgradeEligibility;
function ReservationsUpgradeEligibilityFromJSON(json) {
    return ReservationsUpgradeEligibilityFromJSONTyped(json, false);
}
exports.ReservationsUpgradeEligibilityFromJSON = ReservationsUpgradeEligibilityFromJSON;
function ReservationsUpgradeEligibilityFromJSONTyped(json, ignoreDiscriminator) {
...
function ReservationsUpgradeEligibilityToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
