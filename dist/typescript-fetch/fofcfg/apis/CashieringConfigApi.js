...
class CashieringConfigApi extends runtime.BaseAPI {
     ...
     */
    copyVouchersConfigRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            if (requestParameters.copyVouchersConfig === null || requestParameters.copyVouchersConfig === undefined) {
                throw new runtime.RequiredError('copyVouchersConfig', 'Required parameter requestParameters.copyVouchersConfig was null or undefined when calling copyVouchersConfig.');
            }
            const queryParameters = {};
            const headerParameters = {};
            headerParameters['Content-Type'] = 'application/json;charset=UTF-8';
            ...
            const response = yield this.request({
                path: `/hotelVouchersConfig/copy`,
                method: 'PUT',
                headers: headerParameters,
                query: queryParameters,
                body: (0, index_1.VouchersConfigCopyToJSON)(requestParameters.copyVouchersConfig),
            }, initOverrides);
            return new runtime.JSONApiResponse(response, (jsonValue) => (0, index_1.StatusFromJSON)(jsonValue));
        });
    }
     ...
     * Operation to copy Vouchers Config.
     */
    copyVouchersConfig(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield this.copyVouchersConfigRaw(requestParameters, initOverrides);
            return yield response.value();
        });
    }
    /**
    ...
    deleteRevenueBucketCodesRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (requestParameters.bucketType) {
     ...
     */
    deleteRoomTypebasedchargerangesRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            if (requestParameters.hotelId === null || requestParameters.hotelId === undefined) {
                throw new runtime.RequiredError('hotelId', 'Required parameter requestParameters.hotelId was null or undefined when calling deleteRoomTypebasedchargeranges.');
            }
            if (requestParameters.transactionNo === null || requestParameters.transactionNo === undefined) {
                throw new runtime.RequiredError('transactionNo', 'Required parameter requestParameters.transactionNo was null or undefined when calling deleteRoomTypebasedchargeranges.');
            }
            const queryParameters = {};
            if (requestParameters.hotelId !== undefined) {
                queryParameters['hotelId'] = requestParameters.hotelId;
            ...
            const response = yield this.request({
                path: `/roomTypeBasedChargeRanges`,
                method: 'DELETE',
                headers: headerParameters,
                query: queryParameters,
            }, initOverrides);
     ...
     * Operation to delete Room Type Based Charge Ranges.
     */
    deleteRoomTypebasedchargeranges(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield this.deleteRoomTypebasedchargerangesRaw(requestParameters, initOverrides);
            return yield response.value();
        });
    }
    /**
     ...
     */
    deleteVouchersRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            if (requestParameters.hotelId === null || requestParameters.hotelId === undefined) {
                throw new runtime.RequiredError('hotelId', 'Required parameter requestParameters.hotelId was null or undefined when calling deleteVouchers.');
            }
            if (requestParameters.voucherId === null || requestParameters.voucherId === undefined) {
                throw new runtime.RequiredError('voucherId', 'Required parameter requestParameters.voucherId was null or undefined when calling deleteVouchers.');
            }
            const queryParameters = {};
            if (requestParameters.voucherId !== undefined) {
                queryParameters['voucherId'] = requestParameters.voucherId;
            }
            const headerParameters = {};
            if (requestParameters.authorization !== undefined && requestParameters.authorization !== null) {
                headerParameters['authorization'] = String(requestParameters.authorization);
            ...
            const response = yield this.request({
                path: `/hotels/{hotelId}/vouchers`.replace(`{${"hotelId"}}`, encodeURIComponent(String(requestParameters.hotelId))),
                method: 'DELETE',
                headers: headerParameters,
                query: queryParameters,
            }, initOverrides);
     ...
     * Operation to remove Vouchers.
     */
    deleteVouchers(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield this.deleteVouchersRaw(requestParameters, initOverrides);
            return yield response.value();
        });
    }
    /**
     ...
     */
    getRoomTypeBasedChargeRangesRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            if (requestParameters.hotelId === null || requestParameters.hotelId === undefined) {
                throw new runtime.RequiredError('hotelId', 'Required parameter requestParameters.hotelId was null or undefined when calling getRoomTypeBasedChargeRanges.');
            }
            if (requestParameters.transactionCode === null || requestParameters.transactionCode === undefined) {
                throw new runtime.RequiredError('transactionCode', 'Required parameter requestParameters.transactionCode was null or undefined when calling getRoomTypeBasedChargeRanges.');
            }
            if (requestParameters.generateTrxCode === null || requestParameters.generateTrxCode === undefined) {
                throw new runtime.RequiredError('generateTrxCode', 'Required parameter requestParameters.generateTrxCode was null or undefined when calling getRoomTypeBasedChargeRanges.');
            }
            if (requestParameters.roomTypeGroup === null || requestParameters.roomTypeGroup === undefined) {
                throw new runtime.RequiredError('roomTypeGroup', 'Required parameter requestParameters.roomTypeGroup was null or undefined when calling getRoomTypeBasedChargeRanges.');
            }
            const queryParameters = {};
            if (requestParameters.hotelId !== undefined) {
                queryParameters['hotelId'] = requestParameters.hotelId;
            ...
            if (requestParameters.generateTrxCode !== undefined) {
                queryParameters['generateTrxCode'] = requestParameters.generateTrxCode;
            }
            if (requestParameters.roomTypeGroup !== undefined) {
                queryParameters['roomTypeGroup'] = requestParameters.roomTypeGroup;
            }
            const headerParameters = {};
            if (requestParameters.authorization !== undefined && requestParameters.authorization !== null) {
                headerParameters['authorization'] = String(requestParameters.authorization);
            ...
            return new runtime.JSONApiResponse(response, (jsonValue) => (0, index_1.RoomTypeBasedChargeRngsFromJSON)(jsonValue));
        });
    }
    /**
     * Use this API to return Room Type Based Charge Ranges for a hotels based on search criteria such as hotelId, transactionCode, generateTrxCode, RoomTypeGroup.<p><strong>OperationId:</strong>getRoomTypeBasedChargeRanges</p>
     * Operation to fetch Room Type Based Charge Ranges.
     */
    getRoomTypeBasedChargeRanges(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield this.getRoomTypeBasedChargeRangesRaw(requestParameters, initOverrides);
            return yield response.value();
        });
    }
    /**
    ...
    getTransactionCodesRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (requestParameters.earnMembershipPoints !== undefined) {
                queryParameters['earnMembershipPoints'] = requestParameters.earnMembershipPoints;
            }
            if (requestParameters.transactionGroupCodes) {
                queryParameters['transactionGroupCodes'] = requestParameters.transactionGroupCodes;
            }
     ...
     * Get Vouchers
     */
    getVouchersRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            if (requestParameters.hotelId === null || requestParameters.hotelId === undefined) {
                throw new runtime.RequiredError('hotelId', 'Required parameter requestParameters.hotelId was null or undefined when calling getVouchers.');
            }
            const queryParameters = {};
            if (requestParameters.membershipTypes) {
                queryParameters['membershipTypes'] = requestParameters.membershipTypes;
            ...
            return new runtime.JSONApiResponse(response, (jsonValue) => (0, index_1.VouchersDetailsFromJSON)(jsonValue));
        });
    }
    /**
     * Use this API to get Vouchers. <p><strong>OperationId:</strong>getVouchers</p>
     * Get Vouchers
     */
    getVouchers(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield this.getVouchersRaw(requestParameters, initOverrides);
            return yield response.value();
        });
    }
    /**
     ...
     */
    postRoomTypeBasedChargeRangesRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            if (requestParameters.roomTypeBasedChargeRanges === null || requestParameters.roomTypeBasedChargeRanges === undefined) {
                throw new runtime.RequiredError('roomTypeBasedChargeRanges', 'Required parameter requestParameters.roomTypeBasedChargeRanges was null or undefined when calling postRoomTypeBasedChargeRanges.');
            }
            const queryParameters = {};
            const headerParameters = {};
            headerParameters['Content-Type'] = 'application/json;charset=UTF-8';
            ...
            const response = yield this.request({
                ...
                headers: headerParameters,
                query: queryParameters,
                body: (0, index_1.RoomTypeBasedChargeRngsToJSON)(requestParameters.roomTypeBasedChargeRanges),
            }, initOverrides);
            return new runtime.JSONApiResponse(response, (jsonValue) => (0, index_1.StatusFromJSON)(jsonValue));
        });
    }
     ...
     * Operation to create Room Type Based Charge Ranges.
     */
    postRoomTypeBasedChargeRanges(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield this.postRoomTypeBasedChargeRangesRaw(requestParameters, initOverrides);
            return yield response.value();
        });
    }
    /**
    ...
    postTransactionGeneratesRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return new runtime.JSONApiResponse(response, (jsonValue) => (0, index_1.GeneratesInfoTypeFromJSON)(jsonValue));
        });
    }
    /**
     * Use this API to create transaction generates for a specific property.  Generates are rules used to calculate and post additional charges, such as service charges and taxes, when a particular sales charge transaction code is posted to guest, package or AR ledgers.<p><strong>OperationId:</strong>postTransactionGenerates</p>
     ...
     */
    postVouchersRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            if (requestParameters.hotelId === null || requestParameters.hotelId === undefined) {
                throw new runtime.RequiredError('hotelId', 'Required parameter requestParameters.hotelId was null or undefined when calling postVouchers.');
            }
            if (requestParameters.vouchers === null || requestParameters.vouchers === undefined) {
                throw new runtime.RequiredError('vouchers', 'Required parameter requestParameters.vouchers was null or undefined when calling postVouchers.');
            }
            const queryParameters = {};
            const headerParameters = {};
            headerParameters['Content-Type'] = 'application/json;charset=UTF-8';
            ...
            const response = yield this.request({
                ...
                headers: headerParameters,
                query: queryParameters,
                body: (0, index_1.VouchersDetailsToJSON)(requestParameters.vouchers),
            }, initOverrides);
            return new runtime.JSONApiResponse(response, (jsonValue) => (0, index_1.StatusFromJSON)(jsonValue));
        });
    }
     ...
     * Operation to create Vouchers.
     */
    postVouchers(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield this.postVouchersRaw(requestParameters, initOverrides);
            return yield response.value();
        });
    }
    /**
     ...
     */
    putRoomTypeBasedChargeRangesRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            if (requestParameters.roomTypeBasedChargeRanges === null || requestParameters.roomTypeBasedChargeRanges === undefined) {
                throw new runtime.RequiredError('roomTypeBasedChargeRanges', 'Required parameter requestParameters.roomTypeBasedChargeRanges was null or undefined when calling putRoomTypeBasedChargeRanges.');
            }
            const queryParameters = {};
            const headerParameters = {};
            headerParameters['Content-Type'] = 'application/json;charset=UTF-8';
     ...
     * Operation to change Room Type Based Charge Ranges.
     */
    putRoomTypeBasedChargeRanges(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield this.putRoomTypeBasedChargeRangesRaw(requestParameters, initOverrides);
            return yield response.value();
        });
    }
    /**
     ...
     */
    putVouchersRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            if (requestParameters.hotelId === null || requestParameters.hotelId === undefined) {
                throw new runtime.RequiredError('hotelId', 'Required parameter requestParameters.hotelId was null or undefined when calling putVouchers.');
            }
            if (requestParameters.vouchers === null || requestParameters.vouchers === undefined) {
                throw new runtime.RequiredError('vouchers', 'Required parameter requestParameters.vouchers was null or undefined when calling putVouchers.');
            }
            const queryParameters = {};
            const headerParameters = {};
            headerParameters['Content-Type'] = 'application/json;charset=UTF-8';
     ...
     * Operation to change a voucher.
     */
    putVouchers(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield this.putVouchersRaw(requestParameters, initOverrides);
            return yield response.value();
        });
    }
    /**
 ...
 * @export
 */
exports.DeleteRevenueBucketCodesBucketTypeEnum = {
    Default: 'Default',
    Fiscal: 'Fiscal'
};
/**
