...
export interface CopyVouchersConfigRequest {
    authorization?: string;
    xAppKey?: string;
    xHotelid?: string;
    copyVouchersConfig: VouchersConfigCopy;
    xExternalsystem?: string;
    acceptLanguage?: string;
}
...
export interface DeleteRevenueBucketCodesRequest {
    ...
    bucketType?: Set<DeleteRevenueBucketCodesBucketTypeEnum>;
    xExternalsystem?: string;
    acceptLanguage?: string;
}
...
export interface DeleteRoomTypebasedchargerangesRequest {
    hotelId: string;
...
export interface GetRoomTypeBasedChargeRangesRequest {
    hotelId: string;
    transactionCode: string;
...
export interface PostRoomTypeBasedChargeRangesRequest {
    authorization?: string;
    xAppKey?: string;
    xHotelid?: string;
    roomTypeBasedChargeRanges: RoomTypeBasedChargeRngs;
    xExternalsystem?: string;
    acceptLanguage?: string;
}
...
export interface PostVouchersRequest {
    hotelId: string;
    authorization?: string;
    xAppKey?: string;
    xHotelid?: string;
    vouchers: VouchersDetails;
    xExternalsystem?: string;
    acceptLanguage?: string;
}
...
export interface PutRoomTypeBasedChargeRangesRequest {
    authorization?: string;
    xAppKey?: string;
    xHotelid?: string;
    roomTypeBasedChargeRanges: RoomTypeBasedChargeRngs;
...
export interface PutVouchersRequest {
    hotelId: string;
    authorization?: string;
    xAppKey?: string;
    xHotelid?: string;
...
export declare class CashieringConfigApi extends runtime.BaseAPI {
    ...
    /**
     * Operation to copy Vouchers Config. <p><strong>OperationId:</strong>copyVouchersConfig</p>
     * Operation to copy Vouchers Config.
     */
    copyVouchersConfigRaw(requestParameters: CopyVouchersConfigRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Status>>;
    /**
     * Operation to copy Vouchers Config. <p><strong>OperationId:</strong>copyVouchersConfig</p>
     * Operation to copy Vouchers Config.
     */
    copyVouchersConfig(requestParameters: CopyVouchersConfigRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Status>;
    /**
    ...
    /**
     * Operation to remove Room Type Based Charge Ranges. <p><strong>OperationId:</strong>deleteRoomTypebasedchargeranges</p>
     * Operation to delete Room Type Based Charge Ranges.
     */
    deleteRoomTypebasedchargerangesRaw(requestParameters: DeleteRoomTypebasedchargerangesRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Status>>;
    /**
     * Operation to remove Room Type Based Charge Ranges. <p><strong>OperationId:</strong>deleteRoomTypebasedchargeranges</p>
     * Operation to delete Room Type Based Charge Ranges.
     */
    deleteRoomTypebasedchargeranges(requestParameters: DeleteRoomTypebasedchargerangesRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Status>;
    /**
    ...
    /**
     *  <p><strong>OperationId:</strong>deleteVouchers</p>
     * Operation to remove Vouchers.
     */
    deleteVouchersRaw(requestParameters: DeleteVouchersRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Status>>;
    /**
     *  <p><strong>OperationId:</strong>deleteVouchers</p>
     * Operation to remove Vouchers.
     */
    deleteVouchers(requestParameters: DeleteVouchersRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Status>;
    /**
    ...
    /**
     * Operation to fetch payment method rule. <p><strong>OperationId:</strong>getDefaultPaymentMethodRule</p> <p>The maximum allowable limit for this API is <strong>50</strong>.</p>
    ...
    /**
     * Operation to Fetch Future Past Exchange Rates. <p><strong>OperationId:</strong>getFuturePastExchangeRates</p> <p>This API allows a time span of <strong>30</strong> days.</p>
    ...
    /**
     * Use this API to return Room Type Based Charge Ranges for a hotels based on search criteria such as hotelId, transactionCode, generateTrxCode, RoomTypeGroup.<p><strong>OperationId:</strong>getRoomTypeBasedChargeRanges</p>
     * Operation to fetch Room Type Based Charge Ranges.
     */
    getRoomTypeBasedChargeRangesRaw(requestParameters: GetRoomTypeBasedChargeRangesRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<RoomTypeBasedChargeRngs>>;
    /**
     * Use this API to return Room Type Based Charge Ranges for a hotels based on search criteria such as hotelId, transactionCode, generateTrxCode, RoomTypeGroup.<p><strong>OperationId:</strong>getRoomTypeBasedChargeRanges</p>
     * Operation to fetch Room Type Based Charge Ranges.
     */
    getRoomTypeBasedChargeRanges(requestParameters: GetRoomTypeBasedChargeRangesRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<RoomTypeBasedChargeRngs>;
    /**
    ...
    /**
     * Use this API to get Vouchers. <p><strong>OperationId:</strong>getVouchers</p>
     * Get Vouchers
     */
    getVouchersRaw(requestParameters: GetVouchersRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<VouchersDetails>>;
    /**
     * Use this API to get Vouchers. <p><strong>OperationId:</strong>getVouchers</p>
     * Get Vouchers
     */
    getVouchers(requestParameters: GetVouchersRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<VouchersDetails>;
    /**
    ...
    /**
     * Operation to create Room Type Based Charge Ranges. <p><strong>OperationId:</strong>postRoomTypeBasedChargeRanges</p>
     * Operation to create Room Type Based Charge Ranges.
     */
    postRoomTypeBasedChargeRangesRaw(requestParameters: PostRoomTypeBasedChargeRangesRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Status>>;
    /**
     * Operation to create Room Type Based Charge Ranges. <p><strong>OperationId:</strong>postRoomTypeBasedChargeRanges</p>
     * Operation to create Room Type Based Charge Ranges.
     */
    postRoomTypeBasedChargeRanges(requestParameters: PostRoomTypeBasedChargeRangesRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Status>;
    /**
     ...
     */
    postTransactionGeneratesRaw(requestParameters: PostTransactionGeneratesRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<GeneratesInfoType>>;
    /**
     * Use this API to create transaction generates for a specific property.  Generates are rules used to calculate and post additional charges, such as service charges and taxes, when a particular sales charge transaction code is posted to guest, package or AR ledgers.<p><strong>OperationId:</strong>postTransactionGenerates</p>
     * Post transaction generates
     */
    postTransactionGenerates(requestParameters: PostTransactionGeneratesRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<GeneratesInfoType>;
    /**
    ...
    /**
     * <p><strong>OperationId:</strong>postVouchers</p>
     * Operation to create Vouchers.
     */
    postVouchersRaw(requestParameters: PostVouchersRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Status>>;
    /**
     * <p><strong>OperationId:</strong>postVouchers</p>
     * Operation to create Vouchers.
     */
    postVouchers(requestParameters: PostVouchersRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Status>;
    /**
    ...
    /**
     * Operation to change Room Type Based Charge Ranges. <p><strong>OperationId:</strong>putRoomTypeBasedChargeRanges</p>
     * Operation to change Room Type Based Charge Ranges.
     */
    putRoomTypeBasedChargeRangesRaw(requestParameters: PutRoomTypeBasedChargeRangesRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Status>>;
    /**
     * Operation to change Room Type Based Charge Ranges. <p><strong>OperationId:</strong>putRoomTypeBasedChargeRanges</p>
     * Operation to change Room Type Based Charge Ranges.
     */
    putRoomTypeBasedChargeRanges(requestParameters: PutRoomTypeBasedChargeRangesRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Status>;
    /**
    ...
    /**
     * <p><strong>OperationId:</strong>putVouchers</p>
     * Operation to change a voucher.
     */
    putVouchersRaw(requestParameters: PutVouchersRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Status>>;
    /**
     * <p><strong>OperationId:</strong>putVouchers</p>
     * Operation to change a voucher.
     */
    putVouchers(requestParameters: PutVouchersRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Status>;
    /**
 ...
 * @export
 */
export declare const DeleteRevenueBucketCodesBucketTypeEnum: {
    readonly Default: "Default";
    readonly Fiscal: "Fiscal";
};
export type DeleteRevenueBucketCodesBucketTypeEnum = typeof DeleteRevenueBucketCodesBucketTypeEnum[keyof typeof DeleteRevenueBucketCodesBucketTypeEnum];
/**
 * @export
 */
