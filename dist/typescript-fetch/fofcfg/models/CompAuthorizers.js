 ...
 */
function instanceOfCompAuthorizers(value) {
    let isInstance = true;
    return isInstance;
}
exports.instanceOfCompAuthorizers = instanceOfCompAuthorizers;
function CompAuthorizersFromJSON(json) {
    return CompAuthorizersFromJSONTyped(json, false);
}
exports.CompAuthorizersFromJSON = CompAuthorizersFromJSON;
function CompAuthorizersFromJSONTyped(json, ignoreDiscriminator) {
...
function CompAuthorizersToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
