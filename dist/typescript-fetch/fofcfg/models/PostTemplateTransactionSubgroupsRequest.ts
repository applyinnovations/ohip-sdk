 ...
 * 
 * @export
 * @interface PostTemplateTransactionSubgroupsRequest
 */
export interface PostTemplateTransactionSubgroupsRequest {
     ...
     * @memberof PostTemplateTransactionSubgroupsRequest
     */
...
/**
 * Check if a given object implements the PostTemplateTransactionSubgroupsRequest interface.
 */
export function instanceOfPostTemplateTransactionSubgroupsRequest(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function PostTemplateTransactionSubgroupsRequestFromJSON(json: any): PostTemplateTransactionSubgroupsRequest {
    return PostTemplateTransactionSubgroupsRequestFromJSONTyped(json, false);
}

export function PostTemplateTransactionSubgroupsRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): PostTemplateTransactionSubgroupsRequest {
...
export function PostTemplateTransactionSubgroupsRequestToJSON(value?: PostTemplateTransactionSubgroupsRequest | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
