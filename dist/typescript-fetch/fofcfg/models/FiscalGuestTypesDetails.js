 ...
 */
function instanceOfFiscalGuestTypesDetails(value) {
    let isInstance = true;
    return isInstance;
}
exports.instanceOfFiscalGuestTypesDetails = instanceOfFiscalGuestTypesDetails;
function FiscalGuestTypesDetailsFromJSON(json) {
    return FiscalGuestTypesDetailsFromJSONTyped(json, false);
}
exports.FiscalGuestTypesDetailsFromJSON = FiscalGuestTypesDetailsFromJSON;
function FiscalGuestTypesDetailsFromJSONTyped(json, ignoreDiscriminator) {
...
function FiscalGuestTypesDetailsToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
