 ...
 */
function instanceOfBankAccounts(value) {
    let isInstance = true;
    return isInstance;
}
exports.instanceOfBankAccounts = instanceOfBankAccounts;
function BankAccountsFromJSON(json) {
    return BankAccountsFromJSONTyped(json, false);
}
exports.BankAccountsFromJSON = BankAccountsFromJSON;
function BankAccountsFromJSONTyped(json, ignoreDiscriminator) {
...
function BankAccountsToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
