 ...
 */
function instanceOfCustomChargeExemptionsConfigToBeChanged(value) {
    let isInstance = true;
    return isInstance;
}
exports.instanceOfCustomChargeExemptionsConfigToBeChanged = instanceOfCustomChargeExemptionsConfigToBeChanged;
function CustomChargeExemptionsConfigToBeChangedFromJSON(json) {
    return CustomChargeExemptionsConfigToBeChangedFromJSONTyped(json, false);
}
exports.CustomChargeExemptionsConfigToBeChangedFromJSON = CustomChargeExemptionsConfigToBeChangedFromJSON;
function CustomChargeExemptionsConfigToBeChangedFromJSONTyped(json, ignoreDiscriminator) {
...
function CustomChargeExemptionsConfigToBeChangedToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
