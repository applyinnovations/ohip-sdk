 ...
 */
export function instanceOfCompTypesDetails(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function CompTypesDetailsFromJSON(json: any): CompTypesDetails {
    return CompTypesDetailsFromJSONTyped(json, false);
}

export function CompTypesDetailsFromJSONTyped(json: any, ignoreDiscriminator: boolean): CompTypesDetails {
...
export function CompTypesDetailsToJSON(value?: CompTypesDetails | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
