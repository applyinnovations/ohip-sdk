 ...
 */
function instanceOfCommissionCodes(value) {
    let isInstance = true;
    return isInstance;
}
exports.instanceOfCommissionCodes = instanceOfCommissionCodes;
function CommissionCodesFromJSON(json) {
    return CommissionCodesFromJSONTyped(json, false);
}
exports.CommissionCodesFromJSON = CommissionCodesFromJSON;
function CommissionCodesFromJSONTyped(json, ignoreDiscriminator) {
...
function CommissionCodesToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
