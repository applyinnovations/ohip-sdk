 ...
 */
function instanceOfTaxBrackets(value) {
    let isInstance = true;
    return isInstance;
}
exports.instanceOfTaxBrackets = instanceOfTaxBrackets;
function TaxBracketsFromJSON(json) {
    return TaxBracketsFromJSONTyped(json, false);
}
exports.TaxBracketsFromJSON = TaxBracketsFromJSON;
function TaxBracketsFromJSONTyped(json, ignoreDiscriminator) {
...
function TaxBracketsToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
