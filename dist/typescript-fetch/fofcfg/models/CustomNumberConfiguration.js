 ...
 */
function instanceOfCustomNumberConfiguration(value) {
    let isInstance = true;
    return isInstance;
}
exports.instanceOfCustomNumberConfiguration = instanceOfCustomNumberConfiguration;
function CustomNumberConfigurationFromJSON(json) {
    return CustomNumberConfigurationFromJSONTyped(json, false);
}
exports.CustomNumberConfigurationFromJSON = CustomNumberConfigurationFromJSON;
function CustomNumberConfigurationFromJSONTyped(json, ignoreDiscriminator) {
...
function CustomNumberConfigurationToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
