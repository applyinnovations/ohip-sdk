 ...
 */
function instanceOfAuthorizerGroupType(value) {
    let isInstance = true;
    return isInstance;
}
exports.instanceOfAuthorizerGroupType = instanceOfAuthorizerGroupType;
function AuthorizerGroupTypeFromJSON(json) {
    return AuthorizerGroupTypeFromJSONTyped(json, false);
}
exports.AuthorizerGroupTypeFromJSON = AuthorizerGroupTypeFromJSON;
function AuthorizerGroupTypeFromJSONTyped(json, ignoreDiscriminator) {
...
function AuthorizerGroupTypeToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
