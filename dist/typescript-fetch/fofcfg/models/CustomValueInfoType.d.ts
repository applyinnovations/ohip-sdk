 ...
 */
export declare function instanceOfCustomValueInfoType(value: object): boolean;
export declare function CustomValueInfoTypeFromJSON(json: any): CustomValueInfoType;
export declare function CustomValueInfoTypeFromJSONTyped(json: any, ignoreDiscriminator: boolean): CustomValueInfoType;
export declare function CustomValueInfoTypeToJSON(value?: CustomValueInfoType | null): any;
