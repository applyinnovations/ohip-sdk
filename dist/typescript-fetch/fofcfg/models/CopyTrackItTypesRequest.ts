 ...
 */
export function instanceOfCopyTrackItTypesRequest(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function CopyTrackItTypesRequestFromJSON(json: any): CopyTrackItTypesRequest {
    return CopyTrackItTypesRequestFromJSONTyped(json, false);
}

export function CopyTrackItTypesRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): CopyTrackItTypesRequest {
...
export function CopyTrackItTypesRequestToJSON(value?: CopyTrackItTypesRequest | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
