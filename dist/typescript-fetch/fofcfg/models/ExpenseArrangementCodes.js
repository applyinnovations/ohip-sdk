 ...
 */
function instanceOfExpenseArrangementCodes(value) {
    let isInstance = true;
    return isInstance;
}
exports.instanceOfExpenseArrangementCodes = instanceOfExpenseArrangementCodes;
function ExpenseArrangementCodesFromJSON(json) {
    return ExpenseArrangementCodesFromJSONTyped(json, false);
}
exports.ExpenseArrangementCodesFromJSON = ExpenseArrangementCodesFromJSON;
function ExpenseArrangementCodesFromJSONTyped(json, ignoreDiscriminator) {
...
function ExpenseArrangementCodesToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
