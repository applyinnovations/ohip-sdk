 ...
 */
function instanceOfMarketCodeInformationType(value) {
    let isInstance = true;
    return isInstance;
}
exports.instanceOfMarketCodeInformationType = instanceOfMarketCodeInformationType;
function MarketCodeInformationTypeFromJSON(json) {
    return MarketCodeInformationTypeFromJSONTyped(json, false);
}
exports.MarketCodeInformationTypeFromJSON = MarketCodeInformationTypeFromJSON;
function MarketCodeInformationTypeFromJSONTyped(json, ignoreDiscriminator) {
...
exports.MarketCodeInformationTypeFromJSONTyped = MarketCodeInformationTypeFromJSONTyped;
function MarketCodeInformationTypeToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
...
exports.MarketCodeInformationTypeToJSON = MarketCodeInformationTypeToJSON;
