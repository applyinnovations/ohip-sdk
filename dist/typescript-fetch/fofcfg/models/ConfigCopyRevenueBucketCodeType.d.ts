 ...
 */
export declare function instanceOfConfigCopyRevenueBucketCodeType(value: object): boolean;
export declare function ConfigCopyRevenueBucketCodeTypeFromJSON(json: any): ConfigCopyRevenueBucketCodeType;
export declare function ConfigCopyRevenueBucketCodeTypeFromJSONTyped(json: any, ignoreDiscriminator: boolean): ConfigCopyRevenueBucketCodeType;
export declare function ConfigCopyRevenueBucketCodeTypeToJSON(value?: ConfigCopyRevenueBucketCodeType | null): any;
