 ...
 */
function instanceOfAutoFolioSettlementTypesCriteria(value) {
    let isInstance = true;
    return isInstance;
}
exports.instanceOfAutoFolioSettlementTypesCriteria = instanceOfAutoFolioSettlementTypesCriteria;
function AutoFolioSettlementTypesCriteriaFromJSON(json) {
    return AutoFolioSettlementTypesCriteriaFromJSONTyped(json, false);
}
exports.AutoFolioSettlementTypesCriteriaFromJSON = AutoFolioSettlementTypesCriteriaFromJSON;
function AutoFolioSettlementTypesCriteriaFromJSONTyped(json, ignoreDiscriminator) {
...
function AutoFolioSettlementTypesCriteriaToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
