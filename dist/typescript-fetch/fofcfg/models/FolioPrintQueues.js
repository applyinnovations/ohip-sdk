 ...
 */
function instanceOfFolioPrintQueues(value) {
    let isInstance = true;
    return isInstance;
}
exports.instanceOfFolioPrintQueues = instanceOfFolioPrintQueues;
function FolioPrintQueuesFromJSON(json) {
    return FolioPrintQueuesFromJSONTyped(json, false);
}
exports.FolioPrintQueuesFromJSON = FolioPrintQueuesFromJSON;
function FolioPrintQueuesFromJSONTyped(json, ignoreDiscriminator) {
...
function FolioPrintQueuesToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
