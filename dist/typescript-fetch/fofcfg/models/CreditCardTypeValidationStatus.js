 ...
 */
function instanceOfCreditCardTypeValidationStatus(value) {
    let isInstance = true;
    return isInstance;
}
exports.instanceOfCreditCardTypeValidationStatus = instanceOfCreditCardTypeValidationStatus;
function CreditCardTypeValidationStatusFromJSON(json) {
    return CreditCardTypeValidationStatusFromJSONTyped(json, false);
}
exports.CreditCardTypeValidationStatusFromJSON = CreditCardTypeValidationStatusFromJSON;
function CreditCardTypeValidationStatusFromJSONTyped(json, ignoreDiscriminator) {
...
function CreditCardTypeValidationStatusToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
