 ...
 */
export declare function instanceOfCardUsageRulesType(value: object): boolean;
export declare function CardUsageRulesTypeFromJSON(json: any): CardUsageRulesType;
export declare function CardUsageRulesTypeFromJSONTyped(json: any, ignoreDiscriminator: boolean): CardUsageRulesType;
export declare function CardUsageRulesTypeToJSON(value?: CardUsageRulesType | null): any;
