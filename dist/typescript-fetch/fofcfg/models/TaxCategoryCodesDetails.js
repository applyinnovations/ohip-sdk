 ...
 */
function instanceOfTaxCategoryCodesDetails(value) {
    let isInstance = true;
    return isInstance;
}
exports.instanceOfTaxCategoryCodesDetails = instanceOfTaxCategoryCodesDetails;
function TaxCategoryCodesDetailsFromJSON(json) {
    return TaxCategoryCodesDetailsFromJSONTyped(json, false);
}
exports.TaxCategoryCodesDetailsFromJSON = TaxCategoryCodesDetailsFromJSON;
function TaxCategoryCodesDetailsFromJSONTyped(json, ignoreDiscriminator) {
...
function TaxCategoryCodesDetailsToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
