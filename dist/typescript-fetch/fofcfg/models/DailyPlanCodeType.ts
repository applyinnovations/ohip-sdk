 ...
 */
export function instanceOfDailyPlanCodeType(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function DailyPlanCodeTypeFromJSON(json: any): DailyPlanCodeType {
    return DailyPlanCodeTypeFromJSONTyped(json, false);
}

export function DailyPlanCodeTypeFromJSONTyped(json: any, ignoreDiscriminator: boolean): DailyPlanCodeType {
...
export function DailyPlanCodeTypeToJSON(value?: DailyPlanCodeType | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
