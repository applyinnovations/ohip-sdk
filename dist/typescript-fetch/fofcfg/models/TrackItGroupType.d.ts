 ...
 */
export declare function instanceOfTrackItGroupType(value: object): boolean;
export declare function TrackItGroupTypeFromJSON(json: any): TrackItGroupType;
export declare function TrackItGroupTypeFromJSONTyped(json: any, ignoreDiscriminator: boolean): TrackItGroupType;
export declare function TrackItGroupTypeToJSON(value?: TrackItGroupType | null): any;
