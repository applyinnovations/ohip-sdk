 ...
 */
function instanceOfRateCodeTotalInformationType(value) {
    let isInstance = true;
    return isInstance;
}
exports.instanceOfRateCodeTotalInformationType = instanceOfRateCodeTotalInformationType;
function RateCodeTotalInformationTypeFromJSON(json) {
    return RateCodeTotalInformationTypeFromJSONTyped(json, false);
}
exports.RateCodeTotalInformationTypeFromJSON = RateCodeTotalInformationTypeFromJSON;
function RateCodeTotalInformationTypeFromJSONTyped(json, ignoreDiscriminator) {
...
exports.RateCodeTotalInformationTypeFromJSONTyped = RateCodeTotalInformationTypeFromJSONTyped;
function RateCodeTotalInformationTypeToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
...
exports.RateCodeTotalInformationTypeToJSON = RateCodeTotalInformationTypeToJSON;
