 ...
 */
export declare function instanceOfStopProcessingReasons(value: object): boolean;
export declare function StopProcessingReasonsFromJSON(json: any): StopProcessingReasons;
export declare function StopProcessingReasonsFromJSONTyped(json: any, ignoreDiscriminator: boolean): StopProcessingReasons;
export declare function StopProcessingReasonsToJSON(value?: StopProcessingReasons | null): any;
