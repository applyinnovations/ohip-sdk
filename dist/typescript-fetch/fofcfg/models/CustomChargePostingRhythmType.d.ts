 ...
 */
export declare function instanceOfCustomChargePostingRhythmType(value: object): boolean;
export declare function CustomChargePostingRhythmTypeFromJSON(json: any): CustomChargePostingRhythmType;
export declare function CustomChargePostingRhythmTypeFromJSONTyped(json: any, ignoreDiscriminator: boolean): CustomChargePostingRhythmType;
export declare function CustomChargePostingRhythmTypeToJSON(value?: CustomChargePostingRhythmType | null): any;
