 ...
 */
function instanceOfTemplateCashierShiftDropLocationsCriteria(value) {
    let isInstance = true;
    return isInstance;
}
exports.instanceOfTemplateCashierShiftDropLocationsCriteria = instanceOfTemplateCashierShiftDropLocationsCriteria;
function TemplateCashierShiftDropLocationsCriteriaFromJSON(json) {
    return TemplateCashierShiftDropLocationsCriteriaFromJSONTyped(json, false);
}
exports.TemplateCashierShiftDropLocationsCriteriaFromJSON = TemplateCashierShiftDropLocationsCriteriaFromJSON;
function TemplateCashierShiftDropLocationsCriteriaFromJSONTyped(json, ignoreDiscriminator) {
...
function TemplateCashierShiftDropLocationsCriteriaToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
