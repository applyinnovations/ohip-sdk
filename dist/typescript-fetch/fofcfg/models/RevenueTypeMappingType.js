...
exports.RevenueTypeMappingTypeToJSON = exports.RevenueTypeMappingTypeFromJSONTyped = exports.RevenueTypeMappingTypeFromJSON = exports.instanceOfRevenueTypeMappingType = void 0;
 ...
 */
function instanceOfRevenueTypeMappingType(value) {
    let isInstance = true;
    return isInstance;
}
exports.instanceOfRevenueTypeMappingType = instanceOfRevenueTypeMappingType;
function RevenueTypeMappingTypeFromJSON(json) {
    return RevenueTypeMappingTypeFromJSONTyped(json, false);
}
exports.RevenueTypeMappingTypeFromJSON = RevenueTypeMappingTypeFromJSON;
function RevenueTypeMappingTypeFromJSONTyped(json, ignoreDiscriminator) {
...
exports.RevenueTypeMappingTypeFromJSONTyped = RevenueTypeMappingTypeFromJSONTyped;
function RevenueTypeMappingTypeToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
...
exports.RevenueTypeMappingTypeToJSON = RevenueTypeMappingTypeToJSON;
