 ...
 */
function instanceOfHotelTransactionSubgroups(value) {
    let isInstance = true;
    return isInstance;
}
exports.instanceOfHotelTransactionSubgroups = instanceOfHotelTransactionSubgroups;
function HotelTransactionSubgroupsFromJSON(json) {
    return HotelTransactionSubgroupsFromJSONTyped(json, false);
}
exports.HotelTransactionSubgroupsFromJSON = HotelTransactionSubgroupsFromJSON;
function HotelTransactionSubgroupsFromJSONTyped(json, ignoreDiscriminator) {
...
function HotelTransactionSubgroupsToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
