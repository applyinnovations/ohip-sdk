 ...
 */
export declare function instanceOfRateCodeInformationBaseType(value: object): boolean;
export declare function RateCodeInformationBaseTypeFromJSON(json: any): RateCodeInformationBaseType;
export declare function RateCodeInformationBaseTypeFromJSONTyped(json: any, ignoreDiscriminator: boolean): RateCodeInformationBaseType;
export declare function RateCodeInformationBaseTypeToJSON(value?: RateCodeInformationBaseType | null): any;
