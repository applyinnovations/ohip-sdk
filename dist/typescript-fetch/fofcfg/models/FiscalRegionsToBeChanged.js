 ...
 */
function instanceOfFiscalRegionsToBeChanged(value) {
    let isInstance = true;
    return isInstance;
}
exports.instanceOfFiscalRegionsToBeChanged = instanceOfFiscalRegionsToBeChanged;
function FiscalRegionsToBeChangedFromJSON(json) {
    return FiscalRegionsToBeChangedFromJSONTyped(json, false);
}
exports.FiscalRegionsToBeChangedFromJSON = FiscalRegionsToBeChangedFromJSON;
function FiscalRegionsToBeChangedFromJSONTyped(json, ignoreDiscriminator) {
...
function FiscalRegionsToBeChangedToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
