 ...
 */
export declare function instanceOfTransactionDiscountsAttributeType(value: object): boolean;
export declare function TransactionDiscountsAttributeTypeFromJSON(json: any): TransactionDiscountsAttributeType;
export declare function TransactionDiscountsAttributeTypeFromJSONTyped(json: any, ignoreDiscriminator: boolean): TransactionDiscountsAttributeType;
export declare function TransactionDiscountsAttributeTypeToJSON(value?: TransactionDiscountsAttributeType | null): any;
