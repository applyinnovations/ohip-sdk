 ...
 */
export declare function instanceOfRevenueNightsInfoType(value: object): boolean;
export declare function RevenueNightsInfoTypeFromJSON(json: any): RevenueNightsInfoType;
export declare function RevenueNightsInfoTypeFromJSONTyped(json: any, ignoreDiscriminator: boolean): RevenueNightsInfoType;
export declare function RevenueNightsInfoTypeToJSON(value?: RevenueNightsInfoType | null): any;
