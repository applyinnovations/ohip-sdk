 ...
 */
export declare function instanceOfBudgetForecastMarketInfoType(value: object): boolean;
export declare function BudgetForecastMarketInfoTypeFromJSON(json: any): BudgetForecastMarketInfoType;
export declare function BudgetForecastMarketInfoTypeFromJSONTyped(json: any, ignoreDiscriminator: boolean): BudgetForecastMarketInfoType;
export declare function BudgetForecastMarketInfoTypeToJSON(value?: BudgetForecastMarketInfoType | null): any;
