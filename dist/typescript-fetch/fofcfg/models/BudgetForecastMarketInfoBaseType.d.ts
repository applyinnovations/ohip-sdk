 ...
 */
export declare function instanceOfBudgetForecastMarketInfoBaseType(value: object): boolean;
export declare function BudgetForecastMarketInfoBaseTypeFromJSON(json: any): BudgetForecastMarketInfoBaseType;
export declare function BudgetForecastMarketInfoBaseTypeFromJSONTyped(json: any, ignoreDiscriminator: boolean): BudgetForecastMarketInfoBaseType;
export declare function BudgetForecastMarketInfoBaseTypeToJSON(value?: BudgetForecastMarketInfoBaseType | null): any;
