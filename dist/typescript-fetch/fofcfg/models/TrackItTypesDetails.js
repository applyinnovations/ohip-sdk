 ...
 */
function instanceOfTrackItTypesDetails(value) {
    let isInstance = true;
    return isInstance;
}
exports.instanceOfTrackItTypesDetails = instanceOfTrackItTypesDetails;
function TrackItTypesDetailsFromJSON(json) {
    return TrackItTypesDetailsFromJSONTyped(json, false);
}
exports.TrackItTypesDetailsFromJSON = TrackItTypesDetailsFromJSON;
function TrackItTypesDetailsFromJSONTyped(json, ignoreDiscriminator) {
...
function TrackItTypesDetailsToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
