 ...
 */
export declare function instanceOfAutoFolioSettlementTypesDetails(value: object): boolean;
export declare function AutoFolioSettlementTypesDetailsFromJSON(json: any): AutoFolioSettlementTypesDetails;
export declare function AutoFolioSettlementTypesDetailsFromJSONTyped(json: any, ignoreDiscriminator: boolean): AutoFolioSettlementTypesDetails;
export declare function AutoFolioSettlementTypesDetailsToJSON(value?: AutoFolioSettlementTypesDetails | null): any;
