 ...
 */
export declare function instanceOfFolioPrintQueueType(value: object): boolean;
export declare function FolioPrintQueueTypeFromJSON(json: any): FolioPrintQueueType;
export declare function FolioPrintQueueTypeFromJSONTyped(json: any, ignoreDiscriminator: boolean): FolioPrintQueueType;
export declare function FolioPrintQueueTypeToJSON(value?: FolioPrintQueueType | null): any;
