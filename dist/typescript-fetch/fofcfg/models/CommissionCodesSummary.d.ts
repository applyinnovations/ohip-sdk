 ...
 */
export declare function instanceOfCommissionCodesSummary(value: object): boolean;
export declare function CommissionCodesSummaryFromJSON(json: any): CommissionCodesSummary;
export declare function CommissionCodesSummaryFromJSONTyped(json: any, ignoreDiscriminator: boolean): CommissionCodesSummary;
export declare function CommissionCodesSummaryToJSON(value?: CommissionCodesSummary | null): any;
