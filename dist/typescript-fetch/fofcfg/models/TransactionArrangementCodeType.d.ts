 ...
 */
export declare function instanceOfTransactionArrangementCodeType(value: object): boolean;
export declare function TransactionArrangementCodeTypeFromJSON(json: any): TransactionArrangementCodeType;
export declare function TransactionArrangementCodeTypeFromJSONTyped(json: any, ignoreDiscriminator: boolean): TransactionArrangementCodeType;
export declare function TransactionArrangementCodeTypeToJSON(value?: TransactionArrangementCodeType | null): any;
