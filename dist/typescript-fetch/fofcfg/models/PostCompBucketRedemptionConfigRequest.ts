 ...
 * 
 * @export
 * @interface PostCompBucketRedemptionConfigRequest
 */
export interface PostCompBucketRedemptionConfigRequest {
     ...
     * @memberof PostCompBucketRedemptionConfigRequest
     */
 ...
 */
export function instanceOfPostCompBucketRedemptionConfigRequest(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function PostCompBucketRedemptionConfigRequestFromJSON(json: any): PostCompBucketRedemptionConfigRequest {
    return PostCompBucketRedemptionConfigRequestFromJSONTyped(json, false);
}

export function PostCompBucketRedemptionConfigRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): PostCompBucketRedemptionConfigRequest {
...
export function PostCompBucketRedemptionConfigRequestToJSON(value?: PostCompBucketRedemptionConfigRequest | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
