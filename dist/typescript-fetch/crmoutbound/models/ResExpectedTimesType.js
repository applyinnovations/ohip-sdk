...
function ResExpectedTimesTypeFromJSONTyped(json, ignoreDiscriminator) {
    ...
    return {
        'resExpectedArrivalTime': !(0, runtime_1.exists)(json, 'resExpectedArrivalTime') ? undefined : json['resExpectedArrivalTime'],
        'resExpectedDepartureTime': !(0, runtime_1.exists)(json, 'resExpectedDepartureTime') ? undefined : json['resExpectedDepartureTime'],
    };
}
