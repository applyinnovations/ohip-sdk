 ...
 */
function instanceOfGamingOffers(value) {
    let isInstance = true;
    return isInstance;
}
exports.instanceOfGamingOffers = instanceOfGamingOffers;
function GamingOffersFromJSON(json) {
    return GamingOffersFromJSONTyped(json, false);
}
exports.GamingOffersFromJSON = GamingOffersFromJSON;
function GamingOffersFromJSONTyped(json, ignoreDiscriminator) {
...
function GamingOffersToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
