 ...
 * @export
 * @interface ProfileEnrollmentTypeAddresses
 */
export interface ProfileEnrollmentTypeAddresses {
    /**
     * Collection of Detailed information on an address for the customer.
     * @type {Array<AddressInfoType>}
     * @memberof ProfileEnrollmentTypeAddresses
     */
...
/**
 * Check if a given object implements the ProfileEnrollmentTypeAddresses interface.
 */
export function instanceOfProfileEnrollmentTypeAddresses(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function ProfileEnrollmentTypeAddressesFromJSON(json: any): ProfileEnrollmentTypeAddresses {
    return ProfileEnrollmentTypeAddressesFromJSONTyped(json, false);
}

export function ProfileEnrollmentTypeAddressesFromJSONTyped(json: any, ignoreDiscriminator: boolean): ProfileEnrollmentTypeAddresses {
...
export function ProfileEnrollmentTypeAddressesToJSON(value?: ProfileEnrollmentTypeAddresses | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
