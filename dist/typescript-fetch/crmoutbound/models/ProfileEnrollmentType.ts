...
import type { ProfileEnrollmentTypeAddresses } from './ProfileEnrollmentTypeAddresses';
import {
    ProfileEnrollmentTypeAddressesFromJSON,
    ProfileEnrollmentTypeAddressesFromJSONTyped,
    ProfileEnrollmentTypeAddressesToJSON,
} from './ProfileEnrollmentTypeAddresses';
...
export interface ProfileEnrollmentType {
    ...
    /**
     * 
     * @type {ProfileEnrollmentTypeAddresses}
     * @memberof ProfileEnrollmentType
     */
    addresses?: ProfileEnrollmentTypeAddresses;
    /**
     * 
...
export function ProfileEnrollmentTypeFromJSONTyped(json: any, ignoreDiscriminator: boolean): ProfileEnrollmentType {
    ...
    return {
        ...
        'addresses': !exists(json, 'addresses') ? undefined : ProfileEnrollmentTypeAddressesFromJSON(json['addresses']),
...
export function ProfileEnrollmentTypeToJSON(value?: ProfileEnrollmentType | null): any {
    ...
    return {
        ...
        'addresses': ProfileEnrollmentTypeAddressesToJSON(value.addresses),
