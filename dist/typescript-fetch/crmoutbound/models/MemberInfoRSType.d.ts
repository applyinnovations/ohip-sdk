 ...
 */
export declare function instanceOfMemberInfoRSType(value: object): boolean;
export declare function MemberInfoRSTypeFromJSON(json: any): MemberInfoRSType;
export declare function MemberInfoRSTypeFromJSONTyped(json: any, ignoreDiscriminator: boolean): MemberInfoRSType;
export declare function MemberInfoRSTypeToJSON(value?: MemberInfoRSType | null): any;
