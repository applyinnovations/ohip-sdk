...
function StayDetailTypeFromJSONTyped(json, ignoreDiscriminator) {
    ...
    return {
        ...
        'bookedArrivalDate': !(0, runtime_1.exists)(json, 'bookedArrivalDate') ? undefined : json['bookedArrivalDate'],
        'bookedDepartureDate': !(0, runtime_1.exists)(json, 'bookedDepartureDate') ? undefined : json['bookedDepartureDate'],
