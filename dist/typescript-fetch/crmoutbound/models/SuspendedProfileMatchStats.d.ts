 ...
 */
export declare function instanceOfSuspendedProfileMatchStats(value: object): boolean;
export declare function SuspendedProfileMatchStatsFromJSON(json: any): SuspendedProfileMatchStats;
export declare function SuspendedProfileMatchStatsFromJSONTyped(json: any, ignoreDiscriminator: boolean): SuspendedProfileMatchStats;
export declare function SuspendedProfileMatchStatsToJSON(value?: SuspendedProfileMatchStats | null): any;
