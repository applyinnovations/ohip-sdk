 ...
 */
export declare function instanceOfExternalProfileSummaryTypeFormerName(value: object): boolean;
export declare function ExternalProfileSummaryTypeFormerNameFromJSON(json: any): ExternalProfileSummaryTypeFormerName;
export declare function ExternalProfileSummaryTypeFormerNameFromJSONTyped(json: any, ignoreDiscriminator: boolean): ExternalProfileSummaryTypeFormerName;
export declare function ExternalProfileSummaryTypeFormerNameToJSON(value?: ExternalProfileSummaryTypeFormerName | null): any;
