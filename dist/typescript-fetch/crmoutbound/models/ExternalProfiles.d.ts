 ...
 */
export declare function instanceOfExternalProfiles(value: object): boolean;
export declare function ExternalProfilesFromJSON(json: any): ExternalProfiles;
export declare function ExternalProfilesFromJSONTyped(json: any, ignoreDiscriminator: boolean): ExternalProfiles;
export declare function ExternalProfilesToJSON(value?: ExternalProfiles | null): any;
