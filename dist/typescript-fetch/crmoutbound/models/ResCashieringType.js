...
function ResCashieringTypeFromJSONTyped(json, ignoreDiscriminator) {
    ...
    return {
        ...
        'resPreConfiguredRoutingInstruction': !(0, runtime_1.exists)(json, 'resPreConfiguredRoutingInstruction') ? undefined : (0, ResPreConfiguredRoutingInstrType_1.ResPreConfiguredRoutingInstrTypeFromJSON)(json['resPreConfiguredRoutingInstruction']),
