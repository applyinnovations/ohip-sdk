 ...
 */
export declare function instanceOfLightEventDetailType(value: object): boolean;
export declare function LightEventDetailTypeFromJSON(json: any): LightEventDetailType;
export declare function LightEventDetailTypeFromJSONTyped(json: any, ignoreDiscriminator: boolean): LightEventDetailType;
export declare function LightEventDetailTypeToJSON(value?: LightEventDetailType | null): any;
