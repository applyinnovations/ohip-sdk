 ...
 */
function instanceOfBlockCateringPackageDetails(value) {
    let isInstance = true;
    return isInstance;
}
exports.instanceOfBlockCateringPackageDetails = instanceOfBlockCateringPackageDetails;
function BlockCateringPackageDetailsFromJSON(json) {
    return BlockCateringPackageDetailsFromJSONTyped(json, false);
}
exports.BlockCateringPackageDetailsFromJSON = BlockCateringPackageDetailsFromJSON;
function BlockCateringPackageDetailsFromJSONTyped(json, ignoreDiscriminator) {
...
function BlockCateringPackageDetailsToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
