 ...
 */
function instanceOfQuickInsertResourceStatus(value) {
    let isInstance = true;
    return isInstance;
}
exports.instanceOfQuickInsertResourceStatus = instanceOfQuickInsertResourceStatus;
function QuickInsertResourceStatusFromJSON(json) {
    return QuickInsertResourceStatusFromJSONTyped(json, false);
}
exports.QuickInsertResourceStatusFromJSON = QuickInsertResourceStatusFromJSON;
function QuickInsertResourceStatusFromJSONTyped(json, ignoreDiscriminator) {
...
function QuickInsertResourceStatusToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
