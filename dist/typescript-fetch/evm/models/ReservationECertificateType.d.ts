 ...
 */
export declare function instanceOfReservationECertificateType(value: object): boolean;
export declare function ReservationECertificateTypeFromJSON(json: any): ReservationECertificateType;
export declare function ReservationECertificateTypeFromJSONTyped(json: any, ignoreDiscriminator: boolean): ReservationECertificateType;
export declare function ReservationECertificateTypeToJSON(value?: ReservationECertificateType | null): any;
