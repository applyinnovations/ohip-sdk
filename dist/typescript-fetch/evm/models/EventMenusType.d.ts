 ...
 */
export declare function instanceOfEventMenusType(value: object): boolean;
export declare function EventMenusTypeFromJSON(json: any): EventMenusType;
export declare function EventMenusTypeFromJSONTyped(json: any, ignoreDiscriminator: boolean): EventMenusType;
export declare function EventMenusTypeToJSON(value?: EventMenusType | null): any;
