 ...
 */
export declare function instanceOfSpaceAreaType(value: object): boolean;
export declare function SpaceAreaTypeFromJSON(json: any): SpaceAreaType;
export declare function SpaceAreaTypeFromJSONTyped(json: any, ignoreDiscriminator: boolean): SpaceAreaType;
export declare function SpaceAreaTypeToJSON(value?: SpaceAreaType | null): any;
