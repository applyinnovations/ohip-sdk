 ...
 */
export declare function instanceOfManageAlternateEventsRequest(value: object): boolean;
export declare function ManageAlternateEventsRequestFromJSON(json: any): ManageAlternateEventsRequest;
export declare function ManageAlternateEventsRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): ManageAlternateEventsRequest;
export declare function ManageAlternateEventsRequestToJSON(value?: ManageAlternateEventsRequest | null): any;
