 ...
 */
function instanceOfChangeEventsResourcesRequest(value) {
    let isInstance = true;
    return isInstance;
}
exports.instanceOfChangeEventsResourcesRequest = instanceOfChangeEventsResourcesRequest;
function ChangeEventsResourcesRequestFromJSON(json) {
    return ChangeEventsResourcesRequestFromJSONTyped(json, false);
}
exports.ChangeEventsResourcesRequestFromJSON = ChangeEventsResourcesRequestFromJSON;
function ChangeEventsResourcesRequestFromJSONTyped(json, ignoreDiscriminator) {
...
function ChangeEventsResourcesRequestToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
