 ...
 */
function instanceOfReservationSnapshotType(value) {
    let isInstance = true;
    return isInstance;
}
exports.instanceOfReservationSnapshotType = instanceOfReservationSnapshotType;
function ReservationSnapshotTypeFromJSON(json) {
    return ReservationSnapshotTypeFromJSONTyped(json, false);
}
exports.ReservationSnapshotTypeFromJSON = ReservationSnapshotTypeFromJSON;
function ReservationSnapshotTypeFromJSONTyped(json, ignoreDiscriminator) {
...
function ReservationSnapshotTypeToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
