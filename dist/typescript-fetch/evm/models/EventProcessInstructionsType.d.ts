 ...
 */
export declare function instanceOfEventProcessInstructionsType(value: object): boolean;
export declare function EventProcessInstructionsTypeFromJSON(json: any): EventProcessInstructionsType;
export declare function EventProcessInstructionsTypeFromJSONTyped(json: any, ignoreDiscriminator: boolean): EventProcessInstructionsType;
export declare function EventProcessInstructionsTypeToJSON(value?: EventProcessInstructionsType | null): any;
