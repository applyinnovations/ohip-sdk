 ...
 */
export declare function instanceOfBookingStatusType(value: object): boolean;
export declare function BookingStatusTypeFromJSON(json: any): BookingStatusType;
export declare function BookingStatusTypeFromJSONTyped(json: any, ignoreDiscriminator: boolean): BookingStatusType;
export declare function BookingStatusTypeToJSON(value?: BookingStatusType | null): any;
