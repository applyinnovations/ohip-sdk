 ...
 */
export declare function instanceOfBlockCateringPackageDetails(value: object): boolean;
export declare function BlockCateringPackageDetailsFromJSON(json: any): BlockCateringPackageDetails;
export declare function BlockCateringPackageDetailsFromJSONTyped(json: any, ignoreDiscriminator: boolean): BlockCateringPackageDetails;
export declare function BlockCateringPackageDetailsToJSON(value?: BlockCateringPackageDetails | null): any;
