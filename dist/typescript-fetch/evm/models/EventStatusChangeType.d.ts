 ...
 */
export declare function instanceOfEventStatusChangeType(value: object): boolean;
export declare function EventStatusChangeTypeFromJSON(json: any): EventStatusChangeType;
export declare function EventStatusChangeTypeFromJSONTyped(json: any, ignoreDiscriminator: boolean): EventStatusChangeType;
export declare function EventStatusChangeTypeToJSON(value?: EventStatusChangeType | null): any;
