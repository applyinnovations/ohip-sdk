 ...
 */
export declare function instanceOfEventItemsType(value: object): boolean;
export declare function EventItemsTypeFromJSON(json: any): EventItemsType;
export declare function EventItemsTypeFromJSONTyped(json: any, ignoreDiscriminator: boolean): EventItemsType;
export declare function EventItemsTypeToJSON(value?: EventItemsType | null): any;
