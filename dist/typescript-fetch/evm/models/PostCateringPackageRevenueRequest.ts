 ...
 */
export function instanceOfPostCateringPackageRevenueRequest(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function PostCateringPackageRevenueRequestFromJSON(json: any): PostCateringPackageRevenueRequest {
    return PostCateringPackageRevenueRequestFromJSONTyped(json, false);
}

export function PostCateringPackageRevenueRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): PostCateringPackageRevenueRequest {
...
export function PostCateringPackageRevenueRequestToJSON(value?: PostCateringPackageRevenueRequest | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
