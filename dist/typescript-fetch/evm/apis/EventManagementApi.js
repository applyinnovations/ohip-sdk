...
class EventManagementApi extends runtime.BaseAPI {
     ...
     */
    deleteMultipleEventsRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
     ...
     * Delete Multiple Events
     */
    deleteMultipleEvents(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield this.deleteMultipleEventsRaw(requestParameters, initOverrides);
            return yield response.value();
        });
    }
    /**
 ...
 * @export
 */
exports.GetEventCalendarEventHintsEnum = {
    Account: 'Account',
    Attendees: 'Attendees',
    BlockCode: 'BlockCode',
    BlockName: 'BlockName',
 ...
 * @export
 */
exports.GetEventCalendarMultipleHotelIdsEventHintsEnum = {
    Account: 'Account',
    Attendees: 'Attendees',
    BlockCode: 'BlockCode',
    BlockName: 'BlockName',
