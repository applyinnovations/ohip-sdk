...
export declare class EventManagementApi extends runtime.BaseAPI {
     ...
     */
    changeEventsResourcesRaw(requestParameters: ChangeEventsResourcesRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ManageEventsResources>>;
    /**
     * Update the details of an existing event resource on an event in OPERA Cloud. <p><strong>OperationId:</strong>changeEventsResources</p>
     * Update Events Resources
     */
    changeEventsResources(requestParameters: ChangeEventsResourcesRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<ManageEventsResources>;
    /**
     ...
     */
    deleteMultipleEventsRaw(requestParameters: DeleteMultipleEventsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Status>>;
    /**
     * This API will delete multiple existing events <p><strong>OperationId:</strong>deleteMultipleEvents</p>
     * Delete Multiple Events
     */
    deleteMultipleEvents(requestParameters: DeleteMultipleEventsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Status>;
    /**
 ...
 * @export
 */
export declare const GetEventCalendarEventHintsEnum: {
    readonly Account: "Account";
    readonly Attendees: "Attendees";
    readonly BlockCode: "BlockCode";
    readonly BlockName: "BlockName";
    readonly BlockNonCompete: "BlockNonCompete";
    readonly BlockRateProtect: "BlockRateProtect";
    readonly CateringDecisionDate: "CateringDecisionDate";
    readonly CateringFollowupDate: "CateringFollowupDate";
    readonly CateringOwner: "CateringOwner";
    readonly CateringStatus: "CateringStatus";
    readonly Contact: "Contact";
    readonly CreationDate: "CreationDate";
    readonly EventCategory: "EventCategory";
    readonly EventDuration: "EventDuration";
    ...
    readonly RoomsCount: "RoomsCount";
    readonly RoomsFollowupDate: "RoomsFollowupDate";
    readonly RoomsOwner: "RoomsOwner";
    readonly SetupStyle: "SetupStyle";
    readonly SpaceCode: "SpaceCode";
};
 ...
 * @export
 */
export declare const GetEventCalendarMultipleHotelIdsEventHintsEnum: {
    readonly Account: "Account";
    readonly Attendees: "Attendees";
    readonly BlockCode: "BlockCode";
    readonly BlockName: "BlockName";
