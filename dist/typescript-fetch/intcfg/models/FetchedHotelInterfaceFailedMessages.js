...
const HotelInterfaceFailedMessagesType_1 = require("./HotelInterfaceFailedMessagesType");
...
function FetchedHotelInterfaceFailedMessagesFromJSONTyped(json, ignoreDiscriminator) {
    ...
    return {
        ...
        'messages': !(0, runtime_1.exists)(json, 'messages') ? undefined : (0, HotelInterfaceFailedMessagesType_1.HotelInterfaceFailedMessagesTypeFromJSON)(json['messages']),
...
function FetchedHotelInterfaceFailedMessagesToJSON(value) {
    ...
    return {
        ...
        'messages': (0, HotelInterfaceFailedMessagesType_1.HotelInterfaceFailedMessagesTypeToJSON)(value.messages),
        'offset': value.offset,
