...
const HotelInterfaceControllerRegType_1 = require("./HotelInterfaceControllerRegType");
...
function FetchedHotelInterfaceControllerRegistryFromJSONTyped(json, ignoreDiscriminator) {
    ...
    return {
        'reg': !(0, runtime_1.exists)(json, 'reg') ? undefined : (json['reg'].map(HotelInterfaceControllerRegType_1.HotelInterfaceControllerRegTypeFromJSON)),
...
function FetchedHotelInterfaceControllerRegistryToJSON(value) {
    ...
    return {
        'reg': value.reg === undefined ? undefined : (value.reg.map(HotelInterfaceControllerRegType_1.HotelInterfaceControllerRegTypeToJSON)),
