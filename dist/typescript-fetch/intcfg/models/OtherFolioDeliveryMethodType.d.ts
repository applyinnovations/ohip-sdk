 ...
 */
export declare function instanceOfOtherFolioDeliveryMethodType(value: object): boolean;
export declare function OtherFolioDeliveryMethodTypeFromJSON(json: any): OtherFolioDeliveryMethodType;
export declare function OtherFolioDeliveryMethodTypeFromJSONTyped(json: any, ignoreDiscriminator: boolean): OtherFolioDeliveryMethodType;
export declare function OtherFolioDeliveryMethodTypeToJSON(value?: OtherFolioDeliveryMethodType | null): any;
