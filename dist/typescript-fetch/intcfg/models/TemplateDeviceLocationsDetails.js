 ...
 */
function instanceOfTemplateDeviceLocationsDetails(value) {
    let isInstance = true;
    return isInstance;
}
exports.instanceOfTemplateDeviceLocationsDetails = instanceOfTemplateDeviceLocationsDetails;
function TemplateDeviceLocationsDetailsFromJSON(json) {
    return TemplateDeviceLocationsDetailsFromJSONTyped(json, false);
}
exports.TemplateDeviceLocationsDetailsFromJSON = TemplateDeviceLocationsDetailsFromJSON;
function TemplateDeviceLocationsDetailsFromJSONTyped(json, ignoreDiscriminator) {
...
function TemplateDeviceLocationsDetailsToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
