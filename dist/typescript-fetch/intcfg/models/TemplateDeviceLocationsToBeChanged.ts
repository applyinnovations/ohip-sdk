 ...
 */
export function instanceOfTemplateDeviceLocationsToBeChanged(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function TemplateDeviceLocationsToBeChangedFromJSON(json: any): TemplateDeviceLocationsToBeChanged {
    return TemplateDeviceLocationsToBeChangedFromJSONTyped(json, false);
}

export function TemplateDeviceLocationsToBeChangedFromJSONTyped(json: any, ignoreDiscriminator: boolean): TemplateDeviceLocationsToBeChanged {
...
export function TemplateDeviceLocationsToBeChangedToJSON(value?: TemplateDeviceLocationsToBeChanged | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
