 ...
 */
export declare function instanceOfPutUDFMappingRequest(value: object): boolean;
export declare function PutUDFMappingRequestFromJSON(json: any): PutUDFMappingRequest;
export declare function PutUDFMappingRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): PutUDFMappingRequest;
export declare function PutUDFMappingRequestToJSON(value?: PutUDFMappingRequest | null): any;
