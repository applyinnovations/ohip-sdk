...
class ChainConfigApi extends runtime.BaseAPI {
    ...
    changeTemplateDeviceLocationsRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const response = yield this.request({
                ...
                body: (0, index_1.TemplateDeviceLocationsToBeChangedToJSON)(requestParameters.templateDeviceLocationsToBeChanged),
            }, initOverrides);
    ...
    getTemplateDeviceLocationsRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return new runtime.JSONApiResponse(response, (jsonValue) => (0, index_1.TemplateDeviceLocationsDetailsFromJSON)(jsonValue));
        });
    }
    /**
     * Use this API to get the template device locations. <p><strong>OperationId:</strong>getTemplateDeviceLocations</p>
    ...
    postTemplateDeviceLocationsRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const response = yield this.request({
                ...
                headers: headerParameters,
                query: queryParameters,
                body: (0, index_1.TemplateDeviceLocationsCriteriaToJSON)(requestParameters.templateDeviceLocationsCriteria),
            }, initOverrides);
            return new runtime.JSONApiResponse(response, (jsonValue) => (0, index_1.StatusFromJSON)(jsonValue));
        });
    }
