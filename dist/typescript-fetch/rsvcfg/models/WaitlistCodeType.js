...
exports.WaitlistCodeTypeToJSON = exports.WaitlistCodeTypeFromJSONTyped = exports.WaitlistCodeTypeFromJSON = exports.instanceOfWaitlistCodeType = void 0;
 ...
 */
function instanceOfWaitlistCodeType(value) {
    let isInstance = true;
    return isInstance;
}
exports.instanceOfWaitlistCodeType = instanceOfWaitlistCodeType;
function WaitlistCodeTypeFromJSON(json) {
    return WaitlistCodeTypeFromJSONTyped(json, false);
}
exports.WaitlistCodeTypeFromJSON = WaitlistCodeTypeFromJSON;
function WaitlistCodeTypeFromJSONTyped(json, ignoreDiscriminator) {
...
exports.WaitlistCodeTypeFromJSONTyped = WaitlistCodeTypeFromJSONTyped;
function WaitlistCodeTypeToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
...
exports.WaitlistCodeTypeToJSON = WaitlistCodeTypeToJSON;
