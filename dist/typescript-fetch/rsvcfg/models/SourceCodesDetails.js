 ...
 */
function instanceOfSourceCodesDetails(value) {
    let isInstance = true;
    return isInstance;
}
exports.instanceOfSourceCodesDetails = instanceOfSourceCodesDetails;
function SourceCodesDetailsFromJSON(json) {
    return SourceCodesDetailsFromJSONTyped(json, false);
}
exports.SourceCodesDetailsFromJSON = SourceCodesDetailsFromJSON;
function SourceCodesDetailsFromJSONTyped(json, ignoreDiscriminator) {
...
function SourceCodesDetailsToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
