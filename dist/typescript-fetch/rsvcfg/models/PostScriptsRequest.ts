 ...
 */
export function instanceOfPostScriptsRequest(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function PostScriptsRequestFromJSON(json: any): PostScriptsRequest {
    return PostScriptsRequestFromJSONTyped(json, false);
}

export function PostScriptsRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): PostScriptsRequest {
...
export function PostScriptsRequestToJSON(value?: PostScriptsRequest | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
