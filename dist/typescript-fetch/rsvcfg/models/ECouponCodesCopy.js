 ...
 */
function instanceOfECouponCodesCopy(value) {
    let isInstance = true;
    return isInstance;
}
exports.instanceOfECouponCodesCopy = instanceOfECouponCodesCopy;
function ECouponCodesCopyFromJSON(json) {
    return ECouponCodesCopyFromJSONTyped(json, false);
}
exports.ECouponCodesCopyFromJSON = ECouponCodesCopyFromJSON;
function ECouponCodesCopyFromJSONTyped(json, ignoreDiscriminator) {
...
function ECouponCodesCopyToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
