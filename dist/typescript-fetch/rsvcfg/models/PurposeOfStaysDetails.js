 ...
 */
function instanceOfPurposeOfStaysDetails(value) {
    let isInstance = true;
    return isInstance;
}
exports.instanceOfPurposeOfStaysDetails = instanceOfPurposeOfStaysDetails;
function PurposeOfStaysDetailsFromJSON(json) {
    return PurposeOfStaysDetailsFromJSONTyped(json, false);
}
exports.PurposeOfStaysDetailsFromJSON = PurposeOfStaysDetailsFromJSON;
function PurposeOfStaysDetailsFromJSONTyped(json, ignoreDiscriminator) {
...
function PurposeOfStaysDetailsToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
