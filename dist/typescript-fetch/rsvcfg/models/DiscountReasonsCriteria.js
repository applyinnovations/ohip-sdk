 ...
 */
function instanceOfDiscountReasonsCriteria(value) {
    let isInstance = true;
    return isInstance;
}
exports.instanceOfDiscountReasonsCriteria = instanceOfDiscountReasonsCriteria;
function DiscountReasonsCriteriaFromJSON(json) {
    return DiscountReasonsCriteriaFromJSONTyped(json, false);
}
exports.DiscountReasonsCriteriaFromJSON = DiscountReasonsCriteriaFromJSON;
function DiscountReasonsCriteriaFromJSONTyped(json, ignoreDiscriminator) {
...
function DiscountReasonsCriteriaToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
