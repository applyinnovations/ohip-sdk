 ...
 */
export declare function instanceOfCreateGuaranteeCodeScheduleType(value: object): boolean;
export declare function CreateGuaranteeCodeScheduleTypeFromJSON(json: any): CreateGuaranteeCodeScheduleType;
export declare function CreateGuaranteeCodeScheduleTypeFromJSONTyped(json: any, ignoreDiscriminator: boolean): CreateGuaranteeCodeScheduleType;
export declare function CreateGuaranteeCodeScheduleTypeToJSON(value?: CreateGuaranteeCodeScheduleType | null): any;
