 ...
 */
export function instanceOfPostGuaranteeCodeRequest(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function PostGuaranteeCodeRequestFromJSON(json: any): PostGuaranteeCodeRequest {
    return PostGuaranteeCodeRequestFromJSONTyped(json, false);
}

export function PostGuaranteeCodeRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): PostGuaranteeCodeRequest {
...
export function PostGuaranteeCodeRequestToJSON(value?: PostGuaranteeCodeRequest | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
