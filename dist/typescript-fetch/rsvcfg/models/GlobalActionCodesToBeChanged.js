 ...
 */
function instanceOfGlobalActionCodesToBeChanged(value) {
    let isInstance = true;
    return isInstance;
}
exports.instanceOfGlobalActionCodesToBeChanged = instanceOfGlobalActionCodesToBeChanged;
function GlobalActionCodesToBeChangedFromJSON(json) {
    return GlobalActionCodesToBeChangedFromJSONTyped(json, false);
}
exports.GlobalActionCodesToBeChangedFromJSON = GlobalActionCodesToBeChangedFromJSON;
function GlobalActionCodesToBeChangedFromJSONTyped(json, ignoreDiscriminator) {
...
function GlobalActionCodesToBeChangedToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
