...
exports.BookingTypeTypeToJSON = exports.BookingTypeTypeFromJSONTyped = exports.BookingTypeTypeFromJSON = exports.instanceOfBookingTypeType = void 0;
const runtime_1 = require("../runtime");
const ManagedByOptions_1 = require("./ManagedByOptions");
const TranslationTextType2000_1 = require("./TranslationTextType2000");
/**
 * Check if a given object implements the BookingTypeType interface.
 */
function instanceOfBookingTypeType(value) {
    let isInstance = true;
    return isInstance;
}
exports.instanceOfBookingTypeType = instanceOfBookingTypeType;
function BookingTypeTypeFromJSON(json) {
    return BookingTypeTypeFromJSONTyped(json, false);
}
exports.BookingTypeTypeFromJSON = BookingTypeTypeFromJSON;
function BookingTypeTypeFromJSONTyped(json, ignoreDiscriminator) {
...
exports.BookingTypeTypeFromJSONTyped = BookingTypeTypeFromJSONTyped;
function BookingTypeTypeToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
...
exports.BookingTypeTypeToJSON = BookingTypeTypeToJSON;
