 ...
 */
function instanceOfBookingTypesToBeChanged(value) {
    let isInstance = true;
    return isInstance;
}
exports.instanceOfBookingTypesToBeChanged = instanceOfBookingTypesToBeChanged;
function BookingTypesToBeChangedFromJSON(json) {
    return BookingTypesToBeChangedFromJSONTyped(json, false);
}
exports.BookingTypesToBeChangedFromJSON = BookingTypesToBeChangedFromJSON;
function BookingTypesToBeChangedFromJSONTyped(json, ignoreDiscriminator) {
...
function BookingTypesToBeChangedToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
