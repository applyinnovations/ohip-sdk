 ...
 */
export declare function instanceOfDepositPolicyCriteria(value: object): boolean;
export declare function DepositPolicyCriteriaFromJSON(json: any): DepositPolicyCriteria;
export declare function DepositPolicyCriteriaFromJSONTyped(json: any, ignoreDiscriminator: boolean): DepositPolicyCriteria;
export declare function DepositPolicyCriteriaToJSON(value?: DepositPolicyCriteria | null): any;
