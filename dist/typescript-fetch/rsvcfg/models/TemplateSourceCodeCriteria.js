 ...
 */
function instanceOfTemplateSourceCodeCriteria(value) {
    let isInstance = true;
    return isInstance;
}
exports.instanceOfTemplateSourceCodeCriteria = instanceOfTemplateSourceCodeCriteria;
function TemplateSourceCodeCriteriaFromJSON(json) {
    return TemplateSourceCodeCriteriaFromJSONTyped(json, false);
}
exports.TemplateSourceCodeCriteriaFromJSON = TemplateSourceCodeCriteriaFromJSON;
function TemplateSourceCodeCriteriaFromJSONTyped(json, ignoreDiscriminator) {
...
function TemplateSourceCodeCriteriaToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
