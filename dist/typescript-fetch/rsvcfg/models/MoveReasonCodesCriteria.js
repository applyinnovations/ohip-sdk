 ...
 */
function instanceOfMoveReasonCodesCriteria(value) {
    let isInstance = true;
    return isInstance;
}
exports.instanceOfMoveReasonCodesCriteria = instanceOfMoveReasonCodesCriteria;
function MoveReasonCodesCriteriaFromJSON(json) {
    return MoveReasonCodesCriteriaFromJSONTyped(json, false);
}
exports.MoveReasonCodesCriteriaFromJSON = MoveReasonCodesCriteriaFromJSON;
function MoveReasonCodesCriteriaFromJSONTyped(json, ignoreDiscriminator) {
...
function MoveReasonCodesCriteriaToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
