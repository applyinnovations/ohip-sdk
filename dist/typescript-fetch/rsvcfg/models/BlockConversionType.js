...
exports.BlockConversionTypeToJSON = exports.BlockConversionTypeFromJSONTyped = exports.BlockConversionTypeFromJSON = exports.instanceOfBlockConversionType = void 0;
 ...
 */
function instanceOfBlockConversionType(value) {
    let isInstance = true;
    return isInstance;
}
exports.instanceOfBlockConversionType = instanceOfBlockConversionType;
function BlockConversionTypeFromJSON(json) {
    return BlockConversionTypeFromJSONTyped(json, false);
}
exports.BlockConversionTypeFromJSON = BlockConversionTypeFromJSON;
function BlockConversionTypeFromJSONTyped(json, ignoreDiscriminator) {
...
exports.BlockConversionTypeFromJSONTyped = BlockConversionTypeFromJSONTyped;
function BlockConversionTypeToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
...
exports.BlockConversionTypeToJSON = BlockConversionTypeToJSON;
