 ...
 */
function instanceOfECouponCopyType(value) {
    let isInstance = true;
    return isInstance;
}
exports.instanceOfECouponCopyType = instanceOfECouponCopyType;
function ECouponCopyTypeFromJSON(json) {
    return ECouponCopyTypeFromJSONTyped(json, false);
}
exports.ECouponCopyTypeFromJSON = ECouponCopyTypeFromJSON;
function ECouponCopyTypeFromJSONTyped(json, ignoreDiscriminator) {
...
function ECouponCopyTypeToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
