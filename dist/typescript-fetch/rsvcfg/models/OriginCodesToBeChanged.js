 ...
 */
function instanceOfOriginCodesToBeChanged(value) {
    let isInstance = true;
    return isInstance;
}
exports.instanceOfOriginCodesToBeChanged = instanceOfOriginCodesToBeChanged;
function OriginCodesToBeChangedFromJSON(json) {
    return OriginCodesToBeChangedFromJSONTyped(json, false);
}
exports.OriginCodesToBeChangedFromJSON = OriginCodesToBeChangedFromJSON;
function OriginCodesToBeChangedFromJSONTyped(json, ignoreDiscriminator) {
...
function OriginCodesToBeChangedToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
