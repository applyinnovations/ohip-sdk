 ...
 */
export declare function instanceOfRoomRatings(value: object): boolean;
export declare function RoomRatingsFromJSON(json: any): RoomRatings;
export declare function RoomRatingsFromJSONTyped(json: any, ignoreDiscriminator: boolean): RoomRatings;
export declare function RoomRatingsToJSON(value?: RoomRatings | null): any;
