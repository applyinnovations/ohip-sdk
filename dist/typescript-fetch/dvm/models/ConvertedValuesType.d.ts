 ...
 */
export declare function instanceOfConvertedValuesType(value: object): boolean;
export declare function ConvertedValuesTypeFromJSON(json: any): ConvertedValuesType;
export declare function ConvertedValuesTypeFromJSONTyped(json: any, ignoreDiscriminator: boolean): ConvertedValuesType;
export declare function ConvertedValuesTypeToJSON(value?: ConvertedValuesType | null): any;
