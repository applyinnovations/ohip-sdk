...
class DataValueMappingApi extends runtime.BaseAPI {
     ...
     */
    clearDefaultValueCacheRaw(requestParameters, initOverrides) {
     ...
     * Clear Default Value Cache
     */
    clearDefaultValueCache(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield this.clearDefaultValueCacheRaw(requestParameters, initOverrides);
     ...
     */
    pingDataValueMappingServiceRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            const queryParameters = {};
            const headerParameters = {};
            if (requestParameters.authorization !== undefined && requestParameters.authorization !== null) {
     ...
     * ping Data Value Mapping Service
     */
    pingDataValueMappingService(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield this.pingDataValueMappingServiceRaw(requestParameters, initOverrides);
            return yield response.value();
        });
    }
}
