...
import type { BlockRatePlans, CopyPackageCodesType, CreateBestAvailableRates, DailyRatePlanScheduleRange, DistributedNegotiatedRates, GetBestAvailableRatesDetails, HotelPackageForecastGroups, HotelPackageForecastGroupsToChange, HotelPackageForecastGroupsToCreate, MassRateChangeStatus, MassRatePlanSchedules, NegotiatedRates, NegotiatedRatesDetails, PackageFormulaRanges, PackageGroup, PackageGroupsInfo, PackageInfo, PackageRates, PackagesInfo, PromotionGroup, PromotionGroups, PromotionGroupsCopy, PropertyPromotionCode, PropertyPromotionCodes, RateAccessExclusions, RateActivityLog, RateGroups, RateGroupsInfo, RatePlan, RatePlanInfo, RatePlanPackages, RatePlanPostingRhythms, RatePlanScheduleToSplit, RatePlanScheduleYieldAdjustments, RatePlanSchedules, RatePlanSchedulesInfo, RatePlanSchedulesToCreate, RatePlanSchedulesToSet, RatePlansCopy, RatePlansCopyDetails, RatePlansSchedulesToManage, RatePlansSummary, RatePlansSync, RateStrategies, RateStrategiesToSet, RateStrategy, Status, TemplatePackageForecastGroups, TemplatePromotionCode, TemplatePromotionCodes, TieredRateSchedulesCopy, YieldAdjustments } from '../models/index';
...
export declare class RatePlanApi extends runtime.BaseAPI {
     ...
     */
    setRatePlanSchedulesRaw(requestParameters: SetRatePlanSchedulesRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Status>>;
    /**
     * This API allows you to set Rate Plan schedules. <p><strong>OperationId:</strong>setRatePlanSchedules</p>
     * Set rate plan schedules
     */
    setRatePlanSchedules(requestParameters: SetRatePlanSchedulesRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Status>;
    /**
     ...
     */
    syncRatePlansRaw(requestParameters: SyncRatePlansRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Status>>;
    /**
     * This API updates all requested properties having the same rate code so they have the same rate code attributes.
     * Synchronizes Rate Plan information including Rate Header and Packages across target properties.
     */
    syncRatePlans(requestParameters: SyncRatePlansRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Status>;
}
/**
 * @export
 */
