 ...
 */
export declare function instanceOfScheduleYieldInfoType(value: object): boolean;
export declare function ScheduleYieldInfoTypeFromJSON(json: any): ScheduleYieldInfoType;
export declare function ScheduleYieldInfoTypeFromJSONTyped(json: any, ignoreDiscriminator: boolean): ScheduleYieldInfoType;
export declare function ScheduleYieldInfoTypeToJSON(value?: ScheduleYieldInfoType | null): any;
