 ...
 */
export declare function instanceOfBlockRatePlans(value: object): boolean;
export declare function BlockRatePlansFromJSON(json: any): BlockRatePlans;
export declare function BlockRatePlansFromJSONTyped(json: any, ignoreDiscriminator: boolean): BlockRatePlans;
export declare function BlockRatePlansToJSON(value?: BlockRatePlans | null): any;
