 ...
 */
export declare function instanceOfRatePlanDistributionType(value: object): boolean;
export declare function RatePlanDistributionTypeFromJSON(json: any): RatePlanDistributionType;
export declare function RatePlanDistributionTypeFromJSONTyped(json: any, ignoreDiscriminator: boolean): RatePlanDistributionType;
export declare function RatePlanDistributionTypeToJSON(value?: RatePlanDistributionType | null): any;
