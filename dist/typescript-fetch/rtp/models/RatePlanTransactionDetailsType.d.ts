 ...
 */
export declare function instanceOfRatePlanTransactionDetailsType(value: object): boolean;
export declare function RatePlanTransactionDetailsTypeFromJSON(json: any): RatePlanTransactionDetailsType;
export declare function RatePlanTransactionDetailsTypeFromJSONTyped(json: any, ignoreDiscriminator: boolean): RatePlanTransactionDetailsType;
export declare function RatePlanTransactionDetailsTypeToJSON(value?: RatePlanTransactionDetailsType | null): any;
