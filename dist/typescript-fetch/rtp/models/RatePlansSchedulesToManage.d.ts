 ...
 */
export declare function instanceOfRatePlansSchedulesToManage(value: object): boolean;
export declare function RatePlansSchedulesToManageFromJSON(json: any): RatePlansSchedulesToManage;
export declare function RatePlansSchedulesToManageFromJSONTyped(json: any, ignoreDiscriminator: boolean): RatePlansSchedulesToManage;
export declare function RatePlansSchedulesToManageToJSON(value?: RatePlansSchedulesToManage | null): any;
