 ...
 */
function instanceOfPackageGroupsInfo(value) {
    let isInstance = true;
    return isInstance;
}
exports.instanceOfPackageGroupsInfo = instanceOfPackageGroupsInfo;
function PackageGroupsInfoFromJSON(json) {
    return PackageGroupsInfoFromJSONTyped(json, false);
}
exports.PackageGroupsInfoFromJSON = PackageGroupsInfoFromJSON;
function PackageGroupsInfoFromJSONTyped(json, ignoreDiscriminator) {
...
function PackageGroupsInfoToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
