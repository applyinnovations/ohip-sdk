 ...
 */
export declare function instanceOfRatePlanPostingRhythmType(value: object): boolean;
export declare function RatePlanPostingRhythmTypeFromJSON(json: any): RatePlanPostingRhythmType;
export declare function RatePlanPostingRhythmTypeFromJSONTyped(json: any, ignoreDiscriminator: boolean): RatePlanPostingRhythmType;
export declare function RatePlanPostingRhythmTypeToJSON(value?: RatePlanPostingRhythmType | null): any;
