 ...
 * 
 * @export
 * @interface PostPackageFormulaRangesRequest
 */
export interface PostPackageFormulaRangesRequest {
    /**
     * 
     * @type {Array<InstanceLink>}
     * @memberof PostPackageFormulaRangesRequest
     */
 ...
 */
export function instanceOfPostPackageFormulaRangesRequest(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function PostPackageFormulaRangesRequestFromJSON(json: any): PostPackageFormulaRangesRequest {
    return PostPackageFormulaRangesRequestFromJSONTyped(json, false);
}

export function PostPackageFormulaRangesRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): PostPackageFormulaRangesRequest {
...
export function PostPackageFormulaRangesRequestToJSON(value?: PostPackageFormulaRangesRequest | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
