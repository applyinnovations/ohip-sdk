 ...
 */
function instanceOfDisplaySetsDetails(value) {
    let isInstance = true;
    return isInstance;
}
exports.instanceOfDisplaySetsDetails = instanceOfDisplaySetsDetails;
function DisplaySetsDetailsFromJSON(json) {
    return DisplaySetsDetailsFromJSONTyped(json, false);
}
exports.DisplaySetsDetailsFromJSON = DisplaySetsDetailsFromJSON;
function DisplaySetsDetailsFromJSONTyped(json, ignoreDiscriminator) {
...
function DisplaySetsDetailsToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
