 ...
 */
export declare function instanceOfRatePlanControlsType(value: object): boolean;
export declare function RatePlanControlsTypeFromJSON(json: any): RatePlanControlsType;
export declare function RatePlanControlsTypeFromJSONTyped(json: any, ignoreDiscriminator: boolean): RatePlanControlsType;
export declare function RatePlanControlsTypeToJSON(value?: RatePlanControlsType | null): any;
