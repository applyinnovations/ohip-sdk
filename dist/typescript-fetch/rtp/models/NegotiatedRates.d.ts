 ...
 */
export declare function instanceOfNegotiatedRates(value: object): boolean;
export declare function NegotiatedRatesFromJSON(json: any): NegotiatedRates;
export declare function NegotiatedRatesFromJSONTyped(json: any, ignoreDiscriminator: boolean): NegotiatedRates;
export declare function NegotiatedRatesToJSON(value?: NegotiatedRates | null): any;
