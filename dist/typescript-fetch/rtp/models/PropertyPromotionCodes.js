 ...
 */
function instanceOfPropertyPromotionCodes(value) {
    let isInstance = true;
    return isInstance;
}
exports.instanceOfPropertyPromotionCodes = instanceOfPropertyPromotionCodes;
function PropertyPromotionCodesFromJSON(json) {
    return PropertyPromotionCodesFromJSONTyped(json, false);
}
exports.PropertyPromotionCodesFromJSON = PropertyPromotionCodesFromJSON;
function PropertyPromotionCodesFromJSONTyped(json, ignoreDiscriminator) {
...
function PropertyPromotionCodesToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
