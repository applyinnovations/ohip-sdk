...
exports.CopyTieredRateSchedulesRequestToJSON = exports.CopyTieredRateSchedulesRequestFromJSONTyped = exports.CopyTieredRateSchedulesRequestFromJSON = exports.instanceOfCopyTieredRateSchedulesRequest = void 0;
 ...
 */
function instanceOfCopyTieredRateSchedulesRequest(value) {
    let isInstance = true;
    return isInstance;
}
exports.instanceOfCopyTieredRateSchedulesRequest = instanceOfCopyTieredRateSchedulesRequest;
function CopyTieredRateSchedulesRequestFromJSON(json) {
    return CopyTieredRateSchedulesRequestFromJSONTyped(json, false);
}
exports.CopyTieredRateSchedulesRequestFromJSON = CopyTieredRateSchedulesRequestFromJSON;
function CopyTieredRateSchedulesRequestFromJSONTyped(json, ignoreDiscriminator) {
...
exports.CopyTieredRateSchedulesRequestFromJSONTyped = CopyTieredRateSchedulesRequestFromJSONTyped;
function CopyTieredRateSchedulesRequestToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
...
exports.CopyTieredRateSchedulesRequestToJSON = CopyTieredRateSchedulesRequestToJSON;
