 ...
 */
export declare function instanceOfRateOffsetType(value: object): boolean;
export declare function RateOffsetTypeFromJSON(json: any): RateOffsetType;
export declare function RateOffsetTypeFromJSONTyped(json: any, ignoreDiscriminator: boolean): RateOffsetType;
export declare function RateOffsetTypeToJSON(value?: RateOffsetType | null): any;
