 ...
 */
export declare function instanceOfValidateListOfValues(value: object): boolean;
export declare function ValidateListOfValuesFromJSON(json: any): ValidateListOfValues;
export declare function ValidateListOfValuesFromJSONTyped(json: any, ignoreDiscriminator: boolean): ValidateListOfValues;
export declare function ValidateListOfValuesToJSON(value?: ValidateListOfValues | null): any;
