 ...
 */
export declare function instanceOfListOfValues(value: object): boolean;
export declare function ListOfValuesFromJSON(json: any): ListOfValues;
export declare function ListOfValuesFromJSONTyped(json: any, ignoreDiscriminator: boolean): ListOfValues;
export declare function ListOfValuesToJSON(value?: ListOfValues | null): any;
