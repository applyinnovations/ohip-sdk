 ...
 */
function instanceOfHousekeepingSectionsCriteria(value) {
    let isInstance = true;
    return isInstance;
}
exports.instanceOfHousekeepingSectionsCriteria = instanceOfHousekeepingSectionsCriteria;
function HousekeepingSectionsCriteriaFromJSON(json) {
    return HousekeepingSectionsCriteriaFromJSONTyped(json, false);
}
exports.HousekeepingSectionsCriteriaFromJSON = HousekeepingSectionsCriteriaFromJSON;
function HousekeepingSectionsCriteriaFromJSONTyped(json, ignoreDiscriminator) {
...
function HousekeepingSectionsCriteriaToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
