 ...
 */
export function instanceOfChangeHousekeepingSectionsRequest(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function ChangeHousekeepingSectionsRequestFromJSON(json: any): ChangeHousekeepingSectionsRequest {
    return ChangeHousekeepingSectionsRequestFromJSONTyped(json, false);
}

export function ChangeHousekeepingSectionsRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): ChangeHousekeepingSectionsRequest {
...
export function ChangeHousekeepingSectionsRequestToJSON(value?: ChangeHousekeepingSectionsRequest | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
