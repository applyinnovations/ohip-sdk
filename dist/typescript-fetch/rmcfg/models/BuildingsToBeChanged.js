 ...
 */
function instanceOfBuildingsToBeChanged(value) {
    let isInstance = true;
    return isInstance;
}
exports.instanceOfBuildingsToBeChanged = instanceOfBuildingsToBeChanged;
function BuildingsToBeChangedFromJSON(json) {
    return BuildingsToBeChangedFromJSONTyped(json, false);
}
exports.BuildingsToBeChangedFromJSON = BuildingsToBeChangedFromJSON;
function BuildingsToBeChangedFromJSONTyped(json, ignoreDiscriminator) {
...
function BuildingsToBeChangedToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
