 ...
 */
function instanceOfHotelRoomMaintenanceReasonsCriteria(value) {
    let isInstance = true;
    return isInstance;
}
exports.instanceOfHotelRoomMaintenanceReasonsCriteria = instanceOfHotelRoomMaintenanceReasonsCriteria;
function HotelRoomMaintenanceReasonsCriteriaFromJSON(json) {
    return HotelRoomMaintenanceReasonsCriteriaFromJSONTyped(json, false);
}
exports.HotelRoomMaintenanceReasonsCriteriaFromJSON = HotelRoomMaintenanceReasonsCriteriaFromJSON;
function HotelRoomMaintenanceReasonsCriteriaFromJSONTyped(json, ignoreDiscriminator) {
...
function HotelRoomMaintenanceReasonsCriteriaToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
