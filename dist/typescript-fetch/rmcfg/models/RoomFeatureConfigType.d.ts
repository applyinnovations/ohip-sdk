 ...
 */
export declare function instanceOfRoomFeatureConfigType(value: object): boolean;
export declare function RoomFeatureConfigTypeFromJSON(json: any): RoomFeatureConfigType;
export declare function RoomFeatureConfigTypeFromJSONTyped(json: any, ignoreDiscriminator: boolean): RoomFeatureConfigType;
export declare function RoomFeatureConfigTypeToJSON(value?: RoomFeatureConfigType | null): any;
