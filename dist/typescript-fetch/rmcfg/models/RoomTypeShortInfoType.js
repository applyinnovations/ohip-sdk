...
const ComponentRoomInfoType_1 = require("./ComponentRoomInfoType");
const ComponentSuiteInfoType_1 = require("./ComponentSuiteInfoType");
...
function RoomTypeShortInfoTypeFromJSONTyped(json, ignoreDiscriminator) {
    ...
    return {
        ...
        'componentRoomsInfo': !(0, runtime_1.exists)(json, 'componentRoomsInfo') ? undefined : (json['componentRoomsInfo'].map(ComponentRoomInfoType_1.ComponentRoomInfoTypeFromJSON)),
        'componentSuitesInfo': !(0, runtime_1.exists)(json, 'componentSuitesInfo') ? undefined : (json['componentSuitesInfo'].map(ComponentSuiteInfoType_1.ComponentSuiteInfoTypeFromJSON)),
    };
}
...
function RoomTypeShortInfoTypeToJSON(value) {
    ...
    return {
        ...
        'componentRoomsInfo': value.componentRoomsInfo === undefined ? undefined : (value.componentRoomsInfo.map(ComponentRoomInfoType_1.ComponentRoomInfoTypeToJSON)),
        'componentSuitesInfo': value.componentSuitesInfo === undefined ? undefined : (value.componentSuitesInfo.map(ComponentSuiteInfoType_1.ComponentSuiteInfoTypeToJSON)),
    };
}
