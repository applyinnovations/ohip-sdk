 ...
 */
export declare function instanceOfOutOfOrderServiceReasonType(value: object): boolean;
export declare function OutOfOrderServiceReasonTypeFromJSON(json: any): OutOfOrderServiceReasonType;
export declare function OutOfOrderServiceReasonTypeFromJSONTyped(json: any, ignoreDiscriminator: boolean): OutOfOrderServiceReasonType;
export declare function OutOfOrderServiceReasonTypeToJSON(value?: OutOfOrderServiceReasonType | null): any;
