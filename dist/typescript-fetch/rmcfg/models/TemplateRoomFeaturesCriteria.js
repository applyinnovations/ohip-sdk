 ...
 */
function instanceOfTemplateRoomFeaturesCriteria(value) {
    let isInstance = true;
    return isInstance;
}
exports.instanceOfTemplateRoomFeaturesCriteria = instanceOfTemplateRoomFeaturesCriteria;
function TemplateRoomFeaturesCriteriaFromJSON(json) {
    return TemplateRoomFeaturesCriteriaFromJSONTyped(json, false);
}
exports.TemplateRoomFeaturesCriteriaFromJSON = TemplateRoomFeaturesCriteriaFromJSON;
function TemplateRoomFeaturesCriteriaFromJSONTyped(json, ignoreDiscriminator) {
...
function TemplateRoomFeaturesCriteriaToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
