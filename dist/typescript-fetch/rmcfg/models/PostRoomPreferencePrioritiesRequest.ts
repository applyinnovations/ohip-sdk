 ...
 * 
 * @export
 * @interface PostRoomPreferencePrioritiesRequest
 */
export interface PostRoomPreferencePrioritiesRequest {
    /**
     * 
     * @type {Array<InstanceLink>}
     * @memberof PostRoomPreferencePrioritiesRequest
     */
 ...
 */
export function instanceOfPostRoomPreferencePrioritiesRequest(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function PostRoomPreferencePrioritiesRequestFromJSON(json: any): PostRoomPreferencePrioritiesRequest {
    return PostRoomPreferencePrioritiesRequestFromJSONTyped(json, false);
}

export function PostRoomPreferencePrioritiesRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): PostRoomPreferencePrioritiesRequest {
...
export function PostRoomPreferencePrioritiesRequestToJSON(value?: PostRoomPreferencePrioritiesRequest | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
