 ...
 */
function instanceOfRoomClassesDetails(value) {
    let isInstance = true;
    return isInstance;
}
exports.instanceOfRoomClassesDetails = instanceOfRoomClassesDetails;
function RoomClassesDetailsFromJSON(json) {
    return RoomClassesDetailsFromJSONTyped(json, false);
}
exports.RoomClassesDetailsFromJSON = RoomClassesDetailsFromJSON;
function RoomClassesDetailsFromJSONTyped(json, ignoreDiscriminator) {
...
function RoomClassesDetailsToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
