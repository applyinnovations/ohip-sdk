 ...
 */
function instanceOfBedTypesToBeChanged(value) {
    let isInstance = true;
    return isInstance;
}
exports.instanceOfBedTypesToBeChanged = instanceOfBedTypesToBeChanged;
function BedTypesToBeChangedFromJSON(json) {
    return BedTypesToBeChangedFromJSONTyped(json, false);
}
exports.BedTypesToBeChangedFromJSON = BedTypesToBeChangedFromJSON;
function BedTypesToBeChangedFromJSONTyped(json, ignoreDiscriminator) {
...
function BedTypesToBeChangedToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
