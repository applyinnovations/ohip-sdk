 ...
 */
function instanceOfBuildingGroupsCriteria(value) {
    let isInstance = true;
    return isInstance;
}
exports.instanceOfBuildingGroupsCriteria = instanceOfBuildingGroupsCriteria;
function BuildingGroupsCriteriaFromJSON(json) {
    return BuildingGroupsCriteriaFromJSONTyped(json, false);
}
exports.BuildingGroupsCriteriaFromJSON = BuildingGroupsCriteriaFromJSON;
function BuildingGroupsCriteriaFromJSONTyped(json, ignoreDiscriminator) {
...
function BuildingGroupsCriteriaToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
