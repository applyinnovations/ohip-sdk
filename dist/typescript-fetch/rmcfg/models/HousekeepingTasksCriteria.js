 ...
 */
function instanceOfHousekeepingTasksCriteria(value) {
    let isInstance = true;
    return isInstance;
}
exports.instanceOfHousekeepingTasksCriteria = instanceOfHousekeepingTasksCriteria;
function HousekeepingTasksCriteriaFromJSON(json) {
    return HousekeepingTasksCriteriaFromJSONTyped(json, false);
}
exports.HousekeepingTasksCriteriaFromJSON = HousekeepingTasksCriteriaFromJSON;
function HousekeepingTasksCriteriaFromJSONTyped(json, ignoreDiscriminator) {
...
function HousekeepingTasksCriteriaToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
