 ...
 */
export function instanceOfSetHousekeepingTaskSheetRooms(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function SetHousekeepingTaskSheetRoomsFromJSON(json: any): SetHousekeepingTaskSheetRooms {
    return SetHousekeepingTaskSheetRoomsFromJSONTyped(json, false);
}

export function SetHousekeepingTaskSheetRoomsFromJSONTyped(json: any, ignoreDiscriminator: boolean): SetHousekeepingTaskSheetRooms {
...
export function SetHousekeepingTaskSheetRoomsToJSON(value?: SetHousekeepingTaskSheetRooms | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
