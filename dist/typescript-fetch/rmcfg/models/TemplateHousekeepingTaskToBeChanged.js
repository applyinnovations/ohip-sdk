 ...
 */
function instanceOfTemplateHousekeepingTaskToBeChanged(value) {
    let isInstance = true;
    return isInstance;
}
exports.instanceOfTemplateHousekeepingTaskToBeChanged = instanceOfTemplateHousekeepingTaskToBeChanged;
function TemplateHousekeepingTaskToBeChangedFromJSON(json) {
    return TemplateHousekeepingTaskToBeChangedFromJSONTyped(json, false);
}
exports.TemplateHousekeepingTaskToBeChangedFromJSON = TemplateHousekeepingTaskToBeChangedFromJSON;
function TemplateHousekeepingTaskToBeChangedFromJSONTyped(json, ignoreDiscriminator) {
...
function TemplateHousekeepingTaskToBeChangedToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
