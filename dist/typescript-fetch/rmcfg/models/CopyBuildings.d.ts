 ...
 */
export declare function instanceOfCopyBuildings(value: object): boolean;
export declare function CopyBuildingsFromJSON(json: any): CopyBuildings;
export declare function CopyBuildingsFromJSONTyped(json: any, ignoreDiscriminator: boolean): CopyBuildings;
export declare function CopyBuildingsToJSON(value?: CopyBuildings | null): any;
