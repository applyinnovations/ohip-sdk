 ...
 */
export function instanceOfPostHotelRoomMaintenanceReasonsRequest(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function PostHotelRoomMaintenanceReasonsRequestFromJSON(json: any): PostHotelRoomMaintenanceReasonsRequest {
    return PostHotelRoomMaintenanceReasonsRequestFromJSONTyped(json, false);
}

export function PostHotelRoomMaintenanceReasonsRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): PostHotelRoomMaintenanceReasonsRequest {
...
export function PostHotelRoomMaintenanceReasonsRequestToJSON(value?: PostHotelRoomMaintenanceReasonsRequest | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
