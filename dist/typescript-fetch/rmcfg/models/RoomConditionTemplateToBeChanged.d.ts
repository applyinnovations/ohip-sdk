 ...
 */
export declare function instanceOfRoomConditionTemplateToBeChanged(value: object): boolean;
export declare function RoomConditionTemplateToBeChangedFromJSON(json: any): RoomConditionTemplateToBeChanged;
export declare function RoomConditionTemplateToBeChangedFromJSONTyped(json: any, ignoreDiscriminator: boolean): RoomConditionTemplateToBeChanged;
export declare function RoomConditionTemplateToBeChangedToJSON(value?: RoomConditionTemplateToBeChanged | null): any;
