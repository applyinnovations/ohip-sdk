 ...
 */
export declare function instanceOfBuildingFloorMappingType(value: object): boolean;
export declare function BuildingFloorMappingTypeFromJSON(json: any): BuildingFloorMappingType;
export declare function BuildingFloorMappingTypeFromJSONTyped(json: any, ignoreDiscriminator: boolean): BuildingFloorMappingType;
export declare function BuildingFloorMappingTypeToJSON(value?: BuildingFloorMappingType | null): any;
