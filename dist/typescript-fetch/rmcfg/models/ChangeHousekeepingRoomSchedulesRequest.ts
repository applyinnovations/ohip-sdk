 ...
 */
export function instanceOfChangeHousekeepingRoomSchedulesRequest(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function ChangeHousekeepingRoomSchedulesRequestFromJSON(json: any): ChangeHousekeepingRoomSchedulesRequest {
    return ChangeHousekeepingRoomSchedulesRequestFromJSONTyped(json, false);
}

export function ChangeHousekeepingRoomSchedulesRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): ChangeHousekeepingRoomSchedulesRequest {
...
export function ChangeHousekeepingRoomSchedulesRequestToJSON(value?: ChangeHousekeepingRoomSchedulesRequest | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
