 ...
 */
function instanceOfTemplateRoomMaintenanceReasonsCriteria(value) {
    let isInstance = true;
    return isInstance;
}
exports.instanceOfTemplateRoomMaintenanceReasonsCriteria = instanceOfTemplateRoomMaintenanceReasonsCriteria;
function TemplateRoomMaintenanceReasonsCriteriaFromJSON(json) {
    return TemplateRoomMaintenanceReasonsCriteriaFromJSONTyped(json, false);
}
exports.TemplateRoomMaintenanceReasonsCriteriaFromJSON = TemplateRoomMaintenanceReasonsCriteriaFromJSON;
function TemplateRoomMaintenanceReasonsCriteriaFromJSONTyped(json, ignoreDiscriminator) {
...
function TemplateRoomMaintenanceReasonsCriteriaToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
