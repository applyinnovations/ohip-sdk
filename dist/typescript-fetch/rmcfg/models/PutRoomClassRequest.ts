 ...
 */
export function instanceOfPutRoomClassRequest(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function PutRoomClassRequestFromJSON(json: any): PutRoomClassRequest {
    return PutRoomClassRequestFromJSONTyped(json, false);
}

export function PutRoomClassRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): PutRoomClassRequest {
...
export function PutRoomClassRequestToJSON(value?: PutRoomClassRequest | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
