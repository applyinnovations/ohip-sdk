...
export declare class HotelConfigApi extends runtime.BaseAPI {
     ...
     */
    changeTemplateHousekeepingRoomScheduleRaw(requestParameters: ChangeTemplateHousekeepingRoomScheduleRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Status>>;
    /**
     * Use this API to update housekeeping room schedule configured at template level for a given unique sequence ID of the scheduled task and this operation is supported when either the Task Sheets or the Advance Task Sheets OPERA Control is active.<p><strong>OperationId:</strong>changeTemplateHousekeepingRoomSchedule</p>
     * Change housekeeping room schedules configured at template level
     */
    changeTemplateHousekeepingRoomSchedule(requestParameters: ChangeTemplateHousekeepingRoomScheduleRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Status>;
    /**
     ...
     */
    deleteTemplateHousekeepingRoomScheduleRaw(requestParameters: DeleteTemplateHousekeepingRoomScheduleRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Status>>;
    /**
     * Use this API to delete the housekeeping room schedules configured at template level for a given unique sequence ID of the scheduled template task. <p><strong>OperationId:</strong> deleteTemplateHousekeepingRoomSchedule </p>
     * Delete housekeeping room schedules configured at template level
     */
    deleteTemplateHousekeepingRoomSchedule(requestParameters: DeleteTemplateHousekeepingRoomScheduleRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Status>;
    /**
     ...
     */
    deleteVacantRoomStatusRaw(requestParameters: DeleteVacantRoomStatusRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Status>>;
    /**
     * Delete vacant room status configuration. <p><strong>OperationId:</strong>deleteVacantRoomStatus</p>
     * Delete vacant room status configuration.
     */
    deleteVacantRoomStatus(requestParameters: DeleteVacantRoomStatusRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Status>;
    /**
     ...
     */
    getTemplateHousekeepingRoomSchedulesRaw(requestParameters: GetTemplateHousekeepingRoomSchedulesRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<TemplateHousekeepingRoomSchedulesDetails>>;
    /**
     * Use this API to fetch housekeeping room schedule configured at template level for the given search criteria such Room Type, Housekeeping Room Schedule Codes.<p><strong>OperationId:</strong>getTemplateHousekeepingRoomSchedules</p>
     * Get housekeeping room schedules configured at template level.
     */
    getTemplateHousekeepingRoomSchedules(requestParameters: GetTemplateHousekeepingRoomSchedulesRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<TemplateHousekeepingRoomSchedulesDetails>;
    /**
     ...
     */
    getVacantRoomStatusRaw(requestParameters: GetVacantRoomStatusRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<VacantRoomStatusesList>>;
    /**
     * Use this API to retrieve vacant room status configuration. <p><strong>OperationId:</strong>getVacantRoomStatus</p> <p>This API allows a time span of <strong>90</strong> days.</p>
     * Get vacant room status configuration.
     */
    getVacantRoomStatus(requestParameters: GetVacantRoomStatusRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<VacantRoomStatusesList>;
    /**
     ...
     */
    postTemplateHousekeepingRoomScheduleRaw(requestParameters: PostTemplateHousekeepingRoomScheduleRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Status>>;
    /**
     * Use this API to create/configure housekeeping room schedule at template level for a given data like task code,room type,priority,sequence etc., and this operation is supported when either the Task Sheets or the Advance Task Sheets OPERA Control is active.<p><strong>OperationId:</strong>postTemplateHousekeepingRoomSchedule</p>
     * Create housekeeping room schedules at template level
     */
    postTemplateHousekeepingRoomSchedule(requestParameters: PostTemplateHousekeepingRoomScheduleRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Status>;
    /**
     ...
     */
    postVacantRoomStatusRaw(requestParameters: PostVacantRoomStatusRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Status>>;
    /**
     * Create a new vacant room status for specific room type for a defined date range or number of days or both date range and number of days together. <p><strong>OperationId:</strong>postVacantRoomStatus</p>
     * Create vacant room status configuration.
     */
    postVacantRoomStatus(requestParameters: PostVacantRoomStatusRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Status>;
    /**
     ...
     */
    putVacantRoomStatusRaw(requestParameters: PutVacantRoomStatusRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Status>>;
    /**
     * Update an existing vacant rooms status configuration. <p><strong>OperationId:</strong>putVacantRoomStatus</p>
     * Update the vacant room status configuration.
     */
    putVacantRoomStatus(requestParameters: PutVacantRoomStatusRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Status>;
    /**
     ...
     * Delete housekeeping room schedules
     */
    removeHousekeepingScheduleRaw(requestParameters: RemoveHousekeepingScheduleRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Status>>;
    /**
     * Use this API to remove the housekeeping room schedule for a specific property based on hotleId and sequence number of task. <p><strong>OperationId:</strong> removeHousekeepinSchedule </p>
     * Delete housekeeping room schedules
     */
    removeHousekeepingSchedule(requestParameters: RemoveHousekeepingScheduleRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Status>;
    /**
