...
class HotelConfigApi extends runtime.BaseAPI {
     ...
     */
    changeTemplateHousekeepingRoomScheduleRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const response = yield this.request({
                ...
                headers: headerParameters,
                query: queryParameters,
                body: (0, index_1.TemplateHousekeepingRoomSchedulesToBeChangedToJSON)(requestParameters.templateHousekeepingRoomSchedulesToBeChanged),
            }, initOverrides);
            return new runtime.JSONApiResponse(response, (jsonValue) => (0, index_1.StatusFromJSON)(jsonValue));
        });
    }
     ...
     * Change housekeeping room schedules configured at template level
     */
    changeTemplateHousekeepingRoomSchedule(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield this.changeTemplateHousekeepingRoomScheduleRaw(requestParameters, initOverrides);
            return yield response.value();
        });
    }
    /**
     ...
     */
    deleteTemplateHousekeepingRoomScheduleRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            if (requestParameters.sequenceId === null || requestParameters.sequenceId === undefined) {
     ...
     * Delete housekeeping room schedules configured at template level
     */
    deleteTemplateHousekeepingRoomSchedule(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield this.deleteTemplateHousekeepingRoomScheduleRaw(requestParameters, initOverrides);
            return yield response.value();
        });
    }
    /**
     ...
     */
    deleteVacantRoomStatusRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            if (requestParameters.hotelId === null || requestParameters.hotelId === undefined) {
     ...
     * Delete vacant room status configuration.
     */
    deleteVacantRoomStatus(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield this.deleteVacantRoomStatusRaw(requestParameters, initOverrides);
            return yield response.value();
        });
    }
    /**
     ...
     */
    getTemplateHousekeepingRoomSchedulesRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            const queryParameters = {};
            if (requestParameters.roomTypeCodes) {
                queryParameters['roomTypeCodes'] = requestParameters.roomTypeCodes;
            ...
            return new runtime.JSONApiResponse(response, (jsonValue) => (0, index_1.TemplateHousekeepingRoomSchedulesDetailsFromJSON)(jsonValue));
        });
    }
    /**
     * Use this API to fetch housekeeping room schedule configured at template level for the given search criteria such Room Type, Housekeeping Room Schedule Codes.<p><strong>OperationId:</strong>getTemplateHousekeepingRoomSchedules</p>
     * Get housekeeping room schedules configured at template level.
     */
    getTemplateHousekeepingRoomSchedules(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield this.getTemplateHousekeepingRoomSchedulesRaw(requestParameters, initOverrides);
            return yield response.value();
        });
    }
    /**
     ...
     */
    getVacantRoomStatusRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            if (requestParameters.hotelId === null || requestParameters.hotelId === undefined) {
            ...
            return new runtime.JSONApiResponse(response, (jsonValue) => (0, index_1.VacantRoomStatusesListFromJSON)(jsonValue));
        });
    }
    /**
     * Use this API to retrieve vacant room status configuration. <p><strong>OperationId:</strong>getVacantRoomStatus</p> <p>This API allows a time span of <strong>90</strong> days.</p>
     * Get vacant room status configuration.
     */
    getVacantRoomStatus(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield this.getVacantRoomStatusRaw(requestParameters, initOverrides);
            return yield response.value();
        });
    }
    /**
     ...
     */
    postTemplateHousekeepingRoomScheduleRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const response = yield this.request({
                ...
                headers: headerParameters,
                query: queryParameters,
                body: (0, index_1.TemplateHousekeepingRoomSchedulesCriteriaToJSON)(requestParameters.templateHousekeepingRoomSchedulesCriteria),
            }, initOverrides);
            return new runtime.JSONApiResponse(response, (jsonValue) => (0, index_1.StatusFromJSON)(jsonValue));
        });
    }
     ...
     * Create housekeeping room schedules at template level
     */
    postTemplateHousekeepingRoomSchedule(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield this.postTemplateHousekeepingRoomScheduleRaw(requestParameters, initOverrides);
            return yield response.value();
        });
    }
    /**
     ...
     */
    postVacantRoomStatusRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            if (requestParameters.hotelId === null || requestParameters.hotelId === undefined) {
            ...
            const response = yield this.request({
                ...
                headers: headerParameters,
                query: queryParameters,
                body: (0, index_1.VacantRoomStatusDetailsToJSON)(requestParameters.vacantRoomStatusDetails),
            }, initOverrides);
            return new runtime.JSONApiResponse(response, (jsonValue) => (0, index_1.StatusFromJSON)(jsonValue));
        });
    }
     ...
     * Create vacant room status configuration.
     */
    postVacantRoomStatus(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield this.postVacantRoomStatusRaw(requestParameters, initOverrides);
            return yield response.value();
        });
    }
    /**
     ...
     */
    putVacantRoomStatusRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            if (requestParameters.hotelId === null || requestParameters.hotelId === undefined) {
     ...
     * Update the vacant room status configuration.
     */
    putVacantRoomStatus(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield this.putVacantRoomStatusRaw(requestParameters, initOverrides);
            return yield response.value();
        });
    }
    /**
     ...
     * Delete housekeeping room schedules
     */
    removeHousekeepingScheduleRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            if (requestParameters.sequenceId === null || requestParameters.sequenceId === undefined) {
     ...
     * Delete housekeeping room schedules
     */
    removeHousekeepingSchedule(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield this.removeHousekeepingScheduleRaw(requestParameters, initOverrides);
            return yield response.value();
        });
    }
    /**
