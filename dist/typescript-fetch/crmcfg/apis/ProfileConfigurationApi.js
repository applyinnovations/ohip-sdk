...
class ProfileConfigurationApi extends runtime.BaseAPI {
     ...
     *  clear cache
     */
    deleteProfileConfigServiceCacheRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            const queryParameters = {};
            const headerParameters = {};
            if (requestParameters.authorization !== undefined && requestParameters.authorization !== null) {
     ...
     *  clear cache
     */
    deleteProfileConfigServiceCache(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield this.deleteProfileConfigServiceCacheRaw(requestParameters, initOverrides);
            return yield response.value();
        });
    }
    /**
     ...
     *  ping
     */
    pingProfileConfigServiceRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            const queryParameters = {};
            const headerParameters = {};
            if (requestParameters.authorization !== undefined && requestParameters.authorization !== null) {
     ...
     *  ping
     */
    pingProfileConfigService(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield this.pingProfileConfigServiceRaw(requestParameters, initOverrides);
            return yield response.value();
        });
    }
    /**
