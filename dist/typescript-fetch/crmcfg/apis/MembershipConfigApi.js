...
class MembershipConfigApi extends runtime.BaseAPI {
     ...
     */
    deleteMembershipOriginGroupRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
     ...
     * Delete Membership origin group
     */
    deleteMembershipOriginGroup(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield this.deleteMembershipOriginGroupRaw(requestParameters, initOverrides);
            return yield response.value();
        });
    }
    /**
     ...
     */
    deleteMembershipRatesRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
     ...
     * Delete Membership rates
     */
    deleteMembershipRates(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield this.deleteMembershipRatesRaw(requestParameters, initOverrides);
            return yield response.value();
        });
    }
    /**
     ...
     */
    deleteMembershipSourceGroupRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
     ...
     * Delete Membership Source group
     */
    deleteMembershipSourceGroup(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield this.deleteMembershipSourceGroupRaw(requestParameters, initOverrides);
            return yield response.value();
        });
    }
    /**
     ...
     */
    getMembershipOriginGroupsRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            const queryParameters = {};
            if (requestParameters.codes) {
                queryParameters['codes'] = requestParameters.codes;
            ...
            return new runtime.JSONApiResponse(response, (jsonValue) => (0, index_1.MembershipOriginGroupsDetailsFromJSON)(jsonValue));
        });
    }
    /**
     * You can use this API to get Membership origin groups. <p><strong>OperationId:</strong>getMembershipOriginGroups</p>
     * Get Membership origin groups
     */
    getMembershipOriginGroups(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield this.getMembershipOriginGroupsRaw(requestParameters, initOverrides);
            return yield response.value();
        });
    }
    /**
     ...
     */
    getMembershipRatesRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            const queryParameters = {};
            if (requestParameters.hotelIds) {
                queryParameters['hotelIds'] = requestParameters.hotelIds;
            ...
            return new runtime.JSONApiResponse(response, (jsonValue) => (0, index_1.MembershipRatesInfoFromJSON)(jsonValue));
        });
    }
    /**
     * You can use this API to get Membership rates. <p><strong>OperationId:</strong>getMembershipRates</p>
     * Get Membership rates
     */
    getMembershipRates(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield this.getMembershipRatesRaw(requestParameters, initOverrides);
            return yield response.value();
        });
    }
    /**
     ...
     */
    getMembershipSourceGroupsRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            const queryParameters = {};
            if (requestParameters.codes) {
                queryParameters['codes'] = requestParameters.codes;
            ...
            return new runtime.JSONApiResponse(response, (jsonValue) => (0, index_1.MembershipSourceGroupsDetailsFromJSON)(jsonValue));
        });
    }
    /**
     * You can use this API to get Membership source groups. <p><strong>OperationId:</strong>getMembershipSourceGroups</p>
     * Get Membership source groups
     */
    getMembershipSourceGroups(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield this.getMembershipSourceGroupsRaw(requestParameters, initOverrides);
            return yield response.value();
        });
    }
    /**
     ...
     *  ping
     */
    pingMembershipConfigServiceRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            const queryParameters = {};
            const headerParameters = {};
            if (requestParameters.authorization !== undefined && requestParameters.authorization !== null) {
     ...
     *  ping
     */
    pingMembershipConfigService(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield this.pingMembershipConfigServiceRaw(requestParameters, initOverrides);
            return yield response.value();
        });
    }
    /**
     ...
     */
    postMembershipOriginGroupRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const response = yield this.request({
                ...
                headers: headerParameters,
                query: queryParameters,
                body: (0, index_1.MembershipOriginGroupDetailsToJSON)(requestParameters.membershipOriginGroup),
            }, initOverrides);
            return new runtime.JSONApiResponse(response, (jsonValue) => (0, index_1.StatusFromJSON)(jsonValue));
        });
    }
     ...
     * Create a Membership origin group
     */
    postMembershipOriginGroup(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield this.postMembershipOriginGroupRaw(requestParameters, initOverrides);
            return yield response.value();
        });
    }
    /**
     ...
     */
    postMembershipRatesRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const response = yield this.request({
                ...
                headers: headerParameters,
                query: queryParameters,
                body: (0, index_1.MembershipRatesToJSON)(requestParameters.membershipRates),
            }, initOverrides);
            return new runtime.JSONApiResponse(response, (jsonValue) => (0, index_1.StatusFromJSON)(jsonValue));
        });
    }
     ...
     * Create Membership rates
     */
    postMembershipRates(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield this.postMembershipRatesRaw(requestParameters, initOverrides);
            return yield response.value();
        });
    }
    /**
     ...
     */
    postMembershipSourceGroupRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const response = yield this.request({
                ...
                headers: headerParameters,
                query: queryParameters,
                body: (0, index_1.MembershipSourceGroupDetailsToJSON)(requestParameters.membershipSourceGroup),
            }, initOverrides);
            return new runtime.JSONApiResponse(response, (jsonValue) => (0, index_1.StatusFromJSON)(jsonValue));
        });
    }
     ...
     * Create a Membership source group
     */
    postMembershipSourceGroup(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield this.postMembershipSourceGroupRaw(requestParameters, initOverrides);
            return yield response.value();
        });
    }
    /**
     ...
     */
    putMembershipOriginGroupRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            if (requestParameters.membershipOriginGroupId === null || requestParameters.membershipOriginGroupId === undefined) {
     ...
     * Change Membership origin group
     */
    putMembershipOriginGroup(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield this.putMembershipOriginGroupRaw(requestParameters, initOverrides);
            return yield response.value();
        });
    }
    /**
     ...
     */
    putMembershipRatesRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            if (requestParameters.membershipRatesId === null || requestParameters.membershipRatesId === undefined) {
     ...
     * Change Membership rates
     */
    putMembershipRates(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield this.putMembershipRatesRaw(requestParameters, initOverrides);
            return yield response.value();
        });
    }
    /**
     ...
     */
    putMembershipSourceGroupRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            if (requestParameters.membershipSourceGroupId === null || requestParameters.membershipSourceGroupId === undefined) {
     ...
     * Change Membership source group
     */
    putMembershipSourceGroup(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield this.putMembershipSourceGroupRaw(requestParameters, initOverrides);
            return yield response.value();
        });
    }
    /**
