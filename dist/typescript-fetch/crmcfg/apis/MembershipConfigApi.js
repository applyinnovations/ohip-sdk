...
class MembershipConfigApi extends runtime.BaseAPI {
     ...
     *  clear cache
     */
    deleteMembershipConfigCacheRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            const queryParameters = {};
            const headerParameters = {};
            if (requestParameters.authorization !== undefined && requestParameters.authorization !== null) {
     ...
     *  clear cache
     */
    deleteMembershipConfigCache(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield this.deleteMembershipConfigCacheRaw(requestParameters, initOverrides);
            return yield response.value();
        });
    }
    /**
