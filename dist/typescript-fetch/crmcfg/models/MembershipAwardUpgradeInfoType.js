...
exports.MembershipAwardUpgradeInfoTypeToJSON = exports.MembershipAwardUpgradeInfoTypeFromJSONTyped = exports.MembershipAwardUpgradeInfoTypeFromJSON = exports.instanceOfMembershipAwardUpgradeInfoType = void 0;
 ...
 */
function instanceOfMembershipAwardUpgradeInfoType(value) {
    let isInstance = true;
    return isInstance;
}
exports.instanceOfMembershipAwardUpgradeInfoType = instanceOfMembershipAwardUpgradeInfoType;
function MembershipAwardUpgradeInfoTypeFromJSON(json) {
    return MembershipAwardUpgradeInfoTypeFromJSONTyped(json, false);
}
exports.MembershipAwardUpgradeInfoTypeFromJSON = MembershipAwardUpgradeInfoTypeFromJSON;
function MembershipAwardUpgradeInfoTypeFromJSONTyped(json, ignoreDiscriminator) {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        'basedOnRoomGroup': !(0, runtime_1.exists)(json, 'basedOnRoomGroup') ? undefined : json['basedOnRoomGroup'],
...
exports.MembershipAwardUpgradeInfoTypeFromJSONTyped = MembershipAwardUpgradeInfoTypeFromJSONTyped;
function MembershipAwardUpgradeInfoTypeToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
...
exports.MembershipAwardUpgradeInfoTypeToJSON = MembershipAwardUpgradeInfoTypeToJSON;
