 ...
 */
function instanceOfBusinessSegmentsCriteria(value) {
    let isInstance = true;
    return isInstance;
}
exports.instanceOfBusinessSegmentsCriteria = instanceOfBusinessSegmentsCriteria;
function BusinessSegmentsCriteriaFromJSON(json) {
    return BusinessSegmentsCriteriaFromJSONTyped(json, false);
}
exports.BusinessSegmentsCriteriaFromJSON = BusinessSegmentsCriteriaFromJSON;
function BusinessSegmentsCriteriaFromJSONTyped(json, ignoreDiscriminator) {
...
function BusinessSegmentsCriteriaToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
