 ...
 */
export function instanceOfChangeGuestStatusesRequest(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function ChangeGuestStatusesRequestFromJSON(json: any): ChangeGuestStatusesRequest {
    return ChangeGuestStatusesRequestFromJSONTyped(json, false);
}

export function ChangeGuestStatusesRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): ChangeGuestStatusesRequest {
...
export function ChangeGuestStatusesRequestToJSON(value?: ChangeGuestStatusesRequest | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
