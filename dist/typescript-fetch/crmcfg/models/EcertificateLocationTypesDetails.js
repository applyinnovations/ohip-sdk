 ...
 */
function instanceOfEcertificateLocationTypesDetails(value) {
    let isInstance = true;
    return isInstance;
}
exports.instanceOfEcertificateLocationTypesDetails = instanceOfEcertificateLocationTypesDetails;
function EcertificateLocationTypesDetailsFromJSON(json) {
    return EcertificateLocationTypesDetailsFromJSONTyped(json, false);
}
exports.EcertificateLocationTypesDetailsFromJSON = EcertificateLocationTypesDetailsFromJSON;
function EcertificateLocationTypesDetailsFromJSONTyped(json, ignoreDiscriminator) {
...
function EcertificateLocationTypesDetailsToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
