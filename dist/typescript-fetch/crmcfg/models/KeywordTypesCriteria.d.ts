 ...
 */
export declare function instanceOfKeywordTypesCriteria(value: object): boolean;
export declare function KeywordTypesCriteriaFromJSON(json: any): KeywordTypesCriteria;
export declare function KeywordTypesCriteriaFromJSONTyped(json: any, ignoreDiscriminator: boolean): KeywordTypesCriteria;
export declare function KeywordTypesCriteriaToJSON(value?: KeywordTypesCriteria | null): any;
