...
exports.EcertificateLocationTypesCriteriaToJSON = exports.EcertificateLocationTypesCriteriaFromJSONTyped = exports.EcertificateLocationTypesCriteriaFromJSON = exports.instanceOfEcertificateLocationTypesCriteria = void 0;
 ...
 */
function instanceOfEcertificateLocationTypesCriteria(value) {
    let isInstance = true;
    return isInstance;
}
exports.instanceOfEcertificateLocationTypesCriteria = instanceOfEcertificateLocationTypesCriteria;
function EcertificateLocationTypesCriteriaFromJSON(json) {
    return EcertificateLocationTypesCriteriaFromJSONTyped(json, false);
}
exports.EcertificateLocationTypesCriteriaFromJSON = EcertificateLocationTypesCriteriaFromJSON;
function EcertificateLocationTypesCriteriaFromJSONTyped(json, ignoreDiscriminator) {
...
exports.EcertificateLocationTypesCriteriaFromJSONTyped = EcertificateLocationTypesCriteriaFromJSONTyped;
function EcertificateLocationTypesCriteriaToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
...
exports.EcertificateLocationTypesCriteriaToJSON = EcertificateLocationTypesCriteriaToJSON;
