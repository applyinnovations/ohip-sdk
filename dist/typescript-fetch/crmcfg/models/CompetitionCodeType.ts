 ...
 * @export
 * @interface CompetitionCodeType
 */
export interface CompetitionCodeType {
    /**
     * Common Master unique code.
     * @type {string}
     * @memberof CompetitionCodeType
     */
    code?: string;
    /**
     * 
 ...
 */
export function instanceOfCompetitionCodeType(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function CompetitionCodeTypeFromJSON(json: any): CompetitionCodeType {
    return CompetitionCodeTypeFromJSONTyped(json, false);
}

export function CompetitionCodeTypeFromJSONTyped(json: any, ignoreDiscriminator: boolean): CompetitionCodeType {
...
export function CompetitionCodeTypeToJSON(value?: CompetitionCodeType | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
