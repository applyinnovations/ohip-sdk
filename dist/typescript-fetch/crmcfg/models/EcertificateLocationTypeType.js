...
exports.EcertificateLocationTypeTypeToJSON = exports.EcertificateLocationTypeTypeFromJSONTyped = exports.EcertificateLocationTypeTypeFromJSON = exports.instanceOfEcertificateLocationTypeType = void 0;
const runtime_1 = require("../runtime");
const ManagedByOptions_1 = require("./ManagedByOptions");
const TranslationTextType2000_1 = require("./TranslationTextType2000");
/**
 * Check if a given object implements the EcertificateLocationTypeType interface.
 */
function instanceOfEcertificateLocationTypeType(value) {
    let isInstance = true;
    return isInstance;
}
exports.instanceOfEcertificateLocationTypeType = instanceOfEcertificateLocationTypeType;
function EcertificateLocationTypeTypeFromJSON(json) {
    return EcertificateLocationTypeTypeFromJSONTyped(json, false);
}
exports.EcertificateLocationTypeTypeFromJSON = EcertificateLocationTypeTypeFromJSON;
function EcertificateLocationTypeTypeFromJSONTyped(json, ignoreDiscriminator) {
...
exports.EcertificateLocationTypeTypeFromJSONTyped = EcertificateLocationTypeTypeFromJSONTyped;
function EcertificateLocationTypeTypeToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
...
exports.EcertificateLocationTypeTypeToJSON = EcertificateLocationTypeTypeToJSON;
