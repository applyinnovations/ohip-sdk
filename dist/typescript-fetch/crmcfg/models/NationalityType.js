...
exports.NationalityTypeToJSON = exports.NationalityTypeFromJSONTyped = exports.NationalityTypeFromJSON = exports.instanceOfNationalityType = void 0;
 ...
 */
function instanceOfNationalityType(value) {
    let isInstance = true;
    return isInstance;
}
exports.instanceOfNationalityType = instanceOfNationalityType;
function NationalityTypeFromJSON(json) {
    return NationalityTypeFromJSONTyped(json, false);
}
exports.NationalityTypeFromJSON = NationalityTypeFromJSON;
function NationalityTypeFromJSONTyped(json, ignoreDiscriminator) {
...
exports.NationalityTypeFromJSONTyped = NationalityTypeFromJSONTyped;
function NationalityTypeToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
...
exports.NationalityTypeToJSON = NationalityTypeToJSON;
