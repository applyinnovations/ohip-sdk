 ...
 */
export declare function instanceOfOwnerTeamType(value: object): boolean;
export declare function OwnerTeamTypeFromJSON(json: any): OwnerTeamType;
export declare function OwnerTeamTypeFromJSONTyped(json: any, ignoreDiscriminator: boolean): OwnerTeamType;
export declare function OwnerTeamTypeToJSON(value?: OwnerTeamType | null): any;
