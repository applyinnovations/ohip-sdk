...
exports.ImmigrationStatusesDetailsToJSON = exports.ImmigrationStatusesDetailsFromJSONTyped = exports.ImmigrationStatusesDetailsFromJSON = exports.instanceOfImmigrationStatusesDetails = void 0;
 ...
 */
function instanceOfImmigrationStatusesDetails(value) {
    let isInstance = true;
    return isInstance;
}
exports.instanceOfImmigrationStatusesDetails = instanceOfImmigrationStatusesDetails;
function ImmigrationStatusesDetailsFromJSON(json) {
    return ImmigrationStatusesDetailsFromJSONTyped(json, false);
}
exports.ImmigrationStatusesDetailsFromJSON = ImmigrationStatusesDetailsFromJSON;
function ImmigrationStatusesDetailsFromJSONTyped(json, ignoreDiscriminator) {
...
exports.ImmigrationStatusesDetailsFromJSONTyped = ImmigrationStatusesDetailsFromJSONTyped;
function ImmigrationStatusesDetailsToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
...
exports.ImmigrationStatusesDetailsToJSON = ImmigrationStatusesDetailsToJSON;
