 ...
 */
function instanceOfKeywordTypesDetails(value) {
    let isInstance = true;
    return isInstance;
}
exports.instanceOfKeywordTypesDetails = instanceOfKeywordTypesDetails;
function KeywordTypesDetailsFromJSON(json) {
    return KeywordTypesDetailsFromJSONTyped(json, false);
}
exports.KeywordTypesDetailsFromJSON = KeywordTypesDetailsFromJSON;
function KeywordTypesDetailsFromJSONTyped(json, ignoreDiscriminator) {
...
function KeywordTypesDetailsToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
