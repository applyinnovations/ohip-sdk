...
exports.GenderTypeToJSON = exports.GenderTypeFromJSONTyped = exports.GenderTypeFromJSON = exports.instanceOfGenderType = void 0;
 ...
 */
function instanceOfGenderType(value) {
    let isInstance = true;
    return isInstance;
}
exports.instanceOfGenderType = instanceOfGenderType;
function GenderTypeFromJSON(json) {
    return GenderTypeFromJSONTyped(json, false);
}
exports.GenderTypeFromJSON = GenderTypeFromJSON;
function GenderTypeFromJSONTyped(json, ignoreDiscriminator) {
...
exports.GenderTypeFromJSONTyped = GenderTypeFromJSONTyped;
function GenderTypeToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
...
exports.GenderTypeToJSON = GenderTypeToJSON;
