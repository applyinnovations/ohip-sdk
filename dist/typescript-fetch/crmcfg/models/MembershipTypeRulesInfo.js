...
const MembershipTypeRulesSummariesType_1 = require("./MembershipTypeRulesSummariesType");
...
function MembershipTypeRulesInfoFromJSONTyped(json, ignoreDiscriminator) {
    ...
    return {
        ...
        'membershipTypeRules': !(0, runtime_1.exists)(json, 'membershipTypeRules') ? undefined : (0, MembershipTypeRulesSummariesType_1.MembershipTypeRulesSummariesTypeFromJSON)(json['membershipTypeRules']),
...
function MembershipTypeRulesInfoToJSON(value) {
    ...
    return {
        ...
        'membershipTypeRules': (0, MembershipTypeRulesSummariesType_1.MembershipTypeRulesSummariesTypeToJSON)(value.membershipTypeRules),
