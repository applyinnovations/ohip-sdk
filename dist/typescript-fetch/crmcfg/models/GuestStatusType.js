...
exports.GuestStatusTypeToJSON = exports.GuestStatusTypeFromJSONTyped = exports.GuestStatusTypeFromJSON = exports.instanceOfGuestStatusType = void 0;
 ...
 */
function instanceOfGuestStatusType(value) {
    let isInstance = true;
    return isInstance;
}
exports.instanceOfGuestStatusType = instanceOfGuestStatusType;
function GuestStatusTypeFromJSON(json) {
    return GuestStatusTypeFromJSONTyped(json, false);
}
exports.GuestStatusTypeFromJSON = GuestStatusTypeFromJSON;
function GuestStatusTypeFromJSONTyped(json, ignoreDiscriminator) {
...
exports.GuestStatusTypeFromJSONTyped = GuestStatusTypeFromJSONTyped;
function GuestStatusTypeToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
...
exports.GuestStatusTypeToJSON = GuestStatusTypeToJSON;
