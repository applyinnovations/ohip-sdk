 ...
 */
function instanceOfMembershipClaimOriginsToBeChanged(value) {
    let isInstance = true;
    return isInstance;
}
exports.instanceOfMembershipClaimOriginsToBeChanged = instanceOfMembershipClaimOriginsToBeChanged;
function MembershipClaimOriginsToBeChangedFromJSON(json) {
    return MembershipClaimOriginsToBeChangedFromJSONTyped(json, false);
}
exports.MembershipClaimOriginsToBeChangedFromJSON = MembershipClaimOriginsToBeChangedFromJSON;
function MembershipClaimOriginsToBeChangedFromJSONTyped(json, ignoreDiscriminator) {
...
function MembershipClaimOriginsToBeChangedToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
