...
exports.IndustryCodesDetailsToJSON = exports.IndustryCodesDetailsFromJSONTyped = exports.IndustryCodesDetailsFromJSON = exports.instanceOfIndustryCodesDetails = void 0;
 ...
 */
function instanceOfIndustryCodesDetails(value) {
    let isInstance = true;
    return isInstance;
}
exports.instanceOfIndustryCodesDetails = instanceOfIndustryCodesDetails;
function IndustryCodesDetailsFromJSON(json) {
    return IndustryCodesDetailsFromJSONTyped(json, false);
}
exports.IndustryCodesDetailsFromJSON = IndustryCodesDetailsFromJSON;
function IndustryCodesDetailsFromJSONTyped(json, ignoreDiscriminator) {
...
exports.IndustryCodesDetailsFromJSONTyped = IndustryCodesDetailsFromJSONTyped;
function IndustryCodesDetailsToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
...
exports.IndustryCodesDetailsToJSON = IndustryCodesDetailsToJSON;
