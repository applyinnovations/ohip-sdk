 ...
 */
export function instanceOfCreditRatingType(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function CreditRatingTypeFromJSON(json: any): CreditRatingType {
    return CreditRatingTypeFromJSONTyped(json, false);
}

export function CreditRatingTypeFromJSONTyped(json: any, ignoreDiscriminator: boolean): CreditRatingType {
...
export function CreditRatingTypeToJSON(value?: CreditRatingType | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
