 ...
 */
export function instanceOfPostMembershipFolioTextsRequest(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function PostMembershipFolioTextsRequestFromJSON(json: any): PostMembershipFolioTextsRequest {
    return PostMembershipFolioTextsRequestFromJSONTyped(json, false);
}

export function PostMembershipFolioTextsRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): PostMembershipFolioTextsRequest {
...
export function PostMembershipFolioTextsRequestToJSON(value?: PostMembershipFolioTextsRequest | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
