 ...
 */
export declare function instanceOfConfigCopyExclusivePreferencesType(value: object): boolean;
export declare function ConfigCopyExclusivePreferencesTypeFromJSON(json: any): ConfigCopyExclusivePreferencesType;
export declare function ConfigCopyExclusivePreferencesTypeFromJSONTyped(json: any, ignoreDiscriminator: boolean): ConfigCopyExclusivePreferencesType;
export declare function ConfigCopyExclusivePreferencesTypeToJSON(value?: ConfigCopyExclusivePreferencesType | null): any;
