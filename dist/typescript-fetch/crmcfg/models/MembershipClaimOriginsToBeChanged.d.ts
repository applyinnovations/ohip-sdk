 ...
 */
export declare function instanceOfMembershipClaimOriginsToBeChanged(value: object): boolean;
export declare function MembershipClaimOriginsToBeChangedFromJSON(json: any): MembershipClaimOriginsToBeChanged;
export declare function MembershipClaimOriginsToBeChangedFromJSONTyped(json: any, ignoreDiscriminator: boolean): MembershipClaimOriginsToBeChanged;
export declare function MembershipClaimOriginsToBeChangedToJSON(value?: MembershipClaimOriginsToBeChanged | null): any;
