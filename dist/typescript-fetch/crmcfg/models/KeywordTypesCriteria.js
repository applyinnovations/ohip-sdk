...
exports.KeywordTypesCriteriaToJSON = exports.KeywordTypesCriteriaFromJSONTyped = exports.KeywordTypesCriteriaFromJSON = exports.instanceOfKeywordTypesCriteria = void 0;
 ...
 */
function instanceOfKeywordTypesCriteria(value) {
    let isInstance = true;
    return isInstance;
}
exports.instanceOfKeywordTypesCriteria = instanceOfKeywordTypesCriteria;
function KeywordTypesCriteriaFromJSON(json) {
    return KeywordTypesCriteriaFromJSONTyped(json, false);
}
exports.KeywordTypesCriteriaFromJSON = KeywordTypesCriteriaFromJSON;
function KeywordTypesCriteriaFromJSONTyped(json, ignoreDiscriminator) {
...
exports.KeywordTypesCriteriaFromJSONTyped = KeywordTypesCriteriaFromJSONTyped;
function KeywordTypesCriteriaToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
...
exports.KeywordTypesCriteriaToJSON = KeywordTypesCriteriaToJSON;
