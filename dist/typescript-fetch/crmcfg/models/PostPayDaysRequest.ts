 ...
 */
export function instanceOfPostPayDaysRequest(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function PostPayDaysRequestFromJSON(json: any): PostPayDaysRequest {
    return PostPayDaysRequestFromJSONTyped(json, false);
}

export function PostPayDaysRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): PostPayDaysRequest {
...
export function PostPayDaysRequestToJSON(value?: PostPayDaysRequest | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
