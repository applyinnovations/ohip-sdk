 ...
 */
function instanceOfAddressFormats(value) {
    let isInstance = true;
    return isInstance;
}
exports.instanceOfAddressFormats = instanceOfAddressFormats;
function AddressFormatsFromJSON(json) {
    return AddressFormatsFromJSONTyped(json, false);
}
exports.AddressFormatsFromJSON = AddressFormatsFromJSON;
function AddressFormatsFromJSONTyped(json, ignoreDiscriminator) {
...
function AddressFormatsToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
