 ...
 */
function instanceOfMembershipClasses(value) {
    let isInstance = true;
    return isInstance;
}
exports.instanceOfMembershipClasses = instanceOfMembershipClasses;
function MembershipClassesFromJSON(json) {
    return MembershipClassesFromJSONTyped(json, false);
}
exports.MembershipClassesFromJSON = MembershipClassesFromJSON;
function MembershipClassesFromJSONTyped(json, ignoreDiscriminator) {
...
function MembershipClassesToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
