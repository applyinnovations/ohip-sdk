...
function MembershipTypeTypeFromJSONTyped(json, ignoreDiscriminator) {
    ...
    return {
        ...
        'cardNumberAutoGenerateDetailsForOWS': !(0, runtime_1.exists)(json, 'cardNumberAutoGenerateDetailsForOWS') ? undefined : (0, AutoGenerateCardNumberType_1.AutoGenerateCardNumberTypeFromJSON)(json['cardNumberAutoGenerateDetailsForOWS']),
...
function MembershipTypeTypeToJSON(value) {
    ...
    return {
        ...
        'cardNumberAutoGenerateDetailsForOWS': (0, AutoGenerateCardNumberType_1.AutoGenerateCardNumberTypeToJSON)(value.cardNumberAutoGenerateDetailsForOWS),
