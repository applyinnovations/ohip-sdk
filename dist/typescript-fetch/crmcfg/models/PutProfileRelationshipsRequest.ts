 ...
 */
export function instanceOfPutProfileRelationshipsRequest(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function PutProfileRelationshipsRequestFromJSON(json: any): PutProfileRelationshipsRequest {
    return PutProfileRelationshipsRequestFromJSONTyped(json, false);
}

export function PutProfileRelationshipsRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): PutProfileRelationshipsRequest {
...
export function PutProfileRelationshipsRequestToJSON(value?: PutProfileRelationshipsRequest | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
