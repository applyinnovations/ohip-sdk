 ...
 */
function instanceOfTemplateExclusivePreferences(value) {
    let isInstance = true;
    return isInstance;
}
exports.instanceOfTemplateExclusivePreferences = instanceOfTemplateExclusivePreferences;
function TemplateExclusivePreferencesFromJSON(json) {
    return TemplateExclusivePreferencesFromJSONTyped(json, false);
}
exports.TemplateExclusivePreferencesFromJSON = TemplateExclusivePreferencesFromJSON;
function TemplateExclusivePreferencesFromJSONTyped(json, ignoreDiscriminator) {
...
function TemplateExclusivePreferencesToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
