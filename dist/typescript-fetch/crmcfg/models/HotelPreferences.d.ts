 ...
 */
export declare function instanceOfHotelPreferences(value: object): boolean;
export declare function HotelPreferencesFromJSON(json: any): HotelPreferences;
export declare function HotelPreferencesFromJSONTyped(json: any, ignoreDiscriminator: boolean): HotelPreferences;
export declare function HotelPreferencesToJSON(value?: HotelPreferences | null): any;
