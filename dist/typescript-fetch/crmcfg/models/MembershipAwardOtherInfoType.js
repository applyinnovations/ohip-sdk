...
exports.MembershipAwardOtherInfoTypeToJSON = exports.MembershipAwardOtherInfoTypeFromJSONTyped = exports.MembershipAwardOtherInfoTypeFromJSON = exports.instanceOfMembershipAwardOtherInfoType = void 0;
const runtime_1 = require("../runtime");
/**
 * Check if a given object implements the MembershipAwardOtherInfoType interface.
 */
function instanceOfMembershipAwardOtherInfoType(value) {
    let isInstance = true;
    return isInstance;
}
exports.instanceOfMembershipAwardOtherInfoType = instanceOfMembershipAwardOtherInfoType;
function MembershipAwardOtherInfoTypeFromJSON(json) {
    return MembershipAwardOtherInfoTypeFromJSONTyped(json, false);
}
exports.MembershipAwardOtherInfoTypeFromJSON = MembershipAwardOtherInfoTypeFromJSON;
function MembershipAwardOtherInfoTypeFromJSONTyped(json, ignoreDiscriminator) {
...
exports.MembershipAwardOtherInfoTypeFromJSONTyped = MembershipAwardOtherInfoTypeFromJSONTyped;
function MembershipAwardOtherInfoTypeToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
...
exports.MembershipAwardOtherInfoTypeToJSON = MembershipAwardOtherInfoTypeToJSON;
