 ...
 */
function instanceOfMembershipPropertyGroupsInfo(value) {
    let isInstance = true;
    return isInstance;
}
exports.instanceOfMembershipPropertyGroupsInfo = instanceOfMembershipPropertyGroupsInfo;
function MembershipPropertyGroupsInfoFromJSON(json) {
    return MembershipPropertyGroupsInfoFromJSONTyped(json, false);
}
exports.MembershipPropertyGroupsInfoFromJSON = MembershipPropertyGroupsInfoFromJSON;
function MembershipPropertyGroupsInfoFromJSONTyped(json, ignoreDiscriminator) {
...
function MembershipPropertyGroupsInfoToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
