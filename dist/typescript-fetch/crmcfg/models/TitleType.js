...
exports.TitleTypeToJSON = exports.TitleTypeFromJSONTyped = exports.TitleTypeFromJSON = exports.instanceOfTitleType = void 0;
 ...
 */
function instanceOfTitleType(value) {
    let isInstance = true;
    return isInstance;
}
exports.instanceOfTitleType = instanceOfTitleType;
function TitleTypeFromJSON(json) {
    return TitleTypeFromJSONTyped(json, false);
}
exports.TitleTypeFromJSON = TitleTypeFromJSON;
function TitleTypeFromJSONTyped(json, ignoreDiscriminator) {
...
exports.TitleTypeFromJSONTyped = TitleTypeFromJSONTyped;
function TitleTypeToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
...
exports.TitleTypeToJSON = TitleTypeToJSON;
