 ...
 */
export declare function instanceOfDistrictsDetails(value: object): boolean;
export declare function DistrictsDetailsFromJSON(json: any): DistrictsDetails;
export declare function DistrictsDetailsFromJSONTyped(json: any, ignoreDiscriminator: boolean): DistrictsDetails;
export declare function DistrictsDetailsToJSON(value?: DistrictsDetails | null): any;
