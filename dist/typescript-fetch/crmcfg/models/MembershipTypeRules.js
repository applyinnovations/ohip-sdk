 ...
 */
function instanceOfMembershipTypeRules(value) {
    let isInstance = true;
    return isInstance;
}
exports.instanceOfMembershipTypeRules = instanceOfMembershipTypeRules;
function MembershipTypeRulesFromJSON(json) {
    return MembershipTypeRulesFromJSONTyped(json, false);
}
exports.MembershipTypeRulesFromJSON = MembershipTypeRulesFromJSON;
function MembershipTypeRulesFromJSONTyped(json, ignoreDiscriminator) {
...
function MembershipTypeRulesToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
