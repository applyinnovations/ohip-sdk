 ...
 * @export
 * @interface GuestTypeType
 */
export interface GuestTypeType {
    /**
     * Common Master unique code.
     * @type {string}
     * @memberof GuestTypeType
     */
    code?: string;
    /**
     * 
 ...
 */
export function instanceOfGuestTypeType(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function GuestTypeTypeFromJSON(json: any): GuestTypeType {
    return GuestTypeTypeFromJSONTyped(json, false);
}

export function GuestTypeTypeFromJSONTyped(json: any, ignoreDiscriminator: boolean): GuestTypeType {
...
export function GuestTypeTypeToJSON(value?: GuestTypeType | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
