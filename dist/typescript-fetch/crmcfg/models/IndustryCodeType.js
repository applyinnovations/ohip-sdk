...
exports.IndustryCodeTypeToJSON = exports.IndustryCodeTypeFromJSONTyped = exports.IndustryCodeTypeFromJSON = exports.instanceOfIndustryCodeType = void 0;
 ...
 */
function instanceOfIndustryCodeType(value) {
    let isInstance = true;
    return isInstance;
}
exports.instanceOfIndustryCodeType = instanceOfIndustryCodeType;
function IndustryCodeTypeFromJSON(json) {
    return IndustryCodeTypeFromJSONTyped(json, false);
}
exports.IndustryCodeTypeFromJSON = IndustryCodeTypeFromJSON;
function IndustryCodeTypeFromJSONTyped(json, ignoreDiscriminator) {
...
exports.IndustryCodeTypeFromJSONTyped = IndustryCodeTypeFromJSONTyped;
function IndustryCodeTypeToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
...
exports.IndustryCodeTypeToJSON = IndustryCodeTypeToJSON;
