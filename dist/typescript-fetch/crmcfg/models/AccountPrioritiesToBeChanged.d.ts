 ...
 */
export declare function instanceOfAccountPrioritiesToBeChanged(value: object): boolean;
export declare function AccountPrioritiesToBeChangedFromJSON(json: any): AccountPrioritiesToBeChanged;
export declare function AccountPrioritiesToBeChangedFromJSONTyped(json: any, ignoreDiscriminator: boolean): AccountPrioritiesToBeChanged;
export declare function AccountPrioritiesToBeChangedToJSON(value?: AccountPrioritiesToBeChanged | null): any;
