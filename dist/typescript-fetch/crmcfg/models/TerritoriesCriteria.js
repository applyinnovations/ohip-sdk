...
exports.TerritoriesCriteriaToJSON = exports.TerritoriesCriteriaFromJSONTyped = exports.TerritoriesCriteriaFromJSON = exports.instanceOfTerritoriesCriteria = void 0;
 ...
 */
function instanceOfTerritoriesCriteria(value) {
    let isInstance = true;
    return isInstance;
}
exports.instanceOfTerritoriesCriteria = instanceOfTerritoriesCriteria;
function TerritoriesCriteriaFromJSON(json) {
    return TerritoriesCriteriaFromJSONTyped(json, false);
}
exports.TerritoriesCriteriaFromJSON = TerritoriesCriteriaFromJSON;
function TerritoriesCriteriaFromJSONTyped(json, ignoreDiscriminator) {
...
exports.TerritoriesCriteriaFromJSONTyped = TerritoriesCriteriaFromJSONTyped;
function TerritoriesCriteriaToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
...
exports.TerritoriesCriteriaToJSON = TerritoriesCriteriaToJSON;
