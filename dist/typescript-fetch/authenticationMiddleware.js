...
exports.OhipCredentialsProvider = exports.GrantTypeEnum = void 0;
const oauth_1 = require("./oauth");
const MAX_MS = 10 * 1000;
const MAX_RETRIES = 7;
const TOKEN_EXPIRY_BUFFER = 300 * 1000;
var GrantTypeEnum;
(function (GrantTypeEnum) {
    GrantTypeEnum["password"] = "password";
    GrantTypeEnum["client_credentials"] = "client_credentials";
})(GrantTypeEnum || (exports.GrantTypeEnum = GrantTypeEnum = {}));
const delay = (ms) => new Promise((resolve) => {
    setTimeout(resolve, ms);
});
class OhipCredentialsProvider {
    constructor({ appKey, credentials, grantType, enterpriseId, scope, host, }) {
        this.last_working_credential_idx = 0;
        ...
        return __awaiter(this, void 0, void 0, function* () {
            if (this.grantType === GrantTypeEnum.client_credentials) {
                if (!this.enterpriseId) {
                    throw Error(`OHIP_AUTH_ERR: client_credentials grant type requires enterpriseId`);
                }
                if (!this.scope) {
                    throw Error(`OHIP_AUTH_ERR: client_credentials grant type requires scopes`);
                }
            }
            ...
            try {
                ...
                const credentials = this.credentials[credential_idx];
                try {
                    const res = yield this.ohip.getToken(Object.assign(Object.assign({ xAppKey: this.appKey, grantType: this.grantType }, (this.grantType === GrantTypeEnum.client_credentials && {
                        enterpriseId: this.enterpriseId,
                        scope: this.scope,
                    })), (this.grantType === GrantTypeEnum.password && credentials)), Object.assign({}, (this.grantType === GrantTypeEnum.client_credentials && credentials.username && credentials.password && {
                        headers: {
                    ...
                    if (res.accessToken
                        && res.expiresIn
                        && (yield this.setAccessToken(res.accessToken))) {
