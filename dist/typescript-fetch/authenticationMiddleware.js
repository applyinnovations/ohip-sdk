...
class OhipCredentialsProvider {
    constructor({ appKey, credentials, grantType, clientId, clientSecret, enterpriseId, scope, host, }) {
        ...
        if (grantType === GrantTypeEnum.client_credentials) {
            if (clientId) {
                throw Error(`OHIP_AUTH_ERR: client_credentials grant type requires clientId`);
            }
            if (clientSecret) {
                throw Error(`OHIP_AUTH_ERR: client_credentials grant type requires clientSecret`);
            }
