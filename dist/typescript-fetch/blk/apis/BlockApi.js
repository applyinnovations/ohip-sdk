...
class BlockApi extends runtime.BaseAPI {
     ...
     */
    blockChangesByDateTimeRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            if (requestParameters.hotelId === null || requestParameters.hotelId === undefined) {
                throw new runtime.RequiredError('hotelId', 'Required parameter requestParameters.hotelId was null or undefined when calling blockChangesByDateTime.');
            }
            if (requestParameters.startLastModifiedDate === null || requestParameters.startLastModifiedDate === undefined) {
                throw new runtime.RequiredError('startLastModifiedDate', 'Required parameter requestParameters.startLastModifiedDate was null or undefined when calling blockChangesByDateTime.');
            }
            const queryParameters = {};
            if (requestParameters.startLastModifiedDate !== undefined) {
                queryParameters['startLastModifiedDate'] = requestParameters.startLastModifiedDate;
            }
            if (requestParameters.endLastModifiedDate !== undefined) {
                queryParameters['endLastModifiedDate'] = requestParameters.endLastModifiedDate;
            }
            if (requestParameters.blockStatus) {
                queryParameters['blockStatus'] = requestParameters.blockStatus;
            }
            if (requestParameters.openForPickup !== undefined) {
                queryParameters['openForPickup'] = requestParameters.openForPickup;
            }
            if (requestParameters.cateringOnly !== undefined) {
                queryParameters['cateringOnly'] = requestParameters.cateringOnly;
            }
            if (requestParameters.includeEventChanges !== undefined) {
                queryParameters['includeEventChanges'] = requestParameters.includeEventChanges;
            }
            ...
            const response = yield this.request({
                path: `/hotels/{hotelId}/blocks/changesByDateTime`.replace(`{${"hotelId"}}`, encodeURIComponent(String(requestParameters.hotelId))),
                method: 'GET',
                headers: headerParameters,
                query: queryParameters,
            }, initOverrides);
            return new runtime.JSONApiResponse(response, (jsonValue) => (0, index_1.BlockChangesByDateTimeSummaryFromJSON)(jsonValue));
        });
    }
    /**
     * A user can search for blocks that have been created, updated and/or deleted within maximum 3 day date range. If in the time period searched a block was created and deleted, the query won\'t return this information. If a block is created and updated, the create information is returned. If a block is updated only, it returns the update. If a block is updated and delete, it returns the delete. <p>The maximum allowable limit for this API is <strong>1000</strong>.</p> <p>This API allows a time span of <strong>3</strong> days.</p>
     * Get modified blocks from a specific time period in OPERA.
     */
    blockChangesByDateTime(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield this.blockChangesByDateTimeRaw(requestParameters, initOverrides);
     ...
     */
    createPropertyLeadsRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            if (requestParameters.hotelId === null || requestParameters.hotelId === undefined) {
                throw new runtime.RequiredError('hotelId', 'Required parameter requestParameters.hotelId was null or undefined when calling createPropertyLeads.');
            }
            if (requestParameters.leadId === null || requestParameters.leadId === undefined) {
                throw new runtime.RequiredError('leadId', 'Required parameter requestParameters.leadId was null or undefined when calling createPropertyLeads.');
            }
            if (requestParameters.propertyLeads === null || requestParameters.propertyLeads === undefined) {
                throw new runtime.RequiredError('propertyLeads', 'Required parameter requestParameters.propertyLeads was null or undefined when calling createPropertyLeads.');
            }
            const queryParameters = {};
            const headerParameters = {};
            headerParameters['Content-Type'] = 'application/json;charset=UTF-8';
            ...
            const response = yield this.request({
                path: `/hotels/{hotelId}/leads/{leadId}/propertyLeads`.replace(`{${"hotelId"}}`, encodeURIComponent(String(requestParameters.hotelId))).replace(`{${"leadId"}}`, encodeURIComponent(String(requestParameters.leadId))),
                method: 'POST',
                headers: headerParameters,
                query: queryParameters,
                body: (0, index_1.PropertyLeadsTypeToJSON)(requestParameters.propertyLeads),
            }, initOverrides);
     ...
     * Use this API to create Property Leads
     */
    createPropertyLeads(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield this.createPropertyLeadsRaw(requestParameters, initOverrides);
            return yield response.value();
        });
    }
    /**
     ...
     */
    deleteBlockWashScheduleRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            if (requestParameters.blockId === null || requestParameters.blockId === undefined) {
                throw new runtime.RequiredError('blockId', 'Required parameter requestParameters.blockId was null or undefined when calling deleteBlockWashSchedule.');
            }
            if (requestParameters.hotelId === null || requestParameters.hotelId === undefined) {
                throw new runtime.RequiredError('hotelId', 'Required parameter requestParameters.hotelId was null or undefined when calling deleteBlockWashSchedule.');
            }
            const queryParameters = {};
            if (requestParameters.washDate !== undefined) {
                queryParameters['washDate'] = requestParameters.washDate;
            }
            const headerParameters = {};
            if (requestParameters.authorization !== undefined && requestParameters.authorization !== null) {
                headerParameters['authorization'] = String(requestParameters.authorization);
            ...
            const response = yield this.request({
                path: `/hotels/{hotelId}/blocks/{blockId}/washSchedules`.replace(`{${"blockId"}}`, encodeURIComponent(String(requestParameters.blockId))).replace(`{${"hotelId"}}`, encodeURIComponent(String(requestParameters.hotelId))),
                method: 'DELETE',
                headers: headerParameters,
                query: queryParameters,
            }, initOverrides);
     ...
     * Remove Block Wash Schedule
     */
    deleteBlockWashSchedule(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield this.deleteBlockWashScheduleRaw(requestParameters, initOverrides);
            return yield response.value();
        });
    }
    /**
    ...
    getBlockAvailabilityRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (requestParameters.detailedAvailability !== undefined) {
                queryParameters['detailedAvailability'] = requestParameters.detailedAvailability;
            }
            const headerParameters = {};
            if (requestParameters.authorization !== undefined && requestParameters.authorization !== null) {
                headerParameters['authorization'] = String(requestParameters.authorization);
     ...
     */
    getBlockRoomRateGridRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            if (requestParameters.blockId === null || requestParameters.blockId === undefined) {
                throw new runtime.RequiredError('blockId', 'Required parameter requestParameters.blockId was null or undefined when calling getBlockRoomRateGrid.');
            }
            if (requestParameters.hotelId === null || requestParameters.hotelId === undefined) {
                throw new runtime.RequiredError('hotelId', 'Required parameter requestParameters.hotelId was null or undefined when calling getBlockRoomRateGrid.');
            }
            const queryParameters = {};
            if (requestParameters.fetchAllocatedRoomTypes !== undefined) {
                queryParameters['fetchAllocatedRoomTypes'] = requestParameters.fetchAllocatedRoomTypes;
            ...
            const response = yield this.request({
                path: `/hotels/{hotelId}/blocks/{blockId}/roomRateGrid`.replace(`{${"blockId"}}`, encodeURIComponent(String(requestParameters.blockId))).replace(`{${"hotelId"}}`, encodeURIComponent(String(requestParameters.hotelId))),
                method: 'GET',
                headers: headerParameters,
                query: queryParameters,
            }, initOverrides);
            return new runtime.JSONApiResponse(response, (jsonValue) => (0, index_1.BlockGridTypeFromJSON)(jsonValue));
        });
    }
    /**
     * Use this API to retrieve grid details for a specific block. The response will include detailed information about the block grid and response can be paginated for blocks with longer date range.. <p><strong>OperationId:</strong>getBlockRoomRateGrid</p>
     * Operation to get room rate grid for a Block and supports pagination.
     */
    getBlockRoomRateGrid(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield this.getBlockRoomRateGridRaw(requestParameters, initOverrides);
            return yield response.value();
        });
    }
    /**
    ...
    getBlocksRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (requestParameters.reservationMethod) {
                queryParameters['reservationMethod'] = requestParameters.reservationMethod;
            }
    ...
    getInventoryToBorrowRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (requestParameters.overrideRestriction !== undefined) {
                queryParameters['overrideRestriction'] = requestParameters.overrideRestriction;
            }
            const headerParameters = {};
            if (requestParameters.authorization !== undefined && requestParameters.authorization !== null) {
                headerParameters['authorization'] = String(requestParameters.authorization);
     ...
     */
    postDefaultBlockCodeRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            if (requestParameters.blockDetails === null || requestParameters.blockDetails === undefined) {
                throw new runtime.RequiredError('blockDetails', 'Required parameter requestParameters.blockDetails was null or undefined when calling postDefaultBlockCode.');
            }
            const queryParameters = {};
            const headerParameters = {};
            headerParameters['Content-Type'] = 'application/json;charset=UTF-8';
            ...
            const response = yield this.request({
                ...
                headers: headerParameters,
                query: queryParameters,
                body: (0, index_1.BlockBasicInfosToJSON)(requestParameters.blockDetails),
            }, initOverrides);
            return new runtime.JSONApiResponse(response, (jsonValue) => (0, index_1.BlockBasicInfosFromJSON)(jsonValue));
        });
    }
    /**
     * Use this API to retrieve a list of default block code for Multiple blocks based on template. <p><strong>OperationId:</strong>getDefaultBlockCode</p>>
     * Create default Block Code for Multiple blocks
     */
    postDefaultBlockCode(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield this.postDefaultBlockCodeRaw(requestParameters, initOverrides);
            return yield response.value();
        });
    }
    /**
     ...
     */
    putCateringRevenueRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            if (requestParameters.hotelId === null || requestParameters.hotelId === undefined) {
                throw new runtime.RequiredError('hotelId', 'Required parameter requestParameters.hotelId was null or undefined when calling putCateringRevenue.');
            }
            if (requestParameters.blockId === null || requestParameters.blockId === undefined) {
                throw new runtime.RequiredError('blockId', 'Required parameter requestParameters.blockId was null or undefined when calling putCateringRevenue.');
            }
            if (requestParameters.cateringRevenueToChange === null || requestParameters.cateringRevenueToChange === undefined) {
                throw new runtime.RequiredError('cateringRevenueToChange', 'Required parameter requestParameters.cateringRevenueToChange was null or undefined when calling putCateringRevenue.');
            }
            const queryParameters = {};
            const headerParameters = {};
            headerParameters['Content-Type'] = 'application/json;charset=UTF-8';
            ...
            const response = yield this.request({
                path: `/hotels/{hotelId}/blocks/{blockId}/cateringRevenue`.replace(`{${"hotelId"}}`, encodeURIComponent(String(requestParameters.hotelId))).replace(`{${"blockId"}}`, encodeURIComponent(String(requestParameters.blockId))),
                method: 'PUT',
                headers: headerParameters,
                query: queryParameters,
                body: (0, index_1.CateringRevenueToChangeToJSON)(requestParameters.cateringRevenueToChange),
            }, initOverrides);
            return new runtime.JSONApiResponse(response, (jsonValue) => (0, index_1.StatusFromJSON)(jsonValue));
        });
    }
     ...
     * Recalculate Catering Revenue
     */
    putCateringRevenue(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield this.putCateringRevenueRaw(requestParameters, initOverrides);
            return yield response.value();
        });
    }
    /**
     ...
     */
    putRegularToMasterBlockRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            if (requestParameters.hotelId === null || requestParameters.hotelId === undefined) {
                throw new runtime.RequiredError('hotelId', 'Required parameter requestParameters.hotelId was null or undefined when calling putRegularToMasterBlock.');
            }
            if (requestParameters.blockId === null || requestParameters.blockId === undefined) {
                throw new runtime.RequiredError('blockId', 'Required parameter requestParameters.blockId was null or undefined when calling putRegularToMasterBlock.');
            }
            if (requestParameters.masterBlockCode === null || requestParameters.masterBlockCode === undefined) {
                throw new runtime.RequiredError('masterBlockCode', 'Required parameter requestParameters.masterBlockCode was null or undefined when calling putRegularToMasterBlock.');
            }
            const queryParameters = {};
            const headerParameters = {};
            if (requestParameters.authorization !== undefined && requestParameters.authorization !== null) {
            ...
            const response = yield this.request({
                path: `/hotels/{hotelId}/blocks/{blockId}/regularToMasterBlock/{masterBlockCode}`.replace(`{${"hotelId"}}`, encodeURIComponent(String(requestParameters.hotelId))).replace(`{${"blockId"}}`, encodeURIComponent(String(requestParameters.blockId))).replace(`{${"masterBlockCode"}}`, encodeURIComponent(String(requestParameters.masterBlockCode))),
                method: 'PUT',
                headers: headerParameters,
                query: queryParameters,
            }, initOverrides);
     ...
     * Use this API to convert a regular block to a master block
     */
    putRegularToMasterBlock(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield this.putRegularToMasterBlockRaw(requestParameters, initOverrides);
            return yield response.value();
        });
    }
    /**
     ...
     */
    putSubBlockToRegularRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            if (requestParameters.hotelId === null || requestParameters.hotelId === undefined) {
                throw new runtime.RequiredError('hotelId', 'Required parameter requestParameters.hotelId was null or undefined when calling putSubBlockToRegular.');
            }
            if (requestParameters.blockId === null || requestParameters.blockId === undefined) {
                throw new runtime.RequiredError('blockId', 'Required parameter requestParameters.blockId was null or undefined when calling putSubBlockToRegular.');
            }
            const queryParameters = {};
            const headerParameters = {};
            if (requestParameters.authorization !== undefined && requestParameters.authorization !== null) {
            ...
            const response = yield this.request({
                path: `/hotels/{hotelId}/blocks/{blockId}/subBlockToRegular`.replace(`{${"hotelId"}}`, encodeURIComponent(String(requestParameters.hotelId))).replace(`{${"blockId"}}`, encodeURIComponent(String(requestParameters.blockId))),
                method: 'PUT',
                headers: headerParameters,
                query: queryParameters,
            }, initOverrides);
     ...
     * Use this API to convert a sub block to a regular block
     */
    putSubBlockToRegular(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield this.putSubBlockToRegularRaw(requestParameters, initOverrides);
            return yield response.value();
        });
    }
    /**
 ...
 * @export
 */
exports.BlockChangesByDateTimeBlockStatusEnum = {
    Inquiry: 'INQUIRY',
    Nondeduct: 'NONDEDUCT',
    Deduct: 'DEDUCT',
    Actual: 'ACTUAL',
 ...
 * @export
 */
exports.GetBlockRoomRateGridRoomAllocationCriteriaEnum = {
    Initial: 'Initial',
    Actual: 'Actual',
    Rates: 'Rates',
    Pickup: 'Pickup',
...
exports.GetBlocksFetchInstructionsEnum = {
    ...
    Traces: 'Traces',
    WashSchedules: 'WashSchedules',
    IncludeSubBlocks: 'IncludeSubBlocks'
};
/**
 * @export
 */
