 ...
 */
function instanceOfBlockInstructionType(value) {
    let isInstance = true;
    return isInstance;
}
exports.instanceOfBlockInstructionType = instanceOfBlockInstructionType;
function BlockInstructionTypeFromJSON(json) {
    return BlockInstructionTypeFromJSONTyped(json, false);
}
exports.BlockInstructionTypeFromJSON = BlockInstructionTypeFromJSON;
function BlockInstructionTypeFromJSONTyped(json, ignoreDiscriminator) {
    ...
    return {
        ...
        'responseInstructions': !(0, runtime_1.exists)(json, 'responseInstructions') ? undefined : (0, BlockInstructionTypeResponseInstructions_1.BlockInstructionTypeResponseInstructionsFromJSON)(json['responseInstructions']),
    };
}
exports.BlockInstructionTypeFromJSONTyped = BlockInstructionTypeFromJSONTyped;
function BlockInstructionTypeToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'responseInstructions': (0, BlockInstructionTypeResponseInstructions_1.BlockInstructionTypeResponseInstructionsToJSON)(value.responseInstructions),
    };
}
