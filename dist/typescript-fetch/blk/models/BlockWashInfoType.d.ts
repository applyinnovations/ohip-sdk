 ...
 */
export declare function instanceOfBlockWashInfoType(value: object): boolean;
export declare function BlockWashInfoTypeFromJSON(json: any): BlockWashInfoType;
export declare function BlockWashInfoTypeFromJSONTyped(json: any, ignoreDiscriminator: boolean): BlockWashInfoType;
export declare function BlockWashInfoTypeToJSON(value?: BlockWashInfoType | null): any;
