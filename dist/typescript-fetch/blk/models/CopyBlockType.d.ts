 ...
 */
export declare function instanceOfCopyBlockType(value: object): boolean;
export declare function CopyBlockTypeFromJSON(json: any): CopyBlockType;
export declare function CopyBlockTypeFromJSONTyped(json: any, ignoreDiscriminator: boolean): CopyBlockType;
export declare function CopyBlockTypeToJSON(value?: CopyBlockType | null): any;
