...
function CopyBlockTypeCopyInstructionsFromJSONTyped(json, ignoreDiscriminator) {
    ...
    return {
        ...
        'masterBlock': !(0, runtime_1.exists)(json, 'masterBlock') ? undefined : json['masterBlock'],
        'copySubBlockAsRegularBlock': !(0, runtime_1.exists)(json, 'copySubBlockAsRegularBlock') ? undefined : json['copySubBlockAsRegularBlock'],
    };
}
