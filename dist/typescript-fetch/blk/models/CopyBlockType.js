...
const CopySubBlockDetail_1 = require("./CopySubBlockDetail");
...
function CopyBlockTypeFromJSONTyped(json, ignoreDiscriminator) {
    ...
    return {
        ...
        'subBlocks': !(0, runtime_1.exists)(json, 'subBlocks') ? undefined : (json['subBlocks'].map(CopySubBlockDetail_1.CopySubBlockDetailFromJSON)),
...
function CopyBlockTypeToJSON(value) {
    ...
    return {
        ...
        'subBlocks': value.subBlocks === undefined ? undefined : (value.subBlocks.map(CopySubBlockDetail_1.CopySubBlockDetailToJSON)),
