...
function TourSeriesTypeTourInstructionsFromJSONTyped(json, ignoreDiscriminator) {
    ...
    return {
        ...
        'eventChangeNotes': !(0, runtime_1.exists)(json, 'eventChangeNotes') ? undefined : json['eventChangeNotes'],
        'copyEventAttendees': !(0, runtime_1.exists)(json, 'copyEventAttendees') ? undefined : json['copyEventAttendees'],
        'attendees': !(0, runtime_1.exists)(json, 'attendees') ? undefined : json['attendees'],
        'copyResourcePrice': !(0, runtime_1.exists)(json, 'copyResourcePrice') ? undefined : json['copyResourcePrice'],
    };
}
