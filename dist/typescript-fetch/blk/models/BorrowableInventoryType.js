 ...
 */
function instanceOfBorrowableInventoryType(value) {
    let isInstance = true;
    return isInstance;
}
exports.instanceOfBorrowableInventoryType = instanceOfBorrowableInventoryType;
function BorrowableInventoryTypeFromJSON(json) {
    return BorrowableInventoryTypeFromJSONTyped(json, false);
}
exports.BorrowableInventoryTypeFromJSON = BorrowableInventoryTypeFromJSON;
function BorrowableInventoryTypeFromJSONTyped(json, ignoreDiscriminator) {
...
function BorrowableInventoryTypeToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
