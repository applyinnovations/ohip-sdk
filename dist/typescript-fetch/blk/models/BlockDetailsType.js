...
function BlockDetailsTypeFromJSONTyped(json, ignoreDiscriminator) {
    ...
    return {
        ...
        'isCentralSalesLead': !(0, runtime_1.exists)(json, 'isCentralSalesLead') ? undefined : json['isCentralSalesLead'],
        'centralSalesLeadResort': !(0, runtime_1.exists)(json, 'centralSalesLeadResort') ? undefined : json['centralSalesLeadResort'],
        'centralSalesLeadId': !(0, runtime_1.exists)(json, 'centralSalesLeadId') ? undefined : json['centralSalesLeadId'],
        ...
        'autoloadForecastGrid': !(0, runtime_1.exists)(json, 'autoloadForecastGrid') ? undefined : json['autoloadForecastGrid'],
        'allowRateOverride': !(0, runtime_1.exists)(json, 'allowRateOverride') ? undefined : json['allowRateOverride'],
        'hasLinkedActivities': !(0, runtime_1.exists)(json, 'hasLinkedActivities') ? undefined : json['hasLinkedActivities'],
