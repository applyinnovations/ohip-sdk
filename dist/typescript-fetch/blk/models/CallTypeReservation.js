 ...
 */
function instanceOfCallTypeReservation(value) {
    let isInstance = true;
    return isInstance;
}
exports.instanceOfCallTypeReservation = instanceOfCallTypeReservation;
function CallTypeReservationFromJSON(json) {
    return CallTypeReservationFromJSONTyped(json, false);
}
exports.CallTypeReservationFromJSON = CallTypeReservationFromJSON;
function CallTypeReservationFromJSONTyped(json, ignoreDiscriminator) {
...
function CallTypeReservationToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
