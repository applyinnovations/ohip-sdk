 ...
 */
export declare function instanceOfChangedBlockReservations(value: object): boolean;
export declare function ChangedBlockReservationsFromJSON(json: any): ChangedBlockReservations;
export declare function ChangedBlockReservationsFromJSONTyped(json: any, ignoreDiscriminator: boolean): ChangedBlockReservations;
export declare function ChangedBlockReservationsToJSON(value?: ChangedBlockReservations | null): any;
