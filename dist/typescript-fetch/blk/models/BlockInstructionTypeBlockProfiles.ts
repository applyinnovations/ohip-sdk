 ...
 */
export function instanceOfBlockInstructionTypeBlockProfiles(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function BlockInstructionTypeBlockProfilesFromJSON(json: any): BlockInstructionTypeBlockProfiles {
    return BlockInstructionTypeBlockProfilesFromJSONTyped(json, false);
}

export function BlockInstructionTypeBlockProfilesFromJSONTyped(json: any, ignoreDiscriminator: boolean): BlockInstructionTypeBlockProfiles {
...
export function BlockInstructionTypeBlockProfilesToJSON(value?: BlockInstructionTypeBlockProfiles | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
