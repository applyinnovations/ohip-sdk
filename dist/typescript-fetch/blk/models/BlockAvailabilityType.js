...
const BlockTotalAvailabilityInfoType_1 = require("./BlockTotalAvailabilityInfoType");
/**
...
function BlockAvailabilityTypeFromJSONTyped(json, ignoreDiscriminator) {
    ...
    return {
        ...
        'blockTotalAvailability': !(0, runtime_1.exists)(json, 'blockTotalAvailability') ? undefined : (0, BlockTotalAvailabilityInfoType_1.BlockTotalAvailabilityInfoTypeFromJSON)(json['blockTotalAvailability']),
        'blockTotalAvailabilityRooms': !(0, runtime_1.exists)(json, 'blockTotalAvailabilityRooms') ? undefined : (0, BlockTotalAvailabilityInfoType_1.BlockTotalAvailabilityInfoTypeFromJSON)(json['blockTotalAvailabilityRooms']),
    };
}
...
function BlockAvailabilityTypeToJSON(value) {
    ...
    return {
        ...
        'blockTotalAvailability': (0, BlockTotalAvailabilityInfoType_1.BlockTotalAvailabilityInfoTypeToJSON)(value.blockTotalAvailability),
        'blockTotalAvailabilityRooms': (0, BlockTotalAvailabilityInfoType_1.BlockTotalAvailabilityInfoTypeToJSON)(value.blockTotalAvailabilityRooms),
    };
}
