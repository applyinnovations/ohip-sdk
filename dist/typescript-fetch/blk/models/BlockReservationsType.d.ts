 ...
 */
export declare function instanceOfBlockReservationsType(value: object): boolean;
export declare function BlockReservationsTypeFromJSON(json: any): BlockReservationsType;
export declare function BlockReservationsTypeFromJSONTyped(json: any, ignoreDiscriminator: boolean): BlockReservationsType;
export declare function BlockReservationsTypeToJSON(value?: BlockReservationsType | null): any;
