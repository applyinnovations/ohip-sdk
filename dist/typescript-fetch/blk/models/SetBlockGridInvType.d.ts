 ...
 */
export declare function instanceOfSetBlockGridInvType(value: object): boolean;
export declare function SetBlockGridInvTypeFromJSON(json: any): SetBlockGridInvType;
export declare function SetBlockGridInvTypeFromJSONTyped(json: any, ignoreDiscriminator: boolean): SetBlockGridInvType;
export declare function SetBlockGridInvTypeToJSON(value?: SetBlockGridInvType | null): any;
