 ...
 */
export declare function instanceOfBlockAvailabilityRatePlanInfo(value: object): boolean;
export declare function BlockAvailabilityRatePlanInfoFromJSON(json: any): BlockAvailabilityRatePlanInfo;
export declare function BlockAvailabilityRatePlanInfoFromJSONTyped(json: any, ignoreDiscriminator: boolean): BlockAvailabilityRatePlanInfo;
export declare function BlockAvailabilityRatePlanInfoToJSON(value?: BlockAvailabilityRatePlanInfo | null): any;
