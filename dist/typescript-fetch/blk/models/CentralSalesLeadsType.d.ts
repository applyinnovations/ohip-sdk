 ...
 */
export declare function instanceOfCentralSalesLeadsType(value: object): boolean;
export declare function CentralSalesLeadsTypeFromJSON(json: any): CentralSalesLeadsType;
export declare function CentralSalesLeadsTypeFromJSONTyped(json: any, ignoreDiscriminator: boolean): CentralSalesLeadsType;
export declare function CentralSalesLeadsTypeToJSON(value?: CentralSalesLeadsType | null): any;
