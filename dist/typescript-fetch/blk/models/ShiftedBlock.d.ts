 ...
 */
export declare function instanceOfShiftedBlock(value: object): boolean;
export declare function ShiftedBlockFromJSON(json: any): ShiftedBlock;
export declare function ShiftedBlockFromJSONTyped(json: any, ignoreDiscriminator: boolean): ShiftedBlock;
export declare function ShiftedBlockToJSON(value?: ShiftedBlock | null): any;
