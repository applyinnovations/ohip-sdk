 ...
 */
export declare function instanceOfSalesAllowanceType(value: object): boolean;
export declare function SalesAllowanceTypeFromJSON(json: any): SalesAllowanceType;
export declare function SalesAllowanceTypeFromJSONTyped(json: any, ignoreDiscriminator: boolean): SalesAllowanceType;
export declare function SalesAllowanceTypeToJSON(value?: SalesAllowanceType | null): any;
