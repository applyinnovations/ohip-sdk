 ...
 */
function instanceOfMasterBlockInfoType(value) {
    let isInstance = true;
    return isInstance;
}
exports.instanceOfMasterBlockInfoType = instanceOfMasterBlockInfoType;
function MasterBlockInfoTypeFromJSON(json) {
    return MasterBlockInfoTypeFromJSONTyped(json, false);
}
exports.MasterBlockInfoTypeFromJSON = MasterBlockInfoTypeFromJSON;
function MasterBlockInfoTypeFromJSONTyped(json, ignoreDiscriminator) {
...
exports.MasterBlockInfoTypeFromJSONTyped = MasterBlockInfoTypeFromJSONTyped;
function MasterBlockInfoTypeToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
...
exports.MasterBlockInfoTypeToJSON = MasterBlockInfoTypeToJSON;
