 ...
 */
/**
 * The tag and respective room type for which minimum rate is returned.
 * @export
 * @interface RoomTagType
 */
export interface RoomTagType {
    /**
     * List of Room Type codes
     * @type {Array<string>}
     * @memberof RoomTagType
     */
 ...
 */
export declare function instanceOfRoomTagType(value: object): boolean;
export declare function RoomTagTypeFromJSON(json: any): RoomTagType;
export declare function RoomTagTypeFromJSONTyped(json: any, ignoreDiscriminator: boolean): RoomTagType;
export declare function RoomTagTypeToJSON(value?: RoomTagType | null): any;
