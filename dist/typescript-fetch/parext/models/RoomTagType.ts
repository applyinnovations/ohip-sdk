 ...
 */
export function instanceOfRoomTagType(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function RoomTagTypeFromJSON(json: any): RoomTagType {
    return RoomTagTypeFromJSONTyped(json, false);
}

export function RoomTagTypeFromJSONTyped(json: any, ignoreDiscriminator: boolean): RoomTagType {
...
export function RoomTagTypeToJSON(value?: RoomTagType | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
