...
exports.SortByTypeToJSON = exports.SortByTypeFromJSONTyped = exports.SortByTypeFromJSON = exports.SortByType = void 0;
/**
...
function SortByTypeFromJSON(json) {
    return SortByTypeFromJSONTyped(json, false);
}
exports.SortByTypeFromJSON = SortByTypeFromJSON;
function SortByTypeFromJSONTyped(json, ignoreDiscriminator) {
    return json;
}
exports.SortByTypeFromJSONTyped = SortByTypeFromJSONTyped;
function SortByTypeToJSON(value) {
    return value;
}
exports.SortByTypeToJSON = SortByTypeToJSON;
