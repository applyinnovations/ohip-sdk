...
export declare function SortByTypeFromJSON(json: any): SortByType;
export declare function SortByTypeFromJSONTyped(json: any, ignoreDiscriminator: boolean): SortByType;
export declare function SortByTypeToJSON(value?: SortByType | null): any;
