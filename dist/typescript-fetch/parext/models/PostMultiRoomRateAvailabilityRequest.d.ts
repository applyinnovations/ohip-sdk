 ...
 */
export declare function instanceOfPostMultiRoomRateAvailabilityRequest(value: object): boolean;
export declare function PostMultiRoomRateAvailabilityRequestFromJSON(json: any): PostMultiRoomRateAvailabilityRequest;
export declare function PostMultiRoomRateAvailabilityRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): PostMultiRoomRateAvailabilityRequest;
export declare function PostMultiRoomRateAvailabilityRequestToJSON(value?: PostMultiRoomRateAvailabilityRequest | null): any;
