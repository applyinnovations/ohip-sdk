...
exports.HotelAvailabilityStatusToJSON = exports.HotelAvailabilityStatusFromJSONTyped = exports.HotelAvailabilityStatusFromJSON = exports.HotelAvailabilityStatus = void 0;
/**
 * Availability status of the hotel
 * @export
 */
exports.HotelAvailabilityStatus = {
    AvailableForSale: 'AvailableForSale',
    NoAvailability: 'NoAvailability',
    NotFound: 'NotFound',
    OtherAvailable: 'OtherAvailable'
};
function HotelAvailabilityStatusFromJSON(json) {
    return HotelAvailabilityStatusFromJSONTyped(json, false);
}
exports.HotelAvailabilityStatusFromJSON = HotelAvailabilityStatusFromJSON;
function HotelAvailabilityStatusFromJSONTyped(json, ignoreDiscriminator) {
    return json;
}
exports.HotelAvailabilityStatusFromJSONTyped = HotelAvailabilityStatusFromJSONTyped;
function HotelAvailabilityStatusToJSON(value) {
    return value;
}
exports.HotelAvailabilityStatusToJSON = HotelAvailabilityStatusToJSON;
