 ...
 */
export declare function instanceOfShopBaseRequest(value: object): boolean;
export declare function ShopBaseRequestFromJSON(json: any): ShopBaseRequest;
export declare function ShopBaseRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): ShopBaseRequest;
export declare function ShopBaseRequestToJSON(value?: ShopBaseRequest | null): any;
