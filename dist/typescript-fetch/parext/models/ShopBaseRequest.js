...
exports.ShopBaseRequestToJSON = exports.ShopBaseRequestFromJSONTyped = exports.ShopBaseRequestFromJSON = exports.instanceOfShopBaseRequest = void 0;
const runtime_1 = require("../runtime");
/**
 * Check if a given object implements the ShopBaseRequest interface.
 */
function instanceOfShopBaseRequest(value) {
    let isInstance = true;
    return isInstance;
}
exports.instanceOfShopBaseRequest = instanceOfShopBaseRequest;
function ShopBaseRequestFromJSON(json) {
    return ShopBaseRequestFromJSONTyped(json, false);
}
exports.ShopBaseRequestFromJSON = ShopBaseRequestFromJSON;
function ShopBaseRequestFromJSONTyped(json, ignoreDiscriminator) {
...
exports.ShopBaseRequestFromJSONTyped = ShopBaseRequestFromJSONTyped;
function ShopBaseRequestToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
...
exports.ShopBaseRequestToJSON = ShopBaseRequestToJSON;
