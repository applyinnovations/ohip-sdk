...
exports.CorporateRatesSearchTypeToJSON = exports.CorporateRatesSearchTypeFromJSONTyped = exports.CorporateRatesSearchTypeFromJSON = exports.instanceOfCorporateRatesSearchType = void 0;
const runtime_1 = require("../runtime");
/**
 * Check if a given object implements the CorporateRatesSearchType interface.
 */
function instanceOfCorporateRatesSearchType(value) {
    let isInstance = true;
    return isInstance;
}
exports.instanceOfCorporateRatesSearchType = instanceOfCorporateRatesSearchType;
function CorporateRatesSearchTypeFromJSON(json) {
    return CorporateRatesSearchTypeFromJSONTyped(json, false);
}
exports.CorporateRatesSearchTypeFromJSON = CorporateRatesSearchTypeFromJSON;
function CorporateRatesSearchTypeFromJSONTyped(json, ignoreDiscriminator) {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        'corporateId': !(0, runtime_1.exists)(json, 'corporateId') ? undefined : json['corporateId'],
        'ratePlanSets': !(0, runtime_1.exists)(json, 'ratePlanSets') ? undefined : json['ratePlanSets'],
    };
}
exports.CorporateRatesSearchTypeFromJSONTyped = CorporateRatesSearchTypeFromJSONTyped;
function CorporateRatesSearchTypeToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
...
exports.CorporateRatesSearchTypeToJSON = CorporateRatesSearchTypeToJSON;
