...
exports.MultiRoomRateStayTypeToJSON = exports.MultiRoomRateStayTypeFromJSONTyped = exports.MultiRoomRateStayTypeFromJSON = exports.instanceOfMultiRoomRateStayType = void 0;
const runtime_1 = require("../runtime");
const MultiRoomTypesType_1 = require("./MultiRoomTypesType");
/**
 * Check if a given object implements the MultiRoomRateStayType interface.
 */
function instanceOfMultiRoomRateStayType(value) {
    let isInstance = true;
    return isInstance;
}
exports.instanceOfMultiRoomRateStayType = instanceOfMultiRoomRateStayType;
function MultiRoomRateStayTypeFromJSON(json) {
    return MultiRoomRateStayTypeFromJSONTyped(json, false);
}
exports.MultiRoomRateStayTypeFromJSON = MultiRoomRateStayTypeFromJSON;
function MultiRoomRateStayTypeFromJSONTyped(json, ignoreDiscriminator) {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        'roomClass': !(0, runtime_1.exists)(json, 'roomClass') ? undefined : json['roomClass'],
        'roomTypes': !(0, runtime_1.exists)(json, 'roomTypes') ? undefined : (json['roomTypes'].map(MultiRoomTypesType_1.MultiRoomTypesTypeFromJSON)),
    };
}
exports.MultiRoomRateStayTypeFromJSONTyped = MultiRoomRateStayTypeFromJSONTyped;
function MultiRoomRateStayTypeToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'roomTypes': value.roomTypes === undefined ? undefined : (value.roomTypes.map(MultiRoomTypesType_1.MultiRoomTypesTypeToJSON)),
    };
}
exports.MultiRoomRateStayTypeToJSON = MultiRoomRateStayTypeToJSON;
