 ...
 */
export declare function instanceOfRatesSearchType(value: object): boolean;
export declare function RatesSearchTypeFromJSON(json: any): RatesSearchType;
export declare function RatesSearchTypeFromJSONTyped(json: any, ignoreDiscriminator: boolean): RatesSearchType;
export declare function RatesSearchTypeToJSON(value?: RatesSearchType | null): any;
