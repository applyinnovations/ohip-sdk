 ...
 */
export declare function instanceOfCorporateRatesSearchType(value: object): boolean;
export declare function CorporateRatesSearchTypeFromJSON(json: any): CorporateRatesSearchType;
export declare function CorporateRatesSearchTypeFromJSONTyped(json: any, ignoreDiscriminator: boolean): CorporateRatesSearchType;
export declare function CorporateRatesSearchTypeToJSON(value?: CorporateRatesSearchType | null): any;
