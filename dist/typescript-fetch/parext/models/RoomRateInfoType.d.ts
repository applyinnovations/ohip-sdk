 ...
 */
export declare function instanceOfRoomRateInfoType(value: object): boolean;
export declare function RoomRateInfoTypeFromJSON(json: any): RoomRateInfoType;
export declare function RoomRateInfoTypeFromJSONTyped(json: any, ignoreDiscriminator: boolean): RoomRateInfoType;
export declare function RoomRateInfoTypeToJSON(value?: RoomRateInfoType | null): any;
