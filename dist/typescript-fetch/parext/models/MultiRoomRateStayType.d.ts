 ...
 */
export declare function instanceOfMultiRoomRateStayType(value: object): boolean;
export declare function MultiRoomRateStayTypeFromJSON(json: any): MultiRoomRateStayType;
export declare function MultiRoomRateStayTypeFromJSONTyped(json: any, ignoreDiscriminator: boolean): MultiRoomRateStayType;
export declare function MultiRoomRateStayTypeToJSON(value?: MultiRoomRateStayType | null): any;
