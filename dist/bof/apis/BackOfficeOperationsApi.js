...
class BackOfficeOperationsApi extends runtime.BaseAPI {
     ...
     */
    async clearBackOfficeOperationsServiceCacheRaw(requestParameters, initOverrides) {
     ...
     * Clear cache of back office operations cache
     */
    async clearBackOfficeOperationsServiceCache(requestParameters, initOverrides) {
     ...
     */
    async getBusinessDateRaw(requestParameters, initOverrides) {
        const queryParameters = {};
        const headerParameters = {};
        if (requestParameters.authorization !== undefined && requestParameters.authorization !== null) {
            headerParameters['authorization'] = String(requestParameters.authorization);
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => (0, models_1.BusinessDateFromJSON)(jsonValue));
    }
    /**
     * Use this API to find out the current business date of a specified hotel. <p><strong>OperationId:</strong>getBusinessDate</p>
     * Fetch end of day business dates
     */
    async getBusinessDate(requestParameters, initOverrides) {
     ...
     */
    async pingBackOfficeOperationsServiceRaw(requestParameters, initOverrides) {
        const queryParameters = {};
        const headerParameters = {};
        if (requestParameters.authorization !== undefined && requestParameters.authorization !== null) {
            headerParameters['authorization'] = String(requestParameters.authorization);
     ...
     * Ping back office operations service
     */
    async pingBackOfficeOperationsService(requestParameters, initOverrides) {
