...
class IntegrationProcessorApi extends runtime.BaseAPI {
     ...
     */
    async getBusinessEventsRaw(requestParameters, initOverrides) {
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => (0, models_1.BusinessEventsFromJSON)(jsonValue));
    }
    /**
     * Business Event messages will be placed in a queue. Use this API to fetch the Business Event messages based on External System and Hotel ID. In order to get property specific business event messages, you need to create a unique consumer code (Toolbox > External Database) for the External System and the Property. <p><strong>OperationId:</strong>getBusinessEvents</p>
     * Get Business Events by External System and Hotel ID
     */
    async getBusinessEvents(requestParameters, initOverrides) {
     ...
     */
    async getBusinessEventsByExternalSystemRaw(requestParameters, initOverrides) {
        const queryParameters = {};
        if (requestParameters.limit !== undefined) {
            queryParameters['limit'] = requestParameters.limit;
        }
     ...
     * Get Business Events by External System
     */
    async getBusinessEventsByExternalSystem(requestParameters, initOverrides) {
