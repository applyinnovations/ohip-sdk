 ...
 */
export declare function instanceOfTransactionCodes(value: object): boolean;
export declare function TransactionCodesFromJSON(json: any): TransactionCodes;
export declare function TransactionCodesFromJSONTyped(json: any, ignoreDiscriminator: boolean): TransactionCodes;
export declare function TransactionCodesToJSON(value?: TransactionCodes | null): any;
