...
exports.PostingTypeToJSON = exports.PostingTypeFromJSONTyped = exports.PostingTypeFromJSON = exports.instanceOfPostingType = void 0;
 ...
 */
function instanceOfPostingType(value) {
    let isInstance = true;
    return isInstance;
}
exports.instanceOfPostingType = instanceOfPostingType;
function PostingTypeFromJSON(json) {
    return PostingTypeFromJSONTyped(json, false);
}
exports.PostingTypeFromJSON = PostingTypeFromJSON;
function PostingTypeFromJSONTyped(json, ignoreDiscriminator) {
...
exports.PostingTypeFromJSONTyped = PostingTypeFromJSONTyped;
function PostingTypeToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
...
exports.PostingTypeToJSON = PostingTypeToJSON;
