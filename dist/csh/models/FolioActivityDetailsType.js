 ...
 */
function instanceOfFolioActivityDetailsType(value) {
    let isInstance = true;
    return isInstance;
}
exports.instanceOfFolioActivityDetailsType = instanceOfFolioActivityDetailsType;
function FolioActivityDetailsTypeFromJSON(json) {
    return FolioActivityDetailsTypeFromJSONTyped(json, false);
}
exports.FolioActivityDetailsTypeFromJSON = FolioActivityDetailsTypeFromJSON;
function FolioActivityDetailsTypeFromJSONTyped(json, ignoreDiscriminator) {
...
function FolioActivityDetailsTypeToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
