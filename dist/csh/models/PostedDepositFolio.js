 ...
 */
function instanceOfPostedDepositFolio(value) {
    let isInstance = true;
    return isInstance;
}
exports.instanceOfPostedDepositFolio = instanceOfPostedDepositFolio;
function PostedDepositFolioFromJSON(json) {
    return PostedDepositFolioFromJSONTyped(json, false);
}
exports.PostedDepositFolioFromJSON = PostedDepositFolioFromJSON;
function PostedDepositFolioFromJSONTyped(json, ignoreDiscriminator) {
...
function PostedDepositFolioToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
