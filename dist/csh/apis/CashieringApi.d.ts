...
export declare class CashieringApi extends runtime.BaseAPI {
     ...
     */
    clearCashieringServiceCacheRaw(requestParameters: ClearCashieringServiceCacheRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Status>>;
    /**
     * You can use this API to clear cache in cashiering services. <p><strong>OperationId:</strong>clearCashieringServiceCache</p>
     * clearing of cache in cashiering services
     */
    clearCashieringServiceCache(requestParameters: ClearCashieringServiceCacheRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Status>;
    /**
     ...
     */
    pingCashieringServiceRaw(requestParameters: PingCashieringServiceRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<OperaVersion>>;
    /**
     * You can use this API to Status check of cashiering services. <p><strong>OperationId:</strong>pingCashieringService</p>
     * Status check of cashiering services
     */
    pingCashieringService(requestParameters: PingCashieringServiceRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<OperaVersion>;
    /**
