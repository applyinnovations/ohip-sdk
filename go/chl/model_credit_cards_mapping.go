...
type CreditCardsMapping struct {
	...
	CreditCardsMapping []CreditCardMappingType `json:"creditCardsMapping,omitempty"`
...
// SetCreditCardsMapping gets a reference to the given []CreditCardMappingType and assigns it to the CreditCardsMapping field.
