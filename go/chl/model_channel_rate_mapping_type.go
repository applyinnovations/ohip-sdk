...
type ChannelRateMappingType struct {
	...
	AllowRatesToGds *bool `json:"allowRatesToGds,omitempty"`
...
// GetAllowRatesToGds returns the AllowRatesToGds field value if set, zero value otherwise.
func (o *ChannelRateMappingType) GetAllowRatesToGds() bool {
	if o == nil || IsNil(o.AllowRatesToGds) {
		var ret bool
		return ret
	}
	return *o.AllowRatesToGds
}

// GetAllowRatesToGdsOk returns a tuple with the AllowRatesToGds field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ChannelRateMappingType) GetAllowRatesToGdsOk() (*bool, bool) {
	if o == nil || IsNil(o.AllowRatesToGds) {
		return nil, false
	}
	return o.AllowRatesToGds, true
}
...
// SetAllowRatesToGds gets a reference to the given bool and assigns it to the AllowRatesToGds field.
...
func (o ChannelRateMappingType) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.AllowRatesToGds) {
		toSerialize["allowRatesToGds"] = o.AllowRatesToGds
	}
