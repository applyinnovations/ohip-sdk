...
```golang
import chl "github.com/applyinnovations/ohip-sdk/go/chl/v3"
```
...
*ChannelAPI* | [**DeleteProfileNegRateAccessCodes**](docs/ChannelAPI.md#deleteprofilenegrateaccesscodes) | **Post** /clusters/{clusterId}/channels/profileRatesAccessDeletes | Delete Channel Rates Access for cluster level
...
*ChannelAPI* | [**GetChannelNegotiatedRates**](docs/ChannelAPI.md#getchannelnegotiatedrates) | **Get** /clusters/{clusterId}/channels/negotiatedRates | Gets channel negotiate rate
...
*ChannelAPI* | [**PutProfileNegRateAccessCodes**](docs/ChannelAPI.md#putprofilenegrateaccesscodes) | **Put** /clusters/{clusterId}/channels/profileRatesAccess | Initiate profile rate access codes
...
*ChannelAPI* | [**SyncProfileNegRateAccessCodes**](docs/ChannelAPI.md#syncprofilenegrateaccesscodes) | **Put** /clusters/{clusterId}/channels/syncProfileRatesAccess | Sync profile rate access codes
...
## Documentation For Models
 ...
 - [ChannelRatesAccessMain](docs/ChannelRatesAccessMain.md)
 ...
 - [DeleteNegotiatedRates](docs/DeleteNegotiatedRates.md)
 ...
 - [GetChannelRatesAccessItems](docs/GetChannelRatesAccessItems.md)
 ...
 - [HotelIdChannelRatesAccess](docs/HotelIdChannelRatesAccess.md)
 ...
 - [ProfileChannelRateAccessCode](docs/ProfileChannelRateAccessCode.md)
 - [ProfileChannelRatePlan](docs/ProfileChannelRatePlan.md)
 - [ProfileId](docs/ProfileId.md)
 - [ProfileNegotiatedRateDetails](docs/ProfileNegotiatedRateDetails.md)
 - [ProfileRateAccessCode](docs/ProfileRateAccessCode.md)
 - [ProfileRateAccessCodes](docs/ProfileRateAccessCodes.md)
 ...
 - [SyncProfileRatesAccessCodes](docs/SyncProfileRatesAccessCodes.md)
