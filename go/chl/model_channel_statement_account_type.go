...
type ChannelStatementAccountType struct {
	...
	ChannelAccountStatementDetails []ChannelStatementDetailType `json:"channelAccountStatementDetails,omitempty"`
}
...
// SetChannelAccountStatementDetails gets a reference to the given []ChannelStatementDetailType and assigns it to the ChannelAccountStatementDetails field.
