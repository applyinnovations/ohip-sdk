...
// checks if the ChannelBillingStatementSummaries type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ChannelBillingStatementSummaries{}

// ChannelBillingStatementSummaries Response object of the channel billing statements fetch request.
type ChannelBillingStatementSummaries struct {
	// Holds summary of channel billing statement.
	ChannelBillingStatementsSummary []ChannelBillingStatementSummaryType `json:"channelBillingStatementsSummary,omitempty"`
...
func NewChannelBillingStatementSummaries() *ChannelBillingStatementSummaries {
	this := ChannelBillingStatementSummaries{}
	return &this
}
...
// GetChannelBillingStatementsSummary returns the ChannelBillingStatementsSummary field value if set, zero value otherwise.
func (o *ChannelBillingStatementSummaries) GetChannelBillingStatementsSummary() []ChannelBillingStatementSummaryType {
	if o == nil || IsNil(o.ChannelBillingStatementsSummary) {
		var ret []ChannelBillingStatementSummaryType
		return ret
	}
	return o.ChannelBillingStatementsSummary
}

// GetChannelBillingStatementsSummaryOk returns a tuple with the ChannelBillingStatementsSummary field value if set, nil otherwise
...
func (o *ChannelBillingStatementSummaries) GetChannelBillingStatementsSummaryOk() ([]ChannelBillingStatementSummaryType, bool) {
	...
	return o.ChannelBillingStatementsSummary, true
}
...
// SetChannelBillingStatementsSummary gets a reference to the given []ChannelBillingStatementSummaryType and assigns it to the ChannelBillingStatementsSummary field.
func (o *ChannelBillingStatementSummaries) SetChannelBillingStatementsSummary(v []ChannelBillingStatementSummaryType) {
	o.ChannelBillingStatementsSummary = v
}
...
func (o ChannelBillingStatementSummaries) MarshalJSON() ([]byte, error) {
...
func (o ChannelBillingStatementSummaries) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.ChannelBillingStatementsSummary) {
		toSerialize["channelBillingStatementsSummary"] = o.ChannelBillingStatementsSummary
	}
...
type NullableChannelBillingStatementSummaries struct {
	value *ChannelBillingStatementSummaries
	isSet bool
}

func (v NullableChannelBillingStatementSummaries) Get() *ChannelBillingStatementSummaries {
	return v.value
}

func (v *NullableChannelBillingStatementSummaries) Set(val *ChannelBillingStatementSummaries) {
	v.value = val
	v.isSet = true
}

func (v NullableChannelBillingStatementSummaries) IsSet() bool {
	return v.isSet
}

func (v *NullableChannelBillingStatementSummaries) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableChannelBillingStatementSummaries(val *ChannelBillingStatementSummaries) *NullableChannelBillingStatementSummaries {
	return &NullableChannelBillingStatementSummaries{value: val, isSet: true}
}

func (v NullableChannelBillingStatementSummaries) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableChannelBillingStatementSummaries) UnmarshalJSON(src []byte) error {
	v.isSet = true
