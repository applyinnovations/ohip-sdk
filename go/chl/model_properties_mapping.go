...
type PropertiesMapping struct {
	...
	PropertiesMapping []PropertyMappingType `json:"propertiesMapping,omitempty"`
...
// SetPropertiesMapping gets a reference to the given []PropertyMappingType and assigns it to the PropertiesMapping field.
