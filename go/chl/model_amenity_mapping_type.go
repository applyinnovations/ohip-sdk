...
func (o *AmenityMappingType) GetManagedBy() ManagedByOptions {
...
// and a boolean to check if the value has been set.
func (o *AmenityMappingType) GetManagedByOk() (*ManagedByOptions, bool) {
	if o == nil || IsNil(o.ManagedBy) {
		return nil, false
	}
...
func (o *AmenityMappingType) HasManagedBy() bool {
	if o != nil && !IsNil(o.ManagedBy) {
		return true
	}
...
func (o *AmenityMappingType) SetManagedBy(v ManagedByOptions) {
	o.ManagedBy = &v
}
