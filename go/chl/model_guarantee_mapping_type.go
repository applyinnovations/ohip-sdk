...
func (o *GuaranteeMappingType) GetManagedBy() ManagedByOptions {
...
// and a boolean to check if the value has been set.
func (o *GuaranteeMappingType) GetManagedByOk() (*ManagedByOptions, bool) {
	if o == nil || IsNil(o.ManagedBy) {
		return nil, false
	}
...
func (o *GuaranteeMappingType) HasManagedBy() bool {
	if o != nil && !IsNil(o.ManagedBy) {
		return true
	}
...
func (o *GuaranteeMappingType) SetManagedBy(v ManagedByOptions) {
	o.ManagedBy = &v
}
