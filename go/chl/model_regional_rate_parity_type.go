...
// checks if the RegionalRateParityType type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RegionalRateParityType{}

// RegionalRateParityType Information on Room Rate Parity among Channels/Property
type RegionalRateParityType struct {
	// Channels and Property combination.
	RegionalParityGroups []RegionalParityGroupType `json:"regionalParityGroups,omitempty"`
...
// GetRegionalParityGroups returns the RegionalParityGroups field value if set, zero value otherwise.
func (o *RegionalRateParityType) GetRegionalParityGroups() []RegionalParityGroupType {
	if o == nil || IsNil(o.RegionalParityGroups) {
		var ret []RegionalParityGroupType
		return ret
	}
	return o.RegionalParityGroups
}

// GetRegionalParityGroupsOk returns a tuple with the RegionalParityGroups field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *RegionalRateParityType) GetRegionalParityGroupsOk() ([]RegionalParityGroupType, bool) {
	if o == nil || IsNil(o.RegionalParityGroups) {
		return nil, false
	}
	return o.RegionalParityGroups, true
}
...
// SetRegionalParityGroups gets a reference to the given []RegionalParityGroupType and assigns it to the RegionalParityGroups field.
func (o *RegionalRateParityType) SetRegionalParityGroups(v []RegionalParityGroupType) {
	o.RegionalParityGroups = v
}
...
func (o RegionalRateParityType) MarshalJSON() ([]byte, error) {
...
func (o RegionalRateParityType) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.RegionalParityGroups) {
		toSerialize["regionalParityGroups"] = o.RegionalParityGroups
	}
...
type NullableRegionalRateParityType struct {
	value *RegionalRateParityType
	isSet bool
}

func (v NullableRegionalRateParityType) Get() *RegionalRateParityType {
	return v.value
}

func (v *NullableRegionalRateParityType) Set(val *RegionalRateParityType) {
	v.value = val
	v.isSet = true
}

func (v NullableRegionalRateParityType) IsSet() bool {
	return v.isSet
}

func (v *NullableRegionalRateParityType) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRegionalRateParityType(val *RegionalRateParityType) *NullableRegionalRateParityType {
	return &NullableRegionalRateParityType{value: val, isSet: true}
}

func (v NullableRegionalRateParityType) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRegionalRateParityType) UnmarshalJSON(src []byte) error {
	v.isSet = true
