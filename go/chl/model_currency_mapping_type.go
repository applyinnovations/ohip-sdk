...
func (o *CurrencyMappingType) GetManagedBy() ManagedByOptions {
...
// and a boolean to check if the value has been set.
func (o *CurrencyMappingType) GetManagedByOk() (*ManagedByOptions, bool) {
	if o == nil || IsNil(o.ManagedBy) {
		return nil, false
	}
...
func (o *CurrencyMappingType) HasManagedBy() bool {
	if o != nil && !IsNil(o.ManagedBy) {
		return true
	}
...
func (o *CurrencyMappingType) SetManagedBy(v ManagedByOptions) {
	o.ManagedBy = &v
}
