...
type MarketingTextType struct {
	...
	MarketingTextDescription *TranslationTextType2000 `json:"marketingTextDescription,omitempty"`
	...
	SupportsHTMLEditor *bool `json:"supportsHTMLEditor,omitempty"`
}
...
// GetMarketingTextDescription returns the MarketingTextDescription field value if set, zero value otherwise.
func (o *MarketingTextType) GetMarketingTextDescription() TranslationTextType2000 {
	if o == nil || IsNil(o.MarketingTextDescription) {
		var ret TranslationTextType2000
		return ret
	}
	return *o.MarketingTextDescription
}

// GetMarketingTextDescriptionOk returns a tuple with the MarketingTextDescription field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *MarketingTextType) GetMarketingTextDescriptionOk() (*TranslationTextType2000, bool) {
	if o == nil || IsNil(o.MarketingTextDescription) {
		return nil, false
	}
	return o.MarketingTextDescription, true
}

// HasMarketingTextDescription returns a boolean if a field has been set.
func (o *MarketingTextType) HasMarketingTextDescription() bool {
	if o != nil && !IsNil(o.MarketingTextDescription) {
		return true
	}
...
// SetMarketingTextDescription gets a reference to the given TranslationTextType2000 and assigns it to the MarketingTextDescription field.
func (o *MarketingTextType) SetMarketingTextDescription(v TranslationTextType2000) {
	o.MarketingTextDescription = &v
}
...
func (o *MarketingTextType) GetSupportsHTMLEditor() bool {
...
// and a boolean to check if the value has been set.
func (o *MarketingTextType) GetSupportsHTMLEditorOk() (*bool, bool) {
	if o == nil || IsNil(o.SupportsHTMLEditor) {
		return nil, false
	}
...
func (o *MarketingTextType) HasSupportsHTMLEditor() bool {
	if o != nil && !IsNil(o.SupportsHTMLEditor) {
		return true
	}
...
// SetSupportsHTMLEditor gets a reference to the given bool and assigns it to the SupportsHTMLEditor field.
func (o *MarketingTextType) SetSupportsHTMLEditor(v bool) {
...
func (o MarketingTextType) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.MarketingTextDescription) {
		toSerialize["marketingTextDescription"] = o.MarketingTextDescription
	}
