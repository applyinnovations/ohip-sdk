...
func (o *ConfigUpsellRuleType) GetManagedBy() ManagedByOptions {
...
// and a boolean to check if the value has been set.
func (o *ConfigUpsellRuleType) GetManagedByOk() (*ManagedByOptions, bool) {
	if o == nil || IsNil(o.ManagedBy) {
		return nil, false
	}
...
func (o *ConfigUpsellRuleType) HasManagedBy() bool {
	if o != nil && !IsNil(o.ManagedBy) {
		return true
	}
...
func (o *ConfigUpsellRuleType) SetManagedBy(v ManagedByOptions) {
	o.ManagedBy = &v
}
