...
type PolicyScheduleDetailType struct {
	...
	// Applicable to Cancel Penalties only. When true, the configured Grace Period and Grace Period Advanced Booking Window will not be considered when determining the applicable cancel penalty date.
	IgnoreGracePeriod *bool `json:"ignoreGracePeriod,omitempty"`
}
...
// GetIgnoreGracePeriod returns the IgnoreGracePeriod field value if set, zero value otherwise.
func (o *PolicyScheduleDetailType) GetIgnoreGracePeriod() bool {
	if o == nil || IsNil(o.IgnoreGracePeriod) {
		var ret bool
		return ret
	}
	return *o.IgnoreGracePeriod
}

// GetIgnoreGracePeriodOk returns a tuple with the IgnoreGracePeriod field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *PolicyScheduleDetailType) GetIgnoreGracePeriodOk() (*bool, bool) {
	if o == nil || IsNil(o.IgnoreGracePeriod) {
		return nil, false
	}
	return o.IgnoreGracePeriod, true
}

// HasIgnoreGracePeriod returns a boolean if a field has been set.
func (o *PolicyScheduleDetailType) HasIgnoreGracePeriod() bool {
	if o != nil && !IsNil(o.IgnoreGracePeriod) {
		return true
	}
...
// SetIgnoreGracePeriod gets a reference to the given bool and assigns it to the IgnoreGracePeriod field.
func (o *PolicyScheduleDetailType) SetIgnoreGracePeriod(v bool) {
	o.IgnoreGracePeriod = &v
}
...
func (o PolicyScheduleDetailType) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.IgnoreGracePeriod) {
		toSerialize["ignoreGracePeriod"] = o.IgnoreGracePeriod
	}
