...
// checks if the RetrievedGuestMessages type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RetrievedGuestMessages{}

// RetrievedGuestMessages Response object for information regarding guest message.
type RetrievedGuestMessages struct {
...
func (o RetrievedGuestMessages) MarshalJSON() ([]byte, error) {
...
func (o RetrievedGuestMessages) ToMap() (map[string]interface{}, error) {
...
type NullableRetrievedGuestMessages struct {
	value *RetrievedGuestMessages
	isSet bool
}

func (v NullableRetrievedGuestMessages) Get() *RetrievedGuestMessages {
	return v.value
}

func (v *NullableRetrievedGuestMessages) Set(val *RetrievedGuestMessages) {
	v.value = val
	v.isSet = true
}

func (v NullableRetrievedGuestMessages) IsSet() bool {
	return v.isSet
}

func (v *NullableRetrievedGuestMessages) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRetrievedGuestMessages(val *RetrievedGuestMessages) *NullableRetrievedGuestMessages {
	return &NullableRetrievedGuestMessages{value: val, isSet: true}
}

func (v NullableRetrievedGuestMessages) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRetrievedGuestMessages) UnmarshalJSON(src []byte) error {
	v.isSet = true
