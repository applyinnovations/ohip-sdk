...
func (o *ReservationColorType) GetManagedBy() ManagedByOptions {
...
// and a boolean to check if the value has been set.
func (o *ReservationColorType) GetManagedByOk() (*ManagedByOptions, bool) {
	if o == nil || IsNil(o.ManagedBy) {
		return nil, false
	}
...
func (o *ReservationColorType) HasManagedBy() bool {
	if o != nil && !IsNil(o.ManagedBy) {
		return true
	}
...
func (o *ReservationColorType) SetManagedBy(v ManagedByOptions) {
	o.ManagedBy = &v
}
