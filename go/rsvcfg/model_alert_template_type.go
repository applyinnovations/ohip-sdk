...
type AlertTemplateType struct {
	...
	// Indicates whether the Alert is an Advanced Alert with script.
	IsAdvancedAlert *bool `json:"isAdvancedAlert,omitempty"`
	Script *ScriptType `json:"script,omitempty"`
}
...
// GetIsAdvancedAlert returns the IsAdvancedAlert field value if set, zero value otherwise.
func (o *AlertTemplateType) GetIsAdvancedAlert() bool {
	if o == nil || IsNil(o.IsAdvancedAlert) {
		var ret bool
		return ret
	}
	return *o.IsAdvancedAlert
}

// GetIsAdvancedAlertOk returns a tuple with the IsAdvancedAlert field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *AlertTemplateType) GetIsAdvancedAlertOk() (*bool, bool) {
	if o == nil || IsNil(o.IsAdvancedAlert) {
		return nil, false
	}
	return o.IsAdvancedAlert, true
}

// HasIsAdvancedAlert returns a boolean if a field has been set.
func (o *AlertTemplateType) HasIsAdvancedAlert() bool {
	if o != nil && !IsNil(o.IsAdvancedAlert) {
		return true
	}
...
// SetIsAdvancedAlert gets a reference to the given bool and assigns it to the IsAdvancedAlert field.
func (o *AlertTemplateType) SetIsAdvancedAlert(v bool) {
	o.IsAdvancedAlert = &v
}

// GetScript returns the Script field value if set, zero value otherwise.
func (o *AlertTemplateType) GetScript() ScriptType {
...
// and a boolean to check if the value has been set.
func (o *AlertTemplateType) GetScriptOk() (*ScriptType, bool) {
	if o == nil || IsNil(o.Script) {
		return nil, false
	}
...
func (o *AlertTemplateType) HasScript() bool {
	if o != nil && !IsNil(o.Script) {
		return true
	}
...
// SetScript gets a reference to the given ScriptType and assigns it to the Script field.
func (o *AlertTemplateType) SetScript(v ScriptType) {
	o.Script = &v
}
...
func (o AlertTemplateType) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.IsAdvancedAlert) {
		toSerialize["isAdvancedAlert"] = o.IsAdvancedAlert
	}
	if !IsNil(o.Script) {
