...
func (o *GlobalAlertType) GetManagedBy() ManagedByOptions {
...
// and a boolean to check if the value has been set.
func (o *GlobalAlertType) GetManagedByOk() (*ManagedByOptions, bool) {
	if o == nil || IsNil(o.ManagedBy) {
		return nil, false
	}
...
func (o *GlobalAlertType) HasManagedBy() bool {
	if o != nil && !IsNil(o.ManagedBy) {
		return true
	}
...
func (o *GlobalAlertType) SetManagedBy(v ManagedByOptions) {
	o.ManagedBy = &v
}
