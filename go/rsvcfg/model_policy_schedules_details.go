...
type PolicySchedulesDetails struct {
	...
	PolicySchedules []PolicyScheduleType `json:"policySchedules,omitempty"`
...
// SetPolicySchedules gets a reference to the given []PolicyScheduleType and assigns it to the PolicySchedules field.
