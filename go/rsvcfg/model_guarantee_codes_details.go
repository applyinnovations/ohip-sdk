...
// checks if the GuaranteeCodesDetails type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GuaranteeCodesDetails{}

// GuaranteeCodesDetails Response for fetch Guarantee Codes.
type GuaranteeCodesDetails struct {
	// Collection of Guarantee Codes.
	GuaranteeCodes []GuaranteeCodesType `json:"guaranteeCodes,omitempty"`
...
// SetGuaranteeCodes gets a reference to the given []GuaranteeCodesType and assigns it to the GuaranteeCodes field.
...
func (o GuaranteeCodesDetails) MarshalJSON() ([]byte, error) {
...
func (o GuaranteeCodesDetails) ToMap() (map[string]interface{}, error) {
...
type NullableGuaranteeCodesDetails struct {
	value *GuaranteeCodesDetails
	isSet bool
}

func (v NullableGuaranteeCodesDetails) Get() *GuaranteeCodesDetails {
	return v.value
}

func (v *NullableGuaranteeCodesDetails) Set(val *GuaranteeCodesDetails) {
	v.value = val
	v.isSet = true
}

func (v NullableGuaranteeCodesDetails) IsSet() bool {
	return v.isSet
}

func (v *NullableGuaranteeCodesDetails) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGuaranteeCodesDetails(val *GuaranteeCodesDetails) *NullableGuaranteeCodesDetails {
	return &NullableGuaranteeCodesDetails{value: val, isSet: true}
}

func (v NullableGuaranteeCodesDetails) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGuaranteeCodesDetails) UnmarshalJSON(src []byte) error {
	v.isSet = true
