...
// checks if the EntryPointsCriteria type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &EntryPointsCriteria{}

// EntryPointsCriteria Request object for creating Entry Points.
type EntryPointsCriteria struct {
...
func (o EntryPointsCriteria) MarshalJSON() ([]byte, error) {
...
func (o EntryPointsCriteria) ToMap() (map[string]interface{}, error) {
...
type NullableEntryPointsCriteria struct {
	value *EntryPointsCriteria
	isSet bool
}

func (v NullableEntryPointsCriteria) Get() *EntryPointsCriteria {
	return v.value
}

func (v *NullableEntryPointsCriteria) Set(val *EntryPointsCriteria) {
	v.value = val
	v.isSet = true
}

func (v NullableEntryPointsCriteria) IsSet() bool {
	return v.isSet
}

func (v *NullableEntryPointsCriteria) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableEntryPointsCriteria(val *EntryPointsCriteria) *NullableEntryPointsCriteria {
	return &NullableEntryPointsCriteria{value: val, isSet: true}
}

func (v NullableEntryPointsCriteria) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableEntryPointsCriteria) UnmarshalJSON(src []byte) error {
	v.isSet = true
