...
func (o *ConfigDepositPolicyType) GetManagedBy() ManagedByOptions {
...
// and a boolean to check if the value has been set.
func (o *ConfigDepositPolicyType) GetManagedByOk() (*ManagedByOptions, bool) {
	if o == nil || IsNil(o.ManagedBy) {
		return nil, false
	}
...
func (o *ConfigDepositPolicyType) HasManagedBy() bool {
	if o != nil && !IsNil(o.ManagedBy) {
		return true
	}
...
func (o *ConfigDepositPolicyType) SetManagedBy(v ManagedByOptions) {
	o.ManagedBy = &v
}
