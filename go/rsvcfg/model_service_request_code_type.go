...
func (o *ServiceRequestCodeType) GetManagedBy() ManagedByOptions {
...
// and a boolean to check if the value has been set.
func (o *ServiceRequestCodeType) GetManagedByOk() (*ManagedByOptions, bool) {
	if o == nil || IsNil(o.ManagedBy) {
		return nil, false
	}
...
func (o *ServiceRequestCodeType) HasManagedBy() bool {
	if o != nil && !IsNil(o.ManagedBy) {
		return true
	}
...
func (o *ServiceRequestCodeType) SetManagedBy(v ManagedByOptions) {
	o.ManagedBy = &v
}
