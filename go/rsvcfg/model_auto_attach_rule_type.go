...
func (o *AutoAttachRuleType) GetManagedBy() ManagedByOptions {
...
// and a boolean to check if the value has been set.
func (o *AutoAttachRuleType) GetManagedByOk() (*ManagedByOptions, bool) {
	if o == nil || IsNil(o.ManagedBy) {
		return nil, false
	}
...
func (o *AutoAttachRuleType) HasManagedBy() bool {
	if o != nil && !IsNil(o.ManagedBy) {
		return true
	}
...
func (o *AutoAttachRuleType) SetManagedBy(v ManagedByOptions) {
	o.ManagedBy = &v
}
