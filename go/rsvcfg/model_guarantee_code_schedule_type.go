...
func (o *GuaranteeCodeScheduleType) GetManagedBy() ManagedByOptions {
...
// and a boolean to check if the value has been set.
func (o *GuaranteeCodeScheduleType) GetManagedByOk() (*ManagedByOptions, bool) {
	if o == nil || IsNil(o.ManagedBy) {
		return nil, false
	}
...
func (o *GuaranteeCodeScheduleType) HasManagedBy() bool {
	if o != nil && !IsNil(o.ManagedBy) {
		return true
	}
...
func (o *GuaranteeCodeScheduleType) SetManagedBy(v ManagedByOptions) {
	o.ManagedBy = &v
}
