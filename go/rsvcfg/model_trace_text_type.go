...
func (o *TraceTextType) GetManagedBy() ManagedByOptions {
...
// and a boolean to check if the value has been set.
func (o *TraceTextType) GetManagedByOk() (*ManagedByOptions, bool) {
	if o == nil || IsNil(o.ManagedBy) {
		return nil, false
	}
...
func (o *TraceTextType) HasManagedBy() bool {
	if o != nil && !IsNil(o.ManagedBy) {
		return true
	}
...
func (o *TraceTextType) SetManagedBy(v ManagedByOptions) {
	o.ManagedBy = &v
}
