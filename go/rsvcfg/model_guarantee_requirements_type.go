...
type GuaranteeRequirementsType struct {
	...
	// When true indicates an email on the reservation is required for this guarantee code.
	Email *bool `json:"email,omitempty"`
	// When true indicates attaching a travel agent profile on the reservation is required for this guarantee code.
	TravelAgent *bool `json:"travelAgent,omitempty"`
	// When true indicates attaching a company profile on the reservation is required for this guarantee code.
...
func (o *GuaranteeRequirementsType) GetEmail() bool {
...
// and a boolean to check if the value has been set.
func (o *GuaranteeRequirementsType) GetEmailOk() (*bool, bool) {
	if o == nil || IsNil(o.Email) {
		return nil, false
	}
	return o.Email, true
...
func (o *GuaranteeRequirementsType) HasEmail() bool {
	if o != nil && !IsNil(o.Email) {
		return true
	}
...
func (o *GuaranteeRequirementsType) SetEmail(v bool) {
	o.Email = &v
}

// GetTravelAgent returns the TravelAgent field value if set, zero value otherwise.
func (o *GuaranteeRequirementsType) GetTravelAgent() bool {
	if o == nil || IsNil(o.TravelAgent) {
		var ret bool
		return ret
	}
	return *o.TravelAgent
}

// GetTravelAgentOk returns a tuple with the TravelAgent field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *GuaranteeRequirementsType) GetTravelAgentOk() (*bool, bool) {
	if o == nil || IsNil(o.TravelAgent) {
		return nil, false
	}
	return o.TravelAgent, true
}

// HasTravelAgent returns a boolean if a field has been set.
func (o *GuaranteeRequirementsType) HasTravelAgent() bool {
	if o != nil && !IsNil(o.TravelAgent) {
		return true
	}
...
// SetTravelAgent gets a reference to the given bool and assigns it to the TravelAgent field.
func (o *GuaranteeRequirementsType) SetTravelAgent(v bool) {
	o.TravelAgent = &v
}

// GetCompany returns the Company field value if set, zero value otherwise.
func (o *GuaranteeRequirementsType) GetCompany() bool {
...
// and a boolean to check if the value has been set.
func (o *GuaranteeRequirementsType) GetCompanyOk() (*bool, bool) {
	if o == nil || IsNil(o.Company) {
		return nil, false
	}
...
func (o *GuaranteeRequirementsType) HasCompany() bool {
	if o != nil && !IsNil(o.Company) {
		return true
	}
...
func (o *GuaranteeRequirementsType) SetCompany(v bool) {
	o.Company = &v
}
...
func (o GuaranteeRequirementsType) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.TravelAgent) {
		toSerialize["travelAgent"] = o.TravelAgent
	}
	if !IsNil(o.Company) {
