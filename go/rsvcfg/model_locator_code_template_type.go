...
// checks if the LocatorCodeTemplateType type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &LocatorCodeTemplateType{}

// LocatorCodeTemplateType Common code type for code, description
type LocatorCodeTemplateType struct {
...
func (o LocatorCodeTemplateType) MarshalJSON() ([]byte, error) {
...
func (o LocatorCodeTemplateType) ToMap() (map[string]interface{}, error) {
...
type NullableLocatorCodeTemplateType struct {
	value *LocatorCodeTemplateType
	isSet bool
}

func (v NullableLocatorCodeTemplateType) Get() *LocatorCodeTemplateType {
	return v.value
}

func (v *NullableLocatorCodeTemplateType) Set(val *LocatorCodeTemplateType) {
	v.value = val
	v.isSet = true
}

func (v NullableLocatorCodeTemplateType) IsSet() bool {
	return v.isSet
}

func (v *NullableLocatorCodeTemplateType) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableLocatorCodeTemplateType(val *LocatorCodeTemplateType) *NullableLocatorCodeTemplateType {
	return &NullableLocatorCodeTemplateType{value: val, isSet: true}
}

func (v NullableLocatorCodeTemplateType) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableLocatorCodeTemplateType) UnmarshalJSON(src []byte) error {
	v.isSet = true
