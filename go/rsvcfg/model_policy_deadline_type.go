...
type PolicyDeadlineType struct {
	// Defines the absolute deadline. Either this or the offset attributes may be used. Uses the hotel's time zone.
	...
	// Time on offset day the cancellation penalties applies. Uses the hotel's time zone.
