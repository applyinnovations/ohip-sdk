...
// checks if the MoveReasonCodeType type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MoveReasonCodeType{}

// MoveReasonCodeType Contains Common Master configuration detail.
type MoveReasonCodeType struct {
...
func (o MoveReasonCodeType) MarshalJSON() ([]byte, error) {
...
func (o MoveReasonCodeType) ToMap() (map[string]interface{}, error) {
...
type NullableMoveReasonCodeType struct {
	value *MoveReasonCodeType
	isSet bool
}

func (v NullableMoveReasonCodeType) Get() *MoveReasonCodeType {
	return v.value
}

func (v *NullableMoveReasonCodeType) Set(val *MoveReasonCodeType) {
	v.value = val
	v.isSet = true
}

func (v NullableMoveReasonCodeType) IsSet() bool {
	return v.isSet
}

func (v *NullableMoveReasonCodeType) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMoveReasonCodeType(val *MoveReasonCodeType) *NullableMoveReasonCodeType {
	return &NullableMoveReasonCodeType{value: val, isSet: true}
}

func (v NullableMoveReasonCodeType) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMoveReasonCodeType) UnmarshalJSON(src []byte) error {
	v.isSet = true
