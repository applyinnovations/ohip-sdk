...
type GuaranteeConfigType struct {
	...
	DistributionAttributes *DistributionAttributesType `json:"distributionAttributes,omitempty"`
...
// GetDistributionAttributes returns the DistributionAttributes field value if set, zero value otherwise.
func (o *GuaranteeConfigType) GetDistributionAttributes() DistributionAttributesType {
	if o == nil || IsNil(o.DistributionAttributes) {
		var ret DistributionAttributesType
		return ret
	}
	return *o.DistributionAttributes
}

// GetDistributionAttributesOk returns a tuple with the DistributionAttributes field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *GuaranteeConfigType) GetDistributionAttributesOk() (*DistributionAttributesType, bool) {
	if o == nil || IsNil(o.DistributionAttributes) {
		return nil, false
	}
	return o.DistributionAttributes, true
}

// HasDistributionAttributes returns a boolean if a field has been set.
func (o *GuaranteeConfigType) HasDistributionAttributes() bool {
	if o != nil && !IsNil(o.DistributionAttributes) {
		return true
	}
...
// SetDistributionAttributes gets a reference to the given DistributionAttributesType and assigns it to the DistributionAttributes field.
func (o *GuaranteeConfigType) SetDistributionAttributes(v DistributionAttributesType) {
	o.DistributionAttributes = &v
}
...
func (o *GuaranteeConfigType) GetManagedBy() ManagedByOptions {
...
// and a boolean to check if the value has been set.
func (o *GuaranteeConfigType) GetManagedByOk() (*ManagedByOptions, bool) {
	if o == nil || IsNil(o.ManagedBy) {
		return nil, false
	}
...
func (o *GuaranteeConfigType) HasManagedBy() bool {
	if o != nil && !IsNil(o.ManagedBy) {
		return true
	}
...
func (o *GuaranteeConfigType) SetManagedBy(v ManagedByOptions) {
	o.ManagedBy = &v
}
...
func (o GuaranteeConfigType) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.DistributionAttributes) {
		toSerialize["distributionAttributes"] = o.DistributionAttributes
	}
