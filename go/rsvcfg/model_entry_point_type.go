...
// checks if the EntryPointType type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &EntryPointType{}

// EntryPointType Contains Common Master configuration detail.
...
func (o EntryPointType) MarshalJSON() ([]byte, error) {
...
func (o EntryPointType) ToMap() (map[string]interface{}, error) {
...
type NullableEntryPointType struct {
	value *EntryPointType
	isSet bool
}

func (v NullableEntryPointType) Get() *EntryPointType {
	return v.value
}

func (v *NullableEntryPointType) Set(val *EntryPointType) {
	v.value = val
	v.isSet = true
}

func (v NullableEntryPointType) IsSet() bool {
	return v.isSet
}

func (v *NullableEntryPointType) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableEntryPointType(val *EntryPointType) *NullableEntryPointType {
	return &NullableEntryPointType{value: val, isSet: true}
}

func (v NullableEntryPointType) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableEntryPointType) UnmarshalJSON(src []byte) error {
	v.isSet = true
