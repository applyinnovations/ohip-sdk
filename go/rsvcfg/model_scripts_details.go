...
// checks if the ScriptsDetails type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ScriptsDetails{}

// ScriptsDetails Response object for fetching Scripts.
type ScriptsDetails struct {
...
func (o ScriptsDetails) MarshalJSON() ([]byte, error) {
...
func (o ScriptsDetails) ToMap() (map[string]interface{}, error) {
...
type NullableScriptsDetails struct {
	value *ScriptsDetails
	isSet bool
}

func (v NullableScriptsDetails) Get() *ScriptsDetails {
	return v.value
}

func (v *NullableScriptsDetails) Set(val *ScriptsDetails) {
	v.value = val
	v.isSet = true
}

func (v NullableScriptsDetails) IsSet() bool {
	return v.isSet
}

func (v *NullableScriptsDetails) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableScriptsDetails(val *ScriptsDetails) *NullableScriptsDetails {
	return &NullableScriptsDetails{value: val, isSet: true}
}

func (v NullableScriptsDetails) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableScriptsDetails) UnmarshalJSON(src []byte) error {
	v.isSet = true
