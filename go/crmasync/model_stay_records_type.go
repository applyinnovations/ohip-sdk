...
type StayRecordsType struct {
	...
	// Specifies the confirmation number. If externalReservationId is not passed as part of POST stayRecords API then length of confirmation number should be less than 43 digits
