...
type ProfilesMatchType struct {
	...
	// Description of the processing message while merging profiles.
...
// GetProcessingMessage returns the ProcessingMessage field value if set, zero value otherwise.
func (o *ProfilesMatchType) GetProcessingMessage() string {
	if o == nil || IsNil(o.ProcessingMessage) {
		var ret string
		return ret
	}
	return *o.ProcessingMessage
}

// GetProcessingMessageOk returns a tuple with the ProcessingMessage field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ProfilesMatchType) GetProcessingMessageOk() (*string, bool) {
	if o == nil || IsNil(o.ProcessingMessage) {
		return nil, false
	}
	return o.ProcessingMessage, true
}

// HasProcessingMessage returns a boolean if a field has been set.
func (o *ProfilesMatchType) HasProcessingMessage() bool {
	if o != nil && !IsNil(o.ProcessingMessage) {
		return true
	}
...
// SetProcessingMessage gets a reference to the given string and assigns it to the ProcessingMessage field.
func (o *ProfilesMatchType) SetProcessingMessage(v string) {
	o.ProcessingMessage = &v
}
...
func (o ProfilesMatchType) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.ProcessingMessage) {
		toSerialize["processingMessage"] = o.ProcessingMessage
	}
