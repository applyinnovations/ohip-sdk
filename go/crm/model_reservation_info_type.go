...
type ReservationInfoType struct {
	...
	ParentReservationId *ReservationId `json:"parentReservationId,omitempty"`
...
// GetParentReservationId returns the ParentReservationId field value if set, zero value otherwise.
func (o *ReservationInfoType) GetParentReservationId() ReservationId {
	if o == nil || IsNil(o.ParentReservationId) {
		var ret ReservationId
		return ret
	}
	return *o.ParentReservationId
}

// GetParentReservationIdOk returns a tuple with the ParentReservationId field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ReservationInfoType) GetParentReservationIdOk() (*ReservationId, bool) {
	if o == nil || IsNil(o.ParentReservationId) {
		return nil, false
	}
	return o.ParentReservationId, true
}
...
// SetParentReservationId gets a reference to the given ReservationId and assigns it to the ParentReservationId field.
func (o *ReservationInfoType) SetParentReservationId(v ReservationId) {
	o.ParentReservationId = &v
}
...
func (o ReservationInfoType) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.ParentReservationId) {
		toSerialize["parentReservationId"] = o.ParentReservationId
	}
	if !IsNil(o.RoomStay) {
