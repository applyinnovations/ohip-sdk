...
// checks if the CompanyProfileTypeEmails type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CompanyProfileTypeEmails{}

// CompanyProfileTypeEmails List of email address for the customer.
type CompanyProfileTypeEmails struct {
...
func (o CompanyProfileTypeEmails) MarshalJSON() ([]byte, error) {
...
func (o CompanyProfileTypeEmails) ToMap() (map[string]interface{}, error) {
...
type NullableCompanyProfileTypeEmails struct {
	value *CompanyProfileTypeEmails
	isSet bool
}

func (v NullableCompanyProfileTypeEmails) Get() *CompanyProfileTypeEmails {
	return v.value
}

func (v *NullableCompanyProfileTypeEmails) Set(val *CompanyProfileTypeEmails) {
	v.value = val
	v.isSet = true
}

func (v NullableCompanyProfileTypeEmails) IsSet() bool {
	return v.isSet
}

func (v *NullableCompanyProfileTypeEmails) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCompanyProfileTypeEmails(val *CompanyProfileTypeEmails) *NullableCompanyProfileTypeEmails {
	return &NullableCompanyProfileTypeEmails{value: val, isSet: true}
}

func (v NullableCompanyProfileTypeEmails) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCompanyProfileTypeEmails) UnmarshalJSON(src []byte) error {
	v.isSet = true
