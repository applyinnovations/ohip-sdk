...
type CompanyType struct {
	...
	// Large company name to be used in the Invoice/Credit Bill.
	LongAccountName *string `json:"longAccountName,omitempty"`
}
...
func (o *CompanyType) GetLongAccountName() string {
	if o == nil || IsNil(o.LongAccountName) {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *CompanyType) GetLongAccountNameOk() (*string, bool) {
	if o == nil || IsNil(o.LongAccountName) {
		return nil, false
	}
...
func (o *CompanyType) HasLongAccountName() bool {
	if o != nil && !IsNil(o.LongAccountName) {
		return true
	}
...
func (o *CompanyType) SetLongAccountName(v string) {
	o.LongAccountName = &v
}
...
func (o CompanyType) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.LongAccountName) {
		toSerialize["longAccountName"] = o.LongAccountName
	}
