...
type MemberPointToExpireType struct {
	// Current expiry date for the member award points.
	PointsExpiryDate *string `json:"pointsExpiryDate,omitempty"`
	// Original expiry date for the member award points.
	OriginalPointsExpiryDate *string `json:"originalPointsExpiryDate,omitempty"`
...
// GetOriginalPointsExpiryDate returns the OriginalPointsExpiryDate field value if set, zero value otherwise.
func (o *MemberPointToExpireType) GetOriginalPointsExpiryDate() string {
	if o == nil || IsNil(o.OriginalPointsExpiryDate) {
		var ret string
		return ret
	}
	return *o.OriginalPointsExpiryDate
}

// GetOriginalPointsExpiryDateOk returns a tuple with the OriginalPointsExpiryDate field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *MemberPointToExpireType) GetOriginalPointsExpiryDateOk() (*string, bool) {
	if o == nil || IsNil(o.OriginalPointsExpiryDate) {
		return nil, false
	}
	return o.OriginalPointsExpiryDate, true
}

// HasOriginalPointsExpiryDate returns a boolean if a field has been set.
func (o *MemberPointToExpireType) HasOriginalPointsExpiryDate() bool {
	if o != nil && !IsNil(o.OriginalPointsExpiryDate) {
		return true
	}
...
// SetOriginalPointsExpiryDate gets a reference to the given string and assigns it to the OriginalPointsExpiryDate field.
func (o *MemberPointToExpireType) SetOriginalPointsExpiryDate(v string) {
	o.OriginalPointsExpiryDate = &v
}
...
func (o MemberPointToExpireType) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.OriginalPointsExpiryDate) {
		toSerialize["originalPointsExpiryDate"] = o.OriginalPointsExpiryDate
	}
