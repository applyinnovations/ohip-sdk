...
type AirlineTransactionsStatus struct {
	...
	Transactions []AirlineTransactionType `json:"transactions,omitempty"`
...
func (o *AirlineTransactionsStatus) GetTransactions() []AirlineTransactionType {
	if o == nil || IsNil(o.Transactions) {
		var ret []AirlineTransactionType
		return ret
	}
...
// SetTransactions gets a reference to the given []AirlineTransactionType and assigns it to the Transactions field.
