...
type PrivacyInfoType struct {
	...
	// Customized privacy codes
	CustomizedPrivacyCodes []CustomizedPrivacyCodesType `json:"customizedPrivacyCodes,omitempty"`
}
...
// GetCustomizedPrivacyCodes returns the CustomizedPrivacyCodes field value if set, zero value otherwise.
func (o *PrivacyInfoType) GetCustomizedPrivacyCodes() []CustomizedPrivacyCodesType {
	if o == nil || IsNil(o.CustomizedPrivacyCodes) {
		var ret []CustomizedPrivacyCodesType
		return ret
	}
	return o.CustomizedPrivacyCodes
}

// GetCustomizedPrivacyCodesOk returns a tuple with the CustomizedPrivacyCodes field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *PrivacyInfoType) GetCustomizedPrivacyCodesOk() ([]CustomizedPrivacyCodesType, bool) {
	if o == nil || IsNil(o.CustomizedPrivacyCodes) {
		return nil, false
	}
	return o.CustomizedPrivacyCodes, true
}

// HasCustomizedPrivacyCodes returns a boolean if a field has been set.
func (o *PrivacyInfoType) HasCustomizedPrivacyCodes() bool {
	if o != nil && !IsNil(o.CustomizedPrivacyCodes) {
		return true
	}
...
// SetCustomizedPrivacyCodes gets a reference to the given []CustomizedPrivacyCodesType and assigns it to the CustomizedPrivacyCodes field.
func (o *PrivacyInfoType) SetCustomizedPrivacyCodes(v []CustomizedPrivacyCodesType) {
	o.CustomizedPrivacyCodes = v
}
...
func (o PrivacyInfoType) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.CustomizedPrivacyCodes) {
		toSerialize["customizedPrivacyCodes"] = o.CustomizedPrivacyCodes
	}
