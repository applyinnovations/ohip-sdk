...
// checks if the CompanyProfileTypeAddresses type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CompanyProfileTypeAddresses{}

// CompanyProfileTypeAddresses List of customer addresses.
type CompanyProfileTypeAddresses struct {
...
func NewCompanyProfileTypeAddresses() *CompanyProfileTypeAddresses {
	this := CompanyProfileTypeAddresses{}
	return &this
}
...
func (o CompanyProfileTypeAddresses) MarshalJSON() ([]byte, error) {
...
func (o CompanyProfileTypeAddresses) ToMap() (map[string]interface{}, error) {
...
type NullableCompanyProfileTypeAddresses struct {
	value *CompanyProfileTypeAddresses
	isSet bool
}

func (v NullableCompanyProfileTypeAddresses) Get() *CompanyProfileTypeAddresses {
	return v.value
}

func (v *NullableCompanyProfileTypeAddresses) Set(val *CompanyProfileTypeAddresses) {
	v.value = val
	v.isSet = true
}

func (v NullableCompanyProfileTypeAddresses) IsSet() bool {
	return v.isSet
}

func (v *NullableCompanyProfileTypeAddresses) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCompanyProfileTypeAddresses(val *CompanyProfileTypeAddresses) *NullableCompanyProfileTypeAddresses {
	return &NullableCompanyProfileTypeAddresses{value: val, isSet: true}
}

func (v NullableCompanyProfileTypeAddresses) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCompanyProfileTypeAddresses) UnmarshalJSON(src []byte) error {
	v.isSet = true
