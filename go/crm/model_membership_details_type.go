...
// MembershipDetailsType Details of membership transactions summary such as the membership details, transactions summary, points summary, etc.
...
func (o *MembershipDetailsType) GetReferredMemNameId() int32 {
...
// and a boolean to check if the value has been set.
func (o *MembershipDetailsType) GetReferredMemNameIdOk() (*int32, bool) {
	if o == nil || IsNil(o.ReferredMemNameId) {
		return nil, false
	}
...
func (o *MembershipDetailsType) HasReferredMemNameId() bool {
	if o != nil && !IsNil(o.ReferredMemNameId) {
		return true
	}
...
func (o *MembershipDetailsType) SetReferredMemNameId(v int32) {
	o.ReferredMemNameId = &v
}

// GetReferredDisplayName returns the ReferredDisplayName field value if set, zero value otherwise.
func (o *MembershipDetailsType) GetReferredDisplayName() string {
...
// and a boolean to check if the value has been set.
func (o *MembershipDetailsType) GetReferredDisplayNameOk() (*string, bool) {
	if o == nil || IsNil(o.ReferredDisplayName) {
		return nil, false
	}
...
func (o *MembershipDetailsType) HasReferredDisplayName() bool {
	if o != nil && !IsNil(o.ReferredDisplayName) {
		return true
	}
...
func (o *MembershipDetailsType) SetReferredDisplayName(v string) {
