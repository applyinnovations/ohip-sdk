...
func (o *ProfileStatisticsbyYearSummaryType) GetNetRevenueByTransactionType() []StatisticsRevenueTypeType {
...
// and a boolean to check if the value has been set.
func (o *ProfileStatisticsbyYearSummaryType) GetNetRevenueByTransactionTypeOk() ([]StatisticsRevenueTypeType, bool) {
	if o == nil || IsNil(o.NetRevenueByTransactionType) {
		return nil, false
	}
...
func (o *ProfileStatisticsbyYearSummaryType) HasNetRevenueByTransactionType() bool {
	if o != nil && !IsNil(o.NetRevenueByTransactionType) {
		return true
	}
...
func (o *ProfileStatisticsbyYearSummaryType) SetNetRevenueByTransactionType(v []StatisticsRevenueTypeType) {
