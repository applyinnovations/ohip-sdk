...
type ProfileMembershipType struct {
	...
	// Indicator that implies if membership type is a Primary Membership Type. This attribute is only applicable when fetching information using get operations and not used in post and put operations.
	...
	AutoPopulateFromName *bool `json:"autoPopulateFromName,omitempty"`
	// Name id this profile was referred by.
	ReferredByMembershipNameId *int32 `json:"referredByMembershipNameId,omitempty"`
	// Display name this profile was referred by.
	ReferredByDisplayName *string `json:"referredByDisplayName,omitempty"`
}
...
func NewProfileMembershipType() *ProfileMembershipType {
	...
	var autoPopulateFromName bool = false
	this.AutoPopulateFromName = &autoPopulateFromName
	return &this
}
...
// GetAutoPopulateFromName returns the AutoPopulateFromName field value if set, zero value otherwise.
func (o *ProfileMembershipType) GetAutoPopulateFromName() bool {
	if o == nil || IsNil(o.AutoPopulateFromName) {
		var ret bool
		return ret
	}
	return *o.AutoPopulateFromName
}

// GetAutoPopulateFromNameOk returns a tuple with the AutoPopulateFromName field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ProfileMembershipType) GetAutoPopulateFromNameOk() (*bool, bool) {
	if o == nil || IsNil(o.AutoPopulateFromName) {
		return nil, false
	}
	return o.AutoPopulateFromName, true
}
...
// SetAutoPopulateFromName gets a reference to the given bool and assigns it to the AutoPopulateFromName field.
func (o *ProfileMembershipType) SetAutoPopulateFromName(v bool) {
	o.AutoPopulateFromName = &v
}

// GetReferredByMembershipNameId returns the ReferredByMembershipNameId field value if set, zero value otherwise.
func (o *ProfileMembershipType) GetReferredByMembershipNameId() int32 {
	if o == nil || IsNil(o.ReferredByMembershipNameId) {
		var ret int32
		return ret
	}
	return *o.ReferredByMembershipNameId
}

// GetReferredByMembershipNameIdOk returns a tuple with the ReferredByMembershipNameId field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ProfileMembershipType) GetReferredByMembershipNameIdOk() (*int32, bool) {
	if o == nil || IsNil(o.ReferredByMembershipNameId) {
		return nil, false
	}
	return o.ReferredByMembershipNameId, true
}

// HasReferredByMembershipNameId returns a boolean if a field has been set.
func (o *ProfileMembershipType) HasReferredByMembershipNameId() bool {
	if o != nil && !IsNil(o.ReferredByMembershipNameId) {
		return true
	}
...
// SetReferredByMembershipNameId gets a reference to the given int32 and assigns it to the ReferredByMembershipNameId field.
func (o *ProfileMembershipType) SetReferredByMembershipNameId(v int32) {
	o.ReferredByMembershipNameId = &v
}

// GetReferredByDisplayName returns the ReferredByDisplayName field value if set, zero value otherwise.
func (o *ProfileMembershipType) GetReferredByDisplayName() string {
	if o == nil || IsNil(o.ReferredByDisplayName) {
		var ret string
		return ret
	}
	return *o.ReferredByDisplayName
}

// GetReferredByDisplayNameOk returns a tuple with the ReferredByDisplayName field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ProfileMembershipType) GetReferredByDisplayNameOk() (*string, bool) {
	if o == nil || IsNil(o.ReferredByDisplayName) {
		return nil, false
	}
	return o.ReferredByDisplayName, true
}

// HasReferredByDisplayName returns a boolean if a field has been set.
func (o *ProfileMembershipType) HasReferredByDisplayName() bool {
	if o != nil && !IsNil(o.ReferredByDisplayName) {
		return true
	}
...
// SetReferredByDisplayName gets a reference to the given string and assigns it to the ReferredByDisplayName field.
func (o *ProfileMembershipType) SetReferredByDisplayName(v string) {
	o.ReferredByDisplayName = &v
}
...
func (o ProfileMembershipType) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.AutoPopulateFromName) {
		toSerialize["autoPopulateFromName"] = o.AutoPopulateFromName
	}
	if !IsNil(o.ReferredByMembershipNameId) {
		toSerialize["referredByMembershipNameId"] = o.ReferredByMembershipNameId
	}
	if !IsNil(o.ReferredByDisplayName) {
		toSerialize["referredByDisplayName"] = o.ReferredByDisplayName
	}
