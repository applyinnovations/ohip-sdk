...
type ProfileSummaryType struct {
	...
	ProfileSourceCode *string `json:"profileSourceCode,omitempty"`
}
...
// GetProfileSourceCode returns the ProfileSourceCode field value if set, zero value otherwise.
func (o *ProfileSummaryType) GetProfileSourceCode() string {
	if o == nil || IsNil(o.ProfileSourceCode) {
		var ret string
		return ret
	}
	return *o.ProfileSourceCode
}

// GetProfileSourceCodeOk returns a tuple with the ProfileSourceCode field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ProfileSummaryType) GetProfileSourceCodeOk() (*string, bool) {
	if o == nil || IsNil(o.ProfileSourceCode) {
		return nil, false
	}
	return o.ProfileSourceCode, true
}
...
// SetProfileSourceCode gets a reference to the given string and assigns it to the ProfileSourceCode field.
func (o *ProfileSummaryType) SetProfileSourceCode(v string) {
	o.ProfileSourceCode = &v
}
...
func (o ProfileSummaryType) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.ProfileSourceCode) {
		toSerialize["profileSourceCode"] = o.ProfileSourceCode
	}
