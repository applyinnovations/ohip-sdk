...
// checks if the MemberCardHistoryList type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MemberCardHistoryList{}

// MemberCardHistoryList Response object for member card history.
type MemberCardHistoryList struct {
	// Contains list of card history of a member.
	MemberCardHistoryList []MembershipCardHistoryType `json:"memberCardHistoryList,omitempty"`
...
// GetMemberCardHistoryList returns the MemberCardHistoryList field value if set, zero value otherwise.
func (o *MemberCardHistoryList) GetMemberCardHistoryList() []MembershipCardHistoryType {
	if o == nil || IsNil(o.MemberCardHistoryList) {
		var ret []MembershipCardHistoryType
		return ret
	}
	return o.MemberCardHistoryList
}

// GetMemberCardHistoryListOk returns a tuple with the MemberCardHistoryList field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *MemberCardHistoryList) GetMemberCardHistoryListOk() ([]MembershipCardHistoryType, bool) {
	if o == nil || IsNil(o.MemberCardHistoryList) {
		return nil, false
	}
	return o.MemberCardHistoryList, true
}
...
// SetMemberCardHistoryList gets a reference to the given []MembershipCardHistoryType and assigns it to the MemberCardHistoryList field.
func (o *MemberCardHistoryList) SetMemberCardHistoryList(v []MembershipCardHistoryType) {
	o.MemberCardHistoryList = v
}
...
func (o MemberCardHistoryList) MarshalJSON() ([]byte, error) {
...
func (o MemberCardHistoryList) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.MemberCardHistoryList) {
		toSerialize["memberCardHistoryList"] = o.MemberCardHistoryList
	}
...
type NullableMemberCardHistoryList struct {
	value *MemberCardHistoryList
	isSet bool
}

func (v NullableMemberCardHistoryList) Get() *MemberCardHistoryList {
	return v.value
}

func (v *NullableMemberCardHistoryList) Set(val *MemberCardHistoryList) {
	v.value = val
	v.isSet = true
}

func (v NullableMemberCardHistoryList) IsSet() bool {
	return v.isSet
}

func (v *NullableMemberCardHistoryList) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMemberCardHistoryList(val *MemberCardHistoryList) *NullableMemberCardHistoryList {
	return &NullableMemberCardHistoryList{value: val, isSet: true}
}

func (v NullableMemberCardHistoryList) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMemberCardHistoryList) UnmarshalJSON(src []byte) error {
	v.isSet = true
