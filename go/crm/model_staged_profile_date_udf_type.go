...
// checks if the StagedProfileDateUDFType type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &StagedProfileDateUDFType{}

// StagedProfileDateUDFType Used to hold user defined field of Date Type.
type StagedProfileDateUDFType struct {
...
func (o StagedProfileDateUDFType) MarshalJSON() ([]byte, error) {
...
func (o StagedProfileDateUDFType) ToMap() (map[string]interface{}, error) {
...
type NullableStagedProfileDateUDFType struct {
	value *StagedProfileDateUDFType
	isSet bool
}

func (v NullableStagedProfileDateUDFType) Get() *StagedProfileDateUDFType {
	return v.value
}

func (v *NullableStagedProfileDateUDFType) Set(val *StagedProfileDateUDFType) {
	v.value = val
	v.isSet = true
}

func (v NullableStagedProfileDateUDFType) IsSet() bool {
	return v.isSet
}

func (v *NullableStagedProfileDateUDFType) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableStagedProfileDateUDFType(val *StagedProfileDateUDFType) *NullableStagedProfileDateUDFType {
	return &NullableStagedProfileDateUDFType{value: val, isSet: true}
}

func (v NullableStagedProfileDateUDFType) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableStagedProfileDateUDFType) UnmarshalJSON(src []byte) error {
	v.isSet = true
