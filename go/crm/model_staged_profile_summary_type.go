...
type StagedProfileSummaryType struct {
	...
	InternalProfileName *ProfileNameType `json:"internalProfileName,omitempty"`
	// Indicates the primary membership card number of a staged profile
	PrimaryMembershipCardNo *string `json:"primaryMembershipCardNo,omitempty"`
	...
	StagedProfileReasons []StagedReasonsType `json:"stagedProfileReasons,omitempty"`
...
// GetInternalProfileName returns the InternalProfileName field value if set, zero value otherwise.
func (o *StagedProfileSummaryType) GetInternalProfileName() ProfileNameType {
	if o == nil || IsNil(o.InternalProfileName) {
		var ret ProfileNameType
		return ret
	}
	return *o.InternalProfileName
}

// GetInternalProfileNameOk returns a tuple with the InternalProfileName field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *StagedProfileSummaryType) GetInternalProfileNameOk() (*ProfileNameType, bool) {
	if o == nil || IsNil(o.InternalProfileName) {
		return nil, false
	}
	return o.InternalProfileName, true
}
...
// SetInternalProfileName gets a reference to the given ProfileNameType and assigns it to the InternalProfileName field.
func (o *StagedProfileSummaryType) SetInternalProfileName(v ProfileNameType) {
	o.InternalProfileName = &v
}

// GetPrimaryMembershipCardNo returns the PrimaryMembershipCardNo field value if set, zero value otherwise.
func (o *StagedProfileSummaryType) GetPrimaryMembershipCardNo() string {
	if o == nil || IsNil(o.PrimaryMembershipCardNo) {
		var ret string
		return ret
	}
	return *o.PrimaryMembershipCardNo
}

// GetPrimaryMembershipCardNoOk returns a tuple with the PrimaryMembershipCardNo field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *StagedProfileSummaryType) GetPrimaryMembershipCardNoOk() (*string, bool) {
	if o == nil || IsNil(o.PrimaryMembershipCardNo) {
		return nil, false
	}
	return o.PrimaryMembershipCardNo, true
}
...
// SetPrimaryMembershipCardNo gets a reference to the given string and assigns it to the PrimaryMembershipCardNo field.
func (o *StagedProfileSummaryType) SetPrimaryMembershipCardNo(v string) {
	o.PrimaryMembershipCardNo = &v
}
...
func (o *StagedProfileSummaryType) GetMembershipExpirationDate() string {
	if o == nil || IsNil(o.MembershipExpirationDate) {
		var ret string
		return ret
	}
...
// SetMembershipExpirationDate gets a reference to the given string and assigns it to the MembershipExpirationDate field.
...
// GetStagedProfileReasons returns the StagedProfileReasons field value if set, zero value otherwise.
func (o *StagedProfileSummaryType) GetStagedProfileReasons() []StagedReasonsType {
	if o == nil || IsNil(o.StagedProfileReasons) {
		var ret []StagedReasonsType
		return ret
	}
	return o.StagedProfileReasons
}

// GetStagedProfileReasonsOk returns a tuple with the StagedProfileReasons field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *StagedProfileSummaryType) GetStagedProfileReasonsOk() ([]StagedReasonsType, bool) {
	if o == nil || IsNil(o.StagedProfileReasons) {
		return nil, false
	}
	return o.StagedProfileReasons, true
}
...
// SetStagedProfileReasons gets a reference to the given []StagedReasonsType and assigns it to the StagedProfileReasons field.
func (o *StagedProfileSummaryType) SetStagedProfileReasons(v []StagedReasonsType) {
	o.StagedProfileReasons = v
}
...
func (o StagedProfileSummaryType) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.InternalProfileName) {
		toSerialize["internalProfileName"] = o.InternalProfileName
	}
	if !IsNil(o.PrimaryMembershipCardNo) {
		toSerialize["primaryMembershipCardNo"] = o.PrimaryMembershipCardNo
	}
	if !IsNil(o.MembershipEnrollmentCode) {
		toSerialize["membershipEnrollmentCode"] = o.MembershipEnrollmentCode
	}
	if !IsNil(o.MembershipExpirationDate) {
	...
	if !IsNil(o.StagedProfileReasons) {
		toSerialize["stagedProfileReasons"] = o.StagedProfileReasons
	}
