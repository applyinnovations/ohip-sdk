...
type ProfileType struct {
	...
	ProfileAccounts []ARAccountType `json:"profileAccounts,omitempty"`
	...
	// Unique Identifier of the Profile on the External System that would be fetched against flexFieldExternalProfileId. (For internal use only).
	FlexFieldExternalProfileId *string `json:"flexFieldExternalProfileId,omitempty"`
...
// GetProfileAccounts returns the ProfileAccounts field value if set, zero value otherwise.
func (o *ProfileType) GetProfileAccounts() []ARAccountType {
	if o == nil || IsNil(o.ProfileAccounts) {
		var ret []ARAccountType
		return ret
	}
	return o.ProfileAccounts
}

// GetProfileAccountsOk returns a tuple with the ProfileAccounts field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ProfileType) GetProfileAccountsOk() ([]ARAccountType, bool) {
	if o == nil || IsNil(o.ProfileAccounts) {
		return nil, false
	}
	return o.ProfileAccounts, true
}

// HasProfileAccounts returns a boolean if a field has been set.
func (o *ProfileType) HasProfileAccounts() bool {
	if o != nil && !IsNil(o.ProfileAccounts) {
		return true
	}
...
// SetProfileAccounts gets a reference to the given []ARAccountType and assigns it to the ProfileAccounts field.
func (o *ProfileType) SetProfileAccounts(v []ARAccountType) {
	o.ProfileAccounts = v
}
...
// GetFlexFieldExternalProfileId returns the FlexFieldExternalProfileId field value if set, zero value otherwise.
func (o *ProfileType) GetFlexFieldExternalProfileId() string {
	if o == nil || IsNil(o.FlexFieldExternalProfileId) {
		var ret string
		return ret
	}
	return *o.FlexFieldExternalProfileId
}

// GetFlexFieldExternalProfileIdOk returns a tuple with the FlexFieldExternalProfileId field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ProfileType) GetFlexFieldExternalProfileIdOk() (*string, bool) {
	if o == nil || IsNil(o.FlexFieldExternalProfileId) {
		return nil, false
	}
	return o.FlexFieldExternalProfileId, true
}

// HasFlexFieldExternalProfileId returns a boolean if a field has been set.
func (o *ProfileType) HasFlexFieldExternalProfileId() bool {
	if o != nil && !IsNil(o.FlexFieldExternalProfileId) {
		return true
	}
...
// SetFlexFieldExternalProfileId gets a reference to the given string and assigns it to the FlexFieldExternalProfileId field.
func (o *ProfileType) SetFlexFieldExternalProfileId(v string) {
	o.FlexFieldExternalProfileId = &v
}
...
func (o *ProfileType) GetInactiveReason() string {
	if o == nil || IsNil(o.InactiveReason) {
		var ret string
		return ret
	}
...
func (o ProfileType) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.ProfileAccounts) {
		toSerialize["profileAccounts"] = o.ProfileAccounts
	}
	...
	if !IsNil(o.FlexFieldExternalProfileId) {
		toSerialize["flexFieldExternalProfileId"] = o.FlexFieldExternalProfileId
	}
