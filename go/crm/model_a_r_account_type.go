...
type ARAccountType struct {
	...
	AccountIndicators []IndicatorType `json:"accountIndicators,omitempty"`
...
// SetAccountIndicators gets a reference to the given []IndicatorType and assigns it to the AccountIndicators field.
