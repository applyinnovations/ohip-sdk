...
type MembershipIssueAwards struct {
	...
	MembershipAwardsList []MembershipAwardListType `json:"membershipAwardsList,omitempty"`
...
func (o *MembershipIssueAwards) GetMembershipAwardsList() []MembershipAwardListType {
	if o == nil || IsNil(o.MembershipAwardsList) {
		var ret []MembershipAwardListType
		return ret
	}
...
// SetMembershipAwardsList gets a reference to the given []MembershipAwardListType and assigns it to the MembershipAwardsList field.
