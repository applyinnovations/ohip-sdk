...
type MembershipTransactionRevenueType struct {
	...
	// Indicates the Revenue type associated to Revenue. This is mutually exclusive to Transaction code.
	RevenueType *string `json:"revenueType,omitempty"`
	// Indicates the Transaction code associated to Revenue. This is mutually exclusive to Revenue type.
...
func (o *MembershipTransactionRevenueType) GetTransactionCode() string {
...
// and a boolean to check if the value has been set.
func (o *MembershipTransactionRevenueType) GetTransactionCodeOk() (*string, bool) {
	if o == nil || IsNil(o.TransactionCode) {
		return nil, false
	}
...
func (o *MembershipTransactionRevenueType) HasTransactionCode() bool {
	if o != nil && !IsNil(o.TransactionCode) {
		return true
	}
...
func (o *MembershipTransactionRevenueType) SetTransactionCode(v string) {
	o.TransactionCode = &v
}

// GetTransactionCodeDescription returns the TransactionCodeDescription field value if set, zero value otherwise.
func (o *MembershipTransactionRevenueType) GetTransactionCodeDescription() string {
...
// and a boolean to check if the value has been set.
func (o *MembershipTransactionRevenueType) GetTransactionCodeDescriptionOk() (*string, bool) {
	if o == nil || IsNil(o.TransactionCodeDescription) {
		return nil, false
	}
...
func (o *MembershipTransactionRevenueType) HasTransactionCodeDescription() bool {
	if o != nil && !IsNil(o.TransactionCodeDescription) {
		return true
	}
...
func (o *MembershipTransactionRevenueType) SetTransactionCodeDescription(v string) {
