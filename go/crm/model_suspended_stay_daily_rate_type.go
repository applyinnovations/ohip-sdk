...
type SuspendedStayDailyRateType struct {
	...
	// Duration or length of the stay. The expected value is 1 for multiple Daily Rate records, and the actual number of nights for a single Daily Rate record.
	NumberDays *float32 `json:"numberDays,omitempty"`
}
...
// GetNumberDays returns the NumberDays field value if set, zero value otherwise.
func (o *SuspendedStayDailyRateType) GetNumberDays() float32 {
	if o == nil || IsNil(o.NumberDays) {
		var ret float32
		return ret
	}
	return *o.NumberDays
...
// GetNumberDaysOk returns a tuple with the NumberDays field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *SuspendedStayDailyRateType) GetNumberDaysOk() (*float32, bool) {
	if o == nil || IsNil(o.NumberDays) {
		return nil, false
	}
	return o.NumberDays, true
}

// HasNumberDays returns a boolean if a field has been set.
func (o *SuspendedStayDailyRateType) HasNumberDays() bool {
	if o != nil && !IsNil(o.NumberDays) {
		return true
	}
...
// SetNumberDays gets a reference to the given float32 and assigns it to the NumberDays field.
func (o *SuspendedStayDailyRateType) SetNumberDays(v float32) {
	o.NumberDays = &v
}
...
func (o SuspendedStayDailyRateType) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.NumberDays) {
		toSerialize["numberDays"] = o.NumberDays
	}
