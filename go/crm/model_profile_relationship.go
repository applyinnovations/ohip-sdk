...
// checks if the ProfileRelationship type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ProfileRelationship{}

// ProfileRelationship Request object for creating profile relationship.
...
func (o ProfileRelationship) MarshalJSON() ([]byte, error) {
...
func (o ProfileRelationship) ToMap() (map[string]interface{}, error) {
...
type NullableProfileRelationship struct {
	value *ProfileRelationship
	isSet bool
}

func (v NullableProfileRelationship) Get() *ProfileRelationship {
	return v.value
}

func (v *NullableProfileRelationship) Set(val *ProfileRelationship) {
	v.value = val
	v.isSet = true
}

func (v NullableProfileRelationship) IsSet() bool {
	return v.isSet
}

func (v *NullableProfileRelationship) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableProfileRelationship(val *ProfileRelationship) *NullableProfileRelationship {
	return &NullableProfileRelationship{value: val, isSet: true}
}

func (v NullableProfileRelationship) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableProfileRelationship) UnmarshalJSON(src []byte) error {
	v.isSet = true
