...
// checks if the CompanyProfileTypeKeywords type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CompanyProfileTypeKeywords{}

// CompanyProfileTypeKeywords List of customer keywords.
type CompanyProfileTypeKeywords struct {
...
func NewCompanyProfileTypeKeywords() *CompanyProfileTypeKeywords {
	this := CompanyProfileTypeKeywords{}
	return &this
}
...
func (o CompanyProfileTypeKeywords) MarshalJSON() ([]byte, error) {
...
func (o CompanyProfileTypeKeywords) ToMap() (map[string]interface{}, error) {
...
type NullableCompanyProfileTypeKeywords struct {
	value *CompanyProfileTypeKeywords
	isSet bool
}

func (v NullableCompanyProfileTypeKeywords) Get() *CompanyProfileTypeKeywords {
	return v.value
}

func (v *NullableCompanyProfileTypeKeywords) Set(val *CompanyProfileTypeKeywords) {
	v.value = val
	v.isSet = true
}

func (v NullableCompanyProfileTypeKeywords) IsSet() bool {
	return v.isSet
}

func (v *NullableCompanyProfileTypeKeywords) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCompanyProfileTypeKeywords(val *CompanyProfileTypeKeywords) *NullableCompanyProfileTypeKeywords {
	return &NullableCompanyProfileTypeKeywords{value: val, isSet: true}
}

func (v NullableCompanyProfileTypeKeywords) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCompanyProfileTypeKeywords) UnmarshalJSON(src []byte) error {
	v.isSet = true
