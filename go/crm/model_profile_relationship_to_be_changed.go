...
// checks if the ProfileRelationshipToBeChanged type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ProfileRelationshipToBeChanged{}

// ProfileRelationshipToBeChanged Request object for changing profile relationship.
type ProfileRelationshipToBeChanged struct {
...
func NewProfileRelationshipToBeChanged() *ProfileRelationshipToBeChanged {
	this := ProfileRelationshipToBeChanged{}
	return &this
}
...
func (o ProfileRelationshipToBeChanged) MarshalJSON() ([]byte, error) {
...
func (o ProfileRelationshipToBeChanged) ToMap() (map[string]interface{}, error) {
...
type NullableProfileRelationshipToBeChanged struct {
	value *ProfileRelationshipToBeChanged
	isSet bool
}

func (v NullableProfileRelationshipToBeChanged) Get() *ProfileRelationshipToBeChanged {
	return v.value
}

func (v *NullableProfileRelationshipToBeChanged) Set(val *ProfileRelationshipToBeChanged) {
	v.value = val
	v.isSet = true
}

func (v NullableProfileRelationshipToBeChanged) IsSet() bool {
	return v.isSet
}

func (v *NullableProfileRelationshipToBeChanged) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableProfileRelationshipToBeChanged(val *ProfileRelationshipToBeChanged) *NullableProfileRelationshipToBeChanged {
	return &NullableProfileRelationshipToBeChanged{value: val, isSet: true}
}

func (v NullableProfileRelationshipToBeChanged) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableProfileRelationshipToBeChanged) UnmarshalJSON(src []byte) error {
	v.isSet = true
