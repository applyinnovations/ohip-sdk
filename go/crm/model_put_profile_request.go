...
func (o *PutProfileRequest) GetCopyInstructions() CopyInstructionsType {
...
// and a boolean to check if the value has been set.
func (o *PutProfileRequest) GetCopyInstructionsOk() (*CopyInstructionsType, bool) {
	if o == nil || IsNil(o.CopyInstructions) {
		return nil, false
	}
...
func (o *PutProfileRequest) HasCopyInstructions() bool {
	if o != nil && !IsNil(o.CopyInstructions) {
		return true
	}
...
func (o *PutProfileRequest) SetCopyInstructions(v CopyInstructionsType) {
