...
// checks if the CalculatedPointsType type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CalculatedPointsType{}

// CalculatedPointsType Summary of Points Accrued for current transaction.
type CalculatedPointsType struct {
	// Details of Points Accrued for the current points transaction.
	CalculatedPoint []CalculatedPointType `json:"calculatedPoint,omitempty"`
...
// SetCalculatedPoint gets a reference to the given []CalculatedPointType and assigns it to the CalculatedPoint field.
...
func (o CalculatedPointsType) MarshalJSON() ([]byte, error) {
...
func (o CalculatedPointsType) ToMap() (map[string]interface{}, error) {
...
type NullableCalculatedPointsType struct {
	value *CalculatedPointsType
	isSet bool
}

func (v NullableCalculatedPointsType) Get() *CalculatedPointsType {
	return v.value
}

func (v *NullableCalculatedPointsType) Set(val *CalculatedPointsType) {
	v.value = val
	v.isSet = true
}

func (v NullableCalculatedPointsType) IsSet() bool {
	return v.isSet
}

func (v *NullableCalculatedPointsType) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCalculatedPointsType(val *CalculatedPointsType) *NullableCalculatedPointsType {
	return &NullableCalculatedPointsType{value: val, isSet: true}
}

func (v NullableCalculatedPointsType) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCalculatedPointsType) UnmarshalJSON(src []byte) error {
	v.isSet = true
