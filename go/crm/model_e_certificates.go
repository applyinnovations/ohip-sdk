...
type ECertificates struct {
	...
	ECertificatesDetail []ECertificateType `json:"eCertificatesDetail,omitempty"`
...
// SetECertificatesDetail gets a reference to the given []ECertificateType and assigns it to the ECertificatesDetail field.
