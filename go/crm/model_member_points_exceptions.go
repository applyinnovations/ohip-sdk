...
// checks if the MemberPointsExceptions type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MemberPointsExceptions{}

// MemberPointsExceptions Response object for fetching membership points exceptions.
type MemberPointsExceptions struct {
	// A collection of membership points exceptions.
	MemberPointsExceptions []MemberPointsExceptionType `json:"memberPointsExceptions,omitempty"`
...
// GetMemberPointsExceptions returns the MemberPointsExceptions field value if set, zero value otherwise.
func (o *MemberPointsExceptions) GetMemberPointsExceptions() []MemberPointsExceptionType {
	if o == nil || IsNil(o.MemberPointsExceptions) {
		var ret []MemberPointsExceptionType
		return ret
	}
	return o.MemberPointsExceptions
}

// GetMemberPointsExceptionsOk returns a tuple with the MemberPointsExceptions field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *MemberPointsExceptions) GetMemberPointsExceptionsOk() ([]MemberPointsExceptionType, bool) {
	if o == nil || IsNil(o.MemberPointsExceptions) {
		return nil, false
	}
	return o.MemberPointsExceptions, true
}
...
// SetMemberPointsExceptions gets a reference to the given []MemberPointsExceptionType and assigns it to the MemberPointsExceptions field.
func (o *MemberPointsExceptions) SetMemberPointsExceptions(v []MemberPointsExceptionType) {
	o.MemberPointsExceptions = v
}
...
func (o MemberPointsExceptions) MarshalJSON() ([]byte, error) {
...
func (o MemberPointsExceptions) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.MemberPointsExceptions) {
		toSerialize["memberPointsExceptions"] = o.MemberPointsExceptions
	}
...
type NullableMemberPointsExceptions struct {
	value *MemberPointsExceptions
	isSet bool
}

func (v NullableMemberPointsExceptions) Get() *MemberPointsExceptions {
	return v.value
}

func (v *NullableMemberPointsExceptions) Set(val *MemberPointsExceptions) {
	v.value = val
	v.isSet = true
}

func (v NullableMemberPointsExceptions) IsSet() bool {
	return v.isSet
}

func (v *NullableMemberPointsExceptions) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMemberPointsExceptions(val *MemberPointsExceptions) *NullableMemberPointsExceptions {
	return &NullableMemberPointsExceptions{value: val, isSet: true}
}

func (v NullableMemberPointsExceptions) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMemberPointsExceptions) UnmarshalJSON(src []byte) error {
	v.isSet = true
