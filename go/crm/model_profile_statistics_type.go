...
type ProfileStatisticsType struct {
	...
	StayMembershipSummaryList *StayMembershipSummaryListType `json:"stayMembershipSummaryList,omitempty"`
...
// GetStayMembershipSummaryList returns the StayMembershipSummaryList field value if set, zero value otherwise.
func (o *ProfileStatisticsType) GetStayMembershipSummaryList() StayMembershipSummaryListType {
	if o == nil || IsNil(o.StayMembershipSummaryList) {
		var ret StayMembershipSummaryListType
		return ret
	}
	return *o.StayMembershipSummaryList
}

// GetStayMembershipSummaryListOk returns a tuple with the StayMembershipSummaryList field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ProfileStatisticsType) GetStayMembershipSummaryListOk() (*StayMembershipSummaryListType, bool) {
	if o == nil || IsNil(o.StayMembershipSummaryList) {
		return nil, false
	}
	return o.StayMembershipSummaryList, true
}

// HasStayMembershipSummaryList returns a boolean if a field has been set.
func (o *ProfileStatisticsType) HasStayMembershipSummaryList() bool {
	if o != nil && !IsNil(o.StayMembershipSummaryList) {
		return true
	}
...
// SetStayMembershipSummaryList gets a reference to the given StayMembershipSummaryListType and assigns it to the StayMembershipSummaryList field.
func (o *ProfileStatisticsType) SetStayMembershipSummaryList(v StayMembershipSummaryListType) {
	o.StayMembershipSummaryList = &v
}
...
func (o ProfileStatisticsType) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.StayMembershipSummaryList) {
		toSerialize["stayMembershipSummaryList"] = o.StayMembershipSummaryList
	}
