...
type ProfileSubscriptionType struct {
	...
	// This provides external resort for external profiles
	ExternalResort *string `json:"externalResort,omitempty"`
...
// GetExternalResort returns the ExternalResort field value if set, zero value otherwise.
func (o *ProfileSubscriptionType) GetExternalResort() string {
	if o == nil || IsNil(o.ExternalResort) {
		var ret string
		return ret
	}
	return *o.ExternalResort
}

// GetExternalResortOk returns a tuple with the ExternalResort field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ProfileSubscriptionType) GetExternalResortOk() (*string, bool) {
	if o == nil || IsNil(o.ExternalResort) {
		return nil, false
	}
	return o.ExternalResort, true
}

// HasExternalResort returns a boolean if a field has been set.
func (o *ProfileSubscriptionType) HasExternalResort() bool {
	if o != nil && !IsNil(o.ExternalResort) {
		return true
	}
...
// SetExternalResort gets a reference to the given string and assigns it to the ExternalResort field.
func (o *ProfileSubscriptionType) SetExternalResort(v string) {
	o.ExternalResort = &v
}
...
func (o ProfileSubscriptionType) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.ExternalResort) {
		toSerialize["externalResort"] = o.ExternalResort
	}
