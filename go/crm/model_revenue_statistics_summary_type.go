...
type RevenueStatisticsSummaryType struct {
	...
	RevenueDetails []RevenueStatisticsDetailType `json:"revenueDetails,omitempty"`
	RevenueBucketsSummary *RevenueBucketListType `json:"revenueBucketsSummary,omitempty"`
	RevenueTransactionCodes *RevenueTransactionCodeListType `json:"revenueTransactionCodes,omitempty"`
	// Year of the revenue.
...
func (o *RevenueStatisticsSummaryType) GetRevenueDetails() []RevenueStatisticsDetailType {
	if o == nil || IsNil(o.RevenueDetails) {
		var ret []RevenueStatisticsDetailType
		return ret
	}
...
// SetRevenueDetails gets a reference to the given []RevenueStatisticsDetailType and assigns it to the RevenueDetails field.
...
func (o *RevenueStatisticsSummaryType) GetRevenueTransactionCodes() RevenueTransactionCodeListType {
	if o == nil || IsNil(o.RevenueTransactionCodes) {
		var ret RevenueTransactionCodeListType
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *RevenueStatisticsSummaryType) GetRevenueTransactionCodesOk() (*RevenueTransactionCodeListType, bool) {
	if o == nil || IsNil(o.RevenueTransactionCodes) {
		return nil, false
	}
...
func (o *RevenueStatisticsSummaryType) HasRevenueTransactionCodes() bool {
	if o != nil && !IsNil(o.RevenueTransactionCodes) {
		return true
	}
...
// SetRevenueTransactionCodes gets a reference to the given RevenueTransactionCodeListType and assigns it to the RevenueTransactionCodes field.
func (o *RevenueStatisticsSummaryType) SetRevenueTransactionCodes(v RevenueTransactionCodeListType) {
