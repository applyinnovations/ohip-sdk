...
func (o *ProfileTransactionsType) GetReference() string {
...
// and a boolean to check if the value has been set.
func (o *ProfileTransactionsType) GetReferenceOk() (*string, bool) {
	if o == nil || IsNil(o.Reference) {
		return nil, false
	}
...
func (o *ProfileTransactionsType) HasReference() bool {
	if o != nil && !IsNil(o.Reference) {
		return true
	}
...
func (o *ProfileTransactionsType) SetReference(v string) {
	o.Reference = &v
}
