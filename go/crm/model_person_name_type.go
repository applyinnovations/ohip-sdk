...
type PersonNameType struct {
	// Salutation of honorific (e.g. Mr., Mrs., Ms., Miss, Dr.). Currently this attribute is not used for PUT and POST operations.
	...
	// Hold various name suffixes and letters (e.g. Jr., Sr., III, Ret., Esq.). Currently this attribute is not used for PUT and POST operations.
	...
	// Maternal/paternal name of the guest, required only for the SPAIN country mode.
...
func (o *PersonNameType) GetName2() string {
...
// and a boolean to check if the value has been set.
func (o *PersonNameType) GetName2Ok() (*string, bool) {
	if o == nil || IsNil(o.Name2) {
		return nil, false
	}
	return o.Name2, true
...
func (o *PersonNameType) HasName2() bool {
	if o != nil && !IsNil(o.Name2) {
		return true
	}
...
func (o *PersonNameType) SetName2(v string) {
	o.Name2 = &v
}

// GetName3 returns the Name3 field value if set, zero value otherwise.
func (o *PersonNameType) GetName3() string {
...
// and a boolean to check if the value has been set.
func (o *PersonNameType) GetName3Ok() (*string, bool) {
	if o == nil || IsNil(o.Name3) {
		return nil, false
	}
	return o.Name3, true
...
func (o *PersonNameType) HasName3() bool {
	if o != nil && !IsNil(o.Name3) {
		return true
	}
...
func (o *PersonNameType) SetName3(v string) {
	o.Name3 = &v
}
