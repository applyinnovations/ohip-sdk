...
type TelephoneType struct {
	...
	// Indicator to define if the Phone number is validated by the Phone Validation System.
...
func (o *TelephoneType) GetIsValidated() bool {
...
// and a boolean to check if the value has been set.
func (o *TelephoneType) GetIsValidatedOk() (*bool, bool) {
	if o == nil || IsNil(o.IsValidated) {
		return nil, false
	}
...
func (o *TelephoneType) HasIsValidated() bool {
	if o != nil && !IsNil(o.IsValidated) {
		return true
	}
...
func (o *TelephoneType) SetIsValidated(v bool) {
	o.IsValidated = &v
}
