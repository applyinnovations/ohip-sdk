...
// checks if the ProfileCommissionAccountCriteriaType type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ProfileCommissionAccountCriteriaType{}

// ProfileCommissionAccountCriteriaType Contains base info to determine profile commission bank account and code.
type ProfileCommissionAccountCriteriaType struct {
...
func NewProfileCommissionAccountCriteriaType() *ProfileCommissionAccountCriteriaType {
	this := ProfileCommissionAccountCriteriaType{}
	return &this
}
...
func (o ProfileCommissionAccountCriteriaType) MarshalJSON() ([]byte, error) {
...
func (o ProfileCommissionAccountCriteriaType) ToMap() (map[string]interface{}, error) {
...
type NullableProfileCommissionAccountCriteriaType struct {
	value *ProfileCommissionAccountCriteriaType
	isSet bool
}

func (v NullableProfileCommissionAccountCriteriaType) Get() *ProfileCommissionAccountCriteriaType {
	return v.value
}

func (v *NullableProfileCommissionAccountCriteriaType) Set(val *ProfileCommissionAccountCriteriaType) {
	v.value = val
	v.isSet = true
}

func (v NullableProfileCommissionAccountCriteriaType) IsSet() bool {
	return v.isSet
}

func (v *NullableProfileCommissionAccountCriteriaType) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableProfileCommissionAccountCriteriaType(val *ProfileCommissionAccountCriteriaType) *NullableProfileCommissionAccountCriteriaType {
	return &NullableProfileCommissionAccountCriteriaType{value: val, isSet: true}
}

func (v NullableProfileCommissionAccountCriteriaType) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableProfileCommissionAccountCriteriaType) UnmarshalJSON(src []byte) error {
	v.isSet = true
