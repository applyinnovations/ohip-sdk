...
func (o *StagedProfileURLType) GetUrl() URLType {
...
func (o *StagedProfileURLType) GetUrlOk() (*URLType, bool) {
	if o == nil || IsNil(o.Url) {
		return nil, false
	}
	return o.Url, true
...
func (o *StagedProfileURLType) HasUrl() bool {
	if o != nil && !IsNil(o.Url) {
		return true
	}
...
func (o *StagedProfileURLType) SetUrl(v URLType) {
	o.Url = &v
}
