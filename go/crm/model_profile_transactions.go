...
// checks if the ProfileTransactions type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ProfileTransactions{}

// ProfileTransactions Response of the WS operation FetchProfileTransactions.
type ProfileTransactions struct {
	// Transactions related to the Profile.
	ProfileTransactions []ProfileTransactionsType `json:"profileTransactions,omitempty"`
...
// GetProfileTransactions returns the ProfileTransactions field value if set, zero value otherwise.
func (o *ProfileTransactions) GetProfileTransactions() []ProfileTransactionsType {
	if o == nil || IsNil(o.ProfileTransactions) {
		var ret []ProfileTransactionsType
		return ret
	}
	return o.ProfileTransactions
}

// GetProfileTransactionsOk returns a tuple with the ProfileTransactions field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ProfileTransactions) GetProfileTransactionsOk() ([]ProfileTransactionsType, bool) {
	if o == nil || IsNil(o.ProfileTransactions) {
		return nil, false
	}
	return o.ProfileTransactions, true
}
...
// SetProfileTransactions gets a reference to the given []ProfileTransactionsType and assigns it to the ProfileTransactions field.
func (o *ProfileTransactions) SetProfileTransactions(v []ProfileTransactionsType) {
	o.ProfileTransactions = v
}
...
func (o ProfileTransactions) MarshalJSON() ([]byte, error) {
...
func (o ProfileTransactions) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.ProfileTransactions) {
		toSerialize["profileTransactions"] = o.ProfileTransactions
	}
...
type NullableProfileTransactions struct {
	value *ProfileTransactions
	isSet bool
}

func (v NullableProfileTransactions) Get() *ProfileTransactions {
	return v.value
}

func (v *NullableProfileTransactions) Set(val *ProfileTransactions) {
	v.value = val
	v.isSet = true
}

func (v NullableProfileTransactions) IsSet() bool {
	return v.isSet
}

func (v *NullableProfileTransactions) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableProfileTransactions(val *ProfileTransactions) *NullableProfileTransactions {
	return &NullableProfileTransactions{value: val, isSet: true}
}

func (v NullableProfileTransactions) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableProfileTransactions) UnmarshalJSON(src []byte) error {
	v.isSet = true
