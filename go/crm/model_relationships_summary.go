...
// checks if the RelationshipsSummary type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RelationshipsSummary{}

// RelationshipsSummary Contains details relationships related to a profile.
...
func (o RelationshipsSummary) MarshalJSON() ([]byte, error) {
...
func (o RelationshipsSummary) ToMap() (map[string]interface{}, error) {
...
type NullableRelationshipsSummary struct {
	value *RelationshipsSummary
	isSet bool
}

func (v NullableRelationshipsSummary) Get() *RelationshipsSummary {
	return v.value
}

func (v *NullableRelationshipsSummary) Set(val *RelationshipsSummary) {
	v.value = val
	v.isSet = true
}

func (v NullableRelationshipsSummary) IsSet() bool {
	return v.isSet
}

func (v *NullableRelationshipsSummary) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRelationshipsSummary(val *RelationshipsSummary) *NullableRelationshipsSummary {
	return &NullableRelationshipsSummary{value: val, isSet: true}
}

func (v NullableRelationshipsSummary) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRelationshipsSummary) UnmarshalJSON(src []byte) error {
	v.isSet = true
