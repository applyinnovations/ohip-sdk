...
type MembershipTransactionDetailsType struct {
	...
	ExceptionRejected *bool `json:"exceptionRejected,omitempty"`
...
func (o *MembershipTransactionDetailsType) GetReference() string {
...
// and a boolean to check if the value has been set.
func (o *MembershipTransactionDetailsType) GetReferenceOk() (*string, bool) {
	if o == nil || IsNil(o.Reference) {
		return nil, false
	}
...
func (o *MembershipTransactionDetailsType) HasReference() bool {
	if o != nil && !IsNil(o.Reference) {
		return true
	}
...
func (o *MembershipTransactionDetailsType) SetReference(v string) {
	o.Reference = &v
}
...
// GetExceptionRejected returns the ExceptionRejected field value if set, zero value otherwise.
func (o *MembershipTransactionDetailsType) GetExceptionRejected() bool {
	if o == nil || IsNil(o.ExceptionRejected) {
		var ret bool
		return ret
	}
	return *o.ExceptionRejected
}

// GetExceptionRejectedOk returns a tuple with the ExceptionRejected field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *MembershipTransactionDetailsType) GetExceptionRejectedOk() (*bool, bool) {
	if o == nil || IsNil(o.ExceptionRejected) {
		return nil, false
	}
	return o.ExceptionRejected, true
}
...
// SetExceptionRejected gets a reference to the given bool and assigns it to the ExceptionRejected field.
func (o *MembershipTransactionDetailsType) SetExceptionRejected(v bool) {
	o.ExceptionRejected = &v
}
...
func (o *MembershipTransactionDetailsType) GetMembershipCardNo() string {
...
// and a boolean to check if the value has been set.
func (o *MembershipTransactionDetailsType) GetMembershipCardNoOk() (*string, bool) {
	if o == nil || IsNil(o.MembershipCardNo) {
		return nil, false
	}
...
func (o *MembershipTransactionDetailsType) HasMembershipCardNo() bool {
	if o != nil && !IsNil(o.MembershipCardNo) {
		return true
	}
...
func (o *MembershipTransactionDetailsType) SetMembershipCardNo(v string) {
	o.MembershipCardNo = &v
}

// GetMembershipLevel returns the MembershipLevel field value if set, zero value otherwise.
func (o *MembershipTransactionDetailsType) GetMembershipLevel() string {
...
// and a boolean to check if the value has been set.
func (o *MembershipTransactionDetailsType) GetMembershipLevelOk() (*string, bool) {
	if o == nil || IsNil(o.MembershipLevel) {
		return nil, false
	}
...
func (o *MembershipTransactionDetailsType) HasMembershipLevel() bool {
	if o != nil && !IsNil(o.MembershipLevel) {
		return true
	}
...
func (o *MembershipTransactionDetailsType) SetMembershipLevel(v string) {
	o.MembershipLevel = &v
}

// GetUserName returns the UserName field value if set, zero value otherwise.
func (o *MembershipTransactionDetailsType) GetUserName() string {
...
// and a boolean to check if the value has been set.
func (o *MembershipTransactionDetailsType) GetUserNameOk() (*string, bool) {
	if o == nil || IsNil(o.UserName) {
		return nil, false
	}
...
func (o *MembershipTransactionDetailsType) HasUserName() bool {
	if o != nil && !IsNil(o.UserName) {
		return true
	}
...
func (o *MembershipTransactionDetailsType) SetUserName(v string) {
	o.UserName = &v
}
...
func (o MembershipTransactionDetailsType) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.ExceptionRejected) {
		toSerialize["exceptionRejected"] = o.ExceptionRejected
	}
