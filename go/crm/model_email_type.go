...
type EmailType struct {
	...
	// Indicator to define if the Email is validated by the Email Validation System.
...
func (o *EmailType) GetIsValidated() bool {
...
// and a boolean to check if the value has been set.
func (o *EmailType) GetIsValidatedOk() (*bool, bool) {
	if o == nil || IsNil(o.IsValidated) {
		return nil, false
	}
...
func (o *EmailType) HasIsValidated() bool {
	if o != nil && !IsNil(o.IsValidated) {
		return true
	}
...
func (o *EmailType) SetIsValidated(v bool) {
	o.IsValidated = &v
}
