...
func (r ProfileLOVAPIGetAvailableARAddressesRequest) ExternalData(externalData string) ProfileLOVAPIGetAvailableARAddressesRequest {
	r.externalData = &externalData
	return r
}

// Request Id of an incoming request
func (r ProfileLOVAPIGetAvailableARAddressesRequest) XRequestId(xRequestId string) ProfileLOVAPIGetAvailableARAddressesRequest {
	r.xRequestId = &xRequestId
	return r
}

// Customer&#39;s Integration Application Id
func (r ProfileLOVAPIGetAvailableARAddressesRequest) XOriginatingApplication(xOriginatingApplication string) ProfileLOVAPIGetAvailableARAddressesRequest {
...
// Pass this header as true, if payload needs DVM
func (r ProfileLOVAPIGetAvailablePreferencesRequest) ExternalData(externalData string) ProfileLOVAPIGetAvailablePreferencesRequest {
	r.externalData = &externalData
	return r
}

// Request Id of an incoming request
func (r ProfileLOVAPIGetAvailablePreferencesRequest) XRequestId(xRequestId string) ProfileLOVAPIGetAvailablePreferencesRequest {
	r.xRequestId = &xRequestId
	return r
}

// Customer&#39;s Integration Application Id
func (r ProfileLOVAPIGetAvailablePreferencesRequest) XOriginatingApplication(xOriginatingApplication string) ProfileLOVAPIGetAvailablePreferencesRequest {
	r.xOriginatingApplication = &xOriginatingApplication
	return r
}
