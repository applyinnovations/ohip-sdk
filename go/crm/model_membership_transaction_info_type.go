...
type MembershipTransactionInfoType struct {
	...
	// The card number associated with this membership transaction.
	MembershipCardNo *string `json:"membershipCardNo,omitempty"`
	// The membership level associated with the membership transaction.
	MembershipLevel *string `json:"membershipLevel,omitempty"`
	// User who inserted or updated the membership transaction.
	UserName *string `json:"userName,omitempty"`
	// Name ID of the profile referred.
	ReferredMemNameId *int32 `json:"referredMemNameId,omitempty"`
	// Display Name of the profile that is going to be referred.
	ReferredDisplayName *string `json:"referredDisplayName,omitempty"`
}
...
func (o *MembershipTransactionInfoType) GetReference() string {
...
// and a boolean to check if the value has been set.
func (o *MembershipTransactionInfoType) GetReferenceOk() (*string, bool) {
	if o == nil || IsNil(o.Reference) {
		return nil, false
	}
...
func (o *MembershipTransactionInfoType) HasReference() bool {
	if o != nil && !IsNil(o.Reference) {
		return true
	}
...
func (o *MembershipTransactionInfoType) SetReference(v string) {
	o.Reference = &v
}

// GetMembershipCardNo returns the MembershipCardNo field value if set, zero value otherwise.
func (o *MembershipTransactionInfoType) GetMembershipCardNo() string {
...
// and a boolean to check if the value has been set.
func (o *MembershipTransactionInfoType) GetMembershipCardNoOk() (*string, bool) {
	if o == nil || IsNil(o.MembershipCardNo) {
		return nil, false
	}
...
func (o *MembershipTransactionInfoType) HasMembershipCardNo() bool {
	if o != nil && !IsNil(o.MembershipCardNo) {
		return true
	}
...
func (o *MembershipTransactionInfoType) SetMembershipCardNo(v string) {
	o.MembershipCardNo = &v
}

// GetMembershipLevel returns the MembershipLevel field value if set, zero value otherwise.
func (o *MembershipTransactionInfoType) GetMembershipLevel() string {
...
// and a boolean to check if the value has been set.
func (o *MembershipTransactionInfoType) GetMembershipLevelOk() (*string, bool) {
	if o == nil || IsNil(o.MembershipLevel) {
		return nil, false
	}
...
func (o *MembershipTransactionInfoType) HasMembershipLevel() bool {
	if o != nil && !IsNil(o.MembershipLevel) {
		return true
	}
...
func (o *MembershipTransactionInfoType) SetMembershipLevel(v string) {
	o.MembershipLevel = &v
}

// GetUserName returns the UserName field value if set, zero value otherwise.
func (o *MembershipTransactionInfoType) GetUserName() string {
...
// and a boolean to check if the value has been set.
func (o *MembershipTransactionInfoType) GetUserNameOk() (*string, bool) {
	if o == nil || IsNil(o.UserName) {
		return nil, false
	}
...
func (o *MembershipTransactionInfoType) HasUserName() bool {
	if o != nil && !IsNil(o.UserName) {
		return true
	}
...
func (o *MembershipTransactionInfoType) SetUserName(v string) {
	o.UserName = &v
}

// GetReferredMemNameId returns the ReferredMemNameId field value if set, zero value otherwise.
func (o *MembershipTransactionInfoType) GetReferredMemNameId() int32 {
	if o == nil || IsNil(o.ReferredMemNameId) {
		var ret int32
		return ret
	}
	return *o.ReferredMemNameId
}

// GetReferredMemNameIdOk returns a tuple with the ReferredMemNameId field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *MembershipTransactionInfoType) GetReferredMemNameIdOk() (*int32, bool) {
	if o == nil || IsNil(o.ReferredMemNameId) {
		return nil, false
	}
	return o.ReferredMemNameId, true
}

// HasReferredMemNameId returns a boolean if a field has been set.
func (o *MembershipTransactionInfoType) HasReferredMemNameId() bool {
	if o != nil && !IsNil(o.ReferredMemNameId) {
		return true
	}
...
// SetReferredMemNameId gets a reference to the given int32 and assigns it to the ReferredMemNameId field.
func (o *MembershipTransactionInfoType) SetReferredMemNameId(v int32) {
	o.ReferredMemNameId = &v
}

// GetReferredDisplayName returns the ReferredDisplayName field value if set, zero value otherwise.
func (o *MembershipTransactionInfoType) GetReferredDisplayName() string {
	if o == nil || IsNil(o.ReferredDisplayName) {
		var ret string
		return ret
	}
	return *o.ReferredDisplayName
}

// GetReferredDisplayNameOk returns a tuple with the ReferredDisplayName field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *MembershipTransactionInfoType) GetReferredDisplayNameOk() (*string, bool) {
	if o == nil || IsNil(o.ReferredDisplayName) {
		return nil, false
	}
	return o.ReferredDisplayName, true
}

// HasReferredDisplayName returns a boolean if a field has been set.
func (o *MembershipTransactionInfoType) HasReferredDisplayName() bool {
	if o != nil && !IsNil(o.ReferredDisplayName) {
		return true
	}
...
// SetReferredDisplayName gets a reference to the given string and assigns it to the ReferredDisplayName field.
func (o *MembershipTransactionInfoType) SetReferredDisplayName(v string) {
	o.ReferredDisplayName = &v
}
...
func (o MembershipTransactionInfoType) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.ReferredMemNameId) {
		toSerialize["referredMemNameId"] = o.ReferredMemNameId
	}
	if !IsNil(o.ReferredDisplayName) {
		toSerialize["referredDisplayName"] = o.ReferredDisplayName
	}
