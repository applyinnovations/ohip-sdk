...
// checks if the RoomRotationAdjustmentReasonType type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RoomRotationAdjustmentReasonType{}

// RoomRotationAdjustmentReasonType Defines Rotation Adjustment Reason Details.
type RoomRotationAdjustmentReasonType struct {
...
func NewRoomRotationAdjustmentReasonType() *RoomRotationAdjustmentReasonType {
	this := RoomRotationAdjustmentReasonType{}
	return &this
}
...
func (o *RoomRotationAdjustmentReasonType) GetManagedBy() ManagedByOptions {
...
// and a boolean to check if the value has been set.
func (o *RoomRotationAdjustmentReasonType) GetManagedByOk() (*ManagedByOptions, bool) {
	if o == nil || IsNil(o.ManagedBy) {
		return nil, false
	}
...
func (o *RoomRotationAdjustmentReasonType) HasManagedBy() bool {
	if o != nil && !IsNil(o.ManagedBy) {
		return true
	}
...
func (o *RoomRotationAdjustmentReasonType) SetManagedBy(v ManagedByOptions) {
	o.ManagedBy = &v
}

func (o RoomRotationAdjustmentReasonType) MarshalJSON() ([]byte, error) {
...
func (o RoomRotationAdjustmentReasonType) ToMap() (map[string]interface{}, error) {
...
type NullableRoomRotationAdjustmentReasonType struct {
	value *RoomRotationAdjustmentReasonType
	isSet bool
}

func (v NullableRoomRotationAdjustmentReasonType) Get() *RoomRotationAdjustmentReasonType {
	return v.value
}

func (v *NullableRoomRotationAdjustmentReasonType) Set(val *RoomRotationAdjustmentReasonType) {
	v.value = val
	v.isSet = true
}

func (v NullableRoomRotationAdjustmentReasonType) IsSet() bool {
	return v.isSet
}

func (v *NullableRoomRotationAdjustmentReasonType) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRoomRotationAdjustmentReasonType(val *RoomRotationAdjustmentReasonType) *NullableRoomRotationAdjustmentReasonType {
	return &NullableRoomRotationAdjustmentReasonType{value: val, isSet: true}
}

func (v NullableRoomRotationAdjustmentReasonType) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRoomRotationAdjustmentReasonType) UnmarshalJSON(src []byte) error {
	v.isSet = true
