...
type ValidateReservationChangesInstructions struct {
	...
	BlockAssignInstruction *AssignBlockRateInstructionsType `json:"blockAssignInstruction,omitempty"`
}
...
// GetBlockAssignInstruction returns the BlockAssignInstruction field value if set, zero value otherwise.
func (o *ValidateReservationChangesInstructions) GetBlockAssignInstruction() AssignBlockRateInstructionsType {
	if o == nil || IsNil(o.BlockAssignInstruction) {
		var ret AssignBlockRateInstructionsType
		return ret
	}
	return *o.BlockAssignInstruction
}

// GetBlockAssignInstructionOk returns a tuple with the BlockAssignInstruction field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ValidateReservationChangesInstructions) GetBlockAssignInstructionOk() (*AssignBlockRateInstructionsType, bool) {
	if o == nil || IsNil(o.BlockAssignInstruction) {
		return nil, false
	}
	return o.BlockAssignInstruction, true
}

// HasBlockAssignInstruction returns a boolean if a field has been set.
func (o *ValidateReservationChangesInstructions) HasBlockAssignInstruction() bool {
	if o != nil && !IsNil(o.BlockAssignInstruction) {
		return true
	}
...
// SetBlockAssignInstruction gets a reference to the given AssignBlockRateInstructionsType and assigns it to the BlockAssignInstruction field.
func (o *ValidateReservationChangesInstructions) SetBlockAssignInstruction(v AssignBlockRateInstructionsType) {
	o.BlockAssignInstruction = &v
}
...
func (o ValidateReservationChangesInstructions) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.BlockAssignInstruction) {
		toSerialize["blockAssignInstruction"] = o.BlockAssignInstruction
	}
