...
// checks if the AttachCertificate type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AttachCertificate{}

// AttachCertificate Request to attach certificate to the Reservation.
type AttachCertificate struct {
	// List of awards.
...
func (o AttachCertificate) MarshalJSON() ([]byte, error) {
...
func (o AttachCertificate) ToMap() (map[string]interface{}, error) {
...
type NullableAttachCertificate struct {
	value *AttachCertificate
	isSet bool
}

func (v NullableAttachCertificate) Get() *AttachCertificate {
	return v.value
}

func (v *NullableAttachCertificate) Set(val *AttachCertificate) {
	v.value = val
	v.isSet = true
}

func (v NullableAttachCertificate) IsSet() bool {
	return v.isSet
}

func (v *NullableAttachCertificate) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAttachCertificate(val *AttachCertificate) *NullableAttachCertificate {
	return &NullableAttachCertificate{value: val, isSet: true}
}

func (v NullableAttachCertificate) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAttachCertificate) UnmarshalJSON(src []byte) error {
	v.isSet = true
