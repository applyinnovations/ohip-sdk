...
type RateInfoDetail struct {
	...
	// A sum of the Package Prices for the specified reservation and date
	TotalPackageAmount *float32 `json:"totalPackageAmount,omitempty"`
	// Effective Rate for the specified reservation and date
	TotalRateAmount *float32 `json:"totalRateAmount,omitempty"`
	// A sum of the Taxes for the specified reservation and date
...
// GetTotalPackageAmount returns the TotalPackageAmount field value if set, zero value otherwise.
func (o *RateInfoDetail) GetTotalPackageAmount() float32 {
	if o == nil || IsNil(o.TotalPackageAmount) {
		var ret float32
		return ret
	}
	return *o.TotalPackageAmount
}

// GetTotalPackageAmountOk returns a tuple with the TotalPackageAmount field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *RateInfoDetail) GetTotalPackageAmountOk() (*float32, bool) {
	if o == nil || IsNil(o.TotalPackageAmount) {
		return nil, false
	}
	return o.TotalPackageAmount, true
}

// HasTotalPackageAmount returns a boolean if a field has been set.
func (o *RateInfoDetail) HasTotalPackageAmount() bool {
	if o != nil && !IsNil(o.TotalPackageAmount) {
		return true
	}
...
// SetTotalPackageAmount gets a reference to the given float32 and assigns it to the TotalPackageAmount field.
func (o *RateInfoDetail) SetTotalPackageAmount(v float32) {
	o.TotalPackageAmount = &v
}

// GetTotalRateAmount returns the TotalRateAmount field value if set, zero value otherwise.
func (o *RateInfoDetail) GetTotalRateAmount() float32 {
	if o == nil || IsNil(o.TotalRateAmount) {
		var ret float32
		return ret
	}
	return *o.TotalRateAmount
}

// GetTotalRateAmountOk returns a tuple with the TotalRateAmount field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *RateInfoDetail) GetTotalRateAmountOk() (*float32, bool) {
	if o == nil || IsNil(o.TotalRateAmount) {
		return nil, false
	}
	return o.TotalRateAmount, true
}

// HasTotalRateAmount returns a boolean if a field has been set.
func (o *RateInfoDetail) HasTotalRateAmount() bool {
	if o != nil && !IsNil(o.TotalRateAmount) {
		return true
	}
...
// SetTotalRateAmount gets a reference to the given float32 and assigns it to the TotalRateAmount field.
func (o *RateInfoDetail) SetTotalRateAmount(v float32) {
	o.TotalRateAmount = &v
}

// GetTotalTaxAmount returns the TotalTaxAmount field value if set, zero value otherwise.
func (o *RateInfoDetail) GetTotalTaxAmount() float32 {
...
// and a boolean to check if the value has been set.
func (o *RateInfoDetail) GetTotalTaxAmountOk() (*float32, bool) {
	if o == nil || IsNil(o.TotalTaxAmount) {
		return nil, false
	}
...
func (o *RateInfoDetail) HasTotalTaxAmount() bool {
	if o != nil && !IsNil(o.TotalTaxAmount) {
		return true
	}
...
func (o *RateInfoDetail) SetTotalTaxAmount(v float32) {
	o.TotalTaxAmount = &v
}
...
func (o RateInfoDetail) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.TotalPackageAmount) {
		toSerialize["totalPackageAmount"] = o.TotalPackageAmount
	}
	if !IsNil(o.TotalRateAmount) {
		toSerialize["totalRateAmount"] = o.TotalRateAmount
	}
