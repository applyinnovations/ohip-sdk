...
// checks if the ReservedInventoryItemsInfo type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ReservedInventoryItemsInfo{}

// ReservedInventoryItemsInfo Request object to change the reserved inventory Items for a reservation.
type ReservedInventoryItemsInfo struct {
...
func NewReservedInventoryItemsInfo() *ReservedInventoryItemsInfo {
	this := ReservedInventoryItemsInfo{}
	return &this
}
...
func (o ReservedInventoryItemsInfo) MarshalJSON() ([]byte, error) {
...
func (o ReservedInventoryItemsInfo) ToMap() (map[string]interface{}, error) {
...
type NullableReservedInventoryItemsInfo struct {
	value *ReservedInventoryItemsInfo
	isSet bool
}

func (v NullableReservedInventoryItemsInfo) Get() *ReservedInventoryItemsInfo {
	return v.value
}

func (v *NullableReservedInventoryItemsInfo) Set(val *ReservedInventoryItemsInfo) {
	v.value = val
	v.isSet = true
}

func (v NullableReservedInventoryItemsInfo) IsSet() bool {
	return v.isSet
}

func (v *NullableReservedInventoryItemsInfo) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableReservedInventoryItemsInfo(val *ReservedInventoryItemsInfo) *NullableReservedInventoryItemsInfo {
	return &NullableReservedInventoryItemsInfo{value: val, isSet: true}
}

func (v NullableReservedInventoryItemsInfo) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableReservedInventoryItemsInfo) UnmarshalJSON(src []byte) error {
	v.isSet = true
