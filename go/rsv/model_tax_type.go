...
type TaxType struct {
	...
	// Unique identifier for Generate Tax Transaction code.
	GenerateTransactionCode *string `json:"generateTransactionCode,omitempty"`
	// A monetary amount.
...
// GetGenerateTransactionCode returns the GenerateTransactionCode field value if set, zero value otherwise.
func (o *TaxType) GetGenerateTransactionCode() string {
	if o == nil || IsNil(o.GenerateTransactionCode) {
		var ret string
		return ret
	}
	return *o.GenerateTransactionCode
}

// GetGenerateTransactionCodeOk returns a tuple with the GenerateTransactionCode field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *TaxType) GetGenerateTransactionCodeOk() (*string, bool) {
	if o == nil || IsNil(o.GenerateTransactionCode) {
		return nil, false
	}
	return o.GenerateTransactionCode, true
}
...
// SetGenerateTransactionCode gets a reference to the given string and assigns it to the GenerateTransactionCode field.
func (o *TaxType) SetGenerateTransactionCode(v string) {
	o.GenerateTransactionCode = &v
}
...
func (o TaxType) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.GenerateTransactionCode) {
		toSerialize["generateTransactionCode"] = o.GenerateTransactionCode
	}
	if !IsNil(o.Amount) {
