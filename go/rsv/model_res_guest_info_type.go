...
type ResGuestInfoType struct {
	...
	GuestLastStayInformation *GuestLastStayInfoType `json:"guestLastStayInformation,omitempty"`
...
// GetGuestLastStayInformation returns the GuestLastStayInformation field value if set, zero value otherwise.
func (o *ResGuestInfoType) GetGuestLastStayInformation() GuestLastStayInfoType {
	if o == nil || IsNil(o.GuestLastStayInformation) {
		var ret GuestLastStayInfoType
		return ret
	}
	return *o.GuestLastStayInformation
}

// GetGuestLastStayInformationOk returns a tuple with the GuestLastStayInformation field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ResGuestInfoType) GetGuestLastStayInformationOk() (*GuestLastStayInfoType, bool) {
	if o == nil || IsNil(o.GuestLastStayInformation) {
		return nil, false
	}
	return o.GuestLastStayInformation, true
}
...
// SetGuestLastStayInformation gets a reference to the given GuestLastStayInfoType and assigns it to the GuestLastStayInformation field.
func (o *ResGuestInfoType) SetGuestLastStayInformation(v GuestLastStayInfoType) {
	o.GuestLastStayInformation = &v
}
...
func (o *ResGuestInfoType) GetExternalReferences() []ExternalReferenceType {
...
// and a boolean to check if the value has been set.
func (o *ResGuestInfoType) GetExternalReferencesOk() ([]ExternalReferenceType, bool) {
	if o == nil || IsNil(o.ExternalReferences) {
		return nil, false
	}
...
func (o *ResGuestInfoType) HasExternalReferences() bool {
	if o != nil && !IsNil(o.ExternalReferences) {
		return true
	}
...
func (o *ResGuestInfoType) SetExternalReferences(v []ExternalReferenceType) {
...
func (o ResGuestInfoType) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.GuestLastStayInformation) {
		toSerialize["guestLastStayInformation"] = o.GuestLastStayInformation
	}
