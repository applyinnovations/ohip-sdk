...
func (o *PostReservationByBlockRequest) GetExternalDailyRates() []ExternalDailyRateType {
...
// and a boolean to check if the value has been set.
func (o *PostReservationByBlockRequest) GetExternalDailyRatesOk() ([]ExternalDailyRateType, bool) {
	if o == nil || IsNil(o.ExternalDailyRates) {
		return nil, false
	}
...
func (o *PostReservationByBlockRequest) HasExternalDailyRates() bool {
	if o != nil && !IsNil(o.ExternalDailyRates) {
		return true
	}
...
func (o *PostReservationByBlockRequest) SetExternalDailyRates(v []ExternalDailyRateType) {
