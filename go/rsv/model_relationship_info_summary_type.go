...
type RelationshipInfoSummaryType struct {
	...
	MasterAccountDetails map[string]interface{} `json:"masterAccountDetails,omitempty"`
...
// SetMasterAccountDetails gets a reference to the given map[string]interface{} and assigns it to the MasterAccountDetails field.
