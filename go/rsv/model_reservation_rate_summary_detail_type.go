...
type ReservationRateSummaryDetailType struct {
	...
	// Posting Interval of the rate plan code
	PostingInterval *string `json:"postingInterval,omitempty"`
	// Indicates whether the current date marks the start of a new posting cycle
	IsCycleStartDate *bool `json:"isCycleStartDate,omitempty"`
}
...
func (o *ReservationRateSummaryDetailType) GetPostingInterval() string {
...
// and a boolean to check if the value has been set.
func (o *ReservationRateSummaryDetailType) GetPostingIntervalOk() (*string, bool) {
	if o == nil || IsNil(o.PostingInterval) {
		return nil, false
	}
...
func (o *ReservationRateSummaryDetailType) HasPostingInterval() bool {
	if o != nil && !IsNil(o.PostingInterval) {
		return true
	}
...
// SetPostingInterval gets a reference to the given string and assigns it to the PostingInterval field.
func (o *ReservationRateSummaryDetailType) SetPostingInterval(v string) {
	o.PostingInterval = &v
}

// GetIsCycleStartDate returns the IsCycleStartDate field value if set, zero value otherwise.
func (o *ReservationRateSummaryDetailType) GetIsCycleStartDate() bool {
	if o == nil || IsNil(o.IsCycleStartDate) {
		var ret bool
		return ret
	}
	return *o.IsCycleStartDate
}

// GetIsCycleStartDateOk returns a tuple with the IsCycleStartDate field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ReservationRateSummaryDetailType) GetIsCycleStartDateOk() (*bool, bool) {
	if o == nil || IsNil(o.IsCycleStartDate) {
		return nil, false
	}
	return o.IsCycleStartDate, true
}

// HasIsCycleStartDate returns a boolean if a field has been set.
func (o *ReservationRateSummaryDetailType) HasIsCycleStartDate() bool {
	if o != nil && !IsNil(o.IsCycleStartDate) {
		return true
	}
...
// SetIsCycleStartDate gets a reference to the given bool and assigns it to the IsCycleStartDate field.
func (o *ReservationRateSummaryDetailType) SetIsCycleStartDate(v bool) {
	o.IsCycleStartDate = &v
}
...
func (o ReservationRateSummaryDetailType) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.IsCycleStartDate) {
		toSerialize["isCycleStartDate"] = o.IsCycleStartDate
	}
