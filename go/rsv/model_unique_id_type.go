...
func (o *UniqueIDType) GetIdExtension() int32 {
...
// and a boolean to check if the value has been set.
func (o *UniqueIDType) GetIdExtensionOk() (*int32, bool) {
	if o == nil || IsNil(o.IdExtension) {
		return nil, false
	}
...
func (o *UniqueIDType) HasIdExtension() bool {
	if o != nil && !IsNil(o.IdExtension) {
		return true
	}
...
func (o *UniqueIDType) SetIdExtension(v int32) {
	o.IdExtension = &v
}
