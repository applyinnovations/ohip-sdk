...
type HotelReservationInstructionType struct {
	...
	// Indicates if block restrictions should be overriden when also sending validateBlockRestrictions as true.
	OverrideBlockRestriction *bool `json:"overrideBlockRestriction,omitempty"`
	// Indicates whether to validate block restrictions when making an update to a block reservation.
	ValidateBlockRestrictions *bool `json:"validateBlockRestrictions,omitempty"`
	...
	// Update the review status of a pre-arrival reservation to indicate that it has been reviewed by an authorized user.
	MarkPreArrivalReviewed *bool `json:"markPreArrivalReviewed,omitempty"`
...
func (o *HotelReservationInstructionType) GetResvIdentifications() []ResvIdentificationInfoType {
...
// and a boolean to check if the value has been set.
func (o *HotelReservationInstructionType) GetResvIdentificationsOk() ([]ResvIdentificationInfoType, bool) {
	if o == nil || IsNil(o.ResvIdentifications) {
		return nil, false
	}
...
func (o *HotelReservationInstructionType) HasResvIdentifications() bool {
	if o != nil && !IsNil(o.ResvIdentifications) {
		return true
	}
...
func (o *HotelReservationInstructionType) SetResvIdentifications(v []ResvIdentificationInfoType) {
...
// GetValidateBlockRestrictions returns the ValidateBlockRestrictions field value if set, zero value otherwise.
func (o *HotelReservationInstructionType) GetValidateBlockRestrictions() bool {
	if o == nil || IsNil(o.ValidateBlockRestrictions) {
		var ret bool
		return ret
	}
	return *o.ValidateBlockRestrictions
}

// GetValidateBlockRestrictionsOk returns a tuple with the ValidateBlockRestrictions field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *HotelReservationInstructionType) GetValidateBlockRestrictionsOk() (*bool, bool) {
	if o == nil || IsNil(o.ValidateBlockRestrictions) {
		return nil, false
	}
	return o.ValidateBlockRestrictions, true
}

// HasValidateBlockRestrictions returns a boolean if a field has been set.
func (o *HotelReservationInstructionType) HasValidateBlockRestrictions() bool {
	if o != nil && !IsNil(o.ValidateBlockRestrictions) {
		return true
	}
...
// SetValidateBlockRestrictions gets a reference to the given bool and assigns it to the ValidateBlockRestrictions field.
func (o *HotelReservationInstructionType) SetValidateBlockRestrictions(v bool) {
	o.ValidateBlockRestrictions = &v
}
...
// GetMarkPreArrivalReviewed returns the MarkPreArrivalReviewed field value if set, zero value otherwise.
func (o *HotelReservationInstructionType) GetMarkPreArrivalReviewed() bool {
	if o == nil || IsNil(o.MarkPreArrivalReviewed) {
		var ret bool
		return ret
	}
	return *o.MarkPreArrivalReviewed
}

// GetMarkPreArrivalReviewedOk returns a tuple with the MarkPreArrivalReviewed field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *HotelReservationInstructionType) GetMarkPreArrivalReviewedOk() (*bool, bool) {
	if o == nil || IsNil(o.MarkPreArrivalReviewed) {
		return nil, false
	}
	return o.MarkPreArrivalReviewed, true
}

// HasMarkPreArrivalReviewed returns a boolean if a field has been set.
func (o *HotelReservationInstructionType) HasMarkPreArrivalReviewed() bool {
	if o != nil && !IsNil(o.MarkPreArrivalReviewed) {
		return true
	}
...
// SetMarkPreArrivalReviewed gets a reference to the given bool and assigns it to the MarkPreArrivalReviewed field.
func (o *HotelReservationInstructionType) SetMarkPreArrivalReviewed(v bool) {
	o.MarkPreArrivalReviewed = &v
}

// GetExternalDailyRates returns the ExternalDailyRates field value if set, zero value otherwise.
func (o *HotelReservationInstructionType) GetExternalDailyRates() []ExternalDailyRateType {
...
// and a boolean to check if the value has been set.
func (o *HotelReservationInstructionType) GetExternalDailyRatesOk() ([]ExternalDailyRateType, bool) {
	if o == nil || IsNil(o.ExternalDailyRates) {
		return nil, false
	}
...
func (o *HotelReservationInstructionType) HasExternalDailyRates() bool {
	if o != nil && !IsNil(o.ExternalDailyRates) {
		return true
	}
...
func (o *HotelReservationInstructionType) SetExternalDailyRates(v []ExternalDailyRateType) {
	o.ExternalDailyRates = v
}

// GetReservationProtection returns the ReservationProtection field value if set, zero value otherwise.
func (o *HotelReservationInstructionType) GetReservationProtection() ReservationProtectionType {
...
// and a boolean to check if the value has been set.
func (o *HotelReservationInstructionType) GetReservationProtectionOk() (*ReservationProtectionType, bool) {
	if o == nil || IsNil(o.ReservationProtection) {
		return nil, false
	}
...
func (o *HotelReservationInstructionType) HasReservationProtection() bool {
	if o != nil && !IsNil(o.ReservationProtection) {
		return true
	}
...
func (o *HotelReservationInstructionType) SetReservationProtection(v ReservationProtectionType) {
...
func (o HotelReservationInstructionType) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.ValidateBlockRestrictions) {
		toSerialize["validateBlockRestrictions"] = o.ValidateBlockRestrictions
	}
	...
	if !IsNil(o.MarkPreArrivalReviewed) {
		toSerialize["markPreArrivalReviewed"] = o.MarkPreArrivalReviewed
	}
