...
type CombineShareReservationsType struct {
	...
	ExistingReservation *CombineShareFromExistingReservationType `json:"existingReservation,omitempty"`
}
...
// GetExistingReservation returns the ExistingReservation field value if set, zero value otherwise.
func (o *CombineShareReservationsType) GetExistingReservation() CombineShareFromExistingReservationType {
	if o == nil || IsNil(o.ExistingReservation) {
		var ret CombineShareFromExistingReservationType
		return ret
	}
	return *o.ExistingReservation
}

// GetExistingReservationOk returns a tuple with the ExistingReservation field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *CombineShareReservationsType) GetExistingReservationOk() (*CombineShareFromExistingReservationType, bool) {
	if o == nil || IsNil(o.ExistingReservation) {
		return nil, false
	}
	return o.ExistingReservation, true
}
...
// SetExistingReservation gets a reference to the given CombineShareFromExistingReservationType and assigns it to the ExistingReservation field.
func (o *CombineShareReservationsType) SetExistingReservation(v CombineShareFromExistingReservationType) {
	o.ExistingReservation = &v
}
...
func (o CombineShareReservationsType) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.ExistingReservation) {
		toSerialize["existingReservation"] = o.ExistingReservation
	}
