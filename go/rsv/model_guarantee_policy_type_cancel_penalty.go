...
func (o *GuaranteePolicyTypeCancelPenalty) GetTieredCancelPenalties() []TieredCancelPenalty {
...
// and a boolean to check if the value has been set.
func (o *GuaranteePolicyTypeCancelPenalty) GetTieredCancelPenaltiesOk() ([]TieredCancelPenalty, bool) {
	if o == nil || IsNil(o.TieredCancelPenalties) {
		return nil, false
	}
...
func (o *GuaranteePolicyTypeCancelPenalty) HasTieredCancelPenalties() bool {
	if o != nil && !IsNil(o.TieredCancelPenalties) {
		return true
	}
...
func (o *GuaranteePolicyTypeCancelPenalty) SetTieredCancelPenalties(v []TieredCancelPenalty) {
