...
type ValidateRateInfoCriteria struct {
	...
	IncludeFixedCharges *bool `json:"includeFixedCharges,omitempty"`
	...
	IncludeDeposits *bool `json:"includeDeposits,omitempty"`
	...
	// Flag to indicate if rate information should be returned in rate code currency per night
	ViewInRateCodeCurrency *bool `json:"viewInRateCodeCurrency,omitempty"`
}
...
func NewValidateRateInfoCriteria() *ValidateRateInfoCriteria {
	...
	var includeFixedCharges bool = true
	this.IncludeFixedCharges = &includeFixedCharges
	var includeDeposits bool = true
	this.IncludeDeposits = &includeDeposits
	var includeRouting bool = true
	this.IncludeRouting = &includeRouting
	var viewInRateCodeCurrency bool = false
	this.ViewInRateCodeCurrency = &viewInRateCodeCurrency
	return &this
}
...
// GetIncludeFixedCharges returns the IncludeFixedCharges field value if set, zero value otherwise.
func (o *ValidateRateInfoCriteria) GetIncludeFixedCharges() bool {
	if o == nil || IsNil(o.IncludeFixedCharges) {
		var ret bool
		return ret
	}
	return *o.IncludeFixedCharges
}

// GetIncludeFixedChargesOk returns a tuple with the IncludeFixedCharges field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ValidateRateInfoCriteria) GetIncludeFixedChargesOk() (*bool, bool) {
	if o == nil || IsNil(o.IncludeFixedCharges) {
		return nil, false
	}
	return o.IncludeFixedCharges, true
}
...
// SetIncludeFixedCharges gets a reference to the given bool and assigns it to the IncludeFixedCharges field.
func (o *ValidateRateInfoCriteria) SetIncludeFixedCharges(v bool) {
	o.IncludeFixedCharges = &v
}

// GetIncludeDeposits returns the IncludeDeposits field value if set, zero value otherwise.
func (o *ValidateRateInfoCriteria) GetIncludeDeposits() bool {
	if o == nil || IsNil(o.IncludeDeposits) {
		var ret bool
		return ret
	}
	return *o.IncludeDeposits
}

// GetIncludeDepositsOk returns a tuple with the IncludeDeposits field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ValidateRateInfoCriteria) GetIncludeDepositsOk() (*bool, bool) {
	if o == nil || IsNil(o.IncludeDeposits) {
		return nil, false
	}
	return o.IncludeDeposits, true
}
...
// SetIncludeDeposits gets a reference to the given bool and assigns it to the IncludeDeposits field.
...
// GetViewInRateCodeCurrency returns the ViewInRateCodeCurrency field value if set, zero value otherwise.
func (o *ValidateRateInfoCriteria) GetViewInRateCodeCurrency() bool {
	if o == nil || IsNil(o.ViewInRateCodeCurrency) {
		var ret bool
		return ret
	}
	return *o.ViewInRateCodeCurrency
}

// GetViewInRateCodeCurrencyOk returns a tuple with the ViewInRateCodeCurrency field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ValidateRateInfoCriteria) GetViewInRateCodeCurrencyOk() (*bool, bool) {
	if o == nil || IsNil(o.ViewInRateCodeCurrency) {
		return nil, false
	}
	return o.ViewInRateCodeCurrency, true
}

// HasViewInRateCodeCurrency returns a boolean if a field has been set.
func (o *ValidateRateInfoCriteria) HasViewInRateCodeCurrency() bool {
	if o != nil && !IsNil(o.ViewInRateCodeCurrency) {
		return true
	}
...
// SetViewInRateCodeCurrency gets a reference to the given bool and assigns it to the ViewInRateCodeCurrency field.
func (o *ValidateRateInfoCriteria) SetViewInRateCodeCurrency(v bool) {
	o.ViewInRateCodeCurrency = &v
}
...
func (o ValidateRateInfoCriteria) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.IncludeFixedCharges) {
		toSerialize["includeFixedCharges"] = o.IncludeFixedCharges
	}
	if !IsNil(o.IncludeDeposits) {
		toSerialize["includeDeposits"] = o.IncludeDeposits
	}
	if !IsNil(o.IncludeRouting) {
		toSerialize["includeRouting"] = o.IncludeRouting
	}
	if !IsNil(o.ViewInRateCodeCurrency) {
		toSerialize["viewInRateCodeCurrency"] = o.ViewInRateCodeCurrency
	}
