...
func (o *CreateReservation) GetExternalDailyRates() []ExternalDailyRateType {
...
// and a boolean to check if the value has been set.
func (o *CreateReservation) GetExternalDailyRatesOk() ([]ExternalDailyRateType, bool) {
	if o == nil || IsNil(o.ExternalDailyRates) {
		return nil, false
	}
...
func (o *CreateReservation) HasExternalDailyRates() bool {
	if o != nil && !IsNil(o.ExternalDailyRates) {
		return true
	}
...
func (o *CreateReservation) SetExternalDailyRates(v []ExternalDailyRateType) {
