...
// checks if the ReservationAlertsType type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ReservationAlertsType{}

// ReservationAlertsType Hold the multiple alerts for a single reservation which is identified by a unique identifier.
type ReservationAlertsType struct {
	// List of alerts.
...
// SetAlert gets a reference to the given []AlertType and assigns it to the Alert field.
...
func (o ReservationAlertsType) MarshalJSON() ([]byte, error) {
...
func (o ReservationAlertsType) ToMap() (map[string]interface{}, error) {
...
type NullableReservationAlertsType struct {
	value *ReservationAlertsType
	isSet bool
}

func (v NullableReservationAlertsType) Get() *ReservationAlertsType {
	return v.value
}

func (v *NullableReservationAlertsType) Set(val *ReservationAlertsType) {
	v.value = val
	v.isSet = true
}

func (v NullableReservationAlertsType) IsSet() bool {
	return v.isSet
}

func (v *NullableReservationAlertsType) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableReservationAlertsType(val *ReservationAlertsType) *NullableReservationAlertsType {
	return &NullableReservationAlertsType{value: val, isSet: true}
}

func (v NullableReservationAlertsType) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableReservationAlertsType) UnmarshalJSON(src []byte) error {
	v.isSet = true
