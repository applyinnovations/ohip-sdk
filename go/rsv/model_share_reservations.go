...
// checks if the ShareReservations type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ShareReservations{}

// ShareReservations Response for the fetch share reservation request. This returns all sharer reservations including the request reservation.
...
func (o ShareReservations) MarshalJSON() ([]byte, error) {
...
func (o ShareReservations) ToMap() (map[string]interface{}, error) {
...
type NullableShareReservations struct {
	value *ShareReservations
	isSet bool
}

func (v NullableShareReservations) Get() *ShareReservations {
	return v.value
}

func (v *NullableShareReservations) Set(val *ShareReservations) {
	v.value = val
	v.isSet = true
}

func (v NullableShareReservations) IsSet() bool {
	return v.isSet
}

func (v *NullableShareReservations) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableShareReservations(val *ShareReservations) *NullableShareReservations {
	return &NullableShareReservations{value: val, isSet: true}
}

func (v NullableShareReservations) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableShareReservations) UnmarshalJSON(src []byte) error {
	v.isSet = true
