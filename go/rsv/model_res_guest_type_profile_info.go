...
type ResGuestTypeProfileInfo struct {
	...
	ExternalReference *ExternalReferenceType `json:"externalReference,omitempty"`
	...
	AttachDetachType *AttachDetachType `json:"attachDetachType,omitempty"`
...
// SetExternalReference gets a reference to the given ExternalReferenceType and assigns it to the ExternalReference field.
...
// GetAttachDetachType returns the AttachDetachType field value if set, zero value otherwise.
func (o *ResGuestTypeProfileInfo) GetAttachDetachType() AttachDetachType {
	if o == nil || IsNil(o.AttachDetachType) {
		var ret AttachDetachType
		return ret
	}
	return *o.AttachDetachType
}

// GetAttachDetachTypeOk returns a tuple with the AttachDetachType field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ResGuestTypeProfileInfo) GetAttachDetachTypeOk() (*AttachDetachType, bool) {
	if o == nil || IsNil(o.AttachDetachType) {
		return nil, false
	}
	return o.AttachDetachType, true
}
...
// SetAttachDetachType gets a reference to the given AttachDetachType and assigns it to the AttachDetachType field.
func (o *ResGuestTypeProfileInfo) SetAttachDetachType(v AttachDetachType) {
	o.AttachDetachType = &v
}

// GetExternalReferences returns the ExternalReferences field value if set, zero value otherwise.
func (o *ResGuestTypeProfileInfo) GetExternalReferences() []ExternalReferenceType {
...
// and a boolean to check if the value has been set.
func (o *ResGuestTypeProfileInfo) GetExternalReferencesOk() ([]ExternalReferenceType, bool) {
	if o == nil || IsNil(o.ExternalReferences) {
		return nil, false
	}
...
func (o *ResGuestTypeProfileInfo) HasExternalReferences() bool {
	if o != nil && !IsNil(o.ExternalReferences) {
		return true
	}
...
func (o *ResGuestTypeProfileInfo) SetExternalReferences(v []ExternalReferenceType) {
...
func (o ResGuestTypeProfileInfo) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.AttachDetachType) {
		toSerialize["attachDetachType"] = o.AttachDetachType
	}
