...
func (o *ResSharedGuestInfoType) GetReservationId() ReservationId {
...
// and a boolean to check if the value has been set.
func (o *ResSharedGuestInfoType) GetReservationIdOk() (*ReservationId, bool) {
	if o == nil || IsNil(o.ReservationId) {
		return nil, false
	}
...
func (o *ResSharedGuestInfoType) HasReservationId() bool {
	if o != nil && !IsNil(o.ReservationId) {
		return true
	}
...
func (o *ResSharedGuestInfoType) SetReservationId(v ReservationId) {
	o.ReservationId = &v
}
