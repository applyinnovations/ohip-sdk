...
func (o *RegisterTurnaway) GetCroCode() string {
...
// and a boolean to check if the value has been set.
func (o *RegisterTurnaway) GetCroCodeOk() (*string, bool) {
	if o == nil || IsNil(o.CroCode) {
		return nil, false
	}
...
func (o *RegisterTurnaway) HasCroCode() bool {
	if o != nil && !IsNil(o.CroCode) {
		return true
	}
...
func (o *RegisterTurnaway) SetCroCode(v string) {
	o.CroCode = &v
}
