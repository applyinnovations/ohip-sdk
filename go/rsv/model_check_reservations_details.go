...
type CheckReservationsDetails struct {
	...
	CheckReservations []CheckReservationType `json:"checkReservations,omitempty"`
...
// SetCheckReservations gets a reference to the given []CheckReservationType and assigns it to the CheckReservations field.
