...
// Packages Response to fetch package availability with the data, success and warnings or errors.
type Packages struct {
	ReservationPackages *PackagesReservationPackages `json:"reservationPackages,omitempty"`
...
func (o *Packages) GetReservationPackages() PackagesReservationPackages {
	if o == nil || IsNil(o.ReservationPackages) {
		var ret PackagesReservationPackages
		return ret
	}
...
// SetReservationPackages gets a reference to the given PackagesReservationPackages and assigns it to the ReservationPackages field.
