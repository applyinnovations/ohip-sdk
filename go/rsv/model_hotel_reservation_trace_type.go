...
type HotelReservationTraceType struct {
	...
	TraceFrequency *TraceFrequencyType `json:"traceFrequency,omitempty"`
	// When set as true all associated traces based on the defined trace frequency will also be updated. This is applicable when the trace frequency is set to EveryXNightsStartingNightY, CertainNightsOfTheWeek, or EveryNight
	UpdateFrequencyTraces *bool `json:"updateFrequencyTraces,omitempty"`
}
...
// GetTraceFrequency returns the TraceFrequency field value if set, zero value otherwise.
func (o *HotelReservationTraceType) GetTraceFrequency() TraceFrequencyType {
	if o == nil || IsNil(o.TraceFrequency) {
		var ret TraceFrequencyType
		return ret
	}
	return *o.TraceFrequency
}

// GetTraceFrequencyOk returns a tuple with the TraceFrequency field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *HotelReservationTraceType) GetTraceFrequencyOk() (*TraceFrequencyType, bool) {
	if o == nil || IsNil(o.TraceFrequency) {
		return nil, false
	}
	return o.TraceFrequency, true
}

// HasTraceFrequency returns a boolean if a field has been set.
func (o *HotelReservationTraceType) HasTraceFrequency() bool {
	if o != nil && !IsNil(o.TraceFrequency) {
		return true
	}
...
// SetTraceFrequency gets a reference to the given TraceFrequencyType and assigns it to the TraceFrequency field.
func (o *HotelReservationTraceType) SetTraceFrequency(v TraceFrequencyType) {
	o.TraceFrequency = &v
}

// GetUpdateFrequencyTraces returns the UpdateFrequencyTraces field value if set, zero value otherwise.
func (o *HotelReservationTraceType) GetUpdateFrequencyTraces() bool {
	if o == nil || IsNil(o.UpdateFrequencyTraces) {
		var ret bool
		return ret
	}
	return *o.UpdateFrequencyTraces
}

// GetUpdateFrequencyTracesOk returns a tuple with the UpdateFrequencyTraces field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *HotelReservationTraceType) GetUpdateFrequencyTracesOk() (*bool, bool) {
	if o == nil || IsNil(o.UpdateFrequencyTraces) {
		return nil, false
	}
	return o.UpdateFrequencyTraces, true
}

// HasUpdateFrequencyTraces returns a boolean if a field has been set.
func (o *HotelReservationTraceType) HasUpdateFrequencyTraces() bool {
	if o != nil && !IsNil(o.UpdateFrequencyTraces) {
		return true
	}
...
// SetUpdateFrequencyTraces gets a reference to the given bool and assigns it to the UpdateFrequencyTraces field.
func (o *HotelReservationTraceType) SetUpdateFrequencyTraces(v bool) {
	o.UpdateFrequencyTraces = &v
}
...
func (o HotelReservationTraceType) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.TraceFrequency) {
		toSerialize["traceFrequency"] = o.TraceFrequency
	}
	if !IsNil(o.UpdateFrequencyTraces) {
		toSerialize["updateFrequencyTraces"] = o.UpdateFrequencyTraces
	}
