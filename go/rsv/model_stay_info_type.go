...
type StayInfoType struct {
	...
	BookingTimeSpan *BookingTimeSpanType `json:"bookingTimeSpan,omitempty"`
	...
	ScheduledRoomMoveRoomPending *bool `json:"scheduledRoomMoveRoomPending,omitempty"`
	// Rate plan code
	RatePlanCode *string `json:"ratePlanCode,omitempty"`
	PostingInterval *PostingIntervalType `json:"postingInterval,omitempty"`
	...
	RoomAvailableNights *int32 `json:"roomAvailableNights,omitempty"`
	...
	ScheduledRoomMoveResponseType *ScheduledRoomMoveResponseType `json:"scheduledRoomMoveResponseType,omitempty"`
...
// GetBookingTimeSpan returns the BookingTimeSpan field value if set, zero value otherwise.
func (o *StayInfoType) GetBookingTimeSpan() BookingTimeSpanType {
	if o == nil || IsNil(o.BookingTimeSpan) {
		var ret BookingTimeSpanType
		return ret
	}
	return *o.BookingTimeSpan
}

// GetBookingTimeSpanOk returns a tuple with the BookingTimeSpan field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *StayInfoType) GetBookingTimeSpanOk() (*BookingTimeSpanType, bool) {
	if o == nil || IsNil(o.BookingTimeSpan) {
		return nil, false
	}
	return o.BookingTimeSpan, true
}
...
// SetBookingTimeSpan gets a reference to the given BookingTimeSpanType and assigns it to the BookingTimeSpan field.
...
func (o *StayInfoType) GetChildAges() []ChildAgeType {
...
// and a boolean to check if the value has been set.
func (o *StayInfoType) GetChildAgesOk() ([]ChildAgeType, bool) {
	if o == nil || IsNil(o.ChildAges) {
		return nil, false
	}
...
func (o *StayInfoType) HasChildAges() bool {
	if o != nil && !IsNil(o.ChildAges) {
		return true
	}
...
func (o *StayInfoType) SetChildAges(v []ChildAgeType) {
	o.ChildAges = v
}

// GetChildBuckets returns the ChildBuckets field value if set, zero value otherwise.
func (o *StayInfoType) GetChildBuckets() ChildBucketsType {
...
// and a boolean to check if the value has been set.
func (o *StayInfoType) GetChildBucketsOk() (*ChildBucketsType, bool) {
	if o == nil || IsNil(o.ChildBuckets) {
		return nil, false
	}
...
func (o *StayInfoType) HasChildBuckets() bool {
	if o != nil && !IsNil(o.ChildBuckets) {
		return true
	}
...
func (o *StayInfoType) SetChildBuckets(v ChildBucketsType) {
	o.ChildBuckets = &v
}
...
// GetScheduledRoomMoveRoomPending returns the ScheduledRoomMoveRoomPending field value if set, zero value otherwise.
func (o *StayInfoType) GetScheduledRoomMoveRoomPending() bool {
	if o == nil || IsNil(o.ScheduledRoomMoveRoomPending) {
		var ret bool
		return ret
	}
	return *o.ScheduledRoomMoveRoomPending
}

// GetScheduledRoomMoveRoomPendingOk returns a tuple with the ScheduledRoomMoveRoomPending field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *StayInfoType) GetScheduledRoomMoveRoomPendingOk() (*bool, bool) {
	if o == nil || IsNil(o.ScheduledRoomMoveRoomPending) {
		return nil, false
	}
	return o.ScheduledRoomMoveRoomPending, true
}
...
// SetScheduledRoomMoveRoomPending gets a reference to the given bool and assigns it to the ScheduledRoomMoveRoomPending field.
func (o *StayInfoType) SetScheduledRoomMoveRoomPending(v bool) {
	o.ScheduledRoomMoveRoomPending = &v
}
...
func (o *StayInfoType) GetPostingInterval() PostingIntervalType {
	if o == nil || IsNil(o.PostingInterval) {
		var ret PostingIntervalType
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *StayInfoType) GetPostingIntervalOk() (*PostingIntervalType, bool) {
	if o == nil || IsNil(o.PostingInterval) {
		return nil, false
	}
...
func (o *StayInfoType) HasPostingInterval() bool {
	if o != nil && !IsNil(o.PostingInterval) {
		return true
	}
...
// SetPostingInterval gets a reference to the given PostingIntervalType and assigns it to the PostingInterval field.
func (o *StayInfoType) SetPostingInterval(v PostingIntervalType) {
	o.PostingInterval = &v
}
...
func (o *StayInfoType) GetOffshoreRateInformation() OffshoreRateType {
...
// and a boolean to check if the value has been set.
func (o *StayInfoType) GetOffshoreRateInformationOk() (*OffshoreRateType, bool) {
	if o == nil || IsNil(o.OffshoreRateInformation) {
		return nil, false
	}
...
func (o *StayInfoType) HasOffshoreRateInformation() bool {
	if o != nil && !IsNil(o.OffshoreRateInformation) {
		return true
	}
...
func (o *StayInfoType) SetOffshoreRateInformation(v OffshoreRateType) {
...
// GetRoomAvailableNights returns the RoomAvailableNights field value if set, zero value otherwise.
func (o *StayInfoType) GetRoomAvailableNights() int32 {
	if o == nil || IsNil(o.RoomAvailableNights) {
		var ret int32
		return ret
	}
	return *o.RoomAvailableNights
}

// GetRoomAvailableNightsOk returns a tuple with the RoomAvailableNights field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *StayInfoType) GetRoomAvailableNightsOk() (*int32, bool) {
	if o == nil || IsNil(o.RoomAvailableNights) {
		return nil, false
	}
	return o.RoomAvailableNights, true
}
...
// SetRoomAvailableNights gets a reference to the given int32 and assigns it to the RoomAvailableNights field.
func (o *StayInfoType) SetRoomAvailableNights(v int32) {
	o.RoomAvailableNights = &v
}
...
// GetScheduledRoomMoveResponseType returns the ScheduledRoomMoveResponseType field value if set, zero value otherwise.
func (o *StayInfoType) GetScheduledRoomMoveResponseType() ScheduledRoomMoveResponseType {
	if o == nil || IsNil(o.ScheduledRoomMoveResponseType) {
		var ret ScheduledRoomMoveResponseType
		return ret
	}
	return *o.ScheduledRoomMoveResponseType
}

// GetScheduledRoomMoveResponseTypeOk returns a tuple with the ScheduledRoomMoveResponseType field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *StayInfoType) GetScheduledRoomMoveResponseTypeOk() (*ScheduledRoomMoveResponseType, bool) {
	if o == nil || IsNil(o.ScheduledRoomMoveResponseType) {
		return nil, false
	}
	return o.ScheduledRoomMoveResponseType, true
}
...
// SetScheduledRoomMoveResponseType gets a reference to the given ScheduledRoomMoveResponseType and assigns it to the ScheduledRoomMoveResponseType field.
func (o *StayInfoType) SetScheduledRoomMoveResponseType(v ScheduledRoomMoveResponseType) {
	o.ScheduledRoomMoveResponseType = &v
}
...
func (o StayInfoType) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.BookingTimeSpan) {
		toSerialize["bookingTimeSpan"] = o.BookingTimeSpan
	}
	...
	if !IsNil(o.ScheduledRoomMoveRoomPending) {
		toSerialize["scheduledRoomMoveRoomPending"] = o.ScheduledRoomMoveRoomPending
	}
	...
	if !IsNil(o.RoomAvailableNights) {
		toSerialize["roomAvailableNights"] = o.RoomAvailableNights
	}
	...
	if !IsNil(o.ScheduledRoomMoveResponseType) {
		toSerialize["scheduledRoomMoveResponseType"] = o.ScheduledRoomMoveResponseType
	}
