...
type HotelReservationType struct {
	...
	RateSummary *ReservationRateSummaryType `json:"rateSummary,omitempty"`
	...
	DepositPayment *DepositPaymentType `json:"depositPayment,omitempty"`
	...
	// Indicates whether the block restrictions should be overriden when creating a new block reservation.
	...
	ResvIdentifications []ResvIdentificationInfoType `json:"resvIdentifications,omitempty"`
	...
	BackToBackSequence *BackToBackResSequenceType `json:"backToBackSequence,omitempty"`
	...
	ScheduledRoomMoves []ScheduledRoomMoveType `json:"scheduledRoomMoves,omitempty"`
	...
	RouteAllTransactionsToShare *bool `json:"routeAllTransactionsToShare,omitempty"`
	...
	BackToBackGroupId *string `json:"backToBackGroupId,omitempty"`
	// Indicates to override the check on shared reservations to whom changes can be propagated until their departure date.
	OverrideSharesStayingPastDepartureCheck *bool `json:"overrideSharesStayingPastDepartureCheck,omitempty"`
	...
	ReservationProtection *ReservationProtectionType `json:"reservationProtection,omitempty"`
	PreArrivalReviewStatus *PreArrivalReviewStatusType `json:"preArrivalReviewStatus,omitempty"`
}
...
// GetRateSummary returns the RateSummary field value if set, zero value otherwise.
func (o *HotelReservationType) GetRateSummary() ReservationRateSummaryType {
	if o == nil || IsNil(o.RateSummary) {
		var ret ReservationRateSummaryType
		return ret
	}
	return *o.RateSummary
}

// GetRateSummaryOk returns a tuple with the RateSummary field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *HotelReservationType) GetRateSummaryOk() (*ReservationRateSummaryType, bool) {
	if o == nil || IsNil(o.RateSummary) {
		return nil, false
	}
	return o.RateSummary, true
}

// HasRateSummary returns a boolean if a field has been set.
func (o *HotelReservationType) HasRateSummary() bool {
	if o != nil && !IsNil(o.RateSummary) {
		return true
	}
...
// SetRateSummary gets a reference to the given ReservationRateSummaryType and assigns it to the RateSummary field.
func (o *HotelReservationType) SetRateSummary(v ReservationRateSummaryType) {
	o.RateSummary = &v
}
...
// GetDepositPayment returns the DepositPayment field value if set, zero value otherwise.
func (o *HotelReservationType) GetDepositPayment() DepositPaymentType {
	if o == nil || IsNil(o.DepositPayment) {
		var ret DepositPaymentType
		return ret
	}
	return *o.DepositPayment
}

// GetDepositPaymentOk returns a tuple with the DepositPayment field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *HotelReservationType) GetDepositPaymentOk() (*DepositPaymentType, bool) {
	if o == nil || IsNil(o.DepositPayment) {
		return nil, false
	}
	return o.DepositPayment, true
}

// HasDepositPayment returns a boolean if a field has been set.
func (o *HotelReservationType) HasDepositPayment() bool {
	if o != nil && !IsNil(o.DepositPayment) {
		return true
	}
...
// SetDepositPayment gets a reference to the given DepositPaymentType and assigns it to the DepositPayment field.
func (o *HotelReservationType) SetDepositPayment(v DepositPaymentType) {
	o.DepositPayment = &v
}
...
// GetResvIdentifications returns the ResvIdentifications field value if set, zero value otherwise.
func (o *HotelReservationType) GetResvIdentifications() []ResvIdentificationInfoType {
	if o == nil || IsNil(o.ResvIdentifications) {
		var ret []ResvIdentificationInfoType
		return ret
	}
	return o.ResvIdentifications
}

// GetResvIdentificationsOk returns a tuple with the ResvIdentifications field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *HotelReservationType) GetResvIdentificationsOk() ([]ResvIdentificationInfoType, bool) {
	if o == nil || IsNil(o.ResvIdentifications) {
		return nil, false
	}
	return o.ResvIdentifications, true
}

// HasResvIdentifications returns a boolean if a field has been set.
func (o *HotelReservationType) HasResvIdentifications() bool {
	if o != nil && !IsNil(o.ResvIdentifications) {
		return true
	}
...
// SetResvIdentifications gets a reference to the given []ResvIdentificationInfoType and assigns it to the ResvIdentifications field.
func (o *HotelReservationType) SetResvIdentifications(v []ResvIdentificationInfoType) {
	o.ResvIdentifications = v
}
...
// GetBackToBackSequence returns the BackToBackSequence field value if set, zero value otherwise.
func (o *HotelReservationType) GetBackToBackSequence() BackToBackResSequenceType {
	if o == nil || IsNil(o.BackToBackSequence) {
		var ret BackToBackResSequenceType
		return ret
	}
	return *o.BackToBackSequence
}

// GetBackToBackSequenceOk returns a tuple with the BackToBackSequence field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *HotelReservationType) GetBackToBackSequenceOk() (*BackToBackResSequenceType, bool) {
	if o == nil || IsNil(o.BackToBackSequence) {
		return nil, false
	}
	return o.BackToBackSequence, true
}
...
// SetBackToBackSequence gets a reference to the given BackToBackResSequenceType and assigns it to the BackToBackSequence field.
func (o *HotelReservationType) SetBackToBackSequence(v BackToBackResSequenceType) {
	o.BackToBackSequence = &v
}
...
// GetScheduledRoomMoves returns the ScheduledRoomMoves field value if set, zero value otherwise.
func (o *HotelReservationType) GetScheduledRoomMoves() []ScheduledRoomMoveType {
	if o == nil || IsNil(o.ScheduledRoomMoves) {
		var ret []ScheduledRoomMoveType
		return ret
	}
	return o.ScheduledRoomMoves
}

// GetScheduledRoomMovesOk returns a tuple with the ScheduledRoomMoves field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *HotelReservationType) GetScheduledRoomMovesOk() ([]ScheduledRoomMoveType, bool) {
	if o == nil || IsNil(o.ScheduledRoomMoves) {
		return nil, false
	}
	return o.ScheduledRoomMoves, true
}
...
// SetScheduledRoomMoves gets a reference to the given []ScheduledRoomMoveType and assigns it to the ScheduledRoomMoves field.
func (o *HotelReservationType) SetScheduledRoomMoves(v []ScheduledRoomMoveType) {
	o.ScheduledRoomMoves = v
}

// GetRouteAllTransactionsToShare returns the RouteAllTransactionsToShare field value if set, zero value otherwise.
func (o *HotelReservationType) GetRouteAllTransactionsToShare() bool {
	if o == nil || IsNil(o.RouteAllTransactionsToShare) {
		var ret bool
		return ret
	}
	return *o.RouteAllTransactionsToShare
}

// GetRouteAllTransactionsToShareOk returns a tuple with the RouteAllTransactionsToShare field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *HotelReservationType) GetRouteAllTransactionsToShareOk() (*bool, bool) {
	if o == nil || IsNil(o.RouteAllTransactionsToShare) {
		return nil, false
	}
	return o.RouteAllTransactionsToShare, true
}
...
// SetRouteAllTransactionsToShare gets a reference to the given bool and assigns it to the RouteAllTransactionsToShare field.
func (o *HotelReservationType) SetRouteAllTransactionsToShare(v bool) {
	o.RouteAllTransactionsToShare = &v
}

// GetBackToBackGroupId returns the BackToBackGroupId field value if set, zero value otherwise.
func (o *HotelReservationType) GetBackToBackGroupId() string {
	if o == nil || IsNil(o.BackToBackGroupId) {
		var ret string
		return ret
	}
	return *o.BackToBackGroupId
}

// GetBackToBackGroupIdOk returns a tuple with the BackToBackGroupId field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *HotelReservationType) GetBackToBackGroupIdOk() (*string, bool) {
	if o == nil || IsNil(o.BackToBackGroupId) {
		return nil, false
	}
	return o.BackToBackGroupId, true
}
...
// SetBackToBackGroupId gets a reference to the given string and assigns it to the BackToBackGroupId field.
func (o *HotelReservationType) SetBackToBackGroupId(v string) {
	o.BackToBackGroupId = &v
}

// GetOverrideSharesStayingPastDepartureCheck returns the OverrideSharesStayingPastDepartureCheck field value if set, zero value otherwise.
func (o *HotelReservationType) GetOverrideSharesStayingPastDepartureCheck() bool {
	if o == nil || IsNil(o.OverrideSharesStayingPastDepartureCheck) {
		var ret bool
		return ret
	}
	return *o.OverrideSharesStayingPastDepartureCheck
}

// GetOverrideSharesStayingPastDepartureCheckOk returns a tuple with the OverrideSharesStayingPastDepartureCheck field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *HotelReservationType) GetOverrideSharesStayingPastDepartureCheckOk() (*bool, bool) {
	if o == nil || IsNil(o.OverrideSharesStayingPastDepartureCheck) {
		return nil, false
	}
	return o.OverrideSharesStayingPastDepartureCheck, true
}
...
// SetOverrideSharesStayingPastDepartureCheck gets a reference to the given bool and assigns it to the OverrideSharesStayingPastDepartureCheck field.
func (o *HotelReservationType) SetOverrideSharesStayingPastDepartureCheck(v bool) {
	o.OverrideSharesStayingPastDepartureCheck = &v
}
...
func (o *HotelReservationType) GetCheckInInitiatedBy() string {
...
// and a boolean to check if the value has been set.
func (o *HotelReservationType) GetCheckInInitiatedByOk() (*string, bool) {
	if o == nil || IsNil(o.CheckInInitiatedBy) {
		return nil, false
	}
...
func (o *HotelReservationType) HasCheckInInitiatedBy() bool {
	if o != nil && !IsNil(o.CheckInInitiatedBy) {
		return true
	}
...
func (o *HotelReservationType) SetCheckInInitiatedBy(v string) {
	o.CheckInInitiatedBy = &v
}

// GetReservationProtection returns the ReservationProtection field value if set, zero value otherwise.
func (o *HotelReservationType) GetReservationProtection() ReservationProtectionType {
	if o == nil || IsNil(o.ReservationProtection) {
		var ret ReservationProtectionType
		return ret
	}
	return *o.ReservationProtection
}

// GetReservationProtectionOk returns a tuple with the ReservationProtection field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *HotelReservationType) GetReservationProtectionOk() (*ReservationProtectionType, bool) {
	if o == nil || IsNil(o.ReservationProtection) {
		return nil, false
	}
	return o.ReservationProtection, true
}

// HasReservationProtection returns a boolean if a field has been set.
func (o *HotelReservationType) HasReservationProtection() bool {
	if o != nil && !IsNil(o.ReservationProtection) {
		return true
	}
...
// SetReservationProtection gets a reference to the given ReservationProtectionType and assigns it to the ReservationProtection field.
func (o *HotelReservationType) SetReservationProtection(v ReservationProtectionType) {
	o.ReservationProtection = &v
}

// GetPreArrivalReviewStatus returns the PreArrivalReviewStatus field value if set, zero value otherwise.
func (o *HotelReservationType) GetPreArrivalReviewStatus() PreArrivalReviewStatusType {
	if o == nil || IsNil(o.PreArrivalReviewStatus) {
		var ret PreArrivalReviewStatusType
		return ret
	}
	return *o.PreArrivalReviewStatus
}

// GetPreArrivalReviewStatusOk returns a tuple with the PreArrivalReviewStatus field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *HotelReservationType) GetPreArrivalReviewStatusOk() (*PreArrivalReviewStatusType, bool) {
	if o == nil || IsNil(o.PreArrivalReviewStatus) {
		return nil, false
	}
	return o.PreArrivalReviewStatus, true
}

// HasPreArrivalReviewStatus returns a boolean if a field has been set.
func (o *HotelReservationType) HasPreArrivalReviewStatus() bool {
	if o != nil && !IsNil(o.PreArrivalReviewStatus) {
		return true
	}
...
// SetPreArrivalReviewStatus gets a reference to the given PreArrivalReviewStatusType and assigns it to the PreArrivalReviewStatus field.
func (o *HotelReservationType) SetPreArrivalReviewStatus(v PreArrivalReviewStatusType) {
	o.PreArrivalReviewStatus = &v
}
...
func (o HotelReservationType) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.RateSummary) {
		toSerialize["rateSummary"] = o.RateSummary
	}
	...
	if !IsNil(o.DepositPayment) {
		toSerialize["depositPayment"] = o.DepositPayment
	}
	...
	if !IsNil(o.ResvIdentifications) {
		toSerialize["resvIdentifications"] = o.ResvIdentifications
	}
	...
	if !IsNil(o.BackToBackSequence) {
		toSerialize["backToBackSequence"] = o.BackToBackSequence
	}
	if !IsNil(o.PayeeSharer) {
		toSerialize["payeeSharer"] = o.PayeeSharer
	}
	if !IsNil(o.ScheduledRoomMoves) {
		toSerialize["scheduledRoomMoves"] = o.ScheduledRoomMoves
	}
	if !IsNil(o.RouteAllTransactionsToShare) {
		toSerialize["routeAllTransactionsToShare"] = o.RouteAllTransactionsToShare
	}
	if !IsNil(o.BackToBackGroupId) {
		toSerialize["backToBackGroupId"] = o.BackToBackGroupId
	}
	if !IsNil(o.OverrideSharesStayingPastDepartureCheck) {
		toSerialize["overrideSharesStayingPastDepartureCheck"] = o.OverrideSharesStayingPastDepartureCheck
	}
	...
	if !IsNil(o.ReservationProtection) {
		toSerialize["reservationProtection"] = o.ReservationProtection
	}
	if !IsNil(o.PreArrivalReviewStatus) {
		toSerialize["preArrivalReviewStatus"] = o.PreArrivalReviewStatus
	}
