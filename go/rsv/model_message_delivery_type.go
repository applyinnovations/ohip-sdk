...
type MessageDeliveryType struct {
	...
	// Date the message has been delivered (marked as received). Uses the hotel's time zone for getGuestMessages. Uses database time zone for putGuestMessages.
	DeliveryDate *string `json:"deliveryDate,omitempty"`
	// User who delivered the message (who marked message as received)
	DeliveredBy *string `json:"deliveredBy,omitempty"`
	// Date when message has been printed. Uses database time zone.
	PrintDate *string `json:"printDate,omitempty"`
	// Date when message has been sent via SMS. Uses database time zone.
