...
type BillingPrivilegesType struct {
	...
	ExcludeFromAutoAuthorization *bool `json:"excludeFromAutoAuthorization,omitempty"`
...
// GetExcludeFromAutoAuthorization returns the ExcludeFromAutoAuthorization field value if set, zero value otherwise.
func (o *BillingPrivilegesType) GetExcludeFromAutoAuthorization() bool {
	if o == nil || IsNil(o.ExcludeFromAutoAuthorization) {
		var ret bool
		return ret
	}
	return *o.ExcludeFromAutoAuthorization
}

// GetExcludeFromAutoAuthorizationOk returns a tuple with the ExcludeFromAutoAuthorization field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *BillingPrivilegesType) GetExcludeFromAutoAuthorizationOk() (*bool, bool) {
	if o == nil || IsNil(o.ExcludeFromAutoAuthorization) {
		return nil, false
	}
	return o.ExcludeFromAutoAuthorization, true
}
...
// SetExcludeFromAutoAuthorization gets a reference to the given bool and assigns it to the ExcludeFromAutoAuthorization field.
func (o *BillingPrivilegesType) SetExcludeFromAutoAuthorization(v bool) {
	o.ExcludeFromAutoAuthorization = &v
}
...
func (o BillingPrivilegesType) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.ExcludeFromAutoAuthorization) {
		toSerialize["excludeFromAutoAuthorization"] = o.ExcludeFromAutoAuthorization
	}
