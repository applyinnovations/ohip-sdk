...
func (o *ReservationProfileType) GetExternalReferences() []ExternalReferenceType {
...
// and a boolean to check if the value has been set.
func (o *ReservationProfileType) GetExternalReferencesOk() ([]ExternalReferenceType, bool) {
	if o == nil || IsNil(o.ExternalReferences) {
		return nil, false
	}
...
func (o *ReservationProfileType) HasExternalReferences() bool {
	if o != nil && !IsNil(o.ExternalReferences) {
		return true
	}
...
func (o *ReservationProfileType) SetExternalReferences(v []ExternalReferenceType) {
