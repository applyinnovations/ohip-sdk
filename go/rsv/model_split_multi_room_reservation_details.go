...
type SplitMultiRoomReservationDetails struct {
	...
	NewReservationIdList []UniqueIDType `json:"newReservationIdList,omitempty"`
...
// SetNewReservationIdList gets a reference to the given []UniqueIDType and assigns it to the NewReservationIdList field.
