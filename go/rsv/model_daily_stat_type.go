...
type DailyStatType struct {
	...
	BlockStats []BlockStatType `json:"blockStats,omitempty"`
}
...
// SetBlockStats gets a reference to the given []BlockStatType and assigns it to the BlockStats field.
