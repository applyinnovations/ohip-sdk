...
type AttachDetachType struct {
	// Time stamp the accompanying guest was last attached. Uses the hotel's time zone.
	AttachDateTime *string `json:"attachDateTime,omitempty"`
	// Time stamp the accompanying guest was last detached. Uses the hotel's time zone.
