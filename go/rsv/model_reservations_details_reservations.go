...
type ReservationsDetailsReservations struct {
	...
	// Total number of results returned by similarity search. Returned only when similaritySearch query parameter is true.
	SimilaritySearchResults *int32 `json:"similaritySearchResults,omitempty"`
...
// GetSimilaritySearchResults returns the SimilaritySearchResults field value if set, zero value otherwise.
func (o *ReservationsDetailsReservations) GetSimilaritySearchResults() int32 {
	if o == nil || IsNil(o.SimilaritySearchResults) {
		var ret int32
		return ret
	}
	return *o.SimilaritySearchResults
}

// GetSimilaritySearchResultsOk returns a tuple with the SimilaritySearchResults field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ReservationsDetailsReservations) GetSimilaritySearchResultsOk() (*int32, bool) {
	if o == nil || IsNil(o.SimilaritySearchResults) {
		return nil, false
	}
	return o.SimilaritySearchResults, true
}

// HasSimilaritySearchResults returns a boolean if a field has been set.
func (o *ReservationsDetailsReservations) HasSimilaritySearchResults() bool {
	if o != nil && !IsNil(o.SimilaritySearchResults) {
		return true
	}
...
// SetSimilaritySearchResults gets a reference to the given int32 and assigns it to the SimilaritySearchResults field.
func (o *ReservationsDetailsReservations) SetSimilaritySearchResults(v int32) {
	o.SimilaritySearchResults = &v
}
...
func (o ReservationsDetailsReservations) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.SimilaritySearchResults) {
		toSerialize["similaritySearchResults"] = o.SimilaritySearchResults
	}
