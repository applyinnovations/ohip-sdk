...
type CheckReservationType struct {
	...
	Results []CheckResultType `json:"results,omitempty"`
}
...
// SetResults gets a reference to the given []CheckResultType and assigns it to the Results field.
