...
type RoomStayType struct {
	...
	// Indicates if resertvation has a rate that is configured with a non-nightly posting interval.
	HasExtendedStayRates *bool `json:"hasExtendedStayRates,omitempty"`
	// A collection of Posting Interval details for the reservation.
	PostingIntervals []PostingIntervalType `json:"postingIntervals,omitempty"`
	...
	ReservationKeyInfo *ReservationKeyInfoType `json:"reservationKeyInfo,omitempty"`
...
// GetHasExtendedStayRates returns the HasExtendedStayRates field value if set, zero value otherwise.
func (o *RoomStayType) GetHasExtendedStayRates() bool {
	if o == nil || IsNil(o.HasExtendedStayRates) {
		var ret bool
		return ret
	}
	return *o.HasExtendedStayRates
}

// GetHasExtendedStayRatesOk returns a tuple with the HasExtendedStayRates field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *RoomStayType) GetHasExtendedStayRatesOk() (*bool, bool) {
	if o == nil || IsNil(o.HasExtendedStayRates) {
		return nil, false
	}
	return o.HasExtendedStayRates, true
}

// HasHasExtendedStayRates returns a boolean if a field has been set.
func (o *RoomStayType) HasHasExtendedStayRates() bool {
	if o != nil && !IsNil(o.HasExtendedStayRates) {
		return true
	}
...
// SetHasExtendedStayRates gets a reference to the given bool and assigns it to the HasExtendedStayRates field.
func (o *RoomStayType) SetHasExtendedStayRates(v bool) {
	o.HasExtendedStayRates = &v
}

// GetPostingIntervals returns the PostingIntervals field value if set, zero value otherwise.
func (o *RoomStayType) GetPostingIntervals() []PostingIntervalType {
	if o == nil || IsNil(o.PostingIntervals) {
		var ret []PostingIntervalType
		return ret
	}
	return o.PostingIntervals
}

// GetPostingIntervalsOk returns a tuple with the PostingIntervals field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *RoomStayType) GetPostingIntervalsOk() ([]PostingIntervalType, bool) {
	if o == nil || IsNil(o.PostingIntervals) {
		return nil, false
	}
	return o.PostingIntervals, true
}

// HasPostingIntervals returns a boolean if a field has been set.
func (o *RoomStayType) HasPostingIntervals() bool {
	if o != nil && !IsNil(o.PostingIntervals) {
		return true
	}
...
// SetPostingIntervals gets a reference to the given []PostingIntervalType and assigns it to the PostingIntervals field.
func (o *RoomStayType) SetPostingIntervals(v []PostingIntervalType) {
	o.PostingIntervals = v
}
...
// GetReservationKeyInfo returns the ReservationKeyInfo field value if set, zero value otherwise.
func (o *RoomStayType) GetReservationKeyInfo() ReservationKeyInfoType {
	if o == nil || IsNil(o.ReservationKeyInfo) {
		var ret ReservationKeyInfoType
		return ret
	}
	return *o.ReservationKeyInfo
}

// GetReservationKeyInfoOk returns a tuple with the ReservationKeyInfo field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *RoomStayType) GetReservationKeyInfoOk() (*ReservationKeyInfoType, bool) {
	if o == nil || IsNil(o.ReservationKeyInfo) {
		return nil, false
	}
	return o.ReservationKeyInfo, true
}
...
// SetReservationKeyInfo gets a reference to the given ReservationKeyInfoType and assigns it to the ReservationKeyInfo field.
func (o *RoomStayType) SetReservationKeyInfo(v ReservationKeyInfoType) {
	o.ReservationKeyInfo = &v
}
...
func (o *RoomStayType) GetScheduledRoomMoveRoomPending() bool {
...
// and a boolean to check if the value has been set.
func (o *RoomStayType) GetScheduledRoomMoveRoomPendingOk() (*bool, bool) {
	if o == nil || IsNil(o.ScheduledRoomMoveRoomPending) {
		return nil, false
	}
...
func (o *RoomStayType) HasScheduledRoomMoveRoomPending() bool {
	if o != nil && !IsNil(o.ScheduledRoomMoveRoomPending) {
		return true
	}
...
func (o *RoomStayType) SetScheduledRoomMoveRoomPending(v bool) {
...
func (o RoomStayType) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.HasExtendedStayRates) {
		toSerialize["hasExtendedStayRates"] = o.HasExtendedStayRates
	}
	if !IsNil(o.PostingIntervals) {
		toSerialize["postingIntervals"] = o.PostingIntervals
	}
	...
	if !IsNil(o.ReservationKeyInfo) {
		toSerialize["reservationKeyInfo"] = o.ReservationKeyInfo
	}
