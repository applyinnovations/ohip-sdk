...
type MoveReservationHotelCriteriaType struct {
	...
	RetainRateCodeAndAmount *bool `json:"retainRateCodeAndAmount,omitempty"`
}
...
// GetRetainRateCodeAndAmount returns the RetainRateCodeAndAmount field value if set, zero value otherwise.
func (o *MoveReservationHotelCriteriaType) GetRetainRateCodeAndAmount() bool {
	if o == nil || IsNil(o.RetainRateCodeAndAmount) {
		var ret bool
		return ret
	}
	return *o.RetainRateCodeAndAmount
}

// GetRetainRateCodeAndAmountOk returns a tuple with the RetainRateCodeAndAmount field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *MoveReservationHotelCriteriaType) GetRetainRateCodeAndAmountOk() (*bool, bool) {
	if o == nil || IsNil(o.RetainRateCodeAndAmount) {
		return nil, false
	}
	return o.RetainRateCodeAndAmount, true
}
...
// SetRetainRateCodeAndAmount gets a reference to the given bool and assigns it to the RetainRateCodeAndAmount field.
func (o *MoveReservationHotelCriteriaType) SetRetainRateCodeAndAmount(v bool) {
	o.RetainRateCodeAndAmount = &v
}
...
func (o MoveReservationHotelCriteriaType) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.RetainRateCodeAndAmount) {
		toSerialize["retainRateCodeAndAmount"] = o.RetainRateCodeAndAmount
	}
