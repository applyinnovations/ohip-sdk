...
type GuaranteeRequirementsType struct {
	...
	// When true indicates an email is required for this guarantee code.
	Email *bool `json:"email,omitempty"`
	// When true indicates attaching a travel agent profile is required for this guarantee code.
	TravelAgent *bool `json:"travelAgent,omitempty"`
	// When true indicates attaching a company profile is required for this guarantee code.
