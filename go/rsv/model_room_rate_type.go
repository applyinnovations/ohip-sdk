...
type RoomRateType struct {
	...
	OffshoreRateInformation *OffshoreRateType `json:"offshoreRateInformation,omitempty"`
	...
	// Indicates if the rate code is restricted for use by Owner Reservations.
	OwnerUseRateCode *bool `json:"ownerUseRateCode,omitempty"`
	// Indicates if the rate code is restricted for use by Owner Referral Reservations
	OwnerReferralRateCode *bool `json:"ownerReferralRateCode,omitempty"`
	...
	// This attribute is to verify if the move in room number is locked. When true the move in room number cannot be changed. Locking a room number is available when the Do Not Move OPERA Control is active.
	RoomNumberLocked *bool `json:"roomNumberLocked,omitempty"`
	ScheduledMoveStatus *ScheduledRoomMoveStatusType `json:"scheduledMoveStatus,omitempty"`
}
...
// GetOffshoreRateInformation returns the OffshoreRateInformation field value if set, zero value otherwise.
func (o *RoomRateType) GetOffshoreRateInformation() OffshoreRateType {
	if o == nil || IsNil(o.OffshoreRateInformation) {
		var ret OffshoreRateType
		return ret
	}
	return *o.OffshoreRateInformation
}

// GetOffshoreRateInformationOk returns a tuple with the OffshoreRateInformation field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *RoomRateType) GetOffshoreRateInformationOk() (*OffshoreRateType, bool) {
	if o == nil || IsNil(o.OffshoreRateInformation) {
		return nil, false
	}
	return o.OffshoreRateInformation, true
}

// HasOffshoreRateInformation returns a boolean if a field has been set.
func (o *RoomRateType) HasOffshoreRateInformation() bool {
	if o != nil && !IsNil(o.OffshoreRateInformation) {
		return true
	}
...
// SetOffshoreRateInformation gets a reference to the given OffshoreRateType and assigns it to the OffshoreRateInformation field.
func (o *RoomRateType) SetOffshoreRateInformation(v OffshoreRateType) {
	o.OffshoreRateInformation = &v
}
...
// GetEligibilityCode returns the EligibilityCode field value if set, zero value otherwise.
func (o *RoomRateType) GetEligibilityCode() string {
	if o == nil || IsNil(o.EligibilityCode) {
		var ret string
		return ret
	}
	return *o.EligibilityCode
}

// GetEligibilityCodeOk returns a tuple with the EligibilityCode field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *RoomRateType) GetEligibilityCodeOk() (*string, bool) {
	if o == nil || IsNil(o.EligibilityCode) {
		return nil, false
	}
	return o.EligibilityCode, true
}
...
// SetEligibilityCode gets a reference to the given string and assigns it to the EligibilityCode field.
...
// SetAwardNumber gets a reference to the given string and assigns it to the AwardNumber field.
...
func (o *RoomRateType) GetMembershipEligible() bool {
...
// and a boolean to check if the value has been set.
func (o *RoomRateType) GetMembershipEligibleOk() (*bool, bool) {
	if o == nil || IsNil(o.MembershipEligible) {
		return nil, false
	}
...
func (o *RoomRateType) HasMembershipEligible() bool {
	if o != nil && !IsNil(o.MembershipEligible) {
		return true
	}
...
func (o *RoomRateType) SetMembershipEligible(v bool) {
	o.MembershipEligible = &v
}

// GetOwnerUseRateCode returns the OwnerUseRateCode field value if set, zero value otherwise.
func (o *RoomRateType) GetOwnerUseRateCode() bool {
	if o == nil || IsNil(o.OwnerUseRateCode) {
		var ret bool
		return ret
	}
	return *o.OwnerUseRateCode
}

// GetOwnerUseRateCodeOk returns a tuple with the OwnerUseRateCode field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *RoomRateType) GetOwnerUseRateCodeOk() (*bool, bool) {
	if o == nil || IsNil(o.OwnerUseRateCode) {
		return nil, false
	}
	return o.OwnerUseRateCode, true
}

// HasOwnerUseRateCode returns a boolean if a field has been set.
func (o *RoomRateType) HasOwnerUseRateCode() bool {
	if o != nil && !IsNil(o.OwnerUseRateCode) {
		return true
	}
...
// SetOwnerUseRateCode gets a reference to the given bool and assigns it to the OwnerUseRateCode field.
func (o *RoomRateType) SetOwnerUseRateCode(v bool) {
	o.OwnerUseRateCode = &v
}

// GetOwnerReferralRateCode returns the OwnerReferralRateCode field value if set, zero value otherwise.
func (o *RoomRateType) GetOwnerReferralRateCode() bool {
	if o == nil || IsNil(o.OwnerReferralRateCode) {
		var ret bool
		return ret
	}
	return *o.OwnerReferralRateCode
}

// GetOwnerReferralRateCodeOk returns a tuple with the OwnerReferralRateCode field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *RoomRateType) GetOwnerReferralRateCodeOk() (*bool, bool) {
	if o == nil || IsNil(o.OwnerReferralRateCode) {
		return nil, false
	}
	return o.OwnerReferralRateCode, true
}

// HasOwnerReferralRateCode returns a boolean if a field has been set.
func (o *RoomRateType) HasOwnerReferralRateCode() bool {
	if o != nil && !IsNil(o.OwnerReferralRateCode) {
		return true
	}
...
// SetOwnerReferralRateCode gets a reference to the given bool and assigns it to the OwnerReferralRateCode field.
func (o *RoomRateType) SetOwnerReferralRateCode(v bool) {
	o.OwnerReferralRateCode = &v
}
...
func (o *RoomRateType) GetRoomNumberLocked() bool {
...
// and a boolean to check if the value has been set.
func (o *RoomRateType) GetRoomNumberLockedOk() (*bool, bool) {
	if o == nil || IsNil(o.RoomNumberLocked) {
		return nil, false
	}
...
func (o *RoomRateType) HasRoomNumberLocked() bool {
	if o != nil && !IsNil(o.RoomNumberLocked) {
		return true
	}
...
func (o *RoomRateType) SetRoomNumberLocked(v bool) {
	o.RoomNumberLocked = &v
}

// GetScheduledMoveStatus returns the ScheduledMoveStatus field value if set, zero value otherwise.
func (o *RoomRateType) GetScheduledMoveStatus() ScheduledRoomMoveStatusType {
	if o == nil || IsNil(o.ScheduledMoveStatus) {
		var ret ScheduledRoomMoveStatusType
		return ret
	}
	return *o.ScheduledMoveStatus
}

// GetScheduledMoveStatusOk returns a tuple with the ScheduledMoveStatus field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *RoomRateType) GetScheduledMoveStatusOk() (*ScheduledRoomMoveStatusType, bool) {
	if o == nil || IsNil(o.ScheduledMoveStatus) {
		return nil, false
	}
	return o.ScheduledMoveStatus, true
}

// HasScheduledMoveStatus returns a boolean if a field has been set.
func (o *RoomRateType) HasScheduledMoveStatus() bool {
	if o != nil && !IsNil(o.ScheduledMoveStatus) {
		return true
	}
...
// SetScheduledMoveStatus gets a reference to the given ScheduledRoomMoveStatusType and assigns it to the ScheduledMoveStatus field.
func (o *RoomRateType) SetScheduledMoveStatus(v ScheduledRoomMoveStatusType) {
	o.ScheduledMoveStatus = &v
}
...
func (o RoomRateType) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.OffshoreRateInformation) {
		toSerialize["offshoreRateInformation"] = o.OffshoreRateInformation
	}
	if !IsNil(o.Packages) {
	...
	if !IsNil(o.EligibilityCode) {
		toSerialize["eligibilityCode"] = o.EligibilityCode
	}
	...
	if !IsNil(o.OwnerUseRateCode) {
		toSerialize["ownerUseRateCode"] = o.OwnerUseRateCode
	}
	if !IsNil(o.OwnerReferralRateCode) {
		toSerialize["ownerReferralRateCode"] = o.OwnerReferralRateCode
	}
	...
	if !IsNil(o.ScheduledMoveStatus) {
		toSerialize["scheduledMoveStatus"] = o.ScheduledMoveStatus
	}
