...
// checks if the ChangeGuestMessages type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ChangeGuestMessages{}

// ChangeGuestMessages Request object for updating the Guest Messages for a Reservation.
type ChangeGuestMessages struct {
...
func (o ChangeGuestMessages) MarshalJSON() ([]byte, error) {
...
func (o ChangeGuestMessages) ToMap() (map[string]interface{}, error) {
...
type NullableChangeGuestMessages struct {
	value *ChangeGuestMessages
	isSet bool
}

func (v NullableChangeGuestMessages) Get() *ChangeGuestMessages {
	return v.value
}

func (v *NullableChangeGuestMessages) Set(val *ChangeGuestMessages) {
	v.value = val
	v.isSet = true
}

func (v NullableChangeGuestMessages) IsSet() bool {
	return v.isSet
}

func (v *NullableChangeGuestMessages) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableChangeGuestMessages(val *ChangeGuestMessages) *NullableChangeGuestMessages {
	return &NullableChangeGuestMessages{value: val, isSet: true}
}

func (v NullableChangeGuestMessages) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableChangeGuestMessages) UnmarshalJSON(src []byte) error {
	v.isSet = true
