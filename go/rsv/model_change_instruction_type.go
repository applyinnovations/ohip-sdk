...
type ChangeInstructionType struct {
	...
	// When true, changes to accompanying guests are performed following an incremental update approach instead of a full overlay.
	DeltaUpdateOnAccompanyingGuests *bool `json:"deltaUpdateOnAccompanyingGuests,omitempty"`
}
...
// GetDeltaUpdateOnAccompanyingGuests returns the DeltaUpdateOnAccompanyingGuests field value if set, zero value otherwise.
func (o *ChangeInstructionType) GetDeltaUpdateOnAccompanyingGuests() bool {
	if o == nil || IsNil(o.DeltaUpdateOnAccompanyingGuests) {
		var ret bool
		return ret
	}
	return *o.DeltaUpdateOnAccompanyingGuests
}

// GetDeltaUpdateOnAccompanyingGuestsOk returns a tuple with the DeltaUpdateOnAccompanyingGuests field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ChangeInstructionType) GetDeltaUpdateOnAccompanyingGuestsOk() (*bool, bool) {
	if o == nil || IsNil(o.DeltaUpdateOnAccompanyingGuests) {
		return nil, false
	}
	return o.DeltaUpdateOnAccompanyingGuests, true
}

// HasDeltaUpdateOnAccompanyingGuests returns a boolean if a field has been set.
func (o *ChangeInstructionType) HasDeltaUpdateOnAccompanyingGuests() bool {
	if o != nil && !IsNil(o.DeltaUpdateOnAccompanyingGuests) {
		return true
	}
...
// SetDeltaUpdateOnAccompanyingGuests gets a reference to the given bool and assigns it to the DeltaUpdateOnAccompanyingGuests field.
func (o *ChangeInstructionType) SetDeltaUpdateOnAccompanyingGuests(v bool) {
	o.DeltaUpdateOnAccompanyingGuests = &v
}
...
func (o ChangeInstructionType) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.DeltaUpdateOnAccompanyingGuests) {
		toSerialize["deltaUpdateOnAccompanyingGuests"] = o.DeltaUpdateOnAccompanyingGuests
	}
