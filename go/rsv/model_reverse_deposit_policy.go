...
// checks if the ReverseDepositPolicy type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ReverseDepositPolicy{}

// ReverseDepositPolicy Request type to reverse deposit policy of a reservation.(This is applicable only when advance deposit handling is set to '17') ReverseDepositPolicy operation will reverse the policy by creating a new request with same opposite amount.
type ReverseDepositPolicy struct {
...
func (o ReverseDepositPolicy) MarshalJSON() ([]byte, error) {
...
func (o ReverseDepositPolicy) ToMap() (map[string]interface{}, error) {
...
type NullableReverseDepositPolicy struct {
	value *ReverseDepositPolicy
	isSet bool
}

func (v NullableReverseDepositPolicy) Get() *ReverseDepositPolicy {
	return v.value
}

func (v *NullableReverseDepositPolicy) Set(val *ReverseDepositPolicy) {
	v.value = val
	v.isSet = true
}

func (v NullableReverseDepositPolicy) IsSet() bool {
	return v.isSet
}

func (v *NullableReverseDepositPolicy) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableReverseDepositPolicy(val *ReverseDepositPolicy) *NullableReverseDepositPolicy {
	return &NullableReverseDepositPolicy{value: val, isSet: true}
}

func (v NullableReverseDepositPolicy) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableReverseDepositPolicy) UnmarshalJSON(src []byte) error {
	v.isSet = true
