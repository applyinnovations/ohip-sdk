...
func (o *ReservationsInstructionsType) GetBlockAssignInstruction() AssignBlockRateInstructionsType {
...
// and a boolean to check if the value has been set.
func (o *ReservationsInstructionsType) GetBlockAssignInstructionOk() (*AssignBlockRateInstructionsType, bool) {
	if o == nil || IsNil(o.BlockAssignInstruction) {
		return nil, false
	}
...
func (o *ReservationsInstructionsType) HasBlockAssignInstruction() bool {
	if o != nil && !IsNil(o.BlockAssignInstruction) {
		return true
	}
...
func (o *ReservationsInstructionsType) SetBlockAssignInstruction(v AssignBlockRateInstructionsType) {
