...
// checks if the ReservationPackagesInfo type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ReservationPackagesInfo{}

// ReservationPackagesInfo Request method to attach a package to an existing reservation.
type ReservationPackagesInfo struct {
...
func (o ReservationPackagesInfo) MarshalJSON() ([]byte, error) {
...
func (o ReservationPackagesInfo) ToMap() (map[string]interface{}, error) {
...
type NullableReservationPackagesInfo struct {
	value *ReservationPackagesInfo
	isSet bool
}

func (v NullableReservationPackagesInfo) Get() *ReservationPackagesInfo {
	return v.value
}

func (v *NullableReservationPackagesInfo) Set(val *ReservationPackagesInfo) {
	v.value = val
	v.isSet = true
}

func (v NullableReservationPackagesInfo) IsSet() bool {
	return v.isSet
}

func (v *NullableReservationPackagesInfo) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableReservationPackagesInfo(val *ReservationPackagesInfo) *NullableReservationPackagesInfo {
	return &NullableReservationPackagesInfo{value: val, isSet: true}
}

func (v NullableReservationPackagesInfo) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableReservationPackagesInfo) UnmarshalJSON(src []byte) error {
	v.isSet = true
