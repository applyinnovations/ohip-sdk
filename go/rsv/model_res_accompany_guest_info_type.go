...
func (o *ResAccompanyGuestInfoType) GetAlternateFirstName() string {
...
// and a boolean to check if the value has been set.
func (o *ResAccompanyGuestInfoType) GetAlternateFirstNameOk() (*string, bool) {
	if o == nil || IsNil(o.AlternateFirstName) {
		return nil, false
	}
...
func (o *ResAccompanyGuestInfoType) HasAlternateFirstName() bool {
	if o != nil && !IsNil(o.AlternateFirstName) {
		return true
	}
...
func (o *ResAccompanyGuestInfoType) SetAlternateFirstName(v string) {
	o.AlternateFirstName = &v
}

// GetAlternateLastName returns the AlternateLastName field value if set, zero value otherwise.
func (o *ResAccompanyGuestInfoType) GetAlternateLastName() string {
...
// and a boolean to check if the value has been set.
func (o *ResAccompanyGuestInfoType) GetAlternateLastNameOk() (*string, bool) {
	if o == nil || IsNil(o.AlternateLastName) {
		return nil, false
	}
...
func (o *ResAccompanyGuestInfoType) HasAlternateLastName() bool {
	if o != nil && !IsNil(o.AlternateLastName) {
		return true
	}
...
func (o *ResAccompanyGuestInfoType) SetAlternateLastName(v string) {
	o.AlternateLastName = &v
}

// GetAlternateFullName returns the AlternateFullName field value if set, zero value otherwise.
func (o *ResAccompanyGuestInfoType) GetAlternateFullName() string {
...
// and a boolean to check if the value has been set.
func (o *ResAccompanyGuestInfoType) GetAlternateFullNameOk() (*string, bool) {
	if o == nil || IsNil(o.AlternateFullName) {
		return nil, false
	}
...
func (o *ResAccompanyGuestInfoType) HasAlternateFullName() bool {
	if o != nil && !IsNil(o.AlternateFullName) {
		return true
	}
...
func (o *ResAccompanyGuestInfoType) SetAlternateFullName(v string) {
...
func (o *ResAccompanyGuestInfoType) GetExternalReferences() []ExternalReferenceType {
...
// and a boolean to check if the value has been set.
func (o *ResAccompanyGuestInfoType) GetExternalReferencesOk() ([]ExternalReferenceType, bool) {
	if o == nil || IsNil(o.ExternalReferences) {
		return nil, false
	}
...
func (o *ResAccompanyGuestInfoType) HasExternalReferences() bool {
	if o != nil && !IsNil(o.ExternalReferences) {
		return true
	}
...
func (o *ResAccompanyGuestInfoType) SetExternalReferences(v []ExternalReferenceType) {
