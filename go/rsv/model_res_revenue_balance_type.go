...
type ResRevenueBalanceType struct {
	...
	TotalDepositPaid *CurrencyAmountType `json:"totalDepositPaid,omitempty"`
}
...
// GetTotalDepositPaid returns the TotalDepositPaid field value if set, zero value otherwise.
func (o *ResRevenueBalanceType) GetTotalDepositPaid() CurrencyAmountType {
	if o == nil || IsNil(o.TotalDepositPaid) {
		var ret CurrencyAmountType
		return ret
	}
	return *o.TotalDepositPaid
}

// GetTotalDepositPaidOk returns a tuple with the TotalDepositPaid field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ResRevenueBalanceType) GetTotalDepositPaidOk() (*CurrencyAmountType, bool) {
	if o == nil || IsNil(o.TotalDepositPaid) {
		return nil, false
	}
	return o.TotalDepositPaid, true
}

// HasTotalDepositPaid returns a boolean if a field has been set.
func (o *ResRevenueBalanceType) HasTotalDepositPaid() bool {
	if o != nil && !IsNil(o.TotalDepositPaid) {
		return true
	}
...
// SetTotalDepositPaid gets a reference to the given CurrencyAmountType and assigns it to the TotalDepositPaid field.
func (o *ResRevenueBalanceType) SetTotalDepositPaid(v CurrencyAmountType) {
	o.TotalDepositPaid = &v
}
...
func (o ResRevenueBalanceType) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.TotalDepositPaid) {
		toSerialize["totalDepositPaid"] = o.TotalDepositPaid
	}
