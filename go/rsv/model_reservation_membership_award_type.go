...
type ReservationMembershipAwardType struct {
	...
	// The date of the reservation associated with the award.
...
func (o *ReservationMembershipAwardType) GetStayDate() string {
...
// and a boolean to check if the value has been set.
func (o *ReservationMembershipAwardType) GetStayDateOk() (*string, bool) {
	if o == nil || IsNil(o.StayDate) {
		return nil, false
	}
...
func (o *ReservationMembershipAwardType) HasStayDate() bool {
	if o != nil && !IsNil(o.StayDate) {
		return true
	}
...
func (o *ReservationMembershipAwardType) SetStayDate(v string) {
	o.StayDate = &v
}
