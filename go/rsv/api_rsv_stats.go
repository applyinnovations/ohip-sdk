...
func (r RSVStatsAPIGetBlockReservationStatisticsByDateAndRoomPoolRequest) ExternalData(externalData string) RSVStatsAPIGetBlockReservationStatisticsByDateAndRoomPoolRequest {
	r.externalData = &externalData
	return r
}

// Request Id of an incoming request
func (r RSVStatsAPIGetBlockReservationStatisticsByDateAndRoomPoolRequest) XRequestId(xRequestId string) RSVStatsAPIGetBlockReservationStatisticsByDateAndRoomPoolRequest {
	r.xRequestId = &xRequestId
	return r
}

// Customer&#39;s Integration Application Id
func (r RSVStatsAPIGetBlockReservationStatisticsByDateAndRoomPoolRequest) XOriginatingApplication(xOriginatingApplication string) RSVStatsAPIGetBlockReservationStatisticsByDateAndRoomPoolRequest {
...
// Pass this header as true, if payload needs DVM
func (r RSVStatsAPIGetReservationPaceRequest) ExternalData(externalData string) RSVStatsAPIGetReservationPaceRequest {
	r.externalData = &externalData
	return r
}

// Request Id of an incoming request
func (r RSVStatsAPIGetReservationPaceRequest) XRequestId(xRequestId string) RSVStatsAPIGetReservationPaceRequest {
	r.xRequestId = &xRequestId
	return r
}

// Customer&#39;s Integration Application Id
func (r RSVStatsAPIGetReservationPaceRequest) XOriginatingApplication(xOriginatingApplication string) RSVStatsAPIGetReservationPaceRequest {
	r.xOriginatingApplication = &xOriginatingApplication
	return r
}
...
// Pass this header as true, if payload needs DVM
func (r RSVStatsAPIGetReservationStatisticsRequest) ExternalData(externalData string) RSVStatsAPIGetReservationStatisticsRequest {
	r.externalData = &externalData
	return r
}

// Request Id of an incoming request
func (r RSVStatsAPIGetReservationStatisticsRequest) XRequestId(xRequestId string) RSVStatsAPIGetReservationStatisticsRequest {
	r.xRequestId = &xRequestId
	return r
}

// Customer&#39;s Integration Application Id
func (r RSVStatsAPIGetReservationStatisticsRequest) XOriginatingApplication(xOriginatingApplication string) RSVStatsAPIGetReservationStatisticsRequest {
	r.xOriginatingApplication = &xOriginatingApplication
	return r
}
...
Use this API to get Reservation Statistics. <p><strong>OperationId:</strong>getReservationStatistics</p> <p>This API allows a time span of <strong>90</strong> days.</p>
...
type RSVStatsAPIPingRSVStatsServiceRequest struct {
	ctx context.Context
	ApiService *RSVStatsAPIService
	authorization *string
	xAppKey *string
...
// Bearer token that needs to be passed which is generated post user authentication
func (r RSVStatsAPIPingRSVStatsServiceRequest) Authorization(authorization string) RSVStatsAPIPingRSVStatsServiceRequest {
	r.authorization = &authorization
	return r
}

// Client or Partner&#39;s Application Key
func (r RSVStatsAPIPingRSVStatsServiceRequest) XAppKey(xAppKey string) RSVStatsAPIPingRSVStatsServiceRequest {
	r.xAppKey = &xAppKey
	return r
}

// Mandatory parameter to identify the hotel code where the end user is logged in
func (r RSVStatsAPIPingRSVStatsServiceRequest) XHotelid(xHotelid string) RSVStatsAPIPingRSVStatsServiceRequest {
	r.xHotelid = &xHotelid
	return r
}

// Pass this header as true, if payload needs DVM
func (r RSVStatsAPIPingRSVStatsServiceRequest) ExternalData(externalData string) RSVStatsAPIPingRSVStatsServiceRequest {
	r.externalData = &externalData
	return r
}

// Request Id of an incoming request
func (r RSVStatsAPIPingRSVStatsServiceRequest) XRequestId(xRequestId string) RSVStatsAPIPingRSVStatsServiceRequest {
	r.xRequestId = &xRequestId
	return r
}

// Customer&#39;s Integration Application Id
func (r RSVStatsAPIPingRSVStatsServiceRequest) XOriginatingApplication(xOriginatingApplication string) RSVStatsAPIPingRSVStatsServiceRequest {
	r.xOriginatingApplication = &xOriginatingApplication
	return r
}

// External system code.
func (r RSVStatsAPIPingRSVStatsServiceRequest) XExternalsystem(xExternalsystem string) RSVStatsAPIPingRSVStatsServiceRequest {
	r.xExternalsystem = &xExternalsystem
	return r
}

// Language code
func (r RSVStatsAPIPingRSVStatsServiceRequest) AcceptLanguage(acceptLanguage string) RSVStatsAPIPingRSVStatsServiceRequest {
	r.acceptLanguage = &acceptLanguage
	return r
}

func (r RSVStatsAPIPingRSVStatsServiceRequest) Execute() (*OperaVersion, *http.Response, error) {
	return r.ApiService.PingRSVStatsServiceExecute(r)
}

/*
PingRSVStatsService Ping

Get version for RSV Stats service <p><strong>OperationId:</strong>pingRSVStatsService</p>

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return RSVStatsAPIPingRSVStatsServiceRequest
*/
func (a *RSVStatsAPIService) PingRSVStatsService(ctx context.Context) RSVStatsAPIPingRSVStatsServiceRequest {
	return RSVStatsAPIPingRSVStatsServiceRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return OperaVersion
func (a *RSVStatsAPIService) PingRSVStatsServiceExecute(r RSVStatsAPIPingRSVStatsServiceRequest) (*OperaVersion, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "RSVStatsAPIService.PingRSVStatsService")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/services/rsvStats/status"
