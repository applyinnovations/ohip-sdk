...
func (o *GuaranteePolicyTypeDepositPolicy) GetTieredDepositRules() []TieredDepositRule {
...
// and a boolean to check if the value has been set.
func (o *GuaranteePolicyTypeDepositPolicy) GetTieredDepositRulesOk() ([]TieredDepositRule, bool) {
	if o == nil || IsNil(o.TieredDepositRules) {
		return nil, false
	}
...
func (o *GuaranteePolicyTypeDepositPolicy) HasTieredDepositRules() bool {
	if o != nil && !IsNil(o.TieredDepositRules) {
		return true
	}
...
func (o *GuaranteePolicyTypeDepositPolicy) SetTieredDepositRules(v []TieredDepositRule) {
