...
type PackageConsumptionType struct {
	// Quantity of packages to be attached i.e. the multiplier to be applied against the calculation rule to determine the total quantity of the packages.
	...
	// The total quantity of the package, calculated based on the calculation rule as defined in the PackageHeaderType and defaultQuantity.
