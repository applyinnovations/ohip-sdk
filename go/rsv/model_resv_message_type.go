...
type ResvMessageType struct {
	...
	// Date the message was created. Uses the hotel's time zone.
	...
	// Display the departure date of the guest. Uses the hotel's time zone.
	DepartureDate *string `json:"departureDate,omitempty"`
	// Display the arrival date of the guest. Uses the hotel's time zone.
...
func (o *ResvMessageType) GetLanguage() string {
...
// and a boolean to check if the value has been set.
func (o *ResvMessageType) GetLanguageOk() (*string, bool) {
	if o == nil || IsNil(o.Language) {
		return nil, false
	}
...
func (o *ResvMessageType) HasLanguage() bool {
	if o != nil && !IsNil(o.Language) {
		return true
	}
...
func (o *ResvMessageType) SetLanguage(v string) {
	o.Language = &v
}
