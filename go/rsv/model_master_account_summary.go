...
// checks if the MasterAccountSummary type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MasterAccountSummary{}

// MasterAccountSummary Response for ChangeMasterAccount operation.
type MasterAccountSummary struct {
	MasterAccount *MasterAccountSummaryType `json:"masterAccount,omitempty"`
...
func (o *MasterAccountSummary) GetMasterAccount() MasterAccountSummaryType {
	if o == nil || IsNil(o.MasterAccount) {
		var ret MasterAccountSummaryType
		return ret
	}
...
// SetMasterAccount gets a reference to the given MasterAccountSummaryType and assigns it to the MasterAccount field.
...
func (o MasterAccountSummary) MarshalJSON() ([]byte, error) {
...
func (o MasterAccountSummary) ToMap() (map[string]interface{}, error) {
...
type NullableMasterAccountSummary struct {
	value *MasterAccountSummary
	isSet bool
}

func (v NullableMasterAccountSummary) Get() *MasterAccountSummary {
	return v.value
}

func (v *NullableMasterAccountSummary) Set(val *MasterAccountSummary) {
	v.value = val
	v.isSet = true
}

func (v NullableMasterAccountSummary) IsSet() bool {
	return v.isSet
}

func (v *NullableMasterAccountSummary) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMasterAccountSummary(val *MasterAccountSummary) *NullableMasterAccountSummary {
	return &NullableMasterAccountSummary{value: val, isSet: true}
}

func (v NullableMasterAccountSummary) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMasterAccountSummary) UnmarshalJSON(src []byte) error {
	v.isSet = true
