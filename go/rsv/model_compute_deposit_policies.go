...
// checks if the ComputeDepositPolicies type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ComputeDepositPolicies{}

// ComputeDepositPolicies Operation to fetch the details for deposit rules, applicable to a reservation. Based on the criteria the rule information can be retrieved for all deposit rules or for a particular rule.
type ComputeDepositPolicies struct {
...
func (o ComputeDepositPolicies) MarshalJSON() ([]byte, error) {
...
func (o ComputeDepositPolicies) ToMap() (map[string]interface{}, error) {
...
type NullableComputeDepositPolicies struct {
	value *ComputeDepositPolicies
	isSet bool
}

func (v NullableComputeDepositPolicies) Get() *ComputeDepositPolicies {
	return v.value
}

func (v *NullableComputeDepositPolicies) Set(val *ComputeDepositPolicies) {
	v.value = val
	v.isSet = true
}

func (v NullableComputeDepositPolicies) IsSet() bool {
	return v.isSet
}

func (v *NullableComputeDepositPolicies) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableComputeDepositPolicies(val *ComputeDepositPolicies) *NullableComputeDepositPolicies {
	return &NullableComputeDepositPolicies{value: val, isSet: true}
}

func (v NullableComputeDepositPolicies) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableComputeDepositPolicies) UnmarshalJSON(src []byte) error {
	v.isSet = true
