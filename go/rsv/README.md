...
```golang
import rsv "github.com/applyinnovations/ohip-sdk/go/rsv/v3"
```
...
*RSVStatsAPI* | [**PingRSVStatsService**](docs/RSVStatsAPI.md#pingrsvstatsservice) | **Get** /services/rsvStats/status | Ping
...
*ReservationAPI* | [**CreateRsvFlexFieldValue**](docs/ReservationAPI.md#creatersvflexfieldvalue) | **Post** /hotels/{hotelId}/reservations/{reservationId}/flexFieldValues | Operation to create a flex field with value for a module.
...
*ReservationAPI* | [**DeleteRsvFlexFieldValue**](docs/ReservationAPI.md#deletersvflexfieldvalue) | **Delete** /hotels/{hotelId}/reservations/{reservationId}/flexFieldCode/{flexFieldCode} | Operation to delete a flex field.
...
*ReservationAPI* | [**GetHotelReservations**](docs/ReservationAPI.md#gethotelreservations) | **Get** /hotels/{hotelId}/reservations | Get Reservations for a hotel
...
*ReservationAPI* | [**GetReservationPolicies**](docs/ReservationAPI.md#getreservationpolicies) | **Get** /hotels/{hotelId}/reservations/{reservationId}/policies | Get Reservation Policies
...
*ReservationAPI* | [**GetReservationsByPackage**](docs/ReservationAPI.md#getreservationsbypackage) | **Get** /hotels/{hotelId}/reservations/packageCategoryReservations | Get Reservations by pacakge and consumption date
...
*ReservationAPI* | [**GetRsvFlexFieldValue**](docs/ReservationAPI.md#getrsvflexfieldvalue) | **Get** /hotels/{hotelId}/reservations/{reservationId}/flexFieldValues | Operation to fetch flex field values.
...
*ReservationAPI* | [**PingReservationService**](docs/ReservationAPI.md#pingreservationservice) | **Get** /services/reservations/status | Ping
...
*ReservationAPI* | [**PostCall**](docs/ReservationAPI.md#postcall) | **Post** /calls | Register Call
...
*ReservationAPI* | [**PostDeletePreCheckInReservation**](docs/ReservationAPI.md#postdeleteprecheckinreservation) | **Post** /hotels/{hotelId}/reservations/{reservationId}/preCheckIn/deletions | Revert a PreCheckIn Reservation
...
*ReservationAPI* | [**PostHubTurnawayReservation**](docs/ReservationAPI.md#posthubturnawayreservation) | **Post** /turnaways | Register Hub Turnaway
...
*ReservationAPI* | [**PutConsumedPackageQuantity**](docs/ReservationAPI.md#putconsumedpackagequantity) | **Put** /hotels/{hotelId}/reservations/{reservationId}/consumedPackageQuantity | Update consumed package quantity for package codes.
...
*ReservationAPI* | [**PutSeparateShareReservation**](docs/ReservationAPI.md#putseparatesharereservation) | **Put** /hotels/{hotelId}/reservations/{reservationId}/separatedShare | Separate Share Reservation and apply rate amounts to separated and remaining share reservations from room rates provided by an external application on a daily basis.
*ReservationAPI* | [**PutSeparateShareReservationByExtId**](docs/ReservationAPI.md#putseparatesharereservationbyextid) | **Put** /hotels/{hotelId}/externalSystems/{externalSystemCode}/reservations/{reservationExternalId}/separatedShare | Separate Share Reservation with the given external reservation id and apply rate amounts to separated and remaining share reservations from room rates provided by an external application on a daily basis.
...
*ReservationAPI* | [**SearchExternalSystemReservations**](docs/ReservationAPI.md#searchexternalsystemreservations) | **Post** /externalSystems/{extSystemCode}/reservations/searches | Get Reservations for a hotel from an external system
*ReservationAPI* | [**SearchHotelReservations**](docs/ReservationAPI.md#searchhotelreservations) | **Post** /hotels/{hotelId}/reservations/searches | Get Reservations for a hotel
*ReservationAPI* | [**SearchPreConfiguredRoutingInstructions**](docs/ReservationAPI.md#searchpreconfiguredroutinginstructions) | **Post** /hotels/{hotelId}/preConfiguredRoutingInstructions/searches | Get pre-Configured Routing Instructions
*ReservationAPI* | [**SearchRateInfo**](docs/ReservationAPI.md#searchrateinfo) | **Post** /hotels/{hotelId}/reservations/rateInfo/searches | Get rate information
*ReservationAPI* | [**SearchReservations**](docs/ReservationAPI.md#searchreservations) | **Post** /reservations/searches | Search Reservations for a hotel
*ReservationAPI* | [**SearchReservationsSummary**](docs/ReservationAPI.md#searchreservationssummary) | **Post** /hotels/{hotelId}/reservations/summary/searches | Search brief summary for Reservations
*ReservationAPI* | [**UpdateRsvFlexFieldValue**](docs/ReservationAPI.md#updatersvflexfieldvalue) | **Put** /hotels/{hotelId}/reservations/{reservationId}/flexFieldValues | Operation to update flex field value.
*ReservationAPI* | [**ValidatePolicies**](docs/ReservationAPI.md#validatepolicies) | **Put** /hotels/{hotelId}/reservations/policies | Get Deposit and Cancellation Policies that are applicable to the specified criteria.
...
*ReservationExternalAPI* | [**PingReservationExternalService**](docs/ReservationExternalAPI.md#pingreservationexternalservice) | **Get** /services/reservationExternal/status | Ping
...
## Documentation For Models
 ...
 - [AssignBlockRateInstructionsType](docs/AssignBlockRateInstructionsType.md)
 ...
 - [CertainNightsOfTheWeek](docs/CertainNightsOfTheWeek.md)
 ...
 - [ChangePackageQuantityType](docs/ChangePackageQuantityType.md)
 ...
 - [DailyRateDistributionCriteria](docs/DailyRateDistributionCriteria.md)
 ...
 - [DepositPaymentType](docs/DepositPaymentType.md)
 - [DepositPolicyType](docs/DepositPolicyType.md)
 - [DiscountType](docs/DiscountType.md)
 - [DiscrepancyEnum](docs/DiscrepancyEnum.md)
 ...
 - [ExternalDailyRateType](docs/ExternalDailyRateType.md)
 - [ExternalReferenceType](docs/ExternalReferenceType.md)
 - [ExternalReservationFetchInstruction](docs/ExternalReservationFetchInstruction.md)
 - [ExternalReservationOrderBy](docs/ExternalReservationOrderBy.md)
 - [ExternalReservationSearchType](docs/ExternalReservationSearchType.md)
 - [ExternalReservationStatusType](docs/ExternalReservationStatusType.md)
 ...
 - [FetchInstructionType](docs/FetchInstructionType.md)
 ...
 - [HotelReservationAllowedAction](docs/HotelReservationAllowedAction.md)
 - [HotelReservationFetchInstruction](docs/HotelReservationFetchInstruction.md)
 ...
 - [HotelReservationOrderBy](docs/HotelReservationOrderBy.md)
 - [HotelReservationSearchType](docs/HotelReservationSearchType.md)
 - [HotelReservationStatusType](docs/HotelReservationStatusType.md)
 ...
 - [OffshoreRateType](docs/OffshoreRateType.md)
 ...
 - [PackageCategoryInfoType](docs/PackageCategoryInfoType.md)
 - [PackageCategoryReservationType](docs/PackageCategoryReservationType.md)
 - [PackageCategoryReservations](docs/PackageCategoryReservations.md)
 - [PackageCategoryReservationsReservations](docs/PackageCategoryReservationsReservations.md)
 ...
 - [PackageInfoType](docs/PackageInfoType.md)
 ...
 - [PackageQuantityInfoType](docs/PackageQuantityInfoType.md)
 ...
 - [PeriodicFolioEnum](docs/PeriodicFolioEnum.md)
 ...
 - [PostDeletePreCheckInReservationRequest](docs/PostDeletePreCheckInReservationRequest.md)
 ...
 - [PostingIntervalFrequency](docs/PostingIntervalFrequency.md)
 - [PostingIntervalType](docs/PostingIntervalType.md)
 ...
 - [PreArrivalReviewStatusType](docs/PreArrivalReviewStatusType.md)
 ...
 - [RateSearchType](docs/RateSearchType.md)
 ...
 - [ReservationDepositPaymentCriteriaType](docs/ReservationDepositPaymentCriteriaType.md)
 ...
 - [ReservationOrderBy](docs/ReservationOrderBy.md)
 ...
 - [ReservationProtectionType](docs/ReservationProtectionType.md)
 ...
 - [ReservationSearchType](docs/ReservationSearchType.md)
 - [ReservationStatistics](docs/ReservationStatistics.md)
 - [ReservationStatusEnum](docs/ReservationStatusEnum.md)
 - [ReservationStatusType](docs/ReservationStatusType.md)
 ...
 - [ResvIdentificationInfoType](docs/ResvIdentificationInfoType.md)
 ...
 - [RoomReadyStatusType](docs/RoomReadyStatusType.md)
 ...
 - [SearchExternalSystemReservationsRequest](docs/SearchExternalSystemReservationsRequest.md)
 - [SearchHotelReservationsRequest](docs/SearchHotelReservationsRequest.md)
 - [SearchMatchType](docs/SearchMatchType.md)
 - [SearchPreConfiguredRoutingInstructionsRequest](docs/SearchPreConfiguredRoutingInstructionsRequest.md)
 - [SearchRateInfoRequest](docs/SearchRateInfoRequest.md)
 - [SearchReservationsRequest](docs/SearchReservationsRequest.md)
 - [SearchReservationsSummaryRequest](docs/SearchReservationsSummaryRequest.md)
 ...
 - [SeparateShareReservation](docs/SeparateShareReservation.md)
 - [SeparateShareReservationType](docs/SeparateShareReservationType.md)
 ...
 - [TieredCancelPenalty](docs/TieredCancelPenalty.md)
 - [TieredDepositRule](docs/TieredDepositRule.md)
 - [TimeSpanType](docs/TimeSpanType.md)
 - [TimeWindowType](docs/TimeWindowType.md)
 - [TotalType](docs/TotalType.md)
 - [TraceFrequencyPatternType](docs/TraceFrequencyPatternType.md)
 - [TraceFrequencyType](docs/TraceFrequencyType.md)
 ...
 - [UnavailableItemInstructionType](docs/UnavailableItemInstructionType.md)
 ...
 - [ValidatePoliciesType](docs/ValidatePoliciesType.md)
