...
type ConfRecipientInfoType struct {
	...
	// Email address to which the confirmation letter will be sent. This field is mutually exclusive with emailInfo; providing both will result in an error. Use either emailInfo or optionalEmail, but not both.
	OptionalEmail *string `json:"optionalEmail,omitempty"`
}
...
// GetOptionalEmail returns the OptionalEmail field value if set, zero value otherwise.
func (o *ConfRecipientInfoType) GetOptionalEmail() string {
	if o == nil || IsNil(o.OptionalEmail) {
		var ret string
		return ret
	}
	return *o.OptionalEmail
}

// GetOptionalEmailOk returns a tuple with the OptionalEmail field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ConfRecipientInfoType) GetOptionalEmailOk() (*string, bool) {
	if o == nil || IsNil(o.OptionalEmail) {
		return nil, false
	}
	return o.OptionalEmail, true
}

// HasOptionalEmail returns a boolean if a field has been set.
func (o *ConfRecipientInfoType) HasOptionalEmail() bool {
	if o != nil && !IsNil(o.OptionalEmail) {
		return true
	}
...
// SetOptionalEmail gets a reference to the given string and assigns it to the OptionalEmail field.
func (o *ConfRecipientInfoType) SetOptionalEmail(v string) {
	o.OptionalEmail = &v
}
...
func (o ConfRecipientInfoType) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.OptionalEmail) {
		toSerialize["optionalEmail"] = o.OptionalEmail
	}
