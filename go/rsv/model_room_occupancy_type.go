...
func (o *RoomOccupancyType) GetRoomNumberLocked() bool {
...
// and a boolean to check if the value has been set.
func (o *RoomOccupancyType) GetRoomNumberLockedOk() (*bool, bool) {
	if o == nil || IsNil(o.RoomNumberLocked) {
		return nil, false
	}
...
func (o *RoomOccupancyType) HasRoomNumberLocked() bool {
	if o != nil && !IsNil(o.RoomNumberLocked) {
		return true
	}
...
func (o *RoomOccupancyType) SetRoomNumberLocked(v bool) {
