...
// ScheduledRoomMoveInfoType Scheduled Move information.
type ScheduledRoomMoveInfoType struct {
	...
	// Estimated Move Time. Uses the hotel's time zone.
	...
	MoveOutRoomStatus *HousekeepingRoomStatusType `json:"moveOutRoomStatus,omitempty"`
}
...
// GetMoveOutRoomStatus returns the MoveOutRoomStatus field value if set, zero value otherwise.
func (o *ScheduledRoomMoveInfoType) GetMoveOutRoomStatus() HousekeepingRoomStatusType {
	if o == nil || IsNil(o.MoveOutRoomStatus) {
		var ret HousekeepingRoomStatusType
		return ret
	}
	return *o.MoveOutRoomStatus
}

// GetMoveOutRoomStatusOk returns a tuple with the MoveOutRoomStatus field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ScheduledRoomMoveInfoType) GetMoveOutRoomStatusOk() (*HousekeepingRoomStatusType, bool) {
	if o == nil || IsNil(o.MoveOutRoomStatus) {
		return nil, false
	}
	return o.MoveOutRoomStatus, true
}
...
// SetMoveOutRoomStatus gets a reference to the given HousekeepingRoomStatusType and assigns it to the MoveOutRoomStatus field.
func (o *ScheduledRoomMoveInfoType) SetMoveOutRoomStatus(v HousekeepingRoomStatusType) {
	o.MoveOutRoomStatus = &v
}
...
func (o ScheduledRoomMoveInfoType) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.MoveOutRoomStatus) {
		toSerialize["moveOutRoomStatus"] = o.MoveOutRoomStatus
	}
