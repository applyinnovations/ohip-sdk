...
// APIClient manages communication with the OPERA Cloud Reservation API API v26.2.0.0
...
type APIClient struct {
	...
	ReservationExternalAPI *ReservationExternalAPIService
}
...
func NewAPIClient(cfg *Configuration) *APIClient {
	...
	c.ReservationExternalAPI = (*ReservationExternalAPIService)(&c.common)
