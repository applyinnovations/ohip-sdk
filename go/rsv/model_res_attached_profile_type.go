...
func (o *ResAttachedProfileType) GetExternalReferences() []ExternalReferenceType {
...
// and a boolean to check if the value has been set.
func (o *ResAttachedProfileType) GetExternalReferencesOk() ([]ExternalReferenceType, bool) {
	if o == nil || IsNil(o.ExternalReferences) {
		return nil, false
	}
...
func (o *ResAttachedProfileType) HasExternalReferences() bool {
	if o != nil && !IsNil(o.ExternalReferences) {
		return true
	}
...
func (o *ResAttachedProfileType) SetExternalReferences(v []ExternalReferenceType) {
