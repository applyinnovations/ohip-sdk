...
type RecentlyAccessedReservationType struct {
	...
	// Time stamp of the creation of reservation. Uses the hotel's time zone.
	InsertDateTime *string `json:"insertDateTime,omitempty"`
	// Time stamp of the updation of reservation. Uses the hotel's time zone.
...
func (o *RecentlyAccessedReservationType) GetInsertDateTime() string {
...
// and a boolean to check if the value has been set.
func (o *RecentlyAccessedReservationType) GetInsertDateTimeOk() (*string, bool) {
	if o == nil || IsNil(o.InsertDateTime) {
		return nil, false
	}
...
func (o *RecentlyAccessedReservationType) HasInsertDateTime() bool {
	if o != nil && !IsNil(o.InsertDateTime) {
		return true
	}
...
// SetInsertDateTime gets a reference to the given string and assigns it to the InsertDateTime field.
func (o *RecentlyAccessedReservationType) SetInsertDateTime(v string) {
	o.InsertDateTime = &v
}

// GetUpdateDateTime returns the UpdateDateTime field value if set, zero value otherwise.
func (o *RecentlyAccessedReservationType) GetUpdateDateTime() string {
...
// and a boolean to check if the value has been set.
func (o *RecentlyAccessedReservationType) GetUpdateDateTimeOk() (*string, bool) {
	if o == nil || IsNil(o.UpdateDateTime) {
		return nil, false
	}
...
func (o *RecentlyAccessedReservationType) HasUpdateDateTime() bool {
	if o != nil && !IsNil(o.UpdateDateTime) {
		return true
	}
...
// SetUpdateDateTime gets a reference to the given string and assigns it to the UpdateDateTime field.
func (o *RecentlyAccessedReservationType) SetUpdateDateTime(v string) {
	o.UpdateDateTime = &v
}
