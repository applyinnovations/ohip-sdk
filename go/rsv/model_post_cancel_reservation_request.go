...
func (o *PostCancelReservationRequest) GetExternalDailyRates() []ExternalDailyRateType {
...
// and a boolean to check if the value has been set.
func (o *PostCancelReservationRequest) GetExternalDailyRatesOk() ([]ExternalDailyRateType, bool) {
	if o == nil || IsNil(o.ExternalDailyRates) {
		return nil, false
	}
...
func (o *PostCancelReservationRequest) HasExternalDailyRates() bool {
	if o != nil && !IsNil(o.ExternalDailyRates) {
		return true
	}
...
func (o *PostCancelReservationRequest) SetExternalDailyRates(v []ExternalDailyRateType) {
