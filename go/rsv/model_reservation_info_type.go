...
type ReservationInfoType struct {
	...
	DepartureReservationInfo *DepartureReservationInfoType `json:"departureReservationInfo,omitempty"`
	...
	CommissionsInfo *ReservationCommissionInfoType `json:"commissionsInfo,omitempty"`
	...
	FiscalInfo *FiscalInfoType `json:"fiscalInfo,omitempty"`
	// Property associated with the Linked Reservation that serves as parent to this reservation.
	ParentReservationHotelId *string `json:"parentReservationHotelId,omitempty"`
	...
	// Package consumption information linked to the reservation, including package code, description, category, and consumption details.
	PkgConsumptionInfo []PackageInfoType `json:"pkgConsumptionInfo,omitempty"`
...
// GetDepartureReservationInfo returns the DepartureReservationInfo field value if set, zero value otherwise.
func (o *ReservationInfoType) GetDepartureReservationInfo() DepartureReservationInfoType {
	if o == nil || IsNil(o.DepartureReservationInfo) {
		var ret DepartureReservationInfoType
		return ret
	}
	return *o.DepartureReservationInfo
}

// GetDepartureReservationInfoOk returns a tuple with the DepartureReservationInfo field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ReservationInfoType) GetDepartureReservationInfoOk() (*DepartureReservationInfoType, bool) {
	if o == nil || IsNil(o.DepartureReservationInfo) {
		return nil, false
	}
	return o.DepartureReservationInfo, true
}
...
// SetDepartureReservationInfo gets a reference to the given DepartureReservationInfoType and assigns it to the DepartureReservationInfo field.
func (o *ReservationInfoType) SetDepartureReservationInfo(v DepartureReservationInfoType) {
	o.DepartureReservationInfo = &v
}
...
func (o *ReservationInfoType) GetReservationMemberships() []ReservationMembershipType {
...
// and a boolean to check if the value has been set.
func (o *ReservationInfoType) GetReservationMembershipsOk() ([]ReservationMembershipType, bool) {
	if o == nil || IsNil(o.ReservationMemberships) {
		return nil, false
	}
...
func (o *ReservationInfoType) HasReservationMemberships() bool {
	if o != nil && !IsNil(o.ReservationMemberships) {
		return true
	}
...
func (o *ReservationInfoType) SetReservationMemberships(v []ReservationMembershipType) {
...
// GetCommissionsInfo returns the CommissionsInfo field value if set, zero value otherwise.
func (o *ReservationInfoType) GetCommissionsInfo() ReservationCommissionInfoType {
	if o == nil || IsNil(o.CommissionsInfo) {
		var ret ReservationCommissionInfoType
		return ret
	}
	return *o.CommissionsInfo
}

// GetCommissionsInfoOk returns a tuple with the CommissionsInfo field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ReservationInfoType) GetCommissionsInfoOk() (*ReservationCommissionInfoType, bool) {
	if o == nil || IsNil(o.CommissionsInfo) {
		return nil, false
	}
	return o.CommissionsInfo, true
}
...
// SetCommissionsInfo gets a reference to the given ReservationCommissionInfoType and assigns it to the CommissionsInfo field.
...
// SetFiscalInfo gets a reference to the given FiscalInfoType and assigns it to the FiscalInfo field.
func (o *ReservationInfoType) SetFiscalInfo(v FiscalInfoType) {
	o.FiscalInfo = &v
}

// GetParentReservationHotelId returns the ParentReservationHotelId field value if set, zero value otherwise.
func (o *ReservationInfoType) GetParentReservationHotelId() string {
	if o == nil || IsNil(o.ParentReservationHotelId) {
		var ret string
		return ret
	}
	return *o.ParentReservationHotelId
}

// GetParentReservationHotelIdOk returns a tuple with the ParentReservationHotelId field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ReservationInfoType) GetParentReservationHotelIdOk() (*string, bool) {
	if o == nil || IsNil(o.ParentReservationHotelId) {
		return nil, false
	}
	return o.ParentReservationHotelId, true
}
...
// SetParentReservationHotelId gets a reference to the given string and assigns it to the ParentReservationHotelId field.
func (o *ReservationInfoType) SetParentReservationHotelId(v string) {
	o.ParentReservationHotelId = &v
}
...
func (o *ReservationInfoType) GetCheckInInitiatedBy() string {
...
// and a boolean to check if the value has been set.
func (o *ReservationInfoType) GetCheckInInitiatedByOk() (*string, bool) {
	if o == nil || IsNil(o.CheckInInitiatedBy) {
		return nil, false
	}
...
func (o *ReservationInfoType) HasCheckInInitiatedBy() bool {
	if o != nil && !IsNil(o.CheckInInitiatedBy) {
		return true
	}
...
func (o *ReservationInfoType) SetCheckInInitiatedBy(v string) {
	o.CheckInInitiatedBy = &v
}

// GetUserDefinedFields returns the UserDefinedFields field value if set, zero value otherwise.
func (o *ReservationInfoType) GetUserDefinedFields() UserDefinedFieldsType {
...
// and a boolean to check if the value has been set.
func (o *ReservationInfoType) GetUserDefinedFieldsOk() (*UserDefinedFieldsType, bool) {
	if o == nil || IsNil(o.UserDefinedFields) {
		return nil, false
	}
...
func (o *ReservationInfoType) HasUserDefinedFields() bool {
	if o != nil && !IsNil(o.UserDefinedFields) {
		return true
	}
...
func (o *ReservationInfoType) SetUserDefinedFields(v UserDefinedFieldsType) {
	o.UserDefinedFields = &v
}

// GetPkgConsumptionInfo returns the PkgConsumptionInfo field value if set, zero value otherwise.
func (o *ReservationInfoType) GetPkgConsumptionInfo() []PackageInfoType {
	if o == nil || IsNil(o.PkgConsumptionInfo) {
		var ret []PackageInfoType
		return ret
	}
	return o.PkgConsumptionInfo
}

// GetPkgConsumptionInfoOk returns a tuple with the PkgConsumptionInfo field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ReservationInfoType) GetPkgConsumptionInfoOk() ([]PackageInfoType, bool) {
	if o == nil || IsNil(o.PkgConsumptionInfo) {
		return nil, false
	}
	return o.PkgConsumptionInfo, true
}

// HasPkgConsumptionInfo returns a boolean if a field has been set.
func (o *ReservationInfoType) HasPkgConsumptionInfo() bool {
	if o != nil && !IsNil(o.PkgConsumptionInfo) {
		return true
	}
...
// SetPkgConsumptionInfo gets a reference to the given []PackageInfoType and assigns it to the PkgConsumptionInfo field.
func (o *ReservationInfoType) SetPkgConsumptionInfo(v []PackageInfoType) {
	o.PkgConsumptionInfo = v
}

// GetPreArrivalReviewStatus returns the PreArrivalReviewStatus field value if set, zero value otherwise.
func (o *ReservationInfoType) GetPreArrivalReviewStatus() PreArrivalReviewStatusType {
...
// and a boolean to check if the value has been set.
func (o *ReservationInfoType) GetPreArrivalReviewStatusOk() (*PreArrivalReviewStatusType, bool) {
	if o == nil || IsNil(o.PreArrivalReviewStatus) {
		return nil, false
	}
...
func (o *ReservationInfoType) HasPreArrivalReviewStatus() bool {
	if o != nil && !IsNil(o.PreArrivalReviewStatus) {
		return true
	}
...
func (o *ReservationInfoType) SetPreArrivalReviewStatus(v PreArrivalReviewStatusType) {
...
func (o ReservationInfoType) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.DepartureReservationInfo) {
		toSerialize["departureReservationInfo"] = o.DepartureReservationInfo
	}
	...
	if !IsNil(o.CommissionsInfo) {
		toSerialize["commissionsInfo"] = o.CommissionsInfo
	}
	if !IsNil(o.Specials) {
	...
	if !IsNil(o.FiscalInfo) {
		toSerialize["fiscalInfo"] = o.FiscalInfo
	}
	if !IsNil(o.ParentReservationHotelId) {
		toSerialize["parentReservationHotelId"] = o.ParentReservationHotelId
	}
	...
	if !IsNil(o.PkgConsumptionInfo) {
		toSerialize["pkgConsumptionInfo"] = o.PkgConsumptionInfo
	}
