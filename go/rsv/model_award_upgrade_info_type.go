...
type AwardUpgradeInfoType struct {
	...
	AwardUpgradeSummaries []AwardUpgradeSummaryType `json:"awardUpgradeSummaries,omitempty"`
...
func (o *AwardUpgradeInfoType) GetAwardUpgradeSummaries() []AwardUpgradeSummaryType {
	if o == nil || IsNil(o.AwardUpgradeSummaries) {
		var ret []AwardUpgradeSummaryType
		return ret
	}
...
// SetAwardUpgradeSummaries gets a reference to the given []AwardUpgradeSummaryType and assigns it to the AwardUpgradeSummaries field.
