...
type RoomCalendarResType struct {
	...
	// This attribute indicates if there is a  Scheduled Move Room pending.
	...
	// The Room Type on which the rate is based on. The reservation may use a different room type but is charged based on a different room type. This value is returned when Advance Daily Detail OPERA Control is active.
...
func (o *RoomCalendarResType) GetScheduledRoomMoveRoomPending() bool {
...
// and a boolean to check if the value has been set.
func (o *RoomCalendarResType) GetScheduledRoomMoveRoomPendingOk() (*bool, bool) {
	if o == nil || IsNil(o.ScheduledRoomMoveRoomPending) {
		return nil, false
	}
...
func (o *RoomCalendarResType) HasScheduledRoomMoveRoomPending() bool {
	if o != nil && !IsNil(o.ScheduledRoomMoveRoomPending) {
		return true
	}
...
func (o *RoomCalendarResType) SetScheduledRoomMoveRoomPending(v bool) {
...
func (o *RoomCalendarResType) GetRoomTypeToCharge() string {
...
// and a boolean to check if the value has been set.
func (o *RoomCalendarResType) GetRoomTypeToChargeOk() (*string, bool) {
	if o == nil || IsNil(o.RoomTypeToCharge) {
		return nil, false
	}
...
func (o *RoomCalendarResType) HasRoomTypeToCharge() bool {
	if o != nil && !IsNil(o.RoomTypeToCharge) {
		return true
	}
...
func (o *RoomCalendarResType) SetRoomTypeToCharge(v string) {
