...
func (o *PostReservationRequest) GetExternalDailyRates() []ExternalDailyRateType {
...
// and a boolean to check if the value has been set.
func (o *PostReservationRequest) GetExternalDailyRatesOk() ([]ExternalDailyRateType, bool) {
	if o == nil || IsNil(o.ExternalDailyRates) {
		return nil, false
	}
...
func (o *PostReservationRequest) HasExternalDailyRates() bool {
	if o != nil && !IsNil(o.ExternalDailyRates) {
		return true
	}
...
func (o *PostReservationRequest) SetExternalDailyRates(v []ExternalDailyRateType) {
