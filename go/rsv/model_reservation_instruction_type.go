...
// ReservationInstructionType Simple type for reservation instructions that can be used in requests for information which needs to be returned.
...
const (
	...
	RESERVATIONINSTRUCTIONTYPE_RESERVATION_MEMBERSHIP_AWARDS ReservationInstructionType = "ReservationMembershipAwards"
	RESERVATIONINSTRUCTIONTYPE_RESERVATION_IDENTIFICATION ReservationInstructionType = "ReservationIdentification"
	...
	RESERVATIONINSTRUCTIONTYPE_FISCAL_INFO ReservationInstructionType = "FiscalInfo"
	RESERVATIONINSTRUCTIONTYPE_SCHEDULED_ROOM_MOVES ReservationInstructionType = "ScheduledRoomMoves"
	RESERVATIONINSTRUCTIONTYPE_DAILY_SUMMARY ReservationInstructionType = "DailySummary"
	RESERVATIONINSTRUCTIONTYPE_RATE_SUMMARY ReservationInstructionType = "RateSummary"
	RESERVATIONINSTRUCTIONTYPE_POSTING_INTERVALS ReservationInstructionType = "PostingIntervals"
	RESERVATIONINSTRUCTIONTYPE_PRE_ARRIVALS ReservationInstructionType = "PreArrivals"
)
