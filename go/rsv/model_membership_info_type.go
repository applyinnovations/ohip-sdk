...
type MembershipInfoType struct {
	// Membership ID Number(Unique ID from the memberships table).
	...
	// The account identification or membership card number for this particular member in this particular program.
