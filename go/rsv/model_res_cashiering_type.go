...
type ResCashieringType struct {
	...
	ReservationPreConfiguredRoutingInstructions *ReservationPreConfiguredRoutingInstructionsType `json:"reservationPreConfiguredRoutingInstructions,omitempty"`
}
...
// GetReservationPreConfiguredRoutingInstructions returns the ReservationPreConfiguredRoutingInstructions field value if set, zero value otherwise.
func (o *ResCashieringType) GetReservationPreConfiguredRoutingInstructions() ReservationPreConfiguredRoutingInstructionsType {
	if o == nil || IsNil(o.ReservationPreConfiguredRoutingInstructions) {
		var ret ReservationPreConfiguredRoutingInstructionsType
		return ret
	}
	return *o.ReservationPreConfiguredRoutingInstructions
}

// GetReservationPreConfiguredRoutingInstructionsOk returns a tuple with the ReservationPreConfiguredRoutingInstructions field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ResCashieringType) GetReservationPreConfiguredRoutingInstructionsOk() (*ReservationPreConfiguredRoutingInstructionsType, bool) {
	...
	return o.ReservationPreConfiguredRoutingInstructions, true
}
...
// SetReservationPreConfiguredRoutingInstructions gets a reference to the given ReservationPreConfiguredRoutingInstructionsType and assigns it to the ReservationPreConfiguredRoutingInstructions field.
func (o *ResCashieringType) SetReservationPreConfiguredRoutingInstructions(v ReservationPreConfiguredRoutingInstructionsType) {
	o.ReservationPreConfiguredRoutingInstructions = &v
}
...
func (o ResCashieringType) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.ReservationPreConfiguredRoutingInstructions) {
		toSerialize["reservationPreConfiguredRoutingInstructions"] = o.ReservationPreConfiguredRoutingInstructions
	}
