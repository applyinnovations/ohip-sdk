...
```golang
import invasync "github.com/applyinnovations/ohip-sdk/go/invasync/v3"
```
...
For using other server than the one defined on index 0 set context value `invasync.ContextServerIndex` of type `int`.
...
Templated server URL is formatted using default variables from configuration or from context value `invasync.ContextServerVariables` of type `map[string]string`.
...
Similar rules for overriding default operation server index and variables applies by using `invasync.ContextOperationServerIndices` and `invasync.ContextOperationServerVariables` context maps.
...
------------ | ------------- | ------------- | -------------
*InventoryAsyncAPI* | [**GetInventoryStatisticsAsync**](docs/InventoryAsyncAPI.md#getinventorystatisticsasync) | **Get** /externalSystems/{extSystemCode}/hotels/{hotelId}/inventoryStatistics/{requestId} | Get results of a inventory statistics process
*InventoryAsyncAPI* | [**GetInventoryStatisticsProcessStatus**](docs/InventoryAsyncAPI.md#getinventorystatisticsprocessstatus) | **Head** /externalSystems/{extSystemCode}/hotels/{hotelId}/inventoryStatistics/{requestId} | Check status of hotel inventory statistics process
...
*InventoryAsyncAPI* | [**StartInventoryStatisticsProcess**](docs/InventoryAsyncAPI.md#startinventorystatisticsprocess) | **Post** /externalSystems/{extSystemCode}/hotels/{hotelId}/inventoryStatistics | Start process to get hotel inventory statistics
...
## Documentation For Models
 ...
 - [FilterListType](docs/FilterListType.md)
 - [HouseSellLimitType](docs/HouseSellLimitType.md)
 - [InstanceLink](docs/InstanceLink.md)
 - [InventoryCriteriaType](docs/InventoryCriteriaType.md)
 - [NumericCategorySummaryType](docs/NumericCategorySummaryType.md)
 - [ParamListType](docs/ParamListType.md)
