...
type _InstanceLink InstanceLink
...
func (o *InstanceLink) UnmarshalJSON(bytes []byte) (err error) {
	...
	varInstanceLink := _InstanceLink{}

	err = json.Unmarshal(bytes, &varInstanceLink)

	if err != nil {
		return err
	}

	*o = InstanceLink(varInstanceLink)
