...
// checks if the TranslationTextType1000 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TranslationTextType1000{}

// TranslationTextType1000 Contains Multiple translated texts and language codes.
type TranslationTextType1000 struct {
...
func (o TranslationTextType1000) MarshalJSON() ([]byte, error) {
...
func (o TranslationTextType1000) ToMap() (map[string]interface{}, error) {
...
type NullableTranslationTextType1000 struct {
	value *TranslationTextType1000
	isSet bool
}

func (v NullableTranslationTextType1000) Get() *TranslationTextType1000 {
	return v.value
}

func (v *NullableTranslationTextType1000) Set(val *TranslationTextType1000) {
	v.value = val
	v.isSet = true
}

func (v NullableTranslationTextType1000) IsSet() bool {
	return v.isSet
}

func (v *NullableTranslationTextType1000) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTranslationTextType1000(val *TranslationTextType1000) *NullableTranslationTextType1000 {
	return &NullableTranslationTextType1000{value: val, isSet: true}
}

func (v NullableTranslationTextType1000) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTranslationTextType1000) UnmarshalJSON(src []byte) error {
	v.isSet = true
