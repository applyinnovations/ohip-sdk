...
type FunctionSpaceConfigType struct {
	...
	// if true, record will be considered as inactive.
...
func (o *FunctionSpaceConfigType) GetInactive() bool {
...
// and a boolean to check if the value has been set.
func (o *FunctionSpaceConfigType) GetInactiveOk() (*bool, bool) {
	if o == nil || IsNil(o.Inactive) {
		return nil, false
	}
...
func (o *FunctionSpaceConfigType) HasInactive() bool {
	if o != nil && !IsNil(o.Inactive) {
		return true
	}
...
func (o *FunctionSpaceConfigType) SetInactive(v bool) {
	o.Inactive = &v
}
