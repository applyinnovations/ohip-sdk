...
type CateringPackageEventType struct {
	...
	Notes []CateringPackageEventNoteType `json:"notes,omitempty"`
	// Collection of multiple Resources associated with a particular Catering Package Event.
	Resources []CateringPackageEventResourceType `json:"resources,omitempty"`
}
...
func (o *CateringPackageEventType) GetNotes() []CateringPackageEventNoteType {
	if o == nil || IsNil(o.Notes) {
		var ret []CateringPackageEventNoteType
		return ret
	}
	return o.Notes
}
...
// SetNotes gets a reference to the given []CateringPackageEventNoteType and assigns it to the Notes field.
...
func (o *CateringPackageEventType) GetResources() []CateringPackageEventResourceType {
	if o == nil || IsNil(o.Resources) {
		var ret []CateringPackageEventResourceType
		return ret
	}
	return o.Resources
}
...
// SetResources gets a reference to the given []CateringPackageEventResourceType and assigns it to the Resources field.
