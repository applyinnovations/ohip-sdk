...
type CateringMenuClassInfoType struct {
	...
	// Field for unique code identifier for Menu Class.
...
func (o *CateringMenuClassInfoType) GetManagedBy() ManagedByOptions {
...
// and a boolean to check if the value has been set.
func (o *CateringMenuClassInfoType) GetManagedByOk() (*ManagedByOptions, bool) {
	if o == nil || IsNil(o.ManagedBy) {
		return nil, false
	}
...
func (o *CateringMenuClassInfoType) HasManagedBy() bool {
	if o != nil && !IsNil(o.ManagedBy) {
		return true
	}
...
func (o *CateringMenuClassInfoType) SetManagedBy(v ManagedByOptions) {
	o.ManagedBy = &v
}

// GetCode returns the Code field value if set, zero value otherwise.
func (o *CateringMenuClassInfoType) GetCode() string {
...
// and a boolean to check if the value has been set.
func (o *CateringMenuClassInfoType) GetCodeOk() (*string, bool) {
	if o == nil || IsNil(o.Code) {
		return nil, false
	}
	return o.Code, true
...
func (o *CateringMenuClassInfoType) HasCode() bool {
	if o != nil && !IsNil(o.Code) {
		return true
	}
...
func (o *CateringMenuClassInfoType) SetCode(v string) {
	o.Code = &v
}
