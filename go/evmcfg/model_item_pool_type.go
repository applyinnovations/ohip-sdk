...
func (o *ItemPoolType) GetManagedBy() ManagedByOptions {
...
// and a boolean to check if the value has been set.
func (o *ItemPoolType) GetManagedByOk() (*ManagedByOptions, bool) {
	if o == nil || IsNil(o.ManagedBy) {
		return nil, false
	}
...
func (o *ItemPoolType) HasManagedBy() bool {
	if o != nil && !IsNil(o.ManagedBy) {
		return true
	}
...
func (o *ItemPoolType) SetManagedBy(v ManagedByOptions) {
	o.ManagedBy = &v
}
