...
type RoomTypePoolType struct {
	...
	AssociatedRoomTypes []RoomPoolRoomTypeType `json:"associatedRoomTypes,omitempty"`
...
// SetAssociatedRoomTypes gets a reference to the given []RoomPoolRoomTypeType and assigns it to the AssociatedRoomTypes field.
...
func (o *RoomTypePoolType) GetManagedBy() ManagedByOptions {
...
// and a boolean to check if the value has been set.
func (o *RoomTypePoolType) GetManagedByOk() (*ManagedByOptions, bool) {
	if o == nil || IsNil(o.ManagedBy) {
		return nil, false
	}
...
func (o *RoomTypePoolType) HasManagedBy() bool {
	if o != nil && !IsNil(o.ManagedBy) {
		return true
	}
...
func (o *RoomTypePoolType) SetManagedBy(v ManagedByOptions) {
	o.ManagedBy = &v
}
