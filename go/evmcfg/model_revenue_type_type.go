...
type RevenueTypeType struct {
	...
	// List of Revenue details associated to a Revenue Type (Additional Details)
...
func (o *RevenueTypeType) GetManagedBy() ManagedByOptions {
...
// and a boolean to check if the value has been set.
func (o *RevenueTypeType) GetManagedByOk() (*ManagedByOptions, bool) {
	if o == nil || IsNil(o.ManagedBy) {
		return nil, false
	}
...
func (o *RevenueTypeType) HasManagedBy() bool {
	if o != nil && !IsNil(o.ManagedBy) {
		return true
	}
...
func (o *RevenueTypeType) SetManagedBy(v ManagedByOptions) {
	o.ManagedBy = &v
}
