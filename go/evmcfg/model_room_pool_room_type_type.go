...
func (o *RoomPoolRoomTypeType) GetManagedBy() ManagedByOptions {
...
// and a boolean to check if the value has been set.
func (o *RoomPoolRoomTypeType) GetManagedByOk() (*ManagedByOptions, bool) {
	if o == nil || IsNil(o.ManagedBy) {
		return nil, false
	}
...
func (o *RoomPoolRoomTypeType) HasManagedBy() bool {
	if o != nil && !IsNil(o.ManagedBy) {
		return true
	}
...
func (o *RoomPoolRoomTypeType) SetManagedBy(v ManagedByOptions) {
	o.ManagedBy = &v
}
