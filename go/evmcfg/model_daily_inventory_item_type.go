...
type DailyInventoryItemType struct {
	...
	// The Item Class Code which the Daily Item belongs to.
...
func (o *DailyInventoryItemType) GetItemClassCode() string {
...
// and a boolean to check if the value has been set.
func (o *DailyInventoryItemType) GetItemClassCodeOk() (*string, bool) {
	if o == nil || IsNil(o.ItemClassCode) {
		return nil, false
	}
...
func (o *DailyInventoryItemType) HasItemClassCode() bool {
	if o != nil && !IsNil(o.ItemClassCode) {
		return true
	}
...
func (o *DailyInventoryItemType) SetItemClassCode(v string) {
	o.ItemClassCode = &v
}
