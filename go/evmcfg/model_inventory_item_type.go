...
type InventoryItemType struct {
	...
	TracesPerDay *bool `json:"tracesPerDay,omitempty"`
	...
	// List of Daily Available inventory items.
	DailyInventoryItems []DailyAvailableInventoryItemType `json:"dailyInventoryItems,omitempty"`
...
// GetTracesPerDay returns the TracesPerDay field value if set, zero value otherwise.
func (o *InventoryItemType) GetTracesPerDay() bool {
	if o == nil || IsNil(o.TracesPerDay) {
		var ret bool
		return ret
	}
	return *o.TracesPerDay
}

// GetTracesPerDayOk returns a tuple with the TracesPerDay field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *InventoryItemType) GetTracesPerDayOk() (*bool, bool) {
	if o == nil || IsNil(o.TracesPerDay) {
		return nil, false
	}
	return o.TracesPerDay, true
}
...
// SetTracesPerDay gets a reference to the given bool and assigns it to the TracesPerDay field.
...
func (o *InventoryItemType) GetDailyInventoryItems() []DailyAvailableInventoryItemType {
...
// and a boolean to check if the value has been set.
func (o *InventoryItemType) GetDailyInventoryItemsOk() ([]DailyAvailableInventoryItemType, bool) {
	if o == nil || IsNil(o.DailyInventoryItems) {
		return nil, false
	}
...
func (o *InventoryItemType) HasDailyInventoryItems() bool {
	if o != nil && !IsNil(o.DailyInventoryItems) {
		return true
	}
...
// SetDailyInventoryItems gets a reference to the given []DailyAvailableInventoryItemType and assigns it to the DailyInventoryItems field.
func (o *InventoryItemType) SetDailyInventoryItems(v []DailyAvailableInventoryItemType) {
...
func (o *InventoryItemType) GetManagedBy() ManagedByOptions {
...
// and a boolean to check if the value has been set.
func (o *InventoryItemType) GetManagedByOk() (*ManagedByOptions, bool) {
	if o == nil || IsNil(o.ManagedBy) {
		return nil, false
	}
...
func (o *InventoryItemType) HasManagedBy() bool {
	if o != nil && !IsNil(o.ManagedBy) {
		return true
	}
...
func (o *InventoryItemType) SetManagedBy(v ManagedByOptions) {
	o.ManagedBy = &v
}
...
func (o InventoryItemType) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.TracesPerDay) {
		toSerialize["tracesPerDay"] = o.TracesPerDay
	}
	if !IsNil(o.ItemPool) {
