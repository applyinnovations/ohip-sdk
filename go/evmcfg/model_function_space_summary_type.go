...
func (o *FunctionSpaceSummaryType) GetInactive() bool {
...
// and a boolean to check if the value has been set.
func (o *FunctionSpaceSummaryType) GetInactiveOk() (*bool, bool) {
	if o == nil || IsNil(o.Inactive) {
		return nil, false
	}
...
func (o *FunctionSpaceSummaryType) HasInactive() bool {
	if o != nil && !IsNil(o.Inactive) {
		return true
	}
...
func (o *FunctionSpaceSummaryType) SetInactive(v bool) {
	o.Inactive = &v
}
