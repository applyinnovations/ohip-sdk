...
func (o *ItemClassType) GetManagedBy() ManagedByOptions {
...
// and a boolean to check if the value has been set.
func (o *ItemClassType) GetManagedByOk() (*ManagedByOptions, bool) {
	if o == nil || IsNil(o.ManagedBy) {
		return nil, false
	}
...
func (o *ItemClassType) HasManagedBy() bool {
	if o != nil && !IsNil(o.ManagedBy) {
		return true
	}
...
func (o *ItemClassType) SetManagedBy(v ManagedByOptions) {
	o.ManagedBy = &v
}
