...
func (o *FunctionSpaceLocationType) GetManagedBy() ManagedByOptions {
...
// and a boolean to check if the value has been set.
func (o *FunctionSpaceLocationType) GetManagedByOk() (*ManagedByOptions, bool) {
	if o == nil || IsNil(o.ManagedBy) {
		return nil, false
	}
...
func (o *FunctionSpaceLocationType) HasManagedBy() bool {
	if o != nil && !IsNil(o.ManagedBy) {
		return true
	}
...
func (o *FunctionSpaceLocationType) SetManagedBy(v ManagedByOptions) {
	o.ManagedBy = &v
}
