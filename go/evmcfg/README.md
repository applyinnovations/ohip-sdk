...
```golang
import evmcfg "github.com/applyinnovations/ohip-sdk/go/evmcfg/v2"
```
...
*ResourceConfigAPI* | [**DeleteResourceConfigServiceCache**](docs/ResourceConfigAPI.md#deleteresourceconfigservicecache) | **Delete** /services/resources/cache | ClearCache
