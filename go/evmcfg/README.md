...
```golang
import evmcfg "github.com/applyinnovations/ohip-sdk/go/evmcfg/v3"
```
...
*ChainConfigAPI* | [**ChangeUpsertFunctionSpaceEventTypes**](docs/ChainConfigAPI.md#changeupsertfunctionspaceeventtypes) | **Put** /upsert/cateringEventTypes/{eventTypeCode} | Create/Change Function Space Event Types
...
*HotelConfigAPI* | [**ChangeUpsertCateringRentalCodes**](docs/HotelConfigAPI.md#changeupsertcateringrentalcodes) | **Put** /upsert/functionSpaceRentalCodes | Create/Change Catering s Rental Codes
*HotelConfigAPI* | [**ChangeUpsertEventCodes**](docs/HotelConfigAPI.md#changeupserteventcodes) | **Put** /upsert/hotels/{hotelId}/eventCodes | Create/Change Hotel Event Codes
*HotelConfigAPI* | [**ChangeUpsertFunctionSpaceLocations**](docs/HotelConfigAPI.md#changeupsertfunctionspacelocations) | **Put** /upsert/functionspaceLocations/{functionspaceLocationCode} | Create/Change function space locations
*HotelConfigAPI* | [**ChangeUpsertFunctionSpaceSetupStyles**](docs/HotelConfigAPI.md#changeupsertfunctionspacesetupstyles) | **Put** /upsert/functionspaceSetupStyles | Create/Change function space setup styles
...
*ResourceConfigAPI* | [**CopyCateringPackage**](docs/ResourceConfigAPI.md#copycateringpackage) | **Post** /hotels/{hotelId}/cateringPackages/{cateringPackageId}/copy | Operation to copy catering package or template.
*ResourceConfigAPI* | [**CopyCateringPackagePrice**](docs/ResourceConfigAPI.md#copycateringpackageprice) | **Post** /hotels/{hotelId}/cateringPackages/{cateringPackageId}/prices/{pricesId}/copy | Operation to copy catering package price.
...
*ResourceConfigAPI* | [**PutDailyInventoryItemQuantities**](docs/ResourceConfigAPI.md#putdailyinventoryitemquantities) | **Put** /hotels/{hotelId}/dailyInventoryItemQuantities | Update Daily Inventory Item Quantities
...
*ResourceConfigAPI* | [**PutUpsertCateringMenuClasses**](docs/ResourceConfigAPI.md#putupsertcateringmenuclasses) | **Put** /upsert/cateringMenuClasses | Create/Update catering menu classes
*ResourceConfigAPI* | [**PutUpsertCateringMenuItemClasses**](docs/ResourceConfigAPI.md#putupsertcateringmenuitemclasses) | **Put** /upsert/cateringMenuItemClasses | Create/Update menu item classes
*ResourceConfigAPI* | [**PutUpsertCateringMenuItems**](docs/ResourceConfigAPI.md#putupsertcateringmenuitems) | **Put** /upsert/hotels/{hotelId}/cateringMenuItems | Create/Update menu items
*ResourceConfigAPI* | [**PutUpsertCateringMenus**](docs/ResourceConfigAPI.md#putupsertcateringmenus) | **Put** /upsert/hotels/{hotelId}/cateringMenus | Operation to create/change catering menus.
*ResourceConfigAPI* | [**PutUpsertEventForecasts**](docs/ResourceConfigAPI.md#putupserteventforecasts) | **Put** /upsert/eventForecasts | Create/Update Event forecasts
*ResourceConfigAPI* | [**PutUpsertInventoryItems**](docs/ResourceConfigAPI.md#putupsertinventoryitems) | **Put** /upsert/hotels/{hotelId}/inventoryItems | Create/Update Item Inventory
*ResourceConfigAPI* | [**PutUpsertItemClasses**](docs/ResourceConfigAPI.md#putupsertitemclasses) | **Put** /upsert/itemClasses/{itemClassesCode} | Create/Update item classes
*ResourceConfigAPI* | [**PutUpsertItemPools**](docs/ResourceConfigAPI.md#putupsertitempools) | **Post** /upsert/itemPools/{itemPoolsCode} | Create/Change Item Pools
...
## Documentation For Models
 ...
 - [CopyCateringPackagePriceType](docs/CopyCateringPackagePriceType.md)
 - [CopyCateringPackageType](docs/CopyCateringPackageType.md)
 ...
 - [DailyAvailableInventoryItemType](docs/DailyAvailableInventoryItemType.md)
 - [DailyInventoryItemQuantities](docs/DailyInventoryItemQuantities.md)
 - [DailyInventoryItemQuantityType](docs/DailyInventoryItemQuantityType.md)
 ...
 - [ResourceCodeInfo](docs/ResourceCodeInfo.md)
