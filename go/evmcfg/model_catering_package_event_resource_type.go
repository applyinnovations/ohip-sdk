...
type CateringPackageEventResourceType struct {
	...
	RevenueTypes []string `json:"revenueTypes,omitempty"`
	...
	ResourceNotes []CateringPackageResourceNoteType `json:"resourceNotes,omitempty"`
}
...
// SetRevenueTypes gets a reference to the given []string and assigns it to the RevenueTypes field.
...
func (o *CateringPackageEventResourceType) GetResourceNotes() []CateringPackageResourceNoteType {
	if o == nil || IsNil(o.ResourceNotes) {
		var ret []CateringPackageResourceNoteType
		return ret
	}
...
// SetResourceNotes gets a reference to the given []CateringPackageResourceNoteType and assigns it to the ResourceNotes field.
