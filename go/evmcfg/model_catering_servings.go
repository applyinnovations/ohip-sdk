...
// checks if the CateringServings type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CateringServings{}

// CateringServings Request object which holds modified Catering Code's Serving.
type CateringServings struct {
...
func (o CateringServings) MarshalJSON() ([]byte, error) {
...
func (o CateringServings) ToMap() (map[string]interface{}, error) {
...
type NullableCateringServings struct {
	value *CateringServings
	isSet bool
}

func (v NullableCateringServings) Get() *CateringServings {
	return v.value
}

func (v *NullableCateringServings) Set(val *CateringServings) {
	v.value = val
	v.isSet = true
}

func (v NullableCateringServings) IsSet() bool {
	return v.isSet
}

func (v *NullableCateringServings) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCateringServings(val *CateringServings) *NullableCateringServings {
	return &NullableCateringServings{value: val, isSet: true}
}

func (v NullableCateringServings) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCateringServings) UnmarshalJSON(src []byte) error {
	v.isSet = true
