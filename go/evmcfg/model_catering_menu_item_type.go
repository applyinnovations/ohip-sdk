...
func (o *CateringMenuItemType) GetManagedBy() ManagedByOptions {
...
// and a boolean to check if the value has been set.
func (o *CateringMenuItemType) GetManagedByOk() (*ManagedByOptions, bool) {
	if o == nil || IsNil(o.ManagedBy) {
		return nil, false
	}
...
func (o *CateringMenuItemType) HasManagedBy() bool {
	if o != nil && !IsNil(o.ManagedBy) {
		return true
	}
...
func (o *CateringMenuItemType) SetManagedBy(v ManagedByOptions) {
	o.ManagedBy = &v
}
