...
// checks if the MealTypeType type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MealTypeType{}

// MealTypeType Contains Common Master configuration detail.
type MealTypeType struct {
...
func (o MealTypeType) MarshalJSON() ([]byte, error) {
...
func (o MealTypeType) ToMap() (map[string]interface{}, error) {
...
type NullableMealTypeType struct {
	value *MealTypeType
	isSet bool
}

func (v NullableMealTypeType) Get() *MealTypeType {
	return v.value
}

func (v *NullableMealTypeType) Set(val *MealTypeType) {
	v.value = val
	v.isSet = true
}

func (v NullableMealTypeType) IsSet() bool {
	return v.isSet
}

func (v *NullableMealTypeType) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMealTypeType(val *MealTypeType) *NullableMealTypeType {
	return &NullableMealTypeType{value: val, isSet: true}
}

func (v NullableMealTypeType) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMealTypeType) UnmarshalJSON(src []byte) error {
	v.isSet = true
