...
func (o *CateringMenuType) GetManagedBy() ManagedByOptions {
...
// and a boolean to check if the value has been set.
func (o *CateringMenuType) GetManagedByOk() (*ManagedByOptions, bool) {
	if o == nil || IsNil(o.ManagedBy) {
		return nil, false
	}
...
func (o *CateringMenuType) HasManagedBy() bool {
	if o != nil && !IsNil(o.ManagedBy) {
		return true
	}
...
func (o *CateringMenuType) SetManagedBy(v ManagedByOptions) {
	o.ManagedBy = &v
}
