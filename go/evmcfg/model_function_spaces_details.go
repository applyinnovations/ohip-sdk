...
// checks if the FunctionSpacesDetails type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &FunctionSpacesDetails{}

// FunctionSpacesDetails Response object for fetching function spaces summary info at the property level.
type FunctionSpacesDetails struct {
	// The summary information for a function space.
	FunctionSpaces []FunctionSpaceSummaryType `json:"functionSpaces,omitempty"`
...
func (o *FunctionSpacesDetails) GetFunctionSpaces() []FunctionSpaceSummaryType {
	if o == nil || IsNil(o.FunctionSpaces) {
		var ret []FunctionSpaceSummaryType
		return ret
	}
...
// SetFunctionSpaces gets a reference to the given []FunctionSpaceSummaryType and assigns it to the FunctionSpaces field.
...
func (o FunctionSpacesDetails) MarshalJSON() ([]byte, error) {
...
func (o FunctionSpacesDetails) ToMap() (map[string]interface{}, error) {
...
type NullableFunctionSpacesDetails struct {
	value *FunctionSpacesDetails
	isSet bool
}

func (v NullableFunctionSpacesDetails) Get() *FunctionSpacesDetails {
	return v.value
}

func (v *NullableFunctionSpacesDetails) Set(val *FunctionSpacesDetails) {
	v.value = val
	v.isSet = true
}

func (v NullableFunctionSpacesDetails) IsSet() bool {
	return v.isSet
}

func (v *NullableFunctionSpacesDetails) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableFunctionSpacesDetails(val *FunctionSpacesDetails) *NullableFunctionSpacesDetails {
	return &NullableFunctionSpacesDetails{value: val, isSet: true}
}

func (v NullableFunctionSpacesDetails) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableFunctionSpacesDetails) UnmarshalJSON(src []byte) error {
	v.isSet = true
