...
type BusinessEvents struct {
	...
	// List of available data value mappings for a given external system and property.
	DataValueMapping []DataValueMappingType `json:"dataValueMapping,omitempty"`
...
// GetDataValueMapping returns the DataValueMapping field value if set, zero value otherwise.
func (o *BusinessEvents) GetDataValueMapping() []DataValueMappingType {
	if o == nil || IsNil(o.DataValueMapping) {
		var ret []DataValueMappingType
		return ret
	}
	return o.DataValueMapping
}

// GetDataValueMappingOk returns a tuple with the DataValueMapping field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *BusinessEvents) GetDataValueMappingOk() ([]DataValueMappingType, bool) {
	if o == nil || IsNil(o.DataValueMapping) {
		return nil, false
	}
	return o.DataValueMapping, true
}

// HasDataValueMapping returns a boolean if a field has been set.
func (o *BusinessEvents) HasDataValueMapping() bool {
	if o != nil && !IsNil(o.DataValueMapping) {
		return true
	}
...
// SetDataValueMapping gets a reference to the given []DataValueMappingType and assigns it to the DataValueMapping field.
func (o *BusinessEvents) SetDataValueMapping(v []DataValueMappingType) {
	o.DataValueMapping = v
}
...
func (o BusinessEvents) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.DataValueMapping) {
		toSerialize["dataValueMapping"] = o.DataValueMapping
	}
	if !IsNil(o.Links) {
