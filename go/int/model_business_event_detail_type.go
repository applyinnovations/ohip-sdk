...
type BusinessEventDetailType struct {
	...
	// Hotel code for the data element.
...
func (o *BusinessEventDetailType) GetHotelId() string {
...
// and a boolean to check if the value has been set.
func (o *BusinessEventDetailType) GetHotelIdOk() (*string, bool) {
	if o == nil || IsNil(o.HotelId) {
		return nil, false
	}
...
func (o *BusinessEventDetailType) HasHotelId() bool {
	if o != nil && !IsNil(o.HotelId) {
		return true
	}
...
func (o *BusinessEventDetailType) SetHotelId(v string) {
	o.HotelId = &v
}
