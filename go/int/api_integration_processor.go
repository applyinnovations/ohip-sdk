...
func (r IntegrationProcessorAPIGetBusinessEventsRequest) ExternalData(externalData string) IntegrationProcessorAPIGetBusinessEventsRequest {
	r.externalData = &externalData
	return r
}

// Request Id of an incoming request
func (r IntegrationProcessorAPIGetBusinessEventsRequest) XRequestId(xRequestId string) IntegrationProcessorAPIGetBusinessEventsRequest {
	r.xRequestId = &xRequestId
	return r
}

// Customer&#39;s Integration Application Id
func (r IntegrationProcessorAPIGetBusinessEventsRequest) XOriginatingApplication(xOriginatingApplication string) IntegrationProcessorAPIGetBusinessEventsRequest {
...
// Pass this header as true, if payload needs DVM
func (r IntegrationProcessorAPIGetBusinessEventsByExternalSystemRequest) ExternalData(externalData string) IntegrationProcessorAPIGetBusinessEventsByExternalSystemRequest {
	r.externalData = &externalData
	return r
}

// Request Id of an incoming request
func (r IntegrationProcessorAPIGetBusinessEventsByExternalSystemRequest) XRequestId(xRequestId string) IntegrationProcessorAPIGetBusinessEventsByExternalSystemRequest {
	r.xRequestId = &xRequestId
	return r
}

// Customer&#39;s Integration Application Id
func (r IntegrationProcessorAPIGetBusinessEventsByExternalSystemRequest) XOriginatingApplication(xOriginatingApplication string) IntegrationProcessorAPIGetBusinessEventsByExternalSystemRequest {
	r.xOriginatingApplication = &xOriginatingApplication
	return r
}
