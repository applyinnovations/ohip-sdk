...
func (o *PackageGroupType) GetTranslatedDescription() TranslationTextType2000 {
...
// and a boolean to check if the value has been set.
func (o *PackageGroupType) GetTranslatedDescriptionOk() (*TranslationTextType2000, bool) {
	if o == nil || IsNil(o.TranslatedDescription) {
		return nil, false
	}
...
func (o *PackageGroupType) HasTranslatedDescription() bool {
	if o != nil && !IsNil(o.TranslatedDescription) {
		return true
	}
...
func (o *PackageGroupType) SetTranslatedDescription(v TranslationTextType2000) {
...
func (o *PackageGroupType) GetTranslatedShortDescription() TranslationTextType40 {
...
// and a boolean to check if the value has been set.
func (o *PackageGroupType) GetTranslatedShortDescriptionOk() (*TranslationTextType40, bool) {
	if o == nil || IsNil(o.TranslatedShortDescription) {
		return nil, false
	}
...
func (o *PackageGroupType) HasTranslatedShortDescription() bool {
	if o != nil && !IsNil(o.TranslatedShortDescription) {
		return true
	}
...
func (o *PackageGroupType) SetTranslatedShortDescription(v TranslationTextType40) {
...
func (o *PackageGroupType) GetManagedBy() ManagedByOptions {
...
// and a boolean to check if the value has been set.
func (o *PackageGroupType) GetManagedByOk() (*ManagedByOptions, bool) {
	if o == nil || IsNil(o.ManagedBy) {
		return nil, false
	}
...
func (o *PackageGroupType) HasManagedBy() bool {
	if o != nil && !IsNil(o.ManagedBy) {
		return true
	}
...
func (o *PackageGroupType) SetManagedBy(v ManagedByOptions) {
	o.ManagedBy = &v
}
