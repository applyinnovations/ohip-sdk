...
type _RateAccessExclusionsType RateAccessExclusionsType

// NewRateAccessExclusionsType instantiates a new RateAccessExclusionsType object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewRateAccessExclusionsType(rateCode string) *RateAccessExclusionsType {
...
func (o *RateAccessExclusionsType) UnmarshalJSON(bytes []byte) (err error) {
	...
	varRateAccessExclusionsType := _RateAccessExclusionsType{}

	err = json.Unmarshal(bytes, &varRateAccessExclusionsType)

	if err != nil {
		return err
	}

	*o = RateAccessExclusionsType(varRateAccessExclusionsType)
