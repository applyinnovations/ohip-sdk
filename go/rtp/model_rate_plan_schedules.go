...
// checks if the RatePlanSchedules type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RatePlanSchedules{}

// RatePlanSchedules Request object to change rate plan schedules.
type RatePlanSchedules struct {
...
func (o RatePlanSchedules) MarshalJSON() ([]byte, error) {
...
func (o RatePlanSchedules) ToMap() (map[string]interface{}, error) {
...
type NullableRatePlanSchedules struct {
	value *RatePlanSchedules
	isSet bool
}

func (v NullableRatePlanSchedules) Get() *RatePlanSchedules {
	return v.value
}

func (v *NullableRatePlanSchedules) Set(val *RatePlanSchedules) {
	v.value = val
	v.isSet = true
}

func (v NullableRatePlanSchedules) IsSet() bool {
	return v.isSet
}

func (v *NullableRatePlanSchedules) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRatePlanSchedules(val *RatePlanSchedules) *NullableRatePlanSchedules {
	return &NullableRatePlanSchedules{value: val, isSet: true}
}

func (v NullableRatePlanSchedules) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRatePlanSchedules) UnmarshalJSON(src []byte) error {
	v.isSet = true
