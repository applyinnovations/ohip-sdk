...
type RatePlanMasterInfoType struct {
	...
	RateTiers []RateTierType `json:"rateTiers,omitempty"`
...
// SetRateTiers gets a reference to the given []RateTierType and assigns it to the RateTiers field.
