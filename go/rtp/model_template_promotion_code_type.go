...
func (o *TemplatePromotionCodeType) GetManagedBy() ManagedByOptions {
...
// and a boolean to check if the value has been set.
func (o *TemplatePromotionCodeType) GetManagedByOk() (*ManagedByOptions, bool) {
	if o == nil || IsNil(o.ManagedBy) {
		return nil, false
	}
...
func (o *TemplatePromotionCodeType) HasManagedBy() bool {
	if o != nil && !IsNil(o.ManagedBy) {
		return true
	}
...
func (o *TemplatePromotionCodeType) SetManagedBy(v ManagedByOptions) {
	o.ManagedBy = &v
}
