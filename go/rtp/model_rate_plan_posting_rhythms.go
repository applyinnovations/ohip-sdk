...
type RatePlanPostingRhythms struct {
	...
	PostingRhythms []RatePlanAdvancedPostingRhythmType `json:"postingRhythms,omitempty"`
...
func (o *RatePlanPostingRhythms) GetPostingRhythms() []RatePlanAdvancedPostingRhythmType {
	if o == nil || IsNil(o.PostingRhythms) {
		var ret []RatePlanAdvancedPostingRhythmType
		return ret
	}
...
// SetPostingRhythms gets a reference to the given []RatePlanAdvancedPostingRhythmType and assigns it to the PostingRhythms field.
