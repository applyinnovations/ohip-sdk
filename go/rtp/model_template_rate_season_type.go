...
func (o *TemplateRateSeasonType) GetManagedBy() ManagedByOptions {
...
// and a boolean to check if the value has been set.
func (o *TemplateRateSeasonType) GetManagedByOk() (*ManagedByOptions, bool) {
	if o == nil || IsNil(o.ManagedBy) {
		return nil, false
	}
...
func (o *TemplateRateSeasonType) HasManagedBy() bool {
	if o != nil && !IsNil(o.ManagedBy) {
		return true
	}
...
func (o *TemplateRateSeasonType) SetManagedBy(v ManagedByOptions) {
	o.ManagedBy = &v
}
