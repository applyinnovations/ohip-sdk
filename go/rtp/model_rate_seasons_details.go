...
// checks if the RateSeasonsDetails type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RateSeasonsDetails{}

// RateSeasonsDetails Response object for fetching rate seasons for a hotel.
type RateSeasonsDetails struct {
...
func (o RateSeasonsDetails) MarshalJSON() ([]byte, error) {
...
func (o RateSeasonsDetails) ToMap() (map[string]interface{}, error) {
...
type NullableRateSeasonsDetails struct {
	value *RateSeasonsDetails
	isSet bool
}

func (v NullableRateSeasonsDetails) Get() *RateSeasonsDetails {
	return v.value
}

func (v *NullableRateSeasonsDetails) Set(val *RateSeasonsDetails) {
	v.value = val
	v.isSet = true
}

func (v NullableRateSeasonsDetails) IsSet() bool {
	return v.isSet
}

func (v *NullableRateSeasonsDetails) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRateSeasonsDetails(val *RateSeasonsDetails) *NullableRateSeasonsDetails {
	return &NullableRateSeasonsDetails{value: val, isSet: true}
}

func (v NullableRateSeasonsDetails) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRateSeasonsDetails) UnmarshalJSON(src []byte) error {
	v.isSet = true
