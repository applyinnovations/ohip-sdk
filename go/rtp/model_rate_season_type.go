...
func (o *RateSeasonType) GetManagedBy() ManagedByOptions {
...
// and a boolean to check if the value has been set.
func (o *RateSeasonType) GetManagedByOk() (*ManagedByOptions, bool) {
	if o == nil || IsNil(o.ManagedBy) {
		return nil, false
	}
...
func (o *RateSeasonType) HasManagedBy() bool {
	if o != nil && !IsNil(o.ManagedBy) {
		return true
	}
...
func (o *RateSeasonType) SetManagedBy(v ManagedByOptions) {
	o.ManagedBy = &v
}
