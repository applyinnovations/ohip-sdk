...
type NegRateAccessType struct {
	...
	// The master identifier for multiple offices/locations under the same company profile. This property is intended for retrieval only and cannot be modified during create or update operations.
	...
	// Negotiated Rate is inactive or not. This property is intended for retrieval only and cannot be modified during create or update operations.
...
func (o *NegRateAccessType) GetCorporateAgreementId() string {
...
// and a boolean to check if the value has been set.
func (o *NegRateAccessType) GetCorporateAgreementIdOk() (*string, bool) {
	if o == nil || IsNil(o.CorporateAgreementId) {
		return nil, false
	}
...
func (o *NegRateAccessType) HasCorporateAgreementId() bool {
	if o != nil && !IsNil(o.CorporateAgreementId) {
		return true
	}
...
func (o *NegRateAccessType) SetCorporateAgreementId(v string) {
...
func (o *NegRateAccessType) GetInactive() bool {
...
// and a boolean to check if the value has been set.
func (o *NegRateAccessType) GetInactiveOk() (*bool, bool) {
	if o == nil || IsNil(o.Inactive) {
		return nil, false
	}
...
func (o *NegRateAccessType) HasInactive() bool {
	if o != nil && !IsNil(o.Inactive) {
		return true
	}
...
func (o *NegRateAccessType) SetInactive(v bool) {
	o.Inactive = &v
}
