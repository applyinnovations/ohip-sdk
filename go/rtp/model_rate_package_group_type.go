...
func (o *RatePackageGroupType) GetTranslatedDescription() TranslationTextType2000 {
...
// and a boolean to check if the value has been set.
func (o *RatePackageGroupType) GetTranslatedDescriptionOk() (*TranslationTextType2000, bool) {
	if o == nil || IsNil(o.TranslatedDescription) {
		return nil, false
	}
...
func (o *RatePackageGroupType) HasTranslatedDescription() bool {
	if o != nil && !IsNil(o.TranslatedDescription) {
		return true
	}
...
func (o *RatePackageGroupType) SetTranslatedDescription(v TranslationTextType2000) {
...
func (o *RatePackageGroupType) GetTranslatedShortDescription() TranslationTextType40 {
...
// and a boolean to check if the value has been set.
func (o *RatePackageGroupType) GetTranslatedShortDescriptionOk() (*TranslationTextType40, bool) {
	if o == nil || IsNil(o.TranslatedShortDescription) {
		return nil, false
	}
...
func (o *RatePackageGroupType) HasTranslatedShortDescription() bool {
	if o != nil && !IsNil(o.TranslatedShortDescription) {
		return true
	}
...
func (o *RatePackageGroupType) SetTranslatedShortDescription(v TranslationTextType40) {
