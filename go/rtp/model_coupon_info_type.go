...
type CouponInfoType struct {
	...
	// Indicates if promotion code is of limited use type. This is set to true if it is either set on property or template
...
func (o *CouponInfoType) GetLimitedUse() bool {
...
// and a boolean to check if the value has been set.
func (o *CouponInfoType) GetLimitedUseOk() (*bool, bool) {
	if o == nil || IsNil(o.LimitedUse) {
		return nil, false
	}
...
func (o *CouponInfoType) HasLimitedUse() bool {
	if o != nil && !IsNil(o.LimitedUse) {
		return true
	}
...
func (o *CouponInfoType) SetLimitedUse(v bool) {
	o.LimitedUse = &v
}
