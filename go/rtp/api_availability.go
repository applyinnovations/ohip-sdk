...
func (r AvailabilityAPIValidateRateCouponRequest) ExternalData(externalData string) AvailabilityAPIValidateRateCouponRequest {
	r.externalData = &externalData
	return r
}

// Request Id of an incoming request
func (r AvailabilityAPIValidateRateCouponRequest) XRequestId(xRequestId string) AvailabilityAPIValidateRateCouponRequest {
	r.xRequestId = &xRequestId
	return r
}

// Customer&#39;s Integration Application Id
func (r AvailabilityAPIValidateRateCouponRequest) XOriginatingApplication(xOriginatingApplication string) AvailabilityAPIValidateRateCouponRequest {
...
func (a *AvailabilityAPIService) ValidateRateCouponExecute(r AvailabilityAPIValidateRateCouponRequest) (*PromotionCouponValidationDetails, *http.Response, error) {
	...
	if strlen(r.couponCode) > 40 {
		return localVarReturnValue, nil, reportError("couponCode must have less than 40 elements")
	}
...
// Pass this header as true, if payload needs DVM
func (r AvailabilityAPIValidateRatePromotionRequest) ExternalData(externalData string) AvailabilityAPIValidateRatePromotionRequest {
	r.externalData = &externalData
	return r
}

// Request Id of an incoming request
func (r AvailabilityAPIValidateRatePromotionRequest) XRequestId(xRequestId string) AvailabilityAPIValidateRatePromotionRequest {
	r.xRequestId = &xRequestId
	return r
}

// Customer&#39;s Integration Application Id
func (r AvailabilityAPIValidateRatePromotionRequest) XOriginatingApplication(xOriginatingApplication string) AvailabilityAPIValidateRatePromotionRequest {
	r.xOriginatingApplication = &xOriginatingApplication
	return r
}
...
// Pass this header as true, if payload needs DVM
func (r AvailabilityAPIValidateRatePromotionCouponRequest) ExternalData(externalData string) AvailabilityAPIValidateRatePromotionCouponRequest {
	r.externalData = &externalData
	return r
}

// Request Id of an incoming request
func (r AvailabilityAPIValidateRatePromotionCouponRequest) XRequestId(xRequestId string) AvailabilityAPIValidateRatePromotionCouponRequest {
	r.xRequestId = &xRequestId
	return r
}

// Customer&#39;s Integration Application Id
func (r AvailabilityAPIValidateRatePromotionCouponRequest) XOriginatingApplication(xOriginatingApplication string) AvailabilityAPIValidateRatePromotionCouponRequest {
	r.xOriginatingApplication = &xOriginatingApplication
	return r
}
