...
type PropertyPromotionCodeType struct {
	...
	PromoCodeRoutingInstructions []PromoCodeRoutingInstructionType `json:"promoCodeRoutingInstructions,omitempty"`
...
// GetPromoCodeRoutingInstructions returns the PromoCodeRoutingInstructions field value if set, zero value otherwise.
func (o *PropertyPromotionCodeType) GetPromoCodeRoutingInstructions() []PromoCodeRoutingInstructionType {
	if o == nil || IsNil(o.PromoCodeRoutingInstructions) {
		var ret []PromoCodeRoutingInstructionType
		return ret
	}
	return o.PromoCodeRoutingInstructions
}

// GetPromoCodeRoutingInstructionsOk returns a tuple with the PromoCodeRoutingInstructions field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *PropertyPromotionCodeType) GetPromoCodeRoutingInstructionsOk() ([]PromoCodeRoutingInstructionType, bool) {
	if o == nil || IsNil(o.PromoCodeRoutingInstructions) {
		return nil, false
	}
	return o.PromoCodeRoutingInstructions, true
}
...
// SetPromoCodeRoutingInstructions gets a reference to the given []PromoCodeRoutingInstructionType and assigns it to the PromoCodeRoutingInstructions field.
func (o *PropertyPromotionCodeType) SetPromoCodeRoutingInstructions(v []PromoCodeRoutingInstructionType) {
	o.PromoCodeRoutingInstructions = v
}
...
func (o *PropertyPromotionCodeType) GetManagedBy() ManagedByOptions {
...
// and a boolean to check if the value has been set.
func (o *PropertyPromotionCodeType) GetManagedByOk() (*ManagedByOptions, bool) {
	if o == nil || IsNil(o.ManagedBy) {
		return nil, false
	}
...
func (o *PropertyPromotionCodeType) HasManagedBy() bool {
	if o != nil && !IsNil(o.ManagedBy) {
		return true
	}
...
func (o *PropertyPromotionCodeType) SetManagedBy(v ManagedByOptions) {
	o.ManagedBy = &v
}
...
func (o PropertyPromotionCodeType) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.PromoCodeRoutingInstructions) {
		toSerialize["promoCodeRoutingInstructions"] = o.PromoCodeRoutingInstructions
	}
	if !IsNil(o.HotelId) {
