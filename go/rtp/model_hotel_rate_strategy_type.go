...
func (o *HotelRateStrategyType) GetManagedBy() ManagedByOptions {
...
// and a boolean to check if the value has been set.
func (o *HotelRateStrategyType) GetManagedByOk() (*ManagedByOptions, bool) {
	if o == nil || IsNil(o.ManagedBy) {
		return nil, false
	}
...
func (o *HotelRateStrategyType) HasManagedBy() bool {
	if o != nil && !IsNil(o.ManagedBy) {
		return true
	}
...
func (o *HotelRateStrategyType) SetManagedBy(v ManagedByOptions) {
	o.ManagedBy = &v
}
