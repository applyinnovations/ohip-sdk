...
// ConfigPackageScheduleType A Hotel Package Schedule. 'new' prefixed properties hold updated values for create or update operations; non-prefixed properties hold original values for update or delete operations.
type ConfigPackageScheduleType struct {
	NewTimeSpan *TimeSpanType `json:"newTimeSpan,omitempty"`
	// Collection of price schedule for the package. Omit this field when attempting to delete a pricing schedule.
	...
	// The starting value of the date range. Required when updating or deleting a pricing schedule.
	Start *string `json:"start,omitempty"`
	// The ending value of the date range. Required when updating or deleting a pricing schedule.
	End *string `json:"end,omitempty"`
	DaysOfWeek *DaysOfWeekControlsType `json:"daysOfWeek,omitempty"`
	NewDaysOfWeek *DaysOfWeekControlsType `json:"newDaysOfWeek,omitempty"`
}
...
func (o *ConfigPackageScheduleType) GetDaysOfWeek() DaysOfWeekControlsType {
	if o == nil || IsNil(o.DaysOfWeek) {
		var ret DaysOfWeekControlsType
		return ret
	}
	return *o.DaysOfWeek
}
...
// and a boolean to check if the value has been set.
func (o *ConfigPackageScheduleType) GetDaysOfWeekOk() (*DaysOfWeekControlsType, bool) {
	if o == nil || IsNil(o.DaysOfWeek) {
		return nil, false
	}
...
func (o *ConfigPackageScheduleType) HasDaysOfWeek() bool {
	if o != nil && !IsNil(o.DaysOfWeek) {
		return true
	}
...
// SetDaysOfWeek gets a reference to the given DaysOfWeekControlsType and assigns it to the DaysOfWeek field.
func (o *ConfigPackageScheduleType) SetDaysOfWeek(v DaysOfWeekControlsType) {
	o.DaysOfWeek = &v
}

// GetNewDaysOfWeek returns the NewDaysOfWeek field value if set, zero value otherwise.
func (o *ConfigPackageScheduleType) GetNewDaysOfWeek() DaysOfWeekControlsType {
	if o == nil || IsNil(o.NewDaysOfWeek) {
		var ret DaysOfWeekControlsType
		return ret
	}
	return *o.NewDaysOfWeek
}

// GetNewDaysOfWeekOk returns a tuple with the NewDaysOfWeek field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ConfigPackageScheduleType) GetNewDaysOfWeekOk() (*DaysOfWeekControlsType, bool) {
	if o == nil || IsNil(o.NewDaysOfWeek) {
		return nil, false
	}
	return o.NewDaysOfWeek, true
}

// HasNewDaysOfWeek returns a boolean if a field has been set.
func (o *ConfigPackageScheduleType) HasNewDaysOfWeek() bool {
	if o != nil && !IsNil(o.NewDaysOfWeek) {
		return true
	}
...
// SetNewDaysOfWeek gets a reference to the given DaysOfWeekControlsType and assigns it to the NewDaysOfWeek field.
func (o *ConfigPackageScheduleType) SetNewDaysOfWeek(v DaysOfWeekControlsType) {
	o.NewDaysOfWeek = &v
}
...
func (o ConfigPackageScheduleType) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.NewDaysOfWeek) {
		toSerialize["newDaysOfWeek"] = o.NewDaysOfWeek
	}
