...
```golang
import rtp "github.com/applyinnovations/ohip-sdk/go/rtp/v3"
```
...
*HotelConfigAPI* | [**ChangeUpsertRateSeasons**](docs/HotelConfigAPI.md#changeupsertrateseasons) | **Put** /upsert/hotels/{hotelId}/rateSeasons/{seasonCode} | Create/Change Hotel Rate Seasons
...
*RatePlanAPI* | [**ChangeControlSegment**](docs/RatePlanAPI.md#changecontrolsegment) | **Put** /hotels/{hotelId}/controlSegments/{controlSegmentCode} | Modify a Control Segment
*RatePlanAPI* | [**ChangeTemplateControlSegment**](docs/RatePlanAPI.md#changetemplatecontrolsegment) | **Put** /controlSegmentTemplate/{controlSegmentCode} | Change Control Segment Template
...
*RatePlanAPI* | [**GeneratePackageCodeDescription**](docs/RatePlanAPI.md#generatepackagecodedescription) | **Post** /hotels/{hotelId}/packages/{packageCode}/text | Generate package description with AI Author Service Proxy.
*RatePlanAPI* | [**GeneratePromotionCouponCodes**](docs/RatePlanAPI.md#generatepromotioncouponcodes) | **Post** /hotels/{hotelId}/promotionCodes/{promotionCode}/coupons | Generate promotion coupon codes
*RatePlanAPI* | [**GenerateTemplatePromotionCouponCodes**](docs/RatePlanAPI.md#generatetemplatepromotioncouponcodes) | **Post** /promotionCodes/{promotionCode}/coupons | Generate template promotion coupon codes
...
*RatePlanAPI* | [**GetControlSegments**](docs/RatePlanAPI.md#getcontrolsegments) | **Get** /controlSegments | Get Control Segments
...
*RatePlanAPI* | [**GetPromotionCouponCode**](docs/RatePlanAPI.md#getpromotioncouponcode) | **Get** /hotels/{hotelId}/promotionCodes/{promotionCode}/coupons/{couponId} | Get promotion coupon code
*RatePlanAPI* | [**GetPromotionCouponCodes**](docs/RatePlanAPI.md#getpromotioncouponcodes) | **Get** /hotels/{hotelId}/promotionCodes/{promotionCode}/coupons | Get promotion coupon codes
...
*RatePlanAPI* | [**GetRatePlanMetrics**](docs/RatePlanAPI.md#getrateplanmetrics) | **Get** /hotels/{hotelId}/ratePlans/{ratePlanCode}/metrics | Get rate plan metrics
...
*RatePlanAPI* | [**GetTemplateControlSegments**](docs/RatePlanAPI.md#gettemplatecontrolsegments) | **Get** /controlSegmentTemplates | Get Control Segment Templates
...
*RatePlanAPI* | [**GetTemplatePromotionCouponCode**](docs/RatePlanAPI.md#gettemplatepromotioncouponcode) | **Get** /promotionCodes/{promotionCode}/coupons/{couponId} | Get promotion coupon code at template level.
*RatePlanAPI* | [**GetTemplatePromotionCouponCodes**](docs/RatePlanAPI.md#gettemplatepromotioncouponcodes) | **Get** /promotionCodes/{promotionCode}/coupons | Get promotion coupon codes at template level.
...
*RatePlanAPI* | [**InactivatePromotionCouponBatchCode**](docs/RatePlanAPI.md#inactivatepromotioncouponbatchcode) | **Put** /promotionCodes/{promotionCode}/coupons/inactivate | Inactivate promotion coupon codes for a given batch code.
...
*RatePlanAPI* | [**PostControlSegment**](docs/RatePlanAPI.md#postcontrolsegment) | **Post** /hotels/{hotelId}/controlSegments/{controlSegmentCode} | Create a new Control Segment
...
*RatePlanAPI* | [**PostTemplateControlSegment**](docs/RatePlanAPI.md#posttemplatecontrolsegment) | **Post** /controlSegmentTemplate/{controlSegmentCode} | Create Control Segment Template
...
*RatePlanAPI* | [**PutPromotionCouponCode**](docs/RatePlanAPI.md#putpromotioncouponcode) | **Put** /hotels/{hotelId}/promotionCodes/{promotionCode}/coupons/{couponId} | Update promotion coupon codes
...
*RatePlanAPI* | [**PutTemplatePromotionCouponCode**](docs/RatePlanAPI.md#puttemplatepromotioncouponcode) | **Put** /promotionCodes/{promotionCode}/coupons/{couponId} | Update promotion coupon codeat template level.
*RatePlanAPI* | [**PutUpsertPackageFormulaRanges**](docs/RatePlanAPI.md#putupsertpackageformularanges) | **Put** /upsert/hotels/{hotelId}/packageFormulaRanges | Create/Change package formula ranges
*RatePlanAPI* | [**PutUpsertPromotionCode**](docs/RatePlanAPI.md#putupsertpromotioncode) | **Put** /upsert/hotels/{hotelId}/promotionCodes/{promotionCode} | Change/Create promotion codes
*RatePlanAPI* | [**PutUpsertRateGroups**](docs/RatePlanAPI.md#putupsertrategroups) | **Put** /upsert/hotels/{hotelId}/rateGroups | Change/Create rate groups
*RatePlanAPI* | [**PutUpsertRateStrategy**](docs/RatePlanAPI.md#putupsertratestrategy) | **Put** /upsert/hotels/{hotelId}/rateStrategies | Create/Change rate strategies
*RatePlanAPI* | [**PutUpsertTemplatePromotionCode**](docs/RatePlanAPI.md#putupserttemplatepromotioncode) | **Put** /upsert/promotionCodes/{promotionCode} | Change/create Template Promotion Code
*RatePlanAPI* | [**RemoveControlSegment**](docs/RatePlanAPI.md#removecontrolsegment) | **Delete** /hotels/{hotelId}/controlSegments/{controlSegmentCode} | Delete a Control Segment
*RatePlanAPI* | [**RemoveTemplateControlSegment**](docs/RatePlanAPI.md#removetemplatecontrolsegment) | **Delete** /controlSegmentTemplate/{controlSegmentCode} | Delete Control Segment Template
*RatePlanAPI* | [**SavePackageCodeDescription**](docs/RatePlanAPI.md#savepackagecodedescription) | **Put** /packages/text/{responseId} | Save the package description to the AI Author Service.
...
## Documentation For Models
 ...
 - [ControlSegmentType](docs/ControlSegmentType.md)
 - [ControlSegmentsDetails](docs/ControlSegmentsDetails.md)
 ...
 - [CouponCodeStatus](docs/CouponCodeStatus.md)
 - [CouponGenerateOptionType](docs/CouponGenerateOptionType.md)
 ...
 - [DaysOfWeekControlsType](docs/DaysOfWeekControlsType.md)
 ...
 - [GeneratePackageCodeDescriptionRequest](docs/GeneratePackageCodeDescriptionRequest.md)
 - [GeneratePackageCodeDescriptionResponse](docs/GeneratePackageCodeDescriptionResponse.md)
 - [GeneratePromotionCouponCodeType](docs/GeneratePromotionCouponCodeType.md)
 - [GeneratePromotionCouponCodes](docs/GeneratePromotionCouponCodes.md)
 - [GeneratedCouponCodeDetails](docs/GeneratedCouponCodeDetails.md)
 ...
 - [GetPromotionCouponCode](docs/GetPromotionCouponCode.md)
 - [GetPromotionCouponCodes](docs/GetPromotionCouponCodes.md)
 ...
 - [InactivatePromotionCouponBatchCodeType](docs/InactivatePromotionCouponBatchCodeType.md)
 ...
 - [PromotionCouponCodeType](docs/PromotionCouponCodeType.md)
 ...
 - [PropertyControlSegmentType](docs/PropertyControlSegmentType.md)
 ...
 - [RatePlanMetrics](docs/RatePlanMetrics.md)
 ...
 - [RatePostingInterval](docs/RatePostingInterval.md)
 ...
 - [RestrictionGroupType](docs/RestrictionGroupType.md)
 - [RoutingProfileTypeType](docs/RoutingProfileTypeType.md)
 - [RuleGroupType](docs/RuleGroupType.md)
 - [RuleGroupsType](docs/RuleGroupsType.md)
 - [SavePackageCodeDescriptionRequest](docs/SavePackageCodeDescriptionRequest.md)
 - [SavePackageCodeDescriptionResponse](docs/SavePackageCodeDescriptionResponse.md)
 ...
 - [TemplateControlSegmentCriteria](docs/TemplateControlSegmentCriteria.md)
 - [TemplateControlSegmentDetails](docs/TemplateControlSegmentDetails.md)
 - [TemplateControlSegmentToBeChanged](docs/TemplateControlSegmentToBeChanged.md)
 - [TemplateControlSegmentType](docs/TemplateControlSegmentType.md)
 ...
 - [TranslationTextType40](docs/TranslationTextType40.md)
 - [TranslationsTextTypeInner](docs/TranslationsTextTypeInner.md)
 - [TrxInfoType](docs/TrxInfoType.md)
 - [UniqueIDType](docs/UniqueIDType.md)
 - [UpdatePromotionCouponCode](docs/UpdatePromotionCouponCode.md)
 - [UpdatePromotionCouponCodeType](docs/UpdatePromotionCouponCodeType.md)
