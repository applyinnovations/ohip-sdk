...
func (o *RateStrategyType) GetManagedBy() ManagedByOptions {
...
// and a boolean to check if the value has been set.
func (o *RateStrategyType) GetManagedByOk() (*ManagedByOptions, bool) {
	if o == nil || IsNil(o.ManagedBy) {
		return nil, false
	}
...
func (o *RateStrategyType) HasManagedBy() bool {
	if o != nil && !IsNil(o.ManagedBy) {
		return true
	}
...
func (o *RateStrategyType) SetManagedBy(v ManagedByOptions) {
	o.ManagedBy = &v
}
