...
type RatePlanPrimaryDetailsType struct {
	...
	PostingInterval *RatePostingInterval `json:"postingInterval,omitempty"`
...
func (o *RatePlanPrimaryDetailsType) GetPostingInterval() RatePostingInterval {
	if o == nil || IsNil(o.PostingInterval) {
		var ret RatePostingInterval
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *RatePlanPrimaryDetailsType) GetPostingIntervalOk() (*RatePostingInterval, bool) {
	if o == nil || IsNil(o.PostingInterval) {
		return nil, false
	}
...
func (o *RatePlanPrimaryDetailsType) HasPostingInterval() bool {
	if o != nil && !IsNil(o.PostingInterval) {
		return true
	}
...
// SetPostingInterval gets a reference to the given RatePostingInterval and assigns it to the PostingInterval field.
func (o *RatePlanPrimaryDetailsType) SetPostingInterval(v RatePostingInterval) {
	o.PostingInterval = &v
}
...
func (o *RatePlanPrimaryDetailsType) GetOffshoreRate() bool {
...
// and a boolean to check if the value has been set.
func (o *RatePlanPrimaryDetailsType) GetOffshoreRateOk() (*bool, bool) {
	if o == nil || IsNil(o.OffshoreRate) {
		return nil, false
	}
...
func (o *RatePlanPrimaryDetailsType) HasOffshoreRate() bool {
	if o != nil && !IsNil(o.OffshoreRate) {
		return true
	}
...
func (o *RatePlanPrimaryDetailsType) SetOffshoreRate(v bool) {
	o.OffshoreRate = &v
}
