...
type ConfigPostingAttributesType struct {
	...
	// Calculated Price based on the posting rhythm of the package on the package start date. Note, if the posting rhythm is set to Child, and either 'Child Rates by Defined Bucket' or 'Guest Age Categories' is active, the calculated price is the weighted average based on the ages of children on the reservation.
	CalculatedPrice *float32 `json:"calculatedPrice,omitempty"`
	// Unit Pricing on the Package Start Date Per Child Bucket / Guest Age Category. Applicable when Child Bucket or Guest Age Categories functionality is active and package's price calculation rule is Per Child.
	AgeBucketPricing []HotelPackageSchedulePriceType `json:"ageBucketPricing,omitempty"`
	// Minimum number of days in advance a reservation must be made to attach this package.
	MinAdvanceBookingDays *int32 `json:"minAdvanceBookingDays,omitempty"`
	// Calculated Allowance based on the posting rhythm of the package on the package start date. Note, if the posting rhythm is set to Child, and either 'Child Rates by Defined Bucket' or 'Guest Age Categories' is active, the calculated allowance is the weighted average based on the ages children on the reservation.
	CalculatedAllowance *float32 `json:"calculatedAllowance,omitempty"`
}
...
// GetAgeBucketPricing returns the AgeBucketPricing field value if set, zero value otherwise.
func (o *ConfigPostingAttributesType) GetAgeBucketPricing() []HotelPackageSchedulePriceType {
	if o == nil || IsNil(o.AgeBucketPricing) {
		var ret []HotelPackageSchedulePriceType
		return ret
	}
	return o.AgeBucketPricing
}

// GetAgeBucketPricingOk returns a tuple with the AgeBucketPricing field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ConfigPostingAttributesType) GetAgeBucketPricingOk() ([]HotelPackageSchedulePriceType, bool) {
	if o == nil || IsNil(o.AgeBucketPricing) {
		return nil, false
	}
	return o.AgeBucketPricing, true
}

// HasAgeBucketPricing returns a boolean if a field has been set.
func (o *ConfigPostingAttributesType) HasAgeBucketPricing() bool {
	if o != nil && !IsNil(o.AgeBucketPricing) {
		return true
	}
...
// SetAgeBucketPricing gets a reference to the given []HotelPackageSchedulePriceType and assigns it to the AgeBucketPricing field.
func (o *ConfigPostingAttributesType) SetAgeBucketPricing(v []HotelPackageSchedulePriceType) {
	o.AgeBucketPricing = v
}

// GetMinAdvanceBookingDays returns the MinAdvanceBookingDays field value if set, zero value otherwise.
func (o *ConfigPostingAttributesType) GetMinAdvanceBookingDays() int32 {
	if o == nil || IsNil(o.MinAdvanceBookingDays) {
		var ret int32
		return ret
	}
	return *o.MinAdvanceBookingDays
}

// GetMinAdvanceBookingDaysOk returns a tuple with the MinAdvanceBookingDays field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ConfigPostingAttributesType) GetMinAdvanceBookingDaysOk() (*int32, bool) {
	if o == nil || IsNil(o.MinAdvanceBookingDays) {
		return nil, false
	}
	return o.MinAdvanceBookingDays, true
}

// HasMinAdvanceBookingDays returns a boolean if a field has been set.
func (o *ConfigPostingAttributesType) HasMinAdvanceBookingDays() bool {
	if o != nil && !IsNil(o.MinAdvanceBookingDays) {
		return true
	}
...
// SetMinAdvanceBookingDays gets a reference to the given int32 and assigns it to the MinAdvanceBookingDays field.
func (o *ConfigPostingAttributesType) SetMinAdvanceBookingDays(v int32) {
	o.MinAdvanceBookingDays = &v
}

// GetCalculatedAllowance returns the CalculatedAllowance field value if set, zero value otherwise.
func (o *ConfigPostingAttributesType) GetCalculatedAllowance() float32 {
	if o == nil || IsNil(o.CalculatedAllowance) {
		var ret float32
		return ret
	}
	return *o.CalculatedAllowance
}

// GetCalculatedAllowanceOk returns a tuple with the CalculatedAllowance field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ConfigPostingAttributesType) GetCalculatedAllowanceOk() (*float32, bool) {
	if o == nil || IsNil(o.CalculatedAllowance) {
		return nil, false
	}
	return o.CalculatedAllowance, true
}

// HasCalculatedAllowance returns a boolean if a field has been set.
func (o *ConfigPostingAttributesType) HasCalculatedAllowance() bool {
	if o != nil && !IsNil(o.CalculatedAllowance) {
		return true
	}
...
// SetCalculatedAllowance gets a reference to the given float32 and assigns it to the CalculatedAllowance field.
func (o *ConfigPostingAttributesType) SetCalculatedAllowance(v float32) {
	o.CalculatedAllowance = &v
}
...
func (o ConfigPostingAttributesType) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.AgeBucketPricing) {
		toSerialize["ageBucketPricing"] = o.AgeBucketPricing
	}
	if !IsNil(o.MinAdvanceBookingDays) {
		toSerialize["minAdvanceBookingDays"] = o.MinAdvanceBookingDays
	}
	if !IsNil(o.CalculatedAllowance) {
		toSerialize["calculatedAllowance"] = o.CalculatedAllowance
	}
