...
type RatePlanType struct {
	...
	// Rate Code is available for Owner Reservations.
	OwnerUse *bool `json:"ownerUse,omitempty"`
	// Rate code is available for Owner Referral Reservations
	OwnerReferral *bool `json:"ownerReferral,omitempty"`
	...
	// Flag to identify if the rate plan code is eligible for rate discounting by redeeming points.
	PointsDiscount *bool `json:"pointsDiscount,omitempty"`
	...
	// Exposed rates managed through external systems outside the PMS.
	OffshoreRate *bool `json:"offshoreRate,omitempty"`
	// Rates managed and handled within the PMS by the property.
	LocalRatePlanCode *string `json:"localRatePlanCode,omitempty"`
	// Indicates whether this rate plan participates in Casino Control Segment restrictions. When true the rate is evaluated against the configured Control Segment and its rule GroupA or GroupB during availability and booking.
	CasinoComp *bool `json:"casinoComp,omitempty"`
	RestrictionGroup *RestrictionGroupType `json:"restrictionGroup,omitempty"`
}
...
// GetOwnerUse returns the OwnerUse field value if set, zero value otherwise.
func (o *RatePlanType) GetOwnerUse() bool {
	if o == nil || IsNil(o.OwnerUse) {
		var ret bool
		return ret
	}
	return *o.OwnerUse
...
// GetOwnerUseOk returns a tuple with the OwnerUse field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *RatePlanType) GetOwnerUseOk() (*bool, bool) {
	if o == nil || IsNil(o.OwnerUse) {
		return nil, false
	}
	return o.OwnerUse, true
}

// HasOwnerUse returns a boolean if a field has been set.
func (o *RatePlanType) HasOwnerUse() bool {
	if o != nil && !IsNil(o.OwnerUse) {
		return true
	}
...
// SetOwnerUse gets a reference to the given bool and assigns it to the OwnerUse field.
func (o *RatePlanType) SetOwnerUse(v bool) {
	o.OwnerUse = &v
}

// GetOwnerReferral returns the OwnerReferral field value if set, zero value otherwise.
func (o *RatePlanType) GetOwnerReferral() bool {
	if o == nil || IsNil(o.OwnerReferral) {
		var ret bool
		return ret
	}
	return *o.OwnerReferral
}

// GetOwnerReferralOk returns a tuple with the OwnerReferral field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *RatePlanType) GetOwnerReferralOk() (*bool, bool) {
	if o == nil || IsNil(o.OwnerReferral) {
		return nil, false
	}
	return o.OwnerReferral, true
}

// HasOwnerReferral returns a boolean if a field has been set.
func (o *RatePlanType) HasOwnerReferral() bool {
	if o != nil && !IsNil(o.OwnerReferral) {
		return true
	}
...
// SetOwnerReferral gets a reference to the given bool and assigns it to the OwnerReferral field.
func (o *RatePlanType) SetOwnerReferral(v bool) {
	o.OwnerReferral = &v
}
...
// GetPointsDiscount returns the PointsDiscount field value if set, zero value otherwise.
func (o *RatePlanType) GetPointsDiscount() bool {
	if o == nil || IsNil(o.PointsDiscount) {
		var ret bool
		return ret
	}
	return *o.PointsDiscount
}

// GetPointsDiscountOk returns a tuple with the PointsDiscount field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *RatePlanType) GetPointsDiscountOk() (*bool, bool) {
	if o == nil || IsNil(o.PointsDiscount) {
		return nil, false
	}
	return o.PointsDiscount, true
}

// HasPointsDiscount returns a boolean if a field has been set.
func (o *RatePlanType) HasPointsDiscount() bool {
	if o != nil && !IsNil(o.PointsDiscount) {
		return true
	}
...
// SetPointsDiscount gets a reference to the given bool and assigns it to the PointsDiscount field.
func (o *RatePlanType) SetPointsDiscount(v bool) {
	o.PointsDiscount = &v
}
...
// GetOffshoreRate returns the OffshoreRate field value if set, zero value otherwise.
func (o *RatePlanType) GetOffshoreRate() bool {
	if o == nil || IsNil(o.OffshoreRate) {
		var ret bool
		return ret
	}
	return *o.OffshoreRate
}

// GetOffshoreRateOk returns a tuple with the OffshoreRate field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *RatePlanType) GetOffshoreRateOk() (*bool, bool) {
	if o == nil || IsNil(o.OffshoreRate) {
		return nil, false
	}
	return o.OffshoreRate, true
}

// HasOffshoreRate returns a boolean if a field has been set.
func (o *RatePlanType) HasOffshoreRate() bool {
	if o != nil && !IsNil(o.OffshoreRate) {
		return true
	}
...
// SetOffshoreRate gets a reference to the given bool and assigns it to the OffshoreRate field.
func (o *RatePlanType) SetOffshoreRate(v bool) {
	o.OffshoreRate = &v
}

// GetLocalRatePlanCode returns the LocalRatePlanCode field value if set, zero value otherwise.
func (o *RatePlanType) GetLocalRatePlanCode() string {
	if o == nil || IsNil(o.LocalRatePlanCode) {
		var ret string
		return ret
	}
	return *o.LocalRatePlanCode
}

// GetLocalRatePlanCodeOk returns a tuple with the LocalRatePlanCode field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *RatePlanType) GetLocalRatePlanCodeOk() (*string, bool) {
	if o == nil || IsNil(o.LocalRatePlanCode) {
		return nil, false
	}
	return o.LocalRatePlanCode, true
}

// HasLocalRatePlanCode returns a boolean if a field has been set.
func (o *RatePlanType) HasLocalRatePlanCode() bool {
	if o != nil && !IsNil(o.LocalRatePlanCode) {
		return true
	}
...
// SetLocalRatePlanCode gets a reference to the given string and assigns it to the LocalRatePlanCode field.
func (o *RatePlanType) SetLocalRatePlanCode(v string) {
	o.LocalRatePlanCode = &v
}

// GetCasinoComp returns the CasinoComp field value if set, zero value otherwise.
func (o *RatePlanType) GetCasinoComp() bool {
	if o == nil || IsNil(o.CasinoComp) {
		var ret bool
		return ret
	}
	return *o.CasinoComp
...
// GetCasinoCompOk returns a tuple with the CasinoComp field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *RatePlanType) GetCasinoCompOk() (*bool, bool) {
	if o == nil || IsNil(o.CasinoComp) {
		return nil, false
	}
	return o.CasinoComp, true
}

// HasCasinoComp returns a boolean if a field has been set.
func (o *RatePlanType) HasCasinoComp() bool {
	if o != nil && !IsNil(o.CasinoComp) {
		return true
	}
...
// SetCasinoComp gets a reference to the given bool and assigns it to the CasinoComp field.
func (o *RatePlanType) SetCasinoComp(v bool) {
	o.CasinoComp = &v
}

// GetRestrictionGroup returns the RestrictionGroup field value if set, zero value otherwise.
func (o *RatePlanType) GetRestrictionGroup() RestrictionGroupType {
	if o == nil || IsNil(o.RestrictionGroup) {
		var ret RestrictionGroupType
		return ret
	}
	return *o.RestrictionGroup
}

// GetRestrictionGroupOk returns a tuple with the RestrictionGroup field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *RatePlanType) GetRestrictionGroupOk() (*RestrictionGroupType, bool) {
	if o == nil || IsNil(o.RestrictionGroup) {
		return nil, false
	}
	return o.RestrictionGroup, true
}

// HasRestrictionGroup returns a boolean if a field has been set.
func (o *RatePlanType) HasRestrictionGroup() bool {
	if o != nil && !IsNil(o.RestrictionGroup) {
		return true
	}
...
// SetRestrictionGroup gets a reference to the given RestrictionGroupType and assigns it to the RestrictionGroup field.
func (o *RatePlanType) SetRestrictionGroup(v RestrictionGroupType) {
	o.RestrictionGroup = &v
}
...
func (o RatePlanType) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.OwnerUse) {
		toSerialize["ownerUse"] = o.OwnerUse
	}
	if !IsNil(o.OwnerReferral) {
		toSerialize["ownerReferral"] = o.OwnerReferral
	}
	if !IsNil(o.MembershipEligible) {
		toSerialize["membershipEligible"] = o.MembershipEligible
	}
	if !IsNil(o.PointsDiscount) {
		toSerialize["pointsDiscount"] = o.PointsDiscount
	}
	...
	if !IsNil(o.OffshoreRate) {
		toSerialize["offshoreRate"] = o.OffshoreRate
	}
	if !IsNil(o.LocalRatePlanCode) {
		toSerialize["localRatePlanCode"] = o.LocalRatePlanCode
	}
	if !IsNil(o.CasinoComp) {
		toSerialize["casinoComp"] = o.CasinoComp
	}
	if !IsNil(o.RestrictionGroup) {
		toSerialize["restrictionGroup"] = o.RestrictionGroup
	}
