...
type PromotionCodeDetailsType struct {
	...
	// Indicates if promotion code is of limited use type. Limited use promotion codes can not be used without coupon codes.
	LimitedUse *bool `json:"limitedUse,omitempty"`
	// Indicates if template promotion code is of limited use type. Limited use promotion codes can not be used without coupon codes.
	LimitedUseGlobal *bool `json:"limitedUseGlobal,omitempty"`
}
...
// GetLimitedUse returns the LimitedUse field value if set, zero value otherwise.
func (o *PromotionCodeDetailsType) GetLimitedUse() bool {
	if o == nil || IsNil(o.LimitedUse) {
		var ret bool
		return ret
	}
	return *o.LimitedUse
...
// GetLimitedUseOk returns a tuple with the LimitedUse field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *PromotionCodeDetailsType) GetLimitedUseOk() (*bool, bool) {
	if o == nil || IsNil(o.LimitedUse) {
		return nil, false
	}
	return o.LimitedUse, true
}

// HasLimitedUse returns a boolean if a field has been set.
func (o *PromotionCodeDetailsType) HasLimitedUse() bool {
	if o != nil && !IsNil(o.LimitedUse) {
		return true
	}
...
// SetLimitedUse gets a reference to the given bool and assigns it to the LimitedUse field.
func (o *PromotionCodeDetailsType) SetLimitedUse(v bool) {
	o.LimitedUse = &v
}

// GetLimitedUseGlobal returns the LimitedUseGlobal field value if set, zero value otherwise.
func (o *PromotionCodeDetailsType) GetLimitedUseGlobal() bool {
	if o == nil || IsNil(o.LimitedUseGlobal) {
		var ret bool
		return ret
	}
	return *o.LimitedUseGlobal
}

// GetLimitedUseGlobalOk returns a tuple with the LimitedUseGlobal field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *PromotionCodeDetailsType) GetLimitedUseGlobalOk() (*bool, bool) {
	if o == nil || IsNil(o.LimitedUseGlobal) {
		return nil, false
	}
	return o.LimitedUseGlobal, true
}

// HasLimitedUseGlobal returns a boolean if a field has been set.
func (o *PromotionCodeDetailsType) HasLimitedUseGlobal() bool {
	if o != nil && !IsNil(o.LimitedUseGlobal) {
		return true
	}
...
// SetLimitedUseGlobal gets a reference to the given bool and assigns it to the LimitedUseGlobal field.
func (o *PromotionCodeDetailsType) SetLimitedUseGlobal(v bool) {
	o.LimitedUseGlobal = &v
}
...
func (o PromotionCodeDetailsType) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.LimitedUse) {
		toSerialize["limitedUse"] = o.LimitedUse
	}
	if !IsNil(o.LimitedUseGlobal) {
		toSerialize["limitedUseGlobal"] = o.LimitedUseGlobal
	}
