...
type RatePlanTransactionDetailsType struct {
	...
	RoomTransactionCodes []RatePlanRoomTransactionCodeType `json:"roomTransactionCodes,omitempty"`
	...
	AdvancedPostingRhythms []RatePlanAdvancedPostingRhythmType `json:"advancedPostingRhythms,omitempty"`
}
...
func (o *RatePlanTransactionDetailsType) GetRoomTransactionCodes() []RatePlanRoomTransactionCodeType {
	if o == nil || IsNil(o.RoomTransactionCodes) {
		var ret []RatePlanRoomTransactionCodeType
		return ret
	}
...
// SetRoomTransactionCodes gets a reference to the given []RatePlanRoomTransactionCodeType and assigns it to the RoomTransactionCodes field.
...
// SetAdvancedPostingRhythms gets a reference to the given []RatePlanAdvancedPostingRhythmType and assigns it to the AdvancedPostingRhythms field.
