...
type ConfigPackageTransactionType struct {
	...
	PackageAllowanceValidUntilEOD *bool `json:"packageAllowanceValidUntilEOD,omitempty"`
...
// GetPackageAllowanceValidUntilEOD returns the PackageAllowanceValidUntilEOD field value if set, zero value otherwise.
func (o *ConfigPackageTransactionType) GetPackageAllowanceValidUntilEOD() bool {
	if o == nil || IsNil(o.PackageAllowanceValidUntilEOD) {
		var ret bool
		return ret
	}
	return *o.PackageAllowanceValidUntilEOD
}

// GetPackageAllowanceValidUntilEODOk returns a tuple with the PackageAllowanceValidUntilEOD field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ConfigPackageTransactionType) GetPackageAllowanceValidUntilEODOk() (*bool, bool) {
	if o == nil || IsNil(o.PackageAllowanceValidUntilEOD) {
		return nil, false
	}
	return o.PackageAllowanceValidUntilEOD, true
}
...
// SetPackageAllowanceValidUntilEOD gets a reference to the given bool and assigns it to the PackageAllowanceValidUntilEOD field.
func (o *ConfigPackageTransactionType) SetPackageAllowanceValidUntilEOD(v bool) {
	o.PackageAllowanceValidUntilEOD = &v
}
...
func (o ConfigPackageTransactionType) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.PackageAllowanceValidUntilEOD) {
		toSerialize["packageAllowanceValidUntilEOD"] = o.PackageAllowanceValidUntilEOD
	}
	if !IsNil(o.Currency) {
