...
type MassRateChangeStatus struct {
	...
	StatusList []MassRateChangeStatusType `json:"statusList,omitempty"`
...
func (o *MassRateChangeStatus) GetStatusList() []MassRateChangeStatusType {
	if o == nil || IsNil(o.StatusList) {
		var ret []MassRateChangeStatusType
		return ret
	}
	return o.StatusList
}
...
// SetStatusList gets a reference to the given []MassRateChangeStatusType and assigns it to the StatusList field.
