...
func (o *ActivityConfigTypeDetailType) GetManagedBy() ManagedByOptions {
...
// and a boolean to check if the value has been set.
func (o *ActivityConfigTypeDetailType) GetManagedByOk() (*ManagedByOptions, bool) {
	if o == nil || IsNil(o.ManagedBy) {
		return nil, false
	}
...
func (o *ActivityConfigTypeDetailType) HasManagedBy() bool {
	if o != nil && !IsNil(o.ManagedBy) {
		return true
	}
...
func (o *ActivityConfigTypeDetailType) SetManagedBy(v ManagedByOptions) {
	o.ManagedBy = &v
}
