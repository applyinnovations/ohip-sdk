...
type AutoTraceDefinitionDetailType struct {
	...
	// Element to hold column name of relevant table on selection of Update in AutoTraceTriggerCategoryType.
	FieldNameOnUpdate *string `json:"fieldNameOnUpdate,omitempty"`
	// Element to hold column ID of relevant table on selection of Update in AutoTraceTriggerCategoryType.
