...
func (o *AutoTraceOwnerAssignmentType) GetManagedBy() ManagedByOptions {
...
// and a boolean to check if the value has been set.
func (o *AutoTraceOwnerAssignmentType) GetManagedByOk() (*ManagedByOptions, bool) {
	if o == nil || IsNil(o.ManagedBy) {
		return nil, false
	}
...
func (o *AutoTraceOwnerAssignmentType) HasManagedBy() bool {
	if o != nil && !IsNil(o.ManagedBy) {
		return true
	}
...
func (o *AutoTraceOwnerAssignmentType) SetManagedBy(v ManagedByOptions) {
	o.ManagedBy = &v
}
