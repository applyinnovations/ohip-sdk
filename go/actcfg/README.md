...
```golang
import actcfg "github.com/applyinnovations/ohip-sdk/go/actcfg/v3"
```
...
*ActivityManagementAPI* | [**PutUpsertAutoTraceDefinitions**](docs/ActivityManagementAPI.md#putupsertautotracedefinitions) | **Put** /upsert/hotels/{hotelId}/autoTraceDefinitions | Create/Change an Auto Trace definition Code
*ActivityManagementAPI* | [**PutUpsertAutoTraceOwnerAssignments**](docs/ActivityManagementAPI.md#putupsertautotraceownerassignments) | **Put** /upsert/hotels/{hotelId}/autoTraceOwnerAssignments | Create/Change Trace owner assignments
