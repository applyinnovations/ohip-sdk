...
// checks if the AutoTraceCodesDetails type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AutoTraceCodesDetails{}

// AutoTraceCodesDetails Response object to fetch Auto Trace Codes.
type AutoTraceCodesDetails struct {
...
func (o AutoTraceCodesDetails) MarshalJSON() ([]byte, error) {
...
func (o AutoTraceCodesDetails) ToMap() (map[string]interface{}, error) {
...
type NullableAutoTraceCodesDetails struct {
	value *AutoTraceCodesDetails
	isSet bool
}

func (v NullableAutoTraceCodesDetails) Get() *AutoTraceCodesDetails {
	return v.value
}

func (v *NullableAutoTraceCodesDetails) Set(val *AutoTraceCodesDetails) {
	v.value = val
	v.isSet = true
}

func (v NullableAutoTraceCodesDetails) IsSet() bool {
	return v.isSet
}

func (v *NullableAutoTraceCodesDetails) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAutoTraceCodesDetails(val *AutoTraceCodesDetails) *NullableAutoTraceCodesDetails {
	return &NullableAutoTraceCodesDetails{value: val, isSet: true}
}

func (v NullableAutoTraceCodesDetails) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAutoTraceCodesDetails) UnmarshalJSON(src []byte) error {
	v.isSet = true
