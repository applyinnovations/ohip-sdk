...
```golang
import par "github.com/applyinnovations/ohip-sdk/go/par/v3"
```
...
*AvailabilityAPI* | [**GetAvailabilityRatePlanInfoByMultipleRatePlans**](docs/AvailabilityAPI.md#getavailabilityrateplaninfobymultiplerateplans) | **Get** /hotels/{hotelId}/rates | Get the Rate Plan Information 
...
*AvailabilityAPI* | [**GetMultiPropHurdleRates**](docs/AvailabilityAPI.md#getmultiprophurdlerates) | **Get** /hurdles | Get multiple property Hurdle Rates
*AvailabilityAPI* | [**GetReservationGuarantees**](docs/AvailabilityAPI.md#getreservationguarantees) | **Get** /hotels/{hotelId}/guarantees | Get Reservation Guarantee 
*AvailabilityAPI* | [**GetRestrictionsByDateRange**](docs/AvailabilityAPI.md#getrestrictionsbydaterange) | **Get** /hotels/{hotelId}/restrictions | Get the Restrictions 
...
*AvailabilityAPI* | [**PingAvailabilityService**](docs/AvailabilityAPI.md#pingavailabilityservice) | **Get** /services/availability/status | Get the Availability Service version
...
*AvailabilityAPI* | [**PutUpsertHurdleRates**](docs/AvailabilityAPI.md#putupserthurdlerates) | **Put** /upsert/hotels/{hotelId}/hurdles | Create/Change Hurdle Rates
*AvailabilityAPI* | [**SearchAlternateAvailability**](docs/AvailabilityAPI.md#searchalternateavailability) | **Post** /hotels/{hotelId}/availability/alternate/searches | Get Alternate Availability
*AvailabilityAPI* | [**SearchAnalyzeRateAvailability**](docs/AvailabilityAPI.md#searchanalyzerateavailability) | **Post** /hotels/{hotelId}/analyzeRateAvailability/searches | Analyze Rate Availability 
*AvailabilityAPI* | [**SearchHotelAvailability**](docs/AvailabilityAPI.md#searchhotelavailability) | **Post** /hotels/{hotelId}/availability/searches | Get Hotel Availability
*AvailabilityAPI* | [**SearchHotelAvailabilityCRO**](docs/AvailabilityAPI.md#searchhotelavailabilitycro) | **Post** /availability/searches | Get Hotel Availability
...
*AvailabilityExternalAPI* | [**RetriveExternalControlSegment**](docs/AvailabilityExternalAPI.md#retriveexternalcontrolsegment) | **Post** /externalControlSegment | External Control Segment Lookup
...
## Documentation For Models
 ...
 - [ExternalControlSegmentCriteria](docs/ExternalControlSegmentCriteria.md)
 - [ExternalControlSegmentCriteriaType](docs/ExternalControlSegmentCriteriaType.md)
 - [ExternalControlSegmentDetails](docs/ExternalControlSegmentDetails.md)
 - [ExternalControlSegmentType](docs/ExternalControlSegmentType.md)
 ...
 - [OwnerProfileTypeEnum](docs/OwnerProfileTypeEnum.md)
 ...
 - [RatePostingIntervalEnum](docs/RatePostingIntervalEnum.md)
 ...
 - [ReservationProfileTypeEnum](docs/ReservationProfileTypeEnum.md)
 ...
 - [SearchAlternateAvailabilityRequest](docs/SearchAlternateAvailabilityRequest.md)
 - [SearchAnalyzeRateAvailabilityRequest](docs/SearchAnalyzeRateAvailabilityRequest.md)
 - [SearchHotelAvailabilityCRORequest](docs/SearchHotelAvailabilityCRORequest.md)
 - [SearchHotelAvailabilityRequest](docs/SearchHotelAvailabilityRequest.md)
