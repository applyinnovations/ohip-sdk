...
type HotelSummaryInfoType struct {
	...
	// The Maximum number of rooms in this hotel. This number includes the sell limits. Also the number of deduct rooms already sold and the number of Owner Exclusive Rooms(applicable when Ownership Records functionality is active).
	InventoryRooms *int32 `json:"inventoryRooms,omitempty"`
	// The Maximum number of rooms that can be sold in this hotel. This number excludes the number of Owner Exclusive Rooms(applicable when Ownership Records functionality is active). It includes the sell limits and Also the number of deduct rooms already sold.
	SellableRooms *int32 `json:"sellableRooms,omitempty"`
	// The total number of Owner Exclusive rooms in this hotel. This is only applicable Ownership Records functionality is active.
	OwnerExclusiveRooms *int32 `json:"ownerExclusiveRooms,omitempty"`
	// The number of rooms that are actually available in this hotel. This number includes the sell limits. It excludes the number of deduct rooms already sold and the number of Owner Exclusive rooms.
	AvailableRooms *int32 `json:"availableRooms,omitempty"`
	// The total number of physical rooms in a hotel.
	PhysicalRooms *int32 `json:"physicalRooms,omitempty"`
	// The official check in time of the Hotel. Uses the hotel's time zone.
	CheckInTime *string `json:"checkInTime,omitempty"`
	// The official check out time of the Hotel. Uses the hotel's time zone.
	...
	WebsiteAddress *string `json:"websiteAddress,omitempty"`
}
...
// GetSellableRooms returns the SellableRooms field value if set, zero value otherwise.
func (o *HotelSummaryInfoType) GetSellableRooms() int32 {
	if o == nil || IsNil(o.SellableRooms) {
		var ret int32
		return ret
	}
	return *o.SellableRooms
}

// GetSellableRoomsOk returns a tuple with the SellableRooms field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *HotelSummaryInfoType) GetSellableRoomsOk() (*int32, bool) {
	if o == nil || IsNil(o.SellableRooms) {
		return nil, false
	}
	return o.SellableRooms, true
}

// HasSellableRooms returns a boolean if a field has been set.
func (o *HotelSummaryInfoType) HasSellableRooms() bool {
	if o != nil && !IsNil(o.SellableRooms) {
		return true
	}
...
// SetSellableRooms gets a reference to the given int32 and assigns it to the SellableRooms field.
func (o *HotelSummaryInfoType) SetSellableRooms(v int32) {
	o.SellableRooms = &v
}

// GetOwnerExclusiveRooms returns the OwnerExclusiveRooms field value if set, zero value otherwise.
func (o *HotelSummaryInfoType) GetOwnerExclusiveRooms() int32 {
	if o == nil || IsNil(o.OwnerExclusiveRooms) {
		var ret int32
		return ret
	}
	return *o.OwnerExclusiveRooms
}

// GetOwnerExclusiveRoomsOk returns a tuple with the OwnerExclusiveRooms field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *HotelSummaryInfoType) GetOwnerExclusiveRoomsOk() (*int32, bool) {
	if o == nil || IsNil(o.OwnerExclusiveRooms) {
		return nil, false
	}
	return o.OwnerExclusiveRooms, true
}

// HasOwnerExclusiveRooms returns a boolean if a field has been set.
func (o *HotelSummaryInfoType) HasOwnerExclusiveRooms() bool {
	if o != nil && !IsNil(o.OwnerExclusiveRooms) {
		return true
	}
...
// SetOwnerExclusiveRooms gets a reference to the given int32 and assigns it to the OwnerExclusiveRooms field.
func (o *HotelSummaryInfoType) SetOwnerExclusiveRooms(v int32) {
	o.OwnerExclusiveRooms = &v
}
...
func (o *HotelSummaryInfoType) GetPhysicalRooms() int32 {
...
// and a boolean to check if the value has been set.
func (o *HotelSummaryInfoType) GetPhysicalRoomsOk() (*int32, bool) {
	if o == nil || IsNil(o.PhysicalRooms) {
		return nil, false
	}
...
func (o *HotelSummaryInfoType) HasPhysicalRooms() bool {
	if o != nil && !IsNil(o.PhysicalRooms) {
		return true
	}
...
// SetPhysicalRooms gets a reference to the given int32 and assigns it to the PhysicalRooms field.
func (o *HotelSummaryInfoType) SetPhysicalRooms(v int32) {
	o.PhysicalRooms = &v
}
...
// GetWebsiteAddress returns the WebsiteAddress field value if set, zero value otherwise.
func (o *HotelSummaryInfoType) GetWebsiteAddress() string {
	if o == nil || IsNil(o.WebsiteAddress) {
		var ret string
		return ret
	}
	return *o.WebsiteAddress
}

// GetWebsiteAddressOk returns a tuple with the WebsiteAddress field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *HotelSummaryInfoType) GetWebsiteAddressOk() (*string, bool) {
	if o == nil || IsNil(o.WebsiteAddress) {
		return nil, false
	}
	return o.WebsiteAddress, true
}
...
// SetWebsiteAddress gets a reference to the given string and assigns it to the WebsiteAddress field.
...
func (o HotelSummaryInfoType) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.SellableRooms) {
		toSerialize["sellableRooms"] = o.SellableRooms
	}
	if !IsNil(o.OwnerExclusiveRooms) {
		toSerialize["ownerExclusiveRooms"] = o.OwnerExclusiveRooms
	}
	...
	if !IsNil(o.WebsiteAddress) {
		toSerialize["websiteAddress"] = o.WebsiteAddress
	}
