...
func (o *RestrictionSetHistoryType) GetSeasonCode() string {
...
// and a boolean to check if the value has been set.
func (o *RestrictionSetHistoryType) GetSeasonCodeOk() (*string, bool) {
	if o == nil || IsNil(o.SeasonCode) {
		return nil, false
	}
...
func (o *RestrictionSetHistoryType) HasSeasonCode() bool {
	if o != nil && !IsNil(o.SeasonCode) {
		return true
	}
...
func (o *RestrictionSetHistoryType) SetSeasonCode(v string) {
	o.SeasonCode = &v
}
