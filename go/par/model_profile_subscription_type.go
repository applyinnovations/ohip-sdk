...
type ProfileSubscriptionType struct {
	...
	// Timestamp when the profile was subscribed to. Uses database time zone.
	SubscriptionDate *string `json:"subscriptionDate,omitempty"`
	// Timestamp of the most recent distribution of this profile to the external system. Uses database time zone.
	LastDistributionDate *string `json:"lastDistributionDate,omitempty"`
	// Timestamp of the most recent update of the subscription information by the external system. Uses database time zone.
