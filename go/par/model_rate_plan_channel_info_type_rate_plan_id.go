...
// checks if the RatePlanChannelInfoTypeRatePlanId type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RatePlanChannelInfoTypeRatePlanId{}

// RatePlanChannelInfoTypeRatePlanId An identifier used to uniquely reference an object in a system (e.g. an airline reservation reference, customer profile reference, booking confirmation number, or a reference to a previous availability quote).
type RatePlanChannelInfoTypeRatePlanId struct {
...
func NewRatePlanChannelInfoTypeRatePlanId() *RatePlanChannelInfoTypeRatePlanId {
	this := RatePlanChannelInfoTypeRatePlanId{}
	return &this
}
...
func (o RatePlanChannelInfoTypeRatePlanId) MarshalJSON() ([]byte, error) {
...
func (o RatePlanChannelInfoTypeRatePlanId) ToMap() (map[string]interface{}, error) {
...
type NullableRatePlanChannelInfoTypeRatePlanId struct {
	value *RatePlanChannelInfoTypeRatePlanId
	isSet bool
}

func (v NullableRatePlanChannelInfoTypeRatePlanId) Get() *RatePlanChannelInfoTypeRatePlanId {
	return v.value
}

func (v *NullableRatePlanChannelInfoTypeRatePlanId) Set(val *RatePlanChannelInfoTypeRatePlanId) {
	v.value = val
	v.isSet = true
}

func (v NullableRatePlanChannelInfoTypeRatePlanId) IsSet() bool {
	return v.isSet
}

func (v *NullableRatePlanChannelInfoTypeRatePlanId) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRatePlanChannelInfoTypeRatePlanId(val *RatePlanChannelInfoTypeRatePlanId) *NullableRatePlanChannelInfoTypeRatePlanId {
	return &NullableRatePlanChannelInfoTypeRatePlanId{value: val, isSet: true}
}

func (v NullableRatePlanChannelInfoTypeRatePlanId) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRatePlanChannelInfoTypeRatePlanId) UnmarshalJSON(src []byte) error {
	v.isSet = true
