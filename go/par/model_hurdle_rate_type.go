...
type HurdleRateType struct {
	...
	HurdleRangeStart *string `json:"hurdleRangeStart,omitempty"`
	// Hurdle date end range to which the hurdle rate is scheduled.
	HurdleRangeEnd *string `json:"hurdleRangeEnd,omitempty"`
...
// GetHurdleRangeStart returns the HurdleRangeStart field value if set, zero value otherwise.
func (o *HurdleRateType) GetHurdleRangeStart() string {
	if o == nil || IsNil(o.HurdleRangeStart) {
		var ret string
		return ret
	}
	return *o.HurdleRangeStart
}

// GetHurdleRangeStartOk returns a tuple with the HurdleRangeStart field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *HurdleRateType) GetHurdleRangeStartOk() (*string, bool) {
	if o == nil || IsNil(o.HurdleRangeStart) {
		return nil, false
	}
	return o.HurdleRangeStart, true
}
...
// SetHurdleRangeStart gets a reference to the given string and assigns it to the HurdleRangeStart field.
func (o *HurdleRateType) SetHurdleRangeStart(v string) {
	o.HurdleRangeStart = &v
}

// GetHurdleRangeEnd returns the HurdleRangeEnd field value if set, zero value otherwise.
func (o *HurdleRateType) GetHurdleRangeEnd() string {
	if o == nil || IsNil(o.HurdleRangeEnd) {
		var ret string
		return ret
	}
	return *o.HurdleRangeEnd
}

// GetHurdleRangeEndOk returns a tuple with the HurdleRangeEnd field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *HurdleRateType) GetHurdleRangeEndOk() (*string, bool) {
	if o == nil || IsNil(o.HurdleRangeEnd) {
		return nil, false
	}
	return o.HurdleRangeEnd, true
}
...
// SetHurdleRangeEnd gets a reference to the given string and assigns it to the HurdleRangeEnd field.
...
func (o *HurdleRateType) GetManagedBy() ManagedByOptions {
...
// and a boolean to check if the value has been set.
func (o *HurdleRateType) GetManagedByOk() (*ManagedByOptions, bool) {
	if o == nil || IsNil(o.ManagedBy) {
		return nil, false
	}
...
func (o *HurdleRateType) HasManagedBy() bool {
	if o != nil && !IsNil(o.ManagedBy) {
		return true
	}
...
func (o *HurdleRateType) SetManagedBy(v ManagedByOptions) {
	o.ManagedBy = &v
}
...
func (o HurdleRateType) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.HurdleRangeStart) {
		toSerialize["hurdleRangeStart"] = o.HurdleRangeStart
	}
	if !IsNil(o.HurdleRangeEnd) {
		toSerialize["hurdleRangeEnd"] = o.HurdleRangeEnd
	}
