...
type AvailRatePlanInfoTypeRatePlanInner struct {
	...
	// Specifies the frequency at which charges are posted for this rate plan.
...
func (o *AvailRatePlanInfoTypeRatePlanInner) GetPostingInterval() string {
...
// and a boolean to check if the value has been set.
func (o *AvailRatePlanInfoTypeRatePlanInner) GetPostingIntervalOk() (*string, bool) {
	if o == nil || IsNil(o.PostingInterval) {
		return nil, false
	}
...
func (o *AvailRatePlanInfoTypeRatePlanInner) HasPostingInterval() bool {
	if o != nil && !IsNil(o.PostingInterval) {
		return true
	}
...
func (o *AvailRatePlanInfoTypeRatePlanInner) SetPostingInterval(v string) {
	o.PostingInterval = &v
}
