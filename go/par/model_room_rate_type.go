...
type RoomRateType struct {
	...
	GuaranteedYn *string `json:"guaranteedYn,omitempty"`
	...
	// If true, indicates that rate code is Offshore Rate.
...
// GetGuaranteedYn returns the GuaranteedYn field value if set, zero value otherwise.
func (o *RoomRateType) GetGuaranteedYn() string {
	if o == nil || IsNil(o.GuaranteedYn) {
		var ret string
		return ret
	}
	return *o.GuaranteedYn
}

// GetGuaranteedYnOk returns a tuple with the GuaranteedYn field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *RoomRateType) GetGuaranteedYnOk() (*string, bool) {
	if o == nil || IsNil(o.GuaranteedYn) {
		return nil, false
	}
	return o.GuaranteedYn, true
}
...
// SetGuaranteedYn gets a reference to the given string and assigns it to the GuaranteedYn field.
...
func (o *RoomRateType) GetOffshoreRate() bool {
...
// and a boolean to check if the value has been set.
func (o *RoomRateType) GetOffshoreRateOk() (*bool, bool) {
	if o == nil || IsNil(o.OffshoreRate) {
		return nil, false
	}
...
func (o *RoomRateType) HasOffshoreRate() bool {
	if o != nil && !IsNil(o.OffshoreRate) {
		return true
	}
...
func (o *RoomRateType) SetOffshoreRate(v bool) {
	o.OffshoreRate = &v
}
...
func (o RoomRateType) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.GuaranteedYn) {
		toSerialize["guaranteedYn"] = o.GuaranteedYn
	}
