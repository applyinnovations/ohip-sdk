...
// checks if the CorporateDepartmentCodeType type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CorporateDepartmentCodeType{}

// CorporateDepartmentCodeType Contains Common Master configuration detail.
type CorporateDepartmentCodeType struct {
...
func NewCorporateDepartmentCodeType() *CorporateDepartmentCodeType {
	this := CorporateDepartmentCodeType{}
	return &this
}
...
func (o CorporateDepartmentCodeType) MarshalJSON() ([]byte, error) {
...
func (o CorporateDepartmentCodeType) ToMap() (map[string]interface{}, error) {
...
type NullableCorporateDepartmentCodeType struct {
	value *CorporateDepartmentCodeType
	isSet bool
}

func (v NullableCorporateDepartmentCodeType) Get() *CorporateDepartmentCodeType {
	return v.value
}

func (v *NullableCorporateDepartmentCodeType) Set(val *CorporateDepartmentCodeType) {
	v.value = val
	v.isSet = true
}

func (v NullableCorporateDepartmentCodeType) IsSet() bool {
	return v.isSet
}

func (v *NullableCorporateDepartmentCodeType) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCorporateDepartmentCodeType(val *CorporateDepartmentCodeType) *NullableCorporateDepartmentCodeType {
	return &NullableCorporateDepartmentCodeType{value: val, isSet: true}
}

func (v NullableCorporateDepartmentCodeType) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCorporateDepartmentCodeType) UnmarshalJSON(src []byte) error {
	v.isSet = true
