...
func (o *NoteTypesToBeChanged) GetHotelId() string {
...
// and a boolean to check if the value has been set.
func (o *NoteTypesToBeChanged) GetHotelIdOk() (*string, bool) {
	if o == nil || IsNil(o.HotelId) {
		return nil, false
	}
...
func (o *NoteTypesToBeChanged) HasHotelId() bool {
	if o != nil && !IsNil(o.HotelId) {
		return true
	}
...
func (o *NoteTypesToBeChanged) SetHotelId(v string) {
	o.HotelId = &v
}
