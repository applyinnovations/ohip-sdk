...
// checks if the UserDefinedFieldValueType type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UserDefinedFieldValueType{}

// UserDefinedFieldValueType Contains Common Master configuration detail.
type UserDefinedFieldValueType struct {
...
func NewUserDefinedFieldValueType() *UserDefinedFieldValueType {
	this := UserDefinedFieldValueType{}
	return &this
}
...
func (o *UserDefinedFieldValueType) GetManagedBy() ManagedByOptions {
...
// and a boolean to check if the value has been set.
func (o *UserDefinedFieldValueType) GetManagedByOk() (*ManagedByOptions, bool) {
	if o == nil || IsNil(o.ManagedBy) {
		return nil, false
	}
...
func (o *UserDefinedFieldValueType) HasManagedBy() bool {
	if o != nil && !IsNil(o.ManagedBy) {
		return true
	}
...
func (o *UserDefinedFieldValueType) SetManagedBy(v ManagedByOptions) {
	o.ManagedBy = &v
}

func (o UserDefinedFieldValueType) MarshalJSON() ([]byte, error) {
...
func (o UserDefinedFieldValueType) ToMap() (map[string]interface{}, error) {
...
type NullableUserDefinedFieldValueType struct {
	value *UserDefinedFieldValueType
	isSet bool
}

func (v NullableUserDefinedFieldValueType) Get() *UserDefinedFieldValueType {
	return v.value
}

func (v *NullableUserDefinedFieldValueType) Set(val *UserDefinedFieldValueType) {
	v.value = val
	v.isSet = true
}

func (v NullableUserDefinedFieldValueType) IsSet() bool {
	return v.isSet
}

func (v *NullableUserDefinedFieldValueType) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUserDefinedFieldValueType(val *UserDefinedFieldValueType) *NullableUserDefinedFieldValueType {
	return &NullableUserDefinedFieldValueType{value: val, isSet: true}
}

func (v NullableUserDefinedFieldValueType) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUserDefinedFieldValueType) UnmarshalJSON(src []byte) error {
	v.isSet = true
