...
func (o *TelephoneCategoryType) GetManagedBy() ManagedByOptions {
...
// and a boolean to check if the value has been set.
func (o *TelephoneCategoryType) GetManagedByOk() (*ManagedByOptions, bool) {
	if o == nil || IsNil(o.ManagedBy) {
		return nil, false
	}
...
func (o *TelephoneCategoryType) HasManagedBy() bool {
	if o != nil && !IsNil(o.ManagedBy) {
		return true
	}
...
func (o *TelephoneCategoryType) SetManagedBy(v ManagedByOptions) {
	o.ManagedBy = &v
}
