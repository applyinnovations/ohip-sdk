...
func (o *TemplateMarketingCityConfigType) GetManagedBy() ManagedByOptions {
...
// and a boolean to check if the value has been set.
func (o *TemplateMarketingCityConfigType) GetManagedByOk() (*ManagedByOptions, bool) {
	if o == nil || IsNil(o.ManagedBy) {
		return nil, false
	}
...
func (o *TemplateMarketingCityConfigType) HasManagedBy() bool {
	if o != nil && !IsNil(o.ManagedBy) {
		return true
	}
...
func (o *TemplateMarketingCityConfigType) SetManagedBy(v ManagedByOptions) {
	o.ManagedBy = &v
}
