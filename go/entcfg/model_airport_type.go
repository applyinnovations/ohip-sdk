...
func (o *AirportType) GetManagedBy() ManagedByOptions {
...
// and a boolean to check if the value has been set.
func (o *AirportType) GetManagedByOk() (*ManagedByOptions, bool) {
	if o == nil || IsNil(o.ManagedBy) {
		return nil, false
	}
...
func (o *AirportType) HasManagedBy() bool {
	if o != nil && !IsNil(o.ManagedBy) {
		return true
	}
...
func (o *AirportType) SetManagedBy(v ManagedByOptions) {
	o.ManagedBy = &v
}
