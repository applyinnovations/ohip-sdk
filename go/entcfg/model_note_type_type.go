...
func (o *NoteTypeType) GetManagedBy() ManagedByOptions {
...
// and a boolean to check if the value has been set.
func (o *NoteTypeType) GetManagedByOk() (*ManagedByOptions, bool) {
	if o == nil || IsNil(o.ManagedBy) {
		return nil, false
	}
...
func (o *NoteTypeType) HasManagedBy() bool {
	if o != nil && !IsNil(o.ManagedBy) {
		return true
	}
...
func (o *NoteTypeType) SetManagedBy(v ManagedByOptions) {
	o.ManagedBy = &v
}
