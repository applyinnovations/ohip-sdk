...
func (o *TemplateDayTypeCodeType) GetManagedBy() ManagedByOptions {
...
// and a boolean to check if the value has been set.
func (o *TemplateDayTypeCodeType) GetManagedByOk() (*ManagedByOptions, bool) {
	if o == nil || IsNil(o.ManagedBy) {
		return nil, false
	}
...
func (o *TemplateDayTypeCodeType) HasManagedBy() bool {
	if o != nil && !IsNil(o.ManagedBy) {
		return true
	}
...
func (o *TemplateDayTypeCodeType) SetManagedBy(v ManagedByOptions) {
	o.ManagedBy = &v
}
