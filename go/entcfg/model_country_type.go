...
func (o *CountryType) GetIso3Code() string {
...
// and a boolean to check if the value has been set.
func (o *CountryType) GetIso3CodeOk() (*string, bool) {
	if o == nil || IsNil(o.Iso3Code) {
		return nil, false
	}
...
func (o *CountryType) HasIso3Code() bool {
	if o != nil && !IsNil(o.Iso3Code) {
		return true
	}
...
func (o *CountryType) SetIso3Code(v string) {
	o.Iso3Code = &v
}
