...
func (o *ConfigHotelAmenityType) GetManagedBy() ManagedByOptions {
...
// and a boolean to check if the value has been set.
func (o *ConfigHotelAmenityType) GetManagedByOk() (*ManagedByOptions, bool) {
	if o == nil || IsNil(o.ManagedBy) {
		return nil, false
	}
...
func (o *ConfigHotelAmenityType) HasManagedBy() bool {
	if o != nil && !IsNil(o.ManagedBy) {
		return true
	}
...
func (o *ConfigHotelAmenityType) SetManagedBy(v ManagedByOptions) {
	o.ManagedBy = &v
}
