...
func (o *TemplateJobTitleType) GetManagedBy() ManagedByOptions {
...
// and a boolean to check if the value has been set.
func (o *TemplateJobTitleType) GetManagedByOk() (*ManagedByOptions, bool) {
	if o == nil || IsNil(o.ManagedBy) {
		return nil, false
	}
...
func (o *TemplateJobTitleType) HasManagedBy() bool {
	if o != nil && !IsNil(o.ManagedBy) {
		return true
	}
...
func (o *TemplateJobTitleType) SetManagedBy(v ManagedByOptions) {
	o.ManagedBy = &v
}
