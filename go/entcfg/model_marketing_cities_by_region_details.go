...
// checks if the MarketingCitiesByRegionDetails type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MarketingCitiesByRegionDetails{}

// MarketingCitiesByRegionDetails struct for MarketingCitiesByRegionDetails
type MarketingCitiesByRegionDetails struct {
	// List of Regions.
	MarketingCities []RegionType `json:"marketingCities,omitempty"`
...
func NewMarketingCitiesByRegionDetails() *MarketingCitiesByRegionDetails {
	this := MarketingCitiesByRegionDetails{}
	return &this
}
...
// SetMarketingCities gets a reference to the given []RegionType and assigns it to the MarketingCities field.
...
func (o MarketingCitiesByRegionDetails) MarshalJSON() ([]byte, error) {
...
func (o MarketingCitiesByRegionDetails) ToMap() (map[string]interface{}, error) {
...
type NullableMarketingCitiesByRegionDetails struct {
	value *MarketingCitiesByRegionDetails
	isSet bool
}

func (v NullableMarketingCitiesByRegionDetails) Get() *MarketingCitiesByRegionDetails {
	return v.value
}

func (v *NullableMarketingCitiesByRegionDetails) Set(val *MarketingCitiesByRegionDetails) {
	v.value = val
	v.isSet = true
}

func (v NullableMarketingCitiesByRegionDetails) IsSet() bool {
	return v.isSet
}

func (v *NullableMarketingCitiesByRegionDetails) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMarketingCitiesByRegionDetails(val *MarketingCitiesByRegionDetails) *NullableMarketingCitiesByRegionDetails {
	return &NullableMarketingCitiesByRegionDetails{value: val, isSet: true}
}

func (v NullableMarketingCitiesByRegionDetails) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMarketingCitiesByRegionDetails) UnmarshalJSON(src []byte) error {
	v.isSet = true
