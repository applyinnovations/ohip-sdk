...
type CopyHotelDetailsType struct {
	...
	TemplateHotelDetails []TemplateHotelDetailIDType `json:"templateHotelDetails,omitempty"`
}
...
func (o *CopyHotelDetailsType) GetTemplateHotelDetails() []TemplateHotelDetailIDType {
	if o == nil || IsNil(o.TemplateHotelDetails) {
		var ret []TemplateHotelDetailIDType
		return ret
	}
...
// SetTemplateHotelDetails gets a reference to the given []TemplateHotelDetailIDType and assigns it to the TemplateHotelDetails field.
