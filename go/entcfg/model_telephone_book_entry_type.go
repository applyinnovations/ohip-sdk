...
func (o *TelephoneBookEntryType) GetManagedBy() ManagedByOptions {
...
// and a boolean to check if the value has been set.
func (o *TelephoneBookEntryType) GetManagedByOk() (*ManagedByOptions, bool) {
	if o == nil || IsNil(o.ManagedBy) {
		return nil, false
	}
...
func (o *TelephoneBookEntryType) HasManagedBy() bool {
	if o != nil && !IsNil(o.ManagedBy) {
		return true
	}
...
func (o *TelephoneBookEntryType) SetManagedBy(v ManagedByOptions) {
	o.ManagedBy = &v
}
