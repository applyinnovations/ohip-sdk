...
func (o *JobTitleType) GetManagedBy() ManagedByOptions {
...
// and a boolean to check if the value has been set.
func (o *JobTitleType) GetManagedByOk() (*ManagedByOptions, bool) {
	if o == nil || IsNil(o.ManagedBy) {
		return nil, false
	}
...
func (o *JobTitleType) HasManagedBy() bool {
	if o != nil && !IsNil(o.ManagedBy) {
		return true
	}
...
func (o *JobTitleType) SetManagedBy(v ManagedByOptions) {
	o.ManagedBy = &v
}
