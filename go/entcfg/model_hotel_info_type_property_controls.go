...
type HotelInfoTypePropertyControls struct {
	...
	// Indicates if the configurations are enabled for the property.
	EnablePropertyConfigurations *bool `json:"enablePropertyConfigurations,omitempty"`
	// Indicates if the property has centra license.
	IsCentralResort *bool `json:"isCentralResort,omitempty"`
}
...
// GetEnablePropertyConfigurations returns the EnablePropertyConfigurations field value if set, zero value otherwise.
func (o *HotelInfoTypePropertyControls) GetEnablePropertyConfigurations() bool {
	if o == nil || IsNil(o.EnablePropertyConfigurations) {
		var ret bool
		return ret
	}
	return *o.EnablePropertyConfigurations
}

// GetEnablePropertyConfigurationsOk returns a tuple with the EnablePropertyConfigurations field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *HotelInfoTypePropertyControls) GetEnablePropertyConfigurationsOk() (*bool, bool) {
	if o == nil || IsNil(o.EnablePropertyConfigurations) {
		return nil, false
	}
	return o.EnablePropertyConfigurations, true
}

// HasEnablePropertyConfigurations returns a boolean if a field has been set.
func (o *HotelInfoTypePropertyControls) HasEnablePropertyConfigurations() bool {
	if o != nil && !IsNil(o.EnablePropertyConfigurations) {
		return true
	}
...
// SetEnablePropertyConfigurations gets a reference to the given bool and assigns it to the EnablePropertyConfigurations field.
func (o *HotelInfoTypePropertyControls) SetEnablePropertyConfigurations(v bool) {
	o.EnablePropertyConfigurations = &v
}

// GetIsCentralResort returns the IsCentralResort field value if set, zero value otherwise.
func (o *HotelInfoTypePropertyControls) GetIsCentralResort() bool {
	if o == nil || IsNil(o.IsCentralResort) {
		var ret bool
		return ret
	}
	return *o.IsCentralResort
}

// GetIsCentralResortOk returns a tuple with the IsCentralResort field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *HotelInfoTypePropertyControls) GetIsCentralResortOk() (*bool, bool) {
	if o == nil || IsNil(o.IsCentralResort) {
		return nil, false
	}
	return o.IsCentralResort, true
}

// HasIsCentralResort returns a boolean if a field has been set.
func (o *HotelInfoTypePropertyControls) HasIsCentralResort() bool {
	if o != nil && !IsNil(o.IsCentralResort) {
		return true
	}
...
// SetIsCentralResort gets a reference to the given bool and assigns it to the IsCentralResort field.
func (o *HotelInfoTypePropertyControls) SetIsCentralResort(v bool) {
	o.IsCentralResort = &v
}
...
func (o HotelInfoTypePropertyControls) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.EnablePropertyConfigurations) {
		toSerialize["enablePropertyConfigurations"] = o.EnablePropertyConfigurations
	}
	if !IsNil(o.IsCentralResort) {
		toSerialize["isCentralResort"] = o.IsCentralResort
	}
