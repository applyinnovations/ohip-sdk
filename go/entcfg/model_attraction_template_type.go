...
// checks if the AttractionTemplateType type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AttractionTemplateType{}

// AttractionTemplateType Information about the attractions near the hotel.
type AttractionTemplateType struct {
...
func (o *AttractionTemplateType) GetManagedBy() ManagedByOptions {
...
// and a boolean to check if the value has been set.
func (o *AttractionTemplateType) GetManagedByOk() (*ManagedByOptions, bool) {
	if o == nil || IsNil(o.ManagedBy) {
		return nil, false
	}
...
func (o *AttractionTemplateType) HasManagedBy() bool {
	if o != nil && !IsNil(o.ManagedBy) {
		return true
	}
...
func (o *AttractionTemplateType) SetManagedBy(v ManagedByOptions) {
	o.ManagedBy = &v
}

func (o AttractionTemplateType) MarshalJSON() ([]byte, error) {
...
func (o AttractionTemplateType) ToMap() (map[string]interface{}, error) {
...
type NullableAttractionTemplateType struct {
	value *AttractionTemplateType
	isSet bool
}

func (v NullableAttractionTemplateType) Get() *AttractionTemplateType {
	return v.value
}

func (v *NullableAttractionTemplateType) Set(val *AttractionTemplateType) {
	v.value = val
	v.isSet = true
}

func (v NullableAttractionTemplateType) IsSet() bool {
	return v.isSet
}

func (v *NullableAttractionTemplateType) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAttractionTemplateType(val *AttractionTemplateType) *NullableAttractionTemplateType {
	return &NullableAttractionTemplateType{value: val, isSet: true}
}

func (v NullableAttractionTemplateType) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAttractionTemplateType) UnmarshalJSON(src []byte) error {
	v.isSet = true
