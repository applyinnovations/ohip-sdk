...
// checks if the MarketingCitiesToBeChanged type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MarketingCitiesToBeChanged{}

// MarketingCitiesToBeChanged Request object for modifying marketing cities for hotels.
type MarketingCitiesToBeChanged struct {
...
func NewMarketingCitiesToBeChanged() *MarketingCitiesToBeChanged {
	this := MarketingCitiesToBeChanged{}
	return &this
}
...
func (o MarketingCitiesToBeChanged) MarshalJSON() ([]byte, error) {
...
func (o MarketingCitiesToBeChanged) ToMap() (map[string]interface{}, error) {
...
type NullableMarketingCitiesToBeChanged struct {
	value *MarketingCitiesToBeChanged
	isSet bool
}

func (v NullableMarketingCitiesToBeChanged) Get() *MarketingCitiesToBeChanged {
	return v.value
}

func (v *NullableMarketingCitiesToBeChanged) Set(val *MarketingCitiesToBeChanged) {
	v.value = val
	v.isSet = true
}

func (v NullableMarketingCitiesToBeChanged) IsSet() bool {
	return v.isSet
}

func (v *NullableMarketingCitiesToBeChanged) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMarketingCitiesToBeChanged(val *MarketingCitiesToBeChanged) *NullableMarketingCitiesToBeChanged {
	return &NullableMarketingCitiesToBeChanged{value: val, isSet: true}
}

func (v NullableMarketingCitiesToBeChanged) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMarketingCitiesToBeChanged) UnmarshalJSON(src []byte) error {
	v.isSet = true
