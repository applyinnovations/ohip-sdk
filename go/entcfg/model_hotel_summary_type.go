...
func (o *HotelSummaryType) GetBrandCode() string {
...
// and a boolean to check if the value has been set.
func (o *HotelSummaryType) GetBrandCodeOk() (*string, bool) {
	if o == nil || IsNil(o.BrandCode) {
		return nil, false
	}
...
func (o *HotelSummaryType) HasBrandCode() bool {
	if o != nil && !IsNil(o.BrandCode) {
		return true
	}
...
func (o *HotelSummaryType) SetBrandCode(v string) {
	o.BrandCode = &v
}
