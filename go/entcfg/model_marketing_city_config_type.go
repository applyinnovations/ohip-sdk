...
func (o *MarketingCityConfigType) GetManagedBy() ManagedByOptions {
...
// and a boolean to check if the value has been set.
func (o *MarketingCityConfigType) GetManagedByOk() (*ManagedByOptions, bool) {
	if o == nil || IsNil(o.ManagedBy) {
		return nil, false
	}
...
func (o *MarketingCityConfigType) HasManagedBy() bool {
	if o != nil && !IsNil(o.ManagedBy) {
		return true
	}
...
func (o *MarketingCityConfigType) SetManagedBy(v ManagedByOptions) {
	o.ManagedBy = &v
}
