...
func (o *UserDefinedFieldGroupType) GetManagedBy() ManagedByOptions {
...
// and a boolean to check if the value has been set.
func (o *UserDefinedFieldGroupType) GetManagedByOk() (*ManagedByOptions, bool) {
	if o == nil || IsNil(o.ManagedBy) {
		return nil, false
	}
...
func (o *UserDefinedFieldGroupType) HasManagedBy() bool {
	if o != nil && !IsNil(o.ManagedBy) {
		return true
	}
...
func (o *UserDefinedFieldGroupType) SetManagedBy(v ManagedByOptions) {
	o.ManagedBy = &v
}
