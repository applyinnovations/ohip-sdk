...
func (o *ConfigTemplateAmenityType) GetManagedBy() ManagedByOptions {
...
// and a boolean to check if the value has been set.
func (o *ConfigTemplateAmenityType) GetManagedByOk() (*ManagedByOptions, bool) {
	if o == nil || IsNil(o.ManagedBy) {
		return nil, false
	}
...
func (o *ConfigTemplateAmenityType) HasManagedBy() bool {
	if o != nil && !IsNil(o.ManagedBy) {
		return true
	}
...
func (o *ConfigTemplateAmenityType) SetManagedBy(v ManagedByOptions) {
	o.ManagedBy = &v
}
