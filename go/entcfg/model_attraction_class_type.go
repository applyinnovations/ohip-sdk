...
// checks if the AttractionClassType type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AttractionClassType{}

// AttractionClassType Contains Common Master configuration detail.
type AttractionClassType struct {
...
func (o AttractionClassType) MarshalJSON() ([]byte, error) {
...
func (o AttractionClassType) ToMap() (map[string]interface{}, error) {
...
type NullableAttractionClassType struct {
	value *AttractionClassType
	isSet bool
}

func (v NullableAttractionClassType) Get() *AttractionClassType {
	return v.value
}

func (v *NullableAttractionClassType) Set(val *AttractionClassType) {
	v.value = val
	v.isSet = true
}

func (v NullableAttractionClassType) IsSet() bool {
	return v.isSet
}

func (v *NullableAttractionClassType) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAttractionClassType(val *AttractionClassType) *NullableAttractionClassType {
	return &NullableAttractionClassType{value: val, isSet: true}
}

func (v NullableAttractionClassType) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAttractionClassType) UnmarshalJSON(src []byte) error {
	v.isSet = true
