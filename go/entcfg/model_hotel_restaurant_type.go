...
type HotelRestaurantType struct {
	...
	// This flag will determine wheather the establishment is type of onsite or offsite.
	OnSite *bool `json:"onSite,omitempty"`
	// This field stores the establishment's website.
...
// GetOnSite returns the OnSite field value if set, zero value otherwise.
func (o *HotelRestaurantType) GetOnSite() bool {
	if o == nil || IsNil(o.OnSite) {
		var ret bool
		return ret
	}
	return *o.OnSite
...
// and a boolean to check if the value has been set.
func (o *HotelRestaurantType) GetOnSiteOk() (*bool, bool) {
	if o == nil || IsNil(o.OnSite) {
		return nil, false
	}
	return o.OnSite, true
}

// HasOnSite returns a boolean if a field has been set.
func (o *HotelRestaurantType) HasOnSite() bool {
	if o != nil && !IsNil(o.OnSite) {
		return true
	}
...
// SetOnSite gets a reference to the given bool and assigns it to the OnSite field.
func (o *HotelRestaurantType) SetOnSite(v bool) {
	o.OnSite = &v
}

// GetWebsite returns the Website field value if set, zero value otherwise.
func (o *HotelRestaurantType) GetWebsite() string {
...
// and a boolean to check if the value has been set.
func (o *HotelRestaurantType) GetWebsiteOk() (*string, bool) {
	if o == nil || IsNil(o.Website) {
		return nil, false
	}
...
func (o *HotelRestaurantType) HasWebsite() bool {
	if o != nil && !IsNil(o.Website) {
		return true
	}
...
func (o *HotelRestaurantType) SetWebsite(v string) {
	o.Website = &v
}
