...
func (o *YieldAdjustmentCodeType) GetManagedBy() ManagedByOptions {
...
// and a boolean to check if the value has been set.
func (o *YieldAdjustmentCodeType) GetManagedByOk() (*ManagedByOptions, bool) {
	if o == nil || IsNil(o.ManagedBy) {
		return nil, false
	}
...
func (o *YieldAdjustmentCodeType) HasManagedBy() bool {
	if o != nil && !IsNil(o.ManagedBy) {
		return true
	}
...
func (o *YieldAdjustmentCodeType) SetManagedBy(v ManagedByOptions) {
	o.ManagedBy = &v
}
