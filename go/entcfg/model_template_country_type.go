...
type TemplateCountryType struct {
	...
	// ISO standard 3 letter code for country.
...
func (o *TemplateCountryType) GetIso3Code() string {
...
// and a boolean to check if the value has been set.
func (o *TemplateCountryType) GetIso3CodeOk() (*string, bool) {
	if o == nil || IsNil(o.Iso3Code) {
		return nil, false
	}
...
func (o *TemplateCountryType) HasIso3Code() bool {
	if o != nil && !IsNil(o.Iso3Code) {
		return true
	}
...
func (o *TemplateCountryType) SetIso3Code(v string) {
	o.Iso3Code = &v
}
