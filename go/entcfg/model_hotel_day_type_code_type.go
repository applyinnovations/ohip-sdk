...
func (o *HotelDayTypeCodeType) GetManagedBy() ManagedByOptions {
...
// and a boolean to check if the value has been set.
func (o *HotelDayTypeCodeType) GetManagedByOk() (*ManagedByOptions, bool) {
	if o == nil || IsNil(o.ManagedBy) {
		return nil, false
	}
...
func (o *HotelDayTypeCodeType) HasManagedBy() bool {
	if o != nil && !IsNil(o.ManagedBy) {
		return true
	}
...
func (o *HotelDayTypeCodeType) SetManagedBy(v ManagedByOptions) {
	o.ManagedBy = &v
}
