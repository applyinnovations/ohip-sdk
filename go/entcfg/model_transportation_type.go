...
func (o *TransportationType) GetManagedBy() ManagedByOptions {
...
// and a boolean to check if the value has been set.
func (o *TransportationType) GetManagedByOk() (*ManagedByOptions, bool) {
	if o == nil || IsNil(o.ManagedBy) {
		return nil, false
	}
...
func (o *TransportationType) HasManagedBy() bool {
	if o != nil && !IsNil(o.ManagedBy) {
		return true
	}
...
func (o *TransportationType) SetManagedBy(v ManagedByOptions) {
	o.ManagedBy = &v
}
