...
func (o *YieldCategoryType) GetManagedBy() ManagedByOptions {
...
// and a boolean to check if the value has been set.
func (o *YieldCategoryType) GetManagedByOk() (*ManagedByOptions, bool) {
	if o == nil || IsNil(o.ManagedBy) {
		return nil, false
	}
...
func (o *YieldCategoryType) HasManagedBy() bool {
	if o != nil && !IsNil(o.ManagedBy) {
		return true
	}
...
func (o *YieldCategoryType) SetManagedBy(v ManagedByOptions) {
	o.ManagedBy = &v
}
