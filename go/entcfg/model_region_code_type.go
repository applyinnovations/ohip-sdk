...
// checks if the RegionCodeType type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RegionCodeType{}

// RegionCodeType Contains Common Master configuration detail.
type RegionCodeType struct {
...
func (o RegionCodeType) MarshalJSON() ([]byte, error) {
...
func (o RegionCodeType) ToMap() (map[string]interface{}, error) {
...
type NullableRegionCodeType struct {
	value *RegionCodeType
	isSet bool
}

func (v NullableRegionCodeType) Get() *RegionCodeType {
	return v.value
}

func (v *NullableRegionCodeType) Set(val *RegionCodeType) {
	v.value = val
	v.isSet = true
}

func (v NullableRegionCodeType) IsSet() bool {
	return v.isSet
}

func (v *NullableRegionCodeType) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRegionCodeType(val *RegionCodeType) *NullableRegionCodeType {
	return &NullableRegionCodeType{value: val, isSet: true}
}

func (v NullableRegionCodeType) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRegionCodeType) UnmarshalJSON(src []byte) error {
	v.isSet = true
