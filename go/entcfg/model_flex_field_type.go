...
func (o *FlexFieldType) GetManagedBy() ManagedByOptions {
...
// and a boolean to check if the value has been set.
func (o *FlexFieldType) GetManagedByOk() (*ManagedByOptions, bool) {
	if o == nil || IsNil(o.ManagedBy) {
		return nil, false
	}
...
func (o *FlexFieldType) HasManagedBy() bool {
	if o != nil && !IsNil(o.ManagedBy) {
		return true
	}
...
func (o *FlexFieldType) SetManagedBy(v ManagedByOptions) {
	o.ManagedBy = &v
}
