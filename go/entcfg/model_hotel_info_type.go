...
type HotelInfoType struct {
	...
	// This flag is to indicate that whether the property is configured in the Welcome screen.
...
func (o *HotelInfoType) GetConfigured() bool {
...
// and a boolean to check if the value has been set.
func (o *HotelInfoType) GetConfiguredOk() (*bool, bool) {
	if o == nil || IsNil(o.Configured) {
		return nil, false
	}
...
func (o *HotelInfoType) HasConfigured() bool {
	if o != nil && !IsNil(o.Configured) {
		return true
	}
...
func (o *HotelInfoType) SetConfigured(v bool) {
	o.Configured = &v
}
