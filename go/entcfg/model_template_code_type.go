...
// checks if the TemplateCodeType type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TemplateCodeType{}

// TemplateCodeType Contains Common Master configuration detail.
type TemplateCodeType struct {
...
func (o TemplateCodeType) MarshalJSON() ([]byte, error) {
...
func (o TemplateCodeType) ToMap() (map[string]interface{}, error) {
...
type NullableTemplateCodeType struct {
	value *TemplateCodeType
	isSet bool
}

func (v NullableTemplateCodeType) Get() *TemplateCodeType {
	return v.value
}

func (v *NullableTemplateCodeType) Set(val *TemplateCodeType) {
	v.value = val
	v.isSet = true
}

func (v NullableTemplateCodeType) IsSet() bool {
	return v.isSet
}

func (v *NullableTemplateCodeType) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTemplateCodeType(val *TemplateCodeType) *NullableTemplateCodeType {
	return &NullableTemplateCodeType{value: val, isSet: true}
}

func (v NullableTemplateCodeType) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTemplateCodeType) UnmarshalJSON(src []byte) error {
	v.isSet = true
