...
// checks if the CorporateDivisionType type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CorporateDivisionType{}

// CorporateDivisionType Contains Common Master configuration detail.
type CorporateDivisionType struct {
...
func (o CorporateDivisionType) MarshalJSON() ([]byte, error) {
...
func (o CorporateDivisionType) ToMap() (map[string]interface{}, error) {
...
type NullableCorporateDivisionType struct {
	value *CorporateDivisionType
	isSet bool
}

func (v NullableCorporateDivisionType) Get() *CorporateDivisionType {
	return v.value
}

func (v *NullableCorporateDivisionType) Set(val *CorporateDivisionType) {
	v.value = val
	v.isSet = true
}

func (v NullableCorporateDivisionType) IsSet() bool {
	return v.isSet
}

func (v *NullableCorporateDivisionType) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCorporateDivisionType(val *CorporateDivisionType) *NullableCorporateDivisionType {
	return &NullableCorporateDivisionType{value: val, isSet: true}
}

func (v NullableCorporateDivisionType) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCorporateDivisionType) UnmarshalJSON(src []byte) error {
	v.isSet = true
