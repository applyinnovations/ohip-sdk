...
// checks if the AddressTypeType type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AddressTypeType{}

// AddressTypeType Contains Common Master configuration detail.
type AddressTypeType struct {
...
func (o AddressTypeType) MarshalJSON() ([]byte, error) {
...
func (o AddressTypeType) ToMap() (map[string]interface{}, error) {
...
type NullableAddressTypeType struct {
	value *AddressTypeType
	isSet bool
}

func (v NullableAddressTypeType) Get() *AddressTypeType {
	return v.value
}

func (v *NullableAddressTypeType) Set(val *AddressTypeType) {
	v.value = val
	v.isSet = true
}

func (v NullableAddressTypeType) IsSet() bool {
	return v.isSet
}

func (v *NullableAddressTypeType) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAddressTypeType(val *AddressTypeType) *NullableAddressTypeType {
	return &NullableAddressTypeType{value: val, isSet: true}
}

func (v NullableAddressTypeType) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAddressTypeType) UnmarshalJSON(src []byte) error {
	v.isSet = true
