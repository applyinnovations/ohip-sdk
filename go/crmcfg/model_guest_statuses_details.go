...
// checks if the GuestStatusesDetails type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GuestStatusesDetails{}

// GuestStatusesDetails Response object for fetching Guest Statuses.
type GuestStatusesDetails struct {
...
func (o GuestStatusesDetails) MarshalJSON() ([]byte, error) {
...
func (o GuestStatusesDetails) ToMap() (map[string]interface{}, error) {
...
type NullableGuestStatusesDetails struct {
	value *GuestStatusesDetails
	isSet bool
}

func (v NullableGuestStatusesDetails) Get() *GuestStatusesDetails {
	return v.value
}

func (v *NullableGuestStatusesDetails) Set(val *GuestStatusesDetails) {
	v.value = val
	v.isSet = true
}

func (v NullableGuestStatusesDetails) IsSet() bool {
	return v.isSet
}

func (v *NullableGuestStatusesDetails) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGuestStatusesDetails(val *GuestStatusesDetails) *NullableGuestStatusesDetails {
	return &NullableGuestStatusesDetails{value: val, isSet: true}
}

func (v NullableGuestStatusesDetails) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGuestStatusesDetails) UnmarshalJSON(src []byte) error {
	v.isSet = true
