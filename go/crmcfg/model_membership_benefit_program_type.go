...
func (o *MembershipBenefitProgramType) GetManagedBy() ManagedByOptions {
...
// and a boolean to check if the value has been set.
func (o *MembershipBenefitProgramType) GetManagedByOk() (*ManagedByOptions, bool) {
	if o == nil || IsNil(o.ManagedBy) {
		return nil, false
	}
...
func (o *MembershipBenefitProgramType) HasManagedBy() bool {
	if o != nil && !IsNil(o.ManagedBy) {
		return true
	}
...
func (o *MembershipBenefitProgramType) SetManagedBy(v ManagedByOptions) {
	o.ManagedBy = &v
}
