...
type AwardPointsType struct {
	...
	// Number of days from new member's join date when referral can be added.
	ReferralPeriod *int32 `json:"referralPeriod,omitempty"`
}
...
// GetReferralPeriod returns the ReferralPeriod field value if set, zero value otherwise.
func (o *AwardPointsType) GetReferralPeriod() int32 {
	if o == nil || IsNil(o.ReferralPeriod) {
		var ret int32
		return ret
	}
	return *o.ReferralPeriod
}

// GetReferralPeriodOk returns a tuple with the ReferralPeriod field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *AwardPointsType) GetReferralPeriodOk() (*int32, bool) {
	if o == nil || IsNil(o.ReferralPeriod) {
		return nil, false
	}
	return o.ReferralPeriod, true
}

// HasReferralPeriod returns a boolean if a field has been set.
func (o *AwardPointsType) HasReferralPeriod() bool {
	if o != nil && !IsNil(o.ReferralPeriod) {
		return true
	}
...
// SetReferralPeriod gets a reference to the given int32 and assigns it to the ReferralPeriod field.
func (o *AwardPointsType) SetReferralPeriod(v int32) {
	o.ReferralPeriod = &v
}
...
func (o AwardPointsType) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.ReferralPeriod) {
		toSerialize["referralPeriod"] = o.ReferralPeriod
	}
