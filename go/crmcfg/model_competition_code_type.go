...
// checks if the CompetitionCodeType type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CompetitionCodeType{}

// CompetitionCodeType Contains Common Master configuration detail.
type CompetitionCodeType struct {
...
func (o CompetitionCodeType) MarshalJSON() ([]byte, error) {
...
func (o CompetitionCodeType) ToMap() (map[string]interface{}, error) {
...
type NullableCompetitionCodeType struct {
	value *CompetitionCodeType
	isSet bool
}

func (v NullableCompetitionCodeType) Get() *CompetitionCodeType {
	return v.value
}

func (v *NullableCompetitionCodeType) Set(val *CompetitionCodeType) {
	v.value = val
	v.isSet = true
}

func (v NullableCompetitionCodeType) IsSet() bool {
	return v.isSet
}

func (v *NullableCompetitionCodeType) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCompetitionCodeType(val *CompetitionCodeType) *NullableCompetitionCodeType {
	return &NullableCompetitionCodeType{value: val, isSet: true}
}

func (v NullableCompetitionCodeType) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCompetitionCodeType) UnmarshalJSON(src []byte) error {
	v.isSet = true
