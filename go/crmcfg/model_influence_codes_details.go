...
// checks if the InfluenceCodesDetails type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &InfluenceCodesDetails{}

// InfluenceCodesDetails Response object for fetching Influence Codes.
type InfluenceCodesDetails struct {
...
func (o InfluenceCodesDetails) MarshalJSON() ([]byte, error) {
...
func (o InfluenceCodesDetails) ToMap() (map[string]interface{}, error) {
...
type NullableInfluenceCodesDetails struct {
	value *InfluenceCodesDetails
	isSet bool
}

func (v NullableInfluenceCodesDetails) Get() *InfluenceCodesDetails {
	return v.value
}

func (v *NullableInfluenceCodesDetails) Set(val *InfluenceCodesDetails) {
	v.value = val
	v.isSet = true
}

func (v NullableInfluenceCodesDetails) IsSet() bool {
	return v.isSet
}

func (v *NullableInfluenceCodesDetails) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInfluenceCodesDetails(val *InfluenceCodesDetails) *NullableInfluenceCodesDetails {
	return &NullableInfluenceCodesDetails{value: val, isSet: true}
}

func (v NullableInfluenceCodesDetails) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInfluenceCodesDetails) UnmarshalJSON(src []byte) error {
	v.isSet = true
