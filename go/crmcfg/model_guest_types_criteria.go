...
// checks if the GuestTypesCriteria type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GuestTypesCriteria{}

// GuestTypesCriteria Request object for creating Guest Types.
type GuestTypesCriteria struct {
	// List of Guest Types.
...
func (o GuestTypesCriteria) MarshalJSON() ([]byte, error) {
...
func (o GuestTypesCriteria) ToMap() (map[string]interface{}, error) {
...
type NullableGuestTypesCriteria struct {
	value *GuestTypesCriteria
	isSet bool
}

func (v NullableGuestTypesCriteria) Get() *GuestTypesCriteria {
	return v.value
}

func (v *NullableGuestTypesCriteria) Set(val *GuestTypesCriteria) {
	v.value = val
	v.isSet = true
}

func (v NullableGuestTypesCriteria) IsSet() bool {
	return v.isSet
}

func (v *NullableGuestTypesCriteria) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGuestTypesCriteria(val *GuestTypesCriteria) *NullableGuestTypesCriteria {
	return &NullableGuestTypesCriteria{value: val, isSet: true}
}

func (v NullableGuestTypesCriteria) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGuestTypesCriteria) UnmarshalJSON(src []byte) error {
	v.isSet = true
