...
// checks if the GuestStatusType type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GuestStatusType{}

// GuestStatusType Contains Common Master configuration detail.
type GuestStatusType struct {
...
func (o GuestStatusType) MarshalJSON() ([]byte, error) {
...
func (o GuestStatusType) ToMap() (map[string]interface{}, error) {
...
type NullableGuestStatusType struct {
	value *GuestStatusType
	isSet bool
}

func (v NullableGuestStatusType) Get() *GuestStatusType {
	return v.value
}

func (v *NullableGuestStatusType) Set(val *GuestStatusType) {
	v.value = val
	v.isSet = true
}

func (v NullableGuestStatusType) IsSet() bool {
	return v.isSet
}

func (v *NullableGuestStatusType) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGuestStatusType(val *GuestStatusType) *NullableGuestStatusType {
	return &NullableGuestStatusType{value: val, isSet: true}
}

func (v NullableGuestStatusType) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGuestStatusType) UnmarshalJSON(src []byte) error {
	v.isSet = true
