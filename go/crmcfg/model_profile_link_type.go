...
func (o *ProfileLinkType) GetManagedBy() ManagedByOptions {
...
// and a boolean to check if the value has been set.
func (o *ProfileLinkType) GetManagedByOk() (*ManagedByOptions, bool) {
	if o == nil || IsNil(o.ManagedBy) {
		return nil, false
	}
...
func (o *ProfileLinkType) HasManagedBy() bool {
	if o != nil && !IsNil(o.ManagedBy) {
		return true
	}
...
func (o *ProfileLinkType) SetManagedBy(v ManagedByOptions) {
	o.ManagedBy = &v
}
