...
// PointsRoundingFlagType This flag tells if the total points computed will be rounded based on the rounding option selected.
...
const (
	...
	POINTSROUNDINGFLAGTYPE_ROUNDUPND PointsRoundingFlagType = "Roundupnd"
	POINTSROUNDINGFLAGTYPE_ROUNDDOWNND PointsRoundingFlagType = "Rounddownnd"
	POINTSROUNDINGFLAGTYPE_UNIVERSALROUNDND PointsRoundingFlagType = "Universalroundnd"
)
