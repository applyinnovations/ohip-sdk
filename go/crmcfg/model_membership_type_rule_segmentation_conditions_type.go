...
type MembershipTypeRuleSegmentationConditionsType struct {
	...
	ExcludeSourceGroup *bool `json:"excludeSourceGroup,omitempty"`
}
...
func (o *MembershipTypeRuleSegmentationConditionsType) GetSourceCode() string {
...
// and a boolean to check if the value has been set.
func (o *MembershipTypeRuleSegmentationConditionsType) GetSourceCodeOk() (*string, bool) {
	if o == nil || IsNil(o.SourceCode) {
		return nil, false
	}
...
func (o *MembershipTypeRuleSegmentationConditionsType) HasSourceCode() bool {
	if o != nil && !IsNil(o.SourceCode) {
		return true
	}
...
func (o *MembershipTypeRuleSegmentationConditionsType) SetSourceCode(v string) {
	o.SourceCode = &v
}

// GetSourceGroup returns the SourceGroup field value if set, zero value otherwise.
func (o *MembershipTypeRuleSegmentationConditionsType) GetSourceGroup() string {
...
// and a boolean to check if the value has been set.
func (o *MembershipTypeRuleSegmentationConditionsType) GetSourceGroupOk() (*string, bool) {
	if o == nil || IsNil(o.SourceGroup) {
		return nil, false
	}
...
func (o *MembershipTypeRuleSegmentationConditionsType) HasSourceGroup() bool {
	if o != nil && !IsNil(o.SourceGroup) {
		return true
	}
...
func (o *MembershipTypeRuleSegmentationConditionsType) SetSourceGroup(v string) {
	o.SourceGroup = &v
}

// GetExcludeSourceGroup returns the ExcludeSourceGroup field value if set, zero value otherwise.
func (o *MembershipTypeRuleSegmentationConditionsType) GetExcludeSourceGroup() bool {
	if o == nil || IsNil(o.ExcludeSourceGroup) {
		var ret bool
		return ret
	}
	return *o.ExcludeSourceGroup
}

// GetExcludeSourceGroupOk returns a tuple with the ExcludeSourceGroup field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *MembershipTypeRuleSegmentationConditionsType) GetExcludeSourceGroupOk() (*bool, bool) {
	if o == nil || IsNil(o.ExcludeSourceGroup) {
		return nil, false
	}
	return o.ExcludeSourceGroup, true
}

// HasExcludeSourceGroup returns a boolean if a field has been set.
func (o *MembershipTypeRuleSegmentationConditionsType) HasExcludeSourceGroup() bool {
	if o != nil && !IsNil(o.ExcludeSourceGroup) {
		return true
	}
...
// SetExcludeSourceGroup gets a reference to the given bool and assigns it to the ExcludeSourceGroup field.
func (o *MembershipTypeRuleSegmentationConditionsType) SetExcludeSourceGroup(v bool) {
	o.ExcludeSourceGroup = &v
}
...
func (o MembershipTypeRuleSegmentationConditionsType) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.ExcludeSourceGroup) {
		toSerialize["excludeSourceGroup"] = o.ExcludeSourceGroup
	}
