...
func (o *MembershipTypeRuleDetailType) GetManagedBy() ManagedByOptions {
...
// and a boolean to check if the value has been set.
func (o *MembershipTypeRuleDetailType) GetManagedByOk() (*ManagedByOptions, bool) {
	if o == nil || IsNil(o.ManagedBy) {
		return nil, false
	}
...
func (o *MembershipTypeRuleDetailType) HasManagedBy() bool {
	if o != nil && !IsNil(o.ManagedBy) {
		return true
	}
...
func (o *MembershipTypeRuleDetailType) SetManagedBy(v ManagedByOptions) {
	o.ManagedBy = &v
}
