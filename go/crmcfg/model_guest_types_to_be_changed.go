...
// checks if the GuestTypesToBeChanged type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GuestTypesToBeChanged{}

// GuestTypesToBeChanged Request object for changing Guest Types.
type GuestTypesToBeChanged struct {
	// List of Guest Types.
...
func (o GuestTypesToBeChanged) MarshalJSON() ([]byte, error) {
...
func (o GuestTypesToBeChanged) ToMap() (map[string]interface{}, error) {
...
type NullableGuestTypesToBeChanged struct {
	value *GuestTypesToBeChanged
	isSet bool
}

func (v NullableGuestTypesToBeChanged) Get() *GuestTypesToBeChanged {
	return v.value
}

func (v *NullableGuestTypesToBeChanged) Set(val *GuestTypesToBeChanged) {
	v.value = val
	v.isSet = true
}

func (v NullableGuestTypesToBeChanged) IsSet() bool {
	return v.isSet
}

func (v *NullableGuestTypesToBeChanged) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGuestTypesToBeChanged(val *GuestTypesToBeChanged) *NullableGuestTypesToBeChanged {
	return &NullableGuestTypesToBeChanged{value: val, isSet: true}
}

func (v NullableGuestTypesToBeChanged) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGuestTypesToBeChanged) UnmarshalJSON(src []byte) error {
	v.isSet = true
