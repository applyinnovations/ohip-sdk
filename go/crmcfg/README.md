...
```golang
import crmcfg "github.com/applyinnovations/ohip-sdk/go/crmcfg/v3"
```
...
*ChainConfigAPI* | [**ChangeStates**](docs/ChainConfigAPI.md#changestates) | **Put** /states/{stateCode} | Change States
...
*ChainConfigAPI* | [**ChangeUpsertCityPostalCodes**](docs/ChainConfigAPI.md#changeupsertcitypostalcodes) | **Put** /upsert/cityPostalCodes | Create/Change City Postal Codes
...
*ChainConfigAPI* | [**DeleteCorrespondences**](docs/ChainConfigAPI.md#deletecorrespondences) | **Delete** /correspondences/{correspondenceId} | Delete an existing correspondence
...
*ChainConfigAPI* | [**GetCityPostalCodes**](docs/ChainConfigAPI.md#getcitypostalcodes) | **Get** /cityPostalCodes | Get CityPostalCodes
...
*ChainConfigAPI* | [**GetCorrespondences**](docs/ChainConfigAPI.md#getcorrespondences) | **Get** /correspondences | Get correspondence
...
*ChainConfigAPI* | [**PostCorrespondences**](docs/ChainConfigAPI.md#postcorrespondences) | **Post** /correspondences | Create a new correspondence
...
*ChainConfigAPI* | [**PutCorrespondences**](docs/ChainConfigAPI.md#putcorrespondences) | **Put** /correspondences/{correspondenceId} | Change an existing correspondence
...
*ChainConfigAPI* | [**RemoveStates**](docs/ChainConfigAPI.md#removestates) | **Delete** /states/{stateCode} | Delete States
...
*ChainConfigAPI* | [**SearchAccountOwners**](docs/ChainConfigAPI.md#searchaccountowners) | **Post** /accountOwners/searches | Get Account Owners
...
*MembershipConfigAPI* | [**ApplyTierManagementChanges**](docs/MembershipConfigAPI.md#applytiermanagementchanges) | **Post** /tierManagementChanges | Apply Tier Management Changes
*MembershipConfigAPI* | [**CopySuspendedMatchRule**](docs/MembershipConfigAPI.md#copysuspendedmatchrule) | **Post** /profiles/suspendedMatchRules/copy | Copy suspended match rule
...
*MembershipConfigAPI* | [**DeleteMembershipLevelRules**](docs/MembershipConfigAPI.md#deletemembershiplevelrules) | **Delete** /membershipTypes/{membershipType}/membershipLevels/{membershipLevel}/membershipLevelRules/{membershipLevelRulesID} | Delete Membership Level Rules
...
*MembershipConfigAPI* | [**DeleteMembershipOriginGroup**](docs/MembershipConfigAPI.md#deletemembershiporigingroup) | **Delete** /membershipOriginGroups/{membershipOriginGroupId} | Delete Membership origin group
...
*MembershipConfigAPI* | [**DeleteMembershipRevenueTypes**](docs/MembershipConfigAPI.md#deletemembershiprevenuetypes) | **Delete** /membershipRevenueTypes/{membershipRevenueTypesId} | Delete Membership revenue types
*MembershipConfigAPI* | [**DeleteMembershipRoomGroups**](docs/MembershipConfigAPI.md#deletemembershiproomgroups) | **Delete** /membershipRoomGroups/{membershipRoomGroupsId} | Delete Membership room groups
*MembershipConfigAPI* | [**DeleteMembershipSourceGroup**](docs/MembershipConfigAPI.md#deletemembershipsourcegroup) | **Delete** /membershipSourceGroups/{membershipSourceGroupId} | Delete Membership Source group
...
*MembershipConfigAPI* | [**DeleteProfileRegion**](docs/MembershipConfigAPI.md#deleteprofileregion) | **Delete** /profiles/profileRegion | Delete Profile Region.
*MembershipConfigAPI* | [**DeleteSuspendedMatchRules**](docs/MembershipConfigAPI.md#deletesuspendedmatchrules) | **Delete** /profiles/suspendedMatchRules/{region}/{nameType}/{validationItem} | Delete suspended match rules
*MembershipConfigAPI* | [**DeleteTierManagementBatchRecords**](docs/MembershipConfigAPI.md#deletetiermanagementbatchrecords) | **Delete** /tierManagementBatchRecords/{tierManagementBatchRecordsID} | Delete Tier Management Batch Record
*MembershipConfigAPI* | [**DeleteTierManagementChanges**](docs/MembershipConfigAPI.md#deletetiermanagementchanges) | **Delete** /tierManagementChanges/{tierManagementChangesID} | Delete Tier Management 
...
*MembershipConfigAPI* | [**GetMembershipLevelRules**](docs/MembershipConfigAPI.md#getmembershiplevelrules) | **Get** /membershipLevelRules | Get Membership Level Rules
...
*MembershipConfigAPI* | [**GetMembershipOriginGroups**](docs/MembershipConfigAPI.md#getmembershiporigingroups) | **Get** /membershipOriginGroups | Get Membership origin groups
...
*MembershipConfigAPI* | [**GetMembershipRevenueTypes**](docs/MembershipConfigAPI.md#getmembershiprevenuetypes) | **Get** /membershipRevenueTypes | Get Membership revenue types
*MembershipConfigAPI* | [**GetMembershipRoomGroups**](docs/MembershipConfigAPI.md#getmembershiproomgroups) | **Get** /membershipRoomGroups | Get Membership room groups 
*MembershipConfigAPI* | [**GetMembershipSourceGroups**](docs/MembershipConfigAPI.md#getmembershipsourcegroups) | **Get** /membershipSourceGroups | Get Membership source groups
...
*MembershipConfigAPI* | [**GetProfileRegions**](docs/MembershipConfigAPI.md#getprofileregions) | **Get** /profiles/profileRegion | Get profile regions
*MembershipConfigAPI* | [**GetSuspendedMatchRules**](docs/MembershipConfigAPI.md#getsuspendedmatchrules) | **Get** /profiles/suspendedMatchRules | Get profile suspended match rules
*MembershipConfigAPI* | [**GetTierManagementBatchProcesses**](docs/MembershipConfigAPI.md#gettiermanagementbatchprocesses) | **Get** /tierManagementBatchProcesses | Get Tier Management Batch Processes
*MembershipConfigAPI* | [**GetTierManagementBatchRecords**](docs/MembershipConfigAPI.md#gettiermanagementbatchrecords) | **Get** /tierManagementBatchRecords | Get Tier Management Batch Records
...
*MembershipConfigAPI* | [**PostMembershipLevelRules**](docs/MembershipConfigAPI.md#postmembershiplevelrules) | **Post** /membershipLevelRules | Create Membership Level Rules
...
*MembershipConfigAPI* | [**PostMembershipOriginGroup**](docs/MembershipConfigAPI.md#postmembershiporigingroup) | **Post** /membershipOriginGroups | Create a Membership origin group
...
*MembershipConfigAPI* | [**PostMembershipRevenueTypes**](docs/MembershipConfigAPI.md#postmembershiprevenuetypes) | **Post** /membershipRevenueTypes | Create Membership revenue types
*MembershipConfigAPI* | [**PostMembershipRoomGroups**](docs/MembershipConfigAPI.md#postmembershiproomgroups) | **Post** /membershipRoomGroups | Create Membership room groups
*MembershipConfigAPI* | [**PostMembershipSourceGroup**](docs/MembershipConfigAPI.md#postmembershipsourcegroup) | **Post** /membershipSourceGroups | Create a Membership source group
...
*MembershipConfigAPI* | [**PostProfileRegion**](docs/MembershipConfigAPI.md#postprofileregion) | **Post** /profiles/profileRegion | Create Profile Region
*MembershipConfigAPI* | [**PostSuspendedMatchRules**](docs/MembershipConfigAPI.md#postsuspendedmatchrules) | **Post** /profiles/suspendedMatchRules | Create suspended match rules
*MembershipConfigAPI* | [**ProcessTierManagement**](docs/MembershipConfigAPI.md#processtiermanagement) | **Post** /processTierManagement | Process Tier Management
...
*MembershipConfigAPI* | [**PutMembershipLevelRules**](docs/MembershipConfigAPI.md#putmembershiplevelrules) | **Put** /membershipLevelRules/{membershipLevelRulesID} | Change Membership Level Rules
...
*MembershipConfigAPI* | [**PutMembershipOriginGroup**](docs/MembershipConfigAPI.md#putmembershiporigingroup) | **Put** /membershipOriginGroups/{membershipOriginGroupId} | Change Membership origin group
...
*MembershipConfigAPI* | [**PutMembershipRevenueTypes**](docs/MembershipConfigAPI.md#putmembershiprevenuetypes) | **Put** /membershipRevenueTypes/{membershipRevenueTypesId} | Change Membership revenue types
*MembershipConfigAPI* | [**PutMembershipRoomGroups**](docs/MembershipConfigAPI.md#putmembershiproomgroups) | **Put** /membershipRoomGroups/{membershipRoomGroupsId} | Change Membership room groups
*MembershipConfigAPI* | [**PutMembershipSourceGroup**](docs/MembershipConfigAPI.md#putmembershipsourcegroup) | **Put** /membershipSourceGroups/{membershipSourceGroupId} | Change Membership source group
...
*MembershipConfigAPI* | [**PutProfileRegion**](docs/MembershipConfigAPI.md#putprofileregion) | **Put** /profiles/profileRegion | Update Profile Region
*MembershipConfigAPI* | [**PutSuspendedMatchRules**](docs/MembershipConfigAPI.md#putsuspendedmatchrules) | **Put** /profiles/suspendedMatchRules | Update suspended match rules
*MembershipConfigAPI* | [**PutUpsertMembershipAwards**](docs/MembershipConfigAPI.md#putupsertmembershipawards) | **Put** /upsert/membershipAwards/{membershipAwardsId} | Create/Change Membership Awards
*MembershipConfigAPI* | [**PutUpsertMembershipBenefitPrograms**](docs/MembershipConfigAPI.md#putupsertmembershipbenefitprograms) | **Put** /upsert/membershipBenefitPrograms/{membershipBenefitProgramsId} | Create/Change Membership Benefit Program
*MembershipConfigAPI* | [**PutUpsertMembershipLevels**](docs/MembershipConfigAPI.md#putupsertmembershiplevels) | **Put** /upsert/membershipLevels/{membershipLevelsId} | Create/Change Membership levels
*MembershipConfigAPI* | [**PutUpsertMembershipMarketGroups**](docs/MembershipConfigAPI.md#putupsertmembershipmarketgroups) | **Put** /upsert/membershipMarketGroups/{membershipMarketGroupId} | Create/Change Membership market groups
*MembershipConfigAPI* | [**PutUpsertMembershipOriginGroup**](docs/MembershipConfigAPI.md#putupsertmembershiporigingroup) | **Put** /upsert/membershipOriginGroups/{membershipOriginGroupId} | Create/Change Membership origin group
*MembershipConfigAPI* | [**PutUpsertMembershipPropertyGroups**](docs/MembershipConfigAPI.md#putupsertmembershippropertygroups) | **Put** /upsert/membershipPropertyGroups/{membershipPropertyGroupsId} | Create/Change Membership property groups
*MembershipConfigAPI* | [**PutUpsertMembershipRateGroups**](docs/MembershipConfigAPI.md#putupsertmembershiprategroups) | **Put** /upsert/membershipRateGroups/{membershipRateGroupId} | Create/Change Membership rate groups
*MembershipConfigAPI* | [**PutUpsertMembershipRates**](docs/MembershipConfigAPI.md#putupsertmembershiprates) | **Put** /upsert/membershipRates/{membershipRatesId} | Create/Change Membership rates
*MembershipConfigAPI* | [**PutUpsertMembershipRevenueGroups**](docs/MembershipConfigAPI.md#putupsertmembershiprevenuegroups) | **Put** /upsert/membershipRevenueGroups/{membershipRevenueGroupId} | Create/Change Membership revenue groups
*MembershipConfigAPI* | [**PutUpsertMembershipRevenueTypes**](docs/MembershipConfigAPI.md#putupsertmembershiprevenuetypes) | **Put** /upsert/membershipRevenueTypes/{membershipRevenueTypesId} | Create/Change Membership revenue types
*MembershipConfigAPI* | [**PutUpsertMembershipRoomGroups**](docs/MembershipConfigAPI.md#putupsertmembershiproomgroups) | **Put** /upsert/membershipRoomGroups/{membershipRoomGroupsId} | Create/Change Membership room groups
*MembershipConfigAPI* | [**PutUpsertMembershipSourceGroup**](docs/MembershipConfigAPI.md#putupsertmembershipsourcegroup) | **Put** /upsert/membershipSourceGroups/{membershipSourceGroupId} | Create/Change Membership source group
*MembershipConfigAPI* | [**PutUpsertMembershipTypeRules**](docs/MembershipConfigAPI.md#putupsertmembershiptyperules) | **Put** /upsert/membershipTypeRules/{membershipTypeRulesId} | Create/Change Membership type rules
*MembershipConfigAPI* | [**PutUpsertQualifyingRates**](docs/MembershipConfigAPI.md#putupsertqualifyingrates) | **Put** /upsert/qualifyingRates/{qualifyingRatesId} | Upsert Qualifying Rates
*MembershipConfigAPI* | [**SearchTierManagementBatchRecords**](docs/MembershipConfigAPI.md#searchtiermanagementbatchrecords) | **Post** /tierManagementBatchRecords/searches | Get Tier Management Batch Records
...
*ProfileConfigurationAPI* | [**GetClaimAdjustmentLimits**](docs/ProfileConfigurationAPI.md#getclaimadjustmentlimits) | **Get** /claimAdjustmentLimits | Get Claim Adjustment Limits
...
*ProfileConfigurationAPI* | [**PostClaimAdjustmentLimits**](docs/ProfileConfigurationAPI.md#postclaimadjustmentlimits) | **Post** /claimAdjustmentLimits | Create Claim Adjustment Limits
...
*ProfileConfigurationAPI* | [**PutClaimAdjustmentLimits**](docs/ProfileConfigurationAPI.md#putclaimadjustmentlimits) | **Put** /claimAdjustmentLimits | Change Claim Adjustment Limits
...
*ProfileConfigurationAPI* | [**PutUpsertClaimAdjustmentLimits**](docs/ProfileConfigurationAPI.md#putupsertclaimadjustmentlimits) | **Put** /upsert/claimAdjustmentLimits | Create/Change Claim Adjustment Limits
*ProfileConfigurationAPI* | [**PutUpsertProfileNameValidations**](docs/ProfileConfigurationAPI.md#putupsertprofilenamevalidations) | **Put** /upsert/profileNameValidations | Create/Change Profile Name Validations
*ProfileConfigurationAPI* | [**PutUpsertProfileRelationships**](docs/ProfileConfigurationAPI.md#putupsertprofilerelationships) | **Put** /upsert/relationships | Create/Change profile relationships
...
## Documentation For Models
 ...
 - [ClaimAdjustmentLimitType](docs/ClaimAdjustmentLimitType.md)
 - [ClaimAdjustmentLimits](docs/ClaimAdjustmentLimits.md)
 - [ClaimAdjustmentLimitsInfo](docs/ClaimAdjustmentLimitsInfo.md)
 - [ClaimAdjustmentLimitsRangeType](docs/ClaimAdjustmentLimitsRangeType.md)
 ...
 - [CopySuspendedMatchRuleType](docs/CopySuspendedMatchRuleType.md)
 - [CorrespondenceType](docs/CorrespondenceType.md)
 - [CorrespondencesCriteriaType](docs/CorrespondencesCriteriaType.md)
 - [CorrespondencesDetails](docs/CorrespondencesDetails.md)
 - [CorrespondencesToBeChanged](docs/CorrespondencesToBeChanged.md)
 - [CorrespondencesType](docs/CorrespondencesType.md)
 ...
 - [MembershipAwardRateDiscountInfoType](docs/MembershipAwardRateDiscountInfoType.md)
 ...
 - [MembershipGracePeriodStatusType](docs/MembershipGracePeriodStatusType.md)
 - [MembershipHandlingType](docs/MembershipHandlingType.md)
 - [MembershipLevelRuleRecordType](docs/MembershipLevelRuleRecordType.md)
 - [MembershipLevelRuleType](docs/MembershipLevelRuleType.md)
 - [MembershipLevelRuleTypeType](docs/MembershipLevelRuleTypeType.md)
 - [MembershipLevelRules](docs/MembershipLevelRules.md)
 - [MembershipLevelRulesInfo](docs/MembershipLevelRulesInfo.md)
 ...
 - [MembershipOriginGroupDetails](docs/MembershipOriginGroupDetails.md)
 - [MembershipOriginGroupType](docs/MembershipOriginGroupType.md)
 - [MembershipOriginGroupsDetails](docs/MembershipOriginGroupsDetails.md)
 ...
 - [MembershipRevenueGroupType](docs/MembershipRevenueGroupType.md)
 - [MembershipRevenueGroups](docs/MembershipRevenueGroups.md)
 - [MembershipRevenueTypeType](docs/MembershipRevenueTypeType.md)
 - [MembershipRevenueTypes](docs/MembershipRevenueTypes.md)
 - [MembershipRevenueTypesInfo](docs/MembershipRevenueTypesInfo.md)
 - [MembershipRoomGroupType](docs/MembershipRoomGroupType.md)
 - [MembershipRoomGroups](docs/MembershipRoomGroups.md)
 - [MembershipRoomGroupsInfo](docs/MembershipRoomGroupsInfo.md)
 - [MembershipSourceGroupDetails](docs/MembershipSourceGroupDetails.md)
 - [MembershipSourceGroupType](docs/MembershipSourceGroupType.md)
 - [MembershipSourceGroupsDetails](docs/MembershipSourceGroupsDetails.md)
 ...
 - [MembershipYearlyTransactionSummaryType](docs/MembershipYearlyTransactionSummaryType.md)
 ...
 - [PointsThreshold](docs/PointsThreshold.md)
 ...
 - [ProfileRegionInfo](docs/ProfileRegionInfo.md)
 - [ProfileRegionType](docs/ProfileRegionType.md)
 - [ProfileRegionsInfo](docs/ProfileRegionsInfo.md)
 ...
 - [QualifyingRateType](docs/QualifyingRateType.md)
 - [QualifyingRates](docs/QualifyingRates.md)
 - [RateRuleMembershipType](docs/RateRuleMembershipType.md)
 - [RecordStatusEnum](docs/RecordStatusEnum.md)
 - [RuleAppliesOnType](docs/RuleAppliesOnType.md)
 - [RulePointsTypeType](docs/RulePointsTypeType.md)
 - [SearchAccountOwnersRequest](docs/SearchAccountOwnersRequest.md)
 - [SearchTierManagementBatchRecordsRequest](docs/SearchTierManagementBatchRecordsRequest.md)
 ...
 - [StatesToBeChanged](docs/StatesToBeChanged.md)
 - [Status](docs/Status.md)
 - [SuspendedMatchRuleType](docs/SuspendedMatchRuleType.md)
 - [SuspendedMatchRulesInfo](docs/SuspendedMatchRulesInfo.md)
 ...
 - [TierManagement](docs/TierManagement.md)
 - [TierManagementBatchProcessType](docs/TierManagementBatchProcessType.md)
 - [TierManagementBatchProcesses](docs/TierManagementBatchProcesses.md)
 - [TierManagementBatchRecordIDType](docs/TierManagementBatchRecordIDType.md)
 - [TierManagementBatchRecordStatusType](docs/TierManagementBatchRecordStatusType.md)
 - [TierManagementBatchRecordType](docs/TierManagementBatchRecordType.md)
 - [TierManagementBatchRecords](docs/TierManagementBatchRecords.md)
 - [TierManagementChanges](docs/TierManagementChanges.md)
 - [TierManagementProcessType](docs/TierManagementProcessType.md)
 ...
 - [UpdateSuspendedMatchRuleType](docs/UpdateSuspendedMatchRuleType.md)
