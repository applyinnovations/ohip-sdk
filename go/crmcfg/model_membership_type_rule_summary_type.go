...
func (o *MembershipTypeRuleSummaryType) GetManagedBy() ManagedByOptions {
...
// and a boolean to check if the value has been set.
func (o *MembershipTypeRuleSummaryType) GetManagedByOk() (*ManagedByOptions, bool) {
	if o == nil || IsNil(o.ManagedBy) {
		return nil, false
	}
...
func (o *MembershipTypeRuleSummaryType) HasManagedBy() bool {
	if o != nil && !IsNil(o.ManagedBy) {
		return true
	}
...
func (o *MembershipTypeRuleSummaryType) SetManagedBy(v ManagedByOptions) {
	o.ManagedBy = &v
}
