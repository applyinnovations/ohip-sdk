...
// checks if the OwnerTeamType type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &OwnerTeamType{}

// OwnerTeamType Contains Common Master configuration detail.
type OwnerTeamType struct {
...
func (o OwnerTeamType) MarshalJSON() ([]byte, error) {
...
func (o OwnerTeamType) ToMap() (map[string]interface{}, error) {
...
type NullableOwnerTeamType struct {
	value *OwnerTeamType
	isSet bool
}

func (v NullableOwnerTeamType) Get() *OwnerTeamType {
	return v.value
}

func (v *NullableOwnerTeamType) Set(val *OwnerTeamType) {
	v.value = val
	v.isSet = true
}

func (v NullableOwnerTeamType) IsSet() bool {
	return v.isSet
}

func (v *NullableOwnerTeamType) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableOwnerTeamType(val *OwnerTeamType) *NullableOwnerTeamType {
	return &NullableOwnerTeamType{value: val, isSet: true}
}

func (v NullableOwnerTeamType) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableOwnerTeamType) UnmarshalJSON(src []byte) error {
	v.isSet = true
