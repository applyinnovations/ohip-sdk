...
// checks if the NationalityType type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NationalityType{}

// NationalityType Contains Common Master configuration detail.
...
func (o NationalityType) MarshalJSON() ([]byte, error) {
...
func (o NationalityType) ToMap() (map[string]interface{}, error) {
...
type NullableNationalityType struct {
	value *NationalityType
	isSet bool
}

func (v NullableNationalityType) Get() *NationalityType {
	return v.value
}

func (v *NullableNationalityType) Set(val *NationalityType) {
	v.value = val
	v.isSet = true
}

func (v NullableNationalityType) IsSet() bool {
	return v.isSet
}

func (v *NullableNationalityType) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNationalityType(val *NationalityType) *NullableNationalityType {
	return &NullableNationalityType{value: val, isSet: true}
}

func (v NullableNationalityType) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNationalityType) UnmarshalJSON(src []byte) error {
	v.isSet = true
