...
type MembershipHandlingType struct {
	...
	// Indicates database for external points & redemption system (if applicable).
	ExternalPointsAndRedemptionDatabase *string `json:"externalPointsAndRedemptionDatabase,omitempty"`
...
// GetExternalPointsAndRedemptionDatabase returns the ExternalPointsAndRedemptionDatabase field value if set, zero value otherwise.
func (o *MembershipHandlingType) GetExternalPointsAndRedemptionDatabase() string {
	if o == nil || IsNil(o.ExternalPointsAndRedemptionDatabase) {
		var ret string
		return ret
	}
	return *o.ExternalPointsAndRedemptionDatabase
}

// GetExternalPointsAndRedemptionDatabaseOk returns a tuple with the ExternalPointsAndRedemptionDatabase field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *MembershipHandlingType) GetExternalPointsAndRedemptionDatabaseOk() (*string, bool) {
	if o == nil || IsNil(o.ExternalPointsAndRedemptionDatabase) {
		return nil, false
	}
	return o.ExternalPointsAndRedemptionDatabase, true
}

// HasExternalPointsAndRedemptionDatabase returns a boolean if a field has been set.
func (o *MembershipHandlingType) HasExternalPointsAndRedemptionDatabase() bool {
	if o != nil && !IsNil(o.ExternalPointsAndRedemptionDatabase) {
		return true
	}
...
// SetExternalPointsAndRedemptionDatabase gets a reference to the given string and assigns it to the ExternalPointsAndRedemptionDatabase field.
func (o *MembershipHandlingType) SetExternalPointsAndRedemptionDatabase(v string) {
	o.ExternalPointsAndRedemptionDatabase = &v
}
...
func (o MembershipHandlingType) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.ExternalPointsAndRedemptionDatabase) {
		toSerialize["externalPointsAndRedemptionDatabase"] = o.ExternalPointsAndRedemptionDatabase
	}
