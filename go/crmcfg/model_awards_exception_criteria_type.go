...
type AwardsExceptionCriteriaType struct {
	// Enter the number of multiple rooms that should be flagged as an exception for same stay dates.
	MultipleRooms *int32 `json:"multipleRooms,omitempty"`
...
// SetMultipleRooms gets a reference to the given int32 and assigns it to the MultipleRooms field.
