...
// checks if the MailingActionCodeType type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MailingActionCodeType{}

// MailingActionCodeType Contains Common Master configuration detail.
type MailingActionCodeType struct {
...
func (o MailingActionCodeType) MarshalJSON() ([]byte, error) {
...
func (o MailingActionCodeType) ToMap() (map[string]interface{}, error) {
...
type NullableMailingActionCodeType struct {
	value *MailingActionCodeType
	isSet bool
}

func (v NullableMailingActionCodeType) Get() *MailingActionCodeType {
	return v.value
}

func (v *NullableMailingActionCodeType) Set(val *MailingActionCodeType) {
	v.value = val
	v.isSet = true
}

func (v NullableMailingActionCodeType) IsSet() bool {
	return v.isSet
}

func (v *NullableMailingActionCodeType) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMailingActionCodeType(val *MailingActionCodeType) *NullableMailingActionCodeType {
	return &NullableMailingActionCodeType{value: val, isSet: true}
}

func (v NullableMailingActionCodeType) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMailingActionCodeType) UnmarshalJSON(src []byte) error {
	v.isSet = true
