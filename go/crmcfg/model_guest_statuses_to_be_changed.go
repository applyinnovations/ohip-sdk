...
// checks if the GuestStatusesToBeChanged type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GuestStatusesToBeChanged{}

// GuestStatusesToBeChanged Request object for changing Guest Statuses.
type GuestStatusesToBeChanged struct {
...
func (o GuestStatusesToBeChanged) MarshalJSON() ([]byte, error) {
...
func (o GuestStatusesToBeChanged) ToMap() (map[string]interface{}, error) {
...
type NullableGuestStatusesToBeChanged struct {
	value *GuestStatusesToBeChanged
	isSet bool
}

func (v NullableGuestStatusesToBeChanged) Get() *GuestStatusesToBeChanged {
	return v.value
}

func (v *NullableGuestStatusesToBeChanged) Set(val *GuestStatusesToBeChanged) {
	v.value = val
	v.isSet = true
}

func (v NullableGuestStatusesToBeChanged) IsSet() bool {
	return v.isSet
}

func (v *NullableGuestStatusesToBeChanged) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGuestStatusesToBeChanged(val *GuestStatusesToBeChanged) *NullableGuestStatusesToBeChanged {
	return &NullableGuestStatusesToBeChanged{value: val, isSet: true}
}

func (v NullableGuestStatusesToBeChanged) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGuestStatusesToBeChanged) UnmarshalJSON(src []byte) error {
	v.isSet = true
