...
// checks if the MembershipStatusCodeType type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MembershipStatusCodeType{}

// MembershipStatusCodeType Contains Common Master configuration detail.
type MembershipStatusCodeType struct {
...
func (o MembershipStatusCodeType) MarshalJSON() ([]byte, error) {
...
func (o MembershipStatusCodeType) ToMap() (map[string]interface{}, error) {
...
type NullableMembershipStatusCodeType struct {
	value *MembershipStatusCodeType
	isSet bool
}

func (v NullableMembershipStatusCodeType) Get() *MembershipStatusCodeType {
	return v.value
}

func (v *NullableMembershipStatusCodeType) Set(val *MembershipStatusCodeType) {
	v.value = val
	v.isSet = true
}

func (v NullableMembershipStatusCodeType) IsSet() bool {
	return v.isSet
}

func (v *NullableMembershipStatusCodeType) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMembershipStatusCodeType(val *MembershipStatusCodeType) *NullableMembershipStatusCodeType {
	return &NullableMembershipStatusCodeType{value: val, isSet: true}
}

func (v NullableMembershipStatusCodeType) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMembershipStatusCodeType) UnmarshalJSON(src []byte) error {
	v.isSet = true
