...
func (o *CommunicationTypeType) GetManagedBy() ManagedByOptions {
...
// and a boolean to check if the value has been set.
func (o *CommunicationTypeType) GetManagedByOk() (*ManagedByOptions, bool) {
	if o == nil || IsNil(o.ManagedBy) {
		return nil, false
	}
...
func (o *CommunicationTypeType) HasManagedBy() bool {
	if o != nil && !IsNil(o.ManagedBy) {
		return true
	}
...
func (o *CommunicationTypeType) SetManagedBy(v ManagedByOptions) {
	o.ManagedBy = &v
}
