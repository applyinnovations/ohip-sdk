...
// checks if the AddressTypesToBeChanged type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AddressTypesToBeChanged{}

// AddressTypesToBeChanged Request object for changing an existing Address Type.
type AddressTypesToBeChanged struct {
...
func (o AddressTypesToBeChanged) MarshalJSON() ([]byte, error) {
...
func (o AddressTypesToBeChanged) ToMap() (map[string]interface{}, error) {
...
type NullableAddressTypesToBeChanged struct {
	value *AddressTypesToBeChanged
	isSet bool
}

func (v NullableAddressTypesToBeChanged) Get() *AddressTypesToBeChanged {
	return v.value
}

func (v *NullableAddressTypesToBeChanged) Set(val *AddressTypesToBeChanged) {
	v.value = val
	v.isSet = true
}

func (v NullableAddressTypesToBeChanged) IsSet() bool {
	return v.isSet
}

func (v *NullableAddressTypesToBeChanged) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAddressTypesToBeChanged(val *AddressTypesToBeChanged) *NullableAddressTypesToBeChanged {
	return &NullableAddressTypesToBeChanged{value: val, isSet: true}
}

func (v NullableAddressTypesToBeChanged) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAddressTypesToBeChanged) UnmarshalJSON(src []byte) error {
	v.isSet = true
