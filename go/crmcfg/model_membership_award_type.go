...
type MembershipAwardType struct {
	...
	RateDiscountInfo *MembershipAwardRateDiscountInfoType `json:"rateDiscountInfo,omitempty"`
	// Membership Award Rate details.
	AwardDetails []MembershipAwardDetailType `json:"awardDetails,omitempty"`
...
// GetRateDiscountInfo returns the RateDiscountInfo field value if set, zero value otherwise.
func (o *MembershipAwardType) GetRateDiscountInfo() MembershipAwardRateDiscountInfoType {
	if o == nil || IsNil(o.RateDiscountInfo) {
		var ret MembershipAwardRateDiscountInfoType
		return ret
	}
	return *o.RateDiscountInfo
}

// GetRateDiscountInfoOk returns a tuple with the RateDiscountInfo field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *MembershipAwardType) GetRateDiscountInfoOk() (*MembershipAwardRateDiscountInfoType, bool) {
	if o == nil || IsNil(o.RateDiscountInfo) {
		return nil, false
	}
	return o.RateDiscountInfo, true
}

// HasRateDiscountInfo returns a boolean if a field has been set.
func (o *MembershipAwardType) HasRateDiscountInfo() bool {
	if o != nil && !IsNil(o.RateDiscountInfo) {
		return true
	}
...
// SetRateDiscountInfo gets a reference to the given MembershipAwardRateDiscountInfoType and assigns it to the RateDiscountInfo field.
func (o *MembershipAwardType) SetRateDiscountInfo(v MembershipAwardRateDiscountInfoType) {
	o.RateDiscountInfo = &v
}
...
func (o *MembershipAwardType) GetAwardDetails() []MembershipAwardDetailType {
	if o == nil || IsNil(o.AwardDetails) {
		var ret []MembershipAwardDetailType
		return ret
	}
...
// SetAwardDetails gets a reference to the given []MembershipAwardDetailType and assigns it to the AwardDetails field.
...
func (o *MembershipAwardType) GetManagedBy() ManagedByOptions {
...
// and a boolean to check if the value has been set.
func (o *MembershipAwardType) GetManagedByOk() (*ManagedByOptions, bool) {
	if o == nil || IsNil(o.ManagedBy) {
		return nil, false
	}
...
func (o *MembershipAwardType) HasManagedBy() bool {
	if o != nil && !IsNil(o.ManagedBy) {
		return true
	}
...
func (o *MembershipAwardType) SetManagedBy(v ManagedByOptions) {
	o.ManagedBy = &v
}
...
func (o MembershipAwardType) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.RateDiscountInfo) {
		toSerialize["rateDiscountInfo"] = o.RateDiscountInfo
	}
