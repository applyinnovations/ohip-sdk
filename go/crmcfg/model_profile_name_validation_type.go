...
func (o *ProfileNameValidationType) GetManagedBy() ManagedByOptions {
...
// and a boolean to check if the value has been set.
func (o *ProfileNameValidationType) GetManagedByOk() (*ManagedByOptions, bool) {
	if o == nil || IsNil(o.ManagedBy) {
		return nil, false
	}
...
func (o *ProfileNameValidationType) HasManagedBy() bool {
	if o != nil && !IsNil(o.ManagedBy) {
		return true
	}
...
func (o *ProfileNameValidationType) SetManagedBy(v ManagedByOptions) {
	o.ManagedBy = &v
}
