...
// checks if the IdentificationTypesCriteria type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &IdentificationTypesCriteria{}

// IdentificationTypesCriteria Request object for creating Identification Types.
type IdentificationTypesCriteria struct {
...
func NewIdentificationTypesCriteria() *IdentificationTypesCriteria {
	this := IdentificationTypesCriteria{}
	return &this
}
...
func (o IdentificationTypesCriteria) MarshalJSON() ([]byte, error) {
...
func (o IdentificationTypesCriteria) ToMap() (map[string]interface{}, error) {
...
type NullableIdentificationTypesCriteria struct {
	value *IdentificationTypesCriteria
	isSet bool
}

func (v NullableIdentificationTypesCriteria) Get() *IdentificationTypesCriteria {
	return v.value
}

func (v *NullableIdentificationTypesCriteria) Set(val *IdentificationTypesCriteria) {
	v.value = val
	v.isSet = true
}

func (v NullableIdentificationTypesCriteria) IsSet() bool {
	return v.isSet
}

func (v *NullableIdentificationTypesCriteria) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableIdentificationTypesCriteria(val *IdentificationTypesCriteria) *NullableIdentificationTypesCriteria {
	return &NullableIdentificationTypesCriteria{value: val, isSet: true}
}

func (v NullableIdentificationTypesCriteria) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableIdentificationTypesCriteria) UnmarshalJSON(src []byte) error {
	v.isSet = true
