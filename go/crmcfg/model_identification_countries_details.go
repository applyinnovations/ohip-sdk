...
// checks if the IdentificationCountriesDetails type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &IdentificationCountriesDetails{}

// IdentificationCountriesDetails Response object for fetching Identification Countries.
type IdentificationCountriesDetails struct {
...
func NewIdentificationCountriesDetails() *IdentificationCountriesDetails {
	this := IdentificationCountriesDetails{}
	return &this
}
...
func (o IdentificationCountriesDetails) MarshalJSON() ([]byte, error) {
...
func (o IdentificationCountriesDetails) ToMap() (map[string]interface{}, error) {
...
type NullableIdentificationCountriesDetails struct {
	value *IdentificationCountriesDetails
	isSet bool
}

func (v NullableIdentificationCountriesDetails) Get() *IdentificationCountriesDetails {
	return v.value
}

func (v *NullableIdentificationCountriesDetails) Set(val *IdentificationCountriesDetails) {
	v.value = val
	v.isSet = true
}

func (v NullableIdentificationCountriesDetails) IsSet() bool {
	return v.isSet
}

func (v *NullableIdentificationCountriesDetails) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableIdentificationCountriesDetails(val *IdentificationCountriesDetails) *NullableIdentificationCountriesDetails {
	return &NullableIdentificationCountriesDetails{value: val, isSet: true}
}

func (v NullableIdentificationCountriesDetails) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableIdentificationCountriesDetails) UnmarshalJSON(src []byte) error {
	v.isSet = true
