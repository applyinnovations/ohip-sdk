...
func (o *GuestTitleType) GetManagedBy() ManagedByOptions {
...
// and a boolean to check if the value has been set.
func (o *GuestTitleType) GetManagedByOk() (*ManagedByOptions, bool) {
	if o == nil || IsNil(o.ManagedBy) {
		return nil, false
	}
...
func (o *GuestTitleType) HasManagedBy() bool {
	if o != nil && !IsNil(o.ManagedBy) {
		return true
	}
...
func (o *GuestTitleType) SetManagedBy(v ManagedByOptions) {
	o.ManagedBy = &v
}
