...
func (o *MembershipRateType) GetManagedBy() ManagedByOptions {
...
// and a boolean to check if the value has been set.
func (o *MembershipRateType) GetManagedByOk() (*ManagedByOptions, bool) {
	if o == nil || IsNil(o.ManagedBy) {
		return nil, false
	}
...
func (o *MembershipRateType) HasManagedBy() bool {
	if o != nil && !IsNil(o.ManagedBy) {
		return true
	}
...
func (o *MembershipRateType) SetManagedBy(v ManagedByOptions) {
	o.ManagedBy = &v
}
