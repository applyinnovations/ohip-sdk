...
func (o *MembershipOriginGroupType) GetManagedBy() ManagedByOptions {
...
// and a boolean to check if the value has been set.
func (o *MembershipOriginGroupType) GetManagedByOk() (*ManagedByOptions, bool) {
	if o == nil || IsNil(o.ManagedBy) {
		return nil, false
	}
...
func (o *MembershipOriginGroupType) HasManagedBy() bool {
	if o != nil && !IsNil(o.ManagedBy) {
		return true
	}
...
func (o *MembershipOriginGroupType) SetManagedBy(v ManagedByOptions) {
	o.ManagedBy = &v
}
