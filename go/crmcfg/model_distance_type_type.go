...
// checks if the DistanceTypeType type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DistanceTypeType{}

// DistanceTypeType Contains Common Master configuration detail.
type DistanceTypeType struct {
...
func (o DistanceTypeType) MarshalJSON() ([]byte, error) {
...
func (o DistanceTypeType) ToMap() (map[string]interface{}, error) {
...
type NullableDistanceTypeType struct {
	value *DistanceTypeType
	isSet bool
}

func (v NullableDistanceTypeType) Get() *DistanceTypeType {
	return v.value
}

func (v *NullableDistanceTypeType) Set(val *DistanceTypeType) {
	v.value = val
	v.isSet = true
}

func (v NullableDistanceTypeType) IsSet() bool {
	return v.isSet
}

func (v *NullableDistanceTypeType) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDistanceTypeType(val *DistanceTypeType) *NullableDistanceTypeType {
	return &NullableDistanceTypeType{value: val, isSet: true}
}

func (v NullableDistanceTypeType) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDistanceTypeType) UnmarshalJSON(src []byte) error {
	v.isSet = true
