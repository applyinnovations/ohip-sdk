...
// checks if the MembershipClaimOriginType type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MembershipClaimOriginType{}

// MembershipClaimOriginType Contains Common Master configuration detail.
type MembershipClaimOriginType struct {
...
func NewMembershipClaimOriginType() *MembershipClaimOriginType {
	this := MembershipClaimOriginType{}
	return &this
}
...
func (o MembershipClaimOriginType) MarshalJSON() ([]byte, error) {
...
func (o MembershipClaimOriginType) ToMap() (map[string]interface{}, error) {
...
type NullableMembershipClaimOriginType struct {
	value *MembershipClaimOriginType
	isSet bool
}

func (v NullableMembershipClaimOriginType) Get() *MembershipClaimOriginType {
	return v.value
}

func (v *NullableMembershipClaimOriginType) Set(val *MembershipClaimOriginType) {
	v.value = val
	v.isSet = true
}

func (v NullableMembershipClaimOriginType) IsSet() bool {
	return v.isSet
}

func (v *NullableMembershipClaimOriginType) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMembershipClaimOriginType(val *MembershipClaimOriginType) *NullableMembershipClaimOriginType {
	return &NullableMembershipClaimOriginType{value: val, isSet: true}
}

func (v NullableMembershipClaimOriginType) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMembershipClaimOriginType) UnmarshalJSON(src []byte) error {
	v.isSet = true
