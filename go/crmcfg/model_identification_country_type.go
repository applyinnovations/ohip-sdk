...
// checks if the IdentificationCountryType type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &IdentificationCountryType{}

// IdentificationCountryType Contains Common Master configuration detail.
type IdentificationCountryType struct {
...
func NewIdentificationCountryType() *IdentificationCountryType {
	this := IdentificationCountryType{}
	return &this
}
...
func (o IdentificationCountryType) MarshalJSON() ([]byte, error) {
...
func (o IdentificationCountryType) ToMap() (map[string]interface{}, error) {
...
type NullableIdentificationCountryType struct {
	value *IdentificationCountryType
	isSet bool
}

func (v NullableIdentificationCountryType) Get() *IdentificationCountryType {
	return v.value
}

func (v *NullableIdentificationCountryType) Set(val *IdentificationCountryType) {
	v.value = val
	v.isSet = true
}

func (v NullableIdentificationCountryType) IsSet() bool {
	return v.isSet
}

func (v *NullableIdentificationCountryType) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableIdentificationCountryType(val *IdentificationCountryType) *NullableIdentificationCountryType {
	return &NullableIdentificationCountryType{value: val, isSet: true}
}

func (v NullableIdentificationCountryType) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableIdentificationCountryType) UnmarshalJSON(src []byte) error {
	v.isSet = true
