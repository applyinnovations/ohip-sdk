...
// checks if the AccountTypesCriteria type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AccountTypesCriteria{}

// AccountTypesCriteria Request object for creating Account Types.
type AccountTypesCriteria struct {
...
func (o AccountTypesCriteria) MarshalJSON() ([]byte, error) {
...
func (o AccountTypesCriteria) ToMap() (map[string]interface{}, error) {
...
type NullableAccountTypesCriteria struct {
	value *AccountTypesCriteria
	isSet bool
}

func (v NullableAccountTypesCriteria) Get() *AccountTypesCriteria {
	return v.value
}

func (v *NullableAccountTypesCriteria) Set(val *AccountTypesCriteria) {
	v.value = val
	v.isSet = true
}

func (v NullableAccountTypesCriteria) IsSet() bool {
	return v.isSet
}

func (v *NullableAccountTypesCriteria) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAccountTypesCriteria(val *AccountTypesCriteria) *NullableAccountTypesCriteria {
	return &NullableAccountTypesCriteria{value: val, isSet: true}
}

func (v NullableAccountTypesCriteria) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAccountTypesCriteria) UnmarshalJSON(src []byte) error {
	v.isSet = true
