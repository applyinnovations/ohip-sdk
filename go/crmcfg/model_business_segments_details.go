...
// checks if the BusinessSegmentsDetails type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BusinessSegmentsDetails{}

// BusinessSegmentsDetails Response object for fetching Business Segments.
type BusinessSegmentsDetails struct {
...
func (o BusinessSegmentsDetails) MarshalJSON() ([]byte, error) {
...
func (o BusinessSegmentsDetails) ToMap() (map[string]interface{}, error) {
...
type NullableBusinessSegmentsDetails struct {
	value *BusinessSegmentsDetails
	isSet bool
}

func (v NullableBusinessSegmentsDetails) Get() *BusinessSegmentsDetails {
	return v.value
}

func (v *NullableBusinessSegmentsDetails) Set(val *BusinessSegmentsDetails) {
	v.value = val
	v.isSet = true
}

func (v NullableBusinessSegmentsDetails) IsSet() bool {
	return v.isSet
}

func (v *NullableBusinessSegmentsDetails) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBusinessSegmentsDetails(val *BusinessSegmentsDetails) *NullableBusinessSegmentsDetails {
	return &NullableBusinessSegmentsDetails{value: val, isSet: true}
}

func (v NullableBusinessSegmentsDetails) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBusinessSegmentsDetails) UnmarshalJSON(src []byte) error {
	v.isSet = true
