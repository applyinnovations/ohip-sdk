...
```golang
import rmr "github.com/applyinnovations/ohip-sdk/go/rmr/v3"
```
...
*RoomRotationAPI* | [**PingRoomRotationService**](docs/RoomRotationAPI.md#pingroomrotationservice) | **Get** /services/roomrotation/status | Ping
...
*RoomRotationAPI* | [**SearchReservationRotationPoints**](docs/RoomRotationAPI.md#searchreservationrotationpoints) | **Post** /hotels/{hotelId}/departureStartDate/{departureStartDate}/departureEndDate/{departureEndDate}/reservationRotationPoints/searches | Get list of reservations and the associated rotations points
*RoomRotationAPI* | [**SearchRoomOwners**](docs/RoomRotationAPI.md#searchroomowners) | **Post** /roomOwners/searches | Get Room Owners Details
...
## Documentation For Models
 ...
 - [SearchReservationRotationPointsRequest](docs/SearchReservationRotationPointsRequest.md)
 - [SearchRoomOwnersRequest](docs/SearchRoomOwnersRequest.md)
