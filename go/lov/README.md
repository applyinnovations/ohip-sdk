...
```golang
import lov "github.com/applyinnovations/ohip-sdk/go/lov/v3"
```
...
*LOVAPI* | [**GetInterfaceTrxCodesAllChargesLOV**](docs/LOVAPI.md#getinterfacetrxcodesallchargeslov) | **Get** /listOfValues/hotels/{hotelId}/interfaceTrxCodesAllCharges | Return list of values for hotel interface transaction codes all charges
