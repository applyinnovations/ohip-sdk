...
func (o *ActivityTypeDetailType) GetManagedBy() ManagedByOptions {
...
// and a boolean to check if the value has been set.
func (o *ActivityTypeDetailType) GetManagedByOk() (*ManagedByOptions, bool) {
	if o == nil || IsNil(o.ManagedBy) {
		return nil, false
	}
...
func (o *ActivityTypeDetailType) HasManagedBy() bool {
	if o != nil && !IsNil(o.ManagedBy) {
		return true
	}
...
func (o *ActivityTypeDetailType) SetManagedBy(v ManagedByOptions) {
	o.ManagedBy = &v
}
