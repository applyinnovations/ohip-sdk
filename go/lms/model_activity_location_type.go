...
func (o *ActivityLocationType) GetManagedBy() ManagedByOptions {
...
// and a boolean to check if the value has been set.
func (o *ActivityLocationType) GetManagedByOk() (*ManagedByOptions, bool) {
	if o == nil || IsNil(o.ManagedBy) {
		return nil, false
	}
...
func (o *ActivityLocationType) HasManagedBy() bool {
	if o != nil && !IsNil(o.ManagedBy) {
		return true
	}
...
func (o *ActivityLocationType) SetManagedBy(v ManagedByOptions) {
	o.ManagedBy = &v
}
