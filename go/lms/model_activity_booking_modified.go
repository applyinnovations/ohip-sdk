...
// checks if the ActivityBookingModified type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ActivityBookingModified{}

// ActivityBookingModified struct for ActivityBookingModified
type ActivityBookingModified struct {
	ActivityBooking *ActivityBookingRSType `json:"activityBooking,omitempty"`
...
// SetActivityBooking gets a reference to the given ActivityBookingRSType and assigns it to the ActivityBooking field.
...
func (o ActivityBookingModified) MarshalJSON() ([]byte, error) {
...
func (o ActivityBookingModified) ToMap() (map[string]interface{}, error) {
...
type NullableActivityBookingModified struct {
	value *ActivityBookingModified
	isSet bool
}

func (v NullableActivityBookingModified) Get() *ActivityBookingModified {
	return v.value
}

func (v *NullableActivityBookingModified) Set(val *ActivityBookingModified) {
	v.value = val
	v.isSet = true
}

func (v NullableActivityBookingModified) IsSet() bool {
	return v.isSet
}

func (v *NullableActivityBookingModified) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableActivityBookingModified(val *ActivityBookingModified) *NullableActivityBookingModified {
	return &NullableActivityBookingModified{value: val, isSet: true}
}

func (v NullableActivityBookingModified) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableActivityBookingModified) UnmarshalJSON(src []byte) error {
	v.isSet = true
