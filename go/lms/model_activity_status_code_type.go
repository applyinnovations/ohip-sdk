...
func (o *ActivityStatusCodeType) GetManagedBy() ManagedByOptions {
...
// and a boolean to check if the value has been set.
func (o *ActivityStatusCodeType) GetManagedByOk() (*ManagedByOptions, bool) {
	if o == nil || IsNil(o.ManagedBy) {
		return nil, false
	}
...
func (o *ActivityStatusCodeType) HasManagedBy() bool {
	if o != nil && !IsNil(o.ManagedBy) {
		return true
	}
...
func (o *ActivityStatusCodeType) SetManagedBy(v ManagedByOptions) {
	o.ManagedBy = &v
}
