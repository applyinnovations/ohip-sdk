...
```golang
import lms "github.com/applyinnovations/ohip-sdk/go/lms/v3"
```
...
*LeisureManagementConfigAPI* | [**PutUpsertActivityLocations**](docs/LeisureManagementConfigAPI.md#putupsertactivitylocations) | **Put** /upsert/activityLocations/{activityLocationsId} | Create/Change in Activity Locations
*LeisureManagementConfigAPI* | [**PutUpsertActivityStatusCodes**](docs/LeisureManagementConfigAPI.md#putupsertactivitystatuscodes) | **Put** /upsert/activityStatusCodes/{activityStatusCodesId} | Create/Change Activity Status Code
*LeisureManagementConfigAPI* | [**PutUpsertActivityTypes**](docs/LeisureManagementConfigAPI.md#putupsertactivitytypes) | **Put** /upsert/activityTypes/{activityTypesId} | Create/Change Activity Types
