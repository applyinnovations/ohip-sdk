...
type TourSeriesType struct {
	...
	MasterBlockCode *string `json:"masterBlockCode,omitempty"`
	// When true, Itinerary type is enabled for tour series.
	Itinerary *bool `json:"itinerary,omitempty"`
...
// GetMasterBlockCode returns the MasterBlockCode field value if set, zero value otherwise.
func (o *TourSeriesType) GetMasterBlockCode() string {
	if o == nil || IsNil(o.MasterBlockCode) {
		var ret string
		return ret
	}
	return *o.MasterBlockCode
}

// GetMasterBlockCodeOk returns a tuple with the MasterBlockCode field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *TourSeriesType) GetMasterBlockCodeOk() (*string, bool) {
	if o == nil || IsNil(o.MasterBlockCode) {
		return nil, false
	}
	return o.MasterBlockCode, true
}
...
// SetMasterBlockCode gets a reference to the given string and assigns it to the MasterBlockCode field.
func (o *TourSeriesType) SetMasterBlockCode(v string) {
	o.MasterBlockCode = &v
}

// GetItinerary returns the Itinerary field value if set, zero value otherwise.
func (o *TourSeriesType) GetItinerary() bool {
	if o == nil || IsNil(o.Itinerary) {
		var ret bool
		return ret
	}
	return *o.Itinerary
...
// GetItineraryOk returns a tuple with the Itinerary field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *TourSeriesType) GetItineraryOk() (*bool, bool) {
	if o == nil || IsNil(o.Itinerary) {
		return nil, false
	}
	return o.Itinerary, true
}
...
// SetItinerary gets a reference to the given bool and assigns it to the Itinerary field.
...
func (o TourSeriesType) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.MasterBlockCode) {
		toSerialize["masterBlockCode"] = o.MasterBlockCode
	}
	if !IsNil(o.Itinerary) {
		toSerialize["itinerary"] = o.Itinerary
	}
