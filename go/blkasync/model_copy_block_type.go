...
type CopyBlockType struct {
	...
	NewBlock *CopiedBlockDetailsType `json:"newBlock,omitempty"`
	// Collection of sub block details that will be copied along with the source master block.
	SubBlocks []CopySubBlockDetail `json:"subBlocks,omitempty"`
...
func (o *CopyBlockType) GetNewBlock() CopiedBlockDetailsType {
	if o == nil || IsNil(o.NewBlock) {
		var ret CopiedBlockDetailsType
		return ret
	}
	return *o.NewBlock
}
...
// and a boolean to check if the value has been set.
func (o *CopyBlockType) GetNewBlockOk() (*CopiedBlockDetailsType, bool) {
	if o == nil || IsNil(o.NewBlock) {
		return nil, false
	}
...
// SetNewBlock gets a reference to the given CopiedBlockDetailsType and assigns it to the NewBlock field.
func (o *CopyBlockType) SetNewBlock(v CopiedBlockDetailsType) {
	o.NewBlock = &v
}

// GetSubBlocks returns the SubBlocks field value if set, zero value otherwise.
func (o *CopyBlockType) GetSubBlocks() []CopySubBlockDetail {
	if o == nil || IsNil(o.SubBlocks) {
		var ret []CopySubBlockDetail
		return ret
	}
	return o.SubBlocks
}

// GetSubBlocksOk returns a tuple with the SubBlocks field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *CopyBlockType) GetSubBlocksOk() ([]CopySubBlockDetail, bool) {
	if o == nil || IsNil(o.SubBlocks) {
		return nil, false
	}
	return o.SubBlocks, true
}
...
// SetSubBlocks gets a reference to the given []CopySubBlockDetail and assigns it to the SubBlocks field.
...
func (o CopyBlockType) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.SubBlocks) {
		toSerialize["subBlocks"] = o.SubBlocks
	}
