...
type BlockAvailabilityType struct {
	...
	BlockTotalAvailability *BlockTotalAvailabilityInfoType `json:"blockTotalAvailability,omitempty"`
	BlockTotalAvailabilityRooms *BlockTotalAvailabilityInfoType `json:"blockTotalAvailabilityRooms,omitempty"`
}
...
// GetBlockTotalAvailability returns the BlockTotalAvailability field value if set, zero value otherwise.
func (o *BlockAvailabilityType) GetBlockTotalAvailability() BlockTotalAvailabilityInfoType {
	if o == nil || IsNil(o.BlockTotalAvailability) {
		var ret BlockTotalAvailabilityInfoType
		return ret
	}
	return *o.BlockTotalAvailability
}

// GetBlockTotalAvailabilityOk returns a tuple with the BlockTotalAvailability field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *BlockAvailabilityType) GetBlockTotalAvailabilityOk() (*BlockTotalAvailabilityInfoType, bool) {
	if o == nil || IsNil(o.BlockTotalAvailability) {
		return nil, false
	}
	return o.BlockTotalAvailability, true
}
...
// SetBlockTotalAvailability gets a reference to the given BlockTotalAvailabilityInfoType and assigns it to the BlockTotalAvailability field.
func (o *BlockAvailabilityType) SetBlockTotalAvailability(v BlockTotalAvailabilityInfoType) {
	o.BlockTotalAvailability = &v
}

// GetBlockTotalAvailabilityRooms returns the BlockTotalAvailabilityRooms field value if set, zero value otherwise.
func (o *BlockAvailabilityType) GetBlockTotalAvailabilityRooms() BlockTotalAvailabilityInfoType {
	if o == nil || IsNil(o.BlockTotalAvailabilityRooms) {
		var ret BlockTotalAvailabilityInfoType
		return ret
	}
	return *o.BlockTotalAvailabilityRooms
}

// GetBlockTotalAvailabilityRoomsOk returns a tuple with the BlockTotalAvailabilityRooms field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *BlockAvailabilityType) GetBlockTotalAvailabilityRoomsOk() (*BlockTotalAvailabilityInfoType, bool) {
	if o == nil || IsNil(o.BlockTotalAvailabilityRooms) {
		return nil, false
	}
	return o.BlockTotalAvailabilityRooms, true
}
...
// SetBlockTotalAvailabilityRooms gets a reference to the given BlockTotalAvailabilityInfoType and assigns it to the BlockTotalAvailabilityRooms field.
func (o *BlockAvailabilityType) SetBlockTotalAvailabilityRooms(v BlockTotalAvailabilityInfoType) {
	o.BlockTotalAvailabilityRooms = &v
}
...
func (o BlockAvailabilityType) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.BlockTotalAvailability) {
		toSerialize["blockTotalAvailability"] = o.BlockTotalAvailability
	}
	if !IsNil(o.BlockTotalAvailabilityRooms) {
		toSerialize["blockTotalAvailabilityRooms"] = o.BlockTotalAvailabilityRooms
	}
