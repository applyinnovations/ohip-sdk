...
// checks if the TrackItId type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TrackItId{}

// TrackItId An identifier used to uniquely reference an object in a system (e.g. an airline reservation reference, customer profile reference, booking confirmation number, or a reference to a previous availability quote).
type TrackItId struct {
...
func (o TrackItId) MarshalJSON() ([]byte, error) {
...
func (o TrackItId) ToMap() (map[string]interface{}, error) {
...
type NullableTrackItId struct {
	value *TrackItId
	isSet bool
}

func (v NullableTrackItId) Get() *TrackItId {
	return v.value
}

func (v *NullableTrackItId) Set(val *TrackItId) {
	v.value = val
	v.isSet = true
}

func (v NullableTrackItId) IsSet() bool {
	return v.isSet
}

func (v *NullableTrackItId) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTrackItId(val *TrackItId) *NullableTrackItId {
	return &NullableTrackItId{value: val, isSet: true}
}

func (v NullableTrackItId) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTrackItId) UnmarshalJSON(src []byte) error {
	v.isSet = true
