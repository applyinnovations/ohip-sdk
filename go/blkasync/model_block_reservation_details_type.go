...
type BlockReservationDetailsType struct {
	...
	CutoffScheduleCode *string `json:"cutoffScheduleCode,omitempty"`
...
// GetCutoffScheduleCode returns the CutoffScheduleCode field value if set, zero value otherwise.
func (o *BlockReservationDetailsType) GetCutoffScheduleCode() string {
	if o == nil || IsNil(o.CutoffScheduleCode) {
		var ret string
		return ret
	}
	return *o.CutoffScheduleCode
}

// GetCutoffScheduleCodeOk returns a tuple with the CutoffScheduleCode field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *BlockReservationDetailsType) GetCutoffScheduleCodeOk() (*string, bool) {
	if o == nil || IsNil(o.CutoffScheduleCode) {
		return nil, false
	}
	return o.CutoffScheduleCode, true
}
...
// SetCutoffScheduleCode gets a reference to the given string and assigns it to the CutoffScheduleCode field.
func (o *BlockReservationDetailsType) SetCutoffScheduleCode(v string) {
	o.CutoffScheduleCode = &v
}
...
func (o BlockReservationDetailsType) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.CutoffScheduleCode) {
		toSerialize["cutoffScheduleCode"] = o.CutoffScheduleCode
	}
