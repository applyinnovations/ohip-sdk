...
type Criteria struct {
	...
	// Boolean flag that indicates whether net rates are to be fetched or not. By default, this value is false. 
	IncludeNetRates *bool `json:"includeNetRates,omitempty"`
}
...
func NewCriteria() *Criteria {
	this := Criteria{}
	var includeNetRates bool = false
	this.IncludeNetRates = &includeNetRates
	return &this
}
...
// GetIncludeNetRates returns the IncludeNetRates field value if set, zero value otherwise.
func (o *Criteria) GetIncludeNetRates() bool {
	if o == nil || IsNil(o.IncludeNetRates) {
		var ret bool
		return ret
	}
	return *o.IncludeNetRates
}

// GetIncludeNetRatesOk returns a tuple with the IncludeNetRates field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *Criteria) GetIncludeNetRatesOk() (*bool, bool) {
	if o == nil || IsNil(o.IncludeNetRates) {
		return nil, false
	}
	return o.IncludeNetRates, true
}

// HasIncludeNetRates returns a boolean if a field has been set.
func (o *Criteria) HasIncludeNetRates() bool {
	if o != nil && !IsNil(o.IncludeNetRates) {
		return true
	}
...
// SetIncludeNetRates gets a reference to the given bool and assigns it to the IncludeNetRates field.
func (o *Criteria) SetIncludeNetRates(v bool) {
	o.IncludeNetRates = &v
}
...
func (o Criteria) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.IncludeNetRates) {
		toSerialize["includeNetRates"] = o.IncludeNetRates
	}
