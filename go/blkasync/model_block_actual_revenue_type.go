...
// checks if the BlockActualRevenueType type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BlockActualRevenueType{}

// BlockActualRevenueType Indicates the sum of revenue breakup per room type per block per allocation date for the reservations. Applicable for past dates, business date or future dates.
type BlockActualRevenueType struct {
...
func (o BlockActualRevenueType) MarshalJSON() ([]byte, error) {
...
func (o BlockActualRevenueType) ToMap() (map[string]interface{}, error) {
...
type NullableBlockActualRevenueType struct {
	value *BlockActualRevenueType
	isSet bool
}

func (v NullableBlockActualRevenueType) Get() *BlockActualRevenueType {
	return v.value
}

func (v *NullableBlockActualRevenueType) Set(val *BlockActualRevenueType) {
	v.value = val
	v.isSet = true
}

func (v NullableBlockActualRevenueType) IsSet() bool {
	return v.isSet
}

func (v *NullableBlockActualRevenueType) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBlockActualRevenueType(val *BlockActualRevenueType) *NullableBlockActualRevenueType {
	return &NullableBlockActualRevenueType{value: val, isSet: true}
}

func (v NullableBlockActualRevenueType) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBlockActualRevenueType) UnmarshalJSON(src []byte) error {
	v.isSet = true
