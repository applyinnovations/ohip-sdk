...
type BlockDetailsType struct {
	...
	BlockAliases []string `json:"blockAliases,omitempty"`
	...
	// Flag to determine if user wants to overbook sales allowance.
	...
	IsCentralSalesLead *bool `json:"isCentralSalesLead,omitempty"`
	// Resort name of central sales lead for this property lead.
	CentralSalesLeadResort *string `json:"centralSalesLeadResort,omitempty"`
	// Central sales lead id of the central sales lead for this property lead.
	CentralSalesLeadId *string `json:"centralSalesLeadId,omitempty"`
	// Indicate if Master/Sub Blocks are Synchronized.
	Synchronized *bool `json:"synchronized,omitempty"`
	// Unique Id that references an object uniquely in the system.
	SubBlockIdList []UniqueIDType `json:"subBlockIdList,omitempty"`
	...
	// Indicates if forecast grid will be auto loaded from original grid.
	AutoloadForecastGrid *bool `json:"autoloadForecastGrid,omitempty"`
	...
	// Indicates if block has any linked activity(s).
	HasLinkedActivities *bool `json:"hasLinkedActivities,omitempty"`
	...
	// Indicates whether block code template can be overridden.
	OverrideBlockCodeTemplate *bool `json:"overrideBlockCodeTemplate,omitempty"`
}
...
// SetBlockAliases gets a reference to the given []string and assigns it to the BlockAliases field.
...
// GetIsCentralSalesLead returns the IsCentralSalesLead field value if set, zero value otherwise.
func (o *BlockDetailsType) GetIsCentralSalesLead() bool {
	if o == nil || IsNil(o.IsCentralSalesLead) {
		var ret bool
		return ret
	}
	return *o.IsCentralSalesLead
}

// GetIsCentralSalesLeadOk returns a tuple with the IsCentralSalesLead field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *BlockDetailsType) GetIsCentralSalesLeadOk() (*bool, bool) {
	if o == nil || IsNil(o.IsCentralSalesLead) {
		return nil, false
	}
	return o.IsCentralSalesLead, true
}
...
// SetIsCentralSalesLead gets a reference to the given bool and assigns it to the IsCentralSalesLead field.
func (o *BlockDetailsType) SetIsCentralSalesLead(v bool) {
	o.IsCentralSalesLead = &v
}

// GetCentralSalesLeadResort returns the CentralSalesLeadResort field value if set, zero value otherwise.
func (o *BlockDetailsType) GetCentralSalesLeadResort() string {
	if o == nil || IsNil(o.CentralSalesLeadResort) {
		var ret string
		return ret
	}
	return *o.CentralSalesLeadResort
}

// GetCentralSalesLeadResortOk returns a tuple with the CentralSalesLeadResort field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *BlockDetailsType) GetCentralSalesLeadResortOk() (*string, bool) {
	if o == nil || IsNil(o.CentralSalesLeadResort) {
		return nil, false
	}
	return o.CentralSalesLeadResort, true
}
...
// SetCentralSalesLeadResort gets a reference to the given string and assigns it to the CentralSalesLeadResort field.
func (o *BlockDetailsType) SetCentralSalesLeadResort(v string) {
	o.CentralSalesLeadResort = &v
}

// GetCentralSalesLeadId returns the CentralSalesLeadId field value if set, zero value otherwise.
func (o *BlockDetailsType) GetCentralSalesLeadId() string {
	if o == nil || IsNil(o.CentralSalesLeadId) {
		var ret string
		return ret
	}
	return *o.CentralSalesLeadId
}

// GetCentralSalesLeadIdOk returns a tuple with the CentralSalesLeadId field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *BlockDetailsType) GetCentralSalesLeadIdOk() (*string, bool) {
	if o == nil || IsNil(o.CentralSalesLeadId) {
		return nil, false
	}
	return o.CentralSalesLeadId, true
}
...
// SetCentralSalesLeadId gets a reference to the given string and assigns it to the CentralSalesLeadId field.
func (o *BlockDetailsType) SetCentralSalesLeadId(v string) {
	o.CentralSalesLeadId = &v
}
...
// SetSubBlockIdList gets a reference to the given []UniqueIDType and assigns it to the SubBlockIdList field.
...
// GetAutoloadForecastGrid returns the AutoloadForecastGrid field value if set, zero value otherwise.
func (o *BlockDetailsType) GetAutoloadForecastGrid() bool {
	if o == nil || IsNil(o.AutoloadForecastGrid) {
		var ret bool
		return ret
	}
	return *o.AutoloadForecastGrid
}

// GetAutoloadForecastGridOk returns a tuple with the AutoloadForecastGrid field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *BlockDetailsType) GetAutoloadForecastGridOk() (*bool, bool) {
	if o == nil || IsNil(o.AutoloadForecastGrid) {
		return nil, false
	}
	return o.AutoloadForecastGrid, true
}
...
// SetAutoloadForecastGrid gets a reference to the given bool and assigns it to the AutoloadForecastGrid field.
func (o *BlockDetailsType) SetAutoloadForecastGrid(v bool) {
	o.AutoloadForecastGrid = &v
}
...
// GetHasLinkedActivities returns the HasLinkedActivities field value if set, zero value otherwise.
func (o *BlockDetailsType) GetHasLinkedActivities() bool {
	if o == nil || IsNil(o.HasLinkedActivities) {
		var ret bool
		return ret
	}
	return *o.HasLinkedActivities
}

// GetHasLinkedActivitiesOk returns a tuple with the HasLinkedActivities field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *BlockDetailsType) GetHasLinkedActivitiesOk() (*bool, bool) {
	if o == nil || IsNil(o.HasLinkedActivities) {
		return nil, false
	}
	return o.HasLinkedActivities, true
}
...
// SetHasLinkedActivities gets a reference to the given bool and assigns it to the HasLinkedActivities field.
func (o *BlockDetailsType) SetHasLinkedActivities(v bool) {
	o.HasLinkedActivities = &v
}
...
// GetOverrideBlockCodeTemplate returns the OverrideBlockCodeTemplate field value if set, zero value otherwise.
func (o *BlockDetailsType) GetOverrideBlockCodeTemplate() bool {
	if o == nil || IsNil(o.OverrideBlockCodeTemplate) {
		var ret bool
		return ret
	}
	return *o.OverrideBlockCodeTemplate
}

// GetOverrideBlockCodeTemplateOk returns a tuple with the OverrideBlockCodeTemplate field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *BlockDetailsType) GetOverrideBlockCodeTemplateOk() (*bool, bool) {
	if o == nil || IsNil(o.OverrideBlockCodeTemplate) {
		return nil, false
	}
	return o.OverrideBlockCodeTemplate, true
}

// HasOverrideBlockCodeTemplate returns a boolean if a field has been set.
func (o *BlockDetailsType) HasOverrideBlockCodeTemplate() bool {
	if o != nil && !IsNil(o.OverrideBlockCodeTemplate) {
		return true
	}
...
// SetOverrideBlockCodeTemplate gets a reference to the given bool and assigns it to the OverrideBlockCodeTemplate field.
func (o *BlockDetailsType) SetOverrideBlockCodeTemplate(v bool) {
	o.OverrideBlockCodeTemplate = &v
}
...
func (o BlockDetailsType) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.IsCentralSalesLead) {
		toSerialize["isCentralSalesLead"] = o.IsCentralSalesLead
	}
	if !IsNil(o.CentralSalesLeadResort) {
		toSerialize["centralSalesLeadResort"] = o.CentralSalesLeadResort
	}
	if !IsNil(o.CentralSalesLeadId) {
		toSerialize["centralSalesLeadId"] = o.CentralSalesLeadId
	}
	...
	if !IsNil(o.AutoloadForecastGrid) {
		toSerialize["autoloadForecastGrid"] = o.AutoloadForecastGrid
	}
	if !IsNil(o.AllowRateOverride) {
		toSerialize["allowRateOverride"] = o.AllowRateOverride
	}
	if !IsNil(o.HasLinkedActivities) {
		toSerialize["hasLinkedActivities"] = o.HasLinkedActivities
	}
	...
	if !IsNil(o.OverrideBlockCodeTemplate) {
		toSerialize["overrideBlockCodeTemplate"] = o.OverrideBlockCodeTemplate
	}
