...
type CateringType struct {
	...
	ApplyMoveEvents *bool `json:"applyMoveEvents,omitempty"`
...
// GetApplyMoveEvents returns the ApplyMoveEvents field value if set, zero value otherwise.
func (o *CateringType) GetApplyMoveEvents() bool {
	if o == nil || IsNil(o.ApplyMoveEvents) {
		var ret bool
		return ret
	}
	return *o.ApplyMoveEvents
}

// GetApplyMoveEventsOk returns a tuple with the ApplyMoveEvents field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *CateringType) GetApplyMoveEventsOk() (*bool, bool) {
	if o == nil || IsNil(o.ApplyMoveEvents) {
		return nil, false
	}
	return o.ApplyMoveEvents, true
}
...
// SetApplyMoveEvents gets a reference to the given bool and assigns it to the ApplyMoveEvents field.
...
func (o CateringType) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.ApplyMoveEvents) {
		toSerialize["applyMoveEvents"] = o.ApplyMoveEvents
	}
