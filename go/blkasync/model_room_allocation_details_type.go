...
type RoomAllocationDetailsType struct {
	...
	NetRates *BlockGridRatesType `json:"netRates,omitempty"`
...
// GetNetRates returns the NetRates field value if set, zero value otherwise.
func (o *RoomAllocationDetailsType) GetNetRates() BlockGridRatesType {
	if o == nil || IsNil(o.NetRates) {
		var ret BlockGridRatesType
		return ret
	}
	return *o.NetRates
...
// GetNetRatesOk returns a tuple with the NetRates field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *RoomAllocationDetailsType) GetNetRatesOk() (*BlockGridRatesType, bool) {
	if o == nil || IsNil(o.NetRates) {
		return nil, false
	}
	return o.NetRates, true
}

// HasNetRates returns a boolean if a field has been set.
func (o *RoomAllocationDetailsType) HasNetRates() bool {
	if o != nil && !IsNil(o.NetRates) {
		return true
	}
...
// SetNetRates gets a reference to the given BlockGridRatesType and assigns it to the NetRates field.
func (o *RoomAllocationDetailsType) SetNetRates(v BlockGridRatesType) {
	o.NetRates = &v
}
...
func (o RoomAllocationDetailsType) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.NetRates) {
		toSerialize["netRates"] = o.NetRates
	}
