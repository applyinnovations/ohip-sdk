...
// checks if the BlockRevenueChanges type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BlockRevenueChanges{}

// BlockRevenueChanges Response Object of details fetched of revenue log changes of selected block
type BlockRevenueChanges struct {
	// Block Revenue Changes Details
	BlockRevenueChanges []BlockRevenueChangesDetailType `json:"blockRevenueChanges,omitempty"`
...
// GetBlockRevenueChanges returns the BlockRevenueChanges field value if set, zero value otherwise.
func (o *BlockRevenueChanges) GetBlockRevenueChanges() []BlockRevenueChangesDetailType {
	if o == nil || IsNil(o.BlockRevenueChanges) {
		var ret []BlockRevenueChangesDetailType
		return ret
	}
	return o.BlockRevenueChanges
}

// GetBlockRevenueChangesOk returns a tuple with the BlockRevenueChanges field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *BlockRevenueChanges) GetBlockRevenueChangesOk() ([]BlockRevenueChangesDetailType, bool) {
	if o == nil || IsNil(o.BlockRevenueChanges) {
		return nil, false
	}
	return o.BlockRevenueChanges, true
}
...
// SetBlockRevenueChanges gets a reference to the given []BlockRevenueChangesDetailType and assigns it to the BlockRevenueChanges field.
func (o *BlockRevenueChanges) SetBlockRevenueChanges(v []BlockRevenueChangesDetailType) {
	o.BlockRevenueChanges = v
}
...
func (o BlockRevenueChanges) MarshalJSON() ([]byte, error) {
...
func (o BlockRevenueChanges) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.BlockRevenueChanges) {
		toSerialize["blockRevenueChanges"] = o.BlockRevenueChanges
	}
...
type NullableBlockRevenueChanges struct {
	value *BlockRevenueChanges
	isSet bool
}

func (v NullableBlockRevenueChanges) Get() *BlockRevenueChanges {
	return v.value
}

func (v *NullableBlockRevenueChanges) Set(val *BlockRevenueChanges) {
	v.value = val
	v.isSet = true
}

func (v NullableBlockRevenueChanges) IsSet() bool {
	return v.isSet
}

func (v *NullableBlockRevenueChanges) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBlockRevenueChanges(val *BlockRevenueChanges) *NullableBlockRevenueChanges {
	return &NullableBlockRevenueChanges{value: val, isSet: true}
}

func (v NullableBlockRevenueChanges) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBlockRevenueChanges) UnmarshalJSON(src []byte) error {
	v.isSet = true
