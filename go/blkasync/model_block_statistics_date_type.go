...
type BlockStatisticsDateType struct {
	...
	RoomStatisticsList []BlockRoomStatisticsType `json:"roomStatisticsList,omitempty"`
...
func (o *BlockStatisticsDateType) GetRoomStatisticsList() []BlockRoomStatisticsType {
	if o == nil || IsNil(o.RoomStatisticsList) {
		var ret []BlockRoomStatisticsType
		return ret
	}
...
// SetRoomStatisticsList gets a reference to the given []BlockRoomStatisticsType and assigns it to the RoomStatisticsList field.
