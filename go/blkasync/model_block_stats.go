...
// checks if the BlockStats type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BlockStats{}

// BlockStats Response element for block statistics.
type BlockStats struct {
	// Statistical report - each report is determined by the requested report in the service request criteria.
	Reports []BlockStatReportType `json:"reports,omitempty"`
...
// SetReports gets a reference to the given []BlockStatReportType and assigns it to the Reports field.
...
func (o BlockStats) MarshalJSON() ([]byte, error) {
...
func (o BlockStats) ToMap() (map[string]interface{}, error) {
...
type NullableBlockStats struct {
	value *BlockStats
	isSet bool
}

func (v NullableBlockStats) Get() *BlockStats {
	return v.value
}

func (v *NullableBlockStats) Set(val *BlockStats) {
	v.value = val
	v.isSet = true
}

func (v NullableBlockStats) IsSet() bool {
	return v.isSet
}

func (v *NullableBlockStats) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBlockStats(val *BlockStats) *NullableBlockStats {
	return &NullableBlockStats{value: val, isSet: true}
}

func (v NullableBlockStats) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBlockStats) UnmarshalJSON(src []byte) error {
	v.isSet = true
