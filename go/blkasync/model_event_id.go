...
// checks if the EventId type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &EventId{}

// EventId An identifier used to uniquely reference an object in a system (e.g. an airline reservation reference, customer profile reference, booking confirmation number, or a reference to a previous availability quote).
type EventId struct {
...
func (o EventId) MarshalJSON() ([]byte, error) {
...
func (o EventId) ToMap() (map[string]interface{}, error) {
