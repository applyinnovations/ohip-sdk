...
// checks if the BlockDailyStatistics type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BlockDailyStatistics{}

// BlockDailyStatistics Response Object of Fetch Block Daily Statistics.
type BlockDailyStatistics struct {
	// A collection of Blocks.
	BlockDailyStatistics []BlocksDailyStatisticsTypeInner `json:"blockDailyStatistics,omitempty"`
...
// GetBlockDailyStatistics returns the BlockDailyStatistics field value if set, zero value otherwise.
func (o *BlockDailyStatistics) GetBlockDailyStatistics() []BlocksDailyStatisticsTypeInner {
	if o == nil || IsNil(o.BlockDailyStatistics) {
		var ret []BlocksDailyStatisticsTypeInner
		return ret
	}
	return o.BlockDailyStatistics
}

// GetBlockDailyStatisticsOk returns a tuple with the BlockDailyStatistics field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *BlockDailyStatistics) GetBlockDailyStatisticsOk() ([]BlocksDailyStatisticsTypeInner, bool) {
	if o == nil || IsNil(o.BlockDailyStatistics) {
		return nil, false
	}
	return o.BlockDailyStatistics, true
}
...
// SetBlockDailyStatistics gets a reference to the given []BlocksDailyStatisticsTypeInner and assigns it to the BlockDailyStatistics field.
func (o *BlockDailyStatistics) SetBlockDailyStatistics(v []BlocksDailyStatisticsTypeInner) {
	o.BlockDailyStatistics = v
}
...
func (o BlockDailyStatistics) MarshalJSON() ([]byte, error) {
...
func (o BlockDailyStatistics) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.BlockDailyStatistics) {
		toSerialize["blockDailyStatistics"] = o.BlockDailyStatistics
	}
...
type NullableBlockDailyStatistics struct {
	value *BlockDailyStatistics
	isSet bool
}

func (v NullableBlockDailyStatistics) Get() *BlockDailyStatistics {
	return v.value
}

func (v *NullableBlockDailyStatistics) Set(val *BlockDailyStatistics) {
	v.value = val
	v.isSet = true
}

func (v NullableBlockDailyStatistics) IsSet() bool {
	return v.isSet
}

func (v *NullableBlockDailyStatistics) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBlockDailyStatistics(val *BlockDailyStatistics) *NullableBlockDailyStatistics {
	return &NullableBlockDailyStatistics{value: val, isSet: true}
}

func (v NullableBlockDailyStatistics) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBlockDailyStatistics) UnmarshalJSON(src []byte) error {
	v.isSet = true
