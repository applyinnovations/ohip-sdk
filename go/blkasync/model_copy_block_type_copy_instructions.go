...
type CopyBlockTypeCopyInstructions struct {
	...
	MasterBlock *bool `json:"masterBlock,omitempty"`
	// When true, this sub block will be copied as a new regular block.
	CopySubBlockAsRegularBlock *bool `json:"copySubBlockAsRegularBlock,omitempty"`
	// Forecast grid of the source Block will be copied to the Forecast grid of the new Block
	ForecastGrid *bool `json:"forecastGrid,omitempty"`
}
...
// GetMasterBlock returns the MasterBlock field value if set, zero value otherwise.
func (o *CopyBlockTypeCopyInstructions) GetMasterBlock() bool {
	if o == nil || IsNil(o.MasterBlock) {
		var ret bool
		return ret
	}
	return *o.MasterBlock
}

// GetMasterBlockOk returns a tuple with the MasterBlock field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *CopyBlockTypeCopyInstructions) GetMasterBlockOk() (*bool, bool) {
	if o == nil || IsNil(o.MasterBlock) {
		return nil, false
	}
	return o.MasterBlock, true
}
...
// SetMasterBlock gets a reference to the given bool and assigns it to the MasterBlock field.
func (o *CopyBlockTypeCopyInstructions) SetMasterBlock(v bool) {
	o.MasterBlock = &v
}

// GetCopySubBlockAsRegularBlock returns the CopySubBlockAsRegularBlock field value if set, zero value otherwise.
func (o *CopyBlockTypeCopyInstructions) GetCopySubBlockAsRegularBlock() bool {
	if o == nil || IsNil(o.CopySubBlockAsRegularBlock) {
		var ret bool
		return ret
	}
	return *o.CopySubBlockAsRegularBlock
}

// GetCopySubBlockAsRegularBlockOk returns a tuple with the CopySubBlockAsRegularBlock field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *CopyBlockTypeCopyInstructions) GetCopySubBlockAsRegularBlockOk() (*bool, bool) {
	if o == nil || IsNil(o.CopySubBlockAsRegularBlock) {
		return nil, false
	}
	return o.CopySubBlockAsRegularBlock, true
}
...
// SetCopySubBlockAsRegularBlock gets a reference to the given bool and assigns it to the CopySubBlockAsRegularBlock field.
func (o *CopyBlockTypeCopyInstructions) SetCopySubBlockAsRegularBlock(v bool) {
	o.CopySubBlockAsRegularBlock = &v
}

// GetForecastGrid returns the ForecastGrid field value if set, zero value otherwise.
func (o *CopyBlockTypeCopyInstructions) GetForecastGrid() bool {
	if o == nil || IsNil(o.ForecastGrid) {
		var ret bool
		return ret
	}
	return *o.ForecastGrid
}

// GetForecastGridOk returns a tuple with the ForecastGrid field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *CopyBlockTypeCopyInstructions) GetForecastGridOk() (*bool, bool) {
	if o == nil || IsNil(o.ForecastGrid) {
		return nil, false
	}
	return o.ForecastGrid, true
}

// HasForecastGrid returns a boolean if a field has been set.
func (o *CopyBlockTypeCopyInstructions) HasForecastGrid() bool {
	if o != nil && !IsNil(o.ForecastGrid) {
		return true
	}
...
// SetForecastGrid gets a reference to the given bool and assigns it to the ForecastGrid field.
func (o *CopyBlockTypeCopyInstructions) SetForecastGrid(v bool) {
	o.ForecastGrid = &v
}
...
func (o CopyBlockTypeCopyInstructions) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.MasterBlock) {
		toSerialize["masterBlock"] = o.MasterBlock
	}
	if !IsNil(o.CopySubBlockAsRegularBlock) {
		toSerialize["copySubBlockAsRegularBlock"] = o.CopySubBlockAsRegularBlock
	}
	if !IsNil(o.ForecastGrid) {
		toSerialize["forecastGrid"] = o.ForecastGrid
	}
