...
// checks if the BlockSummariesType type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BlockSummariesType{}

// BlockSummariesType Summary information returned during block search.
type BlockSummariesType struct {
	// A collection of Blocks or Unique IDs of Blocks.
	BlockInfo []BlockSummariesTypeBlockInfoInner `json:"blockInfo,omitempty"`
...
func (o *BlockSummariesType) GetBlockInfo() []BlockSummariesTypeBlockInfoInner {
	if o == nil || IsNil(o.BlockInfo) {
		var ret []BlockSummariesTypeBlockInfoInner
		return ret
	}
	return o.BlockInfo
}
...
// SetBlockInfo gets a reference to the given []BlockSummariesTypeBlockInfoInner and assigns it to the BlockInfo field.
...
func (o BlockSummariesType) MarshalJSON() ([]byte, error) {
...
func (o BlockSummariesType) ToMap() (map[string]interface{}, error) {
...
type NullableBlockSummariesType struct {
	value *BlockSummariesType
	isSet bool
}

func (v NullableBlockSummariesType) Get() *BlockSummariesType {
	return v.value
}

func (v *NullableBlockSummariesType) Set(val *BlockSummariesType) {
	v.value = val
	v.isSet = true
}

func (v NullableBlockSummariesType) IsSet() bool {
	return v.isSet
}

func (v *NullableBlockSummariesType) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBlockSummariesType(val *BlockSummariesType) *NullableBlockSummariesType {
	return &NullableBlockSummariesType{value: val, isSet: true}
}

func (v NullableBlockSummariesType) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBlockSummariesType) UnmarshalJSON(src []byte) error {
	v.isSet = true
