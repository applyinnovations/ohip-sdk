...
// checks if the BlockTypeRoomAllocations type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BlockTypeRoomAllocations{}

// BlockTypeRoomAllocations Room Allocations for the Block.
type BlockTypeRoomAllocations struct {
...
func (o BlockTypeRoomAllocations) MarshalJSON() ([]byte, error) {
...
func (o BlockTypeRoomAllocations) ToMap() (map[string]interface{}, error) {
...
type NullableBlockTypeRoomAllocations struct {
	value *BlockTypeRoomAllocations
	isSet bool
}

func (v NullableBlockTypeRoomAllocations) Get() *BlockTypeRoomAllocations {
	return v.value
}

func (v *NullableBlockTypeRoomAllocations) Set(val *BlockTypeRoomAllocations) {
	v.value = val
	v.isSet = true
}

func (v NullableBlockTypeRoomAllocations) IsSet() bool {
	return v.isSet
}

func (v *NullableBlockTypeRoomAllocations) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBlockTypeRoomAllocations(val *BlockTypeRoomAllocations) *NullableBlockTypeRoomAllocations {
	return &NullableBlockTypeRoomAllocations{value: val, isSet: true}
}

func (v NullableBlockTypeRoomAllocations) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBlockTypeRoomAllocations) UnmarshalJSON(src []byte) error {
	v.isSet = true
