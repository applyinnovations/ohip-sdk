...
type BlockAllocationSummaryType struct {
	...
	// Currency code to reflect the currency for room rates.
...
func (o *BlockAllocationSummaryType) GetHotelId() string {
...
func (o *BlockAllocationSummaryType) GetHotelIdOk() (*string, bool) {
	if o == nil || IsNil(o.HotelId) {
		return nil, false
	}
...
func (o *BlockAllocationSummaryType) HasHotelId() bool {
	if o != nil && !IsNil(o.HotelId) {
		return true
	}
...
func (o *BlockAllocationSummaryType) SetHotelId(v string) {
	o.HotelId = &v
}
...
func (o *BlockAllocationSummaryType) GetCurrency() string {
...
// and a boolean to check if the value has been set.
func (o *BlockAllocationSummaryType) GetCurrencyOk() (*string, bool) {
	if o == nil || IsNil(o.Currency) {
		return nil, false
	}
...
func (o *BlockAllocationSummaryType) HasCurrency() bool {
	if o != nil && !IsNil(o.Currency) {
		return true
	}
...
func (o *BlockAllocationSummaryType) SetCurrency(v string) {
	o.Currency = &v
}
