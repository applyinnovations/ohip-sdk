...
// Summarize the availability based on selected criteria. If not selected, by default AvailableRooms are displayed. 
func (r INVStatsAPIGetBlockInventoryStatisticsRequest) AvailabilitySummaryBy(availabilitySummaryBy string) INVStatsAPIGetBlockInventoryStatisticsRequest {
	r.availabilitySummaryBy = &availabilitySummaryBy
	return r
}
...
func (r INVStatsAPIGetBlockInventoryStatisticsRequest) RoomSummaryBy(roomSummaryBy string) INVStatsAPIGetBlockInventoryStatisticsRequest {
	r.roomSummaryBy = &roomSummaryBy
	return r
}

// Pass this header as true, if payload needs DVM
func (r INVStatsAPIGetBlockInventoryStatisticsRequest) ExternalData(externalData string) INVStatsAPIGetBlockInventoryStatisticsRequest {
	r.externalData = &externalData
	return r
}

// Request Id of an incoming request
func (r INVStatsAPIGetBlockInventoryStatisticsRequest) XRequestId(xRequestId string) INVStatsAPIGetBlockInventoryStatisticsRequest {
	r.xRequestId = &xRequestId
	return r
}

// Customer&#39;s Integration Application Id
func (r INVStatsAPIGetBlockInventoryStatisticsRequest) XOriginatingApplication(xOriginatingApplication string) INVStatsAPIGetBlockInventoryStatisticsRequest {
...
func (a *INVStatsAPIService) GetBlockInventoryStatisticsExecute(r INVStatsAPIGetBlockInventoryStatisticsRequest) (*BlockInventoryStatistic, *http.Response, error) {
	...
	if r.availabilitySummaryBy != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "availabilitySummaryBy", r.availabilitySummaryBy, "")
  }
	...
	if r.roomSummaryBy != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "roomSummaryBy", r.roomSummaryBy, "")
  }
...
// Summarize the availability based on selected criteria. If not selected, by default AvailableRooms are displayed. 
func (r INVStatsAPIGetBlockInventoryStatisticsMultipleHotelIdsRequest) AvailabilitySummaryBy(availabilitySummaryBy string) INVStatsAPIGetBlockInventoryStatisticsMultipleHotelIdsRequest {
	r.availabilitySummaryBy = &availabilitySummaryBy
	return r
}
...
// Summarize the rooms based on selected criteria. If not selected, by default AvailableRooms are displayed. Applicable only when RoomSummary is a fetchInstruction. 
func (r INVStatsAPIGetBlockInventoryStatisticsMultipleHotelIdsRequest) RoomSummaryBy(roomSummaryBy string) INVStatsAPIGetBlockInventoryStatisticsMultipleHotelIdsRequest {
	r.roomSummaryBy = &roomSummaryBy
	return r
}

// Pass this header as true, if payload needs DVM
func (r INVStatsAPIGetBlockInventoryStatisticsMultipleHotelIdsRequest) ExternalData(externalData string) INVStatsAPIGetBlockInventoryStatisticsMultipleHotelIdsRequest {
	r.externalData = &externalData
	return r
}

// Request Id of an incoming request
func (r INVStatsAPIGetBlockInventoryStatisticsMultipleHotelIdsRequest) XRequestId(xRequestId string) INVStatsAPIGetBlockInventoryStatisticsMultipleHotelIdsRequest {
	r.xRequestId = &xRequestId
	return r
}

// Customer&#39;s Integration Application Id
func (r INVStatsAPIGetBlockInventoryStatisticsMultipleHotelIdsRequest) XOriginatingApplication(xOriginatingApplication string) INVStatsAPIGetBlockInventoryStatisticsMultipleHotelIdsRequest {
	r.xOriginatingApplication = &xOriginatingApplication
	return r
}
...
// Pass this header as true, if payload needs DVM
func (r INVStatsAPIGetInventoryStatisticsRequest) ExternalData(externalData string) INVStatsAPIGetInventoryStatisticsRequest {
	r.externalData = &externalData
	return r
}

// Request Id of an incoming request
func (r INVStatsAPIGetInventoryStatisticsRequest) XRequestId(xRequestId string) INVStatsAPIGetInventoryStatisticsRequest {
	r.xRequestId = &xRequestId
	return r
}

// Customer&#39;s Integration Application Id
func (r INVStatsAPIGetInventoryStatisticsRequest) XOriginatingApplication(xOriginatingApplication string) INVStatsAPIGetInventoryStatisticsRequest {
	r.xOriginatingApplication = &xOriginatingApplication
	return r
}
...
/*
GetInventoryStatistics Get a hotels Inventory Statistics

This will fetch a hotel's inventory statistics for a specified date range that you provided in the request.<p> <Strong>Note:</strong> This operation does not contain or return revenue data.</p> <p><strong>OperationId:</strong> getInventoryStatistics</p> <p>This API allows a time span of <strong>62</strong> days.</p>
...
// Pass this header as true, if payload needs DVM
func (r INVStatsAPIPinginvStatsServiceRequest) ExternalData(externalData string) INVStatsAPIPinginvStatsServiceRequest {
	r.externalData = &externalData
	return r
}

// Request Id of an incoming request
func (r INVStatsAPIPinginvStatsServiceRequest) XRequestId(xRequestId string) INVStatsAPIPinginvStatsServiceRequest {
	r.xRequestId = &xRequestId
	return r
}

// Customer&#39;s Integration Application Id
func (r INVStatsAPIPinginvStatsServiceRequest) XOriginatingApplication(xOriginatingApplication string) INVStatsAPIPinginvStatsServiceRequest {
	r.xOriginatingApplication = &xOriginatingApplication
	return r
}
