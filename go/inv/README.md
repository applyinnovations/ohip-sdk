...
```golang
import inv "github.com/applyinnovations/ohip-sdk/go/inv/v3"
```
...
*INVStatsAPI* | [**GetInventoryStatistics**](docs/INVStatsAPI.md#getinventorystatistics) | **Get** /hotels/{hotelId}/inventoryStatistics | Get a hotels Inventory Statistics
