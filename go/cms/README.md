...
```golang
import cms "github.com/applyinnovations/ohip-sdk/go/cms/v3"
```
...
*CustomerManagementAPI* | [**SearchTrackItItems**](docs/CustomerManagementAPI.md#searchtrackititems) | **Post** /hotels/{hotelId}/trackItems/searches | Fetches track it items
...
## Documentation For Models
 ...
 - [AssignedStatusEnum](docs/AssignedStatusEnum.md)
 ...
 - [SearchTrackItItemsRequest](docs/SearchTrackItItemsRequest.md)
 ...
 - [TrackItGroupEnum](docs/TrackItGroupEnum.md)
