...
type CalendarTaskType struct {
	...
	AccountIdList []UniqueNameIDType `json:"accountIdList,omitempty"`
	// Defines descriptive name and unique identification combination.
	ContactIdList []UniqueNameIDType `json:"contactIdList,omitempty"`
	// Defines descriptive name and unique identification combination.
...
// SetAccountIdList gets a reference to the given []UniqueNameIDType and assigns it to the AccountIdList field.
...
// SetContactIdList gets a reference to the given []UniqueNameIDType and assigns it to the ContactIdList field.
