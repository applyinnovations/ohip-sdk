...
// checks if the CutoffScheduleDetails type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CutoffScheduleDetails{}

// CutoffScheduleDetails Object which will contain all the information of 'CutoffCodes'. 
type CutoffScheduleDetails struct {
...
func (o CutoffScheduleDetails) MarshalJSON() ([]byte, error) {
...
func (o CutoffScheduleDetails) ToMap() (map[string]interface{}, error) {
...
type NullableCutoffScheduleDetails struct {
	value *CutoffScheduleDetails
	isSet bool
}

func (v NullableCutoffScheduleDetails) Get() *CutoffScheduleDetails {
	return v.value
}

func (v *NullableCutoffScheduleDetails) Set(val *CutoffScheduleDetails) {
	v.value = val
	v.isSet = true
}

func (v NullableCutoffScheduleDetails) IsSet() bool {
	return v.isSet
}

func (v *NullableCutoffScheduleDetails) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCutoffScheduleDetails(val *CutoffScheduleDetails) *NullableCutoffScheduleDetails {
	return &NullableCutoffScheduleDetails{value: val, isSet: true}
}

func (v NullableCutoffScheduleDetails) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCutoffScheduleDetails) UnmarshalJSON(src []byte) error {
	v.isSet = true
