...
// checks if the BlockSalesAllowanceActivityLogListType type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BlockSalesAllowanceActivityLogListType{}

// BlockSalesAllowanceActivityLogListType struct for BlockSalesAllowanceActivityLogListType
type BlockSalesAllowanceActivityLogListType struct {
	ActivityLog []BlockSalesAllowanceActivityLogType `json:"activityLog,omitempty"`
...
func NewBlockSalesAllowanceActivityLogListType() *BlockSalesAllowanceActivityLogListType {
	this := BlockSalesAllowanceActivityLogListType{}
	return &this
}
...
func (o *BlockSalesAllowanceActivityLogListType) GetActivityLog() []BlockSalesAllowanceActivityLogType {
	if o == nil || IsNil(o.ActivityLog) {
		var ret []BlockSalesAllowanceActivityLogType
		return ret
	}
...
// SetActivityLog gets a reference to the given []BlockSalesAllowanceActivityLogType and assigns it to the ActivityLog field.
...
func (o BlockSalesAllowanceActivityLogListType) MarshalJSON() ([]byte, error) {
...
func (o BlockSalesAllowanceActivityLogListType) ToMap() (map[string]interface{}, error) {
...
type NullableBlockSalesAllowanceActivityLogListType struct {
	value *BlockSalesAllowanceActivityLogListType
	isSet bool
}

func (v NullableBlockSalesAllowanceActivityLogListType) Get() *BlockSalesAllowanceActivityLogListType {
	return v.value
}

func (v *NullableBlockSalesAllowanceActivityLogListType) Set(val *BlockSalesAllowanceActivityLogListType) {
	v.value = val
	v.isSet = true
}

func (v NullableBlockSalesAllowanceActivityLogListType) IsSet() bool {
	return v.isSet
}

func (v *NullableBlockSalesAllowanceActivityLogListType) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBlockSalesAllowanceActivityLogListType(val *BlockSalesAllowanceActivityLogListType) *NullableBlockSalesAllowanceActivityLogListType {
	return &NullableBlockSalesAllowanceActivityLogListType{value: val, isSet: true}
}

func (v NullableBlockSalesAllowanceActivityLogListType) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBlockSalesAllowanceActivityLogListType) UnmarshalJSON(src []byte) error {
	v.isSet = true
