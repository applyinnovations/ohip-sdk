...
// checks if the BlockLostBookingCodeType type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BlockLostBookingCodeType{}

// BlockLostBookingCodeType Contains Common Master configuration detail.
type BlockLostBookingCodeType struct {
	...
	// Indicates whether the Block Lost Reason is inactive or not, returns TRUE when inactive
...
func (o BlockLostBookingCodeType) MarshalJSON() ([]byte, error) {
...
func (o BlockLostBookingCodeType) ToMap() (map[string]interface{}, error) {
...
type NullableBlockLostBookingCodeType struct {
	value *BlockLostBookingCodeType
	isSet bool
}

func (v NullableBlockLostBookingCodeType) Get() *BlockLostBookingCodeType {
	return v.value
}

func (v *NullableBlockLostBookingCodeType) Set(val *BlockLostBookingCodeType) {
	v.value = val
	v.isSet = true
}

func (v NullableBlockLostBookingCodeType) IsSet() bool {
	return v.isSet
}

func (v *NullableBlockLostBookingCodeType) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBlockLostBookingCodeType(val *BlockLostBookingCodeType) *NullableBlockLostBookingCodeType {
	return &NullableBlockLostBookingCodeType{value: val, isSet: true}
}

func (v NullableBlockLostBookingCodeType) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBlockLostBookingCodeType) UnmarshalJSON(src []byte) error {
	v.isSet = true
