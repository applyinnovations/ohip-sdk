...
// checks if the BlockCancellationReasonType type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BlockCancellationReasonType{}

// BlockCancellationReasonType Contains Common Master configuration detail.
type BlockCancellationReasonType struct {
...
func NewBlockCancellationReasonType() *BlockCancellationReasonType {
	this := BlockCancellationReasonType{}
	return &this
}
...
func (o BlockCancellationReasonType) MarshalJSON() ([]byte, error) {
...
func (o BlockCancellationReasonType) ToMap() (map[string]interface{}, error) {
...
type NullableBlockCancellationReasonType struct {
	value *BlockCancellationReasonType
	isSet bool
}

func (v NullableBlockCancellationReasonType) Get() *BlockCancellationReasonType {
	return v.value
}

func (v *NullableBlockCancellationReasonType) Set(val *BlockCancellationReasonType) {
	v.value = val
	v.isSet = true
}

func (v NullableBlockCancellationReasonType) IsSet() bool {
	return v.isSet
}

func (v *NullableBlockCancellationReasonType) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBlockCancellationReasonType(val *BlockCancellationReasonType) *NullableBlockCancellationReasonType {
	return &NullableBlockCancellationReasonType{value: val, isSet: true}
}

func (v NullableBlockCancellationReasonType) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBlockCancellationReasonType) UnmarshalJSON(src []byte) error {
	v.isSet = true
