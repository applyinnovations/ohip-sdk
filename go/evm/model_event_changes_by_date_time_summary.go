...
// checks if the EventChangesByDateTimeSummary type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &EventChangesByDateTimeSummary{}

// EventChangesByDateTimeSummary struct for EventChangesByDateTimeSummary
type EventChangesByDateTimeSummary struct {
	// Collection of Catering Event changes by date and time.
	EventList []EventChangesByDateTimeSummaryType `json:"eventList,omitempty"`
...
func NewEventChangesByDateTimeSummary() *EventChangesByDateTimeSummary {
	this := EventChangesByDateTimeSummary{}
	return &this
}
...
func (o *EventChangesByDateTimeSummary) GetEventList() []EventChangesByDateTimeSummaryType {
	if o == nil || IsNil(o.EventList) {
		var ret []EventChangesByDateTimeSummaryType
		return ret
	}
	return o.EventList
}
...
// SetEventList gets a reference to the given []EventChangesByDateTimeSummaryType and assigns it to the EventList field.
...
func (o EventChangesByDateTimeSummary) MarshalJSON() ([]byte, error) {
...
func (o EventChangesByDateTimeSummary) ToMap() (map[string]interface{}, error) {
...
type NullableEventChangesByDateTimeSummary struct {
	value *EventChangesByDateTimeSummary
	isSet bool
}

func (v NullableEventChangesByDateTimeSummary) Get() *EventChangesByDateTimeSummary {
	return v.value
}

func (v *NullableEventChangesByDateTimeSummary) Set(val *EventChangesByDateTimeSummary) {
	v.value = val
	v.isSet = true
}

func (v NullableEventChangesByDateTimeSummary) IsSet() bool {
	return v.isSet
}

func (v *NullableEventChangesByDateTimeSummary) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableEventChangesByDateTimeSummary(val *EventChangesByDateTimeSummary) *NullableEventChangesByDateTimeSummary {
	return &NullableEventChangesByDateTimeSummary{value: val, isSet: true}
}

func (v NullableEventChangesByDateTimeSummary) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableEventChangesByDateTimeSummary) UnmarshalJSON(src []byte) error {
	v.isSet = true
