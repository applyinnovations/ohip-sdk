...
type BlockCateringPackageType struct {
	...
	// Catering Package discount percentage
	DiscountPercentage *int32 `json:"discountPercentage,omitempty"`
	DiscountPrice *CurrencyAmountType `json:"discountPrice,omitempty"`
...
func (o *BlockCateringPackageType) GetDiscountPercentage() int32 {
...
// and a boolean to check if the value has been set.
func (o *BlockCateringPackageType) GetDiscountPercentageOk() (*int32, bool) {
	if o == nil || IsNil(o.DiscountPercentage) {
		return nil, false
	}
...
func (o *BlockCateringPackageType) HasDiscountPercentage() bool {
	if o != nil && !IsNil(o.DiscountPercentage) {
		return true
	}
...
func (o *BlockCateringPackageType) SetDiscountPercentage(v int32) {
	o.DiscountPercentage = &v
}

// GetDiscountPrice returns the DiscountPrice field value if set, zero value otherwise.
func (o *BlockCateringPackageType) GetDiscountPrice() CurrencyAmountType {
...
// and a boolean to check if the value has been set.
func (o *BlockCateringPackageType) GetDiscountPriceOk() (*CurrencyAmountType, bool) {
	if o == nil || IsNil(o.DiscountPrice) {
		return nil, false
	}
...
func (o *BlockCateringPackageType) HasDiscountPrice() bool {
	if o != nil && !IsNil(o.DiscountPrice) {
		return true
	}
...
// SetDiscountPrice gets a reference to the given CurrencyAmountType and assigns it to the DiscountPrice field.
func (o *BlockCateringPackageType) SetDiscountPrice(v CurrencyAmountType) {
	o.DiscountPrice = &v
}
