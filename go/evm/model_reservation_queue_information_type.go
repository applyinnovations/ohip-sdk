...
type ReservationQueueInformationType struct {
	BlockDates *ReservationQueueInformationTypeBlockDates `json:"blockDates,omitempty"`
...
func (o *ReservationQueueInformationType) GetBlockDates() ReservationQueueInformationTypeBlockDates {
	if o == nil || IsNil(o.BlockDates) {
		var ret ReservationQueueInformationTypeBlockDates
		return ret
	}
	return *o.BlockDates
}
...
// SetBlockDates gets a reference to the given ReservationQueueInformationTypeBlockDates and assigns it to the BlockDates field.
