...
type CateringEventResourceType struct {
	...
	// Configured inventory item or menu resource identifier
	ConfigResourceId *string `json:"configResourceId,omitempty"`
...
// GetConfigResourceId returns the ConfigResourceId field value if set, zero value otherwise.
func (o *CateringEventResourceType) GetConfigResourceId() string {
	if o == nil || IsNil(o.ConfigResourceId) {
		var ret string
		return ret
	}
	return *o.ConfigResourceId
}

// GetConfigResourceIdOk returns a tuple with the ConfigResourceId field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *CateringEventResourceType) GetConfigResourceIdOk() (*string, bool) {
	if o == nil || IsNil(o.ConfigResourceId) {
		return nil, false
	}
	return o.ConfigResourceId, true
}

// HasConfigResourceId returns a boolean if a field has been set.
func (o *CateringEventResourceType) HasConfigResourceId() bool {
	if o != nil && !IsNil(o.ConfigResourceId) {
		return true
	}
...
// SetConfigResourceId gets a reference to the given string and assigns it to the ConfigResourceId field.
func (o *CateringEventResourceType) SetConfigResourceId(v string) {
	o.ConfigResourceId = &v
}
...
func (o CateringEventResourceType) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.ConfigResourceId) {
		toSerialize["configResourceId"] = o.ConfigResourceId
	}
