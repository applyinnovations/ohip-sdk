...
```golang
import evm "github.com/applyinnovations/ohip-sdk/go/evm/v3"
```
...
*EventManagementAPI* | [**CopyEventNotes**](docs/EventManagementAPI.md#copyeventnotes) | **Put** /hotels/{hotelId}/events/{eventId}/notes/copy | Copy event notes
...
*EventManagementAPI* | [**EventChangesByDateTime**](docs/EventManagementAPI.md#eventchangesbydatetime) | **Get** /hotels/{hotelId}/blocks/{blockId}/events/changesByDateTime | Get modified events from a specific time period in OPERA.
...
*EventManagementAPI* | [**GetResourceEvents**](docs/EventManagementAPI.md#getresourceevents) | **Get** /hotels/{hotelId}/block/{blockId}/resourceEvents | Get events for the block ID and resource ID(optional)
...
*EventManagementAPI* | [**PingEventManagementService**](docs/EventManagementAPI.md#pingeventmanagementservice) | **Get** /services/eventManagement/status | This API facilitates status check of event management service.
...
*EventManagementAPI* | [**PostMenuItemsToBookedMenu**](docs/EventManagementAPI.md#postmenuitemstobookedmenu) | **Post** /hotels/{hotelId}/events/{eventId}/menus/{menuId}/menuItems | Add Menu Items to a Booked Menu
...
## Documentation For Models
 ...
 - [CopyEventNoteType](docs/CopyEventNoteType.md)
 ...
 - [MenuItemIds](docs/MenuItemIds.md)
 ...
 - [TargetEventIdWithHotelIdType](docs/TargetEventIdWithHotelIdType.md)
