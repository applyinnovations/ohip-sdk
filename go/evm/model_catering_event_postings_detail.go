...
type CateringEventPostingsDetail struct {
	...
	PostingMasterReservations []BlockPostingReservationsType `json:"postingMasterReservations,omitempty"`
...
// SetPostingMasterReservations gets a reference to the given []BlockPostingReservationsType and assigns it to the PostingMasterReservations field.
