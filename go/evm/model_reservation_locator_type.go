...
type ReservationLocatorType struct {
	...
	BlockDates *DateTimeSpanType `json:"blockDates,omitempty"`
...
// SetBlockDates gets a reference to the given DateTimeSpanType and assigns it to the BlockDates field.
