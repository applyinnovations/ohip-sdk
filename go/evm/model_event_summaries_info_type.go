...
// checks if the EventSummariesInfoType type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &EventSummariesInfoType{}

// EventSummariesInfoType Collection of events.
type EventSummariesInfoType struct {
	// Contains master/sub-events or standalone events summary information
	EventSummary []EventSummaryInfoType `json:"eventSummary,omitempty"`
...
// SetEventSummary gets a reference to the given []EventSummaryInfoType and assigns it to the EventSummary field.
...
func (o EventSummariesInfoType) MarshalJSON() ([]byte, error) {
...
func (o EventSummariesInfoType) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.EventSummary) {
		toSerialize["eventSummary"] = o.EventSummary
	}
...
type NullableEventSummariesInfoType struct {
	value *EventSummariesInfoType
	isSet bool
}

func (v NullableEventSummariesInfoType) Get() *EventSummariesInfoType {
	return v.value
}

func (v *NullableEventSummariesInfoType) Set(val *EventSummariesInfoType) {
	v.value = val
	v.isSet = true
}

func (v NullableEventSummariesInfoType) IsSet() bool {
	return v.isSet
}

func (v *NullableEventSummariesInfoType) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableEventSummariesInfoType(val *EventSummariesInfoType) *NullableEventSummariesInfoType {
	return &NullableEventSummariesInfoType{value: val, isSet: true}
}

func (v NullableEventSummariesInfoType) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableEventSummariesInfoType) UnmarshalJSON(src []byte) error {
	v.isSet = true
