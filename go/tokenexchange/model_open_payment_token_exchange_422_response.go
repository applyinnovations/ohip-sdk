...
// checks if the OpenPaymentTokenExchange422Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &OpenPaymentTokenExchange422Response{}

// OpenPaymentTokenExchange422Response Problem Details for HTTP APIs
type OpenPaymentTokenExchange422Response struct {
...
type _OpenPaymentTokenExchange422Response OpenPaymentTokenExchange422Response
...
func NewOpenPaymentTokenExchange422Response(title string, type_ string) *OpenPaymentTokenExchange422Response {
	this := OpenPaymentTokenExchange422Response{}
	this.Title = title
	this.Type = type_
	return &this
}
...
func (o OpenPaymentTokenExchange422Response) MarshalJSON() ([]byte, error) {
...
func (o OpenPaymentTokenExchange422Response) ToMap() (map[string]interface{}, error) {
...
func (o *OpenPaymentTokenExchange422Response) UnmarshalJSON(bytes []byte) (err error) {
	...
	varOpenPaymentTokenExchange422Response := _OpenPaymentTokenExchange422Response{}

	err = json.Unmarshal(bytes, &varOpenPaymentTokenExchange422Response)

	if err != nil {
		return err
	}

	*o = OpenPaymentTokenExchange422Response(varOpenPaymentTokenExchange422Response)

	return err
}

type NullableOpenPaymentTokenExchange422Response struct {
	value *OpenPaymentTokenExchange422Response
	isSet bool
}

func (v NullableOpenPaymentTokenExchange422Response) Get() *OpenPaymentTokenExchange422Response {
	return v.value
}

func (v *NullableOpenPaymentTokenExchange422Response) Set(val *OpenPaymentTokenExchange422Response) {
	v.value = val
	v.isSet = true
}

func (v NullableOpenPaymentTokenExchange422Response) IsSet() bool {
	return v.isSet
}

func (v *NullableOpenPaymentTokenExchange422Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableOpenPaymentTokenExchange422Response(val *OpenPaymentTokenExchange422Response) *NullableOpenPaymentTokenExchange422Response {
	return &NullableOpenPaymentTokenExchange422Response{value: val, isSet: true}
}

func (v NullableOpenPaymentTokenExchange422Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableOpenPaymentTokenExchange422Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
