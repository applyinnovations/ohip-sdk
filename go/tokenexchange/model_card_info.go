...
func (o *CardInfo) UnmarshalJSON(bytes []byte) (err error) {
	...
	varCardInfo := _CardInfo{}

	err = json.Unmarshal(bytes, &varCardInfo)

	if err != nil {
		return err
	}

	*o = CardInfo(varCardInfo)
