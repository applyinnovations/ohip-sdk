...
// checks if the OpenPaymentTokenExchange500Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &OpenPaymentTokenExchange500Response{}

// OpenPaymentTokenExchange500Response Problem Details for HTTP APIs
type OpenPaymentTokenExchange500Response struct {
...
type _OpenPaymentTokenExchange500Response OpenPaymentTokenExchange500Response
...
func NewOpenPaymentTokenExchange500Response(title string, type_ string) *OpenPaymentTokenExchange500Response {
	this := OpenPaymentTokenExchange500Response{}
	this.Title = title
	this.Type = type_
	return &this
}
...
func (o OpenPaymentTokenExchange500Response) MarshalJSON() ([]byte, error) {
...
func (o OpenPaymentTokenExchange500Response) ToMap() (map[string]interface{}, error) {
...
func (o *OpenPaymentTokenExchange500Response) UnmarshalJSON(bytes []byte) (err error) {
	...
	varOpenPaymentTokenExchange500Response := _OpenPaymentTokenExchange500Response{}

	err = json.Unmarshal(bytes, &varOpenPaymentTokenExchange500Response)

	if err != nil {
		return err
	}

	*o = OpenPaymentTokenExchange500Response(varOpenPaymentTokenExchange500Response)

	return err
}

type NullableOpenPaymentTokenExchange500Response struct {
	value *OpenPaymentTokenExchange500Response
	isSet bool
}

func (v NullableOpenPaymentTokenExchange500Response) Get() *OpenPaymentTokenExchange500Response {
	return v.value
}

func (v *NullableOpenPaymentTokenExchange500Response) Set(val *OpenPaymentTokenExchange500Response) {
	v.value = val
	v.isSet = true
}

func (v NullableOpenPaymentTokenExchange500Response) IsSet() bool {
	return v.isSet
}

func (v *NullableOpenPaymentTokenExchange500Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableOpenPaymentTokenExchange500Response(val *OpenPaymentTokenExchange500Response) *NullableOpenPaymentTokenExchange500Response {
	return &NullableOpenPaymentTokenExchange500Response{value: val, isSet: true}
}

func (v NullableOpenPaymentTokenExchange500Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableOpenPaymentTokenExchange500Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
