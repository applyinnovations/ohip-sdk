...
Oracle Token Exchange Service Specification<br /><br /> Compatible with OPERA Cloud release 1.0.1.<br /><br /><p> This document and all content within is available under the Universal Permissive License v 1.0 (https://oss.oracle.com/licenses/upl). Copyright (c) 2020, 2026 Oracle and/or its affiliates.</p>
...
// checks if the OpenPaymentTokenExchange504Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &OpenPaymentTokenExchange504Response{}

// OpenPaymentTokenExchange504Response Problem Details for HTTP APIs
type OpenPaymentTokenExchange504Response struct {
...
type _OpenPaymentTokenExchange504Response OpenPaymentTokenExchange504Response
...
func NewOpenPaymentTokenExchange504Response(title string, type_ string) *OpenPaymentTokenExchange504Response {
	this := OpenPaymentTokenExchange504Response{}
	this.Title = title
	this.Type = type_
	return &this
}
...
func (o OpenPaymentTokenExchange504Response) MarshalJSON() ([]byte, error) {
...
func (o OpenPaymentTokenExchange504Response) ToMap() (map[string]interface{}, error) {
...
func (o *OpenPaymentTokenExchange504Response) UnmarshalJSON(bytes []byte) (err error) {
	...
	varOpenPaymentTokenExchange504Response := _OpenPaymentTokenExchange504Response{}

	err = json.Unmarshal(bytes, &varOpenPaymentTokenExchange504Response)

	if err != nil {
		return err
	}

	*o = OpenPaymentTokenExchange504Response(varOpenPaymentTokenExchange504Response)

	return err
}

type NullableOpenPaymentTokenExchange504Response struct {
	value *OpenPaymentTokenExchange504Response
	isSet bool
}

func (v NullableOpenPaymentTokenExchange504Response) Get() *OpenPaymentTokenExchange504Response {
	return v.value
}

func (v *NullableOpenPaymentTokenExchange504Response) Set(val *OpenPaymentTokenExchange504Response) {
	v.value = val
	v.isSet = true
}

func (v NullableOpenPaymentTokenExchange504Response) IsSet() bool {
	return v.isSet
}

func (v *NullableOpenPaymentTokenExchange504Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableOpenPaymentTokenExchange504Response(val *OpenPaymentTokenExchange504Response) *NullableOpenPaymentTokenExchange504Response {
	return &NullableOpenPaymentTokenExchange504Response{value: val, isSet: true}
}

func (v NullableOpenPaymentTokenExchange504Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableOpenPaymentTokenExchange504Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
