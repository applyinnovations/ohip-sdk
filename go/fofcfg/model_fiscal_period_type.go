...
func (o *FiscalPeriodType) GetManagedBy() ManagedByOptions {
...
// and a boolean to check if the value has been set.
func (o *FiscalPeriodType) GetManagedByOk() (*ManagedByOptions, bool) {
	if o == nil || IsNil(o.ManagedBy) {
		return nil, false
	}
...
func (o *FiscalPeriodType) HasManagedBy() bool {
	if o != nil && !IsNil(o.ManagedBy) {
		return true
	}
...
func (o *FiscalPeriodType) SetManagedBy(v ManagedByOptions) {
	o.ManagedBy = &v
}
