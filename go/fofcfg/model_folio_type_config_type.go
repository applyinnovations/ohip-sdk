...
type FolioTypeConfigType struct {
	...
	FolioTypePrefix *string `json:"folioTypePrefix,omitempty"`
	// Suffix used for folio type
	FolioTypeSuffix *string `json:"folioTypeSuffix,omitempty"`
	// Last folio number issued for a folio type
	LastFolioNumber *float32 `json:"lastFolioNumber,omitempty"`
	// To indicate if the folio type is to be used for a proforma folio.
	ProFormaFolio *bool `json:"proFormaFolio,omitempty"`
	// To indicate if the folio type is to be used for a Customer Vat folio, used in Poland.
	CustomerVatFolio *bool `json:"customerVatFolio,omitempty"`
	// To indicate if the folio type is to be used for a Debit Note folio, used in Poland.
...
// GetFolioTypePrefix returns the FolioTypePrefix field value if set, zero value otherwise.
func (o *FolioTypeConfigType) GetFolioTypePrefix() string {
	if o == nil || IsNil(o.FolioTypePrefix) {
		var ret string
		return ret
	}
	return *o.FolioTypePrefix
}

// GetFolioTypePrefixOk returns a tuple with the FolioTypePrefix field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *FolioTypeConfigType) GetFolioTypePrefixOk() (*string, bool) {
	if o == nil || IsNil(o.FolioTypePrefix) {
		return nil, false
	}
	return o.FolioTypePrefix, true
}
...
// SetFolioTypePrefix gets a reference to the given string and assigns it to the FolioTypePrefix field.
func (o *FolioTypeConfigType) SetFolioTypePrefix(v string) {
	o.FolioTypePrefix = &v
}

// GetFolioTypeSuffix returns the FolioTypeSuffix field value if set, zero value otherwise.
func (o *FolioTypeConfigType) GetFolioTypeSuffix() string {
	if o == nil || IsNil(o.FolioTypeSuffix) {
		var ret string
		return ret
	}
	return *o.FolioTypeSuffix
}

// GetFolioTypeSuffixOk returns a tuple with the FolioTypeSuffix field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *FolioTypeConfigType) GetFolioTypeSuffixOk() (*string, bool) {
	if o == nil || IsNil(o.FolioTypeSuffix) {
		return nil, false
	}
	return o.FolioTypeSuffix, true
}
...
// SetFolioTypeSuffix gets a reference to the given string and assigns it to the FolioTypeSuffix field.
func (o *FolioTypeConfigType) SetFolioTypeSuffix(v string) {
	o.FolioTypeSuffix = &v
}

// GetLastFolioNumber returns the LastFolioNumber field value if set, zero value otherwise.
func (o *FolioTypeConfigType) GetLastFolioNumber() float32 {
	if o == nil || IsNil(o.LastFolioNumber) {
		var ret float32
		return ret
	}
	return *o.LastFolioNumber
}

// GetLastFolioNumberOk returns a tuple with the LastFolioNumber field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *FolioTypeConfigType) GetLastFolioNumberOk() (*float32, bool) {
	if o == nil || IsNil(o.LastFolioNumber) {
		return nil, false
	}
	return o.LastFolioNumber, true
}
...
// SetLastFolioNumber gets a reference to the given float32 and assigns it to the LastFolioNumber field.
func (o *FolioTypeConfigType) SetLastFolioNumber(v float32) {
	o.LastFolioNumber = &v
}

// GetProFormaFolio returns the ProFormaFolio field value if set, zero value otherwise.
func (o *FolioTypeConfigType) GetProFormaFolio() bool {
	if o == nil || IsNil(o.ProFormaFolio) {
		var ret bool
		return ret
	}
	return *o.ProFormaFolio
}

// GetProFormaFolioOk returns a tuple with the ProFormaFolio field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *FolioTypeConfigType) GetProFormaFolioOk() (*bool, bool) {
	if o == nil || IsNil(o.ProFormaFolio) {
		return nil, false
	}
	return o.ProFormaFolio, true
}
...
// SetProFormaFolio gets a reference to the given bool and assigns it to the ProFormaFolio field.
func (o *FolioTypeConfigType) SetProFormaFolio(v bool) {
	o.ProFormaFolio = &v
}

// GetCustomerVatFolio returns the CustomerVatFolio field value if set, zero value otherwise.
func (o *FolioTypeConfigType) GetCustomerVatFolio() bool {
	if o == nil || IsNil(o.CustomerVatFolio) {
		var ret bool
		return ret
	}
	return *o.CustomerVatFolio
}

// GetCustomerVatFolioOk returns a tuple with the CustomerVatFolio field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *FolioTypeConfigType) GetCustomerVatFolioOk() (*bool, bool) {
	if o == nil || IsNil(o.CustomerVatFolio) {
		return nil, false
	}
	return o.CustomerVatFolio, true
}

// HasCustomerVatFolio returns a boolean if a field has been set.
func (o *FolioTypeConfigType) HasCustomerVatFolio() bool {
	if o != nil && !IsNil(o.CustomerVatFolio) {
		return true
	}
...
// SetCustomerVatFolio gets a reference to the given bool and assigns it to the CustomerVatFolio field.
func (o *FolioTypeConfigType) SetCustomerVatFolio(v bool) {
	o.CustomerVatFolio = &v
}

// GetDebitNote returns the DebitNote field value if set, zero value otherwise.
func (o *FolioTypeConfigType) GetDebitNote() bool {
...
// and a boolean to check if the value has been set.
func (o *FolioTypeConfigType) GetDebitNoteOk() (*bool, bool) {
	if o == nil || IsNil(o.DebitNote) {
		return nil, false
	}
...
func (o *FolioTypeConfigType) HasDebitNote() bool {
	if o != nil && !IsNil(o.DebitNote) {
		return true
	}
...
func (o *FolioTypeConfigType) SetDebitNote(v bool) {
	o.DebitNote = &v
}

// GetManagedBy returns the ManagedBy field value if set, zero value otherwise.
func (o *FolioTypeConfigType) GetManagedBy() ManagedByOptions {
...
// and a boolean to check if the value has been set.
func (o *FolioTypeConfigType) GetManagedByOk() (*ManagedByOptions, bool) {
	if o == nil || IsNil(o.ManagedBy) {
		return nil, false
	}
...
func (o *FolioTypeConfigType) HasManagedBy() bool {
	if o != nil && !IsNil(o.ManagedBy) {
		return true
	}
...
func (o *FolioTypeConfigType) SetManagedBy(v ManagedByOptions) {
	o.ManagedBy = &v
}
...
func (o FolioTypeConfigType) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.FolioTypePrefix) {
		toSerialize["folioTypePrefix"] = o.FolioTypePrefix
	}
	if !IsNil(o.FolioTypeSuffix) {
		toSerialize["folioTypeSuffix"] = o.FolioTypeSuffix
	}
	if !IsNil(o.LastFolioNumber) {
		toSerialize["lastFolioNumber"] = o.LastFolioNumber
	}
	if !IsNil(o.ProFormaFolio) {
		toSerialize["proFormaFolio"] = o.ProFormaFolio
	}
	if !IsNil(o.CustomerVatFolio) {
		toSerialize["customerVatFolio"] = o.CustomerVatFolio
	}
