...
// checks if the TemplateCashierShiftDropLocationType type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TemplateCashierShiftDropLocationType{}

// TemplateCashierShiftDropLocationType Contains Common Master configuration detail.
type TemplateCashierShiftDropLocationType struct {
...
func NewTemplateCashierShiftDropLocationType() *TemplateCashierShiftDropLocationType {
	this := TemplateCashierShiftDropLocationType{}
	return &this
}
...
func (o TemplateCashierShiftDropLocationType) MarshalJSON() ([]byte, error) {
...
func (o TemplateCashierShiftDropLocationType) ToMap() (map[string]interface{}, error) {
...
type NullableTemplateCashierShiftDropLocationType struct {
	value *TemplateCashierShiftDropLocationType
	isSet bool
}

func (v NullableTemplateCashierShiftDropLocationType) Get() *TemplateCashierShiftDropLocationType {
	return v.value
}

func (v *NullableTemplateCashierShiftDropLocationType) Set(val *TemplateCashierShiftDropLocationType) {
	v.value = val
	v.isSet = true
}

func (v NullableTemplateCashierShiftDropLocationType) IsSet() bool {
	return v.isSet
}

func (v *NullableTemplateCashierShiftDropLocationType) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTemplateCashierShiftDropLocationType(val *TemplateCashierShiftDropLocationType) *NullableTemplateCashierShiftDropLocationType {
	return &NullableTemplateCashierShiftDropLocationType{value: val, isSet: true}
}

func (v NullableTemplateCashierShiftDropLocationType) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTemplateCashierShiftDropLocationType) UnmarshalJSON(src []byte) error {
	v.isSet = true
