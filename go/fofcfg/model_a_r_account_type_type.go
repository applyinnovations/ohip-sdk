...
func (o *ARAccountTypeType) GetManagedBy() ManagedByOptions {
...
// and a boolean to check if the value has been set.
func (o *ARAccountTypeType) GetManagedByOk() (*ManagedByOptions, bool) {
	if o == nil || IsNil(o.ManagedBy) {
		return nil, false
	}
...
func (o *ARAccountTypeType) HasManagedBy() bool {
	if o != nil && !IsNil(o.ManagedBy) {
		return true
	}
...
func (o *ARAccountTypeType) SetManagedBy(v ManagedByOptions) {
	o.ManagedBy = &v
}
