...
// checks if the TemplateTransactionSubgroups type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TemplateTransactionSubgroups{}

// TemplateTransactionSubgroups struct for TemplateTransactionSubgroups
type TemplateTransactionSubgroups struct {
	// Template transaction subgroup configurations.
	TransactionSubgroups []TransactionSubgroupType `json:"transactionSubgroups,omitempty"`
...
func NewTemplateTransactionSubgroups() *TemplateTransactionSubgroups {
	this := TemplateTransactionSubgroups{}
	return &this
}
...
func (o *TemplateTransactionSubgroups) GetTransactionSubgroups() []TransactionSubgroupType {
	if o == nil || IsNil(o.TransactionSubgroups) {
		var ret []TransactionSubgroupType
		return ret
	}
...
// SetTransactionSubgroups gets a reference to the given []TransactionSubgroupType and assigns it to the TransactionSubgroups field.
...
func (o TemplateTransactionSubgroups) MarshalJSON() ([]byte, error) {
...
func (o TemplateTransactionSubgroups) ToMap() (map[string]interface{}, error) {
...
type NullableTemplateTransactionSubgroups struct {
	value *TemplateTransactionSubgroups
	isSet bool
}

func (v NullableTemplateTransactionSubgroups) Get() *TemplateTransactionSubgroups {
	return v.value
}

func (v *NullableTemplateTransactionSubgroups) Set(val *TemplateTransactionSubgroups) {
	v.value = val
	v.isSet = true
}

func (v NullableTemplateTransactionSubgroups) IsSet() bool {
	return v.isSet
}

func (v *NullableTemplateTransactionSubgroups) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTemplateTransactionSubgroups(val *TemplateTransactionSubgroups) *NullableTemplateTransactionSubgroups {
	return &NullableTemplateTransactionSubgroups{value: val, isSet: true}
}

func (v NullableTemplateTransactionSubgroups) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTemplateTransactionSubgroups) UnmarshalJSON(src []byte) error {
	v.isSet = true
