...
func (o *GUINumberRule) GetManagedBy() ManagedByOptions {
...
// and a boolean to check if the value has been set.
func (o *GUINumberRule) GetManagedByOk() (*ManagedByOptions, bool) {
	if o == nil || IsNil(o.ManagedBy) {
		return nil, false
	}
...
func (o *GUINumberRule) HasManagedBy() bool {
	if o != nil && !IsNil(o.ManagedBy) {
		return true
	}
...
func (o *GUINumberRule) SetManagedBy(v ManagedByOptions) {
	o.ManagedBy = &v
}
