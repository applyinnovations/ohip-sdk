...
func (o *NoShowPostingRuleEditType) GetManagedBy() ManagedByOptions {
...
// and a boolean to check if the value has been set.
func (o *NoShowPostingRuleEditType) GetManagedByOk() (*ManagedByOptions, bool) {
	if o == nil || IsNil(o.ManagedBy) {
		return nil, false
	}
...
func (o *NoShowPostingRuleEditType) HasManagedBy() bool {
	if o != nil && !IsNil(o.ManagedBy) {
		return true
	}
...
func (o *NoShowPostingRuleEditType) SetManagedBy(v ManagedByOptions) {
	o.ManagedBy = &v
}
