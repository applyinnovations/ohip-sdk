...
func (o *RevenueBucketTypeType) GetManagedBy() ManagedByOptions {
...
// and a boolean to check if the value has been set.
func (o *RevenueBucketTypeType) GetManagedByOk() (*ManagedByOptions, bool) {
	if o == nil || IsNil(o.ManagedBy) {
		return nil, false
	}
...
func (o *RevenueBucketTypeType) HasManagedBy() bool {
	if o != nil && !IsNil(o.ManagedBy) {
		return true
	}
...
func (o *RevenueBucketTypeType) SetManagedBy(v ManagedByOptions) {
	o.ManagedBy = &v
}
