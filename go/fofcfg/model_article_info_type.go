...
func (o *ArticleInfoType) GetManagedBy() ManagedByOptions {
...
// and a boolean to check if the value has been set.
func (o *ArticleInfoType) GetManagedByOk() (*ManagedByOptions, bool) {
	if o == nil || IsNil(o.ManagedBy) {
		return nil, false
	}
...
func (o *ArticleInfoType) HasManagedBy() bool {
	if o != nil && !IsNil(o.ManagedBy) {
		return true
	}
...
func (o *ArticleInfoType) SetManagedBy(v ManagedByOptions) {
	o.ManagedBy = &v
}
