...
func (o *ARFlaggedReasonType) GetManagedBy() ManagedByOptions {
...
// and a boolean to check if the value has been set.
func (o *ARFlaggedReasonType) GetManagedByOk() (*ManagedByOptions, bool) {
	if o == nil || IsNil(o.ManagedBy) {
		return nil, false
	}
...
func (o *ARFlaggedReasonType) HasManagedBy() bool {
	if o != nil && !IsNil(o.ManagedBy) {
		return true
	}
...
func (o *ARFlaggedReasonType) SetManagedBy(v ManagedByOptions) {
	o.ManagedBy = &v
}
