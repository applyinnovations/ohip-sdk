...
type FiscalPartnerType struct {
	...
	PayloadPaymentTypes []string `json:"payloadPaymentTypes,omitempty"`
	...
	FolioRequired *bool `json:"folioRequired,omitempty"`
}
...
// GetPayloadPaymentTypes returns the PayloadPaymentTypes field value if set, zero value otherwise.
func (o *FiscalPartnerType) GetPayloadPaymentTypes() []string {
	if o == nil || IsNil(o.PayloadPaymentTypes) {
		var ret []string
		return ret
	}
	return o.PayloadPaymentTypes
}

// GetPayloadPaymentTypesOk returns a tuple with the PayloadPaymentTypes field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *FiscalPartnerType) GetPayloadPaymentTypesOk() ([]string, bool) {
	if o == nil || IsNil(o.PayloadPaymentTypes) {
		return nil, false
	}
	return o.PayloadPaymentTypes, true
}
...
// SetPayloadPaymentTypes gets a reference to the given []string and assigns it to the PayloadPaymentTypes field.
func (o *FiscalPartnerType) SetPayloadPaymentTypes(v []string) {
	o.PayloadPaymentTypes = v
}
...
// GetFolioRequired returns the FolioRequired field value if set, zero value otherwise.
func (o *FiscalPartnerType) GetFolioRequired() bool {
	if o == nil || IsNil(o.FolioRequired) {
		var ret bool
		return ret
	}
	return *o.FolioRequired
}

// GetFolioRequiredOk returns a tuple with the FolioRequired field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *FiscalPartnerType) GetFolioRequiredOk() (*bool, bool) {
	if o == nil || IsNil(o.FolioRequired) {
		return nil, false
	}
	return o.FolioRequired, true
}
...
// SetFolioRequired gets a reference to the given bool and assigns it to the FolioRequired field.
...
func (o FiscalPartnerType) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.PayloadPaymentTypes) {
		toSerialize["payloadPaymentTypes"] = o.PayloadPaymentTypes
	}
	...
	if !IsNil(o.FolioRequired) {
		toSerialize["folioRequired"] = o.FolioRequired
	}
