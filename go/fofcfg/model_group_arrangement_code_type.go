...
func (o *GroupArrangementCodeType) GetManagedBy() ManagedByOptions {
...
// and a boolean to check if the value has been set.
func (o *GroupArrangementCodeType) GetManagedByOk() (*ManagedByOptions, bool) {
	if o == nil || IsNil(o.ManagedBy) {
		return nil, false
	}
...
func (o *GroupArrangementCodeType) HasManagedBy() bool {
	if o != nil && !IsNil(o.ManagedBy) {
		return true
	}
...
func (o *GroupArrangementCodeType) SetManagedBy(v ManagedByOptions) {
	o.ManagedBy = &v
}
