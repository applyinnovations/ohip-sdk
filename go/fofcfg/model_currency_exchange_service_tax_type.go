...
func (o *CurrencyExchangeServiceTaxType) GetManagedBy() ManagedByOptions {
...
// and a boolean to check if the value has been set.
func (o *CurrencyExchangeServiceTaxType) GetManagedByOk() (*ManagedByOptions, bool) {
	if o == nil || IsNil(o.ManagedBy) {
		return nil, false
	}
...
func (o *CurrencyExchangeServiceTaxType) HasManagedBy() bool {
	if o != nil && !IsNil(o.ManagedBy) {
		return true
	}
...
func (o *CurrencyExchangeServiceTaxType) SetManagedBy(v ManagedByOptions) {
	o.ManagedBy = &v
}
