...
func (o *FolioPrintQueueType) GetManagedBy() ManagedByOptions {
...
// and a boolean to check if the value has been set.
func (o *FolioPrintQueueType) GetManagedByOk() (*ManagedByOptions, bool) {
	if o == nil || IsNil(o.ManagedBy) {
		return nil, false
	}
...
func (o *FolioPrintQueueType) HasManagedBy() bool {
	if o != nil && !IsNil(o.ManagedBy) {
		return true
	}
...
func (o *FolioPrintQueueType) SetManagedBy(v ManagedByOptions) {
	o.ManagedBy = &v
}
