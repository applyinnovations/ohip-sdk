...
func (o *AuthorizationConfigRuleType) GetManagedBy() ManagedByOptions {
...
// and a boolean to check if the value has been set.
func (o *AuthorizationConfigRuleType) GetManagedByOk() (*ManagedByOptions, bool) {
	if o == nil || IsNil(o.ManagedBy) {
		return nil, false
	}
...
func (o *AuthorizationConfigRuleType) HasManagedBy() bool {
	if o != nil && !IsNil(o.ManagedBy) {
		return true
	}
...
func (o *AuthorizationConfigRuleType) SetManagedBy(v ManagedByOptions) {
	o.ManagedBy = &v
}
