...
func (o *TrackItTypeConfigType) GetManagedBy() ManagedByOptions {
...
// and a boolean to check if the value has been set.
func (o *TrackItTypeConfigType) GetManagedByOk() (*ManagedByOptions, bool) {
	if o == nil || IsNil(o.ManagedBy) {
		return nil, false
	}
...
func (o *TrackItTypeConfigType) HasManagedBy() bool {
	if o != nil && !IsNil(o.ManagedBy) {
		return true
	}
...
func (o *TrackItTypeConfigType) SetManagedBy(v ManagedByOptions) {
	o.ManagedBy = &v
}
