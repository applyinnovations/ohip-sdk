...
func (o *RevenueBucketCodeType) GetManagedBy() ManagedByOptions {
...
// and a boolean to check if the value has been set.
func (o *RevenueBucketCodeType) GetManagedByOk() (*ManagedByOptions, bool) {
	if o == nil || IsNil(o.ManagedBy) {
		return nil, false
	}
...
func (o *RevenueBucketCodeType) HasManagedBy() bool {
	if o != nil && !IsNil(o.ManagedBy) {
		return true
	}
...
func (o *RevenueBucketCodeType) SetManagedBy(v ManagedByOptions) {
	o.ManagedBy = &v
}
