...
// checks if the AutoFolioSettlementTypesDetails type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AutoFolioSettlementTypesDetails{}

// AutoFolioSettlementTypesDetails Response object for fetching Auto Folio Settlement Types.
type AutoFolioSettlementTypesDetails struct {
...
func NewAutoFolioSettlementTypesDetails() *AutoFolioSettlementTypesDetails {
	this := AutoFolioSettlementTypesDetails{}
	return &this
}
...
func (o AutoFolioSettlementTypesDetails) MarshalJSON() ([]byte, error) {
...
func (o AutoFolioSettlementTypesDetails) ToMap() (map[string]interface{}, error) {
...
type NullableAutoFolioSettlementTypesDetails struct {
	value *AutoFolioSettlementTypesDetails
	isSet bool
}

func (v NullableAutoFolioSettlementTypesDetails) Get() *AutoFolioSettlementTypesDetails {
	return v.value
}

func (v *NullableAutoFolioSettlementTypesDetails) Set(val *AutoFolioSettlementTypesDetails) {
	v.value = val
	v.isSet = true
}

func (v NullableAutoFolioSettlementTypesDetails) IsSet() bool {
	return v.isSet
}

func (v *NullableAutoFolioSettlementTypesDetails) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAutoFolioSettlementTypesDetails(val *AutoFolioSettlementTypesDetails) *NullableAutoFolioSettlementTypesDetails {
	return &NullableAutoFolioSettlementTypesDetails{value: val, isSet: true}
}

func (v NullableAutoFolioSettlementTypesDetails) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAutoFolioSettlementTypesDetails) UnmarshalJSON(src []byte) error {
	v.isSet = true
