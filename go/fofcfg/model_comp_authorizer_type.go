...
type CompAuthorizerType struct {
	...
	// List of associated user in comp authorization.
	AssociatedUsers []ApplicationUserType `json:"associatedUsers,omitempty"`
...
func (o *CompAuthorizerType) GetExternalUserId() UniqueIDType {
...
// and a boolean to check if the value has been set.
func (o *CompAuthorizerType) GetExternalUserIdOk() (*UniqueIDType, bool) {
	if o == nil || IsNil(o.ExternalUserId) {
		return nil, false
	}
...
func (o *CompAuthorizerType) HasExternalUserId() bool {
	if o != nil && !IsNil(o.ExternalUserId) {
		return true
	}
...
func (o *CompAuthorizerType) SetExternalUserId(v UniqueIDType) {
	o.ExternalUserId = &v
}

// GetAssociatedUsers returns the AssociatedUsers field value if set, zero value otherwise.
func (o *CompAuthorizerType) GetAssociatedUsers() []ApplicationUserType {
...
// and a boolean to check if the value has been set.
func (o *CompAuthorizerType) GetAssociatedUsersOk() ([]ApplicationUserType, bool) {
	if o == nil || IsNil(o.AssociatedUsers) {
		return nil, false
	}
...
func (o *CompAuthorizerType) HasAssociatedUsers() bool {
	if o != nil && !IsNil(o.AssociatedUsers) {
		return true
	}
...
// SetAssociatedUsers gets a reference to the given []ApplicationUserType and assigns it to the AssociatedUsers field.
func (o *CompAuthorizerType) SetAssociatedUsers(v []ApplicationUserType) {
	o.AssociatedUsers = v
}
...
func (o *CompAuthorizerType) GetManagedBy() ManagedByOptions {
...
// and a boolean to check if the value has been set.
func (o *CompAuthorizerType) GetManagedByOk() (*ManagedByOptions, bool) {
	if o == nil || IsNil(o.ManagedBy) {
		return nil, false
	}
...
func (o *CompAuthorizerType) HasManagedBy() bool {
	if o != nil && !IsNil(o.ManagedBy) {
		return true
	}
...
func (o *CompAuthorizerType) SetManagedBy(v ManagedByOptions) {
	o.ManagedBy = &v
}
