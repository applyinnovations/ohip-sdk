...
func (o *CollectingAgentTaxType) GetManagedBy() ManagedByOptions {
...
// and a boolean to check if the value has been set.
func (o *CollectingAgentTaxType) GetManagedByOk() (*ManagedByOptions, bool) {
	if o == nil || IsNil(o.ManagedBy) {
		return nil, false
	}
...
func (o *CollectingAgentTaxType) HasManagedBy() bool {
	if o != nil && !IsNil(o.ManagedBy) {
		return true
	}
...
func (o *CollectingAgentTaxType) SetManagedBy(v ManagedByOptions) {
	o.ManagedBy = &v
}
