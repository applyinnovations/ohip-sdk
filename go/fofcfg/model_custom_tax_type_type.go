...
// checks if the CustomTaxTypeType type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CustomTaxTypeType{}

// CustomTaxTypeType Contains Common Master configuration detail.
type CustomTaxTypeType struct {
...
func (o CustomTaxTypeType) MarshalJSON() ([]byte, error) {
...
func (o CustomTaxTypeType) ToMap() (map[string]interface{}, error) {
...
type NullableCustomTaxTypeType struct {
	value *CustomTaxTypeType
	isSet bool
}

func (v NullableCustomTaxTypeType) Get() *CustomTaxTypeType {
	return v.value
}

func (v *NullableCustomTaxTypeType) Set(val *CustomTaxTypeType) {
	v.value = val
	v.isSet = true
}

func (v NullableCustomTaxTypeType) IsSet() bool {
	return v.isSet
}

func (v *NullableCustomTaxTypeType) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCustomTaxTypeType(val *CustomTaxTypeType) *NullableCustomTaxTypeType {
	return &NullableCustomTaxTypeType{value: val, isSet: true}
}

func (v NullableCustomTaxTypeType) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCustomTaxTypeType) UnmarshalJSON(src []byte) error {
	v.isSet = true
