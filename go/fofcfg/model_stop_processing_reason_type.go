...
func (o *StopProcessingReasonType) GetManagedBy() ManagedByOptions {
...
// and a boolean to check if the value has been set.
func (o *StopProcessingReasonType) GetManagedByOk() (*ManagedByOptions, bool) {
	if o == nil || IsNil(o.ManagedBy) {
		return nil, false
	}
...
func (o *StopProcessingReasonType) HasManagedBy() bool {
	if o != nil && !IsNil(o.ManagedBy) {
		return true
	}
...
func (o *StopProcessingReasonType) SetManagedBy(v ManagedByOptions) {
	o.ManagedBy = &v
}
