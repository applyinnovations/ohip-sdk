...
func (o *AuthorizerGroupType) GetManagedBy() ManagedByOptions {
...
// and a boolean to check if the value has been set.
func (o *AuthorizerGroupType) GetManagedByOk() (*ManagedByOptions, bool) {
	if o == nil || IsNil(o.ManagedBy) {
		return nil, false
	}
...
func (o *AuthorizerGroupType) HasManagedBy() bool {
	if o != nil && !IsNil(o.ManagedBy) {
		return true
	}
...
func (o *AuthorizerGroupType) SetManagedBy(v ManagedByOptions) {
	o.ManagedBy = &v
}
