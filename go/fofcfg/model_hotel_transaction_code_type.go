...
// checks if the HotelTransactionCodeType type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &HotelTransactionCodeType{}

// HotelTransactionCodeType Transaction Code configuration details.
type HotelTransactionCodeType struct {
...
func (o HotelTransactionCodeType) MarshalJSON() ([]byte, error) {
...
func (o HotelTransactionCodeType) ToMap() (map[string]interface{}, error) {
...
type NullableHotelTransactionCodeType struct {
	value *HotelTransactionCodeType
	isSet bool
}

func (v NullableHotelTransactionCodeType) Get() *HotelTransactionCodeType {
	return v.value
}

func (v *NullableHotelTransactionCodeType) Set(val *HotelTransactionCodeType) {
	v.value = val
	v.isSet = true
}

func (v NullableHotelTransactionCodeType) IsSet() bool {
	return v.isSet
}

func (v *NullableHotelTransactionCodeType) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableHotelTransactionCodeType(val *HotelTransactionCodeType) *NullableHotelTransactionCodeType {
	return &NullableHotelTransactionCodeType{value: val, isSet: true}
}

func (v NullableHotelTransactionCodeType) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableHotelTransactionCodeType) UnmarshalJSON(src []byte) error {
	v.isSet = true
