...
// checks if the TransactionCodeOwnership type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TransactionCodeOwnership{}

// TransactionCodeOwnership struct for TransactionCodeOwnership
type TransactionCodeOwnership struct {
...
func (o TransactionCodeOwnership) MarshalJSON() ([]byte, error) {
...
func (o TransactionCodeOwnership) ToMap() (map[string]interface{}, error) {
...
type NullableTransactionCodeOwnership struct {
	value *TransactionCodeOwnership
	isSet bool
}

func (v NullableTransactionCodeOwnership) Get() *TransactionCodeOwnership {
	return v.value
}

func (v *NullableTransactionCodeOwnership) Set(val *TransactionCodeOwnership) {
	v.value = val
	v.isSet = true
}

func (v NullableTransactionCodeOwnership) IsSet() bool {
	return v.isSet
}

func (v *NullableTransactionCodeOwnership) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTransactionCodeOwnership(val *TransactionCodeOwnership) *NullableTransactionCodeOwnership {
	return &NullableTransactionCodeOwnership{value: val, isSet: true}
}

func (v NullableTransactionCodeOwnership) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTransactionCodeOwnership) UnmarshalJSON(src []byte) error {
	v.isSet = true
