...
// checks if the TransactionCodeAccessRoles type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TransactionCodeAccessRoles{}

// TransactionCodeAccessRoles struct for TransactionCodeAccessRoles
type TransactionCodeAccessRoles struct {
...
func NewTransactionCodeAccessRoles() *TransactionCodeAccessRoles {
	this := TransactionCodeAccessRoles{}
	return &this
}
...
func (o TransactionCodeAccessRoles) MarshalJSON() ([]byte, error) {
...
func (o TransactionCodeAccessRoles) ToMap() (map[string]interface{}, error) {
...
type NullableTransactionCodeAccessRoles struct {
	value *TransactionCodeAccessRoles
	isSet bool
}

func (v NullableTransactionCodeAccessRoles) Get() *TransactionCodeAccessRoles {
	return v.value
}

func (v *NullableTransactionCodeAccessRoles) Set(val *TransactionCodeAccessRoles) {
	v.value = val
	v.isSet = true
}

func (v NullableTransactionCodeAccessRoles) IsSet() bool {
	return v.isSet
}

func (v *NullableTransactionCodeAccessRoles) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTransactionCodeAccessRoles(val *TransactionCodeAccessRoles) *NullableTransactionCodeAccessRoles {
	return &NullableTransactionCodeAccessRoles{value: val, isSet: true}
}

func (v NullableTransactionCodeAccessRoles) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTransactionCodeAccessRoles) UnmarshalJSON(src []byte) error {
	v.isSet = true
