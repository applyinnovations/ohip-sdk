...
type GenerateCalcRuleType struct {
	...
	TaxTypeBased []TaxTypeGenerateType `json:"taxTypeBased,omitempty"`
	...
	// Date until when this schedule will be effective.
...
// SetTaxTypeBased gets a reference to the given []TaxTypeGenerateType and assigns it to the TaxTypeBased field.
...
func (o *GenerateCalcRuleType) GetStartDate() string {
...
// and a boolean to check if the value has been set.
func (o *GenerateCalcRuleType) GetStartDateOk() (*string, bool) {
	if o == nil || IsNil(o.StartDate) {
		return nil, false
	}
...
func (o *GenerateCalcRuleType) HasStartDate() bool {
	if o != nil && !IsNil(o.StartDate) {
		return true
	}
...
func (o *GenerateCalcRuleType) SetStartDate(v string) {
	o.StartDate = &v
}

// GetEndDate returns the EndDate field value if set, zero value otherwise.
func (o *GenerateCalcRuleType) GetEndDate() string {
...
// and a boolean to check if the value has been set.
func (o *GenerateCalcRuleType) GetEndDateOk() (*string, bool) {
	if o == nil || IsNil(o.EndDate) {
		return nil, false
	}
...
func (o *GenerateCalcRuleType) HasEndDate() bool {
	if o != nil && !IsNil(o.EndDate) {
		return true
	}
...
func (o *GenerateCalcRuleType) SetEndDate(v string) {
	o.EndDate = &v
}
