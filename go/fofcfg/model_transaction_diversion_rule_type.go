...
func (o *TransactionDiversionRuleType) GetManagedBy() ManagedByOptions {
...
// and a boolean to check if the value has been set.
func (o *TransactionDiversionRuleType) GetManagedByOk() (*ManagedByOptions, bool) {
	if o == nil || IsNil(o.ManagedBy) {
		return nil, false
	}
...
func (o *TransactionDiversionRuleType) HasManagedBy() bool {
	if o != nil && !IsNil(o.ManagedBy) {
		return true
	}
...
func (o *TransactionDiversionRuleType) SetManagedBy(v ManagedByOptions) {
	o.ManagedBy = &v
}
