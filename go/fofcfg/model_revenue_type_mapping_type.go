...
func (o *RevenueTypeMappingType) GetManagedBy() ManagedByOptions {
...
// and a boolean to check if the value has been set.
func (o *RevenueTypeMappingType) GetManagedByOk() (*ManagedByOptions, bool) {
	if o == nil || IsNil(o.ManagedBy) {
		return nil, false
	}
...
func (o *RevenueTypeMappingType) HasManagedBy() bool {
	if o != nil && !IsNil(o.ManagedBy) {
		return true
	}
...
func (o *RevenueTypeMappingType) SetManagedBy(v ManagedByOptions) {
	o.ManagedBy = &v
}
