...
func (o *NumberDescriptionType) GetManagedBy() ManagedByOptions {
...
// and a boolean to check if the value has been set.
func (o *NumberDescriptionType) GetManagedByOk() (*ManagedByOptions, bool) {
	if o == nil || IsNil(o.ManagedBy) {
		return nil, false
	}
...
func (o *NumberDescriptionType) HasManagedBy() bool {
	if o != nil && !IsNil(o.ManagedBy) {
		return true
	}
...
func (o *NumberDescriptionType) SetManagedBy(v ManagedByOptions) {
	o.ManagedBy = &v
}
