...
func (o *PaymentMethodType) GetManagedBy() ManagedByOptions {
...
// and a boolean to check if the value has been set.
func (o *PaymentMethodType) GetManagedByOk() (*ManagedByOptions, bool) {
	if o == nil || IsNil(o.ManagedBy) {
		return nil, false
	}
...
func (o *PaymentMethodType) HasManagedBy() bool {
	if o != nil && !IsNil(o.ManagedBy) {
		return true
	}
...
func (o *PaymentMethodType) SetManagedBy(v ManagedByOptions) {
	o.ManagedBy = &v
}
