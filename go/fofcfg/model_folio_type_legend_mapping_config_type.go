...
func (o *FolioTypeLegendMappingConfigType) GetManagedBy() ManagedByOptions {
...
// and a boolean to check if the value has been set.
func (o *FolioTypeLegendMappingConfigType) GetManagedByOk() (*ManagedByOptions, bool) {
	if o == nil || IsNil(o.ManagedBy) {
		return nil, false
	}
...
func (o *FolioTypeLegendMappingConfigType) HasManagedBy() bool {
	if o != nil && !IsNil(o.ManagedBy) {
		return true
	}
...
func (o *FolioTypeLegendMappingConfigType) SetManagedBy(v ManagedByOptions) {
	o.ManagedBy = &v
}
