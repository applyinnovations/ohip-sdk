...
func (o *ConfigRoutingInstructionType) GetManagedBy() ManagedByOptions {
...
// and a boolean to check if the value has been set.
func (o *ConfigRoutingInstructionType) GetManagedByOk() (*ManagedByOptions, bool) {
	if o == nil || IsNil(o.ManagedBy) {
		return nil, false
	}
...
func (o *ConfigRoutingInstructionType) HasManagedBy() bool {
	if o != nil && !IsNil(o.ManagedBy) {
		return true
	}
...
func (o *ConfigRoutingInstructionType) SetManagedBy(v ManagedByOptions) {
	o.ManagedBy = &v
}
