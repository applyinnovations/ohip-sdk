...
// checks if the TransactionCodesCopy type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TransactionCodesCopy{}

// TransactionCodesCopy struct for TransactionCodesCopy
type TransactionCodesCopy struct {
...
func (o TransactionCodesCopy) MarshalJSON() ([]byte, error) {
...
func (o TransactionCodesCopy) ToMap() (map[string]interface{}, error) {
...
type NullableTransactionCodesCopy struct {
	value *TransactionCodesCopy
	isSet bool
}

func (v NullableTransactionCodesCopy) Get() *TransactionCodesCopy {
	return v.value
}

func (v *NullableTransactionCodesCopy) Set(val *TransactionCodesCopy) {
	v.value = val
	v.isSet = true
}

func (v NullableTransactionCodesCopy) IsSet() bool {
	return v.isSet
}

func (v *NullableTransactionCodesCopy) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTransactionCodesCopy(val *TransactionCodesCopy) *NullableTransactionCodesCopy {
	return &NullableTransactionCodesCopy{value: val, isSet: true}
}

func (v NullableTransactionCodesCopy) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTransactionCodesCopy) UnmarshalJSON(src []byte) error {
	v.isSet = true
