...
type _HotelTransactionDiscountType HotelTransactionDiscountType
...
func (o *HotelTransactionDiscountType) GetManagedBy() ManagedByOptions {
...
// and a boolean to check if the value has been set.
func (o *HotelTransactionDiscountType) GetManagedByOk() (*ManagedByOptions, bool) {
	if o == nil || IsNil(o.ManagedBy) {
		return nil, false
	}
...
func (o *HotelTransactionDiscountType) HasManagedBy() bool {
	if o != nil && !IsNil(o.ManagedBy) {
		return true
	}
...
func (o *HotelTransactionDiscountType) SetManagedBy(v ManagedByOptions) {
	o.ManagedBy = &v
}
...
func (o *HotelTransactionDiscountType) UnmarshalJSON(bytes []byte) (err error) {
	...
	varHotelTransactionDiscountType := _HotelTransactionDiscountType{}

	err = json.Unmarshal(bytes, &varHotelTransactionDiscountType)

	if err != nil {
		return err
	}

	*o = HotelTransactionDiscountType(varHotelTransactionDiscountType)
