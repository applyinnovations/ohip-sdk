...
// checks if the CashierShiftDropLocationsDetails type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CashierShiftDropLocationsDetails{}

// CashierShiftDropLocationsDetails Response object for fetching Cashier Shift Drop Locations.
type CashierShiftDropLocationsDetails struct {
...
func NewCashierShiftDropLocationsDetails() *CashierShiftDropLocationsDetails {
	this := CashierShiftDropLocationsDetails{}
	return &this
}
...
func (o CashierShiftDropLocationsDetails) MarshalJSON() ([]byte, error) {
...
func (o CashierShiftDropLocationsDetails) ToMap() (map[string]interface{}, error) {
...
type NullableCashierShiftDropLocationsDetails struct {
	value *CashierShiftDropLocationsDetails
	isSet bool
}

func (v NullableCashierShiftDropLocationsDetails) Get() *CashierShiftDropLocationsDetails {
	return v.value
}

func (v *NullableCashierShiftDropLocationsDetails) Set(val *CashierShiftDropLocationsDetails) {
	v.value = val
	v.isSet = true
}

func (v NullableCashierShiftDropLocationsDetails) IsSet() bool {
	return v.isSet
}

func (v *NullableCashierShiftDropLocationsDetails) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCashierShiftDropLocationsDetails(val *CashierShiftDropLocationsDetails) *NullableCashierShiftDropLocationsDetails {
	return &NullableCashierShiftDropLocationsDetails{value: val, isSet: true}
}

func (v NullableCashierShiftDropLocationsDetails) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCashierShiftDropLocationsDetails) UnmarshalJSON(src []byte) error {
	v.isSet = true
