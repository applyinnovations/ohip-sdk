...
func (o *FiscalFolioParameterType) GetManagedBy() ManagedByOptions {
...
// and a boolean to check if the value has been set.
func (o *FiscalFolioParameterType) GetManagedByOk() (*ManagedByOptions, bool) {
	if o == nil || IsNil(o.ManagedBy) {
		return nil, false
	}
...
func (o *FiscalFolioParameterType) HasManagedBy() bool {
	if o != nil && !IsNil(o.ManagedBy) {
		return true
	}
...
func (o *FiscalFolioParameterType) SetManagedBy(v ManagedByOptions) {
	o.ManagedBy = &v
}
