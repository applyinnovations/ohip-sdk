...
func (o *FiscalYearType) GetManagedBy() ManagedByOptions {
...
// and a boolean to check if the value has been set.
func (o *FiscalYearType) GetManagedByOk() (*ManagedByOptions, bool) {
	if o == nil || IsNil(o.ManagedBy) {
		return nil, false
	}
...
func (o *FiscalYearType) HasManagedBy() bool {
	if o != nil && !IsNil(o.ManagedBy) {
		return true
	}
...
func (o *FiscalYearType) SetManagedBy(v ManagedByOptions) {
	o.ManagedBy = &v
}
