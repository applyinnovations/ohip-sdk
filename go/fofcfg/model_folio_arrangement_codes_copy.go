...
// checks if the FolioArrangementCodesCopy type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &FolioArrangementCodesCopy{}

// FolioArrangementCodesCopy struct for FolioArrangementCodesCopy
type FolioArrangementCodesCopy struct {
...
func NewFolioArrangementCodesCopy() *FolioArrangementCodesCopy {
	this := FolioArrangementCodesCopy{}
	return &this
}
...
func (o FolioArrangementCodesCopy) MarshalJSON() ([]byte, error) {
...
func (o FolioArrangementCodesCopy) ToMap() (map[string]interface{}, error) {
...
type NullableFolioArrangementCodesCopy struct {
	value *FolioArrangementCodesCopy
	isSet bool
}

func (v NullableFolioArrangementCodesCopy) Get() *FolioArrangementCodesCopy {
	return v.value
}

func (v *NullableFolioArrangementCodesCopy) Set(val *FolioArrangementCodesCopy) {
	v.value = val
	v.isSet = true
}

func (v NullableFolioArrangementCodesCopy) IsSet() bool {
	return v.isSet
}

func (v *NullableFolioArrangementCodesCopy) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableFolioArrangementCodesCopy(val *FolioArrangementCodesCopy) *NullableFolioArrangementCodesCopy {
	return &NullableFolioArrangementCodesCopy{value: val, isSet: true}
}

func (v NullableFolioArrangementCodesCopy) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableFolioArrangementCodesCopy) UnmarshalJSON(src []byte) error {
	v.isSet = true
