...
func (o *HotelNoShowPostingRuleType) GetManagedBy() ManagedByOptions {
...
// and a boolean to check if the value has been set.
func (o *HotelNoShowPostingRuleType) GetManagedByOk() (*ManagedByOptions, bool) {
	if o == nil || IsNil(o.ManagedBy) {
		return nil, false
	}
...
func (o *HotelNoShowPostingRuleType) HasManagedBy() bool {
	if o != nil && !IsNil(o.ManagedBy) {
		return true
	}
...
func (o *HotelNoShowPostingRuleType) SetManagedBy(v ManagedByOptions) {
	o.ManagedBy = &v
}
