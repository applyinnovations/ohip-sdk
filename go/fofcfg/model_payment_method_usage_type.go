...
type PaymentMethodUsageType struct {
	...
	// Indicates if a cash surcharge amount can be included when this payment method is used.
	CashSurcharge *bool `json:"cashSurcharge,omitempty"`
}
...
// GetCashSurcharge returns the CashSurcharge field value if set, zero value otherwise.
func (o *PaymentMethodUsageType) GetCashSurcharge() bool {
	if o == nil || IsNil(o.CashSurcharge) {
		var ret bool
		return ret
	}
	return *o.CashSurcharge
}

// GetCashSurchargeOk returns a tuple with the CashSurcharge field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *PaymentMethodUsageType) GetCashSurchargeOk() (*bool, bool) {
	if o == nil || IsNil(o.CashSurcharge) {
		return nil, false
	}
	return o.CashSurcharge, true
}

// HasCashSurcharge returns a boolean if a field has been set.
func (o *PaymentMethodUsageType) HasCashSurcharge() bool {
	if o != nil && !IsNil(o.CashSurcharge) {
		return true
	}
...
// SetCashSurcharge gets a reference to the given bool and assigns it to the CashSurcharge field.
func (o *PaymentMethodUsageType) SetCashSurcharge(v bool) {
	o.CashSurcharge = &v
}
...
func (o PaymentMethodUsageType) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.CashSurcharge) {
		toSerialize["cashSurcharge"] = o.CashSurcharge
	}
