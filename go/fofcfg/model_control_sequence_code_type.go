...
const (
	...
	CONTROLSEQUENCECODETYPE_TAX_REG_NO ControlSequenceCodeType = "TaxRegNo"
	CONTROLSEQUENCECODETYPE_INTERNAL_POS_ACCOUNT ControlSequenceCodeType = "InternalPOSAccount"
	CONTROLSEQUENCECODETYPE_INTERNAL_POS_ACCOUNT_CREDIT ControlSequenceCodeType = "InternalPOSAccountCredit"
	CONTROLSEQUENCECODETYPE_AR_PAYMENT ControlSequenceCodeType = "ARPayment"
	CONTROLSEQUENCECODETYPE_FISCAL_PROFORMA_FOLIO ControlSequenceCodeType = "FiscalProformaFolio"
	CONTROLSEQUENCECODETYPE_FISCAL_INFORMATION_FOLIO ControlSequenceCodeType = "FiscalInformationFolio"
)
