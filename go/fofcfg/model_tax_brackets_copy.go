...
// checks if the TaxBracketsCopy type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TaxBracketsCopy{}

// TaxBracketsCopy struct for TaxBracketsCopy
type TaxBracketsCopy struct {
...
func (o TaxBracketsCopy) MarshalJSON() ([]byte, error) {
...
func (o TaxBracketsCopy) ToMap() (map[string]interface{}, error) {
...
type NullableTaxBracketsCopy struct {
	value *TaxBracketsCopy
	isSet bool
}

func (v NullableTaxBracketsCopy) Get() *TaxBracketsCopy {
	return v.value
}

func (v *NullableTaxBracketsCopy) Set(val *TaxBracketsCopy) {
	v.value = val
	v.isSet = true
}

func (v NullableTaxBracketsCopy) IsSet() bool {
	return v.isSet
}

func (v *NullableTaxBracketsCopy) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTaxBracketsCopy(val *TaxBracketsCopy) *NullableTaxBracketsCopy {
	return &NullableTaxBracketsCopy{value: val, isSet: true}
}

func (v NullableTaxBracketsCopy) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTaxBracketsCopy) UnmarshalJSON(src []byte) error {
	v.isSet = true
