...
func (o *CycleFiscalPeriodType) GetManagedBy() ManagedByOptions {
...
// and a boolean to check if the value has been set.
func (o *CycleFiscalPeriodType) GetManagedByOk() (*ManagedByOptions, bool) {
	if o == nil || IsNil(o.ManagedBy) {
		return nil, false
	}
...
func (o *CycleFiscalPeriodType) HasManagedBy() bool {
	if o != nil && !IsNil(o.ManagedBy) {
		return true
	}
...
func (o *CycleFiscalPeriodType) SetManagedBy(v ManagedByOptions) {
	o.ManagedBy = &v
}
