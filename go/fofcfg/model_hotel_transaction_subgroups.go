...
type HotelTransactionSubgroups struct {
	...
	TransactionSubgroups []HotelTransactionSubgroupType `json:"transactionSubgroups,omitempty"`
...
// SetTransactionSubgroups gets a reference to the given []HotelTransactionSubgroupType and assigns it to the TransactionSubgroups field.
