...
func (o *CustomNumberTemplateConfigurationType) GetManagedBy() ManagedByOptions {
...
// and a boolean to check if the value has been set.
func (o *CustomNumberTemplateConfigurationType) GetManagedByOk() (*ManagedByOptions, bool) {
	if o == nil || IsNil(o.ManagedBy) {
		return nil, false
	}
...
func (o *CustomNumberTemplateConfigurationType) HasManagedBy() bool {
	if o != nil && !IsNil(o.ManagedBy) {
		return true
	}
...
func (o *CustomNumberTemplateConfigurationType) SetManagedBy(v ManagedByOptions) {
	o.ManagedBy = &v
}
