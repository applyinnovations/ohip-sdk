...
type TransactionCodeInformationType struct {
	...
	AFVarianceInfo []MonthlyTransactionVarianceInfoType `json:"aFVarianceInfo,omitempty"`
	// Monthly Revenue Variance information.
	ABVarianceInfo []MonthlyTransactionVarianceInfoType `json:"aBVarianceInfo,omitempty"`
	// Monthly Revenue Variance information.
	FBVarianceInfo []MonthlyTransactionVarianceInfoType `json:"fBVarianceInfo,omitempty"`
}
...
// SetAFVarianceInfo gets a reference to the given []MonthlyTransactionVarianceInfoType and assigns it to the AFVarianceInfo field.
...
// SetABVarianceInfo gets a reference to the given []MonthlyTransactionVarianceInfoType and assigns it to the ABVarianceInfo field.
...
// SetFBVarianceInfo gets a reference to the given []MonthlyTransactionVarianceInfoType and assigns it to the FBVarianceInfo field.
