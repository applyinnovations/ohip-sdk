...
func (o *ForeignCurrencyType) GetManagedBy() ManagedByOptions {
...
// and a boolean to check if the value has been set.
func (o *ForeignCurrencyType) GetManagedByOk() (*ManagedByOptions, bool) {
	if o == nil || IsNil(o.ManagedBy) {
		return nil, false
	}
...
func (o *ForeignCurrencyType) HasManagedBy() bool {
	if o != nil && !IsNil(o.ManagedBy) {
		return true
	}
...
func (o *ForeignCurrencyType) SetManagedBy(v ManagedByOptions) {
	o.ManagedBy = &v
}
