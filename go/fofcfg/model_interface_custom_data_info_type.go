...
type InterfaceCustomDataInfoType struct {
	...
	InterfaceCustomDataDetails []InterfaceCustomDataDetailType `json:"interfaceCustomDataDetails,omitempty"`
}
...
func (o *InterfaceCustomDataInfoType) GetInterfaceCustomDataDetails() []InterfaceCustomDataDetailType {
	if o == nil || IsNil(o.InterfaceCustomDataDetails) {
		var ret []InterfaceCustomDataDetailType
		return ret
	}
...
// SetInterfaceCustomDataDetails gets a reference to the given []InterfaceCustomDataDetailType and assigns it to the InterfaceCustomDataDetails field.
