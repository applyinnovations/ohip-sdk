...
func (o *CustomNumberConfigurationType) GetManagedBy() ManagedByOptions {
...
// and a boolean to check if the value has been set.
func (o *CustomNumberConfigurationType) GetManagedByOk() (*ManagedByOptions, bool) {
	if o == nil || IsNil(o.ManagedBy) {
		return nil, false
	}
...
func (o *CustomNumberConfigurationType) HasManagedBy() bool {
	if o != nil && !IsNil(o.ManagedBy) {
		return true
	}
...
func (o *CustomNumberConfigurationType) SetManagedBy(v ManagedByOptions) {
	o.ManagedBy = &v
}
