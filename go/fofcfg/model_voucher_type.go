...
func (o *VoucherType) GetManagedBy() ManagedByOptions {
...
// and a boolean to check if the value has been set.
func (o *VoucherType) GetManagedByOk() (*ManagedByOptions, bool) {
	if o == nil || IsNil(o.ManagedBy) {
		return nil, false
	}
...
func (o *VoucherType) HasManagedBy() bool {
	if o != nil && !IsNil(o.ManagedBy) {
		return true
	}
...
func (o *VoucherType) SetManagedBy(v ManagedByOptions) {
	o.ManagedBy = &v
}
