...
```golang
import fofcfg "github.com/applyinnovations/ohip-sdk/go/fofcfg/v3"
```
...
*AccountsReceivablesConfigAPI* | [**PingAccountsReceivables**](docs/AccountsReceivablesConfigAPI.md#pingaccountsreceivables) | **Get** /services/accountsReceivables/status | Operation to ping.
...
*AccountsReceivablesConfigAPI* | [**PutUpsertARAccountTypes**](docs/AccountsReceivablesConfigAPI.md#putupsertaraccounttypes) | **Put** /upsert/accountTypes | Operation to modify/create AR Account Types.
...
*CashieringConfigAPI* | [**ChangeUpsertCompTypes**](docs/CashieringConfigAPI.md#changeupsertcomptypes) | **Put** /upsert/compTypes | Operation to Create/Change Comp Types.
*CashieringConfigAPI* | [**ChangeUpsertFolioTypeLegendMappingConfig**](docs/CashieringConfigAPI.md#changeupsertfoliotypelegendmappingconfig) | **Put** /upsert/folioTypeLegendMappings | Operation to create/change folio type legend mappings config.
...
*CashieringConfigAPI* | [**CopyTransactionDiscounts**](docs/CashieringConfigAPI.md#copytransactiondiscounts) | **Put** /transactionDiscounts/copy | Operation to copy TransactionDiscounts.
...
*CashieringConfigAPI* | [**DeleteCashSurchargeRange**](docs/CashieringConfigAPI.md#deletecashsurchargerange) | **Delete** /cashSurchargeRange | Operation to delete the Cash Surcharge Range.
...
*CashieringConfigAPI* | [**GetArticles**](docs/CashieringConfigAPI.md#getarticles) | **Get** /articles | Operation to fetch Articles.
...
*CashieringConfigAPI* | [**GetCashSurchargeRange**](docs/CashieringConfigAPI.md#getcashsurchargerange) | **Get** /cashSurchargeRange | Operation to fetch Cash Surcharge Ranges.
*CashieringConfigAPI* | [**GetCashiers**](docs/CashieringConfigAPI.md#getcashiers) | **Get** /cashierDetails/cashiers | Operation to fetch Cashiers.
...
*CashieringConfigAPI* | [**GetFolioCopyLegend**](docs/CashieringConfigAPI.md#getfoliocopylegend) | **Get** /hotels/{hotelId}/termCodes/{termCode}/folioCopyLegend | Operation to fetch FolioCopyLegend.
...
*CashieringConfigAPI* | [**GetRoutingInstructions**](docs/CashieringConfigAPI.md#getroutinginstructions) | **Get** /routingInstructions | Operation to fetch RoutingInstructions.
...
*CashieringConfigAPI* | [**GetTemplateTransactionCodes**](docs/CashieringConfigAPI.md#gettemplatetransactioncodes) | **Get** /templateTransactionCodes | Operation to fetch TemplateTransactionCodes.
...
*CashieringConfigAPI* | [**GetTransactionCode**](docs/CashieringConfigAPI.md#gettransactioncode) | **Get** /hotels/{hotelId}/transactionCodes/{transactionCode}/hotelTransactionCode | Operation to fetch TransactionCode.
...
*CashieringConfigAPI* | [**PingCashieringConfigService**](docs/CashieringConfigAPI.md#pingcashieringconfigservice) | **Get** /services/cashieringConfig/status | Operation to ping.
...
*CashieringConfigAPI* | [**PostCashSurchargeRange**](docs/CashieringConfigAPI.md#postcashsurchargerange) | **Post** /cashSurchargeRange | Operation to create a Cash Surcharge Range.
...
*CashieringConfigAPI* | [**PostRevenueTypeMapping**](docs/CashieringConfigAPI.md#postrevenuetypemapping) | **Post** /revenueTypeMapping | Operation to create RevenueTypeMapping.
...
*CashieringConfigAPI* | [**PostTemplateTransactionCodes**](docs/CashieringConfigAPI.md#posttemplatetransactioncodes) | **Post** /templateTransactionCodes | Operation to create TemplateTransactionCodes.
...
*CashieringConfigAPI* | [**PostTransactionCodes**](docs/CashieringConfigAPI.md#posttransactioncodes) | **Post** /transactionCodes | Operation to create TransactionCodes.
...
*CashieringConfigAPI* | [**PostTransactionGenerates**](docs/CashieringConfigAPI.md#posttransactiongenerates) | **Post** /generates | Operation to create TransactionGenerates.
...
*CashieringConfigAPI* | [**PutCashSurchargeRange**](docs/CashieringConfigAPI.md#putcashsurchargerange) | **Put** /cashSurchargeRange | Operation to change the Cash Surcharge Range.
...
*CashieringConfigAPI* | [**PutTransactionCodes**](docs/CashieringConfigAPI.md#puttransactioncodes) | **Put** /transactionCodes | Operation to change TransactionCodes.
...
*CashieringConfigAPI* | [**PutTransactionGenerates**](docs/CashieringConfigAPI.md#puttransactiongenerates) | **Put** /generates | Operation to change TransactionGenerates.
...
*CashieringConfigAPI* | [**PutUpsertAuthorizationConfigRule**](docs/CashieringConfigAPI.md#putupsertauthorizationconfigrule) | **Put** /upsert/authorizationConfigRule | Operation to create/change AuthorizationConfigRule.
*CashieringConfigAPI* | [**PutUpsertAuthorizerGroups**](docs/CashieringConfigAPI.md#putupsertauthorizergroups) | **Put** /upsert/authorizerGroups | Operation to create/change AuthorizerGroups.
*CashieringConfigAPI* | [**PutUpsertCashiers**](docs/CashieringConfigAPI.md#putupsertcashiers) | **Put** /upsert/cashiers | Operation to create/change CashiersDetails.
*CashieringConfigAPI* | [**PutUpsertCollectingAgentTaxes**](docs/CashieringConfigAPI.md#putupsertcollectingagenttaxes) | **Put** /upsert/collectingAgentTaxes | Operation to create/change CollectingAgentTaxes.
*CashieringConfigAPI* | [**PutUpsertCompBucketRedemptionConfig**](docs/CashieringConfigAPI.md#putupsertcompbucketredemptionconfig) | **Put** /upsert/hotels/{hotelId}/compBucket/redemption/{redemptionCode} | Operation to Create/Change Comp Bucket Redemption Codes.
*CashieringConfigAPI* | [**PutUpsertConsumableInventory**](docs/CashieringConfigAPI.md#putupsertconsumableinventory) | **Put** /upsert/hotels/{hotelId}/consumableInventory | Operation to create/change Consumable Inventory.
*CashieringConfigAPI* | [**PutUpsertCurrencyExchangeServiceTaxes**](docs/CashieringConfigAPI.md#putupsertcurrencyexchangeservicetaxes) | **Put** /upsert/currencyExchangeServiceTaxes | create/change ExchangeServiceTaxes.
*CashieringConfigAPI* | [**PutUpsertCustomNumberConfig**](docs/CashieringConfigAPI.md#putupsertcustomnumberconfig) | **Put** /upsert/hotels/{hotelId}/customNumbers/configuration/{configurationId} | Operation to create/change custom number config.
*CashieringConfigAPI* | [**PutUpsertFiscalFolioParameters**](docs/CashieringConfigAPI.md#putupsertfiscalfolioparameters) | **Put** /upsert/fiscalFolioParameters | Operation to create/change FiscalFolioParameters.
*CashieringConfigAPI* | [**PutUpsertFiscalPeriods**](docs/CashieringConfigAPI.md#putupsertfiscalperiods) | **Put** /upsert/fiscalPeriods | Operation to create/change FiscalPeriods.
*CashieringConfigAPI* | [**PutUpsertFiscalYears**](docs/CashieringConfigAPI.md#putupsertfiscalyears) | **Put** /upsert/fiscalYears | Operation to create/change FiscalYears.
*CashieringConfigAPI* | [**PutUpsertFolioCopyLegends**](docs/CashieringConfigAPI.md#putupsertfoliocopylegends) | **Put** /upsert/folioCopyLegends | Operation to create/change FolioCopyLegends.
*CashieringConfigAPI* | [**PutUpsertFolioPrintQueues**](docs/CashieringConfigAPI.md#putupsertfolioprintqueues) | **Put** /upsert/folioPrintQueues | Operation to create/change FolioPrintQueues.
*CashieringConfigAPI* | [**PutUpsertFolioTypesConfig**](docs/CashieringConfigAPI.md#putupsertfoliotypesconfig) | **Put** /upsert/folioTypesConfig | Operation to create/change FolioTypesConfig.
*CashieringConfigAPI* | [**PutUpsertGUINumberRules**](docs/CashieringConfigAPI.md#putupsertguinumberrules) | **Put** /upsert/guiNumberRules | Operation to create/change GUINumberRules.
*CashieringConfigAPI* | [**PutUpsertNoShowPostingRules**](docs/CashieringConfigAPI.md#putupsertnoshowpostingrules) | **Put** /upsert/noShowPostingRules | Operation to create/change NoShowPostingRules.
*CashieringConfigAPI* | [**PutUpsertNumberDescriptions**](docs/CashieringConfigAPI.md#putupsertnumberdescriptions) | **Put** /upsert/numberDescriptions | Operation to create/change NumberDescriptions.
*CashieringConfigAPI* | [**PutUpsertPackageArrangementCodes**](docs/CashieringConfigAPI.md#putupsertpackagearrangementcodes) | **Put** /upsert/packageArrangementCodes | Operation to create/change PackageArrangementCodes.
*CashieringConfigAPI* | [**PutUpsertRevenueBucketCodes**](docs/CashieringConfigAPI.md#putupsertrevenuebucketcodes) | **Put** /upsert/revenueBucketCodes | Operation to create/change RevenueBucketCodes.
*CashieringConfigAPI* | [**PutUpsertRevenueTypeMapping**](docs/CashieringConfigAPI.md#putupsertrevenuetypemapping) | **Put** /upsert/revenueTypeMapping | Operation to create/change RevenueTypeMapping.
*CashieringConfigAPI* | [**PutUpsertRoutingInstructions**](docs/CashieringConfigAPI.md#putupsertroutinginstructions) | **Put** /upsert/routingInstructions | Operation to create/change RoutingInstructions.
*CashieringConfigAPI* | [**PutUpsertTransactionDiscounts**](docs/CashieringConfigAPI.md#putupserttransactiondiscounts) | **Put** /upsert/hotels/{hotelId}/transactionDiscounts/{transactionDiscountCode} | Operation to create/change TransactionDiscounts.
*CashieringConfigAPI* | [**PutUpsertTransactionDiversionRules**](docs/CashieringConfigAPI.md#putupserttransactiondiversionrules) | **Put** /upsert/transactionDiversionRules | Operation to create/change TransactionDiversionRules.
*CashieringConfigAPI* | [**PutUpsertVouchers**](docs/CashieringConfigAPI.md#putupsertvouchers) | **Put** /upsert/hotels/{hotelId}/vouchers | Operation to Create/change a voucher.
...
*CashieringConfigAPI* | [**SearchCashiers**](docs/CashieringConfigAPI.md#searchcashiers) | **Post** /cashierDetails/cashiers/search | Operation to fetch Cashiers.
*CashieringConfigAPI* | [**SearchCompAuthorizers**](docs/CashieringConfigAPI.md#searchcompauthorizers) | **Post** /hotels/{hotelId}/compAuthorizers/search | Operation to fetch CompAuthorizers.
...
*CommissionConfigAPI* | [**PutUpsertConfigBankAccounts**](docs/CommissionConfigAPI.md#putupsertconfigbankaccounts) | **Put** /upsert/configBankAccounts | Operation to create/change config bank accounts.
...
*CreditCardAPI* | [**GetCreditCardInfo**](docs/CreditCardAPI.md#getcreditcardinfo) | **Get** /creditCardInfo | Operation to fetch CreditCardInfo.
...
*CreditCardAPI* | [**PingCreditCardService**](docs/CreditCardAPI.md#pingcreditcardservice) | **Get** /services/creditCard/status | Operation to ping.
...
*CreditCardAPI* | [**SearchPrepaidCard**](docs/CreditCardAPI.md#searchprepaidcard) | **Post** /prepaidCard/search | Operation to fetch Prepaid Card.
*CreditCardAPI* | [**SearchPrepaidCardBalance**](docs/CreditCardAPI.md#searchprepaidcardbalance) | **Post** /prepaidCardBalance/search | Operation to fetch prepaid card balance.
...
*EndOfDayConfigAPI* | [**PingEndOfDayConfigServices**](docs/EndOfDayConfigAPI.md#pingendofdayconfigservices) | **Get** /services/endOfDayConfig/status | Operation to ping.
...
## Documentation For Models
 ...
 - [CashSurchargeRangeType](docs/CashSurchargeRangeType.md)
 - [CashSurchargeRanges](docs/CashSurchargeRanges.md)
 ...
 - [ConsumableInventoryItemGroupType](docs/ConsumableInventoryItemGroupType.md)
 - [ConsumableItemType](docs/ConsumableItemType.md)
 ...
 - [CopyTransactionDiscountsInfoType](docs/CopyTransactionDiscountsInfoType.md)
 - [CopyTransactionDiscountsType](docs/CopyTransactionDiscountsType.md)
 ...
 - [FolioCopyLegendInfoType](docs/FolioCopyLegendInfoType.md)
 ...
 - [HotelConsumableInventoryItemType](docs/HotelConsumableInventoryItemType.md)
 ...
 - [SearchCashiersRequest](docs/SearchCashiersRequest.md)
 - [SearchCompAuthorizersRequest](docs/SearchCompAuthorizersRequest.md)
 - [SearchMatchType](docs/SearchMatchType.md)
 - [SearchPrepaidCardBalanceRequest](docs/SearchPrepaidCardBalanceRequest.md)
 - [SearchPrepaidCardRequest](docs/SearchPrepaidCardRequest.md)
 ...
 - [TransactionDiscountsCopy](docs/TransactionDiscountsCopy.md)
