...
// checks if the FiscalRegionType type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &FiscalRegionType{}

// FiscalRegionType Contains Common Master configuration detail.
type FiscalRegionType struct {
...
func (o FiscalRegionType) MarshalJSON() ([]byte, error) {
...
func (o FiscalRegionType) ToMap() (map[string]interface{}, error) {
...
type NullableFiscalRegionType struct {
	value *FiscalRegionType
	isSet bool
}

func (v NullableFiscalRegionType) Get() *FiscalRegionType {
	return v.value
}

func (v *NullableFiscalRegionType) Set(val *FiscalRegionType) {
	v.value = val
	v.isSet = true
}

func (v NullableFiscalRegionType) IsSet() bool {
	return v.isSet
}

func (v *NullableFiscalRegionType) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableFiscalRegionType(val *FiscalRegionType) *NullableFiscalRegionType {
	return &NullableFiscalRegionType{value: val, isSet: true}
}

func (v NullableFiscalRegionType) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableFiscalRegionType) UnmarshalJSON(src []byte) error {
	v.isSet = true
