...
type CashierType struct {
	...
	// Resort where  cashier ID can be used to log in.
	ReservedResort *string `json:"reservedResort,omitempty"`
...
// GetReservedResort returns the ReservedResort field value if set, zero value otherwise.
func (o *CashierType) GetReservedResort() string {
	if o == nil || IsNil(o.ReservedResort) {
		var ret string
		return ret
	}
	return *o.ReservedResort
}

// GetReservedResortOk returns a tuple with the ReservedResort field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *CashierType) GetReservedResortOk() (*string, bool) {
	if o == nil || IsNil(o.ReservedResort) {
		return nil, false
	}
	return o.ReservedResort, true
}

// HasReservedResort returns a boolean if a field has been set.
func (o *CashierType) HasReservedResort() bool {
	if o != nil && !IsNil(o.ReservedResort) {
		return true
	}
...
// SetReservedResort gets a reference to the given string and assigns it to the ReservedResort field.
func (o *CashierType) SetReservedResort(v string) {
	o.ReservedResort = &v
}
...
func (o *CashierType) GetManagedBy() ManagedByOptions {
...
// and a boolean to check if the value has been set.
func (o *CashierType) GetManagedByOk() (*ManagedByOptions, bool) {
	if o == nil || IsNil(o.ManagedBy) {
		return nil, false
	}
...
func (o *CashierType) HasManagedBy() bool {
	if o != nil && !IsNil(o.ManagedBy) {
		return true
	}
...
func (o *CashierType) SetManagedBy(v ManagedByOptions) {
	o.ManagedBy = &v
}
...
func (o CashierType) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.ReservedResort) {
		toSerialize["reservedResort"] = o.ReservedResort
	}
