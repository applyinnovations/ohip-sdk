...
// checks if the AccountInvoiceInfoType type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AccountInvoiceInfoType{}

// AccountInvoiceInfoType Details of an AR Invoice.
type AccountInvoiceInfoType struct {
...
func (o AccountInvoiceInfoType) MarshalJSON() ([]byte, error) {
...
func (o AccountInvoiceInfoType) ToMap() (map[string]interface{}, error) {
...
type NullableAccountInvoiceInfoType struct {
	value *AccountInvoiceInfoType
	isSet bool
}

func (v NullableAccountInvoiceInfoType) Get() *AccountInvoiceInfoType {
	return v.value
}

func (v *NullableAccountInvoiceInfoType) Set(val *AccountInvoiceInfoType) {
	v.value = val
	v.isSet = true
}

func (v NullableAccountInvoiceInfoType) IsSet() bool {
	return v.isSet
}

func (v *NullableAccountInvoiceInfoType) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAccountInvoiceInfoType(val *AccountInvoiceInfoType) *NullableAccountInvoiceInfoType {
	return &NullableAccountInvoiceInfoType{value: val, isSet: true}
}

func (v NullableAccountInvoiceInfoType) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAccountInvoiceInfoType) UnmarshalJSON(src []byte) error {
	v.isSet = true
