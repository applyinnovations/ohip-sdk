...
// checks if the InvoicesPayments type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &InvoicesPayments{}

// InvoicesPayments Response for the fetch invoice and payments details request.
type InvoicesPayments struct {
...
func (o InvoicesPayments) MarshalJSON() ([]byte, error) {
...
func (o InvoicesPayments) ToMap() (map[string]interface{}, error) {
...
type NullableInvoicesPayments struct {
	value *InvoicesPayments
	isSet bool
}

func (v NullableInvoicesPayments) Get() *InvoicesPayments {
	return v.value
}

func (v *NullableInvoicesPayments) Set(val *InvoicesPayments) {
	v.value = val
	v.isSet = true
}

func (v NullableInvoicesPayments) IsSet() bool {
	return v.isSet
}

func (v *NullableInvoicesPayments) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInvoicesPayments(val *InvoicesPayments) *NullableInvoicesPayments {
	return &NullableInvoicesPayments{value: val, isSet: true}
}

func (v NullableInvoicesPayments) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInvoicesPayments) UnmarshalJSON(src []byte) error {
	v.isSet = true
