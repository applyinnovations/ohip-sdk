...
```golang
import ars "github.com/applyinnovations/ohip-sdk/go/ars/v3"
```
...
*AccountsReceivablesAPI* | [**DeleteARTransactions**](docs/AccountsReceivablesAPI.md#deleteartransactions) | **Put** /hotels/{hotelId}/accounts/{accountId}/invoices/{invoiceId}/transactions | Delete transactions for specific AR Invoice Transactions on current business day
...
*AccountsReceivablesAPI* | [**SearchARTransactions**](docs/AccountsReceivablesAPI.md#searchartransactions) | **Post** /arTransactions/searches | Search AR transactions.
*AccountsReceivablesAPI* | [**SearchInvoicesOnHold**](docs/AccountsReceivablesAPI.md#searchinvoicesonhold) | **Post** /hotels/{hotelId}/accounts/invoicesOnHold/searches | Get list of hold invoices for account receivable
...
## Documentation For Models
 ...
 - [DeleteARTransactionsCriteriaType](docs/DeleteARTransactionsCriteriaType.md)
 ...
 - [SearchARTransactionsRequest](docs/SearchARTransactionsRequest.md)
 - [SearchInvoicesOnHoldRequest](docs/SearchInvoicesOnHoldRequest.md)
 ...
 - [TotalTransferARHoldings](docs/TotalTransferARHoldings.md)
 ...
 - [TransferARHoldingsProcess](docs/TransferARHoldingsProcess.md)
 - [TransferARHoldingsProcessDetails](docs/TransferARHoldingsProcessDetails.md)
