...
func (o *ARCreditCardPaymentInfoType) GetFiscalFolioNo() string {
...
// and a boolean to check if the value has been set.
func (o *ARCreditCardPaymentInfoType) GetFiscalFolioNoOk() (*string, bool) {
	if o == nil || IsNil(o.FiscalFolioNo) {
		return nil, false
	}
...
func (o *ARCreditCardPaymentInfoType) SetFiscalFolioNo(v string) {
	o.FiscalFolioNo = &v
}
