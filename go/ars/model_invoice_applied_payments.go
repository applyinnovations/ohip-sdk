...
// checks if the InvoiceAppliedPayments type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &InvoiceAppliedPayments{}

// InvoiceAppliedPayments Response to the applied payment details,Contains errors or warnings if any.
type InvoiceAppliedPayments struct {
	// Applied Payment record.
	Details []ARAppliedPaymentType `json:"details,omitempty"`
...
// SetDetails gets a reference to the given []ARAppliedPaymentType and assigns it to the Details field.
...
func (o InvoiceAppliedPayments) MarshalJSON() ([]byte, error) {
...
func (o InvoiceAppliedPayments) ToMap() (map[string]interface{}, error) {
...
type NullableInvoiceAppliedPayments struct {
	value *InvoiceAppliedPayments
	isSet bool
}

func (v NullableInvoiceAppliedPayments) Get() *InvoiceAppliedPayments {
	return v.value
}

func (v *NullableInvoiceAppliedPayments) Set(val *InvoiceAppliedPayments) {
	v.value = val
	v.isSet = true
}

func (v NullableInvoiceAppliedPayments) IsSet() bool {
	return v.isSet
}

func (v *NullableInvoiceAppliedPayments) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInvoiceAppliedPayments(val *InvoiceAppliedPayments) *NullableInvoiceAppliedPayments {
	return &NullableInvoiceAppliedPayments{value: val, isSet: true}
}

func (v NullableInvoiceAppliedPayments) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInvoiceAppliedPayments) UnmarshalJSON(src []byte) error {
	v.isSet = true
