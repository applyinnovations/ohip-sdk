...
type ARTransactionType struct {
	...
	Invoices []AccountInvoiceInfoType `json:"invoices,omitempty"`
	// Account Payments info .
	Payments []AccountPaymentInfoType `json:"payments,omitempty"`
}
...
func (o *ARTransactionType) GetInvoices() []AccountInvoiceInfoType {
	if o == nil || IsNil(o.Invoices) {
		var ret []AccountInvoiceInfoType
		return ret
	}
	return o.Invoices
}
...
// SetInvoices gets a reference to the given []AccountInvoiceInfoType and assigns it to the Invoices field.
...
func (o *ARTransactionType) GetPayments() []AccountPaymentInfoType {
	if o == nil || IsNil(o.Payments) {
		var ret []AccountPaymentInfoType
		return ret
	}
	return o.Payments
}
...
// SetPayments gets a reference to the given []AccountPaymentInfoType and assigns it to the Payments field.
