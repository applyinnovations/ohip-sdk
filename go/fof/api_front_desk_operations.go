...
func (r FrontDeskOperationsAPIAddReservationToQueueRequest) ExternalData(externalData string) FrontDeskOperationsAPIAddReservationToQueueRequest {
	r.externalData = &externalData
	return r
}

// Request Id of an incoming request
func (r FrontDeskOperationsAPIAddReservationToQueueRequest) XRequestId(xRequestId string) FrontDeskOperationsAPIAddReservationToQueueRequest {
	r.xRequestId = &xRequestId
	return r
}

// Customer&#39;s Integration Application Id
func (r FrontDeskOperationsAPIAddReservationToQueueRequest) XOriginatingApplication(xOriginatingApplication string) FrontDeskOperationsAPIAddReservationToQueueRequest {
...
// Pass this header as true, if payload needs DVM
func (r FrontDeskOperationsAPIAssignRoomsAIRequest) ExternalData(externalData string) FrontDeskOperationsAPIAssignRoomsAIRequest {
	r.externalData = &externalData
	return r
}

// Request Id of an incoming request
func (r FrontDeskOperationsAPIAssignRoomsAIRequest) XRequestId(xRequestId string) FrontDeskOperationsAPIAssignRoomsAIRequest {
	r.xRequestId = &xRequestId
	return r
}

// Customer&#39;s Integration Application Id
func (r FrontDeskOperationsAPIAssignRoomsAIRequest) XOriginatingApplication(xOriginatingApplication string) FrontDeskOperationsAPIAssignRoomsAIRequest {
	r.xOriginatingApplication = &xOriginatingApplication
	return r
}
...
// Pass this header as true, if payload needs DVM
func (r FrontDeskOperationsAPIAutoAssignRoomRequest) ExternalData(externalData string) FrontDeskOperationsAPIAutoAssignRoomRequest {
	r.externalData = &externalData
	return r
}

// Request Id of an incoming request
func (r FrontDeskOperationsAPIAutoAssignRoomRequest) XRequestId(xRequestId string) FrontDeskOperationsAPIAutoAssignRoomRequest {
	r.xRequestId = &xRequestId
	return r
}

// Customer&#39;s Integration Application Id
func (r FrontDeskOperationsAPIAutoAssignRoomRequest) XOriginatingApplication(xOriginatingApplication string) FrontDeskOperationsAPIAutoAssignRoomRequest {
	r.xOriginatingApplication = &xOriginatingApplication
	return r
}
...
// Pass this header as true, if payload needs DVM
func (r FrontDeskOperationsAPIAutoUnAssignRoomRequest) ExternalData(externalData string) FrontDeskOperationsAPIAutoUnAssignRoomRequest {
	r.externalData = &externalData
	return r
}

// Request Id of an incoming request
func (r FrontDeskOperationsAPIAutoUnAssignRoomRequest) XRequestId(xRequestId string) FrontDeskOperationsAPIAutoUnAssignRoomRequest {
	r.xRequestId = &xRequestId
	return r
}

// Customer&#39;s Integration Application Id
func (r FrontDeskOperationsAPIAutoUnAssignRoomRequest) XOriginatingApplication(xOriginatingApplication string) FrontDeskOperationsAPIAutoUnAssignRoomRequest {
	r.xOriginatingApplication = &xOriginatingApplication
	return r
}
...
// Pass this header as true, if payload needs DVM
func (r FrontDeskOperationsAPIDeleteAdvanceCheckInRequest) ExternalData(externalData string) FrontDeskOperationsAPIDeleteAdvanceCheckInRequest {
	r.externalData = &externalData
	return r
}

// Request Id of an incoming request
func (r FrontDeskOperationsAPIDeleteAdvanceCheckInRequest) XRequestId(xRequestId string) FrontDeskOperationsAPIDeleteAdvanceCheckInRequest {
	r.xRequestId = &xRequestId
	return r
}

// Customer&#39;s Integration Application Id
func (r FrontDeskOperationsAPIDeleteAdvanceCheckInRequest) XOriginatingApplication(xOriginatingApplication string) FrontDeskOperationsAPIDeleteAdvanceCheckInRequest {
	r.xOriginatingApplication = &xOriginatingApplication
	return r
}
...
// Pass this header as true, if payload needs DVM
func (r FrontDeskOperationsAPIDeleteAssignRoomRequest) ExternalData(externalData string) FrontDeskOperationsAPIDeleteAssignRoomRequest {
	r.externalData = &externalData
	return r
}

// Request Id of an incoming request
func (r FrontDeskOperationsAPIDeleteAssignRoomRequest) XRequestId(xRequestId string) FrontDeskOperationsAPIDeleteAssignRoomRequest {
	r.xRequestId = &xRequestId
	return r
}

// Customer&#39;s Integration Application Id
func (r FrontDeskOperationsAPIDeleteAssignRoomRequest) XOriginatingApplication(xOriginatingApplication string) FrontDeskOperationsAPIDeleteAssignRoomRequest {
	r.xOriginatingApplication = &xOriginatingApplication
	return r
}
...
func (r FrontDeskOperationsAPIDeleteCheckinRequest) SharersList(sharersList []string) FrontDeskOperationsAPIDeleteCheckinRequest {
	r.sharersList = &sharersList
	return r
}

// List of back to back reservation IDs linked to the reservation selected.
func (r FrontDeskOperationsAPIDeleteCheckinRequest) BackToBackResvList(backToBackResvList []string) FrontDeskOperationsAPIDeleteCheckinRequest {
	r.backToBackResvList = &backToBackResvList
	return r
}

// Pass this header as true, if payload needs DVM
func (r FrontDeskOperationsAPIDeleteCheckinRequest) ExternalData(externalData string) FrontDeskOperationsAPIDeleteCheckinRequest {
	r.externalData = &externalData
	return r
}

// Request Id of an incoming request
func (r FrontDeskOperationsAPIDeleteCheckinRequest) XRequestId(xRequestId string) FrontDeskOperationsAPIDeleteCheckinRequest {
	r.xRequestId = &xRequestId
	return r
}

// Customer&#39;s Integration Application Id
func (r FrontDeskOperationsAPIDeleteCheckinRequest) XOriginatingApplication(xOriginatingApplication string) FrontDeskOperationsAPIDeleteCheckinRequest {
	r.xOriginatingApplication = &xOriginatingApplication
	return r
}
...
func (a *FrontDeskOperationsAPIService) DeleteCheckinExecute(r FrontDeskOperationsAPIDeleteCheckinRequest) (*Status, *http.Response, error) {
	...
	if r.sharersList != nil {
		t := *r.sharersList
		if reflect.TypeOf(t).Kind() == reflect.Slice {
			s := reflect.ValueOf(t)
			for i := 0; i < s.Len(); i++ {
				parameterAddToHeaderOrQuery(localVarQueryParams, "sharersList", s.Index(i).Interface(), "multi")
			}
		} else {
			parameterAddToHeaderOrQuery(localVarQueryParams, "sharersList", t, "multi")
		}
  }
	if r.backToBackResvList != nil {
		t := *r.backToBackResvList
		if reflect.TypeOf(t).Kind() == reflect.Slice {
			s := reflect.ValueOf(t)
			for i := 0; i < s.Len(); i++ {
				parameterAddToHeaderOrQuery(localVarQueryParams, "backToBackResvList", s.Index(i).Interface(), "multi")
			}
		} else {
			parameterAddToHeaderOrQuery(localVarQueryParams, "backToBackResvList", t, "multi")
		}
  }
	// to determine the Content-Type header
	localVarHTTPContentTypes := []string{}
...
// Pass this header as true, if payload needs DVM
func (r FrontDeskOperationsAPIDeleteDailyDocketRequest) ExternalData(externalData string) FrontDeskOperationsAPIDeleteDailyDocketRequest {
	r.externalData = &externalData
	return r
}

// Request Id of an incoming request
func (r FrontDeskOperationsAPIDeleteDailyDocketRequest) XRequestId(xRequestId string) FrontDeskOperationsAPIDeleteDailyDocketRequest {
	r.xRequestId = &xRequestId
	return r
}

// Customer&#39;s Integration Application Id
func (r FrontDeskOperationsAPIDeleteDailyDocketRequest) XOriginatingApplication(xOriginatingApplication string) FrontDeskOperationsAPIDeleteDailyDocketRequest {
	r.xOriginatingApplication = &xOriginatingApplication
	return r
}
...
// Pass this header as true, if payload needs DVM
func (r FrontDeskOperationsAPIDeleteReservationFromQueueRequest) ExternalData(externalData string) FrontDeskOperationsAPIDeleteReservationFromQueueRequest {
	r.externalData = &externalData
	return r
}

// Request Id of an incoming request
func (r FrontDeskOperationsAPIDeleteReservationFromQueueRequest) XRequestId(xRequestId string) FrontDeskOperationsAPIDeleteReservationFromQueueRequest {
	r.xRequestId = &xRequestId
	return r
}

// Customer&#39;s Integration Application Id
func (r FrontDeskOperationsAPIDeleteReservationFromQueueRequest) XOriginatingApplication(xOriginatingApplication string) FrontDeskOperationsAPIDeleteReservationFromQueueRequest {
	r.xOriginatingApplication = &xOriginatingApplication
	return r
}
...
// Pass this header as true, if payload needs DVM
func (r FrontDeskOperationsAPIDeleteRoomKeyRequest) ExternalData(externalData string) FrontDeskOperationsAPIDeleteRoomKeyRequest {
	r.externalData = &externalData
	return r
}

// Request Id of an incoming request
func (r FrontDeskOperationsAPIDeleteRoomKeyRequest) XRequestId(xRequestId string) FrontDeskOperationsAPIDeleteRoomKeyRequest {
	r.xRequestId = &xRequestId
	return r
}

// Customer&#39;s Integration Application Id
func (r FrontDeskOperationsAPIDeleteRoomKeyRequest) XOriginatingApplication(xOriginatingApplication string) FrontDeskOperationsAPIDeleteRoomKeyRequest {
	r.xOriginatingApplication = &xOriginatingApplication
	return r
}
...
// Pass this header as true, if payload needs DVM
func (r FrontDeskOperationsAPIDeleteServiceRequestsRequest) ExternalData(externalData string) FrontDeskOperationsAPIDeleteServiceRequestsRequest {
	r.externalData = &externalData
	return r
}

// Request Id of an incoming request
func (r FrontDeskOperationsAPIDeleteServiceRequestsRequest) XRequestId(xRequestId string) FrontDeskOperationsAPIDeleteServiceRequestsRequest {
	r.xRequestId = &xRequestId
	return r
}

// Customer&#39;s Integration Application Id
func (r FrontDeskOperationsAPIDeleteServiceRequestsRequest) XOriginatingApplication(xOriginatingApplication string) FrontDeskOperationsAPIDeleteServiceRequestsRequest {
	r.xOriginatingApplication = &xOriginatingApplication
	return r
}
...
// Pass this header as true, if payload needs DVM
func (r FrontDeskOperationsAPIDeleteWakeUpCallRequest) ExternalData(externalData string) FrontDeskOperationsAPIDeleteWakeUpCallRequest {
	r.externalData = &externalData
	return r
}

// Request Id of an incoming request
func (r FrontDeskOperationsAPIDeleteWakeUpCallRequest) XRequestId(xRequestId string) FrontDeskOperationsAPIDeleteWakeUpCallRequest {
	r.xRequestId = &xRequestId
	return r
}

// Customer&#39;s Integration Application Id
func (r FrontDeskOperationsAPIDeleteWakeUpCallRequest) XOriginatingApplication(xOriginatingApplication string) FrontDeskOperationsAPIDeleteWakeUpCallRequest {
	r.xOriginatingApplication = &xOriginatingApplication
	return r
}
...
// Pass this header as true, if payload needs DVM
func (r FrontDeskOperationsAPIDeliverQueueRoomsTextMessageRequest) ExternalData(externalData string) FrontDeskOperationsAPIDeliverQueueRoomsTextMessageRequest {
	r.externalData = &externalData
	return r
}

// Request Id of an incoming request
func (r FrontDeskOperationsAPIDeliverQueueRoomsTextMessageRequest) XRequestId(xRequestId string) FrontDeskOperationsAPIDeliverQueueRoomsTextMessageRequest {
	r.xRequestId = &xRequestId
	return r
}

// Customer&#39;s Integration Application Id
func (r FrontDeskOperationsAPIDeliverQueueRoomsTextMessageRequest) XOriginatingApplication(xOriginatingApplication string) FrontDeskOperationsAPIDeliverQueueRoomsTextMessageRequest {
	r.xOriginatingApplication = &xOriginatingApplication
	return r
}
...
type FrontDeskOperationsAPIGetAiraLastRunStatusRequest struct {
	ctx context.Context
	ApiService *FrontDeskOperationsAPIService
	hotelId string
	authorization *string
...
// Bearer token that needs to be passed which is generated post user authentication
func (r FrontDeskOperationsAPIGetAiraLastRunStatusRequest) Authorization(authorization string) FrontDeskOperationsAPIGetAiraLastRunStatusRequest {
	r.authorization = &authorization
	return r
}

// Client or Partner&#39;s Application Key
func (r FrontDeskOperationsAPIGetAiraLastRunStatusRequest) XAppKey(xAppKey string) FrontDeskOperationsAPIGetAiraLastRunStatusRequest {
	r.xAppKey = &xAppKey
	return r
}

// Mandatory parameter to identify the hotel code where the end user is logged in
func (r FrontDeskOperationsAPIGetAiraLastRunStatusRequest) XHotelid(xHotelid string) FrontDeskOperationsAPIGetAiraLastRunStatusRequest {
	r.xHotelid = &xHotelid
	return r
}

// Pass this header as true, if payload needs DVM
func (r FrontDeskOperationsAPIGetAiraLastRunStatusRequest) ExternalData(externalData string) FrontDeskOperationsAPIGetAiraLastRunStatusRequest {
	r.externalData = &externalData
	return r
}

// Request Id of an incoming request
func (r FrontDeskOperationsAPIGetAiraLastRunStatusRequest) XRequestId(xRequestId string) FrontDeskOperationsAPIGetAiraLastRunStatusRequest {
	r.xRequestId = &xRequestId
	return r
}

// Customer&#39;s Integration Application Id
func (r FrontDeskOperationsAPIGetAiraLastRunStatusRequest) XOriginatingApplication(xOriginatingApplication string) FrontDeskOperationsAPIGetAiraLastRunStatusRequest {
	r.xOriginatingApplication = &xOriginatingApplication
	return r
}

// External system code.
func (r FrontDeskOperationsAPIGetAiraLastRunStatusRequest) XExternalsystem(xExternalsystem string) FrontDeskOperationsAPIGetAiraLastRunStatusRequest {
	r.xExternalsystem = &xExternalsystem
	return r
}

// Language code
func (r FrontDeskOperationsAPIGetAiraLastRunStatusRequest) AcceptLanguage(acceptLanguage string) FrontDeskOperationsAPIGetAiraLastRunStatusRequest {
	r.acceptLanguage = &acceptLanguage
	return r
}

func (r FrontDeskOperationsAPIGetAiraLastRunStatusRequest) Execute() (*AiraLastRunStatusInfo, *http.Response, error) {
	return r.ApiService.GetAiraLastRunStatusExecute(r)
}

/*
GetAiraLastRunStatus Automated Intelligence Room Assignment last run status
...
This API fetches the last run status of an Automated Intelligence Room Assignment. <p><strong>OperationId:</strong>getAiraLastRunStatus</p>
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param hotelId
 @return FrontDeskOperationsAPIGetAiraLastRunStatusRequest
*/
func (a *FrontDeskOperationsAPIService) GetAiraLastRunStatus(ctx context.Context, hotelId string) FrontDeskOperationsAPIGetAiraLastRunStatusRequest {
	return FrontDeskOperationsAPIGetAiraLastRunStatusRequest{
		ApiService: a,
		ctx: ctx,
		hotelId: hotelId,
...
func (a *FrontDeskOperationsAPIService) GetAiraLastRunStatusExecute(r FrontDeskOperationsAPIGetAiraLastRunStatusRequest) (*AiraLastRunStatusInfo, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "FrontDeskOperationsAPIService.GetAiraLastRunStatus")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
// Pass this header as true, if payload needs DVM
func (r FrontDeskOperationsAPIGetDailyDocketRequest) ExternalData(externalData string) FrontDeskOperationsAPIGetDailyDocketRequest {
	r.externalData = &externalData
	return r
}

// Request Id of an incoming request
func (r FrontDeskOperationsAPIGetDailyDocketRequest) XRequestId(xRequestId string) FrontDeskOperationsAPIGetDailyDocketRequest {
	r.xRequestId = &xRequestId
	return r
}

// Customer&#39;s Integration Application Id
func (r FrontDeskOperationsAPIGetDailyDocketRequest) XOriginatingApplication(xOriginatingApplication string) FrontDeskOperationsAPIGetDailyDocketRequest {
	r.xOriginatingApplication = &xOriginatingApplication
	return r
}
...
// Pass this header as true, if payload needs DVM
func (r FrontDeskOperationsAPIGetFloorPlansRequest) ExternalData(externalData string) FrontDeskOperationsAPIGetFloorPlansRequest {
	r.externalData = &externalData
	return r
}

// Request Id of an incoming request
func (r FrontDeskOperationsAPIGetFloorPlansRequest) XRequestId(xRequestId string) FrontDeskOperationsAPIGetFloorPlansRequest {
	r.xRequestId = &xRequestId
	return r
}

// Customer&#39;s Integration Application Id
func (r FrontDeskOperationsAPIGetFloorPlansRequest) XOriginatingApplication(xOriginatingApplication string) FrontDeskOperationsAPIGetFloorPlansRequest {
	r.xOriginatingApplication = &xOriginatingApplication
	return r
}
...
// Pass this header as true, if payload needs DVM
func (r FrontDeskOperationsAPIGetFulfillmentActivityLogRequest) ExternalData(externalData string) FrontDeskOperationsAPIGetFulfillmentActivityLogRequest {
	r.externalData = &externalData
	return r
}

// Request Id of an incoming request
func (r FrontDeskOperationsAPIGetFulfillmentActivityLogRequest) XRequestId(xRequestId string) FrontDeskOperationsAPIGetFulfillmentActivityLogRequest {
	r.xRequestId = &xRequestId
	return r
}

// Customer&#39;s Integration Application Id
func (r FrontDeskOperationsAPIGetFulfillmentActivityLogRequest) XOriginatingApplication(xOriginatingApplication string) FrontDeskOperationsAPIGetFulfillmentActivityLogRequest {
	r.xOriginatingApplication = &xOriginatingApplication
	return r
}
...
type FrontDeskOperationsAPIGetHotelRoomsRequest struct {
	...
	includeScheduledMoveOutRoom *bool
	scheduledRoomMoveOutTime *string
	exactMatchRoomNumber *bool
	includeNextStayInfo *bool
	externalData *string
	xRequestId *string
	xOriginatingApplication *string
	xExternalsystem *string
...
func (r FrontDeskOperationsAPIGetHotelRoomsRequest) SortOrder(sortOrder string) FrontDeskOperationsAPIGetHotelRoomsRequest {
...
func (r FrontDeskOperationsAPIGetHotelRoomsRequest) IncludeScheduledMoveOutRoom(includeScheduledMoveOutRoom bool) FrontDeskOperationsAPIGetHotelRoomsRequest {
	r.includeScheduledMoveOutRoom = &includeScheduledMoveOutRoom
	return r
}
...
func (r FrontDeskOperationsAPIGetHotelRoomsRequest) ScheduledRoomMoveOutTime(scheduledRoomMoveOutTime string) FrontDeskOperationsAPIGetHotelRoomsRequest {
	r.scheduledRoomMoveOutTime = &scheduledRoomMoveOutTime
	return r
}
...
func (r FrontDeskOperationsAPIGetHotelRoomsRequest) ExactMatchRoomNumber(exactMatchRoomNumber bool) FrontDeskOperationsAPIGetHotelRoomsRequest {
	r.exactMatchRoomNumber = &exactMatchRoomNumber
	return r
}

// When true, the response will include &#39;nightsToNextStay&#39; and &#39;nextStayDate&#39; for each room inside &#39;roomOccupancyInfo&#39;.
func (r FrontDeskOperationsAPIGetHotelRoomsRequest) IncludeNextStayInfo(includeNextStayInfo bool) FrontDeskOperationsAPIGetHotelRoomsRequest {
	r.includeNextStayInfo = &includeNextStayInfo
	return r
}

// Pass this header as true, if payload needs DVM
func (r FrontDeskOperationsAPIGetHotelRoomsRequest) ExternalData(externalData string) FrontDeskOperationsAPIGetHotelRoomsRequest {
	r.externalData = &externalData
	return r
}

// Request Id of an incoming request
func (r FrontDeskOperationsAPIGetHotelRoomsRequest) XRequestId(xRequestId string) FrontDeskOperationsAPIGetHotelRoomsRequest {
	r.xRequestId = &xRequestId
	return r
}

// Customer&#39;s Integration Application Id
func (r FrontDeskOperationsAPIGetHotelRoomsRequest) XOriginatingApplication(xOriginatingApplication string) FrontDeskOperationsAPIGetHotelRoomsRequest {
	r.xOriginatingApplication = &xOriginatingApplication
	return r
}
...
func (a *FrontDeskOperationsAPIService) GetHotelRoomsExecute(r FrontDeskOperationsAPIGetHotelRoomsRequest) (*HotelRooms, *http.Response, error) {
	...
	if r.eligiblePseudoRoomsOnly != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "eligiblePseudoRoomsOnly", r.eligiblePseudoRoomsOnly, "")
  }
	...
	if r.includeScheduledMoveOutRoom != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "includeScheduledMoveOutRoom", r.includeScheduledMoveOutRoom, "")
  }
	if r.scheduledRoomMoveOutTime != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "scheduledRoomMoveOutTime", r.scheduledRoomMoveOutTime, "")
  }
	if r.exactMatchRoomNumber != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "exactMatchRoomNumber", r.exactMatchRoomNumber, "")
  }
	if r.includeNextStayInfo != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "includeNextStayInfo", r.includeNextStayInfo, "")
  }
	// to determine the Content-Type header
	localVarHTTPContentTypes := []string{}
...
type FrontDeskOperationsAPIGetKeyOptionsRequest struct {
	ctx context.Context
	ApiService *FrontDeskOperationsAPIService
	reservationId string
	hotelId string
...
// Bearer token that needs to be passed which is generated post user authentication
func (r FrontDeskOperationsAPIGetKeyOptionsRequest) Authorization(authorization string) FrontDeskOperationsAPIGetKeyOptionsRequest {
	r.authorization = &authorization
	return r
}

// Client or Partner&#39;s Application Key
func (r FrontDeskOperationsAPIGetKeyOptionsRequest) XAppKey(xAppKey string) FrontDeskOperationsAPIGetKeyOptionsRequest {
	r.xAppKey = &xAppKey
	return r
}

// Mandatory parameter to identify the hotel code where the end user is logged in
func (r FrontDeskOperationsAPIGetKeyOptionsRequest) XHotelid(xHotelid string) FrontDeskOperationsAPIGetKeyOptionsRequest {
	r.xHotelid = &xHotelid
	return r
}

// Pass this header as true, if payload needs DVM
func (r FrontDeskOperationsAPIGetKeyOptionsRequest) ExternalData(externalData string) FrontDeskOperationsAPIGetKeyOptionsRequest {
	r.externalData = &externalData
	return r
}

// Request Id of an incoming request
func (r FrontDeskOperationsAPIGetKeyOptionsRequest) XRequestId(xRequestId string) FrontDeskOperationsAPIGetKeyOptionsRequest {
	r.xRequestId = &xRequestId
	return r
}

// Customer&#39;s Integration Application Id
func (r FrontDeskOperationsAPIGetKeyOptionsRequest) XOriginatingApplication(xOriginatingApplication string) FrontDeskOperationsAPIGetKeyOptionsRequest {
	r.xOriginatingApplication = &xOriginatingApplication
	return r
}

// External system code.
func (r FrontDeskOperationsAPIGetKeyOptionsRequest) XExternalsystem(xExternalsystem string) FrontDeskOperationsAPIGetKeyOptionsRequest {
	r.xExternalsystem = &xExternalsystem
	return r
}

// Language code
func (r FrontDeskOperationsAPIGetKeyOptionsRequest) AcceptLanguage(acceptLanguage string) FrontDeskOperationsAPIGetKeyOptionsRequest {
	r.acceptLanguage = &acceptLanguage
	return r
}

func (r FrontDeskOperationsAPIGetKeyOptionsRequest) Execute() (*KeyOptionsInfo, *http.Response, error) {
	return r.ApiService.GetKeyOptionsExecute(r)
}

/*
GetKeyOptions Fetch the keysOptions
...
This API is used to retrieve the key options attached to the room, reservation and profile. These key options are preferences that correspond to the Door Lock System in use that control the access to areas with the room key. Key option preferences can be configured and saved on profiles, rooms, and reservations to be included when requesting a room key. <p><strong>OperationId:</strong>getKeyOptions</p>
 ...
 @param hotelId Name of the resort.
 @return FrontDeskOperationsAPIGetKeyOptionsRequest
*/
func (a *FrontDeskOperationsAPIService) GetKeyOptions(ctx context.Context, reservationId string, hotelId string) FrontDeskOperationsAPIGetKeyOptionsRequest {
	return FrontDeskOperationsAPIGetKeyOptionsRequest{
		ApiService: a,
		ctx: ctx,
		reservationId: reservationId,
...
// Execute executes the request
//  @return KeyOptionsInfo
func (a *FrontDeskOperationsAPIService) GetKeyOptionsExecute(r FrontDeskOperationsAPIGetKeyOptionsRequest) (*KeyOptionsInfo, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *KeyOptionsInfo
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "FrontDeskOperationsAPIService.GetKeyOptions")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/hotels/{hotelId}/reservations/{reservationId}/keyOptions"
	localVarPath = strings.Replace(localVarPath, "{"+"reservationId"+"}", url.PathEscape(parameterValueToString(r.reservationId, "reservationId")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"hotelId"+"}", url.PathEscape(parameterValueToString(r.hotelId, "hotelId")), -1)
...
// Pass this header as true, if payload needs DVM
func (r FrontDeskOperationsAPIGetLinkedReservationsRequest) ExternalData(externalData string) FrontDeskOperationsAPIGetLinkedReservationsRequest {
	r.externalData = &externalData
	return r
}

// Request Id of an incoming request
func (r FrontDeskOperationsAPIGetLinkedReservationsRequest) XRequestId(xRequestId string) FrontDeskOperationsAPIGetLinkedReservationsRequest {
	r.xRequestId = &xRequestId
	return r
}

// Customer&#39;s Integration Application Id
func (r FrontDeskOperationsAPIGetLinkedReservationsRequest) XOriginatingApplication(xOriginatingApplication string) FrontDeskOperationsAPIGetLinkedReservationsRequest {
	r.xOriginatingApplication = &xOriginatingApplication
	return r
}
...
// Pass this header as true, if payload needs DVM
func (r FrontDeskOperationsAPIGetQueueRoomsTextMessageRequest) ExternalData(externalData string) FrontDeskOperationsAPIGetQueueRoomsTextMessageRequest {
	r.externalData = &externalData
	return r
}

// Request Id of an incoming request
func (r FrontDeskOperationsAPIGetQueueRoomsTextMessageRequest) XRequestId(xRequestId string) FrontDeskOperationsAPIGetQueueRoomsTextMessageRequest {
	r.xRequestId = &xRequestId
	return r
}

// Customer&#39;s Integration Application Id
func (r FrontDeskOperationsAPIGetQueueRoomsTextMessageRequest) XOriginatingApplication(xOriginatingApplication string) FrontDeskOperationsAPIGetQueueRoomsTextMessageRequest {
	r.xOriginatingApplication = &xOriginatingApplication
	return r
}
...
func (r FrontDeskOperationsAPIGetReservationSummariesRequest) Keyword(keyword string) FrontDeskOperationsAPIGetReservationSummariesRequest {
	r.keyword = &keyword
	return r
}

// Simple type for reservation instructions that can be used in requests to fetch necessary reservation summary details.
func (r FrontDeskOperationsAPIGetReservationSummariesRequest) FetchInstructions(fetchInstructions []string) FrontDeskOperationsAPIGetReservationSummariesRequest {
	r.fetchInstructions = &fetchInstructions
	return r
}

// Indicates maximum number of records a Web Service should return.
func (r FrontDeskOperationsAPIGetReservationSummariesRequest) Limit(limit int32) FrontDeskOperationsAPIGetReservationSummariesRequest {
	r.limit = &limit
	return r
}

// Index or initial index of the set(page) being requested. If the index goes out of the bounds of the total set count then no data will be returned.
func (r FrontDeskOperationsAPIGetReservationSummariesRequest) Offset(offset int32) FrontDeskOperationsAPIGetReservationSummariesRequest {
	r.offset = &offset
	return r
}

// Pass this header as true, if payload needs DVM
func (r FrontDeskOperationsAPIGetReservationSummariesRequest) ExternalData(externalData string) FrontDeskOperationsAPIGetReservationSummariesRequest {
	r.externalData = &externalData
	return r
}

// Request Id of an incoming request
func (r FrontDeskOperationsAPIGetReservationSummariesRequest) XRequestId(xRequestId string) FrontDeskOperationsAPIGetReservationSummariesRequest {
	r.xRequestId = &xRequestId
	return r
}

// Customer&#39;s Integration Application Id
func (r FrontDeskOperationsAPIGetReservationSummariesRequest) XOriginatingApplication(xOriginatingApplication string) FrontDeskOperationsAPIGetReservationSummariesRequest {
	r.xOriginatingApplication = &xOriginatingApplication
	return r
}
...
/*
GetReservationSummaries Get reservation summaries
...
// Pass this header as true, if payload needs DVM
func (r FrontDeskOperationsAPIGetReservationsForBillingRequest) ExternalData(externalData string) FrontDeskOperationsAPIGetReservationsForBillingRequest {
	r.externalData = &externalData
	return r
}

// Request Id of an incoming request
func (r FrontDeskOperationsAPIGetReservationsForBillingRequest) XRequestId(xRequestId string) FrontDeskOperationsAPIGetReservationsForBillingRequest {
	r.xRequestId = &xRequestId
	return r
}

// Customer&#39;s Integration Application Id
func (r FrontDeskOperationsAPIGetReservationsForBillingRequest) XOriginatingApplication(xOriginatingApplication string) FrontDeskOperationsAPIGetReservationsForBillingRequest {
	r.xOriginatingApplication = &xOriginatingApplication
	return r
}
...
// Pass this header as true, if payload needs DVM
func (r FrontDeskOperationsAPIGetReservationsInQueueRequest) ExternalData(externalData string) FrontDeskOperationsAPIGetReservationsInQueueRequest {
	r.externalData = &externalData
	return r
}

// Request Id of an incoming request
func (r FrontDeskOperationsAPIGetReservationsInQueueRequest) XRequestId(xRequestId string) FrontDeskOperationsAPIGetReservationsInQueueRequest {
	r.xRequestId = &xRequestId
	return r
}

// Customer&#39;s Integration Application Id
func (r FrontDeskOperationsAPIGetReservationsInQueueRequest) XOriginatingApplication(xOriginatingApplication string) FrontDeskOperationsAPIGetReservationsInQueueRequest {
	r.xOriginatingApplication = &xOriginatingApplication
	return r
}
...
type FrontDeskOperationsAPIGetReservationsKeyOptionsRequest struct {
	ctx context.Context
	ApiService *FrontDeskOperationsAPIService
...
func (r FrontDeskOperationsAPIGetReservationsKeyOptionsRequest) ReservationIdList(reservationIdList []string) FrontDeskOperationsAPIGetReservationsKeyOptionsRequest {
	r.reservationIdList = &reservationIdList
	return r
}

// Bearer token that needs to be passed which is generated post user authentication
func (r FrontDeskOperationsAPIGetReservationsKeyOptionsRequest) Authorization(authorization string) FrontDeskOperationsAPIGetReservationsKeyOptionsRequest {
	r.authorization = &authorization
	return r
}

// Client or Partner&#39;s Application Key
func (r FrontDeskOperationsAPIGetReservationsKeyOptionsRequest) XAppKey(xAppKey string) FrontDeskOperationsAPIGetReservationsKeyOptionsRequest {
	r.xAppKey = &xAppKey
	return r
}

// Mandatory parameter to identify the hotel code where the end user is logged in
func (r FrontDeskOperationsAPIGetReservationsKeyOptionsRequest) XHotelid(xHotelid string) FrontDeskOperationsAPIGetReservationsKeyOptionsRequest {
	r.xHotelid = &xHotelid
	return r
}

// Indicates maximum number of records a Web Service should return.
func (r FrontDeskOperationsAPIGetReservationsKeyOptionsRequest) Limit(limit int32) FrontDeskOperationsAPIGetReservationsKeyOptionsRequest {
	r.limit = &limit
	return r
}

// Index or initial index of the set(page) being requested. If the index goes out of the bounds of the total set count then no data will be returned.
func (r FrontDeskOperationsAPIGetReservationsKeyOptionsRequest) Offset(offset int32) FrontDeskOperationsAPIGetReservationsKeyOptionsRequest {
	r.offset = &offset
	return r
}

// Pass this header as true, if payload needs DVM
func (r FrontDeskOperationsAPIGetReservationsKeyOptionsRequest) ExternalData(externalData string) FrontDeskOperationsAPIGetReservationsKeyOptionsRequest {
	r.externalData = &externalData
	return r
}

// Request Id of an incoming request
func (r FrontDeskOperationsAPIGetReservationsKeyOptionsRequest) XRequestId(xRequestId string) FrontDeskOperationsAPIGetReservationsKeyOptionsRequest {
	r.xRequestId = &xRequestId
	return r
}

// Customer&#39;s Integration Application Id
func (r FrontDeskOperationsAPIGetReservationsKeyOptionsRequest) XOriginatingApplication(xOriginatingApplication string) FrontDeskOperationsAPIGetReservationsKeyOptionsRequest {
	r.xOriginatingApplication = &xOriginatingApplication
	return r
}

// External system code.
func (r FrontDeskOperationsAPIGetReservationsKeyOptionsRequest) XExternalsystem(xExternalsystem string) FrontDeskOperationsAPIGetReservationsKeyOptionsRequest {
	r.xExternalsystem = &xExternalsystem
	return r
}

// Language code
func (r FrontDeskOperationsAPIGetReservationsKeyOptionsRequest) AcceptLanguage(acceptLanguage string) FrontDeskOperationsAPIGetReservationsKeyOptionsRequest {
	r.acceptLanguage = &acceptLanguage
	return r
}

func (r FrontDeskOperationsAPIGetReservationsKeyOptionsRequest) Execute() (*KeyOptionsInfoListType, *http.Response, error) {
	return r.ApiService.GetReservationsKeyOptionsExecute(r)
}

/*
GetReservationsKeyOptions Fetch keysOptions for the reservation and the guest profile
...
This API is used to retrieve the key options attached to the room, reservation and profile for all the reservations in reservationIdList. These key options are preferences that correspond to the Door Lock System in use that control the access to areas with the room key. Key option preferences can be configured and saved on profiles, rooms, and reservations to be included when requesting a room key. <p><strong>OperationId:</strong>getKeyOptions</p>
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param hotelId Name of the resort.
 @return FrontDeskOperationsAPIGetReservationsKeyOptionsRequest
*/
func (a *FrontDeskOperationsAPIService) GetReservationsKeyOptions(ctx context.Context, hotelId string) FrontDeskOperationsAPIGetReservationsKeyOptionsRequest {
	return FrontDeskOperationsAPIGetReservationsKeyOptionsRequest{
		ApiService: a,
		ctx: ctx,
		hotelId: hotelId,
...
// Execute executes the request
//  @return KeyOptionsInfoListType
func (a *FrontDeskOperationsAPIService) GetReservationsKeyOptionsExecute(r FrontDeskOperationsAPIGetReservationsKeyOptionsRequest) (*KeyOptionsInfoListType, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *KeyOptionsInfoListType
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "FrontDeskOperationsAPIService.GetReservationsKeyOptions")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/hotels/{hotelId}/reservationsKeyOptions"
	localVarPath = strings.Replace(localVarPath, "{"+"hotelId"+"}", url.PathEscape(parameterValueToString(r.hotelId, "hotelId")), -1)
...
// The starting value of the date range.
func (r FrontDeskOperationsAPIGetResvForBatchCCAuthRequest) ArrivalStartDate(arrivalStartDate string) FrontDeskOperationsAPIGetResvForBatchCCAuthRequest {
	r.arrivalStartDate = &arrivalStartDate
	return r
}

// The ending value of the date range.
func (r FrontDeskOperationsAPIGetResvForBatchCCAuthRequest) ArrivalEndDate(arrivalEndDate string) FrontDeskOperationsAPIGetResvForBatchCCAuthRequest {
	r.arrivalEndDate = &arrivalEndDate
	return r
}

// Indicates the status of the reservations that is to be returned 
func (r FrontDeskOperationsAPIGetResvForBatchCCAuthRequest) ReservationStatus(reservationStatus []string) FrontDeskOperationsAPIGetResvForBatchCCAuthRequest {
	r.reservationStatus = &reservationStatus
	return r
}
...
// Pass this header as true, if payload needs DVM
func (r FrontDeskOperationsAPIGetResvForBatchCCAuthRequest) ExternalData(externalData string) FrontDeskOperationsAPIGetResvForBatchCCAuthRequest {
	r.externalData = &externalData
	return r
}

// Request Id of an incoming request
func (r FrontDeskOperationsAPIGetResvForBatchCCAuthRequest) XRequestId(xRequestId string) FrontDeskOperationsAPIGetResvForBatchCCAuthRequest {
	r.xRequestId = &xRequestId
	return r
}

// Customer&#39;s Integration Application Id
func (r FrontDeskOperationsAPIGetResvForBatchCCAuthRequest) XOriginatingApplication(xOriginatingApplication string) FrontDeskOperationsAPIGetResvForBatchCCAuthRequest {
	r.xOriginatingApplication = &xOriginatingApplication
	return r
}
...
func (r FrontDeskOperationsAPIGetRoomInterfaceStatusRequest) GuaranteeCodes(guaranteeCodes []string) FrontDeskOperationsAPIGetRoomInterfaceStatusRequest {
	r.guaranteeCodes = &guaranteeCodes
	return r
}

// Pass this header as true, if payload needs DVM
func (r FrontDeskOperationsAPIGetRoomInterfaceStatusRequest) ExternalData(externalData string) FrontDeskOperationsAPIGetRoomInterfaceStatusRequest {
	r.externalData = &externalData
	return r
}

// Request Id of an incoming request
func (r FrontDeskOperationsAPIGetRoomInterfaceStatusRequest) XRequestId(xRequestId string) FrontDeskOperationsAPIGetRoomInterfaceStatusRequest {
	r.xRequestId = &xRequestId
	return r
}

// Customer&#39;s Integration Application Id
func (r FrontDeskOperationsAPIGetRoomInterfaceStatusRequest) XOriginatingApplication(xOriginatingApplication string) FrontDeskOperationsAPIGetRoomInterfaceStatusRequest {
	r.xOriginatingApplication = &xOriginatingApplication
	return r
}
...
func (r FrontDeskOperationsAPIGetRoomKeyInterfaceDetailsRequest) InterfaceId(interfaceId string) FrontDeskOperationsAPIGetRoomKeyInterfaceDetailsRequest {
	r.interfaceId = &interfaceId
	return r
}

func (r FrontDeskOperationsAPIGetRoomKeyInterfaceDetailsRequest) OrderBy(orderBy []string) FrontDeskOperationsAPIGetRoomKeyInterfaceDetailsRequest {
	r.orderBy = &orderBy
	return r
}

func (r FrontDeskOperationsAPIGetRoomKeyInterfaceDetailsRequest) SortOrder(sortOrder []string) FrontDeskOperationsAPIGetRoomKeyInterfaceDetailsRequest {
	r.sortOrder = &sortOrder
	return r
}

// Pass this header as true, if payload needs DVM
func (r FrontDeskOperationsAPIGetRoomKeyInterfaceDetailsRequest) ExternalData(externalData string) FrontDeskOperationsAPIGetRoomKeyInterfaceDetailsRequest {
	r.externalData = &externalData
	return r
}

// Request Id of an incoming request
func (r FrontDeskOperationsAPIGetRoomKeyInterfaceDetailsRequest) XRequestId(xRequestId string) FrontDeskOperationsAPIGetRoomKeyInterfaceDetailsRequest {
	r.xRequestId = &xRequestId
	return r
}

// Customer&#39;s Integration Application Id
func (r FrontDeskOperationsAPIGetRoomKeyInterfaceDetailsRequest) XOriginatingApplication(xOriginatingApplication string) FrontDeskOperationsAPIGetRoomKeyInterfaceDetailsRequest {
	r.xOriginatingApplication = &xOriginatingApplication
	return r
}
...
func (r FrontDeskOperationsAPIGetRoomKeysRequest) IncludeInactiveRoomKeys(includeInactiveRoomKeys bool) FrontDeskOperationsAPIGetRoomKeysRequest {
	r.includeInactiveRoomKeys = &includeInactiveRoomKeys
	return r
}

// Unique DB internal number of a Hotel Interface record.
func (r FrontDeskOperationsAPIGetRoomKeysRequest) InterfaceId(interfaceId string) FrontDeskOperationsAPIGetRoomKeysRequest {
	r.interfaceId = &interfaceId
	return r
}

// Pass this header as true, if payload needs DVM
func (r FrontDeskOperationsAPIGetRoomKeysRequest) ExternalData(externalData string) FrontDeskOperationsAPIGetRoomKeysRequest {
	r.externalData = &externalData
	return r
}

// Request Id of an incoming request
func (r FrontDeskOperationsAPIGetRoomKeysRequest) XRequestId(xRequestId string) FrontDeskOperationsAPIGetRoomKeysRequest {
	r.xRequestId = &xRequestId
	return r
}

// Customer&#39;s Integration Application Id
func (r FrontDeskOperationsAPIGetRoomKeysRequest) XOriginatingApplication(xOriginatingApplication string) FrontDeskOperationsAPIGetRoomKeysRequest {
	r.xOriginatingApplication = &xOriginatingApplication
	return r
}
...
func (a *FrontDeskOperationsAPIService) GetRoomKeysExecute(r FrontDeskOperationsAPIGetRoomKeysRequest) (*RoomKeyInfo, *http.Response, error) {
	...
	if r.includeInactiveRoomKeys != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "includeInactiveRoomKeys", r.includeInactiveRoomKeys, "")
  }
	if r.interfaceId != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "interfaceId", r.interfaceId, "")
  }
...
// Pass this header as true, if payload needs DVM
func (r FrontDeskOperationsAPIGetRoomMoveHistoryRequest) ExternalData(externalData string) FrontDeskOperationsAPIGetRoomMoveHistoryRequest {
	r.externalData = &externalData
	return r
}

// Request Id of an incoming request
func (r FrontDeskOperationsAPIGetRoomMoveHistoryRequest) XRequestId(xRequestId string) FrontDeskOperationsAPIGetRoomMoveHistoryRequest {
	r.xRequestId = &xRequestId
	return r
}

// Customer&#39;s Integration Application Id
func (r FrontDeskOperationsAPIGetRoomMoveHistoryRequest) XOriginatingApplication(xOriginatingApplication string) FrontDeskOperationsAPIGetRoomMoveHistoryRequest {
	r.xOriginatingApplication = &xOriginatingApplication
	return r
}
...
// Pass this header as true, if payload needs DVM
func (r FrontDeskOperationsAPIGetServiceRequestsRequest) ExternalData(externalData string) FrontDeskOperationsAPIGetServiceRequestsRequest {
	r.externalData = &externalData
	return r
}

// Request Id of an incoming request
func (r FrontDeskOperationsAPIGetServiceRequestsRequest) XRequestId(xRequestId string) FrontDeskOperationsAPIGetServiceRequestsRequest {
	r.xRequestId = &xRequestId
	return r
}

// Customer&#39;s Integration Application Id
func (r FrontDeskOperationsAPIGetServiceRequestsRequest) XOriginatingApplication(xOriginatingApplication string) FrontDeskOperationsAPIGetServiceRequestsRequest {
	r.xOriginatingApplication = &xOriginatingApplication
	return r
}
...
// A code representing a room feature.
func (r FrontDeskOperationsAPIGetSuggestedRoomsRequest) RoomFeatureCode(roomFeatureCode []string) FrontDeskOperationsAPIGetSuggestedRoomsRequest {
	r.roomFeatureCode = &roomFeatureCode
	return r
}

// Pass this header as true, if payload needs DVM
func (r FrontDeskOperationsAPIGetSuggestedRoomsRequest) ExternalData(externalData string) FrontDeskOperationsAPIGetSuggestedRoomsRequest {
	r.externalData = &externalData
	return r
}

// Request Id of an incoming request
func (r FrontDeskOperationsAPIGetSuggestedRoomsRequest) XRequestId(xRequestId string) FrontDeskOperationsAPIGetSuggestedRoomsRequest {
	r.xRequestId = &xRequestId
	return r
}

// Customer&#39;s Integration Application Id
func (r FrontDeskOperationsAPIGetSuggestedRoomsRequest) XOriginatingApplication(xOriginatingApplication string) FrontDeskOperationsAPIGetSuggestedRoomsRequest {
	r.xOriginatingApplication = &xOriginatingApplication
	return r
}
...
// Pass this header as true, if payload needs DVM
func (r FrontDeskOperationsAPIGetWakeUpCallRequest) ExternalData(externalData string) FrontDeskOperationsAPIGetWakeUpCallRequest {
	r.externalData = &externalData
	return r
}

// Request Id of an incoming request
func (r FrontDeskOperationsAPIGetWakeUpCallRequest) XRequestId(xRequestId string) FrontDeskOperationsAPIGetWakeUpCallRequest {
	r.xRequestId = &xRequestId
	return r
}

// Customer&#39;s Integration Application Id
func (r FrontDeskOperationsAPIGetWakeUpCallRequest) XOriginatingApplication(xOriginatingApplication string) FrontDeskOperationsAPIGetWakeUpCallRequest {
	r.xOriginatingApplication = &xOriginatingApplication
	return r
}
...
type FrontDeskOperationsAPIGetWakeUpCallsRequest struct {
	ctx context.Context
	ApiService *FrontDeskOperationsAPIService
	hotelId string
	authorization *string
...
// Bearer token that needs to be passed which is generated post user authentication
func (r FrontDeskOperationsAPIGetWakeUpCallsRequest) Authorization(authorization string) FrontDeskOperationsAPIGetWakeUpCallsRequest {
	r.authorization = &authorization
	return r
}

// Client or Partner&#39;s Application Key
func (r FrontDeskOperationsAPIGetWakeUpCallsRequest) XAppKey(xAppKey string) FrontDeskOperationsAPIGetWakeUpCallsRequest {
	r.xAppKey = &xAppKey
	return r
}

// Mandatory parameter to identify the hotel code where the end user is logged in
func (r FrontDeskOperationsAPIGetWakeUpCallsRequest) XHotelid(xHotelid string) FrontDeskOperationsAPIGetWakeUpCallsRequest {
	r.xHotelid = &xHotelid
	return r
}

// Specifies whether we should fetch wake up calls with pending status.
func (r FrontDeskOperationsAPIGetWakeUpCallsRequest) FetchCancelled(fetchCancelled bool) FrontDeskOperationsAPIGetWakeUpCallsRequest {
	r.fetchCancelled = &fetchCancelled
	return r
}

// Specifies whether we should fetch wake up calls with pending status.
func (r FrontDeskOperationsAPIGetWakeUpCallsRequest) FetchCompleted(fetchCompleted bool) FrontDeskOperationsAPIGetWakeUpCallsRequest {
	r.fetchCompleted = &fetchCompleted
	return r
}

// Specifies whether we should fetch wake up calls with pending status.
func (r FrontDeskOperationsAPIGetWakeUpCallsRequest) FetchNoAnswer(fetchNoAnswer bool) FrontDeskOperationsAPIGetWakeUpCallsRequest {
	r.fetchNoAnswer = &fetchNoAnswer
	return r
}

// Specifies whether we should fetch wake up calls with pending status.
func (r FrontDeskOperationsAPIGetWakeUpCallsRequest) FetchPending(fetchPending bool) FrontDeskOperationsAPIGetWakeUpCallsRequest {
	r.fetchPending = &fetchPending
	return r
}

// A unique identifying value assigned by the creating system. The ID attribute may be used to reference a primary-key value within a database or in a particular implementation.
func (r FrontDeskOperationsAPIGetWakeUpCallsRequest) ReservationId(reservationId string) FrontDeskOperationsAPIGetWakeUpCallsRequest {
	r.reservationId = &reservationId
	return r
}

// Additional identifying value assigned by the creating system.
func (r FrontDeskOperationsAPIGetWakeUpCallsRequest) IdExtension(idExtension int32) FrontDeskOperationsAPIGetWakeUpCallsRequest {
	r.idExtension = &idExtension
	return r
}

// Used to identify the source of the identifier (e.g., IATA, ABTA).
func (r FrontDeskOperationsAPIGetWakeUpCallsRequest) ReservationIdContext(reservationIdContext string) FrontDeskOperationsAPIGetWakeUpCallsRequest {
	r.reservationIdContext = &reservationIdContext
	return r
}

// A reference to the type of object defined by the UniqueID element.
func (r FrontDeskOperationsAPIGetWakeUpCallsRequest) ReservationIdType(reservationIdType string) FrontDeskOperationsAPIGetWakeUpCallsRequest {
	r.reservationIdType = &reservationIdType
	return r
}

// Begin date from which to start fetching wake up calls.
func (r FrontDeskOperationsAPIGetWakeUpCallsRequest) BeginDate(beginDate string) FrontDeskOperationsAPIGetWakeUpCallsRequest {
	r.beginDate = &beginDate
	return r
}

// End date from which to start fetching wake up calls.
func (r FrontDeskOperationsAPIGetWakeUpCallsRequest) EndDate(endDate string) FrontDeskOperationsAPIGetWakeUpCallsRequest {
	r.endDate = &endDate
	return r
}

// Begin time from which to start fetching wake up calls.
func (r FrontDeskOperationsAPIGetWakeUpCallsRequest) BeginTime(beginTime string) FrontDeskOperationsAPIGetWakeUpCallsRequest {
	r.beginTime = &beginTime
	return r
}

// End time from which to start fetching wake up calls.
func (r FrontDeskOperationsAPIGetWakeUpCallsRequest) EndTime(endTime string) FrontDeskOperationsAPIGetWakeUpCallsRequest {
	r.endTime = &endTime
	return r
}

// Hotel room(s) for which wake up calls are to be fetched.
func (r FrontDeskOperationsAPIGetWakeUpCallsRequest) Room(room []string) FrontDeskOperationsAPIGetWakeUpCallsRequest {
	r.room = &room
	return r
}

// Block code for which wake up calls are to be fetched.
func (r FrontDeskOperationsAPIGetWakeUpCallsRequest) BlockId(blockId string) FrontDeskOperationsAPIGetWakeUpCallsRequest {
	r.blockId = &blockId
	return r
}

// Name with which wake up call may be associated.
func (r FrontDeskOperationsAPIGetWakeUpCallsRequest) GuestName(guestName string) FrontDeskOperationsAPIGetWakeUpCallsRequest {
	r.guestName = &guestName
	return r
}

// Pass this header as true, if payload needs DVM
func (r FrontDeskOperationsAPIGetWakeUpCallsRequest) ExternalData(externalData string) FrontDeskOperationsAPIGetWakeUpCallsRequest {
	r.externalData = &externalData
	return r
}

// Request Id of an incoming request
func (r FrontDeskOperationsAPIGetWakeUpCallsRequest) XRequestId(xRequestId string) FrontDeskOperationsAPIGetWakeUpCallsRequest {
	r.xRequestId = &xRequestId
	return r
}

// Customer&#39;s Integration Application Id
func (r FrontDeskOperationsAPIGetWakeUpCallsRequest) XOriginatingApplication(xOriginatingApplication string) FrontDeskOperationsAPIGetWakeUpCallsRequest {
	r.xOriginatingApplication = &xOriginatingApplication
	return r
}

// External system code.
func (r FrontDeskOperationsAPIGetWakeUpCallsRequest) XExternalsystem(xExternalsystem string) FrontDeskOperationsAPIGetWakeUpCallsRequest {
	r.xExternalsystem = &xExternalsystem
	return r
}

// Language code
func (r FrontDeskOperationsAPIGetWakeUpCallsRequest) AcceptLanguage(acceptLanguage string) FrontDeskOperationsAPIGetWakeUpCallsRequest {
	r.acceptLanguage = &acceptLanguage
	return r
}

func (r FrontDeskOperationsAPIGetWakeUpCallsRequest) Execute() (*WakeUpCalls, *http.Response, error) {
	return r.ApiService.GetWakeUpCallsExecute(r)
}

/*
GetWakeUpCalls Get Wake Up Calls

Use thisAPI to get existing wake up calls on an in-house reservation. <p><strong>OperationId:</strong>getWakeUpCalls</p>

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param hotelId
 @return FrontDeskOperationsAPIGetWakeUpCallsRequest

Deprecated
*/
func (a *FrontDeskOperationsAPIService) GetWakeUpCalls(ctx context.Context, hotelId string) FrontDeskOperationsAPIGetWakeUpCallsRequest {
	return FrontDeskOperationsAPIGetWakeUpCallsRequest{
		ApiService: a,
		ctx: ctx,
		hotelId: hotelId,
...
//  @return WakeUpCalls
// Deprecated
func (a *FrontDeskOperationsAPIService) GetWakeUpCallsExecute(r FrontDeskOperationsAPIGetWakeUpCallsRequest) (*WakeUpCalls, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "FrontDeskOperationsAPIService.GetWakeUpCalls")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/hotels/{hotelId}/wakeUpCalls"
	localVarPath = strings.Replace(localVarPath, "{"+"hotelId"+"}", url.PathEscape(parameterValueToString(r.hotelId, "hotelId")), -1)
...
// Pass this header as true, if payload needs DVM
func (r FrontDeskOperationsAPIMoveInHouseGuestRequest) ExternalData(externalData string) FrontDeskOperationsAPIMoveInHouseGuestRequest {
	r.externalData = &externalData
	return r
}

// Request Id of an incoming request
func (r FrontDeskOperationsAPIMoveInHouseGuestRequest) XRequestId(xRequestId string) FrontDeskOperationsAPIMoveInHouseGuestRequest {
	r.xRequestId = &xRequestId
	return r
}

// Customer&#39;s Integration Application Id
func (r FrontDeskOperationsAPIMoveInHouseGuestRequest) XOriginatingApplication(xOriginatingApplication string) FrontDeskOperationsAPIMoveInHouseGuestRequest {
	r.xOriginatingApplication = &xOriginatingApplication
	return r
}
...
type FrontDeskOperationsAPIPingFrontDeskOperationsServiceRequest struct {
	ctx context.Context
	ApiService *FrontDeskOperationsAPIService
	authorization *string
	xAppKey *string
...
// Bearer token that needs to be passed which is generated post user authentication
func (r FrontDeskOperationsAPIPingFrontDeskOperationsServiceRequest) Authorization(authorization string) FrontDeskOperationsAPIPingFrontDeskOperationsServiceRequest {
	r.authorization = &authorization
	return r
}

// Client or Partner&#39;s Application Key
func (r FrontDeskOperationsAPIPingFrontDeskOperationsServiceRequest) XAppKey(xAppKey string) FrontDeskOperationsAPIPingFrontDeskOperationsServiceRequest {
	r.xAppKey = &xAppKey
	return r
}

// Mandatory parameter to identify the hotel code where the end user is logged in
func (r FrontDeskOperationsAPIPingFrontDeskOperationsServiceRequest) XHotelid(xHotelid string) FrontDeskOperationsAPIPingFrontDeskOperationsServiceRequest {
	r.xHotelid = &xHotelid
	return r
}

// Pass this header as true, if payload needs DVM
func (r FrontDeskOperationsAPIPingFrontDeskOperationsServiceRequest) ExternalData(externalData string) FrontDeskOperationsAPIPingFrontDeskOperationsServiceRequest {
	r.externalData = &externalData
	return r
}

// Request Id of an incoming request
func (r FrontDeskOperationsAPIPingFrontDeskOperationsServiceRequest) XRequestId(xRequestId string) FrontDeskOperationsAPIPingFrontDeskOperationsServiceRequest {
	r.xRequestId = &xRequestId
	return r
}

// Customer&#39;s Integration Application Id
func (r FrontDeskOperationsAPIPingFrontDeskOperationsServiceRequest) XOriginatingApplication(xOriginatingApplication string) FrontDeskOperationsAPIPingFrontDeskOperationsServiceRequest {
	r.xOriginatingApplication = &xOriginatingApplication
	return r
}

// External system code.
func (r FrontDeskOperationsAPIPingFrontDeskOperationsServiceRequest) XExternalsystem(xExternalsystem string) FrontDeskOperationsAPIPingFrontDeskOperationsServiceRequest {
	r.xExternalsystem = &xExternalsystem
	return r
}

// Language code
func (r FrontDeskOperationsAPIPingFrontDeskOperationsServiceRequest) AcceptLanguage(acceptLanguage string) FrontDeskOperationsAPIPingFrontDeskOperationsServiceRequest {
	r.acceptLanguage = &acceptLanguage
	return r
}

func (r FrontDeskOperationsAPIPingFrontDeskOperationsServiceRequest) Execute() (*OperaVersion, *http.Response, error) {
	return r.ApiService.PingFrontDeskOperationsServiceExecute(r)
}

/*
PingFrontDeskOperationsService Ping Front Desk Service

Ping front desk service <p><strong>OperationId:</strong>pingFrontDeskOperationsService</p>

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return FrontDeskOperationsAPIPingFrontDeskOperationsServiceRequest
*/
func (a *FrontDeskOperationsAPIService) PingFrontDeskOperationsService(ctx context.Context) FrontDeskOperationsAPIPingFrontDeskOperationsServiceRequest {
	return FrontDeskOperationsAPIPingFrontDeskOperationsServiceRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return OperaVersion
func (a *FrontDeskOperationsAPIService) PingFrontDeskOperationsServiceExecute(r FrontDeskOperationsAPIPingFrontDeskOperationsServiceRequest) (*OperaVersion, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "FrontDeskOperationsAPIService.PingFrontDeskOperationsService")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/services/frontDeskOperations/status"
...
// Pass this header as true, if payload needs DVM
func (r FrontDeskOperationsAPIPlaceRoomsOnHoldRequest) ExternalData(externalData string) FrontDeskOperationsAPIPlaceRoomsOnHoldRequest {
	r.externalData = &externalData
	return r
}

// Request Id of an incoming request
func (r FrontDeskOperationsAPIPlaceRoomsOnHoldRequest) XRequestId(xRequestId string) FrontDeskOperationsAPIPlaceRoomsOnHoldRequest {
	r.xRequestId = &xRequestId
	return r
}

// Customer&#39;s Integration Application Id
func (r FrontDeskOperationsAPIPlaceRoomsOnHoldRequest) XOriginatingApplication(xOriginatingApplication string) FrontDeskOperationsAPIPlaceRoomsOnHoldRequest {
	r.xOriginatingApplication = &xOriginatingApplication
	return r
}
...
// Pass this header as true, if payload needs DVM
func (r FrontDeskOperationsAPIPostAdvanceCheckInRequest) ExternalData(externalData string) FrontDeskOperationsAPIPostAdvanceCheckInRequest {
	r.externalData = &externalData
	return r
}

// Request Id of an incoming request
func (r FrontDeskOperationsAPIPostAdvanceCheckInRequest) XRequestId(xRequestId string) FrontDeskOperationsAPIPostAdvanceCheckInRequest {
	r.xRequestId = &xRequestId
	return r
}

// Customer&#39;s Integration Application Id
func (r FrontDeskOperationsAPIPostAdvanceCheckInRequest) XOriginatingApplication(xOriginatingApplication string) FrontDeskOperationsAPIPostAdvanceCheckInRequest {
	r.xOriginatingApplication = &xOriginatingApplication
	return r
}
...
// Pass this header as true, if payload needs DVM
func (r FrontDeskOperationsAPIPostCheckInRequest) ExternalData(externalData string) FrontDeskOperationsAPIPostCheckInRequest {
	r.externalData = &externalData
	return r
}

// Request Id of an incoming request
func (r FrontDeskOperationsAPIPostCheckInRequest) XRequestId(xRequestId string) FrontDeskOperationsAPIPostCheckInRequest {
	r.xRequestId = &xRequestId
	return r
}

// Customer&#39;s Integration Application Id
func (r FrontDeskOperationsAPIPostCheckInRequest) XOriginatingApplication(xOriginatingApplication string) FrontDeskOperationsAPIPostCheckInRequest {
	r.xOriginatingApplication = &xOriginatingApplication
	return r
}
...
// Pass this header as true, if payload needs DVM
func (r FrontDeskOperationsAPIPostDailyDocketRequest) ExternalData(externalData string) FrontDeskOperationsAPIPostDailyDocketRequest {
	r.externalData = &externalData
	return r
}

// Request Id of an incoming request
func (r FrontDeskOperationsAPIPostDailyDocketRequest) XRequestId(xRequestId string) FrontDeskOperationsAPIPostDailyDocketRequest {
	r.xRequestId = &xRequestId
	return r
}

// Customer&#39;s Integration Application Id
func (r FrontDeskOperationsAPIPostDailyDocketRequest) XOriginatingApplication(xOriginatingApplication string) FrontDeskOperationsAPIPostDailyDocketRequest {
	r.xOriginatingApplication = &xOriginatingApplication
	return r
}
...
type FrontDeskOperationsAPIPostExternalRoomKeysRequest struct {
	ctx context.Context
	ApiService *FrontDeskOperationsAPIService
	hotelId string
	authorization *string
...
// Bearer token that needs to be passed which is generated post user authentication
func (r FrontDeskOperationsAPIPostExternalRoomKeysRequest) Authorization(authorization string) FrontDeskOperationsAPIPostExternalRoomKeysRequest {
	r.authorization = &authorization
	return r
}

// Client or Partner&#39;s Application Key
func (r FrontDeskOperationsAPIPostExternalRoomKeysRequest) XAppKey(xAppKey string) FrontDeskOperationsAPIPostExternalRoomKeysRequest {
	r.xAppKey = &xAppKey
	return r
}

// Mandatory parameter to identify the hotel code where the end user is logged in
func (r FrontDeskOperationsAPIPostExternalRoomKeysRequest) XHotelid(xHotelid string) FrontDeskOperationsAPIPostExternalRoomKeysRequest {
	r.xHotelid = &xHotelid
	return r
}

// Request for generation of room key.
func (r FrontDeskOperationsAPIPostExternalRoomKeysRequest) RoomKey(roomKey RoomKeyExternal) FrontDeskOperationsAPIPostExternalRoomKeysRequest {
	r.roomKey = &roomKey
	return r
}

// Pass this header as true, if payload needs DVM
func (r FrontDeskOperationsAPIPostExternalRoomKeysRequest) ExternalData(externalData string) FrontDeskOperationsAPIPostExternalRoomKeysRequest {
	r.externalData = &externalData
	return r
}

// Request Id of an incoming request
func (r FrontDeskOperationsAPIPostExternalRoomKeysRequest) XRequestId(xRequestId string) FrontDeskOperationsAPIPostExternalRoomKeysRequest {
	r.xRequestId = &xRequestId
	return r
}

// Customer&#39;s Integration Application Id
func (r FrontDeskOperationsAPIPostExternalRoomKeysRequest) XOriginatingApplication(xOriginatingApplication string) FrontDeskOperationsAPIPostExternalRoomKeysRequest {
	r.xOriginatingApplication = &xOriginatingApplication
	return r
}

// External system code.
func (r FrontDeskOperationsAPIPostExternalRoomKeysRequest) XExternalsystem(xExternalsystem string) FrontDeskOperationsAPIPostExternalRoomKeysRequest {
	r.xExternalsystem = &xExternalsystem
	return r
}

// Language code
func (r FrontDeskOperationsAPIPostExternalRoomKeysRequest) AcceptLanguage(acceptLanguage string) FrontDeskOperationsAPIPostExternalRoomKeysRequest {
	r.acceptLanguage = &acceptLanguage
	return r
}

func (r FrontDeskOperationsAPIPostExternalRoomKeysRequest) Execute() (*RoomKeyExternalDetails, *http.Response, error) {
	return r.ApiService.PostExternalRoomKeysExecute(r)
}

/*
PostExternalRoomKeys Requests room key(s)
...
<p><strong>OperationId:</strong> postExternalRoomKeys</p>
 ...
 @return FrontDeskOperationsAPIPostExternalRoomKeysRequest

Deprecated
*/
func (a *FrontDeskOperationsAPIService) PostExternalRoomKeys(ctx context.Context, hotelId string) FrontDeskOperationsAPIPostExternalRoomKeysRequest {
	return FrontDeskOperationsAPIPostExternalRoomKeysRequest{
		ApiService: a,
		ctx: ctx,
		hotelId: hotelId,
...
// Execute executes the request
//  @return RoomKeyExternalDetails
// Deprecated
func (a *FrontDeskOperationsAPIService) PostExternalRoomKeysExecute(r FrontDeskOperationsAPIPostExternalRoomKeysRequest) (*RoomKeyExternalDetails, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *RoomKeyExternalDetails
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "FrontDeskOperationsAPIService.PostExternalRoomKeys")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/hotels/{hotelId}/externalRoomKeys"
	localVarPath = strings.Replace(localVarPath, "{"+"hotelId"+"}", url.PathEscape(parameterValueToString(r.hotelId, "hotelId")), -1)
...
// Pass this header as true, if payload needs DVM
func (r FrontDeskOperationsAPIPostMassAdvanceCheckInRequest) ExternalData(externalData string) FrontDeskOperationsAPIPostMassAdvanceCheckInRequest {
	r.externalData = &externalData
	return r
}

// Request Id of an incoming request
func (r FrontDeskOperationsAPIPostMassAdvanceCheckInRequest) XRequestId(xRequestId string) FrontDeskOperationsAPIPostMassAdvanceCheckInRequest {
	r.xRequestId = &xRequestId
	return r
}

// Customer&#39;s Integration Application Id
func (r FrontDeskOperationsAPIPostMassAdvanceCheckInRequest) XOriginatingApplication(xOriginatingApplication string) FrontDeskOperationsAPIPostMassAdvanceCheckInRequest {
	r.xOriginatingApplication = &xOriginatingApplication
	return r
}
...
// Pass this header as true, if payload needs DVM
func (r FrontDeskOperationsAPIPostMassCheckInRequest) ExternalData(externalData string) FrontDeskOperationsAPIPostMassCheckInRequest {
	r.externalData = &externalData
	return r
}

// Request Id of an incoming request
func (r FrontDeskOperationsAPIPostMassCheckInRequest) XRequestId(xRequestId string) FrontDeskOperationsAPIPostMassCheckInRequest {
	r.xRequestId = &xRequestId
	return r
}

// Customer&#39;s Integration Application Id
func (r FrontDeskOperationsAPIPostMassCheckInRequest) XOriginatingApplication(xOriginatingApplication string) FrontDeskOperationsAPIPostMassCheckInRequest {
	r.xOriginatingApplication = &xOriginatingApplication
	return r
}
...
// Pass this header as true, if payload needs DVM
func (r FrontDeskOperationsAPIPostRoomAssignmentRequest) ExternalData(externalData string) FrontDeskOperationsAPIPostRoomAssignmentRequest {
	r.externalData = &externalData
	return r
}

// Request Id of an incoming request
func (r FrontDeskOperationsAPIPostRoomAssignmentRequest) XRequestId(xRequestId string) FrontDeskOperationsAPIPostRoomAssignmentRequest {
	r.xRequestId = &xRequestId
	return r
}

// Customer&#39;s Integration Application Id
func (r FrontDeskOperationsAPIPostRoomAssignmentRequest) XOriginatingApplication(xOriginatingApplication string) FrontDeskOperationsAPIPostRoomAssignmentRequest {
	r.xOriginatingApplication = &xOriginatingApplication
	return r
}
...
// Pass this header as true, if payload needs DVM
func (r FrontDeskOperationsAPIPostRoomKeyRequest) ExternalData(externalData string) FrontDeskOperationsAPIPostRoomKeyRequest {
	r.externalData = &externalData
	return r
}

// Request Id of an incoming request
func (r FrontDeskOperationsAPIPostRoomKeyRequest) XRequestId(xRequestId string) FrontDeskOperationsAPIPostRoomKeyRequest {
	r.xRequestId = &xRequestId
	return r
}

// Customer&#39;s Integration Application Id
func (r FrontDeskOperationsAPIPostRoomKeyRequest) XOriginatingApplication(xOriginatingApplication string) FrontDeskOperationsAPIPostRoomKeyRequest {
	r.xOriginatingApplication = &xOriginatingApplication
	return r
}
...
type FrontDeskOperationsAPIPostRoomKeysExternalRequest struct {
	ctx context.Context
	ApiService *FrontDeskOperationsAPIService
	hotelId string
	authorization *string
...
// Bearer token that needs to be passed which is generated post user authentication
func (r FrontDeskOperationsAPIPostRoomKeysExternalRequest) Authorization(authorization string) FrontDeskOperationsAPIPostRoomKeysExternalRequest {
	r.authorization = &authorization
	return r
}

// Client or Partner&#39;s Application Key
func (r FrontDeskOperationsAPIPostRoomKeysExternalRequest) XAppKey(xAppKey string) FrontDeskOperationsAPIPostRoomKeysExternalRequest {
	r.xAppKey = &xAppKey
	return r
}

// Mandatory parameter to identify the hotel code where the end user is logged in
func (r FrontDeskOperationsAPIPostRoomKeysExternalRequest) XHotelid(xHotelid string) FrontDeskOperationsAPIPostRoomKeysExternalRequest {
	r.xHotelid = &xHotelid
	return r
}

// Request for generation of room key.
func (r FrontDeskOperationsAPIPostRoomKeysExternalRequest) RoomKey(roomKey RoomKeysExternal) FrontDeskOperationsAPIPostRoomKeysExternalRequest {
	r.roomKey = &roomKey
	return r
}

// Pass this header as true, if payload needs DVM
func (r FrontDeskOperationsAPIPostRoomKeysExternalRequest) ExternalData(externalData string) FrontDeskOperationsAPIPostRoomKeysExternalRequest {
	r.externalData = &externalData
	return r
}

// Request Id of an incoming request
func (r FrontDeskOperationsAPIPostRoomKeysExternalRequest) XRequestId(xRequestId string) FrontDeskOperationsAPIPostRoomKeysExternalRequest {
	r.xRequestId = &xRequestId
	return r
}

// Customer&#39;s Integration Application Id
func (r FrontDeskOperationsAPIPostRoomKeysExternalRequest) XOriginatingApplication(xOriginatingApplication string) FrontDeskOperationsAPIPostRoomKeysExternalRequest {
	r.xOriginatingApplication = &xOriginatingApplication
	return r
}

// External system code.
func (r FrontDeskOperationsAPIPostRoomKeysExternalRequest) XExternalsystem(xExternalsystem string) FrontDeskOperationsAPIPostRoomKeysExternalRequest {
	r.xExternalsystem = &xExternalsystem
	return r
}

// Language code
func (r FrontDeskOperationsAPIPostRoomKeysExternalRequest) AcceptLanguage(acceptLanguage string) FrontDeskOperationsAPIPostRoomKeysExternalRequest {
	r.acceptLanguage = &acceptLanguage
	return r
}

func (r FrontDeskOperationsAPIPostRoomKeysExternalRequest) Execute() (*RoomKeysExternalDetails, *http.Response, error) {
	return r.ApiService.PostRoomKeysExternalExecute(r)
}

/*
PostRoomKeysExternal Requests room key(s)
...
<p><strong>OperationId:</strong> postRoomKeysExternal</p>
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param hotelId Unique ID of the hotel
 @return FrontDeskOperationsAPIPostRoomKeysExternalRequest
*/
func (a *FrontDeskOperationsAPIService) PostRoomKeysExternal(ctx context.Context, hotelId string) FrontDeskOperationsAPIPostRoomKeysExternalRequest {
	return FrontDeskOperationsAPIPostRoomKeysExternalRequest{
		ApiService: a,
		ctx: ctx,
		hotelId: hotelId,
...
// Execute executes the request
//  @return RoomKeysExternalDetails
func (a *FrontDeskOperationsAPIService) PostRoomKeysExternalExecute(r FrontDeskOperationsAPIPostRoomKeysExternalRequest) (*RoomKeysExternalDetails, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *RoomKeysExternalDetails
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "FrontDeskOperationsAPIService.PostRoomKeysExternal")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/hotels/{hotelId}/roomKeysExternal"
	localVarPath = strings.Replace(localVarPath, "{"+"hotelId"+"}", url.PathEscape(parameterValueToString(r.hotelId, "hotelId")), -1)
...
// Pass this header as true, if payload needs DVM
func (r FrontDeskOperationsAPIPostServiceRequestsRequest) ExternalData(externalData string) FrontDeskOperationsAPIPostServiceRequestsRequest {
	r.externalData = &externalData
	return r
}

// Request Id of an incoming request
func (r FrontDeskOperationsAPIPostServiceRequestsRequest) XRequestId(xRequestId string) FrontDeskOperationsAPIPostServiceRequestsRequest {
	r.xRequestId = &xRequestId
	return r
}

// Customer&#39;s Integration Application Id
func (r FrontDeskOperationsAPIPostServiceRequestsRequest) XOriginatingApplication(xOriginatingApplication string) FrontDeskOperationsAPIPostServiceRequestsRequest {
	r.xOriginatingApplication = &xOriginatingApplication
	return r
}
...
// Pass this header as true, if payload needs DVM
func (r FrontDeskOperationsAPIPostWakeUpCallRequest) ExternalData(externalData string) FrontDeskOperationsAPIPostWakeUpCallRequest {
	r.externalData = &externalData
	return r
}

// Request Id of an incoming request
func (r FrontDeskOperationsAPIPostWakeUpCallRequest) XRequestId(xRequestId string) FrontDeskOperationsAPIPostWakeUpCallRequest {
	r.xRequestId = &xRequestId
	return r
}

// Customer&#39;s Integration Application Id
func (r FrontDeskOperationsAPIPostWakeUpCallRequest) XOriginatingApplication(xOriginatingApplication string) FrontDeskOperationsAPIPostWakeUpCallRequest {
	r.xOriginatingApplication = &xOriginatingApplication
	return r
}
...
// Pass this header as true, if payload needs DVM
func (r FrontDeskOperationsAPIProcessBatchCCAuthRequest) ExternalData(externalData string) FrontDeskOperationsAPIProcessBatchCCAuthRequest {
	r.externalData = &externalData
	return r
}

// Request Id of an incoming request
func (r FrontDeskOperationsAPIProcessBatchCCAuthRequest) XRequestId(xRequestId string) FrontDeskOperationsAPIProcessBatchCCAuthRequest {
	r.xRequestId = &xRequestId
	return r
}

// Customer&#39;s Integration Application Id
func (r FrontDeskOperationsAPIProcessBatchCCAuthRequest) XOriginatingApplication(xOriginatingApplication string) FrontDeskOperationsAPIProcessBatchCCAuthRequest {
	r.xOriginatingApplication = &xOriginatingApplication
	return r
}
...
// Pass this header as true, if payload needs DVM
func (r FrontDeskOperationsAPIPutDailyDocketRequest) ExternalData(externalData string) FrontDeskOperationsAPIPutDailyDocketRequest {
	r.externalData = &externalData
	return r
}

// Request Id of an incoming request
func (r FrontDeskOperationsAPIPutDailyDocketRequest) XRequestId(xRequestId string) FrontDeskOperationsAPIPutDailyDocketRequest {
	r.xRequestId = &xRequestId
	return r
}

// Customer&#39;s Integration Application Id
func (r FrontDeskOperationsAPIPutDailyDocketRequest) XOriginatingApplication(xOriginatingApplication string) FrontDeskOperationsAPIPutDailyDocketRequest {
	r.xOriginatingApplication = &xOriginatingApplication
	return r
}
...
// Pass this header as true, if payload needs DVM
func (r FrontDeskOperationsAPIPutReservationQueuePriorityRequest) ExternalData(externalData string) FrontDeskOperationsAPIPutReservationQueuePriorityRequest {
	r.externalData = &externalData
	return r
}

// Request Id of an incoming request
func (r FrontDeskOperationsAPIPutReservationQueuePriorityRequest) XRequestId(xRequestId string) FrontDeskOperationsAPIPutReservationQueuePriorityRequest {
	r.xRequestId = &xRequestId
	return r
}

// Customer&#39;s Integration Application Id
func (r FrontDeskOperationsAPIPutReservationQueuePriorityRequest) XOriginatingApplication(xOriginatingApplication string) FrontDeskOperationsAPIPutReservationQueuePriorityRequest {
	r.xOriginatingApplication = &xOriginatingApplication
	return r
}
...
// Pass this header as true, if payload needs DVM
func (r FrontDeskOperationsAPIPutRoomInterfaceStatusRequest) ExternalData(externalData string) FrontDeskOperationsAPIPutRoomInterfaceStatusRequest {
	r.externalData = &externalData
	return r
}

// Request Id of an incoming request
func (r FrontDeskOperationsAPIPutRoomInterfaceStatusRequest) XRequestId(xRequestId string) FrontDeskOperationsAPIPutRoomInterfaceStatusRequest {
	r.xRequestId = &xRequestId
	return r
}

// Customer&#39;s Integration Application Id
func (r FrontDeskOperationsAPIPutRoomInterfaceStatusRequest) XOriginatingApplication(xOriginatingApplication string) FrontDeskOperationsAPIPutRoomInterfaceStatusRequest {
	r.xOriginatingApplication = &xOriginatingApplication
	return r
}
...
// Pass this header as true, if payload needs DVM
func (r FrontDeskOperationsAPIPutRoomKeysRequest) ExternalData(externalData string) FrontDeskOperationsAPIPutRoomKeysRequest {
	r.externalData = &externalData
	return r
}

// Request Id of an incoming request
func (r FrontDeskOperationsAPIPutRoomKeysRequest) XRequestId(xRequestId string) FrontDeskOperationsAPIPutRoomKeysRequest {
	r.xRequestId = &xRequestId
	return r
}

// Customer&#39;s Integration Application Id
func (r FrontDeskOperationsAPIPutRoomKeysRequest) XOriginatingApplication(xOriginatingApplication string) FrontDeskOperationsAPIPutRoomKeysRequest {
	r.xOriginatingApplication = &xOriginatingApplication
	return r
}
...
// Pass this header as true, if payload needs DVM
func (r FrontDeskOperationsAPIPutServiceRequestsRequest) ExternalData(externalData string) FrontDeskOperationsAPIPutServiceRequestsRequest {
	r.externalData = &externalData
	return r
}

// Request Id of an incoming request
func (r FrontDeskOperationsAPIPutServiceRequestsRequest) XRequestId(xRequestId string) FrontDeskOperationsAPIPutServiceRequestsRequest {
	r.xRequestId = &xRequestId
	return r
}

// Customer&#39;s Integration Application Id
func (r FrontDeskOperationsAPIPutServiceRequestsRequest) XOriginatingApplication(xOriginatingApplication string) FrontDeskOperationsAPIPutServiceRequestsRequest {
	r.xOriginatingApplication = &xOriginatingApplication
	return r
}
...
// Pass this header as true, if payload needs DVM
func (r FrontDeskOperationsAPIPutWakeUpCallRequest) ExternalData(externalData string) FrontDeskOperationsAPIPutWakeUpCallRequest {
	r.externalData = &externalData
	return r
}

// Request Id of an incoming request
func (r FrontDeskOperationsAPIPutWakeUpCallRequest) XRequestId(xRequestId string) FrontDeskOperationsAPIPutWakeUpCallRequest {
	r.xRequestId = &xRequestId
	return r
}

// Customer&#39;s Integration Application Id
func (r FrontDeskOperationsAPIPutWakeUpCallRequest) XOriginatingApplication(xOriginatingApplication string) FrontDeskOperationsAPIPutWakeUpCallRequest {
	r.xOriginatingApplication = &xOriginatingApplication
	return r
}
...
// Unique DB internal number of a Hotel Interface record.
func (r FrontDeskOperationsAPIReadRoomKeyRequest) InterfaceId(interfaceId string) FrontDeskOperationsAPIReadRoomKeyRequest {
	r.interfaceId = &interfaceId
	return r
}
...
// Pass this header as true, if payload needs DVM
func (r FrontDeskOperationsAPIReadRoomKeyRequest) ExternalData(externalData string) FrontDeskOperationsAPIReadRoomKeyRequest {
	r.externalData = &externalData
	return r
}

// Request Id of an incoming request
func (r FrontDeskOperationsAPIReadRoomKeyRequest) XRequestId(xRequestId string) FrontDeskOperationsAPIReadRoomKeyRequest {
	r.xRequestId = &xRequestId
	return r
}

// Customer&#39;s Integration Application Id
func (r FrontDeskOperationsAPIReadRoomKeyRequest) XOriginatingApplication(xOriginatingApplication string) FrontDeskOperationsAPIReadRoomKeyRequest {
	r.xOriginatingApplication = &xOriginatingApplication
	return r
}
...
// Pass this header as true, if payload needs DVM
func (r FrontDeskOperationsAPIReleaseRoomsOnHoldRequest) ExternalData(externalData string) FrontDeskOperationsAPIReleaseRoomsOnHoldRequest {
	r.externalData = &externalData
	return r
}

// Request Id of an incoming request
func (r FrontDeskOperationsAPIReleaseRoomsOnHoldRequest) XRequestId(xRequestId string) FrontDeskOperationsAPIReleaseRoomsOnHoldRequest {
	r.xRequestId = &xRequestId
	return r
}

// Customer&#39;s Integration Application Id
func (r FrontDeskOperationsAPIReleaseRoomsOnHoldRequest) XOriginatingApplication(xOriginatingApplication string) FrontDeskOperationsAPIReleaseRoomsOnHoldRequest {
	r.xOriginatingApplication = &xOriginatingApplication
	return r
}
...
type FrontDeskOperationsAPISearchWakeUpCallsRequest struct {
	ctx context.Context
	ApiService *FrontDeskOperationsAPIService
	hotelId string
	authorization *string
	...
	xExternalsystem *string
	acceptLanguage *string
	searchWakeUpCallsRequest *SearchWakeUpCallsRequest
}

// Bearer token that needs to be passed which is generated post user authentication
func (r FrontDeskOperationsAPISearchWakeUpCallsRequest) Authorization(authorization string) FrontDeskOperationsAPISearchWakeUpCallsRequest {
	r.authorization = &authorization
	return r
}

// Client or Partner&#39;s Application Key
func (r FrontDeskOperationsAPISearchWakeUpCallsRequest) XAppKey(xAppKey string) FrontDeskOperationsAPISearchWakeUpCallsRequest {
	r.xAppKey = &xAppKey
	return r
}

// Mandatory parameter to identify the hotel code where the end user is logged in
func (r FrontDeskOperationsAPISearchWakeUpCallsRequest) XHotelid(xHotelid string) FrontDeskOperationsAPISearchWakeUpCallsRequest {
	r.xHotelid = &xHotelid
	return r
}

// Pass this header as true, if payload needs DVM
func (r FrontDeskOperationsAPISearchWakeUpCallsRequest) ExternalData(externalData string) FrontDeskOperationsAPISearchWakeUpCallsRequest {
	r.externalData = &externalData
	return r
}

// Request Id of an incoming request
func (r FrontDeskOperationsAPISearchWakeUpCallsRequest) XRequestId(xRequestId string) FrontDeskOperationsAPISearchWakeUpCallsRequest {
	r.xRequestId = &xRequestId
	return r
}

// Customer&#39;s Integration Application Id
func (r FrontDeskOperationsAPISearchWakeUpCallsRequest) XOriginatingApplication(xOriginatingApplication string) FrontDeskOperationsAPISearchWakeUpCallsRequest {
	r.xOriginatingApplication = &xOriginatingApplication
	return r
}

// External system code.
func (r FrontDeskOperationsAPISearchWakeUpCallsRequest) XExternalsystem(xExternalsystem string) FrontDeskOperationsAPISearchWakeUpCallsRequest {
	r.xExternalsystem = &xExternalsystem
	return r
}

// Language code
func (r FrontDeskOperationsAPISearchWakeUpCallsRequest) AcceptLanguage(acceptLanguage string) FrontDeskOperationsAPISearchWakeUpCallsRequest {
	r.acceptLanguage = &acceptLanguage
	return r
}

// searchWakeUpCalls Request
func (r FrontDeskOperationsAPISearchWakeUpCallsRequest) SearchWakeUpCallsRequest(searchWakeUpCallsRequest SearchWakeUpCallsRequest) FrontDeskOperationsAPISearchWakeUpCallsRequest {
	r.searchWakeUpCallsRequest = &searchWakeUpCallsRequest
	return r
}

func (r FrontDeskOperationsAPISearchWakeUpCallsRequest) Execute() (*WakeUpCalls, *http.Response, error) {
	return r.ApiService.SearchWakeUpCallsExecute(r)
}

/*
SearchWakeUpCalls Get Wake Up Calls

Use thisAPI to get existing wake up calls on an in-house reservation. <p><strong>OperationId:</strong>searchWakeUpCalls</p>

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param hotelId
 @return FrontDeskOperationsAPISearchWakeUpCallsRequest
*/
func (a *FrontDeskOperationsAPIService) SearchWakeUpCalls(ctx context.Context, hotelId string) FrontDeskOperationsAPISearchWakeUpCallsRequest {
	return FrontDeskOperationsAPISearchWakeUpCallsRequest{
		ApiService: a,
		ctx: ctx,
		hotelId: hotelId,
...
// Execute executes the request
//  @return WakeUpCalls
func (a *FrontDeskOperationsAPIService) SearchWakeUpCallsExecute(r FrontDeskOperationsAPISearchWakeUpCallsRequest) (*WakeUpCalls, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "FrontDeskOperationsAPIService.SearchWakeUpCalls")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/hotels/{hotelId}/wakeUpCalls/searches"
	localVarPath = strings.Replace(localVarPath, "{"+"hotelId"+"}", url.PathEscape(parameterValueToString(r.hotelId, "hotelId")), -1)
	...
	// body params
	localVarPostBody = r.searchWakeUpCallsRequest
	req, err := a.client.prepareRequest(r.ctx, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, formFiles)
	if err != nil {
		return localVarReturnValue, nil, err
	}
...
type FrontDeskOperationsAPIShiftRoomsRequest struct {
	...
	overrideBackToBackRoomSkip *bool
	externalData *string
	xRequestId *string
	xOriginatingApplication *string
	xExternalsystem *string
...
func (r FrontDeskOperationsAPIShiftRoomsRequest) OverrideBackToBackRoomSkip(overrideBackToBackRoomSkip bool) FrontDeskOperationsAPIShiftRoomsRequest {
	r.overrideBackToBackRoomSkip = &overrideBackToBackRoomSkip
	return r
}

// Pass this header as true, if payload needs DVM
func (r FrontDeskOperationsAPIShiftRoomsRequest) ExternalData(externalData string) FrontDeskOperationsAPIShiftRoomsRequest {
	r.externalData = &externalData
	return r
}

// Request Id of an incoming request
func (r FrontDeskOperationsAPIShiftRoomsRequest) XRequestId(xRequestId string) FrontDeskOperationsAPIShiftRoomsRequest {
	r.xRequestId = &xRequestId
	return r
}

// Customer&#39;s Integration Application Id
func (r FrontDeskOperationsAPIShiftRoomsRequest) XOriginatingApplication(xOriginatingApplication string) FrontDeskOperationsAPIShiftRoomsRequest {
	r.xOriginatingApplication = &xOriginatingApplication
	return r
}
...
func (a *FrontDeskOperationsAPIService) ShiftRoomsExecute(r FrontDeskOperationsAPIShiftRoomsRequest) (*Status, *http.Response, error) {
	...
	if r.overrideBackToBackRoomSkip != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "overrideBackToBackRoomSkip", r.overrideBackToBackRoomSkip, "")
  }
	// to determine the Content-Type header
	localVarHTTPContentTypes := []string{"application/json;charset=UTF-8"}
...
// Specifies if the Swap/Shift action should continue regardless of the reservation having a Back to Back Linked Reservation assigned to the same room. Swap/Shift functionality is available when the Swap/Shift Rooms OPERA Control is active. Back to Back Reservation handling is available when the Back to Back Handling for Linked Reservations OPERA Control is active.
func (r FrontDeskOperationsAPISwapRoomsRequest) OverrideBackToBackRoomSkip(overrideBackToBackRoomSkip bool) FrontDeskOperationsAPISwapRoomsRequest {
	r.overrideBackToBackRoomSkip = &overrideBackToBackRoomSkip
	return r
}

// Pass this header as true, if payload needs DVM
func (r FrontDeskOperationsAPISwapRoomsRequest) ExternalData(externalData string) FrontDeskOperationsAPISwapRoomsRequest {
	r.externalData = &externalData
	return r
}

// Request Id of an incoming request
func (r FrontDeskOperationsAPISwapRoomsRequest) XRequestId(xRequestId string) FrontDeskOperationsAPISwapRoomsRequest {
	r.xRequestId = &xRequestId
	return r
}

// Customer&#39;s Integration Application Id
func (r FrontDeskOperationsAPISwapRoomsRequest) XOriginatingApplication(xOriginatingApplication string) FrontDeskOperationsAPISwapRoomsRequest {
	r.xOriginatingApplication = &xOriginatingApplication
	return r
}
...
// Pass this header as true, if payload needs DVM
func (r FrontDeskOperationsAPIVerifyCheckinReservationRequest) ExternalData(externalData string) FrontDeskOperationsAPIVerifyCheckinReservationRequest {
	r.externalData = &externalData
	return r
}

// Request Id of an incoming request
func (r FrontDeskOperationsAPIVerifyCheckinReservationRequest) XRequestId(xRequestId string) FrontDeskOperationsAPIVerifyCheckinReservationRequest {
	r.xRequestId = &xRequestId
	return r
}

// Customer&#39;s Integration Application Id
func (r FrontDeskOperationsAPIVerifyCheckinReservationRequest) XOriginatingApplication(xOriginatingApplication string) FrontDeskOperationsAPIVerifyCheckinReservationRequest {
	r.xOriginatingApplication = &xOriginatingApplication
	return r
}
