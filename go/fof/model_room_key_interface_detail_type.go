...
type RoomKeyInterfaceDetailType struct {
	...
	// Current property date and time. Uses the hotel's time zone.
	...
	InterfaceNumber *float32 `json:"interfaceNumber,omitempty"`
}
...
// GetInterfaceNumber returns the InterfaceNumber field value if set, zero value otherwise.
func (o *RoomKeyInterfaceDetailType) GetInterfaceNumber() float32 {
	if o == nil || IsNil(o.InterfaceNumber) {
		var ret float32
		return ret
	}
	return *o.InterfaceNumber
}

// GetInterfaceNumberOk returns a tuple with the InterfaceNumber field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *RoomKeyInterfaceDetailType) GetInterfaceNumberOk() (*float32, bool) {
	if o == nil || IsNil(o.InterfaceNumber) {
		return nil, false
	}
	return o.InterfaceNumber, true
}

// HasInterfaceNumber returns a boolean if a field has been set.
func (o *RoomKeyInterfaceDetailType) HasInterfaceNumber() bool {
	if o != nil && !IsNil(o.InterfaceNumber) {
		return true
	}
...
// SetInterfaceNumber gets a reference to the given float32 and assigns it to the InterfaceNumber field.
func (o *RoomKeyInterfaceDetailType) SetInterfaceNumber(v float32) {
	o.InterfaceNumber = &v
}
...
func (o RoomKeyInterfaceDetailType) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.InterfaceNumber) {
		toSerialize["interfaceNumber"] = o.InterfaceNumber
	}
