...
type ServiceRequest struct {
	...
	// The date-time in which the service request was opened. Uses the hotel's time zone.
	...
	// The date-time in which the service request was completed. Uses the hotel's time zone.
	CompletionDate *string `json:"completionDate,omitempty"`
	// The date-time in which the service request was closed. Uses the hotel's time zone.
