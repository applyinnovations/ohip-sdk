...
type RoomType struct {
	...
	// It indicates the time of the reservation which is scheduled for move  out. Uses the hotel's time zone.
	...
	RoomOccupancyInfo *RoomOccupancyInfoType `json:"roomOccupancyInfo,omitempty"`
	...
	RotationRoomId *string `json:"rotationRoomId,omitempty"`
}
...
// GetRoomOccupancyInfo returns the RoomOccupancyInfo field value if set, zero value otherwise.
func (o *RoomType) GetRoomOccupancyInfo() RoomOccupancyInfoType {
	if o == nil || IsNil(o.RoomOccupancyInfo) {
		var ret RoomOccupancyInfoType
		return ret
	}
	return *o.RoomOccupancyInfo
}

// GetRoomOccupancyInfoOk returns a tuple with the RoomOccupancyInfo field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *RoomType) GetRoomOccupancyInfoOk() (*RoomOccupancyInfoType, bool) {
	if o == nil || IsNil(o.RoomOccupancyInfo) {
		return nil, false
	}
	return o.RoomOccupancyInfo, true
}

// HasRoomOccupancyInfo returns a boolean if a field has been set.
func (o *RoomType) HasRoomOccupancyInfo() bool {
	if o != nil && !IsNil(o.RoomOccupancyInfo) {
		return true
	}
...
// SetRoomOccupancyInfo gets a reference to the given RoomOccupancyInfoType and assigns it to the RoomOccupancyInfo field.
func (o *RoomType) SetRoomOccupancyInfo(v RoomOccupancyInfoType) {
	o.RoomOccupancyInfo = &v
}
...
// GetRotationRoomId returns the RotationRoomId field value if set, zero value otherwise.
func (o *RoomType) GetRotationRoomId() string {
	if o == nil || IsNil(o.RotationRoomId) {
		var ret string
		return ret
	}
	return *o.RotationRoomId
}

// GetRotationRoomIdOk returns a tuple with the RotationRoomId field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *RoomType) GetRotationRoomIdOk() (*string, bool) {
	if o == nil || IsNil(o.RotationRoomId) {
		return nil, false
	}
	return o.RotationRoomId, true
}
...
// SetRotationRoomId gets a reference to the given string and assigns it to the RotationRoomId field.
...
func (o RoomType) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.RoomOccupancyInfo) {
		toSerialize["roomOccupancyInfo"] = o.RoomOccupancyInfo
	}
	if !IsNil(o.ComponentRoomNumbers) {
		toSerialize["componentRoomNumbers"] = o.ComponentRoomNumbers
	}
	if !IsNil(o.RotationRoomId) {
		toSerialize["rotationRoomId"] = o.RotationRoomId
	}
