...
type RoomKey struct {
	...
	// Old Room Number is used when a room move is performed.
...
func (o *RoomKey) GetInterfaceId() string {
...
// and a boolean to check if the value has been set.
func (o *RoomKey) GetInterfaceIdOk() (*string, bool) {
	if o == nil || IsNil(o.InterfaceId) {
		return nil, false
	}
...
func (o *RoomKey) HasInterfaceId() bool {
	if o != nil && !IsNil(o.InterfaceId) {
		return true
	}
...
func (o *RoomKey) SetInterfaceId(v string) {
	o.InterfaceId = &v
}
