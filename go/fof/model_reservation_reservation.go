...
func (o *ReservationReservation) GetCheckInInitiatedBy() string {
...
// and a boolean to check if the value has been set.
func (o *ReservationReservation) GetCheckInInitiatedByOk() (*string, bool) {
	if o == nil || IsNil(o.CheckInInitiatedBy) {
		return nil, false
	}
...
func (o *ReservationReservation) HasCheckInInitiatedBy() bool {
	if o != nil && !IsNil(o.CheckInInitiatedBy) {
		return true
	}
...
func (o *ReservationReservation) SetCheckInInitiatedBy(v string) {
