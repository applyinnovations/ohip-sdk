...
func (o *RoomKeysExternal) GetInterfaceId() string {
...
// and a boolean to check if the value has been set.
func (o *RoomKeysExternal) GetInterfaceIdOk() (*string, bool) {
	if o == nil || IsNil(o.InterfaceId) {
		return nil, false
	}
...
func (o *RoomKeysExternal) HasInterfaceId() bool {
	if o != nil && !IsNil(o.InterfaceId) {
		return true
	}
...
func (o *RoomKeysExternal) SetInterfaceId(v string) {
	o.InterfaceId = &v
}
