...
type ReservationForCCAuthType struct {
	...
	PaymentMethods []ReservationPaymentMethodType `json:"paymentMethods,omitempty"`
	ConfirmationNo *UniqueIDType `json:"confirmationNo,omitempty"`
	// Arrival date of the reservation. Uses the hotel's time zone.
	ArrivalDate *string `json:"arrivalDate,omitempty"`
	// Departure date of the reservation. Uses the hotel's time zone.
	DepartureDate *string `json:"departureDate,omitempty"`
	ReservationStatus *BatchCCAuthReservationStatusType `json:"reservationStatus,omitempty"`
}
...
// SetPaymentMethods gets a reference to the given []ReservationPaymentMethodType and assigns it to the PaymentMethods field.
...
func (o *ReservationForCCAuthType) GetConfirmationNo() UniqueIDType {
...
// and a boolean to check if the value has been set.
func (o *ReservationForCCAuthType) GetConfirmationNoOk() (*UniqueIDType, bool) {
	if o == nil || IsNil(o.ConfirmationNo) {
		return nil, false
	}
...
func (o *ReservationForCCAuthType) HasConfirmationNo() bool {
	if o != nil && !IsNil(o.ConfirmationNo) {
		return true
	}
...
func (o *ReservationForCCAuthType) SetConfirmationNo(v UniqueIDType) {
	o.ConfirmationNo = &v
}

// GetArrivalDate returns the ArrivalDate field value if set, zero value otherwise.
func (o *ReservationForCCAuthType) GetArrivalDate() string {
...
// and a boolean to check if the value has been set.
func (o *ReservationForCCAuthType) GetArrivalDateOk() (*string, bool) {
	if o == nil || IsNil(o.ArrivalDate) {
		return nil, false
	}
...
func (o *ReservationForCCAuthType) HasArrivalDate() bool {
	if o != nil && !IsNil(o.ArrivalDate) {
		return true
	}
...
func (o *ReservationForCCAuthType) SetArrivalDate(v string) {
	o.ArrivalDate = &v
}

// GetDepartureDate returns the DepartureDate field value if set, zero value otherwise.
func (o *ReservationForCCAuthType) GetDepartureDate() string {
...
// and a boolean to check if the value has been set.
func (o *ReservationForCCAuthType) GetDepartureDateOk() (*string, bool) {
	if o == nil || IsNil(o.DepartureDate) {
		return nil, false
	}
...
func (o *ReservationForCCAuthType) HasDepartureDate() bool {
	if o != nil && !IsNil(o.DepartureDate) {
		return true
	}
...
func (o *ReservationForCCAuthType) SetDepartureDate(v string) {
	o.DepartureDate = &v
}

// GetReservationStatus returns the ReservationStatus field value if set, zero value otherwise.
func (o *ReservationForCCAuthType) GetReservationStatus() BatchCCAuthReservationStatusType {
	if o == nil || IsNil(o.ReservationStatus) {
		var ret BatchCCAuthReservationStatusType
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *ReservationForCCAuthType) GetReservationStatusOk() (*BatchCCAuthReservationStatusType, bool) {
	if o == nil || IsNil(o.ReservationStatus) {
		return nil, false
	}
...
func (o *ReservationForCCAuthType) HasReservationStatus() bool {
	if o != nil && !IsNil(o.ReservationStatus) {
		return true
	}
...
// SetReservationStatus gets a reference to the given BatchCCAuthReservationStatusType and assigns it to the ReservationStatus field.
func (o *ReservationForCCAuthType) SetReservationStatus(v BatchCCAuthReservationStatusType) {
