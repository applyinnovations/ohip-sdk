...
type CommissionInfoType struct {
	...
	CommissionAgents []CommissionAgentType `json:"commissionAgents,omitempty"`
...
// SetCommissionAgents gets a reference to the given []CommissionAgentType and assigns it to the CommissionAgents field.
