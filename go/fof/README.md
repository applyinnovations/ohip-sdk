...
```golang
import fof "github.com/applyinnovations/ohip-sdk/go/fof/v3"
```
...
*CommissionsAPI* | [**GetCommissions**](docs/CommissionsAPI.md#getcommissions) | **Get** /hotels/{hotelId}/commissions | Operation to fetch commissions. The search results are filtered based on the provided criteria, with a specific hierarchy applied when multiple parameters are specified. The filtering parameters are prioritized in the following order: batchId, resvNameId, agentId, and bankAccountId, with the highest-priority parameter being used to narrow down the results.
...
*CommissionsAPI* | [**PingCommissionsService**](docs/CommissionsAPI.md#pingcommissionsservice) | **Get** /services/commissions/status | Ping Commissions
...
*CommissionsAPI* | [**SearchBankAccounts**](docs/CommissionsAPI.md#searchbankaccounts) | **Post** /hotels/{hotelId}/bankAccounts/searches | Operation to fetch bank accounts.
*CommissionsAPI* | [**SearchReservationsForCommissions**](docs/CommissionsAPI.md#searchreservationsforcommissions) | **Post** /hotels/{hotelId}/bankAccounts/{bankAccountId}/agents/{agentId}/reservationsForCommissions/searches | Operation to fetch Reservations for Commissions associated to a Travel Agent
...
*FOFStatsAPI* | [**GetReservationQueueStatistics**](docs/FOFStatsAPI.md#getreservationqueuestatistics) | **Get** /hotels/{hotelId}/queueReservationsStatistics | Get reservation queue statistics
...
*FOFStatsAPI* | [**PingFOFStatsService**](docs/FOFStatsAPI.md#pingfofstatsservice) | **Get** /services/fofStats/status | Ping FOF
...
*FrontDeskOperationsAPI* | [**GetHotelRooms**](docs/FrontDeskOperationsAPI.md#gethotelrooms) | **Get** /hotels/{hotelId}/rooms | Get hotel rooms
...
*FrontDeskOperationsAPI* | [**GetReservationSummaries**](docs/FrontDeskOperationsAPI.md#getreservationsummaries) | **Get** /hotels/{hotelId}/reservationSummaries | Get reservation summaries
...
*FrontDeskOperationsAPI* | [**PingFrontDeskOperationsService**](docs/FrontDeskOperationsAPI.md#pingfrontdeskoperationsservice) | **Get** /services/frontDeskOperations/status | Ping Front Desk Service
...
*FrontDeskOperationsAPI* | [**SearchWakeUpCalls**](docs/FrontDeskOperationsAPI.md#searchwakeupcalls) | **Post** /hotels/{hotelId}/wakeUpCalls/searches | Get Wake Up Calls
...
## Documentation For Models
 ...
 - [BatchCCAuthReservationStatusType](docs/BatchCCAuthReservationStatusType.md)
 ...
 - [CommissionsReservationStatusTypeEnum](docs/CommissionsReservationStatusTypeEnum.md)
 ...
 - [RoomOccupancyInfoType](docs/RoomOccupancyInfoType.md)
 ...
 - [SearchBankAccountsRequest](docs/SearchBankAccountsRequest.md)
 - [SearchMatchType](docs/SearchMatchType.md)
 - [SearchReservationsForCommissionsRequest](docs/SearchReservationsForCommissionsRequest.md)
 - [SearchWakeUpCallsRequest](docs/SearchWakeUpCallsRequest.md)
 ...
 - [SwapShiftOverrideInstructionType](docs/SwapShiftOverrideInstructionType.md)
