...
type ReservationRoomSelectionType struct {
	...
	// Indicates if scheduled move out rooms are to be ignored for room assignment.Scheduled room move functionality is available when the Advanced Daily Details OPERA Control is active.
	IgnoreMoveOutRooms *bool `json:"ignoreMoveOutRooms,omitempty"`
	...
	// Indicates whether the chosen Room changes will be made not only to overlapping dates of share reservations but also to non-overlapping dates after the departure date of the edited reservation. When false or omitted the chosen changes are applied only to overlapping dates of share reservations.
	ApplyUntilLastShareDepartureDate *bool `json:"applyUntilLastShareDepartureDate,omitempty"`
	// Additional notes or remarks about the room assignment, such as room selection, special requests or issues encountered that can be used for AI-driven insights, such as sentiment analysis or predictive modeling.
...
// GetIgnoreMoveOutRooms returns the IgnoreMoveOutRooms field value if set, zero value otherwise.
func (o *ReservationRoomSelectionType) GetIgnoreMoveOutRooms() bool {
	if o == nil || IsNil(o.IgnoreMoveOutRooms) {
		var ret bool
		return ret
	}
	return *o.IgnoreMoveOutRooms
}

// GetIgnoreMoveOutRoomsOk returns a tuple with the IgnoreMoveOutRooms field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ReservationRoomSelectionType) GetIgnoreMoveOutRoomsOk() (*bool, bool) {
	if o == nil || IsNil(o.IgnoreMoveOutRooms) {
		return nil, false
	}
	return o.IgnoreMoveOutRooms, true
}

// HasIgnoreMoveOutRooms returns a boolean if a field has been set.
func (o *ReservationRoomSelectionType) HasIgnoreMoveOutRooms() bool {
	if o != nil && !IsNil(o.IgnoreMoveOutRooms) {
		return true
	}
...
// SetIgnoreMoveOutRooms gets a reference to the given bool and assigns it to the IgnoreMoveOutRooms field.
func (o *ReservationRoomSelectionType) SetIgnoreMoveOutRooms(v bool) {
	o.IgnoreMoveOutRooms = &v
}
...
func (o *ReservationRoomSelectionType) GetApplyUntilLastShareDepartureDate() bool {
...
// and a boolean to check if the value has been set.
func (o *ReservationRoomSelectionType) GetApplyUntilLastShareDepartureDateOk() (*bool, bool) {
	if o == nil || IsNil(o.ApplyUntilLastShareDepartureDate) {
		return nil, false
	}
...
func (o *ReservationRoomSelectionType) HasApplyUntilLastShareDepartureDate() bool {
	if o != nil && !IsNil(o.ApplyUntilLastShareDepartureDate) {
		return true
	}
...
func (o *ReservationRoomSelectionType) SetApplyUntilLastShareDepartureDate(v bool) {
	o.ApplyUntilLastShareDepartureDate = &v
}

// GetComments returns the Comments field value if set, zero value otherwise.
func (o *ReservationRoomSelectionType) GetComments() string {
...
// and a boolean to check if the value has been set.
func (o *ReservationRoomSelectionType) GetCommentsOk() (*string, bool) {
	if o == nil || IsNil(o.Comments) {
		return nil, false
	}
...
func (o *ReservationRoomSelectionType) HasComments() bool {
	if o != nil && !IsNil(o.Comments) {
		return true
	}
...
func (o *ReservationRoomSelectionType) SetComments(v string) {
	o.Comments = &v
}
...
func (o ReservationRoomSelectionType) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.IgnoreMoveOutRooms) {
		toSerialize["ignoreMoveOutRooms"] = o.IgnoreMoveOutRooms
	}
