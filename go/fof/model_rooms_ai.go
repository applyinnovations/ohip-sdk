...
// checks if the RoomsAI type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RoomsAI{}

// RoomsAI Request to run AI Room Assignment and allocate rooms to incoming reservations.
type RoomsAI struct {
...
func (o RoomsAI) MarshalJSON() ([]byte, error) {
...
func (o RoomsAI) ToMap() (map[string]interface{}, error) {
...
type NullableRoomsAI struct {
	value *RoomsAI
	isSet bool
}

func (v NullableRoomsAI) Get() *RoomsAI {
	return v.value
}

func (v *NullableRoomsAI) Set(val *RoomsAI) {
	v.value = val
	v.isSet = true
}

func (v NullableRoomsAI) IsSet() bool {
	return v.isSet
}

func (v *NullableRoomsAI) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRoomsAI(val *RoomsAI) *NullableRoomsAI {
	return &NullableRoomsAI{value: val, isSet: true}
}

func (v NullableRoomsAI) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRoomsAI) UnmarshalJSON(src []byte) error {
	v.isSet = true
