...
type HotelReservationType struct {
	...
	// This flag value true indicates the reservation matches a Voucher Rule. It is supported only if OPERA Control Vouchers is active.
	HasVoucher *bool `json:"hasVoucher,omitempty"`
	// Scheduled Moves
	ScheduledRoomMoves []ScheduledRoomMoveType `json:"scheduledRoomMoves,omitempty"`
	// This attribute indicates if the linked reservation is marked as Back to Back or not. Back to Back functionality is available when the Back to Back Handling of Linked Reservations OPERA Control is active.
...
// GetHasVoucher returns the HasVoucher field value if set, zero value otherwise.
func (o *HotelReservationType) GetHasVoucher() bool {
	if o == nil || IsNil(o.HasVoucher) {
		var ret bool
		return ret
	}
	return *o.HasVoucher
...
// GetHasVoucherOk returns a tuple with the HasVoucher field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *HotelReservationType) GetHasVoucherOk() (*bool, bool) {
	if o == nil || IsNil(o.HasVoucher) {
		return nil, false
	}
	return o.HasVoucher, true
}
...
// SetHasVoucher gets a reference to the given bool and assigns it to the HasVoucher field.
...
func (o HotelReservationType) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.HasVoucher) {
		toSerialize["hasVoucher"] = o.HasVoucher
	}
