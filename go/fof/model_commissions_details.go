...
// checks if the CommissionsDetails type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CommissionsDetails{}

// CommissionsDetails Commissions for the requested account or agent id.
type CommissionsDetails struct {
	// List of commission info.
	CommissionInfoList []CommissionInfoType `json:"commissionInfoList,omitempty"`
...
// SetCommissionInfoList gets a reference to the given []CommissionInfoType and assigns it to the CommissionInfoList field.
...
func (o CommissionsDetails) MarshalJSON() ([]byte, error) {
...
func (o CommissionsDetails) ToMap() (map[string]interface{}, error) {
...
type NullableCommissionsDetails struct {
	value *CommissionsDetails
	isSet bool
}

func (v NullableCommissionsDetails) Get() *CommissionsDetails {
	return v.value
}

func (v *NullableCommissionsDetails) Set(val *CommissionsDetails) {
	v.value = val
	v.isSet = true
}

func (v NullableCommissionsDetails) IsSet() bool {
	return v.isSet
}

func (v *NullableCommissionsDetails) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCommissionsDetails(val *CommissionsDetails) *NullableCommissionsDetails {
	return &NullableCommissionsDetails{value: val, isSet: true}
}

func (v NullableCommissionsDetails) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCommissionsDetails) UnmarshalJSON(src []byte) error {
	v.isSet = true
