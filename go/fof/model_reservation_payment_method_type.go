...
func (o *ReservationPaymentMethodType) GetConfidential() bool {
...
// and a boolean to check if the value has been set.
func (o *ReservationPaymentMethodType) GetConfidentialOk() (*bool, bool) {
	if o == nil || IsNil(o.Confidential) {
		return nil, false
	}
...
func (o *ReservationPaymentMethodType) HasConfidential() bool {
	if o != nil && !IsNil(o.Confidential) {
		return true
	}
...
func (o *ReservationPaymentMethodType) SetConfidential(v bool) {
	o.Confidential = &v
}
