...
func (r FOFStatsAPIGetFrontOfficeStatisticsRequest) ExternalData(externalData string) FOFStatsAPIGetFrontOfficeStatisticsRequest {
	r.externalData = &externalData
	return r
}

// Request Id of an incoming request
func (r FOFStatsAPIGetFrontOfficeStatisticsRequest) XRequestId(xRequestId string) FOFStatsAPIGetFrontOfficeStatisticsRequest {
	r.xRequestId = &xRequestId
	return r
}

// Customer&#39;s Integration Application Id
func (r FOFStatsAPIGetFrontOfficeStatisticsRequest) XOriginatingApplication(xOriginatingApplication string) FOFStatsAPIGetFrontOfficeStatisticsRequest {
...
// Pass this header as true, if payload needs DVM
func (r FOFStatsAPIGetFrontOfficeStatisticsWithDateRangeRequest) ExternalData(externalData string) FOFStatsAPIGetFrontOfficeStatisticsWithDateRangeRequest {
	r.externalData = &externalData
	return r
}

// Request Id of an incoming request
func (r FOFStatsAPIGetFrontOfficeStatisticsWithDateRangeRequest) XRequestId(xRequestId string) FOFStatsAPIGetFrontOfficeStatisticsWithDateRangeRequest {
	r.xRequestId = &xRequestId
	return r
}

// Customer&#39;s Integration Application Id
func (r FOFStatsAPIGetFrontOfficeStatisticsWithDateRangeRequest) XOriginatingApplication(xOriginatingApplication string) FOFStatsAPIGetFrontOfficeStatisticsWithDateRangeRequest {
	r.xOriginatingApplication = &xOriginatingApplication
	return r
}
...
This API is useful to retrieve statistics regarding front office operations <p><strong>OperationId:</strong>getFrontOfficeStatisticsWithDateRange</p> <p>This API allows a time span of <strong>7</strong> days.</p>
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param statisticsCode Below are the Statistics Code mapping for valid metric code.<p><strong>ReservationActivityDaily:</strong></p>AdultsInHouse,ChildrenInHouse,ArrivalsTotal,TurndownRequired,DeparturesTotal,MaxOccupancyPercentage,Stayover,TotalRoomsReserved,PendingRoomMoves;
 @param hotelId
...
// Pass this header as true, if payload needs DVM
func (r FOFStatsAPIGetReservationQueueStatisticsRequest) ExternalData(externalData string) FOFStatsAPIGetReservationQueueStatisticsRequest {
	r.externalData = &externalData
	return r
}

// Request Id of an incoming request
func (r FOFStatsAPIGetReservationQueueStatisticsRequest) XRequestId(xRequestId string) FOFStatsAPIGetReservationQueueStatisticsRequest {
	r.xRequestId = &xRequestId
	return r
}

// Customer&#39;s Integration Application Id
func (r FOFStatsAPIGetReservationQueueStatisticsRequest) XOriginatingApplication(xOriginatingApplication string) FOFStatsAPIGetReservationQueueStatisticsRequest {
	r.xOriginatingApplication = &xOriginatingApplication
	return r
}
...
/*
GetReservationQueueStatistics Get reservation queue statistics
...
// Pass this header as true, if payload needs DVM
func (r FOFStatsAPIGetReservationStatusStatisticsRequest) ExternalData(externalData string) FOFStatsAPIGetReservationStatusStatisticsRequest {
	r.externalData = &externalData
	return r
}

// Request Id of an incoming request
func (r FOFStatsAPIGetReservationStatusStatisticsRequest) XRequestId(xRequestId string) FOFStatsAPIGetReservationStatusStatisticsRequest {
	r.xRequestId = &xRequestId
	return r
}

// Customer&#39;s Integration Application Id
func (r FOFStatsAPIGetReservationStatusStatisticsRequest) XOriginatingApplication(xOriginatingApplication string) FOFStatsAPIGetReservationStatusStatisticsRequest {
	r.xOriginatingApplication = &xOriginatingApplication
	return r
}
...
// Pass this header as true, if payload needs DVM
func (r FOFStatsAPIGetTaskSheetStatisticsRequest) ExternalData(externalData string) FOFStatsAPIGetTaskSheetStatisticsRequest {
	r.externalData = &externalData
	return r
}

// Request Id of an incoming request
func (r FOFStatsAPIGetTaskSheetStatisticsRequest) XRequestId(xRequestId string) FOFStatsAPIGetTaskSheetStatisticsRequest {
	r.xRequestId = &xRequestId
	return r
}

// Customer&#39;s Integration Application Id
func (r FOFStatsAPIGetTaskSheetStatisticsRequest) XOriginatingApplication(xOriginatingApplication string) FOFStatsAPIGetTaskSheetStatisticsRequest {
	r.xOriginatingApplication = &xOriginatingApplication
	return r
}
...
type FOFStatsAPIPingFOFStatsServiceRequest struct {
	ctx context.Context
	ApiService *FOFStatsAPIService
	authorization *string
	xAppKey *string
...
// Bearer token that needs to be passed which is generated post user authentication
func (r FOFStatsAPIPingFOFStatsServiceRequest) Authorization(authorization string) FOFStatsAPIPingFOFStatsServiceRequest {
	r.authorization = &authorization
	return r
}

// Client or Partner&#39;s Application Key
func (r FOFStatsAPIPingFOFStatsServiceRequest) XAppKey(xAppKey string) FOFStatsAPIPingFOFStatsServiceRequest {
	r.xAppKey = &xAppKey
	return r
}

// Mandatory parameter to identify the hotel code where the end user is logged in
func (r FOFStatsAPIPingFOFStatsServiceRequest) XHotelid(xHotelid string) FOFStatsAPIPingFOFStatsServiceRequest {
	r.xHotelid = &xHotelid
	return r
}

// Pass this header as true, if payload needs DVM
func (r FOFStatsAPIPingFOFStatsServiceRequest) ExternalData(externalData string) FOFStatsAPIPingFOFStatsServiceRequest {
	r.externalData = &externalData
	return r
}

// Request Id of an incoming request
func (r FOFStatsAPIPingFOFStatsServiceRequest) XRequestId(xRequestId string) FOFStatsAPIPingFOFStatsServiceRequest {
	r.xRequestId = &xRequestId
	return r
}

// Customer&#39;s Integration Application Id
func (r FOFStatsAPIPingFOFStatsServiceRequest) XOriginatingApplication(xOriginatingApplication string) FOFStatsAPIPingFOFStatsServiceRequest {
	r.xOriginatingApplication = &xOriginatingApplication
	return r
}

// External system code.
func (r FOFStatsAPIPingFOFStatsServiceRequest) XExternalsystem(xExternalsystem string) FOFStatsAPIPingFOFStatsServiceRequest {
	r.xExternalsystem = &xExternalsystem
	return r
}

// Language code
func (r FOFStatsAPIPingFOFStatsServiceRequest) AcceptLanguage(acceptLanguage string) FOFStatsAPIPingFOFStatsServiceRequest {
	r.acceptLanguage = &acceptLanguage
	return r
}

func (r FOFStatsAPIPingFOFStatsServiceRequest) Execute() (*OperaVersion, *http.Response, error) {
	return r.ApiService.PingFOFStatsServiceExecute(r)
}

/*
PingFOFStatsService Ping FOF

Ping FOF stats service <p><strong>OperationId:</strong>pingFOFStatsService</p>

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return FOFStatsAPIPingFOFStatsServiceRequest
*/
func (a *FOFStatsAPIService) PingFOFStatsService(ctx context.Context) FOFStatsAPIPingFOFStatsServiceRequest {
	return FOFStatsAPIPingFOFStatsServiceRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return OperaVersion
func (a *FOFStatsAPIService) PingFOFStatsServiceExecute(r FOFStatsAPIPingFOFStatsServiceRequest) (*OperaVersion, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "FOFStatsAPIService.PingFOFStatsService")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/services/fofStats/status"
