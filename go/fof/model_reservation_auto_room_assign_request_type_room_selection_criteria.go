...
type ReservationAutoRoomAssignRequestTypeRoomSelectionCriteria struct {
	...
	// Indicates if Move Out rooms are to be included in the auto assignment. Move Out rooms are rooms that are assigned to reservations with a scheduled room move on the day of assignment.Scheduled Room Move functionality is available when the Advanced Daily Details OPERA Control is active.
	IncludeScheduledMoveOutRoom *bool `json:"includeScheduledMoveOutRoom,omitempty"`
	// Indicates if preferences on the profile associated to the reservation should be used to determine the room type. The preferences for FLOOR, SMOKING and ROOM FEATURES will be used.
	UseRoomFeatureSuggestions *bool `json:"useRoomFeatureSuggestions,omitempty"`
}
...
// GetIncludeScheduledMoveOutRoom returns the IncludeScheduledMoveOutRoom field value if set, zero value otherwise.
func (o *ReservationAutoRoomAssignRequestTypeRoomSelectionCriteria) GetIncludeScheduledMoveOutRoom() bool {
	if o == nil || IsNil(o.IncludeScheduledMoveOutRoom) {
		var ret bool
		return ret
	}
	return *o.IncludeScheduledMoveOutRoom
}

// GetIncludeScheduledMoveOutRoomOk returns a tuple with the IncludeScheduledMoveOutRoom field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ReservationAutoRoomAssignRequestTypeRoomSelectionCriteria) GetIncludeScheduledMoveOutRoomOk() (*bool, bool) {
	if o == nil || IsNil(o.IncludeScheduledMoveOutRoom) {
		return nil, false
	}
	return o.IncludeScheduledMoveOutRoom, true
}

// HasIncludeScheduledMoveOutRoom returns a boolean if a field has been set.
func (o *ReservationAutoRoomAssignRequestTypeRoomSelectionCriteria) HasIncludeScheduledMoveOutRoom() bool {
	if o != nil && !IsNil(o.IncludeScheduledMoveOutRoom) {
		return true
	}
...
// SetIncludeScheduledMoveOutRoom gets a reference to the given bool and assigns it to the IncludeScheduledMoveOutRoom field.
func (o *ReservationAutoRoomAssignRequestTypeRoomSelectionCriteria) SetIncludeScheduledMoveOutRoom(v bool) {
	o.IncludeScheduledMoveOutRoom = &v
}

// GetUseRoomFeatureSuggestions returns the UseRoomFeatureSuggestions field value if set, zero value otherwise.
func (o *ReservationAutoRoomAssignRequestTypeRoomSelectionCriteria) GetUseRoomFeatureSuggestions() bool {
	if o == nil || IsNil(o.UseRoomFeatureSuggestions) {
		var ret bool
		return ret
	}
	return *o.UseRoomFeatureSuggestions
}

// GetUseRoomFeatureSuggestionsOk returns a tuple with the UseRoomFeatureSuggestions field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ReservationAutoRoomAssignRequestTypeRoomSelectionCriteria) GetUseRoomFeatureSuggestionsOk() (*bool, bool) {
	if o == nil || IsNil(o.UseRoomFeatureSuggestions) {
		return nil, false
	}
	return o.UseRoomFeatureSuggestions, true
}

// HasUseRoomFeatureSuggestions returns a boolean if a field has been set.
func (o *ReservationAutoRoomAssignRequestTypeRoomSelectionCriteria) HasUseRoomFeatureSuggestions() bool {
	if o != nil && !IsNil(o.UseRoomFeatureSuggestions) {
		return true
	}
...
// SetUseRoomFeatureSuggestions gets a reference to the given bool and assigns it to the UseRoomFeatureSuggestions field.
func (o *ReservationAutoRoomAssignRequestTypeRoomSelectionCriteria) SetUseRoomFeatureSuggestions(v bool) {
	o.UseRoomFeatureSuggestions = &v
}
...
func (o ReservationAutoRoomAssignRequestTypeRoomSelectionCriteria) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.IncludeScheduledMoveOutRoom) {
		toSerialize["includeScheduledMoveOutRoom"] = o.IncludeScheduledMoveOutRoom
	}
	if !IsNil(o.UseRoomFeatureSuggestions) {
		toSerialize["useRoomFeatureSuggestions"] = o.UseRoomFeatureSuggestions
	}
