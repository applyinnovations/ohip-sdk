...
type RoomKeyDetails struct {
	...
	// Status of the room key operation as reported by the vendor (e.g. 'success', 'failure', 'Key1: Key Created').
...
func (o *RoomKeyDetails) GetKeyPin() string {
...
// and a boolean to check if the value has been set.
func (o *RoomKeyDetails) GetKeyPinOk() (*string, bool) {
	if o == nil || IsNil(o.KeyPin) {
		return nil, false
	}
...
func (o *RoomKeyDetails) HasKeyPin() bool {
	if o != nil && !IsNil(o.KeyPin) {
		return true
	}
...
func (o *RoomKeyDetails) SetKeyPin(v string) {
	o.KeyPin = &v
}

// GetKeyStatus returns the KeyStatus field value if set, zero value otherwise.
func (o *RoomKeyDetails) GetKeyStatus() string {
...
// and a boolean to check if the value has been set.
func (o *RoomKeyDetails) GetKeyStatusOk() (*string, bool) {
	if o == nil || IsNil(o.KeyStatus) {
		return nil, false
	}
...
func (o *RoomKeyDetails) HasKeyStatus() bool {
	if o != nil && !IsNil(o.KeyStatus) {
		return true
	}
...
func (o *RoomKeyDetails) SetKeyStatus(v string) {
	o.KeyStatus = &v
}
