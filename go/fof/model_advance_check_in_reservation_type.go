...
func (o *AdvanceCheckInReservationType) GetCheckInInitiatedBy() string {
...
// and a boolean to check if the value has been set.
func (o *AdvanceCheckInReservationType) GetCheckInInitiatedByOk() (*string, bool) {
	if o == nil || IsNil(o.CheckInInitiatedBy) {
		return nil, false
	}
...
func (o *AdvanceCheckInReservationType) HasCheckInInitiatedBy() bool {
	if o != nil && !IsNil(o.CheckInInitiatedBy) {
		return true
	}
...
func (o *AdvanceCheckInReservationType) SetCheckInInitiatedBy(v string) {
