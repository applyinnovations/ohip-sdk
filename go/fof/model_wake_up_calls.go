...
// checks if the WakeUpCalls type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &WakeUpCalls{}

// WakeUpCalls Fetch wake up calls response.
type WakeUpCalls struct {
...
func (o WakeUpCalls) MarshalJSON() ([]byte, error) {
...
func (o WakeUpCalls) ToMap() (map[string]interface{}, error) {
...
type NullableWakeUpCalls struct {
	value *WakeUpCalls
	isSet bool
}

func (v NullableWakeUpCalls) Get() *WakeUpCalls {
	return v.value
}

func (v *NullableWakeUpCalls) Set(val *WakeUpCalls) {
	v.value = val
	v.isSet = true
}

func (v NullableWakeUpCalls) IsSet() bool {
	return v.isSet
}

func (v *NullableWakeUpCalls) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableWakeUpCalls(val *WakeUpCalls) *NullableWakeUpCalls {
	return &NullableWakeUpCalls{value: val, isSet: true}
}

func (v NullableWakeUpCalls) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableWakeUpCalls) UnmarshalJSON(src []byte) error {
	v.isSet = true
