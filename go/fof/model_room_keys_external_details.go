...
type RoomKeysExternalDetails struct {
	...
	// Date/Time Key is valid from - only send in response for keyType: 'Read' request. Uses the hotel's time zone.
	KeyValidityStart string `json:"keyValidityStart"`
	// Date/Time Key is valid to - only send in response for keyType: 'Read' request. Uses the hotel's time zone.
	...
	// Date/Time the key has been generated by Door Locking system. Uses the hotel's time zone.
...
func (o *RoomKeysExternalDetails) GetKeyPin() string {
...
// and a boolean to check if the value has been set.
func (o *RoomKeysExternalDetails) GetKeyPinOk() (*string, bool) {
	if o == nil || IsNil(o.KeyPin) {
		return nil, false
	}
...
func (o *RoomKeysExternalDetails) HasKeyPin() bool {
	if o != nil && !IsNil(o.KeyPin) {
		return true
	}
...
func (o *RoomKeysExternalDetails) SetKeyPin(v string) {
	o.KeyPin = &v
}
