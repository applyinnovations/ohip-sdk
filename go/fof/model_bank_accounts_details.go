...
type BankAccountsDetails struct {
	...
	BankAccounts []BankAccountType `json:"bankAccounts,omitempty"`
...
// SetBankAccounts gets a reference to the given []BankAccountType and assigns it to the BankAccounts field.
