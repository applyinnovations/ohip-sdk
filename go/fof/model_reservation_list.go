...
// checks if the ReservationList type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ReservationList{}

// ReservationList A collection of reservation details attached to Profiles.
...
func (o ReservationList) MarshalJSON() ([]byte, error) {
...
func (o ReservationList) ToMap() (map[string]interface{}, error) {
...
type NullableReservationList struct {
	value *ReservationList
	isSet bool
}

func (v NullableReservationList) Get() *ReservationList {
	return v.value
}

func (v *NullableReservationList) Set(val *ReservationList) {
	v.value = val
	v.isSet = true
}

func (v NullableReservationList) IsSet() bool {
	return v.isSet
}

func (v *NullableReservationList) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableReservationList(val *ReservationList) *NullableReservationList {
	return &NullableReservationList{value: val, isSet: true}
}

func (v NullableReservationList) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableReservationList) UnmarshalJSON(src []byte) error {
	v.isSet = true
