...
type BillingChargesCriteriaType struct {
	...
	Charges []ChargeLongTrxCodeCriteriaType `json:"charges,omitempty"`
...
func (o *BillingChargesCriteriaType) GetCharges() []ChargeLongTrxCodeCriteriaType {
	if o == nil || IsNil(o.Charges) {
		var ret []ChargeLongTrxCodeCriteriaType
		return ret
	}
	return o.Charges
}
...
// and a boolean to check if the value has been set.
func (o *BillingChargesCriteriaType) GetChargesOk() ([]ChargeLongTrxCodeCriteriaType, bool) {
	if o == nil || IsNil(o.Charges) {
		return nil, false
	}
...
// SetCharges gets a reference to the given []ChargeLongTrxCodeCriteriaType and assigns it to the Charges field.
func (o *BillingChargesCriteriaType) SetCharges(v []ChargeLongTrxCodeCriteriaType) {
	o.Charges = v
}
