...
func (o *CCAuthorizationCriteriaType) GetStoreToCreditCardWallet() bool {
...
// and a boolean to check if the value has been set.
func (o *CCAuthorizationCriteriaType) GetStoreToCreditCardWalletOk() (*bool, bool) {
	if o == nil || IsNil(o.StoreToCreditCardWallet) {
		return nil, false
	}
...
func (o *CCAuthorizationCriteriaType) HasStoreToCreditCardWallet() bool {
	if o != nil && !IsNil(o.StoreToCreditCardWallet) {
		return true
	}
...
func (o *CCAuthorizationCriteriaType) SetStoreToCreditCardWallet(v bool) {
