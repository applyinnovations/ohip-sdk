...
func (o *TrxTransferCriteriaType) GetTransactionCodeList() []string {
...
// and a boolean to check if the value has been set.
func (o *TrxTransferCriteriaType) GetTransactionCodeListOk() ([]string, bool) {
	if o == nil || IsNil(o.TransactionCodeList) {
		return nil, false
	}
...
func (o *TrxTransferCriteriaType) HasTransactionCodeList() bool {
	if o != nil && !IsNil(o.TransactionCodeList) {
		return true
	}
...
func (o *TrxTransferCriteriaType) SetTransactionCodeList(v []string) {
	o.TransactionCodeList = v
}

// GetSourceFolioWindowNo returns the SourceFolioWindowNo field value if set, zero value otherwise.
func (o *TrxTransferCriteriaType) GetSourceFolioWindowNo() int32 {
...
// and a boolean to check if the value has been set.
func (o *TrxTransferCriteriaType) GetSourceFolioWindowNoOk() (*int32, bool) {
	if o == nil || IsNil(o.SourceFolioWindowNo) {
		return nil, false
	}
...
func (o *TrxTransferCriteriaType) HasSourceFolioWindowNo() bool {
	if o != nil && !IsNil(o.SourceFolioWindowNo) {
		return true
	}
...
func (o *TrxTransferCriteriaType) SetSourceFolioWindowNo(v int32) {
