...
type CCAuthorizationInstructionType struct {
	...
	AlternateTransRef *string `json:"alternateTransRef,omitempty"`
...
// GetAlternateTransRef returns the AlternateTransRef field value if set, zero value otherwise.
func (o *CCAuthorizationInstructionType) GetAlternateTransRef() string {
	if o == nil || IsNil(o.AlternateTransRef) {
		var ret string
		return ret
	}
	return *o.AlternateTransRef
}

// GetAlternateTransRefOk returns a tuple with the AlternateTransRef field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *CCAuthorizationInstructionType) GetAlternateTransRefOk() (*string, bool) {
	if o == nil || IsNil(o.AlternateTransRef) {
		return nil, false
	}
	return o.AlternateTransRef, true
}

// HasAlternateTransRef returns a boolean if a field has been set.
func (o *CCAuthorizationInstructionType) HasAlternateTransRef() bool {
	if o != nil && !IsNil(o.AlternateTransRef) {
		return true
	}
...
// SetAlternateTransRef gets a reference to the given string and assigns it to the AlternateTransRef field.
func (o *CCAuthorizationInstructionType) SetAlternateTransRef(v string) {
	o.AlternateTransRef = &v
}
...
func (o CCAuthorizationInstructionType) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.AlternateTransRef) {
		toSerialize["alternateTransRef"] = o.AlternateTransRef
	}
