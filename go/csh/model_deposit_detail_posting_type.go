...
func (o *DepositDetailPostingType) GetUpdateInfo() DetailPostingTypeUpdateInfo {
...
// and a boolean to check if the value has been set.
func (o *DepositDetailPostingType) GetUpdateInfoOk() (*DetailPostingTypeUpdateInfo, bool) {
	if o == nil || IsNil(o.UpdateInfo) {
		return nil, false
	}
...
func (o *DepositDetailPostingType) SetUpdateInfo(v DetailPostingTypeUpdateInfo) {
	o.UpdateInfo = &v
}
