...
type MembershipInfoType struct {
	...
	TotalAmountRedeemed *float32 `json:"totalAmountRedeemed,omitempty"`
...
// GetTotalAmountRedeemed returns the TotalAmountRedeemed field value if set, zero value otherwise.
func (o *MembershipInfoType) GetTotalAmountRedeemed() float32 {
	if o == nil || IsNil(o.TotalAmountRedeemed) {
		var ret float32
		return ret
	}
	return *o.TotalAmountRedeemed
}

// GetTotalAmountRedeemedOk returns a tuple with the TotalAmountRedeemed field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *MembershipInfoType) GetTotalAmountRedeemedOk() (*float32, bool) {
	if o == nil || IsNil(o.TotalAmountRedeemed) {
		return nil, false
	}
	return o.TotalAmountRedeemed, true
}
...
// SetTotalAmountRedeemed gets a reference to the given float32 and assigns it to the TotalAmountRedeemed field.
func (o *MembershipInfoType) SetTotalAmountRedeemed(v float32) {
	o.TotalAmountRedeemed = &v
}
...
func (o MembershipInfoType) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.TotalAmountRedeemed) {
		toSerialize["totalAmountRedeemed"] = o.TotalAmountRedeemed
	}
