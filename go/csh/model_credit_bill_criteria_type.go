...
type CreditBillCriteriaType struct {
	...
	UnAssociatedCreditBill *UnAssociatedCreditBillType `json:"unAssociatedCreditBill,omitempty"`
}
...
// GetUnAssociatedCreditBill returns the UnAssociatedCreditBill field value if set, zero value otherwise.
func (o *CreditBillCriteriaType) GetUnAssociatedCreditBill() UnAssociatedCreditBillType {
	if o == nil || IsNil(o.UnAssociatedCreditBill) {
		var ret UnAssociatedCreditBillType
		return ret
	}
	return *o.UnAssociatedCreditBill
}

// GetUnAssociatedCreditBillOk returns a tuple with the UnAssociatedCreditBill field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *CreditBillCriteriaType) GetUnAssociatedCreditBillOk() (*UnAssociatedCreditBillType, bool) {
	if o == nil || IsNil(o.UnAssociatedCreditBill) {
		return nil, false
	}
	return o.UnAssociatedCreditBill, true
}

// HasUnAssociatedCreditBill returns a boolean if a field has been set.
func (o *CreditBillCriteriaType) HasUnAssociatedCreditBill() bool {
	if o != nil && !IsNil(o.UnAssociatedCreditBill) {
		return true
	}
...
// SetUnAssociatedCreditBill gets a reference to the given UnAssociatedCreditBillType and assigns it to the UnAssociatedCreditBill field.
func (o *CreditBillCriteriaType) SetUnAssociatedCreditBill(v UnAssociatedCreditBillType) {
	o.UnAssociatedCreditBill = &v
}
...
func (o CreditBillCriteriaType) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.UnAssociatedCreditBill) {
		toSerialize["unAssociatedCreditBill"] = o.UnAssociatedCreditBill
	}
