...
func (o *StayInfoType) GetHasExtendedStayRates() bool {
...
// and a boolean to check if the value has been set.
func (o *StayInfoType) GetHasExtendedStayRatesOk() (*bool, bool) {
	if o == nil || IsNil(o.HasExtendedStayRates) {
		return nil, false
	}
...
func (o *StayInfoType) HasHasExtendedStayRates() bool {
	if o != nil && !IsNil(o.HasExtendedStayRates) {
		return true
	}
...
func (o *StayInfoType) SetHasExtendedStayRates(v bool) {
