...
type PayeeInfoType struct {
	...
	PayeeInternalFolio *bool `json:"payeeInternalFolio,omitempty"`
}
...
// GetPayeeInternalFolio returns the PayeeInternalFolio field value if set, zero value otherwise.
func (o *PayeeInfoType) GetPayeeInternalFolio() bool {
	if o == nil || IsNil(o.PayeeInternalFolio) {
		var ret bool
		return ret
	}
	return *o.PayeeInternalFolio
}

// GetPayeeInternalFolioOk returns a tuple with the PayeeInternalFolio field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *PayeeInfoType) GetPayeeInternalFolioOk() (*bool, bool) {
	if o == nil || IsNil(o.PayeeInternalFolio) {
		return nil, false
	}
	return o.PayeeInternalFolio, true
}
...
// SetPayeeInternalFolio gets a reference to the given bool and assigns it to the PayeeInternalFolio field.
func (o *PayeeInfoType) SetPayeeInternalFolio(v bool) {
	o.PayeeInternalFolio = &v
}
...
func (o PayeeInfoType) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.PayeeInternalFolio) {
		toSerialize["payeeInternalFolio"] = o.PayeeInternalFolio
	}
