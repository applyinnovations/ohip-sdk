...
// checks if the FiscalSupportingDocumentsResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &FiscalSupportingDocumentsResponse{}

// FiscalSupportingDocumentsResponse Response for the supporting documents.
type FiscalSupportingDocumentsResponse struct {
	// List of supporting documents.
	SupportingDocuments []SupportingDocumentType `json:"supportingDocuments,omitempty"`
...
func NewFiscalSupportingDocumentsResponse() *FiscalSupportingDocumentsResponse {
	this := FiscalSupportingDocumentsResponse{}
	return &this
}
...
// GetSupportingDocuments returns the SupportingDocuments field value if set, zero value otherwise.
func (o *FiscalSupportingDocumentsResponse) GetSupportingDocuments() []SupportingDocumentType {
	if o == nil || IsNil(o.SupportingDocuments) {
		var ret []SupportingDocumentType
		return ret
	}
	return o.SupportingDocuments
}

// GetSupportingDocumentsOk returns a tuple with the SupportingDocuments field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *FiscalSupportingDocumentsResponse) GetSupportingDocumentsOk() ([]SupportingDocumentType, bool) {
	if o == nil || IsNil(o.SupportingDocuments) {
		return nil, false
	}
	return o.SupportingDocuments, true
}
...
// SetSupportingDocuments gets a reference to the given []SupportingDocumentType and assigns it to the SupportingDocuments field.
func (o *FiscalSupportingDocumentsResponse) SetSupportingDocuments(v []SupportingDocumentType) {
	o.SupportingDocuments = v
}
...
func (o FiscalSupportingDocumentsResponse) MarshalJSON() ([]byte, error) {
...
func (o FiscalSupportingDocumentsResponse) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.SupportingDocuments) {
		toSerialize["supportingDocuments"] = o.SupportingDocuments
	}
...
type NullableFiscalSupportingDocumentsResponse struct {
	value *FiscalSupportingDocumentsResponse
	isSet bool
}

func (v NullableFiscalSupportingDocumentsResponse) Get() *FiscalSupportingDocumentsResponse {
	return v.value
}

func (v *NullableFiscalSupportingDocumentsResponse) Set(val *FiscalSupportingDocumentsResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableFiscalSupportingDocumentsResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableFiscalSupportingDocumentsResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableFiscalSupportingDocumentsResponse(val *FiscalSupportingDocumentsResponse) *NullableFiscalSupportingDocumentsResponse {
	return &NullableFiscalSupportingDocumentsResponse{value: val, isSet: true}
}

func (v NullableFiscalSupportingDocumentsResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableFiscalSupportingDocumentsResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
