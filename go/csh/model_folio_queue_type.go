...
type FolioQueueType struct {
	...
	// Countries in Latin America that use folio queues, will need to populate the queueName parameter in the request, to have the Fiscal Bill No populated as needed.
