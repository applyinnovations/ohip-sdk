...
type ReservationTrxTransferCriteria struct {
	...
	// List of Transaction code to be transferred.
	TransactionCodeList []string `json:"transactionCodeList,omitempty"`
	// Folio Window Number to where transactions were originated.
	SourceFolioWindowNo *int32 `json:"sourceFolioWindowNo,omitempty"`
...
// GetTransactionCodeList returns the TransactionCodeList field value if set, zero value otherwise.
func (o *ReservationTrxTransferCriteria) GetTransactionCodeList() []string {
	if o == nil || IsNil(o.TransactionCodeList) {
		var ret []string
		return ret
	}
	return o.TransactionCodeList
}

// GetTransactionCodeListOk returns a tuple with the TransactionCodeList field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ReservationTrxTransferCriteria) GetTransactionCodeListOk() ([]string, bool) {
	if o == nil || IsNil(o.TransactionCodeList) {
		return nil, false
	}
	return o.TransactionCodeList, true
}

// HasTransactionCodeList returns a boolean if a field has been set.
func (o *ReservationTrxTransferCriteria) HasTransactionCodeList() bool {
	if o != nil && !IsNil(o.TransactionCodeList) {
		return true
	}
...
// SetTransactionCodeList gets a reference to the given []string and assigns it to the TransactionCodeList field.
func (o *ReservationTrxTransferCriteria) SetTransactionCodeList(v []string) {
	o.TransactionCodeList = v
}

// GetSourceFolioWindowNo returns the SourceFolioWindowNo field value if set, zero value otherwise.
func (o *ReservationTrxTransferCriteria) GetSourceFolioWindowNo() int32 {
	if o == nil || IsNil(o.SourceFolioWindowNo) {
		var ret int32
		return ret
	}
	return *o.SourceFolioWindowNo
}

// GetSourceFolioWindowNoOk returns a tuple with the SourceFolioWindowNo field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ReservationTrxTransferCriteria) GetSourceFolioWindowNoOk() (*int32, bool) {
	if o == nil || IsNil(o.SourceFolioWindowNo) {
		return nil, false
	}
	return o.SourceFolioWindowNo, true
}

// HasSourceFolioWindowNo returns a boolean if a field has been set.
func (o *ReservationTrxTransferCriteria) HasSourceFolioWindowNo() bool {
	if o != nil && !IsNil(o.SourceFolioWindowNo) {
		return true
	}
...
// SetSourceFolioWindowNo gets a reference to the given int32 and assigns it to the SourceFolioWindowNo field.
func (o *ReservationTrxTransferCriteria) SetSourceFolioWindowNo(v int32) {
	o.SourceFolioWindowNo = &v
}
...
func (o ReservationTrxTransferCriteria) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.TransactionCodeList) {
		toSerialize["transactionCodeList"] = o.TransactionCodeList
	}
	if !IsNil(o.SourceFolioWindowNo) {
		toSerialize["sourceFolioWindowNo"] = o.SourceFolioWindowNo
	}
