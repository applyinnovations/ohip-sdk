...
type SaleCriteriaType struct {
	...
	// This flag signifies that the folio to be generated is Normal or Simple Folio. Certain countries of the World mandate a simple folio when the invoice amount is less than defined threshold.
...
func (o *SaleCriteriaType) GetSimpleFolio() bool {
...
// and a boolean to check if the value has been set.
func (o *SaleCriteriaType) GetSimpleFolioOk() (*bool, bool) {
	if o == nil || IsNil(o.SimpleFolio) {
		return nil, false
	}
...
func (o *SaleCriteriaType) HasSimpleFolio() bool {
	if o != nil && !IsNil(o.SimpleFolio) {
		return true
	}
...
func (o *SaleCriteriaType) SetSimpleFolio(v bool) {
	o.SimpleFolio = &v
}
