...
// checks if the FinancialPostings type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &FinancialPostings{}

// FinancialPostings Response for fetching the Posting Journal.
type FinancialPostings struct {
...
func (o FinancialPostings) MarshalJSON() ([]byte, error) {
...
func (o FinancialPostings) ToMap() (map[string]interface{}, error) {
...
type NullableFinancialPostings struct {
	value *FinancialPostings
	isSet bool
}

func (v NullableFinancialPostings) Get() *FinancialPostings {
	return v.value
}

func (v *NullableFinancialPostings) Set(val *FinancialPostings) {
	v.value = val
	v.isSet = true
}

func (v NullableFinancialPostings) IsSet() bool {
	return v.isSet
}

func (v *NullableFinancialPostings) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableFinancialPostings(val *FinancialPostings) *NullableFinancialPostings {
	return &NullableFinancialPostings{value: val, isSet: true}
}

func (v NullableFinancialPostings) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableFinancialPostings) UnmarshalJSON(src []byte) error {
	v.isSet = true
