...
func (o *DetailPostingType) GetHoldingLedgerTransaction() bool {
...
// and a boolean to check if the value has been set.
func (o *DetailPostingType) GetHoldingLedgerTransactionOk() (*bool, bool) {
	if o == nil || IsNil(o.HoldingLedgerTransaction) {
		return nil, false
	}
...
func (o *DetailPostingType) HasHoldingLedgerTransaction() bool {
	if o != nil && !IsNil(o.HoldingLedgerTransaction) {
		return true
	}
...
func (o *DetailPostingType) SetHoldingLedgerTransaction(v bool) {
