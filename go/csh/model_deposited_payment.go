...
// checks if the DepositedPayment type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DepositedPayment{}

// DepositedPayment Response for the post deposit payment request.
type DepositedPayment struct {
...
func (o DepositedPayment) MarshalJSON() ([]byte, error) {
...
func (o DepositedPayment) ToMap() (map[string]interface{}, error) {
...
type NullableDepositedPayment struct {
	value *DepositedPayment
	isSet bool
}

func (v NullableDepositedPayment) Get() *DepositedPayment {
	return v.value
}

func (v *NullableDepositedPayment) Set(val *DepositedPayment) {
	v.value = val
	v.isSet = true
}

func (v NullableDepositedPayment) IsSet() bool {
	return v.isSet
}

func (v *NullableDepositedPayment) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDepositedPayment(val *DepositedPayment) *NullableDepositedPayment {
	return &NullableDepositedPayment{value: val, isSet: true}
}

func (v NullableDepositedPayment) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDepositedPayment) UnmarshalJSON(src []byte) error {
	v.isSet = true
