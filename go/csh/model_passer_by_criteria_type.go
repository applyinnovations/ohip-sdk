...
func (o *PasserByCriteriaType) GetSimpleFolio() bool {
...
// and a boolean to check if the value has been set.
func (o *PasserByCriteriaType) GetSimpleFolioOk() (*bool, bool) {
	if o == nil || IsNil(o.SimpleFolio) {
		return nil, false
	}
...
func (o *PasserByCriteriaType) HasSimpleFolio() bool {
	if o != nil && !IsNil(o.SimpleFolio) {
		return true
	}
...
func (o *PasserByCriteriaType) SetSimpleFolio(v bool) {
	o.SimpleFolio = &v
}
