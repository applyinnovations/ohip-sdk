...
func (o *ResAttachedProfileType) GetProfileRestrictions() ProfileRestrictions {
...
// and a boolean to check if the value has been set.
func (o *ResAttachedProfileType) GetProfileRestrictionsOk() (*ProfileRestrictions, bool) {
	if o == nil || IsNil(o.ProfileRestrictions) {
		return nil, false
	}
...
func (o *ResAttachedProfileType) HasProfileRestrictions() bool {
	if o != nil && !IsNil(o.ProfileRestrictions) {
		return true
	}
...
func (o *ResAttachedProfileType) SetProfileRestrictions(v ProfileRestrictions) {
