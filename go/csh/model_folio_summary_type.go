...
type FolioSummaryType struct {
	...
	IsARAttached *bool `json:"isARAttached,omitempty"`
	// Flag to check if the folio type is fiscal or not.
	IsFiscalFolio *bool `json:"isFiscalFolio,omitempty"`
	...
	PasserbyFolio *bool `json:"passerbyFolio,omitempty"`
	...
	// Associated Bill Number with Prefix.
	AssociatedBillsWithPrefix []string `json:"associatedBillsWithPrefix,omitempty"`
	// Account Code.
	...
	// Indicates if the folio is a Rachunek Folio.
	RachunekFolio *bool `json:"rachunekFolio,omitempty"`
	// Flag to indicate if a Customer Vat is generated from a Rachunek Folio.
	CustomerVatGenerated *bool `json:"customerVatGenerated,omitempty"`
	// Indicate that the billing window is confidential or not.
	Confidential *bool `json:"confidential,omitempty"`
	// Indicates if the folio is a Debit Note.
	DebitNote *bool `json:"debitNote,omitempty"`
}
...
// GetIsARAttached returns the IsARAttached field value if set, zero value otherwise.
func (o *FolioSummaryType) GetIsARAttached() bool {
	if o == nil || IsNil(o.IsARAttached) {
		var ret bool
		return ret
	}
	return *o.IsARAttached
}

// GetIsARAttachedOk returns a tuple with the IsARAttached field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *FolioSummaryType) GetIsARAttachedOk() (*bool, bool) {
	if o == nil || IsNil(o.IsARAttached) {
		return nil, false
	}
	return o.IsARAttached, true
}
...
// SetIsARAttached gets a reference to the given bool and assigns it to the IsARAttached field.
func (o *FolioSummaryType) SetIsARAttached(v bool) {
	o.IsARAttached = &v
}

// GetIsFiscalFolio returns the IsFiscalFolio field value if set, zero value otherwise.
func (o *FolioSummaryType) GetIsFiscalFolio() bool {
	if o == nil || IsNil(o.IsFiscalFolio) {
		var ret bool
		return ret
	}
	return *o.IsFiscalFolio
}

// GetIsFiscalFolioOk returns a tuple with the IsFiscalFolio field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *FolioSummaryType) GetIsFiscalFolioOk() (*bool, bool) {
	if o == nil || IsNil(o.IsFiscalFolio) {
		return nil, false
	}
	return o.IsFiscalFolio, true
}
...
// SetIsFiscalFolio gets a reference to the given bool and assigns it to the IsFiscalFolio field.
...
// GetPasserbyFolio returns the PasserbyFolio field value if set, zero value otherwise.
func (o *FolioSummaryType) GetPasserbyFolio() bool {
	if o == nil || IsNil(o.PasserbyFolio) {
		var ret bool
		return ret
	}
	return *o.PasserbyFolio
}

// GetPasserbyFolioOk returns a tuple with the PasserbyFolio field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *FolioSummaryType) GetPasserbyFolioOk() (*bool, bool) {
	if o == nil || IsNil(o.PasserbyFolio) {
		return nil, false
	}
	return o.PasserbyFolio, true
}
...
// SetPasserbyFolio gets a reference to the given bool and assigns it to the PasserbyFolio field.
...
// GetAssociatedBillsWithPrefix returns the AssociatedBillsWithPrefix field value if set, zero value otherwise.
func (o *FolioSummaryType) GetAssociatedBillsWithPrefix() []string {
	if o == nil || IsNil(o.AssociatedBillsWithPrefix) {
		var ret []string
		return ret
	}
	return o.AssociatedBillsWithPrefix
}

// GetAssociatedBillsWithPrefixOk returns a tuple with the AssociatedBillsWithPrefix field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *FolioSummaryType) GetAssociatedBillsWithPrefixOk() ([]string, bool) {
	if o == nil || IsNil(o.AssociatedBillsWithPrefix) {
		return nil, false
	}
	return o.AssociatedBillsWithPrefix, true
}

// HasAssociatedBillsWithPrefix returns a boolean if a field has been set.
func (o *FolioSummaryType) HasAssociatedBillsWithPrefix() bool {
	if o != nil && !IsNil(o.AssociatedBillsWithPrefix) {
		return true
	}
...
// SetAssociatedBillsWithPrefix gets a reference to the given []string and assigns it to the AssociatedBillsWithPrefix field.
func (o *FolioSummaryType) SetAssociatedBillsWithPrefix(v []string) {
	o.AssociatedBillsWithPrefix = v
}
...
// GetRachunekFolio returns the RachunekFolio field value if set, zero value otherwise.
func (o *FolioSummaryType) GetRachunekFolio() bool {
	if o == nil || IsNil(o.RachunekFolio) {
		var ret bool
		return ret
	}
	return *o.RachunekFolio
}

// GetRachunekFolioOk returns a tuple with the RachunekFolio field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *FolioSummaryType) GetRachunekFolioOk() (*bool, bool) {
	if o == nil || IsNil(o.RachunekFolio) {
		return nil, false
	}
	return o.RachunekFolio, true
}

// HasRachunekFolio returns a boolean if a field has been set.
func (o *FolioSummaryType) HasRachunekFolio() bool {
	if o != nil && !IsNil(o.RachunekFolio) {
		return true
	}
...
// SetRachunekFolio gets a reference to the given bool and assigns it to the RachunekFolio field.
func (o *FolioSummaryType) SetRachunekFolio(v bool) {
	o.RachunekFolio = &v
}

// GetCustomerVatGenerated returns the CustomerVatGenerated field value if set, zero value otherwise.
func (o *FolioSummaryType) GetCustomerVatGenerated() bool {
	if o == nil || IsNil(o.CustomerVatGenerated) {
		var ret bool
		return ret
	}
	return *o.CustomerVatGenerated
}

// GetCustomerVatGeneratedOk returns a tuple with the CustomerVatGenerated field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *FolioSummaryType) GetCustomerVatGeneratedOk() (*bool, bool) {
	if o == nil || IsNil(o.CustomerVatGenerated) {
		return nil, false
	}
	return o.CustomerVatGenerated, true
}

// HasCustomerVatGenerated returns a boolean if a field has been set.
func (o *FolioSummaryType) HasCustomerVatGenerated() bool {
	if o != nil && !IsNil(o.CustomerVatGenerated) {
		return true
	}
...
// SetCustomerVatGenerated gets a reference to the given bool and assigns it to the CustomerVatGenerated field.
func (o *FolioSummaryType) SetCustomerVatGenerated(v bool) {
	o.CustomerVatGenerated = &v
}

// GetConfidential returns the Confidential field value if set, zero value otherwise.
func (o *FolioSummaryType) GetConfidential() bool {
...
// and a boolean to check if the value has been set.
func (o *FolioSummaryType) GetConfidentialOk() (*bool, bool) {
	if o == nil || IsNil(o.Confidential) {
		return nil, false
	}
...
func (o *FolioSummaryType) HasConfidential() bool {
	if o != nil && !IsNil(o.Confidential) {
		return true
	}
...
func (o *FolioSummaryType) SetConfidential(v bool) {
	o.Confidential = &v
}

// GetDebitNote returns the DebitNote field value if set, zero value otherwise.
func (o *FolioSummaryType) GetDebitNote() bool {
	if o == nil || IsNil(o.DebitNote) {
		var ret bool
		return ret
	}
	return *o.DebitNote
...
// GetDebitNoteOk returns a tuple with the DebitNote field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *FolioSummaryType) GetDebitNoteOk() (*bool, bool) {
	if o == nil || IsNil(o.DebitNote) {
		return nil, false
	}
	return o.DebitNote, true
}

// HasDebitNote returns a boolean if a field has been set.
func (o *FolioSummaryType) HasDebitNote() bool {
	if o != nil && !IsNil(o.DebitNote) {
		return true
	}
...
// SetDebitNote gets a reference to the given bool and assigns it to the DebitNote field.
func (o *FolioSummaryType) SetDebitNote(v bool) {
	o.DebitNote = &v
}
...
func (o FolioSummaryType) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.IsARAttached) {
		toSerialize["isARAttached"] = o.IsARAttached
	}
	if !IsNil(o.IsFiscalFolio) {
		toSerialize["isFiscalFolio"] = o.IsFiscalFolio
	}
	...
	if !IsNil(o.PasserbyFolio) {
		toSerialize["passerbyFolio"] = o.PasserbyFolio
	}
	...
	if !IsNil(o.AssociatedBillsWithPrefix) {
		toSerialize["associatedBillsWithPrefix"] = o.AssociatedBillsWithPrefix
	}
	...
	if !IsNil(o.RachunekFolio) {
		toSerialize["rachunekFolio"] = o.RachunekFolio
	}
	if !IsNil(o.CustomerVatGenerated) {
		toSerialize["customerVatGenerated"] = o.CustomerVatGenerated
	}
	if !IsNil(o.Confidential) {
		toSerialize["confidential"] = o.Confidential
	}
	if !IsNil(o.DebitNote) {
		toSerialize["debitNote"] = o.DebitNote
	}
