...
func (o *AuthorizationInfoType) GetAlternateTransRef() string {
...
// and a boolean to check if the value has been set.
func (o *AuthorizationInfoType) GetAlternateTransRefOk() (*string, bool) {
	if o == nil || IsNil(o.AlternateTransRef) {
		return nil, false
	}
...
func (o *AuthorizationInfoType) HasAlternateTransRef() bool {
	if o != nil && !IsNil(o.AlternateTransRef) {
		return true
	}
...
func (o *AuthorizationInfoType) SetAlternateTransRef(v string) {
