...
type PostBillingCheckChargesCriteriaType struct {
	...
	Items []PostBillingCheckChargesItemCriteriaType `json:"items,omitempty"`
...
func (o *PostBillingCheckChargesCriteriaType) GetItems() []PostBillingCheckChargesItemCriteriaType {
	if o == nil || IsNil(o.Items) {
		var ret []PostBillingCheckChargesItemCriteriaType
		return ret
	}
	return o.Items
}
...
// SetItems gets a reference to the given []PostBillingCheckChargesItemCriteriaType and assigns it to the Items field.
