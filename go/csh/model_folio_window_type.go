...
type FolioWindowType struct {
	...
	ServiceTypeInfo []TransactionServiceTypeType `json:"serviceTypeInfo,omitempty"`
	...
	PaymentsOnly *bool `json:"paymentsOnly,omitempty"`
	// Flag to notify if the current folio return summary postings.
	BillingSummary *bool `json:"billingSummary,omitempty"`
	...
	TaxFolioPostingExists *bool `json:"taxFolioPostingExists,omitempty"`
	// Flag indicating a billing window (2-8) as confidential. Applied only when Confidential Billing Window Opera Control is active.
...
func (o *FolioWindowType) GetServiceTypeInfo() []TransactionServiceTypeType {
	if o == nil || IsNil(o.ServiceTypeInfo) {
		var ret []TransactionServiceTypeType
		return ret
	}
...
// SetServiceTypeInfo gets a reference to the given []TransactionServiceTypeType and assigns it to the ServiceTypeInfo field.
...
func (o *FolioWindowType) GetFiscalInvoicingCurrencyInfo() ExchangeRateInfoType {
...
// and a boolean to check if the value has been set.
func (o *FolioWindowType) GetFiscalInvoicingCurrencyInfoOk() (*ExchangeRateInfoType, bool) {
	if o == nil || IsNil(o.FiscalInvoicingCurrencyInfo) {
		return nil, false
	}
...
func (o *FolioWindowType) HasFiscalInvoicingCurrencyInfo() bool {
	if o != nil && !IsNil(o.FiscalInvoicingCurrencyInfo) {
		return true
	}
...
func (o *FolioWindowType) SetFiscalInvoicingCurrencyInfo(v ExchangeRateInfoType) {
...
// GetPaymentsOnly returns the PaymentsOnly field value if set, zero value otherwise.
func (o *FolioWindowType) GetPaymentsOnly() bool {
	if o == nil || IsNil(o.PaymentsOnly) {
		var ret bool
		return ret
	}
	return *o.PaymentsOnly
}

// GetPaymentsOnlyOk returns a tuple with the PaymentsOnly field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *FolioWindowType) GetPaymentsOnlyOk() (*bool, bool) {
	if o == nil || IsNil(o.PaymentsOnly) {
		return nil, false
	}
	return o.PaymentsOnly, true
}
...
// SetPaymentsOnly gets a reference to the given bool and assigns it to the PaymentsOnly field.
func (o *FolioWindowType) SetPaymentsOnly(v bool) {
	o.PaymentsOnly = &v
}

// GetBillingSummary returns the BillingSummary field value if set, zero value otherwise.
func (o *FolioWindowType) GetBillingSummary() bool {
	if o == nil || IsNil(o.BillingSummary) {
		var ret bool
		return ret
	}
	return *o.BillingSummary
}

// GetBillingSummaryOk returns a tuple with the BillingSummary field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *FolioWindowType) GetBillingSummaryOk() (*bool, bool) {
	if o == nil || IsNil(o.BillingSummary) {
		return nil, false
	}
	return o.BillingSummary, true
}

// HasBillingSummary returns a boolean if a field has been set.
func (o *FolioWindowType) HasBillingSummary() bool {
	if o != nil && !IsNil(o.BillingSummary) {
		return true
	}
...
// SetBillingSummary gets a reference to the given bool and assigns it to the BillingSummary field.
func (o *FolioWindowType) SetBillingSummary(v bool) {
	o.BillingSummary = &v
}
...
// GetTaxFolioPostingExists returns the TaxFolioPostingExists field value if set, zero value otherwise.
func (o *FolioWindowType) GetTaxFolioPostingExists() bool {
	if o == nil || IsNil(o.TaxFolioPostingExists) {
		var ret bool
		return ret
	}
	return *o.TaxFolioPostingExists
}

// GetTaxFolioPostingExistsOk returns a tuple with the TaxFolioPostingExists field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *FolioWindowType) GetTaxFolioPostingExistsOk() (*bool, bool) {
	if o == nil || IsNil(o.TaxFolioPostingExists) {
		return nil, false
	}
	return o.TaxFolioPostingExists, true
}
...
// SetTaxFolioPostingExists gets a reference to the given bool and assigns it to the TaxFolioPostingExists field.
func (o *FolioWindowType) SetTaxFolioPostingExists(v bool) {
	o.TaxFolioPostingExists = &v
}

// GetConfidential returns the Confidential field value if set, zero value otherwise.
func (o *FolioWindowType) GetConfidential() bool {
...
// and a boolean to check if the value has been set.
func (o *FolioWindowType) GetConfidentialOk() (*bool, bool) {
	if o == nil || IsNil(o.Confidential) {
		return nil, false
	}
...
func (o *FolioWindowType) HasConfidential() bool {
	if o != nil && !IsNil(o.Confidential) {
		return true
	}
...
func (o *FolioWindowType) SetConfidential(v bool) {
	o.Confidential = &v
}
...
func (o FolioWindowType) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.PaymentsOnly) {
		toSerialize["paymentsOnly"] = o.PaymentsOnly
	}
	if !IsNil(o.BillingSummary) {
		toSerialize["billingSummary"] = o.BillingSummary
	}
	...
	if !IsNil(o.TaxFolioPostingExists) {
		toSerialize["taxFolioPostingExists"] = o.TaxFolioPostingExists
	}
