...
type DepositPaymentCriteriaType struct {
	...
	// Flag to indicate if a cash surcharge amount can be included, when the functionality for Cash Surcharge is available.
	ApplyCashSurcharge *bool `json:"applyCashSurcharge,omitempty"`
	...
	// The unique identifier (transaction number) of the original payment being refunded.
	OriginalTransactionNo *float32 `json:"originalTransactionNo,omitempty"`
}
...
// GetApplyCashSurcharge returns the ApplyCashSurcharge field value if set, zero value otherwise.
func (o *DepositPaymentCriteriaType) GetApplyCashSurcharge() bool {
	if o == nil || IsNil(o.ApplyCashSurcharge) {
		var ret bool
		return ret
	}
	return *o.ApplyCashSurcharge
}

// GetApplyCashSurchargeOk returns a tuple with the ApplyCashSurcharge field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *DepositPaymentCriteriaType) GetApplyCashSurchargeOk() (*bool, bool) {
	if o == nil || IsNil(o.ApplyCashSurcharge) {
		return nil, false
	}
	return o.ApplyCashSurcharge, true
}

// HasApplyCashSurcharge returns a boolean if a field has been set.
func (o *DepositPaymentCriteriaType) HasApplyCashSurcharge() bool {
	if o != nil && !IsNil(o.ApplyCashSurcharge) {
		return true
	}
...
// SetApplyCashSurcharge gets a reference to the given bool and assigns it to the ApplyCashSurcharge field.
func (o *DepositPaymentCriteriaType) SetApplyCashSurcharge(v bool) {
	o.ApplyCashSurcharge = &v
}
...
// GetOriginalTransactionNo returns the OriginalTransactionNo field value if set, zero value otherwise.
func (o *DepositPaymentCriteriaType) GetOriginalTransactionNo() float32 {
	if o == nil || IsNil(o.OriginalTransactionNo) {
		var ret float32
		return ret
	}
	return *o.OriginalTransactionNo
}

// GetOriginalTransactionNoOk returns a tuple with the OriginalTransactionNo field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *DepositPaymentCriteriaType) GetOriginalTransactionNoOk() (*float32, bool) {
	if o == nil || IsNil(o.OriginalTransactionNo) {
		return nil, false
	}
	return o.OriginalTransactionNo, true
}

// HasOriginalTransactionNo returns a boolean if a field has been set.
func (o *DepositPaymentCriteriaType) HasOriginalTransactionNo() bool {
	if o != nil && !IsNil(o.OriginalTransactionNo) {
		return true
	}
...
// SetOriginalTransactionNo gets a reference to the given float32 and assigns it to the OriginalTransactionNo field.
func (o *DepositPaymentCriteriaType) SetOriginalTransactionNo(v float32) {
	o.OriginalTransactionNo = &v
}
...
func (o DepositPaymentCriteriaType) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.ApplyCashSurcharge) {
		toSerialize["applyCashSurcharge"] = o.ApplyCashSurcharge
	}
	...
	if !IsNil(o.OriginalTransactionNo) {
		toSerialize["originalTransactionNo"] = o.OriginalTransactionNo
	}
