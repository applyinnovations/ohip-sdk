...
func (o *DepositPostingType) GetCcSettleRecordExists() bool {
...
// and a boolean to check if the value has been set.
func (o *DepositPostingType) GetCcSettleRecordExistsOk() (*bool, bool) {
	if o == nil || IsNil(o.CcSettleRecordExists) {
		return nil, false
	}
...
func (o *DepositPostingType) HasCcSettleRecordExists() bool {
	if o != nil && !IsNil(o.CcSettleRecordExists) {
		return true
	}
...
func (o *DepositPostingType) SetCcSettleRecordExists(v bool) {
