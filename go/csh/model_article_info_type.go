...
type ArticleInfoType struct {
	...
	QuantityInStock *int32 `json:"quantityInStock,omitempty"`
...
func (o *ArticleInfoType) GetQuantityInStock() int32 {
...
// and a boolean to check if the value has been set.
func (o *ArticleInfoType) GetQuantityInStockOk() (*int32, bool) {
	if o == nil || IsNil(o.QuantityInStock) {
		return nil, false
	}
...
func (o *ArticleInfoType) HasQuantityInStock() bool {
	if o != nil && !IsNil(o.QuantityInStock) {
		return true
	}
...
// SetQuantityInStock gets a reference to the given int32 and assigns it to the QuantityInStock field.
func (o *ArticleInfoType) SetQuantityInStock(v int32) {
	o.QuantityInStock = &v
}
