...
type HotelInterfaceType struct {
	...
	// Stores the external system to identify the target system.
...
func (o *HotelInterfaceType) GetExternalSystem() string {
...
// and a boolean to check if the value has been set.
func (o *HotelInterfaceType) GetExternalSystemOk() (*string, bool) {
	if o == nil || IsNil(o.ExternalSystem) {
		return nil, false
	}
...
func (o *HotelInterfaceType) HasExternalSystem() bool {
	if o != nil && !IsNil(o.ExternalSystem) {
		return true
	}
...
func (o *HotelInterfaceType) SetExternalSystem(v string) {
	o.ExternalSystem = &v
}
