...
type InterfaceAdditionalInfoType struct {
	...
	// Display Order sequence for Interfaces
...
func (o *InterfaceAdditionalInfoType) GetSequence() float32 {
...
// and a boolean to check if the value has been set.
func (o *InterfaceAdditionalInfoType) GetSequenceOk() (*float32, bool) {
	if o == nil || IsNil(o.Sequence) {
		return nil, false
	}
...
func (o *InterfaceAdditionalInfoType) HasSequence() bool {
	if o != nil && !IsNil(o.Sequence) {
		return true
	}
...
func (o *InterfaceAdditionalInfoType) SetSequence(v float32) {
	o.Sequence = &v
}
