...
type HotelInterfaceDetailType struct {
	...
	OpiOnboardingInfo *OpiInfoType `json:"opiOnboardingInfo,omitempty"`
}
...
// GetOpiOnboardingInfo returns the OpiOnboardingInfo field value if set, zero value otherwise.
func (o *HotelInterfaceDetailType) GetOpiOnboardingInfo() OpiInfoType {
	if o == nil || IsNil(o.OpiOnboardingInfo) {
		var ret OpiInfoType
		return ret
	}
	return *o.OpiOnboardingInfo
}

// GetOpiOnboardingInfoOk returns a tuple with the OpiOnboardingInfo field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *HotelInterfaceDetailType) GetOpiOnboardingInfoOk() (*OpiInfoType, bool) {
	if o == nil || IsNil(o.OpiOnboardingInfo) {
		return nil, false
	}
	return o.OpiOnboardingInfo, true
}

// HasOpiOnboardingInfo returns a boolean if a field has been set.
func (o *HotelInterfaceDetailType) HasOpiOnboardingInfo() bool {
	if o != nil && !IsNil(o.OpiOnboardingInfo) {
		return true
	}
...
// SetOpiOnboardingInfo gets a reference to the given OpiInfoType and assigns it to the OpiOnboardingInfo field.
func (o *HotelInterfaceDetailType) SetOpiOnboardingInfo(v OpiInfoType) {
	o.OpiOnboardingInfo = &v
}
...
func (o HotelInterfaceDetailType) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.OpiOnboardingInfo) {
		toSerialize["opiOnboardingInfo"] = o.OpiOnboardingInfo
	}
