...
```golang
import intcfg "github.com/applyinnovations/ohip-sdk/go/intcfg/v3"
```
...
*ExternalSystemsConfigAPI* | [**PutUpsertPrinter**](docs/ExternalSystemsConfigAPI.md#putupsertprinter) | **Put** /upsert/hotels/{hotelId}/printers | Operation to create/change printer.
*OEDSConfigAPI* | [**ChangeOEDSConfigData**](docs/OEDSConfigAPI.md#changeoedsconfigdata) | **Put** /oedsApi | Update OEDS API
*OEDSConfigAPI* | [**GetOEDSConfigData**](docs/OEDSConfigAPI.md#getoedsconfigdata) | **Get** /oedsApi | Get OEDS API
...
## Documentation For Models
 ...
 - [ChangePrinter](docs/ChangePrinter.md)
 ...
 - [ChangedPrinter](docs/ChangedPrinter.md)
 ...
 - [OedsConfigData](docs/OedsConfigData.md)
 - [OedsConfigDataStatus](docs/OedsConfigDataStatus.md)
 - [OedsConfigType](docs/OedsConfigType.md)
 - [OedsConfigUpdate](docs/OedsConfigUpdate.md)
 - [OperaVersion](docs/OperaVersion.md)
 - [OpiInfoType](docs/OpiInfoType.md)
 ...
 - [PrinterOutputType](docs/PrinterOutputType.md)
 - [PrinterSetupType](docs/PrinterSetupType.md)
 - [PspEndpointParamValue](docs/PspEndpointParamValue.md)
 - [PspEndpointValue](docs/PspEndpointValue.md)
