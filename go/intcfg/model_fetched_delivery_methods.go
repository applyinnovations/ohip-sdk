...
// checks if the FetchedDeliveryMethods type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &FetchedDeliveryMethods{}

// FetchedDeliveryMethods Response to request to fetch the delivery method for a property/HUB/Chain and its configurations.
type FetchedDeliveryMethods struct {
...
func (o FetchedDeliveryMethods) MarshalJSON() ([]byte, error) {
...
func (o FetchedDeliveryMethods) ToMap() (map[string]interface{}, error) {
...
type NullableFetchedDeliveryMethods struct {
	value *FetchedDeliveryMethods
	isSet bool
}

func (v NullableFetchedDeliveryMethods) Get() *FetchedDeliveryMethods {
	return v.value
}

func (v *NullableFetchedDeliveryMethods) Set(val *FetchedDeliveryMethods) {
	v.value = val
	v.isSet = true
}

func (v NullableFetchedDeliveryMethods) IsSet() bool {
	return v.isSet
}

func (v *NullableFetchedDeliveryMethods) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableFetchedDeliveryMethods(val *FetchedDeliveryMethods) *NullableFetchedDeliveryMethods {
	return &NullableFetchedDeliveryMethods{value: val, isSet: true}
}

func (v NullableFetchedDeliveryMethods) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableFetchedDeliveryMethods) UnmarshalJSON(src []byte) error {
	v.isSet = true
