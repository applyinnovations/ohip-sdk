...
// checks if the FetchedHotelInterfaceFailedMessages type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &FetchedHotelInterfaceFailedMessages{}

// FetchedHotelInterfaceFailedMessages Response object for retrieving Hotel Interface Failed Messages.
type FetchedHotelInterfaceFailedMessages struct {
	// Collection of Hotel Interface Failed Messages.
	Messages []HotelInterfaceFailedMessageType `json:"messages,omitempty"`
...
func NewFetchedHotelInterfaceFailedMessages() *FetchedHotelInterfaceFailedMessages {
	this := FetchedHotelInterfaceFailedMessages{}
	return &this
}
...
func (o *FetchedHotelInterfaceFailedMessages) GetMessages() []HotelInterfaceFailedMessageType {
	if o == nil || IsNil(o.Messages) {
		var ret []HotelInterfaceFailedMessageType
		return ret
	}
	return o.Messages
}
...
// SetMessages gets a reference to the given []HotelInterfaceFailedMessageType and assigns it to the Messages field.
...
func (o FetchedHotelInterfaceFailedMessages) MarshalJSON() ([]byte, error) {
...
func (o FetchedHotelInterfaceFailedMessages) ToMap() (map[string]interface{}, error) {
...
type NullableFetchedHotelInterfaceFailedMessages struct {
	value *FetchedHotelInterfaceFailedMessages
	isSet bool
}

func (v NullableFetchedHotelInterfaceFailedMessages) Get() *FetchedHotelInterfaceFailedMessages {
	return v.value
}

func (v *NullableFetchedHotelInterfaceFailedMessages) Set(val *FetchedHotelInterfaceFailedMessages) {
	v.value = val
	v.isSet = true
}

func (v NullableFetchedHotelInterfaceFailedMessages) IsSet() bool {
	return v.isSet
}

func (v *NullableFetchedHotelInterfaceFailedMessages) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableFetchedHotelInterfaceFailedMessages(val *FetchedHotelInterfaceFailedMessages) *NullableFetchedHotelInterfaceFailedMessages {
	return &NullableFetchedHotelInterfaceFailedMessages{value: val, isSet: true}
}

func (v NullableFetchedHotelInterfaceFailedMessages) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableFetchedHotelInterfaceFailedMessages) UnmarshalJSON(src []byte) error {
	v.isSet = true
