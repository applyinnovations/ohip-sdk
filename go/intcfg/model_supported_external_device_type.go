...
func (o *SupportedExternalDeviceType) GetManagedBy() ManagedByOptions {
...
// and a boolean to check if the value has been set.
func (o *SupportedExternalDeviceType) GetManagedByOk() (*ManagedByOptions, bool) {
	if o == nil || IsNil(o.ManagedBy) {
		return nil, false
	}
...
func (o *SupportedExternalDeviceType) HasManagedBy() bool {
	if o != nil && !IsNil(o.ManagedBy) {
		return true
	}
...
func (o *SupportedExternalDeviceType) SetManagedBy(v ManagedByOptions) {
	o.ManagedBy = &v
}
