...
type InterfacePrimaryInfoType struct {
	...
	// Stores the External System Code to identify the target system.
...
func (o *InterfacePrimaryInfoType) GetExternalSystem() string {
...
// and a boolean to check if the value has been set.
func (o *InterfacePrimaryInfoType) GetExternalSystemOk() (*string, bool) {
	if o == nil || IsNil(o.ExternalSystem) {
		return nil, false
	}
...
func (o *InterfacePrimaryInfoType) HasExternalSystem() bool {
	if o != nil && !IsNil(o.ExternalSystem) {
		return true
	}
...
func (o *InterfacePrimaryInfoType) SetExternalSystem(v string) {
	o.ExternalSystem = &v
}
