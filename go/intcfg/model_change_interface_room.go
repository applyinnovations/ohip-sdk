...
// checks if the ChangeInterfaceRoom type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ChangeInterfaceRoom{}

// ChangeInterfaceRoom Request object for updating an Interface Room of a Hotel Interface record.
type ChangeInterfaceRoom struct {
...
func (o ChangeInterfaceRoom) MarshalJSON() ([]byte, error) {
...
func (o ChangeInterfaceRoom) ToMap() (map[string]interface{}, error) {
...
type NullableChangeInterfaceRoom struct {
	value *ChangeInterfaceRoom
	isSet bool
}

func (v NullableChangeInterfaceRoom) Get() *ChangeInterfaceRoom {
	return v.value
}

func (v *NullableChangeInterfaceRoom) Set(val *ChangeInterfaceRoom) {
	v.value = val
	v.isSet = true
}

func (v NullableChangeInterfaceRoom) IsSet() bool {
	return v.isSet
}

func (v *NullableChangeInterfaceRoom) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableChangeInterfaceRoom(val *ChangeInterfaceRoom) *NullableChangeInterfaceRoom {
	return &NullableChangeInterfaceRoom{value: val, isSet: true}
}

func (v NullableChangeInterfaceRoom) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableChangeInterfaceRoom) UnmarshalJSON(src []byte) error {
	v.isSet = true
