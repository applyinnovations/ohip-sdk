...
func (o *ActivityInfoType) GetActivityOwnerCode() string {
...
// and a boolean to check if the value has been set.
func (o *ActivityInfoType) GetActivityOwnerCodeOk() (*string, bool) {
	if o == nil || IsNil(o.ActivityOwnerCode) {
		return nil, false
	}
...
func (o *ActivityInfoType) HasActivityOwnerCode() bool {
	if o != nil && !IsNil(o.ActivityOwnerCode) {
		return true
	}
...
func (o *ActivityInfoType) SetActivityOwnerCode(v string) {
