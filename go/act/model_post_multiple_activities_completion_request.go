...
// checks if the PostMultipleActivitiesCompletionRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PostMultipleActivitiesCompletionRequest{}

// PostMultipleActivitiesCompletionRequest struct for PostMultipleActivitiesCompletionRequest
type PostMultipleActivitiesCompletionRequest struct {
...
func NewPostMultipleActivitiesCompletionRequest() *PostMultipleActivitiesCompletionRequest {
	this := PostMultipleActivitiesCompletionRequest{}
	return &this
}
...
func (o PostMultipleActivitiesCompletionRequest) MarshalJSON() ([]byte, error) {
...
func (o PostMultipleActivitiesCompletionRequest) ToMap() (map[string]interface{}, error) {
...
type NullablePostMultipleActivitiesCompletionRequest struct {
	value *PostMultipleActivitiesCompletionRequest
	isSet bool
}

func (v NullablePostMultipleActivitiesCompletionRequest) Get() *PostMultipleActivitiesCompletionRequest {
	return v.value
}

func (v *NullablePostMultipleActivitiesCompletionRequest) Set(val *PostMultipleActivitiesCompletionRequest) {
	v.value = val
	v.isSet = true
}

func (v NullablePostMultipleActivitiesCompletionRequest) IsSet() bool {
	return v.isSet
}

func (v *NullablePostMultipleActivitiesCompletionRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePostMultipleActivitiesCompletionRequest(val *PostMultipleActivitiesCompletionRequest) *NullablePostMultipleActivitiesCompletionRequest {
	return &NullablePostMultipleActivitiesCompletionRequest{value: val, isSet: true}
}

func (v NullablePostMultipleActivitiesCompletionRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePostMultipleActivitiesCompletionRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
