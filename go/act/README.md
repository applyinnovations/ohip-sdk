...
```golang
import act "github.com/applyinnovations/ohip-sdk/go/act/v3"
```
...
*ActivityAPI* | [**SearchEmails**](docs/ActivityAPI.md#searchemails) | **Post** /activities/emails/searches | Get Emails
...
## Documentation For Models
 ...
 - [SearchEmailsRequest](docs/SearchEmailsRequest.md)
