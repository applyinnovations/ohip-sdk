...
// checks if the AccountId type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AccountId{}

// AccountId An identifier used to uniquely reference an object in a system (e.g. an airline reservation reference, customer profile reference, booking confirmation number, or a reference to a previous availability quote).
...
func (o AccountId) MarshalJSON() ([]byte, error) {
...
func (o AccountId) ToMap() (map[string]interface{}, error) {
...
type NullableAccountId struct {
	value *AccountId
	isSet bool
}

func (v NullableAccountId) Get() *AccountId {
	return v.value
}

func (v *NullableAccountId) Set(val *AccountId) {
	v.value = val
	v.isSet = true
}

func (v NullableAccountId) IsSet() bool {
	return v.isSet
}

func (v *NullableAccountId) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAccountId(val *AccountId) *NullableAccountId {
	return &NullableAccountId{value: val, isSet: true}
}

func (v NullableAccountId) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAccountId) UnmarshalJSON(src []byte) error {
	v.isSet = true
