...
func (o *RoomCondtionTemplateType) GetManagedBy() ManagedByOptions {
...
// and a boolean to check if the value has been set.
func (o *RoomCondtionTemplateType) GetManagedByOk() (*ManagedByOptions, bool) {
	if o == nil || IsNil(o.ManagedBy) {
		return nil, false
	}
...
func (o *RoomCondtionTemplateType) HasManagedBy() bool {
	if o != nil && !IsNil(o.ManagedBy) {
		return true
	}
...
func (o *RoomCondtionTemplateType) SetManagedBy(v ManagedByOptions) {
	o.ManagedBy = &v
}
