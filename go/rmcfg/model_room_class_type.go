...
// checks if the RoomClassType type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RoomClassType{}

// RoomClassType Common code type for code, description, seq and inactive
type RoomClassType struct {
	...
	RoomTypes *RoomTypesSummaryType `json:"roomTypes,omitempty"`
...
// SetRoomTypes gets a reference to the given RoomTypesSummaryType and assigns it to the RoomTypes field.
...
func (o RoomClassType) MarshalJSON() ([]byte, error) {
...
func (o RoomClassType) ToMap() (map[string]interface{}, error) {
...
type NullableRoomClassType struct {
	value *RoomClassType
	isSet bool
}

func (v NullableRoomClassType) Get() *RoomClassType {
	return v.value
}

func (v *NullableRoomClassType) Set(val *RoomClassType) {
	v.value = val
	v.isSet = true
}

func (v NullableRoomClassType) IsSet() bool {
	return v.isSet
}

func (v *NullableRoomClassType) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRoomClassType(val *RoomClassType) *NullableRoomClassType {
	return &NullableRoomClassType{value: val, isSet: true}
}

func (v NullableRoomClassType) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRoomClassType) UnmarshalJSON(src []byte) error {
	v.isSet = true
