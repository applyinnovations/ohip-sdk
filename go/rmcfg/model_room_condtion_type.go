...
func (o *RoomCondtionType) GetManagedBy() ManagedByOptions {
...
// and a boolean to check if the value has been set.
func (o *RoomCondtionType) GetManagedByOk() (*ManagedByOptions, bool) {
	if o == nil || IsNil(o.ManagedBy) {
		return nil, false
	}
...
func (o *RoomCondtionType) HasManagedBy() bool {
	if o != nil && !IsNil(o.ManagedBy) {
		return true
	}
...
func (o *RoomCondtionType) SetManagedBy(v ManagedByOptions) {
	o.ManagedBy = &v
}
