...
// checks if the BedTypeType type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BedTypeType{}

// BedTypeType Contains Common Master configuration detail.
type BedTypeType struct {
...
func (o BedTypeType) MarshalJSON() ([]byte, error) {
...
func (o BedTypeType) ToMap() (map[string]interface{}, error) {
...
type NullableBedTypeType struct {
	value *BedTypeType
	isSet bool
}

func (v NullableBedTypeType) Get() *BedTypeType {
	return v.value
}

func (v *NullableBedTypeType) Set(val *BedTypeType) {
	v.value = val
	v.isSet = true
}

func (v NullableBedTypeType) IsSet() bool {
	return v.isSet
}

func (v *NullableBedTypeType) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBedTypeType(val *BedTypeType) *NullableBedTypeType {
	return &NullableBedTypeType{value: val, isSet: true}
}

func (v NullableBedTypeType) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBedTypeType) UnmarshalJSON(src []byte) error {
	v.isSet = true
