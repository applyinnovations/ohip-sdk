...
func (o *ConfigRoomSummaryType) GetManagedBy() ManagedByOptions {
...
// and a boolean to check if the value has been set.
func (o *ConfigRoomSummaryType) GetManagedByOk() (*ManagedByOptions, bool) {
	if o == nil || IsNil(o.ManagedBy) {
		return nil, false
	}
...
func (o *ConfigRoomSummaryType) HasManagedBy() bool {
	if o != nil && !IsNil(o.ManagedBy) {
		return true
	}
...
func (o *ConfigRoomSummaryType) SetManagedBy(v ManagedByOptions) {
	o.ManagedBy = &v
}
