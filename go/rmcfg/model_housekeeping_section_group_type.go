...
func (o *HousekeepingSectionGroupType) GetManagedBy() ManagedByOptions {
...
// and a boolean to check if the value has been set.
func (o *HousekeepingSectionGroupType) GetManagedByOk() (*ManagedByOptions, bool) {
	if o == nil || IsNil(o.ManagedBy) {
		return nil, false
	}
...
func (o *HousekeepingSectionGroupType) HasManagedBy() bool {
	if o != nil && !IsNil(o.ManagedBy) {
		return true
	}
...
func (o *HousekeepingSectionGroupType) SetManagedBy(v ManagedByOptions) {
	o.ManagedBy = &v
}
