...
type RoomTypeType struct {
	...
	// Indicates if the Room Type is configured as a meeting room (function space). This element is available when Type = Pseudo or the Guest Room As Meeting Room OPERA Control is active.
	...
	// Indicates if the room type is available for maintenance requests. This element is available when the Maintenance OPERA Control is active.
	...
	// Indicates if the Room Type shows in the Housekeeping components like the Housekeeping Board.
	...
	// The Room is automatically assigned when a reservation is made for this Room Type. This element is available when the Room Type Auto Room Assign OPERA Control is on.
