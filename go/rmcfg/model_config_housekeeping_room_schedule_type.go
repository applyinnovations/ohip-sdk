...
func (o *ConfigHousekeepingRoomScheduleType) GetManagedBy() ManagedByOptions {
...
// and a boolean to check if the value has been set.
func (o *ConfigHousekeepingRoomScheduleType) GetManagedByOk() (*ManagedByOptions, bool) {
	if o == nil || IsNil(o.ManagedBy) {
		return nil, false
	}
...
func (o *ConfigHousekeepingRoomScheduleType) HasManagedBy() bool {
	if o != nil && !IsNil(o.ManagedBy) {
		return true
	}
...
func (o *ConfigHousekeepingRoomScheduleType) SetManagedBy(v ManagedByOptions) {
	o.ManagedBy = &v
}
