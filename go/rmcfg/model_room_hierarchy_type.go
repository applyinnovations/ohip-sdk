...
func (o *RoomHierarchyType) GetManagedBy() ManagedByOptions {
...
// and a boolean to check if the value has been set.
func (o *RoomHierarchyType) GetManagedByOk() (*ManagedByOptions, bool) {
	if o == nil || IsNil(o.ManagedBy) {
		return nil, false
	}
...
func (o *RoomHierarchyType) HasManagedBy() bool {
	if o != nil && !IsNil(o.ManagedBy) {
		return true
	}
...
func (o *RoomHierarchyType) SetManagedBy(v ManagedByOptions) {
	o.ManagedBy = &v
}
