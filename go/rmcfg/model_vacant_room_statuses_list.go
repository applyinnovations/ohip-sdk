...
// checks if the VacantRoomStatusesList type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VacantRoomStatusesList{}

// VacantRoomStatusesList Response object for fetching vacant room statuses.
type VacantRoomStatusesList struct {
	// Holds collection of vacant room housekeeping statuses.
	VacantRoomStatus []VacantRoomStatusType `json:"vacantRoomStatus,omitempty"`
...
// GetVacantRoomStatus returns the VacantRoomStatus field value if set, zero value otherwise.
func (o *VacantRoomStatusesList) GetVacantRoomStatus() []VacantRoomStatusType {
	if o == nil || IsNil(o.VacantRoomStatus) {
		var ret []VacantRoomStatusType
		return ret
	}
	return o.VacantRoomStatus
}

// GetVacantRoomStatusOk returns a tuple with the VacantRoomStatus field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *VacantRoomStatusesList) GetVacantRoomStatusOk() ([]VacantRoomStatusType, bool) {
	if o == nil || IsNil(o.VacantRoomStatus) {
		return nil, false
	}
	return o.VacantRoomStatus, true
}
...
// SetVacantRoomStatus gets a reference to the given []VacantRoomStatusType and assigns it to the VacantRoomStatus field.
func (o *VacantRoomStatusesList) SetVacantRoomStatus(v []VacantRoomStatusType) {
	o.VacantRoomStatus = v
}
...
func (o VacantRoomStatusesList) MarshalJSON() ([]byte, error) {
...
func (o VacantRoomStatusesList) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.VacantRoomStatus) {
		toSerialize["vacantRoomStatus"] = o.VacantRoomStatus
	}
...
type NullableVacantRoomStatusesList struct {
	value *VacantRoomStatusesList
	isSet bool
}

func (v NullableVacantRoomStatusesList) Get() *VacantRoomStatusesList {
	return v.value
}

func (v *NullableVacantRoomStatusesList) Set(val *VacantRoomStatusesList) {
	v.value = val
	v.isSet = true
}

func (v NullableVacantRoomStatusesList) IsSet() bool {
	return v.isSet
}

func (v *NullableVacantRoomStatusesList) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVacantRoomStatusesList(val *VacantRoomStatusesList) *NullableVacantRoomStatusesList {
	return &NullableVacantRoomStatusesList{value: val, isSet: true}
}

func (v NullableVacantRoomStatusesList) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVacantRoomStatusesList) UnmarshalJSON(src []byte) error {
	v.isSet = true
