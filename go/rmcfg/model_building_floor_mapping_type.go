...
func (o *BuildingFloorMappingType) GetManagedBy() ManagedByOptions {
...
// and a boolean to check if the value has been set.
func (o *BuildingFloorMappingType) GetManagedByOk() (*ManagedByOptions, bool) {
	if o == nil || IsNil(o.ManagedBy) {
		return nil, false
	}
...
func (o *BuildingFloorMappingType) HasManagedBy() bool {
	if o != nil && !IsNil(o.ManagedBy) {
		return true
	}
...
func (o *BuildingFloorMappingType) SetManagedBy(v ManagedByOptions) {
	o.ManagedBy = &v
}
