...
// checks if the HotelRoomMaintenanceReasonsDetails type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &HotelRoomMaintenanceReasonsDetails{}

// HotelRoomMaintenanceReasonsDetails Response object for fetching room maintenance reasons for a hotel.
type HotelRoomMaintenanceReasonsDetails struct {
...
func NewHotelRoomMaintenanceReasonsDetails() *HotelRoomMaintenanceReasonsDetails {
	this := HotelRoomMaintenanceReasonsDetails{}
	return &this
}
...
func (o HotelRoomMaintenanceReasonsDetails) MarshalJSON() ([]byte, error) {
...
func (o HotelRoomMaintenanceReasonsDetails) ToMap() (map[string]interface{}, error) {
...
type NullableHotelRoomMaintenanceReasonsDetails struct {
	value *HotelRoomMaintenanceReasonsDetails
	isSet bool
}

func (v NullableHotelRoomMaintenanceReasonsDetails) Get() *HotelRoomMaintenanceReasonsDetails {
	return v.value
}

func (v *NullableHotelRoomMaintenanceReasonsDetails) Set(val *HotelRoomMaintenanceReasonsDetails) {
	v.value = val
	v.isSet = true
}

func (v NullableHotelRoomMaintenanceReasonsDetails) IsSet() bool {
	return v.isSet
}

func (v *NullableHotelRoomMaintenanceReasonsDetails) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableHotelRoomMaintenanceReasonsDetails(val *HotelRoomMaintenanceReasonsDetails) *NullableHotelRoomMaintenanceReasonsDetails {
	return &NullableHotelRoomMaintenanceReasonsDetails{value: val, isSet: true}
}

func (v NullableHotelRoomMaintenanceReasonsDetails) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableHotelRoomMaintenanceReasonsDetails) UnmarshalJSON(src []byte) error {
	v.isSet = true
