...
func (o *HousekeepingTaskConfigType) GetManagedBy() ManagedByOptions {
...
// and a boolean to check if the value has been set.
func (o *HousekeepingTaskConfigType) GetManagedByOk() (*ManagedByOptions, bool) {
	if o == nil || IsNil(o.ManagedBy) {
		return nil, false
	}
...
func (o *HousekeepingTaskConfigType) HasManagedBy() bool {
	if o != nil && !IsNil(o.ManagedBy) {
		return true
	}
...
func (o *HousekeepingTaskConfigType) SetManagedBy(v ManagedByOptions) {
	o.ManagedBy = &v
}
