...
func (o *BuildingType) GetManagedBy() ManagedByOptions {
...
// and a boolean to check if the value has been set.
func (o *BuildingType) GetManagedByOk() (*ManagedByOptions, bool) {
	if o == nil || IsNil(o.ManagedBy) {
		return nil, false
	}
...
func (o *BuildingType) HasManagedBy() bool {
	if o != nil && !IsNil(o.ManagedBy) {
		return true
	}
...
func (o *BuildingType) SetManagedBy(v ManagedByOptions) {
	o.ManagedBy = &v
}
