...
```golang
import rmcfg "github.com/applyinnovations/ohip-sdk/go/rmcfg/v3"
```
...
*HotelConfigAPI* | [**ChangeUpsertHousekeepingCreditRules**](docs/HotelConfigAPI.md#changeupserthousekeepingcreditrules) | **Put** /upsert/hotels/{hotelId}/creditRules/{code} | Create/Change Housekeeping Credit Rules
*HotelConfigAPI* | [**ChangeUpsertRoomHierarchies**](docs/HotelConfigAPI.md#changeupsertroomhierarchies) | **Put** /upsert/roomHierarchies | Create/Change Room Hierarchies
...
*HotelConfigAPI* | [**GenerateRoomTypeDescription**](docs/HotelConfigAPI.md#generateroomtypedescription) | **Post** /roomTypes/text | Generates the room type description based on the input parameters.
...
*HotelConfigAPI* | [**GetRoomTypes**](docs/HotelConfigAPI.md#getroomtypes) | **Get** /hotels/{hotelId}/roomTypes | Get Room Types
*HotelConfigAPI* | [**GetRooms**](docs/HotelConfigAPI.md#getrooms) | **Get** /hotels/{hotelId}/rooms | Get list of hotel rooms
*HotelConfigAPI* | [**GetRoomsSummary**](docs/HotelConfigAPI.md#getroomssummary) | **Get** /roomsSummary | Get list of rooms and its summary
...
*HotelConfigAPI* | [**PostDeleteHousekeepingAttendants**](docs/HotelConfigAPI.md#postdeletehousekeepingattendants) | **Post** /hotels/{hotelId}/housekeepingAttendants/{attendantId}/deletions | Delete housekeeping attendants configuration
...
*HotelConfigAPI* | [**PostRooms**](docs/HotelConfigAPI.md#postrooms) | **Post** /hotels/{hotelId}/rooms | Create a new room
...
*HotelConfigAPI* | [**PutRoomTypeDescription**](docs/HotelConfigAPI.md#putroomtypedescription) | **Put** /roomTypes/text/{responseId} | Saves the generated room type description to improve quality of room type description generations.
...
*HotelConfigAPI* | [**PutUpsertRooms**](docs/HotelConfigAPI.md#putupsertrooms) | **Put** /upsert/hotels/{hotelId}/rooms/{roomsId} | Create/Change an existing room
...
*HotelConfigAPI* | [**SearchHousekeepingAttendants**](docs/HotelConfigAPI.md#searchhousekeepingattendants) | **Post** /hotels/{hotelId}/housekeepingAttendants/searches | Search Housekeeping Attendants
...
*HotelConfigAPI* | [**SetUpsertBuildingFloorMappings**](docs/HotelConfigAPI.md#setupsertbuildingfloormappings) | **Put** /upsert/buildingFloorMappings | Set Upsert Hotel level floor mappings to buildings
...
## Documentation For Models
 ...
 - [DeleteHousekeepingAttendantsRequest](docs/DeleteHousekeepingAttendantsRequest.md)
 ...
 - [GenerateRoomTypeDescriptionRequest](docs/GenerateRoomTypeDescriptionRequest.md)
 - [GenerateRoomTypeDescriptionResponse](docs/GenerateRoomTypeDescriptionResponse.md)
 ...
 - [SaveRoomTypeDescriptionRequest](docs/SaveRoomTypeDescriptionRequest.md)
 - [SaveRoomTypeDescriptionResponse](docs/SaveRoomTypeDescriptionResponse.md)
 - [SearchHousekeepingAttendantsRequest](docs/SearchHousekeepingAttendantsRequest.md)
