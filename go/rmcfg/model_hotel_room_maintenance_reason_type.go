...
func (o *HotelRoomMaintenanceReasonType) GetManagedBy() ManagedByOptions {
...
// and a boolean to check if the value has been set.
func (o *HotelRoomMaintenanceReasonType) GetManagedByOk() (*ManagedByOptions, bool) {
	if o == nil || IsNil(o.ManagedBy) {
		return nil, false
	}
...
func (o *HotelRoomMaintenanceReasonType) HasManagedBy() bool {
	if o != nil && !IsNil(o.ManagedBy) {
		return true
	}
...
func (o *HotelRoomMaintenanceReasonType) SetManagedBy(v ManagedByOptions) {
	o.ManagedBy = &v
}
