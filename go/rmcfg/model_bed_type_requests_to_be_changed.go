...
// checks if the BedTypeRequestsToBeChanged type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BedTypeRequestsToBeChanged{}

// BedTypeRequestsToBeChanged Request object for changing Bed Type Requests.
type BedTypeRequestsToBeChanged struct {
...
func NewBedTypeRequestsToBeChanged() *BedTypeRequestsToBeChanged {
	this := BedTypeRequestsToBeChanged{}
	return &this
}
...
func (o BedTypeRequestsToBeChanged) MarshalJSON() ([]byte, error) {
...
func (o BedTypeRequestsToBeChanged) ToMap() (map[string]interface{}, error) {
...
type NullableBedTypeRequestsToBeChanged struct {
	value *BedTypeRequestsToBeChanged
	isSet bool
}

func (v NullableBedTypeRequestsToBeChanged) Get() *BedTypeRequestsToBeChanged {
	return v.value
}

func (v *NullableBedTypeRequestsToBeChanged) Set(val *BedTypeRequestsToBeChanged) {
	v.value = val
	v.isSet = true
}

func (v NullableBedTypeRequestsToBeChanged) IsSet() bool {
	return v.isSet
}

func (v *NullableBedTypeRequestsToBeChanged) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBedTypeRequestsToBeChanged(val *BedTypeRequestsToBeChanged) *NullableBedTypeRequestsToBeChanged {
	return &NullableBedTypeRequestsToBeChanged{value: val, isSet: true}
}

func (v NullableBedTypeRequestsToBeChanged) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBedTypeRequestsToBeChanged) UnmarshalJSON(src []byte) error {
	v.isSet = true
