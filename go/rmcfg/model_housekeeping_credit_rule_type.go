...
func (o *HousekeepingCreditRuleType) GetManagedBy() ManagedByOptions {
...
// and a boolean to check if the value has been set.
func (o *HousekeepingCreditRuleType) GetManagedByOk() (*ManagedByOptions, bool) {
	if o == nil || IsNil(o.ManagedBy) {
		return nil, false
	}
...
func (o *HousekeepingCreditRuleType) HasManagedBy() bool {
	if o != nil && !IsNil(o.ManagedBy) {
		return true
	}
...
func (o *HousekeepingCreditRuleType) SetManagedBy(v ManagedByOptions) {
	o.ManagedBy = &v
}
