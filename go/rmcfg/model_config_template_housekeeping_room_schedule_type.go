...
func (o *ConfigTemplateHousekeepingRoomScheduleType) GetManagedBy() ManagedByOptions {
...
// and a boolean to check if the value has been set.
func (o *ConfigTemplateHousekeepingRoomScheduleType) GetManagedByOk() (*ManagedByOptions, bool) {
	if o == nil || IsNil(o.ManagedBy) {
		return nil, false
	}
...
func (o *ConfigTemplateHousekeepingRoomScheduleType) HasManagedBy() bool {
	if o != nil && !IsNil(o.ManagedBy) {
		return true
	}
...
func (o *ConfigTemplateHousekeepingRoomScheduleType) SetManagedBy(v ManagedByOptions) {
	o.ManagedBy = &v
}
