...
type HousekeepingType struct {
	...
	// Indicates if this room has been completed. A room is complete when it reaches the highest available Room Status.
	RoomCompleted *bool `json:"roomCompleted,omitempty"`
}
...
// GetRoomCompleted returns the RoomCompleted field value if set, zero value otherwise.
func (o *HousekeepingType) GetRoomCompleted() bool {
	if o == nil || IsNil(o.RoomCompleted) {
		var ret bool
		return ret
	}
	return *o.RoomCompleted
}

// GetRoomCompletedOk returns a tuple with the RoomCompleted field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *HousekeepingType) GetRoomCompletedOk() (*bool, bool) {
	if o == nil || IsNil(o.RoomCompleted) {
		return nil, false
	}
	return o.RoomCompleted, true
}

// HasRoomCompleted returns a boolean if a field has been set.
func (o *HousekeepingType) HasRoomCompleted() bool {
	if o != nil && !IsNil(o.RoomCompleted) {
		return true
	}
...
// SetRoomCompleted gets a reference to the given bool and assigns it to the RoomCompleted field.
func (o *HousekeepingType) SetRoomCompleted(v bool) {
	o.RoomCompleted = &v
}
...
func (o HousekeepingType) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.RoomCompleted) {
		toSerialize["roomCompleted"] = o.RoomCompleted
	}
