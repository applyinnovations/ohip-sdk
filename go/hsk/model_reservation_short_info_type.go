...
func (o *ReservationShortInfoType) GetQueue() ReservationQueueInformationType {
...
// and a boolean to check if the value has been set.
func (o *ReservationShortInfoType) GetQueueOk() (*ReservationQueueInformationType, bool) {
	if o == nil || IsNil(o.Queue) {
		return nil, false
	}
	return o.Queue, true
...
func (o *ReservationShortInfoType) HasQueue() bool {
	if o != nil && !IsNil(o.Queue) {
		return true
	}
...
func (o *ReservationShortInfoType) SetQueue(v ReservationQueueInformationType) {
	o.Queue = &v
}
