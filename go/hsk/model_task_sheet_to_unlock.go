...
// checks if the TaskSheetToUnlock type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TaskSheetToUnlock{}

// TaskSheetToUnlock Request for unlocking a task sheet.
type TaskSheetToUnlock struct {
...
func (o TaskSheetToUnlock) MarshalJSON() ([]byte, error) {
...
func (o TaskSheetToUnlock) ToMap() (map[string]interface{}, error) {
...
type NullableTaskSheetToUnlock struct {
	value *TaskSheetToUnlock
	isSet bool
}

func (v NullableTaskSheetToUnlock) Get() *TaskSheetToUnlock {
	return v.value
}

func (v *NullableTaskSheetToUnlock) Set(val *TaskSheetToUnlock) {
	v.value = val
	v.isSet = true
}

func (v NullableTaskSheetToUnlock) IsSet() bool {
	return v.isSet
}

func (v *NullableTaskSheetToUnlock) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTaskSheetToUnlock(val *TaskSheetToUnlock) *NullableTaskSheetToUnlock {
	return &NullableTaskSheetToUnlock{value: val, isSet: true}
}

func (v NullableTaskSheetToUnlock) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTaskSheetToUnlock) UnmarshalJSON(src []byte) error {
	v.isSet = true
