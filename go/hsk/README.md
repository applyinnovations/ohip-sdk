...
```golang
import hsk "github.com/applyinnovations/ohip-sdk/go/hsk/v3"
```
...
*HousekeepingAPI* | [**CompleteTaskSheet**](docs/HousekeepingAPI.md#completetasksheet) | **Put** /hotels/{hotelId}/taskSheet/{taskSequenceNumber}/complete | Complete a task sheet
*HousekeepingAPI* | [**CompleteTaskSheetSet**](docs/HousekeepingAPI.md#completetasksheetset) | **Put** /hotels/{hotelId}/taskSheetSet/{taskCodesBreakOutId}/complete | Complete all the hotel&#39;s task sheets for an existing Task Sheet Set.
...
*HousekeepingAPI* | [**PingHouseKeepingService**](docs/HousekeepingAPI.md#pinghousekeepingservice) | **Get** /services/houseKeeping/status |  ping the house keeping service
...
*HousekeepingAPI* | [**ReopenTaskSheet**](docs/HousekeepingAPI.md#reopentasksheet) | **Put** /hotels/{hotelId}/taskSheet/{taskSequenceNumber}/reopen | Reopen a task sheet
*HousekeepingAPI* | [**ReopenTaskSheetSet**](docs/HousekeepingAPI.md#reopentasksheetset) | **Put** /hotels/{hotelId}/taskSheetSet/{taskCodesBreakOutId}/reopen | Reopen all the hotel&#39;s task sheets for an existing Task Sheet Set.
...
## Documentation For Models
 ...
 - [MaintenanceCountType](docs/MaintenanceCountType.md)
 ...
 - [RoomPersonsCountType](docs/RoomPersonsCountType.md)
