...
type HousekeepingRoomStatusCriteria struct {
	...
	RoomPersons *RoomPersonsCountType `json:"roomPersons,omitempty"`
...
func (o *HousekeepingRoomStatusCriteria) GetRoomPersons() RoomPersonsCountType {
	if o == nil || IsNil(o.RoomPersons) {
		var ret RoomPersonsCountType
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *HousekeepingRoomStatusCriteria) GetRoomPersonsOk() (*RoomPersonsCountType, bool) {
	if o == nil || IsNil(o.RoomPersons) {
		return nil, false
	}
...
func (o *HousekeepingRoomStatusCriteria) HasRoomPersons() bool {
	if o != nil && !IsNil(o.RoomPersons) {
		return true
	}
...
// SetRoomPersons gets a reference to the given RoomPersonsCountType and assigns it to the RoomPersons field.
func (o *HousekeepingRoomStatusCriteria) SetRoomPersons(v RoomPersonsCountType) {
	o.RoomPersons = &v
}
