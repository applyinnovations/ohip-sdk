...
// checks if the ScheduleShiftRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ScheduleShiftRequest{}

// ScheduleShiftRequest Request with the information needed for the shift of the schedule.
...
func (o ScheduleShiftRequest) MarshalJSON() ([]byte, error) {
...
func (o ScheduleShiftRequest) ToMap() (map[string]interface{}, error) {
...
type NullableScheduleShiftRequest struct {
	value *ScheduleShiftRequest
	isSet bool
}

func (v NullableScheduleShiftRequest) Get() *ScheduleShiftRequest {
	return v.value
}

func (v *NullableScheduleShiftRequest) Set(val *ScheduleShiftRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableScheduleShiftRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableScheduleShiftRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableScheduleShiftRequest(val *ScheduleShiftRequest) *NullableScheduleShiftRequest {
	return &NullableScheduleShiftRequest{value: val, isSet: true}
}

func (v NullableScheduleShiftRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableScheduleShiftRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
