...
func (o *PutRoomRelatedStatusRequest) GetRoomPersons() RoomPersonsCountType {
...
// and a boolean to check if the value has been set.
func (o *PutRoomRelatedStatusRequest) GetRoomPersonsOk() (*RoomPersonsCountType, bool) {
	if o == nil || IsNil(o.RoomPersons) {
		return nil, false
	}
...
func (o *PutRoomRelatedStatusRequest) HasRoomPersons() bool {
	if o != nil && !IsNil(o.RoomPersons) {
		return true
	}
...
func (o *PutRoomRelatedStatusRequest) SetRoomPersons(v RoomPersonsCountType) {
	o.RoomPersons = &v
}
