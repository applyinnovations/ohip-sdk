...
type ServiceTaskRoomType struct {
	...
	// When set to true, the current Guest Service Status (Do Not Disturb, Service Declined, Make Up Room) will be removed and set to No Status Selected. This element is available when the Guest Service Status OPERA Control is active.
	RemoveGuestServiceStatus *bool `json:"removeGuestServiceStatus,omitempty"`
}
...
// GetRemoveGuestServiceStatus returns the RemoveGuestServiceStatus field value if set, zero value otherwise.
func (o *ServiceTaskRoomType) GetRemoveGuestServiceStatus() bool {
	if o == nil || IsNil(o.RemoveGuestServiceStatus) {
		var ret bool
		return ret
	}
	return *o.RemoveGuestServiceStatus
}

// GetRemoveGuestServiceStatusOk returns a tuple with the RemoveGuestServiceStatus field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ServiceTaskRoomType) GetRemoveGuestServiceStatusOk() (*bool, bool) {
	if o == nil || IsNil(o.RemoveGuestServiceStatus) {
		return nil, false
	}
	return o.RemoveGuestServiceStatus, true
}

// HasRemoveGuestServiceStatus returns a boolean if a field has been set.
func (o *ServiceTaskRoomType) HasRemoveGuestServiceStatus() bool {
	if o != nil && !IsNil(o.RemoveGuestServiceStatus) {
		return true
	}
...
// SetRemoveGuestServiceStatus gets a reference to the given bool and assigns it to the RemoveGuestServiceStatus field.
func (o *ServiceTaskRoomType) SetRemoveGuestServiceStatus(v bool) {
	o.RemoveGuestServiceStatus = &v
}
...
func (o ServiceTaskRoomType) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.RemoveGuestServiceStatus) {
		toSerialize["removeGuestServiceStatus"] = o.RemoveGuestServiceStatus
	}
