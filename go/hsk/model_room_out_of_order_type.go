...
type RoomOutOfOrderType struct {
	...
	RoomRepairId *UniqueIDType `json:"roomRepairId,omitempty"`
}
...
func (o *RoomOutOfOrderType) GetEndTime() string {
...
// and a boolean to check if the value has been set.
func (o *RoomOutOfOrderType) GetEndTimeOk() (*string, bool) {
	if o == nil || IsNil(o.EndTime) {
		return nil, false
	}
...
func (o *RoomOutOfOrderType) HasEndTime() bool {
	if o != nil && !IsNil(o.EndTime) {
		return true
	}
...
func (o *RoomOutOfOrderType) SetEndTime(v string) {
	o.EndTime = &v
}

// GetRoomRepairId returns the RoomRepairId field value if set, zero value otherwise.
func (o *RoomOutOfOrderType) GetRoomRepairId() UniqueIDType {
	if o == nil || IsNil(o.RoomRepairId) {
		var ret UniqueIDType
		return ret
	}
	return *o.RoomRepairId
}

// GetRoomRepairIdOk returns a tuple with the RoomRepairId field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *RoomOutOfOrderType) GetRoomRepairIdOk() (*UniqueIDType, bool) {
	if o == nil || IsNil(o.RoomRepairId) {
		return nil, false
	}
	return o.RoomRepairId, true
}

// HasRoomRepairId returns a boolean if a field has been set.
func (o *RoomOutOfOrderType) HasRoomRepairId() bool {
	if o != nil && !IsNil(o.RoomRepairId) {
		return true
	}
...
// SetRoomRepairId gets a reference to the given UniqueIDType and assigns it to the RoomRepairId field.
func (o *RoomOutOfOrderType) SetRoomRepairId(v UniqueIDType) {
	o.RoomRepairId = &v
}
...
func (o RoomOutOfOrderType) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.RoomRepairId) {
		toSerialize["roomRepairId"] = o.RoomRepairId
	}
