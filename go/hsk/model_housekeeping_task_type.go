...
func (o *HousekeepingTaskType) GetCompletedRoomsCount() int32 {
...
// and a boolean to check if the value has been set.
func (o *HousekeepingTaskType) GetCompletedRoomsCountOk() (*int32, bool) {
	if o == nil || IsNil(o.CompletedRoomsCount) {
		return nil, false
	}
...
func (o *HousekeepingTaskType) HasCompletedRoomsCount() bool {
	if o != nil && !IsNil(o.CompletedRoomsCount) {
		return true
	}
...
func (o *HousekeepingTaskType) SetCompletedRoomsCount(v int32) {
