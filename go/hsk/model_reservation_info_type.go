...
type ReservationInfoType struct {
	...
	// Time stamp of the creation. Uses database time zone.
	...
	// Time stamp of last modification. Uses database time zone.
	...
	// Indicates if the Reservation is Back to Back Reservation. Available when the Back to Back Handling for Linked Reservations OPERA Control is active. 
	BackToBack *bool `json:"backToBack,omitempty"`
	// Indicates if the Reservation is departing today with a Back to Back Reservation arriving today. Available when the Back to Back Handling for Linked Reservations OPERA Control is active.
	BackToBackHSKIndicator *bool `json:"backToBackHSKIndicator,omitempty"`
...
// GetBackToBackHSKIndicator returns the BackToBackHSKIndicator field value if set, zero value otherwise.
func (o *ReservationInfoType) GetBackToBackHSKIndicator() bool {
	if o == nil || IsNil(o.BackToBackHSKIndicator) {
		var ret bool
		return ret
	}
	return *o.BackToBackHSKIndicator
}

// GetBackToBackHSKIndicatorOk returns a tuple with the BackToBackHSKIndicator field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ReservationInfoType) GetBackToBackHSKIndicatorOk() (*bool, bool) {
	if o == nil || IsNil(o.BackToBackHSKIndicator) {
		return nil, false
	}
	return o.BackToBackHSKIndicator, true
}
...
// SetBackToBackHSKIndicator gets a reference to the given bool and assigns it to the BackToBackHSKIndicator field.
func (o *ReservationInfoType) SetBackToBackHSKIndicator(v bool) {
	o.BackToBackHSKIndicator = &v
}
...
func (o ReservationInfoType) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.BackToBackHSKIndicator) {
		toSerialize["backToBackHSKIndicator"] = o.BackToBackHSKIndicator
	}
