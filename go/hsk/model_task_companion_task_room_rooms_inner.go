...
type TaskCompanionTaskRoomRoomsInner struct {
	...
	Maintenance *MaintenanceCountType `json:"maintenance,omitempty"`
...
func (o *TaskCompanionTaskRoomRoomsInner) GetMaintenance() MaintenanceCountType {
	if o == nil || IsNil(o.Maintenance) {
		var ret MaintenanceCountType
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *TaskCompanionTaskRoomRoomsInner) GetMaintenanceOk() (*MaintenanceCountType, bool) {
	if o == nil || IsNil(o.Maintenance) {
		return nil, false
	}
...
func (o *TaskCompanionTaskRoomRoomsInner) HasMaintenance() bool {
	if o != nil && !IsNil(o.Maintenance) {
		return true
	}
...
// SetMaintenance gets a reference to the given MaintenanceCountType and assigns it to the Maintenance field.
func (o *TaskCompanionTaskRoomRoomsInner) SetMaintenance(v MaintenanceCountType) {
	o.Maintenance = &v
}
