...
type RoomMaintenanceType struct {
	...
	// Number of Maintenance images linked to the record.
...
func (o *RoomMaintenanceType) GetImageCount() int32 {
...
// and a boolean to check if the value has been set.
func (o *RoomMaintenanceType) GetImageCountOk() (*int32, bool) {
	if o == nil || IsNil(o.ImageCount) {
		return nil, false
	}
...
func (o *RoomMaintenanceType) HasImageCount() bool {
	if o != nil && !IsNil(o.ImageCount) {
		return true
	}
...
func (o *RoomMaintenanceType) SetImageCount(v int32) {
	o.ImageCount = &v
}
