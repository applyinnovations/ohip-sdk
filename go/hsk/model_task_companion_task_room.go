...
type TaskCompanionTaskRoom struct {
	...
	// The total number of completed rooms in this task sheet.
	CompletedRoomsCount *int32 `json:"completedRoomsCount,omitempty"`
}
...
func (o *TaskCompanionTaskRoom) GetTotalPages() int32 {
...
// and a boolean to check if the value has been set.
func (o *TaskCompanionTaskRoom) GetTotalPagesOk() (*int32, bool) {
	if o == nil || IsNil(o.TotalPages) {
		return nil, false
	}
...
func (o *TaskCompanionTaskRoom) HasTotalPages() bool {
	if o != nil && !IsNil(o.TotalPages) {
		return true
	}
...
func (o *TaskCompanionTaskRoom) SetTotalPages(v int32) {
	o.TotalPages = &v
}

// GetOffset returns the Offset field value if set, zero value otherwise.
func (o *TaskCompanionTaskRoom) GetOffset() int32 {
...
// and a boolean to check if the value has been set.
func (o *TaskCompanionTaskRoom) GetOffsetOk() (*int32, bool) {
	if o == nil || IsNil(o.Offset) {
		return nil, false
	}
...
func (o *TaskCompanionTaskRoom) HasOffset() bool {
	if o != nil && !IsNil(o.Offset) {
		return true
	}
...
func (o *TaskCompanionTaskRoom) SetOffset(v int32) {
	o.Offset = &v
}

// GetLimit returns the Limit field value if set, zero value otherwise.
func (o *TaskCompanionTaskRoom) GetLimit() int32 {
...
// and a boolean to check if the value has been set.
func (o *TaskCompanionTaskRoom) GetLimitOk() (*int32, bool) {
	if o == nil || IsNil(o.Limit) {
		return nil, false
	}
	return o.Limit, true
...
func (o *TaskCompanionTaskRoom) HasLimit() bool {
	if o != nil && !IsNil(o.Limit) {
		return true
	}
...
func (o *TaskCompanionTaskRoom) SetLimit(v int32) {
	o.Limit = &v
}

// GetHasMore returns the HasMore field value if set, zero value otherwise.
func (o *TaskCompanionTaskRoom) GetHasMore() bool {
...
// and a boolean to check if the value has been set.
func (o *TaskCompanionTaskRoom) GetHasMoreOk() (*bool, bool) {
	if o == nil || IsNil(o.HasMore) {
		return nil, false
	}
...
func (o *TaskCompanionTaskRoom) HasHasMore() bool {
	if o != nil && !IsNil(o.HasMore) {
		return true
	}
...
func (o *TaskCompanionTaskRoom) SetHasMore(v bool) {
	o.HasMore = &v
}

// GetTotalResults returns the TotalResults field value if set, zero value otherwise.
func (o *TaskCompanionTaskRoom) GetTotalResults() int32 {
...
// and a boolean to check if the value has been set.
func (o *TaskCompanionTaskRoom) GetTotalResultsOk() (*int32, bool) {
	if o == nil || IsNil(o.TotalResults) {
		return nil, false
	}
...
func (o *TaskCompanionTaskRoom) HasTotalResults() bool {
	if o != nil && !IsNil(o.TotalResults) {
		return true
	}
...
func (o *TaskCompanionTaskRoom) SetTotalResults(v int32) {
	o.TotalResults = &v
}

// GetCount returns the Count field value if set, zero value otherwise.
func (o *TaskCompanionTaskRoom) GetCount() int32 {
...
// and a boolean to check if the value has been set.
func (o *TaskCompanionTaskRoom) GetCountOk() (*int32, bool) {
	if o == nil || IsNil(o.Count) {
		return nil, false
	}
	return o.Count, true
...
func (o *TaskCompanionTaskRoom) HasCount() bool {
	if o != nil && !IsNil(o.Count) {
		return true
	}
...
func (o *TaskCompanionTaskRoom) SetCount(v int32) {
	o.Count = &v
}
...
// GetCompletedRoomsCount returns the CompletedRoomsCount field value if set, zero value otherwise.
func (o *TaskCompanionTaskRoom) GetCompletedRoomsCount() int32 {
	if o == nil || IsNil(o.CompletedRoomsCount) {
		var ret int32
		return ret
	}
	return *o.CompletedRoomsCount
}

// GetCompletedRoomsCountOk returns a tuple with the CompletedRoomsCount field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *TaskCompanionTaskRoom) GetCompletedRoomsCountOk() (*int32, bool) {
	if o == nil || IsNil(o.CompletedRoomsCount) {
		return nil, false
	}
	return o.CompletedRoomsCount, true
}

// HasCompletedRoomsCount returns a boolean if a field has been set.
func (o *TaskCompanionTaskRoom) HasCompletedRoomsCount() bool {
	if o != nil && !IsNil(o.CompletedRoomsCount) {
		return true
	}
...
// SetCompletedRoomsCount gets a reference to the given int32 and assigns it to the CompletedRoomsCount field.
func (o *TaskCompanionTaskRoom) SetCompletedRoomsCount(v int32) {
	o.CompletedRoomsCount = &v
}
...
func (o TaskCompanionTaskRoom) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.CompletedRoomsCount) {
		toSerialize["completedRoomsCount"] = o.CompletedRoomsCount
	}
