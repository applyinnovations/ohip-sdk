...
// checks if the CompleteOutOfOrderRoomsRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CompleteOutOfOrderRoomsRequest{}

// CompleteOutOfOrderRoomsRequest struct for CompleteOutOfOrderRoomsRequest
type CompleteOutOfOrderRoomsRequest struct {
...
func NewCompleteOutOfOrderRoomsRequest() *CompleteOutOfOrderRoomsRequest {
	this := CompleteOutOfOrderRoomsRequest{}
	return &this
}
...
func (o CompleteOutOfOrderRoomsRequest) MarshalJSON() ([]byte, error) {
...
func (o CompleteOutOfOrderRoomsRequest) ToMap() (map[string]interface{}, error) {
...
type NullableCompleteOutOfOrderRoomsRequest struct {
	value *CompleteOutOfOrderRoomsRequest
	isSet bool
}

func (v NullableCompleteOutOfOrderRoomsRequest) Get() *CompleteOutOfOrderRoomsRequest {
	return v.value
}

func (v *NullableCompleteOutOfOrderRoomsRequest) Set(val *CompleteOutOfOrderRoomsRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableCompleteOutOfOrderRoomsRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableCompleteOutOfOrderRoomsRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCompleteOutOfOrderRoomsRequest(val *CompleteOutOfOrderRoomsRequest) *NullableCompleteOutOfOrderRoomsRequest {
	return &NullableCompleteOutOfOrderRoomsRequest{value: val, isSet: true}
}

func (v NullableCompleteOutOfOrderRoomsRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCompleteOutOfOrderRoomsRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
