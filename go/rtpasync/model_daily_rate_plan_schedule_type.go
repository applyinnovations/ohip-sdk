...
type DailyRatePlanScheduleType struct {
	...
	// The start date for the range for which the daily rate amounts will be applied.
	RateDateRangeStart *string `json:"rateDateRangeStart,omitempty"`
	// The end date for the range for which the daily rate amounts will be applied.
	RateDateRangeEnd *string `json:"rateDateRangeEnd,omitempty"`
...
// GetRateDateRangeStart returns the RateDateRangeStart field value if set, zero value otherwise.
func (o *DailyRatePlanScheduleType) GetRateDateRangeStart() string {
	if o == nil || IsNil(o.RateDateRangeStart) {
		var ret string
		return ret
	}
	return *o.RateDateRangeStart
}

// GetRateDateRangeStartOk returns a tuple with the RateDateRangeStart field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *DailyRatePlanScheduleType) GetRateDateRangeStartOk() (*string, bool) {
	if o == nil || IsNil(o.RateDateRangeStart) {
		return nil, false
	}
	return o.RateDateRangeStart, true
}

// HasRateDateRangeStart returns a boolean if a field has been set.
func (o *DailyRatePlanScheduleType) HasRateDateRangeStart() bool {
	if o != nil && !IsNil(o.RateDateRangeStart) {
		return true
	}
...
// SetRateDateRangeStart gets a reference to the given string and assigns it to the RateDateRangeStart field.
func (o *DailyRatePlanScheduleType) SetRateDateRangeStart(v string) {
	o.RateDateRangeStart = &v
}

// GetRateDateRangeEnd returns the RateDateRangeEnd field value if set, zero value otherwise.
func (o *DailyRatePlanScheduleType) GetRateDateRangeEnd() string {
	if o == nil || IsNil(o.RateDateRangeEnd) {
		var ret string
		return ret
	}
	return *o.RateDateRangeEnd
}

// GetRateDateRangeEndOk returns a tuple with the RateDateRangeEnd field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *DailyRatePlanScheduleType) GetRateDateRangeEndOk() (*string, bool) {
	if o == nil || IsNil(o.RateDateRangeEnd) {
		return nil, false
	}
	return o.RateDateRangeEnd, true
}

// HasRateDateRangeEnd returns a boolean if a field has been set.
func (o *DailyRatePlanScheduleType) HasRateDateRangeEnd() bool {
	if o != nil && !IsNil(o.RateDateRangeEnd) {
		return true
	}
...
// SetRateDateRangeEnd gets a reference to the given string and assigns it to the RateDateRangeEnd field.
func (o *DailyRatePlanScheduleType) SetRateDateRangeEnd(v string) {
	o.RateDateRangeEnd = &v
}
...
func (o DailyRatePlanScheduleType) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.RateDateRangeStart) {
		toSerialize["rateDateRangeStart"] = o.RateDateRangeStart
	}
	if !IsNil(o.RateDateRangeEnd) {
		toSerialize["rateDateRangeEnd"] = o.RateDateRangeEnd
	}
