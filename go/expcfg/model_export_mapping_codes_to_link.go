...
// checks if the ExportMappingCodesToLink type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ExportMappingCodesToLink{}

// ExportMappingCodesToLink struct for ExportMappingCodesToLink
type ExportMappingCodesToLink struct {
	// The codes for a given property which are to be linked to the mapping code.
	CodesToLink []ExportMappingCodesToLinkType `json:"codesToLink,omitempty"`
...
// GetCodesToLink returns the CodesToLink field value if set, zero value otherwise.
func (o *ExportMappingCodesToLink) GetCodesToLink() []ExportMappingCodesToLinkType {
	if o == nil || IsNil(o.CodesToLink) {
		var ret []ExportMappingCodesToLinkType
		return ret
	}
	return o.CodesToLink
}

// GetCodesToLinkOk returns a tuple with the CodesToLink field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ExportMappingCodesToLink) GetCodesToLinkOk() ([]ExportMappingCodesToLinkType, bool) {
	if o == nil || IsNil(o.CodesToLink) {
		return nil, false
	}
	return o.CodesToLink, true
}
...
// SetCodesToLink gets a reference to the given []ExportMappingCodesToLinkType and assigns it to the CodesToLink field.
...
func (o ExportMappingCodesToLink) MarshalJSON() ([]byte, error) {
...
func (o ExportMappingCodesToLink) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.CodesToLink) {
		toSerialize["codesToLink"] = o.CodesToLink
	}
...
type NullableExportMappingCodesToLink struct {
	value *ExportMappingCodesToLink
	isSet bool
}

func (v NullableExportMappingCodesToLink) Get() *ExportMappingCodesToLink {
	return v.value
}

func (v *NullableExportMappingCodesToLink) Set(val *ExportMappingCodesToLink) {
	v.value = val
	v.isSet = true
}

func (v NullableExportMappingCodesToLink) IsSet() bool {
	return v.isSet
}

func (v *NullableExportMappingCodesToLink) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableExportMappingCodesToLink(val *ExportMappingCodesToLink) *NullableExportMappingCodesToLink {
	return &NullableExportMappingCodesToLink{value: val, isSet: true}
}

func (v NullableExportMappingCodesToLink) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableExportMappingCodesToLink) UnmarshalJSON(src []byte) error {
	v.isSet = true
