...
```golang
import expcfg "github.com/applyinnovations/ohip-sdk/go/expcfg/v3"
```
...
*ExportAPI* | [**PingExportServices**](docs/ExportAPI.md#pingexportservices) | **Get** /services/export/status | Operation to ping.
