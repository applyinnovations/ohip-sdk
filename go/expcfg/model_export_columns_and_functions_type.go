...
type ExportColumnsAndFunctionsType struct {
	// Function parameters
	DbColumns []ExpDataSourceColumnType `json:"dbColumns,omitempty"`
	// Function parameters
	PrePostFunctions []ExpFunctionType `json:"prePostFunctions,omitempty"`
	// Function parameters
	Functions []ExpFunctionType `json:"functions,omitempty"`
}
...
func (o *ExportColumnsAndFunctionsType) GetDbColumns() []ExpDataSourceColumnType {
	if o == nil || IsNil(o.DbColumns) {
		var ret []ExpDataSourceColumnType
		return ret
	}
	return o.DbColumns
}
...
// SetDbColumns gets a reference to the given []ExpDataSourceColumnType and assigns it to the DbColumns field.
...
// SetPrePostFunctions gets a reference to the given []ExpFunctionType and assigns it to the PrePostFunctions field.
...
// SetFunctions gets a reference to the given []ExpFunctionType and assigns it to the Functions field.
