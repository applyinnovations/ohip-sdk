...
type ReservationDailySummaryType struct {
	// Hotel code for the reservation
	...
	ResvStatus *DatabaseResStatusType `json:"resvStatus,omitempty"`
	...
	SharersResvIdList *string `json:"sharersResvIdList,omitempty"`
	...
	CreatedHotelDateTime *string `json:"createdHotelDateTime,omitempty"`
	...
	ModifiedHotelDateTime *string `json:"modifiedHotelDateTime,omitempty"`
}
...
func (o *ReservationDailySummaryType) GetHotelId() string {
...
func (o *ReservationDailySummaryType) GetHotelIdOk() (*string, bool) {
	if o == nil || IsNil(o.HotelId) {
		return nil, false
	}
...
func (o *ReservationDailySummaryType) HasHotelId() bool {
	if o != nil && !IsNil(o.HotelId) {
		return true
	}
...
func (o *ReservationDailySummaryType) SetHotelId(v string) {
	o.HotelId = &v
}
...
// SetResvStatus gets a reference to the given DatabaseResStatusType and assigns it to the ResvStatus field.
...
// GetSharersResvIdList returns the SharersResvIdList field value if set, zero value otherwise.
func (o *ReservationDailySummaryType) GetSharersResvIdList() string {
	if o == nil || IsNil(o.SharersResvIdList) {
		var ret string
		return ret
	}
	return *o.SharersResvIdList
}

// GetSharersResvIdListOk returns a tuple with the SharersResvIdList field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ReservationDailySummaryType) GetSharersResvIdListOk() (*string, bool) {
	if o == nil || IsNil(o.SharersResvIdList) {
		return nil, false
	}
	return o.SharersResvIdList, true
}
...
// SetSharersResvIdList gets a reference to the given string and assigns it to the SharersResvIdList field.
func (o *ReservationDailySummaryType) SetSharersResvIdList(v string) {
	o.SharersResvIdList = &v
}
...
// GetCreatedHotelDateTime returns the CreatedHotelDateTime field value if set, zero value otherwise.
func (o *ReservationDailySummaryType) GetCreatedHotelDateTime() string {
	if o == nil || IsNil(o.CreatedHotelDateTime) {
		var ret string
		return ret
	}
	return *o.CreatedHotelDateTime
}

// GetCreatedHotelDateTimeOk returns a tuple with the CreatedHotelDateTime field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ReservationDailySummaryType) GetCreatedHotelDateTimeOk() (*string, bool) {
	if o == nil || IsNil(o.CreatedHotelDateTime) {
		return nil, false
	}
	return o.CreatedHotelDateTime, true
}
...
// SetCreatedHotelDateTime gets a reference to the given string and assigns it to the CreatedHotelDateTime field.
func (o *ReservationDailySummaryType) SetCreatedHotelDateTime(v string) {
	o.CreatedHotelDateTime = &v
}

// GetModifiedHotelDateTime returns the ModifiedHotelDateTime field value if set, zero value otherwise.
func (o *ReservationDailySummaryType) GetModifiedHotelDateTime() string {
	if o == nil || IsNil(o.ModifiedHotelDateTime) {
		var ret string
		return ret
	}
	return *o.ModifiedHotelDateTime
}

// GetModifiedHotelDateTimeOk returns a tuple with the ModifiedHotelDateTime field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ReservationDailySummaryType) GetModifiedHotelDateTimeOk() (*string, bool) {
	if o == nil || IsNil(o.ModifiedHotelDateTime) {
		return nil, false
	}
	return o.ModifiedHotelDateTime, true
}
...
// SetModifiedHotelDateTime gets a reference to the given string and assigns it to the ModifiedHotelDateTime field.
func (o *ReservationDailySummaryType) SetModifiedHotelDateTime(v string) {
	o.ModifiedHotelDateTime = &v
}
...
func (o ReservationDailySummaryType) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.SharersResvIdList) {
		toSerialize["sharersResvIdList"] = o.SharersResvIdList
	}
	if !IsNil(o.Arrival) {
	...
	if !IsNil(o.CreatedHotelDateTime) {
		toSerialize["createdHotelDateTime"] = o.CreatedHotelDateTime
	}
	if !IsNil(o.ModifiedHotelDateTime) {
		toSerialize["modifiedHotelDateTime"] = o.ModifiedHotelDateTime
	}
