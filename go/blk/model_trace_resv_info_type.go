...
func (o *TraceResvInfoType) GetTraceFrequency() TraceFrequencyType {
...
// and a boolean to check if the value has been set.
func (o *TraceResvInfoType) GetTraceFrequencyOk() (*TraceFrequencyType, bool) {
	if o == nil || IsNil(o.TraceFrequency) {
		return nil, false
	}
...
func (o *TraceResvInfoType) HasTraceFrequency() bool {
	if o != nil && !IsNil(o.TraceFrequency) {
		return true
	}
...
func (o *TraceResvInfoType) SetTraceFrequency(v TraceFrequencyType) {
	o.TraceFrequency = &v
}
