...
// APIClient manages communication with the OPERA Cloud Block API API v26.2.0.0
...
type APIClient struct {
	...
	BlockExternalAPI *BlockExternalAPIService
...
func NewAPIClient(cfg *Configuration) *APIClient {
	...
	c.BlockExternalAPI = (*BlockExternalAPIService)(&c.common)
