...
type BookingStatusType struct {
	...
	// Flag that indicates if there are return to inventory status blocks, sub-blocks or reservations.
...
func (o *BookingStatusType) GetReturnToInventory() bool {
...
// and a boolean to check if the value has been set.
func (o *BookingStatusType) GetReturnToInventoryOk() (*bool, bool) {
	if o == nil || IsNil(o.ReturnToInventory) {
		return nil, false
	}
...
func (o *BookingStatusType) HasReturnToInventory() bool {
	if o != nil && !IsNil(o.ReturnToInventory) {
		return true
	}
...
func (o *BookingStatusType) SetReturnToInventory(v bool) {
