...
```golang
import blk "github.com/applyinnovations/ohip-sdk/go/blk/v3"
```
...
*BlockAPI* | [**GetBlockDailyRevenue**](docs/BlockAPI.md#getblockdailyrevenue) | **Get** /hotels/{hotelId}/blockDailyRevenue | Get Block Revenue for a given date.
...
*BlockAPI* | [**GetBlockExchangeInterfaces**](docs/BlockAPI.md#getblockexchangeinterfaces) | **Get** /hotels/{hotelId}/blocks/{blockId}/exchangeInterfaces | Get exchange interfaces from business block
...
*BlockAPI* | [**GetCentralSalesHotels**](docs/BlockAPI.md#getcentralsaleshotels) | **Get** /centralSalesHotels | Get Central Sales Hotels
...
*BlockAPI* | [**PutRegularToSubAllocation**](docs/BlockAPI.md#putregulartosuballocation) | **Put** /hotels/{hotelId}/blocks/{blockId}/regularToSubAllocation/{masterAllocationId} | Convert a regular business block to a sub allocation under a master allocation in the same property.
*BlockAPI* | [**PutRegularToSubTour**](docs/BlockAPI.md#putregulartosubtour) | **Put** /hotels/{hotelId}/blocks/{blockId}/regularToSubTour/tourHotels/{masterTourHotelId}/tours/{masterTourId} | Convert a regular block to a sub tour or sub itinerary under a master tour or master itinerary.
...
*BlockAPI* | [**PutTourSeriesValidate**](docs/BlockAPI.md#puttourseriesvalidate) | **Put** /blocks/{blockId}/tourSeries/validate | Validate Block tour series
...
*BlockAPI* | [**SearchBlocks**](docs/BlockAPI.md#searchblocks) | **Post** /blocks/searches | Search Blocks
*BlockAPI* | [**SetBlockExchangeInterfaces**](docs/BlockAPI.md#setblockexchangeinterfaces) | **Put** /hotels/{hotelId}/blocks/{blockId}/exchangeInterfaces | Set exchange interfaces for business block
*BlockExternalAPI* | [**PingBlockExternalServiceStatus**](docs/BlockExternalAPI.md#pingblockexternalservicestatus) | **Get** /services/blockExternal/status | Ping the Block service 
...
## Documentation For Models
 ...
 - [AccessRestrictionEnum](docs/AccessRestrictionEnum.md)
 ...
 - [HotelConfigDetails](docs/HotelConfigDetails.md)
 ...
 - [RoomAllocationCriteriaEnum](docs/RoomAllocationCriteriaEnum.md)
 ...
 - [SearchBlocksRequest](docs/SearchBlocksRequest.md)
