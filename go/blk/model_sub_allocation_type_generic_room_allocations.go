...
// checks if the SubAllocationTypeGenericRoomAllocations type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SubAllocationTypeGenericRoomAllocations{}

// SubAllocationTypeGenericRoomAllocations Generic Room Type Allocations for the Block.
type SubAllocationTypeGenericRoomAllocations struct {
...
func NewSubAllocationTypeGenericRoomAllocations() *SubAllocationTypeGenericRoomAllocations {
	this := SubAllocationTypeGenericRoomAllocations{}
	return &this
}
...
func (o SubAllocationTypeGenericRoomAllocations) MarshalJSON() ([]byte, error) {
...
func (o SubAllocationTypeGenericRoomAllocations) ToMap() (map[string]interface{}, error) {
...
type NullableSubAllocationTypeGenericRoomAllocations struct {
	value *SubAllocationTypeGenericRoomAllocations
	isSet bool
}

func (v NullableSubAllocationTypeGenericRoomAllocations) Get() *SubAllocationTypeGenericRoomAllocations {
	return v.value
}

func (v *NullableSubAllocationTypeGenericRoomAllocations) Set(val *SubAllocationTypeGenericRoomAllocations) {
	v.value = val
	v.isSet = true
}

func (v NullableSubAllocationTypeGenericRoomAllocations) IsSet() bool {
	return v.isSet
}

func (v *NullableSubAllocationTypeGenericRoomAllocations) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSubAllocationTypeGenericRoomAllocations(val *SubAllocationTypeGenericRoomAllocations) *NullableSubAllocationTypeGenericRoomAllocations {
	return &NullableSubAllocationTypeGenericRoomAllocations{value: val, isSet: true}
}

func (v NullableSubAllocationTypeGenericRoomAllocations) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSubAllocationTypeGenericRoomAllocations) UnmarshalJSON(src []byte) error {
	v.isSet = true
