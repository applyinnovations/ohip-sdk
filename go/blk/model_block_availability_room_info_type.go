...
type BlockAvailabilityRoomInfoType struct {
	...
	// Sell Limit rooms for a Sell Limit block.
	...
	TaxBreakdown *TaxesType `json:"taxBreakdown,omitempty"`
...
func (o *BlockAvailabilityRoomInfoType) GetAvailableSellLimit() int32 {
...
// and a boolean to check if the value has been set.
func (o *BlockAvailabilityRoomInfoType) GetAvailableSellLimitOk() (*int32, bool) {
	if o == nil || IsNil(o.AvailableSellLimit) {
		return nil, false
	}
...
func (o *BlockAvailabilityRoomInfoType) HasAvailableSellLimit() bool {
	if o != nil && !IsNil(o.AvailableSellLimit) {
		return true
	}
...
func (o *BlockAvailabilityRoomInfoType) SetAvailableSellLimit(v int32) {
...
func (o *BlockAvailabilityRoomInfoType) GetTaxBreakdown() TaxesType {
...
// and a boolean to check if the value has been set.
func (o *BlockAvailabilityRoomInfoType) GetTaxBreakdownOk() (*TaxesType, bool) {
	if o == nil || IsNil(o.TaxBreakdown) {
		return nil, false
	}
...
func (o *BlockAvailabilityRoomInfoType) HasTaxBreakdown() bool {
	if o != nil && !IsNil(o.TaxBreakdown) {
		return true
	}
...
// SetTaxBreakdown gets a reference to the given TaxesType and assigns it to the TaxBreakdown field.
func (o *BlockAvailabilityRoomInfoType) SetTaxBreakdown(v TaxesType) {
	o.TaxBreakdown = &v
}
