...
The generated SDK clients are derived from the Oracle Hospitality API
specifications at <https://github.com/oracle/hospitality-api-docs>.
...
Works (defined below), to deal in both:

1. the Software; and
2. any piece of software and/or hardware listed in the `lrgrwrks.txt` file if
