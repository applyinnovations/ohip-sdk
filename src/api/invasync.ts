...
export class HttpClient<SecurityDataType = unknown> {
  ...
  constructor({ securityWorker, secure, format, ...axiosConfig }: ApiConfig<SecurityDataType> = {}) {
    this.instance = axios.create({ ...axiosConfig, baseURL: new URL('/inv/async/v1', axiosConfig.baseURL).toString() });
    this.secure = secure;
    this.format = format;
  ...
  externalSystems = {
    ...
    startRevenueInventoryStatisticsProcess: (
      ...
      return this.request<void, ExceptionDetailType>({
        path: `/externalSystems/${extSystemCode}/hotels/${hotelId}/revenueInventoryStatistics`,
        method: 'POST',
        body: criteria,
    ...
    getRevenueInventoryStatisticsProcessStatus: (
      ...
      return this.request<void, void>({
        path: `/externalSystems/${extSystemCode}/hotels/${hotelId}/revenueInventoryStatistics/${requestId}`,
        method: 'HEAD',
        type: ContentType.Json,
        ...newParams,
      });
    ...
    getRevenueInventoryStatistics: (
      ...
      const headers = { ...params.headers, 'x-hotelid': hotelId };
      const newParams = { ...params, headers };
      return this.request<RevenueInventoryStatisticsDetails, ExceptionDetailType>({
        path: `/externalSystems/${extSystemCode}/hotels/${hotelId}/revenueInventoryStatistics/${requestId}`,
        method: 'GET',
        type: ContentType.Json,
        format: 'json',
    ...
    postSellLimitsProcess: (
      ...
      const newParams = { ...params, headers };
      return this.request<void, ExceptionDetailType>({
        path: `/externalSystems/${extSystemCode}/hotels/${hotelId}/sellLimits`,
        method: 'POST',
        body: sellLimitsByDate,
        type: ContentType.Json,
        ...newParams,
      });
    },
    ...
    getSellLimitsProcessStatus: (
      ...
      const newParams = { ...params, headers };
      return this.request<void, void>({
        path: `/externalSystems/${extSystemCode}/hotels/${hotelId}/sellLimits/${requestId}`,
        method: 'HEAD',
        type: ContentType.Json,
        ...newParams,
      });
     ...
     */
    getSellLimits: (requestId: string, hotelId: string, extSystemCode: string, params: RequestParams = {}) => {
      const headers = { ...params.headers, 'x-hotelid': hotelId };
      const newParams = { ...params, headers };
      return this.request<SellLimitByDateStatus, ExceptionDetailType>({
        path: `/externalSystems/${extSystemCode}/hotels/${hotelId}/sellLimits/${requestId}`,
        method: 'GET',
        type: ContentType.Json,
        format: 'json',
