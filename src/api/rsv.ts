...
export enum ReservationInstructionType {
  Reservation = 'Reservation',
  Comments = 'Comments',
...
export enum ChannelResvActionType {
  Book = 'Book',
  Hold = 'Hold',
  Initiate = 'Initiate',
  Ignore = 'Ignore',
...
export enum ReservationValidationInstructionType {
...
export enum UpsellRateInstructionType {
...
export enum ChannelResvStatusType {
  Pending = 'Pending',
  Cancelled = 'Cancelled',
  Modified = 'Modified',
  Committed = 'Committed',
...
/** Facility Scheduler Option value. */
export enum FacilitySchedulerOptionType {
  Default = 'Default',
  Update = 'Update',
  Noupdate = 'Noupdate',
}
...
export class HttpClient<SecurityDataType = unknown> {
  ...
  constructor({ securityWorker, secure, format, ...axiosConfig }: ApiConfig<SecurityDataType> = {}) {
    this.instance = axios.create({ ...axiosConfig, baseURL: new URL('/rsv/v1', axiosConfig.baseURL).toString() });
    this.secure = secure;
    this.format = format;
...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
  calls = {
     ...
     * @request POST:/calls
     */
    postCall: (hotelId: string, registerCall: RegisterCall, params: RequestParams = {}) => {
      const headers = { ...params.headers, 'x-hotelid': hotelId };
      const newParams = { ...params, headers };
      return this.request<RegisterCall, ExceptionDetailType>({
        path: `/calls`,
        method: 'POST',
        body: registerCall,
  ...
  externalSystems = {
    ...
    getExternalSystemReservations: (
      ...
      const headers = { ...params.headers, 'x-hotelid': hotelId };
      const newParams = { ...params, headers };
      return this.request<ReservationsDetails, ExceptionDetailType>({
        path: `/externalSystems/${extSystemCode}/reservations`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
  ...
  hotels = {
    ...
    postReservationByBlock: (
      ...
      return this.request<Status, ExceptionDetailType>({
        path: `/hotels/${hotelId}/blocks/${blockId}/reservations`,
        method: 'POST',
    ...
    postCombineShareReservationsByExtId: (
      ...
      const headers = { ...params.headers, 'x-hotelid': hotelId };
      const newParams = { ...params, headers };
      return this.request<CombineShareReservationsDetails, ExceptionDetailType>({
        path: `/hotels/${hotelId}/externalSystems/${externalSystemCode}/reservations/${reservationExternalId}/shares`,
        method: 'POST',
        body: combineShareReservations,
        type: ContentType.Json,
        format: 'json',
        ...newParams,
      });
     ...
     */
    postReservation: (hotelId: string, createReservation: CreateReservation, params: RequestParams = {}) => {
      const headers = { ...params.headers, 'x-hotelid': hotelId };
      const newParams = { ...params, headers };
      return this.request<Status, ExceptionDetailType>({
        path: `/hotels/${hotelId}/reservations`,
    ...
    getReservationActivityLog: (
      ...
      const headers = { ...params.headers, 'x-hotelid': hotelId };
      const newParams = { ...params, headers };
      return this.request<ActivityLog, ExceptionDetailType>({
        path: `/hotels/${hotelId}/reservations/activityLog`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    postReservationLinks: (
      ...
      const newParams = { ...params, headers };
      return this.request<Status, ExceptionDetailType>({
        path: `/hotels/${hotelId}/reservations/linkedReservations/${reservationId}`,
        method: 'POST',
        body: linkReservationsCriteria,
        type: ContentType.Json,
        format: 'json',
        ...newParams,
      });
     ...
     */
    deleteReservationLinks: (reservationId: string, hotelId: string, params: RequestParams = {}) => {
      const headers = { ...params.headers, 'x-hotelid': hotelId };
      const newParams = { ...params, headers };
      return this.request<Status, ExceptionDetailType>({
        path: `/hotels/${hotelId}/reservations/linkedReservations/${reservationId}`,
    ...
    getRateInfo: (
      ...
      const headers = { ...params.headers, 'x-hotelid': hotelId };
      const newParams = { ...params, headers };
      return this.request<RateInfo, ExceptionDetailType>({
        path: `/hotels/${hotelId}/reservations/rateInfo`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    putValidateReservationChanges: (
      hotelId: string,
      validateReservationChanges: ValidateReservationChanges,
      params: RequestParams = {},
    ) => {
      const headers = { ...params.headers, 'x-hotelid': hotelId };
      const newParams = { ...params, headers };
      return this.request<ValidateReservationChangesDetails, ExceptionDetailType>({
        path: `/hotels/${hotelId}/reservations/validations`,
        method: 'PUT',
        body: validateReservationChanges,
        type: ContentType.Json,
        format: 'json',
        ...newParams,
      });
    ...
    getReservation: (
      ...
      const headers = { ...params.headers, 'x-hotelid': hotelId };
      const newParams = { ...params, headers };
      return this.request<Reservation, ExceptionDetailType>({
        path: `/hotels/${hotelId}/reservations/${reservationId}`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    putReservation: (
      ...
      const headers = { ...params.headers, 'x-hotelid': hotelId };
      const newParams = { ...params, headers };
      return this.request<ChangeReservationDetails, ExceptionDetailType>({
        path: `/hotels/${hotelId}/reservations/${reservationId}`,
        method: 'PUT',
        body: changeReservation,
        type: ContentType.Json,
        format: 'json',
        ...newParams,
      });
    ...
    putReinstateReservation: (
      ...
      const headers = { ...params.headers, 'x-hotelid': hotelId };
      const newParams = { ...params, headers };
      return this.request<ReinstateReservationDetails, ExceptionDetailType>({
        path: `/hotels/${hotelId}/reservations/${reservationId}/cancellations`,
        method: 'PUT',
        body: reinstateReservation,
        type: ContentType.Json,
        format: 'json',
        ...newParams,
      });
    ...
    postCancelReservation: (
      ...
      const headers = { ...params.headers, 'x-hotelid': hotelId };
      const newParams = { ...params, headers };
      return this.request<CancelReservationDetails, ExceptionDetailType>({
        path: `/hotels/${hotelId}/reservations/${reservationId}/cancellations`,
        method: 'POST',
    ...
    postPreCheckInReservation: (
      reservationId: string,
      hotelId: string,
      preCheckInReservation: PreCheckInReservation,
      params: RequestParams = {},
    ) => {
      const headers = { ...params.headers, 'x-hotelid': hotelId };
      const newParams = { ...params, headers };
      return this.request<Status, ExceptionDetailType>({
        path: `/hotels/${hotelId}/reservations/${reservationId}/preCheckIn`,
        method: 'POST',
        body: preCheckInReservation,
        type: ContentType.Json,
        format: 'json',
        ...newParams,
      });
    ...
    postCombineShareReservations: (
      ...
      const newParams = { ...params, headers };
      return this.request<CombineShareReservationsDetails, ExceptionDetailType>({
        path: `/hotels/${hotelId}/reservations/${reservationId}/shares`,
        method: 'POST',
        body: combineShareReservations,
        type: ContentType.Json,
        format: 'json',
    ...
    postUpsellReservation: (
      reservationId: string,
      hotelId: string,
      upsellReservation: UpsellReservation,
      params: RequestParams = {},
    ) => {
      const headers = { ...params.headers, 'x-hotelid': hotelId };
      const newParams = { ...params, headers };
      return this.request<Status, ExceptionDetailType>({
        path: `/hotels/${hotelId}/reservations/${reservationId}/upsell`,
        method: 'POST',
        body: upsellReservation,
        type: ContentType.Json,
        format: 'json',
        ...newParams,
      });
     ...
     */
    getReservationUpsellInfo: (reservationId: string, hotelId: string, params: RequestParams = {}) => {
      const headers = { ...params.headers, 'x-hotelid': hotelId };
      const newParams = { ...params, headers };
      return this.request<ReservationUpsellInfo, ExceptionDetailType>({
        path: `/hotels/${hotelId}/reservations/${reservationId}/upsell`,
        method: 'GET',
        type: ContentType.Json,
        format: 'json',
  ...
  reservations = {
    ...
    postReservationLinksByChain: (
      ...
      const newParams = { ...params, headers };
      return this.request<Status, ExceptionDetailType>({
        path: `/reservations/linkedReservations/${reservationId}`,
        method: 'POST',
        body: linkReservationsCriteria,
        type: ContentType.Json,
        format: 'json',
    ...
    getReservationStatistics: (
      ...
      const headers = { ...params.headers, 'x-hotelid': hotelId };
      const newParams = { ...params, headers };
      return this.request<ReservationStatistics, ExceptionDetailType>({
