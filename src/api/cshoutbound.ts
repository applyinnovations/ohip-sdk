...
export class HttpClient<SecurityDataType = unknown> {
  ...
  constructor({ securityWorker, secure, format, ...axiosConfig }: ApiConfig<SecurityDataType> = {}) {
    this.instance = axios.create({
      ...axiosConfig,
      baseURL: new URL('/csh/outbound/v1', axiosConfig.baseURL).toString(),
    });
    this.secure = secure;
    this.format = format;
...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
  hotels = {
     ...
     */
    getCompRedemptions: (membershipId: string, hotelId: string, params: RequestParams = {}) => {
      const newParams = params;
      return this.request<FetchCompRedemptionsRS, ExceptionDetailType>({
        path: `/hotels/${hotelId}/memberships/${membershipId}/compRedemptions`,
        method: 'GET',
    ...
    authorizeCompRedemptions: (
      ...
      const newParams = params;
      return this.request<AuthorizeCompRedemptionsRS, ExceptionDetailType>({
        path: `/hotels/${hotelId}/memberships/${membershipId}/compRedemptionAuthorizations`,
        method: 'PUT',
        body: authorizeCompRedemptions,
        type: ContentType.Json,
        format: 'json',
        ...newParams,
      });
    ...
    postCompRedemptions: (
      ...
      const newParams = params;
      return this.request<PostCompRedemptionsRS, ExceptionDetailType>({
        path: `/hotels/${hotelId}/memberships/${membershipId}/compRedemptionPostings`,
        method: 'POST',
    ...
    reverseCompRedemptions: (
      ...
      return this.request<Status, ExceptionDetailType>({
        path: `/hotels/${hotelId}/memberships/${membershipId}/compRedemptionReversals`,
        method: 'POST',
     ...
     */
    approveCompPostings: (hotelId: string, postings: CompTransactionsCriteriaType, params: RequestParams = {}) => {
      const newParams = params;
      return this.request<SendCompTransactionsStatus, ExceptionDetailType>({
        path: `/hotels/${hotelId}/compPostingsApproval`,
        method: 'PUT',
        body: postings,
        type: ContentType.Json,
        format: 'json',
     ...
     */
    reverseCompPostings: (hotelId: string, postings: CompTransactionsCriteriaType, params: RequestParams = {}) => {
      const newParams = params;
      return this.request<Status, ExceptionDetailType>({
        path: `/hotels/${hotelId}/compPostingsReversal`,
        method: 'PUT',
        body: postings,
        type: ContentType.Json,
        format: 'json',
