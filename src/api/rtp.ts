...
/** Fixed at Block. */
export enum ExchangePostingType {
...
export enum DepositMaturityPreferenceType {
  CheckIn = 'CheckIn',
...
export enum PackageChildBuckets {
  Bucket1 = 'Bucket1',
  Bucket2 = 'Bucket2',
  Bucket3 = 'Bucket3',
}
...
export enum BasedOnRatePlanType {
  BaseRate = 'BaseRate',
...
export enum RoutingProfileTypeType {
  Agent = 'Agent',
  Company = 'Company',
  Contact = 'Contact',
  Source = 'Source',
...
export class HttpClient<SecurityDataType = unknown> {
  ...
  constructor({ securityWorker, secure, format, ...axiosConfig }: ApiConfig<SecurityDataType> = {}) {
    this.instance = axios.create({ ...axiosConfig, baseURL: new URL('/rtp/v1', axiosConfig.baseURL).toString() });
    this.secure = secure;
    this.format = format;
...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
  hotels = {
    ...
    getBestAvailableRates: (
      ...
      return this.request<GetBestAvailableRatesDetails, ExceptionDetailType>({
        path: `/hotels/${hotelId}/bestavailablerates`,
        method: 'GET',
        query: query,
    ...
    getNegotiatedRates: (
      ...
      const headers = { ...params.headers, 'x-hotelid': hotelId };
      const newParams = { ...params, headers };
      return this.request<NegotiatedRates, ExceptionDetailType>({
        path: `/hotels/${hotelId}/negotiatedRates`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
     ...
     */
    postNegotiatedRates: (hotelId: string, negotiatedRates: NegotiatedRates, params: RequestParams = {}) => {
      const headers = { ...params.headers, 'x-hotelid': hotelId };
      const newParams = { ...params, headers };
      return this.request<Status, ExceptionDetailType>({
        path: `/hotels/${hotelId}/negotiatedRates`,
        method: 'POST',
        body: negotiatedRates,
        type: ContentType.Json,
        format: 'json',
        ...newParams,
      });
    ...
    putNegotiatedRates: (
      ...
      const headers = { ...params.headers, 'x-hotelid': hotelId };
      const newParams = { ...params, headers };
      return this.request<NegotiatedRatesDetails, ExceptionDetailType>({
        path: `/hotels/${hotelId}/negotiatedRates/${rateCode}`,
        method: 'PUT',
        body: negotiatedRates,
        type: ContentType.Json,
        format: 'json',
    ...
    getNegotiatedRatesForGivenHotelAndRate: (
      ...
      const newParams = { ...params, headers };
      return this.request<NegotiatedRates, ExceptionDetailType>({
        path: `/hotels/${hotelId}/negotiatedRates/${rateCode}/profiles`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getRatePlan: (
      ...
      const headers = { ...params.headers, 'x-hotelid': hotelId };
      const newParams = { ...params, headers };
      return this.request<RatePlanInfo, ExceptionDetailType>({
        path: `/hotels/${hotelId}/ratePlans`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getRatePlanSchedules: (
      ...
      const headers = { ...params.headers, 'x-hotelid': hotelId };
      const newParams = { ...params, headers };
      return this.request<RatePlanSchedulesInfo, ExceptionDetailType>({
        path: `/hotels/${hotelId}/ratePlans/${ratePlanCode}/schedules`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
  ...
  packages = {
    ...
    getPackages: (
      ...
      const headers = { ...params.headers, 'x-hotelid': hotelId };
      const newParams = { ...params, headers };
      return this.request<PackagesInfo, ExceptionDetailType>({
        path: `/packages`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
  ...
  profiles = {
    ...
    getNegotiatedRatesForGivenProfile: (
      ...
      const newParams = { ...params, headers };
      return this.request<NegotiatedRates, ExceptionDetailType>({
        path: `/profiles/${profileId}/negotiatedRates`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
  ...
  ratePlans = {
    ...
    getRatePlans: (
      ...
      const headers = { ...params.headers, 'x-hotelid': hotelId };
      const newParams = { ...params, headers };
      return this.request<RatePlansSummary, ExceptionDetailType>({
        path: `/ratePlans`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
