...
export enum HousekeepingRoomReservationStatusType {
  Arrival = 'Arrival',
  Arrived = 'Arrived',
  DayUse = 'DayUse',
  DueOut = 'DueOut',
...
export enum FrontOfficeRoomStatusType {
  Vacant = 'Vacant',
  Occupied = 'Occupied',
}
...
export enum RoomConditionAssigmentType {
  Available = 'Available',
...
export enum RoomDiscrepancyType {
  Sleep = 'Sleep',
  Skip = 'Skip',
...
export enum ServicingAttendantStatusType {
  Standby = 'Standby',
  Break = 'Break',
  Working = 'Working',
  Completed = 'Completed',
...
export enum CheckedInReservationInstructionType {
...
export class HttpClient<SecurityDataType = unknown> {
  ...
  constructor({ securityWorker, secure, format, ...axiosConfig }: ApiConfig<SecurityDataType> = {}) {
    this.instance = axios.create({ ...axiosConfig, baseURL: new URL('/fof/v1', axiosConfig.baseURL).toString() });
    this.secure = secure;
    this.format = format;
...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
  hotels = {
    ...
    getFrontOfficeStatistics: (
      ...
      return this.request<Statistics, ExceptionDetailType>({
        path: `/hotels/${hotelId}/frontOfficeStatistics/${statisticsCode}`,
        method: 'GET',
        query: query,
    ...
    getFrontOfficeStatisticsWithDateRange: (
      ...
      const newParams = { ...params, headers };
      return this.request<Statistics, ExceptionDetailType>({
        path: `/hotels/${hotelId}/frontOfficeStatisticsRange/${statisticsCode}`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getTaskSheetStatistics: (
      ...
      const headers = { ...params.headers, 'x-hotelid': hotelId };
      const newParams = { ...params, headers };
      return this.request<TaskSheetStatistics, ExceptionDetailType>({
        path: `/hotels/${hotelId}/houseKeepingStatistics`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
     ...
     */
    getReservationQueueStatistics: (hotelId: string, params: RequestParams = {}) => {
      const headers = { ...params.headers, 'x-hotelid': hotelId };
      const newParams = { ...params, headers };
      return this.request<ReservationQueueStatistics, ExceptionDetailType>({
        path: `/hotels/${hotelId}/queueReservationsStatistics`,
        method: 'GET',
        type: ContentType.Json,
        format: 'json',
        ...newParams,
     ...
     */
    postCheckIn: (reservationId: string, hotelId: string, reservation: Reservation, params: RequestParams = {}) => {
      const headers = { ...params.headers, 'x-hotelid': hotelId };
      const newParams = { ...params, headers };
      return this.request<CheckedinReservation, ExceptionDetailType>({
        path: `/hotels/${hotelId}/reservations/${reservationId}/checkIns`,
        method: 'POST',
        body: reservation,
        type: ContentType.Json,
        format: 'json',
     ...
     */
    getRoomKeys: (reservationId: string, hotelId: string, params: RequestParams = {}) => {
      const headers = { ...params.headers, 'x-hotelid': hotelId };
      const newParams = { ...params, headers };
      return this.request<RoomKeyInfo, ExceptionDetailType>({
        path: `/hotels/${hotelId}/reservations/${reservationId}/roomKeys`,
        method: 'GET',
        type: ContentType.Json,
        format: 'json',
        ...newParams,
     ...
     */
    postRoomKey: (reservationId: string, hotelId: string, roomKey: RoomKey, params: RequestParams = {}) => {
      const headers = { ...params.headers, 'x-hotelid': hotelId };
      const newParams = { ...params, headers };
      return this.request<RoomKeyDetails, ExceptionDetailType>({
        path: `/hotels/${hotelId}/reservations/${reservationId}/roomKeys`,
        method: 'POST',
        body: roomKey,
        type: ContentType.Json,
    ...
    getHotelRooms: (
      ...
      const headers = { ...params.headers, 'x-hotelid': hotelId };
      const newParams = { ...params, headers };
      return this.request<HotelRooms, ExceptionDetailType>({
