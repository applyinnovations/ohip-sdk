...
export enum UserDefinedFieldGroupDataType {
  Integer = 'Integer',
  Char = 'Char',
}
...
export class HttpClient<SecurityDataType = unknown> {
  ...
  constructor({ securityWorker, secure, format, ...axiosConfig }: ApiConfig<SecurityDataType> = {}) {
    this.instance = axios.create({
      ...axiosConfig,
      baseURL: new URL('/ent/config/v1', axiosConfig.baseURL).toString(),
    });
    this.secure = secure;
    this.format = format;
...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
  attractionClasses = {
    ...
    getAttractionClasses: (
      ...
      return this.request<AttractionClassesDetails, ExceptionDetailType>({
  ...
  brandCodes = {
    ...
    getBrandCodes: (
      ...
      const headers = { ...params.headers, 'x-hotelid': hotelId };
      const newParams = { ...params, headers };
      return this.request<BrandCodesDetails, ExceptionDetailType>({
        path: `/brandCodes`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
  ...
  communicationMethodsEntDetails = {
    ...
    getCommunicationMethodsEntDetails: (
      ...
      const headers = { ...params.headers, 'x-hotelid': hotelId };
      const newParams = { ...params, headers };
      return this.request<CommunicationMethodsEntDetailsDetails, ExceptionDetailType>({
  ...
  corporateDepartmentCodes = {
    ...
    getCorporateDepartmentCodes: (
      ...
      const headers = { ...params.headers, 'x-hotelid': hotelId };
      const newParams = { ...params, headers };
      return this.request<CorporateDepartmentCodesDetails, ExceptionDetailType>({
  ...
  corporateDivisions = {
    ...
    getCorporateDivisions: (
      ...
      const headers = { ...params.headers, 'x-hotelid': hotelId };
      const newParams = { ...params, headers };
      return this.request<CorporateDivisionsDetails, ExceptionDetailType>({
  ...
  corporateOperatingUnits = {
    ...
    getCorporateOperatingUnits: (
      ...
      const headers = { ...params.headers, 'x-hotelid': hotelId };
      const newParams = { ...params, headers };
      return this.request<CorporateOperatingUnitsDetails, ExceptionDetailType>({
  ...
  countries = {
    ...
    getCountryGuestTypes: (
      ...
      const headers = { ...params.headers, 'x-hotelid': hotelId };
      const newParams = { ...params, headers };
      return this.request<CountryGuestTypesDetails, ExceptionDetailType>({
  ...
  countryMainGroups = {
    ...
    getCountryMainGroups: (
      ...
      const headers = { ...params.headers, 'x-hotelid': hotelId };
      const newParams = { ...params, headers };
      return this.request<CountryMainGroupsDetails, ExceptionDetailType>({
  ...
  defaultNote = {
    ...
    getDefaultNote: (
      ...
      const headers = { ...params.headers, 'x-hotelid': hotelId };
      const newParams = { ...params, headers };
      return this.request<DefaultNoteDetails, ExceptionDetailType>({
        path: `/defaultNote`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
  ...
  departments = {
    ...
    getDepartments: (
      ...
      const headers = { ...params.headers, 'x-hotelid': hotelId };
      const newParams = { ...params, headers };
      return this.request<DepartmentsDetails, ExceptionDetailType>({
        path: `/departments`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
     ...
     */
    postDepartments: (hotelId: string, departmentsCriteria: DepartmentsCriteria, params: RequestParams = {}) => {
      const headers = { ...params.headers, 'x-hotelid': hotelId };
      const newParams = { ...params, headers };
      return this.request<Status, ExceptionDetailType>({
        path: `/departments`,
        method: 'POST',
        body: departmentsCriteria,
        type: ContentType.Json,
        format: 'json',
        ...newParams,
      });
  ...
  hotelCategories = {
    ...
    getHotelCategories: (
      ...
      const headers = { ...params.headers, 'x-hotelid': hotelId };
      const newParams = { ...params, headers };
      return this.request<HotelCategoriesDetails, ExceptionDetailType>({
  ...
  hotels = {
    ...
    getHotel: (
      ...
      const headers = { ...params.headers, 'x-hotelid': hotelId };
      const newParams = { ...params, headers };
      return this.request<HotelDetails, ExceptionDetailType>({
        path: `/hotels/${hotelId}`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
    ...
    getAirports: (
      ...
      const headers = { ...params.headers, 'x-hotelid': hotelId };
      const newParams = { ...params, headers };
      return this.request<AirportsDetails, ExceptionDetailType>({
        path: `/hotels/${hotelId}/airports`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getAmenities: (
      ...
      const headers = { ...params.headers, 'x-hotelid': hotelId };
      const newParams = { ...params, headers };
      return this.request<AmenitiesDetails, ExceptionDetailType>({
     ...
     */
    postAmenities: (hotelId: string, amenitiesCriteria: AmenitiesCriteria, params: RequestParams = {}) => {
      const headers = { ...params.headers, 'x-hotelid': hotelId };
      const newParams = { ...params, headers };
      return this.request<Status, ExceptionDetailType>({
        path: `/hotels/${hotelId}/amenities`,
        method: 'POST',
        body: amenitiesCriteria,
        type: ContentType.Json,
        format: 'json',
        ...newParams,
      });
    ...
    getAttractions: (
      ...
      const headers = { ...params.headers, 'x-hotelid': hotelId };
      const newParams = { ...params, headers };
      return this.request<AttractionsDetails, ExceptionDetailType>({
        path: `/hotels/${hotelId}/attractions`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
     ...
     */
    postAttractions: (hotelId: string, attractionsCriteria: AttractionsCriteria, params: RequestParams = {}) => {
      const headers = { ...params.headers, 'x-hotelid': hotelId };
      const newParams = { ...params, headers };
      return this.request<Status, ExceptionDetailType>({
        path: `/hotels/${hotelId}/attractions`,
        method: 'POST',
        body: attractionsCriteria,
        type: ContentType.Json,
        format: 'json',
        ...newParams,
      });
    ...
    changeAttractions: (
      ...
      const newParams = { ...params, headers };
      return this.request<Status, ExceptionDetailType>({
        path: `/hotels/${hotelId}/attractions/${attractionCode}`,
        method: 'PUT',
        body: attractionsToBeChanged,
        type: ContentType.Json,
        format: 'json',
        ...newParams,
      });
     ...
     */
    postHotelContacts: (hotelId: string, hotelContactsCriteria: HotelContactsCriteria, params: RequestParams = {}) => {
      const headers = { ...params.headers, 'x-hotelid': hotelId };
      const newParams = { ...params, headers };
      return this.request<Status, ExceptionDetailType>({
        path: `/hotels/${hotelId}/contacts`,
        method: 'POST',
        body: hotelContactsCriteria,
        type: ContentType.Json,
        format: 'json',
        ...newParams,
      });
    ...
    changeHotelContacts: (
      ...
      const newParams = { ...params, headers };
      return this.request<Status, ExceptionDetailType>({
        path: `/hotels/${hotelId}/contacts/${contactId}`,
        method: 'PUT',
        body: hotelContactsToBeChanged,
        type: ContentType.Json,
        format: 'json',
        ...newParams,
      });
    ...
    getCreditCardTypes: (
      ...
      const headers = { ...params.headers, 'x-hotelid': hotelId };
      const newParams = { ...params, headers };
      return this.request<CreditCardTypesDetails, ExceptionDetailType>({
        path: `/hotels/${hotelId}/creditcardTypes`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    changeCreditCardTypes: (
      ...
      return this.request<Status, ExceptionDetailType>({
        path: `/hotels/${hotelId}/creditcardTypes`,
        method: 'PUT',
        body: creditCardTypesToBeChanged,
        type: ContentType.Json,
        format: 'json',
        ...newParams,
      });
    ...
    getHotelDetails: (
      ...
      const headers = { ...params.headers, 'x-hotelid': hotelId };
      const newParams = { ...params, headers };
      return this.request<HotelDetailsDetails, ExceptionDetailType>({
        path: `/hotels/${hotelId}/hotelDetails`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
     ...
     */
    postHotelNotes: (hotelId: string, hotelNotesCriteria: HotelNotesCriteria, params: RequestParams = {}) => {
      const headers = { ...params.headers, 'x-hotelid': hotelId };
      const newParams = { ...params, headers };
      return this.request<Status, ExceptionDetailType>({
        path: `/hotels/${hotelId}/notes`,
        method: 'POST',
        body: hotelNotesCriteria,
        type: ContentType.Json,
        format: 'json',
        ...newParams,
      });
    ...
    changeHotelNotes: (
      ...
      const newParams = { ...params, headers };
      return this.request<Status, ExceptionDetailType>({
        path: `/hotels/${hotelId}/notes/${noteCode}`,
        method: 'PUT',
        body: hotelNotesToBeChanged,
        type: ContentType.Json,
        format: 'json',
        ...newParams,
      });
    ...
    getTransportation: (
      ...
      const headers = { ...params.headers, 'x-hotelid': hotelId };
      const newParams = { ...params, headers };
      return this.request<TransportationDetails, ExceptionDetailType>({
        path: `/hotels/${hotelId}/transportations`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    copyDepartments: (
      ...
      const newParams = { ...params, headers };
      return this.request<Status, ExceptionDetailType>({
        path: `/hotels/${sourceHotelId}/departments/copy`,
        method: 'PUT',
        body: copyDepartments,
        type: ContentType.Json,
        format: 'json',
        ...newParams,
      });
  ...
  jobTitles = {
    ...
    getTemplateJobTitles: (
      ...
      const headers = { ...params.headers, 'x-hotelid': hotelId };
      const newParams = { ...params, headers };
      return this.request<TemplateJobTitlesDetails, ExceptionDetailType>({
        path: `/jobTitles`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
  ...
  languages = {
    ...
    getLanguages: (
      ...
      const headers = { ...params.headers, 'x-hotelid': hotelId };
      const newParams = { ...params, headers };
      return this.request<LanguagesDetails, ExceptionDetailType>({
        path: `/languages`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
  ...
  notes = {
     ...
     */
    removeHotelNotes: (hotelId: string, noteCode: string, params: RequestParams = {}) => {
      const headers = { ...params.headers, 'x-hotelid': hotelId };
      const newParams = { ...params, headers };
      return this.request<Status, ExceptionDetailType>({
        path: `/notes/${noteCode}`,
  ...
  propertyDetailsCategories = {
    ...
    getPropertyDetailCategories: (
      ...
      const headers = { ...params.headers, 'x-hotelid': hotelId };
      const newParams = { ...params, headers };
      return this.request<PropertyDetailCategoriesDetails, ExceptionDetailType>({
    ...
    postPropertyDetailCategories: (
      ...
      return this.request<Status, ExceptionDetailType>({
        path: `/propertyDetailsCategories`,
        method: 'POST',
        body: propertyDetailCategoriesCriteria,
        type: ContentType.Json,
        format: 'json',
        ...newParams,
      });
    ...
    changePropertyDetailCategories: (
      ...
      const newParams = { ...params, headers };
      return this.request<Status, ExceptionDetailType>({
        path: `/propertyDetailsCategories/${categoryCode}`,
        method: 'PUT',
        body: propertyDetailCategoriesToBeChanged,
        type: ContentType.Json,
        format: 'json',
        ...newParams,
      });
  ...
  propertyTypes = {
    ...
    getPropertyTypes: (
      ...
      const headers = { ...params.headers, 'x-hotelid': hotelId };
      const newParams = { ...params, headers };
      return this.request<PropertyTypesDetails, ExceptionDetailType>({
        path: `/propertyTypes`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
     ...
     */
    postPropertyTypes: (hotelId: string, propertyTypesCriteria: PropertyTypesCriteria, params: RequestParams = {}) => {
      const headers = { ...params.headers, 'x-hotelid': hotelId };
      const newParams = { ...params, headers };
      return this.request<Status, ExceptionDetailType>({
        path: `/propertyTypes`,
        method: 'POST',
        body: propertyTypesCriteria,
        type: ContentType.Json,
        format: 'json',
        ...newParams,
      });
    ...
    putPropertyTypes: (
      ...
      const newParams = { ...params, headers };
      return this.request<Status, ExceptionDetailType>({
        path: `/propertyTypes/${propertyTypeCode}`,
        method: 'PUT',
        body: propertyTypesToBeChanged,
        type: ContentType.Json,
        format: 'json',
        ...newParams,
      });
  ...
  regionCode = {
    ...
    getRegionsCode: (
      ...
      const headers = { ...params.headers, 'x-hotelid': hotelId };
      const newParams = { ...params, headers };
      return this.request<RegionsCodeDetails, ExceptionDetailType>({
        path: `/regionCode`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
     ...
     */
    postRegionsCode: (hotelId: string, regionsCodeCriteria: RegionsCodeCriteria, params: RequestParams = {}) => {
      const headers = { ...params.headers, 'x-hotelid': hotelId };
      const newParams = { ...params, headers };
      return this.request<Status, ExceptionDetailType>({
        path: `/regionCode`,
        method: 'POST',
        body: regionsCodeCriteria,
        type: ContentType.Json,
        format: 'json',
        ...newParams,
      });
     ...
     */
    removeRegionsCode: (hotelId: string, regionCode: string, params: RequestParams = {}) => {
      const headers = { ...params.headers, 'x-hotelid': hotelId };
      const newParams = { ...params, headers };
      return this.request<Status, ExceptionDetailType>({
        path: `/regionCode/${regionCode}`,
  ...
  roomAmenities = {
    ...
    getRoomAmenities: (
      ...
      const headers = { ...params.headers, 'x-hotelid': hotelId };
      const newParams = { ...params, headers };
      return this.request<RoomAmenitiesDetails, ExceptionDetailType>({
        path: `/roomAmenities`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
  ...
  templateCodes = {
    ...
    getTemplateCodes: (
      ...
      const headers = { ...params.headers, 'x-hotelid': hotelId };
      const newParams = { ...params, headers };
      return this.request<TemplateCodesDetails, ExceptionDetailType>({
        path: `/templateCodes`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
  ...
  transportations = {
    ...
    getTransportationTemplates: (
      ...
      const headers = { ...params.headers, 'x-hotelid': hotelId };
      const newParams = { ...params, headers };
      return this.request<TransportationTemplatesDetails, ExceptionDetailType>({
  ...
  userDefinedFieldGroups = {
    ...
    getUserDefinedFieldGroups: (
      ...
      const headers = { ...params.headers, 'x-hotelid': hotelId };
      const newParams = { ...params, headers };
      return this.request<UserDefinedFieldGroupsDetails, ExceptionDetailType>({
  ...
  userDefinedFieldValues = {
    ...
    getUserDefinedFieldValues: (
      ...
      const headers = { ...params.headers, 'x-hotelid': hotelId };
      const newParams = { ...params, headers };
      return this.request<UserDefinedFieldValuesDetails, ExceptionDetailType>({
