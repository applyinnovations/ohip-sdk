...
export class HttpClient<SecurityDataType = unknown> {
  ...
  constructor({ securityWorker, secure, format, ...axiosConfig }: ApiConfig<SecurityDataType> = {}) {
    this.instance = axios.create({ ...axiosConfig, baseURL: new URL('/lov/v1', axiosConfig.baseURL).toString() });
    this.secure = secure;
    this.format = format;
...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
  listOfValues = {
     ...
     */
    getLovNames: (hotelId: string, params: RequestParams = {}) => {
      const headers = { ...params.headers, 'x-hotelid': hotelId };
      const newParams = { ...params, headers };
      return this.request<ListOfValueNames, ExceptionDetailType>({
        path: `/listOfValues`,
        method: 'GET',
    ...
    getMembershipClassTypesLov: (
      ...
      const headers = { ...params.headers, 'x-hotelid': hotelId };
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/airlines/${airlines}/loyalty/${loyalty}/membershipClassTypes`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getPrintersLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/alertPrinters/${alertPrinters}/printers`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getBlockBookingStatusesLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/blockId/${blockId}/blockBookingStatuses`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getBlockCurrentStatusesLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/blockId/${blockId}/blockCurrentStatuses`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
     ...
     */
    getGdsRoomCategoryTemplatesLov: (
      hotelId: string,
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/bookingChannels/${bookingChannelCodes}/gdsRoomCategoryTemplates`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getGdsGuaranteeCodesLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/bookingChannels/${bookingChannelCode}/gdsGuaranteeCodes`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getGdsRateCategoriesLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/bookingChannels/${bookingChannelCode}/gdsRateCategories`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getGdsRateLevelsLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/bookingChannels/${bookingChannelCode}/gdsRateLevels`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
     ...
     */
    getTemplateBookingChannelRoomTypesLov: (
      hotelId: string,
      bookingChannelCode: string,
      query?: {
        /** Only useful for LOVs that support toggle of inactive records inclusion. When set to true, inactive records will be included. */
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/bookingChannels/${bookingChannelCode}/templateBookingChannelRoomTypes`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getBlockNextStatusesLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/bookingStatus/${bookingStatus}/blockNextStatuses`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getGridTypesLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/bookingStatus/${bookingStatus}/gridTypes`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getTaskSheetLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/breakOutId/${breakOutId}/taskSheet`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getCashierHotelsLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/cashierId/${cashierId}/cashierHotels`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getBlockCatNextStatusesLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/catStatus/${catStatus}/blockCatNextStatuses`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getUserDbFunctionsLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/category/${category}/userDbFunctions`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getCateringBudgetTypesLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/catering/${catering}/active/${active}/cateringBudgetTypes`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getHotelsForSnClov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/cateringEvents/${cateringEvents}/hotelsForSnC`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getChainLanguagesLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/chainCode/${chainCode}/chainLanguages`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getPreferenceSubgroupsLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/chainCode/${chainCode}/preferenceGroup/${preferenceGroup}/preferenceSubgroups`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getScreenStyleCodesLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/chainCode/${chainCode}/screenCode/${screenCode}/screenStyleCodes`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getScreenCodesLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/chainCode/${chainCode}/screenType/${screenType}/screenArea/${screenArea}/screenCodes`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getFieldNameLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/changeSource/${changeSource}/fieldName`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getBookingChannelRoomTypesLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/channel/${channel}/bookingChannelRoomTypes`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getGdsHotelsLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/channelType/${channelType}/gdsHotels`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getCateringCodesLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/codeType/${codeType}/cateringCodes`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getPostalCodesLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/country/${country}/postalCodes`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getToPostalCodesLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/country/${country}/toPostalCodes`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getExchangeTypesLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/currencyCode/${currencyCode}/exchangeTypes`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getCurrencyFormatsLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/decimal/${decimal}/currencyFormats`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getNoteTypesLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/departments/${departmentType}/noteTypes`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getDeviceCodeMappingValuesLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/deviceType/${deviceType}/deviceCode/${deviceCode}/codeType/${codeType}/externalCode/${externalCode}/deviceCodeMappingValues`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getECertificateGroupEntityLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/entityName/${entityName}/eCertificateGroupEntity`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getAdsEchoTokenLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/errorType/${errorType}/adsEchoToken`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getAdsStatusLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/errorType/${errorType}/adsStatus`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getCateringStatusCodesLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/exclusionList/${exclusionList}/cateringStatusCodes`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getEventStatusCodesLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/exclusionList/${exclusionList}/eventStatusCodes`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getGdsConvAmenityCodesLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/featureType/${featureType}/bookingChannels/${bookingChannelCodes}/gdsConvAmenityCodes`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
     ...
     */
    getTemplateTransactionSubgroupsLov: (
      hotelId: string,
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/fetchOnlyUniqueValues/${fetchOnlyUniqueValues}/templateTransactionSubgroups`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getGlobalAlertFunctionLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/fieldType/${fieldType}/globalAlertFunction`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getUserDbFunctionArgsLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/functionName/${functionName}/category/${category}/userDbFunctionArgs`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
     ...
     */
    getChannelCardTypeMappingChannelCardTypeLov: (
      hotelId: string,
      cardType: string,
      gdsHost: string,
      query?: {
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/gdsHost/${gdsHost}/cardType/${cardType}/channelCardTypeMappingChannelCardType`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getRepGroupReportsLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/groupName/${groupName}/repGroupReports`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getFrequencyLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/guestRequested/${guestRequested}/defaultDepartureTask/${defaultDepartureTask}/frequency`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getFrequencyTypeLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/guestRequested/${guestRequested}/defaultDepartureTask/${defaultDepartureTask}/frequencyType`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getQueueNameLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/hotelCodeList/${hotelCodeList}/queueName`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getRepRoomTypeMultiHotelLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/hotelCodeList/${hotelCodeList}/repRoomTypeMultiHotel`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getRoomClassMultiPropertyLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/hotelCodeList/${hotelCodeList}/roomClassMultiProperty`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getRepOwnerCodesLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/hotelCodesList/${hotelCodesList}/repOwnerCodes`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getActivitiesLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/hotels/${hotelId}/activities`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getActivityConfigTypesLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/hotels/${hotelId}/activityConfigTypes`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getUserLogActivityTypesLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/hotels/${hotelId}/activityGroup/${activityGroup}/userLogActivityTypes`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getActivityLocationsLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/hotels/${hotelId}/activityLocations`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getActivityStatusLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/hotels/${hotelId}/activityStatus`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getActivityTypesLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/hotels/${hotelId}/activityTypes`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getReservationPackagesLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/hotels/${hotelId}/adults/${adults}/children/${children}/arrival/${arrival}/departure/${departure}/reservationPackages`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
     ...
     */
    getReservationPackagesGroupItemsLov: (
      group: string,
      arrival: string,
      children: string,
      adults: string,
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/hotels/${hotelId}/adults/${adults}/children/${children}/arrival/${arrival}/group/${group}/reservationPackagesGroupItems`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getAgentAccountsLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/hotels/${hotelId}/agentAccounts`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getAgentSourceCitiesLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/hotels/${hotelId}/agentSourceCities`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getAgentSourceResvCitiesLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/hotels/${hotelId}/agentSourceResvCities`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getAlertCodesLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/hotels/${hotelId}/alertCodes`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getAlternateHotelCodesLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/hotels/${hotelId}/alternateHotelCodes`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getAmenitiesLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/hotels/${hotelId}/amenities`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getArAccountTypesLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/hotels/${hotelId}/arAccountTypes`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getArCreditCardsLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/hotels/${hotelId}/arCreditCards`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getArrangementCodeLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/hotels/${hotelId}/arrangementCode`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
     ...
     */
    getPackageArrangementAssociationLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/hotels/${hotelId}/arrangementCode/${arrangementCode}/packageArrangementAssociation`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getBlockRatesLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/hotels/${hotelId}/arrival/${arrival}/departure/${departure}/blockId/${blockId}/blockRates`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getReservationTicketsCodesLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/hotels/${hotelId}/arrival/${arrival}/departure/${departure}/reservationTicketsCodes`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getBlockCodesByArrivalDateLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/hotels/${hotelId}/arrivalDate/${arrivalDate}/blockCodesByArrivalDate`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getArticleCodesLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/hotels/${hotelId}/articleCodes`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getAttractionsLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/hotels/${hotelId}/attractions`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getAuthorizerLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/hotels/${hotelId}/authorizer`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getAvailableProfileOwnerRoomsLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/hotels/${hotelId}/availableProfileOwnerRooms`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
     ...
     */
    getAvailableScriptLanguagesLov: (
      hotelId: string,
      query?: {
        /** Only useful for LOVs that support toggle of inactive records inclusion. When set to true, inactive records will be included. */
        includeInactiveFlag?: boolean;
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/hotels/${hotelId}/availableScriptLanguages`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getAwardCodesLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/hotels/${hotelId}/awardCodes`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getAwardCodesMultiHotelLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/hotels/${hotelId}/awardCodesMultiHotel`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getAwardMktgCodesLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/hotels/${hotelId}/awardMktgCodes`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getBankAccountsLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/hotels/${hotelId}/bankAccounts`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getBankAccountsForReportsLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/hotels/${hotelId}/bankAccountsForReports`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getBanquetPrintingMethodLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/hotels/${hotelId}/banquetPrintingMethod`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getEndOfDayReportsLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/hotels/${hotelId}/beforeIncomeAudit/${beforeIncomeAudit}/endOfDayReports`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getBlockCodesLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/hotels/${hotelId}/beginDate/${beginDate}/endDate/${endDate}/blockCodes`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getBlockIdsLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/hotels/${hotelId}/beginDate/${beginDate}/endDate/${endDate}/blockIds`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getBlockRateCodesLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/hotels/${hotelId}/beginDate/${beginDate}/endDate/${endDate}/negotiatedOnly/${negotiatedOnly}/blockRateCodes`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getResStatReportRateCodeLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/hotels/${hotelId}/beginDate/${beginDate}/endDate/${endDate}/resStatReportRateCode`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getBillingInstructionsLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/hotels/${hotelId}/billingInstructions`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getBlockCodesFinOperationsLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/hotels/${hotelId}/blockCodesFinOperations`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getBlockEventsLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/hotels/${hotelId}/blockEvents`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getBlockEventIdsLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/hotels/${hotelId}/blockId/${blockId}/blockEventIds`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getBlockModeLovLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/hotels/${hotelId}/blockModeLov`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getBlockPaymentMethodsLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/hotels/${hotelId}/blockPaymentMethods`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getChannelConfigRateCodesLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/hotels/${hotelId}/bookingChannels/${bookingChannelCode}/roomType/${roomType}/channelConfigRateCodes`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getBlockReservationTypesLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/hotels/${hotelId}/bookingStatus/${bookingStatus}/blockReservationTypes`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getBookingTypesIndividualsLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/hotels/${hotelId}/bookingTypesIndividuals`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getHkTaskSheetsNoLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/hotels/${hotelId}/breakOutId/${breakOutId}/hkTaskSheetsNo`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getRevenueBucketTrxCodesLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/hotels/${hotelId}/bucketType/${bucketType}/revenueBucketTrxCodes`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getBudgetForecastCodesLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/hotels/${hotelId}/budgetForecastCodes`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getBudgetRateCodesLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/hotels/${hotelId}/budgetRateCodes`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getHkScheduledAttendantsLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/hotels/${hotelId}/businessDate/${businessDate}/hkScheduledAttendants`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getCampaignActivityTypesLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/hotels/${hotelId}/campaignActivityTypes`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getCashRegisterIdlov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/hotels/${hotelId}/cashRegisterId`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getCatBudgetTypeEventCodesLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/hotels/${hotelId}/catBudgetType/${catBudgetType}/catBudgetTypeEventCodes`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
     ...
     */
    getCatBudgetTypeMarketCodesLov: (
      catBudgetType: string,
      hotelId: string,
      query?: {
        /** Only useful for LOVs that support toggle of inactive records inclusion. When set to true, inactive records will be included. */
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/hotels/${hotelId}/catBudgetType/${catBudgetType}/catBudgetTypeMarketCodes`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getCatBudgetTypeMealCodesLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/hotels/${hotelId}/catBudgetType/${catBudgetType}/catBudgetTypeMealCodes`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
     ...
     */
    getCatBudgetTypeRevenueCodesLov: (
      catBudgetType: string,
      hotelId: string,
      query?: {
        /** Only useful for LOVs that support toggle of inactive records inclusion. When set to true, inactive records will be included. */
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/hotels/${hotelId}/catBudgetType/${catBudgetType}/catBudgetTypeRevenueCodes`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
     ...
     */
    getCateringPackagePriceCodesLov: (
      hotelId: string,
      query?: {
        /** Only useful for LOVs that support toggle of inactive records inclusion. When set to true, inactive records will be included. */
        includeInactiveFlag?: boolean;
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/hotels/${hotelId}/cateringPackagePriceCodes`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getBookingChannelRatePlansLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/hotels/${hotelId}/channel/${channel}/bookingChannelRatePlans`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
     ...
     */
    getChannelCardTypeMappingCardTypeLov: (
      hotelId: string,
      query?: {
        /** Only useful for LOVs that support toggle of inactive records inclusion. When set to true, inactive records will be included. */
        includeInactiveFlag?: boolean;
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/hotels/${hotelId}/channelCardTypeMappingCardType`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
     ...
     */
    getChannelCardTypeMappingGdsHostLov: (
      hotelId: string,
      query?: {
        /** Only useful for LOVs that support toggle of inactive records inclusion. When set to true, inactive records will be included. */
        includeInactiveFlag?: boolean;
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/hotels/${hotelId}/channelCardTypeMappingGdsHost`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getCommissionCodeLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/hotels/${hotelId}/commissionCode`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getCommissionTxnCodesLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/hotels/${hotelId}/commissionTxnCodes`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getCompAuthorizersLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/hotels/${hotelId}/compAuthorizers`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getCompTypesLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/hotels/${hotelId}/compTypes`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getCompaniesLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/hotels/${hotelId}/companies`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getConfLetterReportsLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/hotels/${hotelId}/confLetterReports`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
     ...
     */
    getExportMappingCodesToLinkLov: (
      configType: string,
      hotelId: string,
      query?: {
        /** Only useful for LOVs that support toggle of inactive records inclusion. When set to true, inactive records will be included. */
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/hotels/${hotelId}/configType/${configType}/exportMappingCodesToLink`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getHotelContactCommMethodLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/hotels/${hotelId}/contactType/${contactType}/hotelContactCommMethod`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getCreditCardTypesLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/hotels/${hotelId}/creditCardTypes`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getStageProfilesLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/hotels/${hotelId}/criteria/${criteria}/stageProfiles`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getConfigBaseRatePlansLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/hotels/${hotelId}/currentRateCode/${currentRateCode}/currencyCode/${currencyCode}/daily/${daily}/tiered/${tiered}/configBaseRatePlans`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
     ...
     */
    getConfigAdvDynamicBaseRatePlansLov: (
      daily: string,
      tiered: string,
      currentRateCode: string,
      hotelId: string,
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/hotels/${hotelId}/currentRateCode/${currentRateCode}/tiered/${tiered}/daily/${daily}/configAdvDynamicBaseRatePlans`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getCustomNumberConfigCodesLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/hotels/${hotelId}/customNumberConfigCodes`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getCustomRoomTranslationLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/hotels/${hotelId}/dbfLogo/${dbfLogo}/customRoomTranslation`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getQuickTextsLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/hotels/${hotelId}/departmentId/${departmentId}/quickTexts`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getDeviceLocationsLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/hotels/${hotelId}/deviceLocations`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getDietaryPreferencesLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/hotels/${hotelId}/dietaryPreferences`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getECouponLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/hotels/${hotelId}/eCoupon`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getECouponRateCodesLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/hotels/${hotelId}/eCouponRateCodes`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getEcouponResvRoomLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/hotels/${hotelId}/ecouponResvRoom`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getEventGroupsLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/hotels/${hotelId}/eventGroups`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getEventLocationsLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/hotels/${hotelId}/eventLocations`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getCurrencyExchangeRatesLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/hotels/${hotelId}/exchangeType/${exchangeType}/currencyExchangeRates`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getExportMappingTypeCodesLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/hotels/${hotelId}/exportMappingTypeCodes`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getBusinessEventActionTypeLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/hotels/${hotelId}/extSystem/${extSystem}/module/${module}/businessEventActionType`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getExternalReferenceTypesLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/hotels/${hotelId}/externalReferenceTypes`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getFacilityCodesLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/hotels/${hotelId}/facilityCodes`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
     ...
     */
    getFacilityCodesReservationLov: (
      facilityTask: string,
      hotelId: string,
      query?: {
        /** Only useful for LOVs that support toggle of inactive records inclusion. When set to true, inactive records will be included. */
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/hotels/${hotelId}/facilityTask/${facilityTask}/facilityCodesReservation`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getFacilityTasksLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/hotels/${hotelId}/facilityTasks`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
     ...
     */
    getAvailableExportTemplatesLov: (
      fileGroup: string,
      hotelId: string,
      query?: {
        /** Only useful for LOVs that support toggle of inactive records inclusion. When set to true, inactive records will be included. */
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/hotels/${hotelId}/fileGroup/${fileGroup}/availableExportTemplates`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getFiscalPaymentMethodsLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/hotels/${hotelId}/fiscalPaymentMethods`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getRepFiscalMonthsLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/hotels/${hotelId}/fiscalYearId/${fiscalYearId}/repFiscalMonths`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getRepFiscalWeeksLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/hotels/${hotelId}/fiscalYearId/${fiscalYearId}/repFiscalWeeks`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
     ...
     */
    getFixedChargesTransactionCodesLov: (
      hotelId: string,
      query?: {
        /** Only useful for LOVs that support toggle of inactive records inclusion. When set to true, inactive records will be included. */
        includeInactiveFlag?: boolean;
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/hotels/${hotelId}/fixedChargesTransactionCodes`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getFloorsLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/hotels/${hotelId}/floors`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getFolioStylesLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/hotels/${hotelId}/folioStyles`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getFolioTypesLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/hotels/${hotelId}/folioTypes`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getForecastGroupsLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/hotels/${hotelId}/forecastGroups`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getTaskBreakOutLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/hotels/${hotelId}/fromDate/${fromDate}/taskBreakOut`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getRepRoomsStatLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/hotels/${hotelId}/fromDate/${fromDate}/toDate/${toDate}/repRoomsStat`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getUpsellToRoomClassEditLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/hotels/${hotelId}/fromRoomClass/${fromRoomClass}/upsellToRoomClassEdit`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getFromRoomNumberLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/hotels/${hotelId}/fromRoomNumber`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getUpsellToRoomTypeEditLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/hotels/${hotelId}/fromRoomTypeLabel/${fromRoomTypeLabel}/upsellToRoomTypeEdit`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getGemMenuItemsLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/hotels/${hotelId}/gemMenuItems`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getGenericReportsLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/hotels/${hotelId}/genericReports`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getGroupArrivalsLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/hotels/${hotelId}/groupArrivals`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getGroupsLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/hotels/${hotelId}/groups`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getGuestMessagesMultiHotelLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/hotels/${hotelId}/guestMessagesMultiHotel`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getGuestMessagesQuickTextsLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/hotels/${hotelId}/guestMessagesQuickTexts`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getHkAttendantsLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/hotels/${hotelId}/hkAttendants`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getHkAttendantsMobileLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/hotels/${hotelId}/hkAttendantsMobile`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getHkFloorsLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/hotels/${hotelId}/hkFloors`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getHkRoomTypesLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/hotels/${hotelId}/hkRoomTypes`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getHkRoomsLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/hotels/${hotelId}/hkRooms`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getHkTaskBreakOutLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/hotels/${hotelId}/hkTaskBreakOut`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getHkTaskCodesLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/hotels/${hotelId}/hkTaskCodes`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getHkTaskTemplatesLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/hotels/${hotelId}/hkTaskTemplates`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getHotelEventTypesLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/hotels/${hotelId}/hotelEventTypes`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
     ...
     */
    getHotelInterfaceImportRoomsLov: (
      hotelId: string,
      query?: {
        /** Only useful for LOVs that support toggle of inactive records inclusion. When set to true, inactive records will be included. */
        includeInactiveFlag?: boolean;
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/hotels/${hotelId}/hotelInterfaceImportRooms`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getHotelRateTierLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/hotels/${hotelId}/hotelRateTier`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getHouseKeepingRoomsLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/hotels/${hotelId}/houseKeepingRooms`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getHouseKeepingSectionsLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/hotels/${hotelId}/houseKeepingSections`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getHousekeepingCreditRulesLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/hotels/${hotelId}/housekeepingCreditRules`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getIfcRightsViewLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/hotels/${hotelId}/ifcId/${ifcId}/category/${category}/ifcRightsView`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
     ...
     */
    getImbalanceVerificationTypesLov: (
      hotelId: string,
      query?: {
        /** Only useful for LOVs that support toggle of inactive records inclusion. When set to true, inactive records will be included. */
        includeInactiveFlag?: boolean;
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/hotels/${hotelId}/imbalanceVerificationTypes`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getUpsellOccupancyLevelsLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/hotels/${hotelId}/includeBlank/${includeBlank}/upsellOccupancyLevels`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getSourceGroupsLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/hotels/${hotelId}/includeInactive/${includeInactive}/sourceGroups`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getInterfaceAutoBalanceLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/hotels/${hotelId}/interfaceAutoBalance`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
     ...
     */
    getInterfaceDataRequestMarketCodeLov: (
      hotelId: string,
      query?: {
        /** Only useful for LOVs that support toggle of inactive records inclusion. When set to true, inactive records will be included. */
        includeInactiveFlag?: boolean;
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/hotels/${hotelId}/interfaceDataRequestMarketCode`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
     ...
     */
    getInterfaceDataRequestMarketGroupLov: (
      hotelId: string,
      query?: {
        /** Only useful for LOVs that support toggle of inactive records inclusion. When set to true, inactive records will be included. */
        includeInactiveFlag?: boolean;
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/hotels/${hotelId}/interfaceDataRequestMarketGroup`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
     ...
     */
    getInterfaceDataRequestRoomClassLov: (
      hotelId: string,
      query?: {
        /** Only useful for LOVs that support toggle of inactive records inclusion. When set to true, inactive records will be included. */
        includeInactiveFlag?: boolean;
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/hotels/${hotelId}/interfaceDataRequestRoomClass`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
     ...
     */
    getInterfaceDataRequestRoomTypesLov: (
      hotelId: string,
      query?: {
        /** Only useful for LOVs that support toggle of inactive records inclusion. When set to true, inactive records will be included. */
        includeInactiveFlag?: boolean;
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/hotels/${hotelId}/interfaceDataRequestRoomTypes`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
     ...
     */
    getInterfaceDataRequestSourceCodeLov: (
      hotelId: string,
      query?: {
        /** Only useful for LOVs that support toggle of inactive records inclusion. When set to true, inactive records will be included. */
        includeInactiveFlag?: boolean;
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/hotels/${hotelId}/interfaceDataRequestSourceCode`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
     ...
     */
    getInterfaceDataRequestSourceGroupLov: (
      hotelId: string,
      query?: {
        /** Only useful for LOVs that support toggle of inactive records inclusion. When set to true, inactive records will be included. */
        includeInactiveFlag?: boolean;
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/hotels/${hotelId}/interfaceDataRequestSourceGroup`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getInterfacePseudoRoomLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/hotels/${hotelId}/interfacePseudoRoom`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
     ...
     */
    getInterfaceResyncFunctionSpaceLov: (
      hotelId: string,
      query?: {
        /** Only useful for LOVs that support toggle of inactive records inclusion. When set to true, inactive records will be included. */
        includeInactiveFlag?: boolean;
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/hotels/${hotelId}/interfaceResyncFunctionSpace`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
     ...
     */
    getInterfaceResyncOwnerContractLov: (
      hotelId: string,
      query?: {
        /** Only useful for LOVs that support toggle of inactive records inclusion. When set to true, inactive records will be included. */
        includeInactiveFlag?: boolean;
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/hotels/${hotelId}/interfaceResyncOwnerContract`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
     ...
     */
    getInterfaceResyncOwnerContractRoomLov: (
      hotelId: string,
      query?: {
        /** Only useful for LOVs that support toggle of inactive records inclusion. When set to true, inactive records will be included. */
        includeInactiveFlag?: boolean;
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/hotels/${hotelId}/interfaceResyncOwnerContractRoom`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getInterfaceResyncProductsLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/hotels/${hotelId}/interfaceResyncProducts`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
     ...
     */
    getInterfaceTrxCodesAllChargesLov: (
      hotelId: string,
      query?: {
        /** Only useful for LOVs that support toggle of inactive records inclusion. When set to true, inactive records will be included. */
        includeInactiveFlag?: boolean;
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/hotels/${hotelId}/interfaceTrxCodesAllCharges`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
     ...
     */
    getInterfaceTrxCodesMinibarLov: (
      hotelId: string,
      query?: {
        /** Only useful for LOVs that support toggle of inactive records inclusion. When set to true, inactive records will be included. */
        includeInactiveFlag?: boolean;
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/hotels/${hotelId}/interfaceTrxCodesMinibar`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
     ...
     */
    getAllowedHotelInterfaceRightsLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/hotels/${hotelId}/interfaceType/${interfaceType}/interfaceRowId/${interfaceRowId}/allowedHotelInterfaceRights`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getInvItemsClassesLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/hotels/${hotelId}/invItemsClasses`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getInvItemsPoolsLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/hotels/${hotelId}/invItemsPools`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
     ...
     */
    getInventoryItemTemplateItemsLov: (
      hotelId: string,
      query?: {
        /** Only useful for LOVs that support toggle of inactive records inclusion. When set to true, inactive records will be included. */
        includeInactiveFlag?: boolean;
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/hotels/${hotelId}/inventoryItemTemplateItems`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getItemClassesLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/hotels/${hotelId}/itemClasses`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getItemCodesLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/hotels/${hotelId}/itemCodes`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getInventoryItemAttributesLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/hotels/${hotelId}/itemId/${itemId}/inventoryItemAttributes`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getInventoryItemRatesLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/hotels/${hotelId}/itemId/${itemId}/inventoryItemRates`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getItemPriceCodeLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/hotels/${hotelId}/itemId/${itemId}/itemPriceCode`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getItemVendorLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/hotels/${hotelId}/itemId/${itemId}/itemVendor`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getJobTitlesLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/hotels/${hotelId}/jobTitles`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getKeyOptionsLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/hotels/${hotelId}/keyOptions`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getLicensesLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/hotels/${hotelId}/licenses`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getLocatorQuickTextsLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/hotels/${hotelId}/locatorQuickTexts`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
     ...
     */
    getHotelInterfaceDataLineTypesLov: (
      logo: string,
      hotelId: string,
      query?: {
        /** Only useful for LOVs that support toggle of inactive records inclusion. When set to true, inactive records will be included. */
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/hotels/${hotelId}/logo/${logo}/hotelInterfaceDataLineTypes`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getInterfaceRevenueCodeLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/hotels/${hotelId}/logo/${logo}/interfaceRevenueCode`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getManagerReportDetailsLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/hotels/${hotelId}/managerReportDetails`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getManagersReportsLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/hotels/${hotelId}/managersReports`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getMarketGroupsLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/hotels/${hotelId}/marketGroups`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getMarketSegmentLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/hotels/${hotelId}/marketSegment`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getMasterBlockLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/hotels/${hotelId}/masterBlock`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getMembershipAwardFinTrxLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/hotels/${hotelId}/membershipAwardFinTrx`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getMembershipAwardProductsLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/hotels/${hotelId}/membershipAwardProducts`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
     ...
     */
    getMembershipAwardRateCodesLov: (
      hotelId: string,
      query?: {
        /** Only useful for LOVs that support toggle of inactive records inclusion. When set to true, inactive records will be included. */
        includeInactiveFlag?: boolean;
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/hotels/${hotelId}/membershipAwardRateCodes`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
     ...
     */
    getMembershipAwardUpgradeRoomLov: (
      hotelId: string,
      query?: {
        /** Only useful for LOVs that support toggle of inactive records inclusion. When set to true, inactive records will be included. */
        includeInactiveFlag?: boolean;
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/hotels/${hotelId}/membershipAwardUpgradeRoom`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
     ...
     */
    getMembershipAwardUpgradeRoomGroupLov: (
      hotelId: string,
      query?: {
        /** Only useful for LOVs that support toggle of inactive records inclusion. When set to true, inactive records will be included. */
        includeInactiveFlag?: boolean;
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/hotels/${hotelId}/membershipAwardUpgradeRoomGroup`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getMenuClassesLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/hotels/${hotelId}/menuClasses`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getMenuItemsLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/hotels/${hotelId}/menuItems`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
     ...
     */
    getBusinessEventActionTypeExtDblov: (
      databaseId: string,
      extSystem: string,
      module: string,
      hotelId: string,
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/hotels/${hotelId}/module/${module}/extSystem/${extSystem}/databaseId/${databaseId}/businessEventActionTypeExtDB`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getFormatLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/hotels/${hotelId}/moduleName/${moduleName}/method/${method}/format`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getTestUpsellRulesRateCodeLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/hotels/${hotelId}/nights/${nights}/arrivalDate/${arrivalDate}/roomCategory/${roomCategory}/testUpsellRulesRateCode`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getOsaActivityTypesLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/hotels/${hotelId}/osaActivityTypes`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getOxiInterfaceReferencesLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/hotels/${hotelId}/oxiInterfaceReferences`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getOxiInterfaceResortsLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/hotels/${hotelId}/oxiInterfaceResorts`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getOxiInterfacesLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/hotels/${hotelId}/oxiInterfaces`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getPackForecastGroupCodeLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/hotels/${hotelId}/packForecastGroupCode`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getPaymentMethodsLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/hotels/${hotelId}/paymentMethods`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getPaymentTypesLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/hotels/${hotelId}/paymentTypes`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getPeriodSetupLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/hotels/${hotelId}/periodSetup`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getPeriodsSetupLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/hotels/${hotelId}/periodsSetup`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getDepositCancelRulesLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/hotels/${hotelId}/policyType/${policyType}/depositCancelRules`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getPostingRoomLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/hotels/${hotelId}/postingRoom`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getPostingTransactionCodesLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/hotels/${hotelId}/postingTransactionCodes`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getPrepaidCardInterfacesLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/hotels/${hotelId}/prepaidCardInterfaces`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getPrioritiesLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/hotels/${hotelId}/priorities`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getProfileIdentificationsLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/hotels/${hotelId}/profiles/${profileId}/profileIdentifications`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getPromoRatesLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/hotels/${hotelId}/promoCode/${promoCode}/promoRates`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getPromoGroupsLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/hotels/${hotelId}/promoGroups`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getPropertyAmenitiesLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/hotels/${hotelId}/propertyAmenities`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getRateCategoriesLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/hotels/${hotelId}/rateCategories`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
     ...
     */
    getRatePlansForYieldAsConfigLov: (
      rateCode: string,
      hotelId: string,
      query?: {
        /** Only useful for LOVs that support toggle of inactive records inclusion. When set to true, inactive records will be included. */
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/hotels/${hotelId}/rateCode/${rateCode}/ratePlansForYieldAsConfig`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getRateCodeGlobalDescEditLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/hotels/${hotelId}/rateCodeGlobalDescEdit`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getRateCodesByTypeLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/hotels/${hotelId}/rateCodeType/${rateCodeType}/rateCodesByType`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getRatePlanForMassRateLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/hotels/${hotelId}/rateCodeType/${rateCodeType}/ratePlanForMassRate`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getRateCodesValidLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/hotels/${hotelId}/rateCodesValid`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getRateCommissionCodesLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/hotels/${hotelId}/rateCommissionCodes`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getRateConfigCurrenciesLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/hotels/${hotelId}/rateConfigCurrencies`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getRateGroupsLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/hotels/${hotelId}/rateGroups`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getRoomTypesForMassRateLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/hotels/${hotelId}/ratePlanCodes/${ratePlanCodes}/roomTypesForMassRate`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getRatePlansLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/hotels/${hotelId}/ratePlans`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getApplicationModulesLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/hotels/${hotelId}/relModuleName/${relModuleName}/applicationModules`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getRepBlockCodesParamOffLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/hotels/${hotelId}/repBlockCodesParamOff`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getRepBlockCodesParamOnLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/hotels/${hotelId}/repBlockCodesParamOn`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getRepCashiersLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/hotels/${hotelId}/repCashiers`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getRepContactListLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/hotels/${hotelId}/repContactList`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getRepCurrenciesLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/hotels/${hotelId}/repCurrencies`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getRepDepartmentsLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/hotels/${hotelId}/repDepartments`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getRepFiscalYearsLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/hotels/${hotelId}/repFiscalYears`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getRepForeignCurrenciesLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/hotels/${hotelId}/repForeignCurrencies`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getRepGroupsLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/hotels/${hotelId}/repGroups`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getRepInventoryItemPoolsLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/hotels/${hotelId}/repInventoryItemPools`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getRepMarketCodesLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/hotels/${hotelId}/repMarketCodes`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getRepRoomStatusesLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/hotels/${hotelId}/repRoomStatuses`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getRepRoomTypesLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/hotels/${hotelId}/repRoomTypes`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getRepRoomsLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/hotels/${hotelId}/repRooms`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getRepServiceRequestCodesLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/hotels/${hotelId}/repServiceRequestCodes`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getRepTransactionCodesLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/hotels/${hotelId}/repTransactionCodes`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getRepTraveAgtCalendarYearLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/hotels/${hotelId}/repTraveAgtCalendarYear`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getReservationBasedBlocksLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/hotels/${hotelId}/reservationBasedBlocks`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
     ...
     */
    getReservationBasedProfilesLov: (
      hotelId: string,
      query?: {
        /** Only useful for LOVs that support toggle of inactive records inclusion. When set to true, inactive records will be included. */
        includeInactiveFlag?: boolean;
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/hotels/${hotelId}/reservationBasedProfiles`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getReservationPreferencesLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/hotels/${hotelId}/reservationPreferences`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
     ...
     */
    getReservationStatusesHotelLov: (
      hotelId: string,
      query?: {
        /** Only useful for LOVs that support toggle of inactive records inclusion. When set to true, inactive records will be included. */
        includeInactiveFlag?: boolean;
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/hotels/${hotelId}/reservationStatusesHotel`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getResortAirportsLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/hotels/${hotelId}/resortAirports`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getResortCrOsLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/hotels/${hotelId}/resortCROs`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getResortGuaranteeCodesLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/hotels/${hotelId}/resortGuaranteeCodes`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getResortMarketCodesLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/hotels/${hotelId}/resortMarketCodes`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
     ...
     */
    getStagedProfilePreferencesLov: (
      resortNameId: string,
      hotelId: string,
      query?: {
        /** Only useful for LOVs that support toggle of inactive records inclusion. When set to true, inactive records will be included. */
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/hotels/${hotelId}/resortNameId/${resortNameId}/stagedProfilePreferences`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getResortRateClassesLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/hotels/${hotelId}/resortRateClasses`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
     ...
     */
    getResortRestrictionStatusesLov: (
      hotelId: string,
      query?: {
        /** Only useful for LOVs that support toggle of inactive records inclusion. When set to true, inactive records will be included. */
        includeInactiveFlag?: boolean;
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/hotels/${hotelId}/resortRestrictionStatuses`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getResortRoomNumbersLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/hotels/${hotelId}/resortRoomNumbers`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getResortRoomTypesLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/hotels/${hotelId}/resortRoomTypes`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
     ...
     */
    getResortTransportationLabelsLov: (
      hotelId: string,
      query?: {
        /** Only useful for LOVs that support toggle of inactive records inclusion. When set to true, inactive records will be included. */
        includeInactiveFlag?: boolean;
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/hotels/${hotelId}/resortTransportationLabels`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getResourceItemClassesLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/hotels/${hotelId}/resourceItemClasses`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
     ...
     */
    getResvAutoAttachRulesCodesLov: (
      hotelId: string,
      query?: {
        /** Only useful for LOVs that support toggle of inactive records inclusion. When set to true, inactive records will be included. */
        includeInactiveFlag?: boolean;
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/hotels/${hotelId}/resvAutoAttachRulesCodes`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
     ...
     */
    getResvAutoAttachRulesRuleTypeLov: (
      hotelId: string,
      query?: {
        /** Only useful for LOVs that support toggle of inactive records inclusion. When set to true, inactive records will be included. */
        includeInactiveFlag?: boolean;
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/hotels/${hotelId}/resvAutoAttachRulesRuleType`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getResvBasedProfilesLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/hotels/${hotelId}/resvBasedProfiles`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getReservationTicketsLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/hotels/${hotelId}/resvNameId/${resvNameId}/reservationTickets`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
     ...
     */
    getResvTransactionDiversionCodesLov: (
      resvNameId: string,
      hotelId: string,
      query?: {
        /** Only useful for LOVs that support toggle of inactive records inclusion. When set to true, inactive records will be included. */
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/hotels/${hotelId}/resvNameId/${resvNameId}/resvTransactionDiversionCodes`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getRevenueTypeMappingSpaceLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/hotels/${hotelId}/revenueTypeMappingSpace`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
     ...
     */
    getRevenueTypeMappingTrxCodesLov: (
      hotelId: string,
      query?: {
        /** Only useful for LOVs that support toggle of inactive records inclusion. When set to true, inactive records will be included. */
        includeInactiveFlag?: boolean;
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/hotels/${hotelId}/revenueTypeMappingTrxCodes`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getUserRolesLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/hotels/${hotelId}/roleWithDepartment/${roleWithDepartment}/userRoles`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getAssignRoomsLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/hotels/${hotelId}/room/${room}/assignRooms`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getEventSetupStylesLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/hotels/${hotelId}/room/${room}/eventSetupStyles`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getRoomRatesLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/hotels/${hotelId}/room/${room}/roomRates`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getRoomClassCategoriesLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/hotels/${hotelId}/roomClassCategories`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getRoomClassesLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/hotels/${hotelId}/roomClasses`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getRoomFeaturesLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/hotels/${hotelId}/roomFeatures`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getRoomHoldConditionsLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/hotels/${hotelId}/roomHoldConditions`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getRoomMaintenanceLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/hotels/${hotelId}/roomMaintenance`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getConnectingSuitesLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/hotels/${hotelId}/roomNumber/${roomNumber}/connectingSuites`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getRoomPoolRoomTypesLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/hotels/${hotelId}/roomPool/${roomPool}/roomPoolRoomTypes`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getRoomPoolsLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/hotels/${hotelId}/roomPools`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getRoomRevenueTrxCodesLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/hotels/${hotelId}/roomRevenueTrxCodes`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getRoomRotationGroupsLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/hotels/${hotelId}/roomRotationGroups`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getRoomRotationUnitGradesLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/hotels/${hotelId}/roomRotationUnitGrades`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getRoomSpecialsLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/hotels/${hotelId}/roomSpecials`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getRoomingListHkRoomsLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/hotels/${hotelId}/roomType/${roomType}/arrival/${arrival}/departure/${departure}/roomingListHKRooms`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
     ...
     */
    getAvailableRoomTypeComponentsLov: (
      roomType: string,
      hotelId: string,
      query?: {
        /** Only useful for LOVs that support toggle of inactive records inclusion. When set to true, inactive records will be included. */
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/hotels/${hotelId}/roomType/${roomType}/availableRoomTypeComponents`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getAvailableRoomComponentsLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/hotels/${hotelId}/roomType/${roomType}/roomNumber/${roomNumber}/availableRoomComponents`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getFacilityTasksRoomTypeLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/hotels/${hotelId}/roomTypeLabel/${roomTypeLabel}/facilityTasksRoomType`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getRoomTypePoolLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/hotels/${hotelId}/roomTypePool`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getRoomTypesLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/hotels/${hotelId}/roomTypes`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getRoomsLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/hotels/${hotelId}/rooms`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getRoomsKeyGenerationLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/hotels/${hotelId}/roomsKeyGeneration`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getRoutingInstructionsLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/hotels/${hotelId}/routingInstructions`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getSalesManagerGoalPeriodLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/hotels/${hotelId}/salesManagerGoalPeriod`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getScheduledReportsExportLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/hotels/${hotelId}/scheduledReportsExport`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
     ...
     */
    getSitePlanSectionTypeLinksLov: (
      sectionType: string,
      hotelId: string,
      query?: {
        /** Only useful for LOVs that support toggle of inactive records inclusion. When set to true, inactive records will be included. */
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/hotels/${hotelId}/sectionType/${sectionType}/sitePlanSectionTypeLinks`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getForeignCurrenciesLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/hotels/${hotelId}/sell/${sell}/exchangeType/${exchangeType}/foreignCurrencies`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getInventoryItemsLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/hotels/${hotelId}/sellInReservation/${sellInReservation}/sellInEvent/${sellInEvent}/inventoryItems`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getResortInventoryItemsLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/hotels/${hotelId}/sellInReservation/${sellInReservation}/sellInEvent/${sellInEvent}/resortInventoryItems`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getServiceRequestCodesLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/hotels/${hotelId}/serviceRequestCodes`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getSetupStylesLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/hotels/${hotelId}/setupStyles`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getShiftReportsLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/hotels/${hotelId}/shiftReports`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getSitePlansLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/hotels/${hotelId}/siteType/${siteType}/sitePlans`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getCateringSetupStylesLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/hotels/${hotelId}/space/${space}/cateringSetupStyles`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getEventRateCodeLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/hotels/${hotelId}/space/${space}/eventRateCode`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getSpacesLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/hotels/${hotelId}/spaces`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getSpecialRequestsLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/hotels/${hotelId}/specialRequests`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getSpecialsLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/hotels/${hotelId}/specials`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getStoredValueRedeemTrxLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/hotels/${hotelId}/storedValueRedeemTrx`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getSummaryRefreshLogLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/hotels/${hotelId}/summaryRefreshLog`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getSubBlockLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/hotels/${hotelId}/superBlock/${superBlock}/subBlock`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getSynchronizeRateCodesLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/hotels/${hotelId}/synchronizeRateCodes`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getTaskSheetRoomsLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/hotels/${hotelId}/taskCode/${taskCode}/taskSheetNo/${taskSheetNo}/taskSheetRooms`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getTaxTransactionCodeLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/hotels/${hotelId}/taxCode/${taxCode}/taxTransactionCode`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getTaxTypesLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/hotels/${hotelId}/taxTypes`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getTelephoneCategoryLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/hotels/${hotelId}/telephoneCategory`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
     ...
     */
    getConfigDynamicBaseRatePlansLov: (
      currentRateCode: string,
      tiered: string,
      hotelId: string,
      query?: {
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/hotels/${hotelId}/tiered/${tiered}/currentRateCode/${currentRateCode}/configDynamicBaseRatePlans`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
     ...
     */
    getTransactionAdjustmentReasonCodesLov: (
      hotelId: string,
      query?: {
        /** Only useful for LOVs that support toggle of inactive records inclusion. When set to true, inactive records will be included. */
        includeInactiveFlag?: boolean;
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/hotels/${hotelId}/transactionAdjustmentReasonCodes`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getTransactionCodesLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/hotels/${hotelId}/transactionCodes`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
     ...
     */
    getTransactionCodesConsumptionLov: (
      hotelId: string,
      query?: {
        /** Only useful for LOVs that support toggle of inactive records inclusion. When set to true, inactive records will be included. */
        includeInactiveFlag?: boolean;
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/hotels/${hotelId}/transactionCodesConsumption`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getTransactionCodesPaymentLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/hotels/${hotelId}/transactionCodesPayment`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
     ...
     */
    getTransactionDeleteReasonCodesLov: (
      hotelId: string,
      query?: {
        /** Only useful for LOVs that support toggle of inactive records inclusion. When set to true, inactive records will be included. */
        includeInactiveFlag?: boolean;
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/hotels/${hotelId}/transactionDeleteReasonCodes`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
     ...
     */
    getTransactionDiversionRuleRoomsLov: (
      hotelId: string,
      query?: {
        /** Only useful for LOVs that support toggle of inactive records inclusion. When set to true, inactive records will be included. */
        includeInactiveFlag?: boolean;
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/hotels/${hotelId}/transactionDiversionRuleRooms`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getTransactionGroupsLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/hotels/${hotelId}/transactionGroups`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getTransactionSubgroupsLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/hotels/${hotelId}/transactionSubgroups`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getTransportTypesLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/hotels/${hotelId}/transportTypes`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getTransportTypesHotelLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/hotels/${hotelId}/transportTypesHotel`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getTravelAgentSourceLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/hotels/${hotelId}/travelAgentSource`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getTravelAgentSourceResvLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/hotels/${hotelId}/travelAgentSourceResv`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getTurnawayCodesLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/hotels/${hotelId}/turnawayCodes`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getUpsellDefaultTrxCodeLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/hotels/${hotelId}/upsellDefaultTrxCode`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getUpsellFromRoomClassEditLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/hotels/${hotelId}/upsellFromRoomClassEdit`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getUpsellFromRoomTypeEditLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/hotels/${hotelId}/upsellFromRoomTypeEdit`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getUpsellHierarchyLevelsLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/hotels/${hotelId}/upsellHierarchyLevels`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
     ...
     */
    getUpsellRateCategoriesEditLov: (
      hotelId: string,
      query?: {
        /** Only useful for LOVs that support toggle of inactive records inclusion. When set to true, inactive records will be included. */
        includeInactiveFlag?: boolean;
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/hotels/${hotelId}/upsellRateCategoriesEdit`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getUpsellRateCodesLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/hotels/${hotelId}/upsellRateCodes`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getUpsellRoomClassViewLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/hotels/${hotelId}/upsellRoomClassView`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getUpsellRoomTypeViewLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/hotels/${hotelId}/upsellRoomTypeView`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getUpsellRuleLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/hotels/${hotelId}/upsellRule`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getUpsellTrxCodesLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/hotels/${hotelId}/upsellTrxCodes`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getUserLogActivityGroupsLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/hotels/${hotelId}/userLogActivityGroups`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getYearSetupLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/hotels/${hotelId}/yearSetup`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getYieldMarketsLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/hotels/${hotelId}/yieldMarkets`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getRoomReservationStatusLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/includeDayUse/${includeDayUse}/roomReservationStatus`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getTemplatePreferencesLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/includeGlobals/${includeGlobals}/templatePreferences`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getTemplateMarketCodesLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/includeInactive/${includeInactive}/templateMarketCodes`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getTemplateMarketGroupsLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/includeInactive/${includeInactive}/templateMarketGroups`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getTemplateRoomClassesLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/includeInactive/${includeInactive}/templateRoomClasses`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getTemplateSourceCodesLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/includeInactive/${includeInactive}/templateSourceCodes`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getTemplateSourceGroupsLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/includeInactive/${includeInactive}/templateSourceGroups`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getAllRevenueTypesLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/interfaceId/${interfaceId}/allRevenueTypes`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getOxiResortsLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/interfaceId/${interfaceId}/oxiResorts`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
     ...
     */
    getExternalDatabaseAvailableResortsLov: (
      hotelId: string,
      databaseId: string,
      interfaceType: string,
      query?: {
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/interfaceType/${interfaceType}/databaseId/${databaseId}/externalDatabaseAvailableResorts`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getChannelParametersLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/levelCode/${levelCode}/levelType/${levelType}/settingName/${settingName}/channelCode/${channelCode}/channelParameters`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getApplicationSettingsLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/levelCode/${levelCode}/settingName/${settingName}/applicationSettings`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getTaskSheetDeptLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/levelCode/${levelCode}/taskSheetDept`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getDistributionTemplatesLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/locationType/${locationType}/location/${location}/distributionTemplates`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
     ...
     */
    getMembershipStatementBatchListLov: (
      hotelId: string,
      membershipId: string,
      query?: {
        /** Only useful for LOVs that support toggle of inactive records inclusion. When set to true, inactive records will be included. */
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/membershipId/${membershipId}/membershipStatementBatchList`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
     ...
     */
    getMembershipTotalPointsAvailableLov: (
      hotelId: string,
      membershipId: string,
      query?: {
        /** Only useful for LOVs that support toggle of inactive records inclusion. When set to true, inactive records will be included. */
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/membershipId/${membershipId}/membershipTotalPointsAvailable`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getMembershipCardFeeAmountLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/membershipLevel/${membershipLevel}/membershipCardFeeAmount`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
     ...
     */
    getMembershipMaxDowngradeLevelLov: (
      hotelId: string,
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/membershipLevelRank/${membershipLevelRank}/membershipType/${membershipType}/membershipMaxDowngradeLevel`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
     ...
     */
    getMembershipBenefitProgramLov: (
      hotelId: string,
      membershipType: string,
      query?: {
        /** Only useful for LOVs that support toggle of inactive records inclusion. When set to true, inactive records will be included. */
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/membershipType/${membershipType}/membershipBenefitProgram`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getMembershipBenefitsLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/membershipType/${membershipType}/membershipBenefits`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
     ...
     */
    getMembershipPointsRuleCodesLov: (
      hotelId: string,
      membershipType: string,
      query?: {
        /** Only useful for LOVs that support toggle of inactive records inclusion. When set to true, inactive records will be included. */
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/membershipType/${membershipType}/membershipPointsRuleCodes`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
     ...
     */
    getUpsellMembershipLevelsOnlyLov: (
      hotelId: string,
      membershipType: string,
      query?: {
        /** Only useful for LOVs that support toggle of inactive records inclusion. When set to true, inactive records will be included. */
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/membershipType/${membershipType}/upsellMembershipLevelsOnly`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getMenuLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/menuClassId/${menuClassId}/menu`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
     ...
     */
    getFolioGroupingTransactionCodesLov: (
      hotelId: string,
      mode: string,
      query?: {
        /** Only useful for LOVs that support toggle of inactive records inclusion. When set to true, inactive records will be included. */
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/mode/${mode}/folioGroupingTransactionCodes`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getActionTypesLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/module/${module}/actionTypes`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getReportsGenericLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/moduleId/${moduleId}/parameterName/${parameter}/reportsGeneric`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getConfigReportsLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/moduleName/${moduleName}/configReports`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getUdfMappingsLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/moduleName/${moduleName}/udfMappings`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
     ...
     */
    getProfileEnrollmentMatchCriteriaLov: (
      hotelId: string,
      nameType: string,
      query?: {
        /** Only useful for LOVs that support toggle of inactive records inclusion. When set to true, inactive records will be included. */
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/nameType/${nameType}/profileEnrollmentMatchCriteria`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
     ...
     */
    getProfileEnrollmentRuleDoNotMergeCriteriaLov: (
      hotelId: string,
      nameType: string,
      query?: {
        /** Only useful for LOVs that support toggle of inactive records inclusion. When set to true, inactive records will be included. */
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/nameType/${nameType}/profileEnrollmentRuleDoNotMergeCriteria`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
     ...
     */
    getProfileEnrollmentRuleFilterCriteriaLov: (
      hotelId: string,
      nameType: string,
      query?: {
        /** Only useful for LOVs that support toggle of inactive records inclusion. When set to true, inactive records will be included. */
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/nameType/${nameType}/profileEnrollmentRuleFilterCriteria`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getCateringEventStatusLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/newEvent/${newEvent}/waitList/${waitList}/cateringEventStatus`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getAutoNumberGeneratorLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/number/${number}/autoNumberGenerator`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
     ...
     */
    getProfileNameValidationsTypeLov: (
      hotelId: string,
      operaParam: string,
      query?: {
        /** Only useful for LOVs that support toggle of inactive records inclusion. When set to true, inactive records will be included. */
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/operaParam/${operaParam}/profileNameValidationsType`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getServiceNameLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/outboundType/${outboundType}/protocol/${protocol}/outboundServiceNames`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
     ...
     */
    getParameterActiveUnderChainLov: (
      hotelId: string,
      chainCode: string,
      parameter: string,
      query?: {
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/parameterName/${parameter}/chainCode/${chainCode}/parameterActiveUnderChain`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getRepCalendarYearsLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/period/${period}/repCalendarYears`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
     ...
     */
    getCateringPackageRevenueEventTypeLov: (
      hotelId: string,
      pkgId: string,
      query?: {
        /** Only useful for LOVs that support toggle of inactive records inclusion. When set to true, inactive records will be included. */
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/pkgId/${pkgId}/cateringPackageRevenueEventType`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
     ...
     */
    getCateringPackageRevenueConfigEventTypeLov: (
      hotelId: string,
      pkgLinkId: string,
      query?: {
        /** Only useful for LOVs that support toggle of inactive records inclusion. When set to true, inactive records will be included. */
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/pkgLinkId/${pkgLinkId}/cateringPackageRevenueConfigEventType`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
     ...
     */
    getDepositCancelRulesMultiHotelLov: (
      hotelId: string,
      policyType: string,
      query?: {
        /** Only useful for LOVs that support toggle of inactive records inclusion. When set to true, inactive records will be included. */
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/policyType/${policyType}/depositCancelRulesMultiHotel`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getTemplatePolicyCodesLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/policyType/${policyType}/templatePolicyCodes`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getPreferencesMultiHotelsLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/preferenceGroup/${preferenceGroup}/preferencesMultiHotels`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getClaimMembershipDetailsLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/profiles/${profileId}/claimMembershipDetails`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getHotelsForArProfileLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/profiles/${profileId}/hotelsForARProfile`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
     ...
     */
    getMembershipTransferPointsLov: (
      hotelId: string,
      profileId: string,
      query?: {
        /** Only useful for LOVs that support toggle of inactive records inclusion. When set to true, inactive records will be included. */
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/profiles/${profileId}/membershipTransferPoints`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getNegotiatedRateHotelsLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/profiles/${profileId}/negotiatedRateHotels`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getProfileCommunicationsLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/profiles/${profileId}/profileCommunications`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getProfileHotelsLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/profiles/${profileId}/taxTypeCheck/${taxTypeCheck}/profileHotels`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
     ...
     */
    getRoomHierarchyClassesCopyLov: (
      hotelId: string,
      property: string,
      query?: {
        /** Only useful for LOVs that support toggle of inactive records inclusion. When set to true, inactive records will be included. */
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/property/${property}/roomHierarchyClassesCopy`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
     ...
     */
    getRoomHierarchyRoomClassesLov: (
      hotelId: string,
      property: string,
      query?: {
        /** Only useful for LOVs that support toggle of inactive records inclusion. When set to true, inactive records will be included. */
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/property/${property}/roomHierarchyRoomClasses`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getRoomHierarchyRoomTypesLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/property/${property}/roomHierarchyRoomTypes`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getRoomHierarchyTypesCopyLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/property/${property}/roomHierarchyTypesCopy`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getRepRatePlansLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/propertyList/${propertyList}/repRatePlans`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getCateringPackageCodesLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/radioType/${radioType}/hotels/${hotelId}/cateringPackageCodes`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getNegotiatedRatesHotelsLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/rateCode/${rateCode}/profiles/${profileId}/negotiatedRatesHotels`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getRolesForLevelLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/roleLevel/${roleLevel}/levelCode/${levelCode}/rolesForLevel`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getOrganizationsLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/roles/${roles}/chainCode/${chainCode}/actionTask/${actionTask}/organizations`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getAddressFormatElementsLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/salesFormat/${salesFormat}/addressFormatElements`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getShiftReportsNoParamLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/shiftGroupId/${shiftGroupId}/shiftReportsNoParam`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getSitePlanSectionTypesLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/siteType/${siteType}/sitePlanSectionTypes`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getGlobalAlertFieldQueryLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/sourceId/${sourceId}/globalAlertFieldQuery`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getGlobalAlertOperatorLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/sourceIdIn/${sourceIdIn}/fieldType/${fieldType}/fieldName/${fieldName}/tableName/${tableName}/globalAlertOperator`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getMailGenericLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/sourceIdIn/${sourceIdIn}/mailGeneric`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getPublisherPropertiesLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/subscriber/${subscriber}/publisherProperties`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getInterfaceTabColumnsLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/tableName/${tableName}/interfaceTabColumns`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
     ...
     */
    getAutoTraceExpressionFieldsLov: (
      hotelId: string,
      traceGroup: string,
      tableName: string,
      query?: {
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/tableName/${tableName}/traceGroup/${traceGroup}/autoTraceExpressionFields`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
     ...
     */
    getTemplateFiscalFolioParametersLov: (
      hotelId: string,
      templateCode: string,
      query?: {
        /** Only useful for LOVs that support toggle of inactive records inclusion. When set to true, inactive records will be included. */
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/templateCode/${templateCode}/templateFiscalFolioParameters`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getArrangementCodesNumberLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/type/${type}/arrangementCodesNumber`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
     ...
     */
    getEnrollmentMatchCommunicationTypeLov: (
      hotelId: string,
      type: string,
      query?: {
        /** Only useful for LOVs that support toggle of inactive records inclusion. When set to true, inactive records will be included. */
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/type/${type}/enrollmentMatchCommunicationType`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getFolioGroupingCodesLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/type/${type}/folioGroupingCodes`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getRevenueBucketsLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/type/${type}/revenueBuckets`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getTrxCodeArrangementLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/type/${type}/trxCodeArrangement`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getUdfAttributesLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/udfType/${udfType}/udfCategory/${udfCategory}/udfAttributes`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getCroUsersLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/userId/${userId}/croUsers`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
     ...
     */
    validateListOfValues: (hotelId: string, validateListOfValues: ValidateListOfValues, params: RequestParams = {}) => {
      const headers = { ...params.headers, 'x-hotelid': hotelId };
      const newParams = { ...params, headers };
      return this.request<ValidateListOfValuesDetails, ExceptionDetailType>({
        path: `/listOfValues/validate`,
        method: 'PUT',
        body: validateListOfValues,
        type: ContentType.Json,
        format: 'json',
        ...newParams,
      });
    ...
    getTraceDateCalcLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/view/${view}/traceDateCalc`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getTraceFieldLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/view/${view}/traceField`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getRepCalendarMonthsLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/year/${year}/repCalendarMonths`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getRepCalendarWeeksLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/year/${year}/repCalendarWeeks`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getStatisticsYearsLov: (
      ...
      const newParams = { ...params, headers };
      return this.request<ListOfValues, ExceptionDetailType>({
        path: `/listOfValues/year/${year}/statisticsYears`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getListOfValues: (
      ...
      name:
        ...
        | 'AccountTypes'
        | 'AccumulatedBusinessEvtModuleType'
        | 'AccumulatedBusinessEvtStatusType'
        | 'ActivityClasses'
        | 'ActivityResults'
        | 'AddOnLicenses'
        | 'AddressDoctorModes'
        | 'AddressFormats'
        | 'AddressTypes'
        | 'AdjustmentCodeCalculationType'
        | 'AdjustmentCodes'
        | 'AirportTemplates'
        | 'AirportsMultiHotels'
        | 'AlertAreas'
        | 'AlertCodesMultiHotel'
        | 'AllCashiers'
        | 'AllNoteTypes'
        | 'AllProfileTypes'
        | 'AllotmentOrigins'
        | 'AlternateHotelDirections'
        | 'AlternateLanguageTitles'
        | 'AmenitiesMultiHotel'
        | 'AmenityTypes'
        | 'AppUsers'
        | 'ArticleCodesMultiHotel'
        | 'AssociatedCreditFoioType'
        | 'AttractionClasses'
        | 'AttractionsConfigMultiHotels'
        | 'AttractionsMultiHotel'
        | 'AuthorizerGroupsMultiHotel'
        | 'AutoFolioSettlementPreferences'
        | 'AutoFolioSettlementTypes'
        | 'AutoSettleRulesPaymentType'
        | 'AutomaticTranSchedulesFrequencyType'
        | 'AutomaticTranSchedulesModuleType'
        | 'AvailabilityType'
        | 'AvailableColumnsForExport'
        | 'AvailableExportSources'
        | 'AwardRateCodesMultiSel'
        | 'AwardTypes'
        | 'BankMaster'
        | 'BanquetForeignCurrency'
        | 'BanquetRevenueSummary'
        | 'BaseRounding'
        | 'BedTypeRequests'
        | 'BedTypes'
        | 'Beverages'
        | 'BillingAccountContractChannel'
        | 'BillingAccountContractChannelType'
        | 'BillingAccountContractFeeType'
        | 'BillingAccountContractFrequency'
        | 'BillingAccountContractPriceType'
        | 'BillingAccountContractTransactionType'
        | 'BillingAccountTypes'
        | 'BirGuestTypes'
        | 'BirthCountry'
        | 'BlockAllotmentCodes'
        ...
        | 'BlockOwners'
        | 'BlockRankings'
        | 'BlockRefusedBookingCodes'
        | 'BlockRefusedReasons'
        | 'BlockReservationMethods'
        | 'BlockStatusColor'
        | 'BlockStatuses'
        | 'BlockTraceCodes'
        | 'BookingChannelErrorCodes'
        | 'BookingChannels'
        | 'BookingNoteTypes'
        | 'BookingResponses'
        | 'BookingStatusCodes'
        ...
        | 'CashieringTransactionTypes'
        | 'Cashiers'
        | 'CashiersConfig'
        | 'CateringEventTypes'
        | 'CateringRevenueCodes'
        | 'CateringRevenueGroups'
        | 'CateringStatuses'
        | 'CertificateActivities'
        | 'CertificateStatus'
        | 'ChainInventoryItems'
        | 'ChainMaintenanceCodes'
        | 'ChainPackageCodes'
        | 'ChainRoomConditions'
        | 'ChainRoomStatusReasons'
        | 'ChainRoomTypes'
        | 'ChainTrackItTypes'
        | 'Chains'
        | 'ChannelBillingAccounts'
        | 'ChannelCardTypeMappingResort'
        | 'ChannelRateCode'
        | 'ChannelResortMappingGdsHost'
        | 'ChannelResortMappingResort'
        | 'Channels'
        | 'CityTaxRanges'
        | 'ClaimAdjustmentLimitCodes'
        | 'CollectingAgentTaxCodeSeq'
        | 'Colors'
        | 'CommissionCalculatedOnType'
        | 'CommissionPaidType'
        | 'CommissionPaymentActivityStatus'
        | 'CommissionPaymentMethods'
        | 'CommunicationMethods'
        | 'CommunicationMethodsEntDetail'
        | 'CommunicationMethodsSystemType'
        | 'CommunicationRoles'
        | 'CommunicationTypeEmail'
        | 'CommunicationTypePhone'
        | 'CommunicationTypeWeb'
        | 'CommunicationsLocale'
        | 'CompInHouse'
        | 'CompanyTypes'
        | 'CompetitionCodes'
        | 'CompositeResvStatuses'
        | 'ConfigModes'
        | 'ConfigTitles'
        | 'ContactMethod'
        | 'Container'
        ...
        | 'DefiniteStatus'
        | 'DeleteCharacterIndicator'
        | 'DeleteDateIndicator'
        | 'DeleteNumberIndicator'
        | 'DeliveryStatus'
        | 'DeltaMode'
        | 'DepartmentHotel'
        | 'DepartmentMenuItem'
        ...
        | 'ECertificateStatus'
        | 'ECertificateTypes'
        | 'EcertMembershipTypes'
        | 'EmailDeliveryFormats'
        | 'EmailFormats'
        | 'EmployeeEmails'
        | 'EndOfDayReportDestinations'
        | 'EnrollmentCodes'
        | 'EnrollmentMatchCommunicationName'
        | 'EntityDetails'
        | 'EntityHeaderDataTypes'
        | 'EntityHeaders'
        | 'EntryPoint'
        | 'EventActions'
        | 'EventChangeSources'
        ...
        | 'EventSpaceTypes'
        | 'EventTypes'
        | 'ExchangeServiceTaxCode'
        | 'ExportBucketCodes'
        | 'ExportColumnXMLTypes'
        | 'ExportCommonFields'
        | 'ExportEndPoints'
        | 'ExportMappingTypes'
        | 'ExternalDatabases'
        | 'ExternalSystemSubTypes'
        | 'ExternalSystems'
        | 'FITContractStatus'
        | 'FITContractTypes'
        | 'FeatureTypes'
        | 'FetchCount30rPlusValues'
        | 'FileTypes'
        | 'FiscalFolioParameters'
        | 'FiscalFolioProfileHandling'
        | 'FiscalGuestTypes'
        | 'FiscalOperations'
        | 'FiscalPartners'
        | 'FiscalRegionCodes'
        | 'FiscalServiceType'
        | 'FixedChargeFrequencyTypes'
        | 'FlaggedReasons'
        | 'FloorRequests'
        | 'FolioLegends'
        | 'FolioMessageMergeCodes'
        | 'FolioTypeReports'
        | 'FolioWindows'
        | 'ForeignCurrency'
        | 'ForeignCurrencyPosting'
        | 'Formula'
        | 'FullPurgeNoOfDays'
        | 'FunctionSpaceCodes'
        ...
        | 'GdsAmenities'
        | 'GdsCardTypes'
        | 'GdsConvAvailRateCodes'
        | 'GdsHostAndResortCombinedGuaranteeCodes'
        | 'GdsMarketingPolicyDetails'
        | 'GdsMarketingPolicyTypes'
        | 'GdsMarketingTransactionTypes'
        | 'GdsRateTypes'
        | 'GemItemClass'
        | 'GenderTypes'
        | 'GenerateRoundingMethod'
        | 'GenericRevenueTypes'
        | 'GlobalActionCodes'
        | 'GuaranteeCodes'
        | 'GuaranteeCodesMultiHotels'
        | 'GuestSecretQuestions'
        | 'GuestTypes'
        | 'HKStatus'
        | 'HkCreditRuleTravelTypes'
        | 'HoldReasons'
        | 'HotelCategories'
        | 'HotelContactRoleType'
        | 'HotelInterfaceIds'
        | 'HotelInterfaceMachine'
        | 'HotelInterfaceMenuType'
        | 'HotelInterfaceTypes'
        | 'HotelTypes'
        | 'Hotels'
        | 'HouseKeepingGroups'
        | 'HousekeepingCreditRuleTypes'
        | 'Hubs'
        | 'IdentificationCountry'
        | 'IdentificationRoleType'
        | 'IdentificationTypes'
        | 'ImageTypes'
        | 'ImportPostalCodesCountry'
        | 'InactiveHotels'
        | 'Industries'
        | 'InfluenceCodes'
        | 'IntegrationMessageErrorType'
        | 'Interests'
        | 'InterfaceCalcTrxCodes'
        | 'InterfaceCashCreditPosting'
        | 'InterfaceChargeScaling'
        | 'InterfaceDataRequestConfigLevel'
        | 'InterfaceDataRequestConfigType'
        | 'InterfaceDataRequestExchangeRate'
        | 'InterfaceDialedDigits'
        | 'InterfaceDifferencePosting'
        | 'InterfaceOriginCodes'
        | 'InterfacePostType'
        | 'InterfacePostingCodeSetup'
        | 'InterfacePostings'
        | 'InterfacePostingsAddInfo'
        | 'InterfacePrograms'
        | 'InterfaceReferenceField'
        | 'InterfaceResyncDatamartType'
        | 'InterfaceResyncOwnerContractStatus'
        | 'InterfaceSplitCode'
        | 'InterfaceSubtotalPosting'
        | 'InterfaceSystemType'
        | 'InterfaceType'
        | 'InterfaceWorkstationTerminals'
        | 'InterfaceWorkstationType'
        | 'InterfaceZeroPostings'
        | 'ItemPoolsClassCode'
        | 'ItemPoolsCode'
        | 'ItemRates'
        | 'JobTitlesMultiHotels'
        | 'KeepingCharacterIndicator'
        | 'KeepingDateIndicator'
        | 'KeepingNumberIndicator'
        | 'KeyPacketsReport'
        | 'KeywordTypes'
        | 'LanguageCodes'
        | 'Languages'
        ...
        | 'LongDateFormats'
        | 'LongitudeDirections'
        | 'LookupExternalDatabases'
        | 'MDSCustomValidators'
        | 'MailingActions'
        | 'MaintenanceCodes'
        | 'MaintenanceCodesMultiHotel'
        | 'ManagerReportUDFFields'
        | 'MarketCodePrintGroupType'
        | 'MarketCodes'
        | 'MarketCodesMultiHotels'
        | 'MarketGroupsMultiHotels'
        | 'MarketSegments'
        | 'MarketSelection'
        | 'MarketingCities'
        | 'MarketingCitiesMultiHotels'
        | 'MarketingCityTemplates'
        | 'MarketingRegions'
        | 'MarriottModeArrivalAlerts'
        | 'MealTypes'
        | 'MemberLetterList'
        | 'MembershipActions'
        | 'MembershipAwardDisplaySet'
        | 'MembershipAwardPointsValidityDuration'
        | 'MembershipAwards'
        | 'MembershipBasedOn'
        | 'MembershipBillingGroups'
        | 'MembershipCalculationPeriod'
        | 'MembershipCalendarGracePeriod'
        | 'MembershipCardValidationRules'
        | 'MembershipClaimActivity'
        | 'MembershipClaimApprovalStatus'
        | 'MembershipClaimApprovalStatusSearch'
        | 'MembershipClaimOrigins'
        | 'MembershipClaimRecordTypes'
        ...
        | 'MembershipExtractTypes'
        | 'MembershipLevelRuleType'
        | 'MembershipLevels'
        | 'MembershipMarketGroups'
        | 'MembershipMultipleRooms'
        | 'MembershipNumberOfYears'
        | 'MembershipPointsCalcAwards'
        | 'MembershipPointsCalculationCurrency'
        | 'MembershipPointsSchedule'
        | 'MembershipRateCodes'
        | 'MembershipRateGroupRateCodes'
        | 'MembershipRateGroups'
        | 'MembershipResortGroupCodes'
        | 'MembershipResortGroups'
        | 'MembershipRevenueGroups'
        | 'MembershipRevenueTypes'
        | 'MembershipRoomGrps'
        | 'MembershipStatementUDFSet'
        | 'MembershipStatuses'
        | 'MembershipTierAdministration'
        | 'MembershipTransactionCodes'
        | 'MembershipTransactionGroupCode'
        | 'MembershipTscHeader'
        | 'MembershipTypeRuleAppliesOn'
        | 'MembershipTypeRuleBasedOn'
        | 'MembershipTypeRulePointsRoundingFlags'
        | 'MembershipTypeRulePointsType'
        | 'MembershipTypeRuleTransactionCode'
        | 'MembershipTypeRuleTypes'
        | 'MembershipTypes'
        | 'MembershipTypesAndLevels'
        | 'MembershipUpgradeDowngradeCalendarPeriod'
        | 'MembrshipMarketGroupCodes'
        | 'MergeCodes'
        | 'Messages'
        | 'Modules'
        | 'MonthNames'
        ...
        | 'Newspapers'
        | 'NextBlockStatus'
        | 'NoShowPostingRuleValues'
        | 'NoShowPostingRules'
        | 'NoShowReservationTypes'
        | 'NoShowSourceCodes'
        | 'NoteActionTypes'
        | 'NoteGroups'
        | 'NotificationAreas'
        ...
        | 'OXIMessageTypes'
        | 'OXIMesssgeStatuses'
        | 'OXIProcessorLogsErrorType'
        | 'OXIProcessorLogsReviewType'
        | 'OperatorType'
        | 'Origins'
        ...
        | 'PackCodes'
        | 'PackageCodes'
        | 'PackageCodesMultiHotel'
        | 'PackageForecastGroupMultiHotel'
        | 'PackageForecastGroupTemplates'
        | 'PaperSize'
        | 'PastYears'
        | 'PayDays'
        | 'PaymentAuthorizationRules'
        | 'PaymentMethodValidationRules'
        | 'PaymentMethodsMultiHotel'
        | 'PaymentTaxTypes'
        | 'PaymentTransactionCodeType'
        | 'PercentageBaseCode'
        | 'PhoneTypes'
        | 'PillowTypes'
        | 'PostedTransactionTypes'
        | 'PostingRhythms'
        | 'PotentialForecastTypes'
        | 'PotentialFrequency'
        | 'PreRegistrationRuleTypes'
        | 'PreferenceTypes'
        | 'Preferences'
        | 'PreferencesView'
        | 'PrintTask'
        ...
        | 'ProductFeatures'
        | 'ProfileAccountTypes'
        | 'ProfileDistributionCountry'
        | 'ProfileDistributionDatabase'
        | 'ProfileDistributionFilter'
        | 'ProfileDistributionKeywordType'
        | 'ProfileDistributionRegion'
        | 'ProfileDistributionRoomLabel'
        | 'ProfileEnrollmentMatchRules'
        | 'ProfileIdCountries'
        | 'ProfileIdTypes'
        | 'ProfileInactiveReasons'
        | 'ProfileKeywordTypes'
        | 'ProfileLinkNameTypes'
        | 'ProfileMemberships'
        | 'ProfileRegions'
        | 'ProfileRelationships'
        | 'ProfileResortRegions'
        | 'ProfileRestrictionReasons'
        | 'ProfileViewBy'
        | 'PromoGroupTemplates'
        | 'PromotionCodeRegistration'
        | 'Promotions'
        | 'PropertyDayTypes'
        | 'PropertyDetailCategroy'
        | 'PropertyEventCodes'
        | 'PurposeOfStay'
        | 'RankingCodes'
        | 'RateCategoryMultiHotels'
        | 'RateCategoryTemplates'
        | 'RateClassTemplates'
        | 'RateClassesMultiHotels'
        | 'RateCodePostingRhythm'
        | 'RateCodes'
        | 'RateCodesGlobalDesc'
        | 'RateConfigExchangeTypes'
        | 'RateDisplaySets'
        | 'RateDisplaySetsConfiguration'
        | 'RateOverrideReasons'
        | 'RateOwnership'
        | 'RatePkgTrxCodes'
        | 'RatePlanSets'
        | 'RatePlansMultiHotel'
        | 'RateRoomCategory'
        | 'RateSeasonCodeTemplates'
        | 'RateSeasonCodes'
        | 'RateSeasonCodesMultiHotel'
        | 'RateStrategyConditionTypes'
        | 'RateTiers'
        | 'ReasonType'
        | 'ReceiptHistoryTypes'
        | 'ReferenceCurrency'
        ...
        | 'ReportFormats'
        | 'ReportGroups'
        | 'ReportParameterDataTypes'
        | 'ReportParameterForms'
        | 'ReportPrinters'
        | 'ReportServersList'
        | 'ReportTextConfiguration'
        | 'Reports'
        | 'ReportsToAttach'
        | 'RequirementCodes'
        | 'ResStatusWithGuaranteeCodes'
        | 'ReservationAgents'
        | 'ReservationChannels'
        | 'ReservationContactType'
        | 'ReservationGuestStatus'
        | 'ReservationImmigrationStatus'
        ...
        | 'ResortFeatures'
        | 'ResortNoteTypes'
        | 'ResortReservationTypes'
        | 'RestApiModules'
        | 'RestApiOperations'
        | 'ResvAutoAttachRulesBasedOn'
        | 'ResyncBlockCodes'
        | 'RevenueBucketTypes'
        | 'RevenueGroups'
        | 'RevenueTypes'
        ...
        | 'RoomClassMultiHotels'
        | 'RoomClassesTemplate'
        | 'RoomConditions'
        | 'RoomConditionsMultiHotels'
        | 'RoomFeatureRating'
        | 'RoomFeaturesAll'
        | 'RoomMaintenanceTemplates'
        | 'RoomMoveReasons'
        | 'RoomPool'
        | 'RoomPotential'
        | 'RoomPriorityRequests'
        | 'RoomRateAssignment'
        | 'RoomReadyStatus'
        | 'RoomRotationAdjustmentReasons'
        | 'RoomRotationOverrideReasons'
        | 'RoomSpecialRatings'
        | 'RoomStatus'
        | 'RoomStatusReasons'
        | 'RoomTypeRequests'
        ...
        | 'SCMailingActions'
        | 'SCPeriods'
        | 'SalesCateringEventStatus'
        | 'SalesScopeCities'
        | 'SalesScopes'
        | 'SampleDynamic'
        | 'ScannerDevice'
        | 'ScheduledActivitiesLocationCodes'
        | 'ScheduledActivitiesStatusCodes'
        | 'SellBy'
        ...
        | 'Snacks'
        | 'SourceCodes'
        | 'SourceCodesMultiHotels'
        | 'SourceGroupsMultiHotels'
        | 'Sources'
        | 'StagedProfileMembership'
        | 'StartDayOfWeek'
        | 'States'
        | 'StatisticsContactProfileRoles'
        | 'StatisticsCurrencyCodes'
        | 'StoredValueTransaction'
        | 'SynchronizeEventType'
        | 'SynchronizeExternalSystems'
        | 'SynchronizeReservationStatus'
        | 'TaxCategoryCodes'
        | 'TaxOffice'
        | 'TaxRangesType'
        | 'TaxTypesConfiguration'
        | 'TempExclusivePreferences'
        | 'TemplateAlertCodes'
        | 'TemplateAmenityCodes'
        | 'TemplateAttractionCodes'
        | 'TemplateDayTypeCodes'
        | 'TemplateDeviceLocations'
        | 'TemplateEventCodes'
        | 'TemplateGuestMessages'
        | 'TemplateJobTitles'
        | 'TemplateLocatorCodes'
        | 'TemplatePreferenceTypes'
        | 'TemplatePromotionCodes'
        | 'TemplatePromotionGroups'
        | 'TemplateRoomConditions'
        | 'TemplateTransactionCodes'
        | 'TemplateTransactionGroups'
        | 'TemplateTransportCodes'
        | 'TemplateTransportationLabels'
        | 'TemplateType'
        | 'Territories'
        | 'TimeFormats'
        | 'TimezoneRegions'
        | 'Titles'
        | 'TmplCashierShiftDropLocations'
        | 'TopBasedOn'
        | 'TraceCodes'
        | 'TraceGroups'
        | 'TraceStatuses'
        ...
        | 'TransactionCodesMultiHotel'
        | 'TransactionDiversionCodesMultiHotel'
        | 'TransactionDiversionLevels'
        | 'TransactionDiversionRuleTypes'
        | 'TransactionGroupsMultiHotel'
        | 'TransactionSubgroupsMultiHotel'
        | 'TransactionUsages'
        | 'TransactionUserGroupHotels'
        | 'TranslatedLanguages'
        | 'TranslationLanguageCode'
        | 'TransportTypesMultiHotels'
        | 'TravelAgentTypes'
        | 'TrxCodeConsumptionMultiHotel'
        | 'TrxServiceTypes'
        | 'TurnawayCodesMultiHotels'
        | 'TurnawayTemplateCode'
        | 'TurnawaysInterfaceResync'
        | 'UDFAttributesMultiHotels'
        | 'UdfTypes'
        | 'UpdateContactActivityStatus'
        | 'UpsellMarketCodes'
        | 'UpsellMembershipTypesEdit'
        | 'UpsellMembershipTypesOnly'
        | 'UpsellMembershipTypesView'
        ...
        | 'WaitlistPriorities'
        | 'WakeupCallStatuses'
        | 'WashScheduleMultiHotel'
        | 'YieldAdjustmentCodes'
        | 'YieldAdjustmentTypeValues'
        | 'YieldCategories'
        | 'YieldMarketsMultiHotel'
        | 'YieldableCodes',
      query?: {
        /** Only useful for LOVs that support toggle of inactive records inclusion. When set to true, inactive records will be included. */
        includeInactiveFlag?: boolean;
  ...
  services = {
     ...
     */
    pingLovService: (hotelId: string, params: RequestParams = {}) => {
      const headers = { ...params.headers, 'x-hotelid': hotelId };
      const newParams = { ...params, headers };
