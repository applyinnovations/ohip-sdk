...
export enum AutomaticTransmissionScheduleModuleTypeType {
  ARExport = 'ARExport',
  Block = 'Block',
  Inventory = 'Inventory',
...
export enum AutomaticTransmissionScheduleFrequencyTypeType {
  Daily = 'Daily',
  Weekly = 'Weekly',
  Monthly = 'Monthly',
  Yearly = 'Yearly',
...
export enum AccumulatedBusinessEventStatusType {
  New = 'New',
  Ready = 'Ready',
}
...
export enum ApplicationSettingTypeType {
  Function = 'Function',
  Parameter = 'Parameter',
  Setting = 'Setting',
}

export enum ApplicationSettingConversionType {
  Default = 'Default',
  Parameter = 'Parameter',
}
...
export enum ApplicationSettingLevelType {
  Global = 'Global',
  Hotel = 'Hotel',
  Cro = 'Cro',
}
...
/** Supported Exchange Interface statistical codes. */
export enum ExchangeStatCodeType {
  Success = 'Success',
  Failed = 'Failed',
  Warning = 'Warning',
  Total = 'Total',
...
/** Supported Exchange Interface report codes. */
export enum ExchangeStatReportCodeType {
...
export enum OXIMessageStatusType {
  Processed = 'Processed',
  Failed = 'Failed',
  Ready = 'Ready',
  Expired = 'Expired',
...
export enum InterfaceStatusProcessTypeType {
  NtService = 'NtService',
  DbmsJob = 'DbmsJob',
}

/** FileExport process. */
export enum InterfaceStatusProcessRoleType {
  Upload = 'Upload',
  Download = 'Download',
  Lookup = 'Lookup',
...
export enum ExchangeInterfaceStatusType {
  Running = 'Running',
  Stopped = 'Stopped',
  Exited = 'Exited',
...
export enum ExchangeInterfaceStatusCommandType {
  Start = 'Start',
  Stop = 'Stop',
  Exit = 'Exit',
...
export enum MatchAttributeTypeType {
...
export enum ExchangeProfileTypeType {
  Guest = 'Guest',
  Company = 'Company',
...
export class HttpClient<SecurityDataType = unknown> {
  ...
  constructor({ securityWorker, secure, format, ...axiosConfig }: ApiConfig<SecurityDataType> = {}) {
    this.instance = axios.create({ ...axiosConfig, baseURL: new URL('/oxi/v1', axiosConfig.baseURL).toString() });
    this.secure = secure;
    this.format = format;
...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
  automaticTransmissionSchedules = {
    ...
    postAutomaticTransmissionSchedules: (
      hotelId: string,
      automaticTransmissionSchedulesToBeCreated: AutomaticTransmissionSchedulesToBeCreated,
      ...
      return this.request<Status, ExceptionDetailType>({
        ...
        method: 'POST',
        body: automaticTransmissionSchedulesToBeCreated,
  ...
  communicationMethods = {
    ...
    putCommunicationMethods: (
      hotelId: string,
      communicationMethodsToBeChanged: CommunicationMethodsToBeChanged,
      params: RequestParams = {},
    ) => {
      const headers = { ...params.headers, 'x-hotelid': hotelId };
      const newParams = { ...params, headers };
      return this.request<ChangedCommunicationMethods, ExceptionDetailType>({
        path: `/communicationMethods`,
        method: 'PUT',
        body: communicationMethodsToBeChanged,
        type: ContentType.Json,
        format: 'json',
        ...newParams,
      });
  ...
  conversionCodeMappingId = {
     ...
     */
    deleteConversionCodeMappings: (hotelId: string, id: string, params: RequestParams = {}) => {
      const headers = { ...params.headers, 'x-hotelid': hotelId };
      const newParams = { ...params, headers };
      return this.request<Status, ExceptionDetailType>({
        path: `/conversionCodeMappingID/${id}/conversionCodeMapping`,
        method: 'DELETE',
        type: ContentType.Json,
        format: 'json',
        ...newParams,
  ...
  conversionCodesStatus = {
    ...
    putConversionCodesStatus: (
      hotelId: string,
      conversionCodesStatusToBeChanged: ConversionCodesStatusToBeChanged,
      params: RequestParams = {},
    ) => {
      const headers = { ...params.headers, 'x-hotelid': hotelId };
      const newParams = { ...params, headers };
      return this.request<ChangedConversionCodesStatus, ExceptionDetailType>({
        path: `/conversionCodesStatus`,
        method: 'PUT',
        body: conversionCodesStatusToBeChanged,
        type: ContentType.Json,
        format: 'json',
        ...newParams,
      });
  ...
  externalInterfaceSetups = {
    ...
    postExternalInterfaceSetups: (
      hotelId: string,
      externalInterfaceSetupsToBeCreated: ExternalInterfaceSetupsToBeCreated,
      params: RequestParams = {},
    ) => {
      const headers = { ...params.headers, 'x-hotelid': hotelId };
      const newParams = { ...params, headers };
      return this.request<Status, ExceptionDetailType>({
        ...
        method: 'POST',
        body: externalInterfaceSetupsToBeCreated,
        type: ContentType.Json,
        format: 'json',
        ...newParams,
      });
  ...
  hotels = {
    ...
    getIntegrationInboundMessages: (
      ...
      const headers = { ...params.headers, 'x-hotelid': hotelId };
      const newParams = { ...params, headers };
      return this.request<FetchIntegrationInboundMessages, ExceptionDetailType>({
        path: `/hotels/${externalHotelCode}/interfaces/${interfaceId}/integrationSystems/${integrationSystem}/integrationInboundMessages`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getAutomaticTransmissionSchedules: (
      ...
      const headers = { ...params.headers, 'x-hotelid': hotelId };
      const newParams = { ...params, headers };
      return this.request<FetchAutomaticTransmissionSchedules, ExceptionDetailType>({
        path: `/hotels/${hotelId}/automaticTransmissionSchedules`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    putAutomaticTransmissionSchedules: (
      hotelId: string,
      automaticTransmissionSchedulesToBeChanged: AutomaticTransmissionSchedulesToBeChanged,
      params: RequestParams = {},
    ) => {
      const headers = { ...params.headers, 'x-hotelid': hotelId };
      const newParams = { ...params, headers };
      return this.request<ChangedAutomaticTransmissionSchedules, ExceptionDetailType>({
        path: `/hotels/${hotelId}/automaticTransmissionSchedules`,
        method: 'PUT',
        body: automaticTransmissionSchedulesToBeChanged,
        type: ContentType.Json,
        format: 'json',
        ...newParams,
      });
    ...
    getConversionCodes: (
      ...
      const headers = { ...params.headers, 'x-hotelid': hotelId };
      const newParams = { ...params, headers };
      return this.request<FetchConversionCodes, ExceptionDetailType>({
        path: `/hotels/${hotelId}/intefaces/${interfaceId}/conversionCodes`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getAccumulatedBusinessEvents: (
      ...
      const headers = { ...params.headers, 'x-hotelid': hotelId };
      const newParams = { ...params, headers };
      return this.request<FetchAccumulatedBusinessEvents, ExceptionDetailType>({
        path: `/hotels/${hotelId}/interfaces/${interfaceId}/accumulatedBusinessEvents`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    putConversionCodeMappings: (
      ...
      interfaceId: string,
      hotelId: string,
      conversionCodeMappingsToBeChanged: ConversionCodeMappingsToBeChanged,
      params: RequestParams = {},
    ) => {
      const headers = { ...params.headers, 'x-hotelid': hotelId };
      const newParams = { ...params, headers };
      return this.request<ChangedConversionCodeMappings, ExceptionDetailType>({
        path: `/hotels/${hotelId}/interfaces/${interfaceId}/conversionCode/${conversionCode}/ID/${id}/operaValue/${operaValue}/externalValue/${externalValue}/conversionCodeMapping`,
        method: 'PUT',
        body: conversionCodeMappingsToBeChanged,
        type: ContentType.Json,
        format: 'json',
        ...newParams,
      });
    ...
    postConversionCodeMappings: (
      ...
      interfaceId: string,
      hotelId: string,
      conversionCodeMappingsToBeCreated: ConversionCodeMappingsToBeCreated,
      params: RequestParams = {},
    ) => {
      const headers = { ...params.headers, 'x-hotelid': hotelId };
      const newParams = { ...params, headers };
      return this.request<CreatedConversionCodeMappings, ExceptionDetailType>({
        path: `/hotels/${hotelId}/interfaces/${interfaceId}/conversionCode/${conversionCode}/operaValue/${operaValue}/externalValue/${externalValue}/conversionCodeMapping`,
        method: 'POST',
        body: conversionCodeMappingsToBeCreated,
        type: ContentType.Json,
        format: 'json',
        ...newParams,
      });
    ...
    deleteUdfMappings: (
      ...
      const newParams = { ...params, headers };
      return this.request<Status, ExceptionDetailType>({
        path: `/hotels/${hotelId}/interfaces/${interfaceId}/conversionCode/${conversionCode}/operaValue/${operaValue}/udfMapping`,
        method: 'DELETE',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getConversionCodeMappings: (
      ...
      const headers = { ...params.headers, 'x-hotelid': hotelId };
      const newParams = { ...params, headers };
      return this.request<FetchConversionCodeMappings, ExceptionDetailType>({
        path: `/hotels/${hotelId}/interfaces/${interfaceId}/conversions/${conversionCode}/conversionCodeMapping`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
     ...
     */
    deleteExternalInterfaceSetups: (interfaceId: string, hotelId: string, params: RequestParams = {}) => {
      const headers = { ...params.headers, 'x-hotelid': hotelId };
      const newParams = { ...params, headers };
      return this.request<Status, ExceptionDetailType>({
        path: `/hotels/${hotelId}/interfaces/${interfaceId}/externalInterfaceSetups`,
        method: 'DELETE',
        type: ContentType.Json,
        format: 'json',
        ...newParams,
    ...
    getIntegrationOutboundMessages: (
      ...
      const headers = { ...params.headers, 'x-hotelid': hotelId };
      const newParams = { ...params, headers };
      return this.request<FetchIntegrationOutboundMessages, ExceptionDetailType>({
        path: `/hotels/${hotelId}/interfaces/${interfaceId}/integrationSystems/${integrationSystem}/integrationOutboundMessages`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getInterfaceControls: (
      ...
      const headers = { ...params.headers, 'x-hotelid': hotelId };
      const newParams = { ...params, headers };
      return this.request<FetchInterfaceControls, ExceptionDetailType>({
        path: `/hotels/${hotelId}/interfaces/${interfaceId}/interfaceControls`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    deleteProfileMatchRules: (
      ...
      const newParams = { ...params, headers };
      return this.request<Status, ExceptionDetailType>({
        path: `/hotels/${hotelId}/interfaces/${interfaceId}/profiles/${profileType}/profileMatchRules`,
        method: 'DELETE',
        type: ContentType.Json,
        format: 'json',
        ...newParams,
    ...
    getMessageStatistics: (
      ...
      const headers = { ...params.headers, 'x-hotelid': hotelId };
      const newParams = { ...params, headers };
      return this.request<MessageStatistics, ExceptionDetailType>({
        path: `/hotels/${hotelId}/messageStatistics`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getOxiMessageStatistics: (
      ...
      const headers = { ...params.headers, 'x-hotelid': hotelId };
      const newParams = { ...params, headers };
      return this.request<OXIMessageStatistics, ExceptionDetailType>({
        path: `/hotels/${hotelId}/queues/${queueName}/messageStatistics`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
  ...
  intefaces = {
    ...
    getCommunicationMethods: (
      ...
      const headers = { ...params.headers, 'x-hotelid': hotelId };
      const newParams = { ...params, headers };
      return this.request<FetchCommunicationMethods, ExceptionDetailType>({
        path: `/intefaces/${interfaceId}/communicationMethods`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
  ...
  interfaceSetups = {
    ...
    getExternalInterfaceSetups: (
      ...
      const headers = { ...params.headers, 'x-hotelid': hotelId };
      const newParams = { ...params, headers };
      return this.request<FetchExternalInterfaceSetups, ExceptionDetailType>({
    ...
    putExternalInterfaceSetups: (
      hotelId: string,
      externalInterfaceSetupsToBeChanged: ExternalInterfaceSetupsToBeChanged,
      params: RequestParams = {},
    ) => {
      const headers = { ...params.headers, 'x-hotelid': hotelId };
      const newParams = { ...params, headers };
      return this.request<ChangedExternalInterfaceSetups, ExceptionDetailType>({
        path: `/interfaceSetups`,
        method: 'PUT',
        body: externalInterfaceSetupsToBeChanged,
        type: ContentType.Json,
        format: 'json',
        ...newParams,
      });
  ...
  interfaces = {
    ...
    dequeueOxiMessages: (
      ...
      const newParams = { ...params, headers };
      return this.request<Status, ExceptionDetailType>({
        path: `/interfaces/${interfaceId}/hotels/${hotelId}/queues/${queueName}/dequeueOXIMessages`,
        method: 'DELETE',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    putInterfaceControls: (
      hotelId: string,
      interfaceId: string,
      interfaceControlsToBeChanged: InterfaceControlsToBeChanged,
      params: RequestParams = {},
    ) => {
      const headers = { ...params.headers, 'x-hotelid': hotelId };
      const newParams = { ...params, headers };
      return this.request<ChangedInterfaceControls, ExceptionDetailType>({
        path: `/interfaces/${interfaceId}/interfaceControls`,
        method: 'PUT',
        body: interfaceControlsToBeChanged,
        type: ContentType.Json,
        format: 'json',
        ...newParams,
      });
     ...
     */
    getLegacyInterfaceStatus: (hotelId: string, interfaceId: string, params: RequestParams = {}) => {
      const headers = { ...params.headers, 'x-hotelid': hotelId };
      const newParams = { ...params, headers };
      return this.request<LegacyInterfaceStatusDetails, ExceptionDetailType>({
        path: `/interfaces/${interfaceId}/legacyInterfaceStatus`,
        method: 'GET',
        type: ContentType.Json,
        format: 'json',
        ...newParams,
    ...
    getProfileMatchRules: (
      ...
      const headers = { ...params.headers, 'x-hotelid': hotelId };
      const newParams = { ...params, headers };
      return this.request<FetchProfileMatchRules, ExceptionDetailType>({
        path: `/interfaces/${interfaceId}/profileMatchRules`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
  ...
  lovCode = {
    ...
    getOxiListOfValues: (
      ...
      const headers = { ...params.headers, 'x-hotelid': hotelId };
      const newParams = { ...params, headers };
      return this.request<FetchOXIListOfValues, ExceptionDetailType>({
        path: `/lovCode/${lovCode}/listOfValuesOXI`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
  ...
  messages = {
     ...
     */
    deleteAutomaticTransmissionSchedules: (hotelId: string, messageId: string, params: RequestParams = {}) => {
      const headers = { ...params.headers, 'x-hotelid': hotelId };
      const newParams = { ...params, headers };
      return this.request<Status, ExceptionDetailType>({
        path: `/messages/${messageId}/automaticTransmissionSchedules`,
        method: 'DELETE',
        type: ContentType.Json,
        format: 'json',
        ...newParams,
    ...
    getIntegrationMessageAttachments: (
      ...
      const headers = { ...params.headers, 'x-hotelid': hotelId };
      const newParams = { ...params, headers };
      return this.request<FetchIntegrationMessageAttachments, ExceptionDetailType>({
        path: `/messages/${messageId}/integrationMessageAttachments`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
  ...
  profileMatchRules = {
    ...
    postProfileMatchRules: (
      hotelId: string,
      profileMatchRulesToBeCreated: ProfileMatchRulesToBeCreated,
      params: RequestParams = {},
    ) => {
      const headers = { ...params.headers, 'x-hotelid': hotelId };
      const newParams = { ...params, headers };
      return this.request<Status, ExceptionDetailType>({
        ...
        method: 'POST',
        body: profileMatchRulesToBeCreated,
        type: ContentType.Json,
        format: 'json',
        ...newParams,
      });
    ...
    putProfileMatchRules: (
      hotelId: string,
      profileMatchRulesToBeChanged: ProfileMatchRulesToBeChanged,
      params: RequestParams = {},
    ) => {
      const headers = { ...params.headers, 'x-hotelid': hotelId };
      const newParams = { ...params, headers };
      return this.request<ChangedProfileMatchRules, ExceptionDetailType>({
        path: `/profileMatchRules`,
        method: 'PUT',
        body: profileMatchRulesToBeChanged,
        type: ContentType.Json,
        format: 'json',
        ...newParams,
      });
