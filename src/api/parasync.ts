...
export class HttpClient<SecurityDataType = unknown> {
  ...
  constructor({ securityWorker, secure, format, ...axiosConfig }: ApiConfig<SecurityDataType> = {}) {
    this.instance = axios.create({ ...axiosConfig, baseURL: new URL('/par/async/v1', axiosConfig.baseURL).toString() });
    this.secure = secure;
    this.format = format;
...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
  externalSystems = {
    ...
    postRestrictionsProcess: (
      ...
      return this.request<Links, ExceptionDetailType>({
        path: `/externalSystems/${extSystemCode}/hotels/${hotelId}/restrictions`,
        method: 'POST',
        body: restrictions,
    ...
    getRestrictionsProcessStatus: (
      ...
      return this.request<void, void>({
        path: `/externalSystems/${extSystemCode}/hotels/${hotelId}/restrictions/${requestId}`,
        method: 'HEAD',
        type: ContentType.Json,
        ...newParams,
      });
     ...
     */
    getRestrictions: (hotelId: string, extSystemCode: string, requestId: string, params: RequestParams = {}) => {
      const headers = { ...params.headers, 'x-hotelid': hotelId };
      const newParams = { ...params, headers };
      return this.request<RestrictionsStatus, ExceptionDetailType>({
        path: `/externalSystems/${extSystemCode}/hotels/${hotelId}/restrictions/${requestId}`,
        method: 'GET',
        type: ContentType.Json,
        format: 'json',
