...
export enum CalendarTaskClassType {
...
export class HttpClient<SecurityDataType = unknown> {
  ...
  constructor({ securityWorker, secure, format, ...axiosConfig }: ApiConfig<SecurityDataType> = {}) {
    this.instance = axios.create({ ...axiosConfig, baseURL: new URL('/cms/v1', axiosConfig.baseURL).toString() });
    this.secure = secure;
    this.format = format;
...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
  activities = {
    ...
    getCalendarTasks: (
      ...
      return this.request<CalendarTasks, ExceptionDetailType>({
    ...
    getCalendarTask: (
      ...
      const headers = { ...params.headers, 'x-hotelid': hotelId };
      const newParams = { ...params, headers };
      return this.request<CalendarTask, ExceptionDetailType>({
        path: `/activities/${activityId}/task`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
  ...
  hotels = {
     ...
     */
    postCalendarTask: (hotelId: string, calendarTask: CalendarTask, params: RequestParams = {}) => {
      const headers = { ...params.headers, 'x-hotelid': hotelId };
      const newParams = { ...params, headers };
      return this.request<Status, ExceptionDetailType>({
        path: `/hotels/${hotelId}/activities/task`,
        method: 'POST',
        body: calendarTask,
        type: ContentType.Json,
        format: 'json',
    ...
    getCalendarTaskAttachments: (
      ...
      const headers = { ...params.headers, 'x-hotelid': hotelId };
      const newParams = { ...params, headers };
      return this.request<CalendarTaskAttachments, ExceptionDetailType>({
        path: `/hotels/${hotelId}/activities/tasks/${taskId}/attachments`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
     ...
     */
    putCalendarTask: (activityId: string, hotelId: string, calendarTask: CalendarTask, params: RequestParams = {}) => {
      const headers = { ...params.headers, 'x-hotelid': hotelId };
      const newParams = { ...params, headers };
      return this.request<CalendarTask, ExceptionDetailType>({
        path: `/hotels/${hotelId}/activities/${activityId}/task`,
        method: 'PUT',
        body: calendarTask,
        type: ContentType.Json,
        format: 'json',
     ...
     */
    deleteCalendarTask: (activityId: string, hotelId: string, params: RequestParams = {}) => {
      const headers = { ...params.headers, 'x-hotelid': hotelId };
      const newParams = { ...params, headers };
      return this.request<Status, ExceptionDetailType>({
        path: `/hotels/${hotelId}/activities/${activityId}/task`,
     ...
     */
    postTrackItItems: (hotelId: string, trackItItems: TrackItItems, params: RequestParams = {}) => {
      const headers = { ...params.headers, 'x-hotelid': hotelId };
      const newParams = { ...params, headers };
      return this.request<Status, ExceptionDetailType>({
        path: `/hotels/${hotelId}/trackItems`,
        method: 'POST',
        body: trackItItems,
        type: ContentType.Json,
        format: 'json',
     ...
     */
    putTrackItItems: (hotelId: string, trackItItems: TrackItItems, params: RequestParams = {}) => {
      const headers = { ...params.headers, 'x-hotelid': hotelId };
      const newParams = { ...params, headers };
      return this.request<TrackItItems, ExceptionDetailType>({
        path: `/hotels/${hotelId}/trackItems`,
        method: 'PUT',
        body: trackItItems,
        type: ContentType.Json,
  ...
  services = {
     ...
     */
    deleteCustomerManagementServiceCache: (hotelId: string, params: RequestParams = {}) => {
      const headers = { ...params.headers, 'x-hotelid': hotelId };
      const newParams = { ...params, headers };
      return this.request<Status, ExceptionDetailType>({
     ...
     */
    pingCustomerManagementService: (hotelId: string, params: RequestParams = {}) => {
      const headers = { ...params.headers, 'x-hotelid': hotelId };
      const newParams = { ...params, headers };
