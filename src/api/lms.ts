...
export enum LocationNotificationStatus {
  Set = 'Set',
  Clear = 'Clear',
  Other = 'Other',
}
...
export class HttpClient<SecurityDataType = unknown> {
  ...
  constructor({ securityWorker, secure, format, ...axiosConfig }: ApiConfig<SecurityDataType> = {}) {
    this.instance = axios.create({ ...axiosConfig, baseURL: new URL('/lms/v1', axiosConfig.baseURL).toString() });
    this.secure = secure;
    this.format = format;
...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
  activityLocations = {
    ...
    getActivityLocations: (
      ...
      const headers = { ...params.headers, 'x-hotelid': hotelId };
      const newParams = { ...params, headers };
      return this.request<FetchActivityLocations, ExceptionDetailType>({
        path: `/activityLocations`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
    ...
    putActivityLocations: (
      ...
      const headers = { ...params.headers, 'x-hotelid': hotelId };
      const newParams = { ...params, headers };
      return this.request<ChangeActivityLocationsRS, ExceptionDetailType>({
        path: `/activityLocations/${activityLocationsId}`,
        method: 'PUT',
        body: changeActivityLocations,
        type: ContentType.Json,
        format: 'json',
        ...newParams,
      });
    ...
    copyActivityLocations: (
      ...
      const headers = { ...params.headers, 'x-hotelid': hotelId };
      const newParams = { ...params, headers };
      return this.request<CopyActivityLocationsRS, ExceptionDetailType>({
        path: `/activityLocations/${activityLocationsId}/copy`,
        method: 'PUT',
        body: copyActivityLocations,
        type: ContentType.Json,
        format: 'json',
        ...newParams,
      });
  ...
  activityStatusCodes = {
    ...
    postActivityStatusCodes: (
      ...
      return this.request<Status, ExceptionDetailType>({
        ...
        method: 'POST',
        body: createActivityStatusCodes,
        type: ContentType.Json,
        format: 'json',
        ...newParams,
      });
    ...
    getActivityStatusCodes: (
      ...
      const headers = { ...params.headers, 'x-hotelid': hotelId };
      const newParams = { ...params, headers };
      return this.request<FetchActivityStatusCodes, ExceptionDetailType>({
        path: `/activityStatusCodes`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
    ...
    putActivityStatusCodes: (
      ...
      const headers = { ...params.headers, 'x-hotelid': hotelId };
      const newParams = { ...params, headers };
      return this.request<ChangeActivityStatusCodesRS, ExceptionDetailType>({
        path: `/activityStatusCodes/${activityStatusCodesId}`,
        method: 'PUT',
        body: changeActivityStatusCodes,
        type: ContentType.Json,
        format: 'json',
        ...newParams,
      });
  ...
  activityTypes = {
    ...
    getActivityTypes: (
      ...
      const headers = { ...params.headers, 'x-hotelid': hotelId };
      const newParams = { ...params, headers };
      return this.request<FetchActivityTypes, ExceptionDetailType>({
        path: `/activityTypes`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
     ...
     */
    postActivityTypes: (hotelId: string, createActivityTypes: CreateActivityTypes, params: RequestParams = {}) => {
      const headers = { ...params.headers, 'x-hotelid': hotelId };
      const newParams = { ...params, headers };
      return this.request<Status, ExceptionDetailType>({
        path: `/activityTypes`,
        method: 'POST',
        body: createActivityTypes,
        type: ContentType.Json,
        format: 'json',
        ...newParams,
      });
    ...
    putActivityTypes: (
      ...
      const headers = { ...params.headers, 'x-hotelid': hotelId };
      const newParams = { ...params, headers };
      return this.request<ChangeActivityTypesRS, ExceptionDetailType>({
        path: `/activityTypes/${activityTypesId}`,
        method: 'PUT',
        body: changeActivityTypes,
        type: ContentType.Json,
        format: 'json',
        ...newParams,
      });
    ...
    copyActivityTypes: (
      ...
      const headers = { ...params.headers, 'x-hotelid': hotelId };
      const newParams = { ...params, headers };
      return this.request<CopyActivityTypesRS, ExceptionDetailType>({
        path: `/activityTypes/${activityTypesId}/copy`,
        method: 'PUT',
        body: copyActivityTypes,
        type: ContentType.Json,
        format: 'json',
        ...newParams,
      });
  ...
  hotels = {
    ...
    getActivityBookings: (
      ...
      const headers = { ...params.headers, 'x-hotelid': hotelId };
      const newParams = { ...params, headers };
      return this.request<ActivityBookingsDetails, ExceptionDetailType>({
        path: `/hotels/${hotelId}/activityBookings`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    postActivityBooking: (
      ...
      const newParams = { ...params, headers };
      return this.request<Status, ExceptionDetailType>({
        path: `/hotels/${hotelId}/reservations/${reservationId}/activityBookings`,
        method: 'POST',
        body: createActivityBooking,
        type: ContentType.Json,
        format: 'json',
        ...newParams,
      });
    ...
    putActivityBooking: (
      ...
      const headers = { ...params.headers, 'x-hotelid': hotelId };
      const newParams = { ...params, headers };
      return this.request<ActivityBookingModified, ExceptionDetailType>({
        path: `/hotels/${hotelId}/reservations/${reservationId}/activityBookings`,
        method: 'PUT',
        body: changeActivityBooking,
        type: ContentType.Json,
        format: 'json',
        ...newParams,
      });
    ...
    postLocationNotification: (
      ...
      const newParams = { ...params, headers };
      return this.request<Status, ExceptionDetailType>({
        path: `/hotels/${hotelId}/reservations/${reservationId}/locationNotifications`,
        method: 'POST',
        body: locationNotificationToBeCreated,
        type: ContentType.Json,
        format: 'json',
        ...newParams,
      });
  ...
  services = {
     ...
     */
    deleteLeisureManagementServiceCache: (hotelId: string, params: RequestParams = {}) => {
      const headers = { ...params.headers, 'x-hotelid': hotelId };
      const newParams = { ...params, headers };
      return this.request<Status, ExceptionDetailType>({
     ...
     */
    pingLeisureManagementService: (hotelId: string, params: RequestParams = {}) => {
      const headers = { ...params.headers, 'x-hotelid': hotelId };
      const newParams = { ...params, headers };
     ...
     */
    deleteLeisureManagementConfigCache: (hotelId: string, params: RequestParams = {}) => {
      const headers = { ...params.headers, 'x-hotelid': hotelId };
      const newParams = { ...params, headers };
      return this.request<Status, ExceptionDetailType>({
     ...
     */
    getLeisureManagementConfigServicesStatus: (hotelId: string, params: RequestParams = {}) => {
      const headers = { ...params.headers, 'x-hotelid': hotelId };
      const newParams = { ...params, headers };
      return this.request<OperaVersion, ExceptionDetailType>({
