...
/** Used for Room code type. eg. Code="RoomType" or "RoomClass" */
export enum RoomCodeCategoryType {
  RoomType = 'RoomType',
  RoomClass = 'RoomClass',
}
...
export class HttpClient<SecurityDataType = unknown> {
  ...
  constructor({ securityWorker, secure, format, ...axiosConfig }: ApiConfig<SecurityDataType> = {}) {
    this.instance = axios.create({ ...axiosConfig, baseURL: new URL('/inv/v1', axiosConfig.baseURL).toString() });
    this.secure = secure;
    this.format = format;
...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
  hotels = {
    ...
    getBlockInventoryStatistics: (
      ...
      return this.request<BlockInventoryStatistic, ExceptionDetailType>({
        path: `/hotels/${hotelId}/blockInventoryStatistics`,
        method: 'GET',
        query: query,
    ...
    getHotelInventory: (
      ...
      const headers = { ...params.headers, 'x-hotelid': hotelId };
      const newParams = { ...params, headers };
      return this.request<HotelInventory, ExceptionDetailType>({
        path: `/hotels/${hotelId}/hotelInventory`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getInventoryStatistics: (
      ...
      const headers = { ...params.headers, 'x-hotelid': hotelId };
      const newParams = { ...params, headers };
      return this.request<InventoryStatistics, ExceptionDetailType>({
        path: `/hotels/${hotelId}/inventoryStatistics`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getItemInventory: (
      ...
      const headers = { ...params.headers, 'x-hotelid': hotelId };
      const newParams = { ...params, headers };
      return this.request<ItemInventory, ExceptionDetailType>({
        path: `/hotels/${hotelId}/itemInventory`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
     ...
     */
    postHoldItemInventory: (hotelId: string, holdItemInventory: HoldItemInventory, params: RequestParams = {}) => {
      const headers = { ...params.headers, 'x-hotelid': hotelId };
      const newParams = { ...params, headers };
      return this.request<Status, ExceptionDetailType>({
        path: `/hotels/${hotelId}/itemInventoryHold`,
        method: 'POST',
        body: holdItemInventory,
        type: ContentType.Json,
        format: 'json',
        ...newParams,
      });
    ...
    getHoldItemsInventory: (
      ...
      const headers = { ...params.headers, 'x-hotelid': hotelId };
      const newParams = { ...params, headers };
      return this.request<HoldItemsInventory, ExceptionDetailType>({
        path: `/hotels/${hotelId}/itemInventoryHold`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
     ...
     */
    putHoldItemsInventory: (hotelId: string, holdItemInventory: HoldItemInventory, params: RequestParams = {}) => {
      const headers = { ...params.headers, 'x-hotelid': hotelId };
      const newParams = { ...params, headers };
      return this.request<HoldItemInventory, ExceptionDetailType>({
        path: `/hotels/${hotelId}/itemInventoryHold`,
        method: 'PUT',
        body: holdItemInventory,
        type: ContentType.Json,
     ...
     */
    changeSellLimitByDate: (hotelId: string, sellLimit: SellLimit, params: RequestParams = {}) => {
      const headers = { ...params.headers, 'x-hotelid': hotelId };
      const newParams = { ...params, headers };
      return this.request<SellLimitResponse, ExceptionDetailType>({
        path: `/hotels/${hotelId}/sellLimits`,
        method: 'PUT',
        body: sellLimit,
        type: ContentType.Json,
        format: 'json',
     ...
     */
    changeSellLimitByDateRange: (hotelId: string, sellLimitByRange: SellLimitByRange, params: RequestParams = {}) => {
      const headers = { ...params.headers, 'x-hotelid': hotelId };
      const newParams = { ...params, headers };
      return this.request<SellLimitByDateResponse, ExceptionDetailType>({
        path: `/hotels/${hotelId}/sellLimitsByDateRange`,
        method: 'PUT',
        body: sellLimitByRange,
        type: ContentType.Json,
        format: 'json',
        ...newParams,
      });
  ...
  releasedItemInventory = {
    ...
    putItemInventoryHold: (
      ...
      const headers = { ...params.headers, 'x-hotelid': hotelId };
      const newParams = { ...params, headers };
      return this.request<ReleasedItemInventoryHeld, ExceptionDetailType>({
        path: `/releasedItemInventory`,
        method: 'PUT',
        body: releaseItemInventoryHold,
        type: ContentType.Json,
        format: 'json',
        ...newParams,
      });
  ...
  services = {
     ...
     */
    deleteinvStatsService: (hotelId: string, params: RequestParams = {}) => {
      const headers = { ...params.headers, 'x-hotelid': hotelId };
      const newParams = { ...params, headers };
      return this.request<Status, ExceptionDetailType>({
     ...
     */
    pinginvStatsService: (hotelId: string, params: RequestParams = {}) => {
      const headers = { ...params.headers, 'x-hotelid': hotelId };
      const newParams = { ...params, headers };
      return this.request<PingDetail, ExceptionDetailType>({
     ...
     */
    deleteInventoryServiceCache: (hotelId: string, params: RequestParams = {}) => {
      const headers = { ...params.headers, 'x-hotelid': hotelId };
      const newParams = { ...params, headers };
      return this.request<Status, ExceptionDetailType>({
     ...
     */
    pingInventoryService: (hotelId: string, params: RequestParams = {}) => {
      const headers = { ...params.headers, 'x-hotelid': hotelId };
      const newParams = { ...params, headers };
      return this.request<PingDetail, ExceptionDetailType>({
