...
export enum LinkedProfileTypeType {
  Company = 'Company',
  Agent = 'Agent',
  Source = 'Source',
...
/** Supported activity statistical codes. */
export enum ActivityStatCodeType {
...
/** Supported activity statistical category codes. */
export enum ActivityStatCategoryCodeType {
  HotelCode = 'HotelCode',
}

/** Supported Activity report codes. */
export enum ActivityStatReportCodeType {
...
export class HttpClient<SecurityDataType = unknown> {
  ...
  constructor({ securityWorker, secure, format, ...axiosConfig }: ApiConfig<SecurityDataType> = {}) {
    this.instance = axios.create({ ...axiosConfig, baseURL: new URL('/act/v1', axiosConfig.baseURL).toString() });
    this.secure = secure;
    this.format = format;
...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
  activities = {
    ...
    getActivitiesByMultipleHotelIds: (
      ...
      return this.request<ActivitiesInfo, ExceptionDetailType>({
        path: `/activities`,
        method: 'GET',
        query: query,
    ...
    postMultipleActivitiesCompletion: (
      hotelId: string,
      activitiesToChange: ActivitiesToChange,
      params: RequestParams = {},
    ) => {
      const headers = { ...params.headers, 'x-hotelid': hotelId };
      const newParams = { ...params, headers };
    ...
    getEmails: (
      ...
      const headers = { ...params.headers, 'x-hotelid': hotelId };
      const newParams = { ...params, headers };
      return this.request<EmailsDetails, ExceptionDetailType>({
    ...
    getActivityWithOutHotelId: (
      ...
      const headers = { ...params.headers, 'x-hotelid': hotelId };
      const newParams = { ...params, headers };
      return this.request<Activity, ExceptionDetailType>({
  ...
  hotels = {
    ...
    getActivities: (
      ...
      const newParams = { ...params, headers };
      return this.request<ActivitiesInfo, ExceptionDetailType>({
        path: `/hotels/${hotelId}/activities`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
     ...
     */
    postActivities: (hotelId: string, activitiesInformation: ActivitiesInformation, params: RequestParams = {}) => {
      const headers = { ...params.headers, 'x-hotelid': hotelId };
      const newParams = { ...params, headers };
      return this.request<Status, ExceptionDetailType>({
        path: `/hotels/${hotelId}/activities`,
        method: 'POST',
        body: activitiesInformation,
        type: ContentType.Json,
        format: 'json',
        ...newParams,
      });
    ...
    getActivityStatistics: (
      ...
      const headers = { ...params.headers, 'x-hotelid': hotelId };
      const newParams = { ...params, headers };
      return this.request<ActivityStatistics, ExceptionDetailType>({
        path: `/hotels/${hotelId}/activities/statistics`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getActivity: (
      ...
      const newParams = { ...params, headers };
      return this.request<Activity, ExceptionDetailType>({
        path: `/hotels/${hotelId}/activities/${activityId}`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    postSingleActivityCompletion: (
      ...
      const newParams = { ...params, headers };
      return this.request<Status, ExceptionDetailType>({
        path: `/hotels/${hotelId}/activities/${activityId}/activityCompletion`,
        method: 'POST',
        body: activitiesToChange,
        type: ContentType.Json,
        format: 'json',
     ...
     */
    getActivityAttachments: (activityId: string, hotelId: string, params: RequestParams = {}) => {
      const headers = { ...params.headers, 'x-hotelid': hotelId };
      const newParams = { ...params, headers };
      return this.request<ActivityAttachments, ExceptionDetailType>({
        path: `/hotels/${hotelId}/activities/${activityId}/attachments`,
        method: 'GET',
        type: ContentType.Json,
        format: 'json',
        ...newParams,
    ...
    deleteActivityAttachment: (
      ...
      const newParams = { ...params, headers };
      return this.request<Status, ExceptionDetailType>({
        path: `/hotels/${hotelId}/activities/${activityId}/attachments/${attachmentId}`,
        method: 'DELETE',
        type: ContentType.Json,
        format: 'json',
        ...newParams,
    ...
    postLinkedActivities: (
      ...
      const newParams = { ...params, headers };
      return this.request<Status, ExceptionDetailType>({
        path: `/hotels/${hotelId}/activities/${activityId}/linkedActivities`,
        method: 'POST',
    ...
    getActivityLog: (
      ...
      return this.request<ActivityLog, ExceptionDetailType>({
        path: `/hotels/${hotelId}/activityLog`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
     ...
     */
    getRecentlyAccessedActivities: (hotelId: string, params: RequestParams = {}) => {
      const headers = { ...params.headers, 'x-hotelid': hotelId };
      const newParams = { ...params, headers };
      return this.request<RecentlyAccessedActivities, ExceptionDetailType>({
        path: `/hotels/${hotelId}/recentlyAccessedActivities`,
        method: 'GET',
        type: ContentType.Json,
        format: 'json',
        ...newParams,
  ...
  recentlyAccessedActivities = {
     ...
     */
    getRecentlyAccessedActivitiesWithOutHotelId: (hotelId: string, params: RequestParams = {}) => {
      const headers = { ...params.headers, 'x-hotelid': hotelId };
      const newParams = { ...params, headers };
      return this.request<RecentlyAccessedActivities, ExceptionDetailType>({
  ...
  services = {
     ...
     */
    deleteActivityServiceCache: (hotelId: string, params: RequestParams = {}) => {
      const headers = { ...params.headers, 'x-hotelid': hotelId };
      const newParams = { ...params, headers };
      return this.request<Status, ExceptionDetailType>({
     ...
     */
    pingActivityService: (hotelId: string, params: RequestParams = {}) => {
      const headers = { ...params.headers, 'x-hotelid': hotelId };
      const newParams = { ...params, headers };
