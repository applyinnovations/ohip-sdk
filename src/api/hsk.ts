...
export class HttpClient<SecurityDataType = unknown> {
  ...
  constructor({ securityWorker, secure, format, ...axiosConfig }: ApiConfig<SecurityDataType> = {}) {
    this.instance = axios.create({ ...axiosConfig, baseURL: new URL('/hsk/v1', axiosConfig.baseURL).toString() });
    this.secure = secure;
    this.format = format;
...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
  hotels = {
    ...
    getHousekeepingDiscrepancies: (
      ...
      return this.request<Rooms, ExceptionDetailType>({
        path: `/hotels/${hotelId}/housekeepingDiscrepancies`,
        method: 'GET',
        query: query,
    ...
    getHousekeepingOverview: (
      ...
      const headers = { ...params.headers, 'x-hotelid': hotelId };
      const newParams = { ...params, headers };
      return this.request<HousekeepingBoard, ExceptionDetailType>({
        path: `/hotels/${hotelId}/housekeepingOverview`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getOutOfOrderRooms: (
      ...
      const newParams = { ...params, headers };
      return this.request<Rooms, ExceptionDetailType>({
        path: `/hotels/${hotelId}/rooms/outOfOrderRooms`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
     ...
     */
    completeOutOfOrderRooms: (hotelId: string, completeRoomRepair: CompleteRoomRepair, params: RequestParams = {}) => {
      const headers = { ...params.headers, 'x-hotelid': hotelId };
      const newParams = { ...params, headers };
      return this.request<CompleteRoomRepairStatus, ExceptionDetailType>({
        path: `/hotels/${hotelId}/rooms/outOfOrderRooms`,
        method: 'PUT',
        body: completeRoomRepair,
        type: ContentType.Json,
        format: 'json',
        ...newParams,
      });
     ...
     */
    postOutOfOrderRooms: (hotelId: string, roomRepairOutOfOrder: RoomRepairOutOfOrder, params: RequestParams = {}) => {
      const headers = { ...params.headers, 'x-hotelid': hotelId };
      const newParams = { ...params, headers };
      return this.request<Status, ExceptionDetailType>({
        path: `/hotels/${hotelId}/rooms/outOfOrderRooms`,
        method: 'POST',
        body: roomRepairOutOfOrder,
        type: ContentType.Json,
        format: 'json',
        ...newParams,
      });
    ...
    completeOutOfServiceRooms: (
      hotelId: string,
      completeRoomRepair: CompleteRoomRepair,
      params: RequestParams = {},
    ) => {
      const headers = { ...params.headers, 'x-hotelid': hotelId };
      const newParams = { ...params, headers };
      return this.request<CompleteRoomRepairStatus, ExceptionDetailType>({
        path: `/hotels/${hotelId}/rooms/outOfServiceRooms`,
        method: 'PUT',
        body: completeRoomRepair,
        type: ContentType.Json,
        format: 'json',
    ...
    postOutOfServiceRooms: (
      hotelId: string,
      roomRepairOutOfService: RoomRepairOutOfService,
      params: RequestParams = {},
    ) => {
      const headers = { ...params.headers, 'x-hotelid': hotelId };
      const newParams = { ...params, headers };
    ...
    putRoomRelatedStatus: (
      hotelId: string,
      housekeepingRoomStatusCriteria: HousekeepingRoomStatusCriteria,
      params: RequestParams = {},
    ) => {
      const headers = { ...params.headers, 'x-hotelid': hotelId };
      const newParams = { ...params, headers };
      return this.request<HousekeepingRoomStatus, ExceptionDetailType>({
        path: `/hotels/${hotelId}/rooms/status`,
        method: 'PUT',
        body: housekeepingRoomStatusCriteria,
        type: ContentType.Json,
        format: 'json',
        ...newParams,
      });
