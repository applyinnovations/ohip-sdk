...
export enum DataValueMappingCodeType {
...
export enum DefaultValueCodeType {
  AddressTypes = 'AddressTypes',
...
export class HttpClient<SecurityDataType = unknown> {
  ...
  constructor({ securityWorker, secure, format, ...axiosConfig }: ApiConfig<SecurityDataType> = {}) {
    this.instance = axios.create({ ...axiosConfig, baseURL: new URL('/dvm/v1', axiosConfig.baseURL).toString() });
    this.secure = secure;
    this.format = format;
...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
  externalSystems = {
    ...
    getOperaHotelCode: (
      ...
      return this.request<ConvertedHotelCode, ExceptionDetailType>({
        path: `/externalSystems/${extSystemCode}/hotels/${externalHotelId}/conversions`,
        method: 'GET',
        query: query,
    ...
    getConvertedValues: (
      ...
      const headers = { ...params.headers, 'x-hotelid': hotelId };
      const newParams = { ...params, headers };
      return this.request<ConvertedValues, ExceptionDetailType>({
        path: `/externalSystems/${extSystemCode}/hotels/${operaHotelId}/convertedValues`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
     ...
     */
    getDefaultValues: (hotelId: string, operaHotelId: string, extSystemCode: string, params: RequestParams = {}) => {
      const headers = { ...params.headers, 'x-hotelid': hotelId };
      const newParams = { ...params, headers };
      return this.request<DefaultValues, ExceptionDetailType>({
        path: `/externalSystems/${extSystemCode}/hotels/${operaHotelId}/defaultValues`,
        method: 'GET',
        type: ContentType.Json,
        format: 'json',
        ...newParams,
  ...
  services = {
     ...
     */
    clearDvmCache: (hotelId: string, params: RequestParams = {}) => {
      const headers = { ...params.headers, 'x-hotelid': hotelId };
      const newParams = { ...params, headers };
     ...
     */
    clearDefaultValueCache: (hotelId: string, params: RequestParams = {}) => {
      const headers = { ...params.headers, 'x-hotelid': hotelId };
      const newParams = { ...params, headers };
      return this.request<Status, ExceptionDetailType>({
     ...
     */
    pingDataValueMappingService: (hotelId: string, params: RequestParams = {}) => {
      const headers = { ...params.headers, 'x-hotelid': hotelId };
      const newParams = { ...params, headers };
