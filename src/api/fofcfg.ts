...
export enum CommissionBasedOnType {
...
export enum CommissionConfigPaymentMethodType {
  Check = 'Check',
...
export enum AdjustmentReasonCodeType {
...
export enum AmountOrPercentage {
  Amount = 'Amount',
  Percent = 'Percent',
}
...
export class HttpClient<SecurityDataType = unknown> {
  ...
  constructor({ securityWorker, secure, format, ...axiosConfig }: ApiConfig<SecurityDataType> = {}) {
    this.instance = axios.create({
      ...axiosConfig,
      baseURL: new URL('/fof/config/v1', axiosConfig.baseURL).toString(),
    });
    this.secure = secure;
    this.format = format;
...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
  articles = {
     ...
     */
    putArticles: (hotelId: string, articles: Articles, params: RequestParams = {}) => {
     ...
     */
    postArticles: (hotelId: string, articles: Articles, params: RequestParams = {}) => {
      const headers = { ...params.headers, 'x-hotelid': hotelId };
      const newParams = { ...params, headers };
      return this.request<Status, ExceptionDetailType>({
        path: `/articles`,
    ...
    getArticles: (
      ...
      const headers = { ...params.headers, 'x-hotelid': hotelId };
      const newParams = { ...params, headers };
      return this.request<ArticlesInfo, ExceptionDetailType>({
        path: `/articles`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
  ...
  authorizerGroups = {
     ...
     */
    postAuthorizerGroups: (hotelId: string, authorizerGroups: AuthorizerGroups, params: RequestParams = {}) => {
      const headers = { ...params.headers, 'x-hotelid': hotelId };
      const newParams = { ...params, headers };
      return this.request<Status, ExceptionDetailType>({
        path: `/authorizerGroups`,
        method: 'POST',
        body: authorizerGroups,
        type: ContentType.Json,
        format: 'json',
        ...newParams,
      });
    ...
    getAuthorizerGroups: (
      ...
      const headers = { ...params.headers, 'x-hotelid': hotelId };
      const newParams = { ...params, headers };
      return this.request<AuthorizerGroups, ExceptionDetailType>({
        path: `/authorizerGroups`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
  ...
  autoFolioSettlementTypes = {
    ...
    getAutoFolioSettlementTypes: (
      ...
      const headers = { ...params.headers, 'x-hotelid': hotelId };
      const newParams = { ...params, headers };
      return this.request<AutoFolioSettlementTypesDetails, ExceptionDetailType>({
    ...
    postAutoFolioSettlementTypes: (
      ...
      return this.request<Status, ExceptionDetailType>({
        path: `/autoFolioSettlementTypes`,
        method: 'POST',
        body: autoFolioSettlementTypesCriteria,
        type: ContentType.Json,
        format: 'json',
        ...newParams,
      });
    ...
    putAutoFolioSettlementTypes: (
      ...
      const newParams = { ...params, headers };
      return this.request<Status, ExceptionDetailType>({
        path: `/autoFolioSettlementTypes/${code}`,
        method: 'PUT',
        body: autoFolioSettlementTypesToBeChanged,
        type: ContentType.Json,
        format: 'json',
        ...newParams,
      });
     ...
     */
    deleteAutoFolioSettlementTypes: (hotelId: string, code: string, params: RequestParams = {}) => {
      const headers = { ...params.headers, 'x-hotelid': hotelId };
      const newParams = { ...params, headers };
      return this.request<Status, ExceptionDetailType>({
        path: `/autoFolioSettlementTypes/${code}`,
  ...
  cashierDetails = {
    ...
    getCashiers: (
      ...
      const headers = { ...params.headers, 'x-hotelid': hotelId };
      const newParams = { ...params, headers };
      return this.request<CashiersDetails, ExceptionDetailType>({
  ...
  cashiers = {
     ...
     */
    putCashiers: (hotelId: string, cashiers: Cashiers, params: RequestParams = {}) => {
      const headers = { ...params.headers, 'x-hotelid': hotelId };
      const newParams = { ...params, headers };
      return this.request<Status, ExceptionDetailType>({
        path: `/cashiers`,
     ...
     */
    postCashiers: (hotelId: string, cashiers: Cashiers, params: RequestParams = {}) => {
      const headers = { ...params.headers, 'x-hotelid': hotelId };
      const newParams = { ...params, headers };
      return this.request<Status, ExceptionDetailType>({
        path: `/cashiers`,
     ...
     */
    getAvailableCashierNumber: (hotelId: string, params: RequestParams = {}) => {
      const headers = { ...params.headers, 'x-hotelid': hotelId };
      const newParams = { ...params, headers };
      return this.request<CashierNumber, ExceptionDetailType>({
  ...
  commissionCodes = {
    ...
    getCommissionCodes: (
      ...
      const headers = { ...params.headers, 'x-hotelid': hotelId };
      const newParams = { ...params, headers };
      return this.request<CommissionCodesSummary, ExceptionDetailType>({
     ...
     */
    putCommissionCodes: (hotelId: string, commissionCodes: CommissionCodes, params: RequestParams = {}) => {
      const headers = { ...params.headers, 'x-hotelid': hotelId };
      const newParams = { ...params, headers };
      return this.request<Status, ExceptionDetailType>({
        path: `/commissionCodes`,
        method: 'PUT',
        body: commissionCodes,
        type: ContentType.Json,
        format: 'json',
        ...newParams,
      });
     ...
     */
    postCommissionCodes: (hotelId: string, commissionCodes: CommissionCodes, params: RequestParams = {}) => {
      const headers = { ...params.headers, 'x-hotelid': hotelId };
      const newParams = { ...params, headers };
      return this.request<Status, ExceptionDetailType>({
        path: `/commissionCodes`,
  ...
  compTypes = {
     ...
     */
    postCompTypes: (hotelId: string, compTypesCriteria: CompTypesCriteria, params: RequestParams = {}) => {
      const headers = { ...params.headers, 'x-hotelid': hotelId };
      const newParams = { ...params, headers };
      return this.request<Status, ExceptionDetailType>({
        path: `/compTypes`,
        method: 'POST',
        body: compTypesCriteria,
        type: ContentType.Json,
        format: 'json',
        ...newParams,
      });
     ...
     */
    changeCompTypes: (hotelId: string, compTypesToBeChanged: CompTypesToBeChanged, params: RequestParams = {}) => {
      const headers = { ...params.headers, 'x-hotelid': hotelId };
      const newParams = { ...params, headers };
      return this.request<CompTypesStatus, ExceptionDetailType>({
        path: `/compTypes`,
        method: 'PUT',
        body: compTypesToBeChanged,
        type: ContentType.Json,
        format: 'json',
        ...newParams,
      });
     ...
     */
    removeCompTypes: (hotelId: string, compTypesCode: string, params: RequestParams = {}) => {
      const headers = { ...params.headers, 'x-hotelid': hotelId };
      const newParams = { ...params, headers };
      return this.request<Status, ExceptionDetailType>({
        path: `/compTypes/codes/${compTypesCode}`,
        method: 'DELETE',
        type: ContentType.Json,
        format: 'json',
        ...newParams,
  ...
  configBankAccounts = {
    ...
    getConfigBankAccounts: (
      ...
      const headers = { ...params.headers, 'x-hotelid': hotelId };
      const newParams = { ...params, headers };
      return this.request<BankAccountsInfo, ExceptionDetailType>({
     ...
     */
    putConfigBankAccounts: (hotelId: string, bankAccounts: BankAccounts, params: RequestParams = {}) => {
      const headers = { ...params.headers, 'x-hotelid': hotelId };
      const newParams = { ...params, headers };
      return this.request<Status, ExceptionDetailType>({
        path: `/configBankAccounts`,
     ...
     */
    postConfigBankAccounts: (hotelId: string, bankAccounts: BankAccounts, params: RequestParams = {}) => {
      const headers = { ...params.headers, 'x-hotelid': hotelId };
      const newParams = { ...params, headers };
      return this.request<Status, ExceptionDetailType>({
        path: `/configBankAccounts`,
  ...
  creditCardInfo = {
    ...
    getCreditCardInfo: (
      ...
      const headers = { ...params.headers, 'x-hotelid': hotelId };
      const newParams = { ...params, headers };
      return this.request<CreditCardInfo, ExceptionDetailType>({
        path: `/creditCardInfo`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
  ...
  currencyExchangeServiceTaxes = {
    ...
    putCurrencyExchangeServiceTaxes: (
      ...
      return this.request<Status, ExceptionDetailType>({
        ...
        method: 'PUT',
        body: currencyExchangeServiceTaxes,
        type: ContentType.Json,
        format: 'json',
        ...newParams,
      });
    ...
    getCurrencyExchangeServiceTaxes: (
      ...
      const headers = { ...params.headers, 'x-hotelid': hotelId };
      const newParams = { ...params, headers };
      return this.request<CurrencyExchangeServiceTaxes, ExceptionDetailType>({
        path: `/currencyExchangeServiceTaxes`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
  ...
  customTaxTypes = {
    ...
    getCustomTaxTypes: (
      ...
      const headers = { ...params.headers, 'x-hotelid': hotelId };
      const newParams = { ...params, headers };
      return this.request<CustomTaxTypesDetails, ExceptionDetailType>({
        path: `/customTaxTypes`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
    ...
    changeCustomTaxTypes: (
      ...
      const newParams = { ...params, headers };
      return this.request<Status, ExceptionDetailType>({
        path: `/customTaxTypes/${taxTypeCode}`,
        method: 'PUT',
        body: customTaxTypesToBeChanged,
        type: ContentType.Json,
        format: 'json',
        ...newParams,
      });
     ...
     */
    removeCustomTaxTypes: (hotelId: string, taxTypeCode: string, params: RequestParams = {}) => {
      const headers = { ...params.headers, 'x-hotelid': hotelId };
      const newParams = { ...params, headers };
      return this.request<Status, ExceptionDetailType>({
        path: `/customTaxTypes/${taxTypeCode}`,
  ...
  dailyPlanCodes = {
     ...
     */
    putDailyPlanCodes: (hotelId: string, dailyPlanCodes: DailyPlanCodes, params: RequestParams = {}) => {
      const headers = { ...params.headers, 'x-hotelid': hotelId };
      const newParams = { ...params, headers };
      return this.request<Status, ExceptionDetailType>({
        path: `/dailyPlanCodes`,
    ...
    getDailyPlanCodes: (
      ...
      const headers = { ...params.headers, 'x-hotelid': hotelId };
      const newParams = { ...params, headers };
      return this.request<DailyPlanCodes, ExceptionDetailType>({
        path: `/dailyPlanCodes`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
  ...
  expenseArrangementCodes = {
    ...
    getExpenseArrangementCodes: (
      ...
      const headers = { ...params.headers, 'x-hotelid': hotelId };
      const newParams = { ...params, headers };
      return this.request<ExpenseArrangementCodes, ExceptionDetailType>({
        path: `/expenseArrangementCodes`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
  ...
  fiscalFolioParameters = {
    ...
    getFiscalFolioParameters: (
      ...
      const headers = { ...params.headers, 'x-hotelid': hotelId };
      const newParams = { ...params, headers };
      return this.request<FiscalFolioParameters, ExceptionDetailType>({
        path: `/fiscalFolioParameters`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
  ...
  folioTypeLegendMappings = {
    ...
    getFolioTypeLegendMappingsConfig: (
      ...
      const headers = { ...params.headers, 'x-hotelid': hotelId };
      const newParams = { ...params, headers };
      return this.request<FolioTypeLegendMappingsConfigDetails, ExceptionDetailType>({
    ...
    postFolioTypeLegendMappingConfig: (
      ...
      return this.request<Status, ExceptionDetailType>({
        path: `/folioTypeLegendMappings`,
        method: 'POST',
        body: folioTypeLegendMappingConfigCriteria,
        type: ContentType.Json,
        format: 'json',
        ...newParams,
      });
    ...
    changeFolioTypeLegendMappingConfig: (
      ...
      const headers = { ...params.headers, 'x-hotelid': hotelId };
      const newParams = { ...params, headers };
      return this.request<FolioTypeLegendMappingConfigStatus, ExceptionDetailType>({
        path: `/folioTypeLegendMappings`,
        method: 'PUT',
        body: folioTypeLegendMappingConfigToBeChanged,
        type: ContentType.Json,
        format: 'json',
        ...newParams,
      });
  ...
  hotelAdjustmentCodes = {
     ...
     */
    putAdjustmentCodes: (hotelId: string, adjustmentCodes: AdjustmentCodes, params: RequestParams = {}) => {
      const headers = { ...params.headers, 'x-hotelid': hotelId };
      const newParams = { ...params, headers };
      return this.request<Status, ExceptionDetailType>({
        path: `/hotelAdjustmentCodes`,
        method: 'PUT',
        body: adjustmentCodes,
        type: ContentType.Json,
        format: 'json',
        ...newParams,
      });
     ...
     */
    postAdjustmentCodes: (hotelId: string, adjustmentCodes: AdjustmentCodes, params: RequestParams = {}) => {
      const headers = { ...params.headers, 'x-hotelid': hotelId };
      const newParams = { ...params, headers };
      return this.request<Status, ExceptionDetailType>({
        path: `/hotelAdjustmentCodes`,
    ...
    getAdjustmentCodes: (
      ...
      const headers = { ...params.headers, 'x-hotelid': hotelId };
      const newParams = { ...params, headers };
      return this.request<AdjustmentCodes, ExceptionDetailType>({
        path: `/hotelAdjustmentCodes`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
  ...
  hotelTaxTypes = {
    ...
    getTaxTypes: (
      ...
      const headers = { ...params.headers, 'x-hotelid': hotelId };
      const newParams = { ...params, headers };
      return this.request<TaxTypes, ExceptionDetailType>({
        path: `/hotelTaxTypes`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
  ...
  hotels = {
     ...
     */
    getCommissionCode: (commissionCode: string, hotelId: string, params: RequestParams = {}) => {
      const headers = { ...params.headers, 'x-hotelid': hotelId };
      const newParams = { ...params, headers };
      return this.request<CommissionCodeDetail, ExceptionDetailType>({
        path: `/hotels/${hotelId}/commissionCode/${commissionCode}`,
        method: 'GET',
        type: ContentType.Json,
        format: 'json',
        ...newParams,
    ...
    getCompTypes: (
      ...
      const headers = { ...params.headers, 'x-hotelid': hotelId };
      const newParams = { ...params, headers };
      return this.request<CompTypesDetails, ExceptionDetailType>({
        path: `/hotels/${hotelId}/compTypes`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getFuturePastExchangeRates: (
      ...
      const headers = { ...params.headers, 'x-hotelid': hotelId };
      const newParams = { ...params, headers };
      return this.request<FuturePastExchangeRates, ExceptionDetailType>({
        path: `/hotels/${hotelId}/exchangeRates/${currencyCode}`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    removeFolioTypeLegendMappingConfig: (
      ...
      const newParams = { ...params, headers };
      return this.request<Status, ExceptionDetailType>({
        path: `/hotels/${hotelId}/folios/${folioType}/legends/${legendCode}`,
        method: 'DELETE',
        type: ContentType.Json,
        format: 'json',
        ...newParams,
  ...
  stopProcessingReasons = {
    ...
    getStopProcessingReasons: (
      ...
      const headers = { ...params.headers, 'x-hotelid': hotelId };
      const newParams = { ...params, headers };
      return this.request<StopProcessingReasons, ExceptionDetailType>({
