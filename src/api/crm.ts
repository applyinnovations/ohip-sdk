...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
  companies = {
     ...
     */
    postCompanyProfile: (hotelId: string, company: Company, params: RequestParams = {}) => {
    ...
    getCompanyProfile: (
      ...
      const headers = { ...params.headers, 'x-hotelid': hotelId };
      const newParams = { ...params, headers };
      return this.request<Company, ExceptionDetailType>({
        path: `/companies/${corporateId}`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
  ...
  externalSystems = {
    ...
    getProfileByExtId: (
      ...
      return this.request<Profile, ExceptionDetailType>({
        path: `/externalSystems/${extSystemCode}/profiles/${profileExternalId}`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
  ...
  guests = {
     ...
     * @request POST:/guests
     */
    postGuestProfile: (hotelId: string, guest: Guest, params: RequestParams = {}) => {
      const headers = { ...params.headers, 'x-hotelid': hotelId };
      const newParams = { ...params, headers };
      return this.request<Status, ExceptionDetailType>({
        path: `/guests`,
    ...
    getGuestProfile: (
      ...
      const headers = { ...params.headers, 'x-hotelid': hotelId };
      const newParams = { ...params, headers };
      return this.request<Guest, ExceptionDetailType>({
        path: `/guests/${guestId}`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
  ...
  profileListOfValues = {
    ...
    getAvailablePreferences: (
      ...
      const headers = { ...params.headers, 'x-hotelid': hotelId };
      const newParams = { ...params, headers };
      return this.request<AvailablePreferences, ExceptionDetailType>({
  ...
  profiles = {
    ...
    getProfiles: (
      ...
      const headers = { ...params.headers, 'x-hotelid': hotelId };
      const newParams = { ...params, headers };
      return this.request<ProfileSummaries, ExceptionDetailType>({
        path: `/profiles`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
     ...
     */
    postProfile: (hotelId: string, profile: Profile, params: RequestParams = {}) => {
      const headers = { ...params.headers, 'x-hotelid': hotelId };
      const newParams = { ...params, headers };
      return this.request<Status, ExceptionDetailType>({
        path: `/profiles`,
     ...
     */
    putProfile: (hotelId: string, profileId: string, profile: Profile, params: RequestParams = {}) => {
      const headers = { ...params.headers, 'x-hotelid': hotelId };
      const newParams = { ...params, headers };
      return this.request<Profile, ExceptionDetailType>({
        path: `/profiles/${profileId}`,
     ...
     */
    deleteProfile: (hotelId: string, profileId: string, params: RequestParams = {}) => {
      const headers = { ...params.headers, 'x-hotelid': hotelId };
      const newParams = { ...params, headers };
      return this.request<Status, ExceptionDetailType>({
        path: `/profiles/${profileId}`,
    ...
    storeEmail: (
      ...
      const newParams = { ...params, headers };
      return this.request<Status, ExceptionDetailType>({
        path: `/profiles/${profileId}/emails`,
        method: 'POST',
    ...
    getProfileRelationships: (
      ...
      const headers = { ...params.headers, 'x-hotelid': hotelId };
      const newParams = { ...params, headers };
      return this.request<ProfileRelationships, ExceptionDetailType>({
        path: `/profiles/${profileId}/relationships`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    getStayHistory: (
      ...
      const headers = { ...params.headers, 'x-hotelid': hotelId };
      const newParams = { ...params, headers };
      return this.request<ProfileStayHistory, ExceptionDetailType>({
        path: `/profiles/${profileId}/stayHistory`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
    ...
    postProfileRelationship: (
      ...
      const newParams = { ...params, headers };
      return this.request<Status, ExceptionDetailType>({
        path: `/profiles/${sourceProfileId}/relationships/${targetProfileId}`,
        method: 'POST',
        body: profileRelationship,
        type: ContentType.Json,
        format: 'json',
        ...newParams,
      });
    ...
    putProfileRelationship: (
      ...
      targetProfileId: string,
      sourceProfileId: string,
      profileRelationshipToBeChanged: ProfileRelationshipToBeChanged,
      params: RequestParams = {},
    ) => {
      const headers = { ...params.headers, 'x-hotelid': hotelId };
      const newParams = { ...params, headers };
      return this.request<Status, ExceptionDetailType>({
        path: `/profiles/${sourceProfileId}/relationships/${targetProfileId}`,
        method: 'PUT',
        body: profileRelationshipToBeChanged,
        type: ContentType.Json,
        format: 'json',
        ...newParams,
      });
    ...
    mergeProfiles: (
      ...
      profileToBeMerged: ProfileToBeMerged,
      params: RequestParams = {},
    ) => {
      const headers = { ...params.headers, 'x-hotelid': hotelId };
      const newParams = { ...params, headers };
      return this.request<Status, ExceptionDetailType>({
        path: `/profiles/${survivorProfileId}/merges`,
        method: 'POST',
        body: profileToBeMerged,
        type: ContentType.Json,
        format: 'json',
        ...newParams,
      });
