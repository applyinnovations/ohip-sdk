...
export enum RatePlanYieldableType {
  Yieldable = 'Yieldable',
...
export class HttpClient<SecurityDataType = unknown> {
  ...
  constructor({ securityWorker, secure, format, ...axiosConfig }: ApiConfig<SecurityDataType> = {}) {
    this.instance = axios.create({ ...axiosConfig, baseURL: new URL('/rtp/async/v1', axiosConfig.baseURL).toString() });
    this.secure = secure;
    this.format = format;
  ...
  externalSystems = {
    ...
    startSetDailyRatePlanSchedulesProcess: (
      ...
      return this.request<void, ExceptionDetailType>({
        path: `/externalSystems/${extSystemCode}/hotels/${hotelId}/ratePlans/dailySchedules`,
        method: 'POST',
        body: dailyRatePlanSchedules,
    ...
    getDailyRatePlanSchedulesProcessStatus: (
      ...
      return this.request<void, void>({
        path: `/externalSystems/${extSystemCode}/hotels/${hotelId}/ratePlans/dailySchedules/${requestId}`,
        method: 'HEAD',
        type: ContentType.Json,
        ...newParams,
      });
    ...
    getDailyRatePlanSchedules: (
      ...
      const headers = { ...params.headers, 'x-hotelid': hotelId };
      const newParams = { ...params, headers };
      return this.request<DailyRatePlanSchedulesStatus, ExceptionDetailType>({
        path: `/externalSystems/${extSystemCode}/hotels/${hotelId}/ratePlans/dailySchedules/${requestId}`,
        method: 'GET',
        type: ContentType.Json,
        format: 'json',
    ...
    startSetBestAvailableRatePlansProcess: (
      ...
      const newParams = { ...params, headers };
      return this.request<void, ExceptionDetailType>({
        path: `/externalSystems/${extSystemCode}/hotels/${hotelId}/ratePlans/bestAvailableLOS`,
        method: 'POST',
        body: bestAvailableRatePlans,
        type: ContentType.Json,
        ...newParams,
      });
    },
    ...
    getBestAvailableRatePlansProcessStatus: (
      ...
      const newParams = { ...params, headers };
      return this.request<void, void>({
        path: `/externalSystems/${extSystemCode}/hotels/${hotelId}/ratePlans/bestAvailableLOS/${requestId}`,
        method: 'HEAD',
        type: ContentType.Json,
        ...newParams,
      });
    ...
    getBestAvailableRatePlans: (
      ...
      const headers = { ...params.headers, 'x-hotelid': hotelId };
      const newParams = { ...params, headers };
      return this.request<BestAvailableRatePlansStatus, ExceptionDetailType>({
        path: `/externalSystems/${extSystemCode}/hotels/${hotelId}/ratePlans/bestAvailableLOS/${requestId}`,
        method: 'GET',
        type: ContentType.Json,
        format: 'json',
    ...
    startHurdleRatesProcess: (
      ...
      const newParams = { ...params, headers };
      return this.request<void, ExceptionDetailType>({
        path: `/externalSystems/${extSystemCode}/hotels/${hotelId}/rates/hurdles`,
        method: 'POST',
        body: hurdleRates,
        type: ContentType.Json,
        ...newParams,
    ...
    getHurdleRatesProcessStatus: (
      ...
      const newParams = { ...params, headers };
      return this.request<void, void>({
        path: `/externalSystems/${extSystemCode}/hotels/${hotelId}/rates/hurdles/${requestId}`,
        method: 'HEAD',
        type: ContentType.Json,
        ...newParams,
      });
     ...
     */
    getHurdleRates: (hotelId: string, extSystemCode: string, requestId: string, params: RequestParams = {}) => {
      const headers = { ...params.headers, 'x-hotelid': hotelId };
      const newParams = { ...params, headers };
      return this.request<HurdleRatesStatus, ExceptionDetailType>({
        path: `/externalSystems/${extSystemCode}/hotels/${hotelId}/rates/hurdles/${requestId}`,
        method: 'GET',
        type: ContentType.Json,
        format: 'json',
    ...
    startSetRatePlansHeadersProcess: (
      ...
      const newParams = { ...params, headers };
      return this.request<void, ExceptionDetailType>({
        path: `/externalSystems/${extSystemCode}/hotels/${hotelId}/ratePlans/headers`,
        method: 'POST',
        body: ratePlan,
        type: ContentType.Json,
        ...newParams,
    ...
    getRatePlansHeadersProcessStatus: (
      ...
      const newParams = { ...params, headers };
      return this.request<void, void>({
        path: `/externalSystems/${extSystemCode}/hotels/${hotelId}/ratePlans/headers/${requestId}`,
        method: 'HEAD',
        type: ContentType.Json,
        ...newParams,
      });
     ...
     */
    getRatePlansHeaders: (hotelId: string, extSystemCode: string, requestId: string, params: RequestParams = {}) => {
      const headers = { ...params.headers, 'x-hotelid': hotelId };
      const newParams = { ...params, headers };
      return this.request<HurdleRatesStatus, ExceptionDetailType>({
        path: `/externalSystems/${extSystemCode}/hotels/${hotelId}/ratePlans/headers/${requestId}`,
