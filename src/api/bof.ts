 ...
 * @maxItems 4000
 */
export type HotelActiveEndOfDaysType = HotelActiveEndOfDayType[];
...
export class HttpClient<SecurityDataType = unknown> {
  ...
  constructor({ securityWorker, secure, format, ...axiosConfig }: ApiConfig<SecurityDataType> = {}) {
    this.instance = axios.create({ ...axiosConfig, baseURL: new URL('/bof/v1', axiosConfig.baseURL).toString() });
    this.secure = secure;
    this.format = format;
...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
  hotels = {
     ...
     */
    getBusinessDate: (hotelId: string, params: RequestParams = {}) => {
      const headers = { ...params.headers, 'x-hotelid': hotelId };
      const newParams = { ...params, headers };
      return this.request<BusinessDate, ExceptionDetailType>({
        path: `/hotels/${hotelId}/businessDate`,
        method: 'GET',
  ...
  services = {
     ...
     */
    clearBackOfficeOperationsServiceCache: (hotelId: string, params: RequestParams = {}) => {
      const headers = { ...params.headers, 'x-hotelid': hotelId };
      const newParams = { ...params, headers };
     ...
     */
    pingBackOfficeOperationsService: (hotelId: string, params: RequestParams = {}) => {
      const headers = { ...params.headers, 'x-hotelid': hotelId };
      const newParams = { ...params, headers };
