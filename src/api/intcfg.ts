...
export enum EmailDeliveryFormatType {
  Htmlcss = 'Htmlcss',
  Pdf = 'Pdf',
  Rtf = 'Rtf',
  Tif = 'Tif',
...
export enum EmailDeliveryMethodType {
  Billing = 'Billing',
...
export enum TextDeliveryMethodType {
  Url = 'Url',
  Email = 'Email',
}
...
/** Auto Choose */
export enum TelephoneChargeType {
  Value0 = '0',
  Value1 = '1',
  Value2 = '2',
}
...
export enum MaskDialNumberType {
  NoMasking = 'NoMasking',
...
export enum MessageWaitingType {
  NotAvailable = 'NotAvailable',
  AlwaysOn = 'AlwaysOn',
  AlwaysOff = 'AlwaysOff',
  FreelySwitchable = 'FreelySwitchable',
...
export enum ClassOfServiceConfigType {
  NotAvailable = 'NotAvailable',
  AlwaysOn = 'AlwaysOn',
  AlwaysOff = 'AlwaysOff',
  FreelySwitchable = 'FreelySwitchable',
...
export enum DirectInwardDialType {
  NotAvailable = 'NotAvailable',
  AlwaysOn = 'AlwaysOn',
  AlwaysOff = 'AlwaysOff',
  FreelySwitchable = 'FreelySwitchable',
...
export class HttpClient<SecurityDataType = unknown> {
  ...
  constructor({ securityWorker, secure, format, ...axiosConfig }: ApiConfig<SecurityDataType> = {}) {
    this.instance = axios.create({
      ...axiosConfig,
      baseURL: new URL('/int/config/v1', axiosConfig.baseURL).toString(),
    });
    this.secure = secure;
    this.format = format;
...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
  config = {
     ...
     */
    clearCacheBeProcessor: (hotelId: string, params: RequestParams = {}) => {
     ...
     */
    pingBeProcessor: (hotelId: string, params: RequestParams = {}) => {
      const headers = { ...params.headers, 'x-hotelid': hotelId };
      const newParams = { ...params, headers };
  ...
  deliveryMethods = {
    ...
    getDeliveryMethods: (
      ...
      const headers = { ...params.headers, 'x-hotelid': hotelId };
      const newParams = { ...params, headers };
      return this.request<FetchedDeliveryMethods, ExceptionDetailType>({
     ...
     */
    putDeliveryMethods: (hotelId: string, changeDeliveryMethods: ChangeDeliveryMethods, params: RequestParams = {}) => {
      const headers = { ...params.headers, 'x-hotelid': hotelId };
      const newParams = { ...params, headers };
      return this.request<ChangedDeliveryMethods, ExceptionDetailType>({
        path: `/deliveryMethods`,
        method: 'PUT',
        body: changeDeliveryMethods,
        type: ContentType.Json,
        format: 'json',
        ...newParams,
      });
  ...
  deviceLocations = {
    ...
    getTemplateDeviceLocations: (
      ...
      const headers = { ...params.headers, 'x-hotelid': hotelId };
      const newParams = { ...params, headers };
      return this.request<TemplateDeviceLocationsDetails, ExceptionDetailType>({
    ...
    postTemplateDeviceLocations: (
      ...
      return this.request<Status, ExceptionDetailType>({
        path: `/deviceLocations`,
        method: 'POST',
        body: templateDeviceLocationsCriteria,
        type: ContentType.Json,
        format: 'json',
        ...newParams,
      });
    ...
    changeTemplateDeviceLocations: (
      ...
      const newParams = { ...params, headers };
      return this.request<Status, ExceptionDetailType>({
        path: `/deviceLocations/${deviceLocationId}`,
        method: 'PUT',
        body: templateDeviceLocationsToBeChanged,
        type: ContentType.Json,
        format: 'json',
        ...newParams,
      });
     ...
     */
    removeTemplateDeviceLocations: (hotelId: string, deviceLocationId: string, params: RequestParams = {}) => {
      const headers = { ...params.headers, 'x-hotelid': hotelId };
      const newParams = { ...params, headers };
      return this.request<Status, ExceptionDetailType>({
        path: `/deviceLocations/${deviceLocationId}`,
  ...
  externalSystems = {
     ...
     */
    clearCache: (hotelId: string, params: RequestParams = {}) => {
      const headers = { ...params.headers, 'x-hotelid': hotelId };
      const newParams = { ...params, headers };
      return this.request<Status, ExceptionDetailType>({
     ...
     */
    ping: (hotelId: string, params: RequestParams = {}) => {
      const headers = { ...params.headers, 'x-hotelid': hotelId };
      const newParams = { ...params, headers };
      return this.request<OperaVersion, ExceptionDetailType>({
    ...
    postPublishers: (
      ...
      const newParams = { ...params, headers };
      return this.request<Status, ExceptionDetailType>({
        path: `/externalSystems/${externalSystemCode}/hotels/${hotelId}/publishers`,
        method: 'POST',
        body: createPublishers,
        type: ContentType.Json,
        format: 'json',
        ...newParams,
      });
    ...
    getPublishers: (
      ...
      const headers = { ...params.headers, 'x-hotelid': hotelId };
      const newParams = { ...params, headers };
      return this.request<FetchedPublishers, ExceptionDetailType>({
        path: `/externalSystems/${externalSystemCode}/publishers`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
  ...
  hotelInterfaceTypes = {
    ...
    getHotelInterfaces: (
      ...
      const headers = { ...params.headers, 'x-hotelid': hotelId };
      const newParams = { ...params, headers };
      return this.request<FetchedHotelInterfaces, ExceptionDetailType>({
  ...
  hotels = {
    ...
    deleteHotelInterface: (
      ...
      const newParams = { ...params, headers };
      return this.request<Status, ExceptionDetailType>({
        path: `/hotels/${hotelId}/hotelInerface`,
        method: 'DELETE',
        query: query,
        type: ContentType.Json,
        format: 'json',
  ...
  interfaceControllerRegistry = {
    ...
    getHotelInterfaceControllerRegistry: (
      ...
      const headers = { ...params.headers, 'x-hotelid': hotelId };
      const newParams = { ...params, headers };
      return this.request<FetchedHotelInterfaceControllerRegistry, ExceptionDetailType>({
  ...
  interfaceErrors = {
    ...
    getHotelInterfaceErrors: (
      ...
      const headers = { ...params.headers, 'x-hotelid': hotelId };
      const newParams = { ...params, headers };
      return this.request<FetchedHotelInterfaceErrors, ExceptionDetailType>({
  ...
  interfaceFailedMessages = {
    ...
    getHotelInterfaceFailedMessages: (
      ...
      const headers = { ...params.headers, 'x-hotelid': hotelId };
      const newParams = { ...params, headers };
      return this.request<FetchedHotelInterfaceFailedMessages, ExceptionDetailType>({
  ...
  interfaceRights = {
     ...
     */
    putInterfaceRight: (hotelId: string, changeInterfaceRight: ChangeInterfaceRight, params: RequestParams = {}) => {
      const headers = { ...params.headers, 'x-hotelid': hotelId };
      const newParams = { ...params, headers };
      return this.request<ChangedInterfaceRight, ExceptionDetailType>({
        path: `/interfaceRights`,
        method: 'PUT',
        body: changeInterfaceRight,
        type: ContentType.Json,
        format: 'json',
        ...newParams,
      });
    ...
    getInterfaceRights: (
      ...
      const headers = { ...params.headers, 'x-hotelid': hotelId };
      const newParams = { ...params, headers };
      return this.request<FetchedInterfaceRights, ExceptionDetailType>({
        path: `/interfaceRights`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
  ...
  interfaceSchemas = {
    ...
    getHotelInterfaceSchemas: (
      ...
      const headers = { ...params.headers, 'x-hotelid': hotelId };
      const newParams = { ...params, headers };
      return this.request<FetchedHotelInterfaceSchemas, ExceptionDetailType>({
  ...
  interfaces = {
    ...
    getExternalDatabaseAvailableProperties: (
      ...
      const headers = { ...params.headers, 'x-hotelid': hotelId };
      const newParams = { ...params, headers };
      return this.request<FetchedExternalDatabaseAvailableProperties, ExceptionDetailType>({
        path: `/interfaces/${interfaceId}/databases/${databaseId}/availableResorts`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
        format: 'json',
  ...
  udfMappings = {
    ...
    getUdfMappings: (
      ...
      const headers = { ...params.headers, 'x-hotelid': hotelId };
      const newParams = { ...params, headers };
      return this.request<FetchedUDFMappings, ExceptionDetailType>({
        path: `/udfMappings`,
        method: 'GET',
        query: query,
        type: ContentType.Json,
     ...
     */
    putUdfMapping: (hotelId: string, changeUDFMapping: ChangeUDFMapping, params: RequestParams = {}) => {
      const headers = { ...params.headers, 'x-hotelid': hotelId };
      const newParams = { ...params, headers };
      return this.request<ChangedUDFMapping, ExceptionDetailType>({
        path: `/udfMappings`,
        method: 'PUT',
        body: changeUDFMapping,
        type: ContentType.Json,
        format: 'json',
        ...newParams,
      });
