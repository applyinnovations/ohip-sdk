...
type FacilityHousekeepingTaskType struct {
	...
	FacilityCodes *FacilityCodesType `json:"facilityCodes,omitempty"`
...
// SetFacilityCodes gets a reference to the given FacilityCodesType and assigns it to the FacilityCodes field.
