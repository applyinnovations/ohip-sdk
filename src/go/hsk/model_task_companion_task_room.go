...
type TaskCompanionTaskRoom struct {
	...
	TotalSupplies *FacilityCodesType `json:"totalSupplies,omitempty"`
}
...
func (o *TaskCompanionTaskRoom) GetTotalSupplies() FacilityCodesType {
	if o == nil || IsNil(o.TotalSupplies) {
		var ret FacilityCodesType
		return ret
	}
...
// SetTotalSupplies gets a reference to the given FacilityCodesType and assigns it to the TotalSupplies field.
