...
type FacilityCodeForecastType struct {
	...
	Forecast *ForecastQuantitiesType `json:"forecast,omitempty"`
}
...
// SetForecast gets a reference to the given ForecastQuantitiesType and assigns it to the Forecast field.
