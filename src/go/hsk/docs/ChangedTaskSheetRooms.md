...
`func (o *ChangedTaskSheetRooms) GetLinks() Links`

GetLinks returns the Links field if non-nil, zero value otherwise.

### GetLinksOk

`func (o *ChangedTaskSheetRooms) GetLinksOk() (*Links, bool)`
...
`func (o *ChangedTaskSheetRooms) SetLinks(v Links)`
...
`func (o *ChangedTaskSheetRooms) GetWarnings() WarningsType`

GetWarnings returns the Warnings field if non-nil, zero value otherwise.

### GetWarningsOk

`func (o *ChangedTaskSheetRooms) GetWarningsOk() (*WarningsType, bool)`
...
`func (o *ChangedTaskSheetRooms) SetWarnings(v WarningsType)`
