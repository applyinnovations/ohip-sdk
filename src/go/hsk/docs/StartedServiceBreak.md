...
`func (o *StartedServiceBreak) GetLinks() Links`

GetLinks returns the Links field if non-nil, zero value otherwise.

### GetLinksOk

`func (o *StartedServiceBreak) GetLinksOk() (*Links, bool)`
...
`func (o *StartedServiceBreak) SetLinks(v Links)`
...
`func (o *StartedServiceBreak) GetWarnings() WarningsType`

GetWarnings returns the Warnings field if non-nil, zero value otherwise.

### GetWarningsOk

`func (o *StartedServiceBreak) GetWarningsOk() (*WarningsType, bool)`
...
`func (o *StartedServiceBreak) SetWarnings(v WarningsType)`
