...
`func (o *RoomMaintenance) GetLinks() Links`

GetLinks returns the Links field if non-nil, zero value otherwise.

### GetLinksOk

`func (o *RoomMaintenance) GetLinksOk() (*Links, bool)`
...
`func (o *RoomMaintenance) SetLinks(v Links)`
...
`func (o *RoomMaintenance) GetWarnings() WarningsType`

GetWarnings returns the Warnings field if non-nil, zero value otherwise.

### GetWarningsOk

`func (o *RoomMaintenance) GetWarningsOk() (*WarningsType, bool)`
...
`func (o *RoomMaintenance) SetWarnings(v WarningsType)`
