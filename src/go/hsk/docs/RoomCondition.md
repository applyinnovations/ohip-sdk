...
`func (o *RoomCondition) GetLinks() Links`

GetLinks returns the Links field if non-nil, zero value otherwise.

### GetLinksOk

`func (o *RoomCondition) GetLinksOk() (*Links, bool)`
...
`func (o *RoomCondition) SetLinks(v Links)`
...
`func (o *RoomCondition) GetWarnings() WarningsType`

GetWarnings returns the Warnings field if non-nil, zero value otherwise.

### GetWarningsOk

`func (o *RoomCondition) GetWarningsOk() (*WarningsType, bool)`
...
`func (o *RoomCondition) SetWarnings(v WarningsType)`
