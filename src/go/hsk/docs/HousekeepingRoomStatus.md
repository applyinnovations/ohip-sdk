...
`func (o *HousekeepingRoomStatus) GetLinks() Links`

GetLinks returns the Links field if non-nil, zero value otherwise.

### GetLinksOk

`func (o *HousekeepingRoomStatus) GetLinksOk() (*Links, bool)`
...
`func (o *HousekeepingRoomStatus) SetLinks(v Links)`
...
`func (o *HousekeepingRoomStatus) GetWarnings() WarningsType`

GetWarnings returns the Warnings field if non-nil, zero value otherwise.

### GetWarningsOk

`func (o *HousekeepingRoomStatus) GetWarningsOk() (*WarningsType, bool)`
...
`func (o *HousekeepingRoomStatus) SetWarnings(v WarningsType)`
