...
// checks if the EditReservationHousekeepingTasksRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &EditReservationHousekeepingTasksRequest{}

// EditReservationHousekeepingTasksRequest struct for EditReservationHousekeepingTasksRequest
type EditReservationHousekeepingTasksRequest struct {
...
func NewEditReservationHousekeepingTasksRequest() *EditReservationHousekeepingTasksRequest {
	this := EditReservationHousekeepingTasksRequest{}
	return &this
}
...
func (o EditReservationHousekeepingTasksRequest) MarshalJSON() ([]byte, error) {
...
func (o EditReservationHousekeepingTasksRequest) ToMap() (map[string]interface{}, error) {
...
type NullableEditReservationHousekeepingTasksRequest struct {
	value *EditReservationHousekeepingTasksRequest
	isSet bool
}

func (v NullableEditReservationHousekeepingTasksRequest) Get() *EditReservationHousekeepingTasksRequest {
	return v.value
}

func (v *NullableEditReservationHousekeepingTasksRequest) Set(val *EditReservationHousekeepingTasksRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableEditReservationHousekeepingTasksRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableEditReservationHousekeepingTasksRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableEditReservationHousekeepingTasksRequest(val *EditReservationHousekeepingTasksRequest) *NullableEditReservationHousekeepingTasksRequest {
	return &NullableEditReservationHousekeepingTasksRequest{value: val, isSet: true}
}

func (v NullableEditReservationHousekeepingTasksRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableEditReservationHousekeepingTasksRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
