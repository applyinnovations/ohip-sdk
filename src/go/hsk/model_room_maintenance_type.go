...
type RoomMaintenanceType struct {
	...
	Images *ImageResultsType `json:"images,omitempty"`
...
// SetImages gets a reference to the given ImageResultsType and assigns it to the Images field.
