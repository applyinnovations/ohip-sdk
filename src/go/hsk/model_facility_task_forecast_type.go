...
type FacilityTaskForecastType struct {
	FacilityCodes *FacilityCodesForecastType `json:"facilityCodes,omitempty"`
	Task *CodeDescriptionType `json:"task,omitempty"`
	TaskForecast *ForecastQuantitiesType `json:"taskForecast,omitempty"`
}
...
// SetFacilityCodes gets a reference to the given FacilityCodesForecastType and assigns it to the FacilityCodes field.
...
func (o *FacilityTaskForecastType) GetTaskForecast() ForecastQuantitiesType {
	if o == nil || IsNil(o.TaskForecast) {
		var ret ForecastQuantitiesType
		return ret
	}
...
// SetTaskForecast gets a reference to the given ForecastQuantitiesType and assigns it to the TaskForecast field.
