...
type ReservationHousekeepingScheduleType struct {
	...
	FacilityHousekeepingTasks *FacilityHousekeepingTasksType `json:"facilityHousekeepingTasks,omitempty"`
...
func (o *ReservationHousekeepingScheduleType) GetFacilityHousekeepingTasks() FacilityHousekeepingTasksType {
	if o == nil || IsNil(o.FacilityHousekeepingTasks) {
		var ret FacilityHousekeepingTasksType
		return ret
	}
...
// SetFacilityHousekeepingTasks gets a reference to the given FacilityHousekeepingTasksType and assigns it to the FacilityHousekeepingTasks field.
