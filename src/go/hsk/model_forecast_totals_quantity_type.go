...
type ForecastTotalsQuantityType struct {
	...
	RoomTypeBreakDown *RoomTypeTasksType `json:"roomTypeBreakDown,omitempty"`
...
// SetRoomTypeBreakDown gets a reference to the given RoomTypeTasksType and assigns it to the RoomTypeBreakDown field.
