...
type FacilityTotalForecastType struct {
	TotalFacilityCodes *FacilityCodesForecastType `json:"totalFacilityCodes,omitempty"`
	Totals *ForecastTotalsQuantitiesType `json:"totals,omitempty"`
}
...
func (o *FacilityTotalForecastType) GetTotalFacilityCodes() FacilityCodesForecastType {
	if o == nil || IsNil(o.TotalFacilityCodes) {
		var ret FacilityCodesForecastType
		return ret
	}
...
// SetTotalFacilityCodes gets a reference to the given FacilityCodesForecastType and assigns it to the TotalFacilityCodes field.
...
func (o *FacilityTotalForecastType) GetTotals() ForecastTotalsQuantitiesType {
	if o == nil || IsNil(o.Totals) {
		var ret ForecastTotalsQuantitiesType
		return ret
	}
	return *o.Totals
}
...
// SetTotals gets a reference to the given ForecastTotalsQuantitiesType and assigns it to the Totals field.
