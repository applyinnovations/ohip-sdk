...
type FetchRevenueTransactionCodesDetails struct {
	RevenueTransactionCodes *RotationRevenueTransactionCodesType `json:"revenueTransactionCodes,omitempty"`
...
func (o *FetchRevenueTransactionCodesDetails) GetRevenueTransactionCodes() RotationRevenueTransactionCodesType {
	if o == nil || IsNil(o.RevenueTransactionCodes) {
		var ret RotationRevenueTransactionCodesType
		return ret
	}
...
// SetRevenueTransactionCodes gets a reference to the given RotationRevenueTransactionCodesType and assigns it to the RevenueTransactionCodes field.
