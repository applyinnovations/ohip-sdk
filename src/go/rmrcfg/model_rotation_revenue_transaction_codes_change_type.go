...
type RotationRevenueTransactionCodesChangeType struct {
	...
	NonRotationRevenueTransactionCodes *TransactionCodesType `json:"nonRotationRevenueTransactionCodes,omitempty"`
	RotationRevenueTransactionCodes *TransactionCodesType `json:"rotationRevenueTransactionCodes,omitempty"`
}
...
// SetNonRotationRevenueTransactionCodes gets a reference to the given TransactionCodesType and assigns it to the NonRotationRevenueTransactionCodes field.
...
// SetRotationRevenueTransactionCodes gets a reference to the given TransactionCodesType and assigns it to the RotationRevenueTransactionCodes field.
