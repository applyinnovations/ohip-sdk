...
`func (o *CreateRoomOwnerReferralDetails) GetWarnings() WarningsType`

GetWarnings returns the Warnings field if non-nil, zero value otherwise.

### GetWarningsOk

`func (o *CreateRoomOwnerReferralDetails) GetWarningsOk() (*WarningsType, bool)`
...
`func (o *CreateRoomOwnerReferralDetails) SetWarnings(v WarningsType)`
