...
// checks if the ChangeRevenueTransactionCodesDetails type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ChangeRevenueTransactionCodesDetails{}

// ChangeRevenueTransactionCodesDetails Existing Operations Responses will eventually be modified to be extended from this type.
type ChangeRevenueTransactionCodesDetails struct {
...
func NewChangeRevenueTransactionCodesDetails() *ChangeRevenueTransactionCodesDetails {
	this := ChangeRevenueTransactionCodesDetails{}
	var enforceAllowed bool = false
	this.EnforceAllowed = &enforceAllowed
	var retryAllowed bool = false
	this.RetryAllowed = &retryAllowed
	var useLocalAllowed bool = false
	this.UseLocalAllowed = &useLocalAllowed
	return &this
}
...
func (o ChangeRevenueTransactionCodesDetails) MarshalJSON() ([]byte, error) {
...
func (o ChangeRevenueTransactionCodesDetails) ToMap() (map[string]interface{}, error) {
...
type NullableChangeRevenueTransactionCodesDetails struct {
	value *ChangeRevenueTransactionCodesDetails
	isSet bool
}

func (v NullableChangeRevenueTransactionCodesDetails) Get() *ChangeRevenueTransactionCodesDetails {
	return v.value
}

func (v *NullableChangeRevenueTransactionCodesDetails) Set(val *ChangeRevenueTransactionCodesDetails) {
	v.value = val
	v.isSet = true
}

func (v NullableChangeRevenueTransactionCodesDetails) IsSet() bool {
	return v.isSet
}

func (v *NullableChangeRevenueTransactionCodesDetails) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableChangeRevenueTransactionCodesDetails(val *ChangeRevenueTransactionCodesDetails) *NullableChangeRevenueTransactionCodesDetails {
	return &NullableChangeRevenueTransactionCodesDetails{value: val, isSet: true}
}

func (v NullableChangeRevenueTransactionCodesDetails) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableChangeRevenueTransactionCodesDetails) UnmarshalJSON(src []byte) error {
	v.isSet = true
