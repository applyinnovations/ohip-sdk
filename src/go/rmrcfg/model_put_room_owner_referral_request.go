...
// checks if the PutRoomOwnerReferralRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PutRoomOwnerReferralRequest{}

// PutRoomOwnerReferralRequest struct for PutRoomOwnerReferralRequest
type PutRoomOwnerReferralRequest struct {
...
func NewPutRoomOwnerReferralRequest() *PutRoomOwnerReferralRequest {
	this := PutRoomOwnerReferralRequest{}
	return &this
}
...
func (o PutRoomOwnerReferralRequest) MarshalJSON() ([]byte, error) {
...
func (o PutRoomOwnerReferralRequest) ToMap() (map[string]interface{}, error) {
...
type NullablePutRoomOwnerReferralRequest struct {
	value *PutRoomOwnerReferralRequest
	isSet bool
}

func (v NullablePutRoomOwnerReferralRequest) Get() *PutRoomOwnerReferralRequest {
	return v.value
}

func (v *NullablePutRoomOwnerReferralRequest) Set(val *PutRoomOwnerReferralRequest) {
	v.value = val
	v.isSet = true
}

func (v NullablePutRoomOwnerReferralRequest) IsSet() bool {
	return v.isSet
}

func (v *NullablePutRoomOwnerReferralRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePutRoomOwnerReferralRequest(val *PutRoomOwnerReferralRequest) *NullablePutRoomOwnerReferralRequest {
	return &NullablePutRoomOwnerReferralRequest{value: val, isSet: true}
}

func (v NullablePutRoomOwnerReferralRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePutRoomOwnerReferralRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
