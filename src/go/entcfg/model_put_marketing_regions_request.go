...
// checks if the PutMarketingRegionsRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PutMarketingRegionsRequest{}

// PutMarketingRegionsRequest struct for PutMarketingRegionsRequest
type PutMarketingRegionsRequest struct {
...
func NewPutMarketingRegionsRequest() *PutMarketingRegionsRequest {
	this := PutMarketingRegionsRequest{}
	return &this
}
...
func (o PutMarketingRegionsRequest) MarshalJSON() ([]byte, error) {
...
func (o PutMarketingRegionsRequest) ToMap() (map[string]interface{}, error) {
...
type NullablePutMarketingRegionsRequest struct {
	value *PutMarketingRegionsRequest
	isSet bool
}

func (v NullablePutMarketingRegionsRequest) Get() *PutMarketingRegionsRequest {
	return v.value
}

func (v *NullablePutMarketingRegionsRequest) Set(val *PutMarketingRegionsRequest) {
	v.value = val
	v.isSet = true
}

func (v NullablePutMarketingRegionsRequest) IsSet() bool {
	return v.isSet
}

func (v *NullablePutMarketingRegionsRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePutMarketingRegionsRequest(val *PutMarketingRegionsRequest) *NullablePutMarketingRegionsRequest {
	return &NullablePutMarketingRegionsRequest{value: val, isSet: true}
}

func (v NullablePutMarketingRegionsRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePutMarketingRegionsRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
