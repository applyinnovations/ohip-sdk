...
// checks if the PutChainRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PutChainRequest{}

// PutChainRequest struct for PutChainRequest
type PutChainRequest struct {
...
func (o PutChainRequest) MarshalJSON() ([]byte, error) {
...
func (o PutChainRequest) ToMap() (map[string]interface{}, error) {
...
type NullablePutChainRequest struct {
	value *PutChainRequest
	isSet bool
}

func (v NullablePutChainRequest) Get() *PutChainRequest {
	return v.value
}

func (v *NullablePutChainRequest) Set(val *PutChainRequest) {
	v.value = val
	v.isSet = true
}

func (v NullablePutChainRequest) IsSet() bool {
	return v.isSet
}

func (v *NullablePutChainRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePutChainRequest(val *PutChainRequest) *NullablePutChainRequest {
	return &NullablePutChainRequest{value: val, isSet: true}
}

func (v NullablePutChainRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePutChainRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
