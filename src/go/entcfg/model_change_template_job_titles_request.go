...
func (o *ChangeTemplateJobTitlesRequest) GetLinks() Links {
...
func (o *ChangeTemplateJobTitlesRequest) GetLinksOk() (*Links, bool) {
	if o == nil || IsNil(o.Links) {
		return nil, false
	}
	return o.Links, true
...
func (o *ChangeTemplateJobTitlesRequest) SetLinks(v Links) {
	o.Links = &v
}

// GetTemplateJobTitles returns the TemplateJobTitles field value if set, zero value otherwise.
func (o *ChangeTemplateJobTitlesRequest) GetTemplateJobTitles() TemplateJobTitlesType {
...
// and a boolean to check if the value has been set.
func (o *ChangeTemplateJobTitlesRequest) GetTemplateJobTitlesOk() (*TemplateJobTitlesType, bool) {
	if o == nil || IsNil(o.TemplateJobTitles) {
		return nil, false
	}
...
func (o *ChangeTemplateJobTitlesRequest) SetTemplateJobTitles(v TemplateJobTitlesType) {
	o.TemplateJobTitles = &v
}

// GetWarnings returns the Warnings field value if set, zero value otherwise.
func (o *ChangeTemplateJobTitlesRequest) GetWarnings() WarningsType {
...
// and a boolean to check if the value has been set.
func (o *ChangeTemplateJobTitlesRequest) GetWarningsOk() (*WarningsType, bool) {
	if o == nil || IsNil(o.Warnings) {
		return nil, false
	}
...
func (o *ChangeTemplateJobTitlesRequest) SetWarnings(v WarningsType) {
	o.Warnings = &v
}
