...
// checks if the HotelBrochureTypeAddress type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &HotelBrochureTypeAddress{}

// HotelBrochureTypeAddress Provides address information.
type HotelBrochureTypeAddress struct {
...
func (o HotelBrochureTypeAddress) MarshalJSON() ([]byte, error) {
...
func (o HotelBrochureTypeAddress) ToMap() (map[string]interface{}, error) {
...
type NullableHotelBrochureTypeAddress struct {
	value *HotelBrochureTypeAddress
	isSet bool
}

func (v NullableHotelBrochureTypeAddress) Get() *HotelBrochureTypeAddress {
	return v.value
}

func (v *NullableHotelBrochureTypeAddress) Set(val *HotelBrochureTypeAddress) {
	v.value = val
	v.isSet = true
}

func (v NullableHotelBrochureTypeAddress) IsSet() bool {
	return v.isSet
}

func (v *NullableHotelBrochureTypeAddress) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableHotelBrochureTypeAddress(val *HotelBrochureTypeAddress) *NullableHotelBrochureTypeAddress {
	return &NullableHotelBrochureTypeAddress{value: val, isSet: true}
}

func (v NullableHotelBrochureTypeAddress) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableHotelBrochureTypeAddress) UnmarshalJSON(src []byte) error {
	v.isSet = true
