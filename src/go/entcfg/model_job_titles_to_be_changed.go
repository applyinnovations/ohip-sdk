...
func (o *JobTitlesToBeChanged) GetJobTitles() JobTitlesType {
...
func (o *JobTitlesToBeChanged) GetJobTitlesOk() (*JobTitlesType, bool) {
	if o == nil || IsNil(o.JobTitles) {
		return nil, false
	}
...
func (o *JobTitlesToBeChanged) SetJobTitles(v JobTitlesType) {
	o.JobTitles = &v
}

// GetLinks returns the Links field value if set, zero value otherwise.
func (o *JobTitlesToBeChanged) GetLinks() Links {
...
// and a boolean to check if the value has been set.
func (o *JobTitlesToBeChanged) GetLinksOk() (*Links, bool) {
	if o == nil || IsNil(o.Links) {
		return nil, false
	}
	return o.Links, true
...
func (o *JobTitlesToBeChanged) SetLinks(v Links) {
	o.Links = &v
}

// GetWarnings returns the Warnings field value if set, zero value otherwise.
func (o *JobTitlesToBeChanged) GetWarnings() WarningsType {
...
// and a boolean to check if the value has been set.
func (o *JobTitlesToBeChanged) GetWarningsOk() (*WarningsType, bool) {
	if o == nil || IsNil(o.Warnings) {
		return nil, false
	}
...
func (o *JobTitlesToBeChanged) SetWarnings(v WarningsType) {
	o.Warnings = &v
}
