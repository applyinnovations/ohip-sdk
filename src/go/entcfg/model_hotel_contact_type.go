...
type HotelContactType struct {
	...
	Roles *HotelContactRolesType `json:"roles,omitempty"`
}
...
// SetRoles gets a reference to the given HotelContactRolesType and assigns it to the Roles field.
