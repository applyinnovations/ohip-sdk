...
`func (o *TelephoneBookCategoriesToBeChanged) GetLinks() Links`

GetLinks returns the Links field if non-nil, zero value otherwise.

### GetLinksOk

`func (o *TelephoneBookCategoriesToBeChanged) GetLinksOk() (*Links, bool)`
...
`func (o *TelephoneBookCategoriesToBeChanged) SetLinks(v Links)`
...
`func (o *TelephoneBookCategoriesToBeChanged) GetTelephoneCategories() TelephoneCategoriesType`

GetTelephoneCategories returns the TelephoneCategories field if non-nil, zero value otherwise.

### GetTelephoneCategoriesOk

`func (o *TelephoneBookCategoriesToBeChanged) GetTelephoneCategoriesOk() (*TelephoneCategoriesType, bool)`
...
`func (o *TelephoneBookCategoriesToBeChanged) SetTelephoneCategories(v TelephoneCategoriesType)`
...
`func (o *TelephoneBookCategoriesToBeChanged) GetWarnings() WarningsType`

GetWarnings returns the Warnings field if non-nil, zero value otherwise.

### GetWarningsOk

`func (o *TelephoneBookCategoriesToBeChanged) GetWarningsOk() (*WarningsType, bool)`
...
`func (o *TelephoneBookCategoriesToBeChanged) SetWarnings(v WarningsType)`
