...
`func (o *HotelRateRangesCriteria) GetHotelRateRanges() HotelRateRangesType`

GetHotelRateRanges returns the HotelRateRanges field if non-nil, zero value otherwise.

### GetHotelRateRangesOk

`func (o *HotelRateRangesCriteria) GetHotelRateRangesOk() (*HotelRateRangesType, bool)`
...
`func (o *HotelRateRangesCriteria) SetHotelRateRanges(v HotelRateRangesType)`
...
`func (o *HotelRateRangesCriteria) GetLinks() Links`

GetLinks returns the Links field if non-nil, zero value otherwise.

### GetLinksOk

`func (o *HotelRateRangesCriteria) GetLinksOk() (*Links, bool)`
...
`func (o *HotelRateRangesCriteria) SetLinks(v Links)`
...
`func (o *HotelRateRangesCriteria) GetWarnings() WarningsType`

GetWarnings returns the Warnings field if non-nil, zero value otherwise.

### GetWarningsOk

`func (o *HotelRateRangesCriteria) GetWarningsOk() (*WarningsType, bool)`
...
`func (o *HotelRateRangesCriteria) SetWarnings(v WarningsType)`
