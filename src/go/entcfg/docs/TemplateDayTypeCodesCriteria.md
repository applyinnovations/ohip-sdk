...
`func (o *TemplateDayTypeCodesCriteria) GetLinks() Links`

GetLinks returns the Links field if non-nil, zero value otherwise.

### GetLinksOk

`func (o *TemplateDayTypeCodesCriteria) GetLinksOk() (*Links, bool)`
...
`func (o *TemplateDayTypeCodesCriteria) SetLinks(v Links)`
...
`func (o *TemplateDayTypeCodesCriteria) GetTemplateDayTypeCodes() TemplateDayTypeCodesType`

GetTemplateDayTypeCodes returns the TemplateDayTypeCodes field if non-nil, zero value otherwise.

### GetTemplateDayTypeCodesOk

`func (o *TemplateDayTypeCodesCriteria) GetTemplateDayTypeCodesOk() (*TemplateDayTypeCodesType, bool)`
...
`func (o *TemplateDayTypeCodesCriteria) SetTemplateDayTypeCodes(v TemplateDayTypeCodesType)`
...
`func (o *TemplateDayTypeCodesCriteria) GetWarnings() WarningsType`

GetWarnings returns the Warnings field if non-nil, zero value otherwise.

### GetWarningsOk

`func (o *TemplateDayTypeCodesCriteria) GetWarningsOk() (*WarningsType, bool)`
...
`func (o *TemplateDayTypeCodesCriteria) SetWarnings(v WarningsType)`
