...
`func (o *NoteTypesToBeChanged) GetLinks() Links`

GetLinks returns the Links field if non-nil, zero value otherwise.

### GetLinksOk

`func (o *NoteTypesToBeChanged) GetLinksOk() (*Links, bool)`
...
`func (o *NoteTypesToBeChanged) SetLinks(v Links)`
...
`func (o *NoteTypesToBeChanged) GetNoteTypes() NoteTypesType`

GetNoteTypes returns the NoteTypes field if non-nil, zero value otherwise.

### GetNoteTypesOk

`func (o *NoteTypesToBeChanged) GetNoteTypesOk() (*NoteTypesType, bool)`
...
`func (o *NoteTypesToBeChanged) SetNoteTypes(v NoteTypesType)`
...
`func (o *NoteTypesToBeChanged) GetWarnings() WarningsType`

GetWarnings returns the Warnings field if non-nil, zero value otherwise.

### GetWarningsOk

`func (o *NoteTypesToBeChanged) GetWarningsOk() (*WarningsType, bool)`
...
`func (o *NoteTypesToBeChanged) SetWarnings(v WarningsType)`
