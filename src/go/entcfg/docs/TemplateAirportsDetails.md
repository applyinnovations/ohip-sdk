...
`func (o *TemplateAirportsDetails) GetLinks() Links`

GetLinks returns the Links field if non-nil, zero value otherwise.

### GetLinksOk

`func (o *TemplateAirportsDetails) GetLinksOk() (*Links, bool)`
...
`func (o *TemplateAirportsDetails) SetLinks(v Links)`
...
`func (o *TemplateAirportsDetails) GetTemplateAirports() TemplateAirportsType`

GetTemplateAirports returns the TemplateAirports field if non-nil, zero value otherwise.

### GetTemplateAirportsOk

`func (o *TemplateAirportsDetails) GetTemplateAirportsOk() (*TemplateAirportsType, bool)`
...
`func (o *TemplateAirportsDetails) SetTemplateAirports(v TemplateAirportsType)`
...
`func (o *TemplateAirportsDetails) GetWarnings() WarningsType`

GetWarnings returns the Warnings field if non-nil, zero value otherwise.

### GetWarningsOk

`func (o *TemplateAirportsDetails) GetWarningsOk() (*WarningsType, bool)`
...
`func (o *TemplateAirportsDetails) SetWarnings(v WarningsType)`
