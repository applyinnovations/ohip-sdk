...
`func (o *TelephoneBookEntriesCriteria) GetLinks() Links`

GetLinks returns the Links field if non-nil, zero value otherwise.

### GetLinksOk

`func (o *TelephoneBookEntriesCriteria) GetLinksOk() (*Links, bool)`
...
`func (o *TelephoneBookEntriesCriteria) SetLinks(v Links)`
...
`func (o *TelephoneBookEntriesCriteria) GetTelephoneBookEntries() TelephoneBookEntriesType`

GetTelephoneBookEntries returns the TelephoneBookEntries field if non-nil, zero value otherwise.

### GetTelephoneBookEntriesOk

`func (o *TelephoneBookEntriesCriteria) GetTelephoneBookEntriesOk() (*TelephoneBookEntriesType, bool)`
...
`func (o *TelephoneBookEntriesCriteria) SetTelephoneBookEntries(v TelephoneBookEntriesType)`
...
`func (o *TelephoneBookEntriesCriteria) GetWarnings() WarningsType`

GetWarnings returns the Warnings field if non-nil, zero value otherwise.

### GetWarningsOk

`func (o *TelephoneBookEntriesCriteria) GetWarningsOk() (*WarningsType, bool)`
...
`func (o *TelephoneBookEntriesCriteria) SetWarnings(v WarningsType)`
