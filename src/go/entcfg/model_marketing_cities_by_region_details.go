...
type MarketingCitiesByRegionDetails struct {
	...
	MarketingCities *RegionsType `json:"marketingCities,omitempty"`
...
// SetMarketingCities gets a reference to the given RegionsType and assigns it to the MarketingCities field.
