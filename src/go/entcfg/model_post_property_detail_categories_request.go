...
// checks if the PostPropertyDetailCategoriesRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PostPropertyDetailCategoriesRequest{}

// PostPropertyDetailCategoriesRequest struct for PostPropertyDetailCategoriesRequest
type PostPropertyDetailCategoriesRequest struct {
...
func NewPostPropertyDetailCategoriesRequest() *PostPropertyDetailCategoriesRequest {
	this := PostPropertyDetailCategoriesRequest{}
	return &this
}
...
func (o PostPropertyDetailCategoriesRequest) MarshalJSON() ([]byte, error) {
...
func (o PostPropertyDetailCategoriesRequest) ToMap() (map[string]interface{}, error) {
...
type NullablePostPropertyDetailCategoriesRequest struct {
	value *PostPropertyDetailCategoriesRequest
	isSet bool
}

func (v NullablePostPropertyDetailCategoriesRequest) Get() *PostPropertyDetailCategoriesRequest {
	return v.value
}

func (v *NullablePostPropertyDetailCategoriesRequest) Set(val *PostPropertyDetailCategoriesRequest) {
	v.value = val
	v.isSet = true
}

func (v NullablePostPropertyDetailCategoriesRequest) IsSet() bool {
	return v.isSet
}

func (v *NullablePostPropertyDetailCategoriesRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePostPropertyDetailCategoriesRequest(val *PostPropertyDetailCategoriesRequest) *NullablePostPropertyDetailCategoriesRequest {
	return &NullablePostPropertyDetailCategoriesRequest{value: val, isSet: true}
}

func (v NullablePostPropertyDetailCategoriesRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePostPropertyDetailCategoriesRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
