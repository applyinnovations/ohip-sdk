...
type PostConfigActivityLogRequest struct {
	ConfigActivities *ConfigActivitiesType `json:"configActivities,omitempty"`
...
// SetConfigActivities gets a reference to the given ConfigActivitiesType and assigns it to the ConfigActivities field.
