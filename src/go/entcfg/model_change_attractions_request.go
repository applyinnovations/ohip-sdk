...
// checks if the ChangeAttractionsRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ChangeAttractionsRequest{}

// ChangeAttractionsRequest struct for ChangeAttractionsRequest
type ChangeAttractionsRequest struct {
...
func (o ChangeAttractionsRequest) MarshalJSON() ([]byte, error) {
...
func (o ChangeAttractionsRequest) ToMap() (map[string]interface{}, error) {
...
type NullableChangeAttractionsRequest struct {
	value *ChangeAttractionsRequest
	isSet bool
}

func (v NullableChangeAttractionsRequest) Get() *ChangeAttractionsRequest {
	return v.value
}

func (v *NullableChangeAttractionsRequest) Set(val *ChangeAttractionsRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableChangeAttractionsRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableChangeAttractionsRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableChangeAttractionsRequest(val *ChangeAttractionsRequest) *NullableChangeAttractionsRequest {
	return &NullableChangeAttractionsRequest{value: val, isSet: true}
}

func (v NullableChangeAttractionsRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableChangeAttractionsRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
