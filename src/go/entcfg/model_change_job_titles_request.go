...
// checks if the ChangeJobTitlesRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ChangeJobTitlesRequest{}

// ChangeJobTitlesRequest struct for ChangeJobTitlesRequest
type ChangeJobTitlesRequest struct {
...
func (o ChangeJobTitlesRequest) MarshalJSON() ([]byte, error) {
...
func (o ChangeJobTitlesRequest) ToMap() (map[string]interface{}, error) {
...
type NullableChangeJobTitlesRequest struct {
	value *ChangeJobTitlesRequest
	isSet bool
}

func (v NullableChangeJobTitlesRequest) Get() *ChangeJobTitlesRequest {
	return v.value
}

func (v *NullableChangeJobTitlesRequest) Set(val *ChangeJobTitlesRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableChangeJobTitlesRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableChangeJobTitlesRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableChangeJobTitlesRequest(val *ChangeJobTitlesRequest) *NullableChangeJobTitlesRequest {
	return &NullableChangeJobTitlesRequest{value: val, isSet: true}
}

func (v NullableChangeJobTitlesRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableChangeJobTitlesRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
