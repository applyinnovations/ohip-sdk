...
type TemplateJobTitlesToBeChanged struct {
	...
	TemplateJobTitles *TemplateJobTitlesType `json:"templateJobTitles,omitempty"`
...
// SetTemplateJobTitles gets a reference to the given TemplateJobTitlesType and assigns it to the TemplateJobTitles field.
