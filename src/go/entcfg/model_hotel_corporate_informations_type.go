...
type HotelCorporateInformationsType struct {
	...
	BusinessUnit *PrimaryCodesType `json:"businessUnit,omitempty"`
	DepartmentCode *PrimaryCodesType `json:"departmentCode,omitempty"`
	Division *PrimaryCodesType `json:"division,omitempty"`
	HotelCategory *string `json:"hotelCategory,omitempty"`
	OpertingUnit *PrimaryCodesType `json:"opertingUnit,omitempty"`
}
...
// SetBusinessUnit gets a reference to the given PrimaryCodesType and assigns it to the BusinessUnit field.
...
// SetDepartmentCode gets a reference to the given PrimaryCodesType and assigns it to the DepartmentCode field.
...
// SetDivision gets a reference to the given PrimaryCodesType and assigns it to the Division field.
...
// SetOpertingUnit gets a reference to the given PrimaryCodesType and assigns it to the OpertingUnit field.
