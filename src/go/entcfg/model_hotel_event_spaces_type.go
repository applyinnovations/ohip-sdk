...
type HotelEventSpacesType struct {
	EventSpaceDetails *HotelEventSpaceDetailsType `json:"eventSpaceDetails,omitempty"`
	EventSpaceSummaries *HotelEventSpaceSummariesType `json:"eventSpaceSummaries,omitempty"`
	SetupStyles *HotelSetupStylesType `json:"setupStyles,omitempty"`
}
...
func (o *HotelEventSpacesType) GetEventSpaceDetails() HotelEventSpaceDetailsType {
	if o == nil || IsNil(o.EventSpaceDetails) {
		var ret HotelEventSpaceDetailsType
		return ret
	}
...
// SetEventSpaceDetails gets a reference to the given HotelEventSpaceDetailsType and assigns it to the EventSpaceDetails field.
...
func (o *HotelEventSpacesType) GetEventSpaceSummaries() HotelEventSpaceSummariesType {
	if o == nil || IsNil(o.EventSpaceSummaries) {
		var ret HotelEventSpaceSummariesType
		return ret
	}
...
// SetEventSpaceSummaries gets a reference to the given HotelEventSpaceSummariesType and assigns it to the EventSpaceSummaries field.
...
// SetSetupStyles gets a reference to the given HotelSetupStylesType and assigns it to the SetupStyles field.
