...
type NoteTypeType struct {
	...
	Departments *GenericHotelCodeCodeListType `json:"departments,omitempty"`
	...
	NotificationAreas *CodeListType `json:"notificationAreas,omitempty"`
	// Indicates if the Note Types Code is override internal.
	OverrideInternal *bool `json:"overrideInternal,omitempty"`
	PropertyDefaultNoteTexts *DefaultNoteTextsDetailType `json:"propertyDefaultNoteTexts,omitempty"`
}
...
func (o *NoteTypeType) GetDepartments() GenericHotelCodeCodeListType {
	if o == nil || IsNil(o.Departments) {
		var ret GenericHotelCodeCodeListType
		return ret
	}
...
// SetDepartments gets a reference to the given GenericHotelCodeCodeListType and assigns it to the Departments field.
...
// SetNotificationAreas gets a reference to the given CodeListType and assigns it to the NotificationAreas field.
...
func (o *NoteTypeType) GetPropertyDefaultNoteTexts() DefaultNoteTextsDetailType {
	if o == nil || IsNil(o.PropertyDefaultNoteTexts) {
		var ret DefaultNoteTextsDetailType
		return ret
	}
...
// SetPropertyDefaultNoteTexts gets a reference to the given DefaultNoteTextsDetailType and assigns it to the PropertyDefaultNoteTexts field.
