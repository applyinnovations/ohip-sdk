...
// checks if the PostTelephoneBookEntriesRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PostTelephoneBookEntriesRequest{}

// PostTelephoneBookEntriesRequest struct for PostTelephoneBookEntriesRequest
type PostTelephoneBookEntriesRequest struct {
...
func NewPostTelephoneBookEntriesRequest() *PostTelephoneBookEntriesRequest {
	this := PostTelephoneBookEntriesRequest{}
	return &this
}
...
func (o PostTelephoneBookEntriesRequest) MarshalJSON() ([]byte, error) {
...
func (o PostTelephoneBookEntriesRequest) ToMap() (map[string]interface{}, error) {
...
type NullablePostTelephoneBookEntriesRequest struct {
	value *PostTelephoneBookEntriesRequest
	isSet bool
}

func (v NullablePostTelephoneBookEntriesRequest) Get() *PostTelephoneBookEntriesRequest {
	return v.value
}

func (v *NullablePostTelephoneBookEntriesRequest) Set(val *PostTelephoneBookEntriesRequest) {
	v.value = val
	v.isSet = true
}

func (v NullablePostTelephoneBookEntriesRequest) IsSet() bool {
	return v.isSet
}

func (v *NullablePostTelephoneBookEntriesRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePostTelephoneBookEntriesRequest(val *PostTelephoneBookEntriesRequest) *NullablePostTelephoneBookEntriesRequest {
	return &NullablePostTelephoneBookEntriesRequest{value: val, isSet: true}
}

func (v NullablePostTelephoneBookEntriesRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePostTelephoneBookEntriesRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
