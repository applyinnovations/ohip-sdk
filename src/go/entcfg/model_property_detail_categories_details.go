...
func (o *PropertyDetailCategoriesDetails) GetLinks() Links {
...
func (o *PropertyDetailCategoriesDetails) GetLinksOk() (*Links, bool) {
	if o == nil || IsNil(o.Links) {
		return nil, false
	}
	return o.Links, true
...
func (o *PropertyDetailCategoriesDetails) SetLinks(v Links) {
	o.Links = &v
}

// GetPropertyDetailCategories returns the PropertyDetailCategories field value if set, zero value otherwise.
func (o *PropertyDetailCategoriesDetails) GetPropertyDetailCategories() PropertyDetailCategoriesType {
...
// and a boolean to check if the value has been set.
func (o *PropertyDetailCategoriesDetails) GetPropertyDetailCategoriesOk() (*PropertyDetailCategoriesType, bool) {
	if o == nil || IsNil(o.PropertyDetailCategories) {
		return nil, false
	}
...
func (o *PropertyDetailCategoriesDetails) SetPropertyDetailCategories(v PropertyDetailCategoriesType) {
	o.PropertyDetailCategories = &v
}

// GetWarnings returns the Warnings field value if set, zero value otherwise.
func (o *PropertyDetailCategoriesDetails) GetWarnings() WarningsType {
...
// and a boolean to check if the value has been set.
func (o *PropertyDetailCategoriesDetails) GetWarningsOk() (*WarningsType, bool) {
	if o == nil || IsNil(o.Warnings) {
		return nil, false
	}
...
func (o *PropertyDetailCategoriesDetails) SetWarnings(v WarningsType) {
	o.Warnings = &v
}
