...
// checks if the PostJobTitlesRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PostJobTitlesRequest{}

// PostJobTitlesRequest struct for PostJobTitlesRequest
type PostJobTitlesRequest struct {
...
func (o PostJobTitlesRequest) MarshalJSON() ([]byte, error) {
...
func (o PostJobTitlesRequest) ToMap() (map[string]interface{}, error) {
...
type NullablePostJobTitlesRequest struct {
	value *PostJobTitlesRequest
	isSet bool
}

func (v NullablePostJobTitlesRequest) Get() *PostJobTitlesRequest {
	return v.value
}

func (v *NullablePostJobTitlesRequest) Set(val *PostJobTitlesRequest) {
	v.value = val
	v.isSet = true
}

func (v NullablePostJobTitlesRequest) IsSet() bool {
	return v.isSet
}

func (v *NullablePostJobTitlesRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePostJobTitlesRequest(val *PostJobTitlesRequest) *NullablePostJobTitlesRequest {
	return &NullablePostJobTitlesRequest{value: val, isSet: true}
}

func (v NullablePostJobTitlesRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePostJobTitlesRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
