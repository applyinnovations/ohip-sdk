...
// checks if the CreditCardTypesCriteria type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreditCardTypesCriteria{}

// CreditCardTypesCriteria Request object for creating Credit Card Types.
type CreditCardTypesCriteria struct {
...
func (o CreditCardTypesCriteria) MarshalJSON() ([]byte, error) {
...
func (o CreditCardTypesCriteria) ToMap() (map[string]interface{}, error) {
...
type NullableCreditCardTypesCriteria struct {
	value *CreditCardTypesCriteria
	isSet bool
}

func (v NullableCreditCardTypesCriteria) Get() *CreditCardTypesCriteria {
	return v.value
}

func (v *NullableCreditCardTypesCriteria) Set(val *CreditCardTypesCriteria) {
	v.value = val
	v.isSet = true
}

func (v NullableCreditCardTypesCriteria) IsSet() bool {
	return v.isSet
}

func (v *NullableCreditCardTypesCriteria) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreditCardTypesCriteria(val *CreditCardTypesCriteria) *NullableCreditCardTypesCriteria {
	return &NullableCreditCardTypesCriteria{value: val, isSet: true}
}

func (v NullableCreditCardTypesCriteria) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreditCardTypesCriteria) UnmarshalJSON(src []byte) error {
	v.isSet = true
