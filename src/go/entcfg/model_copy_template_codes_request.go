...
type CopyTemplateCodesRequest struct {
	Codes *CodeListType `json:"codes,omitempty"`
	HotelCodes *HotelCodeListType `json:"hotelCodes,omitempty"`
...
// SetCodes gets a reference to the given CodeListType and assigns it to the Codes field.
...
// SetHotelCodes gets a reference to the given HotelCodeListType and assigns it to the HotelCodes field.
