...
func (o *ChangePropertyDetailCategoriesRequest) GetLinks() Links {
...
func (o *ChangePropertyDetailCategoriesRequest) GetLinksOk() (*Links, bool) {
	if o == nil || IsNil(o.Links) {
		return nil, false
	}
	return o.Links, true
...
func (o *ChangePropertyDetailCategoriesRequest) SetLinks(v Links) {
	o.Links = &v
}

// GetPropertyDetailCategories returns the PropertyDetailCategories field value if set, zero value otherwise.
func (o *ChangePropertyDetailCategoriesRequest) GetPropertyDetailCategories() PropertyDetailCategoriesType {
...
// and a boolean to check if the value has been set.
func (o *ChangePropertyDetailCategoriesRequest) GetPropertyDetailCategoriesOk() (*PropertyDetailCategoriesType, bool) {
	if o == nil || IsNil(o.PropertyDetailCategories) {
		return nil, false
	}
...
func (o *ChangePropertyDetailCategoriesRequest) SetPropertyDetailCategories(v PropertyDetailCategoriesType) {
	o.PropertyDetailCategories = &v
}

// GetWarnings returns the Warnings field value if set, zero value otherwise.
func (o *ChangePropertyDetailCategoriesRequest) GetWarnings() WarningsType {
...
// and a boolean to check if the value has been set.
func (o *ChangePropertyDetailCategoriesRequest) GetWarningsOk() (*WarningsType, bool) {
	if o == nil || IsNil(o.Warnings) {
		return nil, false
	}
...
func (o *ChangePropertyDetailCategoriesRequest) SetWarnings(v WarningsType) {
	o.Warnings = &v
}
