...
type HotelAirportType struct {
	...
	TransportationList *TransportationCodeListType `json:"transportationList,omitempty"`
}
...
func (o *HotelAirportType) GetTransportationList() TransportationCodeListType {
	if o == nil || IsNil(o.TransportationList) {
		var ret TransportationCodeListType
		return ret
	}
...
// SetTransportationList gets a reference to the given TransportationCodeListType and assigns it to the TransportationList field.
