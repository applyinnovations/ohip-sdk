...
func (o *MarketingRegionsDetails) GetLinks() Links {
...
func (o *MarketingRegionsDetails) GetLinksOk() (*Links, bool) {
	if o == nil || IsNil(o.Links) {
		return nil, false
	}
	return o.Links, true
...
func (o *MarketingRegionsDetails) SetLinks(v Links) {
	o.Links = &v
}

// GetMarketingRegions returns the MarketingRegions field value if set, zero value otherwise.
func (o *MarketingRegionsDetails) GetMarketingRegions() MarketingRegionsType {
...
// and a boolean to check if the value has been set.
func (o *MarketingRegionsDetails) GetMarketingRegionsOk() (*MarketingRegionsType, bool) {
	if o == nil || IsNil(o.MarketingRegions) {
		return nil, false
	}
...
func (o *MarketingRegionsDetails) SetMarketingRegions(v MarketingRegionsType) {
	o.MarketingRegions = &v
}

// GetWarnings returns the Warnings field value if set, zero value otherwise.
func (o *MarketingRegionsDetails) GetWarnings() WarningsType {
...
// and a boolean to check if the value has been set.
func (o *MarketingRegionsDetails) GetWarningsOk() (*WarningsType, bool) {
	if o == nil || IsNil(o.Warnings) {
		return nil, false
	}
...
func (o *MarketingRegionsDetails) SetWarnings(v WarningsType) {
	o.Warnings = &v
}
