...
// checks if the AlternateHotelsToBeChanged type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AlternateHotelsToBeChanged{}

// AlternateHotelsToBeChanged Request object for changing hotel Alternate Hotels for hotels.
type AlternateHotelsToBeChanged struct {
...
func NewAlternateHotelsToBeChanged() *AlternateHotelsToBeChanged {
	this := AlternateHotelsToBeChanged{}
	return &this
}
...
func (o AlternateHotelsToBeChanged) MarshalJSON() ([]byte, error) {
...
func (o AlternateHotelsToBeChanged) ToMap() (map[string]interface{}, error) {
...
type NullableAlternateHotelsToBeChanged struct {
	value *AlternateHotelsToBeChanged
	isSet bool
}

func (v NullableAlternateHotelsToBeChanged) Get() *AlternateHotelsToBeChanged {
	return v.value
}

func (v *NullableAlternateHotelsToBeChanged) Set(val *AlternateHotelsToBeChanged) {
	v.value = val
	v.isSet = true
}

func (v NullableAlternateHotelsToBeChanged) IsSet() bool {
	return v.isSet
}

func (v *NullableAlternateHotelsToBeChanged) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAlternateHotelsToBeChanged(val *AlternateHotelsToBeChanged) *NullableAlternateHotelsToBeChanged {
	return &NullableAlternateHotelsToBeChanged{value: val, isSet: true}
}

func (v NullableAlternateHotelsToBeChanged) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAlternateHotelsToBeChanged) UnmarshalJSON(src []byte) error {
	v.isSet = true
