...
type MembershipSearchType struct {
	...
	MembershipLevel *CodeListType `json:"membershipLevel,omitempty"`
	MembershipType *CodeListType `json:"membershipType,omitempty"`
}
...
// SetMembershipLevel gets a reference to the given CodeListType and assigns it to the MembershipLevel field.
...
// SetMembershipType gets a reference to the given CodeListType and assigns it to the MembershipType field.
