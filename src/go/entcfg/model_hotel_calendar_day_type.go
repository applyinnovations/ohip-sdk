...
type HotelCalendarDayType struct {
	...
	Events *HotelCalendarEventsType `json:"events,omitempty"`
}
...
func (o *HotelCalendarDayType) GetEvents() HotelCalendarEventsType {
	if o == nil || IsNil(o.Events) {
		var ret HotelCalendarEventsType
		return ret
	}
	return *o.Events
}
...
// SetEvents gets a reference to the given HotelCalendarEventsType and assigns it to the Events field.
