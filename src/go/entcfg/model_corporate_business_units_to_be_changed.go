...
// checks if the CorporateBusinessUnitsToBeChanged type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CorporateBusinessUnitsToBeChanged{}

// CorporateBusinessUnitsToBeChanged Request object for changing Corporate Business Units.
type CorporateBusinessUnitsToBeChanged struct {
...
func NewCorporateBusinessUnitsToBeChanged() *CorporateBusinessUnitsToBeChanged {
	this := CorporateBusinessUnitsToBeChanged{}
	return &this
}
...
func (o CorporateBusinessUnitsToBeChanged) MarshalJSON() ([]byte, error) {
...
func (o CorporateBusinessUnitsToBeChanged) ToMap() (map[string]interface{}, error) {
...
type NullableCorporateBusinessUnitsToBeChanged struct {
	value *CorporateBusinessUnitsToBeChanged
	isSet bool
}

func (v NullableCorporateBusinessUnitsToBeChanged) Get() *CorporateBusinessUnitsToBeChanged {
	return v.value
}

func (v *NullableCorporateBusinessUnitsToBeChanged) Set(val *CorporateBusinessUnitsToBeChanged) {
	v.value = val
	v.isSet = true
}

func (v NullableCorporateBusinessUnitsToBeChanged) IsSet() bool {
	return v.isSet
}

func (v *NullableCorporateBusinessUnitsToBeChanged) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCorporateBusinessUnitsToBeChanged(val *CorporateBusinessUnitsToBeChanged) *NullableCorporateBusinessUnitsToBeChanged {
	return &NullableCorporateBusinessUnitsToBeChanged{value: val, isSet: true}
}

func (v NullableCorporateBusinessUnitsToBeChanged) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCorporateBusinessUnitsToBeChanged) UnmarshalJSON(src []byte) error {
	v.isSet = true
