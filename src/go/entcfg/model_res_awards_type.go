...
type ResAwardsType struct {
	AwardVouchers *AwardVouchersType `json:"awardVouchers,omitempty"`
...
// SetAwardVouchers gets a reference to the given AwardVouchersType and assigns it to the AwardVouchers field.
