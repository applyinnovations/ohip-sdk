...
// checks if the AirportsDetails type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AirportsDetails{}

// AirportsDetails Response object for fetching airports configured for hotels.
type AirportsDetails struct {
...
func (o AirportsDetails) MarshalJSON() ([]byte, error) {
...
func (o AirportsDetails) ToMap() (map[string]interface{}, error) {
...
type NullableAirportsDetails struct {
	value *AirportsDetails
	isSet bool
}

func (v NullableAirportsDetails) Get() *AirportsDetails {
	return v.value
}

func (v *NullableAirportsDetails) Set(val *AirportsDetails) {
	v.value = val
	v.isSet = true
}

func (v NullableAirportsDetails) IsSet() bool {
	return v.isSet
}

func (v *NullableAirportsDetails) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAirportsDetails(val *AirportsDetails) *NullableAirportsDetails {
	return &NullableAirportsDetails{value: val, isSet: true}
}

func (v NullableAirportsDetails) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAirportsDetails) UnmarshalJSON(src []byte) error {
	v.isSet = true
