...
type HotelConferenceFacilitiesType struct {
	...
	HotelConferenceRooms *HotelConferenceRoomsType `json:"hotelConferenceRooms,omitempty"`
}
...
func (o *HotelConferenceFacilitiesType) GetHotelConferenceRooms() HotelConferenceRoomsType {
	if o == nil || IsNil(o.HotelConferenceRooms) {
		var ret HotelConferenceRoomsType
		return ret
	}
...
// SetHotelConferenceRooms gets a reference to the given HotelConferenceRoomsType and assigns it to the HotelConferenceRooms field.
