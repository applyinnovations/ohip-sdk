...
func (o *PutRoomTypeTemplatesRequest) GetLinks() Links {
...
func (o *PutRoomTypeTemplatesRequest) GetLinksOk() (*Links, bool) {
	if o == nil || IsNil(o.Links) {
		return nil, false
	}
	return o.Links, true
...
func (o *PutRoomTypeTemplatesRequest) SetLinks(v Links) {
	o.Links = &v
}
...
func (o *PutRoomTypeTemplatesRequest) GetWarnings() WarningsType {
...
// and a boolean to check if the value has been set.
func (o *PutRoomTypeTemplatesRequest) GetWarningsOk() (*WarningsType, bool) {
	if o == nil || IsNil(o.Warnings) {
		return nil, false
	}
...
func (o *PutRoomTypeTemplatesRequest) SetWarnings(v WarningsType) {
	o.Warnings = &v
}
