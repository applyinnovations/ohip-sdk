...
// checks if the RoomTypesDetails type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RoomTypesDetails{}

// RoomTypesDetails Response object for Fetching existing Room Types.
type RoomTypesDetails struct {
	...
	RoomTypes []RoomTypesType `json:"roomTypes,omitempty"`
	// Contains the results of a successful operation.
	RoomTypesSummary []RoomTypesSummaryType `json:"roomTypesSummary,omitempty"`
...
// SetRoomTypes gets a reference to the given []RoomTypesType and assigns it to the RoomTypes field.
func (o *RoomTypesDetails) SetRoomTypes(v []RoomTypesType) {
	o.RoomTypes = v
}

// GetRoomTypesSummary returns the RoomTypesSummary field value if set, zero value otherwise.
func (o *RoomTypesDetails) GetRoomTypesSummary() []RoomTypesSummaryType {
	if o == nil || IsNil(o.RoomTypesSummary) {
		var ret []RoomTypesSummaryType
		return ret
	}
	return o.RoomTypesSummary
}

// GetRoomTypesSummaryOk returns a tuple with the RoomTypesSummary field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *RoomTypesDetails) GetRoomTypesSummaryOk() ([]RoomTypesSummaryType, bool) {
	if o == nil || IsNil(o.RoomTypesSummary) {
		return nil, false
	}
	return o.RoomTypesSummary, true
}
...
// SetRoomTypesSummary gets a reference to the given []RoomTypesSummaryType and assigns it to the RoomTypesSummary field.
func (o *RoomTypesDetails) SetRoomTypesSummary(v []RoomTypesSummaryType) {
	o.RoomTypesSummary = v
}
...
func (o RoomTypesDetails) MarshalJSON() ([]byte, error) {
...
func (o RoomTypesDetails) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.RoomTypesSummary) {
		toSerialize["roomTypesSummary"] = o.RoomTypesSummary
	}
...
type NullableRoomTypesDetails struct {
	value *RoomTypesDetails
	isSet bool
}

func (v NullableRoomTypesDetails) Get() *RoomTypesDetails {
	return v.value
}

func (v *NullableRoomTypesDetails) Set(val *RoomTypesDetails) {
	v.value = val
	v.isSet = true
}

func (v NullableRoomTypesDetails) IsSet() bool {
	return v.isSet
}

func (v *NullableRoomTypesDetails) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRoomTypesDetails(val *RoomTypesDetails) *NullableRoomTypesDetails {
	return &NullableRoomTypesDetails{value: val, isSet: true}
}

func (v NullableRoomTypesDetails) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRoomTypesDetails) UnmarshalJSON(src []byte) error {
	v.isSet = true
