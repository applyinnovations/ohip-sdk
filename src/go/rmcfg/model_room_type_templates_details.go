...
type RoomTypeTemplatesDetails struct {
	...
	RoomTypeTemplates *RoomTypeTemplateType `json:"roomTypeTemplates,omitempty"`
	RoomTypeTemplatesSummary *RoomTypeTemplateSummaryType `json:"roomTypeTemplatesSummary,omitempty"`
...
// SetRoomTypeTemplates gets a reference to the given RoomTypeTemplateType and assigns it to the RoomTypeTemplates field.
...
func (o *RoomTypeTemplatesDetails) GetRoomTypeTemplatesSummary() RoomTypeTemplateSummaryType {
	if o == nil || IsNil(o.RoomTypeTemplatesSummary) {
		var ret RoomTypeTemplateSummaryType
		return ret
	}
...
// SetRoomTypeTemplatesSummary gets a reference to the given RoomTypeTemplateSummaryType and assigns it to the RoomTypeTemplatesSummary field.
