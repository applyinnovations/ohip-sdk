...
type ConfigHousekeepingRoomScheduleType struct {
	...
	SpecialRequests *CodeListType `json:"specialRequests,omitempty"`
	TaskSupplies *ConfigHousekeepingRoomScheduleTaskSuppliesType `json:"taskSupplies,omitempty"`
	VIPStatuses *CodeListType `json:"vIPStatuses,omitempty"`
}
...
// SetSpecialRequests gets a reference to the given CodeListType and assigns it to the SpecialRequests field.
...
func (o *ConfigHousekeepingRoomScheduleType) GetTaskSupplies() ConfigHousekeepingRoomScheduleTaskSuppliesType {
	if o == nil || IsNil(o.TaskSupplies) {
		var ret ConfigHousekeepingRoomScheduleTaskSuppliesType
		return ret
	}
...
// SetTaskSupplies gets a reference to the given ConfigHousekeepingRoomScheduleTaskSuppliesType and assigns it to the TaskSupplies field.
...
// SetVIPStatuses gets a reference to the given CodeListType and assigns it to the VIPStatuses field.
