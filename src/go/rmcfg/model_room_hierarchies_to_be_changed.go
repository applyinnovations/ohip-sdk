...
func (o *RoomHierarchiesToBeChanged) GetLinks() Links {
...
func (o *RoomHierarchiesToBeChanged) GetLinksOk() (*Links, bool) {
	if o == nil || IsNil(o.Links) {
		return nil, false
	}
	return o.Links, true
...
func (o *RoomHierarchiesToBeChanged) SetLinks(v Links) {
	o.Links = &v
}

// GetRoomHierarchies returns the RoomHierarchies field value if set, zero value otherwise.
func (o *RoomHierarchiesToBeChanged) GetRoomHierarchies() RoomHierarchiesType {
...
// and a boolean to check if the value has been set.
func (o *RoomHierarchiesToBeChanged) GetRoomHierarchiesOk() (*RoomHierarchiesType, bool) {
	if o == nil || IsNil(o.RoomHierarchies) {
		return nil, false
	}
...
func (o *RoomHierarchiesToBeChanged) SetRoomHierarchies(v RoomHierarchiesType) {
	o.RoomHierarchies = &v
}

// GetWarnings returns the Warnings field value if set, zero value otherwise.
func (o *RoomHierarchiesToBeChanged) GetWarnings() WarningsType {
...
// and a boolean to check if the value has been set.
func (o *RoomHierarchiesToBeChanged) GetWarningsOk() (*WarningsType, bool) {
	if o == nil || IsNil(o.Warnings) {
		return nil, false
	}
...
func (o *RoomHierarchiesToBeChanged) SetWarnings(v WarningsType) {
	o.Warnings = &v
}
