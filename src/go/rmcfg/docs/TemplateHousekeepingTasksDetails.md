...
`func (o *TemplateHousekeepingTasksDetails) GetLinks() Links`

GetLinks returns the Links field if non-nil, zero value otherwise.

### GetLinksOk

`func (o *TemplateHousekeepingTasksDetails) GetLinksOk() (*Links, bool)`
...
`func (o *TemplateHousekeepingTasksDetails) SetLinks(v Links)`
...
`func (o *TemplateHousekeepingTasksDetails) GetWarnings() WarningsType`

GetWarnings returns the Warnings field if non-nil, zero value otherwise.

### GetWarningsOk

`func (o *TemplateHousekeepingTasksDetails) GetWarningsOk() (*WarningsType, bool)`
...
`func (o *TemplateHousekeepingTasksDetails) SetWarnings(v WarningsType)`
