...
`func (o *ChangeBuildingsRequest) GetBuildings() BuildingsType`

GetBuildings returns the Buildings field if non-nil, zero value otherwise.

### GetBuildingsOk

`func (o *ChangeBuildingsRequest) GetBuildingsOk() (*BuildingsType, bool)`
...
`func (o *ChangeBuildingsRequest) SetBuildings(v BuildingsType)`
...
`func (o *ChangeBuildingsRequest) GetLinks() Links`

GetLinks returns the Links field if non-nil, zero value otherwise.

### GetLinksOk

`func (o *ChangeBuildingsRequest) GetLinksOk() (*Links, bool)`
...
`func (o *ChangeBuildingsRequest) SetLinks(v Links)`
...
`func (o *ChangeBuildingsRequest) GetWarnings() WarningsType`

GetWarnings returns the Warnings field if non-nil, zero value otherwise.

### GetWarningsOk

`func (o *ChangeBuildingsRequest) GetWarningsOk() (*WarningsType, bool)`
...
`func (o *ChangeBuildingsRequest) SetWarnings(v WarningsType)`
