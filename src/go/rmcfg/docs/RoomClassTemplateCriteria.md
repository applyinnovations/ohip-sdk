...
`func (o *RoomClassTemplateCriteria) GetLinks() Links`

GetLinks returns the Links field if non-nil, zero value otherwise.

### GetLinksOk

`func (o *RoomClassTemplateCriteria) GetLinksOk() (*Links, bool)`
...
`func (o *RoomClassTemplateCriteria) SetLinks(v Links)`
...
`func (o *RoomClassTemplateCriteria) GetWarnings() WarningsType`

GetWarnings returns the Warnings field if non-nil, zero value otherwise.

### GetWarningsOk

`func (o *RoomClassTemplateCriteria) GetWarningsOk() (*WarningsType, bool)`
...
`func (o *RoomClassTemplateCriteria) SetWarnings(v WarningsType)`
