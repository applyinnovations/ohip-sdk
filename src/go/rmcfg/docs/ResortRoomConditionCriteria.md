...
`func (o *ResortRoomConditionCriteria) GetLinks() Links`

GetLinks returns the Links field if non-nil, zero value otherwise.

### GetLinksOk

`func (o *ResortRoomConditionCriteria) GetLinksOk() (*Links, bool)`
...
`func (o *ResortRoomConditionCriteria) SetLinks(v Links)`
...
`func (o *ResortRoomConditionCriteria) GetWarnings() WarningsType`

GetWarnings returns the Warnings field if non-nil, zero value otherwise.

### GetWarningsOk

`func (o *ResortRoomConditionCriteria) GetWarningsOk() (*WarningsType, bool)`
...
`func (o *ResortRoomConditionCriteria) SetWarnings(v WarningsType)`
