...
`func (o *PutBedTypesRequest) GetBedTypes() BedTypesType`

GetBedTypes returns the BedTypes field if non-nil, zero value otherwise.

### GetBedTypesOk

`func (o *PutBedTypesRequest) GetBedTypesOk() (*BedTypesType, bool)`
...
`func (o *PutBedTypesRequest) SetBedTypes(v BedTypesType)`
...
`func (o *PutBedTypesRequest) GetLinks() Links`

GetLinks returns the Links field if non-nil, zero value otherwise.

### GetLinksOk

`func (o *PutBedTypesRequest) GetLinksOk() (*Links, bool)`
...
`func (o *PutBedTypesRequest) SetLinks(v Links)`
...
`func (o *PutBedTypesRequest) GetWarnings() WarningsType`

GetWarnings returns the Warnings field if non-nil, zero value otherwise.

### GetWarningsOk

`func (o *PutBedTypesRequest) GetWarningsOk() (*WarningsType, bool)`
...
`func (o *PutBedTypesRequest) SetWarnings(v WarningsType)`
