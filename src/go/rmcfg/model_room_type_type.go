...
type RoomTypeType struct {
	...
	Components *RoomTypeComponentsType `json:"components,omitempty"`
	...
	Features *RoomFeaturesType `json:"features,omitempty"`
...
func (o *RoomTypeType) GetComponents() RoomTypeComponentsType {
	if o == nil || IsNil(o.Components) {
		var ret RoomTypeComponentsType
		return ret
	}
	return *o.Components
}
...
// SetComponents gets a reference to the given RoomTypeComponentsType and assigns it to the Components field.
...
// SetFeatures gets a reference to the given RoomFeaturesType and assigns it to the Features field.
