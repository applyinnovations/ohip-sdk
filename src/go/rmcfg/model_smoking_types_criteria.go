...
func (o *SmokingTypesCriteria) GetLinks() Links {
...
func (o *SmokingTypesCriteria) GetLinksOk() (*Links, bool) {
	if o == nil || IsNil(o.Links) {
		return nil, false
	}
	return o.Links, true
...
func (o *SmokingTypesCriteria) SetLinks(v Links) {
	o.Links = &v
}

// GetSmokingTypes returns the SmokingTypes field value if set, zero value otherwise.
func (o *SmokingTypesCriteria) GetSmokingTypes() SmokingTypesType {
...
// and a boolean to check if the value has been set.
func (o *SmokingTypesCriteria) GetSmokingTypesOk() (*SmokingTypesType, bool) {
	if o == nil || IsNil(o.SmokingTypes) {
		return nil, false
	}
...
func (o *SmokingTypesCriteria) SetSmokingTypes(v SmokingTypesType) {
	o.SmokingTypes = &v
}

// GetWarnings returns the Warnings field value if set, zero value otherwise.
func (o *SmokingTypesCriteria) GetWarnings() WarningsType {
...
// and a boolean to check if the value has been set.
func (o *SmokingTypesCriteria) GetWarningsOk() (*WarningsType, bool) {
	if o == nil || IsNil(o.Warnings) {
		return nil, false
	}
...
func (o *SmokingTypesCriteria) SetWarnings(v WarningsType) {
	o.Warnings = &v
}
