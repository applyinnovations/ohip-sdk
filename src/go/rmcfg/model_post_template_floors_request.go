...
func (o *PostTemplateFloorsRequest) GetLinks() Links {
...
func (o *PostTemplateFloorsRequest) GetLinksOk() (*Links, bool) {
	if o == nil || IsNil(o.Links) {
		return nil, false
	}
	return o.Links, true
...
func (o *PostTemplateFloorsRequest) SetLinks(v Links) {
	o.Links = &v
}

// GetTemplateFloors returns the TemplateFloors field value if set, zero value otherwise.
func (o *PostTemplateFloorsRequest) GetTemplateFloors() TemplateFloorsType {
...
// and a boolean to check if the value has been set.
func (o *PostTemplateFloorsRequest) GetTemplateFloorsOk() (*TemplateFloorsType, bool) {
	if o == nil || IsNil(o.TemplateFloors) {
		return nil, false
	}
...
func (o *PostTemplateFloorsRequest) SetTemplateFloors(v TemplateFloorsType) {
	o.TemplateFloors = &v
}

// GetWarnings returns the Warnings field value if set, zero value otherwise.
func (o *PostTemplateFloorsRequest) GetWarnings() WarningsType {
...
// and a boolean to check if the value has been set.
func (o *PostTemplateFloorsRequest) GetWarningsOk() (*WarningsType, bool) {
	if o == nil || IsNil(o.Warnings) {
		return nil, false
	}
...
func (o *PostTemplateFloorsRequest) SetWarnings(v WarningsType) {
	o.Warnings = &v
}
