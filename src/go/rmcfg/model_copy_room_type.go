...
type CopyRoomType struct {
	...
	NewRooms *CopyNewRoomsType `json:"newRooms,omitempty"`
...
// SetNewRooms gets a reference to the given CopyNewRoomsType and assigns it to the NewRooms field.
