...
func (o *RoomFeaturesToBeChanged) GetLinks() Links {
...
func (o *RoomFeaturesToBeChanged) GetLinksOk() (*Links, bool) {
	if o == nil || IsNil(o.Links) {
		return nil, false
	}
	return o.Links, true
...
func (o *RoomFeaturesToBeChanged) SetLinks(v Links) {
	o.Links = &v
}

// GetRoomFeatures returns the RoomFeatures field value if set, zero value otherwise.
func (o *RoomFeaturesToBeChanged) GetRoomFeatures() RoomFeaturesConfigType {
...
// and a boolean to check if the value has been set.
func (o *RoomFeaturesToBeChanged) GetRoomFeaturesOk() (*RoomFeaturesConfigType, bool) {
	if o == nil || IsNil(o.RoomFeatures) {
		return nil, false
	}
...
func (o *RoomFeaturesToBeChanged) SetRoomFeatures(v RoomFeaturesConfigType) {
	o.RoomFeatures = &v
}

// GetWarnings returns the Warnings field value if set, zero value otherwise.
func (o *RoomFeaturesToBeChanged) GetWarnings() WarningsType {
...
// and a boolean to check if the value has been set.
func (o *RoomFeaturesToBeChanged) GetWarningsOk() (*WarningsType, bool) {
	if o == nil || IsNil(o.Warnings) {
		return nil, false
	}
...
func (o *RoomFeaturesToBeChanged) SetWarnings(v WarningsType) {
	o.Warnings = &v
}
