...
type RoomClassesDetails struct {
	...
	RoomClasses *RoomClassesType `json:"roomClasses,omitempty"`
...
// SetRoomClasses gets a reference to the given RoomClassesType and assigns it to the RoomClasses field.
