...
func (o *PostRoomTypeTemplatesRequest) GetLinks() Links {
...
func (o *PostRoomTypeTemplatesRequest) GetLinksOk() (*Links, bool) {
	if o == nil || IsNil(o.Links) {
		return nil, false
	}
	return o.Links, true
...
func (o *PostRoomTypeTemplatesRequest) SetLinks(v Links) {
	o.Links = &v
}
...
func (o *PostRoomTypeTemplatesRequest) GetWarnings() WarningsType {
...
// and a boolean to check if the value has been set.
func (o *PostRoomTypeTemplatesRequest) GetWarningsOk() (*WarningsType, bool) {
	if o == nil || IsNil(o.Warnings) {
		return nil, false
	}
...
func (o *PostRoomTypeTemplatesRequest) SetWarnings(v WarningsType) {
	o.Warnings = &v
}
