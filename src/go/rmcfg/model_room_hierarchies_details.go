...
func (o *RoomHierarchiesDetails) GetLinks() Links {
...
func (o *RoomHierarchiesDetails) GetLinksOk() (*Links, bool) {
	if o == nil || IsNil(o.Links) {
		return nil, false
	}
	return o.Links, true
...
func (o *RoomHierarchiesDetails) SetLinks(v Links) {
	o.Links = &v
}

// GetRoomHierarchies returns the RoomHierarchies field value if set, zero value otherwise.
func (o *RoomHierarchiesDetails) GetRoomHierarchies() RoomHierarchiesType {
...
// and a boolean to check if the value has been set.
func (o *RoomHierarchiesDetails) GetRoomHierarchiesOk() (*RoomHierarchiesType, bool) {
	if o == nil || IsNil(o.RoomHierarchies) {
		return nil, false
	}
...
func (o *RoomHierarchiesDetails) SetRoomHierarchies(v RoomHierarchiesType) {
	o.RoomHierarchies = &v
}

// GetWarnings returns the Warnings field value if set, zero value otherwise.
func (o *RoomHierarchiesDetails) GetWarnings() WarningsType {
...
// and a boolean to check if the value has been set.
func (o *RoomHierarchiesDetails) GetWarningsOk() (*WarningsType, bool) {
	if o == nil || IsNil(o.Warnings) {
		return nil, false
	}
...
func (o *RoomHierarchiesDetails) SetWarnings(v WarningsType) {
	o.Warnings = &v
}
