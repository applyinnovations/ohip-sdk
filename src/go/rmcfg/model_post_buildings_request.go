...
// checks if the PostBuildingsRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PostBuildingsRequest{}

// PostBuildingsRequest struct for PostBuildingsRequest
type PostBuildingsRequest struct {
...
func (o PostBuildingsRequest) MarshalJSON() ([]byte, error) {
...
func (o PostBuildingsRequest) ToMap() (map[string]interface{}, error) {
...
type NullablePostBuildingsRequest struct {
	value *PostBuildingsRequest
	isSet bool
}

func (v NullablePostBuildingsRequest) Get() *PostBuildingsRequest {
	return v.value
}

func (v *NullablePostBuildingsRequest) Set(val *PostBuildingsRequest) {
	v.value = val
	v.isSet = true
}

func (v NullablePostBuildingsRequest) IsSet() bool {
	return v.isSet
}

func (v *NullablePostBuildingsRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePostBuildingsRequest(val *PostBuildingsRequest) *NullablePostBuildingsRequest {
	return &NullablePostBuildingsRequest{value: val, isSet: true}
}

func (v NullablePostBuildingsRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePostBuildingsRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
