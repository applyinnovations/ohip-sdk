...
func (o *RoomClassCriteria) GetLinks() Links {
...
func (o *RoomClassCriteria) GetLinksOk() (*Links, bool) {
	if o == nil || IsNil(o.Links) {
		return nil, false
	}
	return o.Links, true
...
func (o *RoomClassCriteria) SetLinks(v Links) {
	o.Links = &v
}
...
func (o *RoomClassCriteria) GetWarnings() WarningsType {
...
// and a boolean to check if the value has been set.
func (o *RoomClassCriteria) GetWarningsOk() (*WarningsType, bool) {
	if o == nil || IsNil(o.Warnings) {
		return nil, false
	}
...
func (o *RoomClassCriteria) SetWarnings(v WarningsType) {
	o.Warnings = &v
}
