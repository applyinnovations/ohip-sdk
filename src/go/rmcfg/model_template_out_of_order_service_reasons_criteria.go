...
func (o *TemplateOutOfOrderServiceReasonsCriteria) GetLinks() Links {
...
func (o *TemplateOutOfOrderServiceReasonsCriteria) GetLinksOk() (*Links, bool) {
	if o == nil || IsNil(o.Links) {
		return nil, false
	}
	return o.Links, true
...
func (o *TemplateOutOfOrderServiceReasonsCriteria) SetLinks(v Links) {
	o.Links = &v
}

// GetTemplateOutOfOrderServiceReasons returns the TemplateOutOfOrderServiceReasons field value if set, zero value otherwise.
func (o *TemplateOutOfOrderServiceReasonsCriteria) GetTemplateOutOfOrderServiceReasons() TemplateOutOfOrderServiceReasonsType {
...
// and a boolean to check if the value has been set.
func (o *TemplateOutOfOrderServiceReasonsCriteria) GetTemplateOutOfOrderServiceReasonsOk() (*TemplateOutOfOrderServiceReasonsType, bool) {
	if o == nil || IsNil(o.TemplateOutOfOrderServiceReasons) {
		return nil, false
	}
...
func (o *TemplateOutOfOrderServiceReasonsCriteria) SetTemplateOutOfOrderServiceReasons(v TemplateOutOfOrderServiceReasonsType) {
	o.TemplateOutOfOrderServiceReasons = &v
}

// GetWarnings returns the Warnings field value if set, zero value otherwise.
func (o *TemplateOutOfOrderServiceReasonsCriteria) GetWarnings() WarningsType {
...
// and a boolean to check if the value has been set.
func (o *TemplateOutOfOrderServiceReasonsCriteria) GetWarningsOk() (*WarningsType, bool) {
	if o == nil || IsNil(o.Warnings) {
		return nil, false
	}
...
func (o *TemplateOutOfOrderServiceReasonsCriteria) SetWarnings(v WarningsType) {
	o.Warnings = &v
}
