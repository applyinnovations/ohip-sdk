...
type RoomFeatureConfigType struct {
	...
	MappedPreferenceCodes *ConfigHotelPreferencesType `json:"mappedPreferenceCodes,omitempty"`
...
// SetMappedPreferenceCodes gets a reference to the given ConfigHotelPreferencesType and assigns it to the MappedPreferenceCodes field.
