...
type ConvertedValues struct {
	ConvertedValues *ConvertedValuesType `json:"convertedValues,omitempty"`
...
// SetConvertedValues gets a reference to the given ConvertedValuesType and assigns it to the ConvertedValues field.
