...
type TrackItItemType struct {
	...
	TrackItLogList *TrackItLogListType `json:"trackItLogList,omitempty"`
...
// SetTrackItLogList gets a reference to the given TrackItLogListType and assigns it to the TrackItLogList field.
