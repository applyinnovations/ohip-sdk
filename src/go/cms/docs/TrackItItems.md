...
`func (o *TrackItItems) GetLinks() Links`

GetLinks returns the Links field if non-nil, zero value otherwise.

### GetLinksOk

`func (o *TrackItItems) GetLinksOk() (*Links, bool)`
...
`func (o *TrackItItems) SetLinks(v Links)`
...
`func (o *TrackItItems) GetTrackItItemsInfo() TrackItItemsType`

GetTrackItItemsInfo returns the TrackItItemsInfo field if non-nil, zero value otherwise.

### GetTrackItItemsInfoOk

`func (o *TrackItItems) GetTrackItItemsInfoOk() (*TrackItItemsType, bool)`
...
`func (o *TrackItItems) SetTrackItItemsInfo(v TrackItItemsType)`
...
`func (o *TrackItItems) GetWarnings() WarningsType`

GetWarnings returns the Warnings field if non-nil, zero value otherwise.

### GetWarningsOk

`func (o *TrackItItems) GetWarningsOk() (*WarningsType, bool)`
...
`func (o *TrackItItems) SetWarnings(v WarningsType)`
