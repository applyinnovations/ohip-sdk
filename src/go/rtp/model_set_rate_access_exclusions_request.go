...
// checks if the SetRateAccessExclusionsRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SetRateAccessExclusionsRequest{}

// SetRateAccessExclusionsRequest struct for SetRateAccessExclusionsRequest
type SetRateAccessExclusionsRequest struct {
...
func NewSetRateAccessExclusionsRequest() *SetRateAccessExclusionsRequest {
	this := SetRateAccessExclusionsRequest{}
	return &this
}
...
func (o SetRateAccessExclusionsRequest) MarshalJSON() ([]byte, error) {
...
func (o SetRateAccessExclusionsRequest) ToMap() (map[string]interface{}, error) {
...
type NullableSetRateAccessExclusionsRequest struct {
	value *SetRateAccessExclusionsRequest
	isSet bool
}

func (v NullableSetRateAccessExclusionsRequest) Get() *SetRateAccessExclusionsRequest {
	return v.value
}

func (v *NullableSetRateAccessExclusionsRequest) Set(val *SetRateAccessExclusionsRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableSetRateAccessExclusionsRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableSetRateAccessExclusionsRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSetRateAccessExclusionsRequest(val *SetRateAccessExclusionsRequest) *NullableSetRateAccessExclusionsRequest {
	return &NullableSetRateAccessExclusionsRequest{value: val, isSet: true}
}

func (v NullableSetRateAccessExclusionsRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSetRateAccessExclusionsRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
