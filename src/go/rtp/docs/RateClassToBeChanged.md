...
`func (o *RateClassToBeChanged) GetLinks() Links`

GetLinks returns the Links field if non-nil, zero value otherwise.

### GetLinksOk

`func (o *RateClassToBeChanged) GetLinksOk() (*Links, bool)`
...
`func (o *RateClassToBeChanged) SetLinks(v Links)`
...
`func (o *RateClassToBeChanged) GetWarnings() WarningsType`

GetWarnings returns the Warnings field if non-nil, zero value otherwise.

### GetWarningsOk

`func (o *RateClassToBeChanged) GetWarningsOk() (*WarningsType, bool)`
...
`func (o *RateClassToBeChanged) SetWarnings(v WarningsType)`
