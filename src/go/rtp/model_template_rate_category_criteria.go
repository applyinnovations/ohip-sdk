...
func (o *TemplateRateCategoryCriteria) GetLinks() Links {
...
func (o *TemplateRateCategoryCriteria) GetLinksOk() (*Links, bool) {
	if o == nil || IsNil(o.Links) {
		return nil, false
	}
	return o.Links, true
...
func (o *TemplateRateCategoryCriteria) SetLinks(v Links) {
	o.Links = &v
}
...
func (o *TemplateRateCategoryCriteria) GetWarnings() WarningsType {
...
// and a boolean to check if the value has been set.
func (o *TemplateRateCategoryCriteria) GetWarningsOk() (*WarningsType, bool) {
	if o == nil || IsNil(o.Warnings) {
		return nil, false
	}
...
func (o *TemplateRateCategoryCriteria) SetWarnings(v WarningsType) {
	o.Warnings = &v
}
