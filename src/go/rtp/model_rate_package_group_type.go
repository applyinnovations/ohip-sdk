...
type RatePackageGroupType struct {
	...
	Packages *RatePackageCodeListType `json:"packages,omitempty"`
...
func (o *RatePackageGroupType) GetPackages() RatePackageCodeListType {
	if o == nil || IsNil(o.Packages) {
		var ret RatePackageCodeListType
		return ret
	}
	return *o.Packages
}
...
// SetPackages gets a reference to the given RatePackageCodeListType and assigns it to the Packages field.
