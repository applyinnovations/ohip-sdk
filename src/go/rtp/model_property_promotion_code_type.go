...
type PropertyPromotionCodeType struct {
	...
	PropertyPromotionRateCodes *PropertyPromotionRateCodesType `json:"propertyPromotionRateCodes,omitempty"`
}
...
func (o *PropertyPromotionCodeType) GetPropertyPromotionRateCodes() PropertyPromotionRateCodesType {
	if o == nil || IsNil(o.PropertyPromotionRateCodes) {
		var ret PropertyPromotionRateCodesType
		return ret
	}
...
// SetPropertyPromotionRateCodes gets a reference to the given PropertyPromotionRateCodesType and assigns it to the PropertyPromotionRateCodes field.
