...
type AdvancedDynamicBaseRateType struct {
	AdvancedDependentRatePlans *RatePlanCodeListType `json:"advancedDependentRatePlans,omitempty"`
...
// SetAdvancedDependentRatePlans gets a reference to the given RatePlanCodeListType and assigns it to the AdvancedDependentRatePlans field.
