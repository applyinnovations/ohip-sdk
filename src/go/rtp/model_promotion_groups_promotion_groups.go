...
type PromotionGroupsPromotionGroups struct {
	...
	PromotionGroups *PromotionGroupsType `json:"promotionGroups,omitempty"`
...
// SetPromotionGroups gets a reference to the given PromotionGroupsType and assigns it to the PromotionGroups field.
