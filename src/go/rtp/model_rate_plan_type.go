...
type RatePlanType struct {
	...
	ApprovalNotes *RatePlanNotesType `json:"approvalNotes,omitempty"`
	...
	RatePlanCodeIndicators *IndicatorsType `json:"ratePlanCodeIndicators,omitempty"`
...
// SetApprovalNotes gets a reference to the given RatePlanNotesType and assigns it to the ApprovalNotes field.
...
// SetRatePlanCodeIndicators gets a reference to the given IndicatorsType and assigns it to the RatePlanCodeIndicators field.
