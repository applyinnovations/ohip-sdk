...
type TemplatePromotionCodes struct {
	...
	TemplatePromotionCodes *TemplatePromotionCodesType `json:"templatePromotionCodes,omitempty"`
...
func (o *TemplatePromotionCodes) GetTemplatePromotionCodes() TemplatePromotionCodesType {
	if o == nil || IsNil(o.TemplatePromotionCodes) {
		var ret TemplatePromotionCodesType
		return ret
	}
...
// SetTemplatePromotionCodes gets a reference to the given TemplatePromotionCodesType and assigns it to the TemplatePromotionCodes field.
