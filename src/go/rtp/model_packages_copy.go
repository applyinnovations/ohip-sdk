...
// checks if the PackagesCopy type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PackagesCopy{}

// PackagesCopy List of the package codes to be copied to other hotel code(s).
type PackagesCopy struct {
	Items []CopyPackageCodesType
}
...
func (o PackagesCopy) ToMap() (map[string]interface{}, error) {
...
func (o *PackagesCopy) UnmarshalJSON(bytes []byte) (err error) {
