...
type PackageGroupType struct {
	...
	MembersList *PackageCodeListType `json:"membersList,omitempty"`
...
// SetMembersList gets a reference to the given PackageCodeListType and assigns it to the MembersList field.
