...
type RatePlanYieldControlsType struct {
	...
	YieldMarketCodeList *YieldMarketCodeListType `json:"yieldMarketCodeList,omitempty"`
...
func (o *RatePlanYieldControlsType) GetYieldMarketCodeList() YieldMarketCodeListType {
	if o == nil || IsNil(o.YieldMarketCodeList) {
		var ret YieldMarketCodeListType
		return ret
	}
...
// SetYieldMarketCodeList gets a reference to the given YieldMarketCodeListType and assigns it to the YieldMarketCodeList field.
