...
type RateClassType struct {
	...
	RateCategories *SimpleRateCategoriesType `json:"rateCategories,omitempty"`
...
func (o *RateClassType) GetRateCategories() SimpleRateCategoriesType {
	if o == nil || IsNil(o.RateCategories) {
		var ret SimpleRateCategoriesType
		return ret
	}
...
// SetRateCategories gets a reference to the given SimpleRateCategoriesType and assigns it to the RateCategories field.
