...
type RateGroups struct {
	...
	RateGroups *RateGroupsType `json:"rateGroups,omitempty"`
...
// SetRateGroups gets a reference to the given RateGroupsType and assigns it to the RateGroups field.
