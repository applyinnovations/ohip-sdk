...
func (o *PostTemplateRateCategoryRequest) GetLinks() Links {
...
func (o *PostTemplateRateCategoryRequest) GetLinksOk() (*Links, bool) {
	if o == nil || IsNil(o.Links) {
		return nil, false
	}
	return o.Links, true
...
func (o *PostTemplateRateCategoryRequest) SetLinks(v Links) {
	o.Links = &v
}
...
func (o *PostTemplateRateCategoryRequest) GetWarnings() WarningsType {
...
// and a boolean to check if the value has been set.
func (o *PostTemplateRateCategoryRequest) GetWarningsOk() (*WarningsType, bool) {
	if o == nil || IsNil(o.Warnings) {
		return nil, false
	}
...
func (o *PostTemplateRateCategoryRequest) SetWarnings(v WarningsType) {
	o.Warnings = &v
}
