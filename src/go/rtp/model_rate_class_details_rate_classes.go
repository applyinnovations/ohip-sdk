...
type RateClassDetailsRateClasses struct {
	...
	RateClasses *RateClassesType `json:"rateClasses,omitempty"`
...
// SetRateClasses gets a reference to the given RateClassesType and assigns it to the RateClasses field.
