...
type RatePlanScheduleDetailType struct {
	AdjustmentDetails *ScheduleAdjustmentDetailsType `json:"adjustmentDetails,omitempty"`
	...
	RoomTypeList *RoomTypeListType `json:"roomTypeList,omitempty"`
...
func (o *RatePlanScheduleDetailType) GetAdjustmentDetails() ScheduleAdjustmentDetailsType {
	if o == nil || IsNil(o.AdjustmentDetails) {
		var ret ScheduleAdjustmentDetailsType
		return ret
	}
...
// SetAdjustmentDetails gets a reference to the given ScheduleAdjustmentDetailsType and assigns it to the AdjustmentDetails field.
...
// SetRoomTypeList gets a reference to the given RoomTypeListType and assigns it to the RoomTypeList field.
