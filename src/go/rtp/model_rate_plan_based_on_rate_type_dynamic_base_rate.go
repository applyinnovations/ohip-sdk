...
type RatePlanBasedOnRateTypeDynamicBaseRate struct {
	...
	DependentRatePlans *RatePlanCodeListType `json:"dependentRatePlans,omitempty"`
...
// SetDependentRatePlans gets a reference to the given RatePlanCodeListType and assigns it to the DependentRatePlans field.
