...
type SynchronizeProfileSubscriptionsCriteriaType struct {
	DatabaseIds *DatabaseIDListType `json:"databaseIds,omitempty"`
...
// SetDatabaseIds gets a reference to the given DatabaseIDListType and assigns it to the DatabaseIds field.
