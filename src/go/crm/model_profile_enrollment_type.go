...
type ProfileEnrollmentType struct {
	...
	PreviousHotelStays *HotelStaysType `json:"previousHotelStays,omitempty"`
	...
	ProfileIndicators *IndicatorsType `json:"profileIndicators,omitempty"`
	...
	Subscriptions *ProfileSubscriptionListType `json:"subscriptions,omitempty"`
	...
	WebUserAccounts *WebUserAccountsType `json:"webUserAccounts,omitempty"`
}
...
// SetPreviousHotelStays gets a reference to the given HotelStaysType and assigns it to the PreviousHotelStays field.
...
// SetProfileIndicators gets a reference to the given IndicatorsType and assigns it to the ProfileIndicators field.
...
func (o *ProfileEnrollmentType) GetSubscriptions() ProfileSubscriptionListType {
	if o == nil || IsNil(o.Subscriptions) {
		var ret ProfileSubscriptionListType
		return ret
	}
...
// SetSubscriptions gets a reference to the given ProfileSubscriptionListType and assigns it to the Subscriptions field.
...
// SetWebUserAccounts gets a reference to the given WebUserAccountsType and assigns it to the WebUserAccounts field.
