...
type ProfileStatisticsType struct {
	...
	RevenueStatisticsSummaryList *RevenueStatisticsSummaryListType `json:"revenueStatisticsSummaryList,omitempty"`
	StayStatisticsDetailList *StayStatisticsDetailListType `json:"stayStatisticsDetailList,omitempty"`
...
func (o *ProfileStatisticsType) GetRevenueStatisticsSummaryList() RevenueStatisticsSummaryListType {
	if o == nil || IsNil(o.RevenueStatisticsSummaryList) {
		var ret RevenueStatisticsSummaryListType
		return ret
	}
...
// SetRevenueStatisticsSummaryList gets a reference to the given RevenueStatisticsSummaryListType and assigns it to the RevenueStatisticsSummaryList field.
...
func (o *ProfileStatisticsType) GetStayStatisticsDetailList() StayStatisticsDetailListType {
	if o == nil || IsNil(o.StayStatisticsDetailList) {
		var ret StayStatisticsDetailListType
		return ret
	}
...
// SetStayStatisticsDetailList gets a reference to the given StayStatisticsDetailListType and assigns it to the StayStatisticsDetailList field.
