...
type MembershipTransactionExceptions struct {
	...
	MemberTransactionExceptions *MembershipTransactionExceptionsType `json:"memberTransactionExceptions,omitempty"`
...
func (o *MembershipTransactionExceptions) GetMemberTransactionExceptions() MembershipTransactionExceptionsType {
	if o == nil || IsNil(o.MemberTransactionExceptions) {
		var ret MembershipTransactionExceptionsType
		return ret
	}
...
// SetMemberTransactionExceptions gets a reference to the given MembershipTransactionExceptionsType and assigns it to the MemberTransactionExceptions field.
