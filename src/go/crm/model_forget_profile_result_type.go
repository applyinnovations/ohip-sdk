...
type ForgetProfileResultType struct {
	...
	FailureReasons *ForgetProfileFailureReasonListType `json:"failureReasons,omitempty"`
...
func (o *ForgetProfileResultType) GetFailureReasons() ForgetProfileFailureReasonListType {
	if o == nil || IsNil(o.FailureReasons) {
		var ret ForgetProfileFailureReasonListType
		return ret
	}
...
// SetFailureReasons gets a reference to the given ForgetProfileFailureReasonListType and assigns it to the FailureReasons field.
