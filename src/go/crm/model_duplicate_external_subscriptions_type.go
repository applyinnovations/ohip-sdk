...
type DuplicateExternalSubscriptionsType struct {
	...
	ProfileSubscriptions *ProfileSubscriptionListType `json:"profileSubscriptions,omitempty"`
}
...
// SetProfileSubscriptions gets a reference to the given ProfileSubscriptionListType and assigns it to the ProfileSubscriptions field.
