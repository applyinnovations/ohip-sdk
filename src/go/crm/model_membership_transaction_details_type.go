...
type MembershipTransactionDetailsType struct {
	...
	ProfilePromotions *CodeListType `json:"profilePromotions,omitempty"`
...
func (o *MembershipTransactionDetailsType) GetProfilePromotions() CodeListType {
...
// SetProfilePromotions gets a reference to the given CodeListType and assigns it to the ProfilePromotions field.
