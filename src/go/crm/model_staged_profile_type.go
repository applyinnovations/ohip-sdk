...
type StagedProfileType struct {
	...
	Comments *StagedProfileCommentInfosType `json:"comments,omitempty"`
...
func (o *StagedProfileType) GetComments() StagedProfileCommentInfosType {
	if o == nil || IsNil(o.Comments) {
		var ret StagedProfileCommentInfosType
		return ret
	}
	return *o.Comments
}
...
// SetComments gets a reference to the given StagedProfileCommentInfosType and assigns it to the Comments field.
