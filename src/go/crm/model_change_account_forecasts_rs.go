...
// checks if the ChangeAccountForecastsRS type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ChangeAccountForecastsRS{}

// ChangeAccountForecastsRS Existing Operations Responses will eventually be modified to be extended from this type.
type ChangeAccountForecastsRS struct {
...
func (o ChangeAccountForecastsRS) MarshalJSON() ([]byte, error) {
...
func (o ChangeAccountForecastsRS) ToMap() (map[string]interface{}, error) {
...
type NullableChangeAccountForecastsRS struct {
	value *ChangeAccountForecastsRS
	isSet bool
}

func (v NullableChangeAccountForecastsRS) Get() *ChangeAccountForecastsRS {
	return v.value
}

func (v *NullableChangeAccountForecastsRS) Set(val *ChangeAccountForecastsRS) {
	v.value = val
	v.isSet = true
}

func (v NullableChangeAccountForecastsRS) IsSet() bool {
	return v.isSet
}

func (v *NullableChangeAccountForecastsRS) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableChangeAccountForecastsRS(val *ChangeAccountForecastsRS) *NullableChangeAccountForecastsRS {
	return &NullableChangeAccountForecastsRS{value: val, isSet: true}
}

func (v NullableChangeAccountForecastsRS) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableChangeAccountForecastsRS) UnmarshalJSON(src []byte) error {
	v.isSet = true
