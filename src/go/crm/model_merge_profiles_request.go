...
type MergeProfilesRequest struct {
	...
	VictimProfileId *UniqueIDListType `json:"victimProfileId,omitempty"`
...
// SetVictimProfileId gets a reference to the given UniqueIDListType and assigns it to the VictimProfileId field.
