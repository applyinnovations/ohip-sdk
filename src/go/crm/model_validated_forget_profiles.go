...
type ValidatedForgetProfiles struct {
	...
	ValidateForgetProfilesResults *ForgetProfileResultListType `json:"validateForgetProfilesResults,omitempty"`
...
func (o *ValidatedForgetProfiles) GetValidateForgetProfilesResults() ForgetProfileResultListType {
	if o == nil || IsNil(o.ValidateForgetProfilesResults) {
		var ret ForgetProfileResultListType
		return ret
	}
...
// SetValidateForgetProfilesResults gets a reference to the given ForgetProfileResultListType and assigns it to the ValidateForgetProfilesResults field.
