...
type PostGuestProfileRequest struct {
	...
	GuestIdList *ProfileIdList `json:"guestIdList,omitempty"`
...
// SetGuestIdList gets a reference to the given ProfileIdList and assigns it to the GuestIdList field.
