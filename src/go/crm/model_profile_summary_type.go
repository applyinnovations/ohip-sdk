...
type ProfileSummaryType struct {
	...
	AllowedActions *ProfileAllowedActionsType `json:"allowedActions,omitempty"`
	...
	Owners *OwnersType `json:"owners,omitempty"`
...
func (o *ProfileSummaryType) GetAllowedActions() ProfileAllowedActionsType {
	if o == nil || IsNil(o.AllowedActions) {
		var ret ProfileAllowedActionsType
		return ret
	}
...
// SetAllowedActions gets a reference to the given ProfileAllowedActionsType and assigns it to the AllowedActions field.
...
// SetOwners gets a reference to the given OwnersType and assigns it to the Owners field.
