...
type CheckProfileType struct {
	...
	Results *CheckProfileResultsType `json:"results,omitempty"`
}
...
func (o *CheckProfileType) GetResults() CheckProfileResultsType {
	if o == nil || IsNil(o.Results) {
		var ret CheckProfileResultsType
		return ret
	}
	return *o.Results
}
...
// SetResults gets a reference to the given CheckProfileResultsType and assigns it to the Results field.
