...
type PutProfileRequest struct {
	...
	ProfileAllowedActions *ProfileAllowedActionsType `json:"profileAllowedActions,omitempty"`
...
// SetProfileAllowedActions gets a reference to the given ProfileAllowedActionsType and assigns it to the ProfileAllowedActions field.
