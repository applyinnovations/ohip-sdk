...
// checks if the ValidateForgetProfilesRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ValidateForgetProfilesRequest{}

// ValidateForgetProfilesRequest struct for ValidateForgetProfilesRequest
type ValidateForgetProfilesRequest struct {
...
func NewValidateForgetProfilesRequest() *ValidateForgetProfilesRequest {
	this := ValidateForgetProfilesRequest{}
	return &this
}
...
func (o ValidateForgetProfilesRequest) MarshalJSON() ([]byte, error) {
...
func (o ValidateForgetProfilesRequest) ToMap() (map[string]interface{}, error) {
...
type NullableValidateForgetProfilesRequest struct {
	value *ValidateForgetProfilesRequest
	isSet bool
}

func (v NullableValidateForgetProfilesRequest) Get() *ValidateForgetProfilesRequest {
	return v.value
}

func (v *NullableValidateForgetProfilesRequest) Set(val *ValidateForgetProfilesRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableValidateForgetProfilesRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableValidateForgetProfilesRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableValidateForgetProfilesRequest(val *ValidateForgetProfilesRequest) *NullableValidateForgetProfilesRequest {
	return &NullableValidateForgetProfilesRequest{value: val, isSet: true}
}

func (v NullableValidateForgetProfilesRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableValidateForgetProfilesRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
