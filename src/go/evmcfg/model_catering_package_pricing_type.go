...
type CateringPackagePricingType struct {
	...
	RevenueDetails *CateringPackageRevenueListType `json:"revenueDetails,omitempty"`
...
func (o *CateringPackagePricingType) GetRevenueDetails() CateringPackageRevenueListType {
	if o == nil || IsNil(o.RevenueDetails) {
		var ret CateringPackageRevenueListType
		return ret
	}
...
// SetRevenueDetails gets a reference to the given CateringPackageRevenueListType and assigns it to the RevenueDetails field.
