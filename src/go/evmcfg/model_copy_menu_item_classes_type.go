...
type CopyMenuItemClassesType struct {
	...
	ItemClasses *UniqueIDListType `json:"itemClasses,omitempty"`
...
// SetItemClasses gets a reference to the given UniqueIDListType and assigns it to the ItemClasses field.
