...
// checks if the ChangeFunctionSpaceSetupStylesRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ChangeFunctionSpaceSetupStylesRequest{}

// ChangeFunctionSpaceSetupStylesRequest struct for ChangeFunctionSpaceSetupStylesRequest
type ChangeFunctionSpaceSetupStylesRequest struct {
...
func NewChangeFunctionSpaceSetupStylesRequest() *ChangeFunctionSpaceSetupStylesRequest {
	this := ChangeFunctionSpaceSetupStylesRequest{}
	return &this
}
...
func (o ChangeFunctionSpaceSetupStylesRequest) MarshalJSON() ([]byte, error) {
...
func (o ChangeFunctionSpaceSetupStylesRequest) ToMap() (map[string]interface{}, error) {
...
type NullableChangeFunctionSpaceSetupStylesRequest struct {
	value *ChangeFunctionSpaceSetupStylesRequest
	isSet bool
}

func (v NullableChangeFunctionSpaceSetupStylesRequest) Get() *ChangeFunctionSpaceSetupStylesRequest {
	return v.value
}

func (v *NullableChangeFunctionSpaceSetupStylesRequest) Set(val *ChangeFunctionSpaceSetupStylesRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableChangeFunctionSpaceSetupStylesRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableChangeFunctionSpaceSetupStylesRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableChangeFunctionSpaceSetupStylesRequest(val *ChangeFunctionSpaceSetupStylesRequest) *NullableChangeFunctionSpaceSetupStylesRequest {
	return &NullableChangeFunctionSpaceSetupStylesRequest{value: val, isSet: true}
}

func (v NullableChangeFunctionSpaceSetupStylesRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableChangeFunctionSpaceSetupStylesRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
