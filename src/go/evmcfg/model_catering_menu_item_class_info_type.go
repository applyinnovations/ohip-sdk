...
type CateringMenuItemClassInfoType struct {
	...
	EventTypeList *CodeListType `json:"eventTypeList,omitempty"`
	...
	ResponsibleDepartmentList *CodeListType `json:"responsibleDepartmentList,omitempty"`
...
// SetEventTypeList gets a reference to the given CodeListType and assigns it to the EventTypeList field.
...
// SetResponsibleDepartmentList gets a reference to the given CodeListType and assigns it to the ResponsibleDepartmentList field.
