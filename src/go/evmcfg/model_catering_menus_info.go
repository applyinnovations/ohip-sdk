...
// checks if the CateringMenusInfo type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CateringMenusInfo{}

// CateringMenusInfo Response object to fetch Menu .
type CateringMenusInfo struct {
...
func (o CateringMenusInfo) MarshalJSON() ([]byte, error) {
...
func (o CateringMenusInfo) ToMap() (map[string]interface{}, error) {
...
type NullableCateringMenusInfo struct {
	value *CateringMenusInfo
	isSet bool
}

func (v NullableCateringMenusInfo) Get() *CateringMenusInfo {
	return v.value
}

func (v *NullableCateringMenusInfo) Set(val *CateringMenusInfo) {
	v.value = val
	v.isSet = true
}

func (v NullableCateringMenusInfo) IsSet() bool {
	return v.isSet
}

func (v *NullableCateringMenusInfo) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCateringMenusInfo(val *CateringMenusInfo) *NullableCateringMenusInfo {
	return &NullableCateringMenusInfo{value: val, isSet: true}
}

func (v NullableCateringMenusInfo) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCateringMenusInfo) UnmarshalJSON(src []byte) error {
	v.isSet = true
