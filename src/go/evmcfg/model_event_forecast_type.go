...
type EventForecastType struct {
	...
	RevenueDetails *EventForecastRevDetailListType `json:"revenueDetails,omitempty"`
}
...
func (o *EventForecastType) GetRevenueDetails() EventForecastRevDetailListType {
	if o == nil || IsNil(o.RevenueDetails) {
		var ret EventForecastRevDetailListType
		return ret
	}
...
// SetRevenueDetails gets a reference to the given EventForecastRevDetailListType and assigns it to the RevenueDetails field.
