...
`func (o *CateringMenuClasses) GetLinks() Links`

GetLinks returns the Links field if non-nil, zero value otherwise.

### GetLinksOk

`func (o *CateringMenuClasses) GetLinksOk() (*Links, bool)`
...
`func (o *CateringMenuClasses) SetLinks(v Links)`
...
`func (o *CateringMenuClasses) GetMenuClassList() CateringMenuClassListType`

GetMenuClassList returns the MenuClassList field if non-nil, zero value otherwise.

### GetMenuClassListOk

`func (o *CateringMenuClasses) GetMenuClassListOk() (*CateringMenuClassListType, bool)`
...
`func (o *CateringMenuClasses) SetMenuClassList(v CateringMenuClassListType)`
...
`func (o *CateringMenuClasses) GetWarnings() WarningsType`

GetWarnings returns the Warnings field if non-nil, zero value otherwise.

### GetWarningsOk

`func (o *CateringMenuClasses) GetWarningsOk() (*WarningsType, bool)`
...
`func (o *CateringMenuClasses) SetWarnings(v WarningsType)`
