...
`func (o *PostMealTypesRequest) GetLinks() Links`

GetLinks returns the Links field if non-nil, zero value otherwise.

### GetLinksOk

`func (o *PostMealTypesRequest) GetLinksOk() (*Links, bool)`
...
`func (o *PostMealTypesRequest) SetLinks(v Links)`
...
`func (o *PostMealTypesRequest) GetMealTypes() MealTypesType`

GetMealTypes returns the MealTypes field if non-nil, zero value otherwise.

### GetMealTypesOk

`func (o *PostMealTypesRequest) GetMealTypesOk() (*MealTypesType, bool)`
...
`func (o *PostMealTypesRequest) SetMealTypes(v MealTypesType)`
...
`func (o *PostMealTypesRequest) GetWarnings() WarningsType`

GetWarnings returns the Warnings field if non-nil, zero value otherwise.

### GetWarningsOk

`func (o *PostMealTypesRequest) GetWarningsOk() (*WarningsType, bool)`
...
`func (o *PostMealTypesRequest) SetWarnings(v WarningsType)`
