...
`func (o *MealTypesDetails) GetLinks() Links`

GetLinks returns the Links field if non-nil, zero value otherwise.

### GetLinksOk

`func (o *MealTypesDetails) GetLinksOk() (*Links, bool)`
...
`func (o *MealTypesDetails) SetLinks(v Links)`
...
`func (o *MealTypesDetails) GetMealTypes() MealTypesType`

GetMealTypes returns the MealTypes field if non-nil, zero value otherwise.

### GetMealTypesOk

`func (o *MealTypesDetails) GetMealTypesOk() (*MealTypesType, bool)`
...
`func (o *MealTypesDetails) SetMealTypes(v MealTypesType)`
...
`func (o *MealTypesDetails) GetWarnings() WarningsType`

GetWarnings returns the Warnings field if non-nil, zero value otherwise.

### GetWarningsOk

`func (o *MealTypesDetails) GetWarningsOk() (*WarningsType, bool)`
...
`func (o *MealTypesDetails) SetWarnings(v WarningsType)`
