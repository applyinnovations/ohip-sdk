...
`func (o *EventForecasts) GetEventForecasts() EventForecastListType`

GetEventForecasts returns the EventForecasts field if non-nil, zero value otherwise.

### GetEventForecastsOk

`func (o *EventForecasts) GetEventForecastsOk() (*EventForecastListType, bool)`
...
`func (o *EventForecasts) SetEventForecasts(v EventForecastListType)`
...
`func (o *EventForecasts) GetLinks() Links`

GetLinks returns the Links field if non-nil, zero value otherwise.

### GetLinksOk

`func (o *EventForecasts) GetLinksOk() (*Links, bool)`
...
`func (o *EventForecasts) SetLinks(v Links)`
...
`func (o *EventForecasts) GetWarnings() WarningsType`

GetWarnings returns the Warnings field if non-nil, zero value otherwise.

### GetWarningsOk

`func (o *EventForecasts) GetWarningsOk() (*WarningsType, bool)`
...
`func (o *EventForecasts) SetWarnings(v WarningsType)`
