...
`func (o *FunctionSpaceSetupStylesCriteria) GetLinks() Links`

GetLinks returns the Links field if non-nil, zero value otherwise.

### GetLinksOk

`func (o *FunctionSpaceSetupStylesCriteria) GetLinksOk() (*Links, bool)`
...
`func (o *FunctionSpaceSetupStylesCriteria) SetLinks(v Links)`
...
`func (o *FunctionSpaceSetupStylesCriteria) GetSetupStyles() FunctionSpaceSetupStylesType`

GetSetupStyles returns the SetupStyles field if non-nil, zero value otherwise.

### GetSetupStylesOk

`func (o *FunctionSpaceSetupStylesCriteria) GetSetupStylesOk() (*FunctionSpaceSetupStylesType, bool)`
...
`func (o *FunctionSpaceSetupStylesCriteria) SetSetupStyles(v FunctionSpaceSetupStylesType)`
...
`func (o *FunctionSpaceSetupStylesCriteria) GetWarnings() WarningsType`

GetWarnings returns the Warnings field if non-nil, zero value otherwise.

### GetWarningsOk

`func (o *FunctionSpaceSetupStylesCriteria) GetWarningsOk() (*WarningsType, bool)`
...
`func (o *FunctionSpaceSetupStylesCriteria) SetWarnings(v WarningsType)`
