...
`func (o *PutCateringServingsRequest) GetLinks() Links`

GetLinks returns the Links field if non-nil, zero value otherwise.

### GetLinksOk

`func (o *PutCateringServingsRequest) GetLinksOk() (*Links, bool)`
...
`func (o *PutCateringServingsRequest) SetLinks(v Links)`
...
`func (o *PutCateringServingsRequest) GetServings() CateringCodesType`

GetServings returns the Servings field if non-nil, zero value otherwise.

### GetServingsOk

`func (o *PutCateringServingsRequest) GetServingsOk() (*CateringCodesType, bool)`
...
`func (o *PutCateringServingsRequest) SetServings(v CateringCodesType)`
...
`func (o *PutCateringServingsRequest) GetWarnings() WarningsType`

GetWarnings returns the Warnings field if non-nil, zero value otherwise.

### GetWarningsOk

`func (o *PutCateringServingsRequest) GetWarningsOk() (*WarningsType, bool)`
...
`func (o *PutCateringServingsRequest) SetWarnings(v WarningsType)`
