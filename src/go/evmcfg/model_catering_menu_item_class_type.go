...
type CateringMenuItemClassType struct {
	...
	ItemList *CateringMenuItemListType `json:"itemList,omitempty"`
}
...
// SetItemList gets a reference to the given CateringMenuItemListType and assigns it to the ItemList field.
