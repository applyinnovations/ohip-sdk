...
// checks if the PutFunctionSpaceTypesRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PutFunctionSpaceTypesRequest{}

// PutFunctionSpaceTypesRequest struct for PutFunctionSpaceTypesRequest
type PutFunctionSpaceTypesRequest struct {
...
func NewPutFunctionSpaceTypesRequest() *PutFunctionSpaceTypesRequest {
	this := PutFunctionSpaceTypesRequest{}
	return &this
}
...
func (o PutFunctionSpaceTypesRequest) MarshalJSON() ([]byte, error) {
...
func (o PutFunctionSpaceTypesRequest) ToMap() (map[string]interface{}, error) {
...
type NullablePutFunctionSpaceTypesRequest struct {
	value *PutFunctionSpaceTypesRequest
	isSet bool
}

func (v NullablePutFunctionSpaceTypesRequest) Get() *PutFunctionSpaceTypesRequest {
	return v.value
}

func (v *NullablePutFunctionSpaceTypesRequest) Set(val *PutFunctionSpaceTypesRequest) {
	v.value = val
	v.isSet = true
}

func (v NullablePutFunctionSpaceTypesRequest) IsSet() bool {
	return v.isSet
}

func (v *NullablePutFunctionSpaceTypesRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePutFunctionSpaceTypesRequest(val *PutFunctionSpaceTypesRequest) *NullablePutFunctionSpaceTypesRequest {
	return &NullablePutFunctionSpaceTypesRequest{value: val, isSet: true}
}

func (v NullablePutFunctionSpaceTypesRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePutFunctionSpaceTypesRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
