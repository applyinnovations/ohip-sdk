...
type PutEventForecastsRequest struct {
	EventForecasts *EventForecastListType `json:"eventForecasts,omitempty"`
...
// SetEventForecasts gets a reference to the given EventForecastListType and assigns it to the EventForecasts field.
