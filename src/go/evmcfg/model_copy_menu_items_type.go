...
type CopyMenuItemsType struct {
	...
	MenuItemList *CateringMenuItemListType `json:"menuItemList,omitempty"`
}
...
// SetMenuItemList gets a reference to the given CateringMenuItemListType and assigns it to the MenuItemList field.
