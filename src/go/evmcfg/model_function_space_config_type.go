...
type FunctionSpaceConfigType struct {
	...
	ComboElements *CodeListType `json:"comboElements,omitempty"`
	ComboRooms *ComboRoomsType `json:"comboRooms,omitempty"`
...
// SetComboElements gets a reference to the given CodeListType and assigns it to the ComboElements field.
...
// SetComboRooms gets a reference to the given ComboRoomsType and assigns it to the ComboRooms field.
