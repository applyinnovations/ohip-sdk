...
type FunctionSpacesDetails struct {
	...
	FunctionSpaces *FunctionSpacesSummaryType `json:"functionSpaces,omitempty"`
...
func (o *FunctionSpacesDetails) GetFunctionSpaces() FunctionSpacesSummaryType {
	if o == nil || IsNil(o.FunctionSpaces) {
		var ret FunctionSpacesSummaryType
		return ret
	}
...
// SetFunctionSpaces gets a reference to the given FunctionSpacesSummaryType and assigns it to the FunctionSpaces field.
