...
type CateringMenuType struct {
	...
	MenuDetailList *CateringMenuDetailListType `json:"menuDetailList,omitempty"`
	MenuNoteList *EventResourceNotesType `json:"menuNoteList,omitempty"`
	MultiChoiceList *CateringMultiChoiceMenuListType `json:"multiChoiceList,omitempty"`
	RevenueList *CateringMenuRevListType `json:"revenueList,omitempty"`
}
...
func (o *CateringMenuType) GetMenuDetailList() CateringMenuDetailListType {
	if o == nil || IsNil(o.MenuDetailList) {
		var ret CateringMenuDetailListType
		return ret
	}
...
// SetMenuDetailList gets a reference to the given CateringMenuDetailListType and assigns it to the MenuDetailList field.
...
// SetMenuNoteList gets a reference to the given EventResourceNotesType and assigns it to the MenuNoteList field.
...
func (o *CateringMenuType) GetMultiChoiceList() CateringMultiChoiceMenuListType {
	if o == nil || IsNil(o.MultiChoiceList) {
		var ret CateringMultiChoiceMenuListType
		return ret
	}
...
// SetMultiChoiceList gets a reference to the given CateringMultiChoiceMenuListType and assigns it to the MultiChoiceList field.
...
func (o *CateringMenuType) GetRevenueList() CateringMenuRevListType {
	if o == nil || IsNil(o.RevenueList) {
		var ret CateringMenuRevListType
		return ret
	}
...
// SetRevenueList gets a reference to the given CateringMenuRevListType and assigns it to the RevenueList field.
