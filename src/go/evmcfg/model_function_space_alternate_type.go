...
type FunctionSpaceAlternateType struct {
	ExcludedCateringEventTypes *CodeListType `json:"excludedCateringEventTypes,omitempty"`
...
// SetExcludedCateringEventTypes gets a reference to the given CodeListType and assigns it to the ExcludedCateringEventTypes field.
