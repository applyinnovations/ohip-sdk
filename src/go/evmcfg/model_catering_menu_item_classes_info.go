...
// checks if the CateringMenuItemClassesInfo type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CateringMenuItemClassesInfo{}

// CateringMenuItemClassesInfo Response object for retrieving Menu Item Classes.
type CateringMenuItemClassesInfo struct {
	...
	MenuItemClassList *CateringMenuItemClassListType `json:"menuItemClassList,omitempty"`
...
func NewCateringMenuItemClassesInfo() *CateringMenuItemClassesInfo {
	this := CateringMenuItemClassesInfo{}
	return &this
}
...
// SetMenuItemClassList gets a reference to the given CateringMenuItemClassListType and assigns it to the MenuItemClassList field.
...
func (o CateringMenuItemClassesInfo) MarshalJSON() ([]byte, error) {
...
func (o CateringMenuItemClassesInfo) ToMap() (map[string]interface{}, error) {
...
type NullableCateringMenuItemClassesInfo struct {
	value *CateringMenuItemClassesInfo
	isSet bool
}

func (v NullableCateringMenuItemClassesInfo) Get() *CateringMenuItemClassesInfo {
	return v.value
}

func (v *NullableCateringMenuItemClassesInfo) Set(val *CateringMenuItemClassesInfo) {
	v.value = val
	v.isSet = true
}

func (v NullableCateringMenuItemClassesInfo) IsSet() bool {
	return v.isSet
}

func (v *NullableCateringMenuItemClassesInfo) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCateringMenuItemClassesInfo(val *CateringMenuItemClassesInfo) *NullableCateringMenuItemClassesInfo {
	return &NullableCateringMenuItemClassesInfo{value: val, isSet: true}
}

func (v NullableCateringMenuItemClassesInfo) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCateringMenuItemClassesInfo) UnmarshalJSON(src []byte) error {
	v.isSet = true
