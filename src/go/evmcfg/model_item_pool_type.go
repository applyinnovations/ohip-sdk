...
type ItemPoolType struct {
	...
	ItemIds *ItemIDListType `json:"itemIds,omitempty"`
}
...
// SetItemIds gets a reference to the given ItemIDListType and assigns it to the ItemIds field.
