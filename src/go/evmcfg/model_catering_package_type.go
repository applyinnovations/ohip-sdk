...
type CateringPackageType struct {
	EventsList *CateringPackageEventListType `json:"eventsList,omitempty"`
	...
	PricingList *CateringPackagePricingListType `json:"pricingList,omitempty"`
}
...
func (o *CateringPackageType) GetEventsList() CateringPackageEventListType {
	if o == nil || IsNil(o.EventsList) {
		var ret CateringPackageEventListType
		return ret
	}
	return *o.EventsList
}
...
// SetEventsList gets a reference to the given CateringPackageEventListType and assigns it to the EventsList field.
...
func (o *CateringPackageType) GetPricingList() CateringPackagePricingListType {
	if o == nil || IsNil(o.PricingList) {
		var ret CateringPackagePricingListType
		return ret
	}
...
// SetPricingList gets a reference to the given CateringPackagePricingListType and assigns it to the PricingList field.
