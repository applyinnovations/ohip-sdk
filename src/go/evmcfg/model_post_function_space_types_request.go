...
// checks if the PostFunctionSpaceTypesRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PostFunctionSpaceTypesRequest{}

// PostFunctionSpaceTypesRequest struct for PostFunctionSpaceTypesRequest
type PostFunctionSpaceTypesRequest struct {
...
func NewPostFunctionSpaceTypesRequest() *PostFunctionSpaceTypesRequest {
	this := PostFunctionSpaceTypesRequest{}
	return &this
}
...
func (o PostFunctionSpaceTypesRequest) MarshalJSON() ([]byte, error) {
...
func (o PostFunctionSpaceTypesRequest) ToMap() (map[string]interface{}, error) {
...
type NullablePostFunctionSpaceTypesRequest struct {
	value *PostFunctionSpaceTypesRequest
	isSet bool
}

func (v NullablePostFunctionSpaceTypesRequest) Get() *PostFunctionSpaceTypesRequest {
	return v.value
}

func (v *NullablePostFunctionSpaceTypesRequest) Set(val *PostFunctionSpaceTypesRequest) {
	v.value = val
	v.isSet = true
}

func (v NullablePostFunctionSpaceTypesRequest) IsSet() bool {
	return v.isSet
}

func (v *NullablePostFunctionSpaceTypesRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePostFunctionSpaceTypesRequest(val *PostFunctionSpaceTypesRequest) *NullablePostFunctionSpaceTypesRequest {
	return &NullablePostFunctionSpaceTypesRequest{value: val, isSet: true}
}

func (v NullablePostFunctionSpaceTypesRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePostFunctionSpaceTypesRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
