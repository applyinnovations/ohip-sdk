...
type InventoryItemTemplateType struct {
	...
	InventoryItemTemplateItems *InventoryItemTemplateItemsType `json:"inventoryItemTemplateItems,omitempty"`
...
func (o *InventoryItemTemplateType) GetInventoryItemTemplateItems() InventoryItemTemplateItemsType {
	if o == nil || IsNil(o.InventoryItemTemplateItems) {
		var ret InventoryItemTemplateItemsType
		return ret
	}
...
// SetInventoryItemTemplateItems gets a reference to the given InventoryItemTemplateItemsType and assigns it to the InventoryItemTemplateItems field.
