...
type HotelInventoryType struct {
	HouseInventory *InventoryCountsListType `json:"houseInventory,omitempty"`
...
func (o *HotelInventoryType) GetHouseInventory() InventoryCountsListType {
	if o == nil || IsNil(o.HouseInventory) {
		var ret InventoryCountsListType
		return ret
	}
...
// SetHouseInventory gets a reference to the given InventoryCountsListType and assigns it to the HouseInventory field.
