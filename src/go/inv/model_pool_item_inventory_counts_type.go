...
type PoolItemInventoryCountsType struct {
	...
	PoolItems *ItemInventoryCountsListType `json:"poolItems,omitempty"`
...
func (o *PoolItemInventoryCountsType) GetPoolItems() ItemInventoryCountsListType {
	if o == nil || IsNil(o.PoolItems) {
		var ret ItemInventoryCountsListType
		return ret
	}
	return *o.PoolItems
}
...
// SetPoolItems gets a reference to the given ItemInventoryCountsListType and assigns it to the PoolItems field.
