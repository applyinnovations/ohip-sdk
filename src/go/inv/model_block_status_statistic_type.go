...
type BlockStatusStatisticType struct {
	...
	StatusSummaryStatistic *StatisticUnitsType `json:"statusSummaryStatistic,omitempty"`
}
...
// SetStatusSummaryStatistic gets a reference to the given StatisticUnitsType and assigns it to the StatusSummaryStatistic field.
