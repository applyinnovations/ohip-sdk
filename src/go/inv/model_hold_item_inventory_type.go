...
type HoldItemInventoryType struct {
	...
	HoldItemInfoList *HoldItemInfoListType `json:"holdItemInfoList,omitempty"`
...
// SetHoldItemInfoList gets a reference to the given HoldItemInfoListType and assigns it to the HoldItemInfoList field.
