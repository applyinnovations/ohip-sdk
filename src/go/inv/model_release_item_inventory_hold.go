...
type ReleaseItemInventoryHold struct {
	...
	ReleaseItemsInventoryHoldInfo *ReleaseItemsInventoryHoldType `json:"releaseItemsInventoryHoldInfo,omitempty"`
...
func (o *ReleaseItemInventoryHold) GetReleaseItemsInventoryHoldInfo() ReleaseItemsInventoryHoldType {
	if o == nil || IsNil(o.ReleaseItemsInventoryHoldInfo) {
		var ret ReleaseItemsInventoryHoldType
		return ret
	}
...
// SetReleaseItemsInventoryHoldInfo gets a reference to the given ReleaseItemsInventoryHoldType and assigns it to the ReleaseItemsInventoryHoldInfo field.
