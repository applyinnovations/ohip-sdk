...
type BlockDetailStatisticType struct {
	...
	BlockStatistics *BlockStatusStatisticsType `json:"blockStatistics,omitempty"`
}
...
func (o *BlockDetailStatisticType) GetBlockStatistics() BlockStatusStatisticsType {
	if o == nil || IsNil(o.BlockStatistics) {
		var ret BlockStatusStatisticsType
		return ret
	}
...
// SetBlockStatistics gets a reference to the given BlockStatusStatisticsType and assigns it to the BlockStatistics field.
