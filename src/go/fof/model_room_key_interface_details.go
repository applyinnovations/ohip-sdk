...
type RoomKeyInterfaceDetails struct {
	KeyInterfaceDetails *RoomKeyInterfaceDetailsType `json:"keyInterfaceDetails,omitempty"`
...
func (o *RoomKeyInterfaceDetails) GetKeyInterfaceDetails() RoomKeyInterfaceDetailsType {
	if o == nil || IsNil(o.KeyInterfaceDetails) {
		var ret RoomKeyInterfaceDetailsType
		return ret
	}
...
// SetKeyInterfaceDetails gets a reference to the given RoomKeyInterfaceDetailsType and assigns it to the KeyInterfaceDetails field.
