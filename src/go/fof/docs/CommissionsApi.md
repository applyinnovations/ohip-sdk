...
func main() {
    ...
    associateCommissionAgentToReservations := *openapiclient.NewAssociateCommissionAgentToReservationsRequest() // AssociateCommissionAgentToReservationsRequest | Request type for associating reservations to Travel Agent or Source Profile.
 ...
 **associateCommissionAgentToReservations** | [**AssociateCommissionAgentToReservationsRequest**](AssociateCommissionAgentToReservationsRequest.md) | Request type for associating reservations to Travel Agent or Source Profile. | 
...
func main() {
    ...
    xAppKey := "xAppKey_example" // string | Client or Partner's Application Key
    xHotelid := "xHotelid_example" // string | Mandatory parameter to identify the hotel code where the end user is logged in
    calculateCommissions := *openapiclient.NewCalculateCommissionsRequest() // CalculateCommissionsRequest | Request type for calculation of commission for all Travel Agent and/or Source.
    xExternalsystem := "EXTERNALSYSTEMCODE" // string | External system code. (optional)
    acceptLanguage := "acceptLanguage_example" // string | Language code (optional)
 ...
 **xAppKey** | **string** | Client or Partner&#39;s Application Key | 
 **xHotelid** | **string** | Mandatory parameter to identify the hotel code where the end user is logged in | 
 **calculateCommissions** | [**CalculateCommissionsRequest**](CalculateCommissionsRequest.md) | Request type for calculation of commission for all Travel Agent and/or Source. | 
 **xExternalsystem** | **string** | External system code. | 
 **acceptLanguage** | **string** | Language code | 
...
func main() {
    ...
    xAppKey := "xAppKey_example" // string | Client or Partner's Application Key
    xHotelid := "xHotelid_example" // string | Mandatory parameter to identify the hotel code where the end user is logged in
    commissionToBeChanged := *openapiclient.NewChangeCommissionRequest() // ChangeCommissionRequest | Request type for update of commission detail.
    xExternalsystem := "EXTERNALSYSTEMCODE" // string | External system code. (optional)
    acceptLanguage := "acceptLanguage_example" // string | Language code (optional)
 ...
 **xAppKey** | **string** | Client or Partner&#39;s Application Key | 
 **xHotelid** | **string** | Mandatory parameter to identify the hotel code where the end user is logged in | 
 **commissionToBeChanged** | [**ChangeCommissionRequest**](ChangeCommissionRequest.md) | Request type for update of commission detail. | 
 **xExternalsystem** | **string** | External system code. | 
 **acceptLanguage** | **string** | Language code | 
...
func main() {
    ...
    xAppKey := "xAppKey_example" // string | Client or Partner's Application Key
    xHotelid := "xHotelid_example" // string | Mandatory parameter to identify the hotel code where the end user is logged in
    commissionCheckToBeChanged := *openapiclient.NewChangeCommissionCheckRequest() // ChangeCommissionCheckRequest | Request type for updating commission check.
    xExternalsystem := "EXTERNALSYSTEMCODE" // string | External system code. (optional)
    acceptLanguage := "acceptLanguage_example" // string | Language code (optional)
 ...
 **xAppKey** | **string** | Client or Partner&#39;s Application Key | 
 **xHotelid** | **string** | Mandatory parameter to identify the hotel code where the end user is logged in | 
 **commissionCheckToBeChanged** | [**ChangeCommissionCheckRequest**](ChangeCommissionCheckRequest.md) | Request type for updating commission check. | 
 **xExternalsystem** | **string** | External system code. | 
 **acceptLanguage** | **string** | Language code | 
...
func main() {
    ...
    xAppKey := "xAppKey_example" // string | Client or Partner's Application Key
    xHotelid := "xHotelid_example" // string | Mandatory parameter to identify the hotel code where the end user is logged in
    commissionPaymentActivityByRangeToBeChanged := *openapiclient.NewChangeCommissionPaymentActivityByRangeRequest() // ChangeCommissionPaymentActivityByRangeRequest | Request type for updating a range of payments activity.
    xExternalsystem := "EXTERNALSYSTEMCODE" // string | External system code. (optional)
    acceptLanguage := "acceptLanguage_example" // string | Language code (optional)
 ...
 **xAppKey** | **string** | Client or Partner&#39;s Application Key | 
 **xHotelid** | **string** | Mandatory parameter to identify the hotel code where the end user is logged in | 
 **commissionPaymentActivityByRangeToBeChanged** | [**ChangeCommissionPaymentActivityByRangeRequest**](ChangeCommissionPaymentActivityByRangeRequest.md) | Request type for updating a range of payments activity. | 
 **xExternalsystem** | **string** | External system code. | 
 **acceptLanguage** | **string** | Language code | 
...
> CommissionsDetails GetReservationsForCommissions(ctx, hotelId, bankAccountId, agentId).Authorization(authorization).XAppKey(xAppKey).XHotelid(xHotelid).Limit(limit).Offset(offset).GuestName(guestName).ConfirmationNo(confirmationNo).ReservationStatus(reservationStatus).AccountReceivableOffset(accountReceivableOffset).OnHold(onHold).XExternalsystem(xExternalsystem).AcceptLanguage(acceptLanguage).Execute()
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.CommissionsApi.GetReservationsForCommissions(context.Background(), hotelId, bankAccountId, agentId).Authorization(authorization).XAppKey(xAppKey).XHotelid(xHotelid).Limit(limit).Offset(offset).GuestName(guestName).ConfirmationNo(confirmationNo).ReservationStatus(reservationStatus).AccountReceivableOffset(accountReceivableOffset).OnHold(onHold).XExternalsystem(xExternalsystem).AcceptLanguage(acceptLanguage).Execute()
    if err != nil {
...
func main() {
    ...
    xAppKey := "xAppKey_example" // string | Client or Partner's Application Key
    xHotelid := "xHotelid_example" // string | Mandatory parameter to identify the hotel code where the end user is logged in
    processCommissionPayments := *openapiclient.NewProcessCommissionPaymentsRequest() // ProcessCommissionPaymentsRequest | Request type for processing commission payments.
    xExternalsystem := "EXTERNALSYSTEMCODE" // string | External system code. (optional)
    acceptLanguage := "acceptLanguage_example" // string | Language code (optional)
 ...
 **xAppKey** | **string** | Client or Partner&#39;s Application Key | 
 **xHotelid** | **string** | Mandatory parameter to identify the hotel code where the end user is logged in | 
 **processCommissionPayments** | [**ProcessCommissionPaymentsRequest**](ProcessCommissionPaymentsRequest.md) | Request type for processing commission payments. | 
 **xExternalsystem** | **string** | External system code. | 
 **acceptLanguage** | **string** | Language code | 
...
func main() {
    ...
    xAppKey := "xAppKey_example" // string | Client or Partner's Application Key
    xHotelid := "xHotelid_example" // string | Mandatory parameter to identify the hotel code where the end user is logged in
    recalculateCommissionOnCodeChange := *openapiclient.NewRecalculateCommissionOnCodeChangeRequest() // RecalculateCommissionOnCodeChangeRequest | Request type for recalculating commission amount when commission code of unpaid commission is changed.
    xExternalsystem := "EXTERNALSYSTEMCODE" // string | External system code. (optional)
    acceptLanguage := "acceptLanguage_example" // string | Language code (optional)
 ...
 **xAppKey** | **string** | Client or Partner&#39;s Application Key | 
 **xHotelid** | **string** | Mandatory parameter to identify the hotel code where the end user is logged in | 
 **recalculateCommissionOnCodeChange** | [**RecalculateCommissionOnCodeChangeRequest**](RecalculateCommissionOnCodeChangeRequest.md) | Request type for recalculating commission amount when commission code of unpaid commission is changed. | 
 **xExternalsystem** | **string** | External system code. | 
 **acceptLanguage** | **string** | Language code | 
...
func main() {
    ...
    xAppKey := "xAppKey_example" // string | Client or Partner's Application Key
    xHotelid := "xHotelid_example" // string | Mandatory parameter to identify the hotel code where the end user is logged in
    reprintCommissionCheckByRange := *openapiclient.NewReprintCommissionCheckByRangeRequest() // ReprintCommissionCheckByRangeRequest | Request type for reprinting a range of check payments.
    xExternalsystem := "EXTERNALSYSTEMCODE" // string | External system code. (optional)
    acceptLanguage := "acceptLanguage_example" // string | Language code (optional)
 ...
 **xAppKey** | **string** | Client or Partner&#39;s Application Key | 
 **xHotelid** | **string** | Mandatory parameter to identify the hotel code where the end user is logged in | 
 **reprintCommissionCheckByRange** | [**ReprintCommissionCheckByRangeRequest**](ReprintCommissionCheckByRangeRequest.md) | Request type for reprinting a range of check payments. | 
 **xExternalsystem** | **string** | External system code. | 
 **acceptLanguage** | **string** | Language code | 
...
func main() {
    ...
    xAppKey := "xAppKey_example" // string | Client or Partner's Application Key
    xHotelid := "xHotelid_example" // string | Mandatory parameter to identify the hotel code where the end user is logged in
    setProcessingInstructions := *openapiclient.NewSetProcessingInstructionsRequest() // SetProcessingInstructionsRequest | Request Type for setting instructions for commission processing on Agent or Reservation level.
    xExternalsystem := "EXTERNALSYSTEMCODE" // string | External system code. (optional)
    acceptLanguage := "acceptLanguage_example" // string | Language code (optional)
 ...
 **xAppKey** | **string** | Client or Partner&#39;s Application Key | 
 **xHotelid** | **string** | Mandatory parameter to identify the hotel code where the end user is logged in | 
 **setProcessingInstructions** | [**SetProcessingInstructionsRequest**](SetProcessingInstructionsRequest.md) | Request Type for setting instructions for commission processing on Agent or Reservation level. | 
 **xExternalsystem** | **string** | External system code. | 
 **acceptLanguage** | **string** | Language code | 
