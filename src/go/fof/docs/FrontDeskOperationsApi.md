...
> AutoAssignedRoom AutoAssignRoom(ctx, hotelId).Authorization(authorization).XAppKey(xAppKey).XHotelid(xHotelid).AutoAssignRoom(autoAssignRoom).XExternalsystem(xExternalsystem).AcceptLanguage(acceptLanguage).Execute()
...
func main() {
    ...
    // response from `AutoAssignRoom`: AutoAssignedRoom
...
[**AutoAssignedRoom**](AutoAssignedRoom.md)
...
func main() {
    ...
    beginTime := "beginTime_example" // string | Begin time from which to start fetching wake up calls. (optional)
    endTime := "endTime_example" // string | End time from which to start fetching wake up calls. (optional)
...
func main() {
    ...
    xAppKey := "xAppKey_example" // string | Client or Partner's Application Key
    xHotelid := "xHotelid_example" // string | Mandatory parameter to identify the hotel code where the end user is logged in
    moveInHouseGuest := *openapiclient.NewMoveInHouseGuestRequest() // MoveInHouseGuestRequest | To move a reservation, the reservation needs to be in Checked-In state.
    xExternalsystem := "EXTERNALSYSTEMCODE" // string | External system code. (optional)
    acceptLanguage := "acceptLanguage_example" // string | Language code (optional)
 ...
 **xAppKey** | **string** | Client or Partner&#39;s Application Key | 
 **xHotelid** | **string** | Mandatory parameter to identify the hotel code where the end user is logged in | 
 **moveInHouseGuest** | [**MoveInHouseGuestRequest**](MoveInHouseGuestRequest.md) | To move a reservation, the reservation needs to be in Checked-In state. | 
 **xExternalsystem** | **string** | External system code. | 
 **acceptLanguage** | **string** | Language code | 
...
func main() {
    ...
    xAppKey := "xAppKey_example" // string | Client or Partner's Application Key
    xHotelid := "xHotelid_example" // string | Mandatory parameter to identify the hotel code where the end user is logged in
    holdRooms := *openapiclient.NewPlaceRoomsOnHoldRequest() // PlaceRoomsOnHoldRequest | Request to place rooms on hold.
    xExternalsystem := "EXTERNALSYSTEMCODE" // string | External system code. (optional)
    acceptLanguage := "acceptLanguage_example" // string | Language code (optional)
 ...
 **xAppKey** | **string** | Client or Partner&#39;s Application Key | 
 **xHotelid** | **string** | Mandatory parameter to identify the hotel code where the end user is logged in | 
 **holdRooms** | [**PlaceRoomsOnHoldRequest**](PlaceRoomsOnHoldRequest.md) | Request to place rooms on hold. | 
 **xExternalsystem** | **string** | External system code. | 
 **acceptLanguage** | **string** | Language code | 
...
func main() {
    ...
    xAppKey := "xAppKey_example" // string | Client or Partner's Application Key
    xHotelid := "xHotelid_example" // string | Mandatory parameter to identify the hotel code where the end user is logged in
    advanceCheckInReservation := *openapiclient.NewPostAdvanceCheckInRequest() // PostAdvanceCheckInRequest | Request object to perform Advance Check In of a Reservation.
    xExternalsystem := "EXTERNALSYSTEMCODE" // string | External system code. (optional)
    acceptLanguage := "acceptLanguage_example" // string | Language code (optional)
 ...
 **xAppKey** | **string** | Client or Partner&#39;s Application Key | 
 **xHotelid** | **string** | Mandatory parameter to identify the hotel code where the end user is logged in | 
 **advanceCheckInReservation** | [**PostAdvanceCheckInRequest**](PostAdvanceCheckInRequest.md) | Request object to perform Advance Check In of a Reservation. | 
 **xExternalsystem** | **string** | External system code. | 
 **acceptLanguage** | **string** | Language code | 
...
func main() {
    ...
    xAppKey := "xAppKey_example" // string | Client or Partner's Application Key
    xHotelid := "xHotelid_example" // string | Mandatory parameter to identify the hotel code where the end user is logged in
    dailyDocket := *openapiclient.NewPutDailyDocketRequest() // PutDailyDocketRequest | Add log book entries.
    xExternalsystem := "EXTERNALSYSTEMCODE" // string | External system code. (optional)
    acceptLanguage := "acceptLanguage_example" // string | Language code (optional)
 ...
 **xAppKey** | **string** | Client or Partner&#39;s Application Key | 
 **xHotelid** | **string** | Mandatory parameter to identify the hotel code where the end user is logged in | 
 **dailyDocket** | [**PutDailyDocketRequest**](PutDailyDocketRequest.md) | Add log book entries. | 
 **xExternalsystem** | **string** | External system code. | 
 **acceptLanguage** | **string** | Language code | 
...
func main() {
    ...
    xAppKey := "xAppKey_example" // string | Client or Partner's Application Key
    xHotelid := "xHotelid_example" // string | Mandatory parameter to identify the hotel code where the end user is logged in
    massAdvanceCheckInReservations := *openapiclient.NewPostMassAdvanceCheckInRequest() // PostMassAdvanceCheckInRequest | Request object to Submit Batch job for Mass Advance Check In of Reservations.
    xExternalsystem := "EXTERNALSYSTEMCODE" // string | External system code. (optional)
    acceptLanguage := "acceptLanguage_example" // string | Language code (optional)
 ...
 **xAppKey** | **string** | Client or Partner&#39;s Application Key | 
 **xHotelid** | **string** | Mandatory parameter to identify the hotel code where the end user is logged in | 
 **massAdvanceCheckInReservations** | [**PostMassAdvanceCheckInRequest**](PostMassAdvanceCheckInRequest.md) | Request object to Submit Batch job for Mass Advance Check In of Reservations. | 
 **xExternalsystem** | **string** | External system code. | 
 **acceptLanguage** | **string** | Language code | 
...
func main() {
    ...
    xAppKey := "xAppKey_example" // string | Client or Partner's Application Key
    xHotelid := "xHotelid_example" // string | Mandatory parameter to identify the hotel code where the end user is logged in
    massCheckInReservations := *openapiclient.NewPostMassCheckInRequest() // PostMassCheckInRequest | Request object to Submit Batch job for Mass Checkin of Reservations.
    xExternalsystem := "EXTERNALSYSTEMCODE" // string | External system code. (optional)
    acceptLanguage := "acceptLanguage_example" // string | Language code (optional)
 ...
 **xAppKey** | **string** | Client or Partner&#39;s Application Key | 
 **xHotelid** | **string** | Mandatory parameter to identify the hotel code where the end user is logged in | 
 **massCheckInReservations** | [**PostMassCheckInRequest**](PostMassCheckInRequest.md) | Request object to Submit Batch job for Mass Checkin of Reservations. | 
 **xExternalsystem** | **string** | External system code. | 
 **acceptLanguage** | **string** | Language code | 
...
func main() {
    ...
    xAppKey := "xAppKey_example" // string | Client or Partner's Application Key
    xHotelid := "xHotelid_example" // string | Mandatory parameter to identify the hotel code where the end user is logged in
    room := *openapiclient.NewPostRoomAssignmentRequest() // PostRoomAssignmentRequest | The reservation must still be reserved to use this operation.
    xExternalsystem := "EXTERNALSYSTEMCODE" // string | External system code. (optional)
    acceptLanguage := "acceptLanguage_example" // string | Language code (optional)
 ...
 **xAppKey** | **string** | Client or Partner&#39;s Application Key | 
 **xHotelid** | **string** | Mandatory parameter to identify the hotel code where the end user is logged in | 
 **room** | [**PostRoomAssignmentRequest**](PostRoomAssignmentRequest.md) | The reservation must still be reserved to use this operation. | 
 **xExternalsystem** | **string** | External system code. | 
 **acceptLanguage** | **string** | Language code | 
...
func main() {
    ...
    xAppKey := "xAppKey_example" // string | Client or Partner's Application Key
    xHotelid := "xHotelid_example" // string | Mandatory parameter to identify the hotel code where the end user is logged in
    serviceRequestsInfo := *openapiclient.NewPutServiceRequestsRequest() // PutServiceRequestsRequest | Add new service request.
    xExternalsystem := "EXTERNALSYSTEMCODE" // string | External system code. (optional)
    acceptLanguage := "acceptLanguage_example" // string | Language code (optional)
 ...
 **xAppKey** | **string** | Client or Partner&#39;s Application Key | 
 **xHotelid** | **string** | Mandatory parameter to identify the hotel code where the end user is logged in | 
 **serviceRequestsInfo** | [**PutServiceRequestsRequest**](PutServiceRequestsRequest.md) | Add new service request. | 
 **xExternalsystem** | **string** | External system code. | 
 **acceptLanguage** | **string** | Language code | 
...
func main() {
    ...
    xAppKey := "xAppKey_example" // string | Client or Partner's Application Key
    xHotelid := "xHotelid_example" // string | Mandatory parameter to identify the hotel code where the end user is logged in
    wakeUpCalls := *openapiclient.NewPutWakeUpCallRequest() // PutWakeUpCallRequest | Request to create a wake up call.
    xExternalsystem := "EXTERNALSYSTEMCODE" // string | External system code. (optional)
    acceptLanguage := "acceptLanguage_example" // string | Language code (optional)
 ...
 **xAppKey** | **string** | Client or Partner&#39;s Application Key | 
 **xHotelid** | **string** | Mandatory parameter to identify the hotel code where the end user is logged in | 
 **wakeUpCalls** | [**PutWakeUpCallRequest**](PutWakeUpCallRequest.md) | Request to create a wake up call. | 
 **xExternalsystem** | **string** | External system code. | 
 **acceptLanguage** | **string** | Language code | 
...
func main() {
    ...
    xAppKey := "xAppKey_example" // string | Client or Partner's Application Key
    xHotelid := "xHotelid_example" // string | Mandatory parameter to identify the hotel code where the end user is logged in
    batchCCAuth := *openapiclient.NewProcessBatchCCAuthRequest() // ProcessBatchCCAuthRequest | Request to start a batch job that will process a list of reservation, and their associated payment methods, that require credit card authorizations.
    xExternalsystem := "EXTERNALSYSTEMCODE" // string | External system code. (optional)
    acceptLanguage := "acceptLanguage_example" // string | Language code (optional)
 ...
 **xAppKey** | **string** | Client or Partner&#39;s Application Key | 
 **xHotelid** | **string** | Mandatory parameter to identify the hotel code where the end user is logged in | 
 **batchCCAuth** | [**ProcessBatchCCAuthRequest**](ProcessBatchCCAuthRequest.md) | Request to start a batch job that will process a list of reservation, and their associated payment methods, that require credit card authorizations. | 
 **xExternalsystem** | **string** | External system code. | 
 **acceptLanguage** | **string** | Language code | 
...
func main() {
    ...
    xAppKey := "xAppKey_example" // string | Client or Partner's Application Key
    xHotelid := "xHotelid_example" // string | Mandatory parameter to identify the hotel code where the end user is logged in
    dailyDocket := *openapiclient.NewPutDailyDocketRequest() // PutDailyDocketRequest | Change log book entries.
    xExternalsystem := "EXTERNALSYSTEMCODE" // string | External system code. (optional)
    acceptLanguage := "acceptLanguage_example" // string | Language code (optional)
 ...
 **xAppKey** | **string** | Client or Partner&#39;s Application Key | 
 **xHotelid** | **string** | Mandatory parameter to identify the hotel code where the end user is logged in | 
 **dailyDocket** | [**PutDailyDocketRequest**](PutDailyDocketRequest.md) | Change log book entries. | 
 **xExternalsystem** | **string** | External system code. | 
 **acceptLanguage** | **string** | Language code | 
...
func main() {
    ...
    xAppKey := "xAppKey_example" // string | Client or Partner's Application Key
    xHotelid := "xHotelid_example" // string | Mandatory parameter to identify the hotel code where the end user is logged in
    reservationQueuePriorityNumber := *openapiclient.NewPutReservationQueuePriorityRequest() // PutReservationQueuePriorityRequest | Request to change the current priority of a reservation in Queue for Check-In.
    xExternalsystem := "EXTERNALSYSTEMCODE" // string | External system code. (optional)
    acceptLanguage := "acceptLanguage_example" // string | Language code (optional)
 ...
 **xAppKey** | **string** | Client or Partner&#39;s Application Key | 
 **xHotelid** | **string** | Mandatory parameter to identify the hotel code where the end user is logged in | 
 **reservationQueuePriorityNumber** | [**PutReservationQueuePriorityRequest**](PutReservationQueuePriorityRequest.md) | Request to change the current priority of a reservation in Queue for Check-In. | 
 **xExternalsystem** | **string** | External system code. | 
 **acceptLanguage** | **string** | Language code | 
...
func main() {
    ...
    xAppKey := "xAppKey_example" // string | Client or Partner's Application Key
    xHotelid := "xHotelid_example" // string | Mandatory parameter to identify the hotel code where the end user is logged in
    reservationInterface := *openapiclient.NewPutRoomInterfaceStatusRequest() // PutRoomInterfaceStatusRequest | Request to change the interface status for a reservation.
    xExternalsystem := "EXTERNALSYSTEMCODE" // string | External system code. (optional)
    acceptLanguage := "acceptLanguage_example" // string | Language code (optional)
 ...
 **xAppKey** | **string** | Client or Partner&#39;s Application Key | 
 **xHotelid** | **string** | Mandatory parameter to identify the hotel code where the end user is logged in | 
 **reservationInterface** | [**PutRoomInterfaceStatusRequest**](PutRoomInterfaceStatusRequest.md) | Request to change the interface status for a reservation. | 
 **xExternalsystem** | **string** | External system code. | 
 **acceptLanguage** | **string** | Language code | 
...
func main() {
    ...
    xAppKey := "xAppKey_example" // string | Client or Partner's Application Key
    xHotelid := "xHotelid_example" // string | Mandatory parameter to identify the hotel code where the end user is logged in
    serviceRequestsInfo := *openapiclient.NewPutServiceRequestsRequest() // PutServiceRequestsRequest | Change service requests.
    xExternalsystem := "EXTERNALSYSTEMCODE" // string | External system code. (optional)
    acceptLanguage := "acceptLanguage_example" // string | Language code (optional)
 ...
 **xAppKey** | **string** | Client or Partner&#39;s Application Key | 
 **xHotelid** | **string** | Mandatory parameter to identify the hotel code where the end user is logged in | 
 **serviceRequestsInfo** | [**PutServiceRequestsRequest**](PutServiceRequestsRequest.md) | Change service requests. | 
 **xExternalsystem** | **string** | External system code. | 
 **acceptLanguage** | **string** | Language code | 
...
func main() {
    ...
    xAppKey := "xAppKey_example" // string | Client or Partner's Application Key
    xHotelid := "xHotelid_example" // string | Mandatory parameter to identify the hotel code where the end user is logged in
    wakeUpCalls := *openapiclient.NewPutWakeUpCallRequest() // PutWakeUpCallRequest | Request to change a wake up call.
    xExternalsystem := "EXTERNALSYSTEMCODE" // string | External system code. (optional)
    acceptLanguage := "acceptLanguage_example" // string | Language code (optional)
 ...
 **xAppKey** | **string** | Client or Partner&#39;s Application Key | 
 **xHotelid** | **string** | Mandatory parameter to identify the hotel code where the end user is logged in | 
 **wakeUpCalls** | [**PutWakeUpCallRequest**](PutWakeUpCallRequest.md) | Request to change a wake up call. | 
 **xExternalsystem** | **string** | External system code. | 
 **acceptLanguage** | **string** | Language code | 
...
func main() {
    ...
    xAppKey := "xAppKey_example" // string | Client or Partner's Application Key
    xHotelid := "xHotelid_example" // string | Mandatory parameter to identify the hotel code where the end user is logged in
    holdRooms := *openapiclient.NewPlaceRoomsOnHoldRequest() // PlaceRoomsOnHoldRequest | Request to release rooms from being held.
    xExternalsystem := "EXTERNALSYSTEMCODE" // string | External system code. (optional)
    acceptLanguage := "acceptLanguage_example" // string | Language code (optional)
 ...
 **xAppKey** | **string** | Client or Partner&#39;s Application Key | 
 **xHotelid** | **string** | Mandatory parameter to identify the hotel code where the end user is logged in | 
 **holdRooms** | [**PlaceRoomsOnHoldRequest**](PlaceRoomsOnHoldRequest.md) | Request to release rooms from being held. | 
 **xExternalsystem** | **string** | External system code. | 
 **acceptLanguage** | **string** | Language code | 
...
func main() {
    ...
    xAppKey := "xAppKey_example" // string | Client or Partner's Application Key
    xHotelid := "xHotelid_example" // string | Mandatory parameter to identify the hotel code where the end user is logged in
    shiftRooms := *openapiclient.NewShiftRoomsRequest() // ShiftRoomsRequest | Request to Shift Rooms between two selected reservations (from the same property), that are for the same arrival date and room type.
    xExternalsystem := "EXTERNALSYSTEMCODE" // string | External system code. (optional)
    acceptLanguage := "acceptLanguage_example" // string | Language code (optional)
 ...
 **xAppKey** | **string** | Client or Partner&#39;s Application Key | 
 **xHotelid** | **string** | Mandatory parameter to identify the hotel code where the end user is logged in | 
 **shiftRooms** | [**ShiftRoomsRequest**](ShiftRoomsRequest.md) | Request to Shift Rooms between two selected reservations (from the same property), that are for the same arrival date and room type. | 
 **xExternalsystem** | **string** | External system code. | 
 **acceptLanguage** | **string** | Language code | 
...
func main() {
    ...
    xAppKey := "xAppKey_example" // string | Client or Partner's Application Key
    xHotelid := "xHotelid_example" // string | Mandatory parameter to identify the hotel code where the end user is logged in
    swapRooms := *openapiclient.NewSwapRoomsRequest() // SwapRoomsRequest | Request to Swap Rooms between two selected reservations (from the same property), that are for the same arrival date and room type.
    xExternalsystem := "EXTERNALSYSTEMCODE" // string | External system code. (optional)
    acceptLanguage := "acceptLanguage_example" // string | Language code (optional)
 ...
 **xAppKey** | **string** | Client or Partner&#39;s Application Key | 
 **xHotelid** | **string** | Mandatory parameter to identify the hotel code where the end user is logged in | 
 **swapRooms** | [**SwapRoomsRequest**](SwapRoomsRequest.md) | Request to Swap Rooms between two selected reservations (from the same property), that are for the same arrival date and room type. | 
 **xExternalsystem** | **string** | External system code. | 
 **acceptLanguage** | **string** | Language code | 
