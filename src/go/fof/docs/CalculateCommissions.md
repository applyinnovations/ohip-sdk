...
`func (o *CalculateCommissions) GetLinks() Links`

GetLinks returns the Links field if non-nil, zero value otherwise.

### GetLinksOk

`func (o *CalculateCommissions) GetLinksOk() (*Links, bool)`
...
`func (o *CalculateCommissions) SetLinks(v Links)`
...
`func (o *CalculateCommissions) GetWarnings() WarningsType`

GetWarnings returns the Warnings field if non-nil, zero value otherwise.

### GetWarningsOk

`func (o *CalculateCommissions) GetWarningsOk() (*WarningsType, bool)`
...
`func (o *CalculateCommissions) SetWarnings(v WarningsType)`
