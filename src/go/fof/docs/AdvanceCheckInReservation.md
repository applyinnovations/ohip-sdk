...
`func (o *AdvanceCheckInReservation) GetLinks() Links`

GetLinks returns the Links field if non-nil, zero value otherwise.

### GetLinksOk

`func (o *AdvanceCheckInReservation) GetLinksOk() (*Links, bool)`
...
`func (o *AdvanceCheckInReservation) SetLinks(v Links)`
...
`func (o *AdvanceCheckInReservation) GetWarnings() WarningsType`

GetWarnings returns the Warnings field if non-nil, zero value otherwise.

### GetWarningsOk

`func (o *AdvanceCheckInReservation) GetWarningsOk() (*WarningsType, bool)`
...
`func (o *AdvanceCheckInReservation) SetWarnings(v WarningsType)`
