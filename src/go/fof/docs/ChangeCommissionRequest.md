...
`func (o *ChangeCommissionRequest) GetLinks() Links`

GetLinks returns the Links field if non-nil, zero value otherwise.

### GetLinksOk

`func (o *ChangeCommissionRequest) GetLinksOk() (*Links, bool)`
...
`func (o *ChangeCommissionRequest) SetLinks(v Links)`
...
`func (o *ChangeCommissionRequest) GetWarnings() WarningsType`

GetWarnings returns the Warnings field if non-nil, zero value otherwise.

### GetWarningsOk

`func (o *ChangeCommissionRequest) GetWarningsOk() (*WarningsType, bool)`
...
`func (o *ChangeCommissionRequest) SetWarnings(v WarningsType)`
