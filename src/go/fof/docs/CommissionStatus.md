...
`func (o *CommissionStatus) GetLinks() Links`

GetLinks returns the Links field if non-nil, zero value otherwise.

### GetLinksOk

`func (o *CommissionStatus) GetLinksOk() (*Links, bool)`
...
`func (o *CommissionStatus) SetLinks(v Links)`
...
`func (o *CommissionStatus) GetWarnings() WarningsType`

GetWarnings returns the Warnings field if non-nil, zero value otherwise.

### GetWarningsOk

`func (o *CommissionStatus) GetWarningsOk() (*WarningsType, bool)`
...
`func (o *CommissionStatus) SetWarnings(v WarningsType)`
