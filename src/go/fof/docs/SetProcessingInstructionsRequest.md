...
`func (o *SetProcessingInstructionsRequest) GetAgents() CommissionProcessingAgentsType`

GetAgents returns the Agents field if non-nil, zero value otherwise.

### GetAgentsOk

`func (o *SetProcessingInstructionsRequest) GetAgentsOk() (*CommissionProcessingAgentsType, bool)`
...
`func (o *SetProcessingInstructionsRequest) SetAgents(v CommissionProcessingAgentsType)`
...
`func (o *SetProcessingInstructionsRequest) GetLinks() Links`

GetLinks returns the Links field if non-nil, zero value otherwise.

### GetLinksOk

`func (o *SetProcessingInstructionsRequest) GetLinksOk() (*Links, bool)`
...
`func (o *SetProcessingInstructionsRequest) SetLinks(v Links)`
...
`func (o *SetProcessingInstructionsRequest) GetWarnings() WarningsType`

GetWarnings returns the Warnings field if non-nil, zero value otherwise.

### GetWarningsOk

`func (o *SetProcessingInstructionsRequest) GetWarningsOk() (*WarningsType, bool)`
...
`func (o *SetProcessingInstructionsRequest) SetWarnings(v WarningsType)`
