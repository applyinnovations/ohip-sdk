...
`func (o *CommissionToBeChanged) GetLinks() Links`

GetLinks returns the Links field if non-nil, zero value otherwise.

### GetLinksOk

`func (o *CommissionToBeChanged) GetLinksOk() (*Links, bool)`
...
`func (o *CommissionToBeChanged) SetLinks(v Links)`
...
`func (o *CommissionToBeChanged) GetWarnings() WarningsType`

GetWarnings returns the Warnings field if non-nil, zero value otherwise.

### GetWarningsOk

`func (o *CommissionToBeChanged) GetWarningsOk() (*WarningsType, bool)`
...
`func (o *CommissionToBeChanged) SetWarnings(v WarningsType)`
