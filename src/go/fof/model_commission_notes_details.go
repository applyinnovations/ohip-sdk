...
type CommissionNotesDetails struct {
	CommissionNotesList *CommissionNotesListType `json:"commissionNotesList,omitempty"`
...
func (o *CommissionNotesDetails) GetCommissionNotesList() CommissionNotesListType {
	if o == nil || IsNil(o.CommissionNotesList) {
		var ret CommissionNotesListType
		return ret
	}
...
// SetCommissionNotesList gets a reference to the given CommissionNotesListType and assigns it to the CommissionNotesList field.
