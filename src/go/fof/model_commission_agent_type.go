...
type CommissionAgentType struct {
	...
	CommissionDetails *CommissionDetailsType `json:"commissionDetails,omitempty"`
}
...
// SetCommissionDetails gets a reference to the given CommissionDetailsType and assigns it to the CommissionDetails field.
