...
type ReservationAutoRoomAssignRequestTypeRoomSelectionCriteria struct {
	...
	ExcludeRoomFeatures *RoomFeaturesType `json:"excludeRoomFeatures,omitempty"`
...
// SetExcludeRoomFeatures gets a reference to the given RoomFeaturesType and assigns it to the ExcludeRoomFeatures field.
