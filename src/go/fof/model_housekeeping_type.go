...
type HousekeepingType struct {
	...
	FacilityTaskCode *CodeListType `json:"facilityTaskCode,omitempty"`
...
// SetFacilityTaskCode gets a reference to the given CodeListType and assigns it to the FacilityTaskCode field.
