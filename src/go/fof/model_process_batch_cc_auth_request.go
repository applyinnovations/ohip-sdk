...
type ProcessBatchCCAuthRequest struct {
	...
	Reservations *ReservationsForCCAuthType `json:"reservations,omitempty"`
...
func (o *ProcessBatchCCAuthRequest) GetReservations() ReservationsForCCAuthType {
	if o == nil || IsNil(o.Reservations) {
		var ret ReservationsForCCAuthType
		return ret
	}
...
// SetReservations gets a reference to the given ReservationsForCCAuthType and assigns it to the Reservations field.
