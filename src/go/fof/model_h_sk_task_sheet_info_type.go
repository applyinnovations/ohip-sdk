...
type HSKTaskSheetInfoType struct {
	AssignedTasks *AssignedTasksType `json:"assignedTasks,omitempty"`
...
// SetAssignedTasks gets a reference to the given AssignedTasksType and assigns it to the AssignedTasks field.
