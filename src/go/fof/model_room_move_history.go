...
type RoomMoveHistory struct {
	...
	RoomMoveHistoryDetails *RoomMoveDetailsType `json:"roomMoveHistoryDetails,omitempty"`
...
// SetRoomMoveHistoryDetails gets a reference to the given RoomMoveDetailsType and assigns it to the RoomMoveHistoryDetails field.
