...
type ReservationAutoRoomAssignRequestType struct {
	...
	ReservationCriteria []ReservationIdList `json:"reservationCriteria,omitempty"`
...
// SetReservationCriteria gets a reference to the given []ReservationIdList and assigns it to the ReservationCriteria field.
