...
type CustomChargeExemptionType struct {
	CustomChargeDates *CustomChargeExemptionDatesType `json:"customChargeDates,omitempty"`
	...
	ExcludedDates *ExcludedDatesType `json:"excludedDates,omitempty"`
...
func (o *CustomChargeExemptionType) GetCustomChargeDates() CustomChargeExemptionDatesType {
	if o == nil || IsNil(o.CustomChargeDates) {
		var ret CustomChargeExemptionDatesType
		return ret
	}
...
// SetCustomChargeDates gets a reference to the given CustomChargeExemptionDatesType and assigns it to the CustomChargeDates field.
...
// SetExcludedDates gets a reference to the given ExcludedDatesType and assigns it to the ExcludedDates field.
