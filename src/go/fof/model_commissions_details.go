...
type CommissionsDetails struct {
	CommissionInfoList *CommissionInfoListType `json:"commissionInfoList,omitempty"`
...
func (o *CommissionsDetails) GetCommissionInfoList() CommissionInfoListType {
	if o == nil || IsNil(o.CommissionInfoList) {
		var ret CommissionInfoListType
		return ret
	}
...
// SetCommissionInfoList gets a reference to the given CommissionInfoListType and assigns it to the CommissionInfoList field.
