...
type CommissionProcessingAgentType struct {
	...
	Reservations *CommissionProcessingReservationsType `json:"reservations,omitempty"`
...
func (o *CommissionProcessingAgentType) GetReservations() CommissionProcessingReservationsType {
	if o == nil || IsNil(o.Reservations) {
		var ret CommissionProcessingReservationsType
		return ret
	}
...
// SetReservations gets a reference to the given CommissionProcessingReservationsType and assigns it to the Reservations field.
