...
type HotelReservationType struct {
	...
	AssociatedReservations *AssociatedResType `json:"associatedReservations,omitempty"`
...
// SetAssociatedReservations gets a reference to the given AssociatedResType and assigns it to the AssociatedReservations field.
