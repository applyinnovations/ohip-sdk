...
type EffectiveRateType struct {
	...
	RateByAgeBuckets *RateByAgeBucketsType `json:"rateByAgeBuckets,omitempty"`
...
// SetRateByAgeBuckets gets a reference to the given RateByAgeBucketsType and assigns it to the RateByAgeBuckets field.
