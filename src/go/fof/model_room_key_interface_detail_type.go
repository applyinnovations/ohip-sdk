...
type RoomKeyInterfaceDetailType struct {
	...
	Encoders *RoomKeyEncodersType `json:"encoders,omitempty"`
	...
	InterfaceRights *RoomKeyInterfaceRightsType `json:"interfaceRights,omitempty"`
...
// SetEncoders gets a reference to the given RoomKeyEncodersType and assigns it to the Encoders field.
...
func (o *RoomKeyInterfaceDetailType) GetInterfaceRights() RoomKeyInterfaceRightsType {
	if o == nil || IsNil(o.InterfaceRights) {
		var ret RoomKeyInterfaceRightsType
		return ret
	}
...
// SetInterfaceRights gets a reference to the given RoomKeyInterfaceRightsType and assigns it to the InterfaceRights field.
