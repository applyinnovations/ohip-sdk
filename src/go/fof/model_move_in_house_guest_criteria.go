...
type MoveInHouseGuestCriteria struct {
	...
	IncludedSharers []ReservationIdList `json:"includedSharers,omitempty"`
...
// SetIncludedSharers gets a reference to the given []ReservationIdList and assigns it to the IncludedSharers field.
