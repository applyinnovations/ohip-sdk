...
type BusinessEventType struct {
	Details *BusinessEventDetailsType `json:"details,omitempty"`
...
func (o *BusinessEventType) GetDetails() BusinessEventDetailsType {
	if o == nil || IsNil(o.Details) {
		var ret BusinessEventDetailsType
		return ret
	}
	return *o.Details
}
...
// SetDetails gets a reference to the given BusinessEventDetailsType and assigns it to the Details field.
