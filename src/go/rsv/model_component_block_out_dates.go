...
func (o *ComponentBlockOutDates) GetReservationIdList() ReservationIdList {
...
// and a boolean to check if the value has been set.
func (o *ComponentBlockOutDates) GetReservationIdListOk() (*ReservationIdList, bool) {
	if o == nil || IsNil(o.ReservationIdList) {
		return nil, false
	}
...
func (o *ComponentBlockOutDates) SetReservationIdList(v ReservationIdList) {
