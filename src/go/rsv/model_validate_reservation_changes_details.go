...
type ValidateReservationChangesDetails struct {
	...
	ValidationMessages *ValidationsReturnType `json:"validationMessages,omitempty"`
...
// SetValidationMessages gets a reference to the given ValidationsReturnType and assigns it to the ValidationMessages field.
