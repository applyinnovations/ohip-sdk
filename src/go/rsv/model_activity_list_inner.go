...
type ActivityListInner struct {
	ActivityIds *UniqueIDListType `json:"activityIds,omitempty"`
...
// SetActivityIds gets a reference to the given UniqueIDListType and assigns it to the ActivityIds field.
