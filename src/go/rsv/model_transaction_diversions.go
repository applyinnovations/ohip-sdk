...
func (o *TransactionDiversions) GetLinks() Links {
...
func (o *TransactionDiversions) GetLinksOk() (*Links, bool) {
	if o == nil || IsNil(o.Links) {
		return nil, false
	}
	return o.Links, true
...
func (o *TransactionDiversions) SetLinks(v Links) {
	o.Links = &v
}

// GetTransactionDiversions returns the TransactionDiversions field value if set, zero value otherwise.
func (o *TransactionDiversions) GetTransactionDiversions() ReservationTransactionDiversionsType {
...
// and a boolean to check if the value has been set.
func (o *TransactionDiversions) GetTransactionDiversionsOk() (*ReservationTransactionDiversionsType, bool) {
	if o == nil || IsNil(o.TransactionDiversions) {
		return nil, false
	}
...
func (o *TransactionDiversions) SetTransactionDiversions(v ReservationTransactionDiversionsType) {
	o.TransactionDiversions = &v
}

// GetWarnings returns the Warnings field value if set, zero value otherwise.
func (o *TransactionDiversions) GetWarnings() WarningsType {
...
// and a boolean to check if the value has been set.
func (o *TransactionDiversions) GetWarningsOk() (*WarningsType, bool) {
	if o == nil || IsNil(o.Warnings) {
		return nil, false
	}
...
func (o *TransactionDiversions) SetWarnings(v WarningsType) {
	o.Warnings = &v
}
