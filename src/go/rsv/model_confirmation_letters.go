...
type ConfirmationLetters struct {
	ConfLetters *ConfirmationsType `json:"confLetters,omitempty"`
...
// SetConfLetters gets a reference to the given ConfirmationsType and assigns it to the ConfLetters field.
