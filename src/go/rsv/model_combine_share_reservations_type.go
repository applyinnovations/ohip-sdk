...
type CombineShareReservationsType struct {
	...
	NewReservations *CombineShareFromProfilesType `json:"newReservations,omitempty"`
...
func (o *CombineShareReservationsType) GetNewReservations() CombineShareFromProfilesType {
	if o == nil || IsNil(o.NewReservations) {
		var ret CombineShareFromProfilesType
		return ret
	}
...
// SetNewReservations gets a reference to the given CombineShareFromProfilesType and assigns it to the NewReservations field.
