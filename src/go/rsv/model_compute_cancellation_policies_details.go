...
type ComputeCancellationPoliciesDetails struct {
	...
	Policies *ResCancellationPoliciesType `json:"policies,omitempty"`
...
// SetPolicies gets a reference to the given ResCancellationPoliciesType and assigns it to the Policies field.
