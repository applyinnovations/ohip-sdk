...
type CopyReservationType struct {
	...
	SourceReservationId *UniqueIDListType `json:"sourceReservationId,omitempty"`
}
...
// SetSourceReservationId gets a reference to the given UniqueIDListType and assigns it to the SourceReservationId field.
