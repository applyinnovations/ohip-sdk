...
// checks if the PutSellMessageConfigRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PutSellMessageConfigRequest{}

// PutSellMessageConfigRequest struct for PutSellMessageConfigRequest
type PutSellMessageConfigRequest struct {
...
func NewPutSellMessageConfigRequest() *PutSellMessageConfigRequest {
	this := PutSellMessageConfigRequest{}
	return &this
}
...
func (o PutSellMessageConfigRequest) MarshalJSON() ([]byte, error) {
...
func (o PutSellMessageConfigRequest) ToMap() (map[string]interface{}, error) {
...
type NullablePutSellMessageConfigRequest struct {
	value *PutSellMessageConfigRequest
	isSet bool
}

func (v NullablePutSellMessageConfigRequest) Get() *PutSellMessageConfigRequest {
	return v.value
}

func (v *NullablePutSellMessageConfigRequest) Set(val *PutSellMessageConfigRequest) {
	v.value = val
	v.isSet = true
}

func (v NullablePutSellMessageConfigRequest) IsSet() bool {
	return v.isSet
}

func (v *NullablePutSellMessageConfigRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePutSellMessageConfigRequest(val *PutSellMessageConfigRequest) *NullablePutSellMessageConfigRequest {
	return &NullablePutSellMessageConfigRequest{value: val, isSet: true}
}

func (v NullablePutSellMessageConfigRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePutSellMessageConfigRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
