...
type HotelReservationInstructionType struct {
	...
	CallHistory *CallHistoryType `json:"callHistory,omitempty"`
	...
	ConfirmationLetters *ConfirmationsType `json:"confirmationLetters,omitempty"`
	...
	CustomChargeExemptionDetails *CustomChargeExemptionsType `json:"customChargeExemptionDetails,omitempty"`
	...
	ECertificates *ReservationECertificatesType `json:"eCertificates,omitempty"`
	ECoupons *ECouponsType `json:"eCoupons,omitempty"`
	...
	Folios *FoliosShortInfoType `json:"folios,omitempty"`
	...
	Locators *ReservationLocatorsType `json:"locators,omitempty"`
	...
	OverrideInstructions *OverrideInstructionsType `json:"overrideInstructions,omitempty"`
	...
	ProfileAwards *AwardsType `json:"profileAwards,omitempty"`
	...
	ReservationActivities *ActivityLookUpList `json:"reservationActivities,omitempty"`
	...
	ScheduledActivities *ActivityLookUpList `json:"scheduledActivities,omitempty"`
	ServiceRequests *ServiceRequests `json:"serviceRequests,omitempty"`
	...
	TrackItItems *TrackItItemsType `json:"trackItItems,omitempty"`
	...
	WebRegistrationCards *AttachmentsType `json:"webRegistrationCards,omitempty"`
}
...
// SetAlerts gets a reference to the given AlertsType and assigns it to the Alerts field.
...
// SetCallHistory gets a reference to the given CallHistoryType and assigns it to the CallHistory field.
...
// SetConfirmationLetters gets a reference to the given ConfirmationsType and assigns it to the ConfirmationLetters field.
...
func (o *HotelReservationInstructionType) GetCustomChargeExemptionDetails() CustomChargeExemptionsType {
	if o == nil || IsNil(o.CustomChargeExemptionDetails) {
		var ret CustomChargeExemptionsType
		return ret
	}
...
// SetCustomChargeExemptionDetails gets a reference to the given CustomChargeExemptionsType and assigns it to the CustomChargeExemptionDetails field.
...
func (o *HotelReservationInstructionType) GetECertificates() ReservationECertificatesType {
	if o == nil || IsNil(o.ECertificates) {
		var ret ReservationECertificatesType
		return ret
	}
...
// SetECertificates gets a reference to the given ReservationECertificatesType and assigns it to the ECertificates field.
...
// SetECoupons gets a reference to the given ECouponsType and assigns it to the ECoupons field.
...
// SetFolios gets a reference to the given FoliosShortInfoType and assigns it to the Folios field.
...
// SetLocators gets a reference to the given ReservationLocatorsType and assigns it to the Locators field.
...
func (o *HotelReservationInstructionType) GetOverrideInstructions() OverrideInstructionsType {
	if o == nil || IsNil(o.OverrideInstructions) {
		var ret OverrideInstructionsType
		return ret
	}
...
// SetOverrideInstructions gets a reference to the given OverrideInstructionsType and assigns it to the OverrideInstructions field.
...
// SetProfileAwards gets a reference to the given AwardsType and assigns it to the ProfileAwards field.
...
// SetReservationActivities gets a reference to the given ActivityLookUpList and assigns it to the ReservationActivities field.
...
// SetScheduledActivities gets a reference to the given ActivityLookUpList and assigns it to the ScheduledActivities field.
...
// SetServiceRequests gets a reference to the given ServiceRequests and assigns it to the ServiceRequests field.
...
// SetTrackItItems gets a reference to the given TrackItItemsType and assigns it to the TrackItItems field.
...
// SetWebRegistrationCards gets a reference to the given AttachmentsType and assigns it to the WebRegistrationCards field.
