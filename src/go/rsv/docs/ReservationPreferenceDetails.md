...
`func (o *ReservationPreferenceDetails) GetLinks() Links`

GetLinks returns the Links field if non-nil, zero value otherwise.

### GetLinksOk

`func (o *ReservationPreferenceDetails) GetLinksOk() (*Links, bool)`
...
`func (o *ReservationPreferenceDetails) SetLinks(v Links)`
...
`func (o *ReservationPreferenceDetails) GetWarnings() WarningsType`

GetWarnings returns the Warnings field if non-nil, zero value otherwise.

### GetWarningsOk

`func (o *ReservationPreferenceDetails) GetWarningsOk() (*WarningsType, bool)`
...
`func (o *ReservationPreferenceDetails) SetWarnings(v WarningsType)`
