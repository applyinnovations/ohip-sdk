...
`func (o *PostReservationByBlockRequest) GetLinks() Links`

GetLinks returns the Links field if non-nil, zero value otherwise.

### GetLinksOk

`func (o *PostReservationByBlockRequest) GetLinksOk() (*Links, bool)`
...
`func (o *PostReservationByBlockRequest) SetLinks(v Links)`
...
`func (o *PostReservationByBlockRequest) GetWarnings() WarningsType`

GetWarnings returns the Warnings field if non-nil, zero value otherwise.

### GetWarningsOk

`func (o *PostReservationByBlockRequest) GetWarningsOk() (*WarningsType, bool)`
...
`func (o *PostReservationByBlockRequest) SetWarnings(v WarningsType)`
