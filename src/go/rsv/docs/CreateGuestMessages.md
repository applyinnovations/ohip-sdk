...
`func (o *CreateGuestMessages) GetGuestMessages() GuestMessagesType`

GetGuestMessages returns the GuestMessages field if non-nil, zero value otherwise.

### GetGuestMessagesOk

`func (o *CreateGuestMessages) GetGuestMessagesOk() (*GuestMessagesType, bool)`
...
`func (o *CreateGuestMessages) SetGuestMessages(v GuestMessagesType)`
...
`func (o *CreateGuestMessages) GetLinks() Links`

GetLinks returns the Links field if non-nil, zero value otherwise.

### GetLinksOk

`func (o *CreateGuestMessages) GetLinksOk() (*Links, bool)`
...
`func (o *CreateGuestMessages) SetLinks(v Links)`
...
`func (o *CreateGuestMessages) GetReservationIdList() ReservationIdList`

GetReservationIdList returns the ReservationIdList field if non-nil, zero value otherwise.

### GetReservationIdListOk

`func (o *CreateGuestMessages) GetReservationIdListOk() (*ReservationIdList, bool)`
...
`func (o *CreateGuestMessages) SetReservationIdList(v ReservationIdList)`
...
`func (o *CreateGuestMessages) GetWarnings() WarningsType`

GetWarnings returns the Warnings field if non-nil, zero value otherwise.

### GetWarningsOk

`func (o *CreateGuestMessages) GetWarningsOk() (*WarningsType, bool)`
...
`func (o *CreateGuestMessages) SetWarnings(v WarningsType)`
