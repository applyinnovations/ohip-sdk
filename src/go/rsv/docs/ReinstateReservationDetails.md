...
`func (o *ReinstateReservationDetails) GetLinks() Links`

GetLinks returns the Links field if non-nil, zero value otherwise.

### GetLinksOk

`func (o *ReinstateReservationDetails) GetLinksOk() (*Links, bool)`
...
`func (o *ReinstateReservationDetails) SetLinks(v Links)`
...
`func (o *ReinstateReservationDetails) GetWarnings() WarningsType`

GetWarnings returns the Warnings field if non-nil, zero value otherwise.

### GetWarningsOk

`func (o *ReinstateReservationDetails) GetWarningsOk() (*WarningsType, bool)`
...
`func (o *ReinstateReservationDetails) SetWarnings(v WarningsType)`
