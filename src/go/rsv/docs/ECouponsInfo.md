...
`func (o *ECouponsInfo) GetECoupons() ECouponsType`

GetECoupons returns the ECoupons field if non-nil, zero value otherwise.

### GetECouponsOk

`func (o *ECouponsInfo) GetECouponsOk() (*ECouponsType, bool)`
...
`func (o *ECouponsInfo) SetECoupons(v ECouponsType)`
...
`func (o *ECouponsInfo) GetLinks() Links`

GetLinks returns the Links field if non-nil, zero value otherwise.

### GetLinksOk

`func (o *ECouponsInfo) GetLinksOk() (*Links, bool)`
...
`func (o *ECouponsInfo) SetLinks(v Links)`
...
`func (o *ECouponsInfo) GetWarnings() WarningsType`

GetWarnings returns the Warnings field if non-nil, zero value otherwise.

### GetWarningsOk

`func (o *ECouponsInfo) GetWarningsOk() (*WarningsType, bool)`
...
`func (o *ECouponsInfo) SetWarnings(v WarningsType)`
