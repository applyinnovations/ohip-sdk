...
**Results** | Pointer to [**CheckResultsType**](CheckResultsType.md) |  | [optional] 
...
`func (o *CheckReservationType) GetResults() CheckResultsType`

GetResults returns the Results field if non-nil, zero value otherwise.

### GetResultsOk

`func (o *CheckReservationType) GetResultsOk() (*CheckResultsType, bool)`
...
`func (o *CheckReservationType) SetResults(v CheckResultsType)`
