...
`func (o *PutTicketsRequest) GetLinks() Links`

GetLinks returns the Links field if non-nil, zero value otherwise.

### GetLinksOk

`func (o *PutTicketsRequest) GetLinksOk() (*Links, bool)`
...
`func (o *PutTicketsRequest) SetLinks(v Links)`
...
`func (o *PutTicketsRequest) GetTickets() TicketsType`

GetTickets returns the Tickets field if non-nil, zero value otherwise.

### GetTicketsOk

`func (o *PutTicketsRequest) GetTicketsOk() (*TicketsType, bool)`
...
`func (o *PutTicketsRequest) SetTickets(v TicketsType)`
...
`func (o *PutTicketsRequest) GetWarnings() WarningsType`

GetWarnings returns the Warnings field if non-nil, zero value otherwise.

### GetWarningsOk

`func (o *PutTicketsRequest) GetWarningsOk() (*WarningsType, bool)`
...
`func (o *PutTicketsRequest) SetWarnings(v WarningsType)`
