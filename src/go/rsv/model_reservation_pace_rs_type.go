...
type ReservationPaceRSType struct {
	...
	DailyPaceStats *DailyPaceStatsType `json:"dailyPaceStats,omitempty"`
...
// SetDailyPaceStats gets a reference to the given DailyPaceStatsType and assigns it to the DailyPaceStats field.
