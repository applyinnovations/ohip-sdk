...
// checks if the PostBulkReservationAlertsRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PostBulkReservationAlertsRequest{}

// PostBulkReservationAlertsRequest struct for PostBulkReservationAlertsRequest
type PostBulkReservationAlertsRequest struct {
...
func NewPostBulkReservationAlertsRequest() *PostBulkReservationAlertsRequest {
	this := PostBulkReservationAlertsRequest{}
	return &this
}
...
func (o PostBulkReservationAlertsRequest) MarshalJSON() ([]byte, error) {
...
func (o PostBulkReservationAlertsRequest) ToMap() (map[string]interface{}, error) {
...
type NullablePostBulkReservationAlertsRequest struct {
	value *PostBulkReservationAlertsRequest
	isSet bool
}

func (v NullablePostBulkReservationAlertsRequest) Get() *PostBulkReservationAlertsRequest {
	return v.value
}

func (v *NullablePostBulkReservationAlertsRequest) Set(val *PostBulkReservationAlertsRequest) {
	v.value = val
	v.isSet = true
}

func (v NullablePostBulkReservationAlertsRequest) IsSet() bool {
	return v.isSet
}

func (v *NullablePostBulkReservationAlertsRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePostBulkReservationAlertsRequest(val *PostBulkReservationAlertsRequest) *NullablePostBulkReservationAlertsRequest {
	return &NullablePostBulkReservationAlertsRequest{value: val, isSet: true}
}

func (v NullablePostBulkReservationAlertsRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePostBulkReservationAlertsRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
