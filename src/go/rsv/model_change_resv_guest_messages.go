...
// checks if the ChangeResvGuestMessages type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ChangeResvGuestMessages{}

// ChangeResvGuestMessages Request object for updating the Guest Messages for a Reservation Workspace.
type ChangeResvGuestMessages struct {
...
func (o ChangeResvGuestMessages) MarshalJSON() ([]byte, error) {
...
func (o ChangeResvGuestMessages) ToMap() (map[string]interface{}, error) {
...
type NullableChangeResvGuestMessages struct {
	value *ChangeResvGuestMessages
	isSet bool
}

func (v NullableChangeResvGuestMessages) Get() *ChangeResvGuestMessages {
	return v.value
}

func (v *NullableChangeResvGuestMessages) Set(val *ChangeResvGuestMessages) {
	v.value = val
	v.isSet = true
}

func (v NullableChangeResvGuestMessages) IsSet() bool {
	return v.isSet
}

func (v *NullableChangeResvGuestMessages) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableChangeResvGuestMessages(val *ChangeResvGuestMessages) *NullableChangeResvGuestMessages {
	return &NullableChangeResvGuestMessages{value: val, isSet: true}
}

func (v NullableChangeResvGuestMessages) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableChangeResvGuestMessages) UnmarshalJSON(src []byte) error {
	v.isSet = true
