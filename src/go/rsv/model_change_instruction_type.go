...
type ChangeInstructionType struct {
	...
	ShareReservations *UniqueIDListType `json:"shareReservations,omitempty"`
...
// SetShareReservations gets a reference to the given UniqueIDListType and assigns it to the ShareReservations field.
