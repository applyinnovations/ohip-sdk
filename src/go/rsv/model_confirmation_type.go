...
type ConfirmationType struct {
	...
	DeliveryInfo *ConfDeliveryInfoTypes `json:"deliveryInfo,omitempty"`
...
// SetDeliveryInfo gets a reference to the given ConfDeliveryInfoTypes and assigns it to the DeliveryInfo field.
