...
type CancellationActivityType struct {
	CancellationIdList *UniqueIDListType `json:"cancellationIdList,omitempty"`
...
// SetCancellationIdList gets a reference to the given UniqueIDListType and assigns it to the CancellationIdList field.
