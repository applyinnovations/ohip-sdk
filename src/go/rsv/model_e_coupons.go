...
// checks if the ECoupons type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ECoupons{}

// ECoupons Response object for fetching the eCoupons attached to Reservation.
type ECoupons struct {
...
func (o ECoupons) MarshalJSON() ([]byte, error) {
...
func (o ECoupons) ToMap() (map[string]interface{}, error) {
...
type NullableECoupons struct {
	value *ECoupons
	isSet bool
}

func (v NullableECoupons) Get() *ECoupons {
	return v.value
}

func (v *NullableECoupons) Set(val *ECoupons) {
	v.value = val
	v.isSet = true
}

func (v NullableECoupons) IsSet() bool {
	return v.isSet
}

func (v *NullableECoupons) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableECoupons(val *ECoupons) *NullableECoupons {
	return &NullableECoupons{value: val, isSet: true}
}

func (v NullableECoupons) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableECoupons) UnmarshalJSON(src []byte) error {
	v.isSet = true
