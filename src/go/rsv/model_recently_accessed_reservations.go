...
type RecentlyAccessedReservations struct {
	...
	Reservations *RecentlyAccessedReservationsType `json:"reservations,omitempty"`
...
func (o *RecentlyAccessedReservations) GetReservations() RecentlyAccessedReservationsType {
	if o == nil || IsNil(o.Reservations) {
		var ret RecentlyAccessedReservationsType
		return ret
	}
...
// SetReservations gets a reference to the given RecentlyAccessedReservationsType and assigns it to the Reservations field.
