...
type RoomCalendarResType struct {
	...
	RoomMoveHistory *RoomMoveDetailsType `json:"roomMoveHistory,omitempty"`
...
// SetRoomMoveHistory gets a reference to the given RoomMoveDetailsType and assigns it to the RoomMoveHistory field.
