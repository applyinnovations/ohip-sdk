...
type OverlappingStayInfoType struct {
	...
	ExcludedReservations *UniqueIDListType `json:"excludedReservations,omitempty"`
...
// SetExcludedReservations gets a reference to the given UniqueIDListType and assigns it to the ExcludedReservations field.
