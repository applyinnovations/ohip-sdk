...
type PutResvGuestMessagesRequest struct {
	GuestMessages *ResvGuestMessagesType `json:"guestMessages,omitempty"`
...
// SetGuestMessages gets a reference to the given ResvGuestMessagesType and assigns it to the GuestMessages field.
