...
type ValidationReturnType struct {
	InvalidReservations *ReservationSummaryListType `json:"invalidReservations,omitempty"`
...
func (o *ValidationReturnType) GetInvalidReservations() ReservationSummaryListType {
	if o == nil || IsNil(o.InvalidReservations) {
		var ret ReservationSummaryListType
		return ret
	}
...
// SetInvalidReservations gets a reference to the given ReservationSummaryListType and assigns it to the InvalidReservations field.
