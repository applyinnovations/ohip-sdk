...
type AwardUpgradeSummaryType struct {
	...
	AwardUpgradeDetails *AwardUpgradeDetailsType `json:"awardUpgradeDetails,omitempty"`
...
func (o *AwardUpgradeSummaryType) GetAwardUpgradeDetails() AwardUpgradeDetailsType {
	if o == nil || IsNil(o.AwardUpgradeDetails) {
		var ret AwardUpgradeDetailsType
		return ret
	}
...
// SetAwardUpgradeDetails gets a reference to the given AwardUpgradeDetailsType and assigns it to the AwardUpgradeDetails field.
