...
type BlockReservationStatisticsByDateAndRoomPoolType struct {
	DailyStats *DailyStatsType `json:"dailyStats,omitempty"`
}
...
// SetDailyStats gets a reference to the given DailyStatsType and assigns it to the DailyStats field.
