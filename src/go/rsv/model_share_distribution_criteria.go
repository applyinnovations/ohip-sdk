...
type ShareDistributionCriteria struct {
	...
	ShareReservations *ShareReservationsType `json:"shareReservations,omitempty"`
}
...
// SetShareReservations gets a reference to the given ShareReservationsType and assigns it to the ShareReservations field.
