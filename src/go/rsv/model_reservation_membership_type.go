...
type ReservationMembershipType struct {
	Benefits *BenefitsType `json:"benefits,omitempty"`
...
// SetBenefits gets a reference to the given BenefitsType and assigns it to the Benefits field.
