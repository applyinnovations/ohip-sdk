...
type Restrictions struct {
	...
	Restrictions *RestrictionsType `json:"restrictions,omitempty"`
}
...
// SetRestrictions gets a reference to the given RestrictionsType and assigns it to the Restrictions field.
