...
func (r AvailabilityAsyncApiPostRestrictionsProcessRequest) Execute() (*Links, *http.Response, error) {
...
// Execute executes the request
//  @return Links
func (a *AvailabilityAsyncApiService) PostRestrictionsProcessExecute(r AvailabilityAsyncApiPostRestrictionsProcessRequest) (*Links, *http.Response, error) {
	var (
