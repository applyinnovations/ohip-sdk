...
func (o *ReservationMethodsToBeChanged) GetLinks() Links {
...
func (o *ReservationMethodsToBeChanged) GetLinksOk() (*Links, bool) {
	if o == nil || IsNil(o.Links) {
		return nil, false
	}
	return o.Links, true
...
func (o *ReservationMethodsToBeChanged) SetLinks(v Links) {
	o.Links = &v
}

// GetReservationMethods returns the ReservationMethods field value if set, zero value otherwise.
func (o *ReservationMethodsToBeChanged) GetReservationMethods() ReservationMethodsType {
...
// and a boolean to check if the value has been set.
func (o *ReservationMethodsToBeChanged) GetReservationMethodsOk() (*ReservationMethodsType, bool) {
	if o == nil || IsNil(o.ReservationMethods) {
		return nil, false
	}
...
func (o *ReservationMethodsToBeChanged) SetReservationMethods(v ReservationMethodsType) {
	o.ReservationMethods = &v
}

// GetWarnings returns the Warnings field value if set, zero value otherwise.
func (o *ReservationMethodsToBeChanged) GetWarnings() WarningsType {
...
// and a boolean to check if the value has been set.
func (o *ReservationMethodsToBeChanged) GetWarningsOk() (*WarningsType, bool) {
	if o == nil || IsNil(o.Warnings) {
		return nil, false
	}
...
func (o *ReservationMethodsToBeChanged) SetWarnings(v WarningsType) {
	o.Warnings = &v
}
