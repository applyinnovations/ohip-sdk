...
type WashCodeType struct {
	...
	WashCodeDetails *WashCodeDetailsType `json:"washCodeDetails,omitempty"`
}
...
// SetWashCodeDetails gets a reference to the given WashCodeDetailsType and assigns it to the WashCodeDetails field.
