...
// checks if the PostReservationMethodsRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PostReservationMethodsRequest{}

// PostReservationMethodsRequest struct for PostReservationMethodsRequest
type PostReservationMethodsRequest struct {
...
func NewPostReservationMethodsRequest() *PostReservationMethodsRequest {
	this := PostReservationMethodsRequest{}
	return &this
}
...
func (o PostReservationMethodsRequest) MarshalJSON() ([]byte, error) {
...
func (o PostReservationMethodsRequest) ToMap() (map[string]interface{}, error) {
...
type NullablePostReservationMethodsRequest struct {
	value *PostReservationMethodsRequest
	isSet bool
}

func (v NullablePostReservationMethodsRequest) Get() *PostReservationMethodsRequest {
	return v.value
}

func (v *NullablePostReservationMethodsRequest) Set(val *PostReservationMethodsRequest) {
	v.value = val
	v.isSet = true
}

func (v NullablePostReservationMethodsRequest) IsSet() bool {
	return v.isSet
}

func (v *NullablePostReservationMethodsRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePostReservationMethodsRequest(val *PostReservationMethodsRequest) *NullablePostReservationMethodsRequest {
	return &NullablePostReservationMethodsRequest{value: val, isSet: true}
}

func (v NullablePostReservationMethodsRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePostReservationMethodsRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
