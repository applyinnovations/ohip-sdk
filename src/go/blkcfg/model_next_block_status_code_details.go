...
type NextBlockStatusCodeDetails struct {
	BlockStatusCodeMasterList *BlockStatusCodeListType `json:"blockStatusCodeMasterList,omitempty"`
...
// SetBlockStatusCodeMasterList gets a reference to the given BlockStatusCodeListType and assigns it to the BlockStatusCodeMasterList field.
