...
type NextBlockStatusCodeType struct {
	NextAvailableStatusList *NextBlockStatusCodeInfoListType `json:"nextAvailableStatusList,omitempty"`
	NextConfiguredStatusList *NextBlockStatusCodeInfoListType `json:"nextConfiguredStatusList,omitempty"`
...
func (o *NextBlockStatusCodeType) GetNextAvailableStatusList() NextBlockStatusCodeInfoListType {
	if o == nil || IsNil(o.NextAvailableStatusList) {
		var ret NextBlockStatusCodeInfoListType
		return ret
	}
...
// SetNextAvailableStatusList gets a reference to the given NextBlockStatusCodeInfoListType and assigns it to the NextAvailableStatusList field.
...
// SetNextConfiguredStatusList gets a reference to the given NextBlockStatusCodeInfoListType and assigns it to the NextConfiguredStatusList field.
