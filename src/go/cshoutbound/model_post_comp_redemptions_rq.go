...
type PostCompRedemptionsRQ struct {
	CompRedemptions *PostCompRedemptionsRQCompRedemptionsType `json:"compRedemptions,omitempty"`
}
...
func (o *PostCompRedemptionsRQ) GetCompRedemptions() PostCompRedemptionsRQCompRedemptionsType {
	if o == nil || IsNil(o.CompRedemptions) {
		var ret PostCompRedemptionsRQCompRedemptionsType
		return ret
	}
...
// SetCompRedemptions gets a reference to the given PostCompRedemptionsRQCompRedemptionsType and assigns it to the CompRedemptions field.
