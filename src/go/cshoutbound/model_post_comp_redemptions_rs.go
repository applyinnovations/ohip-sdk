...
type PostCompRedemptionsRS struct {
	CompRedemptions *PostCompRedemptionsRSCompRedemptionsType `json:"compRedemptions,omitempty"`
...
func (o *PostCompRedemptionsRS) GetCompRedemptions() PostCompRedemptionsRSCompRedemptionsType {
	if o == nil || IsNil(o.CompRedemptions) {
		var ret PostCompRedemptionsRSCompRedemptionsType
		return ret
	}
...
// SetCompRedemptions gets a reference to the given PostCompRedemptionsRSCompRedemptionsType and assigns it to the CompRedemptions field.
