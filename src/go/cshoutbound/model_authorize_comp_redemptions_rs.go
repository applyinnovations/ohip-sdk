...
type AuthorizeCompRedemptionsRS struct {
	CompRedemptions *AuthorizeCompRedemptionsRSCompRedemptionsType `json:"compRedemptions,omitempty"`
...
func (o *AuthorizeCompRedemptionsRS) GetCompRedemptions() AuthorizeCompRedemptionsRSCompRedemptionsType {
	if o == nil || IsNil(o.CompRedemptions) {
		var ret AuthorizeCompRedemptionsRSCompRedemptionsType
		return ret
	}
...
// SetCompRedemptions gets a reference to the given AuthorizeCompRedemptionsRSCompRedemptionsType and assigns it to the CompRedemptions field.
