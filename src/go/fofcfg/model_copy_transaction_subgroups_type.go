...
type CopyTransactionSubgroupsType struct {
	...
	TransactionSubgroups *TemplateTransactionSubgroupIDsType `json:"transactionSubgroups,omitempty"`
}
...
func (o *CopyTransactionSubgroupsType) GetTransactionSubgroups() TemplateTransactionSubgroupIDsType {
	if o == nil || IsNil(o.TransactionSubgroups) {
		var ret TemplateTransactionSubgroupIDsType
		return ret
	}
...
// SetTransactionSubgroups gets a reference to the given TemplateTransactionSubgroupIDsType and assigns it to the TransactionSubgroups field.
