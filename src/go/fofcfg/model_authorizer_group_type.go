...
type AuthorizerGroupType struct {
	...
	TransactionLimits *AuthorizerTrxLimitsType `json:"transactionLimits,omitempty"`
}
...
func (o *AuthorizerGroupType) GetTransactionLimits() AuthorizerTrxLimitsType {
	if o == nil || IsNil(o.TransactionLimits) {
		var ret AuthorizerTrxLimitsType
		return ret
	}
...
// SetTransactionLimits gets a reference to the given AuthorizerTrxLimitsType and assigns it to the TransactionLimits field.
