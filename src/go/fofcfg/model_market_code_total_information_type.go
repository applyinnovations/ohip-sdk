...
// checks if the MarketCodeTotalInformationType type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MarketCodeTotalInformationType{}

// MarketCodeTotalInformationType Budget Forecast information for segment.
type MarketCodeTotalInformationType struct {
	ABVarianceTotalInfo *RevenueNightsVarianceInfoType `json:"aBVarianceTotalInfo,omitempty"`
	AFVarianceTotalInfo *RevenueNightsVarianceInfoType `json:"aFVarianceTotalInfo,omitempty"`
	...
	FBVarianceTotalInfo *RevenueNightsVarianceInfoType `json:"fBVarianceTotalInfo,omitempty"`
...
func NewMarketCodeTotalInformationType() *MarketCodeTotalInformationType {
	this := MarketCodeTotalInformationType{}
	return &this
}
...
func (o *MarketCodeTotalInformationType) GetABVarianceTotalInfo() RevenueNightsVarianceInfoType {
	if o == nil || IsNil(o.ABVarianceTotalInfo) {
		var ret RevenueNightsVarianceInfoType
		return ret
	}
...
// SetABVarianceTotalInfo gets a reference to the given RevenueNightsVarianceInfoType and assigns it to the ABVarianceTotalInfo field.
...
// SetAFVarianceTotalInfo gets a reference to the given RevenueNightsVarianceInfoType and assigns it to the AFVarianceTotalInfo field.
...
// SetFBVarianceTotalInfo gets a reference to the given RevenueNightsVarianceInfoType and assigns it to the FBVarianceTotalInfo field.
...
func (o MarketCodeTotalInformationType) MarshalJSON() ([]byte, error) {
...
func (o MarketCodeTotalInformationType) ToMap() (map[string]interface{}, error) {
...
type NullableMarketCodeTotalInformationType struct {
	value *MarketCodeTotalInformationType
	isSet bool
}

func (v NullableMarketCodeTotalInformationType) Get() *MarketCodeTotalInformationType {
	return v.value
}

func (v *NullableMarketCodeTotalInformationType) Set(val *MarketCodeTotalInformationType) {
	v.value = val
	v.isSet = true
}

func (v NullableMarketCodeTotalInformationType) IsSet() bool {
	return v.isSet
}

func (v *NullableMarketCodeTotalInformationType) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMarketCodeTotalInformationType(val *MarketCodeTotalInformationType) *NullableMarketCodeTotalInformationType {
	return &NullableMarketCodeTotalInformationType{value: val, isSet: true}
}

func (v NullableMarketCodeTotalInformationType) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMarketCodeTotalInformationType) UnmarshalJSON(src []byte) error {
	v.isSet = true
