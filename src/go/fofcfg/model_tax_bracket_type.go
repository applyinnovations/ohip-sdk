...
type TaxBracketType struct {
	...
	TaxBracketAmounts *TaxBracketAmountsType `json:"taxBracketAmounts,omitempty"`
...
// SetTaxBracketAmounts gets a reference to the given TaxBracketAmountsType and assigns it to the TaxBracketAmounts field.
