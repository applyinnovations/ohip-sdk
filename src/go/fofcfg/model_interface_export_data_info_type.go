...
type InterfaceExportDataInfoType struct {
	InterfaceExportDataDetails *InterfaceExportDataDetailsType `json:"interfaceExportDataDetails,omitempty"`
	InterfaceExportDataMandatoryDetails *InterfaceExportDataDetailsType `json:"interfaceExportDataMandatoryDetails,omitempty"`
}
...
func (o *InterfaceExportDataInfoType) GetInterfaceExportDataDetails() InterfaceExportDataDetailsType {
	if o == nil || IsNil(o.InterfaceExportDataDetails) {
		var ret InterfaceExportDataDetailsType
		return ret
	}
...
// SetInterfaceExportDataDetails gets a reference to the given InterfaceExportDataDetailsType and assigns it to the InterfaceExportDataDetails field.
...
// SetInterfaceExportDataMandatoryDetails gets a reference to the given InterfaceExportDataDetailsType and assigns it to the InterfaceExportDataMandatoryDetails field.
