...
type AuthorizerTrxLimitType struct {
	BillingInstructions *AuthBillingInstructionsType `json:"billingInstructions,omitempty"`
	...
	TransactionCodes *AuthTransactionCodesType `json:"transactionCodes,omitempty"`
}
...
func (o *AuthorizerTrxLimitType) GetBillingInstructions() AuthBillingInstructionsType {
	if o == nil || IsNil(o.BillingInstructions) {
		var ret AuthBillingInstructionsType
		return ret
	}
...
// SetBillingInstructions gets a reference to the given AuthBillingInstructionsType and assigns it to the BillingInstructions field.
...
func (o *AuthorizerTrxLimitType) GetTransactionCodes() AuthTransactionCodesType {
	if o == nil || IsNil(o.TransactionCodes) {
		var ret AuthTransactionCodesType
		return ret
	}
...
// SetTransactionCodes gets a reference to the given AuthTransactionCodesType and assigns it to the TransactionCodes field.
