...
type CommissionCodesSummary struct {
	CommissionCodesSummary *CommissionCodesSummaryType `json:"commissionCodesSummary,omitempty"`
...
func (o *CommissionCodesSummary) GetCommissionCodesSummary() CommissionCodesSummaryType {
	if o == nil || IsNil(o.CommissionCodesSummary) {
		var ret CommissionCodesSummaryType
		return ret
	}
...
// SetCommissionCodesSummary gets a reference to the given CommissionCodesSummaryType and assigns it to the CommissionCodesSummary field.
