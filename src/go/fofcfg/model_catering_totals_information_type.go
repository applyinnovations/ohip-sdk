...
type CateringTotalsInformationType struct {
	ABVarianceTotalInfo *CateringVarianceInfoType `json:"aBVarianceTotalInfo,omitempty"`
	AFVarianceTotalInfo *CateringVarianceInfoType `json:"aFVarianceTotalInfo,omitempty"`
	...
	FBVarianceTotalInfo *CateringVarianceInfoType `json:"fBVarianceTotalInfo,omitempty"`
...
func (o *CateringTotalsInformationType) GetABVarianceTotalInfo() CateringVarianceInfoType {
	if o == nil || IsNil(o.ABVarianceTotalInfo) {
		var ret CateringVarianceInfoType
		return ret
	}
...
// SetABVarianceTotalInfo gets a reference to the given CateringVarianceInfoType and assigns it to the ABVarianceTotalInfo field.
...
// SetAFVarianceTotalInfo gets a reference to the given CateringVarianceInfoType and assigns it to the AFVarianceTotalInfo field.
...
// SetFBVarianceTotalInfo gets a reference to the given CateringVarianceInfoType and assigns it to the FBVarianceTotalInfo field.
