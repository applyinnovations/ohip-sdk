...
type HotelInterfaceDetailType struct {
	...
	WorkstationSetupInfo *WorkstationSetupType `json:"workstationSetupInfo,omitempty"`
}
...
// SetWorkstationSetupInfo gets a reference to the given WorkstationSetupType and assigns it to the WorkstationSetupInfo field.
