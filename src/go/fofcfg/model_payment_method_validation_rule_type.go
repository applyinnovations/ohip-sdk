...
type PaymentMethodValidationRuleType struct {
	...
	Ranges *CardRangesType `json:"ranges,omitempty"`
...
// SetRanges gets a reference to the given CardRangesType and assigns it to the Ranges field.
