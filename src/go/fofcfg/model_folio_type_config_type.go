...
type FolioTypeConfigType struct {
	...
	FolioReports *FolioReportsType `json:"folioReports,omitempty"`
...
// SetFolioReports gets a reference to the given FolioReportsType and assigns it to the FolioReports field.
