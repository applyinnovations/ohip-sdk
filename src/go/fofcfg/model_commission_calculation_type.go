...
type CommissionCalculationType struct {
	...
	RevenueBasedCommission *RevenueBasedCommissionType `json:"revenueBasedCommission,omitempty"`
}
...
func (o *CommissionCalculationType) GetRevenueBasedCommission() RevenueBasedCommissionType {
	if o == nil || IsNil(o.RevenueBasedCommission) {
		var ret RevenueBasedCommissionType
		return ret
	}
...
// SetRevenueBasedCommission gets a reference to the given RevenueBasedCommissionType and assigns it to the RevenueBasedCommission field.
