...
type PutCommissionCodesRequest struct {
	CommissionCodes *CommissionCodesType `json:"commissionCodes,omitempty"`
...
// SetCommissionCodes gets a reference to the given CommissionCodesType and assigns it to the CommissionCodes field.
