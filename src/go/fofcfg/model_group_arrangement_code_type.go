...
type GroupArrangementCodeType struct {
	...
	TransactionCodes *CodeListType `json:"transactionCodes,omitempty"`
}
...
// SetTransactionCodes gets a reference to the given CodeListType and assigns it to the TransactionCodes field.
