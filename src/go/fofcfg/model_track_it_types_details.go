...
func (o *TrackItTypesDetails) GetLinks() Links {
...
func (o *TrackItTypesDetails) GetLinksOk() (*Links, bool) {
	if o == nil || IsNil(o.Links) {
		return nil, false
	}
	return o.Links, true
...
func (o *TrackItTypesDetails) SetLinks(v Links) {
	o.Links = &v
}

// GetTrackItTypes returns the TrackItTypes field value if set, zero value otherwise.
func (o *TrackItTypesDetails) GetTrackItTypes() TrackItTypesConfigType {
...
// and a boolean to check if the value has been set.
func (o *TrackItTypesDetails) GetTrackItTypesOk() (*TrackItTypesConfigType, bool) {
	if o == nil || IsNil(o.TrackItTypes) {
		return nil, false
	}
...
func (o *TrackItTypesDetails) SetTrackItTypes(v TrackItTypesConfigType) {
	o.TrackItTypes = &v
}

// GetWarnings returns the Warnings field value if set, zero value otherwise.
func (o *TrackItTypesDetails) GetWarnings() WarningsType {
...
// and a boolean to check if the value has been set.
func (o *TrackItTypesDetails) GetWarningsOk() (*WarningsType, bool) {
	if o == nil || IsNil(o.Warnings) {
		return nil, false
	}
...
func (o *TrackItTypesDetails) SetWarnings(v WarningsType) {
	o.Warnings = &v
}
