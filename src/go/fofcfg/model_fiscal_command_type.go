...
type FiscalCommandType struct {
	...
	FiscalPartnerCodes *FiscalPartnerCodeListType `json:"fiscalPartnerCodes,omitempty"`
...
func (o *FiscalCommandType) GetFiscalPartnerCodes() FiscalPartnerCodeListType {
	if o == nil || IsNil(o.FiscalPartnerCodes) {
		var ret FiscalPartnerCodeListType
		return ret
	}
...
// SetFiscalPartnerCodes gets a reference to the given FiscalPartnerCodeListType and assigns it to the FiscalPartnerCodes field.
