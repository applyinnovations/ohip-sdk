...
type PutRevenueBucketTypesRequest struct {
	...
	RevenueBucketTypes *RevenueBucketTypesType `json:"revenueBucketTypes,omitempty"`
...
func (o *PutRevenueBucketTypesRequest) GetRevenueBucketTypes() RevenueBucketTypesType {
	if o == nil || IsNil(o.RevenueBucketTypes) {
		var ret RevenueBucketTypesType
		return ret
	}
...
// SetRevenueBucketTypes gets a reference to the given RevenueBucketTypesType and assigns it to the RevenueBucketTypes field.
