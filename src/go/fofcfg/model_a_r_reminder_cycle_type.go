...
type ARReminderCycleType struct {
	DaysCycle *ARDaysCycleType `json:"daysCycle,omitempty"`
...
// SetDaysCycle gets a reference to the given ARDaysCycleType and assigns it to the DaysCycle field.
