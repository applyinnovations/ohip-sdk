...
type PostAuthorizerGroupsRequest struct {
	AuthorizerGroups *AuthorizerGroupsType `json:"authorizerGroups,omitempty"`
...
// SetAuthorizerGroups gets a reference to the given AuthorizerGroupsType and assigns it to the AuthorizerGroups field.
