...
type CustomCodeTotalInformationType struct {
	ABVarianceTotalInfo *CustomVarianceInfoType `json:"aBVarianceTotalInfo,omitempty"`
	AFVarianceTotalInfo *CustomVarianceInfoType `json:"aFVarianceTotalInfo,omitempty"`
	...
	FBVarianceTotalInfo *CustomVarianceInfoType `json:"fBVarianceTotalInfo,omitempty"`
...
func (o *CustomCodeTotalInformationType) GetABVarianceTotalInfo() CustomVarianceInfoType {
	if o == nil || IsNil(o.ABVarianceTotalInfo) {
		var ret CustomVarianceInfoType
		return ret
	}
...
// SetABVarianceTotalInfo gets a reference to the given CustomVarianceInfoType and assigns it to the ABVarianceTotalInfo field.
...
// SetAFVarianceTotalInfo gets a reference to the given CustomVarianceInfoType and assigns it to the AFVarianceTotalInfo field.
...
// SetFBVarianceTotalInfo gets a reference to the given CustomVarianceInfoType and assigns it to the FBVarianceTotalInfo field.
