...
// checks if the ChangeTrackItActionsRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ChangeTrackItActionsRequest{}

// ChangeTrackItActionsRequest struct for ChangeTrackItActionsRequest
type ChangeTrackItActionsRequest struct {
...
func NewChangeTrackItActionsRequest() *ChangeTrackItActionsRequest {
	this := ChangeTrackItActionsRequest{}
	return &this
}
...
func (o ChangeTrackItActionsRequest) MarshalJSON() ([]byte, error) {
...
func (o ChangeTrackItActionsRequest) ToMap() (map[string]interface{}, error) {
...
type NullableChangeTrackItActionsRequest struct {
	value *ChangeTrackItActionsRequest
	isSet bool
}

func (v NullableChangeTrackItActionsRequest) Get() *ChangeTrackItActionsRequest {
	return v.value
}

func (v *NullableChangeTrackItActionsRequest) Set(val *ChangeTrackItActionsRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableChangeTrackItActionsRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableChangeTrackItActionsRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableChangeTrackItActionsRequest(val *ChangeTrackItActionsRequest) *NullableChangeTrackItActionsRequest {
	return &NullableChangeTrackItActionsRequest{value: val, isSet: true}
}

func (v NullableChangeTrackItActionsRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableChangeTrackItActionsRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
