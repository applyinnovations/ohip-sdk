...
type CustomCodeInformationType struct {
	ABVarianceInfo *CustomVarianceInfoType `json:"aBVarianceInfo,omitempty"`
	AFVarianceInfo *CustomVarianceInfoType `json:"aFVarianceInfo,omitempty"`
	...
	FBVarianceInfo *CustomVarianceInfoType `json:"fBVarianceInfo,omitempty"`
...
// SetABVarianceInfo gets a reference to the given CustomVarianceInfoType and assigns it to the ABVarianceInfo field.
...
// SetAFVarianceInfo gets a reference to the given CustomVarianceInfoType and assigns it to the AFVarianceInfo field.
...
// SetFBVarianceInfo gets a reference to the given CustomVarianceInfoType and assigns it to the FBVarianceInfo field.
