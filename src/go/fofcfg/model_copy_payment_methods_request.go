...
// checks if the CopyPaymentMethodsRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CopyPaymentMethodsRequest{}

// CopyPaymentMethodsRequest struct for CopyPaymentMethodsRequest
type CopyPaymentMethodsRequest struct {
...
func NewCopyPaymentMethodsRequest() *CopyPaymentMethodsRequest {
	this := CopyPaymentMethodsRequest{}
	return &this
}
...
func (o CopyPaymentMethodsRequest) MarshalJSON() ([]byte, error) {
...
func (o CopyPaymentMethodsRequest) ToMap() (map[string]interface{}, error) {
...
type NullableCopyPaymentMethodsRequest struct {
	value *CopyPaymentMethodsRequest
	isSet bool
}

func (v NullableCopyPaymentMethodsRequest) Get() *CopyPaymentMethodsRequest {
	return v.value
}

func (v *NullableCopyPaymentMethodsRequest) Set(val *CopyPaymentMethodsRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableCopyPaymentMethodsRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableCopyPaymentMethodsRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCopyPaymentMethodsRequest(val *CopyPaymentMethodsRequest) *NullableCopyPaymentMethodsRequest {
	return &NullableCopyPaymentMethodsRequest{value: val, isSet: true}
}

func (v NullableCopyPaymentMethodsRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCopyPaymentMethodsRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
