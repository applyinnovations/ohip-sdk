...
type CateringCodeInformationType struct {
	ABVarianceInfo *CateringVarianceInfoType `json:"aBVarianceInfo,omitempty"`
	AFVarianceInfo *CateringVarianceInfoType `json:"aFVarianceInfo,omitempty"`
	...
	FBVarianceInfo *CateringVarianceInfoType `json:"fBVarianceInfo,omitempty"`
...
// SetABVarianceInfo gets a reference to the given CateringVarianceInfoType and assigns it to the ABVarianceInfo field.
...
// SetAFVarianceInfo gets a reference to the given CateringVarianceInfoType and assigns it to the AFVarianceInfo field.
...
// SetFBVarianceInfo gets a reference to the given CateringVarianceInfoType and assigns it to the FBVarianceInfo field.
