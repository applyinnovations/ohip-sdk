...
type TransactionCodeAccessRoles struct {
	...
	TransactionAccessRoles *TrxCodeAccessRolesType `json:"transactionAccessRoles,omitempty"`
...
func (o *TransactionCodeAccessRoles) GetTransactionAccessRoles() TrxCodeAccessRolesType {
	if o == nil || IsNil(o.TransactionAccessRoles) {
		var ret TrxCodeAccessRolesType
		return ret
	}
...
// SetTransactionAccessRoles gets a reference to the given TrxCodeAccessRolesType and assigns it to the TransactionAccessRoles field.
