...
type PutDailyPlanCodesRequest struct {
	DailyPlanCodes *DailyPlanCodesType `json:"dailyPlanCodes,omitempty"`
...
// SetDailyPlanCodes gets a reference to the given DailyPlanCodesType and assigns it to the DailyPlanCodes field.
