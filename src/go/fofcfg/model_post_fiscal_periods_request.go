...
// checks if the PostFiscalPeriodsRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PostFiscalPeriodsRequest{}

// PostFiscalPeriodsRequest struct for PostFiscalPeriodsRequest
type PostFiscalPeriodsRequest struct {
...
func (o PostFiscalPeriodsRequest) MarshalJSON() ([]byte, error) {
...
func (o PostFiscalPeriodsRequest) ToMap() (map[string]interface{}, error) {
...
type NullablePostFiscalPeriodsRequest struct {
	value *PostFiscalPeriodsRequest
	isSet bool
}

func (v NullablePostFiscalPeriodsRequest) Get() *PostFiscalPeriodsRequest {
	return v.value
}

func (v *NullablePostFiscalPeriodsRequest) Set(val *PostFiscalPeriodsRequest) {
	v.value = val
	v.isSet = true
}

func (v NullablePostFiscalPeriodsRequest) IsSet() bool {
	return v.isSet
}

func (v *NullablePostFiscalPeriodsRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePostFiscalPeriodsRequest(val *PostFiscalPeriodsRequest) *NullablePostFiscalPeriodsRequest {
	return &NullablePostFiscalPeriodsRequest{value: val, isSet: true}
}

func (v NullablePostFiscalPeriodsRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePostFiscalPeriodsRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
