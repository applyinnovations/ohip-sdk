...
type PutARAccountTypesRequest struct {
	AccountTypes *ARAccountTypesType `json:"accountTypes,omitempty"`
...
// SetAccountTypes gets a reference to the given ARAccountTypesType and assigns it to the AccountTypes field.
