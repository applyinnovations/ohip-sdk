...
type RateCodeInformationType struct {
	ABVarianceInfo *RevenueNightsVarianceInfoType `json:"aBVarianceInfo,omitempty"`
	AFVarianceInfo *RevenueNightsVarianceInfoType `json:"aFVarianceInfo,omitempty"`
	...
	FBVarianceInfo *RevenueNightsVarianceInfoType `json:"fBVarianceInfo,omitempty"`
...
// SetABVarianceInfo gets a reference to the given RevenueNightsVarianceInfoType and assigns it to the ABVarianceInfo field.
...
// SetAFVarianceInfo gets a reference to the given RevenueNightsVarianceInfoType and assigns it to the AFVarianceInfo field.
...
// SetFBVarianceInfo gets a reference to the given RevenueNightsVarianceInfoType and assigns it to the FBVarianceInfo field.
