...
type CollectingAgentTaxType struct {
	...
	NewTaxType *CodeListType `json:"newTaxType,omitempty"`
	...
	TaxType *CodeListType `json:"taxType,omitempty"`
	// Primary Key Sequence.
...
// SetNewTaxType gets a reference to the given CodeListType and assigns it to the NewTaxType field.
...
// SetTaxType gets a reference to the given CodeListType and assigns it to the TaxType field.
