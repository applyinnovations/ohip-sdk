...
type FiscalPeriodsCycleFiscalPeriods struct {
	CycleFiscalPeriods *CycleFiscalPeriodsType `json:"cycleFiscalPeriods,omitempty"`
...
func (o *FiscalPeriodsCycleFiscalPeriods) GetCycleFiscalPeriods() CycleFiscalPeriodsType {
	if o == nil || IsNil(o.CycleFiscalPeriods) {
		var ret CycleFiscalPeriodsType
		return ret
	}
...
// SetCycleFiscalPeriods gets a reference to the given CycleFiscalPeriodsType and assigns it to the CycleFiscalPeriods field.
