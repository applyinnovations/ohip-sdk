...
type FiscalPartnerType struct {
	...
	PaymentTypes *CodeListType `json:"paymentTypes,omitempty"`
...
// SetPaymentTypes gets a reference to the given CodeListType and assigns it to the PaymentTypes field.
