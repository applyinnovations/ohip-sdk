...
// checks if the UpdateInterfaceCustomDataRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UpdateInterfaceCustomDataRequest{}

// UpdateInterfaceCustomDataRequest struct for UpdateInterfaceCustomDataRequest
type UpdateInterfaceCustomDataRequest struct {
...
func NewUpdateInterfaceCustomDataRequest() *UpdateInterfaceCustomDataRequest {
	this := UpdateInterfaceCustomDataRequest{}
	return &this
}
...
func (o UpdateInterfaceCustomDataRequest) MarshalJSON() ([]byte, error) {
...
func (o UpdateInterfaceCustomDataRequest) ToMap() (map[string]interface{}, error) {
...
type NullableUpdateInterfaceCustomDataRequest struct {
	value *UpdateInterfaceCustomDataRequest
	isSet bool
}

func (v NullableUpdateInterfaceCustomDataRequest) Get() *UpdateInterfaceCustomDataRequest {
	return v.value
}

func (v *NullableUpdateInterfaceCustomDataRequest) Set(val *UpdateInterfaceCustomDataRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableUpdateInterfaceCustomDataRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableUpdateInterfaceCustomDataRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUpdateInterfaceCustomDataRequest(val *UpdateInterfaceCustomDataRequest) *NullableUpdateInterfaceCustomDataRequest {
	return &NullableUpdateInterfaceCustomDataRequest{value: val, isSet: true}
}

func (v NullableUpdateInterfaceCustomDataRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUpdateInterfaceCustomDataRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
