...
// checks if the PostCustomNumberConfigRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PostCustomNumberConfigRequest{}

// PostCustomNumberConfigRequest struct for PostCustomNumberConfigRequest
type PostCustomNumberConfigRequest struct {
...
func NewPostCustomNumberConfigRequest() *PostCustomNumberConfigRequest {
	this := PostCustomNumberConfigRequest{}
	return &this
}
...
func (o PostCustomNumberConfigRequest) MarshalJSON() ([]byte, error) {
...
func (o PostCustomNumberConfigRequest) ToMap() (map[string]interface{}, error) {
...
type NullablePostCustomNumberConfigRequest struct {
	value *PostCustomNumberConfigRequest
	isSet bool
}

func (v NullablePostCustomNumberConfigRequest) Get() *PostCustomNumberConfigRequest {
	return v.value
}

func (v *NullablePostCustomNumberConfigRequest) Set(val *PostCustomNumberConfigRequest) {
	v.value = val
	v.isSet = true
}

func (v NullablePostCustomNumberConfigRequest) IsSet() bool {
	return v.isSet
}

func (v *NullablePostCustomNumberConfigRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePostCustomNumberConfigRequest(val *PostCustomNumberConfigRequest) *NullablePostCustomNumberConfigRequest {
	return &NullablePostCustomNumberConfigRequest{value: val, isSet: true}
}

func (v NullablePostCustomNumberConfigRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePostCustomNumberConfigRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
