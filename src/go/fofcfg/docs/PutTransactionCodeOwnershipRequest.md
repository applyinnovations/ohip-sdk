...
`func (o *PutTransactionCodeOwnershipRequest) GetLinks() Links`

GetLinks returns the Links field if non-nil, zero value otherwise.

### GetLinksOk

`func (o *PutTransactionCodeOwnershipRequest) GetLinksOk() (*Links, bool)`
...
`func (o *PutTransactionCodeOwnershipRequest) SetLinks(v Links)`
...
`func (o *PutTransactionCodeOwnershipRequest) GetWarnings() WarningsType`

GetWarnings returns the Warnings field if non-nil, zero value otherwise.

### GetWarningsOk

`func (o *PutTransactionCodeOwnershipRequest) GetWarningsOk() (*WarningsType, bool)`
...
`func (o *PutTransactionCodeOwnershipRequest) SetWarnings(v WarningsType)`
