...
`func (o *RevenueBucketCodes) GetLinks() Links`

GetLinks returns the Links field if non-nil, zero value otherwise.

### GetLinksOk

`func (o *RevenueBucketCodes) GetLinksOk() (*Links, bool)`
...
`func (o *RevenueBucketCodes) SetLinks(v Links)`
...
`func (o *RevenueBucketCodes) GetRevenueBucketCodes() RevenueBucketCodesType`

GetRevenueBucketCodes returns the RevenueBucketCodes field if non-nil, zero value otherwise.

### GetRevenueBucketCodesOk

`func (o *RevenueBucketCodes) GetRevenueBucketCodesOk() (*RevenueBucketCodesType, bool)`
...
`func (o *RevenueBucketCodes) SetRevenueBucketCodes(v RevenueBucketCodesType)`
...
`func (o *RevenueBucketCodes) GetWarnings() WarningsType`

GetWarnings returns the Warnings field if non-nil, zero value otherwise.

### GetWarningsOk

`func (o *RevenueBucketCodes) GetWarningsOk() (*WarningsType, bool)`
...
`func (o *RevenueBucketCodes) SetWarnings(v WarningsType)`
