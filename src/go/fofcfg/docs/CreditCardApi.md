...
func main() {
    ...
    xAppKey := "xAppKey_example" // string | Client or Partner's Application Key
    xHotelid := "xHotelid_example" // string | Mandatory parameter to identify the hotel code where the end user is logged in
    creditCardUniqueIdRQ := *openapiclient.NewGetCreditCardUniqueIdRequest() // GetCreditCardUniqueIdRequest | Request for fetching credit card unique id.
    xExternalsystem := "EXTERNALSYSTEMCODE" // string | External system code. (optional)
    acceptLanguage := "acceptLanguage_example" // string | Language code (optional)
 ...
 **xAppKey** | **string** | Client or Partner&#39;s Application Key | 
 **xHotelid** | **string** | Mandatory parameter to identify the hotel code where the end user is logged in | 
 **creditCardUniqueIdRQ** | [**GetCreditCardUniqueIdRequest**](GetCreditCardUniqueIdRequest.md) | Request for fetching credit card unique id. | 
 **xExternalsystem** | **string** | External system code. | 
 **acceptLanguage** | **string** | Language code | 
...
func main() {
    ...
    xAppKey := "xAppKey_example" // string | Client or Partner's Application Key
    xHotelid := "xHotelid_example" // string | Mandatory parameter to identify the hotel code where the end user is logged in
    applicationSecureSetting := *openapiclient.NewPutSecureApplicationSettingsRequest() // PutSecureApplicationSettingsRequest | Request for reading the configured device delimiters.
    xExternalsystem := "EXTERNALSYSTEMCODE" // string | External system code. (optional)
    acceptLanguage := "acceptLanguage_example" // string | Language code (optional)
 ...
 **xAppKey** | **string** | Client or Partner&#39;s Application Key | 
 **xHotelid** | **string** | Mandatory parameter to identify the hotel code where the end user is logged in | 
 **applicationSecureSetting** | [**PutSecureApplicationSettingsRequest**](PutSecureApplicationSettingsRequest.md) | Request for reading the configured device delimiters. | 
 **xExternalsystem** | **string** | External system code. | 
 **acceptLanguage** | **string** | Language code | 
...
func main() {
    ...
    xAppKey := "xAppKey_example" // string | Client or Partner's Application Key
    xHotelid := "xHotelid_example" // string | Mandatory parameter to identify the hotel code where the end user is logged in
    hotelInterfaceDetail := *openapiclient.NewUpdateInterfaceCustomDataRequest() // UpdateInterfaceCustomDataRequest | Request object for updating a Hotel Interface.
    xExternalsystem := "EXTERNALSYSTEMCODE" // string | External system code. (optional)
    acceptLanguage := "acceptLanguage_example" // string | Language code (optional)
 ...
 **xAppKey** | **string** | Client or Partner&#39;s Application Key | 
 **xHotelid** | **string** | Mandatory parameter to identify the hotel code where the end user is logged in | 
 **hotelInterfaceDetail** | [**UpdateInterfaceCustomDataRequest**](UpdateInterfaceCustomDataRequest.md) | Request object for updating a Hotel Interface. | 
 **xExternalsystem** | **string** | External system code. | 
 **acceptLanguage** | **string** | Language code | 
...
func main() {
    ...
    emailFolioInfoCreateDateTime := "emailFolioInfoCreateDateTime_example" // string | Time stamp of the creation. (optional)
    ...
    emailFolioInfoLastModifyDateTime := "emailFolioInfoLastModifyDateTime_example" // string | Time stamp of last modification. (optional)
