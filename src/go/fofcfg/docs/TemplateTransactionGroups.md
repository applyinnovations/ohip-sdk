...
`func (o *TemplateTransactionGroups) GetLinks() Links`

GetLinks returns the Links field if non-nil, zero value otherwise.

### GetLinksOk

`func (o *TemplateTransactionGroups) GetLinksOk() (*Links, bool)`
...
`func (o *TemplateTransactionGroups) SetLinks(v Links)`
...
`func (o *TemplateTransactionGroups) GetTransactionGroups() TemplateTransactionGroupsType`

GetTransactionGroups returns the TransactionGroups field if non-nil, zero value otherwise.

### GetTransactionGroupsOk

`func (o *TemplateTransactionGroups) GetTransactionGroupsOk() (*TemplateTransactionGroupsType, bool)`
...
`func (o *TemplateTransactionGroups) SetTransactionGroups(v TemplateTransactionGroupsType)`
...
`func (o *TemplateTransactionGroups) GetWarnings() WarningsType`

GetWarnings returns the Warnings field if non-nil, zero value otherwise.

### GetWarningsOk

`func (o *TemplateTransactionGroups) GetWarningsOk() (*WarningsType, bool)`
...
`func (o *TemplateTransactionGroups) SetWarnings(v WarningsType)`
