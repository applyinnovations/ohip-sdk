...
type PutFiscalFolioParametersRequest struct {
	FiscalFolioParameters *FiscalFolioParametersType `json:"fiscalFolioParameters,omitempty"`
...
func (o *PutFiscalFolioParametersRequest) GetFiscalFolioParameters() FiscalFolioParametersType {
	if o == nil || IsNil(o.FiscalFolioParameters) {
		var ret FiscalFolioParametersType
		return ret
	}
...
// SetFiscalFolioParameters gets a reference to the given FiscalFolioParametersType and assigns it to the FiscalFolioParameters field.
