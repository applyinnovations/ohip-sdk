...
type FolioPrintQueues struct {
	FolioPrintQueues *FolioPrintQueuesType `json:"folioPrintQueues,omitempty"`
...
// SetFolioPrintQueues gets a reference to the given FolioPrintQueuesType and assigns it to the FolioPrintQueues field.
