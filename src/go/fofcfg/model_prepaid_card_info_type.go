...
type PrepaidCardInfoType struct {
	...
	PrepaidCardTransactions *PrepaidCardTransactionsType `json:"prepaidCardTransactions,omitempty"`
...
func (o *PrepaidCardInfoType) GetPrepaidCardTransactions() PrepaidCardTransactionsType {
	if o == nil || IsNil(o.PrepaidCardTransactions) {
		var ret PrepaidCardTransactionsType
		return ret
	}
...
// SetPrepaidCardTransactions gets a reference to the given PrepaidCardTransactionsType and assigns it to the PrepaidCardTransactions field.
