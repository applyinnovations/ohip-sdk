...
type ActivityDetailsType struct {
	...
	Indicators *IndicatorsType `json:"indicators,omitempty"`
	...
	LinkedAttachments *AttachmentsType `json:"linkedAttachments,omitempty"`
	LinkedBlocks *BlockListType `json:"linkedBlocks,omitempty"`
...
// SetIndicators gets a reference to the given IndicatorsType and assigns it to the Indicators field.
...
// SetLinkedAttachments gets a reference to the given AttachmentsType and assigns it to the LinkedAttachments field.
...
// SetLinkedBlocks gets a reference to the given BlockListType and assigns it to the LinkedBlocks field.
