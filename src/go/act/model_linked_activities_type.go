...
type LinkedActivitiesType struct {
	...
	OwnerCodeList *CodeListType `json:"ownerCodeList,omitempty"`
}
...
// SetOwnerCodeList gets a reference to the given CodeListType and assigns it to the OwnerCodeList field.
