...
// checks if the ActivitiesInfo type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ActivitiesInfo{}

// ActivitiesInfo struct for ActivitiesInfo
...
func (o ActivitiesInfo) MarshalJSON() ([]byte, error) {
...
func (o ActivitiesInfo) ToMap() (map[string]interface{}, error) {
...
type NullableActivitiesInfo struct {
	value *ActivitiesInfo
	isSet bool
}

func (v NullableActivitiesInfo) Get() *ActivitiesInfo {
	return v.value
}

func (v *NullableActivitiesInfo) Set(val *ActivitiesInfo) {
	v.value = val
	v.isSet = true
}

func (v NullableActivitiesInfo) IsSet() bool {
	return v.isSet
}

func (v *NullableActivitiesInfo) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableActivitiesInfo(val *ActivitiesInfo) *NullableActivitiesInfo {
	return &NullableActivitiesInfo{value: val, isSet: true}
}

func (v NullableActivitiesInfo) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableActivitiesInfo) UnmarshalJSON(src []byte) error {
	v.isSet = true
