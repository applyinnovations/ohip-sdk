...
**ActivityIdList** | Pointer to [**ActivityIdListType**](ActivityIdListType.md) |  | [optional] 
...
`func (o *RecentlyAccessedActivityType) GetActivityIdList() ActivityIdListType`

GetActivityIdList returns the ActivityIdList field if non-nil, zero value otherwise.

### GetActivityIdListOk

`func (o *RecentlyAccessedActivityType) GetActivityIdListOk() (*ActivityIdListType, bool)`
...
`func (o *RecentlyAccessedActivityType) SetActivityIdList(v ActivityIdListType)`
