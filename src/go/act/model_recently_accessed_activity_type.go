...
type RecentlyAccessedActivityType struct {
	...
	ActivityIdList *ActivityIdListType `json:"activityIdList,omitempty"`
...
// SetActivityIdList gets a reference to the given ActivityIdListType and assigns it to the ActivityIdList field.
