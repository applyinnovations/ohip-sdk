...
type NewBlockDetailsType struct {
	...
	GridCategory *CodeListType `json:"gridCategory,omitempty"`
...
// SetGridCategory gets a reference to the given CodeListType and assigns it to the GridCategory field.
