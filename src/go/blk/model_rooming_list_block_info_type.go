...
func (o *RoomingListBlockInfoType) GetBlockIdList() BlockIdList {
...
func (o *RoomingListBlockInfoType) GetBlockIdListOk() (*BlockIdList, bool) {
	if o == nil || IsNil(o.BlockIdList) {
		return nil, false
	}
...
func (o *RoomingListBlockInfoType) SetBlockIdList(v BlockIdList) {
	o.BlockIdList = &v
}
