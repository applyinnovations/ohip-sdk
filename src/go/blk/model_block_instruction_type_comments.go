...
// checks if the BlockInstructionTypeComments type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BlockInstructionTypeComments{}

// BlockInstructionTypeComments List of notes for the Block.
type BlockInstructionTypeComments struct {
...
func NewBlockInstructionTypeComments() *BlockInstructionTypeComments {
	this := BlockInstructionTypeComments{}
	return &this
}
...
func (o BlockInstructionTypeComments) MarshalJSON() ([]byte, error) {
...
func (o BlockInstructionTypeComments) ToMap() (map[string]interface{}, error) {
...
type NullableBlockInstructionTypeComments struct {
	value *BlockInstructionTypeComments
	isSet bool
}

func (v NullableBlockInstructionTypeComments) Get() *BlockInstructionTypeComments {
	return v.value
}

func (v *NullableBlockInstructionTypeComments) Set(val *BlockInstructionTypeComments) {
	v.value = val
	v.isSet = true
}

func (v NullableBlockInstructionTypeComments) IsSet() bool {
	return v.isSet
}

func (v *NullableBlockInstructionTypeComments) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBlockInstructionTypeComments(val *BlockInstructionTypeComments) *NullableBlockInstructionTypeComments {
	return &NullableBlockInstructionTypeComments{value: val, isSet: true}
}

func (v NullableBlockInstructionTypeComments) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBlockInstructionTypeComments) UnmarshalJSON(src []byte) error {
	v.isSet = true
