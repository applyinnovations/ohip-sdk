...
type CodeInfoType struct {
	AddtionalCodeInfo *AddtionalCodeInfoType `json:"addtionalCodeInfo,omitempty"`
...
// SetAddtionalCodeInfo gets a reference to the given AddtionalCodeInfoType and assigns it to the AddtionalCodeInfo field.
