...
type SalesAllowances struct {
	...
	SalesAllowances *SalesAllowancesType `json:"salesAllowances,omitempty"`
...
// SetSalesAllowances gets a reference to the given SalesAllowancesType and assigns it to the SalesAllowances field.
