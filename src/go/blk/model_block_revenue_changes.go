...
type BlockRevenueChanges struct {
	BlockRevenueChanges *BlockRevenueChangesDetailsType `json:"blockRevenueChanges,omitempty"`
...
func (o *BlockRevenueChanges) GetBlockRevenueChanges() BlockRevenueChangesDetailsType {
	if o == nil || IsNil(o.BlockRevenueChanges) {
		var ret BlockRevenueChangesDetailsType
		return ret
	}
...
// SetBlockRevenueChanges gets a reference to the given BlockRevenueChangesDetailsType and assigns it to the BlockRevenueChanges field.
