...
`func (o *StatisticsRoomTypeInfoType) GetRoomFeatures() RoomFeaturesType`

GetRoomFeatures returns the RoomFeatures field if non-nil, zero value otherwise.

### GetRoomFeaturesOk

`func (o *StatisticsRoomTypeInfoType) GetRoomFeaturesOk() (*RoomFeaturesType, bool)`
...
`func (o *StatisticsRoomTypeInfoType) SetRoomFeatures(v RoomFeaturesType)`
