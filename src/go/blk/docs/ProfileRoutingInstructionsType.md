...
`func (o *ProfileRoutingInstructionsType) GetBillingInstructions() BillingInstructionsType`

GetBillingInstructions returns the BillingInstructions field if non-nil, zero value otherwise.

### GetBillingInstructionsOk

`func (o *ProfileRoutingInstructionsType) GetBillingInstructionsOk() (*BillingInstructionsType, bool)`
...
`func (o *ProfileRoutingInstructionsType) SetBillingInstructions(v BillingInstructionsType)`
...
`func (o *ProfileRoutingInstructionsType) GetTransactionCodes() TrxCodesInfoType`

GetTransactionCodes returns the TransactionCodes field if non-nil, zero value otherwise.

### GetTransactionCodesOk

`func (o *ProfileRoutingInstructionsType) GetTransactionCodesOk() (*TrxCodesInfoType, bool)`
...
`func (o *ProfileRoutingInstructionsType) SetTransactionCodes(v TrxCodesInfoType)`
