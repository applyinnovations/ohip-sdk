...
**AlternateFullName** | Pointer to **string** | Altername full display name | [optional] 
...
`func (o *ResGuestInfoType) GetWarnings() WarningsType`

GetWarnings returns the Warnings field if non-nil, zero value otherwise.

### GetWarningsOk

`func (o *ResGuestInfoType) GetWarningsOk() (*WarningsType, bool)`
...
`func (o *ResGuestInfoType) SetWarnings(v WarningsType)`
