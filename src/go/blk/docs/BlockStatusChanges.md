...
------------ | ------------- | ------------- | -------------
**BlockStatusChanges** | Pointer to [**BlockStatusChangesDetailsType**](BlockStatusChangesDetailsType.md) |  | [optional] 
...
`func (o *BlockStatusChanges) GetBlockStatusChanges() BlockStatusChangesDetailsType`

GetBlockStatusChanges returns the BlockStatusChanges field if non-nil, zero value otherwise.

### GetBlockStatusChangesOk

`func (o *BlockStatusChanges) GetBlockStatusChangesOk() (*BlockStatusChangesDetailsType, bool)`
...
`func (o *BlockStatusChanges) SetBlockStatusChanges(v BlockStatusChangesDetailsType)`
...
`func (o *BlockStatusChanges) GetLinks() Links`

GetLinks returns the Links field if non-nil, zero value otherwise.

### GetLinksOk

`func (o *BlockStatusChanges) GetLinksOk() (*Links, bool)`
...
`func (o *BlockStatusChanges) SetLinks(v Links)`
...
`func (o *BlockStatusChanges) GetWarnings() WarningsType`

GetWarnings returns the Warnings field if non-nil, zero value otherwise.

### GetWarningsOk

`func (o *BlockStatusChanges) GetWarningsOk() (*WarningsType, bool)`
...
`func (o *BlockStatusChanges) SetWarnings(v WarningsType)`
