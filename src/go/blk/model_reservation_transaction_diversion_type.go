...
type ReservationTransactionDiversionType struct {
	...
	DailyDetails *TransactionDiversionDailyDetailsType `json:"dailyDetails,omitempty"`
...
func (o *ReservationTransactionDiversionType) GetDailyDetails() TransactionDiversionDailyDetailsType {
	if o == nil || IsNil(o.DailyDetails) {
		var ret TransactionDiversionDailyDetailsType
		return ret
	}
...
// SetDailyDetails gets a reference to the given TransactionDiversionDailyDetailsType and assigns it to the DailyDetails field.
