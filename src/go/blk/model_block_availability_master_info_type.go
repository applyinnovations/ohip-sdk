...
type BlockAvailabilityMasterInfoType struct {
	...
	MasterRoomTypes *CodeListType `json:"masterRoomTypes,omitempty"`
...
// SetMasterRoomTypes gets a reference to the given CodeListType and assigns it to the MasterRoomTypes field.
