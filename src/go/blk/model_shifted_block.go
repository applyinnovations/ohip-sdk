...
func (o *ShiftedBlock) GetCateringEventsProcessedInfo() CateringEventsProcessedInfoList {
...
func (o *ShiftedBlock) GetCateringEventsProcessedInfoOk() (*CateringEventsProcessedInfoList, bool) {
	if o == nil || IsNil(o.CateringEventsProcessedInfo) {
		return nil, false
	}
...
func (o *ShiftedBlock) SetCateringEventsProcessedInfo(v CateringEventsProcessedInfoList) {
	o.CateringEventsProcessedInfo = &v
}

// GetLinks returns the Links field value if set, zero value otherwise.
func (o *ShiftedBlock) GetLinks() Links {
...
// and a boolean to check if the value has been set.
func (o *ShiftedBlock) GetLinksOk() (*Links, bool) {
	if o == nil || IsNil(o.Links) {
		return nil, false
	}
	return o.Links, true
...
func (o *ShiftedBlock) SetLinks(v Links) {
	o.Links = &v
}

// GetWarnings returns the Warnings field value if set, zero value otherwise.
func (o *ShiftedBlock) GetWarnings() WarningsType {
...
// and a boolean to check if the value has been set.
func (o *ShiftedBlock) GetWarningsOk() (*WarningsType, bool) {
	if o == nil || IsNil(o.Warnings) {
		return nil, false
	}
...
func (o *ShiftedBlock) SetWarnings(v WarningsType) {
	o.Warnings = &v
}
