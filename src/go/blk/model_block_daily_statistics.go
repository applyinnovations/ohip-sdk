...
type BlockDailyStatistics struct {
	BlockDailyStatistics *BlocksDailyStatisticsType `json:"blockDailyStatistics,omitempty"`
...
func (o *BlockDailyStatistics) GetBlockDailyStatistics() BlocksDailyStatisticsType {
	if o == nil || IsNil(o.BlockDailyStatistics) {
		var ret BlocksDailyStatisticsType
		return ret
	}
...
// SetBlockDailyStatistics gets a reference to the given BlocksDailyStatisticsType and assigns it to the BlockDailyStatistics field.
