...
type BlocksDailyStatisticsTypeInner struct {
	...
	StayDates []BlockDailyStatisticsDatesType `json:"stayDates,omitempty"`
...
func (o *BlocksDailyStatisticsTypeInner) GetStayDates() []BlockDailyStatisticsDatesType {
	if o == nil || IsNil(o.StayDates) {
		var ret []BlockDailyStatisticsDatesType
		return ret
	}
	return o.StayDates
}
...
// SetStayDates gets a reference to the given []BlockDailyStatisticsDatesType and assigns it to the StayDates field.
