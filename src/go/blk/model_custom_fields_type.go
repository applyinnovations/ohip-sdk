...
type CustomFieldsType struct {
	CustomCharUDFs *CustomCharUDFsType `json:"customCharUDFs,omitempty"`
	CustomDateUDFs *CustomDateUDFsType `json:"customDateUDFs,omitempty"`
	CustomNumericUDFs *CustomNumericUDFsType `json:"customNumericUDFs,omitempty"`
}
...
// SetCustomCharUDFs gets a reference to the given CustomCharUDFsType and assigns it to the CustomCharUDFs field.
...
// SetCustomDateUDFs gets a reference to the given CustomDateUDFsType and assigns it to the CustomDateUDFs field.
...
// SetCustomNumericUDFs gets a reference to the given CustomNumericUDFsType and assigns it to the CustomNumericUDFs field.
