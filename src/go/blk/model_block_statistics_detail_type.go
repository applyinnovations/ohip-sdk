...
type BlockStatisticsDetailType struct {
	...
	StatisticsDates []BlockStatisticsDatesType `json:"statisticsDates,omitempty"`
}
...
func (o *BlockStatisticsDetailType) GetStatisticsDates() []BlockStatisticsDatesType {
	if o == nil || IsNil(o.StatisticsDates) {
		var ret []BlockStatisticsDatesType
		return ret
	}
...
// SetStatisticsDates gets a reference to the given []BlockStatisticsDatesType and assigns it to the StatisticsDates field.
