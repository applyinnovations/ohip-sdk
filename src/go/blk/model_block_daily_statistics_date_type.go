...
type BlockDailyStatisticsDateType struct {
	...
	GenericRoomTypeStatisticsList *BlockDailyRoomStatisticsListType `json:"genericRoomTypeStatisticsList,omitempty"`
	RoomTypeStatisticsList *BlockDailyRoomStatisticsListType `json:"roomTypeStatisticsList,omitempty"`
}
...
func (o *BlockDailyStatisticsDateType) GetGenericRoomTypeStatisticsList() BlockDailyRoomStatisticsListType {
	if o == nil || IsNil(o.GenericRoomTypeStatisticsList) {
		var ret BlockDailyRoomStatisticsListType
		return ret
	}
...
// SetGenericRoomTypeStatisticsList gets a reference to the given BlockDailyRoomStatisticsListType and assigns it to the GenericRoomTypeStatisticsList field.
...
// SetRoomTypeStatisticsList gets a reference to the given BlockDailyRoomStatisticsListType and assigns it to the RoomTypeStatisticsList field.
