...
type HotelUseType struct {
	AccessRestrictions *AccessRestrictionsType `json:"accessRestrictions,omitempty"`
...
func (o *HotelUseType) GetAccessRestrictions() AccessRestrictionsType {
	if o == nil || IsNil(o.AccessRestrictions) {
		var ret AccessRestrictionsType
		return ret
	}
...
// SetAccessRestrictions gets a reference to the given AccessRestrictionsType and assigns it to the AccessRestrictions field.
