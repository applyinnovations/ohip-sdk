...
type BlockStatusChanges struct {
	BlockStatusChanges *BlockStatusChangesDetailsType `json:"blockStatusChanges,omitempty"`
...
func (o *BlockStatusChanges) GetBlockStatusChanges() BlockStatusChangesDetailsType {
	if o == nil || IsNil(o.BlockStatusChanges) {
		var ret BlockStatusChangesDetailsType
		return ret
	}
...
// SetBlockStatusChanges gets a reference to the given BlockStatusChangesDetailsType and assigns it to the BlockStatusChanges field.
