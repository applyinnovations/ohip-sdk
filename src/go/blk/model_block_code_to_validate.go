...
func (o *BlockCodeToValidate) GetBlockIdList() BlockIdList {
...
func (o *BlockCodeToValidate) GetBlockIdListOk() (*BlockIdList, bool) {
	if o == nil || IsNil(o.BlockIdList) {
		return nil, false
	}
...
func (o *BlockCodeToValidate) SetBlockIdList(v BlockIdList) {
	o.BlockIdList = &v
}
...
func (o *BlockCodeToValidate) GetLinks() Links {
...
// and a boolean to check if the value has been set.
func (o *BlockCodeToValidate) GetLinksOk() (*Links, bool) {
	if o == nil || IsNil(o.Links) {
		return nil, false
	}
	return o.Links, true
...
func (o *BlockCodeToValidate) SetLinks(v Links) {
	o.Links = &v
}
...
func (o *BlockCodeToValidate) GetWarnings() WarningsType {
...
// and a boolean to check if the value has been set.
func (o *BlockCodeToValidate) GetWarningsOk() (*WarningsType, bool) {
	if o == nil || IsNil(o.Warnings) {
		return nil, false
	}
...
func (o *BlockCodeToValidate) SetWarnings(v WarningsType) {
	o.Warnings = &v
}
