...
type MasterBlockInfoType struct {
	...
	MasterSubHotels []HotelCodeListType `json:"masterSubHotels,omitempty"`
...
// SetMasterSubHotels gets a reference to the given []HotelCodeListType and assigns it to the MasterSubHotels field.
