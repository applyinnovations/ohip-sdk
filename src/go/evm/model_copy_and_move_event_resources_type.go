...
type CopyAndMoveEventResourcesType struct {
	...
	ResourceIdList *ResourceCopyAndMoveListType `json:"resourceIdList,omitempty"`
	TargetBlockId *UniqueIDType `json:"targetBlockId,omitempty"`
	TargetEventIdList *UniqueIDListType `json:"targetEventIdList,omitempty"`
}
...
func (o *CopyAndMoveEventResourcesType) GetResourceIdList() ResourceCopyAndMoveListType {
	if o == nil || IsNil(o.ResourceIdList) {
		var ret ResourceCopyAndMoveListType
		return ret
	}
...
// SetResourceIdList gets a reference to the given ResourceCopyAndMoveListType and assigns it to the ResourceIdList field.
...
// SetTargetEventIdList gets a reference to the given UniqueIDListType and assigns it to the TargetEventIdList field.
