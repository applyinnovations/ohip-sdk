...
type CateringEventChangeInfoType struct {
	...
	EventChangeDetailList *CateringEventChangeDetailListType `json:"eventChangeDetailList,omitempty"`
...
func (o *CateringEventChangeInfoType) GetEventChangeDetailList() CateringEventChangeDetailListType {
	if o == nil || IsNil(o.EventChangeDetailList) {
		var ret CateringEventChangeDetailListType
		return ret
	}
...
// SetEventChangeDetailList gets a reference to the given CateringEventChangeDetailListType and assigns it to the EventChangeDetailList field.
