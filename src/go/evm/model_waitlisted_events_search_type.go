...
type WaitlistedEventsSearchType struct {
	...
	FunctionSpaceCode *CodeListType `json:"functionSpaceCode,omitempty"`
...
// SetFunctionSpaceCode gets a reference to the given CodeListType and assigns it to the FunctionSpaceCode field.
