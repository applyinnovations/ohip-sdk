...
type NameValueDetailType struct {
	NameValues *NameValuesType `json:"nameValues,omitempty"`
}
...
// SetNameValues gets a reference to the given NameValuesType and assigns it to the NameValues field.
