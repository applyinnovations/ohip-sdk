...
type ManageAlternateEvents struct {
	AlternateEvents *EventsInfoType `json:"alternateEvents,omitempty"`
...
// SetAlternateEvents gets a reference to the given EventsInfoType and assigns it to the AlternateEvents field.
