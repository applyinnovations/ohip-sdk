...
type ServiceRequest struct {
	...
	FunctionSpaceDetails *string `json:"functionSpaceDetails,omitempty"`
...
// SetFunctionSpaceDetails gets a reference to the given string and assigns it to the FunctionSpaceDetails field.
