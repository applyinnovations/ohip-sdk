...
type CurrentRoomInfoType struct {
	...
	SuggestedRoomNumbers *CodeListType `json:"suggestedRoomNumbers,omitempty"`
...
// SetSuggestedRoomNumbers gets a reference to the given CodeListType and assigns it to the SuggestedRoomNumbers field.
