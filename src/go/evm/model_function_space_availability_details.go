...
type FunctionSpaceAvailabilityDetails struct {
	FunctionSpacesAvailability *FunctionSpacesAvailabilityType `json:"functionSpacesAvailability,omitempty"`
...
func (o *FunctionSpaceAvailabilityDetails) GetFunctionSpacesAvailability() FunctionSpacesAvailabilityType {
	if o == nil || IsNil(o.FunctionSpacesAvailability) {
		var ret FunctionSpacesAvailabilityType
		return ret
	}
...
// SetFunctionSpacesAvailability gets a reference to the given FunctionSpacesAvailabilityType and assigns it to the FunctionSpacesAvailability field.
