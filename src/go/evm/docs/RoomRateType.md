...
**InventoryLender** | Pointer to **string** | Indicates whether the functionSpaceDetails type inventory was taken from the allotment or House availability. | [optional] 
...
**RateGroup** | Pointer to **string** | For RatePlanSet equals BESTAVAILABLERATE, in case Rate Groups are enabled the elementSpace provides the rate group for the rate plan code. | [optional] 
...
**RoomId** | Pointer to **string** | A string value representing the unique identification of a functionSpaceDetails. | [optional] 
...
**StayProfiles** | Pointer to [**[]ReservationProfileType**](ReservationProfileType.md) | Profile associated with the functionSpaceDetails Stay. | [optional] 
