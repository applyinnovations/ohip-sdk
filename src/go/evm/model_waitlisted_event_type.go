...
type WaitlistedEventType struct {
	AltEventsDetail *LightEventsDetailType `json:"altEventsDetail,omitempty"`
	CurrentEventsHoldingFunctionSpace *EventsInfoType `json:"currentEventsHoldingFunctionSpace,omitempty"`
	EventBlockInfo *BlockType `json:"eventBlockInfo,omitempty"`
	EventDetail *EventDetailType `json:"eventDetail,omitempty"`
	EventIndicators *IndicatorsType `json:"eventIndicators,omitempty"`
	EventNotes *EventNotesType `json:"eventNotes,omitempty"`
	EventPrimaryInfo *EventPrimaryInfoType `json:"eventPrimaryInfo,omitempty"`
	EventResources *EventResourcesListType `json:"eventResources,omitempty"`
	...
	SubEventsDetail *LightEventsDetailType `json:"subEventsDetail,omitempty"`
...
// SetAltEventsDetail gets a reference to the given LightEventsDetailType and assigns it to the AltEventsDetail field.
...
// SetCurrentEventsHoldingFunctionSpace gets a reference to the given EventsInfoType and assigns it to the CurrentEventsHoldingFunctionSpace field.
...
// SetEventIndicators gets a reference to the given IndicatorsType and assigns it to the EventIndicators field.
...
func (o *WaitlistedEventType) GetEventResources() EventResourcesListType {
	if o == nil || IsNil(o.EventResources) {
		var ret EventResourcesListType
		return ret
	}
...
// SetEventResources gets a reference to the given EventResourcesListType and assigns it to the EventResources field.
...
// SetSubEventsDetail gets a reference to the given LightEventsDetailType and assigns it to the SubEventsDetail field.
