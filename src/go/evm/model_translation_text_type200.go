...
type TranslationTextType200 struct {
	...
	Translations *TranslationsTextType `json:"translations,omitempty"`
}
...
// SetTranslations gets a reference to the given TranslationsTextType and assigns it to the Translations field.
