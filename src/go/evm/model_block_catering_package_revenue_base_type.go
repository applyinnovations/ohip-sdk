...
type BlockCateringPackageRevenueBaseType struct {
	...
	Revenues *RevenueListType `json:"revenues,omitempty"`
}
...
// SetRevenues gets a reference to the given RevenueListType and assigns it to the Revenues field.
