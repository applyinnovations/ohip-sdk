...
type EventItemType struct {
	...
	Attributes *ItemAttributesType `json:"attributes,omitempty"`
	Departments *CodeListType `json:"departments,omitempty"`
	...
	Rates *ItemRatesType `json:"rates,omitempty"`
	ResourceNotes *EventResourceNotesType `json:"resourceNotes,omitempty"`
	// The Revenue Type of the Item.
	...
	Vendors *ItemVendorsType `json:"vendors,omitempty"`
}
...
// SetAttributes gets a reference to the given ItemAttributesType and assigns it to the Attributes field.
...
// SetDepartments gets a reference to the given CodeListType and assigns it to the Departments field.
...
// SetRates gets a reference to the given ItemRatesType and assigns it to the Rates field.
...
func (o *EventItemType) GetResourceNotes() EventResourceNotesType {
	if o == nil || IsNil(o.ResourceNotes) {
		var ret EventResourceNotesType
		return ret
	}
...
// SetResourceNotes gets a reference to the given EventResourceNotesType and assigns it to the ResourceNotes field.
...
// SetVendors gets a reference to the given ItemVendorsType and assigns it to the Vendors field.
