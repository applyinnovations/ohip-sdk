...
type CateringEventResourceType struct {
	...
	EventResourceNotes *EventResourceNotesType `json:"eventResourceNotes,omitempty"`
...
// SetEventResourceNotes gets a reference to the given EventResourceNotesType and assigns it to the EventResourceNotes field.
