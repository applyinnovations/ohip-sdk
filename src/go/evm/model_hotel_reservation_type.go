...
type HotelReservationType struct {
	...
	// The color to display this reservation on functionSpaceDetails grid displays.
	...
	// Forcefully override the create/update action on the Reservation. For real-time CRS interfaces, this elementSpace is used as force selling indicator in case of Create or Update Reservation
	...
	// A Service object represents a non-functionSpaceDetails product provided to guests. Service products may have associated inventory and charges.
