...
## Documentation For Models
 ...
 - [BlockCateringPackageListType](docs/BlockCateringPackageListType.md)
 ...
 - [BlockPostingAccountReservationsType](docs/BlockPostingAccountReservationsType.md)
 ...
 - [CateringEventChangeDetailListType](docs/CateringEventChangeDetailListType.md)
 ...
 - [CateringEventChangeListType](docs/CateringEventChangeListType.md)
 ...
 - [CateringEventRevenueChangeListType](docs/CateringEventRevenueChangeListType.md)
 - [CateringEventStatusChangeListType](docs/CateringEventStatusChangeListType.md)
 - [CateringEventsAttendeesType](docs/CateringEventsAttendeesType.md)
 - [CateringEventsBulkUpdate](docs/CateringEventsBulkUpdate.md)
 - [CateringEventsBulkUpdateRequest](docs/CateringEventsBulkUpdateRequest.md)
 - [CateringEventsBulkUpdateStatus](docs/CateringEventsBulkUpdateStatus.md)
 ...
 - [ChangeCateringPackagesRequest](docs/ChangeCateringPackagesRequest.md)
 - [ChangeEventResourceByMenuRequest](docs/ChangeEventResourceByMenuRequest.md)
 - [ChangeEventsRequest](docs/ChangeEventsRequest.md)
 - [ChangeEventsResourcesByChainRequest](docs/ChangeEventsResourcesByChainRequest.md)
 ...
 - [CopyCateringEventsProcessedInfoList](docs/CopyCateringEventsProcessedInfoList.md)
 - [CopyCateringEventsRequest](docs/CopyCateringEventsRequest.md)
 ...
 - [CopyCateringPackageProcessedInfoList](docs/CopyCateringPackageProcessedInfoList.md)
 - [CopyCateringPackageRequest](docs/CopyCateringPackageRequest.md)
 ...
 - [CreateCateringPackageProcessedInfoList](docs/CreateCateringPackageProcessedInfoList.md)
 ...
 - [EventCodeDetailListType](docs/EventCodeDetailListType.md)
 ...
 - [EventIdList](docs/EventIdList.md)
 ...
 - [EventResourcesListType](docs/EventResourcesListType.md)
 ...
 - [EventsInfoType](docs/EventsInfoType.md)
 - [EventsResources](docs/EventsResources.md)
 - [EventsResourcesListType](docs/EventsResourcesListType.md)
 ...
 - [FunctionSpacesAvailabilityType](docs/FunctionSpacesAvailabilityType.md)
 ...
 - [LightEventsDetailType](docs/LightEventsDetailType.md)
 ...
 - [PostCateringPackageRequest](docs/PostCateringPackageRequest.md)
 - [PostCateringPackageRevenueRequest](docs/PostCateringPackageRevenueRequest.md)
 - [PostEventsRequest](docs/PostEventsRequest.md)
 - [PostOpportunityEventsRequest](docs/PostOpportunityEventsRequest.md)
 - [PostQuickInsertResourcesRequest](docs/PostQuickInsertResourcesRequest.md)
 ...
 - [ResourceCopyAndMoveListType](docs/ResourceCopyAndMoveListType.md)
 ...
 - [RevenueListType](docs/RevenueListType.md)
 ...
 - [WaitlistedEventsGroupsType](docs/WaitlistedEventsGroupsType.md)
 - [WaitlistedEventsSearchType](docs/WaitlistedEventsSearchType.md)
 - [WaitlistedEventsType](docs/WaitlistedEventsType.md)
