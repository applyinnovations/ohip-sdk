...
type ManageWaitlistedEventsRequest struct {
	...
	WaitlistedEvents *WaitlistedEventsType `json:"waitlistedEvents,omitempty"`
...
// SetWaitlistedEvents gets a reference to the given WaitlistedEventsType and assigns it to the WaitlistedEvents field.
