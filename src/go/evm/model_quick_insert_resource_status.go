...
type QuickInsertResourceStatus struct {
	...
	QuickinsertResourcesProcessedInfo *CopyCateringEventsProcessedInfoList `json:"quickinsertResourcesProcessedInfo,omitempty"`
...
// SetQuickinsertResourcesProcessedInfo gets a reference to the given CopyCateringEventsProcessedInfoList and assigns it to the QuickinsertResourcesProcessedInfo field.
