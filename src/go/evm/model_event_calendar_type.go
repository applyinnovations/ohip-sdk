...
type EventCalendarType struct {
	EventCodes *EventCodeDetailListType `json:"eventCodes,omitempty"`
...
func (o *EventCalendarType) GetEventCodes() EventCodeDetailListType {
	if o == nil || IsNil(o.EventCodes) {
		var ret EventCodeDetailListType
		return ret
	}
	return *o.EventCodes
}
...
// SetEventCodes gets a reference to the given EventCodeDetailListType and assigns it to the EventCodes field.
