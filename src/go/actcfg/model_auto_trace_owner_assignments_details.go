...
// checks if the AutoTraceOwnerAssignmentsDetails type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AutoTraceOwnerAssignmentsDetails{}

// AutoTraceOwnerAssignmentsDetails Response object to fetch trace owner assignments.
type AutoTraceOwnerAssignmentsDetails struct {
...
func NewAutoTraceOwnerAssignmentsDetails() *AutoTraceOwnerAssignmentsDetails {
	this := AutoTraceOwnerAssignmentsDetails{}
	return &this
}
...
func (o AutoTraceOwnerAssignmentsDetails) MarshalJSON() ([]byte, error) {
...
func (o AutoTraceOwnerAssignmentsDetails) ToMap() (map[string]interface{}, error) {
...
type NullableAutoTraceOwnerAssignmentsDetails struct {
	value *AutoTraceOwnerAssignmentsDetails
	isSet bool
}

func (v NullableAutoTraceOwnerAssignmentsDetails) Get() *AutoTraceOwnerAssignmentsDetails {
	return v.value
}

func (v *NullableAutoTraceOwnerAssignmentsDetails) Set(val *AutoTraceOwnerAssignmentsDetails) {
	v.value = val
	v.isSet = true
}

func (v NullableAutoTraceOwnerAssignmentsDetails) IsSet() bool {
	return v.isSet
}

func (v *NullableAutoTraceOwnerAssignmentsDetails) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAutoTraceOwnerAssignmentsDetails(val *AutoTraceOwnerAssignmentsDetails) *NullableAutoTraceOwnerAssignmentsDetails {
	return &NullableAutoTraceOwnerAssignmentsDetails{value: val, isSet: true}
}

func (v NullableAutoTraceOwnerAssignmentsDetails) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAutoTraceOwnerAssignmentsDetails) UnmarshalJSON(src []byte) error {
	v.isSet = true
