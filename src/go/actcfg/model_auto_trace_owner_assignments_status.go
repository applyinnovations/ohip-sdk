...
func (o *AutoTraceOwnerAssignmentsStatus) GetLinks() Links {
...
func (o *AutoTraceOwnerAssignmentsStatus) GetLinksOk() (*Links, bool) {
	if o == nil || IsNil(o.Links) {
		return nil, false
	}
	return o.Links, true
...
func (o *AutoTraceOwnerAssignmentsStatus) SetLinks(v Links) {
	o.Links = &v
}

// GetWarnings returns the Warnings field value if set, zero value otherwise.
func (o *AutoTraceOwnerAssignmentsStatus) GetWarnings() WarningsType {
...
// and a boolean to check if the value has been set.
func (o *AutoTraceOwnerAssignmentsStatus) GetWarningsOk() (*WarningsType, bool) {
	if o == nil || IsNil(o.Warnings) {
		return nil, false
	}
...
func (o *AutoTraceOwnerAssignmentsStatus) SetWarnings(v WarningsType) {
	o.Warnings = &v
}
