...
type PostAutoTraceDefinitionsRequest struct {
	AutoTraceDefinitions *AutoTraceDefinitionListType `json:"autoTraceDefinitions,omitempty"`
...
func (o *PostAutoTraceDefinitionsRequest) GetAutoTraceDefinitions() AutoTraceDefinitionListType {
	if o == nil || IsNil(o.AutoTraceDefinitions) {
		var ret AutoTraceDefinitionListType
		return ret
	}
...
// SetAutoTraceDefinitions gets a reference to the given AutoTraceDefinitionListType and assigns it to the AutoTraceDefinitions field.
