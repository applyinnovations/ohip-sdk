...
type PostAutoTraceCodesRequest struct {
	AutoTraceCodesConfig *AutoTraceCodesListType `json:"autoTraceCodesConfig,omitempty"`
...
func (o *PostAutoTraceCodesRequest) GetAutoTraceCodesConfig() AutoTraceCodesListType {
	if o == nil || IsNil(o.AutoTraceCodesConfig) {
		var ret AutoTraceCodesListType
		return ret
	}
...
// SetAutoTraceCodesConfig gets a reference to the given AutoTraceCodesListType and assigns it to the AutoTraceCodesConfig field.
