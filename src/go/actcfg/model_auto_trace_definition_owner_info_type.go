...
type AutoTraceDefinitionOwnerInfoType struct {
	...
	OwnerAssignment *AutoTraceOwnerAssignmentListType `json:"ownerAssignment,omitempty"`
...
// SetOwnerAssignment gets a reference to the given AutoTraceOwnerAssignmentListType and assigns it to the OwnerAssignment field.
