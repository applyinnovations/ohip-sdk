...
type ActivityResultsConfigInfo struct {
	ActivityResultsConfiguration *ActivityResultsConfigListType `json:"activityResultsConfiguration,omitempty"`
...
func (o *ActivityResultsConfigInfo) GetActivityResultsConfiguration() ActivityResultsConfigListType {
	if o == nil || IsNil(o.ActivityResultsConfiguration) {
		var ret ActivityResultsConfigListType
		return ret
	}
...
// SetActivityResultsConfiguration gets a reference to the given ActivityResultsConfigListType and assigns it to the ActivityResultsConfiguration field.
