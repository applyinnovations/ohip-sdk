...
`func (o *AutoTraceDefinitionsStatus) GetLinks() Links`

GetLinks returns the Links field if non-nil, zero value otherwise.

### GetLinksOk

`func (o *AutoTraceDefinitionsStatus) GetLinksOk() (*Links, bool)`
...
`func (o *AutoTraceDefinitionsStatus) SetLinks(v Links)`
...
`func (o *AutoTraceDefinitionsStatus) GetWarnings() WarningsType`

GetWarnings returns the Warnings field if non-nil, zero value otherwise.

### GetWarningsOk

`func (o *AutoTraceDefinitionsStatus) GetWarningsOk() (*WarningsType, bool)`
...
`func (o *AutoTraceDefinitionsStatus) SetWarnings(v WarningsType)`
