...
type CopyActivityConfigCriteriaTypeCopyActivityConfig struct {
	ActivityCodeList *CodeListType `json:"activityCodeList,omitempty"`
	// The hotel code where the activity type was created.
	SourceHotelCode *string `json:"sourceHotelCode,omitempty"`
	TargetHotelCode *CodeListType10 `json:"targetHotelCode,omitempty"`
}
...
// SetActivityCodeList gets a reference to the given CodeListType and assigns it to the ActivityCodeList field.
...
// SetTargetHotelCode gets a reference to the given CodeListType10 and assigns it to the TargetHotelCode field.
