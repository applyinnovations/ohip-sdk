...
type ExportSchedulesDetails struct {
	ExportSchedules *ExportSchedulesType `json:"exportSchedules,omitempty"`
...
// SetExportSchedules gets a reference to the given ExportSchedulesType and assigns it to the ExportSchedules field.
