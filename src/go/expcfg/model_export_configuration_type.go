...
type ExportConfigurationType struct {
	Columns *ExportColumnsType `json:"columns,omitempty"`
	Components *ExportComponentsType `json:"components,omitempty"`
...
// SetColumns gets a reference to the given ExportColumnsType and assigns it to the Columns field.
func (o *ExportConfigurationType) SetColumns(v ExportColumnsType) {
	o.Columns = &v
}
...
// SetComponents gets a reference to the given ExportComponentsType and assigns it to the Components field.
