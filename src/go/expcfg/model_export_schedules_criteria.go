...
func (o *ExportSchedulesCriteria) GetLinks() Links {
...
// and a boolean to check if the value has been set.
func (o *ExportSchedulesCriteria) GetLinksOk() (*Links, bool) {
	if o == nil || IsNil(o.Links) {
		return nil, false
	}
	return o.Links, true
...
func (o *ExportSchedulesCriteria) SetLinks(v Links) {
	o.Links = &v
}

// GetWarnings returns the Warnings field value if set, zero value otherwise.
func (o *ExportSchedulesCriteria) GetWarnings() WarningsType {
...
// and a boolean to check if the value has been set.
func (o *ExportSchedulesCriteria) GetWarningsOk() (*WarningsType, bool) {
	if o == nil || IsNil(o.Warnings) {
		return nil, false
	}
...
func (o *ExportSchedulesCriteria) SetWarnings(v WarningsType) {
	o.Warnings = &v
}
