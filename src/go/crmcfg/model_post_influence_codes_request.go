...
// checks if the PostInfluenceCodesRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PostInfluenceCodesRequest{}

// PostInfluenceCodesRequest struct for PostInfluenceCodesRequest
type PostInfluenceCodesRequest struct {
...
func NewPostInfluenceCodesRequest() *PostInfluenceCodesRequest {
	this := PostInfluenceCodesRequest{}
	return &this
}
...
func (o PostInfluenceCodesRequest) MarshalJSON() ([]byte, error) {
...
func (o PostInfluenceCodesRequest) ToMap() (map[string]interface{}, error) {
...
type NullablePostInfluenceCodesRequest struct {
	value *PostInfluenceCodesRequest
	isSet bool
}

func (v NullablePostInfluenceCodesRequest) Get() *PostInfluenceCodesRequest {
	return v.value
}

func (v *NullablePostInfluenceCodesRequest) Set(val *PostInfluenceCodesRequest) {
	v.value = val
	v.isSet = true
}

func (v NullablePostInfluenceCodesRequest) IsSet() bool {
	return v.isSet
}

func (v *NullablePostInfluenceCodesRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePostInfluenceCodesRequest(val *PostInfluenceCodesRequest) *NullablePostInfluenceCodesRequest {
	return &NullablePostInfluenceCodesRequest{value: val, isSet: true}
}

func (v NullablePostInfluenceCodesRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePostInfluenceCodesRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
