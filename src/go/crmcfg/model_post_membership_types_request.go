...
type PostMembershipTypesRequest struct {
	...
	MembershipTypes *MembershipTypesType `json:"membershipTypes,omitempty"`
...
// SetMembershipTypes gets a reference to the given MembershipTypesType and assigns it to the MembershipTypes field.
