...
type PostMembershipTypeRulesRequest struct {
	...
	MembershipTypeRules *MembershipTypeRuleDetailsType `json:"membershipTypeRules,omitempty"`
...
func (o *PostMembershipTypeRulesRequest) GetMembershipTypeRules() MembershipTypeRuleDetailsType {
	if o == nil || IsNil(o.MembershipTypeRules) {
		var ret MembershipTypeRuleDetailsType
		return ret
	}
...
// SetMembershipTypeRules gets a reference to the given MembershipTypeRuleDetailsType and assigns it to the MembershipTypeRules field.
