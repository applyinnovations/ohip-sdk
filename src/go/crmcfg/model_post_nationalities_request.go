...
func (o *PostNationalitiesRequest) GetLinks() Links {
...
func (o *PostNationalitiesRequest) GetLinksOk() (*Links, bool) {
	if o == nil || IsNil(o.Links) {
		return nil, false
	}
	return o.Links, true
...
func (o *PostNationalitiesRequest) SetLinks(v Links) {
	o.Links = &v
}

// GetNationalities returns the Nationalities field value if set, zero value otherwise.
func (o *PostNationalitiesRequest) GetNationalities() NationalitiesType {
...
// and a boolean to check if the value has been set.
func (o *PostNationalitiesRequest) GetNationalitiesOk() (*NationalitiesType, bool) {
	if o == nil || IsNil(o.Nationalities) {
		return nil, false
	}
...
func (o *PostNationalitiesRequest) SetNationalities(v NationalitiesType) {
	o.Nationalities = &v
}

// GetWarnings returns the Warnings field value if set, zero value otherwise.
func (o *PostNationalitiesRequest) GetWarnings() WarningsType {
...
// and a boolean to check if the value has been set.
func (o *PostNationalitiesRequest) GetWarningsOk() (*WarningsType, bool) {
	if o == nil || IsNil(o.Warnings) {
		return nil, false
	}
...
func (o *PostNationalitiesRequest) SetWarnings(v WarningsType) {
	o.Warnings = &v
}
