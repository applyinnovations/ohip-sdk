...
type MembershipEnrollmentGroupType struct {
	...
	EnrollmentCodes *MembershipEnrollmentCodesInfoType `json:"enrollmentCodes,omitempty"`
}
...
func (o *MembershipEnrollmentGroupType) GetEnrollmentCodes() MembershipEnrollmentCodesInfoType {
	if o == nil || IsNil(o.EnrollmentCodes) {
		var ret MembershipEnrollmentCodesInfoType
		return ret
	}
...
// SetEnrollmentCodes gets a reference to the given MembershipEnrollmentCodesInfoType and assigns it to the EnrollmentCodes field.
