...
type MembershipRateGroupType struct {
	...
	RateCodes *MembershipRateCodesType `json:"rateCodes,omitempty"`
}
...
func (o *MembershipRateGroupType) GetRateCodes() MembershipRateCodesType {
	if o == nil || IsNil(o.RateCodes) {
		var ret MembershipRateCodesType
		return ret
	}
	return *o.RateCodes
}
...
// SetRateCodes gets a reference to the given MembershipRateCodesType and assigns it to the RateCodes field.
