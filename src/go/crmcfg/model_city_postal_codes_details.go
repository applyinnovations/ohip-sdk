...
// checks if the CityPostalCodesDetails type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CityPostalCodesDetails{}

// CityPostalCodesDetails Response object for fetching city and postal codes.
type CityPostalCodesDetails struct {
	CityPostalCodes *CityPostalCodesType `json:"cityPostalCodes,omitempty"`
...
// SetCityPostalCodes gets a reference to the given CityPostalCodesType and assigns it to the CityPostalCodes field.
...
func (o CityPostalCodesDetails) MarshalJSON() ([]byte, error) {
...
func (o CityPostalCodesDetails) ToMap() (map[string]interface{}, error) {
...
type NullableCityPostalCodesDetails struct {
	value *CityPostalCodesDetails
	isSet bool
}

func (v NullableCityPostalCodesDetails) Get() *CityPostalCodesDetails {
	return v.value
}

func (v *NullableCityPostalCodesDetails) Set(val *CityPostalCodesDetails) {
	v.value = val
	v.isSet = true
}

func (v NullableCityPostalCodesDetails) IsSet() bool {
	return v.isSet
}

func (v *NullableCityPostalCodesDetails) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCityPostalCodesDetails(val *CityPostalCodesDetails) *NullableCityPostalCodesDetails {
	return &NullableCityPostalCodesDetails{value: val, isSet: true}
}

func (v NullableCityPostalCodesDetails) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCityPostalCodesDetails) UnmarshalJSON(src []byte) error {
	v.isSet = true
