...
type MembershipTypeRulesDetails struct {
	...
	MembershipTypeRules *MembershipTypeRulesIDType `json:"membershipTypeRules,omitempty"`
...
func (o *MembershipTypeRulesDetails) GetMembershipTypeRules() MembershipTypeRulesIDType {
	if o == nil || IsNil(o.MembershipTypeRules) {
		var ret MembershipTypeRulesIDType
		return ret
	}
...
// SetMembershipTypeRules gets a reference to the given MembershipTypeRulesIDType and assigns it to the MembershipTypeRules field.
