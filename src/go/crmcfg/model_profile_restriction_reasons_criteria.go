...
func (o *ProfileRestrictionReasonsCriteria) GetLinks() Links {
...
func (o *ProfileRestrictionReasonsCriteria) GetLinksOk() (*Links, bool) {
	if o == nil || IsNil(o.Links) {
		return nil, false
	}
	return o.Links, true
...
func (o *ProfileRestrictionReasonsCriteria) SetLinks(v Links) {
	o.Links = &v
}

// GetProfileRestrictionReasons returns the ProfileRestrictionReasons field value if set, zero value otherwise.
func (o *ProfileRestrictionReasonsCriteria) GetProfileRestrictionReasons() ProfileRestrictionReasonsType {
...
// and a boolean to check if the value has been set.
func (o *ProfileRestrictionReasonsCriteria) GetProfileRestrictionReasonsOk() (*ProfileRestrictionReasonsType, bool) {
	if o == nil || IsNil(o.ProfileRestrictionReasons) {
		return nil, false
	}
...
func (o *ProfileRestrictionReasonsCriteria) SetProfileRestrictionReasons(v ProfileRestrictionReasonsType) {
	o.ProfileRestrictionReasons = &v
}

// GetWarnings returns the Warnings field value if set, zero value otherwise.
func (o *ProfileRestrictionReasonsCriteria) GetWarnings() WarningsType {
...
// and a boolean to check if the value has been set.
func (o *ProfileRestrictionReasonsCriteria) GetWarningsOk() (*WarningsType, bool) {
	if o == nil || IsNil(o.Warnings) {
		return nil, false
	}
...
func (o *ProfileRestrictionReasonsCriteria) SetWarnings(v WarningsType) {
	o.Warnings = &v
}
