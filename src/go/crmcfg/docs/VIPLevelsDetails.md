...
`func (o *VIPLevelsDetails) GetLinks() Links`

GetLinks returns the Links field if non-nil, zero value otherwise.

### GetLinksOk

`func (o *VIPLevelsDetails) GetLinksOk() (*Links, bool)`
...
`func (o *VIPLevelsDetails) SetLinks(v Links)`
...
`func (o *VIPLevelsDetails) GetVIPLevels() VIPLevelsType`

GetVIPLevels returns the VIPLevels field if non-nil, zero value otherwise.

### GetVIPLevelsOk

`func (o *VIPLevelsDetails) GetVIPLevelsOk() (*VIPLevelsType, bool)`
...
`func (o *VIPLevelsDetails) SetVIPLevels(v VIPLevelsType)`
...
`func (o *VIPLevelsDetails) GetWarnings() WarningsType`

GetWarnings returns the Warnings field if non-nil, zero value otherwise.

### GetWarningsOk

`func (o *VIPLevelsDetails) GetWarningsOk() (*WarningsType, bool)`
...
`func (o *VIPLevelsDetails) SetWarnings(v WarningsType)`
