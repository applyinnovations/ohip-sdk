...
`func (o *GenderTypes) GetGenderTypes() GenderTypesType`

GetGenderTypes returns the GenderTypes field if non-nil, zero value otherwise.

### GetGenderTypesOk

`func (o *GenderTypes) GetGenderTypesOk() (*GenderTypesType, bool)`
...
`func (o *GenderTypes) SetGenderTypes(v GenderTypesType)`
...
`func (o *GenderTypes) GetLinks() Links`

GetLinks returns the Links field if non-nil, zero value otherwise.

### GetLinksOk

`func (o *GenderTypes) GetLinksOk() (*Links, bool)`
...
`func (o *GenderTypes) SetLinks(v Links)`
...
`func (o *GenderTypes) GetWarnings() WarningsType`

GetWarnings returns the Warnings field if non-nil, zero value otherwise.

### GetWarningsOk

`func (o *GenderTypes) GetWarningsOk() (*WarningsType, bool)`
...
`func (o *GenderTypes) SetWarnings(v WarningsType)`
