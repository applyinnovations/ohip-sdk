...
`func (o *PutNationalitiesRequest) GetLinks() Links`

GetLinks returns the Links field if non-nil, zero value otherwise.

### GetLinksOk

`func (o *PutNationalitiesRequest) GetLinksOk() (*Links, bool)`
...
`func (o *PutNationalitiesRequest) SetLinks(v Links)`
...
`func (o *PutNationalitiesRequest) GetNationalities() NationalitiesType`

GetNationalities returns the Nationalities field if non-nil, zero value otherwise.

### GetNationalitiesOk

`func (o *PutNationalitiesRequest) GetNationalitiesOk() (*NationalitiesType, bool)`
...
`func (o *PutNationalitiesRequest) SetNationalities(v NationalitiesType)`
...
`func (o *PutNationalitiesRequest) GetWarnings() WarningsType`

GetWarnings returns the Warnings field if non-nil, zero value otherwise.

### GetWarningsOk

`func (o *PutNationalitiesRequest) GetWarningsOk() (*WarningsType, bool)`
...
`func (o *PutNationalitiesRequest) SetWarnings(v WarningsType)`
