...
`func (o *MembershipTypeRule) GetLinks() Links`

GetLinks returns the Links field if non-nil, zero value otherwise.

### GetLinksOk

`func (o *MembershipTypeRule) GetLinksOk() (*Links, bool)`
...
`func (o *MembershipTypeRule) SetLinks(v Links)`
...
`func (o *MembershipTypeRule) GetWarnings() WarningsType`

GetWarnings returns the Warnings field if non-nil, zero value otherwise.

### GetWarningsOk

`func (o *MembershipTypeRule) GetWarningsOk() (*WarningsType, bool)`
...
`func (o *MembershipTypeRule) SetWarnings(v WarningsType)`
