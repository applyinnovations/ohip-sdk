...
`func (o *PostAccountTypesRequest) GetAccountTypes() AccountTypesType`

GetAccountTypes returns the AccountTypes field if non-nil, zero value otherwise.

### GetAccountTypesOk

`func (o *PostAccountTypesRequest) GetAccountTypesOk() (*AccountTypesType, bool)`
...
`func (o *PostAccountTypesRequest) SetAccountTypes(v AccountTypesType)`
...
`func (o *PostAccountTypesRequest) GetLinks() Links`

GetLinks returns the Links field if non-nil, zero value otherwise.

### GetLinksOk

`func (o *PostAccountTypesRequest) GetLinksOk() (*Links, bool)`
...
`func (o *PostAccountTypesRequest) SetLinks(v Links)`
...
`func (o *PostAccountTypesRequest) GetWarnings() WarningsType`

GetWarnings returns the Warnings field if non-nil, zero value otherwise.

### GetWarningsOk

`func (o *PostAccountTypesRequest) GetWarningsOk() (*WarningsType, bool)`
...
`func (o *PostAccountTypesRequest) SetWarnings(v WarningsType)`
