...
**RateCodes** | Pointer to [**MembershipRateCodesType**](MembershipRateCodesType.md) |  | [optional] 
...
`func (o *MembershipRateGroupType) GetRateCodes() MembershipRateCodesType`

GetRateCodes returns the RateCodes field if non-nil, zero value otherwise.

### GetRateCodesOk

`func (o *MembershipRateGroupType) GetRateCodesOk() (*MembershipRateCodesType, bool)`
...
`func (o *MembershipRateGroupType) SetRateCodes(v MembershipRateCodesType)`
