...
**ReservationChannel** | Pointer to **string** | Reservation Channel for which the rule is applied. | [optional] 
...
SetEnrollmentGroup sets EnrollmentGroup field to given value.
