...
`func (o *AvailablePreferencesDetails) GetLinks() Links`

GetLinks returns the Links field if non-nil, zero value otherwise.

### GetLinksOk

`func (o *AvailablePreferencesDetails) GetLinksOk() (*Links, bool)`
...
`func (o *AvailablePreferencesDetails) SetLinks(v Links)`
...
`func (o *AvailablePreferencesDetails) GetWarnings() WarningsType`

GetWarnings returns the Warnings field if non-nil, zero value otherwise.

### GetWarningsOk

`func (o *AvailablePreferencesDetails) GetWarningsOk() (*WarningsType, bool)`
...
`func (o *AvailablePreferencesDetails) SetWarnings(v WarningsType)`
