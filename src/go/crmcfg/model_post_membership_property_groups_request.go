...
func (o *PostMembershipPropertyGroupsRequest) GetLinks() Links {
...
func (o *PostMembershipPropertyGroupsRequest) GetLinksOk() (*Links, bool) {
	if o == nil || IsNil(o.Links) {
		return nil, false
	}
	return o.Links, true
...
func (o *PostMembershipPropertyGroupsRequest) SetLinks(v Links) {
	o.Links = &v
}

// GetMembershipPropertyGroups returns the MembershipPropertyGroups field value if set, zero value otherwise.
func (o *PostMembershipPropertyGroupsRequest) GetMembershipPropertyGroups() MembershipPropertyGroupsType {
...
// and a boolean to check if the value has been set.
func (o *PostMembershipPropertyGroupsRequest) GetMembershipPropertyGroupsOk() (*MembershipPropertyGroupsType, bool) {
	if o == nil || IsNil(o.MembershipPropertyGroups) {
		return nil, false
	}
...
func (o *PostMembershipPropertyGroupsRequest) SetMembershipPropertyGroups(v MembershipPropertyGroupsType) {
	o.MembershipPropertyGroups = &v
}

// GetWarnings returns the Warnings field value if set, zero value otherwise.
func (o *PostMembershipPropertyGroupsRequest) GetWarnings() WarningsType {
...
// and a boolean to check if the value has been set.
func (o *PostMembershipPropertyGroupsRequest) GetWarningsOk() (*WarningsType, bool) {
	if o == nil || IsNil(o.Warnings) {
		return nil, false
	}
...
func (o *PostMembershipPropertyGroupsRequest) SetWarnings(v WarningsType) {
	o.Warnings = &v
}
