...
// checks if the ChangeAlternateLanguageGuestTitlesRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ChangeAlternateLanguageGuestTitlesRequest{}

// ChangeAlternateLanguageGuestTitlesRequest struct for ChangeAlternateLanguageGuestTitlesRequest
type ChangeAlternateLanguageGuestTitlesRequest struct {
...
func NewChangeAlternateLanguageGuestTitlesRequest() *ChangeAlternateLanguageGuestTitlesRequest {
	this := ChangeAlternateLanguageGuestTitlesRequest{}
	return &this
}
...
func (o ChangeAlternateLanguageGuestTitlesRequest) MarshalJSON() ([]byte, error) {
...
func (o ChangeAlternateLanguageGuestTitlesRequest) ToMap() (map[string]interface{}, error) {
...
type NullableChangeAlternateLanguageGuestTitlesRequest struct {
	value *ChangeAlternateLanguageGuestTitlesRequest
	isSet bool
}

func (v NullableChangeAlternateLanguageGuestTitlesRequest) Get() *ChangeAlternateLanguageGuestTitlesRequest {
	return v.value
}

func (v *NullableChangeAlternateLanguageGuestTitlesRequest) Set(val *ChangeAlternateLanguageGuestTitlesRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableChangeAlternateLanguageGuestTitlesRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableChangeAlternateLanguageGuestTitlesRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableChangeAlternateLanguageGuestTitlesRequest(val *ChangeAlternateLanguageGuestTitlesRequest) *NullableChangeAlternateLanguageGuestTitlesRequest {
	return &NullableChangeAlternateLanguageGuestTitlesRequest{value: val, isSet: true}
}

func (v NullableChangeAlternateLanguageGuestTitlesRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableChangeAlternateLanguageGuestTitlesRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
