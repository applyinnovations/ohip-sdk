...
func (o *MembershipAwards) GetLinks() Links {
...
func (o *MembershipAwards) GetLinksOk() (*Links, bool) {
	if o == nil || IsNil(o.Links) {
		return nil, false
	}
	return o.Links, true
...
func (o *MembershipAwards) SetLinks(v Links) {
	o.Links = &v
}

// GetMembershipAwards returns the MembershipAwards field value if set, zero value otherwise.
func (o *MembershipAwards) GetMembershipAwards() MembershipAwardsType {
...
// and a boolean to check if the value has been set.
func (o *MembershipAwards) GetMembershipAwardsOk() (*MembershipAwardsType, bool) {
	if o == nil || IsNil(o.MembershipAwards) {
		return nil, false
	}
...
func (o *MembershipAwards) SetMembershipAwards(v MembershipAwardsType) {
	o.MembershipAwards = &v
}

// GetWarnings returns the Warnings field value if set, zero value otherwise.
func (o *MembershipAwards) GetWarnings() WarningsType {
...
// and a boolean to check if the value has been set.
func (o *MembershipAwards) GetWarningsOk() (*WarningsType, bool) {
	if o == nil || IsNil(o.Warnings) {
		return nil, false
	}
...
func (o *MembershipAwards) SetWarnings(v WarningsType) {
	o.Warnings = &v
}
