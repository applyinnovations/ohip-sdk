...
func (o *TitlesDetails) GetLinks() Links {
...
func (o *TitlesDetails) GetLinksOk() (*Links, bool) {
	if o == nil || IsNil(o.Links) {
		return nil, false
	}
	return o.Links, true
...
func (o *TitlesDetails) SetLinks(v Links) {
	o.Links = &v
}

// GetTitles returns the Titles field value if set, zero value otherwise.
func (o *TitlesDetails) GetTitles() TitlesType {
...
// and a boolean to check if the value has been set.
func (o *TitlesDetails) GetTitlesOk() (*TitlesType, bool) {
	if o == nil || IsNil(o.Titles) {
		return nil, false
	}
...
func (o *TitlesDetails) SetTitles(v TitlesType) {
	o.Titles = &v
}

// GetWarnings returns the Warnings field value if set, zero value otherwise.
func (o *TitlesDetails) GetWarnings() WarningsType {
...
// and a boolean to check if the value has been set.
func (o *TitlesDetails) GetWarningsOk() (*WarningsType, bool) {
	if o == nil || IsNil(o.Warnings) {
		return nil, false
	}
...
func (o *TitlesDetails) SetWarnings(v WarningsType) {
	o.Warnings = &v
}
