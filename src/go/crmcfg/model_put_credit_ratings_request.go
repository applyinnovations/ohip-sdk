...
type PutCreditRatingsRequest struct {
	CreditRatings *CreditRatingsType `json:"creditRatings,omitempty"`
...
// SetCreditRatings gets a reference to the given CreditRatingsType and assigns it to the CreditRatings field.
