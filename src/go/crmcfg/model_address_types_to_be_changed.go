...
type AddressTypesToBeChanged struct {
	AddressTypes *AddressTypesType `json:"addressTypes,omitempty"`
...
// SetAddressTypes gets a reference to the given AddressTypesType and assigns it to the AddressTypes field.
