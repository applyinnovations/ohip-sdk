...
type PutProfileLinksRequest struct {
	...
	ProfileLinks *ProfileLinksType `json:"profileLinks,omitempty"`
...
// SetProfileLinks gets a reference to the given ProfileLinksType and assigns it to the ProfileLinks field.
