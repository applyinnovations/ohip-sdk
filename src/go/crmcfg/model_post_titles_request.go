...
// checks if the PostTitlesRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PostTitlesRequest{}

// PostTitlesRequest struct for PostTitlesRequest
type PostTitlesRequest struct {
...
func (o PostTitlesRequest) MarshalJSON() ([]byte, error) {
...
func (o PostTitlesRequest) ToMap() (map[string]interface{}, error) {
...
type NullablePostTitlesRequest struct {
	value *PostTitlesRequest
	isSet bool
}

func (v NullablePostTitlesRequest) Get() *PostTitlesRequest {
	return v.value
}

func (v *NullablePostTitlesRequest) Set(val *PostTitlesRequest) {
	v.value = val
	v.isSet = true
}

func (v NullablePostTitlesRequest) IsSet() bool {
	return v.isSet
}

func (v *NullablePostTitlesRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePostTitlesRequest(val *PostTitlesRequest) *NullablePostTitlesRequest {
	return &NullablePostTitlesRequest{value: val, isSet: true}
}

func (v NullablePostTitlesRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePostTitlesRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
