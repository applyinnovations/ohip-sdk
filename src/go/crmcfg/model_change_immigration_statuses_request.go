...
// checks if the ChangeImmigrationStatusesRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ChangeImmigrationStatusesRequest{}

// ChangeImmigrationStatusesRequest struct for ChangeImmigrationStatusesRequest
type ChangeImmigrationStatusesRequest struct {
...
func NewChangeImmigrationStatusesRequest() *ChangeImmigrationStatusesRequest {
	this := ChangeImmigrationStatusesRequest{}
	return &this
}
...
func (o ChangeImmigrationStatusesRequest) MarshalJSON() ([]byte, error) {
...
func (o ChangeImmigrationStatusesRequest) ToMap() (map[string]interface{}, error) {
...
type NullableChangeImmigrationStatusesRequest struct {
	value *ChangeImmigrationStatusesRequest
	isSet bool
}

func (v NullableChangeImmigrationStatusesRequest) Get() *ChangeImmigrationStatusesRequest {
	return v.value
}

func (v *NullableChangeImmigrationStatusesRequest) Set(val *ChangeImmigrationStatusesRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableChangeImmigrationStatusesRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableChangeImmigrationStatusesRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableChangeImmigrationStatusesRequest(val *ChangeImmigrationStatusesRequest) *NullableChangeImmigrationStatusesRequest {
	return &NullableChangeImmigrationStatusesRequest{value: val, isSet: true}
}

func (v NullableChangeImmigrationStatusesRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableChangeImmigrationStatusesRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
