...
func (o *PostCityPostalCodesRequest) GetCityPostalCodes() CityPostalCodesType {
...
func (o *PostCityPostalCodesRequest) GetCityPostalCodesOk() (*CityPostalCodesType, bool) {
	if o == nil || IsNil(o.CityPostalCodes) {
		return nil, false
	}
...
func (o *PostCityPostalCodesRequest) SetCityPostalCodes(v CityPostalCodesType) {
	o.CityPostalCodes = &v
}

// GetLinks returns the Links field value if set, zero value otherwise.
func (o *PostCityPostalCodesRequest) GetLinks() Links {
...
// and a boolean to check if the value has been set.
func (o *PostCityPostalCodesRequest) GetLinksOk() (*Links, bool) {
	if o == nil || IsNil(o.Links) {
		return nil, false
	}
	return o.Links, true
...
func (o *PostCityPostalCodesRequest) SetLinks(v Links) {
	o.Links = &v
}

// GetWarnings returns the Warnings field value if set, zero value otherwise.
func (o *PostCityPostalCodesRequest) GetWarnings() WarningsType {
...
// and a boolean to check if the value has been set.
func (o *PostCityPostalCodesRequest) GetWarningsOk() (*WarningsType, bool) {
	if o == nil || IsNil(o.Warnings) {
		return nil, false
	}
...
func (o *PostCityPostalCodesRequest) SetWarnings(v WarningsType) {
	o.Warnings = &v
}
