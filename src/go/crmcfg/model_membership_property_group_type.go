...
type MembershipPropertyGroupType struct {
	...
	Hotels *MembershipPropertyCodesType `json:"hotels,omitempty"`
}
...
func (o *MembershipPropertyGroupType) GetHotels() MembershipPropertyCodesType {
	if o == nil || IsNil(o.Hotels) {
		var ret MembershipPropertyCodesType
		return ret
	}
	return *o.Hotels
}
...
// SetHotels gets a reference to the given MembershipPropertyCodesType and assigns it to the Hotels field.
