...
func (o *GuestTypesDetails) GetGuestTypes() GuestTypesType {
...
func (o *GuestTypesDetails) GetGuestTypesOk() (*GuestTypesType, bool) {
	if o == nil || IsNil(o.GuestTypes) {
		return nil, false
	}
...
func (o *GuestTypesDetails) SetGuestTypes(v GuestTypesType) {
	o.GuestTypes = &v
}

// GetLinks returns the Links field value if set, zero value otherwise.
func (o *GuestTypesDetails) GetLinks() Links {
...
// and a boolean to check if the value has been set.
func (o *GuestTypesDetails) GetLinksOk() (*Links, bool) {
	if o == nil || IsNil(o.Links) {
		return nil, false
	}
	return o.Links, true
...
func (o *GuestTypesDetails) SetLinks(v Links) {
	o.Links = &v
}

// GetWarnings returns the Warnings field value if set, zero value otherwise.
func (o *GuestTypesDetails) GetWarnings() WarningsType {
...
// and a boolean to check if the value has been set.
func (o *GuestTypesDetails) GetWarningsOk() (*WarningsType, bool) {
	if o == nil || IsNil(o.Warnings) {
		return nil, false
	}
...
func (o *GuestTypesDetails) SetWarnings(v WarningsType) {
	o.Warnings = &v
}
