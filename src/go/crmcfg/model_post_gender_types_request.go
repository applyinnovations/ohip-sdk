...
// checks if the PostGenderTypesRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PostGenderTypesRequest{}

// PostGenderTypesRequest struct for PostGenderTypesRequest
type PostGenderTypesRequest struct {
...
func (o PostGenderTypesRequest) MarshalJSON() ([]byte, error) {
...
func (o PostGenderTypesRequest) ToMap() (map[string]interface{}, error) {
...
type NullablePostGenderTypesRequest struct {
	value *PostGenderTypesRequest
	isSet bool
}

func (v NullablePostGenderTypesRequest) Get() *PostGenderTypesRequest {
	return v.value
}

func (v *NullablePostGenderTypesRequest) Set(val *PostGenderTypesRequest) {
	v.value = val
	v.isSet = true
}

func (v NullablePostGenderTypesRequest) IsSet() bool {
	return v.isSet
}

func (v *NullablePostGenderTypesRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePostGenderTypesRequest(val *PostGenderTypesRequest) *NullablePostGenderTypesRequest {
	return &NullablePostGenderTypesRequest{value: val, isSet: true}
}

func (v NullablePostGenderTypesRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePostGenderTypesRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
