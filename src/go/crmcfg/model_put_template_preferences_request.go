...
type PutTemplatePreferencesRequest struct {
	...
	TemplatePreferences *ConfigTemplatePreferencesType `json:"templatePreferences,omitempty"`
...
func (o *PutTemplatePreferencesRequest) GetTemplatePreferences() ConfigTemplatePreferencesType {
	if o == nil || IsNil(o.TemplatePreferences) {
		var ret ConfigTemplatePreferencesType
		return ret
	}
...
// SetTemplatePreferences gets a reference to the given ConfigTemplatePreferencesType and assigns it to the TemplatePreferences field.
