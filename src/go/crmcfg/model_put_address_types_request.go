...
// checks if the PutAddressTypesRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PutAddressTypesRequest{}

// PutAddressTypesRequest struct for PutAddressTypesRequest
type PutAddressTypesRequest struct {
...
func (o PutAddressTypesRequest) MarshalJSON() ([]byte, error) {
...
func (o PutAddressTypesRequest) ToMap() (map[string]interface{}, error) {
...
type NullablePutAddressTypesRequest struct {
	value *PutAddressTypesRequest
	isSet bool
}

func (v NullablePutAddressTypesRequest) Get() *PutAddressTypesRequest {
	return v.value
}

func (v *NullablePutAddressTypesRequest) Set(val *PutAddressTypesRequest) {
	v.value = val
	v.isSet = true
}

func (v NullablePutAddressTypesRequest) IsSet() bool {
	return v.isSet
}

func (v *NullablePutAddressTypesRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePutAddressTypesRequest(val *PutAddressTypesRequest) *NullablePutAddressTypesRequest {
	return &NullablePutAddressTypesRequest{value: val, isSet: true}
}

func (v NullablePutAddressTypesRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePutAddressTypesRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
