...
func (o *MembershipClasses) GetLinks() Links {
...
func (o *MembershipClasses) GetLinksOk() (*Links, bool) {
	if o == nil || IsNil(o.Links) {
		return nil, false
	}
	return o.Links, true
...
func (o *MembershipClasses) SetLinks(v Links) {
	o.Links = &v
}

// GetMembershipClasses returns the MembershipClasses field value if set, zero value otherwise.
func (o *MembershipClasses) GetMembershipClasses() MembershipClassesType {
...
// and a boolean to check if the value has been set.
func (o *MembershipClasses) GetMembershipClassesOk() (*MembershipClassesType, bool) {
	if o == nil || IsNil(o.MembershipClasses) {
		return nil, false
	}
...
func (o *MembershipClasses) SetMembershipClasses(v MembershipClassesType) {
	o.MembershipClasses = &v
}

// GetWarnings returns the Warnings field value if set, zero value otherwise.
func (o *MembershipClasses) GetWarnings() WarningsType {
...
// and a boolean to check if the value has been set.
func (o *MembershipClasses) GetWarningsOk() (*WarningsType, bool) {
	if o == nil || IsNil(o.Warnings) {
		return nil, false
	}
...
func (o *MembershipClasses) SetWarnings(v WarningsType) {
	o.Warnings = &v
}
