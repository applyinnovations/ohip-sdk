...
type CommunicationTypesDetails struct {
	CommunicationTypes *CommunicationTypesType `json:"communicationTypes,omitempty"`
...
func (o *CommunicationTypesDetails) GetCommunicationTypes() CommunicationTypesType {
	if o == nil || IsNil(o.CommunicationTypes) {
		var ret CommunicationTypesType
		return ret
	}
...
// SetCommunicationTypes gets a reference to the given CommunicationTypesType and assigns it to the CommunicationTypes field.
