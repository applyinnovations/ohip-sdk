...
// checks if the PutCompanyTypesRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PutCompanyTypesRequest{}

// PutCompanyTypesRequest struct for PutCompanyTypesRequest
type PutCompanyTypesRequest struct {
...
func (o PutCompanyTypesRequest) MarshalJSON() ([]byte, error) {
...
func (o PutCompanyTypesRequest) ToMap() (map[string]interface{}, error) {
...
type NullablePutCompanyTypesRequest struct {
	value *PutCompanyTypesRequest
	isSet bool
}

func (v NullablePutCompanyTypesRequest) Get() *PutCompanyTypesRequest {
	return v.value
}

func (v *NullablePutCompanyTypesRequest) Set(val *PutCompanyTypesRequest) {
	v.value = val
	v.isSet = true
}

func (v NullablePutCompanyTypesRequest) IsSet() bool {
	return v.isSet
}

func (v *NullablePutCompanyTypesRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePutCompanyTypesRequest(val *PutCompanyTypesRequest) *NullablePutCompanyTypesRequest {
	return &NullablePutCompanyTypesRequest{value: val, isSet: true}
}

func (v NullablePutCompanyTypesRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePutCompanyTypesRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
