...
type ChangeGuestStatusesRequest struct {
	GuestStatuses *GuestStatusesType `json:"guestStatuses,omitempty"`
...
// SetGuestStatuses gets a reference to the given GuestStatusesType and assigns it to the GuestStatuses field.
