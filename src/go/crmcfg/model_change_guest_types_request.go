...
type ChangeGuestTypesRequest struct {
	GuestTypes *GuestTypesType `json:"guestTypes,omitempty"`
...
// SetGuestTypes gets a reference to the given GuestTypesType and assigns it to the GuestTypes field.
