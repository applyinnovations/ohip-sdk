...
type MembershipMarketGroupType struct {
	...
	MarketCodes *MembershipMarketCodesType `json:"marketCodes,omitempty"`
}
...
func (o *MembershipMarketGroupType) GetMarketCodes() MembershipMarketCodesType {
	if o == nil || IsNil(o.MarketCodes) {
		var ret MembershipMarketCodesType
		return ret
	}
...
// SetMarketCodes gets a reference to the given MembershipMarketCodesType and assigns it to the MarketCodes field.
