...
func (o *ProfileInactiveReasonsToBeChanged) GetLinks() Links {
...
func (o *ProfileInactiveReasonsToBeChanged) GetLinksOk() (*Links, bool) {
	if o == nil || IsNil(o.Links) {
		return nil, false
	}
	return o.Links, true
...
func (o *ProfileInactiveReasonsToBeChanged) SetLinks(v Links) {
	o.Links = &v
}

// GetProfileInactiveReasons returns the ProfileInactiveReasons field value if set, zero value otherwise.
func (o *ProfileInactiveReasonsToBeChanged) GetProfileInactiveReasons() ProfileInactiveReasonsType {
...
// and a boolean to check if the value has been set.
func (o *ProfileInactiveReasonsToBeChanged) GetProfileInactiveReasonsOk() (*ProfileInactiveReasonsType, bool) {
	if o == nil || IsNil(o.ProfileInactiveReasons) {
		return nil, false
	}
...
func (o *ProfileInactiveReasonsToBeChanged) SetProfileInactiveReasons(v ProfileInactiveReasonsType) {
	o.ProfileInactiveReasons = &v
}

// GetWarnings returns the Warnings field value if set, zero value otherwise.
func (o *ProfileInactiveReasonsToBeChanged) GetWarnings() WarningsType {
...
// and a boolean to check if the value has been set.
func (o *ProfileInactiveReasonsToBeChanged) GetWarningsOk() (*WarningsType, bool) {
	if o == nil || IsNil(o.Warnings) {
		return nil, false
	}
...
func (o *ProfileInactiveReasonsToBeChanged) SetWarnings(v WarningsType) {
	o.Warnings = &v
}
