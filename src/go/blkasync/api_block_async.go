...
func (r BlockAsyncApiGetBlockAllocationSummaryRequest) Execute() (*BlockAllocationSummary, *http.Response, error) {
...
func (a *BlockAsyncApiService) GetBlockAllocationSummaryExecute(r BlockAsyncApiGetBlockAllocationSummaryRequest) (*BlockAllocationSummary, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *BlockAllocationSummary
	)
