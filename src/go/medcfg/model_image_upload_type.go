...
type ImageUploadType struct {
	...
	ImageParameters *ImageParametersType `json:"imageParameters,omitempty"`
...
// SetImageParameters gets a reference to the given ImageParametersType and assigns it to the ImageParameters field.
