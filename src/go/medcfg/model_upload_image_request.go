...
type UploadImageRequest struct {
	Images *ImageUploadInfoType `json:"images,omitempty"`
...
// SetImages gets a reference to the given ImageUploadInfoType and assigns it to the Images field.
