...
type BestAvailableRatePlanType struct {
	...
	RatePlanCodes *BestAvailableRateCodesType `json:"ratePlanCodes,omitempty"`
}
...
func (o *BestAvailableRatePlanType) GetRatePlanCodes() BestAvailableRateCodesType {
	if o == nil || IsNil(o.RatePlanCodes) {
		var ret BestAvailableRateCodesType
		return ret
	}
...
// SetRatePlanCodes gets a reference to the given BestAvailableRateCodesType and assigns it to the RatePlanCodes field.
