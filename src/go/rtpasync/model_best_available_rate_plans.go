...
type BestAvailableRatePlans struct {
	BestAvailableRatePlans *BestAvailableRatePlansType `json:"bestAvailableRatePlans,omitempty"`
}
...
func (o *BestAvailableRatePlans) GetBestAvailableRatePlans() BestAvailableRatePlansType {
	if o == nil || IsNil(o.BestAvailableRatePlans) {
		var ret BestAvailableRatePlansType
		return ret
	}
...
// SetBestAvailableRatePlans gets a reference to the given BestAvailableRatePlansType and assigns it to the BestAvailableRatePlans field.
