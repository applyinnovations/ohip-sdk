...
`func (o *DailyRatePlanSchedulesStatus) GetLinks() Links`

GetLinks returns the Links field if non-nil, zero value otherwise.

### GetLinksOk

`func (o *DailyRatePlanSchedulesStatus) GetLinksOk() (*Links, bool)`
...
`func (o *DailyRatePlanSchedulesStatus) SetLinks(v Links)`
...
`func (o *DailyRatePlanSchedulesStatus) GetWarnings() WarningsType`

GetWarnings returns the Warnings field if non-nil, zero value otherwise.

### GetWarningsOk

`func (o *DailyRatePlanSchedulesStatus) GetWarningsOk() (*WarningsType, bool)`
...
`func (o *DailyRatePlanSchedulesStatus) SetWarnings(v WarningsType)`
