...
`func (o *BestAvailableRatePlansStatus) GetLinks() Links`

GetLinks returns the Links field if non-nil, zero value otherwise.

### GetLinksOk

`func (o *BestAvailableRatePlansStatus) GetLinksOk() (*Links, bool)`
...
`func (o *BestAvailableRatePlansStatus) SetLinks(v Links)`
...
`func (o *BestAvailableRatePlansStatus) GetWarnings() WarningsType`

GetWarnings returns the Warnings field if non-nil, zero value otherwise.

### GetWarningsOk

`func (o *BestAvailableRatePlansStatus) GetWarningsOk() (*WarningsType, bool)`
...
`func (o *BestAvailableRatePlansStatus) SetWarnings(v WarningsType)`
