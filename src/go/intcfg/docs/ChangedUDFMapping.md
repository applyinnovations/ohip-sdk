...
`func (o *ChangedUDFMapping) GetLinks() Links`

GetLinks returns the Links field if non-nil, zero value otherwise.

### GetLinksOk

`func (o *ChangedUDFMapping) GetLinksOk() (*Links, bool)`
...
`func (o *ChangedUDFMapping) SetLinks(v Links)`
...
`func (o *ChangedUDFMapping) GetWarnings() WarningsType`

GetWarnings returns the Warnings field if non-nil, zero value otherwise.

### GetWarningsOk

`func (o *ChangedUDFMapping) GetWarningsOk() (*WarningsType, bool)`
...
`func (o *ChangedUDFMapping) SetWarnings(v WarningsType)`
