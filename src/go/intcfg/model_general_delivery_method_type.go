...
type GeneralDeliveryMethodType struct {
	...
	SftpConfigurations *SftpConfigurationsListType `json:"sftpConfigurations,omitempty"`
}
...
func (o *GeneralDeliveryMethodType) GetSftpConfigurations() SftpConfigurationsListType {
	if o == nil || IsNil(o.SftpConfigurations) {
		var ret SftpConfigurationsListType
		return ret
	}
...
// SetSftpConfigurations gets a reference to the given SftpConfigurationsListType and assigns it to the SftpConfigurations field.
