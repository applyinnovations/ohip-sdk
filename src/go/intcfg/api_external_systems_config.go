...
func (r ExternalSystemsConfigApiGetInterfaceRightsRequest) Execute() (*FetchedInterfaceRights, *http.Response, error) {
...
// Execute executes the request
//  @return FetchedInterfaceRights
func (a *ExternalSystemsConfigApiService) GetInterfaceRightsExecute(r ExternalSystemsConfigApiGetInterfaceRightsRequest) (*FetchedInterfaceRights, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *FetchedInterfaceRights
	)
