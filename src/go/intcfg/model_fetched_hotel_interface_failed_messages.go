...
type FetchedHotelInterfaceFailedMessages struct {
	...
	Messages *HotelInterfaceFailedMessagesType `json:"messages,omitempty"`
...
func (o *FetchedHotelInterfaceFailedMessages) GetMessages() HotelInterfaceFailedMessagesType {
	if o == nil || IsNil(o.Messages) {
		var ret HotelInterfaceFailedMessagesType
		return ret
	}
	return *o.Messages
}
...
// SetMessages gets a reference to the given HotelInterfaceFailedMessagesType and assigns it to the Messages field.
