...
type FetchedHotelInterfaceErrors struct {
	...
	HotelInterfaceErrors *HotelInterfaceErrorsType `json:"hotelInterfaceErrors,omitempty"`
...
func (o *FetchedHotelInterfaceErrors) GetHotelInterfaceErrors() HotelInterfaceErrorsType {
	if o == nil || IsNil(o.HotelInterfaceErrors) {
		var ret HotelInterfaceErrorsType
		return ret
	}
...
// SetHotelInterfaceErrors gets a reference to the given HotelInterfaceErrorsType and assigns it to the HotelInterfaceErrors field.
