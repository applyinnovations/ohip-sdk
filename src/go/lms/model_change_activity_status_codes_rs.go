...
// checks if the ChangeActivityStatusCodesRS type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ChangeActivityStatusCodesRS{}

// ChangeActivityStatusCodesRS Existing Operations Responses will eventually be modified to be extended from this type.
type ChangeActivityStatusCodesRS struct {
...
func NewChangeActivityStatusCodesRS() *ChangeActivityStatusCodesRS {
	this := ChangeActivityStatusCodesRS{}
	return &this
}
...
func (o ChangeActivityStatusCodesRS) MarshalJSON() ([]byte, error) {
...
func (o ChangeActivityStatusCodesRS) ToMap() (map[string]interface{}, error) {
...
type NullableChangeActivityStatusCodesRS struct {
	value *ChangeActivityStatusCodesRS
	isSet bool
}

func (v NullableChangeActivityStatusCodesRS) Get() *ChangeActivityStatusCodesRS {
	return v.value
}

func (v *NullableChangeActivityStatusCodesRS) Set(val *ChangeActivityStatusCodesRS) {
	v.value = val
	v.isSet = true
}

func (v NullableChangeActivityStatusCodesRS) IsSet() bool {
	return v.isSet
}

func (v *NullableChangeActivityStatusCodesRS) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableChangeActivityStatusCodesRS(val *ChangeActivityStatusCodesRS) *NullableChangeActivityStatusCodesRS {
	return &NullableChangeActivityStatusCodesRS{value: val, isSet: true}
}

func (v NullableChangeActivityStatusCodesRS) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableChangeActivityStatusCodesRS) UnmarshalJSON(src []byte) error {
	v.isSet = true
