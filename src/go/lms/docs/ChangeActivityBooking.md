...
`func (o *ChangeActivityBooking) GetLinks() Links`

GetLinks returns the Links field if non-nil, zero value otherwise.

### GetLinksOk

`func (o *ChangeActivityBooking) GetLinksOk() (*Links, bool)`
...
`func (o *ChangeActivityBooking) SetLinks(v Links)`
...
`func (o *ChangeActivityBooking) GetWarnings() WarningsType`

GetWarnings returns the Warnings field if non-nil, zero value otherwise.

### GetWarningsOk

`func (o *ChangeActivityBooking) GetWarningsOk() (*WarningsType, bool)`
...
`func (o *ChangeActivityBooking) SetWarnings(v WarningsType)`
