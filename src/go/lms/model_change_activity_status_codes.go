...
// checks if the ChangeActivityStatusCodes type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ChangeActivityStatusCodes{}

// ChangeActivityStatusCodes Request object for changing Activity Status Codes.
type ChangeActivityStatusCodes struct {
...
func NewChangeActivityStatusCodes() *ChangeActivityStatusCodes {
	this := ChangeActivityStatusCodes{}
	return &this
}
...
func (o ChangeActivityStatusCodes) MarshalJSON() ([]byte, error) {
...
func (o ChangeActivityStatusCodes) ToMap() (map[string]interface{}, error) {
...
type NullableChangeActivityStatusCodes struct {
	value *ChangeActivityStatusCodes
	isSet bool
}

func (v NullableChangeActivityStatusCodes) Get() *ChangeActivityStatusCodes {
	return v.value
}

func (v *NullableChangeActivityStatusCodes) Set(val *ChangeActivityStatusCodes) {
	v.value = val
	v.isSet = true
}

func (v NullableChangeActivityStatusCodes) IsSet() bool {
	return v.isSet
}

func (v *NullableChangeActivityStatusCodes) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableChangeActivityStatusCodes(val *ChangeActivityStatusCodes) *NullableChangeActivityStatusCodes {
	return &NullableChangeActivityStatusCodes{value: val, isSet: true}
}

func (v NullableChangeActivityStatusCodes) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableChangeActivityStatusCodes) UnmarshalJSON(src []byte) error {
	v.isSet = true
