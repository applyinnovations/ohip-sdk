...
type HotelEventSpaceDetailType struct {
	...
	MaxOccupancies *EventSpaceMaxOccupanciesType `json:"maxOccupancies,omitempty"`
}
...
func (o *HotelEventSpaceDetailType) GetMaxOccupancies() EventSpaceMaxOccupanciesType {
	if o == nil || IsNil(o.MaxOccupancies) {
		var ret EventSpaceMaxOccupanciesType
		return ret
	}
...
// SetMaxOccupancies gets a reference to the given EventSpaceMaxOccupanciesType and assigns it to the MaxOccupancies field.
