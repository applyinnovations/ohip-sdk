...
type RelationshipProfileType struct {
	...
	ChangeProfileIdList *UniqueIDListType `json:"changeProfileIdList,omitempty"`
...
// SetChangeProfileIdList gets a reference to the given UniqueIDListType and assigns it to the ChangeProfileIdList field.
