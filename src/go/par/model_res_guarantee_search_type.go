...
type ResGuaranteeSearchType struct {
	...
	ResAttachedProfiles *ResAttachedProfileListType `json:"resAttachedProfiles,omitempty"`
...
// SetResAttachedProfiles gets a reference to the given ResAttachedProfileListType and assigns it to the ResAttachedProfiles field.
