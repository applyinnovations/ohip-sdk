...
type UpsellType struct {
	...
	Rates *UpsellDailyRatesType `json:"rates,omitempty"`
...
// SetRates gets a reference to the given UpsellDailyRatesType and assigns it to the Rates field.
