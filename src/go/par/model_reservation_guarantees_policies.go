...
type ReservationGuaranteesPolicies struct {
	...
	ResGuarantees *GuaranteePoliciesType `json:"resGuarantees,omitempty"`
...
// SetResGuarantees gets a reference to the given GuaranteePoliciesType and assigns it to the ResGuarantees field.
