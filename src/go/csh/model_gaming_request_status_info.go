...
type GamingRequestStatusInfo struct {
	...
	StatusInfo *GamingRequestStatusInfoType `json:"statusInfo,omitempty"`
...
func (o *GamingRequestStatusInfo) GetStatusInfo() GamingRequestStatusInfoType {
	if o == nil || IsNil(o.StatusInfo) {
		var ret GamingRequestStatusInfoType
		return ret
	}
	return *o.StatusInfo
}
...
// SetStatusInfo gets a reference to the given GamingRequestStatusInfoType and assigns it to the StatusInfo field.
