...
type AdjustedTransactions struct {
	...
	ServiceRecoveryAdjustments *SummaryPostingsType `json:"serviceRecoveryAdjustments,omitempty"`
...
// SetServiceRecoveryAdjustments gets a reference to the given SummaryPostingsType and assigns it to the ServiceRecoveryAdjustments field.
