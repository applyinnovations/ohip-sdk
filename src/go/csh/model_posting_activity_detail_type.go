...
type PostingActivityDetailType struct {
	...
	NewInfo *SummaryPostingsType `json:"newInfo,omitempty"`
	OldInfo *SummaryPostingsType `json:"oldInfo,omitempty"`
...
// SetNewInfo gets a reference to the given SummaryPostingsType and assigns it to the NewInfo field.
...
// SetOldInfo gets a reference to the given SummaryPostingsType and assigns it to the OldInfo field.
