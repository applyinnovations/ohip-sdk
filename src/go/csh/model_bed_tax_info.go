...
type BedTaxInfo struct {
	BedTaxInfoTypes *BedTaxInfoTypes `json:"bedTaxInfoTypes,omitempty"`
...
// SetBedTaxInfoTypes gets a reference to the given BedTaxInfoTypes and assigns it to the BedTaxInfoTypes field.
