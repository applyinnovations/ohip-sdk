...
type CCBatchSettlementsProcessType struct {
	...
	SettlementIdList *UniqueIDListType `json:"settlementIdList,omitempty"`
}
...
// SetSettlementIdList gets a reference to the given UniqueIDListType and assigns it to the SettlementIdList field.
