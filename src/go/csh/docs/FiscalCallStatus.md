...
`func (o *FiscalCallStatus) GetLinks() Links`

GetLinks returns the Links field if non-nil, zero value otherwise.

### GetLinksOk

`func (o *FiscalCallStatus) GetLinksOk() (*Links, bool)`
...
`func (o *FiscalCallStatus) SetLinks(v Links)`
...
`func (o *FiscalCallStatus) GetWarnings() WarningsType`

GetWarnings returns the Warnings field if non-nil, zero value otherwise.

### GetWarningsOk

`func (o *FiscalCallStatus) GetWarningsOk() (*WarningsType, bool)`
...
`func (o *FiscalCallStatus) SetWarnings(v WarningsType)`
