...
`func (o *RoutingInstructionsToChange) GetLinks() Links`

GetLinks returns the Links field if non-nil, zero value otherwise.

### GetLinksOk

`func (o *RoutingInstructionsToChange) GetLinksOk() (*Links, bool)`
...
`func (o *RoutingInstructionsToChange) SetLinks(v Links)`
...
`func (o *RoutingInstructionsToChange) GetWarnings() WarningsType`

GetWarnings returns the Warnings field if non-nil, zero value otherwise.

### GetWarningsOk

`func (o *RoutingInstructionsToChange) GetWarningsOk() (*WarningsType, bool)`
...
`func (o *RoutingInstructionsToChange) SetWarnings(v WarningsType)`
