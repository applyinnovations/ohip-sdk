...
`func (o *CreditBillCriteriaType) GetCharges() ChargesCriteriaType`

GetCharges returns the Charges field if non-nil, zero value otherwise.

### GetChargesOk

`func (o *CreditBillCriteriaType) GetChargesOk() (*ChargesCriteriaType, bool)`
...
`func (o *CreditBillCriteriaType) SetCharges(v ChargesCriteriaType)`
