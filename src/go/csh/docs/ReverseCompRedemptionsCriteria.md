...
`func (o *ReverseCompRedemptionsCriteria) GetCompRedemptions() CompRedemptionsType`

GetCompRedemptions returns the CompRedemptions field if non-nil, zero value otherwise.

### GetCompRedemptionsOk

`func (o *ReverseCompRedemptionsCriteria) GetCompRedemptionsOk() (*CompRedemptionsType, bool)`
...
`func (o *ReverseCompRedemptionsCriteria) SetCompRedemptions(v CompRedemptionsType)`
