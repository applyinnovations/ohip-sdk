...
`func (o *CreditBillCriteria) GetLinks() Links`

GetLinks returns the Links field if non-nil, zero value otherwise.

### GetLinksOk

`func (o *CreditBillCriteria) GetLinksOk() (*Links, bool)`
...
`func (o *CreditBillCriteria) SetLinks(v Links)`
...
`func (o *CreditBillCriteria) GetWarnings() WarningsType`

GetWarnings returns the Warnings field if non-nil, zero value otherwise.

### GetWarningsOk

`func (o *CreditBillCriteria) GetWarningsOk() (*WarningsType, bool)`
...
`func (o *CreditBillCriteria) SetWarnings(v WarningsType)`
