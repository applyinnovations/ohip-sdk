...
`func (o *PutBillingCharges) GetLinks() Links`

GetLinks returns the Links field if non-nil, zero value otherwise.

### GetLinksOk

`func (o *PutBillingCharges) GetLinksOk() (*Links, bool)`
...
`func (o *PutBillingCharges) SetLinks(v Links)`
...
`func (o *PutBillingCharges) GetWarnings() WarningsType`

GetWarnings returns the Warnings field if non-nil, zero value otherwise.

### GetWarningsOk

`func (o *PutBillingCharges) GetWarningsOk() (*WarningsType, bool)`
...
`func (o *PutBillingCharges) SetWarnings(v WarningsType)`
