...
func (o *BillingChargesDetails) GetLinks() Links {
...
func (o *BillingChargesDetails) GetLinksOk() (*Links, bool) {
	if o == nil || IsNil(o.Links) {
		return nil, false
	}
	return o.Links, true
...
func (o *BillingChargesDetails) SetLinks(v Links) {
	o.Links = &v
}

// GetPostings returns the Postings field value if set, zero value otherwise.
func (o *BillingChargesDetails) GetPostings() SummaryPostingsType {
...
// and a boolean to check if the value has been set.
func (o *BillingChargesDetails) GetPostingsOk() (*SummaryPostingsType, bool) {
	if o == nil || IsNil(o.Postings) {
		return nil, false
	}
...
func (o *BillingChargesDetails) SetPostings(v SummaryPostingsType) {
	o.Postings = &v
}

// GetTrxCodesInfo returns the TrxCodesInfo field value if set, zero value otherwise.
func (o *BillingChargesDetails) GetTrxCodesInfo() TrxCodesInfoType {
...
// and a boolean to check if the value has been set.
func (o *BillingChargesDetails) GetTrxCodesInfoOk() (*TrxCodesInfoType, bool) {
	if o == nil || IsNil(o.TrxCodesInfo) {
		return nil, false
	}
...
func (o *BillingChargesDetails) SetTrxCodesInfo(v TrxCodesInfoType) {
	o.TrxCodesInfo = &v
}

// GetWarnings returns the Warnings field value if set, zero value otherwise.
func (o *BillingChargesDetails) GetWarnings() WarningsType {
...
// and a boolean to check if the value has been set.
func (o *BillingChargesDetails) GetWarningsOk() (*WarningsType, bool) {
	if o == nil || IsNil(o.Warnings) {
		return nil, false
	}
...
func (o *BillingChargesDetails) SetWarnings(v WarningsType) {
	o.Warnings = &v
}
