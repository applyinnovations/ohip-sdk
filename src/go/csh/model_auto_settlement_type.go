...
type AutoSettlementType struct {
	...
	PaymentMethods *PaymentMethodsSearchType `json:"paymentMethods,omitempty"`
...
func (o *AutoSettlementType) GetPaymentMethods() PaymentMethodsSearchType {
	if o == nil || IsNil(o.PaymentMethods) {
		var ret PaymentMethodsSearchType
		return ret
	}
...
// SetPaymentMethods gets a reference to the given PaymentMethodsSearchType and assigns it to the PaymentMethods field.
