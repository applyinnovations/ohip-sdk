...
type AutoSettleCompFoliosStatus struct {
	Folios *AutoSettleCompFoliosType `json:"folios,omitempty"`
...
func (o *AutoSettleCompFoliosStatus) GetFolios() AutoSettleCompFoliosType {
	if o == nil || IsNil(o.Folios) {
		var ret AutoSettleCompFoliosType
		return ret
	}
	return *o.Folios
}
...
// SetFolios gets a reference to the given AutoSettleCompFoliosType and assigns it to the Folios field.
