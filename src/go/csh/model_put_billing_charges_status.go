...
func (o *PutBillingChargesStatus) GetLinks() Links {
...
func (o *PutBillingChargesStatus) GetLinksOk() (*Links, bool) {
	if o == nil || IsNil(o.Links) {
		return nil, false
	}
	return o.Links, true
...
func (o *PutBillingChargesStatus) SetLinks(v Links) {
	o.Links = &v
}

// GetWarnings returns the Warnings field value if set, zero value otherwise.
func (o *PutBillingChargesStatus) GetWarnings() WarningsType {
...
// and a boolean to check if the value has been set.
func (o *PutBillingChargesStatus) GetWarningsOk() (*WarningsType, bool) {
	if o == nil || IsNil(o.Warnings) {
		return nil, false
	}
...
func (o *PutBillingChargesStatus) SetWarnings(v WarningsType) {
	o.Warnings = &v
}
