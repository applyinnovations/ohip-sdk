...
type DepositFolioTransactionDetails struct {
	...
	Transactions *DepositDetailPostingsType `json:"transactions,omitempty"`
...
func (o *DepositFolioTransactionDetails) GetTransactions() DepositDetailPostingsType {
	if o == nil || IsNil(o.Transactions) {
		var ret DepositDetailPostingsType
		return ret
	}
...
// SetTransactions gets a reference to the given DepositDetailPostingsType and assigns it to the Transactions field.
