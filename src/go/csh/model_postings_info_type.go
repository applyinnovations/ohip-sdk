...
type PostingsInfoType struct {
	Transactions *DetailPostingsType `json:"transactions,omitempty"`
...
// SetTransactions gets a reference to the given DetailPostingsType and assigns it to the Transactions field.
