...
func (o *PostingsForRefresh) GetLinks() Links {
...
func (o *PostingsForRefresh) GetLinksOk() (*Links, bool) {
	if o == nil || IsNil(o.Links) {
		return nil, false
	}
	return o.Links, true
...
func (o *PostingsForRefresh) SetLinks(v Links) {
	o.Links = &v
}
...
func (o *PostingsForRefresh) GetWarnings() WarningsType {
...
// and a boolean to check if the value has been set.
func (o *PostingsForRefresh) GetWarningsOk() (*WarningsType, bool) {
	if o == nil || IsNil(o.Warnings) {
		return nil, false
	}
...
func (o *PostingsForRefresh) SetWarnings(v WarningsType) {
	o.Warnings = &v
}
