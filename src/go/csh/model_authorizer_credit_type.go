...
type AuthorizerCreditType struct {
	...
	AuthorizerCreditDetails *AuthorizerCreditDetailsType `json:"authorizerCreditDetails,omitempty"`
...
func (o *AuthorizerCreditType) GetAuthorizerCreditDetails() AuthorizerCreditDetailsType {
	if o == nil || IsNil(o.AuthorizerCreditDetails) {
		var ret AuthorizerCreditDetailsType
		return ret
	}
...
// SetAuthorizerCreditDetails gets a reference to the given AuthorizerCreditDetailsType and assigns it to the AuthorizerCreditDetails field.
