...
type FbaReimbursementCriteria struct {
	CertificateReconciliationTypes *CertificateReconciliationTypes `json:"certificateReconciliationTypes,omitempty"`
...
func (o *FbaReimbursementCriteria) GetCertificateReconciliationTypes() CertificateReconciliationTypes {
	if o == nil || IsNil(o.CertificateReconciliationTypes) {
		var ret CertificateReconciliationTypes
		return ret
	}
...
// SetCertificateReconciliationTypes gets a reference to the given CertificateReconciliationTypes and assigns it to the CertificateReconciliationTypes field.
