...
type BillingChargesStatus struct {
	...
	Options *CheckPostBillingChargesOptionsType `json:"options,omitempty"`
...
func (o *BillingChargesStatus) GetOptions() CheckPostBillingChargesOptionsType {
	if o == nil || IsNil(o.Options) {
		var ret CheckPostBillingChargesOptionsType
		return ret
	}
	return *o.Options
}
...
// SetOptions gets a reference to the given CheckPostBillingChargesOptionsType and assigns it to the Options field.
