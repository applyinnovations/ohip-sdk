...
func (o *StoredFolioDetails) GetLinks() Links {
...
func (o *StoredFolioDetails) GetLinksOk() (*Links, bool) {
	if o == nil || IsNil(o.Links) {
		return nil, false
	}
	return o.Links, true
...
func (o *StoredFolioDetails) SetLinks(v Links) {
	o.Links = &v
}
...
func (o *StoredFolioDetails) GetWarnings() WarningsType {
...
// and a boolean to check if the value has been set.
func (o *StoredFolioDetails) GetWarningsOk() (*WarningsType, bool) {
	if o == nil || IsNil(o.Warnings) {
		return nil, false
	}
...
func (o *StoredFolioDetails) SetWarnings(v WarningsType) {
	o.Warnings = &v
}
