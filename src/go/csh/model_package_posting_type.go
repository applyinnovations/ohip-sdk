...
func (o *PackagePostingType) GetFinancialTransactionIdList() UniqueIDListType {
...
// and a boolean to check if the value has been set.
func (o *PackagePostingType) GetFinancialTransactionIdListOk() (*UniqueIDListType, bool) {
	if o == nil || IsNil(o.FinancialTransactionIdList) {
		return nil, false
	}
...
func (o *PackagePostingType) SetFinancialTransactionIdList(v UniqueIDListType) {
