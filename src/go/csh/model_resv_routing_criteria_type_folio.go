...
// checks if the ResvRoutingCriteriaTypeFolio type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ResvRoutingCriteriaTypeFolio{}

// ResvRoutingCriteriaTypeFolio Folio routing type.
type ResvRoutingCriteriaTypeFolio struct {
	// Accounts Receivable.
...
func NewResvRoutingCriteriaTypeFolio() *ResvRoutingCriteriaTypeFolio {
	this := ResvRoutingCriteriaTypeFolio{}
	return &this
}
...
func (o ResvRoutingCriteriaTypeFolio) MarshalJSON() ([]byte, error) {
...
func (o ResvRoutingCriteriaTypeFolio) ToMap() (map[string]interface{}, error) {
...
type NullableResvRoutingCriteriaTypeFolio struct {
	value *ResvRoutingCriteriaTypeFolio
	isSet bool
}

func (v NullableResvRoutingCriteriaTypeFolio) Get() *ResvRoutingCriteriaTypeFolio {
	return v.value
}

func (v *NullableResvRoutingCriteriaTypeFolio) Set(val *ResvRoutingCriteriaTypeFolio) {
	v.value = val
	v.isSet = true
}

func (v NullableResvRoutingCriteriaTypeFolio) IsSet() bool {
	return v.isSet
}

func (v *NullableResvRoutingCriteriaTypeFolio) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableResvRoutingCriteriaTypeFolio(val *ResvRoutingCriteriaTypeFolio) *NullableResvRoutingCriteriaTypeFolio {
	return &NullableResvRoutingCriteriaTypeFolio{value: val, isSet: true}
}

func (v NullableResvRoutingCriteriaTypeFolio) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableResvRoutingCriteriaTypeFolio) UnmarshalJSON(src []byte) error {
	v.isSet = true
