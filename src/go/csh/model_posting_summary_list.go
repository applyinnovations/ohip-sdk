...
type PostingSummaryList struct {
	...
	PostingSummaries *PostingSummaryListType `json:"postingSummaries,omitempty"`
...
func (o *PostingSummaryList) GetPostingSummaries() PostingSummaryListType {
	if o == nil || IsNil(o.PostingSummaries) {
		var ret PostingSummaryListType
		return ret
	}
...
// SetPostingSummaries gets a reference to the given PostingSummaryListType and assigns it to the PostingSummaries field.
