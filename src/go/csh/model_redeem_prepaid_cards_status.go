...
type RedeemPrepaidCardsStatus struct {
	PrepaidCards *PrepaidCardsInfoType `json:"prepaidCards,omitempty"`
...
// SetPrepaidCards gets a reference to the given PrepaidCardsInfoType and assigns it to the PrepaidCards field.
