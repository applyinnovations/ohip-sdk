...
type DepositFolioCriteriaType struct {
	...
	Charges *ChargesCriteriaType `json:"charges,omitempty"`
...
// SetCharges gets a reference to the given ChargesCriteriaType and assigns it to the Charges field.
