...
type CompRoutingInstructions struct {
	...
	ResvRoutingInstructions *ResvRoutingInfoListType `json:"resvRoutingInstructions,omitempty"`
...
func (o *CompRoutingInstructions) GetResvRoutingInstructions() ResvRoutingInfoListType {
	if o == nil || IsNil(o.ResvRoutingInstructions) {
		var ret ResvRoutingInfoListType
		return ret
	}
...
// SetResvRoutingInstructions gets a reference to the given ResvRoutingInfoListType and assigns it to the ResvRoutingInstructions field.
