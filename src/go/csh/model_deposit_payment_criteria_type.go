...
type DepositPaymentCriteriaType struct {
	...
	CreditablePaymentTaxes *PaymentTaxesType `json:"creditablePaymentTaxes,omitempty"`
	...
	PrepaidCardRedemptions *PrepaidCardRedemptionsType `json:"prepaidCardRedemptions,omitempty"`
...
// SetCreditablePaymentTaxes gets a reference to the given PaymentTaxesType and assigns it to the CreditablePaymentTaxes field.
...
func (o *DepositPaymentCriteriaType) GetPrepaidCardRedemptions() PrepaidCardRedemptionsType {
	if o == nil || IsNil(o.PrepaidCardRedemptions) {
		var ret PrepaidCardRedemptionsType
		return ret
	}
...
// SetPrepaidCardRedemptions gets a reference to the given PrepaidCardRedemptionsType and assigns it to the PrepaidCardRedemptions field.
