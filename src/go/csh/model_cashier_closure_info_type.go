...
type CashierClosureInfoType struct {
	...
	ReportsList *CashierClosureReportsType `json:"reportsList,omitempty"`
}
...
func (o *CashierClosureInfoType) GetReportsList() CashierClosureReportsType {
	if o == nil || IsNil(o.ReportsList) {
		var ret CashierClosureReportsType
		return ret
	}
...
// SetReportsList gets a reference to the given CashierClosureReportsType and assigns it to the ReportsList field.
