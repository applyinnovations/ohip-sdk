...
type DepositDetailPostingType struct {
	...
	FinancialTransactionIdList *UniqueIDListType `json:"financialTransactionIdList,omitempty"`
	...
	SubPostings *SummaryPostingsType `json:"subPostings,omitempty"`
...
// SetFinancialTransactionIdList gets a reference to the given UniqueIDListType and assigns it to the FinancialTransactionIdList field.
...
// SetSubPostings gets a reference to the given SummaryPostingsType and assigns it to the SubPostings field.
