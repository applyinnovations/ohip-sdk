...
func (o *SummaryPostingType) GetFinancialTransactionIdList() UniqueIDListType {
...
// and a boolean to check if the value has been set.
func (o *SummaryPostingType) GetFinancialTransactionIdListOk() (*UniqueIDListType, bool) {
	if o == nil || IsNil(o.FinancialTransactionIdList) {
		return nil, false
	}
...
func (o *SummaryPostingType) SetFinancialTransactionIdList(v UniqueIDListType) {
