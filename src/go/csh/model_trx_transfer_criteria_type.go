...
type TrxTransferCriteriaType struct {
	...
	TargetReservationIdList *UniqueIDListType `json:"targetReservationIdList,omitempty"`
...
// SetTargetReservationIdList gets a reference to the given UniqueIDListType and assigns it to the TargetReservationIdList field.
