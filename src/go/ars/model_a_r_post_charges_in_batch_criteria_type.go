...
type ARPostChargesInBatchCriteriaType struct {
	AccountIdList *UniqueIDListType `json:"accountIdList,omitempty"`
...
// SetAccountIdList gets a reference to the given UniqueIDListType and assigns it to the AccountIdList field.
