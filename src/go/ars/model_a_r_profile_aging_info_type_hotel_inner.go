...
type ARProfileAgingInfoTypeHotelInner struct {
	AccountAging *ARAccountsType `json:"accountAging,omitempty"`
...
// SetAccountAging gets a reference to the given ARAccountsType and assigns it to the AccountAging field.
