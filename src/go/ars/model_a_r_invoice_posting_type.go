...
func (o *ARInvoicePostingType) GetFinancialTransactionIdList() UniqueIDListType {
...
// and a boolean to check if the value has been set.
func (o *ARInvoicePostingType) GetFinancialTransactionIdListOk() (*UniqueIDListType, bool) {
	if o == nil || IsNil(o.FinancialTransactionIdList) {
		return nil, false
	}
...
func (o *ARInvoicePostingType) SetFinancialTransactionIdList(v UniqueIDListType) {
