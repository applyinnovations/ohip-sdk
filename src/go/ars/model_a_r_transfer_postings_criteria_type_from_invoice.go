...
type ARTransferPostingsCriteriaTypeFromInvoice struct {
	...
	InvoicePostings *ARInvoicePostingsType `json:"invoicePostings,omitempty"`
}
...
// SetInvoicePostings gets a reference to the given ARInvoicePostingsType and assigns it to the InvoicePostings field.
