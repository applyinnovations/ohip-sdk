...
type ARInvoiceCriteriaType struct {
	...
	FolioTexts *FolioTextsType `json:"folioTexts,omitempty"`
...
// SetFolioTexts gets a reference to the given FolioTextsType and assigns it to the FolioTexts field.
