...
`func (o *ARInvoiceCriteriaType) GetFolioTexts() FolioTextsType`

GetFolioTexts returns the FolioTexts field if non-nil, zero value otherwise.

### GetFolioTextsOk

`func (o *ARInvoiceCriteriaType) GetFolioTextsOk() (*FolioTextsType, bool)`
...
`func (o *ARInvoiceCriteriaType) SetFolioTexts(v FolioTextsType)`
