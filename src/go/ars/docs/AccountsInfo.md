...
------------ | ------------- | ------------- | -------------
**AccountsDetails** | Pointer to [**ARAccountsType**](ARAccountsType.md) |  | [optional] 
...
`func (o *AccountsInfo) GetAccountsDetails() ARAccountsType`

GetAccountsDetails returns the AccountsDetails field if non-nil, zero value otherwise.

### GetAccountsDetailsOk

`func (o *AccountsInfo) GetAccountsDetailsOk() (*ARAccountsType, bool)`
...
`func (o *AccountsInfo) SetAccountsDetails(v ARAccountsType)`
...
`func (o *AccountsInfo) GetLinks() Links`

GetLinks returns the Links field if non-nil, zero value otherwise.

### GetLinksOk

`func (o *AccountsInfo) GetLinksOk() (*Links, bool)`
...
`func (o *AccountsInfo) SetLinks(v Links)`
...
`func (o *AccountsInfo) GetWarnings() WarningsType`

GetWarnings returns the Warnings field if non-nil, zero value otherwise.

### GetWarningsOk

`func (o *AccountsInfo) GetWarningsOk() (*WarningsType, bool)`
...
`func (o *AccountsInfo) SetWarnings(v WarningsType)`
