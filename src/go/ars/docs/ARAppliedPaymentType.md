...
`func (o *ARAppliedPaymentType) GetFolioTexts() FolioTextsType`

GetFolioTexts returns the FolioTexts field if non-nil, zero value otherwise.

### GetFolioTextsOk

`func (o *ARAppliedPaymentType) GetFolioTextsOk() (*FolioTextsType, bool)`
...
`func (o *ARAppliedPaymentType) SetFolioTexts(v FolioTextsType)`
