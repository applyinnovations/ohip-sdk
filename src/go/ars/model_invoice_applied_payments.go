...
type InvoiceAppliedPayments struct {
	Details *ARAppliedPaymentsType `json:"details,omitempty"`
...
// SetDetails gets a reference to the given ARAppliedPaymentsType and assigns it to the Details field.
