...
type ARInvoiceCriteriaTypeAdditionalFilter struct {
	...
	TransactionCode *CodeListType `json:"transactionCode,omitempty"`
	TransactionSubGroup *CodeListType `json:"transactionSubGroup,omitempty"`
}
...
// SetTransactionCode gets a reference to the given CodeListType and assigns it to the TransactionCode field.
...
// SetTransactionSubGroup gets a reference to the given CodeListType and assigns it to the TransactionSubGroup field.
