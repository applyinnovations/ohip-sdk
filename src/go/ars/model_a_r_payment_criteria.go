...
type ARPaymentCriteria struct {
	...
	Invoices *ARPaymentInvoicesType `json:"invoices,omitempty"`
...
// SetInvoices gets a reference to the given ARPaymentInvoicesType and assigns it to the Invoices field.
