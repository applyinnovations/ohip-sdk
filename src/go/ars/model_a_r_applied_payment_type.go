...
// checks if the ARAppliedPaymentType type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ARAppliedPaymentType{}

// ARAppliedPaymentType Details of an AR Invoice.
type ARAppliedPaymentType struct {
	...
	AppliedAmount *CurrencyAmountType `json:"appliedAmount,omitempty"`
...
// SetAppliedAmount gets a reference to the given CurrencyAmountType and assigns it to the AppliedAmount field.
...
func (o ARAppliedPaymentType) MarshalJSON() ([]byte, error) {
...
func (o ARAppliedPaymentType) ToMap() (map[string]interface{}, error) {
...
type NullableARAppliedPaymentType struct {
	value *ARAppliedPaymentType
	isSet bool
}

func (v NullableARAppliedPaymentType) Get() *ARAppliedPaymentType {
	return v.value
}

func (v *NullableARAppliedPaymentType) Set(val *ARAppliedPaymentType) {
	v.value = val
	v.isSet = true
}

func (v NullableARAppliedPaymentType) IsSet() bool {
	return v.isSet
}

func (v *NullableARAppliedPaymentType) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableARAppliedPaymentType(val *ARAppliedPaymentType) *NullableARAppliedPaymentType {
	return &NullableARAppliedPaymentType{value: val, isSet: true}
}

func (v NullableARAppliedPaymentType) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableARAppliedPaymentType) UnmarshalJSON(src []byte) error {
	v.isSet = true
