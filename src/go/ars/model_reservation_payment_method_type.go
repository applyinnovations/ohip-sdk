...
type ReservationPaymentMethodType struct {
	...
	EmailFolioInfo *CashieringPaymentMethodTypeEmailFolioInfo `json:"emailFolioInfo,omitempty"`
...
func (o *ReservationPaymentMethodType) GetEmailFolioInfo() CashieringPaymentMethodTypeEmailFolioInfo {
	if o == nil || IsNil(o.EmailFolioInfo) {
		var ret CashieringPaymentMethodTypeEmailFolioInfo
		return ret
	}
...
// SetEmailFolioInfo gets a reference to the given CashieringPaymentMethodTypeEmailFolioInfo and assigns it to the EmailFolioInfo field.
