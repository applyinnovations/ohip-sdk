...
type MemberAwardType struct {
	...
	MemberAwardDetails *MemberAwardDetailsType `json:"memberAwardDetails,omitempty"`
...
func (o *MemberAwardType) GetMemberAwardDetails() MemberAwardDetailsType {
	if o == nil || IsNil(o.MemberAwardDetails) {
		var ret MemberAwardDetailsType
		return ret
	}
...
// SetMemberAwardDetails gets a reference to the given MemberAwardDetailsType and assigns it to the MemberAwardDetails field.
