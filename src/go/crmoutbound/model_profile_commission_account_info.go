...
type ProfileCommissionAccountInfo struct {
	ProfileCommissionAccountInfoList *ProfileCommissionAccountInfoListType `json:"profileCommissionAccountInfoList,omitempty"`
...
func (o *ProfileCommissionAccountInfo) GetProfileCommissionAccountInfoList() ProfileCommissionAccountInfoListType {
	if o == nil || IsNil(o.ProfileCommissionAccountInfoList) {
		var ret ProfileCommissionAccountInfoListType
		return ret
	}
...
// SetProfileCommissionAccountInfoList gets a reference to the given ProfileCommissionAccountInfoListType and assigns it to the ProfileCommissionAccountInfoList field.
