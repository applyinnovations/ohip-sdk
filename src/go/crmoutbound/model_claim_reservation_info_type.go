...
type ClaimReservationInfoType struct {
	...
	ConfirmationNo *UniqueIDListType `json:"confirmationNo,omitempty"`
...
// SetConfirmationNo gets a reference to the given UniqueIDListType and assigns it to the ConfirmationNo field.
