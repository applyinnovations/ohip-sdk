...
type GamingOffers struct {
	GamingOffersInfo *GamingOffersType `json:"gamingOffersInfo,omitempty"`
...
// SetGamingOffersInfo gets a reference to the given GamingOffersType and assigns it to the GamingOffersInfo field.
