...
`func (o *StagedProfileMembershipType) GetBenefits() BenefitsType`

GetBenefits returns the Benefits field if non-nil, zero value otherwise.

### GetBenefitsOk

`func (o *StagedProfileMembershipType) GetBenefitsOk() (*BenefitsType, bool)`
...
`func (o *StagedProfileMembershipType) SetBenefits(v BenefitsType)`
