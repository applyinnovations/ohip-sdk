...
type ResGuestInfoType struct {
	...
	AltGivenName *string `json:"altGivenName,omitempty"`
	...
	AltSurname *string `json:"altSurname,omitempty"`
	...
	AltFullName *string `json:"altFullName,omitempty"`
	// Phone number
	...
	AccompanyGuests *ResAccompanyGuestListType `json:"accompanyGuests,omitempty"`
...
// GetAltGivenName returns the AltGivenName field value if set, zero value otherwise.
func (o *ResGuestInfoType) GetAltGivenName() string {
	if o == nil || IsNil(o.AltGivenName) {
		var ret string
		return ret
	}
	return *o.AltGivenName
}

// GetAltGivenNameOk returns a tuple with the AltGivenName field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ResGuestInfoType) GetAltGivenNameOk() (*string, bool) {
	if o == nil || IsNil(o.AltGivenName) {
		return nil, false
	}
	return o.AltGivenName, true
}
...
// SetAltGivenName gets a reference to the given string and assigns it to the AltGivenName field.
...
// GetAltSurname returns the AltSurname field value if set, zero value otherwise.
func (o *ResGuestInfoType) GetAltSurname() string {
	if o == nil || IsNil(o.AltSurname) {
		var ret string
		return ret
	}
	return *o.AltSurname
...
// GetAltSurnameOk returns a tuple with the AltSurname field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ResGuestInfoType) GetAltSurnameOk() (*string, bool) {
	if o == nil || IsNil(o.AltSurname) {
		return nil, false
	}
	return o.AltSurname, true
}
...
// SetAltSurname gets a reference to the given string and assigns it to the AltSurname field.
...
// GetAltFullName returns the AltFullName field value if set, zero value otherwise.
func (o *ResGuestInfoType) GetAltFullName() string {
	if o == nil || IsNil(o.AltFullName) {
		var ret string
		return ret
	}
	return *o.AltFullName
}

// GetAltFullNameOk returns a tuple with the AltFullName field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ResGuestInfoType) GetAltFullNameOk() (*string, bool) {
	if o == nil || IsNil(o.AltFullName) {
		return nil, false
	}
	return o.AltFullName, true
}
...
// SetAltFullName gets a reference to the given string and assigns it to the AltFullName field.
...
func (o *ResGuestInfoType) GetAccompanyGuests() ResAccompanyGuestListType {
	if o == nil || IsNil(o.AccompanyGuests) {
		var ret ResAccompanyGuestListType
		return ret
	}
...
// SetAccompanyGuests gets a reference to the given ResAccompanyGuestListType and assigns it to the AccompanyGuests field.
...
func (o ResGuestInfoType) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.AltGivenName) {
		toSerialize["altGivenName"] = o.AltGivenName
	}
	...
	if !IsNil(o.AltSurname) {
		toSerialize["altSurname"] = o.AltSurname
	}
	...
	if !IsNil(o.AltFullName) {
		toSerialize["altFullName"] = o.AltFullName
	}
