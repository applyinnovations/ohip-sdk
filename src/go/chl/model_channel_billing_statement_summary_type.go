...
type ChannelBillingStatementSummaryType struct {
	AccountCodeList *CodeListType `json:"accountCodeList,omitempty"`
...
// SetAccountCodeList gets a reference to the given CodeListType and assigns it to the AccountCodeList field.
