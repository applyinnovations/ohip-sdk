...
// checks if the TotalPricingElements type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TotalPricingElements{}

// TotalPricingElements Response object to populate total pricing elements of the GDS channel.
type TotalPricingElements struct {
	...
	TotalPricingElements *TotalPricingElementsType `json:"totalPricingElements,omitempty"`
...
func (o *TotalPricingElements) GetTotalPricingElements() TotalPricingElementsType {
	if o == nil || IsNil(o.TotalPricingElements) {
		var ret TotalPricingElementsType
		return ret
	}
...
// SetTotalPricingElements gets a reference to the given TotalPricingElementsType and assigns it to the TotalPricingElements field.
...
func (o TotalPricingElements) MarshalJSON() ([]byte, error) {
...
func (o TotalPricingElements) ToMap() (map[string]interface{}, error) {
...
type NullableTotalPricingElements struct {
	value *TotalPricingElements
	isSet bool
}

func (v NullableTotalPricingElements) Get() *TotalPricingElements {
	return v.value
}

func (v *NullableTotalPricingElements) Set(val *TotalPricingElements) {
	v.value = val
	v.isSet = true
}

func (v NullableTotalPricingElements) IsSet() bool {
	return v.isSet
}

func (v *NullableTotalPricingElements) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTotalPricingElements(val *TotalPricingElements) *NullableTotalPricingElements {
	return &NullableTotalPricingElements{value: val, isSet: true}
}

func (v NullableTotalPricingElements) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTotalPricingElements) UnmarshalJSON(src []byte) error {
	v.isSet = true
