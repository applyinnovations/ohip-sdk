...
type ChannelAccountInformationType struct {
	...
	ChannelAccountIndicators *IndicatorsType `json:"channelAccountIndicators,omitempty"`
	...
	ContractInformation *ChannelAccountContractsInformationType `json:"contractInformation,omitempty"`
}
...
// SetChannelAccountIndicators gets a reference to the given IndicatorsType and assigns it to the ChannelAccountIndicators field.
...
func (o *ChannelAccountInformationType) GetContractInformation() ChannelAccountContractsInformationType {
	if o == nil || IsNil(o.ContractInformation) {
		var ret ChannelAccountContractsInformationType
		return ret
	}
...
// SetContractInformation gets a reference to the given ChannelAccountContractsInformationType and assigns it to the ContractInformation field.
