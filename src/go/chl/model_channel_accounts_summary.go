...
type ChannelAccountsSummary struct {
	ChannelAccounts *ChannelAccountsSummaryType `json:"channelAccounts,omitempty"`
...
func (o *ChannelAccountsSummary) GetChannelAccounts() ChannelAccountsSummaryType {
	if o == nil || IsNil(o.ChannelAccounts) {
		var ret ChannelAccountsSummaryType
		return ret
	}
...
// SetChannelAccounts gets a reference to the given ChannelAccountsSummaryType and assigns it to the ChannelAccounts field.
