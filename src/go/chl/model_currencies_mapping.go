...
type CurrenciesMapping struct {
	...
	CurrenciesMapping *CurrenciesMappingType `json:"currenciesMapping,omitempty"`
...
// SetCurrenciesMapping gets a reference to the given CurrenciesMappingType and assigns it to the CurrenciesMapping field.
