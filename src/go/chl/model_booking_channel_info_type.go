...
type BookingChannelInfoType struct {
	...
	ConfigurationParameters *ParametersType `json:"configurationParameters,omitempty"`
...
// SetConfigurationParameters gets a reference to the given ParametersType and assigns it to the ConfigurationParameters field.
