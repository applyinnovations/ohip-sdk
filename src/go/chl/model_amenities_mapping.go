...
type AmenitiesMapping struct {
	AmenitiesMapping *AmenitiesMappingType `json:"amenitiesMapping,omitempty"`
...
// SetAmenitiesMapping gets a reference to the given AmenitiesMappingType and assigns it to the AmenitiesMapping field.
