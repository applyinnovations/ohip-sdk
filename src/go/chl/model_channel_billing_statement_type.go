...
type ChannelBillingStatementType struct {
	...
	ChannelAccountStatements *ChannelStatementAccountsType `json:"channelAccountStatements,omitempty"`
...
func (o *ChannelBillingStatementType) GetChannelAccountStatements() ChannelStatementAccountsType {
	if o == nil || IsNil(o.ChannelAccountStatements) {
		var ret ChannelStatementAccountsType
		return ret
	}
...
// SetChannelAccountStatements gets a reference to the given ChannelStatementAccountsType and assigns it to the ChannelAccountStatements field.
