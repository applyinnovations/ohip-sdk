...
type ChannelParameterGroupType struct {
	ChannelParameters *ChannelParametersType `json:"channelParameters,omitempty"`
...
// SetChannelParameters gets a reference to the given ChannelParametersType and assigns it to the ChannelParameters field.
