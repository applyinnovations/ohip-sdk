...
type PutCreditCardsMappingRequest struct {
	CreditCards *CreditCardsMappingType `json:"creditCards,omitempty"`
...
// SetCreditCards gets a reference to the given CreditCardsMappingType and assigns it to the CreditCards field.
