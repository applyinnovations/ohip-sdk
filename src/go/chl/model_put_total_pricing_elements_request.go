...
// checks if the PutTotalPricingElementsRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PutTotalPricingElementsRequest{}

// PutTotalPricingElementsRequest struct for PutTotalPricingElementsRequest
type PutTotalPricingElementsRequest struct {
...
func NewPutTotalPricingElementsRequest() *PutTotalPricingElementsRequest {
	this := PutTotalPricingElementsRequest{}
	return &this
}
...
func (o PutTotalPricingElementsRequest) MarshalJSON() ([]byte, error) {
...
func (o PutTotalPricingElementsRequest) ToMap() (map[string]interface{}, error) {
...
type NullablePutTotalPricingElementsRequest struct {
	value *PutTotalPricingElementsRequest
	isSet bool
}

func (v NullablePutTotalPricingElementsRequest) Get() *PutTotalPricingElementsRequest {
	return v.value
}

func (v *NullablePutTotalPricingElementsRequest) Set(val *PutTotalPricingElementsRequest) {
	v.value = val
	v.isSet = true
}

func (v NullablePutTotalPricingElementsRequest) IsSet() bool {
	return v.isSet
}

func (v *NullablePutTotalPricingElementsRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePutTotalPricingElementsRequest(val *PutTotalPricingElementsRequest) *NullablePutTotalPricingElementsRequest {
	return &NullablePutTotalPricingElementsRequest{value: val, isSet: true}
}

func (v NullablePutTotalPricingElementsRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePutTotalPricingElementsRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
