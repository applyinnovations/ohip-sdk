...
type ChannelAccountContractsType struct {
	...
	ChannelAccountContractsInformation *ChannelAccountContractsInformationType `json:"channelAccountContractsInformation,omitempty"`
...
// SetChannelAccountContractsInformation gets a reference to the given ChannelAccountContractsInformationType and assigns it to the ChannelAccountContractsInformation field.
