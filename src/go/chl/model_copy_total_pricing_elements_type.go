...
type CopyTotalPricingElementsType struct {
	TargetHotels *CodeListType `json:"targetHotels,omitempty"`
...
// SetTargetHotels gets a reference to the given CodeListType and assigns it to the TargetHotels field.
