...
type ChannelSnapshotType struct {
	...
	RestrictionsInfo *RestrictionsInfoType `json:"restrictionsInfo,omitempty"`
...
// SetRestrictionsInfo gets a reference to the given RestrictionsInfoType and assigns it to the RestrictionsInfo field.
