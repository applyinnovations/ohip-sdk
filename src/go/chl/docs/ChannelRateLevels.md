...
`func (o *ChannelRateLevels) GetLinks() Links`

GetLinks returns the Links field if non-nil, zero value otherwise.

### GetLinksOk

`func (o *ChannelRateLevels) GetLinksOk() (*Links, bool)`
...
`func (o *ChannelRateLevels) SetLinks(v Links)`
...
`func (o *ChannelRateLevels) GetWarnings() WarningsType`

GetWarnings returns the Warnings field if non-nil, zero value otherwise.

### GetWarningsOk

`func (o *ChannelRateLevels) GetWarningsOk() (*WarningsType, bool)`
...
`func (o *ChannelRateLevels) SetWarnings(v WarningsType)`
