...
------------ | ------------- | ------------- | -------------
**AmenitiesMapping** | Pointer to [**AmenitiesMappingType**](AmenitiesMappingType.md) |  | [optional] 
...
`func (o *AmenitiesMapping) GetAmenitiesMapping() AmenitiesMappingType`

GetAmenitiesMapping returns the AmenitiesMapping field if non-nil, zero value otherwise.

### GetAmenitiesMappingOk

`func (o *AmenitiesMapping) GetAmenitiesMappingOk() (*AmenitiesMappingType, bool)`
...
`func (o *AmenitiesMapping) SetAmenitiesMapping(v AmenitiesMappingType)`
...
`func (o *AmenitiesMapping) GetLinks() Links`

GetLinks returns the Links field if non-nil, zero value otherwise.

### GetLinksOk

`func (o *AmenitiesMapping) GetLinksOk() (*Links, bool)`
...
`func (o *AmenitiesMapping) SetLinks(v Links)`
...
`func (o *AmenitiesMapping) GetWarnings() WarningsType`

GetWarnings returns the Warnings field if non-nil, zero value otherwise.

### GetWarningsOk

`func (o *AmenitiesMapping) GetWarningsOk() (*WarningsType, bool)`
...
`func (o *AmenitiesMapping) SetWarnings(v WarningsType)`
