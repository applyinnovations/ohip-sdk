...
type ChannelPolicyType struct {
	...
	ChannelMarketingInfo *ChannelMarketingInfoType `json:"channelMarketingInfo,omitempty"`
	...
	Guarantees *GuaranteesInfoType `json:"guarantees,omitempty"`
...
func (o *ChannelPolicyType) GetChannelMarketingInfo() ChannelMarketingInfoType {
	if o == nil || IsNil(o.ChannelMarketingInfo) {
		var ret ChannelMarketingInfoType
		return ret
	}
...
// SetChannelMarketingInfo gets a reference to the given ChannelMarketingInfoType and assigns it to the ChannelMarketingInfo field.
...
// SetGuarantees gets a reference to the given GuaranteesInfoType and assigns it to the Guarantees field.
