...
type ChannelAccountContractInformationType struct {
	...
	ChannelAccountContractElements *ChannelAccountContractElementsType `json:"channelAccountContractElements,omitempty"`
...
// SetChannelAccountContractElements gets a reference to the given ChannelAccountContractElementsType and assigns it to the ChannelAccountContractElements field.
