...
type ChangeChannelSellLimitsByDateRangeRequest struct {
	...
	SellLimits *ChannelSellLimitSchedulesType `json:"sellLimits,omitempty"`
...
func (o *ChangeChannelSellLimitsByDateRangeRequest) GetSellLimits() ChannelSellLimitSchedulesType {
	if o == nil || IsNil(o.SellLimits) {
		var ret ChannelSellLimitSchedulesType
		return ret
	}
	return *o.SellLimits
}
...
// SetSellLimits gets a reference to the given ChannelSellLimitSchedulesType and assigns it to the SellLimits field.
