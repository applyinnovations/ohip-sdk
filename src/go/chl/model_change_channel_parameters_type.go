...
type ChangeChannelParametersType struct {
	ChannelParameters *ChannelParametersSimpleType `json:"channelParameters,omitempty"`
...
func (o *ChangeChannelParametersType) GetChannelParameters() ChannelParametersSimpleType {
	if o == nil || IsNil(o.ChannelParameters) {
		var ret ChannelParametersSimpleType
		return ret
	}
...
// SetChannelParameters gets a reference to the given ChannelParametersSimpleType and assigns it to the ChannelParameters field.
