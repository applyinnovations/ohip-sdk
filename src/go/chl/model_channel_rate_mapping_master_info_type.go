...
type ChannelRateMappingMasterInfoType struct {
	...
	SourceDescriptions *ChannelRateMappingsSourceDescriptionsType `json:"sourceDescriptions,omitempty"`
}
...
func (o *ChannelRateMappingMasterInfoType) GetSourceDescriptions() ChannelRateMappingsSourceDescriptionsType {
	if o == nil || IsNil(o.SourceDescriptions) {
		var ret ChannelRateMappingsSourceDescriptionsType
		return ret
	}
...
// SetSourceDescriptions gets a reference to the given ChannelRateMappingsSourceDescriptionsType and assigns it to the SourceDescriptions field.
