...
// checks if the PutChannelsRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PutChannelsRequest{}

// PutChannelsRequest struct for PutChannelsRequest
...
func (o PutChannelsRequest) MarshalJSON() ([]byte, error) {
...
func (o PutChannelsRequest) ToMap() (map[string]interface{}, error) {
...
type NullablePutChannelsRequest struct {
	value *PutChannelsRequest
	isSet bool
}

func (v NullablePutChannelsRequest) Get() *PutChannelsRequest {
	return v.value
}

func (v *NullablePutChannelsRequest) Set(val *PutChannelsRequest) {
	v.value = val
	v.isSet = true
}

func (v NullablePutChannelsRequest) IsSet() bool {
	return v.isSet
}

func (v *NullablePutChannelsRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePutChannelsRequest(val *PutChannelsRequest) *NullablePutChannelsRequest {
	return &NullablePutChannelsRequest{value: val, isSet: true}
}

func (v NullablePutChannelsRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePutChannelsRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
