...
type ChannelStatementDetailType struct {
	...
	OrderByList *OrderByListType `json:"orderByList,omitempty"`
...
// SetOrderByList gets a reference to the given OrderByListType and assigns it to the OrderByList field.
