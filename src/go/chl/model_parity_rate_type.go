...
type ParityRateType struct {
	AdditionalAmounts *AdditionalAmountListType `json:"additionalAmounts,omitempty"`
	AdditionalDetailList *AdditionalDetailListType `json:"additionalDetailList,omitempty"`
	// A monetary amount.
...
func (o *ParityRateType) GetAdditionalAmounts() AdditionalAmountListType {
	if o == nil || IsNil(o.AdditionalAmounts) {
		var ret AdditionalAmountListType
		return ret
	}
...
// SetAdditionalAmounts gets a reference to the given AdditionalAmountListType and assigns it to the AdditionalAmounts field.
...
func (o *ParityRateType) GetAdditionalDetailList() AdditionalDetailListType {
	if o == nil || IsNil(o.AdditionalDetailList) {
		var ret AdditionalDetailListType
		return ret
	}
...
// SetAdditionalDetailList gets a reference to the given AdditionalDetailListType and assigns it to the AdditionalDetailList field.
