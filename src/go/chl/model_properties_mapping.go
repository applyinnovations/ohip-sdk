...
// checks if the PropertiesMapping type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PropertiesMapping{}

// PropertiesMapping Response object for fetching external system properties.
type PropertiesMapping struct {
	...
	PropertiesMapping *PropertiesMappingType `json:"propertiesMapping,omitempty"`
...
// SetPropertiesMapping gets a reference to the given PropertiesMappingType and assigns it to the PropertiesMapping field.
...
func (o PropertiesMapping) MarshalJSON() ([]byte, error) {
...
func (o PropertiesMapping) ToMap() (map[string]interface{}, error) {
...
type NullablePropertiesMapping struct {
	value *PropertiesMapping
	isSet bool
}

func (v NullablePropertiesMapping) Get() *PropertiesMapping {
	return v.value
}

func (v *NullablePropertiesMapping) Set(val *PropertiesMapping) {
	v.value = val
	v.isSet = true
}

func (v NullablePropertiesMapping) IsSet() bool {
	return v.isSet
}

func (v *NullablePropertiesMapping) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePropertiesMapping(val *PropertiesMapping) *NullablePropertiesMapping {
	return &NullablePropertiesMapping{value: val, isSet: true}
}

func (v NullablePropertiesMapping) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePropertiesMapping) UnmarshalJSON(src []byte) error {
	v.isSet = true
