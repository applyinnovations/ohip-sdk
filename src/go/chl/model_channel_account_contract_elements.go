...
type ChannelAccountContractElements struct {
	ContractElements *ChannelAccountContractElementsType `json:"contractElements,omitempty"`
...
func (o *ChannelAccountContractElements) GetContractElements() ChannelAccountContractElementsType {
	if o == nil || IsNil(o.ContractElements) {
		var ret ChannelAccountContractElementsType
		return ret
	}
...
// SetContractElements gets a reference to the given ChannelAccountContractElementsType and assigns it to the ContractElements field.
