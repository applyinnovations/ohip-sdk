...
// checks if the CreditCardsMapping type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreditCardsMapping{}

// CreditCardsMapping Response object for fetching external system credit cards.
type CreditCardsMapping struct {
	// Total number of rows returned
	Count *int32 `json:"count,omitempty"`
	CreditCardsMapping *CreditCardsMappingType `json:"creditCardsMapping,omitempty"`
...
// GetCreditCardsMapping returns the CreditCardsMapping field value if set, zero value otherwise.
func (o *CreditCardsMapping) GetCreditCardsMapping() CreditCardsMappingType {
	if o == nil || IsNil(o.CreditCardsMapping) {
		var ret CreditCardsMappingType
		return ret
	}
	return *o.CreditCardsMapping
}

// GetCreditCardsMappingOk returns a tuple with the CreditCardsMapping field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *CreditCardsMapping) GetCreditCardsMappingOk() (*CreditCardsMappingType, bool) {
	if o == nil || IsNil(o.CreditCardsMapping) {
		return nil, false
	}
	return o.CreditCardsMapping, true
}
...
// SetCreditCardsMapping gets a reference to the given CreditCardsMappingType and assigns it to the CreditCardsMapping field.
func (o *CreditCardsMapping) SetCreditCardsMapping(v CreditCardsMappingType) {
	o.CreditCardsMapping = &v
}
...
func (o CreditCardsMapping) MarshalJSON() ([]byte, error) {
...
func (o CreditCardsMapping) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.Count) {
		toSerialize["count"] = o.Count
	}
	if !IsNil(o.CreditCardsMapping) {
		toSerialize["creditCardsMapping"] = o.CreditCardsMapping
	}
	if !IsNil(o.HasMore) {
...
type NullableCreditCardsMapping struct {
	value *CreditCardsMapping
	isSet bool
}

func (v NullableCreditCardsMapping) Get() *CreditCardsMapping {
	return v.value
}

func (v *NullableCreditCardsMapping) Set(val *CreditCardsMapping) {
	v.value = val
	v.isSet = true
}

func (v NullableCreditCardsMapping) IsSet() bool {
	return v.isSet
}

func (v *NullableCreditCardsMapping) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreditCardsMapping(val *CreditCardsMapping) *NullableCreditCardsMapping {
	return &NullableCreditCardsMapping{value: val, isSet: true}
}

func (v NullableCreditCardsMapping) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreditCardsMapping) UnmarshalJSON(src []byte) error {
	v.isSet = true
