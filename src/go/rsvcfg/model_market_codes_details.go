...
type MarketCodesDetails struct {
	...
	MarketCodes *MarketCodesType `json:"marketCodes,omitempty"`
...
// SetMarketCodes gets a reference to the given MarketCodesType and assigns it to the MarketCodes field.
