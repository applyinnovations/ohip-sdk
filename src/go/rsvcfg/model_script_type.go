...
type ScriptType struct {
	...
	MergeCodes *MergeCodesType `json:"mergeCodes,omitempty"`
	// Script.
...
// SetMergeCodes gets a reference to the given MergeCodesType and assigns it to the MergeCodes field.
