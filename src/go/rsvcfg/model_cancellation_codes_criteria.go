...
func (o *CancellationCodesCriteria) GetCancellationCodes() CancellationCodesType {
...
func (o *CancellationCodesCriteria) GetCancellationCodesOk() (*CancellationCodesType, bool) {
	if o == nil || IsNil(o.CancellationCodes) {
		return nil, false
	}
...
func (o *CancellationCodesCriteria) SetCancellationCodes(v CancellationCodesType) {
	o.CancellationCodes = &v
}

// GetLinks returns the Links field value if set, zero value otherwise.
func (o *CancellationCodesCriteria) GetLinks() Links {
...
// and a boolean to check if the value has been set.
func (o *CancellationCodesCriteria) GetLinksOk() (*Links, bool) {
	if o == nil || IsNil(o.Links) {
		return nil, false
	}
	return o.Links, true
...
func (o *CancellationCodesCriteria) SetLinks(v Links) {
	o.Links = &v
}

// GetWarnings returns the Warnings field value if set, zero value otherwise.
func (o *CancellationCodesCriteria) GetWarnings() WarningsType {
...
// and a boolean to check if the value has been set.
func (o *CancellationCodesCriteria) GetWarningsOk() (*WarningsType, bool) {
	if o == nil || IsNil(o.Warnings) {
		return nil, false
	}
...
func (o *CancellationCodesCriteria) SetWarnings(v WarningsType) {
	o.Warnings = &v
}
