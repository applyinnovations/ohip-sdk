...
// checks if the ChangeBlockRankingsRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ChangeBlockRankingsRequest{}

// ChangeBlockRankingsRequest struct for ChangeBlockRankingsRequest
type ChangeBlockRankingsRequest struct {
...
func NewChangeBlockRankingsRequest() *ChangeBlockRankingsRequest {
	this := ChangeBlockRankingsRequest{}
	return &this
}
...
func (o ChangeBlockRankingsRequest) MarshalJSON() ([]byte, error) {
...
func (o ChangeBlockRankingsRequest) ToMap() (map[string]interface{}, error) {
...
type NullableChangeBlockRankingsRequest struct {
	value *ChangeBlockRankingsRequest
	isSet bool
}

func (v NullableChangeBlockRankingsRequest) Get() *ChangeBlockRankingsRequest {
	return v.value
}

func (v *NullableChangeBlockRankingsRequest) Set(val *ChangeBlockRankingsRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableChangeBlockRankingsRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableChangeBlockRankingsRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableChangeBlockRankingsRequest(val *ChangeBlockRankingsRequest) *NullableChangeBlockRankingsRequest {
	return &NullableChangeBlockRankingsRequest{value: val, isSet: true}
}

func (v NullableChangeBlockRankingsRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableChangeBlockRankingsRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
