...
`func (o *GlobalAlerts) GetGlobalAlerts() GlobalAlertsType`

GetGlobalAlerts returns the GlobalAlerts field if non-nil, zero value otherwise.

### GetGlobalAlertsOk

`func (o *GlobalAlerts) GetGlobalAlertsOk() (*GlobalAlertsType, bool)`
...
`func (o *GlobalAlerts) SetGlobalAlerts(v GlobalAlertsType)`
...
`func (o *GlobalAlerts) GetLinks() Links`

GetLinks returns the Links field if non-nil, zero value otherwise.

### GetLinksOk

`func (o *GlobalAlerts) GetLinksOk() (*Links, bool)`
...
`func (o *GlobalAlerts) SetLinks(v Links)`
...
`func (o *GlobalAlerts) GetWarnings() WarningsType`

GetWarnings returns the Warnings field if non-nil, zero value otherwise.

### GetWarningsOk

`func (o *GlobalAlerts) GetWarningsOk() (*WarningsType, bool)`
...
`func (o *GlobalAlerts) SetWarnings(v WarningsType)`
