...
------------ | ------------- | ------------- | -------------
**Channels** | Pointer to [**CodeListType**](CodeListType.md) |  | [optional] 
...
**MembershipTypes** | Pointer to [**CodeListType**](CodeListType.md) |  | [optional] 
**OccupancyLevelsType** | Pointer to [**ConfigOccupancyLevelsType**](ConfigOccupancyLevelsType.md) |  | [optional] 
**RateCategories** | Pointer to [**CodeListType**](CodeListType.md) |  | [optional] 
