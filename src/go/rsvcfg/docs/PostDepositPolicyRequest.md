...
`func (o *PostDepositPolicyRequest) GetLinks() Links`

GetLinks returns the Links field if non-nil, zero value otherwise.

### GetLinksOk

`func (o *PostDepositPolicyRequest) GetLinksOk() (*Links, bool)`
...
`func (o *PostDepositPolicyRequest) SetLinks(v Links)`
...
`func (o *PostDepositPolicyRequest) GetWarnings() WarningsType`

GetWarnings returns the Warnings field if non-nil, zero value otherwise.

### GetWarningsOk

`func (o *PostDepositPolicyRequest) GetWarningsOk() (*WarningsType, bool)`
...
`func (o *PostDepositPolicyRequest) SetWarnings(v WarningsType)`
