...
`func (o *PostTemplateDepositPolicyRequest) GetLinks() Links`

GetLinks returns the Links field if non-nil, zero value otherwise.

### GetLinksOk

`func (o *PostTemplateDepositPolicyRequest) GetLinksOk() (*Links, bool)`
...
`func (o *PostTemplateDepositPolicyRequest) SetLinks(v Links)`
...
`func (o *PostTemplateDepositPolicyRequest) GetWarnings() WarningsType`

GetWarnings returns the Warnings field if non-nil, zero value otherwise.

### GetWarningsOk

`func (o *PostTemplateDepositPolicyRequest) GetWarningsOk() (*WarningsType, bool)`
...
`func (o *PostTemplateDepositPolicyRequest) SetWarnings(v WarningsType)`
