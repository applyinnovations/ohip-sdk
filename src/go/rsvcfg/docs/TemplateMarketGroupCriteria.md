...
`func (o *TemplateMarketGroupCriteria) GetLinks() Links`

GetLinks returns the Links field if non-nil, zero value otherwise.

### GetLinksOk

`func (o *TemplateMarketGroupCriteria) GetLinksOk() (*Links, bool)`
...
`func (o *TemplateMarketGroupCriteria) SetLinks(v Links)`
...
`func (o *TemplateMarketGroupCriteria) GetWarnings() WarningsType`

GetWarnings returns the Warnings field if non-nil, zero value otherwise.

### GetWarningsOk

`func (o *TemplateMarketGroupCriteria) GetWarningsOk() (*WarningsType, bool)`
...
`func (o *TemplateMarketGroupCriteria) SetWarnings(v WarningsType)`
