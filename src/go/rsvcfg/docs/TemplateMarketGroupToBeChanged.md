...
`func (o *TemplateMarketGroupToBeChanged) GetLinks() Links`

GetLinks returns the Links field if non-nil, zero value otherwise.

### GetLinksOk

`func (o *TemplateMarketGroupToBeChanged) GetLinksOk() (*Links, bool)`
...
`func (o *TemplateMarketGroupToBeChanged) SetLinks(v Links)`
...
`func (o *TemplateMarketGroupToBeChanged) GetWarnings() WarningsType`

GetWarnings returns the Warnings field if non-nil, zero value otherwise.

### GetWarningsOk

`func (o *TemplateMarketGroupToBeChanged) GetWarningsOk() (*WarningsType, bool)`
...
`func (o *TemplateMarketGroupToBeChanged) SetWarnings(v WarningsType)`
