...
func (o *RoomFeatureRatings) GetLinks() Links {
...
func (o *RoomFeatureRatings) GetLinksOk() (*Links, bool) {
	if o == nil || IsNil(o.Links) {
		return nil, false
	}
	return o.Links, true
...
func (o *RoomFeatureRatings) SetLinks(v Links) {
	o.Links = &v
}

// GetRoomFeatureRatingsInfo returns the RoomFeatureRatingsInfo field value if set, zero value otherwise.
func (o *RoomFeatureRatings) GetRoomFeatureRatingsInfo() RoomFeatureRatingsInfoType {
...
// and a boolean to check if the value has been set.
func (o *RoomFeatureRatings) GetRoomFeatureRatingsInfoOk() (*RoomFeatureRatingsInfoType, bool) {
	if o == nil || IsNil(o.RoomFeatureRatingsInfo) {
		return nil, false
	}
...
func (o *RoomFeatureRatings) SetRoomFeatureRatingsInfo(v RoomFeatureRatingsInfoType) {
	o.RoomFeatureRatingsInfo = &v
}

// GetWarnings returns the Warnings field value if set, zero value otherwise.
func (o *RoomFeatureRatings) GetWarnings() WarningsType {
...
// and a boolean to check if the value has been set.
func (o *RoomFeatureRatings) GetWarningsOk() (*WarningsType, bool) {
	if o == nil || IsNil(o.Warnings) {
		return nil, false
	}
...
func (o *RoomFeatureRatings) SetWarnings(v WarningsType) {
	o.Warnings = &v
}
