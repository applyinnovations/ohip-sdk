...
type PutGuestMessageTemplatesRequest struct {
	GuestMessageTemplates *GuestMessageTemplatesType `json:"guestMessageTemplates,omitempty"`
...
func (o *PutGuestMessageTemplatesRequest) GetGuestMessageTemplates() GuestMessageTemplatesType {
	if o == nil || IsNil(o.GuestMessageTemplates) {
		var ret GuestMessageTemplatesType
		return ret
	}
...
// SetGuestMessageTemplates gets a reference to the given GuestMessageTemplatesType and assigns it to the GuestMessageTemplates field.
