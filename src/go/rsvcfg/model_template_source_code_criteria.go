...
func (o *TemplateSourceCodeCriteria) GetLinks() Links {
...
func (o *TemplateSourceCodeCriteria) GetLinksOk() (*Links, bool) {
	if o == nil || IsNil(o.Links) {
		return nil, false
	}
	return o.Links, true
...
func (o *TemplateSourceCodeCriteria) SetLinks(v Links) {
	o.Links = &v
}
...
func (o *TemplateSourceCodeCriteria) GetWarnings() WarningsType {
...
// and a boolean to check if the value has been set.
func (o *TemplateSourceCodeCriteria) GetWarningsOk() (*WarningsType, bool) {
	if o == nil || IsNil(o.Warnings) {
		return nil, false
	}
...
func (o *TemplateSourceCodeCriteria) SetWarnings(v WarningsType) {
	o.Warnings = &v
}
