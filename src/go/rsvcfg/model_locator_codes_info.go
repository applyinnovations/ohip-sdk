...
// checks if the LocatorCodesInfo type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &LocatorCodesInfo{}

// LocatorCodesInfo Response object for fetching locator codes.
type LocatorCodesInfo struct {
...
func (o LocatorCodesInfo) MarshalJSON() ([]byte, error) {
...
func (o LocatorCodesInfo) ToMap() (map[string]interface{}, error) {
...
type NullableLocatorCodesInfo struct {
	value *LocatorCodesInfo
	isSet bool
}

func (v NullableLocatorCodesInfo) Get() *LocatorCodesInfo {
	return v.value
}

func (v *NullableLocatorCodesInfo) Set(val *LocatorCodesInfo) {
	v.value = val
	v.isSet = true
}

func (v NullableLocatorCodesInfo) IsSet() bool {
	return v.isSet
}

func (v *NullableLocatorCodesInfo) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableLocatorCodesInfo(val *LocatorCodesInfo) *NullableLocatorCodesInfo {
	return &NullableLocatorCodesInfo{value: val, isSet: true}
}

func (v NullableLocatorCodesInfo) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableLocatorCodesInfo) UnmarshalJSON(src []byte) error {
	v.isSet = true
