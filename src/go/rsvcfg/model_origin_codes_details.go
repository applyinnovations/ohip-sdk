...
func (o *OriginCodesDetails) GetLinks() Links {
...
func (o *OriginCodesDetails) GetLinksOk() (*Links, bool) {
	if o == nil || IsNil(o.Links) {
		return nil, false
	}
	return o.Links, true
...
func (o *OriginCodesDetails) SetLinks(v Links) {
	o.Links = &v
}

// GetOriginCodes returns the OriginCodes field value if set, zero value otherwise.
func (o *OriginCodesDetails) GetOriginCodes() OriginCodesType {
...
// and a boolean to check if the value has been set.
func (o *OriginCodesDetails) GetOriginCodesOk() (*OriginCodesType, bool) {
	if o == nil || IsNil(o.OriginCodes) {
		return nil, false
	}
...
func (o *OriginCodesDetails) SetOriginCodes(v OriginCodesType) {
	o.OriginCodes = &v
}

// GetWarnings returns the Warnings field value if set, zero value otherwise.
func (o *OriginCodesDetails) GetWarnings() WarningsType {
...
// and a boolean to check if the value has been set.
func (o *OriginCodesDetails) GetWarningsOk() (*WarningsType, bool) {
	if o == nil || IsNil(o.Warnings) {
		return nil, false
	}
...
func (o *OriginCodesDetails) SetWarnings(v WarningsType) {
	o.Warnings = &v
}
