...
func (o *GuestMessages) GetGuestMessages() GuestMessageCodesType {
...
func (o *GuestMessages) GetGuestMessagesOk() (*GuestMessageCodesType, bool) {
	if o == nil || IsNil(o.GuestMessages) {
		return nil, false
	}
...
func (o *GuestMessages) SetGuestMessages(v GuestMessageCodesType) {
	o.GuestMessages = &v
}
