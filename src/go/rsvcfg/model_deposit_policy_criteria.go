...
func (o *DepositPolicyCriteria) GetLinks() Links {
...
// and a boolean to check if the value has been set.
func (o *DepositPolicyCriteria) GetLinksOk() (*Links, bool) {
	if o == nil || IsNil(o.Links) {
		return nil, false
	}
	return o.Links, true
...
func (o *DepositPolicyCriteria) SetLinks(v Links) {
	o.Links = &v
}

// GetWarnings returns the Warnings field value if set, zero value otherwise.
func (o *DepositPolicyCriteria) GetWarnings() WarningsType {
...
// and a boolean to check if the value has been set.
func (o *DepositPolicyCriteria) GetWarningsOk() (*WarningsType, bool) {
	if o == nil || IsNil(o.Warnings) {
		return nil, false
	}
...
func (o *DepositPolicyCriteria) SetWarnings(v WarningsType) {
	o.Warnings = &v
}
