...
func (o *PreCheckInRuleType) GetMemberships() MembershipTypeLevelListType {
	if o == nil || IsNil(o.Memberships) {
		var ret MembershipTypeLevelListType
		return ret
	}
...
// SetMemberships gets a reference to the given MembershipTypeLevelListType and assigns it to the Memberships field.
...
// SetOriginCodes gets a reference to the given CodeListType and assigns it to the OriginCodes field.
...
// SetRatePlans gets a reference to the given CodeListType and assigns it to the RatePlans field.
...
// SetSpecials gets a reference to the given CodeListType and assigns it to the Specials field.
...
// SetVIPCodes gets a reference to the given CodeListType and assigns it to the VIPCodes field.
