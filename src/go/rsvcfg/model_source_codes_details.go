...
// checks if the SourceCodesDetails type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SourceCodesDetails{}

// SourceCodesDetails Response for fetch Source Codes.
type SourceCodesDetails struct {
	...
	SourceCodes *SourceCodesType `json:"sourceCodes,omitempty"`
...
// SetSourceCodes gets a reference to the given SourceCodesType and assigns it to the SourceCodes field.
...
func (o SourceCodesDetails) MarshalJSON() ([]byte, error) {
...
func (o SourceCodesDetails) ToMap() (map[string]interface{}, error) {
...
type NullableSourceCodesDetails struct {
	value *SourceCodesDetails
	isSet bool
}

func (v NullableSourceCodesDetails) Get() *SourceCodesDetails {
	return v.value
}

func (v *NullableSourceCodesDetails) Set(val *SourceCodesDetails) {
	v.value = val
	v.isSet = true
}

func (v NullableSourceCodesDetails) IsSet() bool {
	return v.isSet
}

func (v *NullableSourceCodesDetails) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSourceCodesDetails(val *SourceCodesDetails) *NullableSourceCodesDetails {
	return &NullableSourceCodesDetails{value: val, isSet: true}
}

func (v NullableSourceCodesDetails) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSourceCodesDetails) UnmarshalJSON(src []byte) error {
	v.isSet = true
