...
type UpsellRulesToTestDetails struct {
	...
	UpsellRules *ConfigTestUpsellRulesType `json:"upsellRules,omitempty"`
...
func (o *UpsellRulesToTestDetails) GetUpsellRules() ConfigTestUpsellRulesType {
	if o == nil || IsNil(o.UpsellRules) {
		var ret ConfigTestUpsellRulesType
		return ret
	}
...
// SetUpsellRules gets a reference to the given ConfigTestUpsellRulesType and assigns it to the UpsellRules field.
