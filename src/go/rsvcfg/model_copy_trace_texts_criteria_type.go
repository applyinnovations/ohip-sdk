...
type CopyTraceTextsCriteriaType struct {
	TargetHotels *HotelCodeListType `json:"targetHotels,omitempty"`
...
// SetTargetHotels gets a reference to the given HotelCodeListType and assigns it to the TargetHotels field.
