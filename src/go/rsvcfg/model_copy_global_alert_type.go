...
type CopyGlobalAlertType struct {
	ResvAlertIds *UniqueIDListType `json:"resvAlertIds,omitempty"`
...
// SetResvAlertIds gets a reference to the given UniqueIDListType and assigns it to the ResvAlertIds field.
