...
func (o *PostTemplateMarketCodeRequest) GetLinks() Links {
...
func (o *PostTemplateMarketCodeRequest) GetLinksOk() (*Links, bool) {
	if o == nil || IsNil(o.Links) {
		return nil, false
	}
	return o.Links, true
...
func (o *PostTemplateMarketCodeRequest) SetLinks(v Links) {
	o.Links = &v
}
...
func (o *PostTemplateMarketCodeRequest) GetWarnings() WarningsType {
...
// and a boolean to check if the value has been set.
func (o *PostTemplateMarketCodeRequest) GetWarningsOk() (*WarningsType, bool) {
	if o == nil || IsNil(o.Warnings) {
		return nil, false
	}
...
func (o *PostTemplateMarketCodeRequest) SetWarnings(v WarningsType) {
	o.Warnings = &v
}
