...
type TraceTextChanges struct {
	...
	TraceTexts *TraceTextChangesType `json:"traceTexts,omitempty"`
...
// SetTraceTexts gets a reference to the given TraceTextChangesType and assigns it to the TraceTexts field.
