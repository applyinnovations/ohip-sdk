...
// checks if the GuaranteeCodeScheduleCriteria type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GuaranteeCodeScheduleCriteria{}

// GuaranteeCodeScheduleCriteria Creates the Guarantee Code schedule based on the details provided by the request.
type GuaranteeCodeScheduleCriteria struct {
...
func NewGuaranteeCodeScheduleCriteria() *GuaranteeCodeScheduleCriteria {
	this := GuaranteeCodeScheduleCriteria{}
	return &this
}
...
func (o *GuaranteeCodeScheduleCriteria) GetLinks() Links {
...
// and a boolean to check if the value has been set.
func (o *GuaranteeCodeScheduleCriteria) GetLinksOk() (*Links, bool) {
	if o == nil || IsNil(o.Links) {
		return nil, false
	}
	return o.Links, true
...
func (o *GuaranteeCodeScheduleCriteria) SetLinks(v Links) {
	o.Links = &v
}

// GetWarnings returns the Warnings field value if set, zero value otherwise.
func (o *GuaranteeCodeScheduleCriteria) GetWarnings() WarningsType {
...
// and a boolean to check if the value has been set.
func (o *GuaranteeCodeScheduleCriteria) GetWarningsOk() (*WarningsType, bool) {
	if o == nil || IsNil(o.Warnings) {
		return nil, false
	}
...
func (o *GuaranteeCodeScheduleCriteria) SetWarnings(v WarningsType) {
	o.Warnings = &v
}

func (o GuaranteeCodeScheduleCriteria) MarshalJSON() ([]byte, error) {
...
func (o GuaranteeCodeScheduleCriteria) ToMap() (map[string]interface{}, error) {
...
type NullableGuaranteeCodeScheduleCriteria struct {
	value *GuaranteeCodeScheduleCriteria
	isSet bool
}

func (v NullableGuaranteeCodeScheduleCriteria) Get() *GuaranteeCodeScheduleCriteria {
	return v.value
}

func (v *NullableGuaranteeCodeScheduleCriteria) Set(val *GuaranteeCodeScheduleCriteria) {
	v.value = val
	v.isSet = true
}

func (v NullableGuaranteeCodeScheduleCriteria) IsSet() bool {
	return v.isSet
}

func (v *NullableGuaranteeCodeScheduleCriteria) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGuaranteeCodeScheduleCriteria(val *GuaranteeCodeScheduleCriteria) *NullableGuaranteeCodeScheduleCriteria {
	return &NullableGuaranteeCodeScheduleCriteria{value: val, isSet: true}
}

func (v NullableGuaranteeCodeScheduleCriteria) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGuaranteeCodeScheduleCriteria) UnmarshalJSON(src []byte) error {
	v.isSet = true
