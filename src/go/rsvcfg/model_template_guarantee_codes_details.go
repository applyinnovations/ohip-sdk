...
type TemplateGuaranteeCodesDetails struct {
	...
	GuaranteeCodes *TemplateGuaranteeCodesType `json:"guaranteeCodes,omitempty"`
...
func (o *TemplateGuaranteeCodesDetails) GetGuaranteeCodes() TemplateGuaranteeCodesType {
	if o == nil || IsNil(o.GuaranteeCodes) {
		var ret TemplateGuaranteeCodesType
		return ret
	}
...
// SetGuaranteeCodes gets a reference to the given TemplateGuaranteeCodesType and assigns it to the GuaranteeCodes field.
