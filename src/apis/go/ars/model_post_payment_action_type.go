...
const (
	BILLING PostPaymentActionType = "Billing"
	SETTLEFOLIO PostPaymentActionType = "Settlefolio"
	DEPOSIT PostPaymentActionType = "Deposit"
	COMPREDEMPTION PostPaymentActionType = "Compredemption"
	PREPAIDCARDREDEMPTION PostPaymentActionType = "Prepaidcardredemption"
)
