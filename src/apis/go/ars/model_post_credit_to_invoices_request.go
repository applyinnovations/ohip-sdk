...
// checks if the PostCreditToInvoicesRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PostCreditToInvoicesRequest{}

// PostCreditToInvoicesRequest struct for PostCreditToInvoicesRequest
type PostCreditToInvoicesRequest struct {
...
func NewPostCreditToInvoicesRequest() *PostCreditToInvoicesRequest {
	this := PostCreditToInvoicesRequest{}
	return &this
}
...
func (o PostCreditToInvoicesRequest) MarshalJSON() ([]byte, error) {
...
func (o PostCreditToInvoicesRequest) ToMap() (map[string]interface{}, error) {
...
type NullablePostCreditToInvoicesRequest struct {
	value *PostCreditToInvoicesRequest
	isSet bool
}

func (v NullablePostCreditToInvoicesRequest) Get() *PostCreditToInvoicesRequest {
	return v.value
}

func (v *NullablePostCreditToInvoicesRequest) Set(val *PostCreditToInvoicesRequest) {
	v.value = val
	v.isSet = true
}

func (v NullablePostCreditToInvoicesRequest) IsSet() bool {
	return v.isSet
}

func (v *NullablePostCreditToInvoicesRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePostCreditToInvoicesRequest(val *PostCreditToInvoicesRequest) *NullablePostCreditToInvoicesRequest {
	return &NullablePostCreditToInvoicesRequest{value: val, isSet: true}
}

func (v NullablePostCreditToInvoicesRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePostCreditToInvoicesRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
