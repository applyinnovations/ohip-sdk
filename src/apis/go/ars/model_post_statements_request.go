...
// checks if the PostStatementsRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PostStatementsRequest{}

// PostStatementsRequest struct for PostStatementsRequest
type PostStatementsRequest struct {
...
func (o PostStatementsRequest) MarshalJSON() ([]byte, error) {
...
func (o PostStatementsRequest) ToMap() (map[string]interface{}, error) {
...
type NullablePostStatementsRequest struct {
	value *PostStatementsRequest
	isSet bool
}

func (v NullablePostStatementsRequest) Get() *PostStatementsRequest {
	return v.value
}

func (v *NullablePostStatementsRequest) Set(val *PostStatementsRequest) {
	v.value = val
	v.isSet = true
}

func (v NullablePostStatementsRequest) IsSet() bool {
	return v.isSet
}

func (v *NullablePostStatementsRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePostStatementsRequest(val *PostStatementsRequest) *NullablePostStatementsRequest {
	return &NullablePostStatementsRequest{value: val, isSet: true}
}

func (v NullablePostStatementsRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePostStatementsRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
