...
// Date of the trace.
func (r AccountsReceivablesApiDeleteAccountTraceRequest) TraceOn(traceOn time.Time) AccountsReceivablesApiDeleteAccountTraceRequest {
	r.traceOn = &traceOn
	return r
}
...
type AccountsReceivablesApiDeleteAccountsReceivableServiceCacheRequest struct {
	ctx context.Context
	ApiService *AccountsReceivablesApiService
	authorization *string
	xAppKey *string
...
// Bearer token that needs to be passed which is generated post user authentication
func (r AccountsReceivablesApiDeleteAccountsReceivableServiceCacheRequest) Authorization(authorization string) AccountsReceivablesApiDeleteAccountsReceivableServiceCacheRequest {
	r.authorization = &authorization
	return r
}

// Client or Partner’s Application Key
func (r AccountsReceivablesApiDeleteAccountsReceivableServiceCacheRequest) XAppKey(xAppKey string) AccountsReceivablesApiDeleteAccountsReceivableServiceCacheRequest {
	r.xAppKey = &xAppKey
	return r
}

// Mandatory parameter to identify the hotel code where the end user is logged in
func (r AccountsReceivablesApiDeleteAccountsReceivableServiceCacheRequest) XHotelid(xHotelid string) AccountsReceivablesApiDeleteAccountsReceivableServiceCacheRequest {
	r.xHotelid = &xHotelid
	return r
}

// External system code.
func (r AccountsReceivablesApiDeleteAccountsReceivableServiceCacheRequest) XExternalsystem(xExternalsystem string) AccountsReceivablesApiDeleteAccountsReceivableServiceCacheRequest {
	r.xExternalsystem = &xExternalsystem
	return r
}

// Language code
func (r AccountsReceivablesApiDeleteAccountsReceivableServiceCacheRequest) AcceptLanguage(acceptLanguage string) AccountsReceivablesApiDeleteAccountsReceivableServiceCacheRequest {
	r.acceptLanguage = &acceptLanguage
	return r
}

func (r AccountsReceivablesApiDeleteAccountsReceivableServiceCacheRequest) Execute() (*Status, *http.Response, error) {
...
This API facilitates clearing of cache in account receivable services. <p><strong>OperationId:</strong>deleteAccountsReceivableServiceCache</p>
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return AccountsReceivablesApiDeleteAccountsReceivableServiceCacheRequest
*/
func (a *AccountsReceivablesApiService) DeleteAccountsReceivableServiceCache(ctx context.Context) AccountsReceivablesApiDeleteAccountsReceivableServiceCacheRequest {
	return AccountsReceivablesApiDeleteAccountsReceivableServiceCacheRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return Status
func (a *AccountsReceivablesApiService) DeleteAccountsReceivableServiceCacheExecute(r AccountsReceivablesApiDeleteAccountsReceivableServiceCacheRequest) (*Status, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodDelete
		localVarPostBody     interface{}
		formFiles            []formFile
