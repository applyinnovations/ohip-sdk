...
// checks if the PostBlockRefusedReasonspostBloRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PostBlockRefusedReasonspostBloRequest{}

// PostBlockRefusedReasonspostBloRequest struct for PostBlockRefusedReasonspostBloRequest
type PostBlockRefusedReasonspostBloRequest struct {
...
func NewPostBlockRefusedReasonspostBloRequest() *PostBlockRefusedReasonspostBloRequest {
	this := PostBlockRefusedReasonspostBloRequest{}
	return &this
}
...
func (o PostBlockRefusedReasonspostBloRequest) MarshalJSON() ([]byte, error) {
...
func (o PostBlockRefusedReasonspostBloRequest) ToMap() (map[string]interface{}, error) {
...
type NullablePostBlockRefusedReasonspostBloRequest struct {
	value *PostBlockRefusedReasonspostBloRequest
	isSet bool
}

func (v NullablePostBlockRefusedReasonspostBloRequest) Get() *PostBlockRefusedReasonspostBloRequest {
	return v.value
}

func (v *NullablePostBlockRefusedReasonspostBloRequest) Set(val *PostBlockRefusedReasonspostBloRequest) {
	v.value = val
	v.isSet = true
}

func (v NullablePostBlockRefusedReasonspostBloRequest) IsSet() bool {
	return v.isSet
}

func (v *NullablePostBlockRefusedReasonspostBloRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePostBlockRefusedReasonspostBloRequest(val *PostBlockRefusedReasonspostBloRequest) *NullablePostBlockRefusedReasonspostBloRequest {
	return &NullablePostBlockRefusedReasonspostBloRequest{value: val, isSet: true}
}

func (v NullablePostBlockRefusedReasonspostBloRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePostBlockRefusedReasonspostBloRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
