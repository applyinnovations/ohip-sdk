...
// checks if the CopyDepartmentsRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CopyDepartmentsRequest{}

// CopyDepartmentsRequest struct for CopyDepartmentsRequest
type CopyDepartmentsRequest struct {
...
func (o CopyDepartmentsRequest) MarshalJSON() ([]byte, error) {
...
func (o CopyDepartmentsRequest) ToMap() (map[string]interface{}, error) {
...
type NullableCopyDepartmentsRequest struct {
	value *CopyDepartmentsRequest
	isSet bool
}

func (v NullableCopyDepartmentsRequest) Get() *CopyDepartmentsRequest {
	return v.value
}

func (v *NullableCopyDepartmentsRequest) Set(val *CopyDepartmentsRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableCopyDepartmentsRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableCopyDepartmentsRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCopyDepartmentsRequest(val *CopyDepartmentsRequest) *NullableCopyDepartmentsRequest {
	return &NullableCopyDepartmentsRequest{value: val, isSet: true}
}

func (v NullableCopyDepartmentsRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCopyDepartmentsRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
