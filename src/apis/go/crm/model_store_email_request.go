...
type StoreEmailRequest struct {
	...
	EmailReceiveDate *time.Time `json:"emailReceiveDate,omitempty"`
...
// SetEmailReceiveDate gets a reference to the given time.Time and assigns it to the EmailReceiveDate field.
