...
// checks if the FetchIntegrationOutboundMessages type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &FetchIntegrationOutboundMessages{}

// FetchIntegrationOutboundMessages struct for FetchIntegrationOutboundMessages
type FetchIntegrationOutboundMessages struct {
	// List of integration outbound messages
	Messages []IntegrationOutboundMessageType `json:"messages,omitempty"`
...
func NewFetchIntegrationOutboundMessages() *FetchIntegrationOutboundMessages {
	this := FetchIntegrationOutboundMessages{}
	return &this
}
...
func (o *FetchIntegrationOutboundMessages) GetMessages() []IntegrationOutboundMessageType {
	if o == nil || IsNil(o.Messages) {
		var ret []IntegrationOutboundMessageType
		return ret
	}
	return o.Messages
}
...
// SetMessages gets a reference to the given []IntegrationOutboundMessageType and assigns it to the Messages field.
...
func (o FetchIntegrationOutboundMessages) MarshalJSON() ([]byte, error) {
...
func (o FetchIntegrationOutboundMessages) ToMap() (map[string]interface{}, error) {
...
type NullableFetchIntegrationOutboundMessages struct {
	value *FetchIntegrationOutboundMessages
	isSet bool
}

func (v NullableFetchIntegrationOutboundMessages) Get() *FetchIntegrationOutboundMessages {
	return v.value
}

func (v *NullableFetchIntegrationOutboundMessages) Set(val *FetchIntegrationOutboundMessages) {
	v.value = val
	v.isSet = true
}

func (v NullableFetchIntegrationOutboundMessages) IsSet() bool {
	return v.isSet
}

func (v *NullableFetchIntegrationOutboundMessages) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableFetchIntegrationOutboundMessages(val *FetchIntegrationOutboundMessages) *NullableFetchIntegrationOutboundMessages {
	return &NullableFetchIntegrationOutboundMessages{value: val, isSet: true}
}

func (v NullableFetchIntegrationOutboundMessages) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableFetchIntegrationOutboundMessages) UnmarshalJSON(src []byte) error {
	v.isSet = true
