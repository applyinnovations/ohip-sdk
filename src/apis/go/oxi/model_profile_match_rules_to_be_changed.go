...
// checks if the ProfileMatchRulesToBeChanged type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ProfileMatchRulesToBeChanged{}

// ProfileMatchRulesToBeChanged struct for ProfileMatchRulesToBeChanged
type ProfileMatchRulesToBeChanged struct {
...
func NewProfileMatchRulesToBeChanged() *ProfileMatchRulesToBeChanged {
	this := ProfileMatchRulesToBeChanged{}
	return &this
}
...
func (o ProfileMatchRulesToBeChanged) MarshalJSON() ([]byte, error) {
...
func (o ProfileMatchRulesToBeChanged) ToMap() (map[string]interface{}, error) {
...
type NullableProfileMatchRulesToBeChanged struct {
	value *ProfileMatchRulesToBeChanged
	isSet bool
}

func (v NullableProfileMatchRulesToBeChanged) Get() *ProfileMatchRulesToBeChanged {
	return v.value
}

func (v *NullableProfileMatchRulesToBeChanged) Set(val *ProfileMatchRulesToBeChanged) {
	v.value = val
	v.isSet = true
}

func (v NullableProfileMatchRulesToBeChanged) IsSet() bool {
	return v.isSet
}

func (v *NullableProfileMatchRulesToBeChanged) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableProfileMatchRulesToBeChanged(val *ProfileMatchRulesToBeChanged) *NullableProfileMatchRulesToBeChanged {
	return &NullableProfileMatchRulesToBeChanged{value: val, isSet: true}
}

func (v NullableProfileMatchRulesToBeChanged) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableProfileMatchRulesToBeChanged) UnmarshalJSON(src []byte) error {
	v.isSet = true
