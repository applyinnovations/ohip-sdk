...
// checks if the PostProfileMatchRulesRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PostProfileMatchRulesRequest{}

// PostProfileMatchRulesRequest struct for PostProfileMatchRulesRequest
type PostProfileMatchRulesRequest struct {
...
func NewPostProfileMatchRulesRequest() *PostProfileMatchRulesRequest {
	this := PostProfileMatchRulesRequest{}
	return &this
}
...
func (o PostProfileMatchRulesRequest) MarshalJSON() ([]byte, error) {
...
func (o PostProfileMatchRulesRequest) ToMap() (map[string]interface{}, error) {
...
type NullablePostProfileMatchRulesRequest struct {
	value *PostProfileMatchRulesRequest
	isSet bool
}

func (v NullablePostProfileMatchRulesRequest) Get() *PostProfileMatchRulesRequest {
	return v.value
}

func (v *NullablePostProfileMatchRulesRequest) Set(val *PostProfileMatchRulesRequest) {
	v.value = val
	v.isSet = true
}

func (v NullablePostProfileMatchRulesRequest) IsSet() bool {
	return v.isSet
}

func (v *NullablePostProfileMatchRulesRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePostProfileMatchRulesRequest(val *PostProfileMatchRulesRequest) *NullablePostProfileMatchRulesRequest {
	return &NullablePostProfileMatchRulesRequest{value: val, isSet: true}
}

func (v NullablePostProfileMatchRulesRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePostProfileMatchRulesRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
