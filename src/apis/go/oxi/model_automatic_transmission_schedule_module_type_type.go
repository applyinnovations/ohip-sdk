...
const (
	AR_EXPORT AutomaticTransmissionScheduleModuleTypeType = "ARExport"
	BLOCK AutomaticTransmissionScheduleModuleTypeType = "Block"
	INVENTORY AutomaticTransmissionScheduleModuleTypeType = "Inventory"
	PROFILE_REQUEST AutomaticTransmissionScheduleModuleTypeType = "ProfileRequest"
	PROFILE_DAILY_STATS AutomaticTransmissionScheduleModuleTypeType = "ProfileDailyStats"
)
