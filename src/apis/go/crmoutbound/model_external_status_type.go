...
const (
	NOT_ENOUGH_CRITERIA ExternalStatusType = "NotEnoughCriteria"
	IGNORED_UNSUPPORTED_CRITERIA ExternalStatusType = "IgnoredUnsupportedCriteria"
	EXTERNAL_ERROR ExternalStatusType = "ExternalError"
	COMMUNICATION_ERROR ExternalStatusType = "CommunicationError"
	SUCCESS ExternalStatusType = "Success"
)
