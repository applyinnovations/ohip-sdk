...
type ReservationTaxTypeInfo struct {
	...
	ReportTaxPerc *float32 `json:"reportTaxPerc,omitempty"`
...
// GetReportTaxPerc returns the ReportTaxPerc field value if set, zero value otherwise.
func (o *ReservationTaxTypeInfo) GetReportTaxPerc() float32 {
	if o == nil || IsNil(o.ReportTaxPerc) {
		var ret float32
		return ret
	}
	return *o.ReportTaxPerc
}

// GetReportTaxPercOk returns a tuple with the ReportTaxPerc field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ReservationTaxTypeInfo) GetReportTaxPercOk() (*float32, bool) {
	if o == nil || IsNil(o.ReportTaxPerc) {
		return nil, false
	}
	return o.ReportTaxPerc, true
}
...
// SetReportTaxPerc gets a reference to the given float32 and assigns it to the ReportTaxPerc field.
...
func (o ReservationTaxTypeInfo) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.ReportTaxPerc) {
		toSerialize["reportTaxPerc"] = o.ReportTaxPerc
	}
