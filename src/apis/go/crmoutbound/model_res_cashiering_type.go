...
type ResCashieringType struct {
	...
	ResPreConfiguredRoutingInstruction *ResPreConfiguredRoutingInstrType `json:"resPreConfiguredRoutingInstruction,omitempty"`
...
// GetResPreConfiguredRoutingInstruction returns the ResPreConfiguredRoutingInstruction field value if set, zero value otherwise.
func (o *ResCashieringType) GetResPreConfiguredRoutingInstruction() ResPreConfiguredRoutingInstrType {
	if o == nil || IsNil(o.ResPreConfiguredRoutingInstruction) {
		var ret ResPreConfiguredRoutingInstrType
		return ret
	}
	return *o.ResPreConfiguredRoutingInstruction
}

// GetResPreConfiguredRoutingInstructionOk returns a tuple with the ResPreConfiguredRoutingInstruction field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ResCashieringType) GetResPreConfiguredRoutingInstructionOk() (*ResPreConfiguredRoutingInstrType, bool) {
	if o == nil || IsNil(o.ResPreConfiguredRoutingInstruction) {
		return nil, false
	}
	return o.ResPreConfiguredRoutingInstruction, true
}
...
// SetResPreConfiguredRoutingInstruction gets a reference to the given ResPreConfiguredRoutingInstrType and assigns it to the ResPreConfiguredRoutingInstruction field.
func (o *ResCashieringType) SetResPreConfiguredRoutingInstruction(v ResPreConfiguredRoutingInstrType) {
	o.ResPreConfiguredRoutingInstruction = &v
}
...
func (o ResCashieringType) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.ResPreConfiguredRoutingInstruction) {
		toSerialize["resPreConfiguredRoutingInstruction"] = o.ResPreConfiguredRoutingInstruction
	}
