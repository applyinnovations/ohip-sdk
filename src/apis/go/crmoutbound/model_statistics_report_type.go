...
const (
	RESERVATION StatisticsReportType = "Reservation"
	REVENUE StatisticsReportType = "Revenue"
	PROFILE_STAY_RECORDS StatisticsReportType = "ProfileStayRecords"
	DETAIL_STAY_RECORDS_REVENUE StatisticsReportType = "DetailStayRecordsRevenue"
)
