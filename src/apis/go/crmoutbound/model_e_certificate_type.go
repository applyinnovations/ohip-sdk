...
type ECertificateType struct {
	...
	InLieuSeq *int32 `json:"inLieuSeq,omitempty"`
...
// GetInLieuSeq returns the InLieuSeq field value if set, zero value otherwise.
func (o *ECertificateType) GetInLieuSeq() int32 {
	if o == nil || IsNil(o.InLieuSeq) {
		var ret int32
		return ret
	}
	return *o.InLieuSeq
...
// GetInLieuSeqOk returns a tuple with the InLieuSeq field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ECertificateType) GetInLieuSeqOk() (*int32, bool) {
	if o == nil || IsNil(o.InLieuSeq) {
		return nil, false
	}
	return o.InLieuSeq, true
}
...
// SetInLieuSeq gets a reference to the given int32 and assigns it to the InLieuSeq field.
...
func (o ECertificateType) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.InLieuSeq) {
		toSerialize["inLieuSeq"] = o.InLieuSeq
	}
