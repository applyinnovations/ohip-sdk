...
type ResPaymentCardType struct {
	...
	CardNumberType *CardNumberTypeType `json:"cardNumberType,omitempty"`
}
...
// GetCardNumberType returns the CardNumberType field value if set, zero value otherwise.
func (o *ResPaymentCardType) GetCardNumberType() CardNumberTypeType {
	if o == nil || IsNil(o.CardNumberType) {
		var ret CardNumberTypeType
		return ret
	}
	return *o.CardNumberType
}

// GetCardNumberTypeOk returns a tuple with the CardNumberType field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ResPaymentCardType) GetCardNumberTypeOk() (*CardNumberTypeType, bool) {
	if o == nil || IsNil(o.CardNumberType) {
		return nil, false
	}
	return o.CardNumberType, true
}
...
// SetCardNumberType gets a reference to the given CardNumberTypeType and assigns it to the CardNumberType field.
...
func (o ResPaymentCardType) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.CardNumberType) {
		toSerialize["cardNumberType"] = o.CardNumberType
	}
