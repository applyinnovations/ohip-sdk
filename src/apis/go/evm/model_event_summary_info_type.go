...
// SetEventStartDate gets a reference to the given time.Time and assigns it to the EventStartDate field.
...
// SetEventEndDate gets a reference to the given time.Time and assigns it to the EventEndDate field.
