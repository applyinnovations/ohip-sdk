...
const (
	INQUIRY BlockStatusTypeType = "Inquiry"
	ACTUAL BlockStatusTypeType = "Actual"
	WAITLIST BlockStatusTypeType = "Waitlist"
	CANCEL BlockStatusTypeType = "Cancel"
	REFERRAL BlockStatusTypeType = "Referral"
)
