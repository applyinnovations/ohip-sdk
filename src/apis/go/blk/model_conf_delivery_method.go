...
const (
	PRINT ConfDeliveryMethod = "Print"
	EMAIL ConfDeliveryMethod = "Email"
	FAX ConfDeliveryMethod = "Fax"
	TEXT ConfDeliveryMethod = "Text"
	NOT_CONFIGURED ConfDeliveryMethod = "NotConfigured"
)
