...
const (
	ALL BlockApplyChangesToType = "All"
	SAME_ARRIVAL_DATE BlockApplyChangesToType = "SameArrivalDate"
	CHECKED_IN BlockApplyChangesToType = "CheckedIn"
	RESERVATIONS BlockApplyChangesToType = "Reservations"
	STAY_ON BlockApplyChangesToType = "StayOn"
)
