...
const (
	APPLY_RATE_TO_ALL_ROOM_TYPES ChangeBlockResvInstructionType = "ApplyRateToAllRoomTypes"
	EXCLUDE_CREDIT_CARD_PAYMENT_TYPES ChangeBlockResvInstructionType = "ExcludeCreditCardPaymentTypes"
)
