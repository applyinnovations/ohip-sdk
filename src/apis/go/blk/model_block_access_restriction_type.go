...
const (
	AVAILABILITY BlockAccessRestrictionType = "Availability"
	CREATE BlockAccessRestrictionType = "Create"
	MODIFY BlockAccessRestrictionType = "Modify"
	CANCEL BlockAccessRestrictionType = "Cancel"
)
