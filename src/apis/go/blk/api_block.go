...
type BlockApiDeleteBlockServiceCacheRequest struct {
	ctx context.Context
	ApiService *BlockApiService
	authorization *string
	xAppKey *string
...
// Bearer token that needs to be passed which is generated post user authentication
func (r BlockApiDeleteBlockServiceCacheRequest) Authorization(authorization string) BlockApiDeleteBlockServiceCacheRequest {
	r.authorization = &authorization
	return r
}

// Client or Partner’s Application Key
func (r BlockApiDeleteBlockServiceCacheRequest) XAppKey(xAppKey string) BlockApiDeleteBlockServiceCacheRequest {
	r.xAppKey = &xAppKey
	return r
}

// Mandatory parameter to identify the hotel code where the end user is logged in
func (r BlockApiDeleteBlockServiceCacheRequest) XHotelid(xHotelid string) BlockApiDeleteBlockServiceCacheRequest {
	r.xHotelid = &xHotelid
	return r
}

// External system code.
func (r BlockApiDeleteBlockServiceCacheRequest) XExternalsystem(xExternalsystem string) BlockApiDeleteBlockServiceCacheRequest {
	r.xExternalsystem = &xExternalsystem
	return r
}

// Language code
func (r BlockApiDeleteBlockServiceCacheRequest) AcceptLanguage(acceptLanguage string) BlockApiDeleteBlockServiceCacheRequest {
	r.acceptLanguage = &acceptLanguage
	return r
}

func (r BlockApiDeleteBlockServiceCacheRequest) Execute() (*Status, *http.Response, error) {
...
This API deletes the block service cache. <p><strong>OperationId:</strong>deleteBlockServiceCache</p>
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return BlockApiDeleteBlockServiceCacheRequest
*/
func (a *BlockApiService) DeleteBlockServiceCache(ctx context.Context) BlockApiDeleteBlockServiceCacheRequest {
	return BlockApiDeleteBlockServiceCacheRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return Status
func (a *BlockApiService) DeleteBlockServiceCacheExecute(r BlockApiDeleteBlockServiceCacheRequest) (*Status, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodDelete
		localVarPostBody     interface{}
		formFiles            []formFile
