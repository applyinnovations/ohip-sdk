...
// checks if the PutBlockWashSchedulesRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PutBlockWashSchedulesRequest{}

// PutBlockWashSchedulesRequest struct for PutBlockWashSchedulesRequest
type PutBlockWashSchedulesRequest struct {
...
func NewPutBlockWashSchedulesRequest() *PutBlockWashSchedulesRequest {
	this := PutBlockWashSchedulesRequest{}
	return &this
}
...
func (o PutBlockWashSchedulesRequest) MarshalJSON() ([]byte, error) {
...
func (o PutBlockWashSchedulesRequest) ToMap() (map[string]interface{}, error) {
...
type NullablePutBlockWashSchedulesRequest struct {
	value *PutBlockWashSchedulesRequest
	isSet bool
}

func (v NullablePutBlockWashSchedulesRequest) Get() *PutBlockWashSchedulesRequest {
	return v.value
}

func (v *NullablePutBlockWashSchedulesRequest) Set(val *PutBlockWashSchedulesRequest) {
	v.value = val
	v.isSet = true
}

func (v NullablePutBlockWashSchedulesRequest) IsSet() bool {
	return v.isSet
}

func (v *NullablePutBlockWashSchedulesRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePutBlockWashSchedulesRequest(val *PutBlockWashSchedulesRequest) *NullablePutBlockWashSchedulesRequest {
	return &NullablePutBlockWashSchedulesRequest{value: val, isSet: true}
}

func (v NullablePutBlockWashSchedulesRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePutBlockWashSchedulesRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
