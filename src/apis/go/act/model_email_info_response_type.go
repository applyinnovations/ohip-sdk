...
type EmailInfoResponseType struct {
	...
	EmailReceivedDateTime *time.Time `json:"emailReceivedDateTime,omitempty"`
...
// SetEmailReceivedDateTime gets a reference to the given time.Time and assigns it to the EmailReceivedDateTime field.
