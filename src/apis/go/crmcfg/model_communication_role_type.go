...
const (
	EMAIL CommunicationRoleType = "Email"
	FAX CommunicationRoleType = "Fax"
	EMAIL_FOR_REQUEST CommunicationRoleType = "EmailForRequest"
	WEBPAGE CommunicationRoleType = "Webpage"
	PHONE CommunicationRoleType = "Phone"
)
