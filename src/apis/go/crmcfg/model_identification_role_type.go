...
const (
	PASSPORT IdentificationRoleType = "Passport"
	DRIVER_LICENSE IdentificationRoleType = "DriverLicense"
	VISA IdentificationRoleType = "Visa"
	ID IdentificationRoleType = "Id"
	UNKNOWN IdentificationRoleType = "Unknown"
)
