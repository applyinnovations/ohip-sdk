...
const (
	RATE MembershipAwardBasedOnType = "Rate"
	PRODUCT MembershipAwardBasedOnType = "Product"
	UPGRADE MembershipAwardBasedOnType = "Upgrade"
	OTHER MembershipAwardBasedOnType = "Other"
	FT MembershipAwardBasedOnType = "Ft"
)
