...
const (
	NEW_RESERVATION AttachMembershipToReservationRuleType = "NewReservation"
	UPDATE_RESERVATION AttachMembershipToReservationRuleType = "UpdateReservation"
	CHECKIN AttachMembershipToReservationRuleType = "Checkin"
	CHECKOUT AttachMembershipToReservationRuleType = "Checkout"
)
