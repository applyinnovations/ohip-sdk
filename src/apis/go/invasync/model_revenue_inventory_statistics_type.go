...
type RevenueInventoryStatisticsType struct {
	...
	OoRooms *int32 `json:"ooRooms,omitempty"`
	// The statistical figure for out of service rooms.
	OsRooms *int32 `json:"osRooms,omitempty"`
	...
	RoomArrivals *int32 `json:"roomArrivals,omitempty"`
	// The statistical figure of departure rooms.
	RoomDepartures *int32 `json:"roomDepartures,omitempty"`
	...
	CancelledRooms *int32 `json:"cancelledRooms,omitempty"`
...
// SetOoRooms gets a reference to the given int32 and assigns it to the OoRooms field.
...
// SetOsRooms gets a reference to the given int32 and assigns it to the OsRooms field.
...
// SetRoomArrivals gets a reference to the given int32 and assigns it to the RoomArrivals field.
...
// SetRoomDepartures gets a reference to the given int32 and assigns it to the RoomDepartures field.
...
// SetCancelledRooms gets a reference to the given int32 and assigns it to the CancelledRooms field.
