...
// Rate plan code.
func (r RatePlanApiGetRatePlanRequest) RatePlanCode(ratePlanCode string) RatePlanApiGetRatePlanRequest {
...
*/
func (a *RatePlanApiService) GetRatePlan(ctx context.Context, hotelId string) RatePlanApiGetRatePlanRequest {
	return RatePlanApiGetRatePlanRequest{
		ApiService: a,
		ctx: ctx,
		hotelId: hotelId,
