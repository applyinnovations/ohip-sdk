...
const (
	CHECK_IN DepositMaturityPreferenceType = "CheckIn"
	LAST_STAY_NIGHT DepositMaturityPreferenceType = "LastStayNight"
	LAST_DAY_ADV_DEPOSIT DepositMaturityPreferenceType = "LastDayAdvDeposit"
)
