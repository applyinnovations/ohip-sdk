...
const (
	FIXED_AT_CHECK_IN ExchangePostingType = "FixedAtCheckIn"
	FIXED_AT_RESERVATION ExchangePostingType = "FixedAtReservation"
	CURRENT_DATE ExchangePostingType = "CurrentDate"
	FIXED_AT_BLOCK ExchangePostingType = "FixedAtBlock"
)
