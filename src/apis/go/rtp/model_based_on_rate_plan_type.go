...
const (
	BASE_RATE BasedOnRatePlanType = "BaseRate"
	DYNAMIC_BASE_RATE BasedOnRatePlanType = "DynamicBaseRate"
	BAR_BASED_RATE BasedOnRatePlanType = "BARBasedRate"
	ADVANCED_DYNAMIC_BASE_RATE BasedOnRatePlanType = "AdvancedDynamicBaseRate"
	NONE BasedOnRatePlanType = "None"
)
