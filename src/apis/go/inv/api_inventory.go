...
func (r InventoryApiChangeSellLimitByDateRequest) SellLimit(sellLimit ChangeSellLimitByDateRequest) InventoryApiChangeSellLimitByDateRequest {
...
func (r InventoryApiChangeSellLimitByDateRangeRequest) SellLimitByRange(sellLimitByRange ChangeSellLimitByDateRangeRequest) InventoryApiChangeSellLimitByDateRangeRequest {
...
type InventoryApiDeleteInventoryServiceCacheRequest struct {
	ctx context.Context
	ApiService *InventoryApiService
	authorization *string
	xAppKey *string
...
// Bearer token that needs to be passed which is generated post user authentication
func (r InventoryApiDeleteInventoryServiceCacheRequest) Authorization(authorization string) InventoryApiDeleteInventoryServiceCacheRequest {
	r.authorization = &authorization
	return r
}

// Client or Partner’s Application Key
func (r InventoryApiDeleteInventoryServiceCacheRequest) XAppKey(xAppKey string) InventoryApiDeleteInventoryServiceCacheRequest {
	r.xAppKey = &xAppKey
	return r
}

// Mandatory parameter to identify the hotel code where the endDate user is logged in
func (r InventoryApiDeleteInventoryServiceCacheRequest) XHotelid(xHotelid string) InventoryApiDeleteInventoryServiceCacheRequest {
	r.xHotelid = &xHotelid
	return r
}

// External system code.
func (r InventoryApiDeleteInventoryServiceCacheRequest) XExternalsystem(xExternalsystem string) InventoryApiDeleteInventoryServiceCacheRequest {
	r.xExternalsystem = &xExternalsystem
	return r
}

// Language code
func (r InventoryApiDeleteInventoryServiceCacheRequest) AcceptLanguage(acceptLanguage string) InventoryApiDeleteInventoryServiceCacheRequest {
	r.acceptLanguage = &acceptLanguage
	return r
}

func (r InventoryApiDeleteInventoryServiceCacheRequest) Execute() (*Status, *http.Response, error) {
...
This API facilitates clearing of cache in inventory service <p><strong>OperationId:</strong>deleteInventoryServiceCache</p>
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return InventoryApiDeleteInventoryServiceCacheRequest
*/
func (a *InventoryApiService) DeleteInventoryServiceCache(ctx context.Context) InventoryApiDeleteInventoryServiceCacheRequest {
	return InventoryApiDeleteInventoryServiceCacheRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return Status
func (a *InventoryApiService) DeleteInventoryServiceCacheExecute(r InventoryApiDeleteInventoryServiceCacheRequest) (*Status, *http.Response, error) {
	var (
...
func (r InventoryApiPostHoldItemInventoryRequest) HoldItemInventory(holdItemInventory PutHoldItemsInventoryRequest) InventoryApiPostHoldItemInventoryRequest {
...
func (r InventoryApiPutHoldItemsInventoryRequest) HoldItemInventory(holdItemInventory PutHoldItemsInventoryRequest) InventoryApiPutHoldItemsInventoryRequest {
	r.holdItemInventory = &holdItemInventory
	return r
}
...
func (r InventoryApiPutItemInventoryHoldRequest) ReleaseItemInventoryHold(releaseItemInventoryHold PutItemInventoryHoldRequest) InventoryApiPutItemInventoryHoldRequest {
