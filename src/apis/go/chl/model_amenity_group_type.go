...
const (
	PROPERTY_FEATURES AmenityGroupType = "PropertyFeatures"
	ROOM_FEATURES AmenityGroupType = "RoomFeatures"
	PRODUCTS_FEATURES AmenityGroupType = "ProductsFeatures"
	BED_CODES AmenityGroupType = "BedCodes"
)
