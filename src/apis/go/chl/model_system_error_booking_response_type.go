...
const (
	PENDING_NEEDED SystemErrorBookingResponseType = "PendingNeeded"
	UNCONFIRMED SystemErrorBookingResponseType = "Unconfirmed"
	CANCELLED SystemErrorBookingResponseType = "Cancelled"
)
