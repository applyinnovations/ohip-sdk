...
// checks if the PutRoomDescriptionRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PutRoomDescriptionRequest{}

// PutRoomDescriptionRequest struct for PutRoomDescriptionRequest
type PutRoomDescriptionRequest struct {
...
func NewPutRoomDescriptionRequest() *PutRoomDescriptionRequest {
	this := PutRoomDescriptionRequest{}
	return &this
}
...
func (o PutRoomDescriptionRequest) MarshalJSON() ([]byte, error) {
...
func (o PutRoomDescriptionRequest) ToMap() (map[string]interface{}, error) {
...
type NullablePutRoomDescriptionRequest struct {
	value *PutRoomDescriptionRequest
	isSet bool
}

func (v NullablePutRoomDescriptionRequest) Get() *PutRoomDescriptionRequest {
	return v.value
}

func (v *NullablePutRoomDescriptionRequest) Set(val *PutRoomDescriptionRequest) {
	v.value = val
	v.isSet = true
}

func (v NullablePutRoomDescriptionRequest) IsSet() bool {
	return v.isSet
}

func (v *NullablePutRoomDescriptionRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePutRoomDescriptionRequest(val *PutRoomDescriptionRequest) *NullablePutRoomDescriptionRequest {
	return &NullablePutRoomDescriptionRequest{value: val, isSet: true}
}

func (v NullablePutRoomDescriptionRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePutRoomDescriptionRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
