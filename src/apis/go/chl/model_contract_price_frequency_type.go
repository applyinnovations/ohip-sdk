...
const (
	MONTHLY ContractPriceFrequencyType = "Monthly"
	QUARTERLY ContractPriceFrequencyType = "Quarterly"
	HALF_YEARLY ContractPriceFrequencyType = "HalfYearly"
	YEARLY ContractPriceFrequencyType = "Yearly"
)
