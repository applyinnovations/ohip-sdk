...
type LeisureManagementApiDeleteLeisureManagementServiceCacheRequest struct {
	ctx context.Context
	ApiService *LeisureManagementApiService
	authorization *string
	xAppKey *string
...
// Bearer token that needs to be passed which is generated post user authentication
func (r LeisureManagementApiDeleteLeisureManagementServiceCacheRequest) Authorization(authorization string) LeisureManagementApiDeleteLeisureManagementServiceCacheRequest {
	r.authorization = &authorization
	return r
}

// Client or Partner’s Application Key
func (r LeisureManagementApiDeleteLeisureManagementServiceCacheRequest) XAppKey(xAppKey string) LeisureManagementApiDeleteLeisureManagementServiceCacheRequest {
	r.xAppKey = &xAppKey
	return r
}

// Mandatory parameter to identify the hotel code where the end user is logged in
func (r LeisureManagementApiDeleteLeisureManagementServiceCacheRequest) XHotelid(xHotelid string) LeisureManagementApiDeleteLeisureManagementServiceCacheRequest {
	r.xHotelid = &xHotelid
	return r
}

// External system code.
func (r LeisureManagementApiDeleteLeisureManagementServiceCacheRequest) XExternalsystem(xExternalsystem string) LeisureManagementApiDeleteLeisureManagementServiceCacheRequest {
	r.xExternalsystem = &xExternalsystem
	return r
}

// Language code
func (r LeisureManagementApiDeleteLeisureManagementServiceCacheRequest) AcceptLanguage(acceptLanguage string) LeisureManagementApiDeleteLeisureManagementServiceCacheRequest {
	r.acceptLanguage = &acceptLanguage
	return r
}

func (r LeisureManagementApiDeleteLeisureManagementServiceCacheRequest) Execute() (*Status, *http.Response, error) {
...
Operation to clear cache <p><strong>OperationId:</strong>deleteLeisureManagementServiceCache</p>
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return LeisureManagementApiDeleteLeisureManagementServiceCacheRequest
*/
func (a *LeisureManagementApiService) DeleteLeisureManagementServiceCache(ctx context.Context) LeisureManagementApiDeleteLeisureManagementServiceCacheRequest {
	return LeisureManagementApiDeleteLeisureManagementServiceCacheRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return Status
func (a *LeisureManagementApiService) DeleteLeisureManagementServiceCacheExecute(r LeisureManagementApiDeleteLeisureManagementServiceCacheRequest) (*Status, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodDelete
		localVarPostBody     interface{}
		formFiles            []formFile
