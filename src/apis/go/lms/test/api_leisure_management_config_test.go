...
func Test_openapi_LeisureManagementConfigApiService(t *testing.T) {
	...
	t.Run("Test LeisureManagementConfigApiService DeleteLeisureManagementConfigCache", func(t *testing.T) {

		t.Skip("skip test")  // remove to run test

		resp, httpRes, err := apiClient.LeisureManagementConfigApi.DeleteLeisureManagementConfigCache(context.Background()).Execute()
	...
	t.Run("Test LeisureManagementConfigApiService GetLeisureManagementConfigServicesStatus", func(t *testing.T) {

		t.Skip("skip test")  // remove to run test

		resp, httpRes, err := apiClient.LeisureManagementConfigApi.GetLeisureManagementConfigServicesStatus(context.Background()).Execute()
