...
// checks if the PutActivityBookingRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PutActivityBookingRequest{}

// PutActivityBookingRequest struct for PutActivityBookingRequest
type PutActivityBookingRequest struct {
...
func NewPutActivityBookingRequest() *PutActivityBookingRequest {
	this := PutActivityBookingRequest{}
	return &this
}
...
func (o PutActivityBookingRequest) MarshalJSON() ([]byte, error) {
...
func (o PutActivityBookingRequest) ToMap() (map[string]interface{}, error) {
...
type NullablePutActivityBookingRequest struct {
	value *PutActivityBookingRequest
	isSet bool
}

func (v NullablePutActivityBookingRequest) Get() *PutActivityBookingRequest {
	return v.value
}

func (v *NullablePutActivityBookingRequest) Set(val *PutActivityBookingRequest) {
	v.value = val
	v.isSet = true
}

func (v NullablePutActivityBookingRequest) IsSet() bool {
	return v.isSet
}

func (v *NullablePutActivityBookingRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePutActivityBookingRequest(val *PutActivityBookingRequest) *NullablePutActivityBookingRequest {
	return &NullablePutActivityBookingRequest{value: val, isSet: true}
}

func (v NullablePutActivityBookingRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePutActivityBookingRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
