...
const (
	FLAT_RATE PackageCalculationRuleType = "FlatRate"
	PER_PERSON PackageCalculationRuleType = "PerPerson"
	PER_ADULT PackageCalculationRuleType = "PerAdult"
	PER_CHILD PackageCalculationRuleType = "PerChild"
	PER_ROOM PackageCalculationRuleType = "PerRoom"
)
