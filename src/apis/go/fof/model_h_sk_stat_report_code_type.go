...
const (
	HOUSE_SUMMARY HSKStatReportCodeType = "HouseSummary"
	HOUSE_SUMMARY_MONTH_TO_DATE HSKStatReportCodeType = "HouseSummaryMonthToDate"
	HOUSE_SUMMARY_YEAR_TO_DATE HSKStatReportCodeType = "HouseSummaryYearToDate"
	RESERVATION_ACTIVITY HSKStatReportCodeType = "ReservationActivity"
	RESERVATION_ACTIVITY_DAILY HSKStatReportCodeType = "ReservationActivityDaily"
	RESERVATION_ACTIVITY_MONTH_TO_DATE HSKStatReportCodeType = "ReservationActivityMonthToDate"
	RESERVATION_ACTIVITY_YEAR_TO_DATE HSKStatReportCodeType = "ReservationActivityYearToDate"
	COMPLIMENTARY_OR_HOUSE_USE HSKStatReportCodeType = "ComplimentaryOrHouseUse"
	DAILY_PROJECTION HSKStatReportCodeType = "DailyProjection"
	ROOM_STATUS HSKStatReportCodeType = "RoomStatus"
	LAST_HOUR_STATUS HSKStatReportCodeType = "LastHourStatus"
	TURNDOWN HSKStatReportCodeType = "Turndown"
	IN_HOUSE HSKStatReportCodeType = "InHouse"
	CHECK_INS HSKStatReportCodeType = "CheckIns"
	CHECK_OUTS HSKStatReportCodeType = "CheckOuts"
	AVAILABLE_ROOMS HSKStatReportCodeType = "AvailableRooms"
	ROOM_MAINTENANCE HSKStatReportCodeType = "RoomMaintenance"
	RESERVATION_STATISTICS HSKStatReportCodeType = "ReservationStatistics"
	VIP_GUESTS HSKStatReportCodeType = "VIPGuests"
	ADVANCE_CHECK_IN HSKStatReportCodeType = "AdvanceCheckIn"
	BLOCK_ARRIVALS HSKStatReportCodeType = "BlockArrivals"
	RESERVATIONS_CANCELLATIONS_TODAY HSKStatReportCodeType = "ReservationsCancellationsToday"
	AI_ROOM_ASSIGNMENT HSKStatReportCodeType = "AIRoomAssignment"
	COMP_ROUTING HSKStatReportCodeType = "CompRouting"
)
