...
// CheckedInReservationInstructionType Simple type for fetch checked in reservation instructions that can be used in requests for partial operations.
type CheckedInReservationInstructionType string

// List of checkedInReservationInstructionType
const (
	RESERVATION_DETAIL CheckedInReservationInstructionType = "ReservationDetail"
)
