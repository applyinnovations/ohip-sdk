...
const (
	BONUS_POINTS WelcomeOfferOptionsType = "BonusPoints"
	ECOUPONS WelcomeOfferOptionsType = "Ecoupons"
	ITEMS WelcomeOfferOptionsType = "Items"
	POST_IT WelcomeOfferOptionsType = "PostIt"
	NOT_SELECTED WelcomeOfferOptionsType = "NotSelected"
)
