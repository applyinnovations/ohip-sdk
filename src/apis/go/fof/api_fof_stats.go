...
type ApiGetFrontOfficeStatisticsRequest struct {
	ctx context.Context
...
func (r ApiGetFrontOfficeStatisticsRequest) Authorization(authorization string) ApiGetFrontOfficeStatisticsRequest {
	r.authorization = &authorization
	return r
}

// Client or Partner’s Application Key
func (r ApiGetFrontOfficeStatisticsRequest) XAppKey(xAppKey string) ApiGetFrontOfficeStatisticsRequest {
	r.xAppKey = &xAppKey
	return r
}

// Mandatory parameter to identify the hotel code where the end user is logged in
func (r ApiGetFrontOfficeStatisticsRequest) XHotelid(xHotelid string) ApiGetFrontOfficeStatisticsRequest {
	r.xHotelid = &xHotelid
	return r
}

// Start date of the report.
func (r ApiGetFrontOfficeStatisticsRequest) Date(date string) ApiGetFrontOfficeStatisticsRequest {
	r.date = &date
	return r
}

// Supported housekeeping statistical codes.
func (r ApiGetFrontOfficeStatisticsRequest) Metric(metric []string) ApiGetFrontOfficeStatisticsRequest {
	r.metric = &metric
	return r
}

// Required when statisticsCode is ReservationsCancellationsToday
func (r ApiGetFrontOfficeStatisticsRequest) ParameterNames(parameterNames []string) ApiGetFrontOfficeStatisticsRequest {
	r.parameterNames = &parameterNames
	return r
}

// Required when statisticsCode is ReservationsCancellationsToday
func (r ApiGetFrontOfficeStatisticsRequest) ParameterValues(parameterValues []string) ApiGetFrontOfficeStatisticsRequest {
	r.parameterValues = &parameterValues
	return r
}

// Room Class of the Room.
func (r ApiGetFrontOfficeStatisticsRequest) RoomClasses(roomClasses []string) ApiGetFrontOfficeStatisticsRequest {
	r.roomClasses = &roomClasses
	return r
}

// External system code.
func (r ApiGetFrontOfficeStatisticsRequest) XExternalsystem(xExternalsystem string) ApiGetFrontOfficeStatisticsRequest {
	r.xExternalsystem = &xExternalsystem
	return r
}

// Language code
func (r ApiGetFrontOfficeStatisticsRequest) AcceptLanguage(acceptLanguage string) ApiGetFrontOfficeStatisticsRequest {
	r.acceptLanguage = &acceptLanguage
	return r
}

func (r ApiGetFrontOfficeStatisticsRequest) Execute() (*Statistics, *http.Response, error) {
...
Use this API to return front office statistics for a specific hotel based on search criteria such as statisticsCode, hotelId, date, parameterNames, parameterValues, room Classes.<p><strong>OperationId:</strong>getFrontOfficeStatistics</p>
 ...
 @param hotelId
 @return ApiGetFrontOfficeStatisticsRequest
*/
func (a *FOFStatsApiService) GetFrontOfficeStatistics(ctx context.Context, statisticsCode string, hotelId string) ApiGetFrontOfficeStatisticsRequest {
	return ApiGetFrontOfficeStatisticsRequest{
		ApiService: a,
		ctx: ctx,
...
//  @return Statistics
func (a *FOFStatsApiService) GetFrontOfficeStatisticsExecute(r ApiGetFrontOfficeStatisticsRequest) (*Statistics, *http.Response, error) {
	var (
	...
	if r.metric != nil {
		...
		if reflect.TypeOf(t).Kind() == reflect.Slice {
			s := reflect.ValueOf(t)
			for i := 0; i < s.Len(); i++ {
				parameterAddToHeaderOrQuery(localVarQueryParams, "metric", s.Index(i), "multi")
			}
		} else {
...
type ApiGetFrontOfficeStatisticsWithDateRangeRequest struct {
	ctx context.Context
	ApiService *FOFStatsApiService
	statisticsCode string
	hotelId string
...
// Bearer token that needs to be passed which is generated post user authentication
func (r ApiGetFrontOfficeStatisticsWithDateRangeRequest) Authorization(authorization string) ApiGetFrontOfficeStatisticsWithDateRangeRequest {
	r.authorization = &authorization
	return r
}

// Client or Partner’s Application Key
func (r ApiGetFrontOfficeStatisticsWithDateRangeRequest) XAppKey(xAppKey string) ApiGetFrontOfficeStatisticsWithDateRangeRequest {
	r.xAppKey = &xAppKey
	return r
}

// Mandatory parameter to identify the hotel code where the end user is logged in
func (r ApiGetFrontOfficeStatisticsWithDateRangeRequest) XHotelid(xHotelid string) ApiGetFrontOfficeStatisticsWithDateRangeRequest {
	r.xHotelid = &xHotelid
	return r
}

// End date of the report.
func (r ApiGetFrontOfficeStatisticsWithDateRangeRequest) EndDate(endDate string) ApiGetFrontOfficeStatisticsWithDateRangeRequest {
	r.endDate = &endDate
	return r
}

// Start date of the report.
func (r ApiGetFrontOfficeStatisticsWithDateRangeRequest) Date(date string) ApiGetFrontOfficeStatisticsWithDateRangeRequest {
	r.date = &date
	return r
}

// Supported housekeeping statistical codes.
func (r ApiGetFrontOfficeStatisticsWithDateRangeRequest) Metric(metric []string) ApiGetFrontOfficeStatisticsWithDateRangeRequest {
	r.metric = &metric
	return r
}

// Required when statisticsCode is ReservationsCancellationsToday
func (r ApiGetFrontOfficeStatisticsWithDateRangeRequest) ParameterNames(parameterNames []string) ApiGetFrontOfficeStatisticsWithDateRangeRequest {
	r.parameterNames = &parameterNames
	return r
}

// Required when statisticsCode is ReservationsCancellationsToday
func (r ApiGetFrontOfficeStatisticsWithDateRangeRequest) ParameterValues(parameterValues []string) ApiGetFrontOfficeStatisticsWithDateRangeRequest {
	r.parameterValues = &parameterValues
	return r
}

// Room Class of the Room.
func (r ApiGetFrontOfficeStatisticsWithDateRangeRequest) RoomClasses(roomClasses []string) ApiGetFrontOfficeStatisticsWithDateRangeRequest {
	r.roomClasses = &roomClasses
	return r
}

// External system code.
func (r ApiGetFrontOfficeStatisticsWithDateRangeRequest) XExternalsystem(xExternalsystem string) ApiGetFrontOfficeStatisticsWithDateRangeRequest {
	r.xExternalsystem = &xExternalsystem
	return r
}

// Language code
func (r ApiGetFrontOfficeStatisticsWithDateRangeRequest) AcceptLanguage(acceptLanguage string) ApiGetFrontOfficeStatisticsWithDateRangeRequest {
	r.acceptLanguage = &acceptLanguage
	return r
}

func (r ApiGetFrontOfficeStatisticsWithDateRangeRequest) Execute() (*Statistics, *http.Response, error) {
...
This API is useful to retrieve statistics regarding front office operations <p><strong>OperationId:</strong>getFrontOfficeStatisticsWithDateRange</p>
 ...
 @param statisticsCode Below are the Statistics Code mapping for valid metric code.<p><strong>AdvanceCheckIn:</strong></p>IndividualAdvanceCheckedInCurrent,BlockAdvanceCheckedInInhouse,BlockAdvanceCheckedInTotal,IndividualAdvanceCheckedInInhouse,IndividualAdvanceCheckedInTotal,BlockAdvanceCheckedInCurrent;<p><strong>AIRoomAssignment:</strong></p>MaxPercentageOccupiedTonightRooms,ArrivalResvs,ArrivalVIPResvs,ArrivalMemberResvs,ArrivalUnallocResvs,ArrivalManualAssgnResvs,ArrivalAIAssgnResvs,ArrivalAIUpgResvs,ArrivalAIAssgnVIPResvs,ArrivalAIAssgnMemberResvs,ArrivalAIAssgnOverridden;<p><strong>AvailableRooms:</strong></p>MinAvailableTonightRooms;<p><strong>CheckIns:</strong></p>ArrivalsTotal,CheckedInsTotal,ExpectedCheckInsTotal,QueueRooms;CheckOuts:DeparturesTotal,CheckedOutsTotal,AdultsDeparted,ChildrenDeparted,ExpectedCheckOutsTotal,AdultsExpectedCheckedOut,ChildrenExpectedCheckedOut,ScheduledCheckOutsTotal;<p><strong>ComplimentaryOrHouseUse:</strong></p>ComplimentaryArrivalRooms,ComplimentaryArrivalPersons,ComplimentaryArrivalVIP,ComplimentaryStayoverRooms,ComplimentaryStayoverPersons,ComplimentaryStayoverVIP,ComplimentaryDepartureRooms,ComplimentaryDeparturePersons,ComplimentaryDepartureVIP,HouseUseArrivalRooms,HouseUseArrivalPersons,HouseUseArrivalVIP,HouseUseStayoverRooms,HouseUseStayoverPersons,HouseUseStayoverVIP,HouseUseDepartureRooms,HouseUseDeparturePersons,HouseUseDepartureVIP;<p><strong>DailyProjection:</strong></p>IndividualRooms,IndividualPersons,IndividualVIP,GroupAndBlockRooms,GroupAndBlockPersons,GroupAndBlockVIP,MaxOccupiedTonightRooms,MaxOccupiedTonightPersons,MaxOccupiedTonightVIP,BlocksNotPickedUp,MaxPercentageOccupiedTonightRooms,MinAvailableTonightRooms,RoomRevenue,TotalRevenue,AverageRoomRevenue,RevPar;<p><strong>HouseSummary:</strong></p>TotalPhysicalRooms,TotalOutOfOrder,TotalOutOfService,TotalRoomsToSell,MaxOccupiedTonightRooms,PercentRoomsOccupied,RoomRevenue,TotalRevenue,RevPar,AverageRoomRevenue;<p><strong>HouseSummaryMonthToDate:</strong></p>TotalPhysicalRooms,TotalOutOfOrder,TotalOutOfService,TotalRoomsToSell,MaxOccupiedTonightRooms,PercentRoomsOccupied,RoomRevenue,RevPar,TotalRevenue,AverageRoomRevenue;<p><strong>HouseSummaryYearToDate:</strong></p>TotalPhysicalRooms,TotalOutOfOrder,TotalOutOfService,TotalRoomsToSell,MaxOccupiedTonightRooms,PercentRoomsOccupied,RoomRevenue,RevPar,TotalRevenue,AverageRoomRevenue;<p><strong>InHouse:</strong></p>AdultsInHouse,ChildrenInHouse,InHouseRooms,InHouse;<p><strong>LastHourStatus:</strong></p>ArrivalsInLastHour,DeparturesInLastHour,InspectedRooms,CleanedRooms;<p><strong>ReservationActivity:</strong></p>StayoverRooms,StayoverPersons,StayoverVIP,DeparturesExpectedRooms,DeparturesExpectedPersons,DeparturesExpectedVIP,DeparturesActualRooms,DeparturesActualPersons,DeparturesActualVIP,ArrivalsExpectedRooms,ArrivalsExpectedPersons,ArrivalsExpectedVIP,ArrivalsActualRooms,ArrivalsActualPersons,ArrivalsActualVIP,ArrivalsExpectedRoomsMadeToday,ArrivalsExpectedPersonsMadeToday,ArrivalsExpectedVIPMadeToday,ExtendedStaysRooms,ExtendedStaysPersons,ExtendedStaysVIP,EarlyDeparturesRooms,EarlyDeparturesPersons,EarlyDeparturesVIP,DayUseRooms,DayUsePersons,DayUseVIP,WalkInRooms,WalkInPersons,WalkInVIP,CanceledOnArrivalRooms,CanceledOnArrivalPersons,CanceledOnArrivalVIP,AverageCheckInTime;<p><strong>ReservationActivityDaily:</strong></p>AdultsInHouse,ChildrenInHouse,ArrivalsTotal,TurndownRequired,DeparturesTotal,MaxOccupancyPercentage,Stayover,TotalRoomsReserved;<p><strong>ReservationActivityMonthToDate:</strong></p>ArrivalsActualRooms,ArrivalsActualPersons,DeparturesActualRooms,DeparturesActualPersons,ExtendedStaysRooms,ExtendedStaysPersons,EarlyDeparturesRooms,EarlyDeparturesPersons,DayUseRooms,DayUsePersons;<p><strong>ReservationActivityYearToDate:</strong></p>ArrivalsActualRooms,ArrivalsActualPersons,DeparturesActualRooms,DeparturesActualPersons,ExtendedStaysRooms,ExtendedStaysPersons,EarlyDeparturesRooms,EarlyDeparturesPersons,DayUseRooms,DayUsePersons;<p><strong>ReservationsCancellationsToday:</strong></p>CancellationsTotal,NewReservationsTotal;<p><strong>ReservationStatistics:</strong></p>PreRegisteredTotal,VIPPreRegisteredTotal,TurndownTotal,VIPTurndownTotal,OpenFolioTotal,ExpectedCheckOutsTotal;<p><strong>RoomMaintenance:</strong></p>RoomMaintenanceResolvedTotal,RoomMaintenanceUnResolvedTotal;<p><strong>RoomStatus:</strong></p>InspectedVacant,InspectedAssigned,InspectedOccupied,CleanVacant,CleanAssigned,CleanOccupied,DirtyVacant,DirtyAssigned,DirtyOccupied,PickupVacant,PickupAssigned,PickupOccupied,OutOfOrderVacant,OutOfOrderAssigned,OutOfOrderOccupied,OutOfServiceVacant,OutOfServiceAssigned,OutOfServiceOccupied,TotalOutOfOrder,TotalOutOfService,QueueRooms,CurrentAveWaitTime,SkipRooms,SleepRooms;<p><strong>Turndown:</strong></p>TurndownRequired,TurndownNotRequired,TurndownCompletedRequired;<p><strong>VIPGuests:</strong></p>VIPGuestsArriving,VIPGuestsDeparting;
 @param hotelId
 @return ApiGetFrontOfficeStatisticsWithDateRangeRequest
*/
func (a *FOFStatsApiService) GetFrontOfficeStatisticsWithDateRange(ctx context.Context, statisticsCode string, hotelId string) ApiGetFrontOfficeStatisticsWithDateRangeRequest {
	return ApiGetFrontOfficeStatisticsWithDateRangeRequest{
		ApiService: a,
		ctx: ctx,
		statisticsCode: statisticsCode,
...
// Execute executes the request
//  @return Statistics
func (a *FOFStatsApiService) GetFrontOfficeStatisticsWithDateRangeExecute(r ApiGetFrontOfficeStatisticsWithDateRangeRequest) (*Statistics, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
type ApiGetReservationQueueStatisticsRequest struct {
	ctx context.Context
	ApiService *FOFStatsApiService
	hotelId string
	authorization *string
...
// Bearer token that needs to be passed which is generated post user authentication
func (r ApiGetReservationQueueStatisticsRequest) Authorization(authorization string) ApiGetReservationQueueStatisticsRequest {
	r.authorization = &authorization
	return r
}

// Client or Partner’s Application Key
func (r ApiGetReservationQueueStatisticsRequest) XAppKey(xAppKey string) ApiGetReservationQueueStatisticsRequest {
	r.xAppKey = &xAppKey
	return r
}

// Mandatory parameter to identify the hotel code where the end user is logged in
func (r ApiGetReservationQueueStatisticsRequest) XHotelid(xHotelid string) ApiGetReservationQueueStatisticsRequest {
	r.xHotelid = &xHotelid
	return r
}

// External system code.
func (r ApiGetReservationQueueStatisticsRequest) XExternalsystem(xExternalsystem string) ApiGetReservationQueueStatisticsRequest {
	r.xExternalsystem = &xExternalsystem
	return r
}

// Language code
func (r ApiGetReservationQueueStatisticsRequest) AcceptLanguage(acceptLanguage string) ApiGetReservationQueueStatisticsRequest {
	r.acceptLanguage = &acceptLanguage
	return r
}

func (r ApiGetReservationQueueStatisticsRequest) Execute() (*ReservationQueueStatistics, *http.Response, error) {
...
Use this API to return reservation queue statistics for a specific property.<p><strong>OperationId:</strong>getReservationQueueStatistics</p>
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param hotelId
 @return ApiGetReservationQueueStatisticsRequest
*/
func (a *FOFStatsApiService) GetReservationQueueStatistics(ctx context.Context, hotelId string) ApiGetReservationQueueStatisticsRequest {
	return ApiGetReservationQueueStatisticsRequest{
		ApiService: a,
		ctx: ctx,
		hotelId: hotelId,
...
func (a *FOFStatsApiService) GetReservationQueueStatisticsExecute(r ApiGetReservationQueueStatisticsRequest) (*ReservationQueueStatistics, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
type ApiGetTaskSheetStatisticsRequest struct {
	ctx context.Context
	ApiService *FOFStatsApiService
	hotelId string
	authorization *string
...
// Bearer token that needs to be passed which is generated post user authentication
func (r ApiGetTaskSheetStatisticsRequest) Authorization(authorization string) ApiGetTaskSheetStatisticsRequest {
	r.authorization = &authorization
	return r
}

// Client or Partner’s Application Key
func (r ApiGetTaskSheetStatisticsRequest) XAppKey(xAppKey string) ApiGetTaskSheetStatisticsRequest {
	r.xAppKey = &xAppKey
	return r
}

// Mandatory parameter to identify the hotel code where the end user is logged in
func (r ApiGetTaskSheetStatisticsRequest) XHotelid(xHotelid string) ApiGetTaskSheetStatisticsRequest {
	r.xHotelid = &xHotelid
	return r
}

// This flag, if true, enables fetching statistics for all the housekeeping tasks assigned.
func (r ApiGetTaskSheetStatisticsRequest) IncludeAllAssignedTasks(includeAllAssignedTasks bool) ApiGetTaskSheetStatisticsRequest {
	r.includeAllAssignedTasks = &includeAllAssignedTasks
	return r
}

func (r ApiGetTaskSheetStatisticsRequest) IncludeTaskSheetsDetails(includeTaskSheetsDetails bool) ApiGetTaskSheetStatisticsRequest {
	r.includeTaskSheetsDetails = &includeTaskSheetsDetails
	return r
}

// Task code of the task sheet.
func (r ApiGetTaskSheetStatisticsRequest) TaskCode(taskCode string) ApiGetTaskSheetStatisticsRequest {
	r.taskCode = &taskCode
	return r
}

// External system code.
func (r ApiGetTaskSheetStatisticsRequest) XExternalsystem(xExternalsystem string) ApiGetTaskSheetStatisticsRequest {
	r.xExternalsystem = &xExternalsystem
	return r
}

// Language code
func (r ApiGetTaskSheetStatisticsRequest) AcceptLanguage(acceptLanguage string) ApiGetTaskSheetStatisticsRequest {
	r.acceptLanguage = &acceptLanguage
	return r
}

func (r ApiGetTaskSheetStatisticsRequest) Execute() (*TaskSheetStatistics, *http.Response, error) {
...
This Api will get the housekeeping statistics for your property. <p><strong>OperationId:</strong>getTaskSheetStatistics</p>
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param hotelId
 @return ApiGetTaskSheetStatisticsRequest
*/
func (a *FOFStatsApiService) GetTaskSheetStatistics(ctx context.Context, hotelId string) ApiGetTaskSheetStatisticsRequest {
	return ApiGetTaskSheetStatisticsRequest{
		ApiService: a,
		ctx: ctx,
		hotelId: hotelId,
...
func (a *FOFStatsApiService) GetTaskSheetStatisticsExecute(r ApiGetTaskSheetStatisticsRequest) (*TaskSheetStatistics, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
