...
const (
	FIRST_NIGHT RateChangeTypeType = "FirstNight"
	HIGHEST RateChangeTypeType = "Highest"
	LOWEST RateChangeTypeType = "Lowest"
	MOST_COMMON RateChangeTypeType = "MostCommon"
	AVERAGE RateChangeTypeType = "Average"
)
