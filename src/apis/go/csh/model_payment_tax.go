...
// List of paymentTax
const (
	DEPOSIT PaymentTax = "Deposit"
	FRONT_OFFICE PaymentTax = "FrontOffice"
	CREDIT_NOTE PaymentTax = "CreditNote"
	CITY_LEDGER PaymentTax = "CityLedger"
	ACCOUNTS_RECEIVABLES PaymentTax = "AccountsReceivables"
	NON_VAT PaymentTax = "NonVat"
)
