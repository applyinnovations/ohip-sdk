...
const (
	CHECK_OUT CashieringEventType = "CheckOut"
	EARLY_DEPARTURE CashieringEventType = "EarlyDeparture"
	ADVANCE_BILL CashieringEventType = "AdvanceBill"
	INTERIM_BILL CashieringEventType = "InterimBill"
	PASSER_BY CashieringEventType = "PasserBy"
	POST_IT CashieringEventType = "PostIt"
	CREDIT_BILL CashieringEventType = "CreditBill"
	DEPOSIT CashieringEventType = "Deposit"
	DEPOSIT_REFUND CashieringEventType = "DepositRefund"
	AUTO_FOLIO CashieringEventType = "AutoFolio"
	PREPAID_CARD CashieringEventType = "PrepaidCard"
	AUTO_SETTLEMENT CashieringEventType = "AutoSettlement"
	INFORMATION_FOLIO CashieringEventType = "InformationFolio"
	SUPPLEMENTAL_FOLIO CashieringEventType = "SupplementalFolio"
)
