...
const (
	INVOICE FolioCommandType = "Invoice"
	INFO FolioCommandType = "Info"
	RESEND_INVOICE FolioCommandType = "ResendInvoice"
	CANCELLATION FolioCommandType = "Cancellation"
	EOD_RESET FolioCommandType = "EodReset"
	X_REPORT FolioCommandType = "XReport"
	SEND_FISCAL_INVOICE FolioCommandType = "SendFiscalInvoice"
	ZERO_INVOICE FolioCommandType = "ZeroInvoice"
	END_OF_PERIOD FolioCommandType = "EndOfPeriod"
	ZERO_INVOICE_WITH_RECEIPT FolioCommandType = "ZeroInvoiceWithReceipt"
	FISCAL_UPDATE FolioCommandType = "FiscalUpdate"
	CHECK_OUT FolioCommandType = "CheckOut"
)
