...
// checks if the ApplyFinalPostingsRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ApplyFinalPostingsRequest{}

// ApplyFinalPostingsRequest struct for ApplyFinalPostingsRequest
type ApplyFinalPostingsRequest struct {
...
func NewApplyFinalPostingsRequest() *ApplyFinalPostingsRequest {
	this := ApplyFinalPostingsRequest{}
	return &this
}
...
func (o ApplyFinalPostingsRequest) MarshalJSON() ([]byte, error) {
...
func (o ApplyFinalPostingsRequest) ToMap() (map[string]interface{}, error) {
...
type NullableApplyFinalPostingsRequest struct {
	value *ApplyFinalPostingsRequest
	isSet bool
}

func (v NullableApplyFinalPostingsRequest) Get() *ApplyFinalPostingsRequest {
	return v.value
}

func (v *NullableApplyFinalPostingsRequest) Set(val *ApplyFinalPostingsRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableApplyFinalPostingsRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableApplyFinalPostingsRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableApplyFinalPostingsRequest(val *ApplyFinalPostingsRequest) *NullableApplyFinalPostingsRequest {
	return &NullableApplyFinalPostingsRequest{value: val, isSet: true}
}

func (v NullableApplyFinalPostingsRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableApplyFinalPostingsRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
