...
const (
	CC_UNIQUE_ID VaultHTTPTransactionType = "CCUniqueID"
	CC_NUMBER VaultHTTPTransactionType = "CCNumber"
	FOLIO_AUTHORIZATION VaultHTTPTransactionType = "FolioAuthorization"
)
