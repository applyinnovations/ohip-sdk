...
const (
	CORRESPONDENCE CalendarTaskClassType = "Correspondence"
	MEETING CalendarTaskClassType = "Meeting"
	TODOLIST CalendarTaskClassType = "Todolist"
	CALL CalendarTaskClassType = "Call"
	APPOINTMENT CalendarTaskClassType = "Appointment"
)
