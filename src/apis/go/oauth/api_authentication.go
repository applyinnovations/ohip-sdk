...
func (r ApiGetTokenRequest) XAppKey(xAppKey string) ApiGetTokenRequest {
	r.xAppKey = &xAppKey
	return r
}
...
func (r ApiGetTokenRequest) Execute() (*OAuth2TokenResponse, *http.Response, error) {
...
func (a *AuthenticationApiService) GetTokenExecute(r ApiGetTokenRequest) (*OAuth2TokenResponse, *http.Response, error) {
	var (
