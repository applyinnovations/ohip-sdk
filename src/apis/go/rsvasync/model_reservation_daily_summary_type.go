...
type ReservationDailySummaryType struct {
	...
	CheckedOutDate *time.Time `json:"checkedOutDate,omitempty"`
...
// SetCheckedOutDate gets a reference to the given time.Time and assigns it to the CheckedOutDate field.
