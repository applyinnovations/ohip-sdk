...
type ApiGetReservationsDailySummaryRequest struct {
	ctx context.Context
...
func (r ApiGetReservationsDailySummaryRequest) Authorization(authorization string) ApiGetReservationsDailySummaryRequest {
	r.authorization = &authorization
	return r
}

// Client or Partner’s Application Key
func (r ApiGetReservationsDailySummaryRequest) XAppKey(xAppKey string) ApiGetReservationsDailySummaryRequest {
	r.xAppKey = &xAppKey
	return r
}

// Mandatory parameter to identify the hotel code where the end user is logged in
func (r ApiGetReservationsDailySummaryRequest) XHotelid(xHotelid string) ApiGetReservationsDailySummaryRequest {
	r.xHotelid = &xHotelid
	return r
}

// Language code
func (r ApiGetReservationsDailySummaryRequest) AcceptLanguage(acceptLanguage string) ApiGetReservationsDailySummaryRequest {
	r.acceptLanguage = &acceptLanguage
	return r
}

func (r ApiGetReservationsDailySummaryRequest) Execute() (*ReservationsDailySummaryDetails, *http.Response, error) {
...
Use this API to retrieve a property&apos;s reservation daily summary within the dates given in the startReservationsDailySummaryProcess API request. You can get the value of the summaryId from the Location header returned by the getReservationsProcessStatus operation after the process is completed.  <p><strong>OperationId:</strong>getReservationsDailySummary</p>
 ...
 @param extSystemCode
 @param hotelId
 @return ApiGetReservationsDailySummaryRequest
*/
func (a *ReservationAsyncApiService) GetReservationsDailySummary(ctx context.Context, summaryId string, extSystemCode string, hotelId string) ApiGetReservationsDailySummaryRequest {
	return ApiGetReservationsDailySummaryRequest{
		ApiService: a,
		ctx: ctx,
		summaryId: summaryId,
...
func (a *ReservationAsyncApiService) GetReservationsDailySummaryExecute(r ApiGetReservationsDailySummaryRequest) (*ReservationsDailySummaryDetails, *http.Response, error) {
	var (
...
type ApiGetReservationsProcessStatusRequest struct {
	ctx context.Context
	ApiService *ReservationAsyncApiService
	summaryId string
	extSystemCode string
...
// Bearer token that needs to be passed which is generated post user authentication
func (r ApiGetReservationsProcessStatusRequest) Authorization(authorization string) ApiGetReservationsProcessStatusRequest {
	r.authorization = &authorization
	return r
}

// Client or Partner’s Application Key
func (r ApiGetReservationsProcessStatusRequest) XAppKey(xAppKey string) ApiGetReservationsProcessStatusRequest {
	r.xAppKey = &xAppKey
	return r
}

// Mandatory parameter to identify the hotel code where the end user is logged in
func (r ApiGetReservationsProcessStatusRequest) XHotelid(xHotelid string) ApiGetReservationsProcessStatusRequest {
	r.xHotelid = &xHotelid
	return r
}

// Language code
func (r ApiGetReservationsProcessStatusRequest) AcceptLanguage(acceptLanguage string) ApiGetReservationsProcessStatusRequest {
	r.acceptLanguage = &acceptLanguage
	return r
}

func (r ApiGetReservationsProcessStatusRequest) Execute() (*http.Response, error) {
...
Use this to check whether the process to generate reservations daily summaries is complete. You can get value of summaryId from the Location header returned by the startReservationsDailySummaryProcess operation. <p><strong>OperationId:</strong>getReservationsProcessStatus</p>
 ...
 @param extSystemCode
 @param hotelId
 @return ApiGetReservationsProcessStatusRequest
*/
func (a *ReservationAsyncApiService) GetReservationsProcessStatus(ctx context.Context, summaryId string, extSystemCode string, hotelId string) ApiGetReservationsProcessStatusRequest {
	return ApiGetReservationsProcessStatusRequest{
		ApiService: a,
		ctx: ctx,
		summaryId: summaryId,
...
// Execute executes the request
func (a *ReservationAsyncApiService) GetReservationsProcessStatusExecute(r ApiGetReservationsProcessStatusRequest) (*http.Response, error) {
	var (
...
type ApiStartReservationsDailySummaryProcessRequest struct {
	ctx context.Context
	ApiService *ReservationAsyncApiService
	extSystemCode string
	hotelId string
...
// Bearer token that needs to be passed which is generated post user authentication
func (r ApiStartReservationsDailySummaryProcessRequest) Authorization(authorization string) ApiStartReservationsDailySummaryProcessRequest {
	r.authorization = &authorization
	return r
}

// Client or Partner’s Application Key
func (r ApiStartReservationsDailySummaryProcessRequest) XAppKey(xAppKey string) ApiStartReservationsDailySummaryProcessRequest {
	r.xAppKey = &xAppKey
	return r
}

// Mandatory parameter to identify the hotel code where the end user is logged in
func (r ApiStartReservationsDailySummaryProcessRequest) XHotelid(xHotelid string) ApiStartReservationsDailySummaryProcessRequest {
	r.xHotelid = &xHotelid
	return r
}

// Request object for fetching future reservations asynchronously.
func (r ApiStartReservationsDailySummaryProcessRequest) Criteria(criteria Criteria) ApiStartReservationsDailySummaryProcessRequest {
	r.criteria = &criteria
	return r
}

// Language code
func (r ApiStartReservationsDailySummaryProcessRequest) AcceptLanguage(acceptLanguage string) ApiStartReservationsDailySummaryProcessRequest {
	r.acceptLanguage = &acceptLanguage
	return r
}

func (r ApiStartReservationsDailySummaryProcessRequest) Execute() (*http.Response, error) {
...
Use this API to get a reservation daily summary for a property within a given date range. Maximum limit of date range is 94 days, but the recommendation is to use a date range proportionate to the size of the hotel. Returns a header parameter Location that can be used in the getReservationsProcessStatus operation.  Use event driven APIs (see https://docs.oracle.com/cd/F29336_01/doc.201/f27480/c_business_events.htm#OHIPU-BusinessEvents-F0AC1F1C) to get real time reservation updates.  <p><strong>OperationId:</strong>startReservationsDailySummaryProcess</p>
 ...
 @param extSystemCode
 @param hotelId
 @return ApiStartReservationsDailySummaryProcessRequest
*/
func (a *ReservationAsyncApiService) StartReservationsDailySummaryProcess(ctx context.Context, extSystemCode string, hotelId string) ApiStartReservationsDailySummaryProcessRequest {
	return ApiStartReservationsDailySummaryProcessRequest{
		ApiService: a,
		ctx: ctx,
		extSystemCode: extSystemCode,
...
// Execute executes the request
func (a *ReservationAsyncApiService) StartReservationsDailySummaryProcessExecute(r ApiStartReservationsDailySummaryProcessRequest) (*http.Response, error) {
	var (
