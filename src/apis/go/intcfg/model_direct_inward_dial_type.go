...
const (
	NOT_AVAILABLE DirectInwardDialType = "NotAvailable"
	ALWAYS_ON DirectInwardDialType = "AlwaysOn"
	ALWAYS_OFF DirectInwardDialType = "AlwaysOff"
	FREELY_SWITCHABLE DirectInwardDialType = "FreelySwitchable"
)
