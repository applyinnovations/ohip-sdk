...
const (
	OPERA_TRANSACTION SVTransactionType = "OperaTransaction"
	VENDOR_TRANSACTION SVTransactionType = "VendorTransaction"
	OPERA_AND_VENDOR_TRANSACTION SVTransactionType = "OperaAndVendorTransaction"
)
