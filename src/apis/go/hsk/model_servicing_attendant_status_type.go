...
const (
	STANDBY ServicingAttendantStatusType = "Standby"
	BREAK ServicingAttendantStatusType = "Break"
	WORKING ServicingAttendantStatusType = "Working"
	COMPLETED ServicingAttendantStatusType = "Completed"
)
