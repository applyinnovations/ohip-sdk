...
type HousekeepingCreditsType struct {
	...
	NumberOfCredits *int32 `json:"numberOfCredits,omitempty"`
}
...
// SetNumberOfCredits gets a reference to the given int32 and assigns it to the NumberOfCredits field.
