...
type ActivityManagementApiDeleteActivityManagementServicesCacheRequest struct {
	ctx context.Context
	ApiService *ActivityManagementApiService
	authorization *string
	xAppKey *string
...
// Bearer token that needs to be passed which is generated post user authentication
func (r ActivityManagementApiDeleteActivityManagementServicesCacheRequest) Authorization(authorization string) ActivityManagementApiDeleteActivityManagementServicesCacheRequest {
	r.authorization = &authorization
	return r
}

// Client or Partner’s Application Key
func (r ActivityManagementApiDeleteActivityManagementServicesCacheRequest) XAppKey(xAppKey string) ActivityManagementApiDeleteActivityManagementServicesCacheRequest {
	r.xAppKey = &xAppKey
	return r
}

// Mandatory parameter to identify the hotel code where the end user is logged in
func (r ActivityManagementApiDeleteActivityManagementServicesCacheRequest) XHotelid(xHotelid string) ActivityManagementApiDeleteActivityManagementServicesCacheRequest {
	r.xHotelid = &xHotelid
	return r
}

// External system code.
func (r ActivityManagementApiDeleteActivityManagementServicesCacheRequest) XExternalsystem(xExternalsystem string) ActivityManagementApiDeleteActivityManagementServicesCacheRequest {
	r.xExternalsystem = &xExternalsystem
	return r
}

// Language code
func (r ActivityManagementApiDeleteActivityManagementServicesCacheRequest) AcceptLanguage(acceptLanguage string) ActivityManagementApiDeleteActivityManagementServicesCacheRequest {
	r.acceptLanguage = &acceptLanguage
	return r
}

func (r ActivityManagementApiDeleteActivityManagementServicesCacheRequest) Execute() (*Status, *http.Response, error) {
...
DeleteActivityManagementServicesCache Operation to clear cache.
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ActivityManagementApiDeleteActivityManagementServicesCacheRequest
*/
func (a *ActivityManagementApiService) DeleteActivityManagementServicesCache(ctx context.Context) ActivityManagementApiDeleteActivityManagementServicesCacheRequest {
	return ActivityManagementApiDeleteActivityManagementServicesCacheRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return Status
func (a *ActivityManagementApiService) DeleteActivityManagementServicesCacheExecute(r ActivityManagementApiDeleteActivityManagementServicesCacheRequest) (*Status, *http.Response, error) {
	var (
