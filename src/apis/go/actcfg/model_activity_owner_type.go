...
const (
	CURRENT ActivityOwnerType = "Current"
	PRIMARY ActivityOwnerType = "Primary"
	CUSTOM ActivityOwnerType = "Custom"
	BLOCK ActivityOwnerType = "Block"
	ROOM ActivityOwnerType = "Room"
	CATERING ActivityOwnerType = "Catering"
)
