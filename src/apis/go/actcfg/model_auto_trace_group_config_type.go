...
const (
	ACCOUNTS AutoTraceGroupConfigType = "Accounts"
	CONTACTS AutoTraceGroupConfigType = "Contacts"
	BLOCKS AutoTraceGroupConfigType = "Blocks"
	ACTIVITIES AutoTraceGroupConfigType = "Activities"
)
