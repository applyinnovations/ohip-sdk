 ...
 */
export function instanceOfPutActivitiesRequest(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function PutActivitiesRequestFromJSON(json: any): PutActivitiesRequest {
    return PutActivitiesRequestFromJSONTyped(json, false);
}

export function PutActivitiesRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): PutActivitiesRequest {
...
export function PutActivitiesRequestToJSON(value?: PutActivitiesRequest | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
