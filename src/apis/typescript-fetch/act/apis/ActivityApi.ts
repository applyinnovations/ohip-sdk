...
export class ActivityApi extends runtime.BaseAPI {
     ...
     */
    async deleteActivityServiceCacheRaw(requestParameters: DeleteActivityServiceCacheRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Status>> {
        const queryParameters: any = {};
     ...
     * Clear Activity Cache
     */
    async deleteActivityServiceCache(requestParameters: DeleteActivityServiceCacheRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Status> {
     ...
     */
    async pingActivityServiceRaw(requestParameters: PingActivityServiceRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<OperaVersion>> {
        const queryParameters: any = {};
     ...
     * Operation to get health status
     */
    async pingActivityService(requestParameters: PingActivityServiceRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<OperaVersion> {
