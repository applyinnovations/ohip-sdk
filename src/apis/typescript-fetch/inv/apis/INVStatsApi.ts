...
export class INVStatsApi extends runtime.BaseAPI {
     ...
     * Clear Cache
     */
    async deleteinvStatsServiceRaw(requestParameters: DeleteinvStatsServiceRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Status>> {
     ...
     * Clear Cache
     */
    async deleteinvStatsService(requestParameters: DeleteinvStatsServiceRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Status> {
     ...
     * Ping
     */
    async pinginvStatsServiceRaw(requestParameters: PinginvStatsServiceRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<PingDetail>> {
        const queryParameters: any = {};
     ...
     * Ping
     */
    async pinginvStatsService(requestParameters: PinginvStatsServiceRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<PingDetail> {
