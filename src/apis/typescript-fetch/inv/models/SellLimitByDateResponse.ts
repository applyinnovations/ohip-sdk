 ...
 */
export function instanceOfSellLimitByDateResponse(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function SellLimitByDateResponseFromJSON(json: any): SellLimitByDateResponse {
    return SellLimitByDateResponseFromJSONTyped(json, false);
}

export function SellLimitByDateResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): SellLimitByDateResponse {
...
export function SellLimitByDateResponseToJSON(value?: SellLimitByDateResponse | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
