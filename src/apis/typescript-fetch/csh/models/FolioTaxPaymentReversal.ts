 ...
 */
export function instanceOfFolioTaxPaymentReversal(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function FolioTaxPaymentReversalFromJSON(json: any): FolioTaxPaymentReversal {
    return FolioTaxPaymentReversalFromJSONTyped(json, false);
}

export function FolioTaxPaymentReversalFromJSONTyped(json: any, ignoreDiscriminator: boolean): FolioTaxPaymentReversal {
...
export function FolioTaxPaymentReversalToJSON(value?: FolioTaxPaymentReversal | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
