 ...
 */
export function instanceOfPostCompRedemptions(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function PostCompRedemptionsFromJSON(json: any): PostCompRedemptions {
    return PostCompRedemptionsFromJSONTyped(json, false);
}

export function PostCompRedemptionsFromJSONTyped(json: any, ignoreDiscriminator: boolean): PostCompRedemptions {
...
export function PostCompRedemptionsToJSON(value?: PostCompRedemptions | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
