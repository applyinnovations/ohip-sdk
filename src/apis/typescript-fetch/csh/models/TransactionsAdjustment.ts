 ...
 */
export function instanceOfTransactionsAdjustment(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function TransactionsAdjustmentFromJSON(json: any): TransactionsAdjustment {
    return TransactionsAdjustmentFromJSONTyped(json, false);
}

export function TransactionsAdjustmentFromJSONTyped(json: any, ignoreDiscriminator: boolean): TransactionsAdjustment {
...
export function TransactionsAdjustmentToJSON(value?: TransactionsAdjustment | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
