 ...
 */
export function instanceOfBatchAutoCheckoutReservation(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function BatchAutoCheckoutReservationFromJSON(json: any): BatchAutoCheckoutReservation {
    return BatchAutoCheckoutReservationFromJSONTyped(json, false);
}

export function BatchAutoCheckoutReservationFromJSONTyped(json: any, ignoreDiscriminator: boolean): BatchAutoCheckoutReservation {
...
export function BatchAutoCheckoutReservationToJSON(value?: BatchAutoCheckoutReservation | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
