 ...
 */
export function instanceOfCompAccountingJournal(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function CompAccountingJournalFromJSON(json: any): CompAccountingJournal {
    return CompAccountingJournalFromJSONTyped(json, false);
}

export function CompAccountingJournalFromJSONTyped(json: any, ignoreDiscriminator: boolean): CompAccountingJournal {
...
export function CompAccountingJournalToJSON(value?: CompAccountingJournal | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
