 ...
 */
export function instanceOfSubAllocationTypeBlockProfiles(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function SubAllocationTypeBlockProfilesFromJSON(json: any): SubAllocationTypeBlockProfiles {
    return SubAllocationTypeBlockProfilesFromJSONTyped(json, false);
}

export function SubAllocationTypeBlockProfilesFromJSONTyped(json: any, ignoreDiscriminator: boolean): SubAllocationTypeBlockProfiles {
...
export function SubAllocationTypeBlockProfilesToJSON(value?: SubAllocationTypeBlockProfiles | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
