 ...
 */
export function instanceOfConversionCodesStatusToBeChanged(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function ConversionCodesStatusToBeChangedFromJSON(json: any): ConversionCodesStatusToBeChanged {
    return ConversionCodesStatusToBeChangedFromJSONTyped(json, false);
}

export function ConversionCodesStatusToBeChangedFromJSONTyped(json: any, ignoreDiscriminator: boolean): ConversionCodesStatusToBeChanged {
...
export function ConversionCodesStatusToBeChangedToJSON(value?: ConversionCodesStatusToBeChanged | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
