 ...
 */
export function instanceOfPutInterfaceControlsRequest(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function PutInterfaceControlsRequestFromJSON(json: any): PutInterfaceControlsRequest {
    return PutInterfaceControlsRequestFromJSONTyped(json, false);
}

export function PutInterfaceControlsRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): PutInterfaceControlsRequest {
...
export function PutInterfaceControlsRequestToJSON(value?: PutInterfaceControlsRequest | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
