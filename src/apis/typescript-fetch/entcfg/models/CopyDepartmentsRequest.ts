 ...
 */
export function instanceOfCopyDepartmentsRequest(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function CopyDepartmentsRequestFromJSON(json: any): CopyDepartmentsRequest {
    return CopyDepartmentsRequestFromJSONTyped(json, false);
}

export function CopyDepartmentsRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): CopyDepartmentsRequest {
...
export function CopyDepartmentsRequestToJSON(value?: CopyDepartmentsRequest | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
