 ...
 */
export function instanceOfTranslationTextType20(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function TranslationTextType20FromJSON(json: any): TranslationTextType20 {
    return TranslationTextType20FromJSONTyped(json, false);
}

export function TranslationTextType20FromJSONTyped(json: any, ignoreDiscriminator: boolean): TranslationTextType20 {
...
export function TranslationTextType20ToJSON(value?: TranslationTextType20 | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
