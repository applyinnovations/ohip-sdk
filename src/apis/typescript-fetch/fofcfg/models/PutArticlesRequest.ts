 ...
 */
export function instanceOfPutArticlesRequest(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function PutArticlesRequestFromJSON(json: any): PutArticlesRequest {
    return PutArticlesRequestFromJSONTyped(json, false);
}

export function PutArticlesRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): PutArticlesRequest {
...
export function PutArticlesRequestToJSON(value?: PutArticlesRequest | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
