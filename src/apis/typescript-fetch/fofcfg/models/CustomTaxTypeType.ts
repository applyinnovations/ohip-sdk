 ...
 */
export function instanceOfCustomTaxTypeType(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function CustomTaxTypeTypeFromJSON(json: any): CustomTaxTypeType {
    return CustomTaxTypeTypeFromJSONTyped(json, false);
}

export function CustomTaxTypeTypeFromJSONTyped(json: any, ignoreDiscriminator: boolean): CustomTaxTypeType {
...
export function CustomTaxTypeTypeToJSON(value?: CustomTaxTypeType | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
