 ...
 */
export function instanceOfFolioTypeLegendMappingConfigType(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function FolioTypeLegendMappingConfigTypeFromJSON(json: any): FolioTypeLegendMappingConfigType {
    return FolioTypeLegendMappingConfigTypeFromJSONTyped(json, false);
}

export function FolioTypeLegendMappingConfigTypeFromJSONTyped(json: any, ignoreDiscriminator: boolean): FolioTypeLegendMappingConfigType {
    ...
    return {
        ...
        'legendCode': !exists(json, 'legendCode') ? undefined : json['legendCode'],
        'folioType': !exists(json, 'folioType') ? undefined : json['folioType'],
        'folioTypeDescription': !exists(json, 'folioTypeDescription') ? undefined : json['folioTypeDescription'],
    };
}

export function FolioTypeLegendMappingConfigTypeToJSON(value?: FolioTypeLegendMappingConfigType | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
