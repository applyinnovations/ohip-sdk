...
export class CommissionConfigApi extends runtime.BaseAPI {
     ...
     */
    async deleteCommisionConfigServicesCacheRaw(requestParameters: DeleteCommisionConfigServicesCacheRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Status>> {
     ...
     * Operation to clear cache.
     */
    async deleteCommisionConfigServicesCache(requestParameters: DeleteCommisionConfigServicesCacheRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Status> {
     ...
     * Operation to ping.
     */
    async pingCommisionConfigServicesRaw(requestParameters: PingCommisionConfigServicesRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<OperaVersion>> {
        const queryParameters: any = {};
     ...
     * Operation to ping.
     */
    async pingCommisionConfigServices(requestParameters: PingCommisionConfigServicesRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<OperaVersion> {
