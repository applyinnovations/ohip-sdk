...
export class LeisureManagementConfigApi extends runtime.BaseAPI {
     ...
     *  clear cache
     */
    async deleteLeisureManagementConfigCacheRaw(requestParameters: DeleteLeisureManagementConfigCacheRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Status>> {
        const queryParameters: any = {};
     ...
     *  clear cache
     */
    async deleteLeisureManagementConfigCache(requestParameters: DeleteLeisureManagementConfigCacheRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Status> {
     ...
     */
    async getLeisureManagementConfigServicesStatusRaw(requestParameters: GetLeisureManagementConfigServicesStatusRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<OperaVersion>> {
        const queryParameters: any = {};
     ...
     * Send a response to a ping
     */
    async getLeisureManagementConfigServicesStatus(requestParameters: GetLeisureManagementConfigServicesStatusRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<OperaVersion> {
