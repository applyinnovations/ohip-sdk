 ...
 */
export function instanceOfPostTemplateFloorsRequest(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function PostTemplateFloorsRequestFromJSON(json: any): PostTemplateFloorsRequest {
    return PostTemplateFloorsRequestFromJSONTyped(json, false);
}

export function PostTemplateFloorsRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): PostTemplateFloorsRequest {
...
export function PostTemplateFloorsRequestToJSON(value?: PostTemplateFloorsRequest | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
