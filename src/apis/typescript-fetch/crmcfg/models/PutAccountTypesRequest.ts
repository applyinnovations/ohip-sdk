 ...
 */
export function instanceOfPutAccountTypesRequest(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function PutAccountTypesRequestFromJSON(json: any): PutAccountTypesRequest {
    return PutAccountTypesRequestFromJSONTyped(json, false);
}

export function PutAccountTypesRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): PutAccountTypesRequest {
...
export function PutAccountTypesRequestToJSON(value?: PutAccountTypesRequest | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
