 ...
 */
export function instanceOfPostEcertificateLocationTypesRequest(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function PostEcertificateLocationTypesRequestFromJSON(json: any): PostEcertificateLocationTypesRequest {
    return PostEcertificateLocationTypesRequestFromJSONTyped(json, false);
}

export function PostEcertificateLocationTypesRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): PostEcertificateLocationTypesRequest {
...
export function PostEcertificateLocationTypesRequestToJSON(value?: PostEcertificateLocationTypesRequest | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
