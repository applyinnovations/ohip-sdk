 ...
 */
export function instanceOfCompanyTypeType(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function CompanyTypeTypeFromJSON(json: any): CompanyTypeType {
    return CompanyTypeTypeFromJSONTyped(json, false);
}

export function CompanyTypeTypeFromJSONTyped(json: any, ignoreDiscriminator: boolean): CompanyTypeType {
...
export function CompanyTypeTypeToJSON(value?: CompanyTypeType | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
