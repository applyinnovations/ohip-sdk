...
import {
    ...
    PutProfileRelationshipsRequestFromJSON,
    PutProfileRelationshipsRequestToJSON,
...
export class ProfileConfigurationApi extends runtime.BaseAPI {
     ...
     *  clear cache
     */
    async deleteProfileConfigServiceCacheRaw(requestParameters: DeleteProfileConfigServiceCacheRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Status>> {
        const queryParameters: any = {};
     ...
     *  clear cache
     */
    async deleteProfileConfigServiceCache(requestParameters: DeleteProfileConfigServiceCacheRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Status> {
    ...
    async postProfileRelationshipsRaw(requestParameters: PostProfileRelationshipsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Status>> {
        ...
        const response = await this.request({
            ...
            headers: headerParameters,
            query: queryParameters,
            body: PutProfileRelationshipsRequestToJSON(requestParameters.profileLinks),
        }, initOverrides);
     ...
     */
    async putProfileRelationshipsRaw(requestParameters: PutProfileRelationshipsOperationRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Status>> {
        const queryParameters: any = {};
     ...
     * Change profile relationships
     */
    async putProfileRelationships(requestParameters: PutProfileRelationshipsOperationRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Status> {
