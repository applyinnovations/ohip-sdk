...
export function BaseTypeFromJSON(json: any): BaseType {
    return BaseTypeFromJSONTyped(json, false);
}

export function BaseTypeFromJSONTyped(json: any, ignoreDiscriminator: boolean): BaseType {
    return json as BaseType;
}

export function BaseTypeToJSON(value?: BaseType | null): any {
    return value as any;
}
