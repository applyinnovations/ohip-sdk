...
export function ReservationReservationFromJSONTyped(json: any, ignoreDiscriminator: boolean): ReservationReservation {
    ...
    return {
        ...
        'startCheckInProcessTime': !exists(json, 'startCheckInProcessTime') ? undefined : (new Date(json['startCheckInProcessTime'])),
        'endCheckInProcessTime': !exists(json, 'endCheckInProcessTime') ? undefined : (new Date(json['endCheckInProcessTime'])),
