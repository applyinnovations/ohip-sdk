...
export function RoomKeyInfoTypeFromJSONTyped(json: any, ignoreDiscriminator: boolean): RoomKeyInfoType {
    ...
    return {
        ...
        'keyStartDate': !exists(json, 'keyStartDate') ? undefined : (new Date(json['keyStartDate'])),
        'keyExpiryDate': !exists(json, 'keyExpiryDate') ? undefined : (new Date(json['keyExpiryDate'])),
