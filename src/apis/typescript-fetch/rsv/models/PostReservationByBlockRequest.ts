 ...
 */
export function instanceOfPostReservationByBlockRequest(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function PostReservationByBlockRequestFromJSON(json: any): PostReservationByBlockRequest {
    return PostReservationByBlockRequestFromJSONTyped(json, false);
}

export function PostReservationByBlockRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): PostReservationByBlockRequest {
...
export function PostReservationByBlockRequestToJSON(value?: PostReservationByBlockRequest | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
