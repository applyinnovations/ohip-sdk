 ...
 */
export function instanceOfChangeReservation(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function ChangeReservationFromJSON(json: any): ChangeReservation {
    return ChangeReservationFromJSONTyped(json, false);
}

export function ChangeReservationFromJSONTyped(json: any, ignoreDiscriminator: boolean): ChangeReservation {
...
export function ChangeReservationToJSON(value?: ChangeReservation | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
