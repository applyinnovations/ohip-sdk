 ...
 * 
 * @export
 * @interface PostReservationLinksByChainRequest
 */
export interface PostReservationLinksByChainRequest {
    /**
     * Unique Id that references an object uniquely in the system.
     * @type {Array<UniqueIDType>}
     * @memberof PostReservationLinksByChainRequest
     */
 ...
 */
export function instanceOfPostReservationLinksByChainRequest(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function PostReservationLinksByChainRequestFromJSON(json: any): PostReservationLinksByChainRequest {
    return PostReservationLinksByChainRequestFromJSONTyped(json, false);
}

export function PostReservationLinksByChainRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): PostReservationLinksByChainRequest {
...
export function PostReservationLinksByChainRequestToJSON(value?: PostReservationLinksByChainRequest | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
