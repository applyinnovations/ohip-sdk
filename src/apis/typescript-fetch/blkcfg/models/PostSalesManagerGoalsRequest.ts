 ...
 */
export function instanceOfPostSalesManagerGoalsRequest(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function PostSalesManagerGoalsRequestFromJSON(json: any): PostSalesManagerGoalsRequest {
    return PostSalesManagerGoalsRequestFromJSONTyped(json, false);
}

export function PostSalesManagerGoalsRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): PostSalesManagerGoalsRequest {
...
export function PostSalesManagerGoalsRequestToJSON(value?: PostSalesManagerGoalsRequest | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
