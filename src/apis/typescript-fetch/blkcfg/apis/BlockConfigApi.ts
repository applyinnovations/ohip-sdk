...
export class BlockConfigApi extends runtime.BaseAPI {
     ...
     *  clear cache
     */
    async deleteBlockConfigServiceCacheRaw(requestParameters: DeleteBlockConfigServiceCacheRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Status>> {
     ...
     *  clear cache
     */
    async deleteBlockConfigServiceCache(requestParameters: DeleteBlockConfigServiceCacheRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Status> {
     ...
     *  ping
     */
    async pingBlockConfigServiceRaw(requestParameters: PingBlockConfigServiceRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<OperaVersion>> {
        const queryParameters: any = {};
     ...
     *  ping
     */
    async pingBlockConfigService(requestParameters: PingBlockConfigServiceRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<OperaVersion> {
