...
export class ProfileStatisticsApi extends runtime.BaseAPI {
     ...
     */
    async pingProfileStatsServiceRaw(requestParameters: PingProfileStatsServiceRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<OperaVersion>> {
        const queryParameters: any = {};
     ...
     * Operation to check the status of ProfileStats service
     */
    async pingProfileStatsService(requestParameters: PingProfileStatsServiceRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<OperaVersion> {
        const response = await this.pingProfileStatsServiceRaw(requestParameters, initOverrides);
        return await response.value();
    }
