 ...
 */
export function instanceOfProfileCommissionAccountCriteriaType(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function ProfileCommissionAccountCriteriaTypeFromJSON(json: any): ProfileCommissionAccountCriteriaType {
    return ProfileCommissionAccountCriteriaTypeFromJSONTyped(json, false);
}

export function ProfileCommissionAccountCriteriaTypeFromJSONTyped(json: any, ignoreDiscriminator: boolean): ProfileCommissionAccountCriteriaType {
...
export function ProfileCommissionAccountCriteriaTypeToJSON(value?: ProfileCommissionAccountCriteriaType | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
