 ...
 */
export function instanceOfPostProfileRequest(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function PostProfileRequestFromJSON(json: any): PostProfileRequest {
    return PostProfileRequestFromJSONTyped(json, false);
}

export function PostProfileRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): PostProfileRequest {
...
export function PostProfileRequestToJSON(value?: PostProfileRequest | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
