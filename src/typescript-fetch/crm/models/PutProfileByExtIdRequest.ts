 ...
 * 
 * @export
 * @interface PutProfileByExtIdRequest
 */
export interface PutProfileByExtIdRequest {
    /**
     * Unique Id that references an object uniquely in the system.
     * @type {Array<UniqueIDType>}
     * @memberof PutProfileByExtIdRequest
     */
 ...
 */
export function instanceOfPutProfileByExtIdRequest(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function PutProfileByExtIdRequestFromJSON(json: any): PutProfileByExtIdRequest {
    return PutProfileByExtIdRequestFromJSONTyped(json, false);
}

export function PutProfileByExtIdRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): PutProfileByExtIdRequest {
...
export function PutProfileByExtIdRequestToJSON(value?: PutProfileByExtIdRequest | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
