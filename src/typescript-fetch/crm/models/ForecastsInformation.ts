 ...
 * 
 * @export
 * @interface ForecastsInformation
 */
 ...
 */
export function instanceOfForecastsInformation(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function ForecastsInformationFromJSON(json: any): ForecastsInformation {
    return ForecastsInformationFromJSONTyped(json, false);
}

export function ForecastsInformationFromJSONTyped(json: any, ignoreDiscriminator: boolean): ForecastsInformation {
...
export function ForecastsInformationToJSON(value?: ForecastsInformation | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
