 ...
 */
export function instanceOfStagedProfileNumericUDFType(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function StagedProfileNumericUDFTypeFromJSON(json: any): StagedProfileNumericUDFType {
    return StagedProfileNumericUDFTypeFromJSONTyped(json, false);
}

export function StagedProfileNumericUDFTypeFromJSONTyped(json: any, ignoreDiscriminator: boolean): StagedProfileNumericUDFType {
...
export function StagedProfileNumericUDFTypeToJSON(value?: StagedProfileNumericUDFType | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
