 ...
 */
export function instanceOfMembershipTransactionsSummary(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function MembershipTransactionsSummaryFromJSON(json: any): MembershipTransactionsSummary {
    return MembershipTransactionsSummaryFromJSONTyped(json, false);
}

export function MembershipTransactionsSummaryFromJSONTyped(json: any, ignoreDiscriminator: boolean): MembershipTransactionsSummary {
...
export function MembershipTransactionsSummaryToJSON(value?: MembershipTransactionsSummary | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
