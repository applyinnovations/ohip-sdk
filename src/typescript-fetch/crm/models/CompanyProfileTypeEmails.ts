 ...
 */
export function instanceOfCompanyProfileTypeEmails(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function CompanyProfileTypeEmailsFromJSON(json: any): CompanyProfileTypeEmails {
    return CompanyProfileTypeEmailsFromJSONTyped(json, false);
}

export function CompanyProfileTypeEmailsFromJSONTyped(json: any, ignoreDiscriminator: boolean): CompanyProfileTypeEmails {
...
export function CompanyProfileTypeEmailsToJSON(value?: CompanyProfileTypeEmails | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
