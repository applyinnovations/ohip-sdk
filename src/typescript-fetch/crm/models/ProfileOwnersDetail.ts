 ...
 */
export function instanceOfProfileOwnersDetail(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function ProfileOwnersDetailFromJSON(json: any): ProfileOwnersDetail {
    return ProfileOwnersDetailFromJSONTyped(json, false);
}

export function ProfileOwnersDetailFromJSONTyped(json: any, ignoreDiscriminator: boolean): ProfileOwnersDetail {
...
export function ProfileOwnersDetailToJSON(value?: ProfileOwnersDetail | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
