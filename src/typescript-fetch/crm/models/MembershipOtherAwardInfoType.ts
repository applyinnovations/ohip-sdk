...
import {
    OtherAwardAvailabilityTypeFromJSON,
    OtherAwardAvailabilityTypeFromJSONTyped,
    OtherAwardAvailabilityTypeToJSON,
} from './OtherAwardAvailabilityType';
 ...
 */
export function instanceOfMembershipOtherAwardInfoType(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function MembershipOtherAwardInfoTypeFromJSON(json: any): MembershipOtherAwardInfoType {
    return MembershipOtherAwardInfoTypeFromJSONTyped(json, false);
}

export function MembershipOtherAwardInfoTypeFromJSONTyped(json: any, ignoreDiscriminator: boolean): MembershipOtherAwardInfoType {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        
        'otherInfo': !exists(json, 'otherInfo') ? undefined : OtherAwardAvailabilityTypeFromJSON(json['otherInfo']),
...
export function MembershipOtherAwardInfoTypeToJSON(value?: MembershipOtherAwardInfoType | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'otherInfo': OtherAwardAvailabilityTypeToJSON(value.otherInfo),
