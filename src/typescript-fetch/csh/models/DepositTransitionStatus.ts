 ...
 */
export function instanceOfDepositTransitionStatus(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function DepositTransitionStatusFromJSON(json: any): DepositTransitionStatus {
    return DepositTransitionStatusFromJSONTyped(json, false);
}

export function DepositTransitionStatusFromJSONTyped(json: any, ignoreDiscriminator: boolean): DepositTransitionStatus {
...
export function DepositTransitionStatusToJSON(value?: DepositTransitionStatus | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
