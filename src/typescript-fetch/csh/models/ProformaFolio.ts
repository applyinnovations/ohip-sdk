 ...
 */
export function instanceOfProformaFolio(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function ProformaFolioFromJSON(json: any): ProformaFolio {
    return ProformaFolioFromJSONTyped(json, false);
}

export function ProformaFolioFromJSONTyped(json: any, ignoreDiscriminator: boolean): ProformaFolio {
...
export function ProformaFolioToJSON(value?: ProformaFolio | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
