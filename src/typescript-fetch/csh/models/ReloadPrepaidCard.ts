 ...
 */
export function instanceOfReloadPrepaidCard(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function ReloadPrepaidCardFromJSON(json: any): ReloadPrepaidCard {
    return ReloadPrepaidCardFromJSONTyped(json, false);
}

export function ReloadPrepaidCardFromJSONTyped(json: any, ignoreDiscriminator: boolean): ReloadPrepaidCard {
...
export function ReloadPrepaidCardToJSON(value?: ReloadPrepaidCard | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
