...
import {
    CashOutPrepaidCardCriteriaFromJSON,
    CashOutPrepaidCardCriteriaFromJSONTyped,
    CashOutPrepaidCardCriteriaToJSON,
} from './CashOutPrepaidCardCriteria';
...
export function CashOutPrepaidCardFromJSONTyped(json: any, ignoreDiscriminator: boolean): CashOutPrepaidCard {
    ...
    return {
        ...
        'criteria': !exists(json, 'criteria') ? undefined : CashOutPrepaidCardCriteriaFromJSON(json['criteria']),
...
export function CashOutPrepaidCardToJSON(value?: CashOutPrepaidCard | null): any {
    ...
    return {
        ...
        'criteria': CashOutPrepaidCardCriteriaToJSON(value.criteria),
