 ...
 */
export function instanceOfActivatePrepaidCard(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function ActivatePrepaidCardFromJSON(json: any): ActivatePrepaidCard {
    return ActivatePrepaidCardFromJSONTyped(json, false);
}

export function ActivatePrepaidCardFromJSONTyped(json: any, ignoreDiscriminator: boolean): ActivatePrepaidCard {
...
export function ActivatePrepaidCardToJSON(value?: ActivatePrepaidCard | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
