 ...
 */
export function instanceOfFolioHistoryResponse(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function FolioHistoryResponseFromJSON(json: any): FolioHistoryResponse {
    return FolioHistoryResponseFromJSONTyped(json, false);
}

export function FolioHistoryResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): FolioHistoryResponse {
...
export function FolioHistoryResponseToJSON(value?: FolioHistoryResponse | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
