 ...
 */
export function instanceOfResvRoutingInfoTypeRequest(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function ResvRoutingInfoTypeRequestFromJSON(json: any): ResvRoutingInfoTypeRequest {
    return ResvRoutingInfoTypeRequestFromJSONTyped(json, false);
}

export function ResvRoutingInfoTypeRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): ResvRoutingInfoTypeRequest {
...
export function ResvRoutingInfoTypeRequestToJSON(value?: ResvRoutingInfoTypeRequest | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
