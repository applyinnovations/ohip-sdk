 ...
 */
export function instanceOfTranslationTextType1000(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function TranslationTextType1000FromJSON(json: any): TranslationTextType1000 {
    return TranslationTextType1000FromJSONTyped(json, false);
}

export function TranslationTextType1000FromJSONTyped(json: any, ignoreDiscriminator: boolean): TranslationTextType1000 {
...
export function TranslationTextType1000ToJSON(value?: TranslationTextType1000 | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
