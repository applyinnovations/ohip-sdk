 ...
 */
export function instanceOfReports(value: object): boolean {
    let isInstance = true;
...
export function ReportsFromJSONTyped(json: any, ignoreDiscriminator: boolean): Reports {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        
        'reports': !exists(json, 'reports') ? undefined : ReportsTypeFromJSON(json['reports']),
...
export function ReportsToJSON(value?: Reports | null): any {
    ...
    return {
        ...
        'reports': ReportsTypeToJSON(value.reports),
