...
import {
    CopyCateringPackageProcessedInfoListFromJSON,
    CopyCateringPackageProcessedInfoListFromJSONTyped,
    CopyCateringPackageProcessedInfoListToJSON,
} from './CopyCateringPackageProcessedInfoList';
...
export function CopyCateringPackageResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): CopyCateringPackageResponse {
    ...
    return {
        ...
        'copyCateringPackageProcessedInfoList': !exists(json, 'copyCateringPackageProcessedInfoList') ? undefined : CopyCateringPackageProcessedInfoListFromJSON(json['copyCateringPackageProcessedInfoList']),
...
export function CopyCateringPackageResponseToJSON(value?: CopyCateringPackageResponse | null): any {
    ...
    return {
        ...
        'copyCateringPackageProcessedInfoList': CopyCateringPackageProcessedInfoListToJSON(value.copyCateringPackageProcessedInfoList),
