 ...
 */
export function instanceOfQuickInsertResourceStatus(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function QuickInsertResourceStatusFromJSON(json: any): QuickInsertResourceStatus {
    return QuickInsertResourceStatusFromJSONTyped(json, false);
}

export function QuickInsertResourceStatusFromJSONTyped(json: any, ignoreDiscriminator: boolean): QuickInsertResourceStatus {
...
export function QuickInsertResourceStatusToJSON(value?: QuickInsertResourceStatus | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
