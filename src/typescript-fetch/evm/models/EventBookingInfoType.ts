...
export function EventBookingInfoTypeFromJSONTyped(json: any, ignoreDiscriminator: boolean): EventBookingInfoType {
    ...
    return {
        ...
        'catDecisionDate': !exists(json, 'catDecisionDate') ? undefined : json['catDecisionDate'],
        'catFollowUpDate': !exists(json, 'catFollowUpDate') ? undefined : json['catFollowUpDate'],
        'roomFollowUpDate': !exists(json, 'roomFollowUpDate') ? undefined : json['roomFollowUpDate'],
