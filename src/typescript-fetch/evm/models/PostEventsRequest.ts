 ...
 */
export function instanceOfPostEventsRequest(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function PostEventsRequestFromJSON(json: any): PostEventsRequest {
    return PostEventsRequestFromJSONTyped(json, false);
}

export function PostEventsRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): PostEventsRequest {
...
export function PostEventsRequestToJSON(value?: PostEventsRequest | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
