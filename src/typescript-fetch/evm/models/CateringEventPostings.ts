 ...
 */
export function instanceOfCateringEventPostings(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function CateringEventPostingsFromJSON(json: any): CateringEventPostings {
    return CateringEventPostingsFromJSONTyped(json, false);
}

export function CateringEventPostingsFromJSONTyped(json: any, ignoreDiscriminator: boolean): CateringEventPostings {
...
export function CateringEventPostingsToJSON(value?: CateringEventPostings | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
