...
export interface DeleteActivityBookingForProfileRequest {
    profileId: string;
    hotelId: string;
    activityId: string;
    activityIdType: string;
...
export interface PostActivityBookingForProfileRequest {
    profileId: string;
    hotelId: string;
    authorization?: string;
    xAppKey?: string;
...
export interface PutActivityBookingForProfileRequest {
    profileId: string;
    hotelId: string;
    authorization?: string;
    xAppKey?: string;
...
export class LeisureManagementApi extends runtime.BaseAPI {
     ...
     * Send a response to Cancellation of an Activity Booking
     */
    async deleteActivityBookingForProfileRaw(requestParameters: DeleteActivityBookingForProfileRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Status>> {
        if (requestParameters.profileId === null || requestParameters.profileId === undefined) {
            throw new runtime.RequiredError('profileId','Required parameter requestParameters.profileId was null or undefined when calling deleteActivityBookingForProfile.');
        }
        
        if (requestParameters.hotelId === null || requestParameters.hotelId === undefined) {
            throw new runtime.RequiredError('hotelId','Required parameter requestParameters.hotelId was null or undefined when calling deleteActivityBookingForProfile.');
        }
        
        if (requestParameters.activityId === null || requestParameters.activityId === undefined) {
            throw new runtime.RequiredError('activityId','Required parameter requestParameters.activityId was null or undefined when calling deleteActivityBookingForProfile.');
        }
        
        if (requestParameters.activityIdType === null || requestParameters.activityIdType === undefined) {
            throw new runtime.RequiredError('activityIdType','Required parameter requestParameters.activityIdType was null or undefined when calling deleteActivityBookingForProfile.');
        }
        ...
        const response = await this.request({
            path: `/hotels/{hotelId}/profiles/{profileId}/activityBookings`.replace(`{${"profileId"}}`, encodeURIComponent(String(requestParameters.profileId))).replace(`{${"hotelId"}}`, encodeURIComponent(String(requestParameters.hotelId))),
            method: 'DELETE',
            headers: headerParameters,
            query: queryParameters,
        }, initOverrides);
     ...
     * Send a response to Cancellation of an Activity Booking
     */
    async deleteActivityBookingForProfile(requestParameters: DeleteActivityBookingForProfileRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Status> {
        const response = await this.deleteActivityBookingForProfileRaw(requestParameters, initOverrides);
        return await response.value();
    }
     ...
     * Send a response to Creation of Activity Booking
     */
    async postActivityBookingForProfileRaw(requestParameters: PostActivityBookingForProfileRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Status>> {
        if (requestParameters.profileId === null || requestParameters.profileId === undefined) {
            throw new runtime.RequiredError('profileId','Required parameter requestParameters.profileId was null or undefined when calling postActivityBookingForProfile.');
        }
        
        if (requestParameters.hotelId === null || requestParameters.hotelId === undefined) {
            throw new runtime.RequiredError('hotelId','Required parameter requestParameters.hotelId was null or undefined when calling postActivityBookingForProfile.');
        }
        
        if (requestParameters.createActivityBookingForProfile === null || requestParameters.createActivityBookingForProfile === undefined) {
            throw new runtime.RequiredError('createActivityBookingForProfile','Required parameter requestParameters.createActivityBookingForProfile was null or undefined when calling postActivityBookingForProfile.');
        }
        ...
        const response = await this.request({
            ...
            headers: headerParameters,
            query: queryParameters,
            body: CreateActivityBookingToJSON(requestParameters.createActivityBookingForProfile),
        }, initOverrides);
     ...
     * Send a response to Creation of Activity Booking
     */
    async postActivityBookingForProfile(requestParameters: PostActivityBookingForProfileRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Status> {
        const response = await this.postActivityBookingForProfileRaw(requestParameters, initOverrides);
        return await response.value();
    }
     ...
     * Send a response to Change in Activity Booking
     */
    async putActivityBookingForProfileRaw(requestParameters: PutActivityBookingForProfileRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ActivityBookingModified>> {
        if (requestParameters.profileId === null || requestParameters.profileId === undefined) {
            throw new runtime.RequiredError('profileId','Required parameter requestParameters.profileId was null or undefined when calling putActivityBookingForProfile.');
        }
        
        if (requestParameters.hotelId === null || requestParameters.hotelId === undefined) {
            throw new runtime.RequiredError('hotelId','Required parameter requestParameters.hotelId was null or undefined when calling putActivityBookingForProfile.');
        }
        
        if (requestParameters.changeActivityBookingForProfile === null || requestParameters.changeActivityBookingForProfile === undefined) {
            throw new runtime.RequiredError('changeActivityBookingForProfile','Required parameter requestParameters.changeActivityBookingForProfile was null or undefined when calling putActivityBookingForProfile.');
        }
        ...
        const response = await this.request({
            ...
            headers: headerParameters,
            query: queryParameters,
            body: ChangeActivityBookingToJSON(requestParameters.changeActivityBookingForProfile),
        }, initOverrides);
     ...
     * Send a response to Change in Activity Booking
     */
    async putActivityBookingForProfile(requestParameters: PutActivityBookingForProfileRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<ActivityBookingModified> {
        const response = await this.putActivityBookingForProfileRaw(requestParameters, initOverrides);
        return await response.value();
    }
