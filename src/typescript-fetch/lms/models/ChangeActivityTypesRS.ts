 ...
 */
export function instanceOfChangeActivityTypesRS(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function ChangeActivityTypesRSFromJSON(json: any): ChangeActivityTypesRS {
    return ChangeActivityTypesRSFromJSONTyped(json, false);
}

export function ChangeActivityTypesRSFromJSONTyped(json: any, ignoreDiscriminator: boolean): ChangeActivityTypesRS {
...
export function ChangeActivityTypesRSToJSON(value?: ChangeActivityTypesRS | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
