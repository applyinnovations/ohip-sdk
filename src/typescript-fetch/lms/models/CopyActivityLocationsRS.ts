 ...
 */
export function instanceOfCopyActivityLocationsRS(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function CopyActivityLocationsRSFromJSON(json: any): CopyActivityLocationsRS {
    return CopyActivityLocationsRSFromJSONTyped(json, false);
}

export function CopyActivityLocationsRSFromJSONTyped(json: any, ignoreDiscriminator: boolean): CopyActivityLocationsRS {
...
export function CopyActivityLocationsRSToJSON(value?: CopyActivityLocationsRS | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
