 ...
 */
export function instanceOfCopyActivityLocationsRequest(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function CopyActivityLocationsRequestFromJSON(json: any): CopyActivityLocationsRequest {
    return CopyActivityLocationsRequestFromJSONTyped(json, false);
}

export function CopyActivityLocationsRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): CopyActivityLocationsRequest {
...
export function CopyActivityLocationsRequestToJSON(value?: CopyActivityLocationsRequest | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
