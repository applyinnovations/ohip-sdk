 ...
 */
export function instanceOfServiceRequestCodePrioritiesCriteria(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function ServiceRequestCodePrioritiesCriteriaFromJSON(json: any): ServiceRequestCodePrioritiesCriteria {
    return ServiceRequestCodePrioritiesCriteriaFromJSONTyped(json, false);
}

export function ServiceRequestCodePrioritiesCriteriaFromJSONTyped(json: any, ignoreDiscriminator: boolean): ServiceRequestCodePrioritiesCriteria {
...
export function ServiceRequestCodePrioritiesCriteriaToJSON(value?: ServiceRequestCodePrioritiesCriteria | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
