 ...
 */
export function instanceOfOriginCodeType(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function OriginCodeTypeFromJSON(json: any): OriginCodeType {
    return OriginCodeTypeFromJSONTyped(json, false);
}

export function OriginCodeTypeFromJSONTyped(json: any, ignoreDiscriminator: boolean): OriginCodeType {
...
export function OriginCodeTypeToJSON(value?: OriginCodeType | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
