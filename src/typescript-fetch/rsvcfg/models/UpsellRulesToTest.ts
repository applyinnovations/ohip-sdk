 ...
 * @export
 * @interface UpsellRulesToTest
 */
export interface UpsellRulesToTest {
    /**
     * 
     * @type {ConfigTestUpsellRuleSearchType}
     * @memberof UpsellRulesToTest
     */
 ...
 */
export function instanceOfUpsellRulesToTest(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function UpsellRulesToTestFromJSON(json: any): UpsellRulesToTest {
    return UpsellRulesToTestFromJSONTyped(json, false);
}

export function UpsellRulesToTestFromJSONTyped(json: any, ignoreDiscriminator: boolean): UpsellRulesToTest {
...
export function UpsellRulesToTestToJSON(value?: UpsellRulesToTest | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
