 ...
 */
export function instanceOfRoomSpecialRatingsInfoType(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function RoomSpecialRatingsInfoTypeFromJSON(json: any): RoomSpecialRatingsInfoType {
    return RoomSpecialRatingsInfoTypeFromJSONTyped(json, false);
}

export function RoomSpecialRatingsInfoTypeFromJSONTyped(json: any, ignoreDiscriminator: boolean): RoomSpecialRatingsInfoType {
    return json;
}

export function RoomSpecialRatingsInfoTypeToJSON(value?: RoomSpecialRatingsInfoType | null): any {
    return value;
}
