 ...
 */
export function instanceOfTemplateDepositPolicyCriteria(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function TemplateDepositPolicyCriteriaFromJSON(json: any): TemplateDepositPolicyCriteria {
    return TemplateDepositPolicyCriteriaFromJSONTyped(json, false);
}

export function TemplateDepositPolicyCriteriaFromJSONTyped(json: any, ignoreDiscriminator: boolean): TemplateDepositPolicyCriteria {
...
export function TemplateDepositPolicyCriteriaToJSON(value?: TemplateDepositPolicyCriteria | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
