 ...
 */
export function instanceOfWaitlistPriorityType(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function WaitlistPriorityTypeFromJSON(json: any): WaitlistPriorityType {
    return WaitlistPriorityTypeFromJSONTyped(json, false);
}

export function WaitlistPriorityTypeFromJSONTyped(json: any, ignoreDiscriminator: boolean): WaitlistPriorityType {
...
export function WaitlistPriorityTypeToJSON(value?: WaitlistPriorityType | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
