 ...
 */
export function instanceOfEntryPointsCriteria(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function EntryPointsCriteriaFromJSON(json: any): EntryPointsCriteria {
    return EntryPointsCriteriaFromJSONTyped(json, false);
}

export function EntryPointsCriteriaFromJSONTyped(json: any, ignoreDiscriminator: boolean): EntryPointsCriteria {
...
export function EntryPointsCriteriaToJSON(value?: EntryPointsCriteria | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
