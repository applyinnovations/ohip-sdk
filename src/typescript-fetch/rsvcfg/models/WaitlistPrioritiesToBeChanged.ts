 ...
 */
export function instanceOfWaitlistPrioritiesToBeChanged(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function WaitlistPrioritiesToBeChangedFromJSON(json: any): WaitlistPrioritiesToBeChanged {
    return WaitlistPrioritiesToBeChangedFromJSONTyped(json, false);
}

export function WaitlistPrioritiesToBeChangedFromJSONTyped(json: any, ignoreDiscriminator: boolean): WaitlistPrioritiesToBeChanged {
...
export function WaitlistPrioritiesToBeChangedToJSON(value?: WaitlistPrioritiesToBeChanged | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
