 ...
 */
export function instanceOfGlobalAlertsType(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function GlobalAlertsTypeFromJSON(json: any): GlobalAlertsType {
    return GlobalAlertsTypeFromJSONTyped(json, false);
}

export function GlobalAlertsTypeFromJSONTyped(json: any, ignoreDiscriminator: boolean): GlobalAlertsType {
    return json;
}

export function GlobalAlertsTypeToJSON(value?: GlobalAlertsType | null): any {
    return value;
}
