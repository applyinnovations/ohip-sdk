 ...
 */
export function instanceOfBlockRankingsToBeChanged(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function BlockRankingsToBeChangedFromJSON(json: any): BlockRankingsToBeChanged {
    return BlockRankingsToBeChangedFromJSONTyped(json, false);
}

export function BlockRankingsToBeChangedFromJSONTyped(json: any, ignoreDiscriminator: boolean): BlockRankingsToBeChanged {
...
export function BlockRankingsToBeChangedToJSON(value?: BlockRankingsToBeChanged | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
