 ...
 */
export function instanceOfServiceRequestCodePrioritiesToBeChanged(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function ServiceRequestCodePrioritiesToBeChangedFromJSON(json: any): ServiceRequestCodePrioritiesToBeChanged {
    return ServiceRequestCodePrioritiesToBeChangedFromJSONTyped(json, false);
}

export function ServiceRequestCodePrioritiesToBeChangedFromJSONTyped(json: any, ignoreDiscriminator: boolean): ServiceRequestCodePrioritiesToBeChanged {
...
export function ServiceRequestCodePrioritiesToBeChangedToJSON(value?: ServiceRequestCodePrioritiesToBeChanged | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
