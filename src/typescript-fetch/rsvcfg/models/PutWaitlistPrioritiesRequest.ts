 ...
 */
export function instanceOfPutWaitlistPrioritiesRequest(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function PutWaitlistPrioritiesRequestFromJSON(json: any): PutWaitlistPrioritiesRequest {
    return PutWaitlistPrioritiesRequestFromJSONTyped(json, false);
}

export function PutWaitlistPrioritiesRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): PutWaitlistPrioritiesRequest {
...
export function PutWaitlistPrioritiesRequestToJSON(value?: PutWaitlistPrioritiesRequest | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
