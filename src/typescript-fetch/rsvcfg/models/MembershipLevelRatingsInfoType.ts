 ...
 */
export function instanceOfMembershipLevelRatingsInfoType(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function MembershipLevelRatingsInfoTypeFromJSON(json: any): MembershipLevelRatingsInfoType {
    return MembershipLevelRatingsInfoTypeFromJSONTyped(json, false);
}

export function MembershipLevelRatingsInfoTypeFromJSONTyped(json: any, ignoreDiscriminator: boolean): MembershipLevelRatingsInfoType {
    return json;
}

export function MembershipLevelRatingsInfoTypeToJSON(value?: MembershipLevelRatingsInfoType | null): any {
    return value;
}
