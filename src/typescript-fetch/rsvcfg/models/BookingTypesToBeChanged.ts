 ...
 */
export function instanceOfBookingTypesToBeChanged(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function BookingTypesToBeChangedFromJSON(json: any): BookingTypesToBeChanged {
    return BookingTypesToBeChangedFromJSONTyped(json, false);
}

export function BookingTypesToBeChangedFromJSONTyped(json: any, ignoreDiscriminator: boolean): BookingTypesToBeChanged {
...
export function BookingTypesToBeChangedToJSON(value?: BookingTypesToBeChanged | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
