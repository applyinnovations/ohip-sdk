 ...
 */
export function instanceOfScriptsDetails(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function ScriptsDetailsFromJSON(json: any): ScriptsDetails {
    return ScriptsDetailsFromJSONTyped(json, false);
}

export function ScriptsDetailsFromJSONTyped(json: any, ignoreDiscriminator: boolean): ScriptsDetails {
...
export function ScriptsDetailsToJSON(value?: ScriptsDetails | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
