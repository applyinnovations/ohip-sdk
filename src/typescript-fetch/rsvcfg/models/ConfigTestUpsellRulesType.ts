 ...
 */
export function instanceOfConfigTestUpsellRulesType(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function ConfigTestUpsellRulesTypeFromJSON(json: any): ConfigTestUpsellRulesType {
    return ConfigTestUpsellRulesTypeFromJSONTyped(json, false);
}

export function ConfigTestUpsellRulesTypeFromJSONTyped(json: any, ignoreDiscriminator: boolean): ConfigTestUpsellRulesType {
    return json;
}

export function ConfigTestUpsellRulesTypeToJSON(value?: ConfigTestUpsellRulesType | null): any {
    return value;
}
