...
import {
    BlockCutoffScheduleRangeFromJSON,
    BlockCutoffScheduleRangeToJSON,
    BlockSalesAllowanceFromJSON,
    BlockSalesAllowanceToJSON,
    BlockSalesAllowanceActivityLogFromJSON,
    BlockSalesAllowanceActivityLogToJSON,
    ...
    CutoffCodeCriteriaFromJSON,
    CutoffCodeCriteriaToJSON,
    CutoffScheduleDetailsFromJSON,
    CutoffScheduleDetailsToJSON,
...
export class BlockConfigApi extends runtime.BaseAPI {
     ...
     */
    async deleteCutoffScheduleCodeRaw(requestParameters: DeleteCutoffScheduleCodeRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Status>> {
     ...
     * Delete cutoff schedule code.
     */
    async deleteCutoffScheduleCode(requestParameters: DeleteCutoffScheduleCodeRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Status> {
        const response = await this.deleteCutoffScheduleCodeRaw(requestParameters, initOverrides);
        return await response.value();
    }
     ...
     */
    async getBlockSalesAllowanceActivityLogRaw(requestParameters: GetBlockSalesAllowanceActivityLogRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<BlockSalesAllowanceActivityLog>> {
        if (requestParameters.hotelId === null || requestParameters.hotelId === undefined) {
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => BlockSalesAllowanceActivityLogFromJSON(jsonValue));
    }
     ...
     * Get the Block Sales Allowance activity log
     */
    async getBlockSalesAllowanceActivityLog(requestParameters: GetBlockSalesAllowanceActivityLogRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<BlockSalesAllowanceActivityLog> {
        const response = await this.getBlockSalesAllowanceActivityLogRaw(requestParameters, initOverrides);
        return await response.value();
    }
     ...
     */
    async getCutoffSchedulesRaw(requestParameters: GetCutoffSchedulesRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<CutoffScheduleDetails>> {
        if (requestParameters.hotelId === null || requestParameters.hotelId === undefined) {
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => CutoffScheduleDetailsFromJSON(jsonValue));
    }
     ...
     * Get block cutoff schedule codes.
     */
    async getCutoffSchedules(requestParameters: GetCutoffSchedulesRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<CutoffScheduleDetails> {
        const response = await this.getCutoffSchedulesRaw(requestParameters, initOverrides);
        return await response.value();
    }
     ...
     */
    async getCutoffSchedulesDetailsRaw(requestParameters: GetCutoffSchedulesDetailsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<CutoffScheduleDetails>> {
        if (requestParameters.hotelId === null || requestParameters.hotelId === undefined) {
     ...
     * Get cutoff Schedules Details for a cutoff schedule code.
     */
    async getCutoffSchedulesDetails(requestParameters: GetCutoffSchedulesDetailsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<CutoffScheduleDetails> {
        const response = await this.getCutoffSchedulesDetailsRaw(requestParameters, initOverrides);
        return await response.value();
    }
     ...
     */
    async postCutoffScheduleCodeRaw(requestParameters: PostCutoffScheduleCodeRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Status>> {
        if (requestParameters.hotelId === null || requestParameters.hotelId === undefined) {
        ...
        const response = await this.request({
            ...
            headers: headerParameters,
            query: queryParameters,
            body: CutoffCodeCriteriaToJSON(requestParameters.cutoffScheduleCodeDetails),
        }, initOverrides);
     ...
     * Create a block cutoff schedule code.
     */
    async postCutoffScheduleCode(requestParameters: PostCutoffScheduleCodeRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Status> {
        const response = await this.postCutoffScheduleCodeRaw(requestParameters, initOverrides);
        return await response.value();
    }
     ...
     */
    async putCutoffScheduleCodeRaw(requestParameters: PutCutoffScheduleCodeRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Status>> {
        if (requestParameters.cutoffCodeId === null || requestParameters.cutoffCodeId === undefined) {
        ...
        const response = await this.request({
            ...
            headers: headerParameters,
            query: queryParameters,
            body: CutoffCodeCriteriaToJSON(requestParameters.blockCutoffCodeDetails),
        }, initOverrides);
     ...
     * Change block cutoff schedule code
     */
    async putCutoffScheduleCode(requestParameters: PutCutoffScheduleCodeRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Status> {
        const response = await this.putCutoffScheduleCodeRaw(requestParameters, initOverrides);
        return await response.value();
    }
     ...
     */
    async setBlockCutoffScheduleRangeRaw(requestParameters: SetBlockCutoffScheduleRangeRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Status>> {
        if (requestParameters.hotelId === null || requestParameters.hotelId === undefined) {
        ...
        const response = await this.request({
            ...
            headers: headerParameters,
            query: queryParameters,
            body: BlockCutoffScheduleRangeToJSON(requestParameters.blockCutoffScheduleRange),
        }, initOverrides);
     ...
     * Set block cutoff schedule range
     */
    async setBlockCutoffScheduleRange(requestParameters: SetBlockCutoffScheduleRangeRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Status> {
        const response = await this.setBlockCutoffScheduleRangeRaw(requestParameters, initOverrides);
        return await response.value();
    }
