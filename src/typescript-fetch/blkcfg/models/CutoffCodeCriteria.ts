 ...
 */
export function instanceOfCutoffCodeCriteria(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function CutoffCodeCriteriaFromJSON(json: any): CutoffCodeCriteria {
    return CutoffCodeCriteriaFromJSONTyped(json, false);
}

export function CutoffCodeCriteriaFromJSONTyped(json: any, ignoreDiscriminator: boolean): CutoffCodeCriteria {
...
export function CutoffCodeCriteriaToJSON(value?: CutoffCodeCriteria | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
