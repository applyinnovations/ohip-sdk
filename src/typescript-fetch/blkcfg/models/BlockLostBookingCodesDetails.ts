 ...
 */
export function instanceOfBlockLostBookingCodesDetails(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function BlockLostBookingCodesDetailsFromJSON(json: any): BlockLostBookingCodesDetails {
    return BlockLostBookingCodesDetailsFromJSONTyped(json, false);
}

export function BlockLostBookingCodesDetailsFromJSONTyped(json: any, ignoreDiscriminator: boolean): BlockLostBookingCodesDetails {
...
export function BlockLostBookingCodesDetailsToJSON(value?: BlockLostBookingCodesDetails | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
