 ...
 */
export function instanceOfBlockCancellationReasonsCriteria(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function BlockCancellationReasonsCriteriaFromJSON(json: any): BlockCancellationReasonsCriteria {
    return BlockCancellationReasonsCriteriaFromJSONTyped(json, false);
}

export function BlockCancellationReasonsCriteriaFromJSONTyped(json: any, ignoreDiscriminator: boolean): BlockCancellationReasonsCriteria {
...
export function BlockCancellationReasonsCriteriaToJSON(value?: BlockCancellationReasonsCriteria | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
