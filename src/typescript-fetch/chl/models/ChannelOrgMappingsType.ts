 ...
 */
export function instanceOfChannelOrgMappingsType(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function ChannelOrgMappingsTypeFromJSON(json: any): ChannelOrgMappingsType {
    return ChannelOrgMappingsTypeFromJSONTyped(json, false);
}

export function ChannelOrgMappingsTypeFromJSONTyped(json: any, ignoreDiscriminator: boolean): ChannelOrgMappingsType {
    return json;
}

export function ChannelOrgMappingsTypeToJSON(value?: ChannelOrgMappingsType | null): any {
    return value;
}
