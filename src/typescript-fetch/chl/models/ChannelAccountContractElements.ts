 ...
 */
export function instanceOfChannelAccountContractElements(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function ChannelAccountContractElementsFromJSON(json: any): ChannelAccountContractElements {
    return ChannelAccountContractElementsFromJSONTyped(json, false);
}

export function ChannelAccountContractElementsFromJSONTyped(json: any, ignoreDiscriminator: boolean): ChannelAccountContractElements {
...
export function ChannelAccountContractElementsToJSON(value?: ChannelAccountContractElements | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
