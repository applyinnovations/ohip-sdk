 ...
 */
export function instanceOfPostChannelRatesRequest(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function PostChannelRatesRequestFromJSON(json: any): PostChannelRatesRequest {
    return PostChannelRatesRequestFromJSONTyped(json, false);
}

export function PostChannelRatesRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): PostChannelRatesRequest {
...
export function PostChannelRatesRequestToJSON(value?: PostChannelRatesRequest | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
