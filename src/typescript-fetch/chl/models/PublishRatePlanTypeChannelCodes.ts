 ...
 */
export function instanceOfPublishRatePlanTypeChannelCodes(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function PublishRatePlanTypeChannelCodesFromJSON(json: any): PublishRatePlanTypeChannelCodes {
    return PublishRatePlanTypeChannelCodesFromJSONTyped(json, false);
}

export function PublishRatePlanTypeChannelCodesFromJSONTyped(json: any, ignoreDiscriminator: boolean): PublishRatePlanTypeChannelCodes {
...
export function PublishRatePlanTypeChannelCodesToJSON(value?: PublishRatePlanTypeChannelCodes | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
