 ...
 */
export function instanceOfChannelAccountContractElementsType(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function ChannelAccountContractElementsTypeFromJSON(json: any): ChannelAccountContractElementsType {
    return ChannelAccountContractElementsTypeFromJSONTyped(json, false);
}

export function ChannelAccountContractElementsTypeFromJSONTyped(json: any, ignoreDiscriminator: boolean): ChannelAccountContractElementsType {
    return json;
}

export function ChannelAccountContractElementsTypeToJSON(value?: ChannelAccountContractElementsType | null): any {
    return value;
}
