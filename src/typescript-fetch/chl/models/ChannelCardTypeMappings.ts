 ...
 */
export function instanceOfChannelCardTypeMappings(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function ChannelCardTypeMappingsFromJSON(json: any): ChannelCardTypeMappings {
    return ChannelCardTypeMappingsFromJSONTyped(json, false);
}

export function ChannelCardTypeMappingsFromJSONTyped(json: any, ignoreDiscriminator: boolean): ChannelCardTypeMappings {
...
export function ChannelCardTypeMappingsToJSON(value?: ChannelCardTypeMappings | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
