 ...
 */
export function instanceOfFetchedChannelHotelLetters(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function FetchedChannelHotelLettersFromJSON(json: any): FetchedChannelHotelLetters {
    return FetchedChannelHotelLettersFromJSONTyped(json, false);
}

export function FetchedChannelHotelLettersFromJSONTyped(json: any, ignoreDiscriminator: boolean): FetchedChannelHotelLetters {
...
export function FetchedChannelHotelLettersToJSON(value?: FetchedChannelHotelLetters | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
