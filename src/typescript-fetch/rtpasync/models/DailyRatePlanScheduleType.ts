...
export function DailyRatePlanScheduleTypeFromJSONTyped(json: any, ignoreDiscriminator: boolean): DailyRatePlanScheduleType {
    ...
    return {
        ...
        'rateDateRangeStart': !exists(json, 'rateDateRangeStart') ? undefined : json['rateDateRangeStart'],
        'rateDateRangeEnd': !exists(json, 'rateDateRangeEnd') ? undefined : json['rateDateRangeEnd'],
...
export function DailyRatePlanScheduleTypeToJSON(value?: DailyRatePlanScheduleType | null): any {
    ...
    return {
        ...
        'rateDateRangeStart': value.rateDateRangeStart,
        'rateDateRangeEnd': value.rateDateRangeEnd,
