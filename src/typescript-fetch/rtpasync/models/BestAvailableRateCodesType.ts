 ...
 */
export function instanceOfBestAvailableRateCodesType(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function BestAvailableRateCodesTypeFromJSON(json: any): BestAvailableRateCodesType {
    return BestAvailableRateCodesTypeFromJSONTyped(json, false);
}

export function BestAvailableRateCodesTypeFromJSONTyped(json: any, ignoreDiscriminator: boolean): BestAvailableRateCodesType {
    return json;
}

export function BestAvailableRateCodesTypeToJSON(value?: BestAvailableRateCodesType | null): any {
    return value;
}
