...
import {
    ...
    ResGuaranteeFetchInstructionsTypeFromJSONTyped,
    ResGuaranteeFetchInstructionsTypeToJSON,
} from './ResGuaranteeFetchInstructionsType';
...
import {
    RoomStaySearchTypeFromJSON,
    RoomStaySearchTypeFromJSONTyped,
    RoomStaySearchTypeToJSON,
} from './RoomStaySearchType';
 ...
 */
export function instanceOfResGuaranteeSearchType(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function ResGuaranteeSearchTypeFromJSON(json: any): ResGuaranteeSearchType {
    return ResGuaranteeSearchTypeFromJSONTyped(json, false);
}

export function ResGuaranteeSearchTypeFromJSONTyped(json: any, ignoreDiscriminator: boolean): ResGuaranteeSearchType {
    ...
    return {
        ...
        'roomStayDetails': !exists(json, 'roomStayDetails') ? undefined : RoomStaySearchTypeFromJSON(json['roomStayDetails']),
...
export function ResGuaranteeSearchTypeToJSON(value?: ResGuaranteeSearchType | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'roomStayDetails': RoomStaySearchTypeToJSON(value.roomStayDetails),
