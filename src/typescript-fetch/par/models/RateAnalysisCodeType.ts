 ...
 * @export
 */
export const RateAnalysisCodeType = {
    Closed: 'Closed',
...
export function RateAnalysisCodeTypeFromJSON(json: any): RateAnalysisCodeType {
    return RateAnalysisCodeTypeFromJSONTyped(json, false);
}

export function RateAnalysisCodeTypeFromJSONTyped(json: any, ignoreDiscriminator: boolean): RateAnalysisCodeType {
    return json as RateAnalysisCodeType;
}

export function RateAnalysisCodeTypeToJSON(value?: RateAnalysisCodeType | null): any {
    return value as any;
}
