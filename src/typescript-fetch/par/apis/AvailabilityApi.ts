...
export interface DeleteHurdleRatesRequest {
    ...
    hurdleRangeStart?: Array<string>;
    hurdleRangeEnd?: Array<string>;
    xExternalsystem?: string;
    acceptLanguage?: string;
}
...
export interface GetHotelAvailabilityRequest {
    ...
    includeNoRatePlanSet?: Array<boolean>;
    ...
    membershipCardNumber?: Array<string>;
...
export class AvailabilityApi extends runtime.BaseAPI {
    ...
    async deleteHurdleRatesRaw(requestParameters: DeleteHurdleRatesRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Status>> {
        ...
        if (requestParameters.hurdleRangeStart) {
            queryParameters['hurdleRangeStart'] = requestParameters.hurdleRangeStart;
        }

        if (requestParameters.hurdleRangeEnd) {
            queryParameters['hurdleRangeEnd'] = requestParameters.hurdleRangeEnd;
        }
    ...
    async getHotelAvailabilityRaw(requestParameters: GetHotelAvailabilityRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<HotelAvailability>> {
        ...
        if (requestParameters.includeNoRatePlanSet) {
            queryParameters['includeNoRatePlanSet'] = requestParameters.includeNoRatePlanSet;
        }
        ...
        if (requestParameters.membershipCardNumber) {
    ...
    async getHotelAvailabilityCRORaw(requestParameters: GetHotelAvailabilityCRORequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<HotelAvailability>> {
        ...
        if (requestParameters.accessibleRoomTypesOnly !== undefined) {
            queryParameters['accessibleRoomTypesOnly'] = requestParameters.accessibleRoomTypesOnly;
        }
    ...
    async getHurdleRatesRaw(requestParameters: GetHurdleRatesRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<HurdleRates>> {
        ...
        if (requestParameters.hurdleRangeStart !== undefined) {
            queryParameters['hurdleRangeStart'] = requestParameters.hurdleRangeStart;
        }

        if (requestParameters.hurdleRangeEnd !== undefined) {
            queryParameters['hurdleRangeEnd'] = requestParameters.hurdleRangeEnd;
        }
 ...
 * @export
 */
export const GetHotelsOrderByEnum = {
    Mostavail: 'MOSTAVAIL',
    Leastavail: 'LEASTAVAIL',
    Mostpercavail: 'MOSTPERCAVAIL',
    Listpercavail: 'LISTPERCAVAIL',
    Shortestdistance: 'SHORTESTDISTANCE',
    Default: 'DEFAULT',
    Alphabetical: 'ALPHABETICAL',
    Ratelowtohigh: 'RATELOWTOHIGH',
    Ratehightolow: 'RATEHIGHTOLOW'
} as const;
export type GetHotelsOrderByEnum = typeof GetHotelsOrderByEnum[keyof typeof GetHotelsOrderByEnum];
/**
 * @export
 */
