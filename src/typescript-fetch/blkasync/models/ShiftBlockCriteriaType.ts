...
export function ShiftBlockCriteriaTypeFromJSONTyped(json: any, ignoreDiscriminator: boolean): ShiftBlockCriteriaType {
    ...
    return {
        ...
        'validatePreAllocatedRooms': !exists(json, 'validatePreAllocatedRooms') ? undefined : json['validatePreAllocatedRooms'],
        'validateTraces': !exists(json, 'validateTraces') ? undefined : json['validateTraces'],
