...
import type { BlockAllocationSummaryTypeBlockProfiles } from './BlockAllocationSummaryTypeBlockProfiles';
import {
    BlockAllocationSummaryTypeBlockProfilesFromJSON,
    BlockAllocationSummaryTypeBlockProfilesFromJSONTyped,
    BlockAllocationSummaryTypeBlockProfilesToJSON,
} from './BlockAllocationSummaryTypeBlockProfiles';
...
export interface BlockAllocationSummaryType {
    ...
    /**
     * 
     * @type {BlockAllocationSummaryTypeBlockProfiles}
     * @memberof BlockAllocationSummaryType
     */
    blockProfiles?: BlockAllocationSummaryTypeBlockProfiles;
}
...
export function BlockAllocationSummaryTypeFromJSONTyped(json: any, ignoreDiscriminator: boolean): BlockAllocationSummaryType {
    ...
    return {
        ...
        'blockProfiles': !exists(json, 'blockProfiles') ? undefined : BlockAllocationSummaryTypeBlockProfilesFromJSON(json['blockProfiles']),
    };
}
...
export function BlockAllocationSummaryTypeToJSON(value?: BlockAllocationSummaryType | null): any {
    ...
    return {
        ...
        'blockProfiles': BlockAllocationSummaryTypeBlockProfilesToJSON(value.blockProfiles),
    };
}
