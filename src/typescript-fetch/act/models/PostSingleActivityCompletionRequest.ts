 ...
 */
export function instanceOfPostSingleActivityCompletionRequest(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function PostSingleActivityCompletionRequestFromJSON(json: any): PostSingleActivityCompletionRequest {
    return PostSingleActivityCompletionRequestFromJSONTyped(json, false);
}

export function PostSingleActivityCompletionRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): PostSingleActivityCompletionRequest {
...
export function PostSingleActivityCompletionRequestToJSON(value?: PostSingleActivityCompletionRequest | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
