 ...
 */
export function instanceOfActivityIdRecord(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function ActivityIdRecordFromJSON(json: any): ActivityIdRecord {
    return ActivityIdRecordFromJSONTyped(json, false);
}

export function ActivityIdRecordFromJSONTyped(json: any, ignoreDiscriminator: boolean): ActivityIdRecord {
...
export function ActivityIdRecordToJSON(value?: ActivityIdRecord | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
