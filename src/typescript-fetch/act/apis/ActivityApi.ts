...
import {
    ActivitiesBulkUpdateFromJSON,
    ActivitiesBulkUpdateToJSON,
    ActivitiesBulkUpdateStatusFromJSON,
    ActivitiesBulkUpdateStatusToJSON,
...
export class ActivityApi extends runtime.BaseAPI {
     ...
     */
    async putBulkActivitiesRaw(requestParameters: PutBulkActivitiesRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ActivitiesBulkUpdateStatus>> {
        ...
        const response = await this.request({
            ...
            headers: headerParameters,
            query: queryParameters,
            body: ActivitiesBulkUpdateToJSON(requestParameters.putBulkActivities),
        }, initOverrides);

        return new runtime.JSONApiResponse(response, (jsonValue) => ActivitiesBulkUpdateStatusFromJSON(jsonValue));
    }
     ...
     * Operation to update multiple activities
     */
    async putBulkActivities(requestParameters: PutBulkActivitiesRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<ActivitiesBulkUpdateStatus> {
        const response = await this.putBulkActivitiesRaw(requestParameters, initOverrides);
        return await response.value();
    }
