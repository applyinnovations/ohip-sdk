...
import {
    ...
    FlexFieldCriteriaFromJSON,
    FlexFieldCriteriaToJSON,
    FlexFieldsResponseFromJSON,
    FlexFieldsResponseToJSON,
...
export class ChainConfigApi extends runtime.BaseAPI {
     ...
     *  clear cache
     */
    async deleteChainConfigServicesCacheRaw(requestParameters: DeleteChainConfigServicesCacheRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Status>> {
        const queryParameters: any = {};
     ...
     *  clear cache
     */
    async deleteChainConfigServicesCache(requestParameters: DeleteChainConfigServicesCacheRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Status> {
     ...
     */
    async deleteFlexFieldRaw(requestParameters: DeleteFlexFieldRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Status>> {
        if (requestParameters.flexFieldId === null || requestParameters.flexFieldId === undefined) {
            throw new runtime.RequiredError('flexFieldId','Required parameter requestParameters.flexFieldId was null or undefined when calling deleteFlexField.');
        }
        
        if (requestParameters.hotelId === null || requestParameters.hotelId === undefined) {
            throw new runtime.RequiredError('hotelId','Required parameter requestParameters.hotelId was null or undefined when calling deleteFlexField.');
        }
        ...
        const response = await this.request({
            path: `/hotels/{hotelId}/flexFields/{flexFieldId}`.replace(`{${"flexFieldId"}}`, encodeURIComponent(String(requestParameters.flexFieldId))).replace(`{${"hotelId"}}`, encodeURIComponent(String(requestParameters.hotelId))),
            method: 'DELETE',
            headers: headerParameters,
            query: queryParameters,
        }, initOverrides);
     ...
     * Operation to delete a flex field.
     */
    async deleteFlexField(requestParameters: DeleteFlexFieldRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Status> {
        const response = await this.deleteFlexFieldRaw(requestParameters, initOverrides);
        return await response.value();
    }
     ...
     */
    async getFlexFieldRaw(requestParameters: GetFlexFieldRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<FlexFieldCriteria>> {
        if (requestParameters.flexFieldId === null || requestParameters.flexFieldId === undefined) {
            throw new runtime.RequiredError('flexFieldId','Required parameter requestParameters.flexFieldId was null or undefined when calling getFlexField.');
        }
        
        if (requestParameters.hotelId === null || requestParameters.hotelId === undefined) {
            throw new runtime.RequiredError('hotelId','Required parameter requestParameters.hotelId was null or undefined when calling getFlexField.');
        }
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => FlexFieldCriteriaFromJSON(jsonValue));
    }
     ...
     * Operation to fetch the flex field details.
     */
    async getFlexField(requestParameters: GetFlexFieldRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<FlexFieldCriteria> {
        const response = await this.getFlexFieldRaw(requestParameters, initOverrides);
        return await response.value();
    }
     ...
     */
    async getFlexFieldsRaw(requestParameters: GetFlexFieldsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<FlexFieldsResponse>> {
        const queryParameters: any = {};
        ...
        if (requestParameters.flexFieldId !== undefined) {
            queryParameters['flexFieldId'] = requestParameters.flexFieldId;
        }
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => FlexFieldsResponseFromJSON(jsonValue));
    }
     ...
     * Operation to fetch flex fields.
     */
    async getFlexFields(requestParameters: GetFlexFieldsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<FlexFieldsResponse> {
        const response = await this.getFlexFieldsRaw(requestParameters, initOverrides);
        return await response.value();
    }
     ...
     *  ping
     */
    async pingChainConfigServicesRaw(requestParameters: PingChainConfigServicesRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<OperaVersion>> {
        const queryParameters: any = {};
     ...
     *  ping
     */
    async pingChainConfigServices(requestParameters: PingChainConfigServicesRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<OperaVersion> {
     ...
     */
    async postFlexFieldRaw(requestParameters: PostFlexFieldRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Status>> {
        if (requestParameters.flexFieldDetail === null || requestParameters.flexFieldDetail === undefined) {
            throw new runtime.RequiredError('flexFieldDetail','Required parameter requestParameters.flexFieldDetail was null or undefined when calling postFlexField.');
        }
        ...
        const response = await this.request({
            ...
            headers: headerParameters,
            query: queryParameters,
            body: FlexFieldCriteriaToJSON(requestParameters.flexFieldDetail),
        }, initOverrides);
     ...
     * Operation to create a flex field.
     */
    async postFlexField(requestParameters: PostFlexFieldRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Status> {
        const response = await this.postFlexFieldRaw(requestParameters, initOverrides);
        return await response.value();
    }
     ...
     */
    async updateFlexFieldRaw(requestParameters: UpdateFlexFieldRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Status>> {
        if (requestParameters.flexFieldId === null || requestParameters.flexFieldId === undefined) {
            throw new runtime.RequiredError('flexFieldId','Required parameter requestParameters.flexFieldId was null or undefined when calling updateFlexField.');
        }
        
        if (requestParameters.hotelId === null || requestParameters.hotelId === undefined) {
            throw new runtime.RequiredError('hotelId','Required parameter requestParameters.hotelId was null or undefined when calling updateFlexField.');
        }
        
        if (requestParameters.flexFieldDetail === null || requestParameters.flexFieldDetail === undefined) {
            throw new runtime.RequiredError('flexFieldDetail','Required parameter requestParameters.flexFieldDetail was null or undefined when calling updateFlexField.');
        }
     ...
     * Operation to update flex field.
     */
    async updateFlexField(requestParameters: UpdateFlexFieldRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Status> {
        const response = await this.updateFlexFieldRaw(requestParameters, initOverrides);
        return await response.value();
    }
