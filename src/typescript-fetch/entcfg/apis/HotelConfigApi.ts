...
import {
    ...
    CentralConfigRequestFromJSON,
    CentralConfigRequestToJSON,
    CentralConfigsResponseFromJSON,
    CentralConfigsResponseToJSON,
    ...
    HotelToBeChangedFromJSON,
    HotelToBeChangedToJSON,
...
export interface ChangeCentralConfigRequest {
    hotelId: string;
    config: string;
    code: string;
    authorization?: string;
    xAppKey?: string;
    xHotelid?: string;
    centralConfig: CentralConfigRequest;
    xExternalsystem?: string;
    acceptLanguage?: string;
}
...
export interface GetCentralConfigRequest {
    hotelId: string;
    config: string;
    authorization?: string;
    xAppKey?: string;
...
export interface GetHotelsRequest {
    ...
    propertyTypeCode?: Array<string>;
    fetchInstructions?: Set<GetHotelsFetchInstructionsEnum>;
    xExternalsystem?: string;
    acceptLanguage?: string;
}
...
export interface PutHotelRequest {
    ...
    xAppKey?: string;
    xHotelid?: string;
    hotelToBeChanged: HotelToBeChanged;
    xExternalsystem?: string;
    acceptLanguage?: string;
}
...
export class HotelConfigApi extends runtime.BaseAPI {
     ...
     */
    async changeCentralConfigRaw(requestParameters: ChangeCentralConfigRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Status>> {
        if (requestParameters.hotelId === null || requestParameters.hotelId === undefined) {
            throw new runtime.RequiredError('hotelId','Required parameter requestParameters.hotelId was null or undefined when calling changeCentralConfig.');
        }
        
        if (requestParameters.config === null || requestParameters.config === undefined) {
            throw new runtime.RequiredError('config','Required parameter requestParameters.config was null or undefined when calling changeCentralConfig.');
        }
        
        if (requestParameters.code === null || requestParameters.code === undefined) {
            throw new runtime.RequiredError('code','Required parameter requestParameters.code was null or undefined when calling changeCentralConfig.');
        }
        
        if (requestParameters.centralConfig === null || requestParameters.centralConfig === undefined) {
            throw new runtime.RequiredError('centralConfig','Required parameter requestParameters.centralConfig was null or undefined when calling changeCentralConfig.');
        }
        ...
        const response = await this.request({
            path: `/hotels/{hotelId}/centralConfigs/{config}/items/{code}`.replace(`{${"hotelId"}}`, encodeURIComponent(String(requestParameters.hotelId))).replace(`{${"config"}}`, encodeURIComponent(String(requestParameters.config))).replace(`{${"code"}}`, encodeURIComponent(String(requestParameters.code))),
            method: 'PUT',
            headers: headerParameters,
            query: queryParameters,
            body: CentralConfigRequestToJSON(requestParameters.centralConfig),
        }, initOverrides);
     ...
     * Change the status for Central Config to manage at Hotel/Enterprise Level.
     */
    async changeCentralConfig(requestParameters: ChangeCentralConfigRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Status> {
        const response = await this.changeCentralConfigRaw(requestParameters, initOverrides);
        return await response.value();
    }
     ...
     */
    async getCentralConfigRaw(requestParameters: GetCentralConfigRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<CentralConfigsResponse>> {
        if (requestParameters.hotelId === null || requestParameters.hotelId === undefined) {
            throw new runtime.RequiredError('hotelId','Required parameter requestParameters.hotelId was null or undefined when calling getCentralConfig.');
        }
        
        if (requestParameters.config === null || requestParameters.config === undefined) {
            throw new runtime.RequiredError('config','Required parameter requestParameters.config was null or undefined when calling getCentralConfig.');
        }
        ...
        const response = await this.request({
            path: `/hotels/{hotelId}/centralConfigs/{config}`.replace(`{${"hotelId"}}`, encodeURIComponent(String(requestParameters.hotelId))).replace(`{${"config"}}`, encodeURIComponent(String(requestParameters.config))),
            method: 'GET',
            headers: headerParameters,
            query: queryParameters,
        }, initOverrides);

        return new runtime.JSONApiResponse(response, (jsonValue) => CentralConfigsResponseFromJSON(jsonValue));
    }
     ...
     * Lists the configurations managed centrally
     */
    async getCentralConfig(requestParameters: GetCentralConfigRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<CentralConfigsResponse> {
        const response = await this.getCentralConfigRaw(requestParameters, initOverrides);
        return await response.value();
    }
    ...
    async getHotelsRaw(requestParameters: GetHotelsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<HotelsDetails>> {
        ...
        if (requestParameters.marketingRegionCode !== undefined) {
            queryParameters['marketingRegionCode'] = requestParameters.marketingRegionCode;
        }
        ...
        if (requestParameters.propertyTypeCode) {
            queryParameters['propertyTypeCode'] = requestParameters.propertyTypeCode;
        }
     ...
     */
    async getOperationRaw(requestParameters: GetOperationRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<OperationResponse>> {
        const queryParameters: any = {};
     ...
     * Fetch all operations
     */
    async getOperation(requestParameters: GetOperationRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<OperationResponse> {
     ...
     */
    async putHotelRaw(requestParameters: PutHotelRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Status>> {
        if (requestParameters.hotelId === null || requestParameters.hotelId === undefined) {
            throw new runtime.RequiredError('hotelId','Required parameter requestParameters.hotelId was null or undefined when calling putHotel.');
        }
        
        if (requestParameters.hotelToBeChanged === null || requestParameters.hotelToBeChanged === undefined) {
            throw new runtime.RequiredError('hotelToBeChanged','Required parameter requestParameters.hotelToBeChanged was null or undefined when calling putHotel.');
        }
        ...
        const response = await this.request({
            ...
            headers: headerParameters,
            query: queryParameters,
            body: HotelToBeChangedToJSON(requestParameters.hotelToBeChanged),
        }, initOverrides);
     ...
     * Update hotel information
     */
    async putHotel(requestParameters: PutHotelRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Status> {
        const response = await this.putHotelRaw(requestParameters, initOverrides);
        return await response.value();
    }
 ...
 * @export
 */
export const GetHotelsFetchInstructionsEnum = {
    CateringEvent: 'CateringEvent'
} as const;
export type GetHotelsFetchInstructionsEnum = typeof GetHotelsFetchInstructionsEnum[keyof typeof GetHotelsFetchInstructionsEnum];
/**
 * @export
 */
