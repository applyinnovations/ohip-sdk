...
export class HotelConfigApi extends runtime.BaseAPI {
    ...
    /**
     * clearCache <p><strong>OperationId:</strong>deleteHotelConfigServicesCache</p>
     *  clear cache
     */
    async deleteHotelConfigServicesCacheRaw(requestParameters: DeleteHotelConfigServicesCacheRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Status>> {
        const queryParameters: any = {};
     ...
     *  clear cache
     */
    async deleteHotelConfigServicesCache(requestParameters: DeleteHotelConfigServicesCacheRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Status> {
        const response = await this.deleteHotelConfigServicesCacheRaw(requestParameters, initOverrides);
        return await response.value();
    }
     ...
     *  ping
     */
    async pingHotelConfigServicesRaw(requestParameters: PingHotelConfigServicesRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<OperaVersion>> {
        const queryParameters: any = {};
     ...
     *  ping
     */
    async pingHotelConfigServices(requestParameters: PingHotelConfigServicesRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<OperaVersion> {
        const response = await this.pingHotelConfigServicesRaw(requestParameters, initOverrides);
        return await response.value();
    }
