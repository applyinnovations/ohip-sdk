 ...
 */
export function instanceOfAwardVouchersType(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function AwardVouchersTypeFromJSON(json: any): AwardVouchersType {
    return AwardVouchersTypeFromJSONTyped(json, false);
}

export function AwardVouchersTypeFromJSONTyped(json: any, ignoreDiscriminator: boolean): AwardVouchersType {
    return json;
}

export function AwardVouchersTypeToJSON(value?: AwardVouchersType | null): any {
    return value;
}
