 ...
 */
export function instanceOfTelephoneBookEntriesCriteria(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function TelephoneBookEntriesCriteriaFromJSON(json: any): TelephoneBookEntriesCriteria {
    return TelephoneBookEntriesCriteriaFromJSONTyped(json, false);
}

export function TelephoneBookEntriesCriteriaFromJSONTyped(json: any, ignoreDiscriminator: boolean): TelephoneBookEntriesCriteria {
...
export function TelephoneBookEntriesCriteriaToJSON(value?: TelephoneBookEntriesCriteria | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
