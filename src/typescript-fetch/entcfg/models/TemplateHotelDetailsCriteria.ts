 ...
 */
export function instanceOfTemplateHotelDetailsCriteria(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function TemplateHotelDetailsCriteriaFromJSON(json: any): TemplateHotelDetailsCriteria {
    return TemplateHotelDetailsCriteriaFromJSONTyped(json, false);
}

export function TemplateHotelDetailsCriteriaFromJSONTyped(json: any, ignoreDiscriminator: boolean): TemplateHotelDetailsCriteria {
...
export function TemplateHotelDetailsCriteriaToJSON(value?: TemplateHotelDetailsCriteria | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
