 ...
 */
export function instanceOfCopyYieldAdjustmentCodes(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function CopyYieldAdjustmentCodesFromJSON(json: any): CopyYieldAdjustmentCodes {
    return CopyYieldAdjustmentCodesFromJSONTyped(json, false);
}

export function CopyYieldAdjustmentCodesFromJSONTyped(json: any, ignoreDiscriminator: boolean): CopyYieldAdjustmentCodes {
...
export function CopyYieldAdjustmentCodesToJSON(value?: CopyYieldAdjustmentCodes | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
