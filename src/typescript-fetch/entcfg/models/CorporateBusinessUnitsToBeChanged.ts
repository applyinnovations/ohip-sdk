 ...
 */
export function instanceOfCorporateBusinessUnitsToBeChanged(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function CorporateBusinessUnitsToBeChangedFromJSON(json: any): CorporateBusinessUnitsToBeChanged {
    return CorporateBusinessUnitsToBeChangedFromJSONTyped(json, false);
}

export function CorporateBusinessUnitsToBeChangedFromJSONTyped(json: any, ignoreDiscriminator: boolean): CorporateBusinessUnitsToBeChanged {
...
export function CorporateBusinessUnitsToBeChangedToJSON(value?: CorporateBusinessUnitsToBeChanged | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
