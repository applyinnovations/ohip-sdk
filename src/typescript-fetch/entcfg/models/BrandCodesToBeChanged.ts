 ...
 */
export function instanceOfBrandCodesToBeChanged(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function BrandCodesToBeChangedFromJSON(json: any): BrandCodesToBeChanged {
    return BrandCodesToBeChangedFromJSONTyped(json, false);
}

export function BrandCodesToBeChangedFromJSONTyped(json: any, ignoreDiscriminator: boolean): BrandCodesToBeChanged {
...
export function BrandCodesToBeChangedToJSON(value?: BrandCodesToBeChanged | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
