 ...
 */
export function instanceOfAttractionTemplatesCriteria(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function AttractionTemplatesCriteriaFromJSON(json: any): AttractionTemplatesCriteria {
    return AttractionTemplatesCriteriaFromJSONTyped(json, false);
}

export function AttractionTemplatesCriteriaFromJSONTyped(json: any, ignoreDiscriminator: boolean): AttractionTemplatesCriteria {
...
export function AttractionTemplatesCriteriaToJSON(value?: AttractionTemplatesCriteria | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
