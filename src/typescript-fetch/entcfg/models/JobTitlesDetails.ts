 ...
 */
export function instanceOfJobTitlesDetails(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function JobTitlesDetailsFromJSON(json: any): JobTitlesDetails {
    return JobTitlesDetailsFromJSONTyped(json, false);
}

export function JobTitlesDetailsFromJSONTyped(json: any, ignoreDiscriminator: boolean): JobTitlesDetails {
...
export function JobTitlesDetailsToJSON(value?: JobTitlesDetails | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
