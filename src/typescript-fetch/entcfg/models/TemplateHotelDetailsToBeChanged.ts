 ...
 */
export function instanceOfTemplateHotelDetailsToBeChanged(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function TemplateHotelDetailsToBeChangedFromJSON(json: any): TemplateHotelDetailsToBeChanged {
    return TemplateHotelDetailsToBeChangedFromJSONTyped(json, false);
}

export function TemplateHotelDetailsToBeChangedFromJSONTyped(json: any, ignoreDiscriminator: boolean): TemplateHotelDetailsToBeChanged {
...
export function TemplateHotelDetailsToBeChangedToJSON(value?: TemplateHotelDetailsToBeChanged | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
