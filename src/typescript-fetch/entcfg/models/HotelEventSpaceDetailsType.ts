 ...
 */
export function instanceOfHotelEventSpaceDetailsType(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function HotelEventSpaceDetailsTypeFromJSON(json: any): HotelEventSpaceDetailsType {
    return HotelEventSpaceDetailsTypeFromJSONTyped(json, false);
}

export function HotelEventSpaceDetailsTypeFromJSONTyped(json: any, ignoreDiscriminator: boolean): HotelEventSpaceDetailsType {
    return json;
}

export function HotelEventSpaceDetailsTypeToJSON(value?: HotelEventSpaceDetailsType | null): any {
    return value;
}
