 ...
 * @export
 * @interface HotelBrochureTypeAddress
 */
export interface HotelBrochureTypeAddress {
    /**
     ...
     * @type {Array<string>}
     * @memberof HotelBrochureTypeAddress
     */
 ...
 */
export function instanceOfHotelBrochureTypeAddress(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function HotelBrochureTypeAddressFromJSON(json: any): HotelBrochureTypeAddress {
    return HotelBrochureTypeAddressFromJSONTyped(json, false);
}

export function HotelBrochureTypeAddressFromJSONTyped(json: any, ignoreDiscriminator: boolean): HotelBrochureTypeAddress {
...
export function HotelBrochureTypeAddressToJSON(value?: HotelBrochureTypeAddress | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
