 ...
 * @export
 * @interface RegionCodeType
 */
export interface RegionCodeType {
    /**
     * Common Master unique code.
     * @type {string}
     * @memberof RegionCodeType
     */
    code?: string;
    /**
     * 
 ...
 */
export function instanceOfRegionCodeType(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function RegionCodeTypeFromJSON(json: any): RegionCodeType {
    return RegionCodeTypeFromJSONTyped(json, false);
}

export function RegionCodeTypeFromJSONTyped(json: any, ignoreDiscriminator: boolean): RegionCodeType {
...
export function RegionCodeTypeToJSON(value?: RegionCodeType | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
