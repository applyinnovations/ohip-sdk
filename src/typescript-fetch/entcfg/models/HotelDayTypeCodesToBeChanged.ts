 ...
 */
export function instanceOfHotelDayTypeCodesToBeChanged(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function HotelDayTypeCodesToBeChangedFromJSON(json: any): HotelDayTypeCodesToBeChanged {
    return HotelDayTypeCodesToBeChangedFromJSONTyped(json, false);
}

export function HotelDayTypeCodesToBeChangedFromJSONTyped(json: any, ignoreDiscriminator: boolean): HotelDayTypeCodesToBeChanged {
...
export function HotelDayTypeCodesToBeChangedToJSON(value?: HotelDayTypeCodesToBeChanged | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
