 ...
 */
export function instanceOfCorporateOperatingUnitsType(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function CorporateOperatingUnitsTypeFromJSON(json: any): CorporateOperatingUnitsType {
    return CorporateOperatingUnitsTypeFromJSONTyped(json, false);
}

export function CorporateOperatingUnitsTypeFromJSONTyped(json: any, ignoreDiscriminator: boolean): CorporateOperatingUnitsType {
    return json;
}

export function CorporateOperatingUnitsTypeToJSON(value?: CorporateOperatingUnitsType | null): any {
    return value;
}
