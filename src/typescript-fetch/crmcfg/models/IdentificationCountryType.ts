 ...
 */
export function instanceOfIdentificationCountryType(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function IdentificationCountryTypeFromJSON(json: any): IdentificationCountryType {
    return IdentificationCountryTypeFromJSONTyped(json, false);
}

export function IdentificationCountryTypeFromJSONTyped(json: any, ignoreDiscriminator: boolean): IdentificationCountryType {
...
export function IdentificationCountryTypeToJSON(value?: IdentificationCountryType | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
