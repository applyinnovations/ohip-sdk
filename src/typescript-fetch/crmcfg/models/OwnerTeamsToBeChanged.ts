 ...
 */
export function instanceOfOwnerTeamsToBeChanged(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function OwnerTeamsToBeChangedFromJSON(json: any): OwnerTeamsToBeChanged {
    return OwnerTeamsToBeChangedFromJSONTyped(json, false);
}

export function OwnerTeamsToBeChangedFromJSONTyped(json: any, ignoreDiscriminator: boolean): OwnerTeamsToBeChanged {
...
export function OwnerTeamsToBeChangedToJSON(value?: OwnerTeamsToBeChanged | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
