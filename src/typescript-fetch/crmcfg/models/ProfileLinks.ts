 ...
 */
export function instanceOfProfileLinks(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function ProfileLinksFromJSON(json: any): ProfileLinks {
    return ProfileLinksFromJSONTyped(json, false);
}

export function ProfileLinksFromJSONTyped(json: any, ignoreDiscriminator: boolean): ProfileLinks {
...
export function ProfileLinksToJSON(value?: ProfileLinks | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
