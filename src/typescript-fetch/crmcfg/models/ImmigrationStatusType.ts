 ...
 */
export function instanceOfImmigrationStatusType(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function ImmigrationStatusTypeFromJSON(json: any): ImmigrationStatusType {
    return ImmigrationStatusTypeFromJSONTyped(json, false);
}

export function ImmigrationStatusTypeFromJSONTyped(json: any, ignoreDiscriminator: boolean): ImmigrationStatusType {
...
export function ImmigrationStatusTypeToJSON(value?: ImmigrationStatusType | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
