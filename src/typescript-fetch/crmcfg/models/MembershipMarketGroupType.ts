 ...
 */
export function instanceOfMembershipMarketGroupType(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function MembershipMarketGroupTypeFromJSON(json: any): MembershipMarketGroupType {
    return MembershipMarketGroupTypeFromJSONTyped(json, false);
}

export function MembershipMarketGroupTypeFromJSONTyped(json: any, ignoreDiscriminator: boolean): MembershipMarketGroupType {
...
export function MembershipMarketGroupTypeToJSON(value?: MembershipMarketGroupType | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
