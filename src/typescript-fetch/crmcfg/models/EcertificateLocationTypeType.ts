 ...
 * @export
 * @interface EcertificateLocationTypeType
 */
export interface EcertificateLocationTypeType {
    /**
     * Common Master unique code.
     * @type {string}
     * @memberof EcertificateLocationTypeType
     */
    code?: string;
    /**
     * 
 ...
 */
export function instanceOfEcertificateLocationTypeType(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function EcertificateLocationTypeTypeFromJSON(json: any): EcertificateLocationTypeType {
    return EcertificateLocationTypeTypeFromJSONTyped(json, false);
}

export function EcertificateLocationTypeTypeFromJSONTyped(json: any, ignoreDiscriminator: boolean): EcertificateLocationTypeType {
...
export function EcertificateLocationTypeTypeToJSON(value?: EcertificateLocationTypeType | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
