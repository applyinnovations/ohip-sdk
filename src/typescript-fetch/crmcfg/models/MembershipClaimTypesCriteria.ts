 ...
 */
export function instanceOfMembershipClaimTypesCriteria(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function MembershipClaimTypesCriteriaFromJSON(json: any): MembershipClaimTypesCriteria {
    return MembershipClaimTypesCriteriaFromJSONTyped(json, false);
}

export function MembershipClaimTypesCriteriaFromJSONTyped(json: any, ignoreDiscriminator: boolean): MembershipClaimTypesCriteria {
...
export function MembershipClaimTypesCriteriaToJSON(value?: MembershipClaimTypesCriteria | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
