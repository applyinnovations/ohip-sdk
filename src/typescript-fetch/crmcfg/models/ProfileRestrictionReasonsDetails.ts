 ...
 */
export function instanceOfProfileRestrictionReasonsDetails(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function ProfileRestrictionReasonsDetailsFromJSON(json: any): ProfileRestrictionReasonsDetails {
    return ProfileRestrictionReasonsDetailsFromJSONTyped(json, false);
}

export function ProfileRestrictionReasonsDetailsFromJSONTyped(json: any, ignoreDiscriminator: boolean): ProfileRestrictionReasonsDetails {
...
export function ProfileRestrictionReasonsDetailsToJSON(value?: ProfileRestrictionReasonsDetails | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
