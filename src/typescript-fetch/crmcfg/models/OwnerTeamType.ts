 ...
 * @export
 * @interface OwnerTeamType
 */
export interface OwnerTeamType {
    /**
     * Common Master unique code.
     * @type {string}
     * @memberof OwnerTeamType
     */
    code?: string;
    /**
     * 
 ...
 */
export function instanceOfOwnerTeamType(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function OwnerTeamTypeFromJSON(json: any): OwnerTeamType {
    return OwnerTeamTypeFromJSONTyped(json, false);
}

export function OwnerTeamTypeFromJSONTyped(json: any, ignoreDiscriminator: boolean): OwnerTeamType {
...
export function OwnerTeamTypeToJSON(value?: OwnerTeamType | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
