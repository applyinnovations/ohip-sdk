 ...
 */
export function instanceOfAccountTypesDetails(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function AccountTypesDetailsFromJSON(json: any): AccountTypesDetails {
    return AccountTypesDetailsFromJSONTyped(json, false);
}

export function AccountTypesDetailsFromJSONTyped(json: any, ignoreDiscriminator: boolean): AccountTypesDetails {
...
export function AccountTypesDetailsToJSON(value?: AccountTypesDetails | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
