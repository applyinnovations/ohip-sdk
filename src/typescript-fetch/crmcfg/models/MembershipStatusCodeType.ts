 ...
 * @export
 * @interface MembershipStatusCodeType
 */
export interface MembershipStatusCodeType {
    /**
     * Common Master unique code.
     * @type {string}
     * @memberof MembershipStatusCodeType
     */
    code?: string;
    /**
     * 
 ...
 */
export function instanceOfMembershipStatusCodeType(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function MembershipStatusCodeTypeFromJSON(json: any): MembershipStatusCodeType {
    return MembershipStatusCodeTypeFromJSONTyped(json, false);
}

export function MembershipStatusCodeTypeFromJSONTyped(json: any, ignoreDiscriminator: boolean): MembershipStatusCodeType {
...
export function MembershipStatusCodeTypeToJSON(value?: MembershipStatusCodeType | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
