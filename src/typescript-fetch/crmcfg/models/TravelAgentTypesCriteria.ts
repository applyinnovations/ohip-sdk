 ...
 */
export function instanceOfTravelAgentTypesCriteria(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function TravelAgentTypesCriteriaFromJSON(json: any): TravelAgentTypesCriteria {
    return TravelAgentTypesCriteriaFromJSONTyped(json, false);
}

export function TravelAgentTypesCriteriaFromJSONTyped(json: any, ignoreDiscriminator: boolean): TravelAgentTypesCriteria {
...
export function TravelAgentTypesCriteriaToJSON(value?: TravelAgentTypesCriteria | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
