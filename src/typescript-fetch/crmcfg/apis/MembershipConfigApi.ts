...
import {
    ...
    MembershipOriginGroupDetailsFromJSON,
    MembershipOriginGroupDetailsToJSON,
    MembershipOriginGroupsDetailsFromJSON,
    MembershipOriginGroupsDetailsToJSON,
    ...
    MembershipSourceGroupDetailsFromJSON,
    MembershipSourceGroupDetailsToJSON,
    MembershipSourceGroupsDetailsFromJSON,
    MembershipSourceGroupsDetailsToJSON,
...
export interface DeleteMembershipOriginGroupRequest {
...
export interface DeleteMembershipSourceGroupRequest {
...
export interface GetMembershipOriginGroupsRequest {
    authorization?: string;
    xAppKey?: string;
    xHotelid?: string;
    codes?: Array<string>;
...
export interface GetMembershipSourceGroupsRequest {
    authorization?: string;
    xAppKey?: string;
    xHotelid?: string;
    codes?: Array<string>;
...
export interface PostMembershipOriginGroupRequest {
    authorization?: string;
    xAppKey?: string;
    xHotelid?: string;
...
export interface PostMembershipSourceGroupRequest {
    authorization?: string;
    xAppKey?: string;
    xHotelid?: string;
...
export interface PutMembershipOriginGroupRequest {
    membershipOriginGroupId: string;
    authorization?: string;
    xAppKey?: string;
    xHotelid?: string;
...
export interface PutMembershipSourceGroupRequest {
    membershipSourceGroupId: string;
    authorization?: string;
    xAppKey?: string;
    xHotelid?: string;
...
export class MembershipConfigApi extends runtime.BaseAPI {
     ...
     */
    async deleteMembershipOriginGroupRaw(requestParameters: DeleteMembershipOriginGroupRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Status>> {
        if (requestParameters.membershipOriginGroupId === null || requestParameters.membershipOriginGroupId === undefined) {
            throw new runtime.RequiredError('membershipOriginGroupId','Required parameter requestParameters.membershipOriginGroupId was null or undefined when calling deleteMembershipOriginGroup.');
        }
        ...
        const response = await this.request({
            path: `/membershipOriginGroups/{membershipOriginGroupId}`.replace(`{${"membershipOriginGroupId"}}`, encodeURIComponent(String(requestParameters.membershipOriginGroupId))),
            method: 'DELETE',
            headers: headerParameters,
            query: queryParameters,
        }, initOverrides);
     ...
     * Delete Membership origin group
     */
    async deleteMembershipOriginGroup(requestParameters: DeleteMembershipOriginGroupRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Status> {
        const response = await this.deleteMembershipOriginGroupRaw(requestParameters, initOverrides);
        return await response.value();
    }
     ...
     */
    async deleteMembershipSourceGroupRaw(requestParameters: DeleteMembershipSourceGroupRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Status>> {
        if (requestParameters.membershipSourceGroupId === null || requestParameters.membershipSourceGroupId === undefined) {
            throw new runtime.RequiredError('membershipSourceGroupId','Required parameter requestParameters.membershipSourceGroupId was null or undefined when calling deleteMembershipSourceGroup.');
        }
        ...
        const response = await this.request({
            path: `/membershipSourceGroups/{membershipSourceGroupId}`.replace(`{${"membershipSourceGroupId"}}`, encodeURIComponent(String(requestParameters.membershipSourceGroupId))),
            method: 'DELETE',
            headers: headerParameters,
            query: queryParameters,
        }, initOverrides);
     ...
     * Delete Membership Source group
     */
    async deleteMembershipSourceGroup(requestParameters: DeleteMembershipSourceGroupRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Status> {
        const response = await this.deleteMembershipSourceGroupRaw(requestParameters, initOverrides);
        return await response.value();
    }
     ...
     */
    async getMembershipOriginGroupsRaw(requestParameters: GetMembershipOriginGroupsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<MembershipOriginGroupsDetails>> {
        const queryParameters: any = {};
        ...
        const response = await this.request({
            path: `/membershipOriginGroups`,
            method: 'GET',
            headers: headerParameters,
            query: queryParameters,
        }, initOverrides);

        return new runtime.JSONApiResponse(response, (jsonValue) => MembershipOriginGroupsDetailsFromJSON(jsonValue));
    }
     ...
     * Get Membership origin groups
     */
    async getMembershipOriginGroups(requestParameters: GetMembershipOriginGroupsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<MembershipOriginGroupsDetails> {
        const response = await this.getMembershipOriginGroupsRaw(requestParameters, initOverrides);
        return await response.value();
    }
     ...
     */
    async getMembershipSourceGroupsRaw(requestParameters: GetMembershipSourceGroupsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<MembershipSourceGroupsDetails>> {
        const queryParameters: any = {};
        ...
        const response = await this.request({
            path: `/membershipSourceGroups`,
            method: 'GET',
            headers: headerParameters,
            query: queryParameters,
        }, initOverrides);

        return new runtime.JSONApiResponse(response, (jsonValue) => MembershipSourceGroupsDetailsFromJSON(jsonValue));
    }
     ...
     * Get Membership source groups
     */
    async getMembershipSourceGroups(requestParameters: GetMembershipSourceGroupsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<MembershipSourceGroupsDetails> {
        const response = await this.getMembershipSourceGroupsRaw(requestParameters, initOverrides);
        return await response.value();
    }
     ...
     */
    async postMembershipOriginGroupRaw(requestParameters: PostMembershipOriginGroupRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Status>> {
        if (requestParameters.membershipOriginGroup === null || requestParameters.membershipOriginGroup === undefined) {
            throw new runtime.RequiredError('membershipOriginGroup','Required parameter requestParameters.membershipOriginGroup was null or undefined when calling postMembershipOriginGroup.');
        }
        ...
        const response = await this.request({
            ...
            headers: headerParameters,
            query: queryParameters,
            body: MembershipOriginGroupDetailsToJSON(requestParameters.membershipOriginGroup),
        }, initOverrides);
     ...
     * Create a Membership origin group
     */
    async postMembershipOriginGroup(requestParameters: PostMembershipOriginGroupRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Status> {
        const response = await this.postMembershipOriginGroupRaw(requestParameters, initOverrides);
        return await response.value();
    }
     ...
     */
    async postMembershipSourceGroupRaw(requestParameters: PostMembershipSourceGroupRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Status>> {
        if (requestParameters.membershipSourceGroup === null || requestParameters.membershipSourceGroup === undefined) {
            throw new runtime.RequiredError('membershipSourceGroup','Required parameter requestParameters.membershipSourceGroup was null or undefined when calling postMembershipSourceGroup.');
        }
        ...
        const response = await this.request({
            ...
            headers: headerParameters,
            query: queryParameters,
            body: MembershipSourceGroupDetailsToJSON(requestParameters.membershipSourceGroup),
        }, initOverrides);
     ...
     * Create a Membership source group
     */
    async postMembershipSourceGroup(requestParameters: PostMembershipSourceGroupRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Status> {
        const response = await this.postMembershipSourceGroupRaw(requestParameters, initOverrides);
        return await response.value();
    }
     ...
     */
    async putMembershipOriginGroupRaw(requestParameters: PutMembershipOriginGroupRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Status>> {
        if (requestParameters.membershipOriginGroupId === null || requestParameters.membershipOriginGroupId === undefined) {
            throw new runtime.RequiredError('membershipOriginGroupId','Required parameter requestParameters.membershipOriginGroupId was null or undefined when calling putMembershipOriginGroup.');
        }
        
        if (requestParameters.membershipOriginGroup === null || requestParameters.membershipOriginGroup === undefined) {
            throw new runtime.RequiredError('membershipOriginGroup','Required parameter requestParameters.membershipOriginGroup was null or undefined when calling putMembershipOriginGroup.');
        }
     ...
     * Change Membership origin group
     */
    async putMembershipOriginGroup(requestParameters: PutMembershipOriginGroupRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Status> {
        const response = await this.putMembershipOriginGroupRaw(requestParameters, initOverrides);
        return await response.value();
    }
     ...
     */
    async putMembershipSourceGroupRaw(requestParameters: PutMembershipSourceGroupRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Status>> {
        if (requestParameters.membershipSourceGroupId === null || requestParameters.membershipSourceGroupId === undefined) {
            throw new runtime.RequiredError('membershipSourceGroupId','Required parameter requestParameters.membershipSourceGroupId was null or undefined when calling putMembershipSourceGroup.');
        }
        
        if (requestParameters.membershipSourceGroup === null || requestParameters.membershipSourceGroup === undefined) {
            throw new runtime.RequiredError('membershipSourceGroup','Required parameter requestParameters.membershipSourceGroup was null or undefined when calling putMembershipSourceGroup.');
        }
     ...
     * Change Membership source group
     */
    async putMembershipSourceGroup(requestParameters: PutMembershipSourceGroupRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Status> {
        const response = await this.putMembershipSourceGroupRaw(requestParameters, initOverrides);
        return await response.value();
    }
