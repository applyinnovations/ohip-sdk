 ...
 */
export function instanceOfProfileDistributionFiltersType(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function ProfileDistributionFiltersTypeFromJSON(json: any): ProfileDistributionFiltersType {
    return ProfileDistributionFiltersTypeFromJSONTyped(json, false);
}

export function ProfileDistributionFiltersTypeFromJSONTyped(json: any, ignoreDiscriminator: boolean): ProfileDistributionFiltersType {
    return json;
}

export function ProfileDistributionFiltersTypeToJSON(value?: ProfileDistributionFiltersType | null): any {
    return value;
}
