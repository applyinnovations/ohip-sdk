 ...
 * @export
 * @interface ECertificateGeneration
 */
 ...
 */
export function instanceOfECertificateGeneration(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function ECertificateGenerationFromJSON(json: any): ECertificateGeneration {
    return ECertificateGenerationFromJSONTyped(json, false);
}

export function ECertificateGenerationFromJSONTyped(json: any, ignoreDiscriminator: boolean): ECertificateGeneration {
...
export function ECertificateGenerationToJSON(value?: ECertificateGeneration | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
