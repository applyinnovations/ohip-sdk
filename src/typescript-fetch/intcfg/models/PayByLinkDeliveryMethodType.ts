 ...
 */
export function instanceOfPayByLinkDeliveryMethodType(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function PayByLinkDeliveryMethodTypeFromJSON(json: any): PayByLinkDeliveryMethodType {
    return PayByLinkDeliveryMethodTypeFromJSONTyped(json, false);
}

export function PayByLinkDeliveryMethodTypeFromJSONTyped(json: any, ignoreDiscriminator: boolean): PayByLinkDeliveryMethodType {
...
export function PayByLinkDeliveryMethodTypeToJSON(value?: PayByLinkDeliveryMethodType | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
