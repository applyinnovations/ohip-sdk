 ...
 * @export
 */
export const HotelAvailabilityStatus = {
...
export function HotelAvailabilityStatusFromJSON(json: any): HotelAvailabilityStatus {
    return HotelAvailabilityStatusFromJSONTyped(json, false);
}

export function HotelAvailabilityStatusFromJSONTyped(json: any, ignoreDiscriminator: boolean): HotelAvailabilityStatus {
    return json as HotelAvailabilityStatus;
}

export function HotelAvailabilityStatusToJSON(value?: HotelAvailabilityStatus | null): any {
    return value as any;
}
