 ...
 */
export function instanceOfPropertySearchPropertyInfo(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function PropertySearchPropertyInfoFromJSON(json: any): PropertySearchPropertyInfo {
    return PropertySearchPropertyInfoFromJSONTyped(json, false);
}

export function PropertySearchPropertyInfoFromJSONTyped(json: any, ignoreDiscriminator: boolean): PropertySearchPropertyInfo {
    ...
    return {
        ...
        'isAlternate': !exists(json, 'isAlternate') ? undefined : json['isAlternate'],
    };
}

export function PropertySearchPropertyInfoToJSON(value?: PropertySearchPropertyInfo | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
