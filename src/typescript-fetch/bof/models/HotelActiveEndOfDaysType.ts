 ...
 */
export function instanceOfHotelActiveEndOfDaysType(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function HotelActiveEndOfDaysTypeFromJSON(json: any): HotelActiveEndOfDaysType {
    return HotelActiveEndOfDaysTypeFromJSONTyped(json, false);
}

export function HotelActiveEndOfDaysTypeFromJSONTyped(json: any, ignoreDiscriminator: boolean): HotelActiveEndOfDaysType {
    return json;
}

export function HotelActiveEndOfDaysTypeToJSON(value?: HotelActiveEndOfDaysType | null): any {
    return value;
}
