 ...
 */
export function instanceOfOverrideReasonsCriteria(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function OverrideReasonsCriteriaFromJSON(json: any): OverrideReasonsCriteria {
    return OverrideReasonsCriteriaFromJSONTyped(json, false);
}

export function OverrideReasonsCriteriaFromJSONTyped(json: any, ignoreDiscriminator: boolean): OverrideReasonsCriteria {
...
export function OverrideReasonsCriteriaToJSON(value?: OverrideReasonsCriteria | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
