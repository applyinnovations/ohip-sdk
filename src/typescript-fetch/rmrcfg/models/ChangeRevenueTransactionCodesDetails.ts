 ...
 */
export function instanceOfChangeRevenueTransactionCodesDetails(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function ChangeRevenueTransactionCodesDetailsFromJSON(json: any): ChangeRevenueTransactionCodesDetails {
    return ChangeRevenueTransactionCodesDetailsFromJSONTyped(json, false);
}

export function ChangeRevenueTransactionCodesDetailsFromJSONTyped(json: any, ignoreDiscriminator: boolean): ChangeRevenueTransactionCodesDetails {
...
export function ChangeRevenueTransactionCodesDetailsToJSON(value?: ChangeRevenueTransactionCodesDetails | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
