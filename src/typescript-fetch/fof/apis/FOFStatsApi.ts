...
import {
    ...
    ReservationStatusStatisticsResponseTypeFromJSON,
    ReservationStatusStatisticsResponseTypeToJSON,
    RoomStatusStatisticsListTypeFromJSON,
    RoomStatusStatisticsListTypeToJSON,
    StatisticsFromJSON,
    StatisticsToJSON,
...
export class FOFStatsApi extends runtime.BaseAPI {
     ...
     */
    async getReservationStatusStatisticsRaw(requestParameters: GetReservationStatusStatisticsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ReservationStatusStatisticsResponseType>> {
        if (requestParameters.hotelId === null || requestParameters.hotelId === undefined) {
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => ReservationStatusStatisticsResponseTypeFromJSON(jsonValue));
    }
     ...
     * Get Reservation Status Statistics
     */
    async getReservationStatusStatistics(requestParameters: GetReservationStatusStatisticsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<ReservationStatusStatisticsResponseType> {
        const response = await this.getReservationStatusStatisticsRaw(requestParameters, initOverrides);
        return await response.value();
    }
     ...
     */
    async getRoomsByRoomStatusRaw(requestParameters: GetRoomsByRoomStatusRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<RoomStatusStatisticsListType>> {
        if (requestParameters.hotelId === null || requestParameters.hotelId === undefined) {
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => RoomStatusStatisticsListTypeFromJSON(jsonValue));
    }
     ...
     * Get counts of rooms by housekeeping status and front office status.
     */
    async getRoomsByRoomStatus(requestParameters: GetRoomsByRoomStatusRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<RoomStatusStatisticsListType> {
        const response = await this.getRoomsByRoomStatusRaw(requestParameters, initOverrides);
        return await response.value();
    }
...
export const GetFrontOfficeStatisticsMetricEnum = {
    ...
    WalkInVip: 'WalkInVIP',
    CompletedRoomMoves: 'CompletedRoomMoves',
    PendingRoomMoves: 'PendingRoomMoves',
    AdultsArrivals: 'AdultsArrivals',
    ChildrenArrivals: 'ChildrenArrivals',
    Children1Arrivals: 'Children1Arrivals',
    Children2Arrivals: 'Children2Arrivals',
    Children3Arrivals: 'Children3Arrivals',
    Children1InHouse: 'Children1InHouse',
    Children2InHouse: 'Children2InHouse',
    Children3InHouse: 'Children3InHouse'
} as const;
 ...
 * @export
 */
export const GetReservationStatusStatisticsReservationStatusEnum = {
    DueIn: 'DueIn',
    DueOut: 'DueOut',
    CheckedIn: 'CheckedIn',
 ...
 * @export
 */
export const GetRoomsByRoomStatusFrontOfficeStatusEnum = {
    Vacant: 'Vacant',
    Occupied: 'Occupied'
} as const;
