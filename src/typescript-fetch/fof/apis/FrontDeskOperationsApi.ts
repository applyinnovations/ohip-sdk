...
import {
    ...
    HotelRoomsFromJSON,
    HotelRoomsToJSON,
    KeyOptionsInfoFromJSON,
    KeyOptionsInfoToJSON,
    KeyOptionsInfoListTypeFromJSON,
    KeyOptionsInfoListTypeToJSON,
    ...
    RoomKeyExternalFromJSON,
    RoomKeyExternalToJSON,
    RoomKeyExternalDetailsFromJSON,
    RoomKeyExternalDetailsToJSON,
    RoomKeyInfoFromJSON,
    RoomKeyInfoToJSON,
    ...
    RoomKeyStatusToJSON,
    RoomKeysExternalFromJSON,
    RoomKeysExternalToJSON,
    RoomKeysExternalDetailsFromJSON,
    RoomKeysExternalDetailsToJSON,
...
export interface GetAiraLastRunStatusRequest {
    hotelId: string;
    authorization?: string;
    xAppKey?: string;
    xHotelid?: string;
...
export interface GetKeyOptionsRequest {
    reservationId: string;
    hotelId: string;
    authorization?: string;
    xAppKey?: string;
...
export interface GetReservationSummariesRequest {
    ...
    keyword?: string;
    fetchInstructions?: Set<GetReservationSummariesFetchInstructionsEnum>;
    limit?: number;
    offset?: number;
    xExternalsystem?: string;
    acceptLanguage?: string;
...
export interface GetReservationsKeyOptionsRequest {
...
export interface GetWakeUpCallsRequest {
    hotelId: string;
    authorization?: string;
    xAppKey?: string;
    xHotelid?: string;
...
export interface PostExternalRoomKeysRequest {
    hotelId: string;
    authorization?: string;
    xAppKey?: string;
    xHotelid?: string;
...
export interface PostRoomKeysExternalRequest {
    hotelId: string;
    authorization?: string;
    xAppKey?: string;
    xHotelid?: string;
...
export class FrontDeskOperationsApi extends runtime.BaseAPI {
     ...
     */
    async getAiraLastRunStatusRaw(requestParameters: GetAiraLastRunStatusRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<AiraLastRunStatusInfo>> {
        if (requestParameters.hotelId === null || requestParameters.hotelId === undefined) {
     ...
     * Automated Intelligence Room Assignment last run status
     */
    async getAiraLastRunStatus(requestParameters: GetAiraLastRunStatusRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<AiraLastRunStatusInfo> {
        const response = await this.getAiraLastRunStatusRaw(requestParameters, initOverrides);
        return await response.value();
    }
     ...
     */
    async getKeyOptionsRaw(requestParameters: GetKeyOptionsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<KeyOptionsInfo>> {
        if (requestParameters.reservationId === null || requestParameters.reservationId === undefined) {
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => KeyOptionsInfoFromJSON(jsonValue));
    }
     ...
     * Fetch the keysOptions
     */
    async getKeyOptions(requestParameters: GetKeyOptionsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<KeyOptionsInfo> {
        const response = await this.getKeyOptionsRaw(requestParameters, initOverrides);
        return await response.value();
    }
     ...
     */
    async getReservationsKeyOptionsRaw(requestParameters: GetReservationsKeyOptionsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<KeyOptionsInfoListType>> {
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => KeyOptionsInfoListTypeFromJSON(jsonValue));
    }
     ...
     * Fetch keysOptions for the reservation and the guest profile
     */
    async getReservationsKeyOptions(requestParameters: GetReservationsKeyOptionsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<KeyOptionsInfoListType> {
        const response = await this.getReservationsKeyOptionsRaw(requestParameters, initOverrides);
        return await response.value();
    }
     ...
     * Get Wake Up Calls
     */
    async getWakeUpCallsRaw(requestParameters: GetWakeUpCallsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<WakeUpCalls>> {
        if (requestParameters.hotelId === null || requestParameters.hotelId === undefined) {
     ...
     * Get Wake Up Calls
     */
    async getWakeUpCalls(requestParameters: GetWakeUpCallsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<WakeUpCalls> {
        const response = await this.getWakeUpCallsRaw(requestParameters, initOverrides);
        return await response.value();
    }
     ...
     * @deprecated
     */
    async postExternalRoomKeysRaw(requestParameters: PostExternalRoomKeysRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<RoomKeyExternalDetails>> {
        if (requestParameters.hotelId === null || requestParameters.hotelId === undefined) {
        ...
        const response = await this.request({
            ...
            headers: headerParameters,
            query: queryParameters,
            body: RoomKeyExternalToJSON(requestParameters.roomKey),
        }, initOverrides);

        return new runtime.JSONApiResponse(response, (jsonValue) => RoomKeyExternalDetailsFromJSON(jsonValue));
    }
     ...
     * @deprecated
     */
    async postExternalRoomKeys(requestParameters: PostExternalRoomKeysRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<RoomKeyExternalDetails> {
        const response = await this.postExternalRoomKeysRaw(requestParameters, initOverrides);
        return await response.value();
    }
     ...
     * Requests room key(s)
     */
    async postRoomKeysExternalRaw(requestParameters: PostRoomKeysExternalRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<RoomKeysExternalDetails>> {
        if (requestParameters.hotelId === null || requestParameters.hotelId === undefined) {
        ...
        const response = await this.request({
            ...
            headers: headerParameters,
            query: queryParameters,
            body: RoomKeysExternalToJSON(requestParameters.roomKey),
        }, initOverrides);

        return new runtime.JSONApiResponse(response, (jsonValue) => RoomKeysExternalDetailsFromJSON(jsonValue));
    }
     ...
     * Requests room key(s)
     */
    async postRoomKeysExternal(requestParameters: PostRoomKeysExternalRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<RoomKeysExternalDetails> {
        const response = await this.postRoomKeysExternalRaw(requestParameters, initOverrides);
        return await response.value();
    }
 ...
 * @export
 */
export const GetReservationSummariesFetchInstructionsEnum = {
    ShortReservationSummaries: 'ShortReservationSummaries'
} as const;
export type GetReservationSummariesFetchInstructionsEnum = typeof GetReservationSummariesFetchInstructionsEnum[keyof typeof GetReservationSummariesFetchInstructionsEnum];
/**
 * @export
 */
