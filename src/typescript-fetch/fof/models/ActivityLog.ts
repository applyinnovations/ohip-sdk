...
export function ActivityLogFromJSONTyped(json: any, ignoreDiscriminator: boolean): ActivityLog {
    ...
    return {
        ...
        'activityLogDetails': !exists(json, 'activityLogDetails') ? undefined : ActivityLogListTypeFromJSON(json['activityLogDetails']),
...
export function ActivityLogToJSON(value?: ActivityLog | null): any {
    ...
    return {
        ...
        'activityLogDetails': ActivityLogListTypeToJSON(value.activityLogDetails),
