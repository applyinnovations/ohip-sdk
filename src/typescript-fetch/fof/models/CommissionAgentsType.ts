 ...
 */
export function instanceOfCommissionAgentsType(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function CommissionAgentsTypeFromJSON(json: any): CommissionAgentsType {
    return CommissionAgentsTypeFromJSONTyped(json, false);
}

export function CommissionAgentsTypeFromJSONTyped(json: any, ignoreDiscriminator: boolean): CommissionAgentsType {
    return json;
}

export function CommissionAgentsTypeToJSON(value?: CommissionAgentsType | null): any {
    return value;
}
