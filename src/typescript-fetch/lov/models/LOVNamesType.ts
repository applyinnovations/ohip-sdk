 ...
 * @export
 * @interface LOVNamesType
 */
export interface LOVNamesType extends Array<LOVNameType> {
}

/**
 * Check if a given object implements the LOVNamesType interface.
 */
export function instanceOfLOVNamesType(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function LOVNamesTypeFromJSON(json: any): LOVNamesType {
    return LOVNamesTypeFromJSONTyped(json, false);
}

export function LOVNamesTypeFromJSONTyped(json: any, ignoreDiscriminator: boolean): LOVNamesType {
    return json;
}

export function LOVNamesTypeToJSON(value?: LOVNamesType | null): any {
    return value;
}
