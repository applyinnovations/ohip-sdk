...
import {
    ...
    BlockBasicInfosFromJSON,
    BlockBasicInfosToJSON,
    BlockChangedFromJSON,
    BlockChangedToJSON,
    BlockChangesByDateTimeSummaryFromJSON,
    BlockChangesByDateTimeSummaryToJSON,
    ...
    CateringRevenueToChangeFromJSON,
    CateringRevenueToChangeToJSON,
    ...
    PropertyLeadsTypeFromJSON,
    PropertyLeadsTypeToJSON,
...
export class BlockApi extends runtime.BaseAPI {
     ...
     */
    async blockChangesByDateTimeRaw(requestParameters: BlockChangesByDateTimeRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<BlockChangesByDateTimeSummary>> {
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => BlockChangesByDateTimeSummaryFromJSON(jsonValue));
    }
     ...
     * Get modified blocks from a specific time period in OPERA.
     */
    async blockChangesByDateTime(requestParameters: BlockChangesByDateTimeRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<BlockChangesByDateTimeSummary> {
        const response = await this.blockChangesByDateTimeRaw(requestParameters, initOverrides);
     ...
     */
    async createPropertyLeadsRaw(requestParameters: CreatePropertyLeadsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Status>> {
        if (requestParameters.hotelId === null || requestParameters.hotelId === undefined) {
        ...
        const response = await this.request({
            ...
            headers: headerParameters,
            query: queryParameters,
            body: PropertyLeadsTypeToJSON(requestParameters.propertyLeads),
        }, initOverrides);
     ...
     * Use this API to create Property Leads
     */
    async createPropertyLeads(requestParameters: CreatePropertyLeadsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Status> {
        const response = await this.createPropertyLeadsRaw(requestParameters, initOverrides);
        return await response.value();
    }
     ...
     */
    async deleteBlockWashScheduleRaw(requestParameters: DeleteBlockWashScheduleRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Status>> {
        if (requestParameters.blockId === null || requestParameters.blockId === undefined) {
     ...
     * Remove Block Wash Schedule
     */
    async deleteBlockWashSchedule(requestParameters: DeleteBlockWashScheduleRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Status> {
        const response = await this.deleteBlockWashScheduleRaw(requestParameters, initOverrides);
        return await response.value();
    }
     ...
     */
    async getBlockRoomRateGridRaw(requestParameters: GetBlockRoomRateGridRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<BlockGridType>> {
        if (requestParameters.blockId === null || requestParameters.blockId === undefined) {
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => BlockGridTypeFromJSON(jsonValue));
    }
     ...
     * Operation to get room rate grid for a Block and supports pagination.
     */
    async getBlockRoomRateGrid(requestParameters: GetBlockRoomRateGridRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<BlockGridType> {
        const response = await this.getBlockRoomRateGridRaw(requestParameters, initOverrides);
        return await response.value();
    }
     ...
     */
    async postDefaultBlockCodeRaw(requestParameters: PostDefaultBlockCodeRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<BlockBasicInfos>> {
        ...
        const response = await this.request({
            ...
            headers: headerParameters,
            query: queryParameters,
            body: BlockBasicInfosToJSON(requestParameters.blockDetails),
        }, initOverrides);

        return new runtime.JSONApiResponse(response, (jsonValue) => BlockBasicInfosFromJSON(jsonValue));
    }
     ...
     * Create default Block Code for Multiple blocks
     */
    async postDefaultBlockCode(requestParameters: PostDefaultBlockCodeRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<BlockBasicInfos> {
        const response = await this.postDefaultBlockCodeRaw(requestParameters, initOverrides);
        return await response.value();
    }
     ...
     */
    async putCateringRevenueRaw(requestParameters: PutCateringRevenueRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Status>> {
        if (requestParameters.hotelId === null || requestParameters.hotelId === undefined) {
        ...
        const response = await this.request({
            ...
            headers: headerParameters,
            query: queryParameters,
            body: CateringRevenueToChangeToJSON(requestParameters.cateringRevenueToChange),
        }, initOverrides);
     ...
     * Recalculate Catering Revenue
     */
    async putCateringRevenue(requestParameters: PutCateringRevenueRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Status> {
        const response = await this.putCateringRevenueRaw(requestParameters, initOverrides);
        return await response.value();
    }
     ...
     */
    async putRegularToMasterBlockRaw(requestParameters: PutRegularToMasterBlockRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Status>> {
        if (requestParameters.hotelId === null || requestParameters.hotelId === undefined) {
     ...
     * Use this API to convert a regular block to a master block
     */
    async putRegularToMasterBlock(requestParameters: PutRegularToMasterBlockRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Status> {
        const response = await this.putRegularToMasterBlockRaw(requestParameters, initOverrides);
        return await response.value();
    }
     ...
     */
    async putSubBlockToRegularRaw(requestParameters: PutSubBlockToRegularRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Status>> {
        if (requestParameters.hotelId === null || requestParameters.hotelId === undefined) {
     ...
     * Use this API to convert a sub block to a regular block
     */
    async putSubBlockToRegular(requestParameters: PutSubBlockToRegularRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Status> {
        const response = await this.putSubBlockToRegularRaw(requestParameters, initOverrides);
        return await response.value();
    }
 ...
 * @export
 */
export const BlockChangesByDateTimeBlockStatusEnum = {
    Inquiry: 'INQUIRY',
    Nondeduct: 'NONDEDUCT',
    Deduct: 'DEDUCT',
    Actual: 'ACTUAL',
 ...
 * @export
 */
export const GetBlockRoomRateGridRoomAllocationCriteriaEnum = {
    Initial: 'Initial',
    Actual: 'Actual',
    Rates: 'Rates',
    Pickup: 'Pickup',
