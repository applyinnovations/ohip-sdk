...
export function BlockDetailsTypeFromJSONTyped(json: any, ignoreDiscriminator: boolean): BlockDetailsType {
    ...
    return {
        ...
        'autoloadForecastGrid': !exists(json, 'autoloadForecastGrid') ? undefined : json['autoloadForecastGrid'],
        'allowRateOverride': !exists(json, 'allowRateOverride') ? undefined : json['allowRateOverride'],
        'hasLinkedActivities': !exists(json, 'hasLinkedActivities') ? undefined : json['hasLinkedActivities'],
...
export function BlockDetailsTypeToJSON(value?: BlockDetailsType | null): any {
    ...
    return {
        ...
        'autoloadForecastGrid': value.autoloadForecastGrid,
        'allowRateOverride': value.allowRateOverride,
        'hasLinkedActivities': value.hasLinkedActivities,
