 ...
 * 
 * @export
 * @interface GridRoomAllocations
 */
export interface GridRoomAllocations {
    /**
     * 
     * @type {Array<RoomAllocationTypeType>}
     * @memberof GridRoomAllocations
     */
 ...
 */
export function instanceOfGridRoomAllocations(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function GridRoomAllocationsFromJSON(json: any): GridRoomAllocations {
    return GridRoomAllocationsFromJSONTyped(json, false);
}

export function GridRoomAllocationsFromJSONTyped(json: any, ignoreDiscriminator: boolean): GridRoomAllocations {
...
export function GridRoomAllocationsToJSON(value?: GridRoomAllocations | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
