 ...
 */
export function instanceOfDailyPlanCodesType(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function DailyPlanCodesTypeFromJSON(json: any): DailyPlanCodesType {
    return DailyPlanCodesTypeFromJSONTyped(json, false);
}

export function DailyPlanCodesTypeFromJSONTyped(json: any, ignoreDiscriminator: boolean): DailyPlanCodesType {
    return json;
}

export function DailyPlanCodesTypeToJSON(value?: DailyPlanCodesType | null): any {
    return value;
}
