...
import {
    FolioCodeDescriptionTypeFromJSON,
    FolioCodeDescriptionTypeFromJSONTyped,
    FolioCodeDescriptionTypeToJSON,
} from './FolioCodeDescriptionType';
...
export function ControlSequenceTypeFromJSONTyped(json: any, ignoreDiscriminator: boolean): ControlSequenceType {
    ...
    return {
        ...
        'folioType': !exists(json, 'folioType') ? undefined : FolioCodeDescriptionTypeFromJSON(json['folioType']),
...
export function ControlSequenceTypeToJSON(value?: ControlSequenceType | null): any {
    ...
    return {
        ...
        'folioType': FolioCodeDescriptionTypeToJSON(value.folioType),
