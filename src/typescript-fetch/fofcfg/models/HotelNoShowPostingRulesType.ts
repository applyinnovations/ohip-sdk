 ...
 */
export function instanceOfHotelNoShowPostingRulesType(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function HotelNoShowPostingRulesTypeFromJSON(json: any): HotelNoShowPostingRulesType {
    return HotelNoShowPostingRulesTypeFromJSONTyped(json, false);
}

export function HotelNoShowPostingRulesTypeFromJSONTyped(json: any, ignoreDiscriminator: boolean): HotelNoShowPostingRulesType {
    return json;
}

export function HotelNoShowPostingRulesTypeToJSON(value?: HotelNoShowPostingRulesType | null): any {
    return value;
}
