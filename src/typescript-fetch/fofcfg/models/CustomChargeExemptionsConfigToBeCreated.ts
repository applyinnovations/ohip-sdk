 ...
 */
export function instanceOfCustomChargeExemptionsConfigToBeCreated(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function CustomChargeExemptionsConfigToBeCreatedFromJSON(json: any): CustomChargeExemptionsConfigToBeCreated {
    return CustomChargeExemptionsConfigToBeCreatedFromJSONTyped(json, false);
}

export function CustomChargeExemptionsConfigToBeCreatedFromJSONTyped(json: any, ignoreDiscriminator: boolean): CustomChargeExemptionsConfigToBeCreated {
...
export function CustomChargeExemptionsConfigToBeCreatedToJSON(value?: CustomChargeExemptionsConfigToBeCreated | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
