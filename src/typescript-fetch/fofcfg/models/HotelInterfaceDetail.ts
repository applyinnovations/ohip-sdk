 ...
 */
export function instanceOfHotelInterfaceDetail(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function HotelInterfaceDetailFromJSON(json: any): HotelInterfaceDetail {
    return HotelInterfaceDetailFromJSONTyped(json, false);
}

export function HotelInterfaceDetailFromJSONTyped(json: any, ignoreDiscriminator: boolean): HotelInterfaceDetail {
...
export function HotelInterfaceDetailToJSON(value?: HotelInterfaceDetail | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
