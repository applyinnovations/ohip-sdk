 ...
 * 
 * @export
 * @interface RevenueBucketTypesCopy
 */
export interface RevenueBucketTypesCopy {
    /**
     * 
     * @type {Array<InstanceLink>}
     * @memberof RevenueBucketTypesCopy
     */
 ...
 */
export function instanceOfRevenueBucketTypesCopy(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function RevenueBucketTypesCopyFromJSON(json: any): RevenueBucketTypesCopy {
    return RevenueBucketTypesCopyFromJSONTyped(json, false);
}

export function RevenueBucketTypesCopyFromJSONTyped(json: any, ignoreDiscriminator: boolean): RevenueBucketTypesCopy {
...
export function RevenueBucketTypesCopyToJSON(value?: RevenueBucketTypesCopy | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
