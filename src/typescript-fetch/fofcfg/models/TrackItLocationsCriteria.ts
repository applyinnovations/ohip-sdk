 ...
 */
export function instanceOfTrackItLocationsCriteria(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function TrackItLocationsCriteriaFromJSON(json: any): TrackItLocationsCriteria {
    return TrackItLocationsCriteriaFromJSONTyped(json, false);
}

export function TrackItLocationsCriteriaFromJSONTyped(json: any, ignoreDiscriminator: boolean): TrackItLocationsCriteria {
...
export function TrackItLocationsCriteriaToJSON(value?: TrackItLocationsCriteria | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
