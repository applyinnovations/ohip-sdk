 ...
 */
export function instanceOfFiscalGuestTypesCriteria(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function FiscalGuestTypesCriteriaFromJSON(json: any): FiscalGuestTypesCriteria {
    return FiscalGuestTypesCriteriaFromJSONTyped(json, false);
}

export function FiscalGuestTypesCriteriaFromJSONTyped(json: any, ignoreDiscriminator: boolean): FiscalGuestTypesCriteria {
...
export function FiscalGuestTypesCriteriaToJSON(value?: FiscalGuestTypesCriteria | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
