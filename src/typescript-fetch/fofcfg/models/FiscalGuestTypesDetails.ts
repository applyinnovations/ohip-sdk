 ...
 */
export function instanceOfFiscalGuestTypesDetails(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function FiscalGuestTypesDetailsFromJSON(json: any): FiscalGuestTypesDetails {
    return FiscalGuestTypesDetailsFromJSONTyped(json, false);
}

export function FiscalGuestTypesDetailsFromJSONTyped(json: any, ignoreDiscriminator: boolean): FiscalGuestTypesDetails {
...
export function FiscalGuestTypesDetailsToJSON(value?: FiscalGuestTypesDetails | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
