 ...
 */
export function instanceOfGeneratesSetupType(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function GeneratesSetupTypeFromJSON(json: any): GeneratesSetupType {
    return GeneratesSetupTypeFromJSONTyped(json, false);
}

export function GeneratesSetupTypeFromJSONTyped(json: any, ignoreDiscriminator: boolean): GeneratesSetupType {
...
export function GeneratesSetupTypeToJSON(value?: GeneratesSetupType | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
