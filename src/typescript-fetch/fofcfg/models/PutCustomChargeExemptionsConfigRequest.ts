 ...
 * 
 * @export
 * @interface PutCustomChargeExemptionsConfigRequest
 */
export interface PutCustomChargeExemptionsConfigRequest {
     ...
     * @memberof PutCustomChargeExemptionsConfigRequest
     */
 ...
 */
export function instanceOfPutCustomChargeExemptionsConfigRequest(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function PutCustomChargeExemptionsConfigRequestFromJSON(json: any): PutCustomChargeExemptionsConfigRequest {
    return PutCustomChargeExemptionsConfigRequestFromJSONTyped(json, false);
}

export function PutCustomChargeExemptionsConfigRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): PutCustomChargeExemptionsConfigRequest {
...
export function PutCustomChargeExemptionsConfigRequestToJSON(value?: PutCustomChargeExemptionsConfigRequest | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
