 ...
 */
export function instanceOfRevenueNightsVarianceInfoType(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function RevenueNightsVarianceInfoTypeFromJSON(json: any): RevenueNightsVarianceInfoType {
    return RevenueNightsVarianceInfoTypeFromJSONTyped(json, false);
}

export function RevenueNightsVarianceInfoTypeFromJSONTyped(json: any, ignoreDiscriminator: boolean): RevenueNightsVarianceInfoType {
    return json;
}

export function RevenueNightsVarianceInfoTypeToJSON(value?: RevenueNightsVarianceInfoType | null): any {
    return value;
}
