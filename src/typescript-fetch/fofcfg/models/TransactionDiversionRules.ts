 ...
 * 
 * @export
 * @interface TransactionDiversionRules
 */
 ...
 */
export function instanceOfTransactionDiversionRules(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function TransactionDiversionRulesFromJSON(json: any): TransactionDiversionRules {
    return TransactionDiversionRulesFromJSONTyped(json, false);
}

export function TransactionDiversionRulesFromJSONTyped(json: any, ignoreDiscriminator: boolean): TransactionDiversionRules {
...
export function TransactionDiversionRulesToJSON(value?: TransactionDiversionRules | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
