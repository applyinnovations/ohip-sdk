 ...
 * @export
 * @interface TemplateCashierShiftDropLocationsCriteria
 */
export interface TemplateCashierShiftDropLocationsCriteria {
    /**
     * 
     * @type {Links}
     * @memberof TemplateCashierShiftDropLocationsCriteria
     */
    links?: Links;
    /**
     * 
 ...
 */
export function instanceOfTemplateCashierShiftDropLocationsCriteria(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function TemplateCashierShiftDropLocationsCriteriaFromJSON(json: any): TemplateCashierShiftDropLocationsCriteria {
    return TemplateCashierShiftDropLocationsCriteriaFromJSONTyped(json, false);
}

export function TemplateCashierShiftDropLocationsCriteriaFromJSONTyped(json: any, ignoreDiscriminator: boolean): TemplateCashierShiftDropLocationsCriteria {
...
export function TemplateCashierShiftDropLocationsCriteriaToJSON(value?: TemplateCashierShiftDropLocationsCriteria | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
