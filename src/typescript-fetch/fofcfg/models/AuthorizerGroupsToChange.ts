 ...
 */
export function instanceOfAuthorizerGroupsToChange(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function AuthorizerGroupsToChangeFromJSON(json: any): AuthorizerGroupsToChange {
    return AuthorizerGroupsToChangeFromJSONTyped(json, false);
}

export function AuthorizerGroupsToChangeFromJSONTyped(json: any, ignoreDiscriminator: boolean): AuthorizerGroupsToChange {
...
export function AuthorizerGroupsToChangeToJSON(value?: AuthorizerGroupsToChange | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
