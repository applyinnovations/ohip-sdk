 ...
 * @export
 * @interface OpenPaymentTokenExchange500Response
 */
export interface OpenPaymentTokenExchange500Response {
    /**
     * Unique identifier value that is attached to the request that allows reference to a particular transaction
     * @type {string}
     * @memberof OpenPaymentTokenExchange500Response
     */
 ...
 */
export function instanceOfOpenPaymentTokenExchange500Response(value: object): boolean {
    let isInstance = true;
...
export function OpenPaymentTokenExchange500ResponseFromJSON(json: any): OpenPaymentTokenExchange500Response {
    return OpenPaymentTokenExchange500ResponseFromJSONTyped(json, false);
}

export function OpenPaymentTokenExchange500ResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): OpenPaymentTokenExchange500Response {
...
export function OpenPaymentTokenExchange500ResponseToJSON(value?: OpenPaymentTokenExchange500Response | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
