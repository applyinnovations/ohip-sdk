 ...
 */
export function instanceOfNegotiatedRates(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function NegotiatedRatesFromJSON(json: any): NegotiatedRates {
    return NegotiatedRatesFromJSONTyped(json, false);
}

export function NegotiatedRatesFromJSONTyped(json: any, ignoreDiscriminator: boolean): NegotiatedRates {
...
export function NegotiatedRatesToJSON(value?: NegotiatedRates | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
