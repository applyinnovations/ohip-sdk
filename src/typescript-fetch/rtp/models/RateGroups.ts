 ...
 */
export function instanceOfRateGroups(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function RateGroupsFromJSON(json: any): RateGroups {
    return RateGroupsFromJSONTyped(json, false);
}

export function RateGroupsFromJSONTyped(json: any, ignoreDiscriminator: boolean): RateGroups {
...
export function RateGroupsToJSON(value?: RateGroups | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
