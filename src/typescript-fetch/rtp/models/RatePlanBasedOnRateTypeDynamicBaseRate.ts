 ...
 * @export
 * @interface RatePlanBasedOnRateTypeDynamicBaseRate
 */
export interface RatePlanBasedOnRateTypeDynamicBaseRate {
    /**
 ...
 */
export function instanceOfRatePlanBasedOnRateTypeDynamicBaseRate(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function RatePlanBasedOnRateTypeDynamicBaseRateFromJSON(json: any): RatePlanBasedOnRateTypeDynamicBaseRate {
    return RatePlanBasedOnRateTypeDynamicBaseRateFromJSONTyped(json, false);
}

export function RatePlanBasedOnRateTypeDynamicBaseRateFromJSONTyped(json: any, ignoreDiscriminator: boolean): RatePlanBasedOnRateTypeDynamicBaseRate {
...
export function RatePlanBasedOnRateTypeDynamicBaseRateToJSON(value?: RatePlanBasedOnRateTypeDynamicBaseRate | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
