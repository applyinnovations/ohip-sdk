...
import {
    ...
    RatePlanSchedulesToSetFromJSON,
    RatePlanSchedulesToSetToJSON,
...
export interface SetRatePlanSchedulesRequest {
    ratePlanCode: string;
    hotelId: string;
    authorization?: string;
    xAppKey?: string;
...
export interface SyncRatePlansRequest {
    hotelId: string;
    authorization?: string;
    xAppKey?: string;
    xHotelid?: string;
...
export class RatePlanApi extends runtime.BaseAPI {
    ...
    async getNegotiatedRatesForGivenProfileRaw(requestParameters: GetNegotiatedRatesForGivenProfileRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<NegotiatedRates>> {
        ...
        if (requestParameters.hotelCodes) {
            queryParameters['hotelCodes'] = requestParameters.hotelCodes;
        }
     ...
     */
    async setRatePlanSchedulesRaw(requestParameters: SetRatePlanSchedulesRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Status>> {
        if (requestParameters.ratePlanCode === null || requestParameters.ratePlanCode === undefined) {
            throw new runtime.RequiredError('ratePlanCode','Required parameter requestParameters.ratePlanCode was null or undefined when calling setRatePlanSchedules.');
        }
        
        if (requestParameters.hotelId === null || requestParameters.hotelId === undefined) {
            throw new runtime.RequiredError('hotelId','Required parameter requestParameters.hotelId was null or undefined when calling setRatePlanSchedules.');
        }
        
        if (requestParameters.ratePlanSchedules === null || requestParameters.ratePlanSchedules === undefined) {
            throw new runtime.RequiredError('ratePlanSchedules','Required parameter requestParameters.ratePlanSchedules was null or undefined when calling setRatePlanSchedules.');
        }
        ...
        const response = await this.request({
            path: `/hotels/{hotelId}/ratePlans/{ratePlanCode}/schedules/set`.replace(`{${"ratePlanCode"}}`, encodeURIComponent(String(requestParameters.ratePlanCode))).replace(`{${"hotelId"}}`, encodeURIComponent(String(requestParameters.hotelId))),
            method: 'PUT',
            headers: headerParameters,
            query: queryParameters,
            body: RatePlanSchedulesToSetToJSON(requestParameters.ratePlanSchedules),
        }, initOverrides);
     ...
     * Set rate plan schedules
     */
    async setRatePlanSchedules(requestParameters: SetRatePlanSchedulesRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Status> {
        const response = await this.setRatePlanSchedulesRaw(requestParameters, initOverrides);
        return await response.value();
    }
     ...
     */
    async syncRatePlansRaw(requestParameters: SyncRatePlansRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Status>> {
        if (requestParameters.hotelId === null || requestParameters.hotelId === undefined) {
            throw new runtime.RequiredError('hotelId','Required parameter requestParameters.hotelId was null or undefined when calling syncRatePlans.');
        }
        
        if (requestParameters.ratePlansSync === null || requestParameters.ratePlansSync === undefined) {
            throw new runtime.RequiredError('ratePlansSync','Required parameter requestParameters.ratePlansSync was null or undefined when calling syncRatePlans.');
        }
        ...
        const response = await this.request({
            path: `/hotels/{hotelId}/ratePlans/sync`.replace(`{${"hotelId"}}`, encodeURIComponent(String(requestParameters.hotelId))),
            method: 'PUT',
            headers: headerParameters,
            query: queryParameters,
            body: RatePlansSyncToJSON(requestParameters.ratePlansSync),
        }, initOverrides);
     ...
     * Synchronizes Rate Plan information including Rate Header and Packages across target properties.
     */
    async syncRatePlans(requestParameters: SyncRatePlansRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Status> {
        const response = await this.syncRatePlansRaw(requestParameters, initOverrides);
        return await response.value();
    }
