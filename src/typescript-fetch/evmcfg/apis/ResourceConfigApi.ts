...
import {
    ...
    CopyCateringPackagePriceTypeFromJSON,
    CopyCateringPackagePriceTypeToJSON,
    CopyCateringPackageTypeFromJSON,
    CopyCateringPackageTypeToJSON,
    ...
    ItemPoolsInfoToJSON,
    ResourceCodeInfoFromJSON,
    ResourceCodeInfoToJSON,
...
export interface CopyCateringPackagePriceRequest {
    pricesId: string;
    cateringPackageId: string;
    hotelId: string;
    authorization?: string;
...
export interface DeleteResourceConfigServiceCacheRequest {
    authorization?: string;
    xAppKey?: string;
    xHotelid?: string;
...
export interface GetCateringMenuItemsRequest {
    ...
    fetchInstructions?: Set<GetCateringMenuItemsFetchInstructionsEnum>;
    xExternalsystem?: string;
    acceptLanguage?: string;
}
...
export class ResourceConfigApi extends runtime.BaseAPI {
     ...
     */
    async copyCateringPackageRaw(requestParameters: CopyCateringPackageRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ResourceCodeInfo>> {
        if (requestParameters.hotelId === null || requestParameters.hotelId === undefined) {
            throw new runtime.RequiredError('hotelId','Required parameter requestParameters.hotelId was null or undefined when calling copyCateringPackage.');
        }
        ...
        if (requestParameters.copyCateringPackageType === null || requestParameters.copyCateringPackageType === undefined) {
            throw new runtime.RequiredError('copyCateringPackageType','Required parameter requestParameters.copyCateringPackageType was null or undefined when calling copyCateringPackage.');
        }
        ...
        const response = await this.request({
            path: `/hotels/{hotelId}/cateringPackages/{cateringPackageId}/copy`.replace(`{${"hotelId"}}`, encodeURIComponent(String(requestParameters.hotelId))).replace(`{${"cateringPackageId"}}`, encodeURIComponent(String(requestParameters.cateringPackageId))),
            method: 'POST',
            headers: headerParameters,
            query: queryParameters,
            body: CopyCateringPackageTypeToJSON(requestParameters.copyCateringPackageType),
        }, initOverrides);

        return new runtime.JSONApiResponse(response, (jsonValue) => ResourceCodeInfoFromJSON(jsonValue));
    }
     ...
     * Operation to copy catering package or template.
     */
    async copyCateringPackage(requestParameters: CopyCateringPackageRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<ResourceCodeInfo> {
     ...
     */
    async copyCateringPackagePriceRaw(requestParameters: CopyCateringPackagePriceRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ResourceCodeInfo>> {
        if (requestParameters.pricesId === null || requestParameters.pricesId === undefined) {
            throw new runtime.RequiredError('pricesId','Required parameter requestParameters.pricesId was null or undefined when calling copyCateringPackagePrice.');
        }
        
        if (requestParameters.cateringPackageId === null || requestParameters.cateringPackageId === undefined) {
            throw new runtime.RequiredError('cateringPackageId','Required parameter requestParameters.cateringPackageId was null or undefined when calling copyCateringPackagePrice.');
        }
        
        if (requestParameters.hotelId === null || requestParameters.hotelId === undefined) {
            throw new runtime.RequiredError('hotelId','Required parameter requestParameters.hotelId was null or undefined when calling copyCateringPackagePrice.');
        }
        
        if (requestParameters.copyCateringPackagePriceType === null || requestParameters.copyCateringPackagePriceType === undefined) {
            throw new runtime.RequiredError('copyCateringPackagePriceType','Required parameter requestParameters.copyCateringPackagePriceType was null or undefined when calling copyCateringPackagePrice.');
        }
        ...
        const response = await this.request({
            path: `/hotels/{hotelId}/cateringPackages/{cateringPackageId}/prices/{pricesId}/copy`.replace(`{${"pricesId"}}`, encodeURIComponent(String(requestParameters.pricesId))).replace(`{${"cateringPackageId"}}`, encodeURIComponent(String(requestParameters.cateringPackageId))).replace(`{${"hotelId"}}`, encodeURIComponent(String(requestParameters.hotelId))),
            method: 'POST',
            headers: headerParameters,
            query: queryParameters,
            body: CopyCateringPackagePriceTypeToJSON(requestParameters.copyCateringPackagePriceType),
        }, initOverrides);
     ...
     * Operation to copy catering package price.
     */
    async copyCateringPackagePrice(requestParameters: CopyCateringPackagePriceRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<ResourceCodeInfo> {
        const response = await this.copyCateringPackagePriceRaw(requestParameters, initOverrides);
        return await response.value();
    }
     ...
     * ClearCache
     */
    async deleteResourceConfigServiceCacheRaw(requestParameters: DeleteResourceConfigServiceCacheRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Status>> {
        const queryParameters: any = {};
     ...
     * ClearCache
     */
    async deleteResourceConfigServiceCache(requestParameters: DeleteResourceConfigServiceCacheRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Status> {
        const response = await this.deleteResourceConfigServiceCacheRaw(requestParameters, initOverrides);
        return await response.value();
    }
 ...
 * @export
 */
export const GetCateringMenuItemsFetchInstructionsEnum = {
    SummaryInfo: 'SummaryInfo',
    DetailsInfo: 'DetailsInfo'
} as const;
export type GetCateringMenuItemsFetchInstructionsEnum = typeof GetCateringMenuItemsFetchInstructionsEnum[keyof typeof GetCateringMenuItemsFetchInstructionsEnum];
/**
 * @export
 */
