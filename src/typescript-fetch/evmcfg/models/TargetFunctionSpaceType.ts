 ...
 */
export function instanceOfTargetFunctionSpaceType(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function TargetFunctionSpaceTypeFromJSON(json: any): TargetFunctionSpaceType {
    return TargetFunctionSpaceTypeFromJSONTyped(json, false);
}

export function TargetFunctionSpaceTypeFromJSONTyped(json: any, ignoreDiscriminator: boolean): TargetFunctionSpaceType {
    ...
    return {
        ...
        'targetRoomNumber': !exists(json, 'targetRoomNumber') ? undefined : json['targetRoomNumber'],
    };
}

export function TargetFunctionSpaceTypeToJSON(value?: TargetFunctionSpaceType | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
