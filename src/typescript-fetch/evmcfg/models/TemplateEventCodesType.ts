 ...
 */
export function instanceOfTemplateEventCodesType(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function TemplateEventCodesTypeFromJSON(json: any): TemplateEventCodesType {
    return TemplateEventCodesTypeFromJSONTyped(json, false);
}

export function TemplateEventCodesTypeFromJSONTyped(json: any, ignoreDiscriminator: boolean): TemplateEventCodesType {
    return json;
}

export function TemplateEventCodesTypeToJSON(value?: TemplateEventCodesType | null): any {
    return value;
}
