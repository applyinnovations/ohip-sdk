 ...
 */
export function instanceOfCateringPackageRevenueListType(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function CateringPackageRevenueListTypeFromJSON(json: any): CateringPackageRevenueListType {
    return CateringPackageRevenueListTypeFromJSONTyped(json, false);
}

export function CateringPackageRevenueListTypeFromJSONTyped(json: any, ignoreDiscriminator: boolean): CateringPackageRevenueListType {
    return json;
}

export function CateringPackageRevenueListTypeToJSON(value?: CateringPackageRevenueListType | null): any {
    return value;
}
