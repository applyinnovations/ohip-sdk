 ...
 */
export function instanceOfTemplateEventCodesToBeChanged(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function TemplateEventCodesToBeChangedFromJSON(json: any): TemplateEventCodesToBeChanged {
    return TemplateEventCodesToBeChangedFromJSONTyped(json, false);
}

export function TemplateEventCodesToBeChangedFromJSONTyped(json: any, ignoreDiscriminator: boolean): TemplateEventCodesToBeChanged {
...
export function TemplateEventCodesToBeChangedToJSON(value?: TemplateEventCodesToBeChanged | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
