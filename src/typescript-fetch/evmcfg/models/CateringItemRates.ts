 ...
 */
export function instanceOfCateringItemRates(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function CateringItemRatesFromJSON(json: any): CateringItemRates {
    return CateringItemRatesFromJSONTyped(json, false);
}

export function CateringItemRatesFromJSONTyped(json: any, ignoreDiscriminator: boolean): CateringItemRates {
...
export function CateringItemRatesToJSON(value?: CateringItemRates | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
