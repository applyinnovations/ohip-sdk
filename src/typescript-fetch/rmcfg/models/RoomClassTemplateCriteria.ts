 ...
 */
export function instanceOfRoomClassTemplateCriteria(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function RoomClassTemplateCriteriaFromJSON(json: any): RoomClassTemplateCriteria {
    return RoomClassTemplateCriteriaFromJSONTyped(json, false);
}

export function RoomClassTemplateCriteriaFromJSONTyped(json: any, ignoreDiscriminator: boolean): RoomClassTemplateCriteria {
...
export function RoomClassTemplateCriteriaToJSON(value?: RoomClassTemplateCriteria | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
