 ...
 */
export function instanceOfHousekeepingSectionsToBeChanged(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function HousekeepingSectionsToBeChangedFromJSON(json: any): HousekeepingSectionsToBeChanged {
    return HousekeepingSectionsToBeChangedFromJSONTyped(json, false);
}

export function HousekeepingSectionsToBeChangedFromJSONTyped(json: any, ignoreDiscriminator: boolean): HousekeepingSectionsToBeChanged {
...
export function HousekeepingSectionsToBeChangedToJSON(value?: HousekeepingSectionsToBeChanged | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
