 ...
 */
export function instanceOfTemplateFloorsToBeChanged(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function TemplateFloorsToBeChangedFromJSON(json: any): TemplateFloorsToBeChanged {
    return TemplateFloorsToBeChangedFromJSONTyped(json, false);
}

export function TemplateFloorsToBeChangedFromJSONTyped(json: any, ignoreDiscriminator: boolean): TemplateFloorsToBeChanged {
...
export function TemplateFloorsToBeChangedToJSON(value?: TemplateFloorsToBeChanged | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
