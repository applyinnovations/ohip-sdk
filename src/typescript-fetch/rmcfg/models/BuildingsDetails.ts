 ...
 */
export function instanceOfBuildingsDetails(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function BuildingsDetailsFromJSON(json: any): BuildingsDetails {
    return BuildingsDetailsFromJSONTyped(json, false);
}

export function BuildingsDetailsFromJSONTyped(json: any, ignoreDiscriminator: boolean): BuildingsDetails {
...
export function BuildingsDetailsToJSON(value?: BuildingsDetails | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
