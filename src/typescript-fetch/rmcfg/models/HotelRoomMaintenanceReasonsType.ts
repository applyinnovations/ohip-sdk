 ...
 */
export function instanceOfHotelRoomMaintenanceReasonsType(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function HotelRoomMaintenanceReasonsTypeFromJSON(json: any): HotelRoomMaintenanceReasonsType {
    return HotelRoomMaintenanceReasonsTypeFromJSONTyped(json, false);
}

export function HotelRoomMaintenanceReasonsTypeFromJSONTyped(json: any, ignoreDiscriminator: boolean): HotelRoomMaintenanceReasonsType {
    return json;
}

export function HotelRoomMaintenanceReasonsTypeToJSON(value?: HotelRoomMaintenanceReasonsType | null): any {
    return value;
}
