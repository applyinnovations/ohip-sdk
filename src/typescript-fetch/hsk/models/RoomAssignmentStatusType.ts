 ...
 * @export
 */
export const RoomAssignmentStatusType = {
    Assigned: 'Assigned',
    Unassigned: 'Unassigned'
} as const;
export type RoomAssignmentStatusType = typeof RoomAssignmentStatusType[keyof typeof RoomAssignmentStatusType];


export function RoomAssignmentStatusTypeFromJSON(json: any): RoomAssignmentStatusType {
    return RoomAssignmentStatusTypeFromJSONTyped(json, false);
}

export function RoomAssignmentStatusTypeFromJSONTyped(json: any, ignoreDiscriminator: boolean): RoomAssignmentStatusType {
    return json as RoomAssignmentStatusType;
}

export function RoomAssignmentStatusTypeToJSON(value?: RoomAssignmentStatusType | null): any {
    return value as any;
}
