 ...
 */
export function instanceOfRoomRepairOutOfOrder(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function RoomRepairOutOfOrderFromJSON(json: any): RoomRepairOutOfOrder {
    return RoomRepairOutOfOrderFromJSONTyped(json, false);
}

export function RoomRepairOutOfOrderFromJSONTyped(json: any, ignoreDiscriminator: boolean): RoomRepairOutOfOrder {
...
export function RoomRepairOutOfOrderToJSON(value?: RoomRepairOutOfOrder | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
