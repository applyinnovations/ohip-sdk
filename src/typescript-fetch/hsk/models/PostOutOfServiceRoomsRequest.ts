 ...
 */
export function instanceOfPostOutOfServiceRoomsRequest(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function PostOutOfServiceRoomsRequestFromJSON(json: any): PostOutOfServiceRoomsRequest {
    return PostOutOfServiceRoomsRequestFromJSONTyped(json, false);
}

export function PostOutOfServiceRoomsRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): PostOutOfServiceRoomsRequest {
...
export function PostOutOfServiceRoomsRequestToJSON(value?: PostOutOfServiceRoomsRequest | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
