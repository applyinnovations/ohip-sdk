 ...
 */
export function instanceOfCompleteOutOfOrderRoomsRequest(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function CompleteOutOfOrderRoomsRequestFromJSON(json: any): CompleteOutOfOrderRoomsRequest {
    return CompleteOutOfOrderRoomsRequestFromJSONTyped(json, false);
}

export function CompleteOutOfOrderRoomsRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): CompleteOutOfOrderRoomsRequest {
...
export function CompleteOutOfOrderRoomsRequestToJSON(value?: CompleteOutOfOrderRoomsRequest | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
