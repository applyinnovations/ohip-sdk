 ...
 */
export function instanceOfScheduledSearch(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function ScheduledSearchFromJSON(json: any): ScheduledSearch {
    return ScheduledSearchFromJSONTyped(json, false);
}

export function ScheduledSearchFromJSONTyped(json: any, ignoreDiscriminator: boolean): ScheduledSearch {
...
export function ScheduledSearchToJSON(value?: ScheduledSearch | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
