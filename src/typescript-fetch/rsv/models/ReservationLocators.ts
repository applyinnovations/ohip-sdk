 ...
 */
export function instanceOfReservationLocators(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function ReservationLocatorsFromJSON(json: any): ReservationLocators {
    return ReservationLocatorsFromJSONTyped(json, false);
}

export function ReservationLocatorsFromJSONTyped(json: any, ignoreDiscriminator: boolean): ReservationLocators {
...
export function ReservationLocatorsToJSON(value?: ReservationLocators | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
