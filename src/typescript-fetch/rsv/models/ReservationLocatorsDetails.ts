 ...
 * @export
 * @interface ReservationLocatorsDetails
 */
export interface ReservationLocatorsDetails {
    /**
     * Holds the Locator Information.
     * @type {Array<ReservationLocatorType>}
     * @memberof ReservationLocatorsDetails
     */
 ...
 */
export function instanceOfReservationLocatorsDetails(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function ReservationLocatorsDetailsFromJSON(json: any): ReservationLocatorsDetails {
    return ReservationLocatorsDetailsFromJSONTyped(json, false);
}

export function ReservationLocatorsDetailsFromJSONTyped(json: any, ignoreDiscriminator: boolean): ReservationLocatorsDetails {
...
export function ReservationLocatorsDetailsToJSON(value?: ReservationLocatorsDetails | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
