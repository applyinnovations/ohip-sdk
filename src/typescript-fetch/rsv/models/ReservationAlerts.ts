 ...
 */
export function instanceOfReservationAlerts(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function ReservationAlertsFromJSON(json: any): ReservationAlerts {
    return ReservationAlertsFromJSONTyped(json, false);
}

export function ReservationAlertsFromJSONTyped(json: any, ignoreDiscriminator: boolean): ReservationAlerts {
...
export function ReservationAlertsToJSON(value?: ReservationAlerts | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
