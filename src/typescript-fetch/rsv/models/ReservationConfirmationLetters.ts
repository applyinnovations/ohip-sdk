 ...
 * @export
 * @interface ReservationConfirmationLetters
 */
 ...
 */
export function instanceOfReservationConfirmationLetters(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function ReservationConfirmationLettersFromJSON(json: any): ReservationConfirmationLetters {
    return ReservationConfirmationLettersFromJSONTyped(json, false);
}

export function ReservationConfirmationLettersFromJSONTyped(json: any, ignoreDiscriminator: boolean): ReservationConfirmationLetters {
...
export function ReservationConfirmationLettersToJSON(value?: ReservationConfirmationLetters | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
