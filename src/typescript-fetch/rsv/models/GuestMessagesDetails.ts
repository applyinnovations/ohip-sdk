 ...
 * @export
 * @interface GuestMessagesDetails
 */
 ...
 */
export function instanceOfGuestMessagesDetails(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function GuestMessagesDetailsFromJSON(json: any): GuestMessagesDetails {
    return GuestMessagesDetailsFromJSONTyped(json, false);
}

export function GuestMessagesDetailsFromJSONTyped(json: any, ignoreDiscriminator: boolean): GuestMessagesDetails {
...
export function GuestMessagesDetailsToJSON(value?: GuestMessagesDetails | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
