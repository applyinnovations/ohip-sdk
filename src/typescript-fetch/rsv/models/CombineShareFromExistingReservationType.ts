 ...
 */
export function instanceOfCombineShareFromExistingReservationType(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function CombineShareFromExistingReservationTypeFromJSON(json: any): CombineShareFromExistingReservationType {
    return CombineShareFromExistingReservationTypeFromJSONTyped(json, false);
}

export function CombineShareFromExistingReservationTypeFromJSONTyped(json: any, ignoreDiscriminator: boolean): CombineShareFromExistingReservationType {
...
export function CombineShareFromExistingReservationTypeToJSON(value?: CombineShareFromExistingReservationType | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
