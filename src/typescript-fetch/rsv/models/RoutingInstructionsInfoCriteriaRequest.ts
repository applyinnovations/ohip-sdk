 ...
 */
export function instanceOfRoutingInstructionsInfoCriteriaRequest(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function RoutingInstructionsInfoCriteriaRequestFromJSON(json: any): RoutingInstructionsInfoCriteriaRequest {
    return RoutingInstructionsInfoCriteriaRequestFromJSONTyped(json, false);
}

export function RoutingInstructionsInfoCriteriaRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): RoutingInstructionsInfoCriteriaRequest {
...
export function RoutingInstructionsInfoCriteriaRequestToJSON(value?: RoutingInstructionsInfoCriteriaRequest | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
