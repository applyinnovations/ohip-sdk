 ...
 */
export function instanceOfActivityLookUpList(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function ActivityLookUpListFromJSON(json: any): ActivityLookUpList {
    return ActivityLookUpListFromJSONTyped(json, false);
}

export function ActivityLookUpListFromJSONTyped(json: any, ignoreDiscriminator: boolean): ActivityLookUpList {
    return json;
}

export function ActivityLookUpListToJSON(value?: ActivityLookUpList | null): any {
    return value;
}
