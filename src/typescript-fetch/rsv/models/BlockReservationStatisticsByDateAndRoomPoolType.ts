 ...
 */
export function instanceOfBlockReservationStatisticsByDateAndRoomPoolType(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function BlockReservationStatisticsByDateAndRoomPoolTypeFromJSON(json: any): BlockReservationStatisticsByDateAndRoomPoolType {
    return BlockReservationStatisticsByDateAndRoomPoolTypeFromJSONTyped(json, false);
}

export function BlockReservationStatisticsByDateAndRoomPoolTypeFromJSONTyped(json: any, ignoreDiscriminator: boolean): BlockReservationStatisticsByDateAndRoomPoolType {
...
export function BlockReservationStatisticsByDateAndRoomPoolTypeToJSON(value?: BlockReservationStatisticsByDateAndRoomPoolType | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
