 ...
 */
export function instanceOfChangeSharingGuests(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function ChangeSharingGuestsFromJSON(json: any): ChangeSharingGuests {
    return ChangeSharingGuestsFromJSONTyped(json, false);
}

export function ChangeSharingGuestsFromJSONTyped(json: any, ignoreDiscriminator: boolean): ChangeSharingGuests {
...
export function ChangeSharingGuestsToJSON(value?: ChangeSharingGuests | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
