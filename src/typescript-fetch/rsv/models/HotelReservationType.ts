...
import type { ScheduledRoomMoveType } from './ScheduledRoomMoveType';
import {
    ScheduledRoomMoveTypeFromJSON,
    ScheduledRoomMoveTypeFromJSONTyped,
    ScheduledRoomMoveTypeToJSON,
} from './ScheduledRoomMoveType';
...
export interface HotelReservationType {
     ...
     * @type {Array<ScheduledRoomMoveType>}
     * @memberof HotelReservationType
     */
    scheduledRoomMoves?: Array<ScheduledRoomMoveType>;
    /**
...
export function HotelReservationTypeFromJSONTyped(json: any, ignoreDiscriminator: boolean): HotelReservationType {
    ...
    return {
        ...
        'payeeSharer': !exists(json, 'payeeSharer') ? undefined : json['payeeSharer'],
        'scheduledRoomMoves': !exists(json, 'scheduledRoomMoves') ? undefined : ((json['scheduledRoomMoves'] as Array<any>).map(ScheduledRoomMoveTypeFromJSON)),
        'routeAllTransactionsToShare': !exists(json, 'routeAllTransactionsToShare') ? undefined : json['routeAllTransactionsToShare'],
        'backToBackGroupId': !exists(json, 'backToBackGroupId') ? undefined : json['backToBackGroupId'],
        'overrideSharesStayingPastDepartureCheck': !exists(json, 'overrideSharesStayingPastDepartureCheck') ? undefined : json['overrideSharesStayingPastDepartureCheck'],
...
export function HotelReservationTypeToJSON(value?: HotelReservationType | null): any {
    ...
    return {
        ...
        'scheduledRoomMoves': value.scheduledRoomMoves === undefined ? undefined : ((value.scheduledRoomMoves as Array<any>).map(ScheduledRoomMoveTypeToJSON)),
