...
export function TaxTypeFromJSONTyped(json: any, ignoreDiscriminator: boolean): TaxType {
    ...
    return {
        ...
        'generateTransactionCode': !exists(json, 'generateTransactionCode') ? undefined : json['generateTransactionCode'],
...
export function TaxTypeToJSON(value?: TaxType | null): any {
    ...
    return {
        ...
        'code': value.code,
        'generateTransactionCode': value.generateTransactionCode,
        'amount': value.amount,
