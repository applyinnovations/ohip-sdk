 ...
 * @export
 * @interface ChangeShareRateAmount
 */
export interface ChangeShareRateAmount {
    /**
     * 
 ...
 */
export function instanceOfChangeShareRateAmount(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function ChangeShareRateAmountFromJSON(json: any): ChangeShareRateAmount {
    return ChangeShareRateAmountFromJSONTyped(json, false);
}

export function ChangeShareRateAmountFromJSONTyped(json: any, ignoreDiscriminator: boolean): ChangeShareRateAmount {
...
export function ChangeShareRateAmountToJSON(value?: ChangeShareRateAmount | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
