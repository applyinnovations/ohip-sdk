 ...
 */
export function instanceOfMoveReservationHotelDetails(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function MoveReservationHotelDetailsFromJSON(json: any): MoveReservationHotelDetails {
    return MoveReservationHotelDetailsFromJSONTyped(json, false);
}

export function MoveReservationHotelDetailsFromJSONTyped(json: any, ignoreDiscriminator: boolean): MoveReservationHotelDetails {
...
export function MoveReservationHotelDetailsToJSON(value?: MoveReservationHotelDetails | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
