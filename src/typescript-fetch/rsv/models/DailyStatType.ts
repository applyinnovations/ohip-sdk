 ...
 */
export function instanceOfDailyStatType(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function DailyStatTypeFromJSON(json: any): DailyStatType {
    return DailyStatTypeFromJSONTyped(json, false);
}

export function DailyStatTypeFromJSONTyped(json: any, ignoreDiscriminator: boolean): DailyStatType {
...
export function DailyStatTypeToJSON(value?: DailyStatType | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
