 ...
 */
export function instanceOfSellMessages(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function SellMessagesFromJSON(json: any): SellMessages {
    return SellMessagesFromJSONTyped(json, false);
}

export function SellMessagesFromJSONTyped(json: any, ignoreDiscriminator: boolean): SellMessages {
...
export function SellMessagesToJSON(value?: SellMessages | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
