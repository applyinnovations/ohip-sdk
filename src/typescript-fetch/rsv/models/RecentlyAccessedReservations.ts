 ...
 */
export function instanceOfRecentlyAccessedReservations(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function RecentlyAccessedReservationsFromJSON(json: any): RecentlyAccessedReservations {
    return RecentlyAccessedReservationsFromJSONTyped(json, false);
}

export function RecentlyAccessedReservationsFromJSONTyped(json: any, ignoreDiscriminator: boolean): RecentlyAccessedReservations {
...
export function RecentlyAccessedReservationsToJSON(value?: RecentlyAccessedReservations | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
