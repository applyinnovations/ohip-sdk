 ...
 */
export function instanceOfCallHistory(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function CallHistoryFromJSON(json: any): CallHistory {
    return CallHistoryFromJSONTyped(json, false);
}

export function CallHistoryFromJSONTyped(json: any, ignoreDiscriminator: boolean): CallHistory {
...
export function CallHistoryToJSON(value?: CallHistory | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
