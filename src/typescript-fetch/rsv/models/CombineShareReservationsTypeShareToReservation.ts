 ...
 */
export function instanceOfCombineShareReservationsTypeShareToReservation(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function CombineShareReservationsTypeShareToReservationFromJSON(json: any): CombineShareReservationsTypeShareToReservation {
    return CombineShareReservationsTypeShareToReservationFromJSONTyped(json, false);
}

export function CombineShareReservationsTypeShareToReservationFromJSONTyped(json: any, ignoreDiscriminator: boolean): CombineShareReservationsTypeShareToReservation {
...
export function CombineShareReservationsTypeShareToReservationToJSON(value?: CombineShareReservationsTypeShareToReservation | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
