 ...
 * @export
 * @interface ReservationLocatorsDetailsInfo
 */
export interface ReservationLocatorsDetailsInfo {
    /**
 ...
 */
export function instanceOfReservationLocatorsDetailsInfo(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function ReservationLocatorsDetailsInfoFromJSON(json: any): ReservationLocatorsDetailsInfo {
    return ReservationLocatorsDetailsInfoFromJSONTyped(json, false);
}

export function ReservationLocatorsDetailsInfoFromJSONTyped(json: any, ignoreDiscriminator: boolean): ReservationLocatorsDetailsInfo {
...
export function ReservationLocatorsDetailsInfoToJSON(value?: ReservationLocatorsDetailsInfo | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
