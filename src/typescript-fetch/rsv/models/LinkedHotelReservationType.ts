 ...
 */
export function instanceOfLinkedHotelReservationType(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function LinkedHotelReservationTypeFromJSON(json: any): LinkedHotelReservationType {
    return LinkedHotelReservationTypeFromJSONTyped(json, false);
}

export function LinkedHotelReservationTypeFromJSONTyped(json: any, ignoreDiscriminator: boolean): LinkedHotelReservationType {
...
export function LinkedHotelReservationTypeToJSON(value?: LinkedHotelReservationType | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
