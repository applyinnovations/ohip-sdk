 ...
 * @export
 * @interface HotelReservationInstructionTypeTransactionDiversions
 */
export interface HotelReservationInstructionTypeTransactionDiversions {
    /**
     * 
     * @type {string}
 ...
 */
export function instanceOfHotelReservationInstructionTypeTransactionDiversions(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function HotelReservationInstructionTypeTransactionDiversionsFromJSON(json: any): HotelReservationInstructionTypeTransactionDiversions {
    return HotelReservationInstructionTypeTransactionDiversionsFromJSONTyped(json, false);
}

export function HotelReservationInstructionTypeTransactionDiversionsFromJSONTyped(json: any, ignoreDiscriminator: boolean): HotelReservationInstructionTypeTransactionDiversions {
...
export function HotelReservationInstructionTypeTransactionDiversionsToJSON(value?: HotelReservationInstructionTypeTransactionDiversions | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
