 ...
 */
export function instanceOfReservedInventoryItemsInfo(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function ReservedInventoryItemsInfoFromJSON(json: any): ReservedInventoryItemsInfo {
    return ReservedInventoryItemsInfoFromJSONTyped(json, false);
}

export function ReservedInventoryItemsInfoFromJSONTyped(json: any, ignoreDiscriminator: boolean): ReservedInventoryItemsInfo {
...
export function ReservedInventoryItemsInfoToJSON(value?: ReservedInventoryItemsInfo | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
