...
export function RoomInfoFromJSONTyped(json: any, ignoreDiscriminator: boolean): RoomInfo {
    ...
    return {
        ...
        'roomCondition': !exists(json, 'roomCondition') ? undefined : json['roomCondition'],
        'componentRoomNumber': !exists(json, 'componentRoomNumber') ? undefined : json['componentRoomNumber'],
        'componentSuiteRoomNumbers': !exists(json, 'componentSuiteRoomNumbers') ? undefined : json['componentSuiteRoomNumbers'],
