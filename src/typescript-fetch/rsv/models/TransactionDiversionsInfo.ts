 ...
 */
export function instanceOfTransactionDiversionsInfo(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function TransactionDiversionsInfoFromJSON(json: any): TransactionDiversionsInfo {
    return TransactionDiversionsInfoFromJSONTyped(json, false);
}

export function TransactionDiversionsInfoFromJSONTyped(json: any, ignoreDiscriminator: boolean): TransactionDiversionsInfo {
...
export function TransactionDiversionsInfoToJSON(value?: TransactionDiversionsInfo | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
