 ...
 */
export function instanceOfCombineShareValidationsDetails(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function CombineShareValidationsDetailsFromJSON(json: any): CombineShareValidationsDetails {
    return CombineShareValidationsDetailsFromJSONTyped(json, false);
}

export function CombineShareValidationsDetailsFromJSONTyped(json: any, ignoreDiscriminator: boolean): CombineShareValidationsDetails {
...
export function CombineShareValidationsDetailsToJSON(value?: CombineShareValidationsDetails | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
