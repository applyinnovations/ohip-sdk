...
import {
    CombineShareFromExistingReservationTypeFromJSON,
    CombineShareFromExistingReservationTypeFromJSONTyped,
    CombineShareFromExistingReservationTypeToJSON,
} from './CombineShareFromExistingReservationType';
...
export function CombineShareReservationsTypeFromJSONTyped(json: any, ignoreDiscriminator: boolean): CombineShareReservationsType {
    ...
    return {
        ...
        'existingReservation': !exists(json, 'existingReservation') ? undefined : CombineShareFromExistingReservationTypeFromJSON(json['existingReservation']),
    };
}
...
export function CombineShareReservationsTypeToJSON(value?: CombineShareReservationsType | null): any {
    ...
    return {
        ...
        'existingReservation': CombineShareFromExistingReservationTypeToJSON(value.existingReservation),
    };
}
