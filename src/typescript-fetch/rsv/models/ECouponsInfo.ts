 ...
 */
export function instanceOfECouponsInfo(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function ECouponsInfoFromJSON(json: any): ECouponsInfo {
    return ECouponsInfoFromJSONTyped(json, false);
}

export function ECouponsInfoFromJSONTyped(json: any, ignoreDiscriminator: boolean): ECouponsInfo {
...
export function ECouponsInfoToJSON(value?: ECouponsInfo | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
