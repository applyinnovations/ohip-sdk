...
import {
    ReservationsSummaryInformationTypeFromJSON,
    ReservationsSummaryInformationTypeFromJSONTyped,
    ReservationsSummaryInformationTypeToJSON,
} from './ReservationsSummaryInformationType';
...
export function ReservationsSummaryFromJSONTyped(json: any, ignoreDiscriminator: boolean): ReservationsSummary {
    ...
    return {
        ...
        'reservationsSummaryInformation': !exists(json, 'reservationsSummaryInformation') ? undefined : ReservationsSummaryInformationTypeFromJSON(json['reservationsSummaryInformation']),
...
export function ReservationsSummaryToJSON(value?: ReservationsSummary | null): any {
    ...
    return {
        ...
        'reservationsSummaryInformation': ReservationsSummaryInformationTypeToJSON(value.reservationsSummaryInformation),
