...
import {
    AttachDetachTypeFromJSON,
    AttachDetachTypeFromJSONTyped,
    AttachDetachTypeToJSON,
} from './AttachDetachType';
...
export function ResGuestTypeProfileInfoFromJSONTyped(json: any, ignoreDiscriminator: boolean): ResGuestTypeProfileInfo {
    ...
    return {
        ...
        'attachDetachType': !exists(json, 'attachDetachType') ? undefined : AttachDetachTypeFromJSON(json['attachDetachType']),
    };
}
...
export function ResGuestTypeProfileInfoToJSON(value?: ResGuestTypeProfileInfo | null): any {
    ...
    return {
        ...
        'attachDetachType': AttachDetachTypeToJSON(value.attachDetachType),
    };
}
