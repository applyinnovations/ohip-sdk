 ...
 */
export function instanceOfReservationPreference(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function ReservationPreferenceFromJSON(json: any): ReservationPreference {
    return ReservationPreferenceFromJSONTyped(json, false);
}

export function ReservationPreferenceFromJSONTyped(json: any, ignoreDiscriminator: boolean): ReservationPreference {
...
export function ReservationPreferenceToJSON(value?: ReservationPreference | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
