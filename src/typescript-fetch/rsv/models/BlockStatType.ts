 ...
 */
export function instanceOfBlockStatType(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function BlockStatTypeFromJSON(json: any): BlockStatType {
    return BlockStatTypeFromJSONTyped(json, false);
}

export function BlockStatTypeFromJSONTyped(json: any, ignoreDiscriminator: boolean): BlockStatType {
...
export function BlockStatTypeToJSON(value?: BlockStatType | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
