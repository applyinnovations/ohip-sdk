 ...
 */
export function instanceOfValidateRateInfo(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function ValidateRateInfoFromJSON(json: any): ValidateRateInfo {
    return ValidateRateInfoFromJSONTyped(json, false);
}

export function ValidateRateInfoFromJSONTyped(json: any, ignoreDiscriminator: boolean): ValidateRateInfo {
...
export function ValidateRateInfoToJSON(value?: ValidateRateInfo | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
