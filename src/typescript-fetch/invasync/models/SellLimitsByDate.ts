 ...
 * @export
 * @interface SellLimitsByDate
 */
export interface SellLimitsByDate extends Array<SellLimitByDateType> {
}

/**
 * Check if a given object implements the SellLimitsByDate interface.
 */
export function instanceOfSellLimitsByDate(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function SellLimitsByDateFromJSON(json: any): SellLimitsByDate {
    return SellLimitsByDateFromJSONTyped(json, false);
}

export function SellLimitsByDateFromJSONTyped(json: any, ignoreDiscriminator: boolean): SellLimitsByDate {
    return json;
}

export function SellLimitsByDateToJSON(value?: SellLimitsByDate | null): any {
    return value;
}
